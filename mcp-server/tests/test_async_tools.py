...
class TestValidation:
    ...
    def test_validate_empty_params(self):
        ...
        ***REMOVED*** Should not raise for health check (no params required)
        validate_task_params(
...
***REMOVED*** Note: Integration tests that actually call start_background_task, get_task_status,
***REMOVED*** cancel_task, and list_active_tasks would require a running Celery instance with
***REMOVED*** Redis. Those should be in a separate integration test suite.
