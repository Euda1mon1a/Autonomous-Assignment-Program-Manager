...
class TestMCPConfiguration:
    ...
    def test_mcp_version(self):
        ...
        ***REMOVED*** FastMCP stores version in settings or as attribute
        ***REMOVED*** Version is set in FastMCP constructor
    ...
    def test_mcp_has_instructions(self):
        ...
        ***REMOVED*** Instructions are configured in the FastMCP constructor
        ***REMOVED*** The exact attribute name may vary by FastMCP version
        assert mcp is not None
...
class TestToolsRegistration:
    ...
    def test_tools_registered(self):
        ...
        ***REMOVED*** FastMCP stores tools in _tool_manager or similar
        ***REMOVED*** Access the tools registry - the exact attribute varies by version
        ***REMOVED*** Try common patterns for accessing registered tools
        tools = None
    ...
    def test_minimum_tool_count(self):
        ...
        ***REMOVED*** Get tool count using available methods
        tool_count = 0
        ...
        ***REMOVED*** Server has 34 tools as of current implementation
    ...
    def test_core_scheduling_tools_exist(self):
        ...
        ***REMOVED*** Core scheduling tools that should exist
        expected_tools = [
    ...
    def test_resilience_tools_exist(self):
        ...
        ***REMOVED*** Resilience tools that should exist
        expected_tools = [
    ...
    def test_async_tools_exist(self):
        ...
        ***REMOVED*** Async task tools that should exist
        expected_tools = [
    ...
    def test_deployment_tools_exist(self):
        ...
        ***REMOVED*** Deployment tools that should exist
        expected_tools = [
...
class TestResourcesRegistration:
    ...
    def test_resources_registered(self):
        ...
        ***REMOVED*** In FastMCP 2.x, resources with parameters are registered as templates
        ***REMOVED*** Check for either resources or resource templates
        has_resources = False

        if hasattr(mcp, "_resource_manager"):
            ***REMOVED*** Check for templates (resources with parameters)
    ...
    async def test_minimum_resource_count(self):
        ...
        ***REMOVED*** FastMCP 2.x uses async get_resource_templates for parameterized resources
        templates = await mcp.get_resource_templates()
        resources = await mcp.get_resources()

        total_count = len(templates) + len(resources)

        ***REMOVED*** Server has 2 resource templates (status, compliance)
    ...
    async def test_schedule_status_resource_exists(self):
        ...
        ***REMOVED*** Get resources and templates
        templates = await mcp.get_resource_templates()
        resources = await mcp.get_resources()

        ***REMOVED*** Combine keys from both
        all_keys = set(templates.keys()) | set(resources.keys())

        ***REMOVED*** Check for schedule status resource
        has_status = any(
    ...
    async def test_compliance_resource_exists(self):
        ...
        ***REMOVED*** Check for compliance resource
        has_compliance = any(
...
class TestServerEntryPoint:
    ...
    def test_lifecycle_hooks_exist(self):
        ...
        ***REMOVED*** The on_initialize and on_shutdown hooks should be defined
        ***REMOVED*** These are decorated functions registered with the mcp instance
