...
***REMOVED*** =============================================================================
***REMOVED*** UtilityComponents Tests
***REMOVED*** =============================================================================
...
class TestUtilityComponents:
    ...
    def test_total_utility_calculation(self):
        ...
        ***REMOVED*** All 1.0 with weights summing to 1.0 should give 1.0 (use approx for float)
    ...
    def test_total_utility_with_default_weights(self):
        ...
        ***REMOVED*** Default weights: workload=0.4, preference=0.3, convenience=0.2, continuity=0.1
    ...
    def test_utility_bounds(self):
        ...
        ***REMOVED*** Use approximate comparison for floating point
        assert abs(utility.total_utility() - 1.0) < 1e-9
...
class TestWorkloadFairnessCalculation:
    ...
    def test_equal_distribution_is_fair(self):
        ...
        ***REMOVED*** Each person has exactly 2 assignments
        all_assignments = {
            "person-a": [{"id": "1"}, {"id": "2"}],
            "person-b": [{"id": "3"}, {"id": "4"}],
            "person-c": [{"id": "5"}, {"id": "6"}],
        ...
        ***REMOVED*** Equal distribution should have high fairness (close to 1.0)
        assert result >= 0.9

    def test_unequal_distribution_less_fair(self):
        """Test unequal distribution returns lower fairness."""
        all_assignments = {
            "person-a": [{"id": str(i)} for i in range(10)],  ***REMOVED*** 10 assignments
            "person-b": [{"id": "only-one"}],  ***REMOVED*** 1 assignment
        }
        result = _calculate_workload_fairness(all_assignments["person-a"], all_assignments)

        ***REMOVED*** Unequal distribution should have lower fairness
        assert result < 0.9
...
class TestPreferenceSatisfactionCalculation:
    ...
    def test_with_preference_trails(self):
        ...
        assignments = [{"id": "assign-1"}, {"id": "assign-2"}]
        preference_trails = {"assign-1": 8.0, "assign-2": 6.0}  ***REMOVED*** Scale 0-10

        result = _calculate_preference_satisfaction(assignments, preference_trails)

        ***REMOVED*** Average of 8/10 and 6/10 = 0.7
    ...
    def test_high_preference_strength(self):
        ...
        preference_trails = {"assign-1": 15.0}  ***REMOVED*** Above max

        result = _calculate_preference_satisfaction(assignments, preference_trails)

        ***REMOVED*** Should be capped at 1.0
        assert result == 1.0
...
class TestConvenienceCalculation:
    ...
    def test_with_assignments(self):
        ...
        ***REMOVED*** Placeholder returns 0.6
        assert result == 0.6
...
class TestContinuityCalculation:
    ...
    def test_partial_overlap(self):
        ...
        ***REMOVED*** 1 of 2 previous assignments retained = 0.5
        assert result == 0.5
...
class TestCalculatePersonUtility:
    ...
    def test_utility_with_preference_trails(self, assignments_by_person):
        ...
        ***REMOVED*** With preference data, should have higher preference satisfaction
...
class TestRequestModels:
    ...
    def test_nash_stability_request_valid(self):
        ...
        assert request.include_person_details is True  ***REMOVED*** default
        assert request.deviation_threshold == 0.01  ***REMOVED*** default
    ...
    def test_deviation_incentives_request_valid(self):
        ...
        assert request.max_alternatives == 5  ***REMOVED*** default
...
***REMOVED*** =============================================================================
***REMOVED*** analyze_nash_stability Tests
***REMOVED*** =============================================================================
...
class TestAnalyzeNashStability:
    ...
    async def test_with_assignments_analyzes_players(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** Should have 3 unique persons
    ...
    async def test_respects_deviation_threshold(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** High threshold should filter out small deviations
            request = NashStabilityRequest(
                start_date="2025-01-01",
                end_date="2025-01-31",
                deviation_threshold=0.5,  ***REMOVED*** Very high threshold
            )

            result = await analyze_nash_stability(request)

            ***REMOVED*** With high threshold, fewer deviations should pass
    ...
    async def test_includes_recommendations_when_unstable(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            request = NashStabilityRequest(
                start_date="2025-01-01",
                end_date="2025-01-31",
                deviation_threshold=0.001,  ***REMOVED*** Very low threshold to catch deviations
            )

            result = await analyze_nash_stability(request)

            ***REMOVED*** Response should have interpretation regardless of stability
            assert isinstance(result.game_theoretic_interpretation, str)
            assert len(result.game_theoretic_interpretation) > 0


***REMOVED*** =============================================================================
***REMOVED*** find_deviation_incentives Tests
***REMOVED*** =============================================================================
...
class TestFindDeviationIncentives:
    ...
    async def test_analyzes_strategic_position(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** Strategic position should be a non-empty string
    ...
    async def test_identifies_barriers(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** No candidates should result in barriers being identified
    ...
    async def test_graceful_degradation_on_error(self):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            assert result.current_utility == 0.5  ***REMOVED*** Placeholder value
            assert "backend unavailable" in result.strategic_position.lower()


***REMOVED*** =============================================================================
***REMOVED*** detect_coordination_failures Tests
***REMOVED*** =============================================================================
...
class TestDetectCoordinationFailures:
    ...
    async def test_detects_protocol_barrier(self, mock_api_assignments_response):
        ...
        ***REMOVED*** Create larger assignment set to trigger failure detection
        large_assignments = {
            "assignments": [
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** With >10 assignments, should detect at least one failure
    ...
    async def test_respects_min_pareto_gain(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** All returned failures should have gain >= threshold
...
class TestGameTheoryToolIntegration:
    ...
    async def test_nash_and_deviation_consistency(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** Run deviation analysis for a person
            ...
            ***REMOVED*** Both should return valid results
    ...
    async def test_comprehensive_game_theory_analysis(self, mock_api_assignments_response):
        ...
        with patch("scheduler_mcp.api_client.get_api_client") as mock_get_client:
            ...
            ***REMOVED*** 1. Analyze Nash stability
            nash_request = NashStabilityRequest(
                start_date="2025-01-01",
                end_date="2025-01-31",
            )
            ...
            ***REMOVED*** 2. Find deviation incentives for first player
            deviation_request = DeviationIncentivesRequest(
                person_id="person-0",
                start_date="2025-01-01",
                end_date="2025-01-31",
            ...
            ***REMOVED*** 3. Detect coordination failures
            ...
            ***REMOVED*** All tools should complete without error
