...
class TestGetStaticFallbacks:
    ...
    async def test_fallback_info_structure(self):
        ...
        ***REMOVED*** Even if empty, should be a list
        assert isinstance(response, list)

        ***REMOVED*** If there are fallbacks, they should be FallbackScheduleInfo
...
class TestResponseSeverityValues:
    ...
    def test_utilization_severity_values(self):
        ...
        ***REMOVED*** Create responses with each severity
