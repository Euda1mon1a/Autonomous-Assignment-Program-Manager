...
***REMOVED*** ============================================================================
***REMOVED*** Erlang C Coverage Optimization Tests
***REMOVED*** ============================================================================
...
class TestErlangCoverageTool:
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_optimize_coverage_basic(
        ...
        assert response["service_level"] > 0.9  ***REMOVED*** High service level
    ...
    async def test_optimize_coverage_low_load(self, mock_api_client):
        ...
        mock_response = {
            ...
            "predicted_wait_probability": 0.01,  ***REMOVED*** Very low wait probability
            "offered_load": 0.5,  ***REMOVED*** Low load
            "service_level": 0.998,
            "metrics": {
                "wait_probability": 0.01,
                "avg_wait_time": 0.002,
                "occupancy": 0.25,  ***REMOVED*** Low utilization - could reduce staff
            },
            "recommendations": [
    ...
    async def test_optimize_coverage_high_load(self, mock_api_client):
        ...
        mock_response = {
            ...
            "offered_load": 6.0,  ***REMOVED*** High load
            "service_level": 0.962,
            "metrics": {
                "wait_probability": 0.045,
                "avg_wait_time": 0.018,  ***REMOVED*** 18 minutes
                "occupancy": 0.75,  ***REMOVED*** High but sustainable
            },
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_optimize_coverage_staffing_table(self, mock_api_client):
        ...
        ***REMOVED*** Verify wait probability decreases with more servers
    ...
    async def test_optimize_coverage_zero_arrival(self, mock_api_client):
        ...
        mock_response = {
            ...
            "required_specialists": 1,  ***REMOVED*** Minimum for on-call coverage
...
***REMOVED*** ============================================================================
***REMOVED*** Process Capability (Six Sigma) Tests
***REMOVED*** ============================================================================
...
class TestProcessCapabilityTool:
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_analyze_capability_incapable(
        ...
        mock_response = {
            ...
            "target": 60.0,
            "defect_estimate": {
                "ppm": 25000,  ***REMOVED*** 2.5% defect rate
                "percentage": 2.5,
            },
            "recommendations": [
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_analyze_capability_off_center(self, mock_api_client):
        ...
        mock_response = {
            "cp": 2.0,  ***REMOVED*** High potential
            "cpk": 1.2,  ***REMOVED*** Lower actual due to off-center
            "pp": 2.0,
            "ppk": 1.2,
            "cpm": 1.0,  ***REMOVED*** Low due to Taguchi loss
            "capability_status": "MARGINAL",
            "sigma_level": 3.6,
            "centering_analysis": {
                "centering_ratio": 0.6,  ***REMOVED*** Cpk/Cp
                "status": "POOR - Process significantly off-center",
                "mean_shift": 8.5,  ***REMOVED*** Hours above target
            },
            "recommendations": [
        ...
        assert response["cp"] > response["cpk"]  ***REMOVED*** Off-center indicator
    ...
    async def test_analyze_capability_zero_variation(self, mock_api_client):
        ...
        mock_response = {
            ...
            "sigma_level": 99.0,  ***REMOVED*** Capped for display
            "std_dev": 0.0,
            "warnings": [
    ...
    async def test_analyze_capability_small_sample(self, mock_api_client):
        ...
        mock_response = {
            ...
            "sample_size": 15,  ***REMOVED*** Below recommended 30
            "warnings": [
    ...
    async def test_analyze_capability_custom_limits(self, mock_api_client):
        ...
        mock_response = {
            ...
            "cpk": 1.42,
            "capability_status": "CAPABLE",
            "lsl": 50.0,  ***REMOVED*** Custom lower limit
            "usl": 70.0,  ***REMOVED*** Custom upper limit (tighter than ACGME)
            "target": 60.0,
            "spec_width": 20.0,
            "severity": "healthy",
        }
    ...
    async def test_analyze_capability_with_trends(self, mock_api_client):
        ...
        mock_response = {
            ...
            "trend_analysis": {
                ...
                "slope": 0.5,  ***REMOVED*** Hours per week increase
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_analyze_acgme_compliance_capability(self, mock_api_client):
        ...
        mock_response = {
            ...
            "cpk": 1.35,
            "capability_status": "CAPABLE",
            "lsl": 40.0,  ***REMOVED*** Minimum meaningful workload
            "usl": 80.0,  ***REMOVED*** ACGME limit
            "target": 60.0,  ***REMOVED*** Balanced target
            "acgme_specific": {
                "hours_above_limit": 0,
                "hours_near_limit": 3,  ***REMOVED*** Within 5 hours of 80
                "compliance_rate": 1.0,  ***REMOVED*** 100%
                "margin_to_violation": 8.5,  ***REMOVED*** Average hours below 80
            },
            "severity": "healthy",
        }
        mock_api_client.get.return_value.json.return_value = mock_response
...
***REMOVED*** ============================================================================
***REMOVED*** Integration Tests (with actual backend module imports)
***REMOVED*** ============================================================================
...
class TestOptimizationIntegration:
    ...
    def test_erlang_calculation(self, specialty_coverage_params):
        ...
        try:
            ...
            ***REMOVED*** Calculate for given parameters
    ...
    def test_capability_indices(self):
        ...
        try:
            ...
            ***REMOVED*** Test data with known properties
            ...
            ***REMOVED*** For well-centered data, Cp and Cpk should be similar
            assert abs(cp - cpk) < cp * 0.2

            ***REMOVED*** Cpm should be high for on-target data
            assert cpm > 1.0
    ...
    def test_sigma_level_conversion(self):
        ...
        try:
            ...
            test_cases = [
                (1.0, 3.0),  ***REMOVED*** 3 sigma
                (1.33, 3.99),  ***REMOVED*** ~4 sigma
                (1.67, 5.01),  ***REMOVED*** ~5 sigma
                (2.0, 6.0),  ***REMOVED*** 6 sigma
            ]
