...
***REMOVED*** ============================================================================
***REMOVED*** Fixtures for Test Data
***REMOVED*** ============================================================================
...
def oscillating_historical_data() -> list[HistoricalDataPoint]:
    ...
    for i in range(20):
        ***REMOVED*** Simulate oscillations: capacity and demand cycle
        capacity = 45 + 10 * ((-1) ** (i // 3))  ***REMOVED*** Oscillates 35-55
        demand = 42 + 8 * ((-1) ** ((i + 2) // 3))  ***REMOVED*** Oscillates 34-50, phase shifted
...
def stable_historical_data() -> list[HistoricalDataPoint]:
    ...
    for i in range(15):
        ***REMOVED*** Minimal oscillation around equilibrium
        capacity = 50 + (i % 3 - 1) * 2  ***REMOVED*** 48, 50, 52, 48, ...
        demand = 40 + (i % 3 - 1) * 1  ***REMOVED*** 39, 40, 41, 39, ...
...
def lotka_volterra_params() -> dict[str, float]:
    ...
    return {
        "alpha": 0.1,  ***REMOVED*** Capacity growth rate
        "beta": 0.02,  ***REMOVED*** Consumption rate
        "delta": 0.01,  ***REMOVED*** Demand amplification
        "gamma": 0.05,  ***REMOVED*** Demand decay
    }


***REMOVED*** ============================================================================
***REMOVED*** Tests for analyze_supply_demand_cycles
***REMOVED*** ============================================================================
...
class TestAnalyzeSupplyDemandCycles:
    ...
    async def test_analyze_cycles_fitted_parameters(self, oscillating_historical_data):
        ...
        ***REMOVED*** All LV parameters must be positive
    ...
    async def test_analyze_cycles_current_state(self, oscillating_historical_data):
        ...
        ***REMOVED*** Current values should match last historical point
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for predict_capacity_crunch
***REMOVED*** ============================================================================
...
class TestPredictCapacityCrunch:
    ...
    async def test_predict_crunch_equilibrium_calculated(self, lotka_volterra_params):
        ...
        ***REMOVED*** Equilibrium: x* = gamma/delta, y* = alpha/beta
    ...
    async def test_predict_crunch_no_crunch_scenario(self):
        ...
        ***REMOVED*** Parameters near equilibrium with very low threshold
        ***REMOVED*** Equilibrium: x* = gamma/delta = 0.1/0.01 = 10.0
        ***REMOVED*** Start at equilibrium so oscillations are minimal
        request = CapacityCrunchRequest(
            current_capacity=10.0,  ***REMOVED*** At equilibrium
            current_demand=10.0,  ***REMOVED*** At equilibrium (alpha/beta = 0.1/0.01)
            alpha=0.1,
            beta=0.01,
            delta=0.01,
            gamma=0.1,
            crunch_threshold=1.0,  ***REMOVED*** Very low - well below equilibrium
            prediction_days=90,
        )

        result = await predict_capacity_crunch(request)

        ***REMOVED*** System should stay near equilibrium, minimum capacity should be above threshold
        assert result.minimum_capacity >= 0.0
        ***REMOVED*** Either no crunch, or risk should reflect reality
        assert result.risk_level in RiskLevelEnum
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for find_equilibrium_point
***REMOVED*** ============================================================================
...
class TestFindEquilibriumPoint:
    ...
    async def test_find_equilibrium_formula_correctness(self):
        ...
        ***REMOVED*** x* = gamma/delta = 0.1/0.02 = 5.0
        ***REMOVED*** y* = alpha/beta = 0.2/0.04 = 5.0
    ...
    async def test_find_equilibrium_interpretation_present(self, lotka_volterra_params):
        ...
        assert result.ecological_interpretation != ""
        assert len(result.ecological_interpretation) > 20  ***REMOVED*** Non-trivial explanation
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for simulate_intervention
***REMOVED*** ============================================================================
...
class TestSimulateIntervention:
    ...
    async def test_simulate_intervention_capacity_metrics(self, lotka_volterra_params):
        ...
        ***REMOVED*** With positive intervention, capacity should improve or stay same
    ...
    async def test_simulate_intervention_parameter_changes_tracked(self, lotka_volterra_params):
        ...
        ***REMOVED*** SCHEDULE_COMPRESSION should modify beta and gamma
...
class TestToolIntegration:
    ...
    async def test_analyze_then_predict_crunch(self, oscillating_historical_data):
        ...
        ***REMOVED*** Step 1: Analyze historical data
        ...
        ***REMOVED*** Step 2: Use fitted parameters for crunch prediction
        ...
        ***REMOVED*** Results should be consistent
    ...
    async def test_analyze_then_find_equilibrium(self, oscillating_historical_data):
        ...
        ***REMOVED*** Step 1: Analyze to get parameters
        analyze_request = SupplyDemandCyclesRequest(
            historical_data=oscillating_historical_data,
            prediction_days=60,
        )
        ...
        ***REMOVED*** Step 2: Find equilibrium
        ...
        ***REMOVED*** Equilibrium should match what analyze_supply_demand_cycles calculated
    ...
    async def test_full_workflow(self, oscillating_historical_data):
        ...
        ***REMOVED*** 1. Analyze historical data
        analyze_request = SupplyDemandCyclesRequest(
            historical_data=oscillating_historical_data,
            prediction_days=90,
        )
        ...
        ***REMOVED*** 4. Simulate intervention
