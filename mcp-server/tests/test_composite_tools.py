...
***REMOVED*** ============================================================================
***REMOVED*** Unified Critical Index Tests
***REMOVED*** ============================================================================
...
class TestUnifiedCriticalIndexTool:
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_calculate_index_universal_critical(
        ...
        mock_response = {
            ...
            "domain_agreement": 0.95,  ***REMOVED*** High agreement - all domains agree this is critical
    ...
    async def test_calculate_index_isolated_workhorse(self, mock_api_client):
        ...
        mock_response = {
            ...
            "domain_agreement": 0.42,  ***REMOVED*** Low agreement
            "conflict_details": [
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ***REMOVED*** Population Analysis Tests
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_analyze_population(self, mock_api_client):
        ...
        mock_response = {
            ...
            "total_faculty": 25,
            "risk_concentration": 0.35,  ***REMOVED*** Gini coefficient
            "critical_count": 5,
            ...
            "indices": [],  ***REMOVED*** Truncated for brevity
            "severity": "warning",
        }
        mock_api_client.get.return_value.json.return_value = mock_response
    ...
    async def test_analyze_population_risk_concentration(self, mock_api_client):
        ...
        mock_response = {
            "total_faculty": 30,
            "risk_concentration": 0.72,  ***REMOVED*** High - risk concentrated in few
            "concentration_analysis": {
                "gini_coefficient": 0.72,
                "interpretation": "HIGH - Risk concentrated in few faculty members",
                "top_10_percent_share": 0.65,  ***REMOVED*** Top 10% hold 65% of risk
            },
            "recommendations": [
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_calculate_index_missing_network(self, mock_api_client):
        ...
        mock_response = {
            ...
            "confidence": 0.45,  ***REMOVED*** Lower confidence due to missing data
    ...
    async def test_calculate_index_conflict_detection(self, mock_api_client):
        ...
        mock_response = {
            ...
            "domain_agreement": 0.38,  ***REMOVED*** Low agreement - domains disagree
            "conflict_details": [
    ...
    async def test_calculate_index_new_faculty(self, mock_api_client):
        ...
        mock_response = {
            ...
            "confidence": 0.15,  ***REMOVED*** Very low confidence
            "warnings": [
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_unified_index_schema(
        ...
        ***REMOVED*** Validate domain scores structure
...
***REMOVED*** ============================================================================
***REMOVED*** Recovery Distance Tests
***REMOVED*** ============================================================================
...
class TestRecoveryDistanceTool:
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_calculate_rd_zero(self, mock_api_client, stable_uuids):
        ...
        mock_response = {
            ...
            "recovery_distance": 0,
            "feasible": True,
            "witness_edits": [],  ***REMOVED*** No edits needed
    ...
    async def test_calculate_rd_infeasible(self, mock_api_client):
        ...
        mock_response = {
            ...
            "recovery_distance": 6,  ***REMOVED*** Max depth + 1
            "feasible": False,
            "witness_edits": [],
            "search_depth_reached": 5,  ***REMOVED*** Max depth
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ***REMOVED*** Aggregate Metrics Tests
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    ***REMOVED*** -------------------------------------------------------------------------
    ...
    async def test_rd_timeout(self, mock_api_client):
        ...
        mock_response = {
            ...
            "recovery_distance": -1,  ***REMOVED*** Unknown due to timeout
            "feasible": None,  ***REMOVED*** Unknown
            "witness_edits": [],
            "search_depth_reached": 3,  ***REMOVED*** Stopped early
            "computation_time_ms": 30000.0,  ***REMOVED*** Hit timeout
            "timed_out": True,
    ...
    async def test_rd_cache_hit(self, mock_api_client):
        ...
        mock_response = {
            ...
            "recovery_distance": 2,
            "feasible": True,
            "computation_time_ms": 0.5,  ***REMOVED*** Very fast due to cache
            "cache_hit": True,
            "severity": "healthy",
        }
        mock_api_client.get.return_value.json.return_value = mock_response
...
class TestCompositeIntegration:
    ...
    def test_recovery_distance_calculation(self):
        ...
        try:
            ...
            ***REMOVED*** Create assignments (each block has 2 people)
            assignments = []
            ...
            ***REMOVED*** Calculate recovery distance
    ...
    def test_unified_index_population_analysis(self):
        ...
        try:
            ...
            ***REMOVED*** Create assignments with varied patterns
            assignments = []
            for i, fac in enumerate(faculty):
                ***REMOVED*** Each faculty gets different number of assignments
                for j in range(i + 1):
                    if j < len(blocks):
