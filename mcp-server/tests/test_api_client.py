...
class TestSchedulerAPIClient:
    ...
    async def test_context_manager_cleanup(self):
        ...
        async with client:
            assert client._client is not None
        ***REMOVED*** Client should be closed after exiting context
        assert client._client is not None  ***REMOVED*** Still exists but is closed
...
class TestModuleLevelFunctions:
    ...
    async def test_get_api_client_creates_instance(self):
        ...
        ***REMOVED*** Clean up any existing client first
    ...
    async def test_close_api_client_cleans_up(self):
        ...
        ***REMOVED*** After closing, getting client again should create a new instance
    ...
    async def test_close_api_client_handles_none(self):
        ...
        await close_api_client()  ***REMOVED*** Should not raise even if no client exists
        await close_api_client()  ***REMOVED*** Can be called multiple times safely
