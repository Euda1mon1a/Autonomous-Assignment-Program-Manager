...
async def analyze_schedule_rigidity(
    ...
    ***REMOVED*** Try backend API first
    try:
        ...
        async with SchedulerAPIClient() as client:
            ...
            ***REMOVED*** Map stability grade to severity
    ...
    try:
        ***REMOVED*** Fallback: Import here to avoid circular dependencies
    ...
    ***REMOVED*** Build snapshots from provided data
    if current_assignments and proposed_assignments:
        ...
        ***REMOVED*** TODO: Load from database using schedule_ids
    ...
    ***REMOVED*** Anonymize person IDs for security
    anonymized_churn = {
        f"person_{i}": count
...
async def analyze_schedule_periodicity(
    ...
    ***REMOVED*** Build assignment data
    if assignments:
        ***REMOVED*** Convert to format expected by analyze_periodicity
        ***REMOVED*** This would need adaptation to actual Assignment model
        ...
        ***REMOVED*** TODO: Load from database
...
async def calculate_time_crystal_objective(
    ...
    ***REMOVED*** Constraint score from results
    if constraint_results:
        ...
        constraint_score = 1.0  ***REMOVED*** Assume perfect if no results provided

    ***REMOVED*** Fairness score
    churn_by_person = hamming_distance_by_person(current_snapshot, proposed_snapshot)
...
async def get_checkpoint_status(
    ...
    try:
        ...
        async with SchedulerAPIClient() as client:
            ...
            return CheckpointStatusResponse(
                ...
                authoritative_assignment_count=data.get("total_checkpoints", 0) * 7,  ***REMOVED*** Estimated
    ...
    ***REMOVED*** Placeholder response - real implementation would query manager state
    return CheckpointStatusResponse(
        has_authoritative_state=True,
...
async def get_time_crystal_health() -> TimeCrystalHealthResponse:
    ...
    ***REMOVED*** These would be actual health checks in production
