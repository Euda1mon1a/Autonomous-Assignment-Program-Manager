...
***REMOVED*** =============================================================================
***REMOVED*** Unified Critical Index Types
***REMOVED*** =============================================================================
...
class RiskPatternEnum(str, Enum):
    ...
    UNIVERSAL_CRITICAL = "universal_critical"  ***REMOVED*** All three domains high
    ...
    LOW_RISK = "low_risk"  ***REMOVED*** No domains high
...
***REMOVED*** =============================================================================
***REMOVED*** Recovery Distance Types
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Transcription Factors Types
***REMOVED*** =============================================================================
...
class TFTypeEnum(str, Enum):
    ...
    DUAL = "dual"  ***REMOVED*** Context-dependent
    PIONEER = "pioneer"  ***REMOVED*** Can re-enable silenced constraints
...
async def get_unified_critical_index(
    ...
    Example:
        ***REMOVED*** Check overall system risk
    ...
    try:
        ***REMOVED*** Try to import the actual backend module to verify availability
        import importlib.util
        if importlib.util.find_spec("app.resilience.unified_critical_index") is None:
            raise ImportError("Module not found")

        ***REMOVED*** In production, this would fetch data from the database
        ...
        ***REMOVED*** Mock response demonstrating the response structure
        return UnifiedCriticalIndexResponse(
            ...
            total_faculty=25,
            overall_index=42.5,  ***REMOVED*** Moderate system risk
            risk_level="moderate",
            risk_concentration=0.35,  ***REMOVED*** Moderate concentration
            critical_count=3,
...
async def calculate_recovery_distance(
    ...
    **Key Metrics:**
    ...
    Example:
        ***REMOVED*** Assess schedule fragility
    ...
    ***REMOVED*** Parse dates with defaults
    ...
    try:
        ...
        ***REMOVED*** In production, would fetch schedule and run actual analysis
        logger.warning("Recovery distance using placeholder data")

        ***REMOVED*** Mock response showing typical structure
        sample_results = []
        if include_samples:
            sample_results = [
                RecoveryResultInfo(
        ...
        ***REMOVED*** Calculate fragility score (0=resilient, 1=brittle)
        rd_mean = 1.8
...
async def assess_creep_fatigue(
    ...
    **Combined Risk Assessment:**
    ...
    Example:
        ***REMOVED*** Monitor resident burnout risk
    ...
    try:
        ...
        ***REMOVED*** In production, would fetch resident workload data
...
async def analyze_transcription_triggers(
    ...
    **Network Analysis:**
    ...
    Example:
        ***REMOVED*** Check regulatory state
        ...
        ***REMOVED*** Find repressed constraints during crisis
    ...
    try:
        ...
        ***REMOVED*** In production, would access actual TF scheduler state
