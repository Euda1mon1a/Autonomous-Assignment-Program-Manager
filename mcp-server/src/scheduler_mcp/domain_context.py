...
ABBREVIATIONS: Dict[str, str] = {
    ***REMOVED*** Personnel & Training Levels
    ...
    ***REMOVED*** Military/Administrative
    "TDY": "Temporary Duty",
    "DEP": "Deployment",
...
***REMOVED*** =============================================================================
***REMOVED*** CONSTRAINT EXPLANATIONS
***REMOVED*** =============================================================================

CONSTRAINT_EXPLANATIONS: Dict[str, Dict[str, Any]] = {
    ***REMOVED*** Hard Constraints (Must Be Satisfied)
    ...
    ***REMOVED*** Soft Constraints (Optimization Goals)
    "EquityConstraint": {
        "type": "soft",
...
***REMOVED*** =============================================================================
***REMOVED*** ROLE & PERSONNEL CONTEXT
***REMOVED*** =============================================================================
...
def expand_abbreviations(text: str, first_occurrence_only: bool = False) -> str:
    ...
    ***REMOVED*** Sort by length (longest first) to avoid partial matches
    ...
    for abbrev in sorted_abbrevs:
        if abbrev in expanded_text:
            ...
            ***REMOVED*** Use word boundary to avoid partial matches
...
def enrich_violation_response(violation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    ***REMOVED*** Expand abbreviations in details
