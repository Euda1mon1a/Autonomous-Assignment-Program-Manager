...
***REMOVED*** =============================================================================
***REMOVED*** Seismic Detection (STA/LTA) Models
***REMOVED*** =============================================================================
...
class PrecursorDetectionResponse(BaseModel):
    ...
    severity: str  ***REMOVED*** "healthy", "warning", "elevated", "critical"
...
class MultiSignalMagnitudeResponse(BaseModel):
    ...
    confidence_level: str  ***REMOVED*** "low", "medium", "high"
    interpretation: str
    recommended_actions: list[str]


***REMOVED*** =============================================================================
***REMOVED*** SPC Monitoring (Western Electric) Models
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Burnout Fire Index (CFFDRS) Models
***REMOVED*** =============================================================================
...
class FireDangerResponse(BaseModel):
    ...
    severity: str  ***REMOVED*** "healthy", "warning", "elevated", "critical", "emergency"
...
***REMOVED*** =============================================================================
***REMOVED*** Tool Functions - Seismic Detection
***REMOVED*** =============================================================================
...
async def detect_burnout_precursors(
    ...
    try:
        ...
        ***REMOVED*** Initialize detector with specified windows
        detector = BurnoutEarlyWarning(
            short_window=request.short_window,
            long_window=request.long_window,
        )

        ***REMOVED*** Convert string to UUID for the detector
        try:
            resident_uuid = UUID(request.resident_id)
        except ValueError:
            ***REMOVED*** If not a valid UUID, create a deterministic one from the string
            import hashlib

            hash_bytes = hashlib.md5(request.resident_id.encode()).digest()
            resident_uuid = UUID(bytes=hash_bytes)

        ***REMOVED*** Map MCP signal type to backend enum
        signal_map = {
        ...
        ***REMOVED*** Convert alerts to response format
        alert_infos = []
        max_ratio = 0.0
        for alert in alerts:
        ...
        ***REMOVED*** Return fallback response
        return PrecursorDetectionResponse(
            resident_id=request.resident_id,
            signal_type=request.signal_type,
            alerts_detected=0,
...
async def predict_burnout_magnitude(
    ...
    try:
        ...
        ***REMOVED*** Map signal names to PrecursorSignal enum
        signal_map = {
        ...
        ***REMOVED*** Convert to format expected by detector
        precursor_signals = {}
        ...
        ***REMOVED*** Get predicted magnitude
        magnitude = detector.predict_burnout_magnitude(precursor_signals)

        ***REMOVED*** Calculate individual signal magnitudes for transparency
        signal_magnitudes = {}
        for signal_name, time_series in request.signals.items():
        ...
        ***REMOVED*** Determine confidence based on signal count
...
***REMOVED*** =============================================================================
***REMOVED*** Tool Functions - SPC Monitoring
***REMOVED*** =============================================================================
...
async def run_spc_analysis(
    ...
    try:
        ...
        ***REMOVED*** Convert resident_id to UUID
        try:
            resident_uuid = UUID(request.resident_id)
        except ValueError:
            import hashlib
        ...
        ***REMOVED*** Calculate process capability if enough data
        capability = None
        if len(request.weekly_hours) >= 2:
            try:
                cap_result = calculate_process_capability(
                    data=request.weekly_hours,
                    lsl=40.0,  ***REMOVED*** Minimum reasonable hours
                    usl=80.0,  ***REMOVED*** ACGME maximum
                )
                capability = {
                    "cp": cap_result["cp"],
                    "cpk": cap_result["cpk"],
...
async def calculate_process_capability_tool(
    ...
    try:
        ...
        ***REMOVED*** Generate recommendation based on Cpk
        cpk = result["cpk"]
        if cpk < 0:
...
***REMOVED*** =============================================================================
***REMOVED*** Tool Functions - Burnout Fire Index
***REMOVED*** =============================================================================
...
async def calculate_fire_danger_index(
    ...
    try:
        ...
        ***REMOVED*** Initialize rating system
        ...
        ***REMOVED*** Build component scores
        ...
        ***REMOVED*** Generate temporal analysis
        temporal_analysis = {
