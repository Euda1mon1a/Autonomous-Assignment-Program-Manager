...
async def run_contingency_analysis(
    ...
    ***REMOVED*** Calculate coverage gaps based on scenario type
    if request.scenario == ContingencyScenario.FACULTY_ABSENCE:
        ...
        ***REMOVED*** Based on 80% utilization threshold from resilience framework
...
async def analyze_swap_candidates(
    ...
    try:
        ...
        ***REMOVED*** Map backend response to MCP format
        candidates = []
        ...
        for c in result.get("candidates", []):
            ***REMOVED*** Parse block_date to create date range
            try:
        ...
        ***REMOVED*** Fall back to mock implementation if backend is unavailable
...
async def _analyze_swap_candidates_mock(
    ...
    ***REMOVED*** Candidate 2: Good match
    match_score_2 = (
    ...
    ***REMOVED*** Candidate 3: Moderate match
    match_score_3 = (
