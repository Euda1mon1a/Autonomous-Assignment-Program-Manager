...
async def validate_schedule(
    ...
    try:
        ...
        ***REMOVED*** Call the real backend API
        result = await client.validate_schedule(
            start_date=request.start_date.isoformat(),
            end_date=request.end_date.isoformat(),
        )

        ***REMOVED*** Transform backend response to MCP format
        issues: list[ValidationIssue] = []

        ***REMOVED*** Parse violations from backend response
            ...
            ***REMOVED*** Map severity
            ...
            conflicts.append(
                ConflictInfo(
                    ...
                    auto_resolution_available=False,  ***REMOVED*** Backend doesn't provide auto-resolution
                    resolution_options=[],
                )
            )
...
***REMOVED*** Keep mock implementation as fallback for swap candidates (requires file upload in backend)
...
***REMOVED*** Schedule Generation Models and Function
...
class ScheduleGenerationRequest(BaseModel):
    ...
    start_date: date
    end_date: date
    ***REMOVED*** Default to CP_SAT - greedy has a known bug (see backend/app/scheduling/solvers.py)
...
class ScheduleGenerationResult(BaseModel):
    ...
    status: str  ***REMOVED*** "success", "partial", "failed"
...
async def generate_schedule(
    ...
    try:
        ...
        ***REMOVED*** Extract validation info
