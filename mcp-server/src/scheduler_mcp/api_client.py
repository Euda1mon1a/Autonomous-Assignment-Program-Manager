...
DEFAULT_RETRY_DELAY = 1.0  ***REMOVED*** seconds
...
class SchedulerAPIClient:
    ...
    async def _request_with_retry(
        ...
        **kwargs: Any,
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                ***REMOVED*** Don't retry on success or client errors (4xx except 408, 429)
                ...
                ***REMOVED*** Retry on server errors and specific client errors
        ...
        ***REMOVED*** If we get here, all retries failed
        if last_exception:
    ...
    async def validate_schedule(
        ...
        ***REMOVED*** Note: Uses GET /schedule/validate endpoint (not POST /schedules/validate)
    ...
    async def get_conflicts(self, start_date: str, end_date: str) -> dict[str, Any]:
        ...
        ***REMOVED*** Note: Uses GET /conflicts/analyze endpoint (requires auth)
    ...
    async def generate_schedule(
        ...
        ***REMOVED*** Clear existing assignments if requested
        if clear_existing:
    ...
    ***REMOVED*** ==================== ASSIGNMENT CRUD METHODS ====================
...
***REMOVED*** Module-level client instance
