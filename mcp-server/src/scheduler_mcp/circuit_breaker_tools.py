...
***REMOVED*** =============================================================================
***REMOVED*** Enums and Response Models
***REMOVED*** =============================================================================
...
class CircuitStateEnum(str, Enum):
    ...
    CLOSED = "closed"  ***REMOVED*** Normal operation, requests pass through
    OPEN = "open"  ***REMOVED*** Circuit tripped, requests fail fast
    HALF_OPEN = "half_open"  ***REMOVED*** Testing recovery, limited requests allowed


class BreakerSeverityEnum(str, Enum):
    """Overall severity level for circuit breaker health."""

    HEALTHY = "healthy"  ***REMOVED*** All breakers closed, system normal
    WARNING = "warning"  ***REMOVED*** Some breakers half-open or elevated failure rates
    CRITICAL = "critical"  ***REMOVED*** Multiple breakers open, degraded service
    EMERGENCY = "emergency"  ***REMOVED*** System-wide circuit breaker failures
...
async def check_circuit_breakers() -> AllBreakersStatusResponse:
    ...
    try:
        ...
        ***REMOVED*** Build detailed breaker status list
        breakers = []
...
async def get_breaker_health() -> BreakerHealthResponse:
    ...
    try:
        ...
        ***REMOVED*** Find breakers needing attention
        needing_attention = []
        failure_rates = []
        unhealthiest = None
        ...
        ***REMOVED*** Determine trend (simplified - in production would use historical data)
...
async def test_half_open_breaker(
    ...
    Example:
        ***REMOVED*** Check if database breaker is ready to recover
    ...
    try:
        ...
        ***REMOVED*** Check if breaker exists
        ...
        ***REMOVED*** Check if breaker is in HALF_OPEN state
        ...
        ***REMOVED*** Breaker is in HALF_OPEN - provide recovery status
        consecutive_successes = status.get("consecutive_successes", 0)
        ***REMOVED*** Get success threshold from config (default is 2)
        ...
        test_result = HalfOpenTestResult(
            ...
            test_successful=True,  ***REMOVED*** We're just checking status, not actually calling
...
async def override_circuit_breaker(
    ...
    Example:
        ***REMOVED*** Force close a circuit breaker during maintenance
        ...
        ***REMOVED*** Force open to protect against known issue
        result = await override_circuit_breaker(
