...
class FindSwapMatchesTool(
    ...
    def validate_input(self, **kwargs: Any) -> FindSwapMatchesRequest:
        ...
        ***REMOVED*** Validate person_id
        person_id = validate_person_id(kwargs.get("person_id", ""))

        ***REMOVED*** Validate optional IDs
        ...
        ***REMOVED*** Validate max candidates
    ...
    async def execute(
        ...
        try:
            ...
            ***REMOVED*** Person not found or missing data
            return FindSwapMatchesResponse(
                person_id=request.person_id,
                total_candidates=0,
                candidates=[],
