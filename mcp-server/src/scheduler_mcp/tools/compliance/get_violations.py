...
class Violation(BaseModel):
    ...
    id: str
    rule_type: str  ***REMOVED*** work_hours, day_off, supervision
    severity: str  ***REMOVED*** critical, warning
...
class GetViolationsTool(BaseTool[GetViolationsRequest, GetViolationsResponse]):
    ...
    async def execute(
        ...
        try:
            ...
            ***REMOVED*** Get violations via API
            ...
            ***REMOVED*** Return empty result on error
            return GetViolationsResponse(
                start_date=request.start_date,
                end_date=request.end_date,
                total_violations=0,
