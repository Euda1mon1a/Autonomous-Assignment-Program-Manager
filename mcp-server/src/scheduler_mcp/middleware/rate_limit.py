...
class RateLimiter:
    ...
    def __init__(
        self,
        rate: int = 100,  ***REMOVED*** tokens per minute
        burst: int = 10,  ***REMOVED*** max burst size
    ):
        """
...
class RateLimitMiddleware:
    ...
    def __init__(
        self,
        enabled: bool = True,
        rate: int = 100,  ***REMOVED*** requests per minute
        burst: int = 10,  ***REMOVED*** max burst
    ):
        """
        ...
        ***REMOVED*** Per-tool rate limiters
    ...
    async def __call__(
        ...
        ***REMOVED*** Check global rate limit
        ...
        ***REMOVED*** Check per-tool rate limit
