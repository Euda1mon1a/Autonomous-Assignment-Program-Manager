***REMOVED*** Domain Context Module - Implementation Summary
...
***REMOVED******REMOVED******REMOVED*** 1. ABBREVIATIONS Dictionary (28 entries)

Comprehensive mapping of domain abbreviations to full names:

***REMOVED******REMOVED******REMOVED******REMOVED*** Personnel & Training Levels (8)
- PGY-1, PGY-2, PGY-3, PGY
- MS, MS3, MS4
- TY, PSYCH

***REMOVED******REMOVED******REMOVED******REMOVED*** Faculty Roles (6)
- PD, APD, OIC
- SM, CORE, DEPT_CHIEF

***REMOVED******REMOVED******REMOVED******REMOVED*** Regulatory Bodies (2)
- ACGME, LCME

***REMOVED******REMOVED******REMOVED******REMOVED*** Schedule Elements (6)
- FMIT, PC, ASM
- NF, AM, PM

***REMOVED******REMOVED******REMOVED******REMOVED*** Military/Administrative (8)
- TDY, DEP, FEM, PER
- MTF, PERSEC, OPSEC
- PII, PHI
...
***REMOVED******REMOVED*** 2. CONSTRAINT_EXPLANATIONS Dictionary (13 documented)

***REMOVED******REMOVED******REMOVED*** Hard Constraints (9)
...
***REMOVED******REMOVED******REMOVED*** Soft Constraints (4)
...
***REMOVED******REMOVED*** 3. SCHEDULING_PATTERNS Dictionary (6 patterns)

***REMOVED******REMOVED******REMOVED*** Documented Patterns
...
***REMOVED******REMOVED*** 4. ROLE_CONTEXT Dictionary

***REMOVED******REMOVED******REMOVED*** Faculty Roles (6)
- PD, APD, OIC, DEPT_CHIEF, SPORTS_MED, CORE
- Includes clinic slots/week, constraints, admin status

***REMOVED******REMOVED******REMOVED*** Screener Roles (4)
- DEDICATED (100%), RN (90%), EMT (80%), RESIDENT (70%)
- Includes efficiency percentages

---

***REMOVED******REMOVED*** 5. PII_SECURITY_CONTEXT Dictionary

***REMOVED******REMOVED******REMOVED*** Never Expose (6 fields)
- person.name, person.email
- absence.tdy_location, absence.deployment_*
- schedule_assignment (with names)

***REMOVED******REMOVED******REMOVED*** Safe Fields (5 types)
...
***REMOVED******REMOVED*** 6. Helper Functions (9 functions)
...
***REMOVED******REMOVED*** Additional Constraints Discovered (Not Yet Documented)

During codebase analysis, **19 additional constraints** were found that are not yet documented in domain_context.py:

***REMOVED******REMOVED******REMOVED*** Hard Constraints (13)
...
***REMOVED******REMOVED******REMOVED*** Soft Constraints (8)
...
***REMOVED******REMOVED******REMOVED*** Example 1: Expand Abbreviations
```python
...
***REMOVED*** Result: "PGY-1 (Post-Graduate Year 1) on FMIT (Family Medicine Inpatient Team)
***REMOVED***          with PC (Post-Call) on Friday"
```

***REMOVED******REMOVED******REMOVED*** Example 2: Explain Constraint
```python
...
***REMOVED******REMOVED******REMOVED*** Example 3: Enrich Violation
```python
...
***REMOVED*** Adds explanation, fix_options, code_reference, expands abbreviations
```

***REMOVED******REMOVED******REMOVED*** Example 4: Check PII Safety
```python
from scheduler_mcp.domain_context import is_pii_safe

is_pii_safe("person_id")  ***REMOVED*** True
is_pii_safe("person.email")  ***REMOVED*** False
is_pii_safe("absence.tdy_location")  ***REMOVED*** False
```
...
***REMOVED******REMOVED******REMOVED*** For MCP Tools
