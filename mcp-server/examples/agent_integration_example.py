...
from scheduler_mcp.server import mcp  ***REMOVED*** The existing FastMCP instance
...
***REMOVED*** ============================================================================
***REMOVED*** Integration: Register Agentic Tools with FastMCP
***REMOVED*** ============================================================================
...
def register_agentic_tools():
    ...
    """
    ***REMOVED*** Initialize the agent server
    agent = AgentMCPServer(llm_provider="claude-3-5-sonnet-20241022")

    ***REMOVED*** Register analyze_and_fix_schedule tool
    @mcp.tool()
    async def analyze_and_fix_schedule_agent(
        ...
        ***REMOVED*** Convert Pydantic model to dict for MCP response
        return result.model_dump()

    ***REMOVED*** Register optimize_coverage tool
    @mcp.tool()
    ...
    ***REMOVED*** Register resolve_conflict tool
    @mcp.tool()
    ...
    ***REMOVED*** Register goal status tool
    @mcp.tool()
...
async def example_optimize_coverage():
    ...
    ***REMOVED*** Scenario: Optimize coverage for next month
...
async def example_resolve_conflict():
    ...
    ***REMOVED*** Scenario: Two faculty want the same shift off
    result = await agent.resolve_conflict(
...
async def example_goal_tracking():
    ...
    ***REMOVED*** Start a goal
    result = await agent.analyze_and_fix_schedule(
        issue_description="Test issue for tracking",
        auto_apply=False,
    )

    ***REMOVED*** Get goal status
