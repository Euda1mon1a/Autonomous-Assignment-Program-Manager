...
***REMOVED*** Add backend to path so we can import Celery app
backend_path = Path(__file__).parent.parent.parent / "backend"
sys.path.insert(0, str(backend_path))

***REMOVED*** Import async tools
...
async def example_2_contingency_analysis():
    ...
    ***REMOVED*** Start contingency analysis
    ...
    ***REMOVED*** Poll for completion
    print("\nPolling for completion...")
    max_attempts = 60  ***REMOVED*** 5 minutes max
    poll_interval = 5
...
async def example_3_metrics_computation():
    ...
    ***REMOVED*** Start metrics computation
...
async def example_5_cancel_task():
    ...
    ***REMOVED*** Start a long-running task
...
async def main():
    ...
    try:
        ***REMOVED*** Example 1: Health check
        await example_1_health_check()

        ***REMOVED*** Example 2: Contingency analysis
        await example_2_contingency_analysis()

        ***REMOVED*** Example 3: Metrics computation
        await example_3_metrics_computation()

        ***REMOVED*** Example 4: List active tasks
        await example_4_list_active_tasks()

        ***REMOVED*** Example 5: Cancel task
