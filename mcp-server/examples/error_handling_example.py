...
***REMOVED*** ============================================================================
***REMOVED*** Example 1: Basic Error Handler
***REMOVED*** ============================================================================
...
async def validate_schedule_dates(start_date: str, end_date: str) -> dict[str, Any]:
    ...
    if end < start:
        ***REMOVED*** Explicit validation error with field information
...
***REMOVED*** ============================================================================
***REMOVED*** Example 2: Error Handler with Retry Logic
***REMOVED*** ============================================================================
...
async def fetch_schedule_from_api(schedule_id: str) -> dict[str, Any]:
    ...
    ***REMOVED*** In real implementation, this would use httpx or similar
    import random

    if random.random() < 0.3:  ***REMOVED*** 30% chance of transient failure
...
***REMOVED*** ============================================================================
***REMOVED*** Example 3: Error Handler with Circuit Breaker
***REMOVED*** ============================================================================
...
@mcp_error_handler(
    ...
    circuit_breaker_config=CircuitBreakerConfig(
        ...
        success_threshold=2,  ***REMOVED*** Close after 2 successes in half-open
        timeout=60.0,  ***REMOVED*** Try half-open after 60 seconds
    ),
)
async def query_database(query: str) -> dict[str, Any]:
    ...
    """
    ***REMOVED*** Simulate database query
    ***REMOVED*** In real implementation, this would use SQLAlchemy
    try:
        ***REMOVED*** Simulate potential database issues
...
***REMOVED*** ============================================================================
***REMOVED*** Example 4: Combining Retry and Circuit Breaker
***REMOVED*** ============================================================================
...
async def run_resilience_check() -> dict[str, Any]:
    ...
    """
    ***REMOVED*** Simulate resilience API call
    return {
        "status": "healthy",
        "safety_level": "GREEN",
        "checks_passed": 8,
...
***REMOVED*** ============================================================================
***REMOVED*** Example 5: Manual Error Handling
***REMOVED*** ============================================================================
...
async def manual_error_handling_example() -> dict[str, Any]:
    ...
    """
    try:
        ***REMOVED*** Your operation here
        result = await some_risky_operation()
        return {"success": True, "result": result}

    except MCPValidationError as e:
        ***REMOVED*** Handle validation errors
        print(f"Validation failed: {e.message}")
        return e.to_dict()

    except MCPServiceUnavailable as e:
        ***REMOVED*** Handle service unavailable
...
***REMOVED*** ============================================================================
***REMOVED*** Example 6: Using Circuit Breaker Directly
***REMOVED*** ============================================================================
...
async def direct_circuit_breaker_usage() -> None:
    ...
    """
    ***REMOVED*** Get or create circuit breaker
...
***REMOVED*** ============================================================================
***REMOVED*** Example 7: Monitoring Error Metrics
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Example 8: Structured Error Response
***REMOVED*** ============================================================================
...
async def structured_error_example() -> dict[str, Any]:
    ...
    """
    try:
        ***REMOVED*** Operation that might fail
...
async def main():
    ...
    ***REMOVED*** Example 1: Basic validation
    ...
    ***REMOVED*** Example 3: Circuit breaker
    print("\n3. Circuit Breaker:")
    try:
