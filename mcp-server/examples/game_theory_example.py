...
async def example_nash_stability_analysis():
    ...
    ***REMOVED*** Define date range (e.g., Q1 2025)
    ...
    ***REMOVED*** Create request
    request = NashStabilityRequest(
        ...
        deviation_threshold=0.01,  ***REMOVED*** 1% utility gain threshold
    )

    ***REMOVED*** Analyze stability
...
async def example_person_deviation_analysis():
    ...
    ***REMOVED*** Example person ID (replace with actual ID)
...
async def example_utility_calculation():
    ...
    ***REMOVED*** Example data (replace with actual data)
    person_id = "example-person"
    assignments = []  ***REMOVED*** Would contain actual assignments
    all_assignments = {person_id: assignments}

    ***REMOVED*** Calculate utility with default weights
    ...
    ***REMOVED*** Calculate utility with custom weights (emphasize workload fairness)
    custom_weights = {
        "workload": 0.5,
        "preference": 0.3,
        "convenience": 0.1,
