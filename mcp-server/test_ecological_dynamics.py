...
***REMOVED*** Import the tool functions directly
...
async def test_analyze_cycles():
    ...
    ***REMOVED*** Create synthetic historical data with oscillating pattern
    ...
    for i in range(20):
        ***REMOVED*** Simulate oscillations: capacity and demand cycle
        week = i
        capacity = 45 + 10 * ((-1) ** (i // 3))  ***REMOVED*** Oscillates between 35-55
        demand = 42 + 8 * ((-1) ** ((i + 2) // 3))  ***REMOVED*** Oscillates between 34-50, phase shifted
...
async def test_intervention(params):
    ...
    request = InterventionRequest(
        ...
        intervention_magnitude=0.25,  ***REMOVED*** 25% capacity increase
...
async def main():
    ...
    try:
        ***REMOVED*** Test 1: Analyze historical cycles
        params = await test_analyze_cycles()

        ***REMOVED*** Test 2: Predict capacity crunch
        await test_predict_crunch(params)

        ***REMOVED*** Test 3: Find equilibrium
        await test_equilibrium(params)

        ***REMOVED*** Test 4: Simulate intervention
