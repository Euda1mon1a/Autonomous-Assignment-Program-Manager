...
***REMOVED******REMOVED******REMOVED******REMOVED*** ACGME Rules Validated
...
***REMOVED******REMOVED******REMOVED*** 1a. `validate_schedule_by_id` (ConstraintService Integration)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Input Validation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Constraint Configurations
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Response (Sanitized)
...
***REMOVED******REMOVED******REMOVED*** 2. `analyze_contingency`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Scenario Types
...
***REMOVED******REMOVED******REMOVED*** 3. `detect_conflicts`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Conflict Types
...
***REMOVED******REMOVED******REMOVED*** 4. `find_swap_matches`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Scoring Algorithm
...
***REMOVED******REMOVED*** Integration Example

***REMOVED******REMOVED******REMOVED*** Claude Desktop Configuration
...
***REMOVED******REMOVED******REMOVED*** Tool Invocation
