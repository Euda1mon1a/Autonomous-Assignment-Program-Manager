***REMOVED*** MCP Resources Reference
...
***REMOVED******REMOVED******REMOVED*** 1. `schedule://status`

Returns the current schedule status with coverage metrics and operational data.

***REMOVED******REMOVED******REMOVED******REMOVED*** URI Pattern
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Database Queries
...
***REMOVED******REMOVED******REMOVED*** 2. `compliance://summary`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ACGME Validation Logic

**80-Hour Rule:**
```python
***REMOVED*** Track assignments per resident over rolling 4-week windows
***REMOVED*** Each block = 6 hours
***REMOVED*** Max 53 blocks per 4-week period (80 * 4 / 6 = 53.3)
...
**1-in-7 Rule:**
```python
***REMOVED*** Check for 7+ consecutive duty days
...
***REMOVED******REMOVED******REMOVED*** Accessing Resources
