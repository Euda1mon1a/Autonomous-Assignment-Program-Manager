...
***REMOVED******REMOVED******REMOVED*** Core Scheduling Tools
...
***REMOVED******REMOVED******REMOVED*** Resilience Framework Tools (77 tools)
...
***REMOVED******REMOVED******REMOVED*** Exotic Research Tools (20 tools) - NEW
...
***REMOVED******REMOVED******REMOVED*** Docker Container (Recommended)
...
***REMOVED*** Development mode (hot reload, HTTP transport on port 8080)
...
***REMOVED******REMOVED******REMOVED*** Standalone Mode (Development)
...
***REMOVED******REMOVED******REMOVED*** Remote Deployment (Render, Railway, Fly.io)

Deploy the MCP server to a cloud platform for remote AI agent access:

***REMOVED******REMOVED******REMOVED******REMOVED*** Render Deployment
...
3. **Environment Variables**
   ...
   ```bash
   ***REMOVED*** MCP Transport (required)
   MCP_TRANSPORT=http
   MCP_HOST=0.0.0.0
   MCP_PORT=8080

   ***REMOVED*** Authentication (required for production)
...
5. **Verify Connection**
   ...
   ***REMOVED*** MCP endpoint (requires auth)
   curl -H "Authorization: Bearer <your-key>" \
        https://residency-scheduler-mcp.onrender.com/mcp
   ```

***REMOVED******REMOVED******REMOVED******REMOVED*** Security Notes
