...
function createApiClient(): AxiosInstance {
  const client = axios.create({
    ...
    // Issue ***REMOVED***4: Timeout mismatch - increased from 30s to 120s to match backend
  ...
  client.interceptors.response.use(
    (response) => {
      ...
      // Issue ***REMOVED***5: Handle 207 Multi-Status as a successful response (partial success)
    ...
    async (error: AxiosError) => {
      ...
      // Issue ***REMOVED***5: Treat 207 Multi-Status as success (partial success scenario)
