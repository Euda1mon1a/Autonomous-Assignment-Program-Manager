***REMOVED*** State Management Patterns - Residency Scheduler Frontend
...
***REMOVED******REMOVED*** 1. React Context Providers

***REMOVED******REMOVED******REMOVED*** Location: `/frontend/src/contexts/`

The codebase uses three React Context providers:

***REMOVED******REMOVED******REMOVED*** 1.1 AuthContext
...
***REMOVED******REMOVED******REMOVED*** 1.2 ToastContext
...
***REMOVED******REMOVED******REMOVED*** 1.3 ClaudeChatContext
...
***REMOVED******REMOVED*** 2. TanStack Query (Server State)
...
***REMOVED******REMOVED******REMOVED*** Query Key Factory Pattern
...
***REMOVED******REMOVED******REMOVED*** Hook Organization
...
***REMOVED******REMOVED******REMOVED*** Query Hook Pattern
...
***REMOVED******REMOVED******REMOVED*** Mutation Hook Pattern
...
***REMOVED******REMOVED*** 3. Optimistic Updates

**File:** `hooks/useOptimisticUpdate.ts`

***REMOVED******REMOVED******REMOVED*** Basic Optimistic Update
...
***REMOVED******REMOVED******REMOVED*** Optimistic List Operations
...
***REMOVED******REMOVED*** 4. Type Definitions

***REMOVED******REMOVED******REMOVED*** Location: `/frontend/src/types/`
...
***REMOVED******REMOVED******REMOVED*** Key Type Patterns
...
***REMOVED******REMOVED*** 5. Hook Exports
...
***REMOVED******REMOVED*** 6. WebSocket Real-Time Updates
...
***REMOVED******REMOVED*** 7. Best Practices
...
***REMOVED******REMOVED*** 8. Migration Notes

***REMOVED******REMOVED******REMOVED*** From Legacy `queryKeys` Object
...
***REMOVED******REMOVED******REMOVED*** From Legacy Toast Methods
...
***REMOVED******REMOVED*** 9. Files Reference
