...
export default function AdminPeoplePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showShortcutsHint && (
        <div className="fixed bottom-4 right-4 z-50 bg-white border border-gray-200 rounded-lg shadow-xl p-4 max-w-xs">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between text-gray-500">
              ...
              <kbd className="px-2 py-0.5 bg-gray-100 rounded text-xs">{getShortcutDisplay({ key: 'k', modifiers: ['cmd'] })}</kbd>
            </div>
            <div className="flex justify-between text-gray-500">
              <span>Refresh</span>
            ...
            <div className="flex justify-between text-gray-500">
              <span>This help</span>
              <kbd className="px-2 py-0.5 bg-gray-100 rounded text-xs">Shift+?</kbd>
            </div>
          </div>
        </div>
      )}
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        <SectionErrorBoundary sectionName="People Management">
          {/* Filters */}
          <div className="flex flex-wrap items-center gap-4 mb-6">
            ...
            <div className="relative flex-1 min-w-[200px] max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-white"
              />
              {filters.search && (
                <button
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 bg-white border border-gray-200 rounded-lg text-gray-900 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-white"
              >
