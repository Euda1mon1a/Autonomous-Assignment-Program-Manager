  ...
  return (
    <div className="space-y-6">
      ...
      {exportType === 'schedules' && (
        <div className="space-y-6">
          <Card className="p-6 bg-slate-800/50 border-slate-700">
            <h3 className="text-lg font-semibold text-white mb-4">Block-Level Excel Export</h3>
            <p className="text-sm text-slate-400 mb-4">
              Download the canonical schedule workbook generated by the server for the selected date range.
          ...
          <Card className="p-6 bg-blue-900/20 border-blue-800/50">
            ...
            <div className="flex flex-wrap items-end gap-4">
              ...
              <a
                ...
                download
                className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors h-[42px]"
              >
                <FileSpreadsheet className="w-4 h-4" />
