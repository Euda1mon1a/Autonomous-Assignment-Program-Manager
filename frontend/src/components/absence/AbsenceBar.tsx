...
export const absenceTypeColors: Record<string, { bg: string; text: string; border: string }> = {
  ...
  maternityPaternity: { bg: 'bg-pink-200', text: 'text-pink-800', border: 'border-pink-400' },
  // Emergency (blocking - Hawaii reality)
  familyEmergency: { bg: 'bg-purple-200', text: 'text-purple-800', border: 'border-purple-400' },
  emergencyLeave: { bg: 'bg-purple-300', text: 'text-purple-900', border: 'border-purple-500' },
