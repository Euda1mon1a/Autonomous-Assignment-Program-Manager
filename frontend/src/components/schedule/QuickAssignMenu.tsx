...
function getActivityColor(activityType: string): string {
  const colors: Record<string, string> = {
    clinic: '***REMOVED***3B82F6', // blue
    inpatient: '***REMOVED***10B981', // green
    call: '***REMOVED***F59E0B', // amber
    leave: '***REMOVED***6B7280', // gray
    conference: '***REMOVED***8B5CF6', // purple
    procedure: '***REMOVED***EF4444', // red
    admin: '***REMOVED***64748B', // slate
  };
  return colors[activityType.toLowerCase()] || '***REMOVED***9CA3AF';
}
