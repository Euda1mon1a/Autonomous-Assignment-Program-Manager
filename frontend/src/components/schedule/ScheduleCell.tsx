...
export function ScheduleCell({
  ...
  const tailwindToHex: Record<string, string> = {
    ...
    'green-100': '***REMOVED***dcfce7',
    'green-500': '***REMOVED***22c55e',
    'green-800': '***REMOVED***166534',
    'blue-300': '***REMOVED***93c5fd',
    'sky-500': '***REMOVED***0ea5e9',
    'purple-700': '***REMOVED***7c3aed',
    'amber-100': '***REMOVED***fef3c7',
    'amber-800': '***REMOVED***92400e',
    'yellow-300': '***REMOVED***fde047',
    'emerald-200': '***REMOVED***a7f3d0',
  }
    ...
    if (assignment.fontColor && assignment.backgroundColor) {
      ...
      return {
        ...
        customStyle: {
          ...
          borderColor: bgHex === '***REMOVED***ffffff' ? '***REMOVED***e5e7eb' : bgHex === '***REMOVED***000000' ? '***REMOVED***374151' : bgHex,
        }
      }
    }
