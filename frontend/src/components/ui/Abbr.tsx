...
const GLOSSARY: Record<string, string> = {
  ...
  ACS: 'Acute Care Surgery rotation',
  ADV: 'Advising — faculty advising sessions',
  DFM: 'Department of Family Medicine',
  CONF: 'Conference — protected didactic session',
  OFF: 'Day Off — scheduled non-duty day',
  AT: 'Attending — faculty supervision activity',
  VASC: 'Vascular Surgery rotation',
  VAS: 'Vascular Access Surgery procedures',
  DERM: 'Dermatology rotation',
  CARDS: 'Cardiology rotation',
  PR: 'Procedures — credentialed procedural sessions',
  SIM: 'Simulation — clinical simulation training',
  W: 'Weekend — non-duty weekend day',
  PC: 'Post-Call — recovery day after overnight duty',
