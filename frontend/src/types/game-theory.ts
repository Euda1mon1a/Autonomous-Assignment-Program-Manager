...
export const STRATEGY_COLORS: Record<StrategyType, string> = {
  cooperative: '***REMOVED***22c55e',    // green
  aggressive: '***REMOVED***ef4444',     // red
  tit_for_tat: '***REMOVED***3b82f6',    // blue
  grudger: '***REMOVED***f97316',        // orange
  pavlov: '***REMOVED***8b5cf6',         // purple
  random: '***REMOVED***6b7280',         // gray
  suspicious_tft: '***REMOVED***eab308', // yellow
  forgiving_tft: '***REMOVED***06b6d4',  // cyan
  custom: '***REMOVED***ec4899',         // pink
};
...
export const STATUS_COLORS: Record<SimulationStatus, string> = {
  pending: '***REMOVED***6b7280',   // gray
  running: '***REMOVED***3b82f6',   // blue
  completed: '***REMOVED***22c55e', // green
  failed: '***REMOVED***ef4444',    // red
  cancelled: '***REMOVED***f97316', // orange
};
