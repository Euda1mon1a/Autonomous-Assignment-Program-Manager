  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .meta { color: ***REMOVED***666; margin-bottom: 20px; }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        th, td { border: 1px solid ***REMOVED***ddd; padding: 8px; text-align: left; }
        th { background-color: ***REMOVED***f5f5f5; }
        .severity-info { color: ***REMOVED***2563eb; }
        .severity-warning { color: ***REMOVED***d97706; }
        .severity-critical { color: ***REMOVED***dc2626; }
        .acgme-override { background-color: ***REMOVED***fff7ed; }
        @media print {
