***REMOVED*** File Ownership Matrix - Conflict Resolution Feature

***REMOVED******REMOVED*** Territory: `frontend/src/features/conflicts/`
...
***REMOVED******REMOVED*** Component Responsibilities

***REMOVED******REMOVED******REMOVED*** Core Types (`types.ts`)
...
***REMOVED******REMOVED******REMOVED*** Hooks (`hooks.ts`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ConflictCard
...
***REMOVED******REMOVED*** Related Territories
