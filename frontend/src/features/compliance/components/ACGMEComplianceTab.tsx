...
import { CheckCircle, XCircle, AlertTriangle, ChevronLeft, ChevronRight, RefreshCw, Shield } from 'lucide-react';
import { useValidateSchedule } from '@/hooks/useSchedule';
import type { Violation } from '@/types/api';

export function ACGMEComplianceTab() {
      ...
      <div className="card">
        <div className="border-b pb-4 mb-4">
          ...
          <p className="text-sm text-gray-500">
            Coverage Rate: {(validation?.coverageRate ?? 0).toFixed(1)}%
          </p>
        </div>
