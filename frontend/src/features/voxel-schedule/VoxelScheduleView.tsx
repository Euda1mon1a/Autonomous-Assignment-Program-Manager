...
function drawVoxel(
  ...
  ctx.fill();
  ctx.strokeStyle = isHovered ? "***REMOVED***fff" : "***REMOVED***333";
  ...
  if (isConflict) {
    ctx.globalAlpha = 1;
    ctx.strokeStyle = "***REMOVED***ff0000";
    ctx.lineWidth = 3;
    ctx.beginPath();
    ctx.moveTo(topBack.screenX, topBack.screenY);
    ctx.lineTo(topFront.screenX, topFront.screenY);
...
function adjustBrightness(hex: string, amount: number): string {
  // Remove ***REMOVED*** if present
  hex = hex.replace("***REMOVED***", "");
  ...
  // Convert back to hex
  return `***REMOVED***${r.toString(16).padStart(2, "0")}${g.toString(16).padStart(2, "0")}${b.toString(16).padStart(2, "0")}`;
}
      ...
      <div className="absolute top-4 right-4 z-10 bg-gray-800/80 p-4 rounded-lg text-white text-sm">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded" style={{ backgroundColor: "***REMOVED***3B82F6" }} />
            <span>Clinic</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded" style={{ backgroundColor: "***REMOVED***8B5CF6" }} />
            <span>Inpatient</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded" style={{ backgroundColor: "***REMOVED***EF4444" }} />
            <span>Procedures</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded" style={{ backgroundColor: "***REMOVED***F97316" }} />
            <span>Call</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded" style={{ backgroundColor: "***REMOVED***F59E0B" }} />
            <span>Leave</span>
          </div>
        </div>
      </div>
