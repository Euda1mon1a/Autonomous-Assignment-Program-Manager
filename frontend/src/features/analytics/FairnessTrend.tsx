      ...
      <div role="img" aria-label="Bar chart comparing shift distributions across PGY levels, showing average shifts, night shifts, weekend shifts, and holiday shifts">
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={pgyData}>
            <CartesianGrid strokeDasharray="3 3" stroke="***REMOVED***e5e7eb" />
            <XAxis
              dataKey="pgyLevel"
            ...
            <Bar dataKey="averageShifts" name="Avg Shifts" fill="***REMOVED***3b82f6" />
            <Bar dataKey="nightShifts" name="Night Shifts" fill="***REMOVED***8b5cf6" />
            <Bar dataKey="weekendShifts" name="Weekend Shifts" fill="***REMOVED***ec4899" />
            <Bar dataKey="holidayShifts" name="Holiday Shifts" fill="***REMOVED***f59e0b" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
