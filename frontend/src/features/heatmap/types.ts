...
export const ACTIVITY_TYPE_COLORS: Record<string, string> = {
  residency: '***REMOVED***3b82f6', // blue
  fmit: '***REMOVED***10b981', // green
  both: '***REMOVED***8b5cf6', // purple
  clinical: '***REMOVED***f59e0b', // amber
...
export const COVERAGE_INDICATOR_COLORS = {
  full: '***REMOVED***22c55e', // green
  partial: '***REMOVED***fbbf24', // yellow
  gap: '***REMOVED***ef4444', // red
  overcovered: '***REMOVED***06b6d4', // cyan
};
