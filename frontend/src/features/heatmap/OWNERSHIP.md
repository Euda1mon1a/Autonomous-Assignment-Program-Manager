***REMOVED*** File Ownership Matrix: frontend/src/features/heatmap/

***REMOVED******REMOVED*** Territory: Heatmap Visualization
...
***REMOVED******REMOVED******REMOVED*** API Request Parameters
...
***REMOVED******REMOVED******REMOVED*** Color Scale Design Philosophy
...
Color values used:
- Black (critical): `***REMOVED***1e1b4b`
- Red (high/gap): `***REMOVED***ef4444`
- Yellow (warning/partial): `***REMOVED***fbbf24`
- Green (good/full): `***REMOVED***22c55e`
- Blue (light): `***REMOVED***3b82f6`

***REMOVED******REMOVED******REMOVED*** API Response Format
...
```typescript
{
  "heatmap": {
    ...
    "color_scale": {
      "min": 0,
      "max": 100,
      "colors": ["***REMOVED***1e1b4b", "***REMOVED***ef4444", "***REMOVED***fbbf24", "***REMOVED***22c55e"],  // black→red→yellow→green for coverage
...
***REMOVED******REMOVED******REMOVED*** Required Package Additions
...
***REMOVED******REMOVED******REMOVED*** Basic Coverage Heatmap
...
***REMOVED******REMOVED******REMOVED*** Workload Heatmap with Filters
