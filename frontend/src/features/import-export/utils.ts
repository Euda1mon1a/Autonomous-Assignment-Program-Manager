...
const COLUMN_ALIASES: Record<string, string[]> = {
  name: ['name', 'full_name', 'fullname', 'person_name', 'personname'],
  email: ['email', 'email_address', 'emailaddress', 'mail'],
  type: ['type', 'person_type', 'persontype', 'role_type'],
  pgy_level: ['pgy_level', 'pgylevel', 'pgy', 'year', 'training_year'],
  performs_procedures: ['performs_procedures', 'performsprocedures', 'procedures', 'can_do_procedures'],
  specialties: ['specialties', 'specialty', 'specialization'],
  primary_duty: ['primary_duty', 'primaryduty', 'duty', 'main_duty'],
  date: ['date', 'assignment_date', 'block_date', 'schedule_date'],
  time_of_day: ['time_of_day', 'timeofday', 'time', 'period', 'am_pm', 'ampm'],
  person_name: ['person_name', 'personname', 'resident_name', 'faculty_name', 'name'],
  person_id: ['person_id', 'personid', 'resident_id', 'faculty_id'],
  rotation_name: ['rotation_name', 'rotationname', 'rotation', 'activity'],
  rotation_template_id: ['rotation_template_id', 'rotationtemplateid', 'template_id'],
  role: ['role', 'assignment_role', 'position'],
  activity_override: ['activity_override', 'activityoverride', 'override', 'custom_activity'],
  notes: ['notes', 'note', 'comments', 'comment', 'description'],
  start_date: ['start_date', 'startdate', 'from_date', 'from', 'begin_date'],
  end_date: ['end_date', 'enddate', 'to_date', 'to', 'finish_date'],
  absence_type: ['absence_type', 'absencetype', 'leave_type', 'type'],
  deployment_orders: ['deployment_orders', 'deploymentorders', 'orders', 'military_orders'],
  tdy_location: ['tdy_location', 'tdylocation', 'location', 'duty_location'],
  replacement_activity: ['replacement_activity', 'replacementactivity', 'replacement', 'alternate'],
};
