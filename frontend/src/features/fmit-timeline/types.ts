...
export const WORKLOAD_STATUS_COLORS: Record<WorkloadStatus, string> = {
  'on-track': '***REMOVED***22c55e', // green
  'overloaded': '***REMOVED***ef4444', // red
  'underutilized': '***REMOVED***fbbf24', // yellow
};
...
export const ASSIGNMENT_STATUS_COLORS: Record<AssignmentStatus, string> = {
  'scheduled': '***REMOVED***3b82f6', // blue
  'in-progress': '***REMOVED***10b981', // green
  'completed': '***REMOVED***6b7280', // gray
  'cancelled': '***REMOVED***ef4444', // red
};
...
export const ACTIVITY_TYPE_COLORS: Record<string, string> = {
  'Clinical': '***REMOVED***3b82f6', // blue
  'Research': '***REMOVED***06b6d4', // cyan
  'Education': '***REMOVED***ec4899', // pink
  'Administrative': '***REMOVED***8b5cf6', // purple
  'FMIT': '***REMOVED***10b981', // green
  'Residency': '***REMOVED***f59e0b', // amber
  'default': '***REMOVED***6b7280', // gray
};
