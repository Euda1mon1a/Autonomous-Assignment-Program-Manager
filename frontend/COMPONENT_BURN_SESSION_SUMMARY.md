***REMOVED*** Frontend Component Burn Session - Summary
...
***REMOVED******REMOVED*** Components by Category

***REMOVED******REMOVED******REMOVED*** 1. Schedule Components (Tasks 1-20)
...
***REMOVED******REMOVED******REMOVED*** 2. ACGME Compliance Components (Tasks 21-40)
...
***REMOVED******REMOVED******REMOVED*** 3. Swap Components (Tasks 41-60)
...
***REMOVED******REMOVED******REMOVED*** 4. Resilience Dashboard Components (Tasks 61-80)
...
***REMOVED******REMOVED******REMOVED*** 5. Shared/UI Components (Tasks 81-100)
...
***REMOVED******REMOVED*** Military Medical Context Features

***REMOVED******REMOVED******REMOVED*** No Moonlighting
...
***REMOVED******REMOVED******REMOVED*** TDY/Deployment Support
...
***REMOVED******REMOVED*** Component Organization

```
frontend/src/components/
├── schedule/           ***REMOVED*** Schedule management components
│   ├── BlockCard.tsx
│   ├── RotationBadge.tsx
│   ├── TimelineView.tsx
│   ├── ShiftIndicator.tsx
...
│   └── __tests__/
│
├── compliance/         ***REMOVED*** ACGME compliance components
│   ├── CompliancePanel.tsx
│   ├── WorkHourGauge.tsx
│   ├── DayOffIndicator.tsx
...
│   └── index.ts
│
├── swap/              ***REMOVED*** Swap management components
│   ├── SwapRequestForm.tsx
│   ├── SwapCard.tsx
│   ├── SwapMatchList.tsx
...
│   └── index.ts
│
├── resilience/        ***REMOVED*** Resilience dashboard components
...
│   └── index.ts
│
└── ui/                ***REMOVED*** Shared UI components
    ├── DataTable.tsx
    ├── DatePicker.tsx
    ├── Skeleton.tsx
    ├── Select.tsx
...
***REMOVED******REMOVED******REMOVED*** BlockCard Component
```tsx
<BlockCard
  blockId="block-123"
  personName="Dr. Smith"
...
***REMOVED******REMOVED******REMOVED*** CompliancePanel Component
```tsx
<CompliancePanel
  data={{
    personId: "123",
...
***REMOVED******REMOVED******REMOVED*** ResilienceDashboard Component
```tsx
<ResilienceDashboard
  metrics={{
    defenseLevel: "YELLOW",
...
***REMOVED******REMOVED******REMOVED*** DataTable Component
```tsx
<DataTable
  data={residents}
  columns={[
...
***REMOVED******REMOVED*** Accessibility Compliance

***REMOVED******REMOVED******REMOVED*** WCAG 2.1 AA Standards
