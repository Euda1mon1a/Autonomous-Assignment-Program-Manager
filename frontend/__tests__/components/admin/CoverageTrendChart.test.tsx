...
describe('CoverageTrendChart', () => {
  ...
  describe('Gradient Fill', () => {
    it('should render gradient fill under line', () => {
      ...
      const gradient = container.querySelector('***REMOVED***coverageGradient');
    ...
    it('should apply gradient to area path', () => {
      ...
      const gradientPath = Array.from(paths).find((path) =>
        path.getAttribute('fill')?.includes('url(***REMOVED***coverageGradient)')
      );
  ...
  describe('Grid Lines', () => {
    it('should render grid pattern', () => {
      ...
      const gridPattern = container.querySelector('***REMOVED***grid');
