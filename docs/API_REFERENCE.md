...
2. [People API](***REMOVED***people-api)
3. [Blocks API](***REMOVED***blocks-api)
4. [Rotation Templates API](***REMOVED***rotation-templates-api)
5. [Assignments API](***REMOVED***assignments-api)
6. [Absences API](***REMOVED***absences-api)
7. [Schedule API](***REMOVED***schedule-api)
8. [Common Response Formats](***REMOVED***common-response-formats)
...
***REMOVED******REMOVED******REMOVED*** Common Headers
...
***REMOVED******REMOVED*** Assignments API
...
***REMOVED******REMOVED******REMOVED*** Bulk Delete Assignments
...
***REMOVED******REMOVED*** Common Response Formats
...
***REMOVED******REMOVED******REMOVED*** Date Formats

- All dates use ISO 8601 format: `YYYY-MM-DD`
- All timestamps use ISO 8601 with timezone: `YYYY-MM-DDTHH:MM:SSZ`

***REMOVED******REMOVED******REMOVED*** UUID Format
