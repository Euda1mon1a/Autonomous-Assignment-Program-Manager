...
2. [Choosing Your Claude Interface](***REMOVED***choosing-your-claude-interface)
3. [The Three Pillars](***REMOVED***the-three-pillars)
4. [Quick Start](***REMOVED***quick-start)
5. [Skills Reference](***REMOVED***skills-reference)
6. [Claude Code Platforms](***REMOVED***claude-code-platforms)
7. [Model Selection](***REMOVED***model-selection)
8. [Evaluation & Testing](***REMOVED***evaluation--testing)
...
***REMOVED******REMOVED*** Choosing Your Claude Interface

Before diving in, understand the difference between Claude's interfaces:

***REMOVED******REMOVED******REMOVED*** Claude Code: Web, CLI, and IDE
...
***REMOVED******REMOVED******REMOVED*** Claude Code Web (Primary Development Interface)
...
***REMOVED******REMOVED******REMOVED*** Claude for macOS/Desktop (Chat App) vs Claude Code
...
- macOS automation with OSAScript (see [IDE Setup for macOS](***REMOVED***ide-setup-for-macos))
...
***REMOVED******REMOVED******REMOVED*** Decision Flowchart
...
***REMOVED******REMOVED******REMOVED*** IDE Integration Options
...
***REMOVED******REMOVED******REMOVED*** ChatGPT Codex vs Claude Code (Common Confusion)
...
***REMOVED******REMOVED******REMOVED*** Browser Extensions & Agentic Browsers
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Quick Comparison (Updated December 2025)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Claude for Chrome (Browser Agent)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Agentic Browsers (Comet, Atlas, Dia)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Comet (Perplexity)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Atlas (OpenAI)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Dia (Browser Company → Atlassian)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Gemini in Chrome
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Choosing the Right Agentic Tool
...
***REMOVED******REMOVED******REMOVED******REMOVED*** When You DON'T Want Agency
...
***REMOVED******REMOVED******REMOVED******REMOVED*** The "Same Model, Different Capabilities" Confusion
...
***REMOVED******REMOVED******REMOVED******REMOVED*** When to Combine Tools
...
***REMOVED******REMOVED*** The Three Pillars

***REMOVED******REMOVED******REMOVED*** 1. Skills (Domain Knowledge)
...
***REMOVED******REMOVED******REMOVED*** 2. MCP Tools (Actions)
...
***REMOVED******REMOVED******REMOVED*** 3. ADK Agents (Testing)
...
> See [Choosing Your Claude Interface](***REMOVED***choosing-your-claude-interface) for guidance.

***REMOVED******REMOVED******REMOVED*** Option A: Claude Code Web (Recommended - No Installation)
...
***REMOVED******REMOVED******REMOVED*** Option B: Claude Code CLI (Local Development)

```bash
***REMOVED*** Install Claude Code
...
***REMOVED*** Claude automatically loads skills from .claude/skills/
```

***REMOVED******REMOVED******REMOVED*** Option C: Google Antigravity

```bash
***REMOVED*** Download from https://antigravityai.org/
***REMOVED*** Install and open

***REMOVED*** Open this repository folder
***REMOVED*** Antigravity detects Skills and MCP automatically
```
...
***REMOVED******REMOVED******REMOVED*** Option C: ADK Web Interface

```bash
***REMOVED*** Navigate to ADK module
cd agent-adk

***REMOVED*** Install dependencies
npm install

***REMOVED*** Set up API key
cp .env.example .env
***REMOVED*** Edit .env with GOOGLE_GENAI_API_KEY

***REMOVED*** Start web UI
npm run dev

***REMOVED*** Open http://localhost:8000
```

---

***REMOVED******REMOVED*** Skills Reference

***REMOVED******REMOVED******REMOVED*** Using Skills
...
***REMOVED******REMOVED******REMOVED*** Skill Files
...
.claude/skills/
└── skill-name/
    ├── SKILL.md        ***REMOVED*** Core instructions (required)
    ├── reference.md    ***REMOVED*** Detailed procedures (optional)
    └── examples.md     ***REMOVED*** Example scenarios (optional)
```

***REMOVED******REMOVED******REMOVED*** Creating Custom Skills
...
***REMOVED******REMOVED*** Claude Code Platforms

***REMOVED******REMOVED******REMOVED*** Claude Code Web
...
***REMOVED******REMOVED******REMOVED*** Claude Code CLI
...
***REMOVED******REMOVED******REMOVED*** IDE Setup for macOS
...
1. **VS Code with Claude Extension:**
   ```bash
   ***REMOVED*** Install Claude extension from VS Code marketplace
...
***REMOVED******REMOVED******REMOVED*** Google Antigravity (Recommended for Beginners)
...
See [Model Selection](***REMOVED***model-selection) for detailed guidance on which model to use.
...
***REMOVED******REMOVED******REMOVED*** Understanding Your Options (Beginner's Guide)
...
***REMOVED******REMOVED******REMOVED*** Available Models in Antigravity
...
***REMOVED******REMOVED******REMOVED*** Which Model Should I Use?
...
***REMOVED******REMOVED******REMOVED*** Model Details

***REMOVED******REMOVED******REMOVED******REMOVED*** "Thinking" Models - Best for Learning
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Speed vs Quality Trade-offs
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Open Source Option
...
***REMOVED******REMOVED******REMOVED*** Recommended Setup for This Project
...
***REMOVED******REMOVED******REMOVED*** Claude Code Model Selection

If using Claude Code CLI instead of Antigravity:

```bash
***REMOVED*** Daily development (balanced)
claude --model sonnet

***REMOVED*** Complex reasoning (slower but smarter)
claude --model opus

***REMOVED*** Set default in config
echo "model: sonnet" >> ~/.claude/config
```

---

***REMOVED******REMOVED*** Evaluation & Testing

***REMOVED******REMOVED******REMOVED*** Running ADK Evaluations

```bash
cd agent-adk

***REMOVED*** Run all evaluation tests
npm run test:eval
...
***REMOVED******REMOVED******REMOVED*** What Gets Tested
...
***REMOVED******REMOVED******REMOVED*** Adding Test Cases
...
***REMOVED******REMOVED******REMOVED*** Skills Not Loading
...
***REMOVED******REMOVED******REMOVED*** MCP Tools Not Available
...
***REMOVED******REMOVED******REMOVED*** ADK Won't Start
...
1. Check Node version:
   ```bash
   node --version  ***REMOVED*** Need >= 20.12.0
   ```
...
***REMOVED******REMOVED******REMOVED*** Wrong Tool Called
...
***REMOVED******REMOVED******REMOVED*** Setting Up
...
***REMOVED******REMOVED*** Summary Cheat Sheet
