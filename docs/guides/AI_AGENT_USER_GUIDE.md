...
2. [The Three Pillars](***REMOVED***the-three-pillars)
3. [Quick Start](***REMOVED***quick-start)
4. [Skills Reference](***REMOVED***skills-reference)
5. [CLI Platforms](***REMOVED***cli-platforms)
6. [Model Selection](***REMOVED***model-selection)
7. [Evaluation & Testing](***REMOVED***evaluation--testing)
...
***REMOVED******REMOVED******REMOVED*** Option A: Claude Code (Recommended for macOS)
...
***REMOVED******REMOVED******REMOVED*** Google Antigravity
...
***REMOVED******REMOVED******REMOVED*** When to Use Each Model
...
***REMOVED******REMOVED******REMOVED*** Recommended Configurations
