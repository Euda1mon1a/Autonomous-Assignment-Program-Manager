***REMOVED*** 3D Schedule Visualization Guide
...
***REMOVED******REMOVED*** Component Props
...
***REMOVED******REMOVED*** Interactive Controls
...
***REMOVED******REMOVED******REMOVED*** Filter by Person
...
***REMOVED******REMOVED******REMOVED*** Filter by Activity Type
...
***REMOVED******REMOVED******REMOVED*** Handle Voxel Clicks
...
***REMOVED******REMOVED******REMOVED*** Show Only Conflicts
...
***REMOVED******REMOVED******REMOVED*** Display Hover Tooltips
...
***REMOVED******REMOVED*** Understanding the 3D Space

***REMOVED******REMOVED******REMOVED*** Axes
...
***REMOVED******REMOVED******REMOVED*** What Each Voxel Represents
...
***REMOVED******REMOVED******REMOVED*** Voxel Interface
...
***REMOVED******REMOVED******REMOVED*** With Date Range Picker
...
***REMOVED******REMOVED******REMOVED*** With Person Filter
...
***REMOVED******REMOVED******REMOVED*** Visualization is empty

1. Check date range contains data
2. Verify API endpoint is accessible
3. Check browser console for errors

***REMOVED******REMOVED******REMOVED*** Voxels not rendering
...
***REMOVED******REMOVED******REMOVED*** Performance is slow
