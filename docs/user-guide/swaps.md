***REMOVED*** Swap Marketplace

The swap system allows residents to trade assignments.

---

***REMOVED******REMOVED*** Requesting a Swap
...
***REMOVED******REMOVED*** Responding to Swap Requests
...
***REMOVED******REMOVED******REMOVED*** Why Residents Are Restricted
