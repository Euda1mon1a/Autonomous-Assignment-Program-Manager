***REMOVED*** Frequently Asked Questions (FAQ)
...
1. [General Questions](***REMOVED***general-questions)
2. [Access and Permissions](***REMOVED***access-and-permissions)
3. [Scheduling Questions](***REMOVED***scheduling-questions)
4. [People Management](***REMOVED***people-management)
5. [Absences and Time Off](***REMOVED***absences-and-time-off)
6. [Compliance Questions](***REMOVED***compliance-questions)
7. [Export and Printing](***REMOVED***export-and-printing)
8. [Technical Questions](***REMOVED***technical-questions)
9. [Military-Specific Questions](***REMOVED***military-specific-questions)

---

***REMOVED******REMOVED*** General Questions

***REMOVED******REMOVED******REMOVED*** What is the Residency Scheduler?
...
***REMOVED******REMOVED******REMOVED*** Who should use this system?
...
***REMOVED******REMOVED******REMOVED*** Is my data secure?
...
***REMOVED******REMOVED******REMOVED*** Can I use this on my phone?
...
***REMOVED******REMOVED*** Access and Permissions

***REMOVED******REMOVED******REMOVED*** How do I get an account?

Contact your program administrator. They will create your account and assign the appropriate role.

***REMOVED******REMOVED******REMOVED*** Why can't I see the Settings page?
...
***REMOVED******REMOVED*** Scheduling Questions

***REMOVED******REMOVED******REMOVED*** Which scheduling algorithm should I use?
...
***REMOVED******REMOVED******REMOVED*** How far in advance can I generate schedules?
...
***REMOVED******REMOVED******REMOVED*** Why is my schedule showing compliance violations?
...
***REMOVED******REMOVED******REMOVED*** Can I manually adjust the schedule after generation?
...
***REMOVED******REMOVED******REMOVED*** What happens to existing schedules when I regenerate?

Regenerating for a date range will replace existing assignments for those dates. Previous data is overwritten.

***REMOVED******REMOVED******REMOVED*** Why did schedule generation fail?
...
***REMOVED******REMOVED******REMOVED*** How do I add a new resident?
...
***REMOVED******REMOVED******REMOVED*** How do I update PGY levels at the start of the year?
...
***REMOVED******REMOVED******REMOVED*** What happens if I delete a person who has scheduled assignments?
...
***REMOVED******REMOVED******REMOVED*** How do I add a faculty member?
...
***REMOVED******REMOVED*** Absences and Time Off

***REMOVED******REMOVED******REMOVED*** What types of absences can I record?
...
***REMOVED******REMOVED******REMOVED*** What's the difference between Deployment and TDY?
...
***REMOVED******REMOVED******REMOVED*** How do absences affect scheduling?
...
***REMOVED******REMOVED******REMOVED*** Can I add a last-minute absence?
...
***REMOVED******REMOVED*** Compliance Questions

***REMOVED******REMOVED******REMOVED*** What is ACGME?
...
***REMOVED******REMOVED******REMOVED*** What are the ACGME rules being monitored?
...
***REMOVED******REMOVED******REMOVED*** How is the 80-hour average calculated?
...
***REMOVED******REMOVED******REMOVED*** What if my program has an exception to ACGME rules?
...
***REMOVED******REMOVED******REMOVED*** How often should I check compliance?
...
***REMOVED******REMOVED*** Export and Printing

***REMOVED******REMOVED******REMOVED*** How do I export the schedule to Excel?

1. Go to Dashboard
2. Click **Export Excel** in Quick Actions
3. File will download automatically

***REMOVED******REMOVED******REMOVED*** Can I print the schedule?
...
***REMOVED******REMOVED******REMOVED*** How do I export the people list?

1. Go to **People**
2. Click **Export** dropdown
3. Choose **CSV** or **JSON**

***REMOVED******REMOVED******REMOVED*** What's the difference between CSV and JSON exports?
...
***REMOVED******REMOVED*** Technical Questions

***REMOVED******REMOVED******REMOVED*** What browsers are supported?
...
***REMOVED******REMOVED******REMOVED*** Why is the page loading slowly?
...
***REMOVED******REMOVED******REMOVED*** My changes aren't saving. What should I do?
...
***REMOVED******REMOVED******REMOVED*** I'm getting an error. What should I do?
...
***REMOVED******REMOVED*** Military-Specific Questions

***REMOVED******REMOVED******REMOVED*** How do I handle deployment orders?
...
***REMOVED******REMOVED******REMOVED*** How is TDY different from regular absence?
...
***REMOVED******REMOVED******REMOVED*** How do I plan around a resident's deployment?
...
***REMOVED******REMOVED******REMOVED*** What if deployment dates change?
...
***REMOVED******REMOVED*** More Questions?
...
***REMOVED******REMOVED******REMOVED*** Still Need Help?
