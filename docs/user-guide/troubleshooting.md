...
1. [Login and Access Issues](***REMOVED***login-and-access-issues)
2. [Navigation Problems](***REMOVED***navigation-problems)
3. [People Management Issues](***REMOVED***people-management-issues)
4. [Template Issues](***REMOVED***template-issues)
5. [Absence Management Issues](***REMOVED***absence-management-issues)
6. [Schedule Generation Problems](***REMOVED***schedule-generation-problems)
7. [Compliance Issues](***REMOVED***compliance-issues)
8. [Export Problems](***REMOVED***export-problems)
9. [Performance Issues](***REMOVED***performance-issues)
10. [Browser-Specific Issues](***REMOVED***browser-specific-issues)

---

***REMOVED******REMOVED*** Login and Access Issues

***REMOVED******REMOVED******REMOVED*** Cannot Log In
...
***REMOVED******REMOVED******REMOVED*** "Access Denied" After Login
...
***REMOVED******REMOVED******REMOVED*** Session Timeout
...
***REMOVED******REMOVED*** Navigation Problems

***REMOVED******REMOVED******REMOVED*** Menu Items Missing
...
***REMOVED******REMOVED******REMOVED*** Page Not Loading
...
***REMOVED******REMOVED******REMOVED*** Buttons Not Responding
...
***REMOVED******REMOVED*** People Management Issues

***REMOVED******REMOVED******REMOVED*** Cannot Add Person
...
***REMOVED******REMOVED******REMOVED*** Cannot Edit Person
...
***REMOVED******REMOVED******REMOVED*** Cannot Delete Person
...
***REMOVED******REMOVED******REMOVED*** Person Not Showing in Dropdowns
...
***REMOVED******REMOVED*** Template Issues

***REMOVED******REMOVED******REMOVED*** Cannot Create Template
...
***REMOVED******REMOVED******REMOVED*** Template Not Used in Schedule
...
***REMOVED******REMOVED*** Absence Management Issues

***REMOVED******REMOVED******REMOVED*** Cannot Add Absence
...
***REMOVED******REMOVED******REMOVED*** Absence Not Showing on Calendar
...
***REMOVED******REMOVED******REMOVED*** Calendar View Not Working
...
***REMOVED******REMOVED*** Schedule Generation Problems

***REMOVED******REMOVED******REMOVED*** Generation Fails Immediately
...
***REMOVED******REMOVED******REMOVED*** Poor Coverage After Generation
...
***REMOVED******REMOVED******REMOVED*** Many Violations After Generation
...
4. See [Compliance Issues](***REMOVED***compliance-issues) section

---

***REMOVED******REMOVED*** Compliance Issues

***REMOVED******REMOVED******REMOVED*** 80-Hour Violation Won't Clear
...
***REMOVED******REMOVED******REMOVED*** 1-in-7 Violation Won't Clear
...
***REMOVED******REMOVED******REMOVED*** Supervision Violation Persists
...
***REMOVED******REMOVED******REMOVED*** Compliance Page Shows Stale Data
...
***REMOVED******REMOVED*** Export Problems

***REMOVED******REMOVED******REMOVED*** Excel Export Not Downloading
...
***REMOVED******REMOVED******REMOVED*** Excel File Won't Open
...
***REMOVED******REMOVED******REMOVED*** CSV Has Encoding Issues
...
***REMOVED******REMOVED******REMOVED*** Colors Not Showing in Export
...
***REMOVED******REMOVED******REMOVED*** Application is Slow
...
***REMOVED******REMOVED******REMOVED*** Browser Crashes or Freezes
...
***REMOVED******REMOVED******REMOVED*** Data Not Saving
...
***REMOVED******REMOVED*** Browser-Specific Issues

***REMOVED******REMOVED******REMOVED*** Chrome Issues
...
***REMOVED******REMOVED******REMOVED*** Firefox Issues
...
***REMOVED******REMOVED******REMOVED*** Safari Issues
...
***REMOVED******REMOVED******REMOVED*** Edge Issues
...
***REMOVED******REMOVED******REMOVED*** Recommended Browser Settings

For best experience:
- JavaScript: Enabled
- PGY2-01ies: Enabled for this site
...
***REMOVED******REMOVED******REMOVED*** When to Contact Support
...
***REMOVED******REMOVED******REMOVED*** Information to Provide
...
***REMOVED******REMOVED*** Error Message Reference
