...
***REMOVED******REMOVED******REMOVED*** Who Should Read This Guide?
...
***REMOVED******REMOVED*** Guide Sections

<div class="feature-grid" markdown>

<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-view-dashboard: [Dashboard](dashboard.md)
Overview of the main dashboard and navigation.
</div>

<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-calendar: [Schedule Management](schedule.md)
Viewing, generating, and editing schedules.
</div>

<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-account-group: [People Management](people.md)
Managing residents, faculty, and certifications.
</div>

<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-calendar-remove: [Absences](absences.md)
...
<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-shield-check: [Compliance](compliance.md)
ACGME compliance monitoring and violations.
</div>

<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-upload: [Importing Data](imports.md)
Import absences and schedules from Excel files.
</div>

<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-download: [Exporting Data](exports.md)
...
<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-monitor-dashboard: [GUI Improvements](gui-improvements.md)
...
***REMOVED******REMOVED******REMOVED*** Violation Severity Levels

| Level | Color | Response Required |
|-------|-------|------------------|
| **Critical** | :material-circle:{ style="color: ***REMOVED***E57373" } Red | Immediate action |
| **High** | :material-circle:{ style="color: ***REMOVED***FF8A65" } Orange | Same-day resolution |
| **Medium** | :material-circle:{ style="color: ***REMOVED***FFD54F" } Yellow | Weekly review |
| **Low** | :material-circle:{ style="color: ***REMOVED***4FC3F7" } Blue | Informational |
