...
Manage residents, faculty, and their credentials.
...
***REMOVED******REMOVED*** Person Profiles
...
***REMOVED******REMOVED*** Managing Certifications
...
!!! warning "Certification Alerts"
    The system automatically alerts 30 days before certifications expire.

---

***REMOVED******REMOVED*** Procedure Credentials

Track faculty qualifications:

| Competency Level | Description |
|------------------|-------------|
| **Trainee** | Learning the procedure |
| **Qualified** | Can perform independently |
| **Expert** | Advanced proficiency |
| **Master** | Can train others |
