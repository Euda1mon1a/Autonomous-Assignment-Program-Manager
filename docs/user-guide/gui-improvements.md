...
***REMOVED******REMOVED*** Scheduled Hours Calculator
...
***REMOVED******REMOVED******REMOVED*** What It Shows
...
***REMOVED******REMOVED******REMOVED*** How Hours Are Calculated
...
***REMOVED******REMOVED******REMOVED*** Where to Find It
...
***REMOVED******REMOVED*** Schedule Legend
...
***REMOVED******REMOVED******REMOVED*** Display Modes
...
***REMOVED******REMOVED*** Quick Swap Button

One-click swap request directly from schedule cells.

***REMOVED******REMOVED******REMOVED*** How to Use
...
***REMOVED******REMOVED*** Upcoming Assignments Preview
...
***REMOVED******REMOVED*** Coverage Impact Analysis

Enhanced absence display with coverage impact.

***REMOVED******REMOVED******REMOVED*** Impact Levels
...
***REMOVED******REMOVED******REMOVED*** Alert Banner
...
***REMOVED******REMOVED*** Configuration Presets (Admin)

Save and load scheduling configurations for the Admin Scheduling Lab.

***REMOVED******REMOVED******REMOVED*** Built-in Presets
...
***REMOVED******REMOVED******REMOVED*** Custom Presets
...
***REMOVED******REMOVED******REMOVED*** Finding Shortcuts

Press `?` anywhere to open the keyboard shortcut reference.

---

***REMOVED******REMOVED*** Progress Indicators

Visual feedback for long-running operations.

***REMOVED******REMOVED******REMOVED*** Variants
...
***REMOVED******REMOVED******REMOVED*** Used In
