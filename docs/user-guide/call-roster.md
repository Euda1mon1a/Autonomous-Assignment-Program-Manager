...
***REMOVED******REMOVED*** Reading the Calendar
...
***REMOVED******REMOVED******REMOVED*** Day Details
...
***REMOVED******REMOVED******REMOVED*** Contact Display
...
***REMOVED******REMOVED*** Today's On-Call
...
***REMOVED******REMOVED*** Filters

***REMOVED******REMOVED******REMOVED*** Role Filter
...
***REMOVED******REMOVED******REMOVED*** Date Filter
...
***REMOVED******REMOVED******REMOVED*** Person Links
...
***REMOVED******REMOVED*** For Nurses and Staff

***REMOVED******REMOVED******REMOVED*** Finding Who to Page

1. Open Call Roster
2. Check "Today's On-Call" section
3. Use contact information to reach on-call provider

***REMOVED******REMOVED******REMOVED*** After Hours
...
***REMOVED******REMOVED*** How Call is Assigned

***REMOVED******REMOVED******REMOVED*** Automated Overnight Call (Sun-Thu)
...
***REMOVED******REMOVED******REMOVED*** FMIT Weekend Coverage (Fri-Sat)
