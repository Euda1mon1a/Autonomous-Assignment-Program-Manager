...
***REMOVED******REMOVED*** Accessing People Management
...
***REMOVED******REMOVED*** People Page Overview
...
***REMOVED******REMOVED*** Viewing People

***REMOVED******REMOVED******REMOVED*** Person Cards
...
***REMOVED******REMOVED******REMOVED*** Filtering Options

***REMOVED******REMOVED******REMOVED******REMOVED*** By Type
...
***REMOVED******REMOVED******REMOVED******REMOVED*** By PGY Level (Residents only)
...
***REMOVED******REMOVED*** Adding a Person

***REMOVED******REMOVED******REMOVED*** Opening the Add Dialog

1. Click **+ Add Person** button (top right)
2. The Add Person modal will appear

***REMOVED******REMOVED******REMOVED*** Add Person Form
...
***REMOVED******REMOVED******REMOVED*** Adding a Resident
...
***REMOVED******REMOVED******REMOVED*** Adding a Faculty Member
...
***REMOVED******REMOVED*** Editing a Person

***REMOVED******REMOVED******REMOVED*** Opening the Edit Dialog

1. Find the person's card
2. Click **Edit** button

***REMOVED******REMOVED******REMOVED*** Edit Person Form

The edit form is identical to the add form, pre-populated with current data.

***REMOVED******REMOVED******REMOVED*** Common Edits

***REMOVED******REMOVED******REMOVED******REMOVED*** Updating PGY Level (Annual Promotion)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Updating Contact Information

1. Click **Edit** on the person's card
2. Update the email address
3. Click **Save Changes**

***REMOVED******REMOVED******REMOVED******REMOVED*** Adding Specialties
...
***REMOVED******REMOVED*** Deleting a Person

***REMOVED******REMOVED******REMOVED*** Important Warning
...
***REMOVED******REMOVED*** Person Types Explained
...
***REMOVED******REMOVED******REMOVED*** Exporting People Data
...
***REMOVED******REMOVED******REMOVED*** Importing People
...
***REMOVED******REMOVED******REMOVED*** Email Addresses

- Use institutional email addresses
- Ensure accuracy for notifications

***REMOVED******REMOVED******REMOVED*** Specialty Management

- Use consistent terminology
- Separate multiple specialties with commas
- Example: "Internal Medicine, Cardiology"

***REMOVED******REMOVED******REMOVED*** PGY Level Maintenance
...
***REMOVED******REMOVED******REMOVED*** New Academic Year Setup
...
***REMOVED******REMOVED******REMOVED*** Mid-Year Changes
