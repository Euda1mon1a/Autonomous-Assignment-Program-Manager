...
***REMOVED******REMOVED*** Export Formats Overview
...
***REMOVED******REMOVED*** Excel Export (Schedule)

The primary export format for schedule distribution.

***REMOVED******REMOVED******REMOVED*** Accessing Excel Export

1. Go to **Dashboard**
2. Click **Export Excel** in Quick Actions

***REMOVED******REMOVED******REMOVED*** What's Included
...
***REMOVED******REMOVED******REMOVED*** Excel Features
...
***REMOVED******REMOVED******REMOVED*** Color Legend in Export
...
***REMOVED******REMOVED******REMOVED*** Export Date Range

The Excel export includes the current 4-week block by default.

---

***REMOVED******REMOVED*** CSV Export

Comma-separated values format for spreadsheet analysis.

***REMOVED******REMOVED******REMOVED*** Accessing CSV Export

***REMOVED******REMOVED******REMOVED******REMOVED*** From People Page
1. Go to **People**
2. Click **Export** dropdown
3. Select **Export as CSV**

***REMOVED******REMOVED******REMOVED******REMOVED*** From Absences Page
1. Go to **Absences**
2. Switch to **List View**
3. Click **Export** dropdown
4. Select **Export as CSV**

***REMOVED******REMOVED******REMOVED*** People CSV Format
...
***REMOVED******REMOVED******REMOVED*** Absences CSV Format
...
***REMOVED******REMOVED******REMOVED*** CSV Use Cases
...
***REMOVED******REMOVED*** JSON Export

JavaScript Object Notation format for programmatic access.

***REMOVED******REMOVED******REMOVED*** Accessing JSON Export
...
***REMOVED******REMOVED******REMOVED*** People JSON Format
...
***REMOVED******REMOVED******REMOVED*** Absences JSON Format
...
***REMOVED******REMOVED******REMOVED*** JSON Use Cases
...
***REMOVED******REMOVED*** Export Step-by-Step Guides

***REMOVED******REMOVED******REMOVED*** Exporting Schedule for Distribution
...
***REMOVED******REMOVED******REMOVED*** Exporting People for GME Report
...
***REMOVED******REMOVED******REMOVED*** Backing Up Absence Data
...
***REMOVED******REMOVED*** Export Tips and Best Practices
...
***REMOVED******REMOVED******REMOVED*** Regular Exports
...
***REMOVED******REMOVED*** Troubleshooting Exports
...
***REMOVED******REMOVED******REMOVED*** Browser Download Settings
...
***REMOVED******REMOVED******REMOVED*** Large File Exports
...
***REMOVED******REMOVED*** Data Security Considerations

***REMOVED******REMOVED******REMOVED*** Sensitive Information
