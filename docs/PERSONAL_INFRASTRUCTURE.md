***REMOVED*** Personal AI Infrastructure (PAI) - Residency Scheduler
...
1. [What is PAI?](***REMOVED***what-is-pai)
2. [Why PAI Matters](***REMOVED***why-pai-matters)
3. [Architecture at a Glance](***REMOVED***architecture-at-a-glance)
4. [Key Components](***REMOVED***key-components)
5. [How It Works](***REMOVED***how-it-works)
6. [Core Principles](***REMOVED***core-principles)
7. [Common Tasks](***REMOVED***common-tasks-quick-reference)
8. [Maintenance & Evolution](***REMOVED***maintenance--evolution)
9. [Getting Started](***REMOVED***getting-started-for-new-developers)
10. [Advanced Topics](***REMOVED***advanced-topics)

---

***REMOVED******REMOVED*** What is PAI?
...
***REMOVED******REMOVED*** Why PAI Matters

***REMOVED******REMOVED******REMOVED*** The Problem Without PAI
...
***REMOVED******REMOVED******REMOVED*** The Solution With PAI
...
***REMOVED******REMOVED******REMOVED*** Real-World Impact
...
***REMOVED******REMOVED*** Architecture at a Glance
...
***REMOVED******REMOVED******REMOVED*** Component Interaction Flow
...
***REMOVED******REMOVED******REMOVED*** 1. CONSTITUTION (.claude/CONSTITUTION.md)
...
**Example Rule:**
```markdown
***REMOVED******REMOVED*** III.A. ACGME Compliance (Tier 0 - Absolute)
...
***REMOVED******REMOVED******REMOVED*** 2. Agents (.claude/Agents/)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** SCHEDULER (.claude/Agents/SCHEDULER.md)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ARCHITECT (.claude/Agents/ARCHITECT.md)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** RESILIENCE_ENGINEER (.claude/Agents/RESILIENCE_ENGINEER.md)
...
***REMOVED******REMOVED******REMOVED*** 3. Skills (.claude/skills/)
...
```
.claude/History/
├── scheduling/        ***REMOVED*** Schedule generation records (1 year retention)
├── swaps/             ***REMOVED*** Swap execution records (1 year retention)
...
***REMOVED******REMOVED******REMOVED*** 5. Hooks (.claude/Hooks/)
...
***REMOVED******REMOVED******REMOVED*** 6. Scratchpad (.claude/Scratchpad/)
...
***REMOVED******REMOVED******REMOVED*** 7. MetaUpdater (Conceptual Agent)
...
***REMOVED******REMOVED******REMOVED*** Example Workflow: Schedule Generation
...
***REMOVED******REMOVED******REMOVED*** 1. Solve Once, Reuse Forever
...
***REMOVED******REMOVED******REMOVED*** 2. Progressive Disclosure
...
***REMOVED******REMOVED******REMOVED*** 3. Defense in Depth (Safety)
...
***REMOVED******REMOVED******REMOVED*** 4. Institutional Memory (Learning)
...
***REMOVED******REMOVED******REMOVED*** 5. Explicit Over Implicit
...
***REMOVED******REMOVED*** Common Tasks Quick Reference

***REMOVED******REMOVED******REMOVED*** For Developers

**Generate a schedule:**
```bash
***REMOVED*** 1. Activate SCHEDULER agent
***REMOVED*** 2. Load schedule-optimization skill
***REMOVED*** 3. Command: "Generate Block 10 schedule for July-August"
***REMOVED*** AI will:
***REMOVED***   - Backup database
***REMOVED***   - Validate pre-conditions
***REMOVED***   - Run solver
***REMOVED***   - Validate ACGME compliance
***REMOVED***   - Document in History
```

**Process a swap request:**
```bash
***REMOVED*** 1. Activate SCHEDULER agent
***REMOVED*** 2. Load swap-management skill
***REMOVED*** 3. Command: "Process swap S12345"
***REMOVED*** AI will:
***REMOVED***   - Validate safety checks
***REMOVED***   - Check ACGME compliance
***REMOVED***   - Execute if approved
***REMOVED***   - Document in History
```

**Debug an incident:**
```bash
***REMOVED*** 1. Activate systematic-debugger skill
***REMOVED*** 2. Create Scratchpad entry for notes
***REMOVED*** 3. Workflow: Explore → Plan → Debug → Fix
***REMOVED*** 4. Document final solution in History/incidents/
```

**Write tests for new code:**
```bash
***REMOVED*** 1. Load test-writer skill
***REMOVED*** 2. Command: "Write tests for backend/app/services/swap_executor.py"
***REMOVED*** AI will:
***REMOVED***   - Generate unit tests (70%)
***REMOVED***   - Generate integration tests (20%)
***REMOVED***   - Generate E2E tests (10%)
***REMOVED***   - Ensure coverage ≥ 80%
```

**Create a database migration:**
```bash
***REMOVED*** 1. Load database-migration skill
***REMOVED*** 2. Command: "Add middle_name field to Person model"
***REMOVED*** AI will:
***REMOVED***   - Update model
***REMOVED***   - Generate Alembic migration
***REMOVED***   - Test migration up/down
***REMOVED***   - Document in commit message
```

**Review ACGME compliance:**
```bash
***REMOVED*** 1. Load acgme-compliance skill
***REMOVED*** 2. Command: "Audit Block 10 for ACGME violations"
***REMOVED*** AI will:
***REMOVED***   - Check 80-hour rule (all residents)
***REMOVED***   - Check 1-in-7 rule (all residents)
***REMOVED***   - Check supervision ratios
***REMOVED***   - Generate compliance report
***REMOVED***   - Document in History/compliance/
```
...
***REMOVED******REMOVED******REMOVED*** Weekly Reviews
...
***REMOVED******REMOVED******REMOVED*** Monthly Reviews
...
***REMOVED******REMOVED******REMOVED*** Quarterly Reviews
...
***REMOVED******REMOVED*** Getting Started (For New Developers)

***REMOVED******REMOVED******REMOVED*** Day 1: Orientation
...
***REMOVED******REMOVED******REMOVED*** Day 2: Hands-On Practice

**Task 1: Explore History**
```bash
***REMOVED*** Find all schedule generation records
ls .claude/History/scheduling/

***REMOVED*** Read a sample entry
cat .claude/History/scheduling/2025-07-15_block10_gen001.md

***REMOVED*** Understand what was generated and why
```

**Task 2: Review an Agent**
```bash
***REMOVED*** Read SCHEDULER agent definition
cat .claude/Agents/SCHEDULER.md

***REMOVED*** Note:
***REMOVED*** - What can SCHEDULER do autonomously?
***REMOVED*** - What requires approval?
***REMOVED*** - What are the safety protocols?
```

**Task 3: Examine a Skill**
```bash
***REMOVED*** Read schedule-optimization skill
cat .claude/skills/schedule-optimization/SKILL.md

***REMOVED*** Note:
***REMOVED*** - When is this skill activated?
***REMOVED*** - What are the prerequisites?
***REMOVED*** - What is the workflow?
```

---

***REMOVED******REMOVED******REMOVED*** Day 3: Execute a Task

**Guided Exercise: Generate a Test Schedule**
```bash
***REMOVED*** 1. Activate SCHEDULER agent (via AI interface)
***REMOVED*** 2. Command: "Generate a test schedule for 3 residents, 1 week (Block 0)"
***REMOVED*** 3. Observe:
***REMOVED***    - Skills loaded (schedule-optimization, safe-schedule-generation)
***REMOVED***    - Safety checks (backup, resilience validation)
***REMOVED***    - Solver execution
***REMOVED***    - ACGME validation
***REMOVED***    - History entry creation
***REMOVED*** 4. Review History entry: .claude/History/scheduling/[DATE]_block0_test.md
```
...
***REMOVED******REMOVED******REMOVED*** Week 1: Independent Work
...
***REMOVED******REMOVED******REMOVED*** Custom Skill Creation
...
***REMOVED******REMOVED******REMOVED*** Example 2: [Scenario]
[Concrete walkthrough]
```

---

***REMOVED******REMOVED******REMOVED*** Agent Customization
...
***REMOVED******REMOVED******REMOVED*** History Analysis Techniques
...
***REMOVED******REMOVED******REMOVED*** Integration with External Systems
...
***REMOVED******REMOVED*** Appendix: PAI Philosophy

***REMOVED******REMOVED******REMOVED*** Why We Built This
...
***REMOVED******REMOVED******REMOVED*** Inspired By
...
***REMOVED******REMOVED*** Feedback & Contribution
