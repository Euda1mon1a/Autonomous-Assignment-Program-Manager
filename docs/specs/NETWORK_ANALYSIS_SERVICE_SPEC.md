***REMOVED*** Network Analysis Service - Implementation Specification
...
4. [Graph Types](***REMOVED***4-graph-types)
5. [Analysis Modules](***REMOVED***5-analysis-modules)
6. [Integration with Existing Code](***REMOVED***6-integration-with-existing-code)
7. [Visualization API](***REMOVED***7-visualization-api)
8. [Performance Optimization](***REMOVED***8-performance-optimization)
9. [Testing Strategy](***REMOVED***9-testing-strategy)
10. [Deployment](***REMOVED***10-deployment)
11. [Future Enhancements](***REMOVED***11-future-enhancements)
...
├── hub_analysis.py                    ***REMOVED*** EXISTING - Basic centrality
├── network_analysis/                  ***REMOVED*** NEW - Advanced analysis
│   ├── __init__.py
│   ├── service.py                    ***REMOVED*** Main service class
│   ├── topology.py                   ***REMOVED*** Topology analyzers
│   ├── centrality.py                 ***REMOVED*** Centrality calculators
│   ├── community.py                  ***REMOVED*** Community detection
│   ├── robustness.py                 ***REMOVED*** Robustness analyzers
│   ├── temporal.py                   ***REMOVED*** Temporal network analysis
│   ├── visualization.py              ***REMOVED*** Graph export for viz
│   └── cache.py                      ***REMOVED*** Redis caching layer
```

***REMOVED******REMOVED******REMOVED*** 2.2 Core Service Class
...
class NetworkAnalysisService:
    ...
    async def _run_centrality_analysis(self, G: nx.Graph) -> Dict:
        ...
        ***REMOVED*** Calculate all centrality measures
    ...
    ***REMOVED*** Graph builders
    async def _build_coverage_graph(
        ...
        ***REMOVED*** TODO: Implement query logic
        ***REMOVED*** Query assignments in date range
        ***REMOVED*** Build bipartite graph: faculty <-> rotations
        ***REMOVED*** Project to faculty-faculty graph (shared rotations)
        pass
    ...
    async def _build_supervision_graph(
        ...
        ***REMOVED*** TODO: Implement directed graph for supervision
        pass
    ...
    async def _build_swap_graph(
        ...
        ***REMOVED*** TODO: Implement from swap_requests table
        pass
```

***REMOVED******REMOVED******REMOVED*** 2.3 Caching Strategy
...
***REMOVED******REMOVED******REMOVED*** 3.1 Endpoint Specification
...
***REMOVED*** Service instance (consider dependency injection in production)
...
async def get_centrality_measures(
    ...
    ***REMOVED*** Temporarily enable expensive ops if requested
...
async def predict_coverage_gaps(
    ...
    """
    ***REMOVED*** Build temporal sequence
...
***REMOVED******REMOVED******REMOVED*** 3.2 API Response Schemas
...
class GraphExportResponse(BaseModel):
    ...
    graph_type: str
    format: str
    data: Any  ***REMOVED*** Format-specific data
```

---

***REMOVED******REMOVED*** 4. Graph Types

***REMOVED******REMOVED******REMOVED*** 4.1 Coverage Network
...
***REMOVED******REMOVED******REMOVED*** 4.2 Supervision Network
...
async def _build_supervision_graph(
    ...
    ***REMOVED*** Query assignments with supervision data
    stmt = (
        select(Assignment)
        .join(Block)
    ...
    ***REMOVED*** Group by rotation/block to find supervision pairs
    ...
    ***REMOVED*** Create supervision edges
...
***REMOVED******REMOVED******REMOVED*** 4.3 Swap Network
...
***REMOVED******REMOVED*** 5. Analysis Modules

***REMOVED******REMOVED******REMOVED*** 5.1 Topology Analyzer
...
class TopologyAnalyzer:
    ...
    def analyze_small_world(self, G: nx.Graph) -> Dict:
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from NETWORK_RESILIENCE_DEEP_DIVE.md lines 74-134)
        ...
    ...
    def detect_scale_free(self, G: nx.Graph) -> Dict:
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 252-395)
        ...
    ...
    def analyze_clustering(self, G: nx.Graph) -> Dict:
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 438-569)
        ...
    ...
    def identify_bridges(self, G: nx.Graph) -> List[Tuple[str, str]]:
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 136-166)
        ...
```

***REMOVED******REMOVED******REMOVED*** 5.2 Centrality Calculator
...
class CentralityCalculator:
    ...
    def calculate_all_measures(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1021-1091)
        ...
    ...
    def calculate_consensus_ranking(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1094-1142)
        ...
    ...
    def identify_critical_nodes(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 971-1005)
        ...
```

***REMOVED******REMOVED******REMOVED*** 5.3 Community Detector
...
class CommunityDetector:
    ...
    def detect_louvain(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1183-1243)
        ...
    ...
    def compare_algorithms(self, G: nx.Graph) -> Dict:
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1269-1335)
        ...
    ...
    def analyze_stability(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1348-1430)
        ...
```

***REMOVED******REMOVED******REMOVED*** 5.4 Robustness Analyzer
...
class RobustnessAnalyzer:
    ...
    def calculate_percolation_threshold(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 603-754)
        ...
    ...
    def compare_attack_tolerance(self, G: nx.Graph) -> Dict:
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 777-860)
        ...
    ...
    def analyze_k_core(self, G: nx.Graph) -> Dict:
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 887-1005)
        ...
```

***REMOVED******REMOVED******REMOVED*** 5.5 Temporal Analyzer
...
class TemporalAnalyzer:
    ...
    async def build_temporal_sequence(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1456-1506)
        ...
    ...
    def predict_future_links(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1611-1672)
        ...
    ...
    def detect_emerging_patterns(
        ...
        """
        ***REMOVED*** Implementation from research doc
        ***REMOVED*** (Code from lines 1674-1760)
        ...
```

---

***REMOVED******REMOVED*** 6. Integration with Existing Code

***REMOVED******REMOVED******REMOVED*** 6.1 Extending HubAnalyzer

The `NetworkAnalysisService` **extends** (not replaces) the existing `HubAnalyzer`:

```python
***REMOVED*** In NetworkAnalysisService.__init__
self.hub_analyzer = HubAnalyzer(use_networkx=True)

***REMOVED*** Delegate to hub analyzer for basic centrality
async def calculate_basic_centrality(self, ...):
    return self.hub_analyzer.calculate_centrality(...)

***REMOVED*** Add advanced centrality on top
async def calculate_advanced_centrality(self, ...):
    ...
    ***REMOVED*** Merge results
    return {**basic, **advanced}
```

***REMOVED******REMOVED******REMOVED*** 6.2 Integration with Contingency Analysis

**File**: `backend/app/resilience/n1_n2_analysis.py`

```python
***REMOVED*** Add network analysis to contingency detection
...
class ContingencyAnalyzer:
    ...
    async def detect_n1_vulnerabilities(self, db, schedule_id):
        ...
        ***REMOVED*** Use k-core to find critical nodes
        k_core = self.network_service.robustness.analyze_k_core(G)
        nucleus_nodes = k_core["nucleus_nodes"]

        ***REMOVED*** Test removal of nucleus nodes (N-1)
        for node in nucleus_nodes:
            G_copy = G.copy()
            G_copy.remove_node(node)

            ***REMOVED*** Check if network fragments
            if not nx.is_connected(G_copy):
                logger.warning(f"N-1 failure detected: {node}")
                ***REMOVED*** ... generate contingency plan
```

***REMOVED******REMOVED******REMOVED*** 6.3 Integration with Burnout Epidemiology

**File**: `backend/app/resilience/burnout_epidemiology.py`

```python
***REMOVED*** Use community detection for burnout contagion modeling
...
class BurnoutEpidemiologyAnalyzer:
    ...
    async def model_burnout_spread(self, db, seed_faculty_ids):
        ***REMOVED*** Build supervision network (burnout spreads via supervision)
        G = await self.network_service.build_coverage_network(
            db,
            start_date,
            end_date,
...
***REMOVED******REMOVED******REMOVED*** 6.4 API Integration Points
...
***REMOVED******REMOVED*** 7. Visualization API

***REMOVED******REMOVED******REMOVED*** 7.1 NetworkVisualizer
...
class NetworkVisualizer:
    ...
    def _export_d3(
        ...
        """
        ***REMOVED*** Calculate layout if requested
        if include_layout:
            pos = self._calculate_layout(G, layout_algorithm)
        else:
            pos = None

        ***REMOVED*** Build node list
        nodes = []
    ...
    def _export_graphml(self, G: nx.Graph) -> str:
        ...
        ***REMOVED*** Use NetworkX built-in GraphML writer
        buffer = BytesIO()
    ...
    def export_with_communities(
        ...
        """
        ***REMOVED*** Add community attribute to nodes
        G_copy = G.copy()
        ...
        ***REMOVED*** Export with community data
        return self.export_graph(G_copy, format=format)
```

***REMOVED******REMOVED******REMOVED*** 7.2 Frontend Integration Example
...
***REMOVED******REMOVED*** 8. Performance Optimization

***REMOVED******REMOVED******REMOVED*** 8.1 Caching Strategy
...
***REMOVED******REMOVED******REMOVED*** 8.2 Algorithm Complexity Management
...
***REMOVED******REMOVED******REMOVED*** 8.3 Parallel Processing

**Celery Tasks for Expensive Operations**:

```python
***REMOVED*** backend/app/resilience/network_analysis/tasks.py
...
class TestTopologyAnalyzer:
    ...
    def test_small_world_detection(self):
        ...
        ***REMOVED*** Watts-Strogatz small-world graph
    ...
    def test_scale_free_detection(self):
        ...
        ***REMOVED*** Barabási-Albert scale-free graph
    ...
    def test_clustering_analysis(self):
        ...
        ***REMOVED*** Complete graph (maximum clustering)
...
class TestCentralityCalculator:
    ...
    def test_all_measures(self):
        ...
        ***REMOVED*** Should have all measures
        ...
        ***REMOVED*** All nodes should have scores
...
class TestNetworkPerformance:
    ...
    def test_large_graph_analysis(self):
        ...
        ***REMOVED*** Should complete in < 30 seconds
        assert elapsed < 30.0
```

---

***REMOVED******REMOVED*** 10. Deployment

***REMOVED******REMOVED******REMOVED*** 10.1 Dependencies
...
networkx>=3.0
scipy>=1.11.0
scikit-learn>=1.3.0  ***REMOVED*** For NMI in community stability
powerlaw>=1.5  ***REMOVED*** Optional, for scale-free detection
```

***REMOVED******REMOVED******REMOVED*** 10.2 Database Migrations
...
***REMOVED******REMOVED******REMOVED*** 10.3 Configuration
...
class Settings(BaseSettings):
    ...
    ***REMOVED*** Network Analysis
    NETWORK_ANALYSIS_CACHE_TTL: int = 900  ***REMOVED*** 15 minutes
    NETWORK_ANALYSIS_MAX_NODES_EXPENSIVE: int = 100
    NETWORK_ANALYSIS_ENABLE_EXPENSIVE_OPS: bool = True
```

***REMOVED******REMOVED******REMOVED*** 10.4 Docker Updates
...
***REMOVED******REMOVED******REMOVED*** 11.1 Phase 2 Features
...
***REMOVED******REMOVED******REMOVED*** 11.2 Advanced Analytics
...
***REMOVED******REMOVED******REMOVED*** 11.3 Visualization Enhancements
...
***REMOVED******REMOVED*** Appendix A: Research Reference
...
***REMOVED******REMOVED*** Appendix B: API Quick Reference
