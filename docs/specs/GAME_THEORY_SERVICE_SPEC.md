***REMOVED*** Game Theory Scheduling Service - Implementation Specification
...
2. [Service Architecture](***REMOVED***2-service-architecture)
3. [Database Schema](***REMOVED***3-database-schema)
4. [Pydantic Schemas](***REMOVED***4-pydantic-schemas)
5. [Service Layer Implementation](***REMOVED***5-service-layer-implementation)
6. [API Endpoints](***REMOVED***6-api-endpoints)
7. [Integration Points](***REMOVED***7-integration-points)
8. [Testing Strategy](***REMOVED***8-testing-strategy)
9. [Performance Considerations](***REMOVED***9-performance-considerations)
10. [Migration Plan](***REMOVED***10-migration-plan)
...
***REMOVED******REMOVED******REMOVED*** 1.2 Relationship to Existing Systems
...
***REMOVED******REMOVED******REMOVED*** 1.3 Core Mechanisms
...
***REMOVED******REMOVED*** 2. Service Architecture

***REMOVED******REMOVED******REMOVED*** 2.1 Module Layout

```
backend/app/
├── services/
│   ├── game_theory/                    ***REMOVED*** NEW DIRECTORY
│   │   ├── __init__.py
│   │   ├── vcg_allocator.py           ***REMOVED*** VCG auction mechanism
│   │   ├── rsd_allocator.py           ***REMOVED*** Random Serial Dictatorship
│   │   ├── shapley_calculator.py      ***REMOVED*** Shapley value computation
│   │   ├── nash_analyzer.py           ***REMOVED*** Nash equilibrium analysis
│   │   ├── preference_elicitor.py     ***REMOVED*** Strategyproof preference collection
│   │   └── auction_engine.py          ***REMOVED*** Priority point auctions
│   │
│   ├── game_theory.py                 ***REMOVED*** EXISTING: Axelrod tournaments (unchanged)
│   ├── swap_auto_matcher.py           ***REMOVED*** ENHANCED: Add game theory matching
│   └── faculty_preference_service.py  ***REMOVED*** ENHANCED: Add strategyproof collection
│
├── models/
│   ├── game_theory_scheduling.py      ***REMOVED*** NEW: Scheduling-specific models
│   └── game_theory.py                 ***REMOVED*** EXISTING: Tournament models (unchanged)
│
├── schemas/
│   └── game_theory_scheduling.py      ***REMOVED*** NEW: Request/response schemas
│
└── api/routes/
    └── game_theory_scheduling.py      ***REMOVED*** NEW: API endpoints
```

***REMOVED******REMOVED******REMOVED*** 2.2 Service Dependencies

```python
***REMOVED*** app/services/game_theory/__init__.py
"""
...
***REMOVED******REMOVED******REMOVED*** 2.3 Design Principles
...
***REMOVED******REMOVED*** 3. Database Schema

***REMOVED******REMOVED******REMOVED*** 3.1 New Models
...
class AllocationMechanism(str, Enum):
    ...
    VCG = "vcg"  ***REMOVED*** Vickrey-Clarke-Groves
    RSD = "rsd"  ***REMOVED*** Random Serial Dictatorship
    VICKREY_AUCTION = "vickrey_auction"  ***REMOVED*** Second-price auction
    SHAPLEY_FAIR = "shapley_fair"  ***REMOVED*** Shapley value based


class PreferenceType(str, Enum):
    """Types of preferences."""
    ORDINAL = "ordinal"  ***REMOVED*** Ranked list
    CARDINAL = "cardinal"  ***REMOVED*** Numeric valuations
    BINARY = "binary"  ***REMOVED*** Accept/reject


***REMOVED*** ============================================================================
***REMOVED*** Preference Elicitation
***REMOVED*** ============================================================================
...
class StrategyproofPreference(Base):
    ...
    ***REMOVED*** Mechanism used
    mechanism = Column(String(20), nullable=False)  ***REMOVED*** AllocationMechanism enum
    preference_type = Column(String(20), nullable=False)  ***REMOVED*** PreferenceType enum

    ***REMOVED*** Preferences (format depends on type)
    ***REMOVED*** Ordinal: {week_iso: rank, ...}
    ***REMOVED*** Cardinal: {week_iso: value, ...}
    ***REMOVED*** Binary: {week_iso: bool, ...}
    preferences_json = Column(JSONB, nullable=False)

    ***REMOVED*** Metadata
    collected_at = Column(DateTime, default=datetime.utcnow, nullable=False)
    collection_method = Column(String(50))  ***REMOVED*** web_form, api, import

    ***REMOVED*** Validation
    is_validated = Column(Boolean, default=False)
    validation_errors = Column(JSONB)  ***REMOVED*** List of error messages

    ***REMOVED*** Audit trail
    ip_address = Column(String(45))  ***REMOVED*** IPv4/IPv6
...
class AllocationRecord(Base):
    ...
    ***REMOVED*** Allocation details
    ...
    allocated_slot_type = Column(String(50), nullable=False)  ***REMOVED*** clinic, inpatient, etc.

    ***REMOVED*** Mechanism-specific data
    ***REMOVED*** VCG: {payment: float, others_welfare_change: float}
    ***REMOVED*** RSD: {lottery_position: int, num_participants: int}
    ***REMOVED*** Vickrey: {winning_bid: float, payment: float}
    mechanism_data = Column(JSONB)

    ***REMOVED*** Utility/value
    faculty_reported_value = Column(Float)  ***REMOVED*** What faculty reported
    faculty_true_utility = Column(Float, nullable=True)  ***REMOVED*** Revealed preference (if available)
    social_welfare_contribution = Column(Float)  ***REMOVED*** Contribution to total welfare

    ***REMOVED*** Timestamp
    allocated_at = Column(DateTime, default=datetime.utcnow, nullable=False)

    ***REMOVED*** Properties
    is_efficient = Column(Boolean, default=False)  ***REMOVED*** Part of efficient allocation
    is_envy_free = Column(Boolean, default=False)  ***REMOVED*** No envy
...
class ShapleyValue(Base):
    ...
    ***REMOVED*** Shapley calculation
    shapley_value = Column(Float, nullable=False)
    expected_workload_shifts = Column(Float, nullable=False)  ***REMOVED*** Based on Shapley
    actual_workload_shifts = Column(Integer)  ***REMOVED*** Actual assignments

    ***REMOVED*** Deviation from fair share
    fairness_deviation = Column(Float)  ***REMOVED*** abs(actual - expected)
    fairness_percentage = Column(Float)  ***REMOVED*** 0-100 where 100 = perfectly fair

    ***REMOVED*** Calculation metadata
    calculation_method = Column(String(20))  ***REMOVED*** exact, monte_carlo
    monte_carlo_samples = Column(Integer)  ***REMOVED*** If approximation used
    confidence_interval = Column(JSONB)  ***REMOVED*** {lower: float, upper: float}

    ***REMOVED*** Marginal contributions (for debugging)
    ***REMOVED*** {coalition_size: avg_marginal_contribution, ...}
    marginal_contributions = Column(JSONB)

    ***REMOVED*** Coverage capability
    rotation_qualifications = Column(JSONB)  ***REMOVED*** {rotation_type: bool, ...}
    coverage_capacity = Column(Float)  ***REMOVED*** Num shifts this faculty enables

    ***REMOVED*** Timestamps
    calculated_at = Column(DateTime, default=datetime.utcnow, nullable=False)
    valid_until = Column(DateTime)  ***REMOVED*** Cache expiration
...
***REMOVED*** ============================================================================
***REMOVED*** Nash Equilibrium Analysis
***REMOVED*** ============================================================================
...
class NashStabilityReport(Base):
    ...
    ***REMOVED*** Stability metrics
    ...
    nash_distance = Column(Float, nullable=False)  ***REMOVED*** 0 = at equilibrium, 1 = very unstable

    ***REMOVED*** Potential improvements
    num_beneficial_swaps = Column(Integer, nullable=False)  ***REMOVED*** Count of improvement opportunities
    max_utility_gain = Column(Float)  ***REMOVED*** Largest possible utility improvement
    avg_utility_gain = Column(Float)  ***REMOVED*** Average across all improvements

    ***REMOVED*** Improvement opportunities (detailed)
    ***REMOVED*** List of {faculty_a, faculty_b, week_a, week_b, utility_gain_a, utility_gain_b}
    improvement_list = Column(JSONB)

    ***REMOVED*** Price of Anarchy/Stability
    optimal_welfare = Column(Float)  ***REMOVED*** Best possible total welfare
    current_welfare = Column(Float)  ***REMOVED*** Current total welfare
    price_of_anarchy = Column(Float)  ***REMOVED*** optimal / worst_equilibrium
    price_of_stability = Column(Float)  ***REMOVED*** optimal / best_equilibrium

    ***REMOVED*** Recommendations
    recommended_swaps = Column(JSONB)  ***REMOVED*** Top 10 swaps to improve stability
    stability_forecast = Column(String(50))  ***REMOVED*** stable, minor_adjustments, major_revision
...
***REMOVED*** ============================================================================
***REMOVED*** Priority Points (for Auctions)
***REMOVED*** ============================================================================
...
class PriorityPointTransaction(Base):
    ...
    ***REMOVED*** Transaction details
    amount = Column(Float, nullable=False)  ***REMOVED*** Positive = earned, negative = spent
    transaction_type = Column(String(50), nullable=False)  ***REMOVED*** holiday_shift, vacation_bid, etc.
    description = Column(Text)

    ***REMOVED*** Related entities
    shift_id = Column(PGUUID(as_uuid=True), nullable=True)  ***REMOVED*** If related to specific shift
    auction_id = Column(PGUUID(as_uuid=True), nullable=True)  ***REMOVED*** If from auction
    swap_id = Column(PGUUID(as_uuid=True), nullable=True)  ***REMOVED*** If from swap
...
class VickreyAuction(Base):
    ...
    ***REMOVED*** Auctioned item
    shift_week = Column(Date, nullable=False)
    shift_type = Column(String(50), nullable=False)
    is_desirable = Column(Boolean, nullable=False)  ***REMOVED*** Bidding for or against

    ***REMOVED*** Auction details
    reserve_price = Column(Float, default=0.0)

    ***REMOVED*** Bids (encrypted for privacy)
    ***REMOVED*** List of {faculty_id: uuid, bid: float}
    bids_json = Column(JSONB, nullable=False)

    ***REMOVED*** Results
    winner_faculty_id = Column(PGUUID(as_uuid=True), ForeignKey("people.id"))
    winning_bid = Column(Float)  ***REMOVED*** Highest bid
    payment = Column(Float)  ***REMOVED*** Second-highest bid (Vickrey rule)
...
***REMOVED*** ============================================================================
***REMOVED*** Evolutionary Strategy Learning
***REMOVED*** ============================================================================
...
class StrategyPerformance(Base):
    ...
    ***REMOVED*** Strategy identification
    strategy_type = Column(String(50), nullable=False)  ***REMOVED*** early_request, mutual_preference, etc.
    ...
    ***REMOVED*** Evolutionary dynamics
    population_frequency = Column(Float, nullable=False, default=0.0)  ***REMOVED*** Fraction using this strategy
    fitness = Column(Float)  ***REMOVED*** Success rate - avg success rate
    growth_rate = Column(Float)  ***REMOVED*** dx/dt from replicator equation

    ***REMOVED*** Time series (sampled)
    ***REMOVED*** List of {date: iso, frequency: float, success_rate: float}
...
***REMOVED******REMOVED******REMOVED*** 3.2 Alembic Migration Outline
...
def upgrade():
    ***REMOVED*** Create tables in dependency order
...
***REMOVED******REMOVED*** 4. Pydantic Schemas
...
class PreferenceTypeEnum(str, Enum):
    ...
    ORDINAL = "ordinal"  ***REMOVED*** Ranked list
    CARDINAL = "cardinal"  ***REMOVED*** Numeric values
    BINARY = "binary"  ***REMOVED*** Accept/reject
...
class StrategyproofPreferenceRequest(BaseModel):
    ...
    ***REMOVED*** Preference data (format depends on type)
...
***REMOVED*** ============================================================================
***REMOVED*** Random Serial Dictatorship
***REMOVED*** ============================================================================
...
***REMOVED******REMOVED*** 5. Service Layer Implementation

***REMOVED******REMOVED******REMOVED*** 5.1 Random Serial Dictatorship Allocator
...
class RandomSerialDictatorshipAllocator:
    ...
    async def allocate_shifts(
        ...
        ***REMOVED*** Generate random lottery order
        ...
        ***REMOVED*** Allocate in lottery order
        allocation: Dict[UUID, date] = {}
        ...
        for faculty_id in lottery_order:
            ...
            ***REMOVED*** Get this faculty's ranked preferences
            rankings = self._extract_rankings(pref)

            ***REMOVED*** Pick first available from ranked list
            allocated = False
        ...
        ***REMOVED*** Record allocations in database
    ...
    async def _record_allocations(
        ...
        for faculty_id, week in allocation.items():
            ...
            record = AllocationRecord(
                ...
                allocated_week=week,
                allocated_slot_type="week",  ***REMOVED*** Generic
                mechanism_data={
                    "lottery_position": lottery_position,
                    "num_participants": len(lottery_order),
                    "seed_used": None  ***REMOVED*** Could store if needed
                },
                is_efficient=True,  ***REMOVED*** RSD is ex-post efficient
                is_envy_free=False,  ***REMOVED*** RSD doesn't guarantee envy-freeness
            )
...
***REMOVED******REMOVED******REMOVED*** 5.2 Nash Equilibrium Analyzer
...
class NashEquilibriumAnalyzer:
    ...
    async def analyze_stability(
        ...
        ***REMOVED*** Store report
        report = NashStabilityReport(
            ...
            price_of_stability=1.0,  ***REMOVED*** Assuming current is best equilibrium
        ...
        return NashStabilityResponse(
            ...
            nash_distance=nash_distance,
            num_beneficial_swaps=len(beneficial_swaps),
            beneficial_swaps=recommended_swaps,  ***REMOVED*** Return top swaps only
            current_welfare=current_welfare,
            optimal_welfare=optimal_welfare,
    ...
    async def _load_utilities(
        ...
        """
        ***REMOVED*** Load utility functions from multiple sources:
        ***REMOVED*** 1. Strategyproof preference declarations (if available)
        ***REMOVED*** 2. Stigmergy trails from past swap acceptance patterns
        ***REMOVED*** 3. Default utilities based on faculty role and target weeks

        utilities = {}

        ***REMOVED*** Load from database (strategyproof preferences)
        ...
        ***REMOVED*** Augment with stigmergy trail data (swap history learning)
    ...
    async def _load_faculty_preferences(
        ...
        Example:
            {
                UUID('faculty-123'): {
                    date(2024, 7, 15): 1.0,  ***REMOVED*** Prefer this week
                    date(2024, 8, 5): 0.0    ***REMOVED*** Avoid this week
                }
            }
        """
        ***REMOVED*** Query faculty_preferences table
        ***REMOVED*** This would be implemented in the actual service
        return {}
    ...
    async def _load_stigmergy_utilities(
        ...
        Example:
            {
                (UUID('faculty-123'), date(2024, 7, 15)): 0.7,  ***REMOVED*** Accepted swaps into this week
                (UUID('faculty-456'), date(2024, 8, 5)): -0.3   ***REMOVED*** Rejected swaps into this week
            }
        """
        ***REMOVED*** Analyze swap_history table to derive implicit preferences
        ***REMOVED*** Weight recent swaps more heavily than old ones
        ***REMOVED*** This would be implemented in the actual service
        return {}
    ...
    async def _find_beneficial_swaps(
        ...
        for i, faculty_a in enumerate(faculty_ids):
            for faculty_b in faculty_ids[i+1:]:
                ***REMOVED*** Check all pairwise swaps between these two faculty
                for assign_a in assignments[faculty_a]:
                    for assign_b in assignments[faculty_b]:
                        ***REMOVED*** Calculate utility change
                        ...
                        ***REMOVED*** Both must improve (Pareto improvement)
                        if gain_a > 0 and gain_b > 0:
                            beneficial.append(BeneficialSwap(
                                faculty_a_id=faculty_a,
                                faculty_a_name="Faculty A",  ***REMOVED*** TODO: Load name
    ...
    def _calculate_nash_distance(
        ...
        ***REMOVED*** Average potential gain as fraction of max possible
        avg_gain = sum(s.total_utility_gain for s in beneficial_swaps) / len(beneficial_swaps)

        ***REMOVED*** Normalize (assume max gain per swap is 100)
    ...
    async def _calculate_optimal_welfare(
        ...
        """
        ***REMOVED*** TODO: Implement VCG or Hungarian algorithm
        ***REMOVED*** For now, return current welfare * 1.1 as upper bound
...
async def collect_strategyproof_preferences(
    ...
    ***REMOVED*** TODO: Implement preference collection
...
async def get_price_of_anarchy(
    ...
    ***REMOVED*** TODO: Implement PoA calculation
    raise HTTPException(
        status_code=status.HTTP_501_NOT_IMPLEMENTED,
...
***REMOVED******REMOVED*** 7. Integration Points

***REMOVED******REMOVED******REMOVED*** 7.1 Enhance Swap Auto-Matcher
...
class SwapAutoMatcher:
    ...
    async def suggest_optimal_matches(
        ...
        """
        ***REMOVED*** Existing matching logic
        matches = await self._find_compatible_matches(request_id)

        ***REMOVED*** NEW: Enhance with Nash stability scoring
...
***REMOVED******REMOVED******REMOVED*** 7.2 Enhance Faculty Preference Service
...
class FacultyPreferenceService:
    def __init__(self, db: AsyncSession):
        ...
        ***REMOVED*** NEW: Add strategyproof elicitor
...
***REMOVED******REMOVED*** 8. Testing Strategy

***REMOVED******REMOVED******REMOVED*** 8.1 Test File Structure
...
***REMOVED******REMOVED******REMOVED*** 8.2 Key Test Cases

***REMOVED******REMOVED******REMOVED******REMOVED*** VCG Mechanism Tests

```python
***REMOVED*** backend/tests/unit/services/game_theory/test_vcg_allocator.py
...
async def test_vcg_is_strategyproof(db):
    ...
    ***REMOVED*** Create scenario with 3 faculty, 3 shifts
    true_values = {
    ...
    ***REMOVED*** Allocate with truthful reporting
    ...
    ***REMOVED*** Try lying (inflate preferences)
    lying_values = true_values.copy()
    lying_values["faculty_1"] = {"shift_1": 100, "shift_2": 80, "shift_3": 60}  ***REMOVED*** Lie

    lying_result = await vcg.allocate(lying_values)
    lying_utility = calculate_faculty_utility(lying_result, true_values, "faculty_1")

    ***REMOVED*** Truth-telling should be better or equal
...
async def test_vcg_efficiency(db):
    ...
    ***REMOVED*** Try all possible allocations (brute force for small n)
    all_allocations = generate_all_allocations(values)
    max_welfare = max(calculate_total_welfare(a, values) for a in all_allocations)

    ***REMOVED*** VCG should achieve maximum
    assert vcg_welfare == max_welfare, "VCG not efficient!"
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Nash Equilibrium Tests

```python
***REMOVED*** backend/tests/unit/services/game_theory/test_nash_analyzer.py
...
async def test_nash_stability_no_improvements(db):
    ...
    ***REMOVED*** Create perfectly balanced schedule (everyone happy)
...
async def test_nash_stability_finds_improvements(db):
    ...
    ***REMOVED*** Create unbalanced schedule with obvious swap
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Shapley Value Tests

```python
***REMOVED*** backend/tests/unit/services/game_theory/test_shapley_calculator.py
...
async def test_shapley_symmetry_axiom(db):
    ...
    ***REMOVED*** Create two identical faculty
    faculty = [
        create_faculty(qualifications=["clinic", "inpatient"]),
        create_faculty(qualifications=["clinic", "inpatient"]),  ***REMOVED*** Identical
    ]

    shapley_values = await calculator.calculate_exact(faculty)

    ***REMOVED*** Should have equal Shapley values
...
async def test_shapley_monte_carlo_accuracy(db):
    ...
    ***REMOVED*** Exact calculation (feasible for n=10)
    exact = await calculator.calculate_exact(faculty)

    ***REMOVED*** Monte Carlo approximation
    ...
    ***REMOVED*** Should be within epsilon with high probability
    for fid in faculty:
...
***REMOVED******REMOVED*** 9. Performance Considerations

***REMOVED******REMOVED******REMOVED*** 9.1 Complexity Summary
...
***REMOVED******REMOVED******REMOVED*** 9.2 Caching Strategy

```python
***REMOVED*** In shapley_calculator.py
...
class ShapleyValueCalculator:
    ...
    async def calculate_shapley_values(
        ...
        ***REMOVED*** Calculate fresh
        result = await self._calculate_fresh(request)

        ***REMOVED*** Cache for 1 hour (invalidate on schedule change)
        await redis_client.setex(
            cache_key,
            3600,  ***REMOVED*** 1 hour TTL
            result.json()
        )
...
***REMOVED******REMOVED******REMOVED*** 9.3 Database Indexing
...
***REMOVED******REMOVED*** 10. Migration Plan
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Shapley Fairness (Weeks 5-8)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Auctions (Weeks 9-12)
...
***REMOVED******REMOVED******REMOVED*** Phase 4: VCG (Optional, Weeks 13-16)
