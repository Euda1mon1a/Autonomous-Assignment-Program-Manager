***REMOVED*** Thermodynamic Optimization Solver Service Specification
...
3. [API Endpoints](***REMOVED***3-api-endpoints)
4. [Solver Components](***REMOVED***4-solver-components)
5. [Integration with OR-Tools](***REMOVED***5-integration-with-or-tools)
6. [Ensemble Generation](***REMOVED***6-ensemble-generation)
7. [Configuration](***REMOVED***7-configuration)
8. [Database Schema](***REMOVED***8-database-schema)
9. [Testing Requirements](***REMOVED***9-testing-requirements)
10. [Performance Benchmarks](***REMOVED***10-performance-benchmarks)
11. [Security Considerations](***REMOVED***11-security-considerations)
12. [Deployment Plan](***REMOVED***12-deployment-plan)
...
***REMOVED******REMOVED******REMOVED*** 1.2 Goals
...
***REMOVED******REMOVED******REMOVED*** 1.3 Key Features
...
***REMOVED******REMOVED******REMOVED*** 1.4 Integration Points
...
***REMOVED******REMOVED******REMOVED*** 2.1 System Overview
...
***REMOVED******REMOVED******REMOVED*** 2.2 Component Responsibilities

***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2.1 SimulatedAnnealingSolver
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2.2 FreeEnergyCalculator
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2.3 EntropyMonitor
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2.4 EnergyLandscapeAnalyzer
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2.5 EnsembleGenerator
...
***REMOVED******REMOVED******REMOVED*** 2.3 Data Flow
...
***REMOVED******REMOVED******REMOVED*** 3.1 Endpoint Overview
...
***REMOVED******REMOVED******REMOVED*** 3.2 POST /api/v1/thermo/anneal
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Response (Failure)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Error Codes
...
***REMOVED******REMOVED******REMOVED*** 3.3 GET /api/v1/thermo/entropy

**Description:** Get entropy metrics for a schedule or date range.

***REMOVED******REMOVED******REMOVED******REMOVED*** Request Parameters
...
***REMOVED******REMOVED******REMOVED*** 3.4 POST /api/v1/thermo/ensemble
...
***REMOVED******REMOVED******REMOVED*** 3.5 GET /api/v1/thermo/energy-landscape
...
***REMOVED******REMOVED******REMOVED*** 3.6 GET /api/v1/thermo/config
...
***REMOVED******REMOVED******REMOVED*** 3.7 PUT /api/v1/thermo/config
...
***REMOVED******REMOVED*** 4. Solver Components

***REMOVED******REMOVED******REMOVED*** 4.1 SimulatedAnnealingSolver Class
...
class SAConfig:
    ...
    cooling_schedule: str = "geometric"  ***REMOVED*** geometric, adaptive, logarithmic
...
class SimulatedAnnealingSolver(BaseSolver):
    ...
    def solve(
        ...
        ***REMOVED*** Initialize with greedy solver or provided assignments
        ...
        ***REMOVED*** Annealing loop
        ...
        while (
            ...
            for _ in range(self.config.steps_per_temperature):
                ...
                ***REMOVED*** Metropolis criterion
                delta_F = candidate_F - current_F

                if delta_F < 0:
                    ***REMOVED*** Improvement: always accept
                    accept = True
                elif self.cooling.temperature > 0:
                    ***REMOVED*** Deterioration: accept probabilistically
        ...
        ***REMOVED*** Validate best solution
        validation_results = self._validate_solution(best, context)

        ***REMOVED*** Convert to solver result format
        assignments_tuple = [
    ...
    def _random_initialization(
        ...
        for block in workday_blocks:
            ***REMOVED*** Filter available residents
            available = [
    ...
    def _propose_move(
        ...
        if move_type < 0.5 and len(candidate) >= 2:
            ...
            ***REMOVED*** Change one assignment's template
            idx = random.randint(0, len(candidate) - 1)
...
***REMOVED******REMOVED******REMOVED*** 4.2 CoolingSchedule Classes
...
class AdaptiveCooling(CoolingSchedule):
    ...
    def __init__(
        ...
        self.alpha = 0.95  ***REMOVED*** Initial cooling rate
...
***REMOVED******REMOVED******REMOVED*** 4.3 FreeEnergyCalculator Class
...
class FreeEnergyCalculator:
    ...
    def calculate_internal_energy(
        ...
        ***REMOVED*** Category 1: ACGME violations (via validator)
        ***REMOVED*** TODO: Integrate ACGMEValidator for real violations
        ***REMOVED*** For now, use simplified heuristics

        ***REMOVED*** Category 2: Coverage gaps
        ...
        ***REMOVED*** Category 3: Workload imbalance
        ...
        ***REMOVED*** Category 4: Template concentration
...
class EntropyMonitor:
    ...
    def update(self, assignments: list[Assignment]) -> dict:
        ...
        ***REMOVED*** Early warning detection
    ...
    def calculate_multidimensional_entropy(
        ...
        ***REMOVED*** Flexibility score (normalized person entropy)
...
***REMOVED******REMOVED*** 5. Integration with OR-Tools

***REMOVED******REMOVED******REMOVED*** 5.1 Hybrid Approach Strategy
...
class HybridThermodynamicSolver(BaseSolver):
    ...
    def __init__(
        ...
        self.sa_config = sa_config or SAConfig(
            temperature_initial=50.0,  ***REMOVED*** Lower than pure SA
            cooling_rate=0.95,
    ...
    def solve(
        ...
        ***REMOVED*** Phase 2: Simulated Annealing refinement
        logger.info("Phase 2: Running simulated annealing refinement")

        ***REMOVED*** Use CP-SAT result as initialization
        ...
        ***REMOVED*** Run SA with remaining time budget
...
***REMOVED******REMOVED******REMOVED*** 5.2 OR-Tools Validation Integration
...
def validate_sa_solution_with_cpsat(
    ...
    ***REMOVED*** Solve for feasibility check
...
***REMOVED******REMOVED*** 6. Ensemble Generation

***REMOVED******REMOVED******REMOVED*** 6.1 EnsembleGenerator Class
...
class EnsembleGenerator:
    ...
    def generate_ensemble(
        ...
        ***REMOVED*** Initialize
        ...
        while samples_collected < ensemble_size and iterations < max_iterations:
            ...
            ***REMOVED*** Collect sample (with thinning)
            if iterations % thinning_interval == 0:
                ***REMOVED*** Check if this is a valid schedule
    ...
    def _propose_random_move(
        ...
        if len(candidate) >= 2:
            ***REMOVED*** Swap two random assignments
            i, j = random.sample(range(len(candidate)), 2)
            candidate[i], candidate[j] = candidate[j], candidate[i]
    ...
    def _is_valid_schedule(
        ...
        ***REMOVED*** Basic checks: no major violations
        energy = self.energy_calculator.calculate_internal_energy(schedule, context)
        return energy < 200.0  ***REMOVED*** Threshold for "acceptable" quality
```

***REMOVED******REMOVED******REMOVED*** 6.2 Ensemble Storage
...
***REMOVED******REMOVED*** 7. Configuration

***REMOVED******REMOVED******REMOVED*** 7.1 Environment Variables
...
class Settings(BaseSettings):
    ...
    ***REMOVED*** Thermodynamic Optimization
    SA_TEMPERATURE_INITIAL: float = 100.0
    SA_TEMPERATURE_FINAL: float = 0.01
    SA_COOLING_RATE: float = 0.95
    SA_COOLING_SCHEDULE: str = "geometric"  ***REMOVED*** geometric, adaptive, logarithmic
    ...
    ***REMOVED*** Solver Selection
    AUTO_SOLVER_SELECTION: bool = True
    SA_COMPLEXITY_THRESHOLD: int = 60  ***REMOVED*** Use SA if complexity > 60

    ***REMOVED*** Ensemble Generation
...
***REMOVED******REMOVED******REMOVED*** 7.2 Configuration File

Add to `.env.example`:

```bash
***REMOVED*** Thermodynamic Optimization Settings
...
***REMOVED******REMOVED*** 8. Database Schema

***REMOVED******REMOVED******REMOVED*** 8.1 New Tables
...
***REMOVED******REMOVED******REMOVED*** 8.2 Schema Migration
...
def upgrade():
    ***REMOVED*** Schedule entropy history
    op.create_table(
    ...
    ***REMOVED*** Energy landscape analysis
    op.create_table(
...
***REMOVED******REMOVED*** 9. Testing Requirements
...
class TestEntropyMonitor:
    ...
    def test_early_warning_detection(self):
        ...
        ***REMOVED*** Simulate increasing autocorrelation
        for i in range(30):
            assignments = [
...
class TestSAPerformance:
    ...
    def test_small_problem_speed(self, small_context):
        ...
        assert result.success
        assert runtime < 5.0  ***REMOVED*** Should complete in < 5s
    ...
    def test_medium_problem_speed(self, medium_context):
        ...
        assert result.success
        assert runtime < 60.0  ***REMOVED*** Should complete in < 60s
    ...
    def test_convergence_rate(self, medium_context):
        ...
        ***REMOVED*** Energy should improve significantly in first 50% of iterations
        ...
        ***REMOVED*** Most improvement should happen early
        assert improvement_first_half > improvement_second_half
```

---

***REMOVED******REMOVED*** 10. Performance Benchmarks

***REMOVED******REMOVED******REMOVED*** 10.1 Target Performance
...
***REMOVED******REMOVED******REMOVED*** 10.2 Comparison with Existing Solvers
...
***REMOVED******REMOVED******REMOVED*** 10.3 Benchmark Suite
...
class TestThermodynamicBenchmarks:
    ...
    def test_benchmark_sa_vs_cpsat(self, medium_context):
        ...
        ***REMOVED*** SA should be faster
        assert sa_time < cpsat_time

    def test_benchmark_scaling(self):
        """Test how SA scales with problem size."""
        sizes = [
            (7, 5, 500),    ***REMOVED*** 7 days, 5 residents, 500 iterations
            (14, 8, 1000),  ***REMOVED*** 14 days, 8 residents, 1000 iterations
            (28, 12, 2000), ***REMOVED*** 28 days, 12 residents, 2000 iterations
        ]
...
***REMOVED******REMOVED*** 11. Security Considerations

***REMOVED******REMOVED******REMOVED*** 11.1 Input Validation
...
***REMOVED******REMOVED******REMOVED*** 11.2 Resource Limits

```python
***REMOVED*** Rate limiting for expensive operations
from app.core.rate_limit import RateLimiter

@router.post("/api/v1/thermo/anneal")
@RateLimiter(max_calls=5, time_window=3600)  ***REMOVED*** 5 per hour
async def anneal_schedule(...):
    pass

@router.post("/api/v1/thermo/ensemble")
@RateLimiter(max_calls=2, time_window=3600)  ***REMOVED*** 2 per hour
async def generate_ensemble(...):
    pass
```

***REMOVED******REMOVED******REMOVED*** 11.3 Authentication & Authorization

- All endpoints require authentication
- Configuration endpoints (GET/PUT `/config`) require Admin role
- Ensemble generation limited to Coordinator+ roles

***REMOVED******REMOVED******REMOVED*** 11.4 Data Privacy
...
***REMOVED******REMOVED*** 12. Deployment Plan

***REMOVED******REMOVED******REMOVED*** 12.1 Phase 1: Core Implementation (Week 1-2)
...
***REMOVED******REMOVED******REMOVED*** 12.2 Phase 2: API Endpoints (Week 3)
...
***REMOVED******REMOVED******REMOVED*** 12.3 Phase 3: Entropy Monitoring (Week 4)
...
***REMOVED******REMOVED******REMOVED*** 12.4 Phase 4: Ensemble Generation (Week 5)
...
***REMOVED******REMOVED******REMOVED*** 12.5 Phase 5: Hybrid & Optimization (Week 6)
...
***REMOVED******REMOVED******REMOVED*** 12.6 Phase 6: Documentation & Rollout (Week 7-8)
...
***REMOVED******REMOVED*** Appendix A: File Structure

```
backend/app/
├── scheduling/
│   ├── solvers/
│   │   ├── simulated_annealing.py    ***REMOVED*** NEW: SA solver
│   │   └── hybrid_thermo.py          ***REMOVED*** NEW: Hybrid CP-SAT + SA
│   ├── thermodynamics/               ***REMOVED*** NEW: Thermodynamics module
│   │   ├── __init__.py
│   │   ├── free_energy.py            ***REMOVED*** Free energy calculator
│   │   ├── entropy.py                ***REMOVED*** Entropy monitor
│   │   ├── cooling.py                ***REMOVED*** Cooling schedules
│   │   ├── landscape.py              ***REMOVED*** Energy landscape analyzer
│   │   └── ensemble.py               ***REMOVED*** Ensemble generator
│   └── optimizer.py                  ***REMOVED*** UPDATED: Add SA to selection
│
├── api/routes/
│   └── thermodynamics.py             ***REMOVED*** NEW: API endpoints
│
├── schemas/
│   └── thermodynamics.py             ***REMOVED*** NEW: Pydantic schemas
│
├── models/
│   ├── entropy_history.py            ***REMOVED*** NEW: Entropy tracking model
│   ├── energy_landscape.py           ***REMOVED*** NEW: Landscape analysis model
│   └── ensemble.py                   ***REMOVED*** NEW: Ensemble model
│
└── tests/
    ├── thermodynamics/               ***REMOVED*** NEW: Unit tests
    ...
    │   └── test_ensemble.py
    ├── integration/
    │   └── test_thermodynamic_api.py ***REMOVED*** NEW: Integration tests
    ├── performance/
    │   └── test_sa_performance.py    ***REMOVED*** NEW: Performance tests
    └── benchmarks/
        └── thermodynamic_benchmarks.py ***REMOVED*** NEW: Benchmarks
```

---

***REMOVED******REMOVED*** Appendix B: Dependencies

**Add to `backend/requirements.txt`:**

```
***REMOVED*** Already included (no new dependencies needed):
numpy>=1.24.0
scipy>=1.11.0

***REMOVED*** Optional for advanced features:
matplotlib>=3.7.0  ***REMOVED*** For energy landscape visualization
```
...
***REMOVED******REMOVED*** Appendix C: Monitoring & Alerts
