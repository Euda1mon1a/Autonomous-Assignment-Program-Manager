...
***REMOVED******REMOVED*** The Test

***REMOVED******REMOVED******REMOVED*** Phase 1: Detection (Simple)
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Interpretation (Cascade)
...
***REMOVED******REMOVED*** The Aberrant Sentence Explained
...
***REMOVED******REMOVED*** Running the Test
...
***REMOVED******REMOVED*** First Test Results
