...
| MUST | `TODO.md` (root) | Prioritized actionable work backlog (P0-P3) |
...
| `planning/` | Roadmaps, strategic plans, MCP planning | ~10 |
...
- `docs/operations/` — Ops runbooks, deployment, monitoring, CI/CD, playbooks (~37 files)
...
- `docs/archived/prompts/` — Experimental AI prompt templates
