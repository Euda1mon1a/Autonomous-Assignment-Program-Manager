***REMOVED*** Skill-Based Zone Self-Sufficiency Design
...
***REMOVED******REMOVED******REMOVED*** The Warm Body Fallacy: A Concrete Example
...
***REMOVED******REMOVED******REMOVED*** Existing Code
...
***REMOVED******REMOVED******REMOVED*** What's Currently Tracked
...
***REMOVED******REMOVED*** Related Existing Code
...
***REMOVED******REMOVED******REMOVED*** Hub Analysis Module
...
***REMOVED******REMOVED******REMOVED*** 5a. Data Model Changes
...
class SchedulingZone:
    ...
    ***REMOVED*** NEW: Critical skills required for zone operation
    critical_skills: dict[str, int] = field(default_factory=dict)
    ***REMOVED*** Key: skill identifier (e.g., "ob_supervision")
    ***REMOVED*** Value: minimum number of providers required
    ***REMOVED*** Example: {"ob_supervision": 1, "icu_procedures": 2, "trauma": 1}

@dataclass
class ZoneFacultyAssignment:
    ***REMOVED*** ... existing fields ...

    ***REMOVED*** NEW: Skills this faculty member can provide
    skills: list[str] = field(default_factory=list)
    ***REMOVED*** List of skill identifiers this person is credentialed/qualified to perform
    ***REMOVED*** Example: ["ob_supervision", "clinic_supervision", "code_team_leader"]
```
...
***REMOVED******REMOVED******REMOVED*** 5b. Enhanced Self-Sufficiency Check
...
def is_self_sufficient(self) -> bool:
    ...
    """
    ***REMOVED*** Check total headcount (existing logic)
    if self.get_total_available() < self.minimum_coverage:
        return False

    ***REMOVED*** Check critical skills coverage (NEW)
...
***REMOVED******REMOVED******REMOVED*** 5c. Enhanced Status Calculation
...
def calculate_status(self) -> ZoneStatus:
    ...
    Returns:
        Current zone status
    """
    ***REMOVED*** ... existing capacity checks ...

    ***REMOVED*** Check skill gaps (NEW)
    skill_gaps = self._check_skill_gaps()

    if not skill_gaps:
        ***REMOVED*** No skill gaps, use traditional headcount-based status
        return self._calculate_headcount_status()

    ***REMOVED*** Analyze skill gap severity
    ...
    if complete_gaps:
        ***REMOVED*** Complete absence of critical skill = RED
        return ZoneStatus.RED
    elif len(partial_gaps) >= 2:
        ***REMOVED*** Multiple partial gaps = ORANGE
        return ZoneStatus.ORANGE
    elif partial_gaps:
        ***REMOVED*** Single partial gap = YELLOW
...
***REMOVED******REMOVED*** Integration with Hub Analysis
        ...
        ***REMOVED*** Find qualified trainers
        ...
        recommendations.append(
            CrossTrainingRecommendation(
                ...
                suggested_trainees=candidates[:2],  ***REMOVED*** Top 2 candidates
...
***REMOVED******REMOVED*** Zone Health Report Enhancement
...
class ZoneHealthReport:
    ...
    ***REMOVED*** List of skill deficits, format:
    ***REMOVED*** [{"skill": "ob_supervision", "required": 1, "available": 0, "missing": 1}]

    skill_coverage_rate: float
    ***REMOVED*** Percentage of critical skills adequately covered (0.0 - 1.0)
    ***REMOVED*** Formula: (skills_with_adequate_coverage / total_critical_skills)

    skill_details: dict[str, dict]
    ***REMOVED*** Detailed skill coverage info:
    ***REMOVED*** {
    ***REMOVED***     "ob_supervision": {
    ***REMOVED***         "required": 1,
    ***REMOVED***         "available": 0,
    ***REMOVED***         "providers": [],
    ***REMOVED***         "status": "CRITICAL"
    ***REMOVED***     }
    ***REMOVED*** }
...
def generate_health_report(self) -> ZoneHealthReport:
    ...
    ***REMOVED*** Calculate skill coverage rate
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Data Model Enhancement (Backward Compatible)
**Timeline**: Sprint 1
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Configuration Population
**Timeline**: Sprint 2
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Faculty Skill Tracking
**Timeline**: Sprint 3
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Skill-Based Self-Sufficiency
**Timeline**: Sprint 4
...
***REMOVED******REMOVED******REMOVED*** Inpatient Zone
```python
critical_skills = {
    "icu_attending": 1,           ***REMOVED*** At least 1 ICU-qualified attending
    "procedure_supervision": 1,    ***REMOVED*** At least 1 procedure supervisor
    "code_team_leader": 1,         ***REMOVED*** At least 1 code team leader
}

***REMOVED*** Example faculty in this zone:
faculty = [
...
***REMOVED*** Status: GREEN (all skills covered)
```

***REMOVED******REMOVED******REMOVED*** Outpatient Zone
```python
critical_skills = {
    "clinic_supervision": 2,      ***REMOVED*** At least 2 clinic supervisors
    "precepting": 2,              ***REMOVED*** At least 2 faculty who can precept
}

***REMOVED*** Example scenario with skill gap:
faculty = [
    ZoneFacultyAssignment(
        faculty_id="F010",
        name="Dr. Wilson",
    ...
    ZoneFacultyAssignment(
        ...
        role="primary",
        available=True,
        skills=["precepting"]  ***REMOVED*** Missing clinic_supervision
    )
]
***REMOVED*** Status: ORANGE (headcount OK, but clinic_supervision gap)
```

***REMOVED******REMOVED******REMOVED*** Education Zone
```python
critical_skills = {
    "simulation_instructor": 1,    ***REMOVED*** At least 1 sim instructor
    "didactics_faculty": 1,        ***REMOVED*** At least 1 didactics-qualified faculty
    "curriculum_development": 1,   ***REMOVED*** At least 1 curriculum developer
}

***REMOVED*** High-functioning zone example:
faculty = [
    ZoneFacultyAssignment(
        faculty_id="F020",
        name="Dr. Martinez",
...
***REMOVED*** Status: GREEN (all skills well-covered)
```

***REMOVED******REMOVED******REMOVED*** Emergency Department Zone
```python
critical_skills = {
    "trauma_team_leader": 1,       ***REMOVED*** At least 1 trauma leader
    "pediatric_resuscitation": 1,  ***REMOVED*** At least 1 PALS-qualified
    "ultrasound_supervision": 1,   ***REMOVED*** At least 1 ultrasound supervisor
    "toxicology_consult": 1,       ***REMOVED*** At least 1 tox specialist
}

***REMOVED*** Demonstration of the "Warm Body Fallacy":
faculty = [
    ...
    ZoneFacultyAssignment(faculty_id="F032", name="Dr. Black",
                         ...
                         skills=[])  ***REMOVED*** No critical skills
]
***REMOVED*** OLD LOGIC: GREEN (3 faculty, minimum 2)
***REMOVED*** NEW LOGIC: RED (missing trauma_team_leader and toxicology_consult)
```

***REMOVED******REMOVED*** Testing Strategy

***REMOVED******REMOVED******REMOVED*** Unit Tests: Skill-Based Self-Sufficiency
...
def test_is_self_sufficient_with_skill_gaps():
    ...
    zone.primary = [
        ZoneFacultyAssignment(
            ...
            available=True, skills=[]  ***REMOVED*** No OB skill
        ),
        ZoneFacultyAssignment(
...
***REMOVED******REMOVED******REMOVED*** Unit Tests: Skill-Based Status Calculation
...
def test_calculate_status_partial_skill_gap():
    ...
    zone = SchedulingZone(
        name="Test Zone",
        minimum_coverage=2,
        critical_skills={"icu": 2}  ***REMOVED*** Need 2, have 1
    )
    zone.primary = [
        ZoneFacultyAssignment(
            faculty_id="F1", name="Dr. A", role="primary",
...
def test_hub_analyzer_integration():
    ...
    ***REMOVED*** Verify recommendation targets the gap
    assert len(recommendations) == 1
    assert recommendations[0].skill == "ultrasound"
    assert recommendations[0].priority == "HIGH"
```

***REMOVED******REMOVED******REMOVED*** Regression Tests: Backward Compatibility
...
def test_backward_compatibility_no_critical_skills():
    ...
    zone = SchedulingZone(
        name="Test Zone",
        minimum_coverage=2,
        critical_skills={}  ***REMOVED*** No critical skills defined
    )
    zone.primary = [
        ZoneFacultyAssignment(
            faculty_id="F1", name="Dr. A", role="primary",
    ...
    ***REMOVED*** Should be self-sufficient based on headcount alone
    assert zone.is_self_sufficient()
...
def test_backward_compatibility_no_faculty_skills():
    ...
    zone.primary = [
        ZoneFacultyAssignment(
            faculty_id="F1", name="Dr. A", role="primary",
            available=True
            ***REMOVED*** skills field not set (defaults to empty list)
        ),
        ZoneFacultyAssignment(
            faculty_id="F2", name="Dr. B", role="primary",
            available=True
            ***REMOVED*** skills field not set
        )
    ]

    ***REMOVED*** During migration, should gracefully handle missing skill data
    assert not zone.is_self_sufficient()  ***REMOVED*** Skill gap detected
```
...
def test_performance_large_zone():
    ...
    zone = SchedulingZone(
        name="Large Zone",
        minimum_coverage=10,
        critical_skills={f"skill_{i}": 1 for i in range(20)}  ***REMOVED*** 20 skills
    )

    ***REMOVED*** Add 100 faculty members
    for i in range(100):
        zone.primary.append(
            ZoneFacultyAssignment(
                faculty_id=f"F{i}",
                ...
                role="primary",
                available=True,
                skills=[f"skill_{i % 20}"]  ***REMOVED*** Distribute skills
            )
        )
    ...
    assert duration < 0.1  ***REMOVED*** Should complete in < 100ms
    assert result is True
```

***REMOVED******REMOVED*** Success Metrics

***REMOVED******REMOVED******REMOVED*** Primary Objective: Eliminate False Positives
...
***REMOVED******REMOVED******REMOVED*** Secondary Objective: Improve Cross-Training Targeting
...
***REMOVED******REMOVED******REMOVED*** Tertiary Objective: Accurate Capability Reporting
...
***REMOVED******REMOVED******REMOVED*** System Reliability
...
***REMOVED******REMOVED*** Appendix: Skill Taxonomy Examples

To ensure consistency, define a standardized skill catalog:

***REMOVED******REMOVED******REMOVED*** Clinical Skills
...
***REMOVED******REMOVED******REMOVED*** Supervision Skills
...
***REMOVED******REMOVED******REMOVED*** Education Skills
...
***REMOVED******REMOVED******REMOVED*** Administrative Skills
