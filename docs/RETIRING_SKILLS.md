***REMOVED*** Retiring Skills - Deprecation and Archival Procedures
...
1. [When to Retire a Skill](***REMOVED***when-to-retire-a-skill)
2. [Deprecation Markers and Warnings](***REMOVED***deprecation-markers-and-warnings)
3. [Migration Path Documentation](***REMOVED***migration-path-documentation)
4. [Archive Location and Structure](***REMOVED***archive-location-and-structure)
5. [GitHub Issue Template for Retirement](***REMOVED***github-issue-template-for-retirement)
6. [Grace Period and Timeline](***REMOVED***grace-period-and-timeline)
7. [Removal Process](***REMOVED***removal-process)
8. [Example: Retiring OLD_COMPLIANCE_CHECKER](***REMOVED***example-retiring-old_compliance_checker)
9. [Post-Retirement Monitoring](***REMOVED***post-retirement-monitoring)

---

***REMOVED******REMOVED*** When to Retire a Skill

***REMOVED******REMOVED******REMOVED*** Retirement Criteria

Retire a skill when ANY of these conditions are met:

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Superseded by Better Skill
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. No Usage in Extended Period
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Functionality Moved to Core System
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Policy or Technology Obsolete
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Security or Compliance Risk
...
***REMOVED******REMOVED******REMOVED*** Retirement Decision Matrix
...
***REMOVED******REMOVED*** Deprecation Markers and Warnings

***REMOVED******REMOVED******REMOVED*** Phase 1: Deprecation Announcement

**When:** As soon as retirement decision made

**What to update:**

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. SKILL.md - Add Deprecation Notice
...
***REMOVED*** ⚠️ DEPRECATED: old-compliance-checker
...
***REMOVED*** old-compliance-checker Skill (Deprecated)

[Rest of skill documentation...]
```

***REMOVED******REMOVED******REMOVED******REMOVED*** 2. CORE/SKILL.md - Mark as Deprecated

Update skill registry with deprecation warning:

```markdown
***REMOVED******REMOVED******REMOVED*** G. Deprecated Skills (Do Not Use)

***REMOVED******REMOVED******REMOVED******REMOVED*** 99. Old Compliance Checker (`old-compliance-checker`) ⚠️ DEPRECATED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Routing Logic - Add Deprecation Warning
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Runtime Warnings (if skill invoked)

**Implement deprecation warning in skill invocation:**

```python
***REMOVED*** .claude/skills/old-compliance-checker/SKILL.md (execution wrapper)
...
def invoke_skill():
    ***REMOVED*** Check if past sunset date
    ...
    ***REMOVED*** Issue warning
    warnings.warn(DEPRECATION_MESSAGE, DeprecationWarning, stacklevel=2)

    ***REMOVED*** Continue with skill execution (until sunset)
    ...
```

***REMOVED******REMOVED******REMOVED*** Phase 3: Communication

**Announce deprecation to all agents:**

```markdown
***REMOVED******REMOVED*** Deprecation Notice: old-compliance-checker
...
***REMOVED******REMOVED******REMOVED*** Replacement
...
***REMOVED******REMOVED******REMOVED*** Migration Guide
...
***REMOVED******REMOVED*** Migration Path Documentation

***REMOVED******REMOVED******REMOVED*** Migration Guide Template

Create comprehensive migration guide in `docs/skills/migration/`:

```markdown
***REMOVED*** Migration Guide: old-compliance-checker → COMPLIANCE_VALIDATION
...
***REMOVED******REMOVED*** Step-by-Step Migration

***REMOVED******REMOVED******REMOVED*** Step 1: Update Skill Invocation
...
***REMOVED*** Use workflow instead of direct function call
...
***REMOVED******REMOVED******REMOVED*** Step 2: Update Output Parsing
...
if result.overall_status == "VIOLATION":
    ...
    ***REMOVED*** Get remediation guidance (new feature!)
    for recommendation in result.recommendations:
        print(f"→ {recommendation}")
```

***REMOVED******REMOVED******REMOVED*** Step 3: Follow New Workflows
...
***REMOVED******REMOVED******REMOVED*** Step 4: Update Error Handling
...
**After (COMPLIANCE_VALIDATION):**
```python
***REMOVED*** New skill returns violations instead of throwing exceptions
...
if result is None:
    ...
    ***REMOVED*** Process violations
    process_violations(result)
```

***REMOVED******REMOVED******REMOVED*** Step 5: Update Integration Points
...
```bash
***REMOVED*** Find any remaining old-compliance-checker references
grep -r "old-compliance-checker" .claude/ backend/ frontend/

***REMOVED*** Should return zero results after migration
```
...
***REMOVED******REMOVED*** Help & Support

**Questions?**
- Contact META_UPDATER agent
- GitHub issue: [***REMOVED***XXX - old-compliance-checker migration support](https://github.com/...)
...
***REMOVED******REMOVED*** Archive Location and Structure

***REMOVED******REMOVED******REMOVED*** Archive Directory

```
.claude/skills/ARCHIVE/
├── README.md                           ***REMOVED*** Archive index
├── old-compliance-checker/             ***REMOVED*** Archived skill
│   ├── RETIREMENT_NOTICE.md            ***REMOVED*** Why retired, when, replacement
│   ├── SKILL.md                        ***REMOVED*** Original skill spec (frozen)
│   ├── Workflows/                      ***REMOVED*** Original workflows (if any)
│   └── Reference/                      ***REMOVED*** Original reference docs (if any)
├── legacy-pdf-generator/               ***REMOVED*** Another archived skill
...
└── covid-rotation-handler/
    ...
    ├── SKILL.md
    └── Reference/
        └── covid-policies-2020-2023.md  ***REMOVED*** Historical reference
```

***REMOVED******REMOVED******REMOVED*** Archive Index (README.md)

```markdown
***REMOVED*** Skill Archive
...
***REMOVED******REMOVED*** Archived Skills
...
***REMOVED******REMOVED*** Why Archive Instead of Delete?
...
***REMOVED******REMOVED*** Accessing Archived Skills
...
```bash
***REMOVED*** Copy from archive back to active skills
cp -r .claude/skills/ARCHIVE/old-compliance-checker .claude/skills/

***REMOVED*** Update CORE/SKILL.md to re-register

***REMOVED*** Create GitHub issue documenting why restoration needed
```

---

***REMOVED******REMOVED*** Retention Policy
...
***REMOVED******REMOVED******REMOVED*** Retirement Notice Template

Create `RETIREMENT_NOTICE.md` for each archived skill:

```markdown
***REMOVED*** Retirement Notice: old-compliance-checker

---

***REMOVED******REMOVED*** Retirement Summary
...
***REMOVED******REMOVED*** Reason for Retirement
...
***REMOVED******REMOVED******REMOVED*** Peak Usage
**Date:** 2024-06 (78 invocations/month)
**Primary User:** SCHEDULER agent

***REMOVED******REMOVED******REMOVED*** Decline
...
***REMOVED******REMOVED******REMOVED*** Applied to COMPLIANCE_VALIDATION
...
***REMOVED******REMOVED*** Preserved Artifacts
...
***REMOVED******REMOVED*** Emergency Restoration
...
***REMOVED******REMOVED*** GitHub Issue Template for Retirement

***REMOVED******REMOVED******REMOVED*** Issue Title

```
[RETIREMENT] Deprecate and retire [SKILL_NAME] by [SUNSET_DATE]
```

***REMOVED******REMOVED******REMOVED*** Issue Template

```markdown
***REMOVED******REMOVED*** Skill Retirement Proposal
...
***REMOVED******REMOVED*** Retirement Rationale
...
| [YYYY-MM-DD+14] | Reminder ***REMOVED***1 | Check migration progress, offer support |
| [YYYY-MM-DD+28] | Reminder ***REMOVED***2 | Final warning, escalate if needed |
...
***REMOVED******REMOVED*** Deprecation Checklist
...
- [ ] Send reminder ***REMOVED***1 (14 days before sunset)
- [ ] Send reminder ***REMOVED***2 (28 days before sunset)
- [ ] Send final warning (42 days before sunset)

***REMOVED******REMOVED******REMOVED*** Migration Support
- [ ] Migration guide complete and tested
- [ ] Affected agents contacted
- [ ] Migration support available (META_UPDATER)
- [ ] Track migration progress (GitHub project board)

***REMOVED******REMOVED******REMOVED*** Pre-Retirement Verification
...
***REMOVED******REMOVED*** Approval Required
...
***REMOVED******REMOVED*** Grace Period and Timeline

***REMOVED******REMOVED******REMOVED*** Standard Timeline (Non-Emergency)
...
***REMOVED******REMOVED******REMOVED*** Emergency Timeline (Security Risk)
...
***REMOVED******REMOVED******REMOVED*** Extension Policy
...
***REMOVED******REMOVED*** Removal Process

***REMOVED******REMOVED******REMOVED*** Step 1: Final Verification (Day 42)

```bash
***REMOVED*** Check for recent invocations
python scripts/check_skill_usage.py --skill old-compliance-checker --days 7

***REMOVED*** Expected output: 0 invocations
```

```bash
***REMOVED*** Search codebase for references
grep -r "old-compliance-checker" .claude/ backend/ frontend/

***REMOVED*** Expected output: None (or only in migration guide / archive)
```

```bash
***REMOVED*** Check test files
grep -r "old-compliance-checker" backend/tests/ frontend/__tests__/

***REMOVED*** Expected output: None
```
...
***REMOVED******REMOVED******REMOVED*** Step 2: Move to Archive (Day 45)

```bash
***REMOVED*** Create archive directory if not exists
mkdir -p .claude/skills/ARCHIVE/old-compliance-checker

***REMOVED*** Move skill directory
mv .claude/skills/old-compliance-checker/* .claude/skills/ARCHIVE/old-compliance-checker/

***REMOVED*** Create RETIREMENT_NOTICE.md
...
***REMOVED*** Remove original directory
rmdir .claude/skills/old-compliance-checker
```

***REMOVED******REMOVED******REMOVED*** Step 3: Update CORE/SKILL.md

**Remove from active skills list:**
```markdown
***REMOVED*** BEFORE
***REMOVED******REMOVED******REMOVED******REMOVED*** 15. Old Compliance Checker (`old-compliance-checker`)
...

***REMOVED*** AFTER (moved to Deprecated Skills section)
***REMOVED******REMOVED******REMOVED*** G. Deprecated Skills (Archived)

***REMOVED******REMOVED******REMOVED******REMOVED*** old-compliance-checker ⚠️ RETIRED 2025-03-01
**Replacement:** COMPLIANCE_VALIDATION
...
***REMOVED******REMOVED******REMOVED*** Step 4: Update Documentation

```bash
***REMOVED*** Update migration guide (mark as complete)
echo "Migration complete: 2025-03-01" >> docs/skills/migration/old-to-new-compliance.md

***REMOVED*** Update CHANGELOG
echo "- RETIRED: old-compliance-checker skill (replaced by COMPLIANCE_VALIDATION)" >> CHANGELOG.md
```

***REMOVED******REMOVED******REMOVED*** Step 5: Create Retirement PR

```markdown
***REMOVED******REMOVED*** Retirement PR: old-compliance-checker
...
**Verification:**
```bash
***REMOVED*** No recent invocations
python scripts/check_skill_usage.py --skill old-compliance-checker --days 7
***REMOVED*** Output: 0 invocations

***REMOVED*** No codebase references
grep -r "old-compliance-checker" .claude/ backend/ frontend/
***REMOVED*** Output: None (except in ARCHIVE/)
```
...
***REMOVED******REMOVED******REMOVED*** Step 6: Merge and Announce

```bash
***REMOVED*** Merge retirement PR
gh pr merge [PR-number] --squash --delete-branch

***REMOVED*** Tag retirement
...
***REMOVED*** Post retirement announcement
...
***REMOVED*** Close retirement issue
gh issue close [retirement-issue]
```

---

***REMOVED******REMOVED*** Example: Retiring OLD_COMPLIANCE_CHECKER

***REMOVED******REMOVED******REMOVED*** Complete Walkthrough

***REMOVED******REMOVED******REMOVED******REMOVED*** Day 0: Deprecation Decision (2025-01-15)

**Trigger:** Weekly scan detects 95% of compliance validation now uses COMPLIANCE_VALIDATION

**Analysis:**
```python
***REMOVED*** Usage comparison
old_skill_invocations = 2  ***REMOVED*** Past 30 days
new_skill_invocations = 87  ***REMOVED*** Past 30 days

migration_percentage = new_skill_invocations / (old_skill_invocations + new_skill_invocations)
***REMOVED*** Result: 97.8% migrated

***REMOVED*** Decision: Retire old-compliance-checker
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Day 0: Deprecation Markers Added
...
```markdown
***REMOVED******REMOVED******REMOVED*** G. Deprecated Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** old-compliance-checker ⚠️ DEPRECATED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Day 0: Announcement Posted

```markdown
***REMOVED******REMOVED*** Deprecation Announcement: old-compliance-checker
...
- 2025-01-29: Reminder ***REMOVED***1 (14 days)
- 2025-02-12: Reminder ***REMOVED***2 (28 days)
- 2025-03-01: Skill removed (45 days)

**Questions?** Contact META_UPDATER
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Day 14: Reminder ***REMOVED***1 (2025-01-29)

**Check migration progress:**
```python
invocations_past_7_days = check_skill_usage("old-compliance-checker", days=7)
***REMOVED*** Result: 1 invocation

***REMOVED*** Identify agent still using old skill
last_user = get_last_skill_user("old-compliance-checker")
***REMOVED*** Result: QA_TESTER (1 invocation on 2025-01-27)
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Day 28: Reminder ***REMOVED***2 (2025-02-12)

**Check migration progress:**
```python
invocations_past_7_days = check_skill_usage("old-compliance-checker", days=7)
***REMOVED*** Result: 0 invocations ✅
```

**Send final warning:**
```markdown
***REMOVED******REMOVED*** Final Reminder: old-compliance-checker Retirement
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Day 42: Pre-Retirement Check (2025-02-26)

**Final verification:**
```bash
***REMOVED*** Check invocations
python scripts/check_skill_usage.py --skill old-compliance-checker --days 7
***REMOVED*** Output: 0 invocations ✅

***REMOVED*** Search codebase
grep -r "old-compliance-checker" .claude/ backend/ frontend/
***REMOVED*** Output:
***REMOVED***   docs/skills/migration/old-to-new-compliance.md (migration guide - OK)
***REMOVED***   CHANGELOG.md (deprecation notice - OK)
***REMOVED*** ✅ No active references

***REMOVED*** Check tests
grep -r "old-compliance-checker" backend/tests/ frontend/__tests__/
***REMOVED*** Output: None ✅

***REMOVED*** Verify replacement skill works
python scripts/test_skill.py --skill COMPLIANCE_VALIDATION
***REMOVED*** Output: All tests passed ✅
```

**Approval:**
```markdown
***REMOVED******REMOVED*** Pre-Retirement Approval Request
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Day 45: Retirement Execution (2025-03-01)

**Execute retirement:**
```bash
***REMOVED*** Move to archive
mkdir -p .claude/skills/ARCHIVE/old-compliance-checker
mv .claude/skills/old-compliance-checker/* .claude/skills/ARCHIVE/old-compliance-checker/
rmdir .claude/skills/old-compliance-checker
...
***REMOVED*** Update CORE/SKILL.md
***REMOVED*** (Remove from active skills, add to deprecated section)

***REMOVED*** Update CHANGELOG
echo "- RETIRED: old-compliance-checker (replaced by COMPLIANCE_VALIDATION)" >> CHANGELOG.md

***REMOVED*** Create retirement PR
...
```markdown
***REMOVED******REMOVED*** Retirement Complete: old-compliance-checker
...
***REMOVED******REMOVED*** Post-Retirement Monitoring

***REMOVED******REMOVED******REMOVED*** Week 1: Monitor for Errors

**Check for attempts to invoke retired skill:**
```bash
***REMOVED*** Monitor logs for old skill references
...
***REMOVED******REMOVED******REMOVED*** Month 1: Verify Replacement Adoption
...
***REMOVED******REMOVED******REMOVED*** Quarter 1: Lessons Learned

**Retrospective:**
```markdown
***REMOVED******REMOVED*** Retirement Retrospective: old-compliance-checker
...
***REMOVED******REMOVED******REMOVED*** Lessons for Future Retirements
...
***REMOVED******REMOVED******REMOVED*** Retention Review (Annual)

**Check if archived skills can be purged:**
```markdown
***REMOVED******REMOVED*** Archive Retention Review - 2026-03-01
...
***REMOVED******REMOVED*** Summary: Skill Retirement Lifecycle
...
3. Migration Support (Days 0-45)
   ├─ Day 14: Reminder ***REMOVED***1, check progress
   ├─ Day 28: Reminder ***REMOVED***2, final warning
