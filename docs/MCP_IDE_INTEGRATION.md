***REMOVED*** MCP IDE Integration Guide
...
> see [Choosing Your Claude Interface](./guides/AI_AGENT_USER_GUIDE.md***REMOVED***choosing-your-claude-interface).
...
***REMOVED******REMOVED******REMOVED*** VSCode Configuration Files
...
***REMOVED******REMOVED******REMOVED*** Zed Configuration Files
...
***REMOVED******REMOVED******REMOVED*** Option B: Local Python (Alternative)
...
2. **Configure Environment Variables**
   ```bash
   cp .env.example .env
   nano .env  ***REMOVED*** Set API_BASE_URL=http://localhost:8000
   ```
...
***REMOVED******REMOVED******REMOVED*** Using in VSCode
...
***REMOVED******REMOVED******REMOVED*** Using in Zed
...
***REMOVED******REMOVED******REMOVED*** Using with Claude Code CLI
...
***REMOVED******REMOVED*** MCP Server Capabilities

***REMOVED******REMOVED******REMOVED*** Resources (Read-Only Data Access)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `schedule://compliance`
...
***REMOVED******REMOVED******REMOVED*** Tools (Active Operations)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `run_contingency_analysis_tool`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `analyze_swap_candidates_tool`
...
***REMOVED******REMOVED******REMOVED*** Claude Code Configuration (`.mcp.json`)
...
***REMOVED******REMOVED******REMOVED*** VSCode Configuration (`.vscode/mcp.json`)
...
***REMOVED******REMOVED******REMOVED*** Zed Configuration (`.zed/mcp.json`)
...
***REMOVED******REMOVED******REMOVED*** Built-in Protection
...
3. **Review MCP logs regularly**
   ```bash
   tail -f .vscode/mcp.log  ***REMOVED*** VSCode
   tail -f .zed/mcp.log     ***REMOVED*** Zed
   ```

4. **Enable audit logging**
   ```bash
   ***REMOVED*** In .env
   LOG_LEVEL=INFO  ***REMOVED*** or DEBUG for detailed logs
   ```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Server Won't Start
...
***REMOVED******REMOVED******REMOVED******REMOVED*** No Data Returned
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Connection Timeouts
...
3. **Server Logs**:
   ...
   ***REMOVED*** Server output (if running manually)
...
***REMOVED******REMOVED******REMOVED*** Example 1: Check Schedule Status
...
***REMOVED******REMOVED******REMOVED*** Example 2: Validate ACGME Compliance
...
***REMOVED******REMOVED******REMOVED*** Example 3: Analyze Absence Impact
...
***REMOVED******REMOVED******REMOVED*** Example 4: Find Swap Matches
...
***REMOVED******REMOVED******REMOVED*** IDE Features Enabled

***REMOVED******REMOVED******REMOVED******REMOVED*** VSCode
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Zed
...
***REMOVED******REMOVED******REMOVED*** Recommended Extensions (VSCode)
...
***REMOVED******REMOVED******REMOVED*** For System Administrators
...
***REMOVED******REMOVED******REMOVED*** For AI Assistant Users
...
***REMOVED******REMOVED*** Claude Code Specific Resources
...
***REMOVED******REMOVED******REMOVED*** External Links
