***REMOVED*** Schedule Swap System

***REMOVED******REMOVED*** Overview

The schedule swap system allows residents and faculty to exchange scheduled assignments while maintaining coverage requirements and ACGME compliance. The system provides automated matching, validation, and approval workflows to facilitate swaps efficiently and safely.

***REMOVED******REMOVED*** Swap Types

***REMOVED******REMOVED******REMOVED*** One-to-One Swap

A **one-to-one swap** (also called a bilateral swap or trade) occurs when two individuals exchange scheduled assignments for mutual benefit.
...
***REMOVED******REMOVED******REMOVED*** Absorb Swap (Give-Away)

An **absorb swap** (also called a give-away or unilateral swap) occurs when one individual gives away a scheduled shift without receiving anything in return.
...
***REMOVED******REMOVED******REMOVED*** Partial Swap

A **partial swap** involves exchanging only part of a scheduled assignment rather than the entire rotation or shift.
...
***REMOVED******REMOVED*** Swap Request Process

***REMOVED******REMOVED******REMOVED*** Step 1: Initiate Swap Request
...
***REMOVED******REMOVED******REMOVED*** Step 2: Find a Swap Partner
...
- **Availability:** Who is scheduled on desired dates?
- **Qualifications:** Who has the required credentials for each rotation?
- **ACGME Compliance:** Who can accept the swap without violating duty hour limits?
- **Swap History:** Who has swapped with you before or owes/needs swaps?
- **Preferences:** Who has indicated interest in similar swaps?
...
***REMOVED******REMOVED******REMOVED*** Step 3: Partner Acceptance
...
***REMOVED******REMOVED******REMOVED*** Step 4: System Validation

Once both parties agree, the system automatically validates:

**ACGME Compliance Checks:**
- Would either party exceed 80 hours/week (4-week rolling average)?
- Would either party lose their 1 day off in 7 (4-week rolling average)?
- Is there adequate rest between shifts (10-hour minimum)?
- Would call frequency exceed every-3rd-night limit?
- For PGY-1: Would shift exceed 16-hour limit?

**Coverage Validation:**
- Does each rotation maintain minimum staffing levels?
- Are there overlapping assignments or conflicts?
- Are there any blocked-out periods (mandatory conferences, etc.)?

**Credential Validation:**
- Does each person have required certifications for the new assignment?
- Are immunizations current?
- Has required training been completed?
- Are privileges adequate for the rotation?
...
***REMOVED******REMOVED******REMOVED*** Step 5: Approval Workflow
...
***REMOVED******REMOVED******REMOVED*** Step 6: Execution and Notification
...
***REMOVED******REMOVED*** 24-Hour Rollback Window

***REMOVED******REMOVED******REMOVED*** Rollback Policy

All swaps include a **24-hour rollback window** (sometimes called a cooling-off period) during which either party can cancel the swap without penalty.
...
***REMOVED******REMOVED******REMOVED*** Emergency Cancellation
...
***REMOVED******REMOVED*** ACGME Compliance During Swaps

***REMOVED******REMOVED******REMOVED*** Pre-Swap Validation
...
***REMOVED******REMOVED******REMOVED*** Post-Swap Monitoring
...
***REMOVED******REMOVED******REMOVED*** Swap Violation Remediation
...
***REMOVED******REMOVED*** Swap History and Fairness

***REMOVED******REMOVED******REMOVED*** Tracking Swap Balance
...
***REMOVED******REMOVED******REMOVED*** Swap Frequency Limits
...
***REMOVED******REMOVED******REMOVED*** Red Flags and Monitoring
...
***REMOVED******REMOVED*** Best Practices for Requesting Swaps

***REMOVED******REMOVED******REMOVED*** Timing
...
***REMOVED******REMOVED******REMOVED*** Reciprocity
...
***REMOVED******REMOVED******REMOVED*** Professionalism
...
***REMOVED******REMOVED*** Technical Support and Troubleshooting
...
***REMOVED******REMOVED*** Swap System Benefits
...
- Better work-life balance supports patient safety
