***REMOVED*** ACGME Duty Hour Requirements
...
***REMOVED******REMOVED*** Maximum Work Hours

***REMOVED******REMOVED******REMOVED*** 80-Hour Maximum Work Week

Residents must not exceed **80 hours per week** of clinical and educational work, averaged over a **rolling 4-week period**. This is the most fundamental ACGME requirement and applies to all residency programs regardless of specialty.
...
All moonlighting (internal or external) must be counted toward the 80-hour weekly limit. Programs must have a policy for monitoring moonlighting hours and ensuring residents report these hours accurately.

***REMOVED******REMOVED*** Mandatory Time Off

***REMOVED******REMOVED******REMOVED*** One Day Off in Seven Rule
...
***REMOVED******REMOVED******REMOVED*** Minimum Rest Between Shifts

Residents must have a **minimum of 10 hours free from all duties** between scheduled clinical work and education periods.
...
***REMOVED******REMOVED*** Maximum Shift Length

***REMOVED******REMOVED******REMOVED*** Standard Shifts

For routine clinical duties, shifts should be designed to minimize fatigue and ensure resident alertness. While the ACGME does not specify a maximum for routine shifts other than the 80-hour weekly limit, programs must ensure schedules promote adequate rest.

***REMOVED******REMOVED******REMOVED*** Extended Duration and On-Call Activities
...
***REMOVED******REMOVED******REMOVED*** In-House Call Frequency
...
***REMOVED******REMOVED*** PGY-1 Specific Restrictions

First-year residents (PGY-1, also called interns) have additional protective restrictions:

***REMOVED******REMOVED******REMOVED*** Clinical Experience and Supervision Oversight
...
***REMOVED******REMOVED******REMOVED*** Enhanced Supervision Requirements
...
***REMOVED******REMOVED******REMOVED*** Faculty-to-Resident Ratios
...
***REMOVED******REMOVED******REMOVED*** Clinical Setting Variations
...
***REMOVED******REMOVED******REMOVED*** Program Responsibilities
...
***REMOVED******REMOVED******REMOVED*** Resident Responsibilities
...
***REMOVED******REMOVED******REMOVED*** Consequences of Non-Compliance
...
***REMOVED******REMOVED******REMOVED*** Backup Call
...
***REMOVED******REMOVED******REMOVED*** Strategic Patient Care
...
***REMOVED******REMOVED******REMOVED*** Transitions of Care
...
Handoffs are critical times that require structured communication protocols and dedicated time within the duty hour limits.

***REMOVED******REMOVED*** Integration with Scheduling Systems
...
***REMOVED******REMOVED******REMOVED*** Calculation Examples
...
***REMOVED******REMOVED*** Summary of Key Numbers
