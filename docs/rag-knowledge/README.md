...
***REMOVED******REMOVED*** Embedding Documents

***REMOVED******REMOVED******REMOVED*** Method 1: Using the initialization script (Recommended)
...
***REMOVED*** Clear and re-embed all
python scripts/init_rag_embeddings.py --clear-all
```

***REMOVED******REMOVED******REMOVED*** Method 2: Using Celery task
...
***REMOVED*** Trigger embedding task
result = refresh_single_document.delay("exotic-concepts.md")
```

***REMOVED******REMOVED******REMOVED*** Method 3: Using the RAG API endpoint

```bash
***REMOVED*** Assuming backend is running on localhost:8000
