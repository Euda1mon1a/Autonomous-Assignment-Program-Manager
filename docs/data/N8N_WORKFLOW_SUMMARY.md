***REMOVED*** n8n Cloud Workflow Summary
...
***REMOVED******REMOVED*** Master Orchestrator Architecture
...
***REMOVED******REMOVED******REMOVED*** Master Orchestrator
**ID:** `8NEHGi7nGpqOitME`
- Coordinates all phases
- Handles success/error branching
- Generates final report

***REMOVED******REMOVED******REMOVED*** Phase 2: Smart Resident Association (Absence-Aware)
**ID:** `DUVgfqE35w9Fteik`
...
***REMOVED******REMOVED*** Workflow Categories
...
***REMOVED******REMOVED*** Relevant for Local Implementation
