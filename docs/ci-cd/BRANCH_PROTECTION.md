***REMOVED*** Branch Protection Rules
...
2. [Protected Branches](***REMOVED***protected-branches)
3. [Required Status Checks](***REMOVED***required-status-checks)
4. [Review Requirements](***REMOVED***review-requirements)
5. [Merge Requirements](***REMOVED***merge-requirements)
6. [Branch Naming Conventions](***REMOVED***branch-naming-conventions)
7. [Exemptions](***REMOVED***exemptions)
8. [Configuration](***REMOVED***configuration)
...
***REMOVED******REMOVED*** Protected Branches

***REMOVED******REMOVED******REMOVED*** Main Branch (`main`)
...
***REMOVED******REMOVED******REMOVED*** Master Branch (`master`)

**Status:** Fully Protected (if exists)

**Same rules as `main`** (legacy support)

***REMOVED******REMOVED******REMOVED*** Develop Branch (`develop`)
...
***REMOVED******REMOVED******REMOVED*** Feature Branches (Non-protected)
...
***REMOVED******REMOVED*** Required Status Checks

***REMOVED******REMOVED******REMOVED*** All PRs Require These Checks

These checks must pass before a PR can be merged:

***REMOVED******REMOVED******REMOVED******REMOVED*** Hard Gates (Blocking)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Soft Gates (Informational)
...
***REMOVED******REMOVED******REMOVED*** Status Check Configuration
...
required_status_checks:
  strict: true  ***REMOVED*** Must be up to date with base branch
  contexts:
    ***REMOVED*** Linting
...
***REMOVED******REMOVED******REMOVED*** Local Pre-merge Verification
...
***REMOVED******REMOVED******REMOVED*** Approval Requirements
...
***REMOVED******REMOVED******REMOVED*** Who Can Approve

**Code Owners** (from `.github/CODEOWNERS`):

```
***REMOVED*** Core Backend
...
***REMOVED******REMOVED******REMOVED*** Large PR Handling
...
***REMOVED******REMOVED*** Merge Requirements

***REMOVED******REMOVED******REMOVED*** What Can Be Merged
...
***REMOVED******REMOVED******REMOVED*** Merge Options
...
***REMOVED******REMOVED*** Branch Naming Conventions

***REMOVED******REMOVED******REMOVED*** Branch Name Format
...
***REMOVED******REMOVED******REMOVED*** AI-Generated Branches
...
***REMOVED******REMOVED*** Exemptions

***REMOVED******REMOVED******REMOVED*** When to Bypass Protection
...
***REMOVED******REMOVED******REMOVED*** When Bypass Was Used
...
***REMOVED******REMOVED******REMOVED*** GitHub UI Setup
...
***REMOVED******REMOVED******REMOVED*** Terraform Configuration (If Using)
...
***REMOVED*** Check protection status
...
***REMOVED******REMOVED******REMOVED*** For Feature Developers

```bash
***REMOVED*** 1. Create feature branch
git checkout -b feat/my-feature

***REMOVED*** 2. Make changes and test locally
npm test        ***REMOVED*** Frontend
pytest          ***REMOVED*** Backend

***REMOVED*** 3. Verify pre-commit hooks pass
pre-commit run --all-files

***REMOVED*** 4. Push and create PR
git push origin feat/my-feature
***REMOVED*** Then create PR on GitHub

***REMOVED*** 5. Wait for CI to pass (green checks)

***REMOVED*** 6. Request review and get approval

***REMOVED*** 7. Merge when ready
```

***REMOVED******REMOVED******REMOVED*** For Code Reviewers

```bash
***REMOVED*** Review checklist
...
***REMOVED*** Approve (comment: "Approved!" or use GitHub approve)
```

***REMOVED******REMOVED******REMOVED*** For Release Manager

```bash
***REMOVED*** Merge to main
git checkout main
