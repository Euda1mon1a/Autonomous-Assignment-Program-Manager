...
console.log('%c🌺 Aloha! Welcome to Residency Scheduler Documentation',
  'background: linear-gradient(135deg, ***REMOVED***E57373, ***REMOVED***26A69A); color: white; padding: 10px 20px; border-radius: 8px; font-size: 14px; font-weight: bold;');
console.log('%cBuilt with care for healthcare professionals',
  'color: ***REMOVED***26A69A; font-size: 12px;');
