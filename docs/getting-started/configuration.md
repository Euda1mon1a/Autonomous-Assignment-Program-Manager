...
***REMOVED******REMOVED******REMOVED*** Application Settings
...
***REMOVED******REMOVED******REMOVED*** Redis & Celery
...
***REMOVED******REMOVED*** Resilience Framework Settings
...
***REMOVED******REMOVED*** Sample Configuration
...
***REMOVED*** CORS (allow all localhost)
...
***REMOVED******REMOVED*** Docker Compose Override
...
services:
  backend:
    environment:
      ...
      - LOG_LEVEL=DEBUG
    volumes:
      - ./backend:/app  ***REMOVED*** Hot reload
...
***REMOVED******REMOVED*** Configuration Validation
