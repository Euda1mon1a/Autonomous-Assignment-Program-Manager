***REMOVED*** Rotation Template GUI Implementation Plan
...
***REMOVED******REMOVED*** Phase 1: Backend Model Extensions

**Duration Estimate:** Medium complexity
**Dependencies:** None

***REMOVED******REMOVED******REMOVED*** 1.1 New Enums
...
class RotationPatternType(str, Enum):
    ...
    REGULAR = "regular"           ***REMOVED*** Full block, single activity
    SPLIT = "split"               ***REMOVED*** Two activities, fixed sequence
    MIRRORED_SPLIT = "mirrored"   ***REMOVED*** Two cohorts swap mid-block
    ALTERNATING = "alternating"   ***REMOVED*** A/B week pattern

class RotationSettingType(str, Enum):
    """Clinical setting for the rotation."""
    INPATIENT = "inpatient"       ***REMOVED*** 7-day coverage, ward-based
    OUTPATIENT = "outpatient"     ***REMOVED*** Weekday clinic, AM/PM flexible
...
class PreferenceWeight(str, Enum):
    ...
    MEDIUM = "medium"
    HIGH = "high"
    REQUIRED = "required"  ***REMOVED*** Soft but strongly enforced
```

***REMOVED******REMOVED******REMOVED*** 1.2 Extend RotationTemplate Model

**File:** `backend/app/models/rotation_template.py`

```python
***REMOVED*** Add new columns to existing RotationTemplate class

***REMOVED*** Pattern configuration
...
***REMOVED*** For split rotations - link to paired template
...
***REMOVED******REMOVED******REMOVED*** 1.3 New WeeklyPattern Model
...
class WeeklyPattern(Base):
    ...
    ***REMOVED*** Grid position (0=Sunday, 6=Saturday)
    ...
    ***REMOVED*** Activity assigned to this slot
    activity_type: Mapped[str] = mapped_column(
        String(50),
        comment="fm_clinic, specialty, elective, conference, off"
    )

    ***REMOVED*** Optional: link to specific sub-rotation template
    ...
    ***REMOVED*** Relationships
    ...
    __table_args__ = (
        ***REMOVED*** Unique constraint: one slot per day/time per template
        {"postgresql_partition_by": None},  ***REMOVED*** Future: consider partitioning
    )
...
***REMOVED******REMOVED******REMOVED*** 1.4 New RotationPreference Model
...
class RotationPreference(Base):
    ...
    ***REMOVED*** Flexible configuration as JSON
    ...
    ***REMOVED*** Is this preference currently active?
    is_active: Mapped[bool] = mapped_column(default=True)

    ***REMOVED*** Description for UI display
...
***REMOVED*** Preference type constants with default configs
PREFERENCE_DEFAULTS = {
    "full_day_grouping": {
    ...
    "preferred_days": {
        ...
        "config_schema": {
            "activity": "fm_clinic",
            "days": [1, 2, 5]  ***REMOVED*** Mon, Tue, Fri
        }
    },
    "avoid_friday_pm": {
...
***REMOVED******REMOVED******REMOVED*** 1.5 Alembic Migration
...
def upgrade() -> None:
    ***REMOVED*** Extend rotation_templates table
    ...
    ***REMOVED*** Add foreign key for paired template
    ...
    ***REMOVED*** Create weekly_patterns table
    op.create_table(
        'weekly_patterns',
    ...
    ***REMOVED*** Create rotation_preferences table
    op.create_table(
...
***REMOVED******REMOVED******REMOVED*** 1.6 Pydantic Schemas

**File:** `backend/app/schemas/rotation_template.py` (extend)

```python
***REMOVED*** Add to existing schemas
...
class RotationTemplateExtendedResponse(RotationTemplateResponse):
    ...
    ***REMOVED*** Computed fields
    half_day_summary: dict[str, int] | None = None  ***REMOVED*** {"fm_clinic": 4, "specialty": 3, ...}
...
***REMOVED******REMOVED******REMOVED*** 1.7 API Routes

**File:** `backend/app/api/routes/rotation_templates.py` (extend)

```python
***REMOVED*** Add new endpoints
...
***REMOVED******REMOVED*** Phase 2: Weekly Grid Editor Component

**Duration Estimate:** Medium-High complexity
**Dependencies:** Phase 1 (backend models)

***REMOVED******REMOVED******REMOVED*** 2.1 Component Structure

```
frontend/src/features/rotation-templates/
├── components/
│   ├── RotationTemplateEditor.tsx      ***REMOVED*** Main container/orchestrator
│   ├── WeeklyGridEditor.tsx            ***REMOVED*** 7x2 visual grid (core)
│   ├── GridCell.tsx                    ***REMOVED*** Individual AM/PM cell
│   ├── ActivityPicker.tsx              ***REMOVED*** Dropdown/popover for activity selection
│   ├── HalfDaySummary.tsx              ***REMOVED*** Real-time half-day counts
│   ├── SplitRotationConfig.tsx         ***REMOVED*** Split/mirrored configuration
│   ├── PreferencePanel.tsx             ***REMOVED*** Soft constraint toggles
│   ├── RotationTypeSelector.tsx        ***REMOVED*** Regular/Split/Mirrored tabs
│   ├── SettingTypeToggle.tsx           ***REMOVED*** Inpatient/Outpatient switch
│   ├── RotationPreview.tsx             ***REMOVED*** Multi-week preview
│   └── index.ts                        ***REMOVED*** Barrel exports
├── hooks/
│   ├── useRotationTemplate.ts          ***REMOVED*** CRUD operations
│   ├── useWeeklyGrid.ts                ***REMOVED*** Grid state management
│   ├── usePreferences.ts               ***REMOVED*** Preference management
│   └── useSplitRotation.ts             ***REMOVED*** Split rotation logic
├── types.ts                            ***REMOVED*** TypeScript interfaces
├── constants.ts                        ***REMOVED*** Activity types, colors, defaults
├── utils/
│   ├── gridHelpers.ts                  ***REMOVED*** Grid manipulation utilities
│   ├── validationHelpers.ts            ***REMOVED*** Pattern validation
│   └── previewGenerator.ts             ***REMOVED*** Generate preview data
└── api.ts                              ***REMOVED*** API client functions
```

***REMOVED******REMOVED******REMOVED*** 2.2 Core Types
...
***REMOVED******REMOVED******REMOVED*** 2.3 WeeklyGridEditor Component
...
***REMOVED******REMOVED******REMOVED*** 2.4 Grid Cell Component
...
***REMOVED******REMOVED******REMOVED*** 2.5 Constants
...
***REMOVED******REMOVED*** Phase 3: Split Rotation Configuration

**Duration Estimate:** Medium complexity
**Dependencies:** Phase 1, Phase 2 (grid editor)

***REMOVED******REMOVED******REMOVED*** 3.1 SplitRotationConfig Component
...
***REMOVED******REMOVED*** Phase 4: Preference System

**Duration Estimate:** Medium complexity
**Dependencies:** Phase 1 (backend models)

***REMOVED******REMOVED******REMOVED*** 4.1 PreferencePanel Component
...
***REMOVED******REMOVED*** Phase 5: Main Editor & Integration

**Duration Estimate:** Medium complexity
**Dependencies:** Phases 1-4

***REMOVED******REMOVED******REMOVED*** 5.1 RotationTemplateEditor (Main Container)
...
***REMOVED******REMOVED*** Phase 6: Testing & Quality Assurance

**Duration Estimate:** Medium complexity
**Dependencies:** All previous phases

***REMOVED******REMOVED******REMOVED*** 6.1 Backend Tests
...
class TestWeeklyPatterns:
    ...
    async def test_unique_slot_constraint(self, db, rotation_template):
        ...
        pattern2 = WeeklyPattern(
            ...
            day_of_week=1,
            time_of_day="AM",
            activity_type="specialty"  ***REMOVED*** Same slot, different activity
        )
        ...
        db.add(pattern2)
        with pytest.raises(Exception):  ***REMOVED*** IntegrityError
            await db.commit()
...
class TestSplitRotations:
    ...
    async def test_create_mirrored_rotation(self, client, auth_headers):
        ...
        ***REMOVED*** Should have 4 templates: A-primary, A-secondary, B-primary, B-secondary
...
class TestRotationPreview:
    ...
    async def test_generate_preview(self, client, auth_headers, rotation_template):
        ...
        data = response.json()
        assert "grid" in data
        assert len(data["grid"]) == 4  ***REMOVED*** 4 weeks
        assert len(data["grid"][0]) == 7  ***REMOVED*** 7 days per week
```

***REMOVED******REMOVED******REMOVED*** 6.2 Frontend Tests
...
***REMOVED******REMOVED*** File Summary

***REMOVED******REMOVED******REMOVED*** Backend Files to Create/Modify
...
***REMOVED******REMOVED******REMOVED*** Frontend Files to Create
