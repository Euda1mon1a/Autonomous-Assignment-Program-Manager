***REMOVED*** ChatGPT Feature Review: Codex & Pulse
...
***REMOVED******REMOVED*** OpenAI Codex (Autonomous Coding Agent)
...
***REMOVED******REMOVED******REMOVED*** Questions to Explore

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Multi-Agent Parallel Task Handling
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Test-Driven Iteration
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Large Refactor Capability
...
***REMOVED******REMOVED*** ChatGPT Pulse (Proactive AI Assistant)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Calendar Integration for Scheduling Systems
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Proactive Research & Monitoring
...
***REMOVED******REMOVED*** Codex Evaluation Results (2025-12-18)
...
***REMOVED******REMOVED******REMOVED*** What Codex Does Well ✅
...
***REMOVED******REMOVED******REMOVED*** What Codex Does Poorly ❌
...
***REMOVED******REMOVED******REMOVED*** Key Finding: Test-Passing ≠ Correctness
...
***REMOVED******REMOVED*** Codex Usage Guidelines

***REMOVED******REMOVED******REMOVED*** RECOMMENDED Tasks for Codex
...
***REMOVED******REMOVED******REMOVED*** AVOID Giving Codex These Tasks
...
***REMOVED******REMOVED******REMOVED*** Codex Task Prompt Template

When assigning tasks to Codex, use this structure:

```markdown
***REMOVED******REMOVED*** Task Type: Bug Fix / Import Fix / Type Annotation Fix

***REMOVED******REMOVED*** Scope: (specific file paths only)
- backend/app/core/config.py
- backend/app/models/calendar_subscription.py

***REMOVED******REMOVED*** Specific Instructions:
...
***REMOVED******REMOVED******REMOVED*** Review Checklist for Codex PRs
