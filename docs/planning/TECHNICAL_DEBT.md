***REMOVED*** Technical Debt Tracker
...
***REMOVED******REMOVED*** Priority Legend
...
***REMOVED******REMOVED******REMOVED*** DEBT-001: Celery Worker Missing Queues
**Location:** `docker-compose.yml` (celery-worker service)
**Category:** Infrastructure
**Found:** 2025-12-30
**Status:** ✅ RESOLVED (2025-12-30, PR ***REMOVED***546)
...
***REMOVED******REMOVED******REMOVED*** DEBT-002: Security TODOs in Audience Tokens
...
***REMOVED******REMOVED******REMOVED*** DEBT-003: Frontend Environment Variable Mismatch
...
***REMOVED******REMOVED******REMOVED*** DEBT-004: Missing Database Indexes
...
***REMOVED******REMOVED******REMOVED*** DEBT-005: Admin Users Page API Not Wired
...
***REMOVED******REMOVED******REMOVED*** DEBT-006: Resilience API Response Model Coverage
...
***REMOVED******REMOVED******REMOVED*** DEBT-007: Token Refresh Not Implemented in Frontend
...
***REMOVED******REMOVED******REMOVED*** DEBT-008: Frontend Accessibility Gaps
...
***REMOVED******REMOVED******REMOVED*** DEBT-009: MCP Placeholder Tools
...
***REMOVED******REMOVED******REMOVED*** DEBT-010: Frontend WebSocket Client Missing
**Location:** Frontend
...
***REMOVED******REMOVED******REMOVED*** DEBT-011: N+1 Query Patterns in Scheduling Engine
...
**Issues:**
```python
people = self.db.query(Person).all()  ***REMOVED*** No eager loading
***REMOVED*** Later accesses: person.assignments -> N+1 per person
```
...
***REMOVED******REMOVED******REMOVED*** DEBT-012: Hardcoded API URLs in Frontend
...
***REMOVED******REMOVED******REMOVED*** DEBT-013: Duplicate Cache TTL Definitions
...
***REMOVED******REMOVED******REMOVED*** DEBT-014: localStorage Usage in Swap Marketplace
...
***REMOVED******REMOVED*** P3: Low Priority Issues

***REMOVED******REMOVED******REMOVED*** DEBT-015: Test Calibration Failures (45 tests)
...
***REMOVED******REMOVED******REMOVED*** DEBT-016: Skipped Tests (147 total)
...
***REMOVED******REMOVED******REMOVED*** DEBT-017: LLM Router Placeholder
...
***REMOVED******REMOVED******REMOVED*** DEBT-018: OpenTelemetry Not Enabled
...
***REMOVED******REMOVED******REMOVED*** DEBT-019: Logout Error Swallowed
...
***REMOVED******REMOVED******REMOVED*** DEBT-020: No Global Unhandled Rejection Handler
**Location:** Frontend
**Category:** Error Handling
**Found:** 2025-12-30
...
***REMOVED******REMOVED*** Summary by Category
...
***REMOVED******REMOVED*** Resolution Tracking
