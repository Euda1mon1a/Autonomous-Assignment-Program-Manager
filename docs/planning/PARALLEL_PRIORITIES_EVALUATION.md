***REMOVED*** Parallel Priorities Evaluation
...
***REMOVED******REMOVED*** Workstream Overview

| ***REMOVED*** | Workstream | Priority | Type | Primary Files | Est. Complexity |
|---|------------|----------|------|---------------|-----------------|
...
***REMOVED******REMOVED******REMOVED*** Workstream 1: Swap Executor Implementation
**Priority:** High | **Type:** Backend Feature

**Location:** `backend/app/services/swap_executor.py`

**TODOs to Resolve:**
- Line 60: `***REMOVED*** TODO: Persist SwapRecord when model is wired`
- Line 61: `***REMOVED*** TODO: Update schedule assignments`
- Line 62: `***REMOVED*** TODO: Update call cascade`
- Line 84: `***REMOVED*** TODO: Implement when SwapRecord model is wired`
...
***REMOVED******REMOVED******REMOVED*** Workstream 2: Stability Metrics TODOs
**Priority:** Medium | **Type:** Backend Feature

**Location:** `backend/app/analytics/stability_metrics.py`

**TODOs to Resolve:**
- Line 222: `***REMOVED*** TODO: Implement version history lookup using SQLAlchemy-Continuum`
- Line 520: `***REMOVED*** TODO: Integrate with app.scheduling.validator.ACGMEValidator`
- Line 544: `***REMOVED*** TODO: Implement by querying schedule version history`
...
***REMOVED******REMOVED******REMOVED*** Workstream 3: Leave Routes FMIT Integration
**Priority:** Medium | **Type:** Backend Feature

**Location:** `backend/app/api/routes/leave.py`

**TODOs to Resolve:**
- Line 180: `***REMOVED*** TODO: Check for FMIT conflicts when schedule data is available`
- Line 236: `***REMOVED*** TODO: Trigger conflict detection in background`
...
***REMOVED******REMOVED******REMOVED*** Workstream 4: Portal Routes Enhancement
**Priority:** Low | **Type:** Backend Feature

**Location:** `backend/app/api/routes/portal.py`

**TODOs to Resolve:**
- Line 102: `has_conflict=False, ***REMOVED*** TODO: Could check conflict_alerts table`
- Line 306: `***REMOVED*** TODO: Create notifications for candidates`
...
***REMOVED******REMOVED******REMOVED*** Workstream 5: FMIT Week Verification
**Priority:** High | **Type:** Backend Feature

**Location:** `backend/app/services/swap_request_service.py`

**TODOs to Resolve:**
- Line 668: `***REMOVED*** TODO: Implement proper FMIT week verification`
...
***REMOVED******REMOVED******REMOVED*** Workstream 6: Frontend Hooks Reorganization
...
***REMOVED******REMOVED******REMOVED*** Workstream 7: Frontend Feature Tests
...
***REMOVED******REMOVED******REMOVED*** Workstream 8: Constraints Module Refactoring
...
***REMOVED******REMOVED******REMOVED*** Workstream 9: Documentation Consolidation
...
***REMOVED******REMOVED******REMOVED*** Workstream 10: Playwright E2E Test Expansion
...
***REMOVED******REMOVED*** Execution Order Recommendations
...
***REMOVED******REMOVED*** Terminal Assignment
