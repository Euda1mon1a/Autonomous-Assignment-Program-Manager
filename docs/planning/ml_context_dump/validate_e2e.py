...
def compute_metrics(ground_truth, solver_output, block_templates, requirements,
    ...
    """Compute 3-tier E2E validation metrics.

    Tier 1: Constraint satisfaction rate
    ...
    # --- Tier 1: Constraint satisfaction rate ---
    # Check if solver output satisfies rotation_activity_requirements
...
def run_validation(session, block_number, academic_year, timeout,
    ...
    print(f"\n  RESULTS:")
    print(f"    Tier 1 — Constraint satisfaction: "
