***REMOVED*** Scheduler Hardening TODO
...
***REMOVED******REMOVED*** Completed (2025-12-25)

***REMOVED******REMOVED******REMOVED*** P0: Kill-Switch for Runaway Solver Jobs
- **Files created:**
...
***REMOVED******REMOVED******REMOVED*** P1: Constraint-Level Violation Metrics
- **Files modified:**
...
***REMOVED******REMOVED*** P2: Near-Term (Next Month)

***REMOVED******REMOVED******REMOVED*** Deterministic Solver Checkpointing
...
***REMOVED******REMOVED******REMOVED*** Schedule Diff Guard Before Activation
...
***REMOVED******REMOVED******REMOVED*** Write-Ahead Schedule Publish Staging
...
class SchedulePublishStaging(Base):
    ...
    status = Column(String, default="pending")  ***REMOVED*** pending, committed, rolled_back
```
...
***REMOVED******REMOVED******REMOVED*** Schedule Correctness SLO
...
***REMOVED******REMOVED*** P3: Longer-Term

***REMOVED******REMOVED******REMOVED*** Solver Sandboxing with Resource Ceilings
...
***REMOVED******REMOVED******REMOVED*** Field-Level Encryption for Sensitive Data
...
***REMOVED******REMOVED******REMOVED*** One-Time Publish Tokens to Prevent Replay
...
def verify_publish_token(job_id: str, token: str) -> bool:
    ...
    redis.delete(key)  ***REMOVED*** Consume token
    return True
```
...
***REMOVED******REMOVED******REMOVED*** Where to Hook Kill-Switch in Solvers
...
***REMOVED******REMOVED******REMOVED*** Example Integration (CP-SAT):
...
***REMOVED******REMOVED*** MCP Server Integration

***REMOVED******REMOVED******REMOVED*** MCP Tool: Solver Abort
...
***REMOVED******REMOVED******REMOVED*** MCP Tool: Solver Progress
...
***REMOVED******REMOVED******REMOVED*** MCP Tool: Constraint Diagnostics
...
async def get_constraint_metrics() -> dict:
    ...
    """
    ***REMOVED*** Query Prometheus metrics or Redis cache
    return {
...
***REMOVED******REMOVED******REMOVED*** MCP Resource: Solver Status (SSE)
...
***REMOVED******REMOVED******REMOVED*** Integration with Safe Schedule Generation Skill
