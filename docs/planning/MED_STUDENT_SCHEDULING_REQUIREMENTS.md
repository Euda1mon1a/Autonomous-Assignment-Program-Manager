...
***REMOVED******REMOVED*** Learner Track System

***REMOVED******REMOVED******REMOVED*** Concept: Generic Tracks
...
***REMOVED******REMOVED******REMOVED*** Frontend GUI Workflow
...
***REMOVED******REMOVED******REMOVED*** Staggered FMIT Distribution
...
***REMOVED******REMOVED******REMOVED*** Learner Track Model (NEW)
...
class LearnerTrack(Base):
    ...
    id = Column(GUID(), primary_key=True, default=uuid.uuid4)
    track_number = Column(Integer, nullable=False, unique=True)  ***REMOVED*** 1-7
    name = Column(String(50))  ***REMOVED*** "Track 1" or "Track A" - display name

    ***REMOVED*** Default FMIT week for this track (1-4), null for TY/PSYCH tracks
...
class LearnerToTrack(Base):
    ...
    ***REMOVED*** Override FMIT requirement (False for TY/PSYCH even on MS track)
...
***REMOVED******REMOVED******REMOVED*** Supervision Rules
...
def can_supervise_learners(person: Person) -> bool:
    ...
    if person.is_resident and person.pgy_level >= 2:
        return True  ***REMOVED*** PGY-2/3 can supervise
    return False  ***REMOVED*** PGY-1 cannot supervise
