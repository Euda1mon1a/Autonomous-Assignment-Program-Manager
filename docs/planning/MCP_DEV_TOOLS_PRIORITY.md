***REMOVED*** MCP Development Tools Priority List
...
***REMOVED******REMOVED******REMOVED*** What Claude Code CAN Do Now (Without MCP)
...
***REMOVED******REMOVED******REMOVED*** What Claude Code CANNOT Do Efficiently
...
***REMOVED******REMOVED*** Priority 1: Test Analysis Tools

***REMOVED******REMOVED******REMOVED*** Tool: `run_tests`
...
***REMOVED******REMOVED******REMOVED*** Tool: `analyze_test_failure`
...
async def analyze_test_failure_tool(
    test_path: str,  ***REMOVED*** e.g., "tests/test_solvers.py::test_greedy_solver"
...
***REMOVED******REMOVED*** Priority 2: Solver/Engine Analysis Tools

***REMOVED******REMOVED******REMOVED*** Tool: `analyze_solver_run`
...
async def analyze_solver_run_tool(
    solver_type: str,  ***REMOVED*** greedy, cp_sat, pulp, hybrid
    start_date: str,
    end_date: str,
    dry_run: bool = True,  ***REMOVED*** Don't save to DB
) -> SolverAnalysis:
    """
...
***REMOVED******REMOVED******REMOVED*** Tool: `explain_constraint_violation`
...
async def explain_constraint_violation_tool(
    violation_type: str,  ***REMOVED*** acgme_80_hour, supervision_ratio, etc.
...
***REMOVED******REMOVED*** Priority 3: Code Quality Tools

***REMOVED******REMOVED******REMOVED*** Tool: `check_module_health`
...
async def check_module_health_tool(
    module_path: str,  ***REMOVED*** e.g., "app/scheduling/solvers.py"
) -> ModuleHealth:
    """
...
***REMOVED******REMOVED******REMOVED*** Tool: `find_related_code`
...
async def find_related_code_tool(
    symbol: str,  ***REMOVED*** e.g., "SchedulingEngine.solve"
    relation_type: str = "all",  ***REMOVED*** callers, callees, tests, similar
) -> RelatedCode:
    """
...
***REMOVED******REMOVED*** Priority 4: Validation Tools

***REMOVED******REMOVED******REMOVED*** Tool: `validate_change`
...
async def validate_change_tool(
    changed_files: list[str] | None = None,  ***REMOVED*** If None, use git diff
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Quick Wins (1-2 days)
...
***REMOVED******REMOVED******REMOVED*** Current Workflow (Without MCP Dev Tools)
...
***REMOVED******REMOVED******REMOVED*** Improved Workflow (With MCP Dev Tools)
...
***REMOVED******REMOVED*** Connection to Existing MCP Infrastructure

***REMOVED******REMOVED******REMOVED*** These Tools Would Use:
...
***REMOVED******REMOVED******REMOVED*** These Tools Would Add:
