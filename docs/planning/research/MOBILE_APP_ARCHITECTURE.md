***REMOVED*** Mobile App Architecture Research
...
2. [Technology Decision](***REMOVED***technology-decision)
3. [Offline-First Architecture](***REMOVED***offline-first-architecture)
4. [Push Notifications](***REMOVED***push-notifications)
5. [Authentication & Security](***REMOVED***authentication--security)
6. [Architecture Patterns](***REMOVED***architecture-patterns)
7. [Development Considerations](***REMOVED***development-considerations)
8. [Technology Stack Recommendation](***REMOVED***technology-stack-recommendation)
9. [Implementation Timeline](***REMOVED***implementation-timeline)
10. [Sources & References](***REMOVED***sources--references)
...
***REMOVED******REMOVED******REMOVED*** Key Recommendations
...
***REMOVED******REMOVED*** 1. Technology Decision

***REMOVED******REMOVED******REMOVED*** Expo Managed Workflow vs Bare Workflow vs React Native CLI

***REMOVED******REMOVED******REMOVED******REMOVED*** Current State (2025)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Comparison Matrix
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Recommendation: **Expo Managed Workflow**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Exit Strategy
...
***REMOVED******REMOVED*** 2. Offline-First Architecture

***REMOVED******REMOVED******REMOVED*** Why Offline-First Matters
...
***REMOVED******REMOVED******REMOVED*** Local Database: WatermelonDB

***REMOVED******REMOVED******REMOVED******REMOVED*** Why WatermelonDB?
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Alternatives Considered
...
***REMOVED******REMOVED******REMOVED*** Synchronization Strategy
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Sync Protocol
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Sync Triggers
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Conflict Resolution Strategy
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Background Sync Implementation
...
***REMOVED******REMOVED******REMOVED*** Data Storage Size Estimates
...
***REMOVED******REMOVED*** 3. Push Notifications

***REMOVED******REMOVED******REMOVED*** Strategy: Expo Notifications + Firebase Cloud Messaging (FCM)

***REMOVED******REMOVED******REMOVED******REMOVED*** Hybrid Approach
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Notification Categories
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Notification Actions
...
async def send_emergency_notification(user_ids: list[str], message: str):
    ...
    ***REMOVED*** Get FCM tokens from database
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Cost Analysis
...
***REMOVED******REMOVED*** 4. Authentication & Security

***REMOVED******REMOVED******REMOVED*** Healthcare Security Requirements
...
***REMOVED******REMOVED******REMOVED*** Biometric Authentication

***REMOVED******REMOVED******REMOVED******REMOVED*** Library: `expo-local-authentication`
...
***REMOVED******REMOVED******REMOVED*** Secure Token Storage: `expo-secure-store`
...
***REMOVED******REMOVED******REMOVED*** Best Practices Implementation

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Cryptographic Biometric Auth (Most Secure)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Session Management
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Security Checklist
...
***REMOVED******REMOVED*** 5. Architecture Patterns

***REMOVED******REMOVED******REMOVED*** State Management: Zustand + TanStack Query

***REMOVED******REMOVED******REMOVED******REMOVED*** Why This Combination?
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Implementation Examples
...
***REMOVED******REMOVED******REMOVED*** Navigation: React Navigation v6

***REMOVED******REMOVED******REMOVED******REMOVED*** Structure
...
│   │   ├── Badge.tsx
│   │   └── Spinner.tsx
│   ├── molecules/          ***REMOVED*** Simple composites
│   │   ├── SwapCard.tsx
│   │   ├── ScheduleBlock.tsx
│   │   └── NotificationItem.tsx
│   ├── organisms/          ***REMOVED*** Complex composites
│   │   ├── SwapList.tsx
...
│   ├── useSwaps.ts
│   └── useAuth.ts
├── services/               ***REMOVED*** API clients
│   ├── api.ts
│   ├── sync.ts
│   └── notifications.ts
├── stores/                 ***REMOVED*** Zustand stores
│   ├── authStore.ts
│   └── appStore.ts
└── utils/                  ***REMOVED*** Helpers
    ├── date.ts
    ├── formatting.ts
    └── validation.ts
```
...
***REMOVED******REMOVED*** 6. Development Considerations

***REMOVED******REMOVED******REMOVED*** Development Workflow

***REMOVED******REMOVED******REMOVED******REMOVED*** Local Development Setup

```bash
***REMOVED*** Install Expo CLI
npm install -g expo-cli eas-cli

***REMOVED*** Create new project
...
***REMOVED*** Options:
***REMOVED*** - Press 'i' for iOS simulator
***REMOVED*** - Press 'a' for Android emulator
***REMOVED*** - Scan QR code with Expo Go app on physical device
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Hot Reload
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Environment Configuration
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Unit Tests (Jest + React Native Testing Library)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** E2E Tests (Detox or Maestro)

**Maestro** (simpler, recommended):

```yaml
***REMOVED*** .maestro/swap_flow.yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Test Coverage Goals
...
***REMOVED******REMOVED******REMOVED*** CI/CD with EAS Build

***REMOVED******REMOVED******REMOVED******REMOVED*** Setup

```bash
***REMOVED*** Initialize EAS
eas init

***REMOVED*** Configure build profiles
eas build:configure
```
...
```yaml
***REMOVED*** .github/workflows/eas-build.yml
name: EAS Build
...
***REMOVED******REMOVED******REMOVED******REMOVED*** OTA Updates (Expo Updates)

```bash
***REMOVED*** Deploy update to production
eas update --branch production --message "Fix swap approval bug"

***REMOVED*** Deploy to specific channel
eas update --channel preview --message "Test new feature"

***REMOVED*** View update history
eas update:list
```
...
```bash
***REMOVED*** Rollback to previous update
eas update:rollback --branch production
```

***REMOVED******REMOVED******REMOVED*** Performance Optimization

***REMOVED******REMOVED******REMOVED******REMOVED*** Bundle Size

```bash
***REMOVED*** Analyze bundle
npx expo-bundle-analyzer

***REMOVED*** Techniques:
***REMOVED*** - Use Hermes engine (enabled by default)
***REMOVED*** - Import only needed components: import { Button } from 'package/Button'
***REMOVED*** - Lazy load screens: const Screen = lazy(() => import('./Screen'))
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Image Optimization
...
***REMOVED******REMOVED******REMOVED******REMOVED*** List Performance
...
***REMOVED******REMOVED*** 7. Technology Stack Recommendation

***REMOVED******REMOVED******REMOVED*** Final Technology Stack
...
***REMOVED******REMOVED******REMOVED*** Package.json (Core Dependencies)
...
***REMOVED******REMOVED*** 8. Implementation Timeline
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Core Features (Weeks 3-5)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Advanced Features (Weeks 6-7)
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Testing & Polish (Weeks 8-9)
...
***REMOVED******REMOVED******REMOVED*** Phase 5: Deployment (Week 10)
...
***REMOVED******REMOVED******REMOVED*** Total Timeline: 10 Weeks (2.5 Months)
...
***REMOVED******REMOVED******REMOVED*** Milestones
...
***REMOVED******REMOVED*** 9. Additional Considerations
...
***REMOVED******REMOVED******REMOVED*** Internationalization (Future)
...
***REMOVED******REMOVED******REMOVED*** Analytics Events
...
***REMOVED******REMOVED******REMOVED*** Error Monitoring (Sentry)
...
***REMOVED******REMOVED*** 10. Sources & References

***REMOVED******REMOVED******REMOVED*** Research Sources
