...
***REMOVED******REMOVED*** 2) Academic year boundaries
...
***REMOVED******REMOVED*** 3) Absence semantics (blocking vs partial)
...
***REMOVED******REMOVED*** 4) FMIT preservation vs supervision conflicts
...
***REMOVED******REMOVED*** 5) Rotation naming normalization
...
***REMOVED******REMOVED*** 6) Post-generation audit gaps
...
***REMOVED******REMOVED*** 7) API contract mismatches
...
***REMOVED******REMOVED*** 8) Manual overrides and swap provenance
...
***REMOVED******REMOVED*** 9) Human-only Excel behaviors not modeled yet
