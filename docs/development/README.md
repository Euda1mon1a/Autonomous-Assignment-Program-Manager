...
If you're using Claude or other AI assistants, see:

- **[AI Agent User Guide](../guides/AI_AGENT_USER_GUIDE.md)** - Complete guide to Claude interfaces, skills, and MCP tools
  - Includes guidance on when to use Claude for macOS (chat app) vs Claude Code (CLI)
