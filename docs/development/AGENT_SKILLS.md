***REMOVED*** Agent Skills Reference
...
***REMOVED******REMOVED******REMOVED*** How Skills Work
...
***REMOVED******REMOVED*** Skills Directory

All skills are located in `.claude/skills/`:

```
.claude/skills/
├── acgme-compliance/           ***REMOVED*** ACGME regulatory compliance
│   ├── SKILL.md
│   ├── thresholds.md
│   └── exceptions.md
├── automated-code-fixer/       ***REMOVED*** Auto-fix code issues
│   ├── SKILL.md
│   ├── reference.md
│   └── examples.md
├── changelog-generator/        ***REMOVED*** Release notes from git
│   └── SKILL.md
├── code-quality-monitor/       ***REMOVED*** Quality gate enforcement
│   └── SKILL.md
├── code-review/                ***REMOVED*** Code review procedures
│   └── SKILL.md
├── constraint-preflight/       ***REMOVED*** Constraint verification pre-flight
│   └── SKILL.md
├── docker-containerization/    ***REMOVED*** Docker development & orchestration
│   ├── SKILL.md
│   ├── security.md
│   └── troubleshooting.md
├── database-migration/         ***REMOVED*** Alembic migration expertise
│   └── SKILL.md
├── fastapi-production/         ***REMOVED*** Production FastAPI patterns
│   └── SKILL.md
├── frontend-development/       ***REMOVED*** Next.js/React/TailwindCSS
│   └── SKILL.md
├── lint-monorepo/              ***REMOVED*** Unified Python/TypeScript linting
│   ├── SKILL.md
│   ├── python.md
│   └── typescript.md
├── pdf/                        ***REMOVED*** PDF generation & extraction
│   └── SKILL.md
├── pr-reviewer/                ***REMOVED*** Pull request review
│   └── SKILL.md
├── production-incident-responder/  ***REMOVED*** Crisis response
│   └── SKILL.md
├── python-testing-patterns/    ***REMOVED*** Advanced pytest patterns
│   └── SKILL.md
├── react-typescript/           ***REMOVED*** TypeScript for React/Next.js
│   └── SKILL.md
├── safe-schedule-generation/   ***REMOVED*** Backup-first schedule generation
│   └── SKILL.md
├── schedule-optimization/      ***REMOVED*** Multi-objective optimization
│   └── SKILL.md
├── schedule-verification/      ***REMOVED*** Human verification checklist
│   └── SKILL.md
├── security-audit/             ***REMOVED*** Security auditing
│   └── SKILL.md
├── swap-management/            ***REMOVED*** Shift swap workflows
│   └── SKILL.md
├── session-documentation/      ***REMOVED*** Comprehensive documentation enforcement
│   └── SKILL.md
├── solver-control/             ***REMOVED*** Kill-switch & progress monitoring
│   └── SKILL.md
├── systematic-debugger/        ***REMOVED*** Systematic debugging workflow
│   └── SKILL.md
├── test-writer/                ***REMOVED*** Test generation
│   └── SKILL.md
└── xlsx/                       ***REMOVED*** Excel import/export
    └── SKILL.md
```
...
***REMOVED******REMOVED******REMOVED*** Frontend Skills
...
***REMOVED******REMOVED*** Detailed Skill Documentation
...
***REMOVED******REMOVED******REMOVED*** automated-code-fixer
...
***REMOVED******REMOVED******REMOVED*** code-quality-monitor
...
***REMOVED******REMOVED******REMOVED*** constraint-preflight
...
***REMOVED******REMOVED******REMOVED*** docker-containerization
...
***REMOVED******REMOVED******REMOVED*** pr-reviewer
...
***REMOVED******REMOVED******REMOVED*** production-incident-responder
...
***REMOVED******REMOVED******REMOVED*** schedule-verification
...
***REMOVED******REMOVED******REMOVED*** solver-control
...
***REMOVED******REMOVED******REMOVED*** session-documentation
...
***REMOVED******REMOVED******REMOVED*** security-audit
...
***REMOVED******REMOVED******REMOVED*** test-writer
...
***REMOVED******REMOVED******REMOVED*** changelog-generator
...
***REMOVED******REMOVED******REMOVED*** lint-monorepo
...
***REMOVED******REMOVED******REMOVED*** react-typescript
...
***REMOVED******REMOVED******REMOVED*** python-testing-patterns
...
***REMOVED******REMOVED******REMOVED*** fastapi-production
...
***REMOVED******REMOVED******REMOVED*** systematic-debugger
...
***REMOVED******REMOVED******REMOVED*** safe-schedule-generation
...
***REMOVED******REMOVED*** Creating Custom Skills

***REMOVED******REMOVED******REMOVED*** Step 1: Create Directory

```bash
mkdir -p .claude/skills/my-skill
```

***REMOVED******REMOVED******REMOVED*** Step 2: Create SKILL.md
...
***REMOVED******REMOVED******REMOVED*** Step 3: Add Supporting Files (Optional)

- `reference.md` - Detailed procedures
- `examples.md` - Example scenarios
- `thresholds.md` - Configurable values

***REMOVED******REMOVED******REMOVED*** Step 4: Test

Ask Claude about the skill topic and verify it activates.

---

***REMOVED******REMOVED*** Skill Specification

Skills follow the [Agent Skills Specification](https://agentskills.io):

***REMOVED******REMOVED******REMOVED*** SKILL.md Format

```yaml
---
name: skill-name          ***REMOVED*** Required: kebab-case identifier
description: Brief desc   ***REMOVED*** Required: Used for skill matching
---
...
***REMOVED******REMOVED******REMOVED*** Progressive Loading
...
***REMOVED******REMOVED******REMOVED*** Cross-Agent Compatibility
...
***REMOVED******REMOVED******REMOVED*** Skill Design
...
***REMOVED******REMOVED******REMOVED*** Skill Maintenance
...
***REMOVED******REMOVED*** Agent-to-Agent Critique Schema
...
***REMOVED******REMOVED******REMOVED*** Minimal Contract
...
***REMOVED******REMOVED******REMOVED*** Field Definitions
...
***REMOVED******REMOVED******REMOVED*** Confidence Thresholds
...
***REMOVED******REMOVED******REMOVED*** Router Logic (n8n/Workflow Example)
...
***REMOVED******REMOVED******REMOVED*** Agent Tier Assignments
...
***REMOVED******REMOVED******REMOVED*** Vector-Based Selection (pgvector)
...
***REMOVED******REMOVED******REMOVED*** Agent Skill Matcher Service (NEW)
...
***REMOVED*** Simple usage - get best agent for a task
agent, model = match_task_to_agent("Validate ACGME compliance for schedule")
***REMOVED*** Returns: ("ACGME_VALIDATOR", "haiku")

***REMOVED*** Advanced usage - get multiple matches with explanations
matcher = get_agent_matcher()
explanation = matcher.explain_match("Generate a compliant resident schedule")
***REMOVED*** Returns: {
***REMOVED***   "task": "Generate a compliant resident schedule",
***REMOVED***   "matches": [{"agent": "SCHEDULER", "score": 0.82, ...}, ...],
***REMOVED***   "recommendation": "SCHEDULER",
...
***REMOVED******REMOVED*** ML Research Roadmap
