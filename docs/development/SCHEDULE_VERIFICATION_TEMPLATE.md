***REMOVED*** Schedule Generation Verification Template
...
***REMOVED******REMOVED*** Instructions for Local Claude Code
...
***REMOVED******REMOVED*** Part 1: Database State Proof

***REMOVED******REMOVED******REMOVED*** 1.1 Assignment Count
...
***REMOVED******REMOVED******REMOVED*** 1.2 Assignments by Person (First 20)
...
***REMOVED******REMOVED******REMOVED*** 1.3 Orphan Check (Causes ??? in UI)
...
***REMOVED******REMOVED*** Part 2: API Verification

***REMOVED******REMOVED******REMOVED*** 2.1 Schedule Endpoint Response

```bash
***REMOVED*** Get auth token first:
TOKEN=$(curl -s -X POST 'http://localhost:8000/api/v1/auth/login/json' \
  -H 'Content-Type: application/json' \
  -d '{"username": "admin", "password": "YOUR_PASSWORD"}' | jq -r '.access_token')

***REMOVED*** Then fetch schedule:
...
***REMOVED******REMOVED******REMOVED*** 2.2 Validation Endpoint
...
***REMOVED******REMOVED*** Part 3: Coverage Summary

***REMOVED******REMOVED******REMOVED*** 3.1 Daily Coverage Check
...
***REMOVED******REMOVED******REMOVED*** 3.2 PGY Level Distribution
...
***REMOVED******REMOVED*** Part 4: ACGME Compliance Proof

***REMOVED******REMOVED******REMOVED*** 4.1 Constraint Registration
...
***REMOVED******REMOVED******REMOVED*** 4.2 Violation Summary

```bash
***REMOVED*** If there's a validation MCP tool or API endpoint:
...
***REMOVED******REMOVED*** Part 5: Real Names Mapping (OPTIONAL - Local Only)
...
***REMOVED******REMOVED*** Part 6: Frontend Verification

***REMOVED******REMOVED******REMOVED*** 6.1 Does the schedule display correctly?
...
***REMOVED******REMOVED******REMOVED*** 6.2 Screenshot (if possible)

Attach or describe what you see at `http://localhost:3000/schedule`

---

***REMOVED******REMOVED*** Verification Summary
