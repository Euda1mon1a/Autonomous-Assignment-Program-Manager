***REMOVED*** Audience-Scoped JWT Authentication - Integration Checklist
...
***REMOVED******REMOVED******REMOVED*** 1. Core Authentication Module
...
***REMOVED******REMOVED******REMOVED*** 2. Pydantic Schemas
...
***REMOVED******REMOVED******REMOVED*** 3. API Routes
...
***REMOVED******REMOVED******REMOVED*** 4. Comprehensive Tests
...
***REMOVED******REMOVED******REMOVED*** 5. Usage Documentation
...
***REMOVED******REMOVED*** Integration Steps

***REMOVED******REMOVED******REMOVED*** Step 1: Register API Routes
...
***REMOVED*** Add to route registration
app.include_router(
...
***REMOVED******REMOVED******REMOVED*** Step 2: Update Existing Endpoints
...
async def abort_job(
    ...
    ***REMOVED*** Verify token belongs to user
...
***REMOVED******REMOVED******REMOVED*** Step 3: Add New Audiences (If Needed)

**File**: `backend/app/core/audience_auth.py`

```python
VALID_AUDIENCES = {
    ***REMOVED*** Existing audiences...
    "your.new.operation": "Description of operation",
}
```

***REMOVED******REMOVED******REMOVED*** Step 4: Database Migration (If Needed)
...
***REMOVED******REMOVED******REMOVED*** Step 5: Frontend Integration
...
***REMOVED******REMOVED******REMOVED*** Step 6: Update API Documentation

**File**: `docs/api/README.md`

Add section:
```markdown
***REMOVED******REMOVED*** Audience-Scoped Authentication
...
***REMOVED******REMOVED*** Security Review Checklist
...
**Query Examples**:
```promql
***REMOVED*** Tokens issued per minute
...
Search logs:
```bash
***REMOVED*** View all audience token operations
docker-compose logs backend | grep "Audience token"

***REMOVED*** View validation failures
...
***REMOVED******REMOVED******REMOVED*** Step 1: Remove Route Registration
```python
***REMOVED*** backend/app/main.py
***REMOVED*** Comment out:
***REMOVED*** app.include_router(audience_tokens.router, ...)
```

***REMOVED******REMOVED******REMOVED*** Step 2: Restart Services
```bash
docker-compose restart backend
```

***REMOVED******REMOVED******REMOVED*** Step 3: Revert Frontend Changes
```bash
...
***REMOVED******REMOVED******REMOVED*** Immediate (Required for MVP)
...
***REMOVED******REMOVED******REMOVED*** Long-term (Future Enhancements)
...
***REMOVED******REMOVED*** Support and Questions
