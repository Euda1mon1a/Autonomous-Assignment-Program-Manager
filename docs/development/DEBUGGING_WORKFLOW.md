***REMOVED*** Debugging Workflow Guide
...
1. [Core Philosophy](***REMOVED***core-philosophy)
2. [Systematic Debugging Workflow](***REMOVED***systematic-debugging-workflow)
3. [Test-Driven Debugging (TDD)](***REMOVED***test-driven-debugging-tdd)
4. [Advanced Techniques](***REMOVED***advanced-techniques)
5. [Context Management](***REMOVED***context-management)
6. [Domain-Specific Debugging](***REMOVED***domain-specific-debugging)
7. [Database Debugging](***REMOVED***database-debugging)
8. [Logging Strategy](***REMOVED***logging-strategy)
9. [Multi-Session Workflows](***REMOVED***multi-session-workflows)
10. [Error-Driven Development](***REMOVED***error-driven-development)
11. [Preventive Practices](***REMOVED***preventive-practices)
12. [Quick Reference](***REMOVED***quick-reference)

---

***REMOVED******REMOVED*** Core Philosophy

***REMOVED******REMOVED******REMOVED*** The Explore → Plan → Debug → Fix Cycle
...
***REMOVED******REMOVED*** Systematic Debugging Workflow

***REMOVED******REMOVED******REMOVED*** Phase 1: Exploration
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Planning with Extended Thinking
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Debugging
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Fix and Verify
...
***REMOVED******REMOVED*** Test-Driven Debugging (TDD)

***REMOVED******REMOVED******REMOVED*** Step 1: Write Failing Test First
...
class TestBugFix:
    ...
    async def test_bug_reproduction(self, db):
        ...
        ***REMOVED*** Setup: Create exact conditions that trigger the bug
        ***REMOVED*** ...

        ***REMOVED*** Action: Execute the operation that causes the bug
        ***REMOVED*** ...

        ***REMOVED*** Assert: Verify expected (correct) behavior
...
***REMOVED******REMOVED******REMOVED*** Step 2: Confirm Test Fails
...
***REMOVED******REMOVED******REMOVED*** Step 3: Implement Minimal Fix
...
***REMOVED******REMOVED******REMOVED*** Step 4: Verify - All Green

```bash
***REMOVED*** Specific test
pytest tests/regression/test_bug_*.py -v

***REMOVED*** Related module
...
***REMOVED******REMOVED******REMOVED*** Step 5: Commit with Traceability
...
***REMOVED******REMOVED******REMOVED*** Reasoning-First Strategy
...
***REMOVED******REMOVED******REMOVED*** Binary Search Debugging
...
***REMOVED******REMOVED******REMOVED*** Incremental Query Building
...
***REMOVED******REMOVED******REMOVED*** The Document & Clear Pattern
...
***REMOVED*** Debug Session: [Issue Description]
***REMOVED******REMOVED*** Date: YYYY-MM-DD
...
***REMOVED******REMOVED*** What We Tried
- [Attempt 1]: [Result]
- [Attempt 2]: [Result]

***REMOVED******REMOVED*** Current Understanding
[What we now know]
...
***REMOVED******REMOVED******REMOVED*** Why Avoid `/compact`
...
```python
***REMOVED*** WRONG: Comparing without timezone awareness
if assignment.start_date == date.today():  ***REMOVED*** Server timezone!

***REMOVED*** RIGHT: Explicit timezone handling
from datetime import timezone
local_tz = timezone(timedelta(hours=-10))  ***REMOVED*** HST
local_today = datetime.now(local_tz).date()
if assignment.start_date == local_today:
```

***REMOVED******REMOVED******REMOVED*** ACGME Compliance Debugging
...
***REMOVED*** Check specific compliance validator
pytest tests/services/test_acgme_validator.py -v
```

***REMOVED******REMOVED******REMOVED*** Swap System Debugging

```bash
***REMOVED*** Check swap execution logs
grep -i "swap" backend/logs/*.log | tail -50

***REMOVED*** Test swap workflow
pytest tests/integration/test_swap_workflow.py -v
```

***REMOVED******REMOVED******REMOVED*** Resilience Framework Debugging

```bash
***REMOVED*** Run resilience tests
...
***REMOVED******REMOVED*** Database Debugging

***REMOVED******REMOVED******REMOVED*** Query Performance Analysis
...
```python
***REMOVED*** Add row locking for concurrent operations
result = await db.execute(
    select(Assignment)
...
***REMOVED******REMOVED*** Logging Strategy

***REMOVED******REMOVED******REMOVED*** Structured Logging for Debugging
...
***REMOVED******REMOVED******REMOVED*** Log Levels for Healthcare Systems
...
***REMOVED******REMOVED******REMOVED*** Temporary Diagnostic Logging

```python
***REMOVED*** Add temporarily during debugging
import logging
logger = logging.getLogger(__name__)
...
***REMOVED******REMOVED*** Multi-Session Workflows

***REMOVED******REMOVED******REMOVED*** Parallel Investigation Pattern
...
***REMOVED******REMOVED******REMOVED*** Verification Pattern
...
***REMOVED******REMOVED*** Error-Driven Development

***REMOVED******REMOVED******REMOVED*** The Error Recovery Cycle
...
***REMOVED******REMOVED******REMOVED*** Error Categorization
...
***REMOVED******REMOVED*** Preventive Practices
...
***REMOVED******REMOVED******REMOVED*** Defensive Assertions

Have Claude add runtime checks:
```python
***REMOVED*** Add to validate assumptions
...
***REMOVED******REMOVED******REMOVED*** Pre-Fix Validation
...
***REMOVED******REMOVED******REMOVED*** Common Test Commands
...
***REMOVED******REMOVED******REMOVED*** Key Files by Domain
