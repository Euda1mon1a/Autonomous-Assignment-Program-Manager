...
1. [Testing Overview](***REMOVED***testing-overview)
2. [Backend Testing](***REMOVED***backend-testing)
3. [Frontend Testing](***REMOVED***frontend-testing)
4. [End-to-End Testing](***REMOVED***end-to-end-testing)
5. [Test Coverage](***REMOVED***test-coverage)
6. [Best Practices](***REMOVED***best-practices)
7. [Continuous Integration](***REMOVED***continuous-integration)

---

***REMOVED******REMOVED*** Testing Overview

***REMOVED******REMOVED******REMOVED*** Test Pyramid
...
***REMOVED******REMOVED******REMOVED*** Testing Stack
...
***REMOVED*** Run specific test method
...
***REMOVED******REMOVED******REMOVED*** Writing Backend Tests

***REMOVED******REMOVED******REMOVED******REMOVED*** API Tests

```python
***REMOVED*** tests/test_people_api.py
import pytest
from fastapi.testclient import TestClient
...
class TestCreatePerson:
    ...
    def test_create_duplicate_email(self, client: TestClient, sample_resident):
        ...
        payload = {
            ...
            "email": sample_resident.email,  ***REMOVED*** Already exists
            "type": "resident",
            "pgy_level": 1,
        }
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ACGME Compliance Tests

```python
***REMOVED*** tests/test_constraints.py
import pytest
...
class TestACGMECompliance:
    ...
    def test_80_hour_rule_compliance(self, validator, db):
        ...
        ***REMOVED*** Create test data with 70 hours/week
    ...
    def test_80_hour_rule_violation(self, validator, db):
        ...
        ***REMOVED*** Create test data with 90 hours/week
    ...
    def test_one_in_seven_rule(self, validator, db):
        ...
        ***REMOVED*** Create 7 consecutive working days
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Scheduling Engine Tests

```python
***REMOVED*** tests/test_scheduling_engine.py
import pytest
from datetime import date, timedelta
...
class TestSchedulingEngine:
    ...
    def test_respects_absences(self, engine, sample_resident, sample_absence):
        ...
        ***REMOVED*** Verify no assignments for the absent person
        absent_assignments = [
    ...
    def test_acgme_compliance(self, engine, sample_residents, sample_blocks):
        ...
        ***REMOVED*** Should have no critical violations
        critical_violations = [
...
***REMOVED*** Install dependencies (includes test dependencies)
npm install
```
...
***REMOVED******REMOVED******REMOVED*** Mocking API Calls
...
***REMOVED******REMOVED*** End-to-End Testing
...
***REMOVED******REMOVED******REMOVED*** Running E2E Tests

```bash
***REMOVED*** Run all E2E tests
npm run test:e2e

***REMOVED*** Run with browser UI
npm run test:e2e:ui
...
***REMOVED*** Run with specific browser
npx playwright test --project=chromium
```

***REMOVED******REMOVED******REMOVED*** E2E Test Example
...
***REMOVED******REMOVED******REMOVED*** Generating Coverage Reports
...
***REMOVED******REMOVED******REMOVED*** Coverage Configuration
...
***REMOVED******REMOVED******REMOVED*** Test Independence
...
***REMOVED******REMOVED******REMOVED*** What to Test
...
***REMOVED******REMOVED******REMOVED*** Mocking Guidelines
...
***REMOVED******REMOVED******REMOVED*** GitHub Actions Configuration
