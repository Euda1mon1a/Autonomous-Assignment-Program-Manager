***REMOVED*** MCP Domain Glossary & Context Guide
...
1. [Abbreviations](***REMOVED***abbreviations)
2. [Scheduling Concepts](***REMOVED***scheduling-concepts)
3. [Constraint Patterns](***REMOVED***constraint-patterns)
4. [Role Types](***REMOVED***role-types)
5. [Activity Types](***REMOVED***activity-types)
6. [Temporal Patterns](***REMOVED***temporal-patterns)
7. [Open Questions](***REMOVED***open-questions)

---

***REMOVED******REMOVED*** Abbreviations

***REMOVED******REMOVED******REMOVED*** Personnel & Training Levels
...
***REMOVED******REMOVED******REMOVED*** Faculty Roles
...
***REMOVED******REMOVED******REMOVED*** Regulatory Bodies
...
***REMOVED******REMOVED******REMOVED*** Schedule Elements
...
***REMOVED******REMOVED******REMOVED*** Military/Administrative
...
***REMOVED******REMOVED*** Scheduling Concepts

***REMOVED******REMOVED******REMOVED*** Block Structure
...
***REMOVED******REMOVED******REMOVED*** Assignment Hierarchy
...
***REMOVED******REMOVED******REMOVED*** Supervision Ratios (ACGME)
...
***REMOVED******REMOVED******REMOVED*** Work Hour Rules (ACGME)
...
***REMOVED******REMOVED*** Constraint Patterns

***REMOVED******REMOVED******REMOVED*** Hard Constraints (Must Be Satisfied)
...
***REMOVED******REMOVED******REMOVED*** Soft Constraints (Optimization Goals)
...
***REMOVED******REMOVED*** Role Types

***REMOVED******REMOVED******REMOVED*** Person Types

```python
class PersonType(str, Enum):
    RESIDENT = "resident"    ***REMOVED*** PGY-1, PGY-2, PGY-3
    FACULTY = "faculty"      ***REMOVED*** Attending physicians
    LEARNER = "learner"      ***REMOVED*** Medical students, rotating interns
    SCREENER = "screener"    ***REMOVED*** Clinical support staff
```

***REMOVED******REMOVED******REMOVED*** Faculty Roles (from `backend/app/models/person.py:14`)

```python
class FacultyRole(str, Enum):
    PD = "pd"              ***REMOVED*** Program Director: 0 clinic, avoid Tue call
    APD = "apd"            ***REMOVED*** Associate PD: 2/week, avoid Tue call
    OIC = "oic"            ***REMOVED*** Officer in Charge: 2/week
    DEPT_CHIEF = "dept_chief"  ***REMOVED*** Dept Chief: 1/week, prefers Wed call
    SPORTS_MED = "sports_med"  ***REMOVED*** Sports Medicine: 0 regular, 4 SM clinic
    CORE = "core"          ***REMOVED*** Core Faculty: max 4/week
```

***REMOVED******REMOVED******REMOVED*** Screener Roles

```python
class ScreenerRole(str, Enum):
    DEDICATED = "dedicated"  ***REMOVED*** 100% efficiency
    RN = "rn"               ***REMOVED*** 90% efficiency
    EMT = "emt"             ***REMOVED*** 80% efficiency
    RESIDENT = "resident"   ***REMOVED*** 70% efficiency (when covering)
```
...
***REMOVED******REMOVED******REMOVED*** Wednesday Special Sessions

| Wednesday ***REMOVED*** | AM Activity | PM Activity | Notes |
|-------------|-------------|-------------|-------|
...
***REMOVED******REMOVED*** Temporal Patterns

***REMOVED******REMOVED******REMOVED*** "Inverted Wednesday" Pattern
...
***REMOVED******REMOVED******REMOVED*** FMIT Week Pattern
...
***REMOVED******REMOVED******REMOVED*** Post-Call Recovery
...
***REMOVED******REMOVED******REMOVED*** Terminology Questions
...
***REMOVED******REMOVED******REMOVED*** Pattern Questions
...
***REMOVED******REMOVED******REMOVED*** Business Rule Questions
...
***REMOVED******REMOVED*** Usage in MCP Tools

***REMOVED******REMOVED******REMOVED*** Returning Context-Aware Responses

```python
***REMOVED*** Example: Tool response with domain context
@mcp.tool()
async def explain_violation(violation_id: str) -> dict:
    ...
    ***REMOVED*** Add domain context based on constraint type
...
***REMOVED******REMOVED******REMOVED*** Abbreviation Expansion

```python
***REMOVED*** MCP tools should expand abbreviations in responses
ABBREVIATION_MAP = {
...
***REMOVED******REMOVED*** PII Sanitization Reference

***REMOVED******REMOVED******REMOVED*** Fields That Must Never Leave Local
...
***REMOVED******REMOVED******REMOVED*** Safe Fields for MCP Responses
...
***REMOVED******REMOVED*** Document Maintenance

***REMOVED******REMOVED******REMOVED*** Adding New Terms
...
***REMOVED******REMOVED******REMOVED*** Review Cadence
