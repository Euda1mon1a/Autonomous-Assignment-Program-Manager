***REMOVED*** Claude Code for macOS Guide

***REMOVED******REMOVED*** Local Development with Claude CLI
...
***REMOVED******REMOVED*** What is Claude Code?
...
```bash
***REMOVED*** Install via npm
npm install -g @anthropic-ai/claude-code

***REMOVED*** Or via Homebrew
...
```bash
***REMOVED*** Set your API key
export ANTHROPIC_API_KEY="your-api-key"

***REMOVED*** Or configure via CLI
claude config set api_key "your-api-key"

***REMOVED*** Set preferred model (optional)
claude config set model "claude-sonnet-4-20250514"
```

---

***REMOVED******REMOVED*** Model Selection for Local Development

***REMOVED******REMOVED******REMOVED*** Recommended: Claude Sonnet 4 (Default Workhorse)
...
***REMOVED******REMOVED******REMOVED*** When to Use: Claude Opus 4.5 (Troubleshooting & Complex Issues)
...
***REMOVED******REMOVED******REMOVED*** Model Usage Summary
...
***REMOVED******REMOVED******REMOVED*** 1. Executing Code & Commands
...
***REMOVED******REMOVED******REMOVED*** 2. Reading & Writing Files
...
***REMOVED******REMOVED******REMOVED*** 3. Running Tests
...
***REMOVED******REMOVED******REMOVED*** 4. Build & Compile
...
***REMOVED******REMOVED******REMOVED*** 5. Git Operations
...
***REMOVED******REMOVED******REMOVED*** 6. Docker Operations
...
***REMOVED******REMOVED******REMOVED*** 7. Package Management
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Test-Driven Development
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Bug Fix with Verification
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Feature Implementation
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Debugging Session
...
***REMOVED******REMOVED*** Project-Specific Commands

***REMOVED******REMOVED******REMOVED*** For This Project (Residency Scheduler)
...
***REMOVED*** Apply database migrations
...
***REMOVED*** Rebuild after changes
docker-compose up -d --build
```

***REMOVED******REMOVED******REMOVED*** Example Prompts for This Project
...
***REMOVED******REMOVED*** Troubleshooting Escalation Path

***REMOVED******REMOVED******REMOVED*** Level 1: Sonnet (First Attempt)
```
[Describe the problem]
Investigate and fix it.
```

***REMOVED******REMOVED******REMOVED*** Level 2: Sonnet (With Context)
```
...
***REMOVED******REMOVED******REMOVED*** Level 3: Opus (After Sonnet Failures)
```
...
***REMOVED******REMOVED******REMOVED*** Level 4: Opus (Complex System Issue)
```
...
***REMOVED******REMOVED******REMOVED*** Multi-Service Coordination
```
...
***REMOVED******REMOVED******REMOVED*** Start Development Session
```
...
***REMOVED******REMOVED******REMOVED*** End Development Session
```
Before I stop:
...
***REMOVED******REMOVED******REMOVED*** Daily Standup Check
```
Give me a status on:
1. Any failing tests
...
***REMOVED******REMOVED*** Integration with Multi-Model Workflow

When using Claude Code as part of the multi-model orchestration system:

***REMOVED******REMOVED******REMOVED*** Sonnet via Claude Code (Implementation)
...
***REMOVED******REMOVED******REMOVED*** Opus via Claude Code (Troubleshooting)
...
***REMOVED******REMOVED******REMOVED*** Haiku via Claude Code (Batch Operations)
...
***REMOVED******REMOVED******REMOVED*** What Claude Code Can Access
...
***REMOVED******REMOVED******REMOVED*** Recommended Practices
...
***REMOVED******REMOVED******REMOVED*** Sandboxing (Optional)
