***REMOVED*** Session 14 Frontend Issues
...
***REMOVED******REMOVED******REMOVED*** 1. View Full Schedule Link Broken - FIXED (Unverified)
...
***REMOVED******REMOVED******REMOVED*** 2. View Templates Shows Placeholders
...
***REMOVED******REMOVED******REMOVED*** 3. Absences Page Empty
...
***REMOVED******REMOVED******REMOVED*** 4. Add People Input Bug - FIXED (Unverified)
...
***REMOVED******REMOVED******REMOVED*** 5. My Schedule Redirects to Login - FIXED (Needs Browser Verification)
...
***REMOVED******REMOVED******REMOVED*** 6. Block View Date Selection - FIX NOT VERIFIED
...
***REMOVED******REMOVED*** Working Features
...
***REMOVED******REMOVED*** Backend Verification
...
***REMOVED******REMOVED******REMOVED*** Completed (Code Fixes Applied, Need Browser Verification)
...
***REMOVED******REMOVED******REMOVED*** Remaining (Browser Testing Required)
...
***REMOVED******REMOVED*** Open Questions (Speed Check)
...
***REMOVED******REMOVED*** NEW ISSUE: Faculty-Inpatient Year View Shows Zeros

***REMOVED******REMOVED******REMOVED*** Issue Discovered During Testing
- **Location:** /schedule with Faculty-Inpatient view
- **Symptom:** All faculty show 0 inpatient weeks, empty grid

***REMOVED******REMOVED******REMOVED*** Root Cause Analysis (COMPLETED)
...
***REMOVED******REMOVED******REMOVED*** Frontend Code Reference
```typescript
...
***REMOVED******REMOVED******REMOVED*** Required Fix
