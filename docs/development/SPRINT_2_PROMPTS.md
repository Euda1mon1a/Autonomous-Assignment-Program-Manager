***REMOVED*** Sprint 2 - Copy-Paste Prompts for Comet Assistant

***REMOVED******REMOVED*** READY FOR COMET - 25 TERMINAL PROMPTS

Generated: 2025-12-15

---

***REMOVED******REMOVED*** AUTO-SPAWN PROMPTS (Terminals 1-5)

***REMOVED******REMOVED******REMOVED*** Terminal 1: Analytics API
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 2: Notifications API
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 3: Maintenance API
```
...
***REMOVED******REMOVED*** COMET ROUND A PROMPTS (Terminals 6-9)
...
***REMOVED******REMOVED*** COMET ROUND B PROMPTS (Terminals 10-13)
...
***REMOVED******REMOVED*** COMET ROUND C PROMPTS (Terminals 14-17)
...
***REMOVED******REMOVED*** COMET ROUND D PROMPTS (Terminals 18-21)
...
***REMOVED******REMOVED******REMOVED*** Terminal 20: Performance Testing
```
...
***REMOVED******REMOVED*** COMET ROUND E PROMPTS (Terminals 22-25)
...
***REMOVED******REMOVED******REMOVED*** Terminal 23: Print & Export UI
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 24: Accessibility Components
```
...
***REMOVED******REMOVED*** Execution Checklist
...
***REMOVED******REMOVED******REMOVED*** After Completion
- [ ] Run full test suite
