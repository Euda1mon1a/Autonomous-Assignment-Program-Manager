***REMOVED*** Review Patches for Claude

This document proposes concrete patches for issues found in the review. Apply selectively.

***REMOVED******REMOVED*** 1) Daily Manifest: keep legacy `/assignments/daily-manifest` path
...
***REMOVED******REMOVED*** 2) Import preview: honor manual type selection, otherwise auto-detect
...
***REMOVED******REMOVED*** 3) Pydantic schema: avoid mutable defaults
