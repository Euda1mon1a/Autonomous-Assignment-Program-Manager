***REMOVED*** Faculty Constraints Integration Guide
...
***REMOVED******REMOVED******REMOVED*** 1. Database Migration Applied
```bash
cd backend
...
***REMOVED******REMOVED******REMOVED*** 2. Faculty Roles Assigned
...
***REMOVED*** Example: Assign roles to faculty
...
***REMOVED******REMOVED******REMOVED*** 3. Required Rotation Templates
...
***REMOVED******REMOVED******REMOVED*** 4. Block Structure
...
***REMOVED******REMOVED*** Wiring Up Constraints

***REMOVED******REMOVED******REMOVED*** Option A: Register All Constraints (Recommended)

In your scheduling engine initialization:

```python
from app.scheduling.constraints import (
    ***REMOVED*** Phase 2: Core constraints
    ...
    ***REMOVED*** Phase 4: SM alignment and post-call
...
class SchedulingEngine:
    def __init__(self):
        self.constraints = [
            ***REMOVED*** Hard constraints (order doesn't matter for CP-SAT)
            FacultyRoleClinicConstraint(),
            SMFacultyClinicConstraint(),
            FMITWeekBlockingConstraint(),
            FMITMandatoryCallConstraint(),
            ...
            SMResidentFacultyAlignmentConstraint(),
            PostCallAutoAssignmentConstraint(),
            ***REMOVED*** Soft constraints (weights determine priority)
            SundayCallEquityConstraint(),
            WeekdayCallEquityConstraint(),
            TuesdayCallPreferenceConstraint(),
            DeptChiefWednesdayPreferenceConstraint(),
...
***REMOVED******REMOVED******REMOVED*** Option B: Selective Constraint Loading
...
***REMOVED******REMOVED******REMOVED*** FMIT Week Flow
...
***REMOVED******REMOVED******REMOVED*** Post-Call Assignment Flow
...
***REMOVED******REMOVED******REMOVED*** SM Clinic Flow
...
***REMOVED******REMOVED*** Call Equity Tracking

***REMOVED******REMOVED******REMOVED*** Updating Counters After Scheduling
...
async def update_call_equity_counters(
    ...
    for assignment in assignments:
        ...
        if call_date.weekday() == 6:  ***REMOVED*** Sunday
...
***REMOVED******REMOVED******REMOVED*** Querying Current Equity State
...
***REMOVED******REMOVED******REMOVED*** Unit Testing Individual Constraints
...
***REMOVED******REMOVED******REMOVED*** Smoke Test Script
...
***REMOVED******REMOVED*** Remaining Considerations

***REMOVED******REMOVED******REMOVED*** 1. Template Creation
...
***REMOVED******REMOVED******REMOVED*** 2. Solver Configuration
For large schedules, consider CP-SAT solver time limits:
```python
solver.parameters.max_time_in_seconds = 300  ***REMOVED*** 5 minutes
```

***REMOVED******REMOVED******REMOVED*** 3. Constraint Weights Tuning
...
***REMOVED******REMOVED******REMOVED*** 4. FMIT Week Assignment
...
***REMOVED******REMOVED******REMOVED*** 5. Resident Specialty Tracking
...
***REMOVED******REMOVED******REMOVED*** 6. Audit Trail
Consider logging constraint violations for review:
```python
***REMOVED*** In scheduling service
...
***REMOVED******REMOVED*** Quick Reference: Constraint Priority
