***REMOVED*** Parallel Session Prompts - Round 10
...
***REMOVED******REMOVED*** Terminal 1: Opus-APIFix

**Branch**: `claude/opus-api-fix-r10`
**Priority**: CRITICAL
**Duration**: ~30 min

***REMOVED******REMOVED******REMOVED*** Prompt
...
***REMOVED******REMOVED*** Your Exclusive Files
...
***REMOVED******REMOVED*** Expected Changes
...
***REMOVED******REMOVED*** Terminal 2: Opus-DependabotProtect
...
***REMOVED******REMOVED*** Task 1: Update Dependabot Configuration
...
```yaml
  - package-ecosystem: "npm"
    ...
    schedule:
      interval: "weekly"
    ignore:
      ***REMOVED*** Tailwind v4 is a breaking rewrite - manual updates only
      - dependency-name: "tailwindcss"
        update-types: ["version-update:semver-major", "version-update:semver-minor"]
      ***REMOVED*** PostCSS ecosystem - often has breaking changes
      - dependency-name: "postcss"
        update-types: ["version-update:semver-major"]
      - dependency-name: "autoprefixer"
        update-types: ["version-update:semver-major"]
      ***REMOVED*** Next.js major versions need careful migration
      - dependency-name: "next"
        update-types: ["version-update:semver-major"]
```

***REMOVED******REMOVED*** Task 2: Pin Critical Frontend Dependencies
...
***REMOVED******REMOVED*** Task 3: Commit and Push
...
***REMOVED******REMOVED*** Terminal 3: Opus-FrontendTests
...
***REMOVED******REMOVED*** Task 1: Install MSW
...
***REMOVED******REMOVED*** Task 2: Create MSW Handlers
...
***REMOVED******REMOVED*** Task 3: Create MSW Server
...
***REMOVED******REMOVED*** Task 4: Update Jest Setup
...
***REMOVED******REMOVED*** Task 5: Create Hook Tests
...
***REMOVED******REMOVED*** Task 6: Create Component Test
...
***REMOVED******REMOVED*** Task 7: Run Tests and Commit
...
***REMOVED******REMOVED*** Terminal 4: Opus-E2ETests
...
***REMOVED******REMOVED*** Task 1: Review Playwright Config
...
***REMOVED******REMOVED*** Task 2: Create Auth Tests
...
***REMOVED******REMOVED*** Task 3: Create Schedule Tests
...
***REMOVED******REMOVED*** Task 4: Create People Tests
...
***REMOVED******REMOVED*** Task 5: Create Absences Tests
...
***REMOVED******REMOVED*** Task 6: Add Test Script and Run
...
***REMOVED******REMOVED*** Terminal 5: Opus-ConsoleCleanup
...
***REMOVED******REMOVED*** Task 1: Review Each File

For each file, find console.log and console.error statements.

***REMOVED******REMOVED*** Task 2: Apply Fixes

***REMOVED******REMOVED******REMOVED*** ErrorBoundary.tsx
...
***REMOVED******REMOVED******REMOVED*** export.ts
...
***REMOVED******REMOVED******REMOVED*** ExcelExportButton.tsx
...
***REMOVED******REMOVED******REMOVED*** absences/page.tsx
...
***REMOVED******REMOVED******REMOVED*** QuickAssignMenu.tsx
...
***REMOVED******REMOVED******REMOVED*** QuickActions.tsx
Replace with toast notification:
```typescript
// Before
...
***REMOVED******REMOVED*** Task 3: Check for Toast System
...
***REMOVED******REMOVED*** Task 4: Run TypeScript Check
...
***REMOVED******REMOVED*** Task 5: Commit and Push
...
***REMOVED******REMOVED*** Merge Order

After all terminals complete:

```
1. claude/opus-api-fix-r10           ***REMOVED*** Critical bug fix
2. claude/opus-dependabot-protect-r10 ***REMOVED*** Config only, no conflicts
3. claude/opus-console-cleanup-r10    ***REMOVED*** Isolated component fixes
4. claude/opus-frontend-tests-r10     ***REMOVED*** New test files
5. claude/opus-e2e-tests-r10          ***REMOVED*** New E2E test files
```

***REMOVED******REMOVED*** Conflict Risk Assessment
