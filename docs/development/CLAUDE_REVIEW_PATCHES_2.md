***REMOVED*** Review Patches for Claude (New Findings)

This document proposes concrete fixes for the newest review findings.

***REMOVED******REMOVED*** 1) Conflict list filters: validate enums + bad UUIDs
...
***REMOVED******REMOVED*** 2) Conflict list sorting: restrict sort fields
...
***REMOVED******REMOVED*** 3) Import preview: callback dependencies include `dataTypeSource`
...
***REMOVED******REMOVED*** 4) Daily manifest docstring example: update to new canonical path
