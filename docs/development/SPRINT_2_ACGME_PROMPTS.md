***REMOVED*** Sprint 2 ACGME Compliance - Terminal Prompts
...
***REMOVED******REMOVED*** PHASE 1 PROMPTS (Foundation)

***REMOVED******REMOVED******REMOVED*** Terminal 1: Block Model Enhancement
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 2: Rotation Period Configuration
```
...
***REMOVED******REMOVED*** PHASE 2 PROMPTS (Validators - Run in Parallel)

***REMOVED******REMOVED******REMOVED*** Terminal 3: 80-Hour Rule Validator
```
...
- get_excluded_days(person_id, rotation_period) -> list[date]  ***REMOVED*** vacation/sick
...
***REMOVED******REMOVED******REMOVED*** Terminal 4: 1-in-7 Day Off Validator
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 5: In-House Call Frequency (Q3)
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 6: 24+4 Continuous Duty Rewrite
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 7: 8-Hour Rest Between Shifts
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 8: 14-Hour Post-Call Rest
```
...
***REMOVED******REMOVED*** PHASE 3 PROMPTS (Integration)

***REMOVED******REMOVED******REMOVED*** Terminal 9: Edge Case Handler
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 10: Validator Orchestrator Update
```
...
***REMOVED******REMOVED*** PHASE 4 PROMPTS (Frontend & Docs)

***REMOVED******REMOVED******REMOVED*** Terminal 11: Frontend Block Editor Updates
```
...
***REMOVED******REMOVED******REMOVED*** Terminal 12: ACGME Compliance Documentation
```
