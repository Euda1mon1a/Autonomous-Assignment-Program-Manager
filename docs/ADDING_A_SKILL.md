***REMOVED*** Adding a New Skill to the Personal AI Infrastructure
...
1. [When to Create a New Skill](***REMOVED***when-to-create-a-new-skill)
2. [Skill vs. Existing Capabilities](***REMOVED***skill-vs-existing-capabilities)
3. [Directory Structure Requirements](***REMOVED***directory-structure-requirements)
4. [SKILL.md Template and Specification](***REMOVED***skillmd-template-and-specification)
5. [Workflow File Template](***REMOVED***workflow-file-template)
6. [Reference File Template](***REMOVED***reference-file-template)
7. [Registering in CORE/SKILL.md](***REMOVED***registering-in-coreskillmd)
8. [Testing Checklist](***REMOVED***testing-checklist)
9. [Example: VACATION_MANAGEMENT Skill](***REMOVED***example-vacation_management-skill)
10. [Common Pitfalls](***REMOVED***common-pitfalls)

---

***REMOVED******REMOVED*** When to Create a New Skill

***REMOVED******REMOVED******REMOVED*** Create a NEW Skill When:
...
***REMOVED******REMOVED******REMOVED*** ADD TO Existing Skill When:
...
***REMOVED******REMOVED*** Skill vs. Existing Capabilities

***REMOVED******REMOVED******REMOVED*** Decision Matrix
...
***REMOVED******REMOVED******REMOVED*** Before Creating a Skill: Ask These Questions
...
***REMOVED******REMOVED*** Directory Structure Requirements

***REMOVED******REMOVED******REMOVED*** Simple Skill Structure

Use for skills with straightforward workflows and minimal supporting documentation:

```
.claude/skills/SKILL_NAME/
└── SKILL.md                    ***REMOVED*** Complete skill definition
```
...
***REMOVED******REMOVED******REMOVED*** Complex Skill Structure
...
├── Workflows/                  ***REMOVED*** Step-by-step procedures
│   ├── workflow-1.md
│   ├── workflow-2.md
│   └── workflow-3.md
├── Reference/                  ***REMOVED*** Knowledge base
│   ├── glossary.md
│   ├── thresholds.md
│   └── historical-data.md
└── Tools/                      ***REMOVED*** Optional: CLI scripts
    └── helper-script.sh
```
...
***REMOVED******REMOVED******REMOVED*** Workflow Directory Guidelines
...
***REMOVED******REMOVED******REMOVED*** Reference Directory Guidelines
...
***REMOVED******REMOVED******REMOVED*** Tools Directory (Optional)
...
***REMOVED******REMOVED*** SKILL.md Template and Specification

***REMOVED******REMOVED******REMOVED*** YAML Frontmatter (Optional but Recommended)
...
***REMOVED******REMOVED******REMOVED*** Complete SKILL.md Template
...
***REMOVED******REMOVED*** Core Capabilities

***REMOVED******REMOVED******REMOVED*** Capability 1: [Name]
...
***REMOVED******REMOVED******REMOVED*** Capability 2: [Name]
[Description]
...
***REMOVED******REMOVED*** Skill Phases (if multi-step workflow)

***REMOVED******REMOVED******REMOVED*** Phase 1: [Phase Name]
...
***REMOVED******REMOVED******REMOVED*** Phase 2: [Phase Name]
...
***REMOVED******REMOVED******REMOVED*** Backend Code (if applicable)
```
backend/app/[module]/
├── [key_file_1.py]        ***REMOVED*** [Description]
├── [key_file_2.py]        ***REMOVED*** [Description]
└── [key_file_3.py]        ***REMOVED*** [Description]
```

***REMOVED******REMOVED******REMOVED*** Database Tables Used (if applicable)
- `[table_name]` - [Purpose]
- `[table_name]` - [Purpose]
...
***REMOVED******REMOVED******REMOVED*** API Endpoints (if applicable)
- `GET /api/[endpoint]` - [Purpose]
- `POST /api/[endpoint]` - [Purpose]

***REMOVED******REMOVED*** Output Formats

***REMOVED******REMOVED******REMOVED*** [Output Type 1]
```json
{
  "field1": "value",
  "field2": 123,
...
***REMOVED******REMOVED******REMOVED*** [Output Type 2]
```
...
***REMOVED******REMOVED******REMOVED*** Workflow: [Common Use Case]
```
...
***REMOVED******REMOVED******REMOVED*** Workflow: [Another Use Case]
```
1. [Skill composition pattern]
2. [This skill's role]
```

***REMOVED******REMOVED*** Reference Documents (if complex skill)
...
***REMOVED******REMOVED******REMOVED*** Example 1: [Use Case Name]
```bash
...
***REMOVED*** Expected output: [Description]
```

***REMOVED******REMOVED******REMOVED*** Example 2: [Use Case Name]
```python
***REMOVED*** Python usage example
[code]
```
...
***REMOVED******REMOVED*** Workflow File Template
...
***REMOVED******REMOVED*** Input Requirements
...
***REMOVED******REMOVED******REMOVED*** Step 1: [Step Name]

[Detailed description of what to do in this step]

**Actions:**
```bash
***REMOVED*** Example commands
[command 1]
[command 2]
```
...
**If Error Occurs:**
→ See [Error Handling](***REMOVED***error-handling) section below

***REMOVED******REMOVED******REMOVED*** Step 2: [Step Name]

[Description]

**Actions:**
```python
***REMOVED*** Example Python code
[code]
```
...
***REMOVED******REMOVED******REMOVED*** Step 3: [Step Name]
...
***REMOVED******REMOVED******REMOVED*** Step 4: [Conditional Step]
...
***REMOVED******REMOVED******REMOVED*** Error: [Common Error 1]
...
***REMOVED******REMOVED******REMOVED*** Error: [Common Error 2]
...
***REMOVED******REMOVED*** Reference File Template

Use this template for files in the `Reference/` directory:

```markdown
***REMOVED*** Reference: [Topic Name]
...
***REMOVED******REMOVED*** [Section 1: Definitions/Rules/Formulas]

***REMOVED******REMOVED******REMOVED*** [Item 1]
...
***REMOVED******REMOVED******REMOVED*** [Item 2]

[Same structure as Item 1]

***REMOVED******REMOVED*** [Section 2: Thresholds/Constants]
...
***REMOVED******REMOVED*** [Section 3: Historical Data/Benchmarks]

***REMOVED******REMOVED******REMOVED*** [Time Period or Category]
...
***REMOVED******REMOVED*** [Section 4: Decision Matrix]
...
***REMOVED******REMOVED*** Citations and Sources
...
***REMOVED******REMOVED*** Registering in CORE/SKILL.md

After creating your skill, you MUST register it in `.claude/skills/CORE/SKILL.md`.

***REMOVED******REMOVED******REMOVED*** Step 1: Add to Available Skills List

Find the appropriate category (Domain-Specific, Security, Development, Infrastructure, etc.) and add your skill:

```markdown
***REMOVED******REMOVED******REMOVED******REMOVED*** [Number]. [Skill Display Name] (`skill-directory-name`)
...
***REMOVED******REMOVED******REMOVED*** Step 2: Update Routing Logic Keywords
...
***REMOVED******REMOVED******REMOVED*** Step 3: Update Quick Reference (if applicable)
...
***REMOVED******REMOVED******REMOVED*** Functional Testing
...
***REMOVED******REMOVED******REMOVED*** Code Quality (if skill involves code generation)
...
***REMOVED******REMOVED******REMOVED*** User Acceptance
...
***REMOVED******REMOVED*** Example: VACATION_MANAGEMENT Skill
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Determine if Skill is Needed
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: Choose Structure
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 3: Create Directory Structure
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 4: Create SKILL.md
...
***REMOVED*** VACATION_MANAGEMENT Skill
...
***REMOVED******REMOVED******REMOVED*** Capability 1: Request Validation
...
***REMOVED*** Result: {"valid": False, "violations": ["Overlaps blackout: Block 10 Peds clinic"]}
```

***REMOVED******REMOVED******REMOVED*** Capability 2: Coverage Impact Analysis
...
***REMOVED*** Output: {"health_score_change": -0.08, "risk_level": "MEDIUM", "affected_rotations": ["EM", "Peds Clinic"]}
```

***REMOVED******REMOVED******REMOVED*** Capability 3: Approval Recommendation
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Request Validation
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Coverage Impact Analysis
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Approval Workflow
...
├── vacation_service.py              ***REMOVED*** Request validation
├── vacation_coverage_analyzer.py    ***REMOVED*** Impact analysis
└── vacation_approval.py             ***REMOVED*** Approval workflow
```
...
***REMOVED******REMOVED******REMOVED*** Validation Report
```json
{
...
***REMOVED******REMOVED******REMOVED*** Coverage Impact Report
```json
{
  "request_id": "vac-req-123",
...
***REMOVED******REMOVED******REMOVED*** Approval Decision
```json
{
  "request_id": "vac-req-123",
...
***REMOVED******REMOVED******REMOVED*** Workflow: Complete Vacation Approval
```
...
***REMOVED******REMOVED******REMOVED*** Workflow: Quarterly Vacation Audit
```
...
***REMOVED******REMOVED******REMOVED*** Example 1: Validate Vacation Request
```bash
***REMOVED*** Via API
...
***REMOVED*** Expected output: Validation report (pass/fail + violations)
```

***REMOVED******REMOVED******REMOVED*** Example 2: Assess Coverage Impact
```bash
***REMOVED*** Via MCP tool
mcp__vacation_coverage_check --resident PGY2-03 --start 2025-07-15 --end 2025-07-28

***REMOVED*** Expected output: Health score delta, affected rotations, risk level
```

***REMOVED******REMOVED******REMOVED*** Example 3: Approve Request (Programmatic)
```python
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 5: Create Workflow Files

**Workflows/validate-vacation-request.md:**

```markdown
***REMOVED*** Workflow: Validate Vacation Request
...
***REMOVED******REMOVED******REMOVED*** Step 1: Validate Input Data

**Actions:**
```python
from datetime import date

***REMOVED*** Check dates are valid
...
***REMOVED******REMOVED******REMOVED*** Step 2: Check Blackout Dates
...
***REMOVED******REMOVED******REMOVED*** Step 3: Check Notice Period

**Actions:**
```python
notice_days = (start_date - date.today()).days
policy_min_notice = 30  ***REMOVED*** days
...
***REMOVED******REMOVED******REMOVED*** Step 4: Check Vacation Budget
...
**Validation:**
```python
max_vacation_days = 21  ***REMOVED*** Annual limit
...
***REMOVED******REMOVED******REMOVED*** Step 5: Generate Validation Report
...
***REMOVED******REMOVED******REMOVED*** Error: Resident not found
...
***REMOVED******REMOVED******REMOVED*** Error: Blackout date calendar empty
...
```markdown
***REMOVED*** Workflow: Assess Coverage Impact
...
***REMOVED******REMOVED******REMOVED*** Step 1: Simulate Absence
...
***REMOVED*** Mark resident as absent for requested period
...
***REMOVED******REMOVED******REMOVED*** Step 2: Calculate Health Score Delta

**Actions:**
```python
calculator = HealthScoreCalculator(db)

***REMOVED*** Baseline health score (current state)
baseline_report = await calculator.compute_health_score(
    start_date=request.start_date,
    end_date=request.end_date
)

***REMOVED*** Projected health score (with absence)
...
***REMOVED******REMOVED******REMOVED*** Step 3: Identify Affected Rotations
...
***REMOVED******REMOVED******REMOVED*** Step 4: Run N-1 Vulnerability Analysis
...
***REMOVED*** Baseline: critical residents under current schedule
baseline_critical = await analyzer.identify_critical_residents(
    start_date=request.start_date,
    end_date=request.end_date
)

***REMOVED*** Projected: critical residents after vacation approval
...
***REMOVED******REMOVED******REMOVED*** Step 5: Classify Risk Level
...
***REMOVED******REMOVED******REMOVED*** Step 6: Generate Recommendations

**Actions:**
```python
recommendations = []

***REMOVED*** Understaffed rotations
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 6: Create Reference Files

**Reference/blackout-dates-policy.md:**

```markdown
***REMOVED*** Reference: Blackout Dates Policy
...
***REMOVED******REMOVED*** Rotation-Specific Blackout Periods

***REMOVED******REMOVED******REMOVED*** Pediatrics Clinic
...
***REMOVED******REMOVED******REMOVED*** Emergency Medicine
...
***REMOVED******REMOVED******REMOVED*** Obstetrics & Gynecology
...
***REMOVED******REMOVED*** Policy Enforcement

***REMOVED******REMOVED******REMOVED*** Hard Blackouts (No Exceptions)
- Fellow board exam periods
- New resident orientation
- Public health mandates (e.g., flu clinic)

***REMOVED******REMOVED******REMOVED*** Soft Blackouts (Exception with PD Approval)
- Holiday periods (exception for family emergencies)
- Residency Match Week (exception if substitute coverage secured)

***REMOVED******REMOVED*** Exception Process
...
***REMOVED******REMOVED*** Historical Data

***REMOVED******REMOVED******REMOVED*** 2024 Blackout Violations (Approved Despite Blackout)
...
```markdown
***REMOVED*** Reference: Vacation Policies
...
***REMOVED******REMOVED*** Annual Vacation Allotment
...
***REMOVED******REMOVED*** Request Constraints

***REMOVED******REMOVED******REMOVED*** Minimum Notice Period
...
***REMOVED******REMOVED******REMOVED*** Maximum Consecutive Days
...
***REMOVED******REMOVED******REMOVED*** Auto-Approval Eligible
...
***REMOVED******REMOVED******REMOVED*** Program Director Approval Required
...
***REMOVED******REMOVED******REMOVED*** Denial Reasons
...
***REMOVED******REMOVED*** Rollback Policy
...
***REMOVED******REMOVED*** Fairness Tracking
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 7: Register in CORE/SKILL.md

Add to `.claude/skills/CORE/SKILL.md` under **Domain-Specific Skills**:

```markdown
***REMOVED******REMOVED******REMOVED******REMOVED*** 26. Vacation Management (`vacation-management`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 8: Test the Skill
...
***REMOVED******REMOVED******REMOVED*** Pitfall 1: Skill Too Broad
...
***REMOVED******REMOVED******REMOVED*** Pitfall 2: Skill Too Narrow
...
***REMOVED******REMOVED******REMOVED*** Pitfall 3: Missing Integration Points
...
***REMOVED******REMOVED******REMOVED*** Pitfall 4: No Examples or Examples Too Generic
...
***REMOVED******REMOVED******REMOVED*** Pitfall 5: Undocumented Dependencies
...
***REMOVED******REMOVED******REMOVED*** Pitfall 6: Stale Documentation
...
***REMOVED******REMOVED******REMOVED*** Pitfall 7: No Error Handling Documentation
...
***REMOVED******REMOVED******REMOVED*** Pitfall 8: Circular Dependencies
...
***REMOVED******REMOVED*** Summary: Skill Creation Workflow
