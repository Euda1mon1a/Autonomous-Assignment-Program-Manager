***REMOVED*** Block Schedule Parser Architecture
...
***REMOVED******REMOVED******REMOVED*** 1. Anchor-Based Column Discovery
...
def _find_anchor_columns(self):
    ...
    for row in range(1, min(50, max_rows)):
        for col in range(max_cols):
            ...
            ***REMOVED*** Template anchor: R1, R2, R3, or "TEMPLATE"
            if val in {"R1", "R2", "R3", "R2-NIGHT", "TEMPLATE"}:
                self.template_col = col

            ***REMOVED*** Role anchor: PGY levels or "ROLE"
            if val in {"PGY 1", "PGY 2", "PGY 3", "FAC", "ROLE"}:
                self.role_col = col

            ***REMOVED*** Provider anchor: Known names or "PROVIDER"
            if val in known_names or val == "PROVIDER":
                self.provider_col = col
```

***REMOVED******REMOVED******REMOVED*** 2. Fuzzy Name Matching
...
def _fuzzy_match_name(self, parsed_name: str) -> tuple[str, float]:
    ...
    ***REMOVED*** No match, return original
...
***REMOVED******REMOVED******REMOVED*** 3. Merged Cell Handling
...
***REMOVED******REMOVED******REMOVED*** 4. Date Column Discovery
...
***REMOVED******REMOVED*** API Surface

***REMOVED******REMOVED******REMOVED*** Convenience Functions

```python
***REMOVED*** Parse entire block roster
...
***REMOVED*** Parse FMIT attending schedule
fmit_weeks = parse_fmit_attending(
    filepath="schedule.xlsx"
)
```

***REMOVED******REMOVED******REMOVED*** Class Usage
...
***REMOVED******REMOVED******REMOVED*** 2. JSON (CLI or API)
...
***REMOVED******REMOVED******REMOVED*** 3. Markdown
...
***REMOVED******REMOVED******REMOVED*** Sheet Naming
...
***REMOVED******REMOVED******REMOVED*** Recoverable Errors (Warnings)

- Low confidence name match
- Missing optional columns
- Unexpected template values

***REMOVED******REMOVED******REMOVED*** Fatal Errors
