...
***REMOVED******REMOVED*** Core Architecture Documents
...
***REMOVED******REMOVED******REMOVED*** Constraints & Validation
...
***REMOVED******REMOVED******REMOVED*** Advanced Optimization
...
***REMOVED******REMOVED******REMOVED*** Experimental Research
...
***REMOVED******REMOVED******REMOVED*** Integration & Orchestration
...
***REMOVED******REMOVED******REMOVED*** Security & Operations
...
***REMOVED******REMOVED******REMOVED*** Visualization & Analytics
...
***REMOVED******REMOVED******REMOVED*** Decision Records & Lessons
...
***REMOVED******REMOVED*** Architectural Decision Records (ADRs)

Formal records of significant architectural decisions:

***REMOVED******REMOVED******REMOVED*** Adopted ADRs
...
***REMOVED******REMOVED*** Key Architectural Principles
...
***REMOVED******REMOVED******REMOVED*** 6. Security
- JWT authentication with httpOnly cookies
- Role-based access control (RBAC)
- Rate limiting on sensitive endpoints
- OPSEC/PERSEC for military medical data

***REMOVED******REMOVED******REMOVED*** 7. Testability
...
***REMOVED******REMOVED*** Tech Stack Overview
...
***REMOVED******REMOVED*** Contributing to Architecture

***REMOVED******REMOVED******REMOVED*** When to Document
...
***REMOVED******REMOVED******REMOVED*** ADR Process
...
***REMOVED******REMOVED******REMOVED*** Documentation Standards
