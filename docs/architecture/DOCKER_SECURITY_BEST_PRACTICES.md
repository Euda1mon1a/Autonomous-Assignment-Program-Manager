***REMOVED*** Docker Security Best Practices
...
***REMOVED******REMOVED*** Security Measures by Container

***REMOVED******REMOVED******REMOVED*** Backend (`backend/Dockerfile`)
...
***REMOVED******REMOVED******REMOVED*** Frontend (`frontend/Dockerfile`)
...
***REMOVED******REMOVED******REMOVED*** MCP Server (`mcp-server/Dockerfile`)
...
***REMOVED******REMOVED******REMOVED*** Nginx (`nginx/Dockerfile`)
...
***REMOVED******REMOVED*** Docker Compose Security

***REMOVED******REMOVED******REMOVED*** Base Configuration (`docker-compose.yml`)
...
***REMOVED******REMOVED******REMOVED*** Production Configuration (`docker-compose.prod.yml`)
...
***REMOVED******REMOVED*** CI/CD Security Scanning

Security scanning is automated via `.github/workflows/security.yml`:

***REMOVED******REMOVED******REMOVED*** Vulnerability Scanning
...
***REMOVED******REMOVED******REMOVED*** Static Analysis
...
***REMOVED******REMOVED******REMOVED*** Container Image Scanning

```yaml
***REMOVED*** Builds and scans both backend and frontend images
docker-scan:
  strategy:
    matrix:
...
***REMOVED******REMOVED******REMOVED*** Application-Level Validation
...
***REMOVED******REMOVED*** What We Don't Implement (and Why)
...
***REMOVED******REMOVED******REMOVED*** Check non-root users

```bash
***REMOVED*** Backend
docker compose exec backend whoami
***REMOVED*** Expected: appuser

***REMOVED*** Frontend
docker compose exec frontend whoami
***REMOVED*** Expected: nextjs

***REMOVED*** MCP Server
docker compose exec mcp-server whoami
***REMOVED*** Expected: mcp
```

***REMOVED******REMOVED******REMOVED*** Check health status

```bash
docker compose ps --format "table {{.Name}}\t{{.Status}}"
```

***REMOVED******REMOVED******REMOVED*** Run vulnerability scan locally
