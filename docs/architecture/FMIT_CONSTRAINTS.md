...
***REMOVED******REMOVED******REMOVED*** Faculty FMIT Week
...
***REMOVED******REMOVED******REMOVED*** Resident FMIT Week
...
***REMOVED******REMOVED*** Faculty vs Resident: Template Matching
...
***REMOVED******REMOVED******REMOVED*** 1. FMITWeekBlockingConstraint
...
***REMOVED******REMOVED******REMOVED*** 2. FMITMandatoryCallConstraint
...
***REMOVED******REMOVED******REMOVED*** 3. PostFMITRecoveryConstraint
...
***REMOVED******REMOVED******REMOVED*** 4. PostFMITSundayBlockingConstraint
...
***REMOVED******REMOVED******REMOVED*** 5. FMITContinuityTurfConstraint
...
***REMOVED******REMOVED******REMOVED*** 6. FMITStaffingFloorConstraint
...
***REMOVED******REMOVED******REMOVED*** `get_fmit_week_dates(any_date: date) -> tuple[date, date]`
...
***REMOVED******REMOVED******REMOVED*** `is_sun_thurs(any_date: date) -> bool`
