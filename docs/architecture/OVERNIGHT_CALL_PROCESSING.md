***REMOVED*** Overnight Call Processing Architecture

> **Last Updated:** 2025-12-27
> **Status:** Implemented
> **Related PRs:** ***REMOVED***470, ***REMOVED***472 (unified)
...
***REMOVED******REMOVED******REMOVED*** Weeknight Call (Solver-Generated)
...
***REMOVED******REMOVED******REMOVED*** Weekend Call (FMIT-Managed)
...
***REMOVED******REMOVED*** Architecture Layers
...
***REMOVED******REMOVED******REMOVED*** Modular Constraint Trio

The overnight call system uses three modular hard constraints:

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. OvernightCallCoverageConstraint

**Purpose:** Ensures exactly one faculty member is assigned overnight call for each Sun-Thu night.

```python
***REMOVED*** Constraint: sum of all faculty call vars for this date == 1
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. AdjunctCallExclusionConstraint

**Purpose:** Prevents adjunct faculty from being auto-assigned call.

```python
***REMOVED*** Constraint: adjunct call vars forced to 0
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. CallAvailabilityConstraint

**Purpose:** Blocks call assignment when faculty is unavailable.

```python
***REMOVED*** Constraint: call blocked when unavailable
...
***REMOVED******REMOVED*** Solver Integration

***REMOVED******REMOVED******REMOVED*** Variable Creation

Call assignment variables are created in both PuLP and CP-SAT solvers:

```python
***REMOVED*** In solver.solve()
call = {}
...
***REMOVED******REMOVED******REMOVED*** Solution Extraction
...
***REMOVED******REMOVED*** SchedulingContext Fields
...
class SchedulingContext:
    ...
    ***REMOVED*** Call-eligible faculty (excludes adjuncts)
...
class CallAssignment(Base):
    ...
    call_type = Column(String(50))  ***REMOVED*** 'overnight', 'weekend', 'backup'
...
***REMOVED******REMOVED*** FMIT Coordination
