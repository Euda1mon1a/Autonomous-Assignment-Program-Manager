...
***REMOVED******REMOVED******REMOVED*** 8. Recovery Distance (Operations Research)
...
***REMOVED******REMOVED*** Advanced Modules

***REMOVED******REMOVED******REMOVED*** Artificial Immune System (AIS)
...
***REMOVED******REMOVED******REMOVED*** Burnout Contagion Model
