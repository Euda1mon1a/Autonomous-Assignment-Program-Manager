...
***REMOVED******REMOVED******REMOVED******REMOVED*** MCP Tools
...
See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***run_spc_analysis) for full documentation.
...
result = await calculate_process_capability_tool(
    ...
    lower_spec_limit=40.0,  ***REMOVED*** Minimum hours
    upper_spec_limit=80.0   ***REMOVED*** ACGME max
)
print(f"Cpk: {result.cpk:.2f} - {result.interpretation}")
```

See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***calculate_process_capability_tool) for full documentation.
...
See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***calculate_burnout_rt) for full documentation.
...
See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***optimize_erlang_coverage) for full documentation.
...
See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***detect_burnout_precursors) for full documentation.
...
result = await calculate_fire_danger_index(
    resident_id="abc-123",
    recent_hours=75.0,       ***REMOVED*** High recent workload
    monthly_load=260.0,      ***REMOVED*** Sustained overwork
    yearly_satisfaction=0.4, ***REMOVED*** Low satisfaction
    workload_velocity=8.0    ***REMOVED*** Increasing workload
)
...
See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***calculate_fire_danger_index) for full documentation.
...
See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***assess_creep_fatigue) for full documentation.
...
See [MCP Tools Reference](../api/MCP_TOOLS_REFERENCE.md***REMOVED***calculate_recovery_distance) for full documentation.

---

***REMOVED******REMOVED*** MCP Tools Integration
...
***REMOVED******REMOVED******REMOVED*** Composite Analytics Tools
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Unified Critical Index
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Transcription Triggers
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Equity Metrics
...
***REMOVED******REMOVED******REMOVED*** MCP Tool Categories Summary
...
***REMOVED******REMOVED******REMOVED*** Full Reference
...
***REMOVED******REMOVED*** Tier 4: Exotic Cross-Disciplinary Research (NEW - 2025-12-29)
...
***REMOVED******REMOVED******REMOVED*** 9. Kalman Filter (Control Theory)
...
***REMOVED******REMOVED******REMOVED*** 10. Fourier/FFT Analysis (Signal Processing)
...
***REMOVED******REMOVED******REMOVED*** 11. Game Theory (Economics)
...
***REMOVED******REMOVED******REMOVED*** 12. Value-at-Risk (Financial Engineering)
...
***REMOVED******REMOVED******REMOVED*** 13. Lotka-Volterra Dynamics (Ecology)
...
***REMOVED******REMOVED******REMOVED*** 14. Hopfield Network Attractors (Neuroscience)
...
***REMOVED******REMOVED******REMOVED*** Integration: Exotic Tools with Core Framework
...
***REMOVED******REMOVED******REMOVED*** Full Documentation
...
***REMOVED******REMOVED*** Tier 5: Exotic Frontier Physics & Mathematics (NEW - 2025-12-29)
...
***REMOVED******REMOVED******REMOVED*** 15. Metastability Detection
...
***REMOVED******REMOVED******REMOVED*** 16. Spin Glass Constraint Model
...
***REMOVED******REMOVED******REMOVED*** 17. Circadian Phase Response Curves
...
***REMOVED******REMOVED******REMOVED*** 18. Penrose Process Efficiency
...
***REMOVED******REMOVED******REMOVED*** 19. Anderson Localization
...
***REMOVED******REMOVED******REMOVED*** 20. Persistent Homology (TDA)
...
***REMOVED******REMOVED******REMOVED*** 21. Free Energy Principle
...
***REMOVED******REMOVED******REMOVED*** 22. Keystone Species Analysis
...
***REMOVED******REMOVED******REMOVED*** 23. Quantum Zeno Governor
...
***REMOVED******REMOVED******REMOVED*** 24. Catastrophe Theory Detector
...
***REMOVED******REMOVED******REMOVED*** Integration with Core Framework
