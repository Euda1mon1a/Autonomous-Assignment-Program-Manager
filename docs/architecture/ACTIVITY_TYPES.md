***REMOVED*** Activity Types Reference
...
***REMOVED******REMOVED*** Solver-Managed Types

***REMOVED******REMOVED******REMOVED*** `outpatient` (16 templates)
...
***REMOVED******REMOVED******REMOVED*** `procedures` (6 templates)
...
***REMOVED******REMOVED******REMOVED*** `off` (5 templates)
...
***REMOVED******REMOVED******REMOVED*** `education` (5 templates)
...
***REMOVED******REMOVED******REMOVED*** `absence` (4 templates)
...
***REMOVED******REMOVED******REMOVED*** `recovery` (1 template)
...
***REMOVED******REMOVED*** Engine Behavior

***REMOVED******REMOVED******REMOVED*** Loading Preserved Assignments
...
***REMOVED*** Inpatient rotations
self._load_fmit_assignments()           ***REMOVED*** FMIT for faculty
self._load_resident_inpatient_assignments()  ***REMOVED*** All resident inpatient

***REMOVED*** Other preserved types
self._load_absence_assignments()        ***REMOVED*** Leave, Weekend
self._load_offsite_assignments()        ***REMOVED*** Hilo, Kapiolani, Okinawa
self._load_recovery_assignments()       ***REMOVED*** Post-Call
self._load_education_assignments()      ***REMOVED*** FMO, GME, Lectures
```

***REMOVED******REMOVED******REMOVED*** Conflict Filtering
...
***REMOVED*** Skip if slot is occupied by preserved assignment
if (person_id, block_id) in occupied_slots:
    continue  ***REMOVED*** Do not create this assignment
```

---

***REMOVED******REMOVED*** Template Naming Conventions
