***REMOVED*** Academic Year Block Structure
...
***REMOVED******REMOVED*** Block Types

***REMOVED******REMOVED******REMOVED*** Block 0: Orientation
...
***REMOVED******REMOVED******REMOVED*** Blocks 1-12: Standard Rotation Blocks
- **Duration**: 28 days each
- **Pattern**: Thursday through Wednesday (Thu→Wed)
- **Total**: 336 days (12 blocks x 28 days)

***REMOVED******REMOVED******REMOVED*** Block 13: Final Block
- **Duration**: 27 days
...
***REMOVED******REMOVED*** AY 2025-2026 Block Schedule
...
***REMOVED******REMOVED*** Daily Block Structure
...
***REMOVED******REMOVED*** Leap Year Handling
...
***REMOVED******REMOVED*** Key Invariants
