***REMOVED*** Circadian-Workload Resonance Patterns
...
1. [Biological Background](***REMOVED***biological-background)
2. [Resonance Patterns Catalog](***REMOVED***resonance-patterns-catalog)
3. [Detection Algorithms](***REMOVED***detection-algorithms)
4. [Mitigation Strategies](***REMOVED***mitigation-strategies)
5. [Integration with FRMS](***REMOVED***integration-with-frms)
6. [Validation Evidence](***REMOVED***validation-evidence)

---

***REMOVED******REMOVED*** Biological Background

***REMOVED******REMOVED******REMOVED*** The Circadian System
...
***REMOVED******REMOVED******REMOVED*** Window of Circadian Low (WOCL)
...
***REMOVED******REMOVED******REMOVED*** Resonance Effect
...
***REMOVED******REMOVED*** Resonance Patterns Catalog

***REMOVED******REMOVED******REMOVED*** Pattern 1: WOCL Procedure Scheduling
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Rotating Shift Desynchronization
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Early Morning Start Syndrome
...
def detect_early_start_syndrome(schedule, typical_bedtime=23.0):
    ...
    ***REMOVED*** Calculate implied sleep duration
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Post-Night Recovery Failure
...
***REMOVED******REMOVED******REMOVED*** Pattern 5: Cumulative Debt Cascade
...
***REMOVED******REMOVED******REMOVED*** Pattern 6: Post-Call Circadian Disruption
...
def detect_post_call_disruption(call_end_time, next_activity_time):
    ...
    ***REMOVED*** Danger zone: 0-4 hours after call ending in early morning
...
***REMOVED******REMOVED******REMOVED*** Pattern 7: Weekend Call Circadian Shift
...
def detect_weekend_call_shift(schedule):
    ...
    for call in weekend_calls:
        ...
        if friday_activity and friday_activity.hour > 20:
            ***REMOVED*** Late Friday -> early weekend call
            return {
...
***REMOVED******REMOVED*** Detection Algorithms

***REMOVED******REMOVED******REMOVED*** Composite Resonance Score
...
def calculate_composite_resonance(person_id, schedule, current_time):
    ...
    ***REMOVED*** Combine amplifiers (multiplicative with diminishing returns)
    composite = 1.0
    for detection in sorted(detections, key=lambda d: d["amplifier"], reverse=True):
        ***REMOVED*** Each additional pattern adds diminishing amplification
        marginal = (detection["amplifier"] - 1.0) * 0.7
        composite += marginal

    return min(composite, 5.0)  ***REMOVED*** Cap at 5x amplification
```

***REMOVED******REMOVED******REMOVED*** Real-Time Detection
...
***REMOVED******REMOVED*** Mitigation Strategies

***REMOVED******REMOVED******REMOVED*** Scheduler Integration
...
class ResonanceAwareConstraint(SoftConstraint):
    ...
    def calculate_penalty(self, proposed_assignment, current_schedule):
        ***REMOVED*** Project schedule with proposed assignment
        test_schedule = current_schedule + [proposed_assignment]

        ***REMOVED*** Calculate resonance
        resonance = calculate_composite_resonance(
        ...
        ***REMOVED*** Penalty proportional to resonance above 1.0
        if resonance > 1.0:
            return self.weight * (resonance - 1.0) * 100
        return 0
```

***REMOVED******REMOVED******REMOVED*** Intervention Recommendations
...
***REMOVED******REMOVED*** Integration with FRMS

***REMOVED******REMOVED******REMOVED*** Three-Process Model Extension
...
class ThreeProcessModel:
    ...
    def calculate_effectiveness(self, state, time_of_day, schedule=None):
        ***REMOVED*** Base three-process calculation
        base_score = self._calculate_base_effectiveness(state, time_of_day)

        ***REMOVED*** Apply resonance modification if schedule provided
        if schedule:
            resonance = calculate_composite_resonance(
...
***REMOVED******REMOVED******REMOVED*** QUBO Penalty Terms
...
def add_resonance_penalties(Q, formulation, context):
    ...
    for resident in context.residents:
        for block in context.blocks:
            ***REMOVED*** Project resonance if this assignment is made
            ...
            if projected_resonance > 1.2:
                ...
                ***REMOVED*** Add to diagonal (linear term)
...
***REMOVED******REMOVED*** Validation Evidence

***REMOVED******REMOVED******REMOVED*** Aviation Studies
...
***REMOVED******REMOVED******REMOVED*** Medical Studies
...
***REMOVED******REMOVED******REMOVED*** Implementation Metrics
