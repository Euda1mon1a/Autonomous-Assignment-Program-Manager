***REMOVED*** Game Theory Framework Architecture
...
***REMOVED******REMOVED******REMOVED*** Prisoner's Dilemma Mapping
...
***REMOVED******REMOVED******REMOVED*** Strategy Types
...
backend/app/
├── models/
│   └── game_theory.py          ***REMOVED*** SQLAlchemy models
├── schemas/
│   └── game_theory.py          ***REMOVED*** Pydantic schemas
├── services/
│   └── game_theory.py          ***REMOVED*** Business logic + Axelrod integration
└── api/routes/
    └── game_theory.py          ***REMOVED*** REST API endpoints
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Database Models

```python
***REMOVED*** ConfigStrategy - Represents a configuration as a game strategy
class ConfigStrategy(Base):
    id: UUID
    name: str
    strategy_type: StrategyType  ***REMOVED*** cooperative, aggressive, tit_for_tat, etc.
    utilization_target: float
    cross_zone_borrowing: bool
    sacrifice_willingness: str  ***REMOVED*** low, medium, high
    response_timeout_ms: int
    custom_logic: Optional[str]  ***REMOVED*** JSON for custom behavior
    is_active: bool

***REMOVED*** GameTheoryTournament - Round-robin tournament execution
class GameTheoryTournament(Base):
    ...
    repetitions: int
    noise: float
    results: Optional[dict]  ***REMOVED*** JSON results

***REMOVED*** EvolutionSimulation - Moran process evolutionary simulation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** GameTheoryService
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ResilienceConfigPlayer
...
class ResilienceConfigPlayer(axl.Player):
    ...
    def strategy(self, opponent: axl.Player) -> axl.Action:
        ***REMOVED*** First move: always cooperate (nice property)
        if len(self.history) == 0:
            return axl.Action.C

        ***REMOVED*** Map strategy_type to behavior
...
│   └── page.tsx                    ***REMOVED*** Main dashboard page
├── components/game-theory/
│   ├── PayoffMatrix.tsx            ***REMOVED*** Heatmap visualization
│   ├── EvolutionChart.tsx          ***REMOVED*** Population dynamics chart
│   ├── StrategyCard.tsx            ***REMOVED*** Strategy display
│   ├── TournamentCard.tsx          ***REMOVED*** Tournament results
│   └── index.ts                    ***REMOVED*** Barrel export
├── hooks/
│   └── useGameTheory.ts            ***REMOVED*** TanStack Query hooks
└── types/
    └── game-theory.ts              ***REMOVED*** TypeScript types
```

***REMOVED******REMOVED******REMOVED******REMOVED*** React Hooks
...
***REMOVED******REMOVED******REMOVED*** Tournament Execution Flow
...
***REMOVED******REMOVED******REMOVED*** Evolution Simulation Flow
...
***REMOVED******REMOVED******REMOVED*** Mapping to Existing Concepts
...
***REMOVED******REMOVED******REMOVED*** Using Game Theory for Resilience Validation
...
***REMOVED******REMOVED******REMOVED*** Tournament Complexity
...
***REMOVED******REMOVED******REMOVED*** Evolution Complexity
