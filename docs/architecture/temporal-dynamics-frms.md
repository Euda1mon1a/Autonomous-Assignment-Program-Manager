***REMOVED*** Temporal Dynamics: Fatigue Risk Management System (FRMS)
...
***REMOVED******REMOVED*** The Temporal Constraint Challenge
...
***REMOVED******REMOVED*** Theoretical Foundations

***REMOVED******REMOVED******REMOVED*** The Three-Process Model
...
***REMOVED******REMOVED******REMOVED*** Samn-Perelli Fatigue Scale
...
***REMOVED******REMOVED******REMOVED*** Circadian Rhythm Phases
...
***REMOVED******REMOVED******REMOVED*** Sleep Debt Accumulation
...
***REMOVED******REMOVED*** FRMS Architecture

***REMOVED******REMOVED******REMOVED*** Component Stack
...
***REMOVED******REMOVED*** Hazard Threshold System

Adapted from aviation FRMS with medical-specific thresholds:

***REMOVED******REMOVED******REMOVED*** Level Definitions
...
***REMOVED******REMOVED******REMOVED*** Mitigation Escalation
...
***REMOVED******REMOVED*** Scheduling Constraints
...
***REMOVED******REMOVED******REMOVED*** Real-Time Fatigue Scoring
```
...
***REMOVED******REMOVED******REMOVED*** Resident Fatigue Profile
```
GET /api/v1/fatigue-risk/resident/{id}/profile
→ Returns: Complete fatigue state, hazard level, ACGME status
```

***REMOVED******REMOVED******REMOVED*** Schedule Fatigue Assessment
```
...
***REMOVED******REMOVED******REMOVED*** Tests Proving FRMS Prevents ACGME Violations
...
***REMOVED******REMOVED******REMOVED*** Metrics for Evaluation
