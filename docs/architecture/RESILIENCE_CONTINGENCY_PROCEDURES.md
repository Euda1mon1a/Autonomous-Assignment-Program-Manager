***REMOVED*** N-1/N-2 Contingency Analysis & Procedures
...
2. [Contingency Scanning Schedule](***REMOVED***contingency-scanning-schedule)
3. [Vulnerability Detection Procedures](***REMOVED***vulnerability-detection-procedures)
4. [Fallback Activation Procedures](***REMOVED***fallback-activation-procedures)
5. [Test Scenarios](***REMOVED***test-scenarios)
6. [Contingency Dashboard](***REMOVED***contingency-dashboard)

---

***REMOVED******REMOVED*** Executive Summary

***REMOVED******REMOVED******REMOVED*** What are N-1 and N-2 Vulnerabilities?
...
***REMOVED******REMOVED*** Contingency Scanning Schedule

***REMOVED******REMOVED******REMOVED*** Automated Scanning (Weekly)
...
def scan_contingencies(self, program_id: str):
    ...
    ***REMOVED*** 1. Get current assignments
    assignments = get_week_assignments(program_id)

    ***REMOVED*** 2. Run N-1 analysis
    n1_vulns = analyze_n1_vulnerabilities(
        program,
        assignments,
        threshold_critical=0.20  ***REMOVED*** >20% blocks affected = CRITICAL
    )

    ***REMOVED*** 3. Run N-2 analysis (only test critical pairs)
    ...
    n2_vulns = analyze_n2_vulnerabilities(
        ...
        threshold_dangerous=0.10  ***REMOVED*** >10% blocks uncovered = DANGEROUS
    )

    ***REMOVED*** 4. Update contingency tracking
    store_contingency_analysis(program, n1_vulns, n2_vulns)

    ***REMOVED*** 5. Alert on new critical vulnerabilities
    ...
    ***REMOVED*** 6. Generate contingency dashboard update
...
***REMOVED******REMOVED******REMOVED*** Manual Scanning (On-Demand)
...
***REMOVED******REMOVED******REMOVED*** Quarterly Deep Dive
...
***REMOVED******REMOVED*** Vulnerability Detection Procedures
...
def analyze_n1_vulnerabilities(program, assignments, threshold_critical=0.20):
    ...
    for faculty in program.active_faculty:
        ***REMOVED*** 1. Create "removed" assignment state
        assignments_without_faculty = [
            a for a in assignments
            if a.person_id != faculty.id
        ]

        ***REMOVED*** 2. For each block this faculty is assigned to
        affected_blocks = set()
        ...
        ***REMOVED*** 3. Calculate severity
        ...
        if len(uncovered_blocks) > 0:
            severity = "CRITICAL"  ***REMOVED*** Any uncovered blocks = critical
...
***REMOVED******REMOVED******REMOVED*** Identifying Vulnerability Reasons
...
***REMOVED******REMOVED******REMOVED*** Example: Full Vulnerability Report
...
***REMOVED******REMOVED*** Fallback Activation Procedures

***REMOVED******REMOVED******REMOVED*** Pre-Planned Fallbacks
...
***REMOVED******REMOVED******REMOVED*** Fallback Activation Triggers
...
***REMOVED******REMOVED******REMOVED*** Fallback Maintenance
...
***REMOVED******REMOVED******REMOVED*** Monthly Contingency Drills
...
def monthly_contingency_drill(program_id):
    ...
    ***REMOVED*** 1. Select random critical vulnerability
    ...
    ***REMOVED*** 2. Ask: "What happens if they're absent next Monday?"
    ***REMOVED*** 3. Review fallback plan
    ***REMOVED*** 4. Walk through activation steps
    ***REMOVED*** 5. Verify fallback person is available/willing
    ***REMOVED*** 6. Discuss any issues/improvements

    ***REMOVED*** 7. Document results
...
***REMOVED******REMOVED******REMOVED*** Scenario 1: Single Faculty Absence
...
***REMOVED******REMOVED******REMOVED*** Scenario 2: Multiple Absences
...
***REMOVED******REMOVED******REMOVED*** Scenario 3: Fallback Unavailable (Chain of Failure)
...
***REMOVED******REMOVED*** Contingency Dashboard
...
***REMOVED******REMOVED*** Appendix: Contingency Checklist

***REMOVED******REMOVED******REMOVED*** For Each Critical N-1 Vulnerability:
...
***REMOVED******REMOVED******REMOVED*** For Each Critical N-2 Pair:
