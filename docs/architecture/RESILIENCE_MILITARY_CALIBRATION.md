***REMOVED*** Military Medical Resilience Calibration
...
2. [Military Medical Context](***REMOVED***military-medical-context)
3. [TDY/Deployment Fatigue Weighting](***REMOVED***tdydeployment-fatigue-weighting)
4. [Post-Deployment Recovery Periods](***REMOVED***post-deployment-recovery-periods)
5. [Rank/Hierarchy Stress Factors](***REMOVED***rankhierarchy-stress-factors)
6. [Military-Specific Rt Calculation Adjustments](***REMOVED***military-specific-rt-calculation-adjustments)
7. [Implementation Procedures](***REMOVED***implementation-procedures)
8. [Monitoring Dashboard](***REMOVED***monitoring-dashboard)
9. [Case Studies](***REMOVED***case-studies)
...
***REMOVED******REMOVED******REMOVED*** Operational Environment Characteristics

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. **TDY/Temporary Duty Assignments**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. **Deployment Cycles**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. **Rank-Based Hierarchy Impact**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. **OPSEC/PERSEC Constraints**
...
***REMOVED******REMOVED******REMOVED*** Operational Tempo Categories
...
***REMOVED******REMOVED*** TDY/Deployment Fatigue Weighting

***REMOVED******REMOVED******REMOVED*** Allostatic Load Adjustment Algorithm
...
allostatic_load_military = (
    0.35*work_hours +                    ***REMOVED*** Base workload (5% increase)
    0.40*schedule_variance +              ***REMOVED*** Schedule unpredictability
    0.25*psychosocial_stress +            ***REMOVED*** Reduced slightly (amplified by TDY)
    0.10*tdy_fatigue_factor +             ***REMOVED*** NEW: TDY-specific component
    0.05*deployment_reintegration         ***REMOVED*** NEW: Post-deployment stress
)

Where:
  tdy_fatigue_factor = (
      0.50 * active_tdy_indicator +       ***REMOVED*** Currently on TDY (0 or 1)
      0.30 * tdy_frequency_last_6mo +     ***REMOVED*** How many TDYs in past 6 months
      0.20 * avg_tdy_duration             ***REMOVED*** Average length of TDYs (normalized 0-1)
  )
...
***REMOVED******REMOVED******REMOVED*** TDY Fatigue Factor Breakdown
...
***REMOVED******REMOVED******REMOVED*** Deployment Reintegration Weighting
...
***REMOVED******REMOVED*** Post-Deployment Recovery Periods

***REMOVED******REMOVED******REMOVED*** Mandatory Recovery Schedule
...
***REMOVED******REMOVED******REMOVED*** Recovery Schedule Implementation
...
***REMOVED******REMOVED******REMOVED*** Psychosocial Recovery Support
...
***REMOVED******REMOVED******REMOVED*** Return-to-Duty Clearance
...
***REMOVED******REMOVED*** Rank/Hierarchy Stress Factors

***REMOVED******REMOVED******REMOVED*** Rank-Based Workload Distribution
...
***REMOVED******REMOVED******REMOVED*** Rank-Based Burnout Contagion Model
...
***REMOVED******REMOVED******REMOVED*** Hierarchy-Based Role Stress
...
***REMOVED******REMOVED******REMOVED*** Hierarchy-Based Support Structures
...
***REMOVED******REMOVED*** Military-Specific Rt Calculation Adjustments

***REMOVED******REMOVED******REMOVED*** Modified Rt Formula for Military Context
...
***REMOVED******REMOVED******REMOVED*** Military Multiplier Components

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. TDY Contagion Amplifier

```
TDY Contagion = (
    0.6 * tdy_return_clustering +        ***REMOVED*** Multiple returns same week
    0.4 * psychosocial_sharing_intensity  ***REMOVED*** Return decompression
)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Deployment Cycle Amplifier
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Rank Hierarchy Amplifier
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Isolation Amplifier
...
***REMOVED******REMOVED******REMOVED*** Complete Example: Military Rt Calculation
...
***REMOVED******REMOVED******REMOVED*** Quarterly Rt Review Protocol
...
***REMOVED******REMOVED*** Implementation Procedures

***REMOVED******REMOVED******REMOVED*** Configuration Setup

**In System Configuration:**

```python
***REMOVED*** backend/app/core/config.py (add military adjustments)

MILITARY_MEDICAL_ADJUSTMENTS = {
    "enabled": True,
    "program_type": "military",  ***REMOVED*** or "civilian"
    ...
    "mandatory_recovery": {
        "3_months_deployment": 1,   ***REMOVED*** months
    ...
    "recovery_phases": {
        "phase_1_duration": 14,  ***REMOVED*** days
...
***REMOVED******REMOVED******REMOVED*** Monitoring Implementation
...
def calculate_military_adjusted_metrics(self, program_id: str):
    ...
    if not program.military_medical_mode:
        return  ***REMOVED*** Skip if not military

    ***REMOVED*** 1. Calculate TDY status for each resident
    ...
    for resident in residents:
        ...
        ***REMOVED*** 2. Adjust allostatic load
        ...
        ***REMOVED*** 3. Store adjusted metrics
        store_military_metrics(resident, adjusted_load)

    ***REMOVED*** 4. Calculate Rt with military multiplier
...
***REMOVED******REMOVED******REMOVED*** Key Military-Specific Metrics
...
***REMOVED******REMOVED******REMOVED*** Case 1: Successful TDY Management
...
***REMOVED******REMOVED******REMOVED*** Case 2: Post-Deployment Reintegration Failure
...
***REMOVED******REMOVED******REMOVED*** Stress Factor Checklist
...
***REMOVED******REMOVED******REMOVED*** Escalation Decision Tree (Military Context)
