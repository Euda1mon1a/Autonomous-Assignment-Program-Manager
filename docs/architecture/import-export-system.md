***REMOVED*** Import/Export System Architecture
...
***REMOVED******REMOVED******REMOVED*** Backend Excel Export (Recommended)
...
async def export_schedule_xlsx(
    ...
    wb = Workbook()
    ws = wb.active
    ***REMOVED*** ... generate Excel content
...
***REMOVED******REMOVED******REMOVED*** Frontend Excel Export (Fallback)
...
***REMOVED******REMOVED******REMOVED*** Frontend → Backend Excel Export
...
***REMOVED******REMOVED******REMOVED*** Backend Excel Import
...
***REMOVED******REMOVED******REMOVED*** Frontend Import
...
***REMOVED******REMOVED******REMOVED*** File Upload Validation
...
***REMOVED******REMOVED******REMOVED*** ⚠️ Known Issues
...
***REMOVED******REMOVED******REMOVED*** Data Sanitization

```python
***REMOVED*** PII fields are masked in logs
SENSITIVE_FIELDS = ["ssn", "email", "phone", "mrn"]

***REMOVED*** Validation via Pydantic schemas
...
***REMOVED******REMOVED******REMOVED*** NOT Used
