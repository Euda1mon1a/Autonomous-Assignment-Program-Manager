***REMOVED*** Session 14 Lessons Learned: Deployment Debugging
...
***REMOVED******REMOVED*** Issues Discovered and Fixed
...
***REMOVED******REMOVED******REMOVED*** 2. Missing `freeze_horizon_days` and `freeze_scope` in ApplicationSettings
...
***REMOVED******REMOVED******REMOVED*** 3. Version Table Naming Mismatch
...
***REMOVED******REMOVED******REMOVED*** 4. PropertyModTrackerPlugin Requires `*_mod` Columns
...
***REMOVED******REMOVED******REMOVED*** 5. CORS Errors Masking Backend Crashes
...
***REMOVED******REMOVED******REMOVED*** 6. 307 Redirect Drops CORS Headers
...
***REMOVED******REMOVED******REMOVED*** 7. Rate Limit Cascade Causing Frontend Seizure
...
***REMOVED******REMOVED******REMOVED*** 8. Frontend Render Loop (RESOLVED)
...
***REMOVED******REMOVED******REMOVED*** Migrations Created
...
***REMOVED******REMOVED******REMOVED*** Documentation Created/Updated
...
***REMOVED******REMOVED*** Recommended Clean Rebuild Procedure

```bash
***REMOVED*** 1. Stop everything
docker-compose -f docker-compose.local.yml down

***REMOVED*** 2. Remove all project images
...
***REMOVED*** 3. Remove volumes (fresh database)
docker-compose -f docker-compose.local.yml down -v

***REMOVED*** 4. Prune build cache
docker builder prune -af

***REMOVED*** 5. Rebuild everything
docker-compose -f docker-compose.local.yml up -d --build

***REMOVED*** 6. Wait for services
sleep 30

***REMOVED*** 7. Apply all migrations
docker exec scheduler-local-backend alembic upgrade head

***REMOVED*** 8. Verify backend health
...
***REMOVED*** 10. Test login
***REMOVED*** Open http://localhost:3000 and login with admin/admin123
```

---

***REMOVED******REMOVED*** Prevention Checklist for Future Sessions
...
***REMOVED******REMOVED*** Technical Debt Identified
...
2. **Manual version table migrations** - Consider using Continuum's auto-generation:
   ```python
   ***REMOVED*** In alembic/env.py, configure Continuum to auto-generate
   ```
