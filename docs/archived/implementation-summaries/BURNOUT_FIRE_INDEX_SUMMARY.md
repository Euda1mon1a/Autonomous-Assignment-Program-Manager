***REMOVED*** Burnout Fire Index Implementation Summary
...
***REMOVED******REMOVED******REMOVED*** Multi-Temporal Analysis
...
***REMOVED******REMOVED******REMOVED*** Danger Classifications
...
***REMOVED******REMOVED******REMOVED*** Restrictions Escalation
...
***REMOVED******REMOVED******REMOVED*** Single Resident Assessment
```python
...
report = rating.calculate_burnout_danger(
    resident_id=uuid4(),
    recent_hours=77.0,          ***REMOVED*** Last 2 weeks
    monthly_load=280.0,         ***REMOVED*** Last 3 months avg
    yearly_satisfaction=0.42,   ***REMOVED*** 0.0-1.0 scale
    workload_velocity=6.0,      ***REMOVED*** Hours/week increase
)

print(f"Danger: {report.danger_class}")  ***REMOVED*** HIGH
print(f"FWI Score: {report.fwi_score}")  ***REMOVED*** 45.6
print(f"Safe: {report.is_safe}")         ***REMOVED*** False
print(f"Restrictions: {len(report.recommended_restrictions)}")  ***REMOVED*** 5
```

***REMOVED******REMOVED******REMOVED*** Program-Wide Screening
```python
residents = [
...
***REMOVED******REMOVED******REMOVED*** Custom Targets (Different Specialties)
```python
***REMOVED*** Surgery residency with different sustainable hours
surgery_rating = BurnoutDangerRating(
    ffmc_target=70.0,   ***REMOVED*** 70h per 2 weeks
    dmc_target=280.0,   ***REMOVED*** 280h per month
)

report = surgery_rating.calculate_burnout_danger(...)
```

***REMOVED******REMOVED*** Scientific Basis

***REMOVED******REMOVED******REMOVED*** Why Fire Weather Index?
...
***REMOVED******REMOVED******REMOVED*** Burnout Parallels
...
***REMOVED******REMOVED******REMOVED*** Key Insight: Temporal Alignment
...
***REMOVED******REMOVED******REMOVED*** Formulas
...
***REMOVED******REMOVED******REMOVED*** Calibration
...
***REMOVED******REMOVED******REMOVED*** Current Resilience Framework
