...
- Faculty F04 clinic cap: (0, 4)
- Adjunct F13: adjunct (already in DB)
...
- Faculty eligible: Faculty F06, Faculty F03, Faculty F02
- Faculty priority: (Faculty F06 = Faculty F03) >> Faculty F02 (soft penalty)
