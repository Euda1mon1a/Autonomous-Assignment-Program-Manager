***REMOVED*** React Query Caching Strategy
...
2. [Cache Time Configuration](***REMOVED***cache-time-configuration)
3. [Entity-Specific Strategies](***REMOVED***entity-specific-strategies)
4. [Cache Invalidation Rules](***REMOVED***cache-invalidation-rules)
5. [Optimistic Updates](***REMOVED***optimistic-updates)
6. [Background Refetching](***REMOVED***background-refetching)
7. [Implementation Patterns](***REMOVED***implementation-patterns)

---

***REMOVED******REMOVED*** Overview

***REMOVED******REMOVED******REMOVED*** Why Caching Matters
...
***REMOVED******REMOVED******REMOVED*** React Query Concepts
...
***REMOVED******REMOVED*** Cache Time Configuration

***REMOVED******REMOVED******REMOVED*** Entity Cache Times Summary
...
***REMOVED******REMOVED*** Entity-Specific Strategies

***REMOVED******REMOVED******REMOVED*** Schedule Data
...
***REMOVED******REMOVED******REMOVED*** People (Residents, Faculty)
...
***REMOVED******REMOVED*** Cache Invalidation Rules

***REMOVED******REMOVED******REMOVED*** Mutation-Based Invalidation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Assignment CRUD
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Absence CRUD
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Person CRUD
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Rotation Template CRUD
...
***REMOVED******REMOVED******REMOVED*** Cross-Entity Invalidation Matrix
...
***REMOVED******REMOVED******REMOVED*** Implementation Pattern
...
***REMOVED******REMOVED******REMOVED*** NOT Recommended for Optimistic Updates
...
***REMOVED******REMOVED*** Background Refetching

***REMOVED******REMOVED******REMOVED*** Automatic Refetching Strategy
...
***REMOVED******REMOVED******REMOVED*** Polling for Real-Time Data
...
***REMOVED******REMOVED******REMOVED*** Query Key Best Practices
...
***REMOVED******REMOVED******REMOVED*** Prefetching Strategy
...
***REMOVED******REMOVED******REMOVED*** Dependent Queries
...
***REMOVED******REMOVED*** Error Handling in Cache

***REMOVED******REMOVED******REMOVED*** Stale-While-Revalidate Pattern
...
***REMOVED******REMOVED******REMOVED*** Error Recovery
...
***REMOVED******REMOVED******REMOVED*** Avoiding Over-Invalidation
...
***REMOVED******REMOVED******REMOVED*** Selective Refetching
...
***REMOVED******REMOVED******REMOVED*** Cache State Logging
