***REMOVED*** PHI Exposure Audit Report
...
***REMOVED******REMOVED******REMOVED*** Overall Risk Assessment
...
***REMOVED******REMOVED*** 1. PHI Data Elements Identified

***REMOVED******REMOVED******REMOVED*** 1.1 Person Data (Highest Risk)
...
***REMOVED******REMOVED******REMOVED*** 1.2 Absence Data (OPSEC/PERSEC Risk)
...
***REMOVED******REMOVED******REMOVED*** 1.3 Assignment/Schedule Data (Pattern Exposure)
...
***REMOVED******REMOVED******REMOVED*** 1.4 Swap Request Data (Faculty PHI)
...
***REMOVED******REMOVED*** 2. Bulk Export Endpoints (HIGH RISK)
...
***REMOVED******REMOVED******REMOVED*** 2.1 People Export
...
***REMOVED******REMOVED******REMOVED*** 2.2 Absence Export
...
***REMOVED******REMOVED******REMOVED*** 2.3 Schedule Export
...
***REMOVED******REMOVED*** 3. Error Messages (LOW RISK)

***REMOVED******REMOVED******REMOVED*** 3.1 Global Exception Handler
...
async def global_exception_handler(request: Request, exc: Exception):
    if settings.DEBUG:
        ***REMOVED*** Development: includes details
        return JSONResponse(
            status_code=500,
            content={"detail": str(exc), "type": type(exc).__name__}
        )
    else:
        ***REMOVED*** Production: generic message (GOOD)
        return JSONResponse(
            status_code=500,
...
***REMOVED******REMOVED******REMOVED*** 3.2 Specific Error Messages
...
raise HTTPException(
    status_code=404,
    detail=f"Person {request.person_id} not found"  ***REMOVED*** Exposes person ID
)
```
...
***REMOVED******REMOVED*** 4. Logging (MEDIUM RISK)

***REMOVED******REMOVED******REMOVED*** 4.1 Email Address Logging
...
***REMOVED******REMOVED******REMOVED*** 4.2 Certification Scheduler Logging
...
***REMOVED******REMOVED******REMOVED*** 4.3 Compliance Report Logging
...
***REMOVED******REMOVED*** 5. HIPAA Compliance Analysis

***REMOVED******REMOVED******REMOVED*** 5.1 HIPAA Requirements
...
***REMOVED******REMOVED******REMOVED*** 5.2 HIPAA Privacy Rule Violations
...
***REMOVED******REMOVED*** 6. OPSEC/PERSEC Compliance (Military Context)

***REMOVED******REMOVED******REMOVED*** 6.1 PERSEC Violations
...
***REMOVED******REMOVED******REMOVED*** 6.2 Data Security Policy Alignment
...
***REMOVED******REMOVED*** 7. Recommendations

***REMOVED******REMOVED******REMOVED*** 7.1 CRITICAL (Implement Within 30 Days)
...
class PersonResponse(PersonBase):
    id: UUID
    name: str
    email: EmailStr | None = None  ***REMOVED*** Only for admins
...
***REMOVED******REMOVED******REMOVED*** 7.2 HIGH PRIORITY (Implement Within 60 Days)
...
"person": {
    "id": "123...",
    "name": "Dr. John Smith",  ***REMOVED*** PHI
    "email": "john.smith@example.mil",  ***REMOVED*** PHI
    "type": "faculty"
}
...
***REMOVED******REMOVED******REMOVED*** 7.3 MEDIUM PRIORITY (Implement Within 90 Days)
...
***REMOVED******REMOVED******REMOVED*** 7.4 LOW PRIORITY (Implement Within 6 Months)
...
***REMOVED******REMOVED*** 8. Immediate Actions Checklist
...
***REMOVED******REMOVED*** 9. Compliance Summary

***REMOVED******REMOVED******REMOVED*** 9.1 HIPAA Compliance Score: 6/10
...
***REMOVED******REMOVED******REMOVED*** 9.2 OPSEC/PERSEC Compliance Score: 5/10
...
***REMOVED******REMOVED******REMOVED*** Regulatory References
...
***REMOVED******REMOVED******REMOVED*** Internal References
