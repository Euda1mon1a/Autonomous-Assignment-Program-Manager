...
> **Documentation Restructure (2025-12-31):** Human-readable docs are now in `/docs/`, while LLM-focused documentation (session reports, technical deep dives) has moved to `.claude/dontreadme/`. See [Documentation Structure](***REMOVED***documentation-structure-update-2025-12-31) below.

---

***REMOVED******REMOVED*** Quick Navigation

***REMOVED******REMOVED******REMOVED*** For New Users
...
***REMOVED******REMOVED******REMOVED*** :material-file-document: Essential Root Documents
...
***REMOVED******REMOVED******REMOVED*** :material-rocket-launch: Getting Started
...
***REMOVED******REMOVED******REMOVED*** :material-book-open: User Guide
...
***REMOVED******REMOVED******REMOVED*** :material-map: Guides
...
***REMOVED******REMOVED******REMOVED*** :material-cog: Admin Manual
...
***REMOVED******REMOVED******REMOVED*** :material-sitemap: Architecture
...
***REMOVED******REMOVED******REMOVED*** :material-api: API Reference
...
***REMOVED******REMOVED******REMOVED*** :material-code-braces: Development
...
***REMOVED******REMOVED******REMOVED*** :material-cog-outline: Operations
...
***REMOVED******REMOVED******REMOVED*** :material-rocket: Deployment
...
***REMOVED******REMOVED******REMOVED*** :material-clipboard-check: Planning
...
***REMOVED******REMOVED******REMOVED*** :material-flask: Research
...
***REMOVED******REMOVED******REMOVED*** :material-robot: AI Agent Documentation (LLMs)
...
***REMOVED******REMOVED******REMOVED*** :material-archive: Archived
...
***REMOVED******REMOVED******REMOVED*** :material-tools: Troubleshooting
[Troubleshooting Guide](troubleshooting.md) - Common issues and solutions

***REMOVED******REMOVED******REMOVED*** :material-history: Changelog
[Changelog](../CHANGELOG.md) - Version history and release notes

***REMOVED******REMOVED******REMOVED*** :material-clipboard-text: Task Templates
...
***REMOVED******REMOVED******REMOVED*** :material-note-text: Other Root-Level Documentation
...
***REMOVED******REMOVED******REMOVED*** :material-file-multiple: Docs Root-Level Files
...
***REMOVED******REMOVED*** Documentation Structure (Update 2025-12-31)
...
***REMOVED******REMOVED*** Documentation Conventions

***REMOVED******REMOVED******REMOVED*** Admonitions
...
````markdown
```python
***REMOVED*** Python example
def example():
    pass
```
````

***REMOVED******REMOVED******REMOVED*** Version References

When documentation is version-specific, it includes a version badge at the top.

---

***REMOVED******REMOVED*** Quick Start Path
...
***REMOVED******REMOVED*** Contributing to Documentation
...
***REMOVED******REMOVED******REMOVED*** Interactive API Docs
When running the application:
- **Swagger UI**: http://localhost:8000/docs
- **ReDoc**: http://localhost:8000/redoc

***REMOVED******REMOVED******REMOVED*** GitHub Wiki
...
- **[Troubleshooting](guides/SCHEDULE_GENERATION_RUNBOOK.md***REMOVED***troubleshooting)** - Common issues and solutions
...
- See [Troubleshooting](guides/SCHEDULE_GENERATION_RUNBOOK.md***REMOVED***troubleshooting) for issues
