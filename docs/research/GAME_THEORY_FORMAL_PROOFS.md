***REMOVED*** Game Theory Formal Proofs for Residency Scheduling
...
1. [Mathematical Preliminaries](***REMOVED***mathematical-preliminaries)
2. [VCG Mechanism Proofs](***REMOVED***vcg-mechanism-proofs)
3. [Nash Equilibrium Proofs](***REMOVED***nash-equilibrium-proofs)
4. [Shapley Value Proofs](***REMOVED***shapley-value-proofs)
5. [Mechanism Design Impossibility Results](***REMOVED***mechanism-design-impossibility-results)
6. [Applications to Residency Scheduling](***REMOVED***applications-to-residency-scheduling)
7. [Computational Complexity Analysis](***REMOVED***computational-complexity-analysis)
8. [References](***REMOVED***references)

---

***REMOVED******REMOVED*** Mathematical Preliminaries

***REMOVED******REMOVED******REMOVED*** Notation and Definitions
...
***REMOVED******REMOVED*** VCG Mechanism Proofs

***REMOVED******REMOVED******REMOVED*** Theorem 2.1: VCG is Dominant-Strategy Incentive Compatible
...
***REMOVED******REMOVED******REMOVED*** Theorem 2.2: VCG Achieves Allocative Efficiency
...
***REMOVED******REMOVED******REMOVED*** Application 2.3: Shift Allocation as VCG Auction
...
***REMOVED******REMOVED*** Nash Equilibrium Proofs

***REMOVED******REMOVED******REMOVED*** Theorem 3.1: Schedule Equilibrium Existence
...
***REMOVED******REMOVED******REMOVED*** Theorem 3.2: Nash Stability of Swap Requests
...
***REMOVED******REMOVED******REMOVED*** Theorem 3.3: Price of Anarchy for Greedy Scheduling
...
***REMOVED******REMOVED*** Shapley Value Proofs

***REMOVED******REMOVED******REMOVED*** Theorem 4.1: Shapley Value Axiom Satisfaction
...
***REMOVED******REMOVED******REMOVED*** Theorem 4.2: Computational Complexity of Shapley Value
...
Therefore, exact Shapley value computation is *****REMOVED***P-hard** in general cooperative games. $\square$
...
***REMOVED******REMOVED******REMOVED*** Theorem 4.3: Monte Carlo Approximation for Shapley Values
...
***REMOVED******REMOVED******REMOVED*** Application 4.4: Fair On-Call Burden Distribution
...
***REMOVED******REMOVED*** Mechanism Design Impossibility Results

***REMOVED******REMOVED******REMOVED*** Theorem 5.1: Impossibility of Truthful, Efficient, Budget-Balanced Mechanisms
...
***REMOVED******REMOVED******REMOVED*** Theorem 5.2: Trade-offs in Residency Scheduling Mechanisms
...
***REMOVED******REMOVED******REMOVED*** Theorem 5.3: Second-Best Mechanism Design
...
***REMOVED******REMOVED*** Applications to Residency Scheduling

***REMOVED******REMOVED******REMOVED*** Application 6.1: Shift Preference Auction
...
2. **Allocation (ILP):**
   ...
   def allocate_shifts_vcg(residents, shifts, bids):
       ...
       ***REMOVED*** Decision variables: x[i][s] = 1 if resident i gets shift s
       x = {}
       for i in residents:
           for s in shifts:
       ...
       ***REMOVED*** Constraints: Each shift assigned exactly once
       for s in shifts:
           solver.Add(solver.Sum([x[i, s] for i in residents]) == 1)

       ***REMOVED*** Constraints: Each resident gets exactly one shift
       for i in residents:
           solver.Add(solver.Sum([x[i, s] for s in shifts]) == 1)

       ***REMOVED*** ACGME constraints (work hour limits, etc.)
       ***REMOVED*** ... [additional constraints]
...
3. **VCG Payments:**
   ...
   def compute_vcg_payments(residents, shifts, bids):
       ...
       for i in residents:
           ...
           ***REMOVED*** Welfare of others under chosen allocation
...
***REMOVED******REMOVED******REMOVED*** Application 6.2: Swap Matching with Nash Stability
...
def find_nash_stable_swaps(schedule, preferences):
    ...
    while improved:
        ...
        ***REMOVED*** Check all pairwise swaps
        for i in range(len(schedule)):
            for j in range(i + 1, len(schedule)):
                shift_i, shift_j = schedule[i], schedule[j]

                ***REMOVED*** Utility from swap
                ...
                ***REMOVED*** Both benefit from swap?
...
***REMOVED******REMOVED******REMOVED*** Application 6.3: Fair On-Call Distribution via Shapley
...
def shapley_value_call_duty(residents, coverage_function):
    ...
    for i, resident in enumerate(residents):
        ***REMOVED*** Iterate over all subsets not containing resident
        for size in range(n):
...
***REMOVED******REMOVED*** Computational Complexity Analysis

***REMOVED******REMOVED******REMOVED*** Complexity Summary Table
...
| Shapley Value (Exact) | ***REMOVED***P-hard | Enumeration | Deng & Papadimitriou (1994) |
...
***REMOVED******REMOVED******REMOVED*** Practical Implications
...
3. **Shapley Value:** Uniquely characterized by fairness axioms (Theorem 4.1), computationally hard in general (***REMOVED***P-hard), but approximable via Monte Carlo (Theorem 4.3).
