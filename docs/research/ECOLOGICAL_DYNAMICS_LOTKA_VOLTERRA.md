***REMOVED*** Ecological Dynamics: Lotka-Volterra Predator-Prey Modeling for Schedule Supply/Demand
...
***REMOVED******REMOVED******REMOVED*** Lotka-Volterra Equations
...
***REMOVED******REMOVED******REMOVED*** Equilibrium Point
...
***REMOVED******REMOVED******REMOVED*** Oscillation Period
...
***REMOVED******REMOVED*** MCP Tools

***REMOVED******REMOVED******REMOVED*** 1. `analyze_supply_demand_cycles_tool`
...
```python
{
  "historical_data": [
    ...
    ***REMOVED*** ... minimum 10 data points
  ],
  "prediction_days": 90
}
```
...
```python
{
  ...
  "r_squared": 0.87,  ***REMOVED*** Goodness of fit
...
***REMOVED******REMOVED******REMOVED*** 2. `predict_capacity_crunch_tool`
...
```python
{
  ...
  "current_demand": 48.0,
  "alpha": 0.12,  ***REMOVED*** From fitted model
  "beta": 0.015,
  "delta": 0.008,
  "gamma": 0.10,
  "crunch_threshold": 10.0,  ***REMOVED*** Minimum acceptable capacity
  "prediction_days": 180
}
```
...
```python
{
  "risk_level": "HIGH",  ***REMOVED*** IMMINENT, CRITICAL, HIGH, ELEVATED, MODERATE, LOW
...
***REMOVED******REMOVED******REMOVED*** 3. `find_equilibrium_point_tool`
...
```python
{
  "equilibrium_capacity": 12.5,  ***REMOVED*** x* = γ/δ
  "equilibrium_demand": 8.0,     ***REMOVED*** y* = α/β
  "oscillation_period_days": 57.3,
  "is_stable": true,
...
***REMOVED******REMOVED******REMOVED*** 4. `simulate_intervention_tool`
...
```python
{
  ...
  "delta": 0.008,
  "gamma": 0.10,
  "intervention_type": "add_capacity",  ***REMOVED*** See table below
...
```python
{
  ...
  "intervention_effectiveness": 0.73,  ***REMOVED*** 73% effective
...
***REMOVED******REMOVED*** Ecological Interpretation

***REMOVED******REMOVED******REMOVED*** Predator-Prey Analogy
...
***REMOVED******REMOVED******REMOVED*** System Dynamics
...
***REMOVED******REMOVED*** Integration with Other Resilience Tools

***REMOVED******REMOVED******REMOVED*** Complementary Frameworks
...
***REMOVED******REMOVED******REMOVED*** Parameter Fitting Algorithm
...
def fit_lotka_volterra_parameters(
    ...
    ***REMOVED*** ... (see implementation in ecological_dynamics_tools.py)
```

***REMOVED******REMOVED******REMOVED*** ODE Integration
...
***REMOVED******REMOVED******REMOVED*** Stability Classification
...
***REMOVED******REMOVED******REMOVED*** Scenario 1: Flu Season Surge

**Context:** Winter flu season increases clinic demand.

**Data:**
```python
***REMOVED*** Historical data shows demand spikes in winter
data = [
  {"date": "2024-12-01", "capacity": 50, "demand": 35},
  {"date": "2024-12-15", "capacity": 48, "demand": 42},
  {"date": "2025-01-01", "capacity": 42, "demand": 55},  ***REMOVED*** Peak flu
  {"date": "2025-01-15", "capacity": 38, "demand": 60},  ***REMOVED*** Overloaded
  {"date": "2025-02-01", "capacity": 45, "demand": 48},  ***REMOVED*** Recovery
  ***REMOVED*** ...
]
```
...
***REMOVED******REMOVED******REMOVED*** Scenario 2: Deployment Impact

**Context:** 3 residents deployed for 6 months.

**Data:**
```python
***REMOVED*** Sudden capacity drop
before_deployment = {"capacity": 55, "demand": 48}
after_deployment = {"capacity": 35, "demand": 48}  ***REMOVED*** -20 capacity
```
...
***REMOVED******REMOVED******REMOVED*** Scenario 3: Long-Term Staffing Policy
...
***REMOVED******REMOVED******REMOVED*** Application to Workforce Dynamics
...
***REMOVED******REMOVED******REMOVED*** Resilience Engineering
...
***REMOVED******REMOVED******REMOVED*** When to Use vs Avoid
