***REMOVED*** Leadership Discussion Guide: Edge Cases & Policy Decisions
...
***REMOVED******REMOVED*** Your Stated Preferences (Baseline)
...
***REMOVED******REMOVED******REMOVED*** Recommended Thresholds:
...
***REMOVED******REMOVED*** Part 2: Forced Swaps (Coverage Mode)

When PD/APD/OIC needs to pull someone from admin to cover clinic due to emergency.

***REMOVED******REMOVED******REMOVED*** Scenarios to Discuss:

***REMOVED******REMOVED******REMOVED******REMOVED*** Scenario A: Simple Coverage Pull
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Scenario B: No One Available
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Scenario C: Cascade Effect
```
...
***REMOVED******REMOVED*** Part 3: Gaming Detection

What patterns indicate someone is gaming the system vs. legitimate needs?

***REMOVED******REMOVED******REMOVED*** Red Flags to Discuss:
...
***REMOVED******REMOVED******REMOVED*** Suggested Gaming Thresholds:
...
***REMOVED******REMOVED*** Part 4: Biggest Morale Killers

Based on residency scheduling literature and common patterns:

***REMOVED******REMOVED******REMOVED*** 1. **Perception of Unfairness** (Even When Mathematically Fair)
...
***REMOVED******REMOVED******REMOVED*** 2. **Last-Minute Changes Without Warning**
...
***REMOVED******REMOVED******REMOVED*** 3. **The "Martyrs" and "Evaders"**
...
***REMOVED******REMOVED******REMOVED*** 4. **New Faculty vs. Senior Faculty**
...
***REMOVED******REMOVED******REMOVED*** 5. **External Commitments Collision**
...
***REMOVED******REMOVED******REMOVED*** 6. **The "Invisible Workload" Problem**
...
***REMOVED******REMOVED*** Part 5: Hard Decisions That Will Happen

These situations WILL occur. Better to have a policy than improvise.

***REMOVED******REMOVED******REMOVED*** Decision 1: "I Can't, But I Won't Say Why"
...
***REMOVED******REMOVED******REMOVED*** Decision 2: Two Emergencies, One Slot
...
***REMOVED******REMOVED******REMOVED*** Decision 3: The Chronic Problem
...
***REMOVED******REMOVED******REMOVED*** Decision 4: The Schedule Complainer
...
***REMOVED******REMOVED******REMOVED*** Decision 5: Resident vs. Faculty Conflict
...
***REMOVED******REMOVED*** Part 6: What the System WILL Track (For Your Awareness)
...
***REMOVED******REMOVED*** Summary: Decisions Needed Before Go-Live

***REMOVED******REMOVED******REMOVED*** Must Decide:
...
***REMOVED******REMOVED******REMOVED*** Should Discuss:
...
***REMOVED******REMOVED******REMOVED*** Nice to Align On:
...
***REMOVED******REMOVED*** Appendix: Swap Auto-Approval Logic (Technical Reference)

```
IF swap_request.days_until_effective > THRESHOLD_DAYS
   AND both_parties_consented = TRUE
   AND week_type_match(from_week, to_week) = TRUE  ***REMOVED*** clinic↔clinic, admin↔admin
