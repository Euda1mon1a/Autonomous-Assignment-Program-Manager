***REMOVED*** Onboarding & Offboarding Playbook
...
2. [New Resident Onboarding](***REMOVED***new-resident-onboarding)
3. [New Faculty Onboarding](***REMOVED***new-faculty-onboarding)
4. [System Access Provisioning](***REMOVED***system-access-provisioning)
5. [Training Checklist](***REMOVED***training-checklist)
6. [Offboarding Procedures](***REMOVED***offboarding-procedures)
7. [Quick Reference](***REMOVED***quick-reference)

---

***REMOVED******REMOVED*** Overview

***REMOVED******REMOVED******REMOVED*** Onboarding Timeline
...
***REMOVED******REMOVED*** New Resident Onboarding

***REMOVED******REMOVED******REMOVED*** Pre-Arrival (4-12 Weeks Before)

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Credentialing Initiation

```bash
***REMOVED*** POST: Create resident credentialing record
...
***REMOVED*** Response includes: resident_id (e.g., PGY1-001)
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: IT Account Setup

```bash
***REMOVED*** Create IT accounts 2 weeks before arrival

***REMOVED*** 1. Create email account
***REMOVED*** Contact: IT Department
***REMOVED*** Account: [firstname.lastname@hospital.edu]
***REMOVED*** Forward to personal email until start date

***REMOVED*** 2. Create system login credentials
***REMOVED*** Username: [pgy1_001]
***REMOVED*** Initial password: [Generated secure password]
***REMOVED*** Sent via secure channel to personal email

***REMOVED*** 3. Set up phone extension
***REMOVED*** Request from: Facilities/Communications
***REMOVED*** Extension: [Assigned]
***REMOVED*** Shared voicemail setup

***REMOVED*** 4. Order badge/access card
***REMOVED*** Request from: Security
***REMOVED*** Include photo ID
***REMOVED*** Set access groups:
***REMOVED***   - Clinical areas
***REMOVED***   - Resident lounge
***REMOVED***   - Call rooms
***REMOVED***   - Computer labs
```
...
***REMOVED******REMOVED******REMOVED*** Arrival Week (Day 1-5)

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Welcome and Check-In

```bash
***REMOVED*** On Day 1, complete welcome activities
...
***REMOVED*** Execute Day 1 activities according to schedule
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: Account Activation

```bash
***REMOVED*** Activate all accounts for new resident

***REMOVED*** POST: Activate system access
...
***REMOVED*** Activate portal access
...
***REMOVED******REMOVED******REMOVED*** First Month (Week 1-4)

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: System Training

```bash
***REMOVED*** Comprehensive system training during first week
...
***REMOVED*** Track training completion
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: Compliance Training

```bash
***REMOVED*** Mandatory compliance training (MUST complete before starting)
...
***REMOVED*** Assign training to resident
...
***REMOVED******REMOVED*** New Faculty Onboarding

***REMOVED******REMOVED******REMOVED*** Pre-Arrival (4 Weeks Before)

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Credentialing

```bash
***REMOVED*** POST: Create faculty credentialing record
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: IT & Workspace Setup

```bash
***REMOVED*** Same IT account creation as residents, plus:

***REMOVED*** 1. Faculty-specific email
***REMOVED*** Account: [fname.lname@hospital.edu]
***REMOVED*** Shared resource calendar access

***REMOVED*** 2. System administrative access
***REMOVED*** Scheduling system admin access (if needed)
***REMOVED*** Report generation access
***REMOVED*** Staff management access

***REMOVED*** 3. Workspace preparation
***REMOVED*** Office assignment
***REMOVED*** Parking space
***REMOVED*** Phone extension
***REMOVED*** Computer/laptop
```

***REMOVED******REMOVED******REMOVED*** Arrival Week

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Welcome and Orientation
...
```bash
***REMOVED*** POST: Activate faculty access
...
***REMOVED******REMOVED******REMOVED*** First Month Training

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Supervision Training

```bash
***REMOVED*** Critical training for faculty supervising residents
...
***REMOVED*** Assign supervision training
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: System Training

```bash
***REMOVED*** Faculty-specific system training
...
***REMOVED******REMOVED*** System Access Provisioning

***REMOVED******REMOVED******REMOVED*** Access Control Matrix
...
***REMOVED******REMOVED******REMOVED*** Access Provisioning Process

```bash
***REMOVED*** 1. Create user account
...
***REMOVED*** 2. Assign role-specific permissions
...
***REMOVED*** 3. Verify access works
***REMOVED*** Send test login link to user
***REMOVED*** User logs in and confirms access
```
...
***REMOVED******REMOVED*** Training Checklist

***REMOVED******REMOVED******REMOVED*** Mandatory Training Completion
...
***REMOVED******REMOVED*** Offboarding Procedures

***REMOVED******REMOVED******REMOVED*** Notification and Planning (2 Weeks Before Departure)

```bash
***REMOVED*** Initiate offboarding process

***REMOVED*** POST: Create offboarding record
...
***REMOVED******REMOVED******REMOVED*** System Access Removal

```bash
***REMOVED*** Remove all system access on final day

***REMOVED*** 1. Disable all accounts
curl -X POST http://localhost:8000/api/admin/users/PGY1-001/disable \
  -H "Authorization: Bearer $TOKEN"

***REMOVED*** 2. Revoke all permissions
curl -X POST http://localhost:8000/api/admin/users/PGY1-001/revoke-permissions \
  -H "Authorization: Bearer $TOKEN"

***REMOVED*** 3. Expire/revoke credentials
***REMOVED*** - Password reset
***REMOVED*** - Session termination
***REMOVED*** - Token revocation
***REMOVED*** - API key removal

***REMOVED*** 4. Update person status
...
***REMOVED*** 5. Archive person record
curl -X POST http://localhost:8000/api/admin/persons/PGY1-001/archive \
  -H "Authorization: Bearer $TOKEN"
```

***REMOVED******REMOVED******REMOVED*** Schedule Cleanup

```bash
***REMOVED*** Remove departed person from future assignments

***REMOVED*** POST: Remove from remaining rotations
...
***REMOVED*** Should return: No assignments found
```
...
***REMOVED******REMOVED******REMOVED*** Key Contacts
...
***REMOVED******REMOVED******REMOVED*** Key Forms
...
***REMOVED******REMOVED******REMOVED*** Key Dates
