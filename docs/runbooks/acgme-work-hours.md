***REMOVED*** Runbook: ACGME Work Hours Compliance
...
***REMOVED******REMOVED*** Regulatory Context
...
***REMOVED******REMOVED******REMOVED*** For Violation Alerts (Limit Exceeded)

**IMMEDIATE ACTIONS (within 1 hour):**

1. **Document the violation**
   ```bash
   ***REMOVED*** Generate violation report
...
***REMOVED******REMOVED******REMOVED*** For Continuous Duty Violations
...
***REMOVED******REMOVED*** Investigation Checklist
