***REMOVED*** AI Assistant Interface Guide for Administrators
...
***REMOVED******REMOVED*** Quick Reference: Web vs CLI
...
***REMOVED******REMOVED*** What Each Interface Can "See"

***REMOVED******REMOVED******REMOVED*** Web App (Browser-Based)
...
***REMOVED******REMOVED******REMOVED*** CLI/Terminal
...
***REMOVED******REMOVED*** How Changes Are Applied

***REMOVED******REMOVED******REMOVED*** Web App: "Suggestion Mode"
...
***REMOVED******REMOVED******REMOVED*** CLI: "Direct Edit Mode"
...
***REMOVED******REMOVED*** Session Context: The Isolation Problem

***REMOVED******REMOVED******REMOVED*** What "Session" Means
...
***REMOVED******REMOVED******REMOVED*** Why This Causes Problems
...
***REMOVED******REMOVED*** Split Terminal Is Not Shared Context
...
***REMOVED******REMOVED*** Parallel Session Risks

***REMOVED******REMOVED******REMOVED*** The Danger Zone
...
***REMOVED******REMOVED******REMOVED*** How to Avoid This
...
***REMOVED******REMOVED*** Checklists: Web vs CLI

***REMOVED******REMOVED******REMOVED*** If You're Using the Web App
...
***REMOVED******REMOVED******REMOVED*** If You're Using CLI (Terminal)
...
***REMOVED******REMOVED*** Common Mistakes and How to Avoid Them

***REMOVED******REMOVED******REMOVED*** Mistake 1: Assuming the Web AI "Knows" Your Project
...
***REMOVED******REMOVED******REMOVED*** Mistake 2: Running Multiple CLI Sessions
...
***REMOVED******REMOVED******REMOVED*** Mistake 3: Trusting CLI to Push Safely
...
***REMOVED******REMOVED******REMOVED*** Mistake 4: Switching Interfaces Mid-Task
...
***REMOVED******REMOVED******REMOVED*** What Are PII Files?
...
***REMOVED******REMOVED******REMOVED*** What "Diverge" Means
...
Your branch is ahead of 'origin/main' by 1 commit.
  (use "git push" to publish your local commits)   ***REMOVED*** ← DO NOT DO THIS
```

**Ignore the suggestion to push.** Those commits contain PII.

***REMOVED******REMOVED******REMOVED*** If You Accidentally Push PII
...
***REMOVED******REMOVED*** MCP Chat Interface Quick Start
...
***REMOVED******REMOVED******REMOVED*** Example Commands
