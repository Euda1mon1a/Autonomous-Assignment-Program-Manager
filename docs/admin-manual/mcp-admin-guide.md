***REMOVED*** Admin MCP Guide: Using Claude Code for Schedule Management
...
2. [Getting Started](***REMOVED***getting-started)
3. [Available Capabilities](***REMOVED***available-capabilities)
4. [Common Workflows](***REMOVED***common-workflows)
5. [Best Practices](***REMOVED***best-practices)
...
***REMOVED******REMOVED******REMOVED*** What You Can Do
...
***REMOVED******REMOVED******REMOVED*** Accessing the Chat Interface
...
***REMOVED******REMOVED******REMOVED*** Session Persistence
...
***REMOVED******REMOVED******REMOVED*** Quick Prompts
...
***REMOVED******REMOVED*** Available Capabilities

***REMOVED******REMOVED******REMOVED*** Scheduling & Compliance Tools
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Daily Compliance Check
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Handling a Swap Request
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Planning for Extended Absence
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: System Health Check
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Generating a Report
...
***REMOVED******REMOVED******REMOVED*** Be Specific with Dates
...
***REMOVED******REMOVED******REMOVED*** Provide Context
...
***REMOVED******REMOVED******REMOVED*** Use the MCP Capabilities Panel
...
***REMOVED******REMOVED******REMOVED*** Review Results Carefully
...
***REMOVED******REMOVED******REMOVED*** Export Important Results
...
***REMOVED******REMOVED******REMOVED*** Unexpected Results
...
***REMOVED******REMOVED*** Example Prompts by Use Case

***REMOVED******REMOVED******REMOVED*** Compliance & Validation
...
***REMOVED******REMOVED******REMOVED*** Coverage & Swaps
...
***REMOVED******REMOVED******REMOVED*** Resilience & Planning
