***REMOVED*** User and Permission Management
...
1. [User Model Overview](***REMOVED***user-model-overview)
2. [Role-Based Access Control](***REMOVED***role-based-access-control)
3. [Creating Users](***REMOVED***creating-users)
4. [Managing Users](***REMOVED***managing-users)
5. [Permission Matrix](***REMOVED***permission-matrix)
6. [Authentication Configuration](***REMOVED***authentication-configuration)
7. [Session Management](***REMOVED***session-management)
8. [Audit Logging](***REMOVED***audit-logging)
9. [Troubleshooting](***REMOVED***troubleshooting)

---

***REMOVED******REMOVED*** User Model Overview

***REMOVED******REMOVED******REMOVED*** User vs Person Distinction
...
***REMOVED******REMOVED******REMOVED*** User Attributes
...
***REMOVED******REMOVED*** Role-Based Access Control
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Admin Role
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Coordinator Role
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Faculty Role
...
***REMOVED******REMOVED*** Creating Users

***REMOVED******REMOVED******REMOVED*** Via API (Programmatic)
...
***REMOVED******REMOVED******REMOVED*** Via Database (Initial Setup)
...
***REMOVED******REMOVED******REMOVED*** Bulk User Import
...
***REMOVED*** CSV format:
***REMOVED*** username,email,temp_password,full_name,role
***REMOVED*** jsmith,jsmith@hospital.org,TempPass123!,Dr. John Smith,coordinator
```

---

***REMOVED******REMOVED*** Managing Users

***REMOVED******REMOVED******REMOVED*** Listing Users
...
***REMOVED******REMOVED******REMOVED*** Updating Users
...
***REMOVED*** Link user to person record
curl -X PATCH https://api.your-domain.com/api/users/<user-id> \
  -H "Authorization: Bearer <admin-token>" \
  -H "Content-Type: application/json" \
  -d '{
...
***REMOVED******REMOVED******REMOVED*** Deleting Users
...
***REMOVED******REMOVED******REMOVED*** Password Reset
...
```bash
***REMOVED*** Change own password (authenticated user)
...
***REMOVED******REMOVED******REMOVED*** Resource Permissions
...
***REMOVED******REMOVED******REMOVED*** API Permission Enforcement
...
***REMOVED******REMOVED*** Authentication Configuration

***REMOVED******REMOVED******REMOVED*** JWT Token Settings
...
***REMOVED******REMOVED*** Session Management

***REMOVED******REMOVED******REMOVED*** Token-Based Sessions
...
***REMOVED******REMOVED******REMOVED*** Revoking Sessions
...
***REMOVED******REMOVED******REMOVED*** Concurrent Sessions
...
***REMOVED******REMOVED******REMOVED*** Audited Events
...
***REMOVED******REMOVED******REMOVED*** User Cannot Login
...
***REMOVED******REMOVED******REMOVED*** Token Expired Errors
...
***REMOVED******REMOVED******REMOVED*** Database Queries for User Management
...
***REMOVED******REMOVED******REMOVED*** User Administration
...
***REMOVED******REMOVED******REMOVED*** Security Recommendations
