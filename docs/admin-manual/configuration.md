...
***REMOVED******REMOVED*** Resilience Settings
...
***REMOVED******REMOVED*** Security Settings
...
***REMOVED******REMOVED******REMOVED*** Trusted Proxies
...
```env
***REMOVED*** Only trust X-Forwarded-For from these IPs
...
***REMOVED******REMOVED******REMOVED*** Additional Security Settings
