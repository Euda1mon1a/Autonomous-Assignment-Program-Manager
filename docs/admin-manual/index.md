...
<div class="feature-card" markdown>
***REMOVED******REMOVED******REMOVED*** :material-robot: [AI Interface Guide](ai-interface-guide.md)
...
***REMOVED******REMOVED*** Operational Lessons Learned
...
***REMOVED******REMOVED*** "main" and "origin" Explained (Clinician-Friendly)
...
***REMOVED******REMOVED*** Parallel AI Sessions (What “Split Terminal” Really Means)
