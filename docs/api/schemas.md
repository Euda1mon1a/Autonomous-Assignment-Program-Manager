...
***REMOVED******REMOVED*** Authentication Schemas

***REMOVED******REMOVED******REMOVED*** UserLogin
...
***REMOVED******REMOVED******REMOVED*** UserCreate
...
***REMOVED******REMOVED******REMOVED*** UserResponse
...
***REMOVED******REMOVED*** Person Schemas

***REMOVED******REMOVED******REMOVED*** PersonCreate
...
***REMOVED******REMOVED******REMOVED*** PersonUpdate
...
***REMOVED******REMOVED******REMOVED*** PersonResponse
...
***REMOVED******REMOVED******REMOVED*** PersonListResponse
...
***REMOVED******REMOVED******REMOVED*** BlockGenerateParams
...
***REMOVED******REMOVED*** Rotation Template Schemas

***REMOVED******REMOVED******REMOVED*** RotationTemplateCreate
...
***REMOVED******REMOVED******REMOVED*** RotationTemplateResponse
...
***REMOVED******REMOVED*** Assignment Schemas

***REMOVED******REMOVED******REMOVED*** AssignmentCreate
...
***REMOVED******REMOVED******REMOVED*** AssignmentUpdate
...
***REMOVED******REMOVED******REMOVED*** AssignmentResponse
...
***REMOVED******REMOVED******REMOVED*** AssignmentWithWarnings
...
***REMOVED******REMOVED*** Absence Schemas

***REMOVED******REMOVED******REMOVED*** AbsenceCreate
...
***REMOVED******REMOVED******REMOVED*** AbsenceResponse
...
***REMOVED******REMOVED*** Schedule Schemas
...
***REMOVED******REMOVED*** Settings Schema
...
***REMOVED******REMOVED*** Common Response Wrappers
