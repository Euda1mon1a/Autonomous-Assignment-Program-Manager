...
***REMOVED******REMOVED*** Model Health

***REMOVED******REMOVED******REMOVED*** Check Model Health
...
***REMOVED******REMOVED*** Model Training

***REMOVED******REMOVED******REMOVED*** Train Models (Synchronous)
...
***REMOVED******REMOVED******REMOVED*** Train Models (Async)
...
***REMOVED******REMOVED*** Schedule Scoring

***REMOVED******REMOVED******REMOVED*** Score Schedule
...
***REMOVED******REMOVED******REMOVED*** Grade Scale
...
***REMOVED******REMOVED*** Conflict Prediction

***REMOVED******REMOVED******REMOVED*** Predict Conflict
...
***REMOVED******REMOVED*** Preference Prediction

***REMOVED******REMOVED******REMOVED*** Predict Preference
...
***REMOVED******REMOVED*** Workload Analysis

***REMOVED******REMOVED******REMOVED*** Analyze Workload
...
***REMOVED******REMOVED*** Model Artifacts
...
│   ├── model.pkl          ***REMOVED*** RandomForestRegressor
│   ├── scaler.pkl         ***REMOVED*** StandardScaler
│   └── features.pkl       ***REMOVED*** Feature names
├── conflict_predictor/
│   ├── model.pkl          ***REMOVED*** GradientBoostingClassifier
│   ├── scaler.pkl
│   └── features.pkl
└── workload_optimizer/
    ├── workload_model.pkl ***REMOVED*** GradientBoostingRegressor
    ├── clusterer.pkl      ***REMOVED*** KMeans
    ├── scaler.pkl
    └── features.pkl
```
...
***REMOVED******REMOVED*** Feature Requirements

***REMOVED******REMOVED******REMOVED*** Preference Predictor Features (31+)
...
***REMOVED******REMOVED******REMOVED*** Conflict Predictor Features (25+)
- ACGME: hours worked, days since off
- Supervision: ratio requirements
- Workload: assignment count, concentration

***REMOVED******REMOVED******REMOVED*** Workload Optimizer Features (25+)
