***REMOVED*** Cross-Disciplinary Resilience API Integration
...
***REMOVED******REMOVED*** Endpoint Examples

***REMOVED******REMOVED******REMOVED*** 1. SPC Workload Monitoring Endpoint
...
async def analyze_workload_spc(
    ...
    ***REMOVED*** Initialize control chart
...
***REMOVED******REMOVED******REMOVED*** 2. Process Capability Dashboard
...
***REMOVED******REMOVED******REMOVED*** 3. Burnout Contagion Analysis
...
async def analyze_burnout_contagion(
    ...
    ***REMOVED*** Build social network from shared shifts
    ***REMOVED*** In production, this would use actual assignment data
    G = nx.Graph()
    ...
    ***REMOVED*** Add edges based on shared shifts (simplified)
    ***REMOVED*** In production, query assignments and connect residents
    ***REMOVED*** who frequently work together
    assignments = db.query(Assignment).all()
    ***REMOVED*** ... build edges from shared blocks ...

    ***REMOVED*** Initialize epidemiology analyzer
    epi = BurnoutEpidemiology(social_network=G)

    ***REMOVED*** Calculate reproduction number
...
***REMOVED******REMOVED******REMOVED*** 4. Specialist Coverage Optimization
...
***REMOVED******REMOVED******REMOVED*** 5. Burnout Early Warning System
...
async def detect_burnout_precursors(
    ...
    ***REMOVED*** Map signal type string to enum
    signal_map = {
...
***REMOVED******REMOVED******REMOVED*** 6. Fire Weather Danger Rating
...
class FireDangerResponse(BaseModel):
    ...
    resident_id: UUID
    danger_class: str  ***REMOVED*** LOW, MODERATE, HIGH, VERY_HIGH, EXTREME
    fwi_score: float
...
***REMOVED******REMOVED******REMOVED*** 7. Chronic Overwork Prediction
...
class CreepFatigueResponse(BaseModel):
    ...
    resident_id: UUID
    overall_risk: str  ***REMOVED*** high, moderate, low
    risk_score: float
...
***REMOVED******REMOVED******REMOVED*** Example: Periodic SPC Monitoring Task
...
def spc_workload_monitoring(self):
    ...
    try:
        ***REMOVED*** Get all residents
        ...
        for resident in residents:
            ***REMOVED*** Get last 8 weeks of hours
            ***REMOVED*** (In production, query from assignments)
            ...
            if len(weekly_hours) >= 8:
                ...
                ***REMOVED*** Collect critical alerts
                critical = [a for a in alerts if a.severity == "CRITICAL"]
                if critical:
                    critical_alerts.extend(critical)

        ***REMOVED*** Send alert if critical violations found
        if critical_alerts:
            send_resilience_alert.delay(
                ...
                details={
                    "violations": [
                        ...
                        for a in critical_alerts[:5]  ***REMOVED*** Top 5
                    ]
                },
            )
...
def get_weekly_hours(db, resident_id, weeks=8):
    ...
    ***REMOVED*** Implementation depends on your assignment model
    ***REMOVED*** This is a simplified example
    from datetime import date, timedelta
    ...
    for i in range(weeks):
        ...
        ***REMOVED*** Query assignments for this week
        ***REMOVED*** Calculate total hours
        ***REMOVED*** weekly_hours.append(total)

    return weekly_hours
```

***REMOVED******REMOVED******REMOVED*** Example: Burnout Epidemiology Monitoring
...
def burnout_epidemiology_check(self):
    ...
    db = SessionLocal()
    try:
        ***REMOVED*** Build social network from assignments
        G = build_social_network(db)

        ***REMOVED*** Get burned out residents (would use real burnout assessment)
        ...
        if burned_out:
            ...
            ***REMOVED*** Alert if Rt > 1 (spreading)
...
***REMOVED******REMOVED******REMOVED*** Metrics Definition

```python
***REMOVED*** In app/resilience/metrics.py
    ...
    def __init__(self):
        ...
        ***REMOVED*** Epidemiology Metrics
        ...
        self.burnout_cases = Gauge(
            ...
            ['state']  ***REMOVED*** susceptible, at_risk, burned_out, recovered
        )

        ***REMOVED*** Erlang C Metrics
...
***REMOVED******REMOVED******REMOVED*** Using Metrics in Endpoints
...
***REMOVED******REMOVED*** Response Schemas
...
***REMOVED*** Process Capability Schemas
...
***REMOVED******REMOVED******REMOVED*** 3. Pagination for Large Results
...
***REMOVED******REMOVED******REMOVED*** 4. Async Database Operations
...
***REMOVED******REMOVED*** Complete Example: Combined Endpoint
...
async def comprehensive_burnout_analysis(
    ...
    ***REMOVED*** 3. Fire Danger Rating
    ...
    danger = fire_rating.calculate_burnout_danger(
        ...
        yearly_satisfaction=0.7,  ***REMOVED*** Would get from survey
        workload_velocity=5.0,  ***REMOVED*** Would calculate from trend
    )

    ***REMOVED*** 4. Creep/Fatigue
    creep_model = CreepFatigueModel()
    creep_risk = creep_model.assess_combined_risk(
        resident_id=resident_id,
        sustained_workload=0.85,  ***REMOVED*** Would calculate
...
def test_process_capability_endpoint(client: TestClient):
    ...
    response = client.post(
        ...
        json={
            "weekly_hours": [60 + i for i in range(30)],  ***REMOVED*** 30 samples
            "min_hours": 40,
            "max_hours": 80,
        }
    )
