***REMOVED*** Assignments API Reference
...
***REMOVED******REMOVED******REMOVED*** GET /{assignment_id}
...
***REMOVED******REMOVED******REMOVED*** PUT /{assignment_id}
...
***REMOVED******REMOVED******REMOVED*** DELETE /{assignment_id}
...
***REMOVED******REMOVED******REMOVED*** Rules Checked
...
***REMOVED******REMOVED******REMOVED*** Violation Response Format
...
***REMOVED******REMOVED******REMOVED*** Creating Assignments with Violations
...
***REMOVED******REMOVED*** Filtering Examples

***REMOVED******REMOVED******REMOVED*** Get All Clinic Assignments for a Resident
...
***REMOVED******REMOVED******REMOVED*** Get All Call Assignments in January
...
***REMOVED******REMOVED******REMOVED*** Get All Faculty Supervision Assignments
...
***REMOVED******REMOVED******REMOVED*** Get All Assignments with Pagination

```bash
***REMOVED*** Page 1 (items 1-50)
curl -X GET 'http://localhost:8000/api/assignments?page=1&page_size=50' \
  -H "Authorization: Bearer <ACCESS_TOKEN>"

***REMOVED*** Page 2 (items 51-100)
...
***REMOVED******REMOVED******REMOVED*** 1. Get a Resident's Full Schedule
...
***REMOVED******REMOVED******REMOVED*** 2. Check for ACGME Violations Before Bulk Assignment

```bash
***REMOVED*** Get current hours for resident
curl -X GET "http://localhost:8000/api/assignments?person_id=$RESIDENT_ID&start_date=2025-01-01&end_date=2025-01-28" \
  -H "Authorization: Bearer <ACCESS_TOKEN>" | jq '.items | length'

***REMOVED*** Then create assignment and check response for violations
curl -X POST http://localhost:8000/api/assignments \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <ACCESS_TOKEN>" \
  -d '{...}' | jq '.violations'
...
***REMOVED******REMOVED******REMOVED*** 3. Clear January and Regenerate Schedule

```bash
***REMOVED*** Delete all assignments for January
curl -X DELETE 'http://localhost:8000/api/assignments?start_date=2025-01-01&end_date=2025-01-31' \
  -H "Authorization: Bearer <ACCESS_TOKEN>"

***REMOVED*** Then regenerate via /schedule/generate endpoint
...
***REMOVED******REMOVED******REMOVED*** Assignment Response
...
***REMOVED******REMOVED******REMOVED*** Violation Item
...
***REMOVED******REMOVED******REMOVED*** Before Creating Assignments
...
***REMOVED******REMOVED******REMOVED*** Handling ACGME Violations
