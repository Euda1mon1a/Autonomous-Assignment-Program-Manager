***REMOVED*** Exotic Resilience API Documentation
...
***REMOVED******REMOVED******REMOVED*** 2. Reorganization Risk Prediction

Predict risk of sudden system reorganization due to external perturbations.

***REMOVED******REMOVED******REMOVED******REMOVED*** `POST /exotic/reorganization-risk`
...
***REMOVED******REMOVED******REMOVED*** 3. Spin Glass Replica Generation

Generate diverse schedule replicas using frustrated constraint physics.

***REMOVED******REMOVED******REMOVED******REMOVED*** `POST /exotic/spin-glass`
...
***REMOVED******REMOVED******REMOVED*** 4. Catastrophe Prediction

Predict sudden system failures using catastrophe theory (cusp catastrophe model).

***REMOVED******REMOVED******REMOVED******REMOVED*** `POST /exotic/catastrophe`
...
***REMOVED******REMOVED******REMOVED*** 422 Unprocessable Entity
...
***REMOVED******REMOVED******REMOVED*** 500 Internal Server Error
...
***REMOVED******REMOVED******REMOVED*** JavaScript (fetch)
