***REMOVED*** Schedule API Reference
...
***REMOVED******REMOVED******REMOVED*** Scheduling Algorithms
...
***REMOVED******REMOVED******REMOVED*** POST /generate
...
***REMOVED******REMOVED******REMOVED*** GET /validate
...
***REMOVED******REMOVED******REMOVED*** POST /emergency-coverage
...
***REMOVED******REMOVED******REMOVED*** GET /{start_date}/{end_date}
...
***REMOVED******REMOVED*** Import & Analysis

***REMOVED******REMOVED******REMOVED*** POST /import/analyze
...
***REMOVED******REMOVED******REMOVED*** POST /import/analyze-file
...
***REMOVED******REMOVED******REMOVED*** POST /import/block
...
***REMOVED******REMOVED******REMOVED*** POST /swaps/find
...
***REMOVED******REMOVED******REMOVED*** POST /swaps/candidates
...
***REMOVED******REMOVED*** Faculty Outpatient Assignments

***REMOVED******REMOVED******REMOVED*** POST /faculty-outpatient/generate
...
***REMOVED******REMOVED******REMOVED*** 1. Use Idempotency Keys

```bash
***REMOVED*** Generate with idempotency key
curl -X POST http://localhost:8000/api/schedule/generate \
...
***REMOVED*** Same key + params = returns cached result (instant)
***REMOVED*** Retry-safe: Can safely retry without duplicating
```

***REMOVED******REMOVED******REMOVED*** 2. Use Appropriate Algorithm
...
***REMOVED******REMOVED******REMOVED*** 3. Validate Before Finalizing

```bash
***REMOVED*** Generate schedule
curl -X POST http://localhost:8000/api/schedule/generate ...

***REMOVED*** Then validate
curl -X GET 'http://localhost:8000/api/schedule/validate?start_date=2025-01-01&end_date=2025-01-31'

***REMOVED*** Check for violations before publishing
```
