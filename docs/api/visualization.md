...
***REMOVED******REMOVED*** 2D Heatmap Endpoints

***REMOVED******REMOVED******REMOVED*** GET `/heatmap`
...
***REMOVED******REMOVED******REMOVED*** GET `/heatmap/image`
...
***REMOVED******REMOVED******REMOVED*** GET `/coverage`
...
***REMOVED******REMOVED*** 3D Voxel Visualization Endpoints
...
***REMOVED******REMOVED******REMOVED*** GET `/voxel-grid`
...
***REMOVED******REMOVED******REMOVED*** GET `/voxel-grid/conflicts`
...
***REMOVED******REMOVED******REMOVED*** GET `/voxel-grid/coverage-gaps`
...
***REMOVED******REMOVED*** Activity Type Color Mapping
