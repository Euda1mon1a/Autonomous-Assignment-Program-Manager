...
***REMOVED******REMOVED*** Schedule Block
...
***REMOVED******REMOVED******REMOVED*** Coverage Gap Severity
...
***REMOVED******REMOVED*** Create Manual Assignment
...
***REMOVED******REMOVED*** Algorithm Details

***REMOVED******REMOVED******REMOVED*** Leave-Eligible Matching
...
***REMOVED******REMOVED******REMOVED*** Block Date Calculation
...
***REMOVED******REMOVED******REMOVED*** Preview Block Schedule
...
***REMOVED******REMOVED******REMOVED*** Execute Block Schedule
...
***REMOVED******REMOVED******REMOVED*** Get Dashboard
