...
***REMOVED******REMOVED*** GET /api/blocks
...
***REMOVED******REMOVED*** GET /api/blocks/{block_id}
...
***REMOVED******REMOVED*** POST /api/blocks
...
***REMOVED******REMOVED*** POST /api/blocks/generate
...
```bash
***REMOVED*** Generate blocks for January 2024
curl -X POST "http://localhost:8000/api/blocks/generate?start_date=2024-01-01&end_date=2024-01-31"

***REMOVED*** Generate blocks for full year with custom block numbering
...
***REMOVED******REMOVED*** DELETE /api/blocks/{block_id}
...
***REMOVED******REMOVED******REMOVED*** Academic Block Numbers
...
***REMOVED******REMOVED******REMOVED*** Generate Full Academic Year

```bash
***REMOVED*** Generate blocks for academic year (July 1 - June 30)
curl -X POST "http://localhost:8000/api/blocks/generate?start_date=2024-07-01&end_date=2025-06-30&base_block_number=1"
```

***REMOVED******REMOVED******REMOVED*** Find Available Blocks

```bash
***REMOVED*** Get all blocks for a specific week
...
```bash
***REMOVED*** Get blocks by block number to see coverage
curl "http://localhost:8000/api/blocks?block_number=5"
```
