...
***REMOVED******REMOVED*** GET /api/people
...
***REMOVED******REMOVED*** GET /api/people/residents
...
***REMOVED******REMOVED*** GET /api/people/faculty
...
***REMOVED******REMOVED*** GET /api/people/{person_id}
...
***REMOVED******REMOVED*** POST /api/people
...
***REMOVED******REMOVED*** PUT /api/people/{person_id}
...
***REMOVED******REMOVED*** DELETE /api/people/{person_id}
...
***REMOVED******REMOVED******REMOVED*** Bulk Import Residents

```bash
***REMOVED*** Import multiple residents
...
***REMOVED******REMOVED******REMOVED*** Update PGY Level for Year Advancement

```bash
***REMOVED*** Get all PGY-2 residents and advance to PGY-3
