...
***REMOVED******REMOVED******REMOVED*** List Credentials by Person
...
***REMOVED******REMOVED******REMOVED*** List Credentials by Procedure
...
***REMOVED******REMOVED******REMOVED*** Get Qualified Faculty
...
***REMOVED******REMOVED******REMOVED*** Check Qualification
...
***REMOVED******REMOVED******REMOVED*** Get Credential
