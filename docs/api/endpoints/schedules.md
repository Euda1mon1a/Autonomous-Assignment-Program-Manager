***REMOVED*** Schedule API Endpoints
...
***REMOVED******REMOVED******REMOVED*** Conflict Types
...
***REMOVED******REMOVED*** Parse Block Schedule
...
***REMOVED******REMOVED*** Find Swap Candidates
...
***REMOVED******REMOVED*** Faculty Outpatient Generation
...
***REMOVED******REMOVED******REMOVED*** Faculty Clinic Limits by Role
