...
***REMOVED******REMOVED*** GET /api/schedule/{start_date}/{end_date}
...
***REMOVED******REMOVED*** POST /api/schedule/generate
...
***REMOVED******REMOVED******REMOVED*** Response with Violations
...
***REMOVED******REMOVED*** GET /api/schedule/validate
...
***REMOVED******REMOVED*** POST /api/schedule/emergency-coverage
...
***REMOVED******REMOVED******REMOVED*** Response Status Values
...
***REMOVED******REMOVED******REMOVED*** Coverage Detail Status
...
***REMOVED******REMOVED******REMOVED*** Weekly Schedule Review

```bash
***REMOVED*** Get this week's schedule
...
***REMOVED******REMOVED******REMOVED*** Quarterly Schedule Generation

```bash
***REMOVED*** Generate Q1 schedule
curl -X POST http://localhost:8000/api/schedule/generate \
  -H "Authorization: Bearer $TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
***REMOVED******REMOVED******REMOVED*** Compliance Monitoring

```bash
***REMOVED*** Validate current month's schedule
...
***REMOVED******REMOVED******REMOVED*** Emergency Coverage Workflow

```bash
***REMOVED*** 1. Create absence record
...
***REMOVED*** 3. Review gaps and manually assign if needed
```
