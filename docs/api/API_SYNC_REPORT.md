***REMOVED*** API Sync Report: OpenAPI Spec vs Actual Endpoints
...
***REMOVED******REMOVED*** Detailed Analysis

***REMOVED******REMOVED******REMOVED*** 1. Route Files Inventory

Total route files identified: **66**

***REMOVED******REMOVED******REMOVED******REMOVED*** Fully Analyzed Routes (23 files, 160 endpoints extracted)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Partially Analyzed Routes (43 files, ~402 endpoints)
...
***REMOVED******REMOVED*** 2. Documentation Status by Category

***REMOVED******REMOVED******REMOVED*** ✅ Well-Documented Categories (>80% coverage)
...
***REMOVED******REMOVED******REMOVED*** ⚠️ Partially Documented Categories (30-80% coverage)
...
***REMOVED******REMOVED******REMOVED*** 🔴 Undocumented/Missing Categories (<30% coverage)
...
***REMOVED******REMOVED*** 3. Critical Gaps Identified

***REMOVED******REMOVED******REMOVED*** Gap ***REMOVED***1: Resilience Framework (54 endpoints)
...
***REMOVED******REMOVED******REMOVED*** Gap ***REMOVED***2: Job Queue Management (40 endpoints)
...
***REMOVED******REMOVED******REMOVED*** Gap ***REMOVED***3: Administrative Routes (26 endpoints)
...
***REMOVED******REMOVED******REMOVED*** Gap ***REMOVED***4: WebSocket & Real-Time (13+ endpoints)
...
***REMOVED******REMOVED*** 4. OpenAPI Spec Analysis
...
1. **Production Mode Disabled**
   ```python
   ***REMOVED*** backend/app/main.py (lines 236-238)
...
***REMOVED******REMOVED*** 5. Recommended Actions

***REMOVED******REMOVED******REMOVED*** Priority 1: CRITICAL (Immediate)

1. **Export OpenAPI Spec to Repository**
   ```bash
   ***REMOVED*** Run server in DEBUG mode
   uvicorn app.main:app --reload

   ***REMOVED*** Export spec
   curl http://localhost:8000/openapi.json > docs/api/openapi.json

   ***REMOVED*** Convert to YAML (optional)
   ***REMOVED*** Using openapi-generator or similar tool
   ```

2. **Update ENDPOINT_CATALOG.md**
   - Update total endpoint count: 200+ → **562**
   - Add missing route sections (see Gap ***REMOVED***1-4 above)
...
***REMOVED******REMOVED******REMOVED*** Priority 2: HIGH (This Sprint)
...
***REMOVED******REMOVED******REMOVED*** Priority 3: MEDIUM (Next Sprint)
...
***REMOVED******REMOVED******REMOVED*** Priority 4: LOW (Backlog)
...
***REMOVED******REMOVED*** 6. Endpoint Inventory by Route File

***REMOVED******REMOVED******REMOVED*** Complete Extraction (23 files, 160 endpoints)

<details>
<summary>Click to expand detailed endpoint list</summary>

***REMOVED******REMOVED******REMOVED******REMOVED*** absences.py (5 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** academic_blocks.py (2 endpoints)
- `GET /academic-blocks/matrix/academic-blocks` - Block matrix
- `GET /academic-blocks/matrix/blocks` - List blocks

***REMOVED******REMOVED******REMOVED******REMOVED*** admin_users.py (8 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** assignments.py (6 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** auth.py (7 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** block_scheduler.py (6 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** blocks.py (5 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** calendar.py (9 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** certifications.py (14 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** conflict_resolution.py (5 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** credentials.py (13 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** daily_manifest.py (1 endpoint)
- `GET /assignments/daily-manifest` - Daily manifest

***REMOVED******REMOVED******REMOVED******REMOVED*** export.py (4 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** health.py (9 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** leave.py (6 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** people.py (10 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** portal.py (8 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** procedures.py (10 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** role_views.py (6 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** rotation_templates.py (5 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** schedule.py (9 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** settings.py (4 endpoints)
- `GET /settings` - Get settings
- `POST /settings` - Update settings
- `PATCH /settings` - Patch settings
- `DELETE /settings` - Reset settings

***REMOVED******REMOVED******REMOVED******REMOVED*** swap.py (5 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** unified_heatmap.py (10 endpoints)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** visualization.py (9 endpoints)
...
***REMOVED******REMOVED******REMOVED*** Remaining Route Files (43 files, ~402 endpoints)
...
***REMOVED******REMOVED*** 7. Documentation Sync Roadmap
...
***REMOVED******REMOVED******REMOVED*** Week 2: Core Routes
...
***REMOVED******REMOVED******REMOVED*** Week 3: Specialized Routes
...
***REMOVED******REMOVED******REMOVED*** Week 4: Polish & Automation
...
***REMOVED******REMOVED*** 8. Appendix: Tools Used

***REMOVED******REMOVED******REMOVED*** Endpoint Extraction
...
***REMOVED******REMOVED******REMOVED*** Documentation Review
- **Files Analyzed:**
