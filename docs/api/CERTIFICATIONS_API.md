...
***REMOVED******REMOVED*** Certification Type Endpoints

***REMOVED******REMOVED******REMOVED*** List Certification Types
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Common Certification Types
...
***REMOVED******REMOVED******REMOVED*** Get Certification Type
...
***REMOVED******REMOVED******REMOVED*** Create Certification Type
...
***REMOVED******REMOVED******REMOVED*** Update Certification Type
...
***REMOVED******REMOVED*** Person Certification Endpoints

***REMOVED******REMOVED******REMOVED*** List Certifications for Person
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Certification Status Values
...
***REMOVED******REMOVED******REMOVED*** Get Person Certification
...
***REMOVED******REMOVED******REMOVED*** Create Person Certification
...
***REMOVED******REMOVED******REMOVED*** Update Person Certification
...
***REMOVED******REMOVED******REMOVED*** Renew Certification
...
***REMOVED******REMOVED******REMOVED*** Delete Person Certification
...
***REMOVED******REMOVED*** Compliance & Expiration Endpoints
...
***REMOVED******REMOVED******REMOVED*** Get Compliance Summary
...
***REMOVED******REMOVED******REMOVED*** Get Person Compliance
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Compliance Determination
...
***REMOVED******REMOVED*** Admin Endpoints

***REMOVED******REMOVED******REMOVED*** Trigger Certification Reminders
...
***REMOVED******REMOVED******REMOVED******REMOVED*** What This Does
...
***REMOVED******REMOVED******REMOVED*** Onboarding New Personnel

```bash
***REMOVED*** 1. Create person (via /persons API)

***REMOVED*** 2. Add required certifications
POST /certifications
{
  "person_id": "{person_id}",
...
***REMOVED*** 3. Verify compliance
GET /certifications/compliance/{person_id}
```

***REMOVED******REMOVED******REMOVED*** Renewal Process

```bash
***REMOVED*** 1. Identify expiring certifications
GET /certifications/expiring?days=90

***REMOVED*** 2. Notify person to renew

***REMOVED*** 3. After renewal, update certification
POST /certifications/{cert_id}/renew
{
...
```bash
***REMOVED*** 1. Get overall compliance
GET /certifications/compliance

***REMOVED*** 2. Identify non-compliant personnel
GET /certifications/expiring?days=0  ***REMOVED*** Expired only

***REMOVED*** 3. Review individual compliance
GET /certifications/compliance/{person_id}
```

***REMOVED******REMOVED******REMOVED*** Dashboard Widget Data

```bash
***REMOVED*** Get data for certification dashboard
GET /certifications/compliance          ***REMOVED*** Overall stats
GET /certifications/expiring?days=30    ***REMOVED*** Urgent renewals
GET /certifications/expiring?days=90    ***REMOVED*** Planning renewals
```

---

***REMOVED******REMOVED*** Reminder Email Schedule
...
***REMOVED******REMOVED*** Integration with Scheduling

***REMOVED******REMOVED******REMOVED*** Slot-Type Invariants

Certifications integrate with the scheduling system via **slot-type invariants**:

```python
***REMOVED*** Example: Inpatient call requires valid certifications
invariant_catalog = {
    "inpatient_call": {
...
***REMOVED******REMOVED******REMOVED*** Pre-Assignment Validation

Before creating an assignment:
```bash
***REMOVED*** Check person is compliant for slot type
GET /certifications/compliance/{person_id}

***REMOVED*** Verify no hard constraint failures
***REMOVED*** Proceed with assignment if is_compliant = true
```

---

***REMOVED******REMOVED*** Error Codes Summary
