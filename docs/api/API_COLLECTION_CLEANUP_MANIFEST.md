***REMOVED*** G2 RECON: API Collection Cleanup Manifest
...
***REMOVED******REMOVED******REMOVED*** Collection 1: `/docs/api/postman_collection.json` (RECOMMENDED KEEP)
...
***REMOVED******REMOVED******REMOVED*** Collection 2: `/docs/api/collections/postman-collection.json` (RECOMMENDED DELETE)
...
***REMOVED******REMOVED******REMOVED*** Generation Analysis
...
***REMOVED******REMOVED******REMOVED*** Official Documentation Reference
...
***REMOVED******REMOVED******REMOVED*** Why Two Collections Exist
...
***REMOVED******REMOVED*** Cleanup Decision Matrix

***REMOVED******REMOVED******REMOVED*** KEEP: `/docs/api/postman_collection.json`
...
***REMOVED******REMOVED******REMOVED*** DELETE: `/docs/api/collections/postman-collection.json`
...
***REMOVED******REMOVED******REMOVED*** Priority 1: DELETE (Immediate)
...
***REMOVED******REMOVED******REMOVED*** Priority 2: VERIFY (After Deletion)
Confirm that:
...
***REMOVED******REMOVED******REMOVED*** Priority 3: OPTIONAL ENHANCEMENT (If Resources Available)
...
- [ ] Commit deletion with message: "cleanup: Remove duplicate Postman collection (***REMOVED***XXX)"
- [ ] Test import of remaining collection in Postman UI

---

***REMOVED******REMOVED*** Evidence Files
