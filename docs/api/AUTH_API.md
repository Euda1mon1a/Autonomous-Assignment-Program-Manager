***REMOVED*** Authentication API Reference
...
***REMOVED******REMOVED******REMOVED*** POST /login
...
***REMOVED******REMOVED******REMOVED*** POST /login/json
...
***REMOVED******REMOVED******REMOVED*** POST /logout
...
***REMOVED******REMOVED******REMOVED*** POST /refresh
...
***REMOVED******REMOVED******REMOVED*** GET /me
...
***REMOVED******REMOVED******REMOVED*** POST /register
...
- **Password Requirements**:
  ...
  - At least one number
  - At least one special character (!@***REMOVED***$%^&*)
...
***REMOVED******REMOVED******REMOVED*** GET /users
...
***REMOVED******REMOVED*** Authentication Methods

***REMOVED******REMOVED******REMOVED*** Cookie-Based Authentication

The API automatically sets and uses httpOnly cookies for access tokens:

```bash
***REMOVED*** Login sets the cookie automatically
curl -X POST http://localhost:8000/api/auth/login \
  -H "Content-Type: application/x-www-form-urlencoded" \
  -d "username=user@example.com&password=pass"

***REMOVED*** Subsequent requests automatically include the cookie
curl -X GET http://localhost:8000/api/auth/me
```

***REMOVED******REMOVED******REMOVED*** Bearer Token Authentication
...
***REMOVED*** Token rotation (security enhancement)
REFRESH_TOKEN_ROTATE=true

***REMOVED*** Rate limiting
RATE_LIMIT_LOGIN_ATTEMPTS=5
RATE_LIMIT_LOGIN_WINDOW=900  ***REMOVED*** 15 minutes

RATE_LIMIT_REGISTER_ATTEMPTS=10
RATE_LIMIT_REGISTER_WINDOW=3600  ***REMOVED*** 1 hour
...
***REMOVED*** Security
SECRET_KEY=<generated-secret-key>  ***REMOVED*** Min 32 characters
DEBUG=false  ***REMOVED*** Must be false in production
```
...
***REMOVED******REMOVED******REMOVED*** Access Token (JWT)
...
***REMOVED******REMOVED******REMOVED*** Refresh Token (JWT)
...
***REMOVED******REMOVED******REMOVED*** For CLI/Scripts
...
***REMOVED******REMOVED******REMOVED*** "Invalid or expired refresh token"
...
***REMOVED******REMOVED******REMOVED*** XSS Protection
...
***REMOVED******REMOVED******REMOVED*** Token Theft Prevention
