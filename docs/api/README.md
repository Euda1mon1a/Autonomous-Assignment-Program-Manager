...
***REMOVED******REMOVED******REMOVED*** 1. Health Check

```bash
curl http://localhost:8000/health
```

***REMOVED******REMOVED******REMOVED*** 2. Register a User
...
***REMOVED******REMOVED******REMOVED*** 3. Login and Get Token
...
***REMOVED******REMOVED******REMOVED*** 4. Use the Token
...
***REMOVED******REMOVED******REMOVED*** Endpoint Documentation
...
***REMOVED******REMOVED*** Common Headers

***REMOVED******REMOVED******REMOVED*** Request Headers
...
***REMOVED******REMOVED*** SDKs and Client Libraries
