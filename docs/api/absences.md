...
***REMOVED******REMOVED******REMOVED*** Absence Status
...
***REMOVED******REMOVED*** Approve/Deny Absence
...
***REMOVED******REMOVED******REMOVED*** Request Body (optional for approve)
...
***REMOVED******REMOVED******REMOVED*** 1. Request Vacation
...
***REMOVED******REMOVED******REMOVED*** 2. Track Deployments
...
***REMOVED******REMOVED******REMOVED*** 3. Approve Pending Requests
...
def approve_pending_absences(token):
    ...
    for absence in pending:
        ...
        ***REMOVED*** Auto-approve if < 7 days and no conflicts
...
***REMOVED******REMOVED******REMOVED*** 4. Check Person's Absence History
...
def get_absence_summary(token, person_id, year):
    ...
    ***REMOVED*** Calculate totals by type
    totals = {}
...
***REMOVED******REMOVED******REMOVED*** 1. Always Check Conflicts
...
if result.get('conflicts'):
    ***REMOVED*** Handle conflicts before finalizing
    for conflict in result['conflicts']:
        if conflict['type'] == 'fmit_assignment':
            ***REMOVED*** Request swap for FMIT week
            request_swap(conflict['date'])
```

***REMOVED******REMOVED******REMOVED*** 2. Request Absences Early
...
***REMOVED******REMOVED******REMOVED*** 3. Deployment Coordination
...
***REMOVED******REMOVED******REMOVED*** 4. Track Absence Quota
