...
7. [Absences & Leave](#absences--leave)
8. [Schedule Generation](#schedule-generation)
9. [Swaps & Exchanges](#swaps--exchanges)
10. [Rotation Templates](#rotation-templates)
...
16. [Resilience Framework](#resilience-framework)
17. [Audit & Compliance](#audit--compliance)
18. [Search](#search)
19. [Exports](#exports)
20. [Conflict Resolution](#conflict-resolution)
21. [Portal & Dashboard](#portal--dashboard)
22. [Specialized Routes](#specialized-routes)
23. [Response Codes](#response-codes)
...
| GET | `/call-assignments/{id}` | Bearer | Get call assignment by ID |
| POST | `/call-assignments` | Scheduler | Create call assignment |
| PUT | `/call-assignments/{id}` | Scheduler | Update call assignment |
| DELETE | `/call-assignments/{id}` | Scheduler | Delete call assignment |
| POST | `/call-assignments/bulk` | Scheduler | Bulk create call assignments |
| DELETE | `/call-assignments/bulk` | Admin | Bulk delete by date range |
...
| `start_date` | date | Filter by start date |
| `end_date` | date | Filter by end date |
| `person_id` | uuid | Filter by assigned faculty |
| `call_type` | string | Filter by type (`overnight`, `weekend`) |
| `is_holiday` | bool | Filter holiday assignments |

### Call Types

| Type | Coverage | Assigned By |
|------|----------|-------------|
| `overnight` | Sun-Thurs nights | Solver-generated |
| `fmit_friday` | Friday night (FMIT week) | Pre-loaded with FMIT |
| `fmit_saturday` | Saturday night (FMIT week) | Pre-loaded with FMIT |

### Integration with Solver

Overnight call assignments (Sun-Thurs) are automatically generated by the `OvernightCallGenerationConstraint` during schedule generation. FMIT call assignments (Fri-Sat) are pre-loaded when faculty are assigned to FMIT weeks.
