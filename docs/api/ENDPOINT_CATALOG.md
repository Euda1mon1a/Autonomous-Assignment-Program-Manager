...
2. [Health & Monitoring](***REMOVED***health--monitoring)
3. [Authentication & Authorization](***REMOVED***authentication--authorization)
4. [People Management](***REMOVED***people-management)
5. [Blocks & Calendar](***REMOVED***blocks--calendar)
6. [Block Scheduler](***REMOVED***block-scheduler)
7. [Assignments](***REMOVED***assignments)
8. [Call Assignments](***REMOVED***call-assignments)
9. [Absences & Leave](***REMOVED***absences--leave)
10. [Schedule Generation](***REMOVED***schedule-generation)
11. [Swaps & Exchanges](***REMOVED***swaps--exchanges)
13. [Rotation Templates](***REMOVED***rotation-templates)
14. [Procedures](***REMOVED***procedures)
15. [Credentials](***REMOVED***credentials)
16. [Certifications](***REMOVED***certifications)
17. [Settings](***REMOVED***settings)
18. [Analytics & Reporting](***REMOVED***analytics--reporting)
19. [Resilience Framework](***REMOVED***resilience-framework)
20. [Audit & Compliance](***REMOVED***audit--compliance)
21. [Search](***REMOVED***search)
22. [Exports](***REMOVED***exports)
23. [Conflict Resolution](***REMOVED***conflict-resolution)
24. [Portal & Dashboard](***REMOVED***portal--dashboard)
25. [Specialized Routes](***REMOVED***specialized-routes)
26. [Response Codes](***REMOVED***response-codes)
27. [Authentication Requirements](***REMOVED***authentication-requirements)
...
***REMOVED******REMOVED******REMOVED*** Interactive Documentation
...
***REMOVED******REMOVED******REMOVED*** Service Names
...
***REMOVED******REMOVED*** Blocks & Calendar
...
***REMOVED******REMOVED*** Block Scheduler
...
***REMOVED******REMOVED******REMOVED*** Query Parameters (Dashboard)
...
***REMOVED******REMOVED******REMOVED*** Schedule Request Body
...
***REMOVED******REMOVED******REMOVED*** Assignment Reasons
...
***REMOVED******REMOVED*** Absences & Leave
...
***REMOVED******REMOVED******REMOVED*** Leave Management
...
***REMOVED******REMOVED******REMOVED*** Schedule Generation Request
...
***REMOVED******REMOVED*** Swaps & Exchanges
...
***REMOVED******REMOVED******REMOVED*** Activity Types
...
***REMOVED******REMOVED*** Certifications

**Prefix:** `/api/v1/certifications`

***REMOVED******REMOVED******REMOVED*** Certification Types
...
***REMOVED******REMOVED******REMOVED*** Compliance & Tracking
...
***REMOVED******REMOVED******REMOVED*** Person Certifications
...
***REMOVED******REMOVED*** Analytics & Reporting
...
***REMOVED******REMOVED******REMOVED*** Reports
...
***REMOVED******REMOVED*** Audit & Compliance
...
***REMOVED******REMOVED*** Portal & Dashboard

***REMOVED******REMOVED******REMOVED*** Personal Dashboard
...
***REMOVED******REMOVED******REMOVED*** Faculty Portal
...
***REMOVED******REMOVED*** Specialized Routes

***REMOVED******REMOVED******REMOVED*** Metrics & Monitoring
...
***REMOVED******REMOVED*** Response Codes
...
***REMOVED******REMOVED******REMOVED*** Validation Error Format
...
***REMOVED******REMOVED*** Authentication Requirements
...
***REMOVED******REMOVED******REMOVED*** Most Common Endpoints
...
***REMOVED*** Authenticated request
curl http://localhost:8000/api/v1/people \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIs..."

***REMOVED*** Generate schedule (with idempotency)
