...
***REMOVED******REMOVED*** Metrics Health Check
...
***REMOVED******REMOVED******REMOVED*** Response (Degraded)
...
***REMOVED******REMOVED*** Metrics Information
...
***REMOVED******REMOVED******REMOVED*** Metric Types
...
***REMOVED******REMOVED*** Export Metrics
...
```
***REMOVED*** HELP http_requests_total Total HTTP requests
***REMOVED*** TYPE http_requests_total counter
...
***REMOVED*** HELP http_request_duration_seconds HTTP request latency
***REMOVED*** TYPE http_request_duration_seconds histogram
...
***REMOVED*** HELP db_connections_active Number of active database connections
***REMOVED*** TYPE db_connections_active gauge
db_connections_active 3.0

***REMOVED*** HELP background_tasks_in_progress Background tasks executing
***REMOVED*** TYPE background_tasks_in_progress gauge
...
***REMOVED*** ... (all other metrics)
```

***REMOVED******REMOVED******REMOVED*** Prometheus Format Details
...
***REMOVED******REMOVED******REMOVED*** Error Response (503)
...
***REMOVED******REMOVED*** Metrics Summary
...
***REMOVED******REMOVED******REMOVED*** Response (Enabled)
...
***REMOVED******REMOVED******REMOVED*** Response (Disabled)
...
***REMOVED******REMOVED******REMOVED*** Response (Debug Mode)
...
***REMOVED******REMOVED******REMOVED*** Response (Production)
...
***REMOVED******REMOVED*** Prometheus Integration
...
***REMOVED******REMOVED******REMOVED*** Scraping Behavior
...
***REMOVED******REMOVED******REMOVED*** Common Prometheus Queries

***REMOVED******REMOVED******REMOVED******REMOVED*** Request Rate
```promql
rate(http_requests_total[5m])
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Request Latency (p95)
```promql
histogram_quantile(0.95, rate(http_request_duration_seconds_bucket[5m]))
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Error Rate
```promql
rate(errors_total[5m])
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Database Connection Pool Usage
```promql
db_connections_active / db_connection_pool_size * 100
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Cache Hit Ratio
```promql
cache_hit_ratio
```

***REMOVED******REMOVED******REMOVED******REMOVED*** ACGME Compliance Score
```promql
acgme_compliance_score
```
...
***REMOVED******REMOVED*** Grafana Dashboard Examples

***REMOVED******REMOVED******REMOVED*** HTTP Performance Panel
...
***REMOVED******REMOVED******REMOVED*** Database Query Duration
...
***REMOVED******REMOVED******REMOVED*** Background Task Queue Depth
...
***REMOVED******REMOVED******REMOVED*** ACGME Violations
...
***REMOVED******REMOVED******REMOVED*** System Resource Usage
...
***REMOVED******REMOVED*** Alerting Rules
...
***REMOVED******REMOVED******REMOVED*** Database Connection Pool Exhausted
...
***REMOVED******REMOVED******REMOVED*** Long-Running Schedule Generation
...
***REMOVED******REMOVED******REMOVED*** ACGME Compliance Degradation
...
***REMOVED******REMOVED*** Metric Collection Best Practices

***REMOVED******REMOVED******REMOVED*** Instrumentation
...
***REMOVED*** Record a histogram value
metrics.observe_histogram("http_request_duration_seconds", 0.045, {
    "method": "GET",
    "endpoint": "/api/v1/schedule"
})

***REMOVED*** Set a gauge value
metrics.set_gauge("db_connections_active", 5)
```

***REMOVED******REMOVED******REMOVED*** Label Cardinality

**Good (low cardinality):**
```python
labels = {"method": "GET", "status_code": "200"}  ***REMOVED*** ~10 unique combinations
```

**Bad (high cardinality):**
```python
labels = {"user_id": "uuid", "timestamp": "2024-01-15T10:30:00"}  ***REMOVED*** Millions of combinations
```
...
***REMOVED******REMOVED******REMOVED*** Scraping Overhead
...
***REMOVED******REMOVED******REMOVED*** Query Performance
...
***REMOVED******REMOVED******REMOVED*** High Cardinality Warning
...
***REMOVED******REMOVED******REMOVED*** Stale Metrics
