...
3. [Import & Analysis Endpoints](***REMOVED***import--analysis-endpoints)
4. [Swap Finder Endpoints](***REMOVED***swap-finder-endpoints)
5. [Faculty Outpatient Endpoints](***REMOVED***faculty-outpatient-endpoints)
6. [Schemas](***REMOVED***schemas)
...
***REMOVED******REMOVED*** Import & Analysis Endpoints

***REMOVED******REMOVED******REMOVED*** Analyze Imported Schedules
...
***REMOVED******REMOVED******REMOVED*** Analyze Single File
...
***REMOVED******REMOVED******REMOVED*** Parse Block Schedule
...
***REMOVED******REMOVED*** Swap Finder Endpoints

***REMOVED******REMOVED******REMOVED*** Find Swap Candidates (Excel)
...
***REMOVED******REMOVED******REMOVED*** Find Swap Candidates (JSON)
...
***REMOVED******REMOVED*** Faculty Outpatient Endpoints

***REMOVED******REMOVED******REMOVED*** Generate Faculty Outpatient Assignments
...
***REMOVED******REMOVED******REMOVED*** ScheduleRequest
...
***REMOVED******REMOVED******REMOVED*** ScheduleResponse
...
***REMOVED******REMOVED******REMOVED*** EmergencyRequest
...
***REMOVED******REMOVED******REMOVED*** EmergencyResponse
...
***REMOVED******REMOVED******REMOVED*** SwapFinderRequest
...
***REMOVED******REMOVED******REMOVED*** SwapFinderResponse
...
***REMOVED******REMOVED******REMOVED*** Generate Schedule with Idempotency
...
***REMOVED******REMOVED******REMOVED*** 409 Conflict - Idempotency Key Conflict
...
***REMOVED******REMOVED******REMOVED*** 409 Conflict - Generation In Progress
...
***REMOVED******REMOVED******REMOVED*** 207 Multi-Status - Partial Success
