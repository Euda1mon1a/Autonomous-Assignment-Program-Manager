...
3. [Reports](***REMOVED***reports)
4. [Schemas](***REMOVED***schemas)
5. [Examples](***REMOVED***examples)
...
***REMOVED******REMOVED******REMOVED*** Get Call Assignment
...
***REMOVED******REMOVED******REMOVED*** Update Call Assignment
...
***REMOVED******REMOVED******REMOVED*** Get Call Assignments by Person
...
***REMOVED******REMOVED******REMOVED*** Get Call Assignments by Date
...
***REMOVED******REMOVED******REMOVED*** Get Coverage Report
...
***REMOVED******REMOVED******REMOVED*** Get Equity Report
...
***REMOVED******REMOVED******REMOVED*** CallAssignmentUpdate
...
***REMOVED******REMOVED******REMOVED*** CallAssignmentListResponse
...
***REMOVED******REMOVED******REMOVED*** BulkCallAssignmentCreate
...
***REMOVED******REMOVED******REMOVED*** BulkCallAssignmentResponse
...
***REMOVED******REMOVED*** Call Types

***REMOVED******REMOVED******REMOVED*** Overnight Call

- **Days:** Sunday PM → Monday AM through Thursday PM → Friday AM
- **Type:** `overnight`
- **Description:** Sun-Thu overnight call assignments

***REMOVED******REMOVED******REMOVED*** Weekend Call
...
***REMOVED******REMOVED******REMOVED*** List Call Assignments with Filters
...
***REMOVED******REMOVED******REMOVED*** 403 Forbidden - Insufficient Permissions
...
***REMOVED******REMOVED******REMOVED*** 404 Not Found - Call Assignment Not Found
...
***REMOVED******REMOVED******REMOVED*** 422 Unprocessable Entity - Validation Error
...
***REMOVED******REMOVED******REMOVED*** Call Assignment vs Regular Assignment
...
***REMOVED******REMOVED******REMOVED*** Equity Tracking
