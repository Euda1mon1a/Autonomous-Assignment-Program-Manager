...
***REMOVED******REMOVED******REMOVED*** POST /execute
...
***REMOVED******REMOVED******REMOVED*** POST /validate
...
***REMOVED******REMOVED******REMOVED*** GET /history
...
***REMOVED******REMOVED*** Excel-Based Swap Finder

***REMOVED******REMOVED******REMOVED*** POST /swaps/find (in schedule.py)
...
***REMOVED******REMOVED******REMOVED*** POST /swaps/candidates (in schedule.py)
...
***REMOVED******REMOVED*** Swap Validation Rules

The swap validation system checks multiple constraints:

***REMOVED******REMOVED******REMOVED*** 1. Availability Conflicts
...
***REMOVED******REMOVED******REMOVED*** 2. Back-to-Back Conflicts
...
***REMOVED******REMOVED******REMOVED*** 3. External Conflicts
...
***REMOVED******REMOVED******REMOVED*** 4. Coverage Requirements
...
***REMOVED******REMOVED******REMOVED*** 1. Faculty Initiates Swap Request
...
***REMOVED*** Step 2: Validate the swap before executing
curl -X POST http://localhost:8000/api/swaps/validate \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <ACCESS_TOKEN>" \
  -d '{
...
***REMOVED*** Step 3: Execute if valid
curl -X POST http://localhost:8000/api/swaps/execute \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <ACCESS_TOKEN>" \
  -d '{
...
***REMOVED******REMOVED******REMOVED*** 2. Import Excel Schedule and Find Swaps

```bash
***REMOVED*** From FMIT Excel file
curl -X POST http://localhost:8000/api/schedule/swaps/find \
...
***REMOVED******REMOVED******REMOVED*** 3. View All Swaps for a Faculty
...
- [Schedule API - Swap Finder](SCHEDULE_API.md***REMOVED***excel-based-swap-finder) - Excel-based swap candidate finding
...
- [ADR-006: Swap System with Auto-Matching](../.claude/dontreadme/synthesis/DECISIONS.md***REMOVED***adr-006-swap-system-with-auto-matching) - Swap system design rationale
