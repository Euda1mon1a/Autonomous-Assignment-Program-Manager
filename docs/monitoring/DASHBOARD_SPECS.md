***REMOVED*** Monitoring Dashboard Specifications
...
1. [System Health Dashboard](***REMOVED***system-health-dashboard)
2. [Scheduler Performance Dashboard](***REMOVED***scheduler-performance-dashboard)
3. [ACGME Compliance Dashboard](***REMOVED***acgme-compliance-dashboard)
4. [Resilience Metrics Dashboard](***REMOVED***resilience-metrics-dashboard)
5. [Swap Activity Dashboard](***REMOVED***swap-activity-dashboard)
6. [User Activity Dashboard](***REMOVED***user-activity-dashboard)
7. [Error Tracking Dashboard](***REMOVED***error-tracking-dashboard)
8. [SLA Monitoring Dashboard](***REMOVED***sla-monitoring-dashboard)
9. [Grafana JSON Exports](***REMOVED***grafana-json-exports)

---

***REMOVED******REMOVED*** System Health Dashboard
...
***REMOVED******REMOVED*** Scheduler Performance Dashboard
...
***REMOVED******REMOVED*** ACGME Compliance Dashboard
...
***REMOVED******REMOVED*** Resilience Metrics Dashboard
...
***REMOVED******REMOVED*** Swap Activity Dashboard
...
***REMOVED******REMOVED*** User Activity Dashboard
...
***REMOVED******REMOVED*** Error Tracking Dashboard
...
***REMOVED******REMOVED*** SLA Monitoring Dashboard
...
***REMOVED******REMOVED******REMOVED*** Dashboard JSON Structure
...
***REMOVED******REMOVED******REMOVED*** Key Grafana Features Used
...
***REMOVED******REMOVED******REMOVED*** Prometheus Data Source
...
***REMOVED******REMOVED*** Dashboard Refresh Rates
...
***REMOVED******REMOVED******REMOVED*** Viewing Dashboards
...
***REMOVED******REMOVED******REMOVED*** Customization
