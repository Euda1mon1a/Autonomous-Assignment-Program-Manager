***REMOVED*** Phase 1 Integration Specification: Exotic Modules
...
***REMOVED******REMOVED*** Module 1: Keystone Species Integration
...
***REMOVED******REMOVED******REMOVED*** Files Involved
...
***REMOVED******REMOVED******REMOVED*** Implementation Steps

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Create Integration Adapter
...
class KeystoneIntegration:
    ...
    async def identify_critical_resources(
        ...
        """
        ***REMOVED*** Get all people and rotations
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: Integrate into ResilienceService
...
async def health_check(self, db: Session) -> HealthReport:
    ...
    ***REMOVED*** ... existing checks ...

    ***REMOVED*** NEW: Keystone analysis
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 3: Create API Endpoint
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 4: Test Suite
...
class TestKeystoneIntegration:
    ...
    async def test_identify_keystones(self, db, faculty_with_assignments):
        ...
        ***REMOVED*** Verify keystoneness is computed
    ...
    async def test_cascade_prediction(self, db, faculty_network):
        ...
        ***REMOVED*** Simulate removing a keystone
...
***REMOVED******REMOVED******REMOVED*** Estimated Effort: 2-3 days

---

***REMOVED******REMOVED*** Module 2: Catastrophe Theory Integration
...
class CatastropheIntegration:
    ...
    async def assess_schedule_stability(
        ...
        """
        ***REMOVED*** Extract control parameters
        parameters = CuspParameters(
            a=resilience_metrics.get("stress_level", 0),     ***REMOVED*** Asymmetry
            b=resilience_metrics.get("workload_ratio", 0),   ***REMOVED*** Bias
            x=resilience_metrics.get("morale_index", 0.5),   ***REMOVED*** Behavior
            potential=0.0,
        )

        ***REMOVED*** Check for catastrophe regions
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: Integrate into Schedule Engine
**File**: `backend/app/scheduling/engine.py`

Add to `generate()` method after solver completes (around line 350):

```python
***REMOVED*** NEW: Post-solve catastrophe detection
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 3: Add to Health Report
**File**: `backend/app/resilience/service.py`
...
async def health_check(self, db: Session) -> HealthReport:
    ...
    ***REMOVED*** NEW: Catastrophe assessment
    catastrophe_integration = CatastropheIntegration()
    catastrophe_assessment = await catastrophe_integration.assess_schedule_stability(
...
class TestCatastropheIntegration:
    ...
    async def test_near_bifurcation(self):
        ...
        assessment = await integration.assess_schedule_stability(
            resilience_metrics={
                "stress_level": 0.9,  ***REMOVED*** High stress
                "workload_ratio": 0.95,  ***REMOVED*** Near 100%
                "morale_index": 0.2,  ***REMOVED*** Low morale
            }
        )
...
***REMOVED******REMOVED******REMOVED*** Estimated Effort: 3-5 days

---

***REMOVED******REMOVED*** Module 3: Zeno Governor Enforcement
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1: Create Enforcement Adapter
...
class ZenoEnforcement:
    ...
    async def record_intervention(
        ...
        ***REMOVED*** Record in governor
        self.governor.record_intervention(intervention)

        ***REMOVED*** Check risk level
    ...
    async def get_metrics(self) -> dict:
        ...
        return {
            ...
            "trend": metrics.trend,  ***REMOVED*** "INCREASING", "STABLE", "DECREASING"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2: Integrate into Schedule Edit Routes
...
async def lock_assignment(
    ...
    ***REMOVED*** Proceed with lock (with warning if needed)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 3: Create Dashboard Endpoint
...
class TestZenoEnforcement:
    ...
    async def test_reject_excessive_interventions(self, db):
        ...
        ***REMOVED*** Record many interventions quickly
        for i in range(20):
        ...
        ***REMOVED*** Should now be rejected
        allowed, warning = await enforcement.check_intervention_allowed()
...
***REMOVED******REMOVED******REMOVED*** Estimated Effort: 5-7 days
...
***REMOVED******REMOVED******REMOVED*** Stress Tests
...
***REMOVED******REMOVED*** Rollout Plan

***REMOVED******REMOVED******REMOVED*** Week 1-2: Development
- Implement all three modules
- Write comprehensive tests
- Internal code review

***REMOVED******REMOVED******REMOVED*** Week 3: Testing
- Run integration tests
- Stress testing
- Load testing
- Documentation review

***REMOVED******REMOVED******REMOVED*** Week 4: Deployment
- Deploy to staging
- 1-week monitoring
...
***REMOVED******REMOVED*** Contingency Plans
