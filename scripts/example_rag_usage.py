    ...
    try:
        ...
        ***REMOVED*** Ingest the document
        result = await rag_service.ingest_document(
            ...
            chunk_size=200,  ***REMOVED*** Smaller chunks for this example
            chunk_overlap=20,
        )
...
async def example_3_semantic_search():
    ...
    try:
        ...
        ***REMOVED*** Search for documents about work hours
...
async def example_4_build_context():
    ...
    try:
        ...
        ***REMOVED*** Build context for a query
...
async def example_6_celery_tasks():
    ...
    try:
        ...
        logger.info("\nExample usage:")
        logger.info("""
        ***REMOVED*** Initialize all embeddings
...
async def main():
    ...
    try:
        ***REMOVED*** Run examples in sequence
