...
Usage:
    ***REMOVED*** Fetch from Airtable and save to JSON
    python scripts/airtable_sync.py fetch

    ***REMOVED*** Import from JSON to database
    python scripts/airtable_sync.py import

    ***REMOVED*** Both in one step
...
***REMOVED*** Output directory (gitignored)
...
def import_people(token: str):
    ...
    ***REMOVED*** Import residents
    ...
    for record in residents:
        ...
        last_name = fields.get("Resident", "")  ***REMOVED*** Last name is in "Resident" field
        ...
        person_data = {
            ...
            "pgy_level": pgy,
            "email": email,
            "external_id": airtable_id,  ***REMOVED*** Store Airtable ID for linking
        }
    ...
    ***REMOVED*** Import faculty
    ...
    for record in faculty:
        ...
        ***REMOVED*** Map faculty type to role (adjunct not in enum, use core)
        role = "core"
        ***REMOVED*** Valid roles: pd, apd, oic, dept_chief, sports_med, core

        ***REMOVED*** Generate placeholder email if missing (use example.com per RFC 2606)
        if not email:
...
def import_rotation_templates(token: str):
    ...
    for record in templates:
        ...
        ***REMOVED*** Generate abbreviation from name
        ***REMOVED*** e.g., "Inpatient Attending AM" -> "INA-AM"
        ***REMOVED*** e.g., "Clinic PM" -> "CLI-PM"
        ...
        ***REMOVED*** Determine activity type from name
        activity_type = "outpatient"  ***REMOVED*** default
        ...
        ***REMOVED*** Determine days of week
        days = []
        ...
        template_data = {
            ...
            "external_id": airtable_id,
            ***REMOVED*** "days_of_week": days,  ***REMOVED*** If schema supports it
        }
