...
***REMOVED*** Rotation templates by activity type
TEMPLATES = {
    "inpatient": [
        ***REMOVED*** FMIT variants
        ("FMIT AM", "FMIT-AM"),
        ("FMIT PM", "FMIT-PM"),
        ...
        ***REMOVED*** Other inpatient
        ("Internal Medicine Intern", "IM-INT"),
        ("Pediatrics Ward Intern", "PEDS-W"),
        ("Newborn Nursery", "NBN"),
    ],
    "off": [
        ***REMOVED*** Off-site rotations (different hospitals)
        ("Hilo", "HILO"),
        ("Kapiolani", "KAPI"),
        ("Okinawa", "OKI"),
        ("OFF AM", "OFF-AM"),
    ...
    "education": [
        ***REMOVED*** Orientation and education
    ...
    "outpatient": [
        ***REMOVED*** Clinic rotations (solver handles these)
        ("Clinic AM", "CLI-AM"),
        ("Clinic PM", "CLI-PM"),
