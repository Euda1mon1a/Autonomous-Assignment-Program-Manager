...
***REMOVED*** Read credentials from environment (allows override without editing code)
...
***REMOVED*** Faculty (10) - without "Dr." in email
print("\n=== Creating Faculty ===")
faculty_data = [
...
***REMOVED*** No screeners for now - API only supports resident/faculty types
...
def main():
    ...
    ***REMOVED*** ==================== FACULTY (12) ====================
    ...
    faculty = [
        ...
        {"name": "FAC-CORE-04", "role": "core"},  ***REMOVED*** Example: excluded from assignments
