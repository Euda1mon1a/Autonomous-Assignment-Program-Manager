...
LAST_NAMES = [
    ...
    "Miller", "Davis", "Rodriguez", "Martinez", "PGY3-D-Last", "Lopez",
...
def generate_people(
    ...
    ***REMOVED*** Generate residents (6 per PGY level)
    for pgy in [1, 2, 3]:
    ...
    ***REMOVED*** Generate faculty with various roles
    faculty_roles = [
        FacultyRole.PD,
        FacultyRole.APD,
        FacultyRole.OIC,
        ...
        try:
            ***REMOVED*** Clear existing data if requested
            if args.clear_first:
                ...
                ***REMOVED*** This would need proper implementation to avoid foreign key issues
                print("  ⚠ Clear functionality not yet implemented")

            ***REMOVED*** Generate data
