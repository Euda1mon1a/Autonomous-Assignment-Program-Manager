...
***REMOVED*** Your actual rotations from Airtable - POPULATE THIS
***REMOVED*** Key fields: name, activity_type, abbreviation, leave_eligible
***REMOVED*** Half-day patterns: outpatient=10/week (3 FM clinic), inpatient/FMIT=14/week
ROTATIONS = [
    ***REMOVED*** ========== INPATIENT (14 half-days/week, no call, leave NOT eligible) ==========
    {
        "name": "FMIT",
    ...
    ***REMOVED*** ========== NIGHT FLOAT (Special 2-week patterns) ==========
    {
        "name": "Night Float",
    ...
    ***REMOVED*** ========== OUTPATIENT (10 half-days/week, 3/10 = FM Clinic) ==========
    {
