...
FEATURE_FLAGS = [
    {
        ...
        "flag_type": "boolean",
        "enabled": True,
        ***REMOVED*** Only allow these roles to access marketplace (excludes 'resident')
        "target_roles": ["admin", "coordinator", "faculty"],
        "environments": None,  ***REMOVED*** All environments
...
def main():
    ...
    ***REMOVED*** Print usage instructions
