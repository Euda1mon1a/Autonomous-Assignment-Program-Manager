...
Usage:
    ***REMOVED*** Generate blocks for Block 10 (March 10 - April 6, 2026)
    python scripts/generate_blocks.py --start 2026-03-10 --end 2026-04-06 --block-number 10

    ***REMOVED*** Generate full academic year 2025-2026 (starts July 1, 2025)
    python scripts/generate_blocks.py --academic-year 2025

    ***REMOVED*** Dry run to see what would be created
...
***REMOVED*** Add backend to Python path
...
def calculate_block_dates(block_number: int, academic_year_start: date) -> tuple[date, date]:
    ...
    """
    ***REMOVED*** Blocks start on first Thursday of the academic year
    ...
    if (
        ...
        ***REMOVED*** Extend the final block to include the last day of the academic year.
...
def generate_blocks(
    ...
    try:
        ...
        while current <= end_date:
            is_weekend = current.weekday() >= 5  ***REMOVED*** Saturday = 5, Sunday = 6

            for tod in ["AM", "PM"]:
                ***REMOVED*** Check if block already exists
...
def generate_academic_year(
    ...
    for block_num in range(1, 14):  ***REMOVED*** Blocks 1-13
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  ***REMOVED*** Generate a single block period
  python scripts/generate_blocks.py --start 2026-03-10 --end 2026-04-06 --block-number 10

  ***REMOVED*** Generate full academic year 2025-2026
  python scripts/generate_blocks.py --academic-year 2025
