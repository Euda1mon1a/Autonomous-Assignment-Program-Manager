...
class ScheduleVerifier:
    ...
    def _add_result(self, name: str, passed: bool, details: str, data: Any = None):
        ...
        ***REMOVED*** Print immediately for visibility
    ...
    ***REMOVED*** =========================================================================
    ...
    def _check_post_fmit_sunday_blocking(self, block_num: int, start_date: date, end_date: date):
        ...
        ***REMOVED*** This would need the PostFMITSundayBlockingConstraint logic
        ***REMOVED*** For now, mark as manual check
    ...
    def _check_weekend_coverage(self, block_num: int, start_date: date, end_date: date):
        ...
        ***REMOVED*** Calculate expected weekend days
        current = start_date
        expected_weekends = 0
        while current <= end_date:
            if current.weekday() in [5, 6]:  ***REMOVED*** Saturday=5, Sunday=6
                expected_weekends += 1
    ...
    def generate_report(self, block_num: int, start_date: date, end_date: date) -> str:
        ...
        report = f"""***REMOVED*** Schedule Verification Report
...
"""
        ...
        if failed > 0:
            report += "\n***REMOVED******REMOVED*** Failed Checks - Details\n\n"
            for r in self.results:
                if not r.passed and r.data:
                    report += f"***REMOVED******REMOVED******REMOVED*** {r.name}\n\n"
...
def main():
    ...
    ***REMOVED*** Try to get DB URL from environment if not provided
    db_url = args.db_url
    if not db_url:
        import os
    ...
    ***REMOVED*** Generate and print summary
    print("\n" + "="*70)
    print("  SUMMARY")
    print("="*70)
    ...
    ***REMOVED*** Generate and save report
    ...
    ***REMOVED*** Exit with error if any checks failed
