...
***REMOVED*** Base path for knowledge documents
...
class EmbeddingInitializer:
    ...
    async def process_document(
        ...
        try:
            ...
            ***REMOVED*** Clear existing documents of this type (idempotent)
    ...
    async def process_all_documents(
        ...
        """
        ***REMOVED*** Get all markdown files
        if doc_filter:
...
async def main(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        return 130  ***REMOVED*** Standard exit code for SIGINT
    except Exception as e:
