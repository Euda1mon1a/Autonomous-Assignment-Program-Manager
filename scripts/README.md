...
***REMOVED******REMOVED*** Verification Scripts

***REMOVED******REMOVED******REMOVED*** verify_schedule.py
...
***REMOVED******REMOVED******REMOVED*** verify_constraints.py
