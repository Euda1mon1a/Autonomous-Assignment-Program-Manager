...
***REMOVED******REMOVED******REMOVED******REMOVED*** Models (`app/models/`)
Define database table schemas using SQLAlchemy ORM.

```python
***REMOVED*** app/models/person.py
class Person(Base):
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Repositories (`app/repositories/`)
Pure database operations. No business logic - just CRUD and queries.

```python
***REMOVED*** app/repositories/person_repository.py
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Services (`app/services/`)
Business logic layer. Uses repositories as building blocks to implement domain rules.

```python
***REMOVED*** app/services/schedule_service.py
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Routers (`app/api/routes/`)
Map URL paths to controller methods. Minimal logic here.

```python
***REMOVED*** app/api/routes/schedule.py
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Schemas (`app/schemas/`)
Pydantic models for request/response validation. Separate from database models.

```python
***REMOVED*** app/schemas/schedule.py
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Middleware (`app/middleware/`)
Functions applied to every request. Good for cross-cutting concerns.

```python
***REMOVED*** app/middleware/auth.py
...
***REMOVED******REMOVED******REMOVED*** Domain-Specific Modules
...
***REMOVED******REMOVED*** Frontend Architecture (Next.js + React)
...
***REMOVED******REMOVED*** Request Lifecycle Example
...
***REMOVED******REMOVED*** Adding New Features
