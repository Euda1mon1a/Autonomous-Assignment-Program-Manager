...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Daily Manifest ("Where is Everyone NOW")
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Call Roster (Filtered Calendar)
...
***REMOVED*** Existing endpoint, just needs frontend filter + color coding:
***REMOVED*** Red = Attending, Blue = Senior, Green = Intern
```

***REMOVED******REMOVED******REMOVED******REMOVED*** 3. My Life Dashboard (Personal Feed)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Role-Based Views (RN/LPN/MSA)
