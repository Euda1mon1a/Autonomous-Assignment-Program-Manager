...
<p align="center">
  ...
  <a href="***REMOVED***ai-assisted-development">AI Development</a> •
...
***REMOVED******REMOVED*** What's New (December 2025)

***REMOVED******REMOVED******REMOVED*** Major Additions
...
***REMOVED******REMOVED******REMOVED*** Recent Changes (427 commits since Dec 18)
...
***REMOVED******REMOVED******REMOVED*** Solver Operational Controls
...
***REMOVED******REMOVED******REMOVED*** Block Schedule Import/Export
...
***REMOVED******REMOVED*** AI-Assisted Development

***REMOVED******REMOVED******REMOVED*** Personal AI Infrastructure (PAI)
...
***REMOVED******REMOVED******REMOVED*** Slash Commands (27 Available)
...
***REMOVED******REMOVED******REMOVED*** Agent Skills (34 Available)
...
***REMOVED******REMOVED******REMOVED*** MCP Server (34 Tools)
...
│   │   │   ├── solver_control.py    ***REMOVED*** Kill-switch & progress monitoring
│   │   │   ├── profiler.py          ***REMOVED*** Performance instrumentation
│   │   │   └── constraints/         ***REMOVED*** Constraint system
...
│   ├── Dockerfile
│   └── package.json
├── mcp-server/                  ***REMOVED*** MCP Server (AI Integration)
│   └── src/scheduler_mcp/       ***REMOVED*** 34 scheduling tools
├── .claude/                     ***REMOVED*** AI Infrastructure (PAI)
│   ├── commands/                ***REMOVED*** 27 slash commands
│   ├── skills/                  ***REMOVED*** 34 agent skills
│   ├── Agents/                  ***REMOVED*** Agent personas (ORCHESTRATOR, etc.)
│   ├── PromptTemplates/         ***REMOVED*** Reusable workflow templates
│   └── Methodologies/           ***REMOVED*** Decision frameworks
├── docs/                        ***REMOVED*** Project documentation
│   ├── architecture/            ***REMOVED*** System design
│   │   └── bridges/             ***REMOVED*** Cross-disciplinary integrations
│   ├── specs/                   ***REMOVED*** Service specifications
│   ├── research/                ***REMOVED*** Advanced research topics
│   └── schedules/               ***REMOVED*** Sanitized test data
├── scripts/                     ***REMOVED*** CLI tools & utilities
├── docker-compose.yml           ***REMOVED*** Production configuration
├── docker-compose.dev.yml       ***REMOVED*** Development configuration
├── docker-compose.prod.yml      ***REMOVED*** Security-hardened production
└── README.md
```
...
***REMOVED******REMOVED******REMOVED*** AI-Assisted Development
| Document | Description |
|----------|-------------|
...
***REMOVED******REMOVED******REMOVED*** Advanced Architecture
| Document | Description |
|----------|-------------|
...
***REMOVED******REMOVED******REMOVED*** Research & Innovation
| Document | Description |
|----------|-------------|
