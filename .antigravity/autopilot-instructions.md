***REMOVED*** Antigravity Autopilot Instructions
...
***REMOVED******REMOVED*** Operating Principles

***REMOVED******REMOVED******REMOVED*** 1. Read Before Write
- **ALWAYS** read a file before editing it
- Understand the existing patterns before making changes
- Check imports, dependencies, and related files

***REMOVED******REMOVED******REMOVED*** 2. Minimal Changes
...
***REMOVED******REMOVED******REMOVED*** 3. Validate Continuously
- Run tests after every significant change
- Check linting before committing
- Verify the fix actually works

***REMOVED******REMOVED******REMOVED*** 4. Fail Fast, Recover Smart
...
***REMOVED******REMOVED*** Standard Workflows

***REMOVED******REMOVED******REMOVED*** When Fixing Bugs
...
***REMOVED******REMOVED******REMOVED*** When Adding Features
...
***REMOVED******REMOVED******REMOVED*** When Exploring/Researching
...
***REMOVED******REMOVED*** Project-Specific Context
...
***REMOVED******REMOVED******REMOVED*** Critical Areas (Extra Caution)
...
***REMOVED******REMOVED*** Communication Protocol

***REMOVED******REMOVED******REMOVED*** Progress Updates
...
***REMOVED******REMOVED*** Tool Usage

***REMOVED******REMOVED******REMOVED*** Preferred Tools
...
***REMOVED******REMOVED******REMOVED*** Skills Auto-Activation
...
***REMOVED******REMOVED******REMOVED*** Common Errors and Responses
...
***REMOVED******REMOVED******REMOVED*** Recovery Priority
...
***REMOVED******REMOVED******REMOVED*** Speed vs Quality Trade-off
...
***REMOVED******REMOVED******REMOVED*** Resource Awareness
