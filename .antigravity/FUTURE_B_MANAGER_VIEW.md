***REMOVED*** Manager View Configuration (FUTURE - NOT ACTIVATED)
...
***REMOVED******REMOVED*** What Manager View Enables
...
***REMOVED******REMOVED******REMOVED*** From Autopilot (A):
...
***REMOVED******REMOVED*** Planned Configuration
