***REMOVED*** Antigravity Recovery Procedures
...
***REMOVED******REMOVED*** Recovery Hierarchy

When something goes wrong, follow this priority order:

***REMOVED******REMOVED******REMOVED*** Level 1: Immediate Rollback
...
***REMOVED******REMOVED******REMOVED*** Level 2: Stash and Reset
...
***REMOVED******REMOVED******REMOVED*** Level 3: Full Session Reset
...
***REMOVED******REMOVED******REMOVED*** Level 4: Human Required
...
***REMOVED******REMOVED*** Common Failure Patterns

***REMOVED******REMOVED******REMOVED*** Pattern: Test Passes Locally, Fails in CI
...
***REMOVED******REMOVED******REMOVED*** Pattern: Import Errors After Edit
...
***REMOVED******REMOVED******REMOVED*** Pattern: Docker File Sync Issues
...
***REMOVED******REMOVED******REMOVED*** Pattern: Migration Chain Broken
...
***REMOVED******REMOVED******REMOVED*** Pattern: Type Checker vs Runtime Mismatch
...
***REMOVED******REMOVED*** Recovery Checkpoints

Before major operations, create checkpoint:

```bash
***REMOVED*** Create named checkpoint
git stash push -m "checkpoint-before-<operation>"

***REMOVED*** Or create lightweight tag
git tag -a "checkpoint-$(date +%Y%m%d-%H%M%S)" -m "Before <operation>"
```

***REMOVED******REMOVED******REMOVED*** When to Checkpoint
...
***REMOVED******REMOVED*** Rollback Commands

***REMOVED******REMOVED******REMOVED*** Single File
```bash
git checkout -- <file>
```

***REMOVED******REMOVED******REMOVED*** Multiple Files (keep in staging)
```bash
git checkout HEAD -- <file1> <file2>
```

***REMOVED******REMOVED******REMOVED*** Everything Since Last Commit
```bash
git checkout -- .
```

***REMOVED******REMOVED******REMOVED*** Undo Last Commit (keep changes)
```bash
git reset --soft HEAD~1
```

***REMOVED******REMOVED******REMOVED*** Full Hard Reset (DESTRUCTIVE - use with caution)
```bash
git reset --hard HEAD
```
...
***REMOVED******REMOVED*** Recovery Logging
...
***REMOVED******REMOVED*** Post-Recovery Verification
...
***REMOVED******REMOVED*** Recovery Metrics
