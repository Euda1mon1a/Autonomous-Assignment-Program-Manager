***REMOVED*** Backend Error Handling Standards
***REMOVED******REMOVED*** SESSION 8 BURN: Standardized Exception Hierarchy & Response Patterns
...
***REMOVED******REMOVED*** SECTION 1: EXCEPTION HIERARCHY STANDARDIZATION

***REMOVED******REMOVED******REMOVED*** Recommended Exception Structure

```python
***REMOVED*** backend/app/core/exceptions.py (EXTENDED)
...
***REMOVED*** Domain-Specific Exception Classes
...
***REMOVED******REMOVED*** SECTION 2: ERROR RESPONSE PATTERNS

***REMOVED******REMOVED******REMOVED*** Pattern 1: Standard Error Response

**Usage:** Most API endpoints

```python
***REMOVED*** Response format (RFC 7807)
{
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Validation Error Response (Multiple Fields)
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: ACGME Compliance Error Response
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Batch Operation Error Response
...
***REMOVED******REMOVED*** SECTION 3: SERVICE-LEVEL ERROR HANDLING

***REMOVED******REMOVED******REMOVED*** Pattern A: Service Returns Result Dict
...
***REMOVED******REMOVED******REMOVED*** Pattern B: Service Raises Exception (Recommended)
...
***REMOVED*** Service method (improved)
...
***REMOVED*** Controller handler (improved)
def create_assignment(self, assignment_in: AssignmentCreate) -> dict:
    result = self.service.create_assignment(...)
...
***REMOVED******REMOVED*** SECTION 4: ERROR CODE STANDARDIZATION

***REMOVED******REMOVED******REMOVED*** Error Code Categories

```python
***REMOVED*** backend/app/core/error_codes.py (EXTENDED)
...
class ErrorCode(str, Enum):
    ...
    ***REMOVED*** Resource Errors (4xx client errors)
    NOT_FOUND = "NOT_FOUND"
    ALREADY_EXISTS = "ALREADY_EXISTS"
    DUPLICATE_RECORD = "DUPLICATE_RECORD"

    ***REMOVED*** Validation Errors (422)
    VALIDATION_ERROR = "VALIDATION_ERROR"
    INVALID_FORMAT = "INVALID_FORMAT"
    REQUIRED_FIELD_MISSING = "REQUIRED_FIELD_MISSING"

    ***REMOVED*** Authentication/Authorization (401/403)
    UNAUTHORIZED = "UNAUTHORIZED"
    FORBIDDEN = "FORBIDDEN"
    INVALID_CREDENTIALS = "INVALID_CREDENTIALS"
    TOKEN_EXPIRED = "TOKEN_EXPIRED"

    ***REMOVED*** Business Logic (409)
    CONFLICT = "CONFLICT"
    SCHEDULE_CONFLICT = "SCHEDULE_CONFLICT"
    INVALID_STATE_TRANSITION = "INVALID_STATE_TRANSITION"

    ***REMOVED*** ACGME Compliance (409)
    ...
    ***REMOVED*** Database (5xx server errors)
    DATABASE_ERROR = "DATABASE_ERROR"
    DATABASE_CONNECTION_ERROR = "DATABASE_CONNECTION_ERROR"
    TRANSACTION_ERROR = "TRANSACTION_ERROR"

    ***REMOVED*** External Services (5xx)
    EXTERNAL_SERVICE_ERROR = "EXTERNAL_SERVICE_ERROR"
    EMAIL_SERVICE_ERROR = "EMAIL_SERVICE_ERROR"
    SERVICE_UNAVAILABLE = "SERVICE_UNAVAILABLE"

    ***REMOVED*** Rate Limiting (429)
...
***REMOVED*** Mapping to HTTP status codes
...
***REMOVED*** Human-readable descriptions
...
***REMOVED******REMOVED*** SECTION 5: MIDDLEWARE CONFIGURATION

***REMOVED******REMOVED******REMOVED*** Global Error Handler Middleware

```python
***REMOVED*** backend/app/middleware/error_handler.py
...
class ErrorHandlerMiddleware:
    ...
    async def __call__(self, request: Request, call_next):
        try:
            ...
            ***REMOVED*** Pydantic validation errors
            return await self._handle_validation_error(request, exc)

        except AppException as exc:
            ***REMOVED*** Custom application exceptions
    ...
    async def _handle_app_exception(
        ...
        return JSONResponse(
            status_code=exc.status_code,
            content={
                "type": f"about:blank***REMOVED***{exc.error_code.lower()}",
    ...
    async def _handle_internal_error(
        ...
        ***REMOVED*** Return generic message to client (don't leak details)
        return JSONResponse(
            status_code=500,
            content={
                "type": "about:blank***REMOVED***internal_error",
...
***REMOVED******REMOVED******REMOVED*** Registering Middleware
...
***REMOVED*** Register error handler AFTER other middleware
app.add_middleware(ErrorHandlerMiddleware)
```

---

***REMOVED******REMOVED*** SECTION 6: SERVICE ERROR HANDLING CHECKLIST

***REMOVED******REMOVED******REMOVED*** Checklist for Every Service Method

```python
***REMOVED*** Template: service_method_error_handling.py
...
class TestAssignmentServiceErrors:
    ...
    def test_error_response_format(self, client):
        ...
        ***REMOVED*** [ ] RFC 7807 fields present
        assert "type" in body
        assert "title" in body
        assert "status" in body
        assert "detail" in body

        ***REMOVED*** [ ] Custom fields present
...
***REMOVED******REMOVED*** SECTION 8: PII/SENSITIVE DATA PROTECTION

***REMOVED******REMOVED******REMOVED*** Sensitive Fields That Must Be Redacted
...
***REMOVED*** Usage in exception handler
def _handle_app_exception(self, request, exc):
    ***REMOVED*** Sanitize error detail before sending to client
...
***REMOVED******REMOVED*** SECTION 9: MIGRATION GUIDE

***REMOVED******REMOVED******REMOVED*** Step 1: Add New Exception Base

```python
***REMOVED*** Add to backend/app/core/exceptions.py
from dataclasses import dataclass
...
***REMOVED******REMOVED******REMOVED*** Step 2: Update Service Layer (Gradual)
...
***REMOVED******REMOVED******REMOVED*** Step 3: Update Controllers
...
***REMOVED******REMOVED*** SECTION 10: SUMMARY CHECKLIST
