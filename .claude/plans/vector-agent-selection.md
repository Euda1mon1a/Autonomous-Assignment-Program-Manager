***REMOVED*** Plan: Vector-Based Agent Model Selection
...
***REMOVED******REMOVED*** Proposed Solution: pgvector + Embeddings

***REMOVED******REMOVED******REMOVED*** Why pgvector?
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Foundation (This Session)

**Goal:** Get pgvector installed and basic schema created.

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1.1: Enable pgvector Extension
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1.2: Create Alembic Migration

Create migration for:
```python
***REMOVED*** model_tiers table - Static lookup for default model assignments
class ModelTier(Base):
    __tablename__ = "model_tiers"

    agent_name = Column(String, primary_key=True)  ***REMOVED*** e.g., "QA_TESTER"
    default_model = Column(String, nullable=False)  ***REMOVED*** "haiku", "sonnet", "opus"
    updated_at = Column(DateTime, server_default=func.now(), onupdate=func.now())
    notes = Column(Text, nullable=True)  ***REMOVED*** Why this model?

***REMOVED*** task_history table - Learning from past spawns
class TaskHistory(Base):
    ...
    ***REMOVED*** Task info
    ...
    task_embedding = Column(Vector(1536), nullable=True)  ***REMOVED*** OpenAI ada-002 dimension

    ***REMOVED*** Execution info
    agent_used = Column(String, nullable=False)
    model_used = Column(String, nullable=False)  ***REMOVED*** "haiku", "sonnet", "opus"
...
***REMOVED*** agent_embeddings table - Pre-computed embeddings of agent specs
class AgentEmbedding(Base):
    ...
    spec_hash = Column(String, nullable=False)  ***REMOVED*** SHA256 of spec content
    updated_at = Column(DateTime, server_default=func.now())
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 1.3: Seed Model Tiers
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Embedding Infrastructure (Next Session)

**Goal:** Generate and store embeddings.

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2.1: Embedding Provider Selection
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 2.2: Embed All Agent Specs
...
async def embed_agent_specs():
    ...
    for agent_file in glob(".claude/Agents/*.md"):
        ...
        agent_name = agent_file.stem  ***REMOVED*** e.g., "QA_TESTER"
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Retrieval & Matching (Future Session)

**Goal:** Intelligent model selection based on similarity.

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 3.1: Similarity Query
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 3.2: Model Recommendation Logic
...
def recommend_model(similar_tasks: list[TaskHistory]) -> str:
    ...
    """
    ***REMOVED*** Group by model, weighted by similarity
    ...
    ***REMOVED*** Prefer cheaper models when scores are close
    ...
    for model, score in model_scores.items():
        value = score / MODEL_COST[model]  ***REMOVED*** Score per dollar
        if value > best_value:
            best_value = value
            best_model = model

    return best_model or "sonnet"  ***REMOVED*** Default to balanced
```

***REMOVED******REMOVED******REMOVED*** Phase 4: Agent Pruning & Evolution (Future)

**Goal:** Remove unused agents, split overloaded ones.

***REMOVED******REMOVED******REMOVED******REMOVED*** Step 4.1: Usage Analytics
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Step 4.2: Capability Gap Detection
...
def find_capability_gaps():
    ...
    return orphan_tasks  ***REMOVED*** Consider creating new agents for these
```

---

***REMOVED******REMOVED*** Files to Create/Modify
...
```python
***REMOVED*** backend/tests/unit/test_agent_recommender.py
...
def test_recommend_model_weights_by_similarity():
    ...
    ***REMOVED*** Opus should win despite cost due to much higher similarity
...
```python
***REMOVED*** backend/tests/integration/test_pgvector.py
...
***REMOVED******REMOVED*** Immediate Next Steps (This Session)
