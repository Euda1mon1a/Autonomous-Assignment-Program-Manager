...
***REMOVED******REMOVED*** The Ten Planning Probes (Framings)
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Intel Receipt

PLAN_PARTY receives reconnaissance from G2_RECON:

```markdown
***REMOVED******REMOVED*** Planning Mission
...
timeout = 90000  ***REMOVED*** 90 seconds (longer than recon - planning is harder)
...
```markdown
***REMOVED******REMOVED*** Plan Proposal: [PROBE_NAME]

***REMOVED******REMOVED******REMOVED*** Strategy Summary
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Cross-Reference (Signal Amplification)
...
```markdown
***REMOVED******REMOVED******REMOVED*** Convergence Matrix
...
***REMOVED******REMOVED******REMOVED*** Phase 5: Strategy Selection
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Phase 2: [Name] (Sequential - depends on Phase 1)
...
***REMOVED******REMOVED******REMOVED*** Disagreements for User Decision
...
***REMOVED******REMOVED*** When to Use PLAN_PARTY
...
def use_plan_party(task: Task, intel: IntelBrief) -> bool:
    ...
    PLAN_PARTY_TRIGGERS = [
        task.complexity_score > 10,  ***REMOVED*** From ORCHESTRATOR rubric
    ...
    SKIP_PLANNING = [
        ...
        task.priority == "P0",  ***REMOVED*** Emergency, just fix it
...
***REMOVED******REMOVED*** TodoWrite Integration

When PLAN_PARTY produces an execution plan, translate to TodoWrite format:

```python
***REMOVED*** From PLAN_PARTY output to TodoWrite
...
Example output:
```
***REMOVED******REMOVED*** Tasks (from PLAN_PARTY)

***REMOVED******REMOVED******REMOVED*** Phase 1: Schema Design (Parallel)
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Implementation (Sequential, after Phase 1)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Validation (Parallel, after Phase 2)
...
***REMOVED******REMOVED*** PLAN_COORDINATOR Agent (Proposed)

***REMOVED******REMOVED******REMOVED*** Charter
...
***REMOVED******REMOVED******REMOVED*** Authority
...
***REMOVED******REMOVED******REMOVED*** Integration Options
