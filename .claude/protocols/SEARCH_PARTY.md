...
***REMOVED******REMOVED*** The Ten Probes (Lenses)
...
***REMOVED******REMOVED******REMOVED*** Probe Characteristics

***REMOVED******REMOVED******REMOVED******REMOVED*** PERCEPTION Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** INVESTIGATION Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ARCANA Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** HISTORY Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** INSIGHT Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** RELIGION Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** NATURE Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** MEDICINE Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** SURVIVAL Probe
...
***REMOVED******REMOVED******REMOVED******REMOVED*** STEALTH Probe
...
***REMOVED******REMOVED*** Protocol Flow

***REMOVED******REMOVED******REMOVED*** Phase 1: Mission Receipt

G2_RECON receives reconnaissance mission from ORCHESTRATOR:

```markdown
***REMOVED******REMOVED*** Reconnaissance Mission
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Party Deployment

G2_RECON spawns all 10 probes **IN PARALLEL** with identical timeout:

```python
***REMOVED*** Pseudocode - spawn all 10 with same timeout
timeout = 60000  ***REMOVED*** 60 seconds
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Collection

Gather findings from all probes. Structure:

```markdown
***REMOVED******REMOVED*** Probe Findings: [PROBE_NAME]

***REMOVED******REMOVED******REMOVED*** Observations
- [Finding 1]
- [Finding 2]
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Cross-Reference
...
```markdown
***REMOVED******REMOVED******REMOVED*** Discrepancy Detected
...
***REMOVED******REMOVED******REMOVED*** Phase 5: Gap Analysis
...
***REMOVED******REMOVED******REMOVED*** Phase 6: Synthesis

Deliver context-dense intel brief to ORCHESTRATOR:

```markdown
***REMOVED******REMOVED*** G2_RECON Intel Brief

***REMOVED******REMOVED******REMOVED*** Mission: [What was asked]

***REMOVED******REMOVED******REMOVED*** Surface State (PERCEPTION)
- [Key findings from perception probe]
- [Current observable state]

***REMOVED******REMOVED******REMOVED*** Connection Analysis (INVESTIGATION)
- [Dependency findings]
- [Data flow analysis]
- [Coupling assessment]

***REMOVED******REMOVED******REMOVED*** Domain Implications (ARCANA)
- [ACGME compliance status]
- [Resilience framework alignment]
- [Security considerations]

***REMOVED******REMOVED******REMOVED*** Recent Changes (HISTORY)
- [Relevant git history]
- [Who changed what when]
- [Migration status]

***REMOVED******REMOVED******REMOVED*** Design Context (INSIGHT)
- [Architectural intent]
- [Technical debt observations]
- [Design pattern assessment]

***REMOVED******REMOVED******REMOVED*** Doctrine Compliance (RELIGION)
- [CLAUDE.md adherence status]
- [Pattern heresies identified]
- [Ritual compliance (PR, CI, reviews)]

***REMOVED******REMOVED******REMOVED*** Ecosystem Health (NATURE)
- [Organic vs forced growth patterns]
- [Over-engineering indicators]
- [Natural boundaries assessment]

***REMOVED******REMOVED******REMOVED*** System Vitals (MEDICINE)
- [Resource health status]
- [Performance bottleneck locations]
- [Sick components identified]

***REMOVED******REMOVED******REMOVED*** Resilience Assessment (SURVIVAL)
- [Edge case coverage]
- [Failure mode mapping]
- [Chaos engineering opportunities]

***REMOVED******REMOVED******REMOVED*** Hidden Elements (STEALTH)
- [Hidden dependencies discovered]
- [Security blind spots]
- [Invisible coupling revealed]

***REMOVED******REMOVED******REMOVED*** Discrepancies Detected
...
***REMOVED******REMOVED*** Probe Prompt Templates

***REMOVED******REMOVED******REMOVED*** PERCEPTION Probe Prompt

```markdown
***REMOVED******REMOVED*** PERCEPTION Probe
...
***REMOVED******REMOVED******REMOVED*** INVESTIGATION Probe Prompt

```markdown
***REMOVED******REMOVED*** INVESTIGATION Probe
...
***REMOVED******REMOVED******REMOVED*** ARCANA Probe Prompt

```markdown
***REMOVED******REMOVED*** ARCANA Probe
...
***REMOVED******REMOVED******REMOVED*** HISTORY Probe Prompt

```markdown
***REMOVED******REMOVED*** HISTORY Probe
...
***REMOVED******REMOVED******REMOVED*** INSIGHT Probe Prompt

```markdown
***REMOVED******REMOVED*** INSIGHT Probe
...
***REMOVED******REMOVED******REMOVED*** RELIGION Probe Prompt

```markdown
***REMOVED******REMOVED*** RELIGION Probe
...
***REMOVED******REMOVED******REMOVED*** NATURE Probe Prompt

```markdown
***REMOVED******REMOVED*** NATURE Probe
...
***REMOVED******REMOVED******REMOVED*** MEDICINE Probe Prompt

```markdown
***REMOVED******REMOVED*** MEDICINE Probe
...
***REMOVED******REMOVED******REMOVED*** SURVIVAL Probe Prompt

```markdown
***REMOVED******REMOVED*** SURVIVAL Probe
...
***REMOVED******REMOVED******REMOVED*** STEALTH Probe Prompt

```markdown
***REMOVED******REMOVED*** STEALTH Probe
...
```markdown
***REMOVED*** In G2_RECON workflows:

***REMOVED******REMOVED*** Pre-Task Reconnaissance
...
***REMOVED******REMOVED******REMOVED*** ORCHESTRATOR Integration

ORCHESTRATOR can request SEARCH_PARTY directly:

```markdown
***REMOVED******REMOVED*** Request to G2_RECON
...
***REMOVED******REMOVED******REMOVED*** Result Integration
...
***REMOVED******REMOVED*** When to Use SEARCH_PARTY

***REMOVED******REMOVED******REMOVED*** Good Candidates
...
***REMOVED******REMOVED******REMOVED*** Poor Candidates
...
***REMOVED******REMOVED*** Related Agents
