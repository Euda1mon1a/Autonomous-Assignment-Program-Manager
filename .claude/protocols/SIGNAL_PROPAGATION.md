***REMOVED*** Signal Propagation Protocol
...
***REMOVED******REMOVED*** Signal Structure
...
***REMOVED******REMOVED*** Propagation Rules

***REMOVED******REMOVED******REMOVED*** Rule 1: ORCHESTRATOR Routes All Signals
...
***REMOVED******REMOVED******REMOVED*** Rule 2: BLOCKED Triggers Investigation
...
***REMOVED******REMOVED******REMOVED*** Rule 3: CONFLICT_DETECTED Serializes
...
***REMOVED******REMOVED******REMOVED*** Rule 4: INTEGRATION_REQUIRED Synchronizes
...
***REMOVED******REMOVED*** Integration with PARALLELISM_FRAMEWORK

***REMOVED******REMOVED******REMOVED*** Level 3 Integration Points Emit Signals
...
***REMOVED******REMOVED******REMOVED*** Level 2 Dependencies Emit Signals
...
***REMOVED******REMOVED******REMOVED*** Write-Write Conflict
...
def detect_conflict(pending_writes: list[Write]) -> bool:
    ...
    return len(files) != len(set(files))  ***REMOVED*** Duplicates = conflict
```

***REMOVED******REMOVED******REMOVED*** Read-Write Conflict
...
def detect_stale_read(reads: list[Read], writes: list[Write]) -> bool:
    ...
    return bool(read_files & write_files)  ***REMOVED*** Intersection = stale read risk
```

---

***REMOVED******REMOVED*** Example: Parallel Implementation Session
...
***REMOVED******REMOVED******REMOVED*** Current: Convention-Based

Agents voluntarily emit signals in structured output. No enforcement.

***REMOVED******REMOVED******REMOVED*** Future: Infrastructure
