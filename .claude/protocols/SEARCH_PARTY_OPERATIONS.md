***REMOVED*** SEARCH_PARTY Operations Runbook
...
***REMOVED******REMOVED*** Timeout Profile Selection Guide
...
***REMOVED******REMOVED******REMOVED*** Override Scenarios
...
***REMOVED******REMOVED*** Common Mission Patterns

***REMOVED******REMOVED******REMOVED*** Pattern 1: Bug Investigation (P1)
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Security Audit (P2)
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Architecture Review (P2)
...
***REMOVED******REMOVED******REMOVED*** Symptom: Probe Timeout (All Probes Stalling)
...
***REMOVED******REMOVED******REMOVED*** Symptom: Probe Crash (Specific Probe Fails)
...
***REMOVED******REMOVED******REMOVED*** Symptom: Low Confidence Findings (Most Probes Partial)
...
***REMOVED******REMOVED******REMOVED*** Symptom: Circuit Breaker Tripped (OPEN State)
...
***REMOVED******REMOVED******REMOVED*** Symptom: Discrepancies Not Detected (Cross-Reference Gap)
...
***REMOVED******REMOVED******REMOVED*** Context Overhead Reduction
...
***REMOVED******REMOVED******REMOVED*** Wall-Clock Time Optimization
...
***REMOVED******REMOVED*** Monitoring Dashboard Template
...
***REMOVED******REMOVED******REMOVED*** Contact List
...
***REMOVED******REMOVED*** Post-Incident Review Template
