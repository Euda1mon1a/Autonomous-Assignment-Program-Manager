***REMOVED*** MCP Confidence Framework
...
***REMOVED******REMOVED******REMOVED*** Level 0: No Confidence (0.0)
...
***REMOVED******REMOVED******REMOVED*** Level 1: Very Low Confidence (0.1-0.25)
...
***REMOVED******REMOVED******REMOVED*** Level 2: Low Confidence (0.25-0.50)
...
***REMOVED******REMOVED******REMOVED*** Level 3: Moderate Confidence (0.50-0.75)
...
***REMOVED******REMOVED******REMOVED*** Level 4: High Confidence (0.75-0.90)
...
***REMOVED******REMOVED******REMOVED*** Level 5: Very High Confidence (0.90-1.0)
...
***REMOVED******REMOVED*** Per-Tool Confidence Adjustments

***REMOVED******REMOVED******REMOVED*** Scheduling Tools
...
***REMOVED******REMOVED******REMOVED*** Early Warning Tools
...
***REMOVED******REMOVED******REMOVED*** Epidemiology Tools
...
***REMOVED******REMOVED*** Confidence Aggregation
...
***REMOVED*** Use when: All tools must be confident
***REMOVED*** Example: Schedule validation (all checks must pass)
```
...
***REMOVED*** Use when: Some tools more important than others
***REMOVED*** Example: Unified critical index
```

**Strategy 3: Harmonic Mean (Emphasis on Low Values)**
```python
overall_confidence = 3 / (1/conf1 + 1/conf2 + 1/conf3)
***REMOVED*** Use when: Want to emphasize weak links
***REMOVED*** Example: Safety-critical decision
```

**Strategy 4: Maximum (Optimistic)**
```python
overall_confidence = max([tool1_confidence, tool2_confidence, tool3_confidence])
***REMOVED*** Use when: Any tool being confident is enough
***REMOVED*** Example: Early warning detection (any signal matters)
```
...
***REMOVED******REMOVED******REMOVED*** Example: Compliance Check Aggregation
...
weights = {
    "acgme_80_hour": 0.3,      ***REMOVED*** Most critical
    "acgme_1_in_7": 0.2,
    "supervision_ratio": 0.2,
    "conflict_detection": 0.2,
    "spc_analysis": 0.1,        ***REMOVED*** Least critical
}
...
***REMOVED*** Result: 0.89 (High confidence in compliance assessment)
```

---

***REMOVED******REMOVED*** Confidence Decision Tree
...
***REMOVED******REMOVED*** Per-Workflow Confidence Thresholds
...
***REMOVED******REMOVED******REMOVED*** Compliance Check Workflow
...
***REMOVED******REMOVED******REMOVED*** Swap Execution Workflow
...
***REMOVED******REMOVED******REMOVED*** Resilience Assessment Workflow
...
***REMOVED******REMOVED*** Confidence Transparency
...
***REMOVED******REMOVED*** Monitoring Confidence Trends
...
***REMOVED******REMOVED******REMOVED*** Example 1: High-Confidence Schedule Validation
...
***REMOVED******REMOVED******REMOVED*** Example 2: Low-Confidence Contingency Analysis
