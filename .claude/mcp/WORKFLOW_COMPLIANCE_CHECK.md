***REMOVED*** Workflow: Compliance Check
...
***REMOVED******REMOVED*** Phase 1: Core ACGME Compliance (0.5 seconds)
...
***REMOVED******REMOVED*** Phase 2: Detailed Constraint Analysis (1 second)
...
***REMOVED******REMOVED*** Phase 3: Advanced Compliance Analysis (0.5-1 second)
...
***REMOVED******REMOVED*** Phase 4: Synthesis & Reporting (0.5 seconds)
...
***REMOVED******REMOVED******REMOVED*** 1. Executive Summary (For Leadership)
```
...
***REMOVED******REMOVED******REMOVED*** 2. Detailed Report (For Coordinators)
```
DETAILED COMPLIANCE ANALYSIS
[10+ page PDF with all violations, trends, recommendations]
```

***REMOVED******REMOVED******REMOVED*** 3. JSON API Response (For Integrations)
```json
{
  "compliance_score": 92,
  "violations": [...],
...
***REMOVED******REMOVED******REMOVED*** 4. Monitoring Dashboard Data
```
...
***REMOVED******REMOVED*** Common Scenarios & Responses

***REMOVED******REMOVED******REMOVED*** Scenario 1: Compliant Schedule
```
Status: COMPLIANT ✓
Score: 95+
...
***REMOVED******REMOVED******REMOVED*** Scenario 2: Minor Violations
```
Status: MINOR ISSUES ⚠
Score: 80-94
...
***REMOVED******REMOVED******REMOVED*** Scenario 3: Critical Violations
```
...
***REMOVED******REMOVED******REMOVED*** Quick Check (30 seconds)
```python
"mode": "quick",
"phases": [1],  ***REMOVED*** ACGME rules only
"caching": True,
"detail_level": "summary",
```

***REMOVED******REMOVED******REMOVED*** Standard Check (2-3 seconds)
```python
"mode": "standard",
"phases": [1, 2, 3, 4],  ***REMOVED*** All phases
"caching": True,
"detail_level": "detailed",
```

***REMOVED******REMOVED******REMOVED*** Audit Check (5-10 seconds)
```python
"mode": "audit",
"phases": [1, 2, 3, 4],  ***REMOVED*** All phases
"caching": False,  ***REMOVED*** Fresh data
"detail_level": "exhaustive",
"include_historical": True,  ***REMOVED*** Trend analysis
```
