***REMOVED*** Workflow: Schedule Generation
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Pre-Generation Analysis (2 seconds)
...
phase_1_config = {
    ...
    "check_utilization_threshold": {
        "critical": False,  ***REMOVED*** Allow generation even if yellow
    },
    "detect_conflicts": {
        "include_resolved": False,  ***REMOVED*** Only unresolved conflicts
    },
    "timeout": 2.0,  ***REMOVED*** seconds
}
```
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Contingency Simulation (3-5 seconds)
...
phase_2_config = {
    "run_contingency_analysis": {
        "analyze_n1": True,
        "analyze_n2": False,  ***REMOVED*** Only single-point failures
        "days_ahead": 30,
    },
    "calculate_blast_radius": {
        "max_personnel": 10,  ***REMOVED*** Top 10 critical people
        "include_cost": True,
    },
    "execute_sacrifice_hierarchy": {
        "preview_mode": True,  ***REMOVED*** No apply
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Early Warning Assessment (1-2 seconds)
...
phase_3_config = {
    "detect_burnout_precursors": {
        "signal_type": "ALL",  ***REMOVED*** All signal types
        "confidence_level": 0.85,  ***REMOVED*** Be conservative
    },
    "run_spc_analysis": {
        "target_hours": 60.0,
        "sigma": 5.0,
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Unified Risk Assessment (1-2 seconds)
...
phase_4_config = {
    "get_unified_critical_index": {
        ...
        "top_n": 20,  ***REMOVED*** Top 20 at-risk faculty
    },
    "timeout": 1.0,
}
```
...
***REMOVED******REMOVED******REMOVED*** Phase 5: Generation Parameters & Execute (5-10 seconds)
...
```python
phase_5_config = {
    "algorithm": "hybrid",  ***REMOVED*** Default
    "constraints": {
        "acgme_hard": True,  ***REMOVED*** Never violate
    ...
    "objectives": {
        "minimize_churn": 0.8,  ***REMOVED*** 80% weight
        "maximize_equity": 0.1,  ***REMOVED*** 10% weight
        "minimize_cost": 0.1,   ***REMOVED*** 10% weight
    },
    "timeout": 10.0,
}
```
...
***REMOVED******REMOVED******REMOVED*** Phase 6: Post-Generation Validation (1-2 seconds)
...
phase_6_config = {
    "validate_schedule": {
        "strict_mode": True,  ***REMOVED*** Higher bar
    },
    "run_contingency_analysis": {
        ***REMOVED*** Same config as Phase 2
    },
    "timeout": 2.0,
}
```
...
***REMOVED******REMOVED******REMOVED*** Phase 7: Human Review & Approval
...
***REMOVED******REMOVED*** Error Handling & Fallback

***REMOVED******REMOVED******REMOVED*** Critical Failures
...
class GenerationBlockedError(ScheduleGenerationError):
    ...
    ***REMOVED*** Trigger: Phase 1 validation < 80%
    ***REMOVED*** Action: Request manual conflict resolution before retry

class ContingencyFailureError(ScheduleGenerationError):
    """Contingency analysis failed - system too fragile"""
    ***REMOVED*** Trigger: Phase 2 shows >50% N-1 gaps
    ***REMOVED*** Action: Activate sacrifice hierarchy first, then retry

class RiskTooHighError(ScheduleGenerationError):
    """System risk too elevated - generation deferred"""
    ***REMOVED*** Trigger: Phase 4 index > 70
    ***REMOVED*** Action: Address top concerns, retry in 24h
```
...
***REMOVED******REMOVED******REMOVED*** Fast Generation (Express Path)
```python
***REMOVED*** Skip deep analysis, trust recent baseline
"workflow_mode": "express",
"skip_phases": ["contingency_deep"],
"use_cached": {
    "contingency": 1440,  ***REMOVED*** 24h cache ok
    "early_warning": 360,  ***REMOVED*** 6h cache ok
},
"timeout": 5.0,
```

***REMOVED******REMOVED******REMOVED*** Thorough Generation (Full Analysis)
```python
***REMOVED*** Run all phases, extensive validation
...
***REMOVED******REMOVED******REMOVED*** Emergency Generation (Critical Fix)
```python
***REMOVED*** Fast, accept lower validation bars
"workflow_mode": "emergency",
"skip_phases": ["full_contingency"],
"validation_threshold": 0.85,  ***REMOVED*** Instead of 0.95
"timeout": 5.0,
...
```python
success_metrics = {
    "compliance_maintained": True,  ***REMOVED*** >= 95% compliance
    "churn_minimized": <10,  ***REMOVED*** Changes from previous
    "fatigue_improved": True,  ***REMOVED*** Unified index lower
    "contingency_robust": >75,  ***REMOVED*** % N-1 gaps covered
    "staff_satisfaction": >=4.0,  ***REMOVED*** Survey score
