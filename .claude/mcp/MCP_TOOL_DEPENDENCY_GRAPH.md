***REMOVED*** MCP Tool Dependency Graph
...
***REMOVED******REMOVED*** Tool Categories and Dependencies

***REMOVED******REMOVED******REMOVED*** Category 1: Core Scheduling Tools (5 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 2: Resilience Framework Tools (12 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 3: Early Warning Detection Tools (7 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 4: Fatigue & Burnout Analysis Tools (7 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 5: Optimization & Analytics Tools (6 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 6: Composite Resilience Tools (4 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 7: Specialized Analytics Tools (8 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 8: Time Crystal & Anti-Churn Tools (5 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 9: Risk Analysis Tools (5 tools)
...
***REMOVED******REMOVED******REMOVED*** Category 10: Auxiliary Systems (4 tools)
...
***REMOVED******REMOVED*** Dependency Tiers & Safety Levels

***REMOVED******REMOVED******REMOVED*** Execution Safety Tiers
...
***REMOVED******REMOVED******REMOVED*** Parallelization Matrix
...
***REMOVED******REMOVED*** Circular Dependency Detection
...
***REMOVED******REMOVED*** Dependency Validation Checklist
...
***REMOVED******REMOVED******REMOVED*** Pattern 1: Validation → Analysis (Serial)
```
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Early Warning Batch (Parallel)
```
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Resilience Assessment (Tiered)
```
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Risk Aggregation (Star topology)
```
...
***REMOVED******REMOVED******REMOVED*** Error Propagation
...
***REMOVED******REMOVED******REMOVED*** Timeout Recommendations

```python
TOOL_TIMEOUTS = {
    ***REMOVED*** Fast tools (no timeout needed)
    "validate_schedule": 0.1,
    "detect_conflicts": 0.1,
    "run_spc_analysis": 0.05,

    ***REMOVED*** Medium tools
...
***REMOVED******REMOVED*** Graph Visualization
