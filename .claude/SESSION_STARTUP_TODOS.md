***REMOVED*** Session Startup TODOs for Claude Code
...
***REMOVED******REMOVED*** Phase 1: Environment Verification

***REMOVED******REMOVED******REMOVED*** TODO 1.1: Check Current Branch
```bash
...
***REMOVED******REMOVED******REMOVED*** TODO 1.2: Check Docker Status
```bash
...
***REMOVED******REMOVED******REMOVED*** TODO 1.3: Verify MCP Server Connectivity
```bash
...
***REMOVED******REMOVED******REMOVED*** TODO 1.4: Verify Backend API
```bash
...
***REMOVED******REMOVED*** Phase 2: Context Loading

***REMOVED******REMOVED******REMOVED*** TODO 2.1: Load Project Guidelines
- [ ] Read `CLAUDE.md` (root of project)
- [ ] Note: Tech stack, architecture, testing requirements

***REMOVED******REMOVED******REMOVED*** TODO 2.2: Load AI Rules
- [ ] Read `.claude/CONSTITUTION.md`
- [ ] Note: Safety rules, forbidden actions, escalation protocols

***REMOVED******REMOVED******REMOVED*** TODO 2.3: Load Skill Index
- [ ] Read `.claude/SKILL_INDEX.md`
- [ ] Note: 34 skills available, routing rules, intent mappings

***REMOVED******REMOVED******REMOVED*** TODO 2.4: Load MCP Usage Guide
- [ ] Read `.claude/MCP_USAGE_TODOS.md`
- [ ] Note: Tool reference, error handling, logging requirements

---

***REMOVED******REMOVED*** Phase 3: State Check

***REMOVED******REMOVED******REMOVED*** TODO 3.1: Check Recent Activity
```bash
...
***REMOVED******REMOVED******REMOVED*** TODO 3.2: Check for Active Incidents
```bash
ls -la docs/incidents/INCIDENT_*.md 2>/dev/null | tail -3
```
- [ ] If active incident exists, prioritize incident response

***REMOVED******REMOVED******REMOVED*** TODO 3.3: Check Test Status
```bash
...
***REMOVED******REMOVED*** Phase 4: Ready Confirmation

***REMOVED******REMOVED******REMOVED*** TODO 4.1: Summarize Status
Report to user:
```
Session Ready:
...
***REMOVED******REMOVED******REMOVED*** TODO 4.2: Await User Command
...
***REMOVED******REMOVED******REMOVED*** If Everything is Down (Cold Start)
```bash
***REMOVED*** 1. Start all services
docker compose up -d

***REMOVED*** 2. Wait for health checks (30 seconds)
sleep 30
...
***REMOVED******REMOVED******REMOVED*** If Just MCP Needs Restart
```bash
...
***REMOVED******REMOVED******REMOVED*** If Backend Needs Restart
```bash
...
***REMOVED******REMOVED*** Troubleshooting Checklist

***REMOVED******REMOVED******REMOVED*** MCP Import Error
...
***REMOVED******REMOVED******REMOVED*** Backend Connection Refused
...
***REMOVED******REMOVED******REMOVED*** Database Connection Error
...
***REMOVED******REMOVED*** Session End TODOs
