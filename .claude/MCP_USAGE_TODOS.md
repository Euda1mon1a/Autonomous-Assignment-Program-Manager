***REMOVED*** MCP Usage TODOs for Claude Code CLI
...
***REMOVED******REMOVED*** Pre-Flight Checklist (RUN EVERY SESSION)

Before using any MCP tools, Claude Code MUST complete these steps:

***REMOVED******REMOVED******REMOVED*** TODO 1: Verify Docker is Running
```bash
docker compose ps
```
...
***REMOVED******REMOVED******REMOVED*** TODO 2: Verify MCP Server Health
```bash
...
***REMOVED******REMOVED******REMOVED*** TODO 3: Verify Backend API Connectivity
```bash
...
***REMOVED******REMOVED*** Using MCP Tools

***REMOVED******REMOVED******REMOVED*** Pattern: Schedule Validation
...
***REMOVED******REMOVED******REMOVED*** Pattern: Resilience Check
...
***REMOVED******REMOVED******REMOVED*** Pattern: Swap Analysis
...
***REMOVED******REMOVED******REMOVED*** Pattern: Schedule Generation
...
***REMOVED******REMOVED*** MCP Tool Quick Reference

***REMOVED******REMOVED******REMOVED*** Core Scheduling (5 tools)
...
***REMOVED******REMOVED******REMOVED*** Resilience Framework (13 tools)
| Tool | Purpose | Required Params |
|------|---------|-----------------|
...
***REMOVED******REMOVED*** Error Handling TODOs

***REMOVED******REMOVED******REMOVED*** If MCP Tool Returns Error
...
***REMOVED******REMOVED******REMOVED*** If Docker Container Not Running
...
***REMOVED******REMOVED******REMOVED*** If Backend API Unreachable
...
***REMOVED******REMOVED******REMOVED*** Log Entry Template
```json
{
...
***REMOVED******REMOVED*** Integration with CLI (`aapm`)
...
***REMOVED******REMOVED*** Safety TODOs (NON-NEGOTIABLE)

***REMOVED******REMOVED******REMOVED*** Before Any Write Operation
...
***REMOVED******REMOVED*** Session Startup TODO
