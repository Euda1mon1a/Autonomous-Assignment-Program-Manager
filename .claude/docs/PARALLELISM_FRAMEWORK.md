...
────────────────────────────────────────────────────────────────────────────────────────────
***REMOVED*** COMPLIANCE EXCEPTIONS (specific files → COORD_RESILIENCE)
...
***REMOVED*** DIRECTORY PATTERNS (apply when no specific match above)
...
***REMOVED******REMOVED******REMOVED*** When to Use Speculative Reads
...
***REMOVED******REMOVED******REMOVED*** Example: Understanding Swap Feature
...
***REMOVED******REMOVED******REMOVED*** Anti-Pattern
...
***REMOVED******REMOVED******REMOVED*** Integration with Explore Subagent
...
***REMOVED******REMOVED******REMOVED*** 5. Single Validator Bottleneck
...
***REMOVED******REMOVED*** Agent Modification Patterns
...
***REMOVED******REMOVED******REMOVED*** Pattern 1: Team Lead (New Agent Creation)
...
```python
***REMOVED*** AGENT_FACTORY spawns 3 parallel COORD_QUALITY teams
for agent_spec in [CI_LIAISON, DOMAIN_ANALYST, CRASH_RECOVERY_SPECIALIST]:
    Task(
        ...
        prompt=f"""
        ***REMOVED******REMOVED*** Agent: COORD_QUALITY (Team Lead)
...
***REMOVED*** All 3 COORD_QUALITY teams run in PARALLEL
***REMOVED*** Each team runs TOOLSMITH → QA → REVIEW sequentially
```

---

***REMOVED******REMOVED******REMOVED*** Pattern 2: Batch Augmentation (Existing Agent Updates)
...
```python
***REMOVED*** Spawn TOOLSMITH agents in parallel for each augmentation
augmentations = [
...
***REMOVED*** All 4 TOOLSMITH run in PARALLEL

***REMOVED*** After all complete, single COORD_QUALITY validates batch
Task(
...
***REMOVED******REMOVED******REMOVED*** Decision Guide: Which Pattern?
...
| 1.1.0 | 2025-12-30 | Added Team Lead Pattern, Anti-Pattern ***REMOVED***5 (Single Validator Bottleneck) |
