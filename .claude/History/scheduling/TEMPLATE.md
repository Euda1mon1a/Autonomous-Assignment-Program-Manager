***REMOVED*** Schedule Generation - [Block/Period Name]
...
***REMOVED******REMOVED******REMOVED*** Tier 1: Regulatory (Hard Constraints - MUST Satisfy)
...
***REMOVED******REMOVED******REMOVED*** Tier 2: Institutional (Hard Constraints Unless Waived)
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Optimization (Soft Constraints - Optimize)
...
***REMOVED******REMOVED******REMOVED*** Tier 4: Nice-to-Have (Lowest Priority)
...
***REMOVED******REMOVED*** Constraint Evaluation

***REMOVED******REMOVED******REMOVED*** Relaxation Log
...
***REMOVED******REMOVED******REMOVED*** Conflicts Detected
...
***REMOVED******REMOVED*** Solver Statistics
...
***REMOVED******REMOVED*** Resilience Score
...
***REMOVED******REMOVED*** Trade-offs and Rationale
...
***REMOVED******REMOVED*** Validation & Review
