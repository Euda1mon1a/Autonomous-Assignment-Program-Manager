***REMOVED*** Phase Summary Conventions
...
1. [When to Create a Phase Summary](***REMOVED***when-to-create-a-phase-summary)
2. [Naming Conventions](***REMOVED***naming-conventions)
3. [Storage Organization](***REMOVED***storage-organization)
4. [How Agents Should Use Phase Summaries](***REMOVED***how-agents-should-use-phase-summaries)
5. [Context Window Management](***REMOVED***context-window-management)
6. [Archive and Retention Policy](***REMOVED***archive-and-retention-policy)
7. [Quality Standards](***REMOVED***quality-standards)

---

***REMOVED******REMOVED*** When to Create a Phase Summary

***REMOVED******REMOVED******REMOVED*** Mandatory Phase Summaries
...
***REMOVED******REMOVED******REMOVED*** Optional Phase Summaries
...
***REMOVED******REMOVED******REMOVED*** When NOT to Create a Phase Summary
...
***REMOVED******REMOVED******REMOVED*** File Naming Format
...
***REMOVED******REMOVED******REMOVED*** Bad Naming Examples
...
***REMOVED******REMOVED******REMOVED*** Good Naming Examples
...
***REMOVED******REMOVED*** Storage Organization

***REMOVED******REMOVED******REMOVED*** Directory Structure

```
.claude/History/
├── PHASE_SUMMARY_TEMPLATE.md          ***REMOVED*** Template for new summaries
├── PHASE_CONVENTIONS.md               ***REMOVED*** This file
├── active/                            ***REMOVED*** Current work (last 30 days)
│   ├── 2024-01-15_implementation_block10-schedule-generation.md
│   ├── 2024-01-16_debugging_race-condition-assignments.md
│   └── 2024-01-17_design_swap-auto-matcher-algorithm.md
├── archive/                           ***REMOVED*** Completed work (30-365 days)
│   ├── 2023/
...
│       └── Q1/
│           └── [older summaries]
├── examples/                          ***REMOVED*** Example summaries for reference
│   └── 2024-01-15_block10-schedule-generation.md
└── indexes/
    ├── by-phase-type.md              ***REMOVED*** Index organized by phase type
    ├── by-feature.md                 ***REMOVED*** Index organized by feature area
    └── by-agent.md                   ***REMOVED*** Index organized by agent/author
```

***REMOVED******REMOVED******REMOVED*** Storage Location Rules
...
***REMOVED******REMOVED******REMOVED*** Automatic Archival

Agents should check for summaries older than 30 days in `active/` and suggest moving them:

```bash
***REMOVED*** Find summaries older than 30 days
find .claude/History/active/ -name "*.md" -mtime +30
```

---

***REMOVED******REMOVED*** How Agents Should Use Phase Summaries

***REMOVED******REMOVED******REMOVED*** Starting a New Phase

**Agent should:**

1. **Check for related previous phases:**
   ```bash
   ***REMOVED*** Search for related summaries
...
3. **Reference in new work:**
   ```markdown
   ***REMOVED******REMOVED*** Context from Previous Phases
...
***REMOVED******REMOVED******REMOVED*** During a Phase
...
***REMOVED******REMOVED******REMOVED*** Completing a Phase
...
***REMOVED******REMOVED******REMOVED*** Referencing Previous Summaries
...
```markdown
***REMOVED******REMOVED*** Design Rationale
...
***REMOVED******REMOVED*** Context Window Management

***REMOVED******REMOVED******REMOVED*** Context Window Budget
...
***REMOVED******REMOVED******REMOVED*** When to Reload Summaries
...
***REMOVED******REMOVED******REMOVED*** When to Summarize Instead of Reload
...
```markdown
***REMOVED******REMOVED*** Quick Context: Block 9 Schedule Generation
...
***REMOVED******REMOVED******REMOVED*** Aggressive Context Pruning
...
***REMOVED******REMOVED*** Archive and Retention Policy

***REMOVED******REMOVED******REMOVED*** Retention Schedule
...
***REMOVED******REMOVED******REMOVED*** Archival Process

**Every 30 days (automated via script):**

```bash
***REMOVED*** Move summaries older than 30 days to archive
...
***REMOVED******REMOVED******REMOVED*** Deletion Policy
...
***REMOVED******REMOVED******REMOVED*** Minimum Quality Requirements
...
***REMOVED******REMOVED******REMOVED*** High-Quality Summaries
...
***REMOVED******REMOVED******REMOVED*** Quality Checklist
...
***REMOVED******REMOVED*** Examples of Good vs. Bad Summaries

***REMOVED******REMOVED******REMOVED*** ❌ Bad Example

```markdown
***REMOVED*** Phase Summary: Implemented stuff
...
***REMOVED******REMOVED******REMOVED*** ✅ Good Example
...
***REMOVED******REMOVED*** Integration with AI Agent Workflows

***REMOVED******REMOVED******REMOVED*** Slash Commands (for future implementation)

```bash
/phase:start [phase-type] [description]
  ***REMOVED*** Initializes a new phase summary from template

/phase:decision [decision-name]
  ***REMOVED*** Logs a key decision in the current phase

/phase:artifact [file-path]
  ***REMOVED*** Adds artifact to current phase summary

/phase:complete
  ***REMOVED*** Finalizes phase summary and moves to active/

/phase:search [query]
  ***REMOVED*** Searches historical phase summaries

/phase:load [phase-name]
  ***REMOVED*** Loads a previous phase summary into context
```

***REMOVED******REMOVED******REMOVED*** Agent Prompts
