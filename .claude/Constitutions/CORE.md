***REMOVED*** CORE CONSTITUTION - Universal System Rules
...
***REMOVED******REMOVED******REMOVED*** B. Implementation Examples

**FORBIDDEN:**
```python
***REMOVED*** Interactive prompt - breaks automation
...
***REMOVED******REMOVED*** III. LOGGING & AUDITABILITY

**Principle:** All significant operations must be logged with full audit trails.

***REMOVED******REMOVED******REMOVED*** A. Logging Requirements
...
***REMOVED******REMOVED******REMOVED*** B. Audit Trail Events
...
***REMOVED******REMOVED******REMOVED*** C. Implementation Example
...
***REMOVED******REMOVED******REMOVED*** D. Correlation IDs

**Requirement:** All operations must be traceable across distributed systems.

```python
***REMOVED*** Generate correlation ID at entry point
import uuid
correlation_id = str(uuid.uuid4())

***REMOVED*** Pass through all layers
...
***REMOVED******REMOVED*** IV. SECURITY DEFENSE-IN-DEPTH
...
class AssignmentCreate(BaseModel):
    person_id: UUID
    block_id: int = Field(gt=0, le=730)  ***REMOVED*** Valid block range for academic year
    rotation_id: UUID

    @validator('block_id')
    def block_must_be_future(cls, v):
        ***REMOVED*** Additional business logic validation
        if v < current_block():
...
***REMOVED******REMOVED*** V. ERROR HANDLING & ROLLBACK
...
***REMOVED******REMOVED******REMOVED*** C. Implementation Examples

**Database Migration Rollback:**
```bash
***REMOVED***!/bin/bash
***REMOVED*** Pre-migration backup
...
async def generate_schedule_with_rollback(
    ...
    ***REMOVED*** Backup current schedule
...
***REMOVED******REMOVED******REMOVED*** D. Graceful Degradation
...
***REMOVED******REMOVED*** VI. META-IMPROVEMENT
...
***REMOVED******REMOVED*** VII. AGENT COMMUNICATION STANDARDS

**Principle:** Agents must communicate clearly with humans and other agents.

***REMOVED******REMOVED******REMOVED*** A. Communication with Humans
...
Would you like me to set up option ***REMOVED***1 (test environment)?
```

***REMOVED******REMOVED******REMOVED*** B. Communication with Other Agents
...
***REMOVED******REMOVED*** VIII. CODE QUALITY STANDARDS
...
***REMOVED******REMOVED******REMOVED*** B. Code Review Checklist
...
***REMOVED******REMOVED*** IX. CROSS-REFERENCES
...
***REMOVED******REMOVED*** XI. AMENDMENT HISTORY
