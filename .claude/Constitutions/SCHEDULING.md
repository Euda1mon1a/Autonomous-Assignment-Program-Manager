***REMOVED*** SCHEDULING CONSTITUTION - Domain-Specific Rules
...
***REMOVED******REMOVED******REMOVED*** B. 1-in-7 Rule
...
def validate_1_in_7_rule(person_id: str, current_date: date) -> bool:
    ...
    ***REMOVED*** Check each day in window
    for day_offset in range(7):
        check_date = start_date + timedelta(days=day_offset)

        ***REMOVED*** Check if this 24-hour period is completely free
        if is_day_completely_free(person_id, check_date):
            return True

    ***REMOVED*** No free 24-hour period found in 7-day window
    logger.error(
        "1_in_7_violation",
        person_id=person_id,
...
***REMOVED******REMOVED******REMOVED*** C. Supervision Ratios
...
***REMOVED******REMOVED******REMOVED*** D. ACGME Validation Points
...
***REMOVED******REMOVED******REMOVED*** Tier 2: Institutional Policy
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Optimization Preferences
...
```python
TIER_3_PENALTIES = {
    "unfair_distribution": 10,  ***REMOVED*** Penalty per unfair shift assignment
    "rotation_change": 5,       ***REMOVED*** Penalty per unnecessary rotation change
    "missed_learning": 3,       ***REMOVED*** Penalty per missed learning opportunity
    "preference_violation": 1   ***REMOVED*** Penalty per preference violation
}
```

***REMOVED******REMOVED******REMOVED*** Tier 4: Nice-to-Have
...
***REMOVED******REMOVED*** IV. RESILIENCE FRAMEWORK

**Principle:** Schedules must be resilient to disruptions and maintain safe staffing levels.

***REMOVED******REMOVED******REMOVED*** A. Defense-in-Depth Levels
...
***REMOVED******REMOVED******REMOVED*** B. N-1/N-2 Contingency
...
async def validate_n1_contingency(schedule: Schedule) -> bool:
    ...
    for person in key_persons:
        ***REMOVED*** Simulate person unavailability
        test_schedule = schedule.without(person)

        ***REMOVED*** Validate remaining schedule
...
***REMOVED******REMOVED******REMOVED*** C. Health Check Requirements
...
def calculate_schedule_health(schedule: Schedule) -> float:
    ...
    ***REMOVED*** Weighted average
    weights = {
        "acgme_compliance": 0.40,  ***REMOVED*** 40% weight
...
***REMOVED******REMOVED*** V. SCHEDULE VALIDATION REQUIREMENTS

**Principle:** All schedules must pass comprehensive validation before deployment.

***REMOVED******REMOVED******REMOVED*** A. Validation Checklist
...
***REMOVED******REMOVED******REMOVED*** B. Validation Enforcement
...
4. **Require Approval for Warnings**
   ...
   if validation_result.has_warnings():
       ...
       ***REMOVED*** Require explicit PD approval before deployment
       await request_approval(schedule, validation_result.warnings)
   ```

---

***REMOVED******REMOVED*** VI. BACKUP REQUIREMENTS

**Principle:** Never generate schedules without backup capability.

***REMOVED******REMOVED******REMOVED*** A. Backup Before Generation
...
async def generate_schedule_with_backup(
    ...
    """
    ***REMOVED*** REQUIRED: Backup current schedule
...
***REMOVED******REMOVED******REMOVED*** B. Backup Retention
...
***REMOVED******REMOVED*** VII. SWAP VALIDATION

**Principle:** All schedule swaps must maintain ACGME compliance and system integrity.

***REMOVED******REMOVED******REMOVED*** A. Swap Validation Sequence

**Required Checks (in order):**

1. **Pre-Swap Compliance Check**
   ```python
   ***REMOVED*** Verify both parties currently compliant
...
2. **Post-Swap Simulation**
   ```python
   ***REMOVED*** Calculate projected work hours after swap
...
3. **Conflict Detection**
   ```python
   ***REMOVED*** Check for double-booking or rotation conflicts
...
4. **Credential Verification**
   ```python
   ***REMOVED*** Ensure both parties qualified for swapped slots
...
***REMOVED******REMOVED******REMOVED*** C. Rollback Window
...
***REMOVED******REMOVED*** VIII. COVERAGE REQUIREMENTS

**Principle:** All clinical services must maintain minimum staffing levels.

***REMOVED******REMOVED******REMOVED*** A. Minimum Staffing Levels
...
***REMOVED******REMOVED******REMOVED*** B. Coverage Gap Detection
...
***REMOVED******REMOVED*** IX. FAIRNESS & EQUITY

**Principle:** Distribute workload and undesirable shifts equitably.

***REMOVED******REMOVED******REMOVED*** A. Fairness Metrics
...
def calculate_gini_coefficient(assignments: list[Assignment]) -> float:
    ...
    """
    ***REMOVED*** Count shifts per person
...
***REMOVED******REMOVED******REMOVED*** B. Undesirable Shift Distribution
...
***REMOVED******REMOVED*** X. CROSS-REFERENCES
...
***REMOVED******REMOVED*** XI. ENFORCEMENT
...
***REMOVED******REMOVED*** XII. AMENDMENT HISTORY
