***REMOVED*** SAFETY-CRITICAL CONSTITUTION - Non-Negotiable Principles
...
***REMOVED******REMOVED*** II. ABSOLUTE PROHIBITIONS

**These actions are FORBIDDEN under ALL circumstances:**

***REMOVED******REMOVED******REMOVED*** A. Regulatory Violations
...
***REMOVED******REMOVED******REMOVED*** B. Data Protection Violations
...
***REMOVED******REMOVED******REMOVED*** C. Security Violations
...
***REMOVED******REMOVED******REMOVED*** D. Data Integrity Violations
...
***REMOVED******REMOVED*** III. PATIENT SAFETY IMPLICATIONS

**Principle:** All decisions must consider downstream effects on patient care.

***REMOVED******REMOVED******REMOVED*** A. Understaffing Risks
...
***REMOVED******REMOVED******REMOVED*** B. Fatigue-Related Risks
...
***REMOVED******REMOVED******REMOVED*** C. Supervision Requirements
...
***REMOVED******REMOVED*** IV. MILITARY OPSEC/PERSEC REQUIREMENTS

**Principle:** Protect operational and personal security of military personnel.

***REMOVED******REMOVED******REMOVED*** A. Operational Security (OPSEC)
...
***REMOVED******REMOVED******REMOVED*** B. Personal Security (PERSEC)
...
```python
***REMOVED*** FORBIDDEN - Real names
residents = ["CPT Smith, John", "LT Jones, Sarah"]

***REMOVED*** REQUIRED - Anonymized
        ...
        "blocks": [
            {
                ...
                "role": assignment.person.role,  ***REMOVED*** Role only, no name
                "rotation_type": assignment.rotation.type
                ***REMOVED*** NO: person name, contact info, specific location
            }
...
***REMOVED******REMOVED*** V. FORBIDDEN OPERATIONS

**These operations require EXPLICIT human approval and are NEVER autonomous:**

***REMOVED******REMOVED******REMOVED*** A. Git Operations
...
***REMOVED******REMOVED******REMOVED*** B. Database Operations
...
***REMOVED******REMOVED******REMOVED*** C. Deployment Operations
...
***REMOVED******REMOVED******REMOVED*** D. Configuration Changes
...
***REMOVED******REMOVED*** VI. EMERGENCY OVERRIDE PROCEDURES

**Principle:** Even in emergencies, safety rules apply.

***REMOVED******REMOVED******REMOVED*** A. When Emergencies Occur
...
***REMOVED******REMOVED******REMOVED*** B. Emergency Override Protocol

**Procedure for legitimate emergencies:**

1. **Document Emergency**
   ```markdown
   ***REMOVED******REMOVED*** Emergency Declaration
...
***REMOVED******REMOVED******REMOVED*** C. What Can Be Relaxed in Emergencies
...
***REMOVED******REMOVED*** VII. ESCALATION REQUIREMENTS

**Principle:** Agents must escalate safety-critical issues immediately.

***REMOVED******REMOVED******REMOVED*** A. Immediate Escalation Triggers
...
**Escalation Format:**
```markdown
***REMOVED******REMOVED*** URGENT: Safety-Critical Issue
...
***REMOVED******REMOVED******REMOVED*** B. Escalation Channels
...
***REMOVED******REMOVED*** VIII. AUDIT TRAIL REQUIREMENTS

**Principle:** All safety-critical operations must be auditable.

***REMOVED******REMOVED******REMOVED*** A. Required Audit Events
...
***REMOVED******REMOVED******REMOVED*** B. Audit Log Format
...
***REMOVED******REMOVED******REMOVED*** C. Audit Log Retention
...
***REMOVED******REMOVED*** IX. AGENT RESPONSIBILITIES

**Principle:** Agents are guardians of safety-critical rules.

***REMOVED******REMOVED******REMOVED*** A. Core Responsibilities
...
***REMOVED******REMOVED******REMOVED*** B. Refusal Template
...
***REMOVED******REMOVED******REMOVED*** C. When to Ask for Clarification
...
***REMOVED******REMOVED*** X. COMPLIANCE MONITORING
...
***REMOVED******REMOVED******REMOVED*** B. Violation Response
...
***REMOVED******REMOVED*** XI. CROSS-REFERENCES
...
***REMOVED******REMOVED*** XII. ENFORCEMENT
