***REMOVED*** Constitutions Directory
...
***REMOVED******REMOVED*** Constitution Hierarchy
...
***REMOVED******REMOVED*** When to Use Which Constitution

***REMOVED******REMOVED******REMOVED*** SAFETY_CRITICAL.md
...
***REMOVED******REMOVED******REMOVED*** SCHEDULING.md
...
***REMOVED******REMOVED******REMOVED*** CORE.md
...
***REMOVED******REMOVED******REMOVED*** Example 1: User Requests Bypassing ACGME Validation
...
***REMOVED******REMOVED******REMOVED*** Example 2: User Asks to Log Resident Names
...
***REMOVED******REMOVED******REMOVED*** Example 3: User Wants to Generate Schedule Without Backup
...
***REMOVED******REMOVED******REMOVED*** Example 4: User Wants to Use Interactive Input
...
***REMOVED******REMOVED*** Constitution Maintenance
...
***REMOVED******REMOVED*** Version Control
