***REMOVED*** Surgical Swaps Methodology
...
***REMOVED******REMOVED******REMOVED*** Surgical vs Brute Force
...
***REMOVED******REMOVED*** Minimal Change Principle
...
***REMOVED******REMOVED******REMOVED*** Measurement
...
```python
***REMOVED*** Regenerate all assignments for the week
regenerate_schedule(start="2026-03-10", end="2026-03-16")

impact = {
    "assignments_modified": 56,  ***REMOVED*** 28 assignments × 2 sessions
    "people_affected": 15,
...
***REMOVED******REMOVED*** Impact Assessment Framework

***REMOVED******REMOVED******REMOVED*** Pre-Change Analysis

Before making any change, assess:

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Direct Impact
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Constraint Impact
...
def assess_constraint_impact(proposed_change):
    ...
    ***REMOVED*** Check which constraints involve changed assignments
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Ripple Effects
...
def assess_ripple_effects(proposed_change):
    ...
    ***REMOVED*** Check supervision ratio
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Reversibility
...
def calculate_impact_score(assessment):
    ...
    ***REMOVED*** Direct changes
    score += assessment.direct_impact.count * 1.0

    ***REMOVED*** Constraint violations introduced
...
***REMOVED******REMOVED*** Ripple Effect Analysis
...
class ScheduleDependencyGraph:
    ...
    def find_ripple_effects(self, graph, changed_assignment):
        ...
        while queue:
            ...
            ***REMOVED*** Find neighbors (assignments affected by same constraints)
            for neighbor in graph.neighbors(current):
                ...
                ripples.append({
                    ...
                    "distance": len(visited)  ***REMOVED*** Hops from original change
                })
...
***REMOVED******REMOVED******REMOVED*** Containment Strategies

***REMOVED******REMOVED******REMOVED******REMOVED*** Strategy 1: Constraint Isolation

**If change only affects local constraints, ripple is contained**

```python
***REMOVED*** Example: Swap within same rotation on same date
***REMOVED*** Only affects:
***REMOVED*** - Those 2 people's workload
***REMOVED*** - That rotation's coverage (same people, just swapped)
***REMOVED*** Does NOT affect:
***REMOVED*** - Other rotations
***REMOVED*** - Other dates
***REMOVED*** - Supervision ratios (same people count)
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Strategy 2: Barrier Placement

**Use constraint boundaries as firewalls**

```python
***REMOVED*** Example: Workload balance constraint has weekly scope
***REMOVED*** Changes within a week don't ripple to other weeks
***REMOVED*** Use week boundaries as barriers
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Strategy 3: Dampening
...
***REMOVED******REMOVED*** Swap Candidate Selection

***REMOVED******REMOVED******REMOVED*** Compatibility Criteria
...
def find_compatible_swap_candidates(initiator, target_assignment):
    ...
    for person in all_people:
        ...
        ***REMOVED*** Check credential match
        if not person.has_credentials_for(target_assignment.rotation):
            continue

        ***REMOVED*** Check schedule conflicts
        ...
        ***REMOVED*** Calculate fairness impact
...
***REMOVED******REMOVED******REMOVED*** Ranking Algorithm
    ...
    for candidate in candidates:
        ...
        ***REMOVED*** Reciprocity (0-3 points)
        ...
        scored.append({
            "candidate": candidate,
            "score": score,
            "rank": None  ***REMOVED*** Will be assigned after sorting
        })

    ***REMOVED*** Sort by score (descending)
    scored.sort(key=lambda x: x["score"], reverse=True)

    ***REMOVED*** Assign ranks
...
***REMOVED******REMOVED*** Validation and Rollback

***REMOVED******REMOVED******REMOVED*** Pre-Execution Validation
...
def validate_swap_before_execution(swap):
    ...
    ***REMOVED*** Gate 3: User confirmation
    validations.append({
    ...
    ***REMOVED*** Gate 4: Rollback window
    validations.append({
...
***REMOVED******REMOVED******REMOVED*** Post-Execution Verification
...
def rollback_swap(swap_id, reason):
    ...
    ***REMOVED*** Backup current state (before rollback)
    ...
    try:
        ...
        ***REMOVED*** Verify reversal
        verification = verify_rollback(swap)

        if verification.verified:
            ***REMOVED*** Mark swap as rolled back
            ...
            ***REMOVED*** Rollback failed, restore from backup
...
***REMOVED******REMOVED******REMOVED*** Surgical Swap Decision Tree
