...
***REMOVED******REMOVED******REMOVED*** Example 1: 80-Hour Rule Violation Detection
...
**Output:**
```markdown
***REMOVED******REMOVED*** ACGME Compliance Violation
...
***REMOVED******REMOVED******REMOVED*** Example 2: Supervision Ratio Pre-Validation
...
**Output:**
```markdown
***REMOVED******REMOVED*** ACGME Supervision Violation
...
***REMOVED******REMOVED******REMOVED*** With schedule-validator (MCP Tool)
**Tool Usage Pattern:**
```bash
***REMOVED*** Get validation data
...
***REMOVED*** If violations found, generate remediation plan
if [ -n "$violations" ]; then
  ***REMOVED*** Use acgme-compliance skill to analyze and propose fixes
  ***REMOVED*** Then call swap_execution or schedule_generation to implement
fi
```
