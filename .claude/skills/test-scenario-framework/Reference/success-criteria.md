***REMOVED*** Success Criteria Reference
...
***REMOVED******REMOVED*** Criteria Categories
...
***REMOVED******REMOVED*** Coverage Criteria

***REMOVED******REMOVED******REMOVED*** Coverage Completeness
...
***REMOVED******REMOVED******REMOVED*** Coverage Gap Duration
...
***REMOVED******REMOVED******REMOVED*** Backup Coverage Depth
...
***REMOVED******REMOVED*** ACGME Compliance Criteria

***REMOVED******REMOVED******REMOVED*** 80-Hour Rule Compliance
...
***REMOVED******REMOVED******REMOVED*** 1-in-7 Day Off Compliance
...
***REMOVED******REMOVED******REMOVED*** Duty Period Limit Compliance
...
***REMOVED******REMOVED******REMOVED*** Post-Call Rest Compliance
...
***REMOVED******REMOVED******REMOVED*** Supervision Ratio Compliance
...
acgme_supervision_ratios:
  pgy1_ratio:
    ...
    max_ratio: 2.0  ***REMOVED*** 2 PGY-1s per 1 faculty
    critical: true

  pgy2_pgy3_ratio:
    metric: residents_pgy2_pgy3 / faculty_count
    max_ratio: 4.0  ***REMOVED*** 4 PGY-2/3s per 1 faculty
    critical: true
```
...
***REMOVED******REMOVED******REMOVED*** Night Float Limit Compliance
...
***REMOVED******REMOVED******REMOVED*** Overall ACGME Compliance
...
***REMOVED******REMOVED*** Performance Criteria
...
execution_time_seconds:
  ...
  critical: false  ***REMOVED*** Performance issue, not correctness
```
...
***REMOVED******REMOVED******REMOVED*** Database Query Count
...
***REMOVED*** Check for outliers (> 2 std dev from mean)
outliers = [h for h in hours_per_resident if abs(h - mean) > 2 * std_dev]
```

***REMOVED******REMOVED******REMOVED*** Utilization Rate
...
***REMOVED******REMOVED******REMOVED*** Schedule Stability
...
***REMOVED******REMOVED*** Operational Criteria

***REMOVED******REMOVED******REMOVED*** Assignment Modification Count
...
***REMOVED******REMOVED******REMOVED*** Persons Affected
...
***REMOVED******REMOVED******REMOVED*** Notification Delivery
...
notification_delivery:
  ...
  thresholds:
    ...
    partial: ≥ 90%
    failure: < 90%
  critical: true  ***REMOVED*** Communication is critical
```
...
***REMOVED******REMOVED******REMOVED*** Audit Trail Completeness
...
***REMOVED******REMOVED*** Data Integrity Criteria

***REMOVED******REMOVED******REMOVED*** No Double Booking
...
def check_double_booking(person, date):
    ...
    for i, a1 in enumerate(assignments):
        for a2 in assignments[i+1:]:
            if a1.overlaps(a2):
                return False  ***REMOVED*** Double booking detected
    return True  ***REMOVED*** No conflicts
```

***REMOVED******REMOVED******REMOVED*** No Orphaned Assignments
...
***REMOVED******REMOVED******REMOVED*** State Consistency
...
***REMOVED******REMOVED******REMOVED*** Idempotency
...
idempotency:
  ...
  critical: true  ***REMOVED*** For deterministic scenarios
...
***REMOVED******REMOVED*** Composite Success Criteria

***REMOVED******REMOVED******REMOVED*** Scenario Pass Definition
...
***REMOVED******REMOVED******REMOVED*** Scenario Fail Definition
...
***REMOVED******REMOVED******REMOVED*** Scenario Warning Definition
...
***REMOVED******REMOVED*** Tolerance Configuration

***REMOVED******REMOVED******REMOVED*** Default Tolerances

```yaml
default_tolerances:
  numeric_percentage: 0.05  ***REMOVED*** 5%
  numeric_absolute: 2       ***REMOVED*** ±2 for counts
  timestamp_seconds: 1      ***REMOVED*** 1 second
  boolean_exact: true       ***REMOVED*** No tolerance for boolean
```

***REMOVED******REMOVED******REMOVED*** Field-Specific Tolerances

```yaml
field_tolerances:
  execution_time_seconds:
    percentage: 0.20  ***REMOVED*** ±20%
    rationale: "System load variance"

  assignments_modified:
    absolute: 3  ***REMOVED*** ±3 assignments
    rationale: "Optimization may vary"

  persons_affected:
    absolute: 2  ***REMOVED*** ±2 persons
    rationale: "Backup chain alternatives"

  weekly_hours:
    absolute: 1.0  ***REMOVED*** ±1 hour
    rationale: "Rounding and partial shifts"
```

***REMOVED******REMOVED******REMOVED*** Scenario-Specific Overrides

```yaml
scenario_type_tolerances:
  n1_failure:
    assignments_modified:
      absolute: 5  ***REMOVED*** Higher tolerance for N-1 scenarios

  integration:
    execution_time_seconds:
      percentage: 0.50  ***REMOVED*** ±50% for complex integration tests
```
...
***REMOVED******REMOVED******REMOVED*** Post-Execution Validation
...
***REMOVED******REMOVED******REMOVED*** Failure Analysis Checklist
