...
***REMOVED******REMOVED*** Category Index
...
***REMOVED******REMOVED*** N-1 Failure Scenarios

***REMOVED******REMOVED******REMOVED*** N1-001: Simple Single Resident Unavailable
...
***REMOVED******REMOVED******REMOVED*** N1-002: Holiday Coverage Failure
...
***REMOVED******REMOVED******REMOVED*** N1-003: Multiple Simultaneous Absences
...
***REMOVED******REMOVED******REMOVED*** N1-004: Backup Chain Cascade
...
***REMOVED******REMOVED******REMOVED*** N1-005: Weekend Coverage Gap
...
***REMOVED******REMOVED******REMOVED*** N1-006: Night Float Replacement
...
***REMOVED******REMOVED******REMOVED*** N1-007: TDY/Deployment Coverage
...
***REMOVED******REMOVED******REMOVED*** N1-008: Post-Call Relief Failure
...
***REMOVED******REMOVED******REMOVED*** N1-009: Supervision Ratio Violation Risk
...
***REMOVED******REMOVED******REMOVED*** N1-010: Cascade Failure Prevention
...
***REMOVED******REMOVED*** Swap Operation Scenarios

***REMOVED******REMOVED******REMOVED*** SWAP-001: Simple One-to-One Swap
...
***REMOVED******REMOVED******REMOVED*** SWAP-002: Multi-Swap Chain
...
***REMOVED******REMOVED******REMOVED*** SWAP-003: Swap Rejected - ACGME Violation
...
***REMOVED******REMOVED******REMOVED*** SWAP-004: Absorb Shift (Give Away)
...
***REMOVED******REMOVED******REMOVED*** SWAP-005: Auto-Match Swap Candidate
...
***REMOVED******REMOVED*** ACGME Edge Case Scenarios

***REMOVED******REMOVED******REMOVED*** ACGME-001: Exact 80-Hour Boundary
...
***REMOVED******REMOVED******REMOVED*** ACGME-002: 1-in-7 Strict Boundary
...
***REMOVED******REMOVED******REMOVED*** ACGME-003: Post-Call 8-Hour Minimum
...
***REMOVED******REMOVED******REMOVED*** ACGME-004: Duty Period 24-Hour Limit
...
***REMOVED******REMOVED******REMOVED*** ACGME-005: Night Float 6-Night Maximum
...
***REMOVED******REMOVED******REMOVED*** ACGME-006: Supervision Ratio PGY-1
...
***REMOVED******REMOVED******REMOVED*** ACGME-007: 4-Week Rolling Average
...
***REMOVED******REMOVED*** Holiday & Vacation Conflict Scenarios

***REMOVED******REMOVED******REMOVED*** HOLIDAY-001: Christmas Coverage Overlap
...
***REMOVED******REMOVED******REMOVED*** HOLIDAY-002: Thanksgiving Week Shortage
...
***REMOVED******REMOVED******REMOVED*** HOLIDAY-003: New Year's Vacation Conflict
...
***REMOVED******REMOVED******REMOVED*** HOLIDAY-004: Last-Minute Leave Cancellation
...
***REMOVED******REMOVED*** Moonlighting Scenarios

***REMOVED******REMOVED******REMOVED*** MOONLIGHT-001: External Moonlighting Hours
...
***REMOVED******REMOVED******REMOVED*** MOONLIGHT-002: Internal Moonlighting
...
***REMOVED******REMOVED******REMOVED*** MOONLIGHT-003: Moonlighting Conflict with Scheduled Duty
...
***REMOVED******REMOVED*** Integration Scenarios

***REMOVED******REMOVED******REMOVED*** INT-001: Full Month Schedule Generation
...
***REMOVED******REMOVED******REMOVED*** INT-002: Concurrent Multi-Swap with N-1 Failure
...
***REMOVED******REMOVED*** Using Scenarios

***REMOVED******REMOVED******REMOVED*** Run Single Scenario

```bash
***REMOVED*** Run specific scenario by ID
...
***REMOVED*** Capture artifacts for debugging
pytest -m scenario -k "n1-simple-unavailable-001" --capture-artifacts
```

***REMOVED******REMOVED******REMOVED*** Run Category of Scenarios

```bash
***REMOVED*** Run all N-1 scenarios
pytest -m scenario -k "n1-"

***REMOVED*** Run all swap scenarios
pytest -m scenario -k "swap-"

***REMOVED*** Run all ACGME edge cases
pytest -m scenario -k "acgme-"

***REMOVED*** Run all holiday scenarios
pytest -m scenario -k "holiday-"

***REMOVED*** Run all moonlighting scenarios
pytest -m scenario -k "moonlight-"

***REMOVED*** Run integration scenarios
pytest -m scenario -k "integration-"
```

***REMOVED******REMOVED******REMOVED*** Run All Scenarios
...
***REMOVED*** Run in parallel (faster)
pytest -m scenario -n auto
```

***REMOVED******REMOVED******REMOVED*** Generate Scenario Report
...
***REMOVED******REMOVED*** Coverage Map

***REMOVED******REMOVED******REMOVED*** ACGME Rules Covered
...
***REMOVED******REMOVED******REMOVED*** Scheduling Operations Covered
- ✅ Assignment creation
...
***REMOVED******REMOVED******REMOVED*** Edge Cases Covered
...
***REMOVED******REMOVED*** Adding New Scenarios

***REMOVED******REMOVED******REMOVED*** Scenario Template
...
***REMOVED******REMOVED******REMOVED*** Submit New Scenario
