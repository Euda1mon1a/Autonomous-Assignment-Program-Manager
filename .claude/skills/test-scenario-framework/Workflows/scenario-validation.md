...
***REMOVED******REMOVED*** Validation Types

***REMOVED******REMOVED******REMOVED*** 1. Boolean Validation
...
***REMOVED******REMOVED******REMOVED*** 2. Numeric Validation with Tolerance
...
def validate_numeric(
    ...
    ***REMOVED*** Check exact match with tolerance
    if expected is not None:
        if tolerance is not None:
            ***REMOVED*** Absolute tolerance
...
***REMOVED******REMOVED******REMOVED*** 3. String Validation
...
def validate_string(
    actual: str,
    expected: str,
    match_type: str = "exact",  ***REMOVED*** exact | contains | regex | case_insensitive
    critical: bool = False
) -> ValidationResult:
...
***REMOVED******REMOVED******REMOVED*** 4. Collection Validation

```python
def validate_collection(
    actual: list,
    expected: list,
    match_type: str = "exact",  ***REMOVED*** exact | subset | superset | contains_all
...
***REMOVED******REMOVED******REMOVED*** 5. State Comparison Validation
...
def validate_state_change(
    ...
    post_state: dict,
    field_path: str,
    expected_change: str,  ***REMOVED*** increased | decreased | unchanged | changed
    ...
    ***REMOVED*** Extract field values using dot notation
...
***REMOVED******REMOVED*** Output Comparison Strategies

***REMOVED******REMOVED******REMOVED*** Strict Comparison
...
class StrictComparator:
    ...
    def compare(self, expected: dict, actual: dict) -> ComparisonResult:
        ...
        ***REMOVED*** Check for unexpected keys
...
***REMOVED******REMOVED******REMOVED*** Lenient Comparison
...
class LenientComparator:
    ...
    def compare(self, expected: dict, actual: dict) -> ComparisonResult:
        ...
        for key, expected_value in expected.items():
            ...
            ***REMOVED*** Numeric comparison with tolerance
            ...
            ***REMOVED*** Timestamp comparison with tolerance
            ...
            ***REMOVED*** Exact comparison for other types
            elif expected_value != actual_value:
                mismatches.append(
                    f"{key}: expected {expected_value}, got {actual_value}"
                )

        ***REMOVED*** Extra fields are allowed in lenient mode
...
***REMOVED******REMOVED******REMOVED*** Custom Comparison
...
***REMOVED******REMOVED*** Tolerance Thresholds
...
validation:
  tolerances:
    ***REMOVED*** Numeric tolerances
    numeric_percentage: 0.05      ***REMOVED*** 5% tolerance for numeric values
    numeric_absolute: 2           ***REMOVED*** ±2 for integer counts

    ***REMOVED*** Temporal tolerances
    timestamp_seconds: 1          ***REMOVED*** 1 second for timestamps
    date_days: 0                  ***REMOVED*** Exact date match

    ***REMOVED*** Collection tolerances
    collection_size_percentage: 0.1  ***REMOVED*** 10% size difference allowed
    collection_order_matters: false

    ***REMOVED*** Field-specific tolerances
    field_overrides:
      execution_time_seconds:
        numeric_percentage: 0.20  ***REMOVED*** 20% tolerance for execution time
      assignments_modified:
        numeric_absolute: 3       ***REMOVED*** ±3 assignments OK
```

***REMOVED******REMOVED******REMOVED*** Applying Tolerances
...
class ToleranceValidator:
    ...
    def validate_with_tolerance(
        ...
        if isinstance(expected, (int, float)):
            ...
            ***REMOVED*** Convert to numeric seconds and validate
            ...
            ***REMOVED*** Exact match for non-numeric types
            passed = actual == expected
            return ValidationResult(
...
***REMOVED******REMOVED*** Partial Match Handling

***REMOVED******REMOVED******REMOVED*** Partial Match Rules

```yaml
validation:
  partial_match:
    ***REMOVED*** Allow extra items in collections
    allow_extra_assignments: true
    allow_extra_persons: false

    ***REMOVED*** Allow missing items
    allow_missing_assignments: false
    allow_missing_persons: false

    ***REMOVED*** Order sensitivity
    require_exact_order: false
    require_sorted_order: true  ***REMOVED*** Can be different order if sortable
```
...
class PartialMatchValidator:
    ...
    def validate_collection_partial(
        ...
        ***REMOVED*** Check for missing items
...
***REMOVED******REMOVED*** Failure Categorization

***REMOVED******REMOVED******REMOVED*** Failure Types

```python
class FailureCategory(Enum):
    """Categories for validation failures."""

    CRITICAL = "critical"              ***REMOVED*** Must-pass assertion failed
    ASSERTION_FAILED = "assertion"     ***REMOVED*** Expected outcome not met
    STATE_INCONSISTENCY = "state"      ***REMOVED*** Final state invalid
    PERFORMANCE = "performance"        ***REMOVED*** Performance threshold exceeded
    TIMEOUT = "timeout"                ***REMOVED*** Operation timed out
    ERROR = "error"                    ***REMOVED*** Execution error occurred
```

***REMOVED******REMOVED******REMOVED*** Categorize Failures
...
***REMOVED******REMOVED******REMOVED*** Failure Report
...
***REMOVED******REMOVED*** Complete Validation Function
...
async def validate_scenario_complete(
    ...
    ***REMOVED*** Validate state changes
    ...
    ***REMOVED*** Determine overall pass/fail
    ...
    ***REMOVED*** Generate failure report
...
***REMOVED******REMOVED******REMOVED*** Validate Single Assertion

```python
***REMOVED*** Validate boolean assertion
result = validate_boolean(
...
***REMOVED******REMOVED******REMOVED*** Validate with Tolerance

```python
***REMOVED*** Validate numeric with tolerance
result = validate_numeric(
    actual=execution_result["assignments_modified"],
    expected=5,
    tolerance=2,  ***REMOVED*** Accept 3-7
    critical=False
)
```

***REMOVED******REMOVED******REMOVED*** Custom Validator

```python
***REMOVED*** Define custom validator
async def validate_backup_chain(
    ...
    ***REMOVED*** Check all assignments have backup coverage
