...
***REMOVED*** Schedule Verification Skill
...
***REMOVED******REMOVED*** MANDATORY: Generate Visible Report
...
***REMOVED******REMOVED******REMOVED*** 1. Faculty FMIT Schedule
...
***REMOVED******REMOVED******REMOVED*** 2. Resident Inpatient Assignments
...
***REMOVED******REMOVED******REMOVED*** 3. Call Schedule Equity
...
***REMOVED******REMOVED******REMOVED*** 4. Absence Handling
...
***REMOVED******REMOVED******REMOVED*** 5. Coverage Metrics
...
***REMOVED******REMOVED*** Spot Check Protocol

For any generated schedule, spot check **at least 3 people** of each type:

***REMOVED******REMOVED******REMOVED*** Faculty Spot Check
...
***REMOVED******REMOVED******REMOVED*** Resident Spot Check
...
***REMOVED******REMOVED*** Query Templates

***REMOVED******REMOVED******REMOVED*** Check FMIT Faculty Schedule
```sql
...
***REMOVED******REMOVED******REMOVED*** Check Night Float Headcount
```sql
...
***REMOVED******REMOVED******REMOVED*** Check for Absence Conflicts
```sql
...
***REMOVED******REMOVED*** Red Flags (Stop and Investigate)
...
***REMOVED******REMOVED******REMOVED*** Example 1: Clean Schedule Verification
...
***REMOVED******REMOVED******REMOVED*** Example 2: Schedule with Issues Requiring Fix
...
***REMOVED******REMOVED******REMOVED*** Example 3: Quick Spot Check
