...
***REMOVED******REMOVED*** Deployment Pattern

***REMOVED******REMOVED******REMOVED*** Standard Deployment: 8 QA Agents
...
***REMOVED******REMOVED******REMOVED*** Extended Deployment: 12 QA Agents
...
***REMOVED******REMOVED******REMOVED*** Full Deployment (8 agents)
...
***REMOVED******REMOVED******REMOVED*** Quick Deployment (4 agents)
...
***REMOVED******REMOVED******REMOVED*** Extended Deployment (12 agents)
...
***REMOVED******REMOVED******REMOVED*** Single Domain
...
***REMOVED******REMOVED*** Spawn Pattern

```python
***REMOVED*** Deploy all 8 QA agents in parallel
***REMOVED*** Wall-clock = slowest agent timeout
...
***REMOVED******REMOVED******REMOVED*** Per-Agent Report

Each QA agent reports:

```markdown
***REMOVED******REMOVED*** QA Agent: [NAME]
...
***REMOVED******REMOVED******REMOVED*** Errors (if any)
```
[error output]
```
...
***REMOVED******REMOVED******REMOVED*** Consolidated Dashboard

```markdown
***REMOVED******REMOVED*** QA_PARTY Validation Dashboard
...
***REMOVED******REMOVED******REMOVED*** Overall: 6/8 PASS (75%)
...
***REMOVED******REMOVED******REMOVED*** Non-Blocking Issues
[None]

***REMOVED******REMOVED******REMOVED*** Recommended CCW Tasks
...
***REMOVED******REMOVED******REMOVED*** Minimum Viable QA
...
***REMOVED******REMOVED*** Integration with CCW

***REMOVED******REMOVED******REMOVED*** Pre-CCW Validation
```
/qa-party --quick
```
Establish baseline before CCW burns tasks.

***REMOVED******REMOVED******REMOVED*** Post-CCW Validation
```
/qa-party --full
```
Comprehensive validation after CCW completes.

***REMOVED******REMOVED******REMOVED*** Report to CCW
After running `/qa-party`, generate CCW directive:

```markdown
***REMOVED******REMOVED*** CCW Task from QA_PARTY
...
***REMOVED******REMOVED******REMOVED*** Skill vs Subagent Types
...
***REMOVED******REMOVED******REMOVED*** Oversight Hierarchy
...
***REMOVED******REMOVED******REMOVED*** Coordinator Responsibilities
...
***REMOVED******REMOVED******REMOVED*** Coordinator Spawn Pattern

```python
***REMOVED*** ORCHESTRATOR spawns COORD_QUALITY who spawns 12 G-2s
Task(
    subagent_type="general-purpose",
    description="COORD_QUALITY: QA_PARTY Commander",
    prompt="""
***REMOVED******REMOVED*** Agent: COORD_QUALITY
...
***REMOVED******REMOVED*** Your IG Teams to Deploy
...
***REMOVED******REMOVED*** Spawn all 12 in parallel using Task tool with subagent_type="general-purpose"
...
***REMOVED******REMOVED******REMOVED*** IG Team Spawn Pattern (Each Team Deploys 10 Workers)

```python
***REMOVED*** Example: QA-IG-BACKEND-ROUTES spawning 10 workers
Task(
    subagent_type="general-purpose",
    description="QA-IG-BACKEND-ROUTES",
    prompt="""
***REMOVED******REMOVED*** Agent: QA-IG-BACKEND-ROUTES
...
***REMOVED******REMOVED*** Scaled Deployment: 120 QA Agents

***REMOVED******REMOVED******REMOVED*** How to Get 120 QA Testers Going
...
***REMOVED******REMOVED******REMOVED*** Discovery Phase (Run First)

Before spawning 120 agents, discover test targets:

```bash
***REMOVED*** Backend: Find all test files
find backend/tests -name "test_*.py" -type f | wc -l  ***REMOVED*** ~60 files

***REMOVED*** Frontend: Find all test files
find frontend/__tests__ -name "*.test.ts" -o -name "*.test.tsx" | wc -l  ***REMOVED*** ~50 files

***REMOVED*** Frontend: Find untested components
find frontend/src/components -name "*.tsx" | wc -l  ***REMOVED*** ~254 components
```

***REMOVED******REMOVED******REMOVED*** Scaled Spawn Pattern

```python
***REMOVED*** Phase 1: Discover test files
import subprocess
...
***REMOVED*** Phase 2: Generate 120 parallel tasks
tasks = []

***REMOVED*** 60 backend test agents (one per file)
...
***REMOVED*** 50 frontend test agents (one per file)
...
***REMOVED*** 10 component batch agents (25 components each)
...
***REMOVED*** Spawn all 120 in parallel
spawn_parallel(tasks)
```

***REMOVED******REMOVED******REMOVED*** Alternative: Pytest-xdist Native Parallelism

If you want pytest's native parallelism instead of Task tool parallelism:

```bash
***REMOVED*** Install pytest-xdist
pip install pytest-xdist

***REMOVED*** Run with 120 parallel workers
cd backend
...
***REMOVED******REMOVED******REMOVED*** Hybrid Approach: 12 IG Teams × 10 Test Slices
...
***REMOVED******REMOVED******REMOVED*** Practical Limits
...
***REMOVED******REMOVED******REMOVED*** CRITICAL: IDE Crash Prevention
