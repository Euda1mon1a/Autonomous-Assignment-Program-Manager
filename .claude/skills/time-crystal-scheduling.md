...
***REMOVED*** Time Crystal Scheduling Skill
...
***REMOVED******REMOVED******REMOVED*** Time Crystal Objective Function
...
***REMOVED******REMOVED******REMOVED*** Rigidity Score
...
***REMOVED******REMOVED******REMOVED*** Subharmonic Periods
...
***REMOVED******REMOVED*** Module Location

```
backend/app/scheduling/periodicity/
├── __init__.py              ***REMOVED*** Module exports
├── anti_churn.py            ***REMOVED*** Rigidity scoring, time crystal objective
├── subharmonic_detector.py  ***REMOVED*** Cycle detection via autocorrelation
└── stroboscopic_manager.py  ***REMOVED*** Checkpoint-based state management
```

***REMOVED******REMOVED*** Key Functions

***REMOVED******REMOVED******REMOVED*** Anti-Churn Analysis
...
***REMOVED*** Compare two schedules
rigidity = calculate_schedule_rigidity(new_schedule, current_schedule)
***REMOVED*** Returns 0.0-1.0 (1.0 = identical)

***REMOVED*** Get detailed impact
impact = estimate_churn_impact(current, proposed)
***REMOVED*** Returns: total_changes, affected_people, severity, recommendation
```

***REMOVED******REMOVED******REMOVED*** Periodicity Detection
...
***REMOVED*** Find natural cycles
cycles = detect_subharmonics(assignments, base_period=7)
***REMOVED*** Returns: [7, 14, 28] - detected cycle lengths in days

***REMOVED*** Full analysis
report = analyze_periodicity(assignments)
***REMOVED*** Returns: PeriodicityReport with strength, patterns, recommendations
```

***REMOVED******REMOVED******REMOVED*** Stroboscopic State Management
...
***REMOVED*** Propose draft changes
await manager.propose_draft(new_assignments)

***REMOVED*** Advance checkpoint (makes draft authoritative)
await manager.advance_checkpoint(CheckpointBoundary.WEEK_START)

***REMOVED*** Get stable state (what observers see)
...
***REMOVED******REMOVED******REMOVED*** Check if Schedule Regeneration is Safe
...
***REMOVED******REMOVED******REMOVED*** Preserve Natural Patterns
...
***REMOVED*** Configure optimizer to preserve detected patterns
optimizer_config = {
