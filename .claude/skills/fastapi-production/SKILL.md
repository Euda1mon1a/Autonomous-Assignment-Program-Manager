...
***REMOVED*** FastAPI Production Patterns Skill
...
***REMOVED******REMOVED*** Project Architecture

```
backend/app/
├── api/
│   ├── deps.py          ***REMOVED*** Dependency injection
│   └── routes/          ***REMOVED*** API endpoints
├── controllers/         ***REMOVED*** Request/response handling
├── services/            ***REMOVED*** Business logic
├── repositories/        ***REMOVED*** Data access (optional)
├── models/              ***REMOVED*** SQLAlchemy ORM
...
***REMOVED******REMOVED*** Route Patterns

***REMOVED******REMOVED******REMOVED*** Standard CRUD Endpoint
...
***REMOVED******REMOVED*** Pydantic Schema Patterns

***REMOVED******REMOVED******REMOVED*** Request/Response Separation
...
***REMOVED*** Base schema with shared fields
...
***REMOVED*** Create schema - fields required for creation
class ScheduleCreate(ScheduleBase):
    description: Optional[str] = None


***REMOVED*** Update schema - all fields optional
...
***REMOVED*** Response schema - includes DB fields
...
***REMOVED*** List response with pagination
...
***REMOVED******REMOVED******REMOVED*** Nested Schemas
...
***REMOVED******REMOVED*** Service Layer Patterns

***REMOVED******REMOVED******REMOVED*** Service Structure
...
***REMOVED******REMOVED******REMOVED*** Business Logic with Validation
...
class AssignmentService:
    ...
    async def create_assignment(
        ...
        ***REMOVED*** Check existing assignments for conflicts
...
***REMOVED******REMOVED*** Database Query Patterns

***REMOVED******REMOVED******REMOVED*** Eager Loading (Prevent N+1)
...
***REMOVED******REMOVED******REMOVED*** Complex Queries
...
async def update_with_lock(
    ...
    result = await db.execute(
        ...
        .with_for_update()  ***REMOVED*** Lock the row
    )
...
***REMOVED******REMOVED******REMOVED*** Custom Exception Classes

```python
***REMOVED*** app/core/exceptions.py
...
```python
***REMOVED*** app/api/exception_handlers.py
...
***REMOVED*** Register in main.py
app.add_exception_handler(AppException, app_exception_handler)
```

***REMOVED******REMOVED*** Dependency Injection

***REMOVED******REMOVED******REMOVED*** Database Session

```python
***REMOVED*** app/api/deps.py
...
***REMOVED******REMOVED******REMOVED*** Current User
...
***REMOVED******REMOVED******REMOVED*** Role-Based Access
...
***REMOVED******REMOVED******REMOVED*** FastAPI Background Tasks
...
***REMOVED******REMOVED******REMOVED*** Celery Integration
...
@router.get("/stats")
@cache(expire=300)  ***REMOVED*** Cache for 5 minutes
async def get_stats(db: AsyncSession = Depends(get_db)):
    """Get cached statistics."""
    return await stats_service.calculate(db)
```

***REMOVED******REMOVED******REMOVED*** Streaming Responses
