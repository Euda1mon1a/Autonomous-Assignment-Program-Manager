...
***REMOVED******REMOVED*** Documentation Template

***REMOVED******REMOVED******REMOVED*** Session Summary (`docs/sessions/SESSION_YYYY-MM-DD_TOPIC.md`)

```markdown
***REMOVED*** Session: [Topic]
...
***REMOVED******REMOVED*** Architecture Reference Files

Create these when session involves system behavior:

***REMOVED******REMOVED******REMOVED*** Activity Types (`docs/architecture/ACTIVITY_TYPES.md`)
- Classification table
- Solver handling rules
- Template examples

***REMOVED******REMOVED******REMOVED*** Constraints (`docs/architecture/*_CONSTRAINTS.md`)
- Constraint class descriptions
- Registration requirements
- Validation rules

***REMOVED******REMOVED******REMOVED*** Flow Diagrams (`docs/architecture/*_FLOW.md`)
- Mermaid diagrams
...
***REMOVED******REMOVED*** Required Sections
...
***REMOVED******REMOVED*** Parallel Documentation

Create multiple docs simultaneously:

```python
***REMOVED*** Launch parallel file creation
...
***REMOVED******REMOVED*** File Naming Conventions
...
***REMOVED******REMOVED*** Post-Documentation Checklist
