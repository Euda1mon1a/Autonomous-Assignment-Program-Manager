...
***REMOVED*** Import Block Schedule Skill
...
```bash
***REMOVED*** Parse block 10 and show roster (Rich table output)
...
***REMOVED******REMOVED******REMOVED*** Residents by Template
...
***REMOVED******REMOVED******REMOVED*** FMIT Schedule
...
***REMOVED******REMOVED******REMOVED*** Confidence Scores
