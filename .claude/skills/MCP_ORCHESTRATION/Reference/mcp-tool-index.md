***REMOVED*** MCP Tool Index

Complete catalog of all 36 MCP tools with input/output schemas, use cases, and dependencies.

***REMOVED******REMOVED*** Tool Categories

- [Core Scheduling Tools](***REMOVED***core-scheduling-tools) (5 tools)
- [Resilience Framework Tools](***REMOVED***resilience-framework-tools) (13 tools)
- [Background Task Management](***REMOVED***background-task-management) (4 tools)
- [Deployment Workflow Tools](***REMOVED***deployment-workflow-tools) (7 tools)
- [Empirical Testing Tools](***REMOVED***empirical-testing-tools) (5 tools)
- [Resource Tools](***REMOVED***resource-tools) (2 tools)

---

***REMOVED******REMOVED*** Core Scheduling Tools

***REMOVED******REMOVED******REMOVED*** 1. validate_schedule_tool
...
```python
{
    "start_date": str,           ***REMOVED*** YYYY-MM-DD format
    "end_date": str,             ***REMOVED*** YYYY-MM-DD format
    "check_work_hours": bool,    ***REMOVED*** Default: True
    "check_supervision": bool,   ***REMOVED*** Default: True
    "check_rest_periods": bool,  ***REMOVED*** Default: True
    "check_consecutive_duty": bool  ***REMOVED*** Default: True
}
```
...
***REMOVED******REMOVED******REMOVED*** 2. validate_schedule_by_id_tool
...
```python
{
    "schedule_id": str,              ***REMOVED*** UUID or alphanumeric ID
    "constraint_config": str,        ***REMOVED*** "default", "minimal", "strict", "resilience"
    "include_suggestions": bool      ***REMOVED*** Default: True
}
```
...
***REMOVED******REMOVED******REMOVED*** 3. detect_conflicts_tool
...
```python
{
    ...
    "conflict_types": list[str] | None,  ***REMOVED*** Filter specific types
    "include_auto_resolution": bool  ***REMOVED*** Default: True
}
```
...
***REMOVED******REMOVED******REMOVED*** 4. analyze_swap_candidates_tool
...
```python
{
    ...
    "assignment_id": str,
    "preferred_start_date": str | None,  ***REMOVED*** YYYY-MM-DD
    "preferred_end_date": str | None,    ***REMOVED*** YYYY-MM-DD
    "max_candidates": int                ***REMOVED*** Default: 10, max: 50
}
```
...
SwapCandidate:
{
    ...
    "match_score": float,       ***REMOVED*** 0.0-1.0
    "rotation": str,
    "date_range": tuple[date, date],
...
***REMOVED******REMOVED******REMOVED*** 5. run_contingency_analysis_tool
...
```python
{
    "scenario": str,              ***REMOVED*** "faculty_absence", "resident_absence",
                                  ***REMOVED*** "emergency_coverage", "mass_absence"
    "affected_person_ids": list[str],
    "start_date": str,            ***REMOVED*** YYYY-MM-DD
    "end_date": str,              ***REMOVED*** YYYY-MM-DD
    "auto_resolve": bool          ***REMOVED*** Default: False
}
```
...
ImpactAssessment:
{
    ...
    "feasibility_score": float,  ***REMOVED*** 0.0-1.0
...
ResolutionOption:
{
    ...
    "estimated_effort": str,     ***REMOVED*** "low", "medium", "high"
    "success_probability": float  ***REMOVED*** 0.0-1.0
}
```
...
***REMOVED******REMOVED*** Resilience Framework Tools

***REMOVED******REMOVED******REMOVED*** 6. check_utilization_threshold_tool
...
```python
{
    ...
    "required_blocks": int,
    "blocks_per_faculty_per_day": float,  ***REMOVED*** Default: 2.0
    "days_in_period": int                 ***REMOVED*** Default: 1
}
```
...
```python
{
    "level": str,                  ***REMOVED*** "green", "yellow", "orange", "red", "black"
    "utilization_rate": float,     ***REMOVED*** 0.0-1.0
    ...
    "severity": str               ***REMOVED*** "healthy", "warning", "critical", "emergency"
}
```
...
***REMOVED******REMOVED******REMOVED*** 7. get_defense_level_tool
...
```python
{
    "coverage_rate": float  ***REMOVED*** 0.0-1.0
}
```
...
```python
{
    "current_level": str,      ***REMOVED*** "prevention", "control", "safety_systems",
                               ***REMOVED*** "containment", "emergency"
    "recommended_level": str,
    "status": str,             ***REMOVED*** "ready", "active", "degraded"
    "active_actions": list[dict],
    "automation_status": dict[str, bool],
    "escalation_needed": bool,
    "coverage_rate": float,
    "severity": str            ***REMOVED*** "normal", "elevated", "critical"
}
```
...
***REMOVED******REMOVED******REMOVED*** 8. run_contingency_analysis_resilience_tool
...
```python
{
    "analyze_n1": bool,                    ***REMOVED*** Default: True
    "analyze_n2": bool,                    ***REMOVED*** Default: True
    "include_cascade_simulation": bool,    ***REMOVED*** Default: False
    "critical_faculty_only": bool          ***REMOVED*** Default: True
}
```
...
```python
{
    ...
    "phase_transition_risk": str,  ***REMOVED*** "low", "medium", "high", "critical"
    "leading_indicators": list[str],
    "recommended_actions": list[str],
    "severity": str                ***REMOVED*** "healthy", "vulnerable", "critical"
}
```
...
***REMOVED******REMOVED******REMOVED*** 9. get_static_fallbacks_tool
...
{
    "scenario": str,          ***REMOVED*** "single_absence", "dual_absence", "pcs_season", etc.
    "is_active": bool,
...
***REMOVED******REMOVED******REMOVED*** 10. execute_sacrifice_hierarchy_tool
...
```python
{
    "target_level": str,      ***REMOVED*** "normal", "yellow", "orange", "red", "black"
    "simulate_only": bool     ***REMOVED*** Default: True
}
```
...
***REMOVED******REMOVED******REMOVED*** 11-18. Additional Resilience Tools
...
***REMOVED******REMOVED*** Background Task Management

***REMOVED******REMOVED******REMOVED*** 19. start_background_task_tool
...
```python
{
    "task_type": str,           ***REMOVED*** See TaskType enum
    "params": dict | None       ***REMOVED*** Task-specific parameters
}
```
...
***REMOVED******REMOVED******REMOVED*** 20. get_task_status_tool
...
{
    "task_id": str,
    "status": str,        ***REMOVED*** "pending", "started", "success", "failure", "revoked"
    "progress": int,      ***REMOVED*** 0-100
    "result": any | None,
    "error": str | None,
...
***REMOVED******REMOVED******REMOVED*** 21. cancel_task_tool
...
***REMOVED******REMOVED******REMOVED*** 22. list_active_tasks_tool
...
```python
{
    "task_type": str | None  ***REMOVED*** Optional filter
}
```
...
***REMOVED******REMOVED*** Deployment Workflow Tools

***REMOVED******REMOVED******REMOVED*** 23. validate_deployment_tool
...
```python
{
    "environment": str,         ***REMOVED*** "staging" or "production"
    "git_ref": str,
    "dry_run": bool,            ***REMOVED*** Default: False
    "skip_tests": bool,         ***REMOVED*** Default: False
    "skip_security_scan": bool  ***REMOVED*** Default: False
}
```
...
***REMOVED******REMOVED******REMOVED*** 24. run_security_scan_tool
...
{
    "git_ref": str,
    "scan_dependencies": bool,  ***REMOVED*** Default: True
    "scan_code": bool,          ***REMOVED*** Default: True
    "scan_secrets": bool,       ***REMOVED*** Default: True
    "dry_run": bool             ***REMOVED*** Default: False
}
```
...
***REMOVED******REMOVED******REMOVED*** 25-29. Additional Deployment Tools
...
***REMOVED******REMOVED*** Empirical Testing Tools

***REMOVED******REMOVED******REMOVED*** 30. benchmark_solvers_tool
...
```python
{
    "solvers": list[str] | None,  ***REMOVED*** Default: all
    "scenario_count": int,         ***REMOVED*** Default: 10
    "timeout_per_run": int         ***REMOVED*** Default: 60 seconds
}
```
...
***REMOVED******REMOVED******REMOVED*** 31-34. Additional Empirical Tools
...
***REMOVED******REMOVED*** Resource Tools

***REMOVED******REMOVED******REMOVED*** 35. schedule_status_resource
...
```python
{
    "start_date": str | None,  ***REMOVED*** Default: today
    "end_date": str | None     ***REMOVED*** Default: 30 days from start
}
```
...
***REMOVED******REMOVED******REMOVED*** 36. compliance_summary_resource
...
***REMOVED******REMOVED*** Tool Dependency Matrix
...
***REMOVED******REMOVED*** Research-to-Tool Conversions (3 tools)

New tools that bridge research into actionable functionality.

***REMOVED******REMOVED******REMOVED*** 37. calculate_shapley_workload_tool
...
```python
{
    "faculty_ids": list[str],    ***REMOVED*** Faculty IDs to analyze (minimum 2)
    "start_date": str,           ***REMOVED*** YYYY-MM-DD format
    "end_date": str,             ***REMOVED*** YYYY-MM-DD format
    "num_samples": int           ***REMOVED*** Monte Carlo samples (100-10000, default 1000)
}
```
...
```python
{
    ...
    "results": {
        "<faculty_id>": {
            "shapley_value": float,        ***REMOVED*** 0-1, normalized contribution
            "marginal_contribution": float, ***REMOVED*** Blocks covered uniquely
            "fair_workload_target": float,  ***REMOVED*** Hours based on Shapley
            "current_workload": float,      ***REMOVED*** Actual hours
            "equity_gap": float             ***REMOVED*** +/- from fair
        }
    },
    "summary": {
...
***REMOVED******REMOVED******REMOVED*** 38. detect_critical_slowing_down_tool
...
```python
{
    "utilization_history": list[float],  ***REMOVED*** Daily utilization (0.0-1.0)
    "coverage_history": list[float] | None,  ***REMOVED*** Optional coverage rates
    "days_lookback": int                 ***REMOVED*** Days to analyze (default: 60)
}
```
...
{
    "status": str,
    "is_critical": bool,           ***REMOVED*** Approaching critical point?
    "warning_level": str,          ***REMOVED*** GREEN/YELLOW/ORANGE/RED
    "confidence": float,           ***REMOVED*** 0-1
    "data_quality": str,           ***REMOVED*** excellent/good/fair/poor
    "signals_triggered": int,      ***REMOVED*** 0-3 early warning signals
    "triggered_signals": list[str],
    "estimated_days_to_critical": int | None,
    "metrics": {
        "relaxation_time_hours": float,   ***REMOVED*** Target: < 48
        "variance_slope": float,          ***REMOVED*** Target: < 0.1
        "autocorrelation_ac1": float,     ***REMOVED*** Target: < 0.7
...
***REMOVED******REMOVED******REMOVED*** 39. detect_schedule_changepoints_tool
...
```python
{
    "daily_values": list[float],  ***REMOVED*** Daily workload values
    "dates": list[str],           ***REMOVED*** YYYY-MM-DD format
    "methods": list[str] | None   ***REMOVED*** ["cusum", "pelt"] (default: both)
}
```
...
ChangePoint:
{
    "index": int,
    "timestamp": str,
    "change_type": str,    ***REMOVED*** mean_shift_upward, mean_shift_downward, segment_boundary
    "magnitude": float,
    "confidence": float,   ***REMOVED*** 0-1
    "description": str
}
