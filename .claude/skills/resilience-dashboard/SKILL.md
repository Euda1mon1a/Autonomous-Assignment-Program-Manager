...
***REMOVED******REMOVED*** Overall Status: [GREEN/YELLOW/ORANGE/RED/BLACK]

[1-2 sentence executive summary]

---

***REMOVED******REMOVED******REMOVED*** Critical Index: [0-100]
...
***REMOVED******REMOVED******REMOVED*** Burnout Epidemic Status
...
***REMOVED******REMOVED******REMOVED*** Capacity Status
...
***REMOVED******REMOVED*** Tool Orchestration Details

***REMOVED******REMOVED******REMOVED*** MCP Tools Called
...
***REMOVED******REMOVED******REMOVED*** Status Determination Logic
...
***REMOVED******REMOVED******REMOVED*** Example 1: Healthy Program
...
***REMOVED******REMOVED******REMOVED*** Example 2: Elevated Risk
...
***REMOVED******REMOVED*** Overall Status: ORANGE
...
***REMOVED******REMOVED******REMOVED*** Critical Index: 58
...
***REMOVED******REMOVED******REMOVED*** Example 3: Crisis Mode
...
***REMOVED******REMOVED*** Overall Status: RED
...
***REMOVED******REMOVED******REMOVED*** Critical Index: 82
...
```markdown
***REMOVED******REMOVED*** Overall Status: YELLOW (Partial Data)
