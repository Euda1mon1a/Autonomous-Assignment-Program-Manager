...
***REMOVED*** ORCHESTRATION_DEBUGGING
...
***REMOVED******REMOVED*** Architecture Context
...
***REMOVED******REMOVED******REMOVED*** Common Failure Points
...
***REMOVED******REMOVED*** Core Debugging Phases
...
***REMOVED******REMOVED******REMOVED*** Phase 2: DIAGNOSIS
...
***REMOVED******REMOVED******REMOVED*** Phase 3: RESOLUTION
**Goal:** Fix the issue
...
***REMOVED******REMOVED******REMOVED*** Phase 4: PREVENTION
...
***REMOVED******REMOVED******REMOVED*** Workflows/incident-review.md
...
***REMOVED******REMOVED******REMOVED*** Workflows/log-analysis.md
...
***REMOVED******REMOVED******REMOVED*** Workflows/root-cause-analysis.md
...
***REMOVED******REMOVED******REMOVED*** Reference/common-failure-patterns.md
...
***REMOVED******REMOVED******REMOVED*** Reference/debugging-checklist.md
...
***REMOVED******REMOVED*** Key Files to Inspect
...
***REMOVED******REMOVED******REMOVED*** Celery Logs
```bash
***REMOVED*** Worker logs
...
***REMOVED*** Check queue status
docker-compose exec redis redis-cli LLEN celery
```

***REMOVED******REMOVED*** Output Format

***REMOVED******REMOVED******REMOVED*** Quick Status Check
```
...
***REMOVED******REMOVED******REMOVED*** Full Incident Report
```markdown
***REMOVED******REMOVED*** INCIDENT REPORT: [Title]
...
***REMOVED******REMOVED******REMOVED*** 1. Preserve Context
```python
***REMOVED*** Bad - loses context
try:
    result = await some_operation()
except Exception:
    raise HTTPException(status_code=500, detail="Operation failed")

***REMOVED*** Good - preserves stack trace
try:
    result = await some_operation()
...
***REMOVED******REMOVED******REMOVED*** 2. Log Diagnostic Information
```python
...
***REMOVED******REMOVED******REMOVED*** 3. Add Request IDs
```python
***REMOVED*** For tracing requests across services
...
***REMOVED******REMOVED*** Escalation Criteria
