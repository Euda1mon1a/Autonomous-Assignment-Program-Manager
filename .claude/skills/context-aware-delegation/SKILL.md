...
***REMOVED*** Context-Aware Delegation Skill
...
***REMOVED******REMOVED*** The Core Model: Context Isolation
...
***REMOVED******REMOVED******REMOVED*** What This Means for You
...
***REMOVED******REMOVED*** Key Insight: Mid-Task Updates Don't Affect Running Agents
...
***REMOVED******REMOVED*** The Golden Rule
...
***REMOVED******REMOVED*** What to Include in Agent Prompts

***REMOVED******REMOVED******REMOVED*** Required Elements Checklist
...
***REMOVED******REMOVED******REMOVED*** Context Transfer Template

```markdown
***REMOVED******REMOVED*** Agent: [AGENT_NAME]
...
***REMOVED******REMOVED*** Anti-Patterns: What NOT to Do

***REMOVED******REMOVED******REMOVED*** Anti-Pattern 1: Assuming Shared Context
...
***REMOVED******REMOVED******REMOVED*** Anti-Pattern 2: Vague File References
...
***REMOVED******REMOVED******REMOVED*** Anti-Pattern 3: Implicit Decisions
...
***REMOVED******REMOVED******REMOVED*** Anti-Pattern 4: Missing Success Criteria
...
***REMOVED******REMOVED*** Prompt Templates by Agent Type

***REMOVED******REMOVED******REMOVED*** SCHEDULER Agent
...
***REMOVED******REMOVED******REMOVED*** QA_TESTER Agent
...
***REMOVED******REMOVED******REMOVED*** ARCHITECT Agent
...
***REMOVED******REMOVED*** Context for Built-in Agent Types
...
***REMOVED******REMOVED******REMOVED*** Using "Access to Current Context" Agents

For `Explore` and `Plan` agents, you can write shorter prompts:

```markdown
***REMOVED******REMOVED*** With Explore agent (HAS context access):

Task(
  prompt="Find where the scheduling conflict we discussed is handled",
  subagent_type="Explore"
)
***REMOVED*** Works because Explore can see prior conversation

***REMOVED******REMOVED*** With general-purpose agent (NO context access):
...
***REMOVED*** Must be explicit because agent starts fresh
```

---

***REMOVED******REMOVED*** Parallel Agent Context Strategy

When spawning multiple agents in parallel, each needs independent context:

```markdown
***REMOVED******REMOVED*** Parallel Spawn Pattern

***REMOVED*** Agent 1: Code Review
Task(
...
***REMOVED*** Agent 2: Security Audit (PARALLEL - different context)
Task(
  description="ARCHITECT: Security review",
  prompt="""
  ***REMOVED******REMOVED*** Agent: ARCHITECT (Security Focus)
...
***REMOVED*** Agent 3: Test Generation (PARALLEL - different context)
Task(
...
***REMOVED******REMOVED*** Result Synthesis: Getting Information Back

Subagents return a single message. Design your prompts to get structured output:

***REMOVED******REMOVED******REMOVED*** Structured Output Request

```markdown
***REMOVED******REMOVED*** Expected Output Format
...
***REMOVED******REMOVED******REMOVED*** Aggregating Multiple Agent Results
