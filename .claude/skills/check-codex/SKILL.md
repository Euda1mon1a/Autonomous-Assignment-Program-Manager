...
***REMOVED*** Check Codex Feedback Skill
...
***REMOVED******REMOVED******REMOVED*** Step 1: Get Current PR

```bash
***REMOVED*** Get PR for current branch
...
echo "Checking Codex feedback for PR ***REMOVED***${PR_NUMBER} on ${REPO}..."
```

***REMOVED******REMOVED******REMOVED*** Step 2: Fetch Codex Comments

```bash
***REMOVED*** Fetch inline review comments from Codex
...
***REMOVED*** Fetch top-level reviews from Codex
...
***REMOVED******REMOVED******REMOVED*** Step 3: Parse Priority Levels
...
***REMOVED******REMOVED******REMOVED*** Step 4: Present Feedback

Output structured feedback in this format:

```markdown
***REMOVED******REMOVED*** Codex Feedback for PR ***REMOVED***[number]

**Branch:** `[branch-name]`
**Status:** [N] comment(s) pending

***REMOVED******REMOVED******REMOVED*** [P1/P2/P3] `[file:line]`
...
***REMOVED******REMOVED*** Codex Bot Identifier
...
***REMOVED******REMOVED******REMOVED*** Default: Current Branch PR
```
/check-codex
```

***REMOVED******REMOVED******REMOVED*** All Open PRs with Codex Feedback
```
/check-codex --all
```
...
***REMOVED******REMOVED******REMOVED*** With `/startup` and `/startupO`
...
***REMOVED******REMOVED******REMOVED*** With RELEASE_MANAGER
...
```markdown
***REMOVED******REMOVED*** Codex Feedback for PR ***REMOVED***491

**Branch:** `claude/repo-cleanup-priorities-MHRhY`
**Status:** 1 comment pending

***REMOVED******REMOVED******REMOVED*** [P2] `docs/changelog.md:3`
...
[View on GitHub](https://github.com/.../pull/491***REMOVED***discussion_r2649434837)
...
```bash
***REMOVED*** Check current PR for Codex feedback
