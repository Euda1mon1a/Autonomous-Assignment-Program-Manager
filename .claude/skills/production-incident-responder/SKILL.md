...
***REMOVED*** Production Incident Responder
...
***REMOVED******REMOVED******REMOVED*** Tier 1: Critical Resilience Tools
...
***REMOVED******REMOVED******REMOVED*** Tier 2: Strategic Tools
| MCP Tool | Purpose | Trigger |
|----------|---------|---------|
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Advanced Analytics
| MCP Tool | Purpose | Trigger |
|----------|---------|---------|
...
***REMOVED******REMOVED******REMOVED*** Level 1: DETECTION (Automated)
...
***REMOVED******REMOVED******REMOVED*** Level 2: DIAGNOSIS (Automated + Human Review)
...
***REMOVED******REMOVED******REMOVED*** Level 3: RESPONSE (Human Approval Required)
...
***REMOVED******REMOVED******REMOVED*** Level 4: RECOVERY (Post-Incident)
...
***REMOVED******REMOVED*** MCP Server Connection
...
***REMOVED*** Ensure backend is running
cd backend
uvicorn app.main:app --reload

***REMOVED*** Start Celery for async operations
./scripts/start-celery.sh both
```

***REMOVED******REMOVED******REMOVED*** MCP Configuration
...
***REMOVED******REMOVED*** Crisis Response Workflows

***REMOVED******REMOVED******REMOVED*** Workflow 1: Faculty Absence Emergency
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Mass Casualty / Deployment Event
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: ACGME Compliance Violation
...
***REMOVED******REMOVED******REMOVED*** ALWAYS Escalate to Human When:
...
***REMOVED******REMOVED******REMOVED*** Can Handle Automatically:
...
***REMOVED******REMOVED*** Response Time Expectations
...
***REMOVED******REMOVED******REMOVED*** Quick Status (for monitoring)
```
...
***REMOVED******REMOVED******REMOVED*** Incident Report (for escalation)
```markdown
***REMOVED******REMOVED*** INCIDENT REPORT
...
***REMOVED******REMOVED******REMOVED*** MCP Analysis Results
...
***REMOVED******REMOVED******REMOVED*** Required Approvals
- [ ] Coordinator approval for fallback activation
- [ ] Medical director review of supervision plan

***REMOVED******REMOVED******REMOVED*** Generated Documentation
- SITREP attached
