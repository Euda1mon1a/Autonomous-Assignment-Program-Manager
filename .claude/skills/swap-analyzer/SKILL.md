...
***REMOVED******REMOVED*** Swap Analysis Framework

***REMOVED******REMOVED******REMOVED*** Phase 1: Swap Type Classification
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Feasibility Analysis
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Recommendation
...
***REMOVED******REMOVED*** Swap Analysis Report

```markdown
***REMOVED******REMOVED*** Swap Feasibility Report

**Swap Type:** [TYPE]
**Requested By:** [NAME]
**Date Requested:** [DATE]

***REMOVED******REMOVED******REMOVED*** Proposed Swap
- Resident A: [Current] → [Proposed]
- Resident B: [Current] → [Proposed]
- Dates: [START] to [END]

***REMOVED******REMOVED******REMOVED*** Feasibility Analysis

***REMOVED******REMOVED******REMOVED******REMOVED*** Rotation Compatibility
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Coverage Impact
...
***REMOVED******REMOVED******REMOVED*** Conditions (if applicable)
1. [Condition 1]
2. [Condition 2]

***REMOVED******REMOVED******REMOVED*** Alternative Suggestions
1. [Alternative 1]
2. [Alternative 2]
```

***REMOVED******REMOVED*** Common Swap Scenarios

***REMOVED******REMOVED******REMOVED*** Scenario 1: One-to-One Procedural Swap
...
***REMOVED******REMOVED******REMOVED*** Scenario 2: Holiday Coverage Request
...
***REMOVED******REMOVED******REMOVED*** Scenario 3: Night Float Swap
...
***REMOVED******REMOVED******REMOVED*** Scenario 4: Last-Minute Absence Coverage
...
***REMOVED******REMOVED*** Integration with swap-execution
...
***REMOVED******REMOVED*** Quick Analysis Commands

```bash
***REMOVED*** Analyze proposed swap
python -m app.swaps.analyzer --resident1=A --resident2=B --dates=START-END

***REMOVED*** Check impact on 80-hour rule
python -m app.swaps.analyzer --resident1=A --rule=80-hour --dates=START-END

***REMOVED*** Simulate swap to see hours impact
