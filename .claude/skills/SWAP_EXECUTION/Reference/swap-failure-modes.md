...
***REMOVED******REMOVED*** 1. Work Hour Creep
...
***REMOVED******REMOVED******REMOVED*** Detection Method
...
def detect_work_hour_creep(swap_request: StructuredSwapRequest) -> bool:
    ...
    ***REMOVED*** Calculate 4-week rolling average AFTER swap
    target_hours_after = calculator.get_4week_average_after_swap(
        ...
        swap_delta=FMIT_WEEK_HOURS  ***REMOVED*** ~60 hours
    )
...
if target_hours_after > 75:
    ***REMOVED*** Suggest alternative weeks with lower utilization
...
***REMOVED******REMOVED*** 2. Continuity Breaks
...
***REMOVED******REMOVED*** 3. Coverage Gaps
...
def detect_coverage_gap(swap_request: StructuredSwapRequest) -> bool:
    ...
    ***REMOVED*** Get coverage levels after swap
    ...
    MINIMUM_FMIT_COVERAGE = 1  ***REMOVED*** At least 1 faculty must cover FMIT
...
if coverage_gap_detected:
    ***REMOVED*** Find replacement candidates
...
***REMOVED******REMOVED*** 4. Moonlighting Conflicts
...
def detect_moonlighting_conflict(swap_request: StructuredSwapRequest) -> dict | None:
    ...
    ***REMOVED*** Query moonlighting assignments for target faculty
...
if moonlighting_conflict:
    ***REMOVED*** Calculate total hours (military duty + moonlighting)
    military_hours = FMIT_WEEK_HOURS  ***REMOVED*** ~60 hours
...
***REMOVED******REMOVED*** 5. Fairness Violations
...
def detect_fairness_violation(swap_request: StructuredSwapRequest) -> dict:
    ...
    ***REMOVED*** Calculate net swap balance for each faculty (last 3 months)
    ...
    ***REMOVED*** Calculate balance after this swap
    source_balance_after = source_balance - 1  ***REMOVED*** Giving away
    target_balance_after = target_balance + 1  ***REMOVED*** Taking on

    ***REMOVED*** Calculate faculty-wide statistics
    ...
    ***REMOVED*** Fairness thresholds
    WARN_THRESHOLD = mean_balance + (1.5 * std_dev)  ***REMOVED*** 1.5 std dev
    VIOLATION_THRESHOLD = mean_balance + (2.0 * std_dev)  ***REMOVED*** 2 std dev
...
if fairness_analysis["violation"]:
    ***REMOVED*** Check if there are less-utilized faculty who could take the week
...
***REMOVED******REMOVED*** Failure Mode Summary Table
...
***REMOVED******REMOVED*** Detection Automation
...
def comprehensive_failure_detection(swap_request: StructuredSwapRequest) -> list[dict]:
    ...
    ***REMOVED*** 4. Moonlighting conflicts
