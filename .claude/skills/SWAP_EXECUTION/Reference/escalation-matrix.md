...
***REMOVED******REMOVED*** Decision Authority Matrix
...
***REMOVED******REMOVED*** Escalation Tier Definitions

***REMOVED******REMOVED******REMOVED*** Tier 1: Auto-Approve (No Human Involvement)
...
def is_auto_approvable(safety_result: SafetyCheckResult) -> bool:
    ...
    """
    ***REMOVED*** Check Tier 1 (hard constraints)
    if safety_result.tier1_violations:
        return False  ***REMOVED*** Any hard constraint violation = no auto-approve

    ***REMOVED*** Check Tier 2 (soft constraints)
    critical_tier2 = [
        "BACK_TO_BACK_FMIT",
        "COVERAGE_GAP",
        "EXTERNAL_CONFLICT"
    ...
    if any(w.code in critical_tier2 for w in safety_result.tier2_warnings):
        return False  ***REMOVED*** Critical soft constraint = escalate

    ***REMOVED*** Check Tier 3 (resilience)
    if safety_result.tier3_metrics.get("utilization_delta", 0) > 0.05:
        return False  ***REMOVED*** >5% degradation = escalate

    ***REMOVED*** Check reason sensitivity
    sensitive_reasons = [
    ...
    if any(r in swap_request.reason.lower() for r in sensitive_reasons):
        return False  ***REMOVED*** Sensitive = escalate for privacy

    return True  ***REMOVED*** All checks passed, auto-approve

***REMOVED*** Execute if auto-approvable
...
***REMOVED******REMOVED******REMOVED*** Tier 2: Coordinator Approval

**When to escalate to Coordinator:**

***REMOVED******REMOVED******REMOVED******REMOVED*** 2.1 Tier 2 Soft Constraint Violations

```python
COORDINATOR_ESCALATION_CODES = [
    "BACK_TO_BACK_FMIT",      ***REMOVED*** Burnout risk
    "COVERAGE_GAP",            ***REMOVED*** Staffing concern
    "IMMINENT_SWAP",           ***REMOVED*** <7 days notice
    "MOONLIGHTING_CONFLICT",   ***REMOVED*** External work overlap
    "FAIRNESS_VIOLATION"       ***REMOVED*** Equity concern
]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2 Multiple Failed Attempts
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.3 Dispute Resolution
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Faculty/Program Director Approval

**When to escalate to Faculty/PD:**

***REMOVED******REMOVED******REMOVED******REMOVED*** 3.1 Sensitive Reasons (Privacy/Accommodation)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3.2 Fellowship Interviews
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3.3 Coverage Gap with No Replacement
...
***REMOVED******REMOVED******REMOVED*** Tier 4: Architect/System Owner Approval

**When to escalate to Architect:**

***REMOVED******REMOVED******REMOVED******REMOVED*** 4.1 Resilience Degradation >10%
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4.2 Large Blast Radius (>10 Assignments Affected)
...
***REMOVED******REMOVED*** Escalation Notification Templates

***REMOVED******REMOVED******REMOVED*** Template 1: Coordinator Escalation
...
def notify_coordinator_approval_needed(swap_request: StructuredSwapRequest, reason: str):
    ...
    **View Details:** [Dashboard Link]
    ...
    send_slack_alert(channel="***REMOVED***swap-approvals", message=body)
```

---

***REMOVED******REMOVED******REMOVED*** Template 2: Program Director Escalation
...
***REMOVED******REMOVED******REMOVED*** Template 3: Architect Escalation
...
***REMOVED******REMOVED*** Escalation SLAs
...
***REMOVED******REMOVED*** Approval Tracking
...
class ApprovalRecord:
    ...
    swap_id: UUID
    approver_role: str  ***REMOVED*** "coordinator" | "program_director" | "architect"
    approver_id: UUID
    approver_name: str
    decision: str  ***REMOVED*** "approved" | "rejected"
...
***REMOVED******REMOVED*** Override Procedures
...
def emergency_override(
    ...
    override_by: User,
    reason: str,
    authorization: str  ***REMOVED*** Command approval reference
) -> None:
    """
    ...
    ***REMOVED*** Execute swap with override flag
