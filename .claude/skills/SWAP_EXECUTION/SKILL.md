...
***REMOVED******REMOVED******REMOVED*** The Five Phases
...
```markdown
***REMOVED******REMOVED*** Swap Execution Report
...
***REMOVED******REMOVED******REMOVED*** Safety Check Results
...
***REMOVED******REMOVED******REMOVED*** Validation Failures
...
***REMOVED******REMOVED******REMOVED*** Execution Failures
...
***REMOVED******REMOVED******REMOVED*** Scenario 1: Simple One-to-One Swap (AUTO-APPROVED)
...
***REMOVED******REMOVED******REMOVED*** Scenario 2: Absorb with Back-to-Back Conflict (REJECTED)
...
***REMOVED******REMOVED******REMOVED*** Scenario 3: Fellowship Interview (ESCALATED)
...
```bash
***REMOVED*** Run swap-specific tests
cd backend
...
***REMOVED******REMOVED*** Rollback Safety
...
```python
***REMOVED*** Check if rollback eligible
