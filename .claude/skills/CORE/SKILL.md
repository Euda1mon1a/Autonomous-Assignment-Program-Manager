***REMOVED*** CORE - Skill Metadata and Routing
...
***REMOVED******REMOVED*** II. AVAILABLE SKILLS

***REMOVED******REMOVED******REMOVED*** A. Domain-Specific Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. ACGME Compliance (`acgme-compliance`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Schedule Optimization (`schedule-optimization`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Swap Management (`swap-management`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Safe Schedule Generation (`safe-schedule-generation`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Schedule Verification (`schedule-verification`)
...
***REMOVED******REMOVED******REMOVED*** B. Security & Compliance Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** 6. Security Audit (`security-audit`)
...
***REMOVED******REMOVED******REMOVED*** C. Development & Code Quality Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** 7. Test Writer (`test-writer`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 8. Code Review (`code-review`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 9. Automated Code Fixer (`automated-code-fixer`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 10. Code Quality Monitor (`code-quality-monitor`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 11. Lint Monorepo (`lint-monorepo`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 12. Systematic Debugger (`systematic-debugger`)
...
***REMOVED******REMOVED******REMOVED*** D. Infrastructure & Operations Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** 13. Database Migration (`database-migration`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 14. Docker Containerization (`docker-containerization`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 15. FastAPI Production (`fastapi-production`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 16. Frontend Development (`frontend-development`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 17. React TypeScript (`react-typescript`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 18. Python Testing Patterns (`python-testing-patterns`)
...
***REMOVED******REMOVED******REMOVED*** E. Workflow & Process Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** 19. PR Reviewer (`pr-reviewer`)
...
**Example Invocation:**
```
Task: "Review PR ***REMOVED***123 before merging"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 20. Changelog Generator (`changelog-generator`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 21. Constraint Preflight (`constraint-preflight`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 22. Solver Control (`solver-control`)
...
***REMOVED******REMOVED******REMOVED*** F. Emergency & Incident Response Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** 23. Production Incident Responder (`production-incident-responder`)
...
***REMOVED******REMOVED******REMOVED*** G. Specialized Utility Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** 24. PDF Generation (`pdf`)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 25. Excel Integration (`xlsx`)
...
***REMOVED******REMOVED*** III. ROUTING LOGIC

***REMOVED******REMOVED******REMOVED*** A. Primary Routing Rules
...
***REMOVED******REMOVED******REMOVED*** B. Routing Decision Tree
...
***REMOVED******REMOVED******REMOVED*** C. Progressive Disclosure
...
***REMOVED******REMOVED*** IV. SKILL COMPOSITION PATTERNS

***REMOVED******REMOVED******REMOVED*** A. Sequential Composition
...
***REMOVED******REMOVED******REMOVED*** B. Parallel Composition
...
***REMOVED******REMOVED******REMOVED*** C. Conditional Composition
...
***REMOVED******REMOVED******REMOVED*** D. Recursive Composition
...
***REMOVED******REMOVED*** V. DELEGATION PROTOCOLS

***REMOVED******REMOVED******REMOVED*** A. When to Delegate
...
***REMOVED******REMOVED******REMOVED*** B. Delegation Message Format
...
***REMOVED******REMOVED******REMOVED*** C. Result Synthesis
...
def synthesize_quality_reports(results):
    ...
    ***REMOVED*** Collect all issues
    for skill_result in results:
        report["issues"].extend(skill_result.issues)

    ***REMOVED*** Worst status wins (error > warning > success)
...
***REMOVED******REMOVED*** VI. ERROR HANDLING IN ROUTING

***REMOVED******REMOVED******REMOVED*** A. Skill Not Available
...
***REMOVED******REMOVED******REMOVED*** B. Skill Prerequisites Not Met
...
***REMOVED******REMOVED******REMOVED*** C. Skill Execution Failure
...
***REMOVED******REMOVED*** VII. SKILL VERSIONING

***REMOVED******REMOVED******REMOVED*** A. Version Compatibility
...
***REMOVED******REMOVED******REMOVED*** B. Deprecation Policy
...
***REMOVED******REMOVED*** VIII. MONITORING & METRICS

***REMOVED******REMOVED******REMOVED*** A. Skill Performance Tracking
...
***REMOVED******REMOVED******REMOVED*** B. Routing Effectiveness
...
***REMOVED******REMOVED******REMOVED*** A. Skill Selection
...
***REMOVED******REMOVED******REMOVED*** B. Skill Development
...
***REMOVED******REMOVED******REMOVED*** C. Skill Maintenance
...
***REMOVED******REMOVED*** X. QUICK REFERENCE

***REMOVED******REMOVED******REMOVED*** A. Skill Selection Cheat Sheet
...
***REMOVED******REMOVED******REMOVED*** B. Common Workflows
