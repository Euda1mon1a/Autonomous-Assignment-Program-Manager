...
***REMOVED******REMOVED*** Python Testing (pytest)
...
class TestSwapExecutor:
    ...
    ***REMOVED*** ===== Happy Path Tests =====
    ...
    async def test_execute_one_to_one_swap_success(
        ...
        ***REMOVED*** Arrange
        ***REMOVED*** (setup is done in fixtures)
    ...
    ***REMOVED*** ===== Integration Tests =====
    ...
    async def test_execute_swap_persists_to_database(
        ...
        ***REMOVED*** Assert - verify in database
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Unit Tests
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Service Tests
...
class TestScheduleService:
    ...
    async def test_create_schedule_rejects_violation(self, db, service):
        ...
        data = ScheduleCreate(weekly_hours=90)  ***REMOVED*** Over 80 limit

        with pytest.raises(ACGMEViolationError):
            await service.create_schedule(db, data)
```

***REMOVED******REMOVED******REMOVED******REMOVED*** 3. API Tests
...
***REMOVED******REMOVED******REMOVED*** Mocking Patterns
...
***REMOVED******REMOVED*** TypeScript Testing (Jest)
...
***REMOVED******REMOVED******REMOVED*** Hook Testing
...
***REMOVED******REMOVED*** Test Generation Checklist

***REMOVED******REMOVED******REMOVED*** For Every New Function
...
***REMOVED******REMOVED******REMOVED*** For Every New Class
...
***REMOVED******REMOVED******REMOVED*** For Every New API Endpoint
...
***REMOVED******REMOVED******REMOVED*** For Every Bug Fix
...
```bash
***REMOVED*** Python (pytest)
cd /home/user/Autonomous-Assignment-Program-Manager/backend

pytest                              ***REMOVED*** All tests
pytest -v                           ***REMOVED*** Verbose output
pytest --tb=short                   ***REMOVED*** Short traceback
pytest -x                           ***REMOVED*** Stop on first failure
pytest -k "test_swap"               ***REMOVED*** Run matching tests
pytest -m integration               ***REMOVED*** Run marked tests
pytest --cov=app                    ***REMOVED*** With coverage
pytest --cov=app --cov-fail-under=70  ***REMOVED*** Fail if under 70%

***REMOVED*** TypeScript (Jest)
cd /home/user/Autonomous-Assignment-Program-Manager/frontend

npm test                            ***REMOVED*** All tests
npm test -- --coverage              ***REMOVED*** With coverage
npm test -- --watch                 ***REMOVED*** Watch mode
npm test -- --testPathPattern=Schedule  ***REMOVED*** Run matching
```
