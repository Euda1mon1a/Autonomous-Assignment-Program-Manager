***REMOVED*** Reference: Metric Definitions
...
***REMOVED******REMOVED*** Core Health Score Components
...
***REMOVED******REMOVED*** Component Metrics

***REMOVED******REMOVED******REMOVED*** 1. Coverage Component
...
***REMOVED******REMOVED******REMOVED*** 2. Margin Component
...
expected_blocks = evaluation_days / 14  ***REMOVED*** Assuming 2-week blocks
...
***REMOVED******REMOVED*** N-1 Analysis Metrics

***REMOVED******REMOVED******REMOVED*** Critical Resident
...
***REMOVED******REMOVED******REMOVED*** Understaffing Hours
...
***REMOVED******REMOVED******REMOVED*** Recovery Time Estimate
...
if failed_rotations:
  ...
  recovery_days = 1  ***REMOVED*** Internal shuffle only
else:
  recovery_days = 0  ***REMOVED*** Fully absorbed
```
...
***REMOVED******REMOVED*** Multi-Failure Metrics
...
***REMOVED******REMOVED******REMOVED*** Impact Score
...
***REMOVED******REMOVED*** Recovery Planning Metrics

***REMOVED******REMOVED******REMOVED*** Recovery Time (Hours)
...
***REMOVED******REMOVED******REMOVED*** Cost Estimate
...
***REMOVED******REMOVED*** Historical Tracking Metrics

***REMOVED******REMOVED******REMOVED*** Health Score Trend
...
***REMOVED******REMOVED******REMOVED*** Seasonal Adjustment
...
***REMOVED******REMOVED*** Metric Calculation Examples

***REMOVED******REMOVED******REMOVED*** Example 1: Compute Health Score
...
***REMOVED******REMOVED******REMOVED*** Example 2: Classify Resident via N-1 Analysis
...
***REMOVED******REMOVED******REMOVED*** Example 3: Compute Collapse Probability
