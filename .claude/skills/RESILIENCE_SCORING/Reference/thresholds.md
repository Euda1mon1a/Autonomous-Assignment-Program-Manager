***REMOVED*** Reference: Alert Thresholds
...
***REMOVED******REMOVED*** Health Score Thresholds

***REMOVED******REMOVED******REMOVED*** Overall Health Score
...
***REMOVED******REMOVED*** Component Thresholds

***REMOVED******REMOVED******REMOVED*** Coverage Component
...
***REMOVED******REMOVED******REMOVED*** Margin Component
...
***REMOVED******REMOVED******REMOVED*** Continuity Component
...
***REMOVED******REMOVED*** N-1 Analysis Thresholds

***REMOVED******REMOVED******REMOVED*** Critical Resident Count
...
***REMOVED******REMOVED******REMOVED*** High-Impact Resident Count
...
***REMOVED******REMOVED******REMOVED*** Understaffing Hours (per 7-day absence)
...
***REMOVED******REMOVED*** Multi-Failure Thresholds
...
***REMOVED******REMOVED******REMOVED*** Median Time-to-Failure
...
***REMOVED******REMOVED******REMOVED*** Fragile Rotation Failure Rate
...
***REMOVED******REMOVED*** Recovery Planning Thresholds

***REMOVED******REMOVED******REMOVED*** Recovery Time
...
***REMOVED******REMOVED******REMOVED*** Bottleneck Detection
...
***REMOVED******REMOVED*** Historical Trend Thresholds

***REMOVED******REMOVED******REMOVED*** Health Score Degradation Rate
...
***REMOVED******REMOVED******REMOVED*** Incident Correlation
...
***REMOVED******REMOVED*** Seasonal Thresholds
...
***REMOVED******REMOVED*** Alert Notification Matrix
...
***REMOVED******REMOVED*** Auto-Mitigation Thresholds

Some thresholds should trigger **automatic** mitigation actions (not just alerts):

***REMOVED******REMOVED******REMOVED*** Automatic Schedule Hold

```
if collapse_probability > 0.20:
  ***REMOVED*** DO NOT DEPLOY - automatically mark schedule as "needs_revision"
...
***REMOVED******REMOVED******REMOVED*** Automatic Supplemental Staff Request

```
if critical_resident_count > 5:
  ***REMOVED*** Automatically generate supplemental staff request
...
***REMOVED******REMOVED******REMOVED*** Automatic Cross-Training Recommendation

```
for rotation in fragile_rotations:
  if rotation.failure_rate > 0.50:
    ***REMOVED*** Automatically create cross-training task
...
***REMOVED******REMOVED*** Threshold Calibration
...
***REMOVED******REMOVED******REMOVED*** Annual Review
...
***REMOVED******REMOVED******REMOVED*** Calibration Example

```
***REMOVED*** Historical Data (past 12 months):
***REMOVED*** - Schedules with collapse_prob > 10%: 8 deployed
***REMOVED*** - Actual collapses: 1 (12.5% actual collapse rate)
***REMOVED*** - Threshold appears well-calibrated

***REMOVED*** vs

***REMOVED*** Historical Data (past 12 months):
***REMOVED*** - Schedules with margin < 0.30: 12 deployed
***REMOVED*** - Actual ACGME violations: 5 (41.7% violation rate)
***REMOVED*** - Threshold too lenient → increase to margin < 0.35
```

---

***REMOVED******REMOVED*** Testing Threshold Effectiveness

***REMOVED******REMOVED******REMOVED*** Sensitivity Analysis
...
***REMOVED******REMOVED******REMOVED*** Specificity Analysis
