***REMOVED*** ACGME Rules - Detailed Reference
...
***REMOVED******REMOVED*** Section VI: The Learning and Working Environment

***REMOVED******REMOVED******REMOVED*** VI.A. Principles
...
***REMOVED******REMOVED******REMOVED*** VI.B. Professionalism
...
***REMOVED******REMOVED*** VI.F. Duty Hours, On-Call Activities, and Working Environment

***REMOVED******REMOVED******REMOVED*** VI.F.1. Maximum Hours of Work per Week
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Calculation Method
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Warning Thresholds (Institutional)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Common Violations
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Validation Formula
```python
***REMOVED*** For each resident, for each 28-day window
...
***REMOVED******REMOVED******REMOVED*** VI.F.2. Duty Periods
...
***REMOVED******REMOVED******REMOVED******REMOVED*** PGY-1 Limits (Interns)
- **Maximum continuous duty:** 16 hours
- **With transition time:** 16 + 4 = 20 hours maximum
- **No exceptions**

***REMOVED******REMOVED******REMOVED******REMOVED*** PGY-2+ Limits (Senior Residents)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 24+4 Rule Details
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Violation Examples
```
...
***REMOVED******REMOVED******REMOVED*** VI.F.3. Minimum Time Off between Scheduled Duty Periods
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Acceptable Patterns (28-day examples)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Simplified Implementation
...
***REMOVED******REMOVED******REMOVED*** VI.F.3.b. Minimum Time Off Between Duty Periods
...
***REMOVED******REMOVED******REMOVED*** VI.F.4. Maximum Frequency of In-House Night Float
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Night Float Definition
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Maximum Limits
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Institutional Best Practices
...
***REMOVED******REMOVED******REMOVED*** VI.F.5. Maximum In-House On-Call Frequency
...
***REMOVED******REMOVED******REMOVED*** VI.F.6. Moonlighting
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Tracking Requirements
...
***REMOVED******REMOVED******REMOVED*** VI.F.7. In-House Call Rooms
...
***REMOVED******REMOVED******REMOVED*** VI.F.8. Professionalism, Responsibility, and Patient Safety
...
***REMOVED******REMOVED*** VI.C. Supervision

***REMOVED******REMOVED******REMOVED*** VI.C.1. General Supervision Requirements
...
***REMOVED******REMOVED******REMOVED*** VI.C.1.a. PGY-1 Supervision
...
***REMOVED******REMOVED******REMOVED*** VI.C.1.b. PGY-2+ Supervision
...
***REMOVED******REMOVED*** VI.D. Well-Being

***REMOVED******REMOVED******REMOVED*** VI.D.1. Resident Well-Being
...
***REMOVED******REMOVED******REMOVED*** VI.D.1.a. Fatigue Mitigation
...
***REMOVED******REMOVED*** Violation Consequences

***REMOVED******REMOVED******REMOVED*** Institutional Consequences
...
***REMOVED******REMOVED******REMOVED*** Reporting Requirements
...
***REMOVED******REMOVED******REMOVED*** VI.F.9. Duty Hours Monitoring
...
***REMOVED******REMOVED******REMOVED*** Required Data Points
...
***REMOVED******REMOVED*** Program-Specific Variations
...
***REMOVED******REMOVED*** Institutional Policies (Example - Military MTF)
