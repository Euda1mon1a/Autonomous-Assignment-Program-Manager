***REMOVED*** Workflow: Historical Compliance Analysis
...
***REMOVED******REMOVED******REMOVED*** Step 1: Define Analysis Period

```python
from datetime import date, timedelta
from collections import defaultdict

***REMOVED*** Define historical period (e.g., last 6 blocks)
analysis_start = date(2025, 7, 1)   ***REMOVED*** Start of academic year
analysis_end = date(2025, 12, 31)    ***REMOVED*** End of analysis period

***REMOVED*** Break into block periods (28-day blocks)
block_periods = []
...
***REMOVED******REMOVED******REMOVED*** Step 2: Load Historical Data
...
***REMOVED******REMOVED******REMOVED*** Step 3: Run Validation for Each Block
...
***REMOVED*** Store results by block
block_results = []
...
for period in block_periods:
    ...
    ***REMOVED*** Filter data for this block
...
***REMOVED******REMOVED******REMOVED*** Step 4: Aggregate Violation Statistics
...
***REMOVED*** Violation breakdown by type
...
***REMOVED******REMOVED******REMOVED*** Step 5: Identify Recurring Patterns
...
***REMOVED*** Pattern 1: Consecutive Block Violations (same constraint)
...
***REMOVED*** Pattern 2: Seasonal Trends
print("\nSeasonal Trends:")
***REMOVED*** Group by quarter
...
***REMOVED*** Pattern 3: Improvement/Degradation Trend
...
***REMOVED******REMOVED******REMOVED*** Step 6: Generate Trend Chart (Text-Based)
...
if max_violations == 0:
    max_violations = 1  ***REMOVED*** Avoid division by zero
...
***REMOVED******REMOVED******REMOVED*** Step 7: Root Cause Analysis
...
***REMOVED*** Analyze most common violations
...
for i, (vtype, count) in enumerate(top_violations[:3], 1):
    ...
    ***REMOVED*** Provide context-specific root cause suggestions
    if vtype == "duty_hours":
...
***REMOVED******REMOVED******REMOVED*** Step 8: Generate Recommendations
...
***REMOVED*** Recommendation 1: Based on compliance rate
...
***REMOVED*** Recommendation 2: Based on recurring patterns
if consecutive_patterns:
    recommendations.append({
        "priority": "HIGH",
...
***REMOVED*** Recommendation 3: Based on personnel violations
...
***REMOVED*** Recommendation 4: Based on trend
...
***REMOVED******REMOVED******REMOVED*** Step 9: Save Historical Report
...
with open(report_filename, 'w') as f:
    f.write("***REMOVED*** Historical Compliance Analysis Report\n\n")
    ...
    f.write("***REMOVED******REMOVED*** Violations by Block\n\n")
    ...
    f.write("\n***REMOVED******REMOVED*** Top Violations\n\n")
...
***REMOVED******REMOVED******REMOVED*** Step 10: Cleanup
