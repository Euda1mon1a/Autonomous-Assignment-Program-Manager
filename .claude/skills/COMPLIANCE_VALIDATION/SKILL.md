...
***REMOVED*** COMPLIANCE_VALIDATION Skill
...
***REMOVED******REMOVED*** Key Phases

***REMOVED******REMOVED******REMOVED*** Phase 1: Audit
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Analyze
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Remediate
...
***REMOVED******REMOVED*** Constraint Tiers

All constraints are classified into tiers for prioritization:

***REMOVED******REMOVED******REMOVED*** Tier 1: ACGME Regulatory (CRITICAL)
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Soft Constraints (MEDIUM)
...
***REMOVED******REMOVED******REMOVED*** Tier 4: Optimization Goals (LOW)
...
***REMOVED******REMOVED******REMOVED*** Core Validation Code
```
...
```python
***REMOVED*** Always use try-catch with rollback
try:
    db = SessionLocal()
...
***REMOVED******REMOVED******REMOVED*** Missing Data
...
***REMOVED******REMOVED******REMOVED*** Constraint Failures
...
***REMOVED******REMOVED******REMOVED*** Remediation Tools
```
