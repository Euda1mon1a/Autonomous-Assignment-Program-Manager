...
***REMOVED******REMOVED******REMOVED*** Standard Deployment: 12 G-2s × 10 Probes = 120 Probes
...
***REMOVED******REMOVED******REMOVED*** Probe Composition (Per Party)
...
***REMOVED******REMOVED******REMOVED*** Full Deployment (120 probes)
...
***REMOVED******REMOVED******REMOVED*** Targeted Deployment (10 probes)
...
***REMOVED******REMOVED******REMOVED*** Quick Search (focused)
...
***REMOVED******REMOVED******REMOVED*** Via G2_RECON Commander (CORRECT)

```python
***REMOVED*** ORCHESTRATOR spawns G2_RECON who manages the 12 G-2 teams
Task(
    subagent_type="general-purpose",
    description="G2_RECON: SEARCH_PARTY Commander",
    prompt="""
***REMOVED******REMOVED*** Agent: G2_RECON (G-2 Commander)
...
***REMOVED******REMOVED*** Your G-2 Teams to Deploy
1. G2-BACKEND-CORE
2. G2-BACKEND-MODELS
3. G2-SCHEDULING
4. G2-RESILIENCE
...
***REMOVED******REMOVED******REMOVED*** Direct Deployment (Only if G2_RECON unavailable)

```python
***REMOVED*** Deploy all 12 G-2s in parallel
***REMOVED*** WARNING: Only use if spawning from within a coordinator, NOT from ORCHESTRATOR
***REMOVED*** Total: 120 probes, wall-clock = single probe timeout
...
***REMOVED******REMOVED*** Intel Synthesis
...
***REMOVED******REMOVED******REMOVED*** Discrepancy Analysis
...
***REMOVED******REMOVED******REMOVED*** Per-G-2 Report

```markdown
***REMOVED******REMOVED*** G-2 Intel: [DOMAIN]

***REMOVED******REMOVED******REMOVED*** Health Grade: [A-F]
...
***REMOVED******REMOVED******REMOVED*** Priority Actions
1. [Most urgent fix]
2. [Next priority]
```

***REMOVED******REMOVED******REMOVED*** Consolidated Brief

```markdown
***REMOVED******REMOVED*** SEARCH_PARTY Intel Brief (120 Probes Deployed)
...
***REMOVED******REMOVED******REMOVED*** Cross-Domain Discrepancies
[High-signal findings where domains/probes disagreed]

***REMOVED******REMOVED******REMOVED*** Global Gaps
...
***REMOVED******REMOVED******REMOVED*** Minimum Viable Intel
