***REMOVED*** Conflict Resolution Workflow
...
***REMOVED******REMOVED*** Conflict Classification

***REMOVED******REMOVED******REMOVED*** Tier 1: Critical Conflicts (ACGME Violations)
...
***REMOVED******REMOVED******REMOVED*** Tier 2: High Conflicts (Institutional Policy Violations)
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Medium Conflicts (Optimization Trade-offs)
...
***REMOVED******REMOVED******REMOVED*** Tier 4: Low Conflicts (Minor Suboptimality)
...
***REMOVED******REMOVED*** Conflict Identification

***REMOVED******REMOVED******REMOVED*** Automated Detection
...
***REMOVED******REMOVED******REMOVED*** Manual Review
...
***REMOVED******REMOVED*** Resolution Process

***REMOVED******REMOVED******REMOVED*** Step 1: Rank Conflicts by Priority
...
def rank_conflicts(conflicts):
    ...
    def priority_score(conflict):
        ***REMOVED*** Tier 1 (ACGME) = highest priority
        tier_score = (4 - conflict['tier']) * 1000

        ***REMOVED*** Within tier, sort by number of affected people
        people_score = len(conflict['affected_people']) * 10

        ***REMOVED*** Then by date proximity (earlier dates = higher priority)
...
***REMOVED******REMOVED******REMOVED*** Step 2: Generate Resolution Proposals

**For each conflict, generate 2-3 resolution options:**

***REMOVED******REMOVED******REMOVED******REMOVED*** Example: ACGME Work Hour Violation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example: Hard Preference Violation
...
***REMOVED******REMOVED******REMOVED*** Step 3: Evaluate Trade-offs
...
***REMOVED******REMOVED******REMOVED*** Step 4: Document Decisions

**All conflict resolutions must be documented:**

***REMOVED******REMOVED******REMOVED******REMOVED*** Resolution Documentation Template

```markdown
***REMOVED******REMOVED*** Conflict Resolution Report

**Conflict ID:** conflict-001
**Date Resolved:** 2026-11-15
**Resolved By:** Program Coordinator

***REMOVED******REMOVED******REMOVED*** Conflict Description
...
***REMOVED******REMOVED******REMOVED*** Resolution Selected
...
***REMOVED******REMOVED******REMOVED*** Approvals
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Store in Database
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Escalate to Chief Resident
- Tier 3 conflicts requiring peer mediation
- Swap negotiations between residents
- Minor policy clarifications

***REMOVED******REMOVED******REMOVED******REMOVED*** Escalate to Program Coordinator
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Escalate to Program Director
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Escalate to Curriculum Committee
- Rotation structure conflicts
- Curriculum requirement conflicts
- Major policy change proposals

***REMOVED******REMOVED******REMOVED*** Escalation Template

```markdown
***REMOVED******REMOVED*** Escalation Request
...
***REMOVED******REMOVED******REMOVED*** Issue Summary
Multiple conflicts detected in Block 7 schedule due to simultaneous absences.

***REMOVED******REMOVED******REMOVED*** Conflicts Requiring Resolution
...
***REMOVED******REMOVED******REMOVED*** Attempted Resolutions
...
***REMOVED******REMOVED******REMOVED*** Proposed Solutions Requiring PD Approval
...
***REMOVED******REMOVED******REMOVED*** Required Decision
Please approve Option A or select alternative by 2026-11-22.

***REMOVED******REMOVED******REMOVED*** Supporting Documents
...
***REMOVED******REMOVED*** Automated Conflict Resolution

***REMOVED******REMOVED******REMOVED*** Swap Auto-Matcher
...
def auto_match_swaps(conflict):
    ...
    ***REMOVED*** Find people who:
    ***REMOVED*** 1. Are available on those dates
    ***REMOVED*** 2. Are qualified for the rotation
    ***REMOVED*** 3. Might want this shift (preference match)
    candidates = []
    ...
    for other_person in get_all_residents():
        ...
        ***REMOVED*** Check qualification
        if not is_qualified(other_person, unwanted_assignment.rotation):
            continue

        ***REMOVED*** Check if this matches their preference
            ...
            ***REMOVED*** Would original person want this?
            ...
            if preference_score > 0.5 and reverse_score > 0.5:
                candidates.append({
                    ...
                    'estimated_satisfaction_gain': preference_score - 0.3  ***REMOVED*** Current dissatisfaction
                })

    return sorted(candidates, key=lambda c: c['match_score'], reverse=True)
```

***REMOVED******REMOVED******REMOVED*** Fairness Auto-Balancer
...
def auto_balance_workload(conflict):
    ...
    for overloaded_person in overloaded:
        ***REMOVED*** Find their lowest-priority assignments
        assignments = get_assignments(overloaded_person, order_by='priority')

        for assignment in assignments:
            ***REMOVED*** Find underloaded person who can take it
            for underloaded_person in underloaded:
                if can_transfer(assignment, from_person=overloaded_person, to_person=underloaded_person):
                    ...
                    proposals.append({
                        ...
                        'estimated_effort': 'LOW'  ***REMOVED*** Single shift transfer
                    })
...
***REMOVED******REMOVED*** Conflict Prevention

***REMOVED******REMOVED******REMOVED*** Proactive Strategies

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Front-load Constraint Checking

**Check for conflicts BEFORE generating schedule:**

```bash
***REMOVED*** Pre-generation conflict detection
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Stagger Absences
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Maintain Buffer Capacity
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Regular Schedule Health Checks

**Weekly monitoring:**

```bash
***REMOVED*** Automated health check (run via cron)
