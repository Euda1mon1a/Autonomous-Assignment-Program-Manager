***REMOVED*** SKILL INDEX - Personal AI Infrastructure Metadata & Routing
...
1. [Complete Skill Registry](***REMOVED***complete-skill-registry)
2. [Routing Rules](***REMOVED***routing-rules)
3. [Agent-Skill Matrix](***REMOVED***agent-skill-matrix)
4. [Skill Dependencies](***REMOVED***skill-dependencies)
5. [Tags Taxonomy](***REMOVED***tags-taxonomy)
6. [Discovery Queries](***REMOVED***discovery-queries)
7. [Quick Reference](***REMOVED***quick-reference)

---

***REMOVED******REMOVED*** Complete Skill Registry

***REMOVED******REMOVED******REMOVED*** Tier 1: Core Scheduling Skills (Kai Pattern)

***REMOVED******REMOVED******REMOVED******REMOVED*** SCHEDULING
```yaml
name: SCHEDULING
...
***REMOVED******REMOVED******REMOVED******REMOVED*** COMPLIANCE_VALIDATION
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** RESILIENCE_SCORING
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** SWAP_EXECUTION
```yaml
name: SWAP_EXECUTION
...
***REMOVED******REMOVED******REMOVED******REMOVED*** MCP_ORCHESTRATION
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ORCHESTRATION_DEBUGGING
```yaml
...
***REMOVED******REMOVED******REMOVED*** Tier 2: Domain-Specific Skills (Legacy Pattern)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** schedule-optimization
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** swap-management
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** safe-schedule-generation
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** schedule-verification
```yaml
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Development & Code Quality Skills
...
***REMOVED******REMOVED******REMOVED******REMOVED*** code-review
```yaml
name: code-review
...
***REMOVED******REMOVED******REMOVED******REMOVED*** automated-code-fixer
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** code-quality-monitor
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** lint-monorepo
```yaml
name: lint-monorepo
...
***REMOVED******REMOVED******REMOVED******REMOVED*** solver-control
```yaml
name: solver-control
...
***REMOVED******REMOVED******REMOVED*** Tier 4: Infrastructure & Operations Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** database-migration
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** docker-containerization
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** fastapi-production
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** frontend-development
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** react-typescript
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** python-testing-patterns
```yaml
...
***REMOVED******REMOVED******REMOVED*** Tier 5: Workflow & Process Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** pr-reviewer
```yaml
name: pr-reviewer
...
***REMOVED******REMOVED******REMOVED******REMOVED*** changelog-generator
```yaml
...
***REMOVED******REMOVED******REMOVED******REMOVED*** session-documentation
```yaml
...
***REMOVED******REMOVED******REMOVED*** Tier 6: Emergency & Incident Response Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** production-incident-responder
```yaml
...
***REMOVED******REMOVED******REMOVED*** Tier 7: Security & Compliance Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** security-audit
```yaml
name: security-audit
...
***REMOVED******REMOVED******REMOVED*** Tier 8: Specialized Utility Skills

***REMOVED******REMOVED******REMOVED******REMOVED*** pdf
```yaml
name: pdf
...
***REMOVED******REMOVED******REMOVED******REMOVED*** xlsx
```yaml
name: xlsx
...
***REMOVED******REMOVED******REMOVED******REMOVED*** test-scenario-framework
```yaml
...
***REMOVED******REMOVED*** Routing Rules

***REMOVED******REMOVED******REMOVED*** Intent → Skill Mapping
...
***REMOVED******REMOVED******REMOVED*** Domain → Skill Mapping
...
***REMOVED******REMOVED******REMOVED*** Complexity → Skill Routing

***REMOVED******REMOVED******REMOVED******REMOVED*** Simple Queries (Direct Answer)
- Use general Claude capabilities
- Reference skills: acgme-compliance, CORE

***REMOVED******REMOVED******REMOVED******REMOVED*** Intermediate Tasks (Single Skill)
- swap-management, test-writer, code-review, database-migration
- Estimated: 2-15 minutes

***REMOVED******REMOVED******REMOVED******REMOVED*** Complex Tasks (Multi-Skill Composition)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Critical Operations (Safety Skills First)
...
***REMOVED******REMOVED*** Agent-Skill Matrix

***REMOVED******REMOVED******REMOVED*** Agent Types
...
***REMOVED******REMOVED******REMOVED*** Skill Access by Agent
...
***REMOVED******REMOVED*** Skill Dependencies
...
***REMOVED******REMOVED******REMOVED*** Critical Dependencies (Safety-Critical Skills)
...
***REMOVED******REMOVED*** Tags Taxonomy

***REMOVED******REMOVED******REMOVED*** Domain Tags
...
***REMOVED******REMOVED******REMOVED*** Type Tags
...
***REMOVED******REMOVED******REMOVED*** Complexity Tags
...
***REMOVED******REMOVED******REMOVED*** Safety Tags
...
***REMOVED******REMOVED*** Discovery Queries

***REMOVED******REMOVED******REMOVED*** Example Queries → Skill Mappings
...
***REMOVED******REMOVED******REMOVED*** Discovery by MCP Tool
...
***REMOVED******REMOVED******REMOVED*** Skill Selection Decision Tree
...
***REMOVED******REMOVED******REMOVED*** Common Workflows

***REMOVED******REMOVED******REMOVED******REMOVED*** Schedule Generation Workflow
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Code Change Workflow
```
1. [Make changes]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Swap Request Workflow
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Incident Response Workflow
```
...
***REMOVED******REMOVED******REMOVED*** Progressive Disclosure Levels
...
***REMOVED******REMOVED******REMOVED*** Skill Pattern Comparison
