***REMOVED*** Template Variable Documentation
...
***REMOVED******REMOVED*** Common Variables Reference

***REMOVED******REMOVED******REMOVED*** Mission Variables
```
...
***REMOVED******REMOVED******REMOVED*** Personnel Variables
```
...
***REMOVED******REMOVED******REMOVED*** Schedule Variables
```
...
***REMOVED******REMOVED******REMOVED*** Assignment Variables
```
...
***REMOVED******REMOVED******REMOVED*** Rotation Variables
```
...
***REMOVED******REMOVED******REMOVED*** Coverage Variables
```
...
***REMOVED******REMOVED******REMOVED*** ACGME Variables
```
...
***REMOVED******REMOVED******REMOVED*** Resource Variables
```
...
***REMOVED******REMOVED******REMOVED*** Time Variables
```
...
***REMOVED******REMOVED******REMOVED*** Metric Variables
```
...
***REMOVED******REMOVED******REMOVED*** Alert Variables
```
...
***REMOVED******REMOVED******REMOVED*** Status Variables
```
...
***REMOVED******REMOVED******REMOVED*** Credential Variables
```
...
***REMOVED******REMOVED******REMOVED*** Error Variables
```
...
***REMOVED******REMOVED*** Variable Type Guide
...
***REMOVED******REMOVED*** Variable Initialization Checklist
...
***REMOVED******REMOVED******REMOVED*** Variable Masking
```
