...
1. [ACGME Validation](***REMOVED***acgme-validation)
2. [Code Review](***REMOVED***code-review)
3. [Test Generation](***REMOVED***test-generation)
4. [Documentation](***REMOVED***documentation)
5. [Debugging](***REMOVED***debugging)
6. [Refactoring](***REMOVED***refactoring)
7. [Database Migrations](***REMOVED***database-migrations)
8. [Incident Response](***REMOVED***incident-response)
9. [Compliance Audits](***REMOVED***compliance-audits)
10. [Performance Optimization](***REMOVED***performance-optimization)
11. [Accessibility](***REMOVED***accessibility)
12. [API Design](***REMOVED***api-design)
13. [Query Optimization](***REMOVED***query-optimization)
14. [Error Handling](***REMOVED***error-handling)
15. [Security Hardening](***REMOVED***security-hardening)

---

***REMOVED******REMOVED*** ACGME Validation

***REMOVED******REMOVED******REMOVED*** Template: Schedule Compliance Check
...
***REMOVED******REMOVED******REMOVED*** Template: Constraint Validation
...
***REMOVED******REMOVED******REMOVED*** Template: Compliance Regression Test
...
***REMOVED******REMOVED*** Code Review

***REMOVED******REMOVED******REMOVED*** Template: Security-Focused Review
...
***REMOVED******REMOVED******REMOVED*** Template: Performance Review
...
***REMOVED******REMOVED******REMOVED*** Template: Architecture Review
...
***REMOVED******REMOVED*** Test Generation

***REMOVED******REMOVED******REMOVED*** Template: Unit Test Generation
...
***REMOVED******REMOVED******REMOVED*** Template: Integration Test Generation
...
***REMOVED******REMOVED******REMOVED*** Template: Fixture Generation
...
***REMOVED******REMOVED******REMOVED*** Template: API Documentation
...
***REMOVED******REMOVED******REMOVED*** Template: Function Documentation
...
***REMOVED******REMOVED******REMOVED*** Template: Architecture Documentation
...
***REMOVED******REMOVED******REMOVED*** Template: Exploration-First Debugging
...
***REMOVED******REMOVED******REMOVED*** Template: Root Cause Analysis
...
***REMOVED******REMOVED******REMOVED*** Template: Test-Driven Debugging
...
***REMOVED******REMOVED*** Refactoring

***REMOVED******REMOVED******REMOVED*** Template: Extract Function
...
***REMOVED******REMOVED******REMOVED*** Template: Rename Refactoring
...
***REMOVED******REMOVED******REMOVED*** Template: Simplification
...
***REMOVED******REMOVED******REMOVED*** Template: Schema Change Migration
...
***REMOVED******REMOVED******REMOVED*** Template: Data Migration
...
***REMOVED******REMOVED******REMOVED*** Template: Safe Migration Deployment
...
***REMOVED******REMOVED******REMOVED*** Template: Production Incident Diagnosis
...
***REMOVED******REMOVED******REMOVED*** Template: Incident Postmortem
...
***REMOVED******REMOVED******REMOVED*** Template: Escalation Checklist
...
***REMOVED******REMOVED*** Compliance Audits

***REMOVED******REMOVED******REMOVED*** Template: HIPAA Compliance Check
...
***REMOVED******REMOVED******REMOVED*** Template: Security Audit
...
***REMOVED******REMOVED******REMOVED*** Template: Data Privacy Review
...
***REMOVED******REMOVED******REMOVED*** Template: Performance Profiling
...
***REMOVED******REMOVED******REMOVED*** Template: Query Optimization
...
***REMOVED******REMOVED******REMOVED*** Template: Scaling Analysis
...
***REMOVED******REMOVED******REMOVED*** Template: WCAG 2.1 Audit
...
***REMOVED******REMOVED******REMOVED*** Template: Keyboard Navigation Test
...
***REMOVED******REMOVED******REMOVED*** Template: REST API Review
...
***REMOVED******REMOVED******REMOVED*** Template: API Contract Testing
...
***REMOVED******REMOVED******REMOVED*** Template: Slow Query Investigation
...
***REMOVED******REMOVED******REMOVED*** Template: Index Analysis
...
***REMOVED******REMOVED******REMOVED*** Template: Error Handling Review
...
***REMOVED******REMOVED******REMOVED*** Template: Error Message Audit
...
***REMOVED******REMOVED******REMOVED*** Template: Dependency Security Audit
...
***REMOVED******REMOVED******REMOVED*** Template: Secrets Rotation Plan
...
***REMOVED******REMOVED*** Template Usage Guidelines

***REMOVED******REMOVED******REMOVED*** When to Use Templates
...
***REMOVED******REMOVED******REMOVED*** Template Customization
...
***REMOVED******REMOVED*** Creating Custom Templates

***REMOVED******REMOVED******REMOVED*** Template Format

```
***REMOVED******REMOVED******REMOVED*** Template: [Category] - [Specific Task]
...
***REMOVED******REMOVED******REMOVED*** Template Validation
...
***REMOVED******REMOVED*** Integration with Skills
