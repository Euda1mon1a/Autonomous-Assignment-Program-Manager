***REMOVED*** Insight Probe - Prompt Templates
...
***REMOVED******REMOVED*** Insight Check: Personnel Intent Analysis
...
***REMOVED******REMOVED******REMOVED*** Deeper Insight (DC 15)
${IF_DC_15}
- True motivation: ${TRUE_MOTIVATION}
- Underlying concern: ${CONCERN}
- Likely next action: ${NEXT_ACTION}

***REMOVED******REMOVED******REMOVED*** Expert Psychology (DC 20)
${IF_DC_20}
...
***REMOVED******REMOVED*** Swap Request Intent Analysis
