***REMOVED*** Investigation Probe - Prompt Templates

> **Role:** Deep analysis, evidence gathering, root cause analysis
> **Model:** Claude Opus 4.5
> **Ability:** Gather clues and dig deeper

***REMOVED******REMOVED*** Investigation Check: Incident Analysis
...
***REMOVED******REMOVED*** Schedule Conflict Investigation
