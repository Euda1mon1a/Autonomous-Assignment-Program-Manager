***REMOVED*** Test Engineer Agent - Prompt Templates
...
***REMOVED******REMOVED*** 1. TEST STRATEGY TEMPLATE
...
***REMOVED******REMOVED*** 2. UNIT TEST TEMPLATE
...
***REMOVED******REMOVED*** 3. INTEGRATION TEST TEMPLATE
...
class TestScheduleAPI:
    ...
    async def test_update_schedule_acgme_compliance(self, client, db):
        ...
        response = await client.patch(
            ...
            json={'hours_per_week': 95}  ***REMOVED*** Violates 80-hour rule
        )
...
***REMOVED******REMOVED*** 4. MOCK & FIXTURE TEMPLATE
...
***REMOVED******REMOVED*** 5. PERFORMANCE TEST TEMPLATE
...
class TestScheduleGenerationPerformance:
    ...
    async def test_generate_schedule_performance(self, db):
        ...
        ***REMOVED*** Assert performance target
    ...
    async def test_query_performance_n1(self, db):
        ...
        ***REMOVED*** Use query counter
        with count_queries(db) as counter:
            for schedule in schedules:
                _ = schedule.personnel  ***REMOVED*** Access relationship

        ***REMOVED*** Should not increase query count per item
...
***REMOVED******REMOVED*** 6. ACGME COMPLIANCE TEST TEMPLATE
...
class TestACGMECompliance:
    ...
    async def test_supervision_ratio_pgy1(self, validator):
        ...
        ***REMOVED*** 1 faculty per 2 residents
...
***REMOVED******REMOVED*** 7. ERROR SCENARIO TEST TEMPLATE
...
class TestErrorScenarios:
    ...
    async def test_race_condition_handling(self, db):
        ...
        ***REMOVED*** Simulate race condition
        tasks = [
        ...
        ***REMOVED*** Only one update should succeed
