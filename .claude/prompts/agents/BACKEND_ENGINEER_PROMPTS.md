***REMOVED*** Backend Engineer Agent - Prompt Templates
...
***REMOVED******REMOVED*** 2. FEATURE IMPLEMENTATION TEMPLATE
...
***REMOVED******REMOVED*** 3. API ENDPOINT TEMPLATE
...
***REMOVED******REMOVED*** 4. DATABASE OPERATION TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Query (with proper async + relationships)
\`\`\`python
...
***REMOVED******REMOVED******REMOVED*** Create (with transaction safety)
\`\`\`python
...
***REMOVED******REMOVED******REMOVED*** Update (with change tracking)
\`\`\`python
async def update_${entity_name}(
    ...
    result = await db.execute(
        ...
        .with_for_update()  ***REMOVED*** Row lock for concurrency
    )
...
***REMOVED******REMOVED*** 5. SERVICE LOGIC TEMPLATE
...
***REMOVED******REMOVED*** 6. STATUS REPORT TEMPLATE
...
***REMOVED******REMOVED*** 7. ERROR HANDLING TEMPLATE
...
***REMOVED******REMOVED*** 8. ASYNC OPERATION TEMPLATE
...
async def ${function_name}(
    ...
    """${DOCSTRING}"""
    ***REMOVED*** Async database operation
    result = await db.execute(select(...))

    ***REMOVED*** Async external call (if needed)
...
async def ${function_name}(...):
    ...
    ***REMOVED*** Handle exceptions and results
\`\`\`
...
***REMOVED******REMOVED*** 9. HANDOFF TEMPLATE
...
***REMOVED******REMOVED*** 10. DELEGATION TEMPLATE
...
***REMOVED******REMOVED*** 11. CODE REVIEW TEMPLATE
...
***REMOVED******REMOVED*** 12. MIGRATION TEMPLATE
...
***REMOVED*** Review alembic/versions/xxx_${MIGRATION_NAME}.py
alembic upgrade head
alembic downgrade -1
alembic upgrade head
\`\`\`
