...
***REMOVED******REMOVED*** 2. SWAP MATCHING TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Match 1: ${MATCH_1_ID}
- Confidence: ${CONF_1}%
- Reasons to accept: ${REASONS_1}
- Risks: ${RISKS_1}
- Coverage impact: ${COVERAGE_1}%

***REMOVED******REMOVED******REMOVED*** Match 2: ${MATCH_2_ID}
- Confidence: ${CONF_2}%
- Reasons to accept: ${REASONS_2}
- Coverage impact: ${COVERAGE_2}%

***REMOVED******REMOVED******REMOVED*** Match 3: ${MATCH_3_ID}
- Confidence: ${CONF_3}%
...
***REMOVED******REMOVED*** 3. COMPLIANCE VERIFICATION TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Credentials
...
***REMOVED******REMOVED*** 4. SWAP EXECUTION TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Pre-Execution (${TIME_1}min)
- [ ] Final compliance verification
- [ ] Both parties confirmed
- [ ] Backup schedule ready
- [ ] Rollback plan documented

***REMOVED******REMOVED******REMOVED*** Phase 2: Transaction (${TIME_2}min)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Notification (${TIME_3}min)
- [ ] Notify Person A
- [ ] Notify Person B
- [ ] Notify coordinators
- [ ] Update schedule display

***REMOVED******REMOVED******REMOVED*** Phase 4: Validation (${TIME_4}min)
...
***REMOVED******REMOVED*** 5. SWAP WITHDRAWAL TEMPLATE
...
***REMOVED******REMOVED*** 6. ROLLBACK CAPABILITY TEMPLATE
...
***REMOVED******REMOVED*** 7. APPROVAL WORKFLOW TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Level 1: Requester Confirmation
- Status: ${REQUESTER_CONFIRMED}
- Confirmed by: ${REQUESTER}
- Date: ${REQUESTER_DATE}

***REMOVED******REMOVED******REMOVED*** Level 2: Partner Confirmation (if new match)
- Status: ${PARTNER_CONFIRMED}
- Confirmed by: ${PARTNER_ID}
- Date: ${PARTNER_DATE}

***REMOVED******REMOVED******REMOVED*** Level 3: Compliance Check (Automatic)
- Status: ${COMPLIANCE_PASSED}
- Checked by: Compliance Engine
- Date: ${COMPLIANCE_DATE}

***REMOVED******REMOVED******REMOVED*** Level 4: Coordinator Approval (if needed)
...
***REMOVED******REMOVED*** 8. SWAP HISTORY & ANALYTICS TEMPLATE
...
***REMOVED******REMOVED*** 9. STATUS REPORT TEMPLATE
...
***REMOVED******REMOVED*** 10. ESCALATION TEMPLATE
...
***REMOVED******REMOVED*** 11. HANDOFF TEMPLATE
...
***REMOVED******REMOVED*** 12. DELEGATION TEMPLATE
