***REMOVED*** G5 Planning Agent - Prompt Templates
...
***REMOVED******REMOVED*** 2. CONSTRAINT VALIDATION TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Soft Constraints (Try to satisfy)
...
***REMOVED******REMOVED*** 3. SCHEDULE GENERATION TEMPLATE
...
***REMOVED******REMOVED*** 4. FEASIBILITY ANALYSIS TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Coverage Feasibility
- Required slots: ${REQUIRED_SLOTS}
- Available capacity: ${AVAILABLE_CAPACITY}
- Capacity ratio: ${CAPACITY_RATIO}
- Verdict: ${COVERAGE_FEASIBLE}

***REMOVED******REMOVED******REMOVED*** Constraint Feasibility
...
***REMOVED******REMOVED******REMOVED*** Credential Feasibility
...
***REMOVED******REMOVED*** 5. OPTIMIZATION TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Coverage Optimization
...
***REMOVED******REMOVED******REMOVED*** Rotation Balance
- Current variance: ${CURRENT_VARIANCE}%
- Target variance: ${TARGET_VARIANCE}%
- Gap: ${VARIANCE_GAP}%

***REMOVED******REMOVED******REMOVED*** Change Minimization
...
***REMOVED******REMOVED*** 6. ACGME COMPLIANCE TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Clinical Supervision
...
***REMOVED******REMOVED*** 11. ERROR HANDLING TEMPLATE
...
***REMOVED******REMOVED*** 12. SOLVER CONTROL TEMPLATE
