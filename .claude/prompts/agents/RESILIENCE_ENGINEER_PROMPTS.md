***REMOVED*** Resilience Engineer Agent - Prompt Templates
...
***REMOVED******REMOVED*** 1. RESILIENCE ASSESSMENT TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Defense Levels (GREEN to BLACK)
...
***REMOVED******REMOVED******REMOVED*** Single Point of Failures (SPOF)
- SPOF 1: ${SPOF_1} (Impact: ${IMPACT_1})
- SPOF 2: ${SPOF_2} (Impact: ${IMPACT_2})
- SPOF 3: ${SPOF_3} (Impact: ${IMPACT_3})

***REMOVED******REMOVED******REMOVED*** Critical Resources
...
***REMOVED******REMOVED*** 2. N-1 CONTINGENCY TEMPLATE
...
***REMOVED******REMOVED*** 3. N-2 CONTINGENCY TEMPLATE
...
***REMOVED******REMOVED*** 4. FAILURE MODE ANALYSIS TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Failure Mode 1: Database Connection Loss
- Severity: 9/10
- Probability: 2/10
- Detectability: 10/10
- RPN = 9 × 2 × 10 = 180
...
***REMOVED******REMOVED******REMOVED*** Failure Mode 2: Memory Leak
- Severity: 7/10
- Probability: 3/10
- Detectability: 5/10
- RPN = 7 × 3 × 5 = 105
...
***REMOVED******REMOVED******REMOVED*** Failure Mode 3: Solver Timeout
- Severity: 5/10
- Probability: 4/10
- Detectability: 10/10
- RPN = 5 × 4 × 10 = 200
...
***REMOVED******REMOVED*** 5. CHAOS ENGINEERING TEMPLATE
...
***REMOVED******REMOVED*** 6. CONTINGENCY DRILLS TEMPLATE
...
***REMOVED******REMOVED*** 7. RECOVERY DISTANCE ANALYSIS TEMPLATE
...
***REMOVED******REMOVED******REMOVED*** Strategy 1: Minimal Changes
