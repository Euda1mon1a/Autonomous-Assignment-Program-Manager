***REMOVED*** HISTORIAN Agent Specification
...
***REMOVED******REMOVED******REMOVED*** The Human Context Problem
...
***REMOVED******REMOVED******REMOVED*** Narrative Over Reference
...
***REMOVED******REMOVED*** Invocation Criteria

***REMOVED******REMOVED******REMOVED*** When to Invoke HISTORIAN

HISTORIAN should be invoked when any of these occur:

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. **Poignant Failures** (Failures That Teach)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. **Breakthrough Moments**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. **Significant Design Decisions**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. **Stakeholder-Impacting Changes**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. **Cross-Disciplinary Insights**
...
```markdown
***REMOVED*** Session XXX: [Evocative Title]
...
***REMOVED******REMOVED*** The Resolution

[What was ultimately done? Why did this approach work?]

---

***REMOVED******REMOVED*** Insights Gained
...
***REMOVED******REMOVED*** Example Invocation Scenarios

***REMOVED******REMOVED******REMOVED*** Scenario 1: The Night Float Epiphany
...
***REMOVED******REMOVED******REMOVED*** Scenario 2: The SIR Model Breakthrough
...
***REMOVED******REMOVED******REMOVED*** Scenario 3: The Swap System Philosophy
...
***REMOVED******REMOVED*** Relationship to Other Agents

***REMOVED******REMOVED******REMOVED*** HISTORIAN vs. META_UPDATER
...
***REMOVED******REMOVED******REMOVED*** ORCHESTRATOR's Role
...
***REMOVED******REMOVED*** Tone and Style Guidelines
...
***REMOVED******REMOVED*** Example Opening Paragraphs

***REMOVED******REMOVED******REMOVED*** Good (Narrative, Contextual)
...
***REMOVED******REMOVED******REMOVED*** Bad (Dry, Technical)
...
***REMOVED******REMOVED******REMOVED*** Required Context (Minimum)
...
***REMOVED******REMOVED******REMOVED*** Artifacts to Provide
...
***REMOVED******REMOVED******REMOVED*** Example Delegation Message
...
**Artifacts:**
- PR ***REMOVED***523: docs: Session 014 - HISTORIAN agent and The Block Revelation
- Commits: faa56ca
...
***REMOVED******REMOVED*** Invocation Syntax

```bash
***REMOVED*** From ORCHESTRATOR or human command
