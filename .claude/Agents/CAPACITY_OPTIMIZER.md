***REMOVED*** CAPACITY_OPTIMIZER Agent
...
```markdown
***REMOVED******REMOVED*** Task for CAPACITY_OPTIMIZER
...
```markdown
***REMOVED******REMOVED*** Staffing Analysis: [Specialty]
...
**Process Capability:**
```markdown
***REMOVED******REMOVED*** Schedule Quality Report
| Index | Value | Status |
|-------|-------|--------|
...
**Equity Analysis:**
```markdown
***REMOVED******REMOVED*** Workload Equity Analysis
...
**Utilization Check:**
```markdown
***REMOVED******REMOVED*** Utilization Status
...
***REMOVED******REMOVED******REMOVED*** 1. Erlang-C Coverage Optimization
...
async def optimize_specialty_coverage(
    specialty: str,
    arrival_rate: float,      ***REMOVED*** cases/hour
    service_time_min: float,  ***REMOVED*** minutes per case
    target_wait_min: float = 15.0,
    target_wait_prob: float = 0.05  ***REMOVED*** 5% chance of waiting > target
...
***REMOVED******REMOVED******REMOVED*** 2. Process Capability Analysis
...
```python
***REMOVED*** Weekly work hours (ACGME compliance)
await calculate_process_capability(
    data=weekly_hours_by_resident,
    lower_spec_limit=40,   ***REMOVED*** Minimum useful engagement
    upper_spec_limit=80,   ***REMOVED*** ACGME maximum
    target=60              ***REMOVED*** Ideal balance
)

***REMOVED*** Coverage rates
await calculate_process_capability(
    data=daily_coverage_rates,
    lower_spec_limit=0.95, ***REMOVED*** Minimum acceptable coverage
    upper_spec_limit=1.0,  ***REMOVED*** Maximum (full coverage)
    target=1.0             ***REMOVED*** Goal: 100% coverage
)

***REMOVED*** Utilization rates
await calculate_process_capability(
    data=weekly_utilization_rates,
    lower_spec_limit=0.0,  ***REMOVED*** Minimum (no floor)
    upper_spec_limit=0.8,  ***REMOVED*** Maximum (80% threshold)
    target=0.70            ***REMOVED*** Optimal operating point
)
```

***REMOVED******REMOVED******REMOVED*** 3. Equity Metrics Analysis
...
```python
***REMOVED*** Simple hours don't capture difficulty
base_hours = {"RES-01": 50, "RES-02": 50, "RES-03": 50}

***REMOVED*** But night shifts are harder
intensity_weights = {
    "RES-01": 1.0,   ***REMOVED*** Day shifts only
    "RES-02": 1.3,   ***REMOVED*** Some weekend shifts
    "RES-03": 1.5    ***REMOVED*** Night float rotation
}

***REMOVED*** Intensity-adjusted hours reveal true inequality
adjusted_hours = {
    "RES-01": 50 * 1.0 = 50,
    "RES-02": 50 * 1.3 = 65,  ***REMOVED*** Effectively 65 "standard hours"
    "RES-03": 50 * 1.5 = 75   ***REMOVED*** Effectively 75 "standard hours"
}
```
...
***REMOVED******REMOVED******REMOVED*** 4. Utilization Threshold Monitoring
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Specialty Staffing Optimization
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Schedule Quality Assessment
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Workload Equity Analysis
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Utilization Health Check
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Capacity Planning Scenario Analysis
...
***REMOVED******REMOVED******REMOVED*** Automatic Escalation (System-Driven)
...
***REMOVED******REMOVED******REMOVED*** Manual Escalation (Judgment-Based)
...
```markdown
***REMOVED******REMOVED*** Capacity Optimization Alert: [Title]
...
***REMOVED******REMOVED******REMOVED*** Expected Outcomes
- Utilization: XX% -> YY%
- Service Level: XX% -> YY%
- Gini: X.XX -> Y.YY

***REMOVED******REMOVED******REMOVED*** Decision Required
...
***REMOVED******REMOVED******REMOVED*** Staffing Table Format

```markdown
***REMOVED******REMOVED*** Staffing Analysis: [Specialty Name]
...
***REMOVED******REMOVED******REMOVED*** Process Capability Report Format
...
***REMOVED******REMOVED******REMOVED*** Capability Indices
...
***REMOVED******REMOVED******REMOVED*** Classification
...
***REMOVED******REMOVED******REMOVED*** Centering Assessment
...
***REMOVED******REMOVED******REMOVED*** Equity Report Format
...
***REMOVED******REMOVED******REMOVED*** Equity Metrics
| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| Gini Coefficient | X.XX | < 0.15 | [status] |
| Coefficient of Variation | X.XX | < 0.20 | [status] |

***REMOVED******REMOVED******REMOVED*** Workload Distribution
| Statistic | Hours |
|-----------|-------|
| Mean | X.X |
| Std Dev | X.X |
...
***REMOVED******REMOVED******REMOVED*** Outliers
...
***REMOVED******REMOVED******REMOVED*** Projected Improvement
- Current Gini: X.XX
- Projected Gini: Y.YY
- Improvement: ZZ%
```
...
***REMOVED******REMOVED*** Optimization Goals

***REMOVED******REMOVED******REMOVED*** Service Level Targets
...
***REMOVED******REMOVED******REMOVED*** Utilization Guardrails
...
***REMOVED******REMOVED******REMOVED*** Capacity Buffer Requirements

```python
***REMOVED*** Minimum safety margins
MIN_UTILIZATION_BUFFER = 0.20  ***REMOVED*** 20% idle capacity required
MIN_N1_PASS_RATE = 0.90        ***REMOVED*** 90% of N-1 scenarios must pass
MIN_SERVICE_LEVEL = 0.90       ***REMOVED*** 90% served within target wait

***REMOVED*** Circuit breaker thresholds
UTILIZATION_CIRCUIT_BREAKER = 0.90  ***REMOVED*** Halt new assignments
QUEUE_GROWTH_CIRCUIT_BREAKER = 3    ***REMOVED*** Queue growing 3x expected
```
...
***REMOVED******REMOVED******REMOVED*** With SCHEDULER
...
***REMOVED******REMOVED******REMOVED*** With RESILIENCE_ENGINEER
...
***REMOVED******REMOVED******REMOVED*** With ORCHESTRATOR
