...
***REMOVED******REMOVED******REMOVED*** Cannot Execute (Report Only)
...
***REMOVED******REMOVED******REMOVED*** A. Skills (`.claude/skills/*/SKILL.md`)
...
| `S-SECT-001` | "When to Use" section exists | `***REMOVED******REMOVED*** When to Use` heading present | "Missing required section: When to Use" |
| `S-SECT-002` | "Required Actions" section exists | `***REMOVED******REMOVED*** Required Actions` heading present | "Missing required section: Required Actions" |

**Advisory Checks (Warn if Fail):**

| Check ID | Check | Pass Criteria | Warning |
|----------|-------|---------------|---------|
| `S-DOC-001` | Examples section exists | `***REMOVED******REMOVED*** Examples` heading present | "Recommended: Add Examples section" |
| `S-DOC-002` | Related section exists | `***REMOVED******REMOVED*** Related` heading present | "Recommended: Add Related section" |
...
***REMOVED******REMOVED******REMOVED*** B. Agent Specifications (`.claude/Agents/*.md`)
...
| `A-SECT-001` | Charter section exists | `***REMOVED******REMOVED*** Charter` heading present | "Missing required section: Charter" |
| `A-SECT-002` | Decision Authority section | `***REMOVED******REMOVED*** Decision Authority` heading | "Missing required section: Decision Authority" |
| `A-SECT-003` | Escalation Rules section | `***REMOVED******REMOVED*** Escalation Rules` heading | "Missing required section: Escalation Rules" |
| `A-SECT-004` | Version History section | `***REMOVED******REMOVED*** Version History` heading | "Missing required section: Version History" |

**Advisory Checks (Warn if Fail):**

| Check ID | Check | Pass Criteria | Warning |
|----------|-------|---------------|---------|
| `A-SECT-005` | Personality Traits section | `***REMOVED******REMOVED*** Personality Traits` heading | "Recommended: Add Personality Traits section" |
| `A-SECT-006` | Key Workflows section | `***REMOVED******REMOVED*** Key Workflows` heading | "Recommended: Add Key Workflows section" |
| `A-SECT-007` | How to Delegate section | `***REMOVED******REMOVED*** How to Delegate` heading | "Recommended: Add delegation instructions" |
...
***REMOVED******REMOVED******REMOVED*** C. MCP Tools (`mcp-server/src/scheduler_mcp/tools/*.py`)
...
***REMOVED******REMOVED******REMOVED*** D. Slash Commands (`.claude/commands/*.md`)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Validate Skill Creation
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Validate Agent Specification
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Validate MCP Tool
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Revision Validation
...
***REMOVED******REMOVED*** Validation Report Format

***REMOVED******REMOVED******REMOVED*** Standard Report Structure
...
validation_report:
  ...
  advisory_checks:
    - id: "S-DOC-001"
      ...
      recommendation: "Add ***REMOVED******REMOVED*** Examples section with usage examples"
...
***REMOVED******REMOVED******REMOVED*** Quick Report (for Fast Path)
...
***REMOVED******REMOVED******REMOVED*** When to Escalate to COORD_TOOLING
...
***REMOVED******REMOVED******REMOVED*** When to Flag for TOOLSMITH Revision
...
***REMOVED******REMOVED******REMOVED*** When to Flag for ARCHITECT
...
```markdown
***REMOVED******REMOVED*** TOOL_QA Escalation: [Title]
...
***REMOVED******REMOVED******REMOVED*** Validation State
[What checks passed before the issue?]
[What checks remain?]

***REMOVED******REMOVED******REMOVED*** Question/Request
[What decision or action is needed?]

***REMOVED******REMOVED******REMOVED*** Options (if applicable)
1. [Option A]
2. [Option B]
```
...
***REMOVED******REMOVED******REMOVED*** A. Partial Artifacts
...
***REMOVED******REMOVED******REMOVED*** B. Unknown Artifact Type
...
***REMOVED******REMOVED******REMOVED*** C. Conflicting Validation Rules
...
***REMOVED******REMOVED******REMOVED*** D. New Patterns
...
***REMOVED******REMOVED******REMOVED*** E. Legacy Artifacts
...
***REMOVED******REMOVED******REMOVED*** Accuracy
...
***REMOVED******REMOVED******REMOVED*** Clarity
