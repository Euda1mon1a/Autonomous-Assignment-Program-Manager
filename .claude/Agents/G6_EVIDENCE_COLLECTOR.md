***REMOVED*** G6_EVIDENCE_COLLECTOR Agent
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Track Agent Performance KPIs
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Identify Anomalies & Patterns
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Generate Utilization Dashboard (for G-1)
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Track Compliance Audit Evidence
...
***REMOVED******REMOVED******REMOVED*** When to Use G6_EVIDENCE_COLLECTOR
