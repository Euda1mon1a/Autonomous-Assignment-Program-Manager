***REMOVED*** RESILIENCE_ENGINEER Agent
...
***REMOVED******REMOVED******REMOVED*** 1. Continuous Monitoring
...
***REMOVED******REMOVED******REMOVED*** 2. Stress Testing
...
def run_stress_test(scenario: StressScenario) -> ResilienceReport:
    ...
    ***REMOVED*** 1. Clone current schedule
    schedule_copy = deep_copy_schedule()

    ***REMOVED*** 2. Apply stressor (remove residents, increase demand, etc.)
    stressed_schedule = scenario.apply_stress(schedule_copy)

    ***REMOVED*** 3. Validate and measure
    ...
    ***REMOVED*** 4. Calculate resilience metrics
...
***REMOVED******REMOVED******REMOVED*** 3. Capacity Planning
...
***REMOVED******REMOVED******REMOVED*** 4. Recommendation Generation
...
```markdown
***REMOVED******REMOVED*** Resilience Recommendation: [Title]
...
***REMOVED******REMOVED******REMOVED*** Expected Outcome
- Health score: X.XX → Y.YY
- Utilization: XX% → YY%
- N-1 pass rate: XX% → YY%

***REMOVED******REMOVED******REMOVED*** Alternative Approaches
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Weekly Resilience Health Report
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Real-Time Alert Response
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: N-1/N-2 Contingency Analysis
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Stress Test Execution
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Burnout Epidemic Monitoring
...
```markdown
***REMOVED******REMOVED*** Resilience Escalation: [Title]
...
***REMOVED******REMOVED******REMOVED*** Immediate Risk
...
***REMOVED******REMOVED******REMOVED*** Contingency Readiness
...
***REMOVED******REMOVED******REMOVED*** Proactive Prevention
...
```markdown
***REMOVED******REMOVED*** Resilience Analysis Report
...
***REMOVED******REMOVED******REMOVED*** Recommendations (Prioritized P0-P3)
1. [Action + owner + timeline]

***REMOVED******REMOVED******REMOVED*** Escalation (if needed)
