***REMOVED*** OPTIMIZATION_SPECIALIST Agent
...
***REMOVED******REMOVED******REMOVED*** Primary Ownership (Full Authority)

**Bio-Inspired Optimization:**
```
backend/app/scheduling/bio_inspired/
├── __init__.py              ***REMOVED*** Module exports
├── base.py                  ***REMOVED*** BioInspiredSolver, Chromosome, Individual
├── genetic_algorithm.py     ***REMOVED*** GeneticAlgorithmSolver
├── nsga2.py                 ***REMOVED*** NSGA2Solver, ParetoFront
├── particle_swarm.py        ***REMOVED*** ParticleSwarmSolver
├── ant_colony.py            ***REMOVED*** AntColonySolver
├── hybrid_quantum.py        ***REMOVED*** HybridGAQUBOSolver
├── visualization.py         ***REMOVED*** FitnessLandscapeVisualizer
└── export.py                ***REMOVED*** ParetoExporter
```
...
├── __init__.py              ***REMOVED*** Module exports
├── qubo_solver.py           ***REMOVED*** QUBOFormulation, SimulatedQuantumAnnealingSolver
├── call_assignment_qubo.py  ***REMOVED*** CallAssignmentQUBO
└── qubo_template_selector.py ***REMOVED*** QUBO template selection
```
...
├── __init__.py              ***REMOVED*** Module exports
├── core.py                  ***REMOVED*** ObjectiveConfig, Solution, ParetoFrontier
├── moead.py                 ***REMOVED*** MOEADAlgorithm
├── constraints.py           ***REMOVED*** ConstraintHandler, PenaltyMethod
├── preferences.py           ***REMOVED*** PreferenceArticulator
├── indicators.py            ***REMOVED*** HypervolumeIndicator, SpreadIndicator
├── decision_support.py      ***REMOVED*** DecisionMaker, TradeOffAnalyzer
├── diversity.py             ***REMOVED*** CrowdingDistance, EpsilonDominance
├── export.py                ***REMOVED*** HolographicExporter
└── reweighting.py           ***REMOVED*** DynamicReweighter
```

***REMOVED******REMOVED******REMOVED*** Interface Ownership (Consult on Changes)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Optimize Schedule Fairness with NSGA-II
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Call Assignment via QUBO
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Tune Genetic Algorithm Hyperparameters
...
***REMOVED******REMOVED*** Constraints & Invariants

***REMOVED******REMOVED******REMOVED*** Algorithm Correctness
...
***REMOVED******REMOVED*** Coordination with Other Agents

***REMOVED******REMOVED******REMOVED*** SCHEDULER (via COORD_ENGINE)
...
***REMOVED******REMOVED******REMOVED*** RESILIENCE_ENGINEER (via COORD_ENGINE)
...
***REMOVED******REMOVED******REMOVED*** Algorithm Quality
