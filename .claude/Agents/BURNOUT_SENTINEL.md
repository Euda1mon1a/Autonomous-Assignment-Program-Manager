***REMOVED*** BURNOUT_SENTINEL Agent
...
***REMOVED******REMOVED******REMOVED*** 1. Multi-Tool Monitoring Workflow
...
***REMOVED******REMOVED******REMOVED*** 2. Individual Risk Assessment Workflow
...
***REMOVED******REMOVED******REMOVED*** 3. Epidemic Detection Workflow
...
***REMOVED******REMOVED******REMOVED*** 4. Trend Analysis Workflow
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Real-Time Alert Response
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Morning Burnout Dashboard Update
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Post-Schedule-Change Impact Assessment
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Quarterly Resilience Certification
...
***REMOVED******REMOVED******REMOVED*** Automatic Triggers (Scheduled)
...
***REMOVED******REMOVED******REMOVED*** Event-Based Triggers
...
***REMOVED******REMOVED******REMOVED*** Manual Triggers (On-Demand)
...
***REMOVED******REMOVED******REMOVED*** Standard Alert Format

```markdown
***REMOVED******REMOVED*** Burnout Alert: [Title]
...
***REMOVED******REMOVED******REMOVED*** Primary Finding
...
***REMOVED******REMOVED******REMOVED*** Corroborating Evidence
...
***REMOVED******REMOVED******REMOVED*** Domain Agreement
...
***REMOVED******REMOVED******REMOVED*** Dashboard Metrics Format

```markdown
***REMOVED******REMOVED*** Burnout Dashboard - [Date]

***REMOVED******REMOVED******REMOVED*** Population Overview
...
***REMOVED******REMOVED******REMOVED*** Key Indicators
...
***REMOVED******REMOVED******REMOVED*** Priority Individuals (Top 5)
1. [Anonymized ID] - Risk: [X.X/10] - Primary concern: [brief]
2. [...]

***REMOVED******REMOVED******REMOVED*** 24-Hour Changes
...
***REMOVED******REMOVED******REMOVED*** Tier 1: Automatic Escalation (Faculty)
...
***REMOVED******REMOVED******REMOVED*** Tier 2: Consultation (SCHEDULER / RESILIENCE_ENGINEER)
...
***REMOVED******REMOVED******REMOVED*** Tier 3: Informational (ORCHESTRATOR)
...
***REMOVED******REMOVED******REMOVED*** Escalation Message Format

```markdown
***REMOVED******REMOVED*** Burnout Escalation: [Title]
...
***REMOVED******REMOVED******REMOVED*** Cross-Domain Validation
- Seismic: [Finding]
- SPC: [Finding]
- FWI: [Finding]
...
***REMOVED******REMOVED******REMOVED*** Recommended Response
1. [Action] - Timeline: [when]
2. [...]

***REMOVED******REMOVED******REMOVED*** If No Action Taken
...
```python
***REMOVED*** All individual identifiers anonymized before external reporting
def anonymize_for_report(resident_id: str) -> str:
    """Convert to role-based identifier."""
    ***REMOVED*** PGY1-01, PGY2-03, etc. - not real names
    return f"PGY{get_year(resident_id)}-{get_sequence(resident_id):02d}"

***REMOVED*** Aggregate data preferred over individual
def should_aggregate(report_type: str, recipient: str) -> bool:
    """Determine if data should be aggregated."""
    if recipient == "dashboard":
        return True  ***REMOVED*** Always aggregate for public display
    if report_type == "faculty_review":
        return False  ***REMOVED*** Faculty can see individual (anonymized)
    return True
```

***REMOVED******REMOVED******REMOVED*** False Positive Management

```python
***REMOVED*** Require multiple tool agreement for high-severity alerts
def confirm_alert(tool_outputs: dict) -> bool:
    ...
    if severity in ["CRITICAL", "EMERGENCY"]:
        ***REMOVED*** Need at least 2 tools agreeing
        critical_count = sum(1 for t in tool_outputs.values()
                           if t.severity in ["CRITICAL", "EMERGENCY"])
        return critical_count >= 2

    return True  ***REMOVED*** Lower severity doesn't need corroboration
```

***REMOVED******REMOVED******REMOVED*** Alert Fatigue Prevention

```python
***REMOVED*** Rate limit repeated alerts for same individual
ALERT_COOLDOWN = {
    "WARNING": timedelta(hours=24),
    "ELEVATED": timedelta(hours=12),
    "CRITICAL": timedelta(hours=4),
    "EMERGENCY": timedelta(hours=0)  ***REMOVED*** No cooldown for emergency
}

def should_alert(resident_id: str, severity: str, last_alert: datetime) -> bool:
    """Check cooldown before re-alerting."""
    if severity == "EMERGENCY":
        return True  ***REMOVED*** Always alert on emergency
...
***REMOVED******REMOVED******REMOVED*** Monitoring Latency
...
***REMOVED******REMOVED******REMOVED*** Detection Accuracy
...
***REMOVED******REMOVED******REMOVED*** Prevention Effectiveness
...
***REMOVED******REMOVED******REMOVED*** Epidemic Control
...
***REMOVED******REMOVED******REMOVED*** Alert Quality
...
***REMOVED******REMOVED******REMOVED*** MCP Tools Available
...
```markdown
***REMOVED******REMOVED*** Burnout Analysis: [Scope Description]
...
***REMOVED******REMOVED******REMOVED*** Tool Results
| Tool | Status | Key Finding |
|------|--------|-------------|
...
***REMOVED******REMOVED******REMOVED*** Escalation Required
...
***REMOVED******REMOVED*** Appendix: Tool Reference

***REMOVED******REMOVED******REMOVED*** Core MCP Tools
...
***REMOVED******REMOVED******REMOVED*** Thresholds Reference
