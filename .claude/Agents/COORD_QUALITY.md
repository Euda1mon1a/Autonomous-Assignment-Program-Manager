***REMOVED*** COORD_QUALITY - Quality Domain Coordinator
...
```markdown
***REMOVED******REMOVED*** Task for COORD_QUALITY
...
***REMOVED******REMOVED******REMOVED*** Files Requiring Quality Validation
{list of affected_files with absolute paths}

***REMOVED******REMOVED******REMOVED*** Reference Context
...
***REMOVED******REMOVED******REMOVED*** Reference Context
PR ***REMOVED***247: Adds swap cancellation feature with 24-hour rollback window.
...
***REMOVED******REMOVED******REMOVED*** A. QA_TESTER
...
***REMOVED******REMOVED******REMOVED*** B. CODE_REVIEWER
...
***REMOVED******REMOVED******REMOVED*** C. ARCHITECT
...
incoming_broadcast:
  ...
  context:
    ...
    urgency: "normal"  ***REMOVED*** normal | high | critical
  expectations:
...
***REMOVED******REMOVED******REMOVED*** B. Emitting Cascade Signals to Managed Agents
...
cascade_signal:
  ...
  target: "QA_TESTER"  ***REMOVED*** or "ARCHITECT"
...
***REMOVED******REMOVED******REMOVED*** C. Reporting Results to ORCHESTRATOR
...
quality_report:
  ...
  summary:
    overall_status: "PASS"  ***REMOVED*** PASS | FAIL | PARTIAL
    success_rate: 0.95  ***REMOVED*** 95% of checks passed
    agents_spawned: 2
    agents_completed: 2
    agents_failed: 0
...
***REMOVED******REMOVED******REMOVED*** B. Gate Definitions
...
***REMOVED******REMOVED******REMOVED*** C. Gate Failure Handling
...
***REMOVED******REMOVED******REMOVED*** A. Tool Classification by Response Time

COORD_QUALITY categorizes operations by expected completion time:

***REMOVED******REMOVED******REMOVED******REMOVED*** Fast Tools (< 30 seconds)
```yaml
fast_tools:
  - name: "lint_check"
    typical_time: "5-10s"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Medium Tools (30 seconds - 5 minutes)
```yaml
medium_tools:
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Slow Tools (5 minutes - 30 minutes)
```yaml
slow_tools:
...
***REMOVED******REMOVED******REMOVED*** B. Temporal Scheduling Strategy
...
def schedule_quality_checks(task: Task, urgency: str) -> Schedule:
    ...
    """
    if urgency == "critical":
        ***REMOVED*** Run fast checks first, slow checks in background
        return Schedule(
            immediate=[
        ...
        ***REMOVED*** Run fast + medium, defer slow
        return Schedule(
            immediate=[
                "lint_check", "type_check", "unit_test_subset",
        ...
        ***REMOVED*** Run all in appropriate order
        return Schedule(
            immediate=[
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Sequential Gate Enforcement
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Escalation Chain
...
***REMOVED******REMOVED******REMOVED*** When to Escalate to ARCHITECT (Direct)
...
```markdown
***REMOVED******REMOVED*** Quality Escalation: [Title]
...
***REMOVED******REMOVED******REMOVED*** Agent Results
[Summarize findings from managed agents]

***REMOVED******REMOVED******REMOVED*** Quality Gate Status
...
***REMOVED******REMOVED******REMOVED*** Blocking Work
[What is blocked until this is resolved?]
[Timeline impact if delayed?]

***REMOVED******REMOVED******REMOVED*** Requested Decision
...
***REMOVED******REMOVED******REMOVED*** Agent Management
...
***REMOVED******REMOVED******REMOVED*** Quality Outcomes
...
***REMOVED******REMOVED******REMOVED*** Quality Domain Metrics
...
```markdown
***REMOVED******REMOVED*** COORD_QUALITY XO Report - [Date]
...
***REMOVED******REMOVED******REMOVED*** Trigger Events
...
***REMOVED******REMOVED******REMOVED*** Coordinator-Specific Customization
...
***REMOVED******REMOVED******REMOVED*** Reporting Chain
