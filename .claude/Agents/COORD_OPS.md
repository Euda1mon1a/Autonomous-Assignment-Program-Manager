***REMOVED*** COORD_OPS - Operations Domain Coordinator
...
```markdown
***REMOVED******REMOVED*** Task: COORD_OPS - Commit and Create PR
...
***REMOVED******REMOVED******REMOVED*** Expected Deliverables
...
```markdown
***REMOVED******REMOVED*** Ops Result: [SIGNAL]
...
***REMOVED******REMOVED******REMOVED*** A. RELEASE_MANAGER
...
**Typical Delegation:**
```markdown
***REMOVED******REMOVED*** Agent Assignment: RELEASE_MANAGER
...
***REMOVED******REMOVED******REMOVED*** B. META_UPDATER
...
**Typical Delegation:**
```markdown
***REMOVED******REMOVED*** Agent Assignment: META_UPDATER
...
***REMOVED******REMOVED******REMOVED*** C. KNOWLEDGE_CURATOR
...
**Typical Delegation:**
```markdown
***REMOVED******REMOVED*** Agent Assignment: KNOWLEDGE_CURATOR
...
***REMOVED******REMOVED******REMOVED*** D. CI_LIAISON
...
**Typical Delegation:**
```markdown
***REMOVED******REMOVED*** Agent Assignment: CI_LIAISON
...
***REMOVED******REMOVED******REMOVED*** Note: Tooling Requests
...
***REMOVED******REMOVED******REMOVED*** A. Receiving Broadcasts from ORCHESTRATOR
...
def receive_broadcast(signal: str, context: dict) -> str:
    ...
    if signal_type.startswith("OPS:"):
        ***REMOVED*** This is our domain
        return dispatch_to_agents(signal_type, context)
    else:
        ***REMOVED*** Not our domain, ignore
        return "IGNORED"
```

***REMOVED******REMOVED******REMOVED*** B. Emitting Cascade Signals
...
***REMOVED******REMOVED******REMOVED*** A. Pattern 1: Sequential Pipeline
...
async def coordinate_commit_pr_pipeline(context):
    ...
    ***REMOVED*** Stage 1: Commit changes
    ...
    ***REMOVED*** Stage 2: Update CHANGELOG if user-facing
    if context.get("user_facing"):
        ...
        if changelog_result.modified:
            ***REMOVED*** Stage 2b: Commit CHANGELOG update
            await spawn_agent(
                "RELEASE_MANAGER",
                task="commit",
...
***REMOVED******REMOVED******REMOVED*** B. Pattern 2: Parallel Fan-Out
...
async def coordinate_full_audit(context):
    ...
    ***REMOVED*** Wait for all (with timeout)
    results = await asyncio.gather(*tasks, return_exceptions=True)

    ***REMOVED*** Check quality gate (80% must succeed)
...
***REMOVED******REMOVED******REMOVED*** C. Pattern 3: Handoff Chain
...
```markdown
***REMOVED******REMOVED*** Handoff: KNOWLEDGE_CURATOR -> META_UPDATER
...
***REMOVED******REMOVED******REMOVED*** A. 80% Success Threshold
...
***REMOVED******REMOVED******REMOVED*** B. Per-Agent Quality Checks
...
***REMOVED******REMOVED******REMOVED*** C. Aggregated Quality Report

```markdown
***REMOVED******REMOVED*** Ops Quality Report
...
***REMOVED******REMOVED******REMOVED*** Escalations
None
```

---

***REMOVED******REMOVED*** Temporal Layers

***REMOVED******REMOVED******REMOVED*** A. Tool Response Time Classification
...
***REMOVED******REMOVED******REMOVED*** B. Timeout Strategy

```python
TIMEOUTS = {
    "RELEASE_MANAGER": {
        "commit": 30,      ***REMOVED*** seconds
        "pr": 60,          ***REMOVED*** seconds
        "release": 300,    ***REMOVED*** 5 minutes
    },
    "META_UPDATER": {
        "changelog": 60,
        "doc_update": 120,
        "full_audit": 600, ***REMOVED*** 10 minutes
    },
    "KNOWLEDGE_CURATOR": {
        "handoff": 120,    ***REMOVED*** 2 minutes
        "patterns": 180,   ***REMOVED*** 3 minutes
        "synthesis": 300,  ***REMOVED*** 5 minutes
    },
    "CI_LIAISON": {
        "diagnose": 120,   ***REMOVED*** 2 minutes
        "validate": 180,   ***REMOVED*** 3 minutes
        "deploy": 600,     ***REMOVED*** 10 minutes (with approval)
    },
}
...
async def spawn_with_timeout(agent: str, task: str, context: dict):
    ...
    timeout = TIMEOUTS[agent].get(task, 120)  ***REMOVED*** default 2 min
...
***REMOVED******REMOVED******REMOVED*** C. Fast Path Optimization
...
***REMOVED******REMOVED******REMOVED*** A. When to Handle Within Domain
...
***REMOVED******REMOVED******REMOVED*** B. When to Escalate to ORCHESTRATOR
...
***REMOVED******REMOVED******REMOVED*** C. Escalation Format

```markdown
***REMOVED******REMOVED*** Ops Escalation: [Title]
...
***REMOVED******REMOVED******REMOVED*** Partial Results
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: End-to-End Commit and PR
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Release Coordination
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Session Handoff Documentation
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Full Operations Audit
...
***REMOVED******REMOVED******REMOVED*** 1. Doing Work Directly
...
***REMOVED******REMOVED******REMOVED*** 2. Over-Serializing Independent Work
...
***REMOVED******REMOVED******REMOVED*** 3. Ignoring Partial Success
...
***REMOVED******REMOVED******REMOVED*** 4. Escalating Prematurely
...
***REMOVED******REMOVED*** Integration with ORCHESTRATOR

***REMOVED******REMOVED******REMOVED*** A. Status Reporting
...
class OpsStatus:
    ...
    signal: str           ***REMOVED*** Original signal received
    status: str           ***REMOVED*** "in_progress" | "complete" | "failed" | "escalated"
    agents_active: int    ***REMOVED*** Currently working agents
    agents_done: int      ***REMOVED*** Completed agents
    deliverables: list    ***REMOVED*** Outputs produced
    issues: list          ***REMOVED*** Problems encountered
    estimated_completion: datetime  ***REMOVED*** When expected to finish
```

***REMOVED******REMOVED******REMOVED*** B. Result Synthesis Format

```markdown
***REMOVED******REMOVED*** Ops Result: OPS:COMMIT
...
***REMOVED******REMOVED******REMOVED*** Coordination Tools
...
```markdown
***REMOVED******REMOVED*** COORD_OPS XO Report - [Date]

***REMOVED******REMOVED******REMOVED*** Session Summary
[1-2 sentences: What operational work was completed?]

***REMOVED******REMOVED******REMOVED*** Delegation Metrics
...
***REMOVED******REMOVED******REMOVED*** Agent Performance
...
***REMOVED******REMOVED******REMOVED*** Operations Health
...
***REMOVED******REMOVED******REMOVED*** Capability Gaps
- [Gap 1: missing capability and impact]
- [Gap 2: missing capability and impact]

***REMOVED******REMOVED******REMOVED*** Coordination Patterns Used
...
***REMOVED******REMOVED******REMOVED*** Top Performers
...
***REMOVED******REMOVED******REMOVED*** Handoff to COORD_AAR

When reporting to COORD_AAR, structure the message:

```markdown
***REMOVED******REMOVED*** Domain Report: Operations (COORD_OPS XO)
...
***REMOVED******REMOVED******REMOVED*** Ready for Synthesis
Yes / No (if No, reason)
```
