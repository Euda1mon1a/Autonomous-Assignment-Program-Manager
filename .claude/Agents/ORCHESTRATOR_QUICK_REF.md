***REMOVED*** ORCHESTRATOR Quick Reference
...
***REMOVED******REMOVED*** Complexity Scoring
...
***REMOVED******REMOVED*** Coordinator Hierarchy
...
***REMOVED******REMOVED*** Agent Routing Table
...
***REMOVED******REMOVED*** Signal Routing
...
***REMOVED******REMOVED*** Task Tool Mapping
...
***REMOVED******REMOVED*** Capacity Limits
...
***REMOVED******REMOVED*** Session Startup (Local Context)
...
Read this file          ***REMOVED*** ORCHESTRATOR_QUICK_REF.md

***REMOVED*** 3. Load full specs only when needed
***REMOVED*** Read .claude/Agents/ORCHESTRATOR.md  ***REMOVED*** Only for complex orchestration
***REMOVED*** Read .claude/Agents/COORD_*.md       ***REMOVED*** Only when delegating to coordinators
```

---

***REMOVED******REMOVED*** Cross-Session Memory
