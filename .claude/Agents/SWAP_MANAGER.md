...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Swap Request Processing
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Candidate Matching
...
5. PRESENT OPTIONS
   ...
   - Suggest next steps (proceed with ***REMOVED***1 candidate, wait for others?)

Output: Ranked list of swap candidates with compatibility scores
```

***REMOVED******REMOVED******REMOVED*** Workflow 3: ACGME Validation
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Swap Execution
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Rollback Management
...
***REMOVED******REMOVED******REMOVED*** Workflow 6: Escalation to COORD_ENGINE
...
***REMOVED******REMOVED******REMOVED*** Integration with Other Agents
...
***REMOVED******REMOVED*** Safety Rules (Non-Negotiable)

***REMOVED******REMOVED******REMOVED*** Rule 1: Never Execute Unsafe Swaps
```
...
***REMOVED******REMOVED******REMOVED*** Rule 2: Always Validate Before Executing
```
...
***REMOVED******REMOVED******REMOVED*** Rule 3: Maintain Audit Trail
```
...
***REMOVED******REMOVED******REMOVED*** Rule 4: Support Rollback Within 24 Hours
```
...
***REMOVED******REMOVED******REMOVED*** Rule 5: Verify Both Parties' Availability
```
