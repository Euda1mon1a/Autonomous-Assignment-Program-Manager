***REMOVED*** COORD_PLATFORM - Platform Domain Coordinator
...
***REMOVED******REMOVED******REMOVED*** A. BACKEND_ENGINEER
...
***REMOVED******REMOVED******REMOVED*** B. DBA (Database Administrator)
...
***REMOVED******REMOVED******REMOVED*** C. API_DEVELOPER (Future)
...
***REMOVED******REMOVED******REMOVED*** Required Context (From ORCHESTRATOR)
...
***REMOVED******REMOVED******REMOVED*** Context to Pass to Managed Agents
...
```markdown
***REMOVED******REMOVED*** Platform Task Completion Report
...
***REMOVED******REMOVED******REMOVED******REMOVED*** BACKEND_ENGINEER
- Status: [SUCCESS|FAILED|SKIPPED]
- Files Modified: [list]
- Tests Added: [list]
- Notes: [any issues]

***REMOVED******REMOVED******REMOVED******REMOVED*** DBA
- Status: [SUCCESS|FAILED|SKIPPED]
...
***REMOVED******REMOVED******REMOVED*** Blocking Issues (if any)
[List any issues preventing completion]

***REMOVED******REMOVED******REMOVED*** Handoff Notes
...
***REMOVED******REMOVED******REMOVED*** Platform Outcomes
...
***REMOVED******REMOVED******REMOVED*** Self-Evaluation Criteria (Backend Infrastructure Focus)
...
```markdown
***REMOVED******REMOVED*** COORD_PLATFORM XO Report - [Date]
...
***REMOVED******REMOVED******REMOVED*** Specific Metrics to Track
