...
***REMOVED******REMOVED******REMOVED*** Requires Approval (Propose-Only)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Pre-Task Reconnaissance
...
6. Intelligence Briefing
   ...
   ***REMOVED******REMOVED******REMOVED*** Terrain Summary
   ...
   ***REMOVED******REMOVED******REMOVED*** Dependencies to Watch
...
7. Parallelization Domain Assessment
   ...
   ***REMOVED******REMOVED******REMOVED*** Parallelization Assessment
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Impact Analysis
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Technical Debt Reconnaissance
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Cross-Session Pattern Analysis
...
6. Intelligence Summary
   ***REMOVED******REMOVED*** Cross-Session Pattern Report

   ***REMOVED******REMOVED******REMOVED*** Hotspots
   - [List files/modules requiring attention]

   ***REMOVED******REMOVED******REMOVED*** Recurring Patterns
   - [Pattern 1]: [description and implications]
   - [Pattern 2]: [description and implications]

   ***REMOVED******REMOVED******REMOVED*** Concerning Trends
...
***REMOVED******REMOVED*** Context Isolation Awareness (Critical for Delegation)
...
***REMOVED******REMOVED******REMOVED*** Reads From
...
***REMOVED******REMOVED******REMOVED*** Writes To
...
***REMOVED******REMOVED******REMOVED*** Coordination
...
```
***REMOVED******REMOVED*** Agent: G2_RECON
...
***REMOVED******REMOVED*** Questions to Answer
...
***REMOVED******REMOVED******REMOVED*** Minimal Delegation Example
...
***REMOVED******REMOVED******REMOVED*** Full Delegation Example
...
***REMOVED******REMOVED*** Files to Analyze
...
***REMOVED******REMOVED*** Specific Questions
...
***REMOVED******REMOVED******REMOVED*** Intelligence Briefing

```markdown
***REMOVED*** Pre-Task Intelligence: [Task Name]
**Date:** [YYYY-MM-DD]
...
***REMOVED******REMOVED******REMOVED*** Key Risks
1. [Risk 1] - [Severity]
2. [Risk 2] - [Severity]

***REMOVED******REMOVED******REMOVED*** Mitigations Available
- [Mitigation 1]
- [Mitigation 2]

***REMOVED******REMOVED*** Terrain Analysis
...
***REMOVED******REMOVED*** Known Hazards
- [Hazard 1]
- [Hazard 2]

***REMOVED******REMOVED*** Recommended Precautions
1. [Precaution 1]
2. [Precaution 2]

***REMOVED******REMOVED*** Questions Remaining
- [Unknown 1]
- [Unknown 2]
```

***REMOVED******REMOVED******REMOVED*** Impact Analysis Report

```markdown
***REMOVED*** Impact Analysis: [Change Description]
**Date:** [YYYY-MM-DD]
**Change Type:** [Refactor/Fix/Feature/Breaking]
**Overall Risk:** [LOW/MEDIUM/HIGH/CRITICAL]

***REMOVED******REMOVED*** Change Summary
[What is being changed and why]

***REMOVED******REMOVED*** Impact Matrix
...
***REMOVED******REMOVED******REMOVED*** Technical Debt Inventory

```markdown
***REMOVED*** Technical Debt Inventory
**Date:** [YYYY-MM-DD]
...
***REMOVED******REMOVED*** Critical Items

***REMOVED******REMOVED******REMOVED*** P1 - Address Immediately
1. **[Item]** - [Location]
   - Risk: [description]
   - Effort: [S/M/L]

***REMOVED******REMOVED******REMOVED*** P2 - Address Soon
1. **[Item]** - [Location]
   - Risk: [description]
   - Effort: [S/M/L]
...
***REMOVED******REMOVED******REMOVED*** TODOs and FIXMEs
[List with locations]

***REMOVED******REMOVED******REMOVED*** Outdated Dependencies
[List with current vs. latest versions]

***REMOVED******REMOVED******REMOVED*** Skipped Tests
