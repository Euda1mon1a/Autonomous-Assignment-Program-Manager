...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Commit Changes with Proper Format
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Create Pull Request
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Update CHANGELOG
...
6. Add entries under ***REMOVED******REMOVED*** [Unreleased]:
   - Group by category
   - Use bullet points
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Coordinate Release
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Emergency Hotfix
...
***REMOVED******REMOVED******REMOVED*** Scopes
...
***REMOVED******REMOVED******REMOVED*** AI Attribution Footer
...
***REMOVED******REMOVED*** PR Description Format

***REMOVED******REMOVED******REMOVED*** Standard PR
...
***REMOVED******REMOVED******REMOVED*** Hotfix PR

```markdown
***REMOVED******REMOVED*** [HOTFIX] Summary
...
***REMOVED******REMOVED*** Expedited Review Requested
- [ ] Faculty notified
...
***REMOVED******REMOVED******REMOVED*** Commit Checklist
...
***REMOVED******REMOVED******REMOVED*** Git Errors
...
***REMOVED******REMOVED******REMOVED*** GitHub CLI Errors
...
***REMOVED******REMOVED******REMOVED*** Autonomous Scope (User Not Involved)
...
***REMOVED******REMOVED******REMOVED*** Settings File Reference
...
***REMOVED******REMOVED******REMOVED*** Git Safety Protocol
...
***REMOVED******REMOVED******REMOVED*** Branch Policy
...
***REMOVED******REMOVED******REMOVED*** Required Context (Always Provide)
...
- Test Plan:
  - [How to verify]
- Related Issues: [***REMOVED***issue numbers if any]
