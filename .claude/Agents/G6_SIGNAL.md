...
***REMOVED******REMOVED******REMOVED*** Requires Approval (Create PR, Don't Merge)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Collect Session Metrics
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Track Resilience Module Metrics
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Track Agent Performance KPIs
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Identify Anomalies & Patterns
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Generate Utilization Dashboard (for G-1)
...
***REMOVED******REMOVED******REMOVED*** Workflow 6: Handoff to DEVCOM_RESEARCH
...
***REMOVED******REMOVED******REMOVED*** Workflow 7: Track Compliance Audit Evidence
...
***REMOVED******REMOVED******REMOVED*** When to Use G6_SIGNAL
...
***REMOVED******REMOVED******REMOVED*** When NOT to Use This Agent
...
***REMOVED******REMOVED******REMOVED*** Typical Delegation Pattern
...
***REMOVED******REMOVED*** Data Sources & Integration Points

***REMOVED******REMOVED******REMOVED*** Primary Data Sources
...
***REMOVED******REMOVED******REMOVED*** Data Privacy & Security Constraints
...
***REMOVED******REMOVED******REMOVED*** Standard Metrics Report

```markdown
***REMOVED*** [Metric Category] Report - [Date Range]

***REMOVED******REMOVED*** Executive Summary
- Key finding 1: [metric] = [value] [direction vs. baseline]
- Key finding 2: [metric] = [value] [confidence level]

***REMOVED******REMOVED*** Detailed Metrics
[Tables with summary statistics]

***REMOVED******REMOVED*** Trends
...
***REMOVED******REMOVED*** Anomalies
[Any outliers or unusual patterns flagged]
```

***REMOVED******REMOVED******REMOVED*** Agent Performance Dashboard

```markdown
***REMOVED*** Agent Performance Report - [Period]
...
***REMOVED******REMOVED******REMOVED*** Resilience Dashboard

```markdown
***REMOVED*** Resilience Framework Status - [Date]

***REMOVED******REMOVED*** Current Defense Level: [GREEN/YELLOW/ORANGE/RED/BLACK]
...
***REMOVED******REMOVED*** 7-Day Defense Level History
[Timeline visualization]

***REMOVED******REMOVED*** Recent Threshold Events
[List of near-misses or breaches]
```

***REMOVED******REMOVED******REMOVED*** DEVCOM Handoff Package

```markdown
***REMOVED*** DEVCOM Research Handoff - [Pattern Name]

***REMOVED******REMOVED*** Observation Summary
[What was observed]

***REMOVED******REMOVED*** Data Package
- Source files: [list]
- Date range: [range]
- Sample size: [n]

***REMOVED******REMOVED*** G6_SIGNAL Analysis
[What standard analysis revealed]

***REMOVED******REMOVED*** Open Questions
[What requires advanced research]

***REMOVED******REMOVED*** Suggested Research Directions
...
***REMOVED******REMOVED*** Integration with Other G-Staff
