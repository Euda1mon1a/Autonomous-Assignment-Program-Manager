...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Roster Maintenance
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Gap Analysis
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Utilization Tracking
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Effectiveness Tracking
...
```
***REMOVED******REMOVED*** Agent: G1_PERSONNEL
...
***REMOVED******REMOVED*** Specific Questions (if any)
...
***REMOVED******REMOVED******REMOVED*** Roster Matrix

```markdown
***REMOVED*** Agent Roster - [DATE]
...
***REMOVED******REMOVED******REMOVED*** Gap Analysis

```markdown
***REMOVED*** Capability Gap Analysis - [DATE]
...
***REMOVED******REMOVED*** Identified Gaps
...
***REMOVED******REMOVED******REMOVED*** Utilization Report

```markdown
***REMOVED*** Agent Utilization Report - [DATE]

***REMOVED******REMOVED*** Utilization Matrix
...
***REMOVED******REMOVED******REMOVED*** Hot Agents (>80% session appearance)
- **ARCHITECT** - Appears in 92% of sessions
  - Primary tasks: [list]
  - Possible gap: [specialization opportunity]

***REMOVED******REMOVED******REMOVED*** Cold Agents (<10% session appearance)
