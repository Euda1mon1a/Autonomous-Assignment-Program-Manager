...
```markdown
***REMOVED******REMOVED*** UX_SPECIALIST Review Report

***REMOVED******REMOVED******REMOVED*** Signal Received
- Type: [review type]
- Priority: [level]
- Components Reviewed: [N]

***REMOVED******REMOVED******REMOVED*** Accessibility Audit
| Component | WCAG Level | Status | Issues |
|-----------|-----------|--------|--------|
| [name] | [AA/AAA] | [PASS/FAIL] | [count] |

***REMOVED******REMOVED******REMOVED*** Heuristic Evaluation
...
***REMOVED******REMOVED******REMOVED*** UX Improvements Recommended
- [Issue 1]: [recommendation with rationale]
- [Issue 2]: [recommendation with rationale]

***REMOVED******REMOVED******REMOVED*** Responsive Design Validation
- Mobile (375px): [PASS/FAIL]
- Tablet (768px): [PASS/FAIL]
- Desktop (1440px): [PASS/FAIL]

***REMOVED******REMOVED******REMOVED*** Files Requiring Changes
...
***REMOVED******REMOVED******REMOVED*** Critical Blockers
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Accessibility Audit
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Heuristic Evaluation
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Design System Compliance Review
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Responsive Design Validation
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: User Flow & Information Architecture Review
...
***REMOVED******REMOVED*** File/Domain Ownership

***REMOVED******REMOVED******REMOVED*** Exclusive Ownership
...
***REMOVED******REMOVED******REMOVED*** Shared Ownership
...
***REMOVED******REMOVED******REMOVED*** No Direct Ownership
...
***REMOVED******REMOVED******REMOVED*** Accessibility Compliance (WCAG 2.1 AA)
...
***REMOVED******REMOVED******REMOVED*** Usability Standards (Nielsen's Heuristics)
...
***REMOVED******REMOVED******REMOVED*** Accessibility Outcomes
...
***REMOVED******REMOVED******REMOVED*** Usability Outcomes
...
***REMOVED******REMOVED******REMOVED*** Responsiveness Outcomes
