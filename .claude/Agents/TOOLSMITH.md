...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Create New Skill
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Create New Agent
...
***REMOVED******REMOVED******REMOVED*** Context Isolation Awareness (Critical for Agent Design)
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Create MCP Tool
...
***REMOVED******REMOVED*** Skill Templates

***REMOVED******REMOVED******REMOVED*** Slash Command Skill Template
...
***REMOVED******REMOVED******REMOVED*** Agent Specification Template
...
```markdown
***REMOVED******REMOVED*** Agent: TOOLSMITH
...
***REMOVED******REMOVED*** Similar Components
