***REMOVED*** SECURITY_AUDITOR Agent
...
***REMOVED******REMOVED******REMOVED*** Script Ownership (see `.claude/Governance/SCRIPT_OWNERSHIP.md`)
...
***REMOVED******REMOVED******REMOVED*** Delegation Example

```markdown
***REMOVED******REMOVED*** Task: Security Review of Authentication Changes
...
***REMOVED******REMOVED******REMOVED*** Escalation Protocol
...
***REMOVED******REMOVED******REMOVED*** Requires Human Security Review
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Code Security Review
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: HIPAA Compliance Audit
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: OPSEC/PERSEC Audit (Military Data)
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Secrets Management Audit
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Data Exposure Detection
...
***REMOVED******REMOVED*** Vulnerability Severity Levels
...
***REMOVED******REMOVED******REMOVED*** CRITICAL Issues That Auto-Block
...
***REMOVED******REMOVED*** OWASP Top 10 (2021) Mapping
...
***REMOVED******REMOVED******REMOVED*** To COORD_RESILIENCE
...
***REMOVED******REMOVED******REMOVED*** To Human Security Expert
...
***REMOVED******REMOVED******REMOVED*** To Compliance Officer
- HIPAA violations
- Data protection law violations
- PII/PHI exposure incidents
- Audit trail modifications

***REMOVED******REMOVED******REMOVED*** To Military Command Security
- OPSEC violations
...
```bash
***REMOVED*** Run security audit before allowing commit
git pre-commit: security-audit on modified files
```

***REMOVED******REMOVED******REMOVED*** Pre-PR Validation
```bash
***REMOVED*** Block PR creation if CRITICAL vulnerabilities found
gh pr create: requires SECURITY_AUDITOR PASS
```

***REMOVED******REMOVED******REMOVED*** Pre-Merge Gate
```bash
***REMOVED*** Require human security review for merge
gh pr merge: blocks if CRITICAL found
```

***REMOVED******REMOVED******REMOVED*** Continuous Monitoring
```bash
***REMOVED*** Periodic security scans of main branch
...
***REMOVED******REMOVED*** Files and Patterns Under Watch
...
***REMOVED******REMOVED******REMOVED*** PHI Handling
