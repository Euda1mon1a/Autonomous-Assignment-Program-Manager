...
***REMOVED******REMOVED*** Chaos Experiment Types

***REMOVED******REMOVED******REMOVED*** 1. Infrastructure Chaos
...
***REMOVED******REMOVED******REMOVED*** 2. Schedule Domain Chaos
...
***REMOVED******REMOVED******REMOVED*** 3. Data Chaos
...
***REMOVED******REMOVED*** Chaos Experiment Protocol

***REMOVED******REMOVED******REMOVED*** Phase 1: Hypothesis
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Steady State
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Experiment
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Analysis
...
```markdown
***REMOVED******REMOVED*** Task: CHAOS_ENGINEER - N-1 Contingency Test

***REMOVED******REMOVED******REMOVED*** Experiment Type
Schedule Domain Chaos

***REMOVED******REMOVED******REMOVED*** Target Component
Faculty scheduling with single absence (Dr. Smith)

***REMOVED******REMOVED******REMOVED*** Hypothesis
...
```markdown
***REMOVED******REMOVED*** Chaos Experiment Report: [Name]
...
***REMOVED******REMOVED******REMOVED*** Execution Summary
...
***REMOVED******REMOVED******REMOVED*** Unexpected Behaviors
...
***REMOVED******REMOVED******REMOVED*** Blast Radius Measured
[Scope of impact - which components were affected]

***REMOVED******REMOVED******REMOVED*** Rollback Status
...
***REMOVED******REMOVED*** Safety Constraints
...
***REMOVED******REMOVED******REMOVED*** Information Required for Effective Execution
...
***REMOVED******REMOVED******REMOVED*** Basic Delegation Pattern
...
***REMOVED******REMOVED******REMOVED*** Example: N-1 Contingency Test
...
***REMOVED******REMOVED******REMOVED*** Example: Database Connection Failure
...
***REMOVED******REMOVED*** Chaos Experiment Template

```markdown
***REMOVED******REMOVED*** Chaos Experiment: [Name]

***REMOVED******REMOVED******REMOVED*** Hypothesis
When [condition], the system should [behavior].

***REMOVED******REMOVED******REMOVED*** Steady State Definition
- Metric 1: [baseline]
- Metric 2: [baseline]

***REMOVED******REMOVED******REMOVED*** Experiment Design
- **Target:** [component]
- **Failure Type:** [latency/error/crash/resource]
- **Duration:** [time]
- **Blast Radius:** [scope]
...
```bash
***REMOVED*** After experiment, verify rollback
cd backend
...
***REMOVED*** Verify no side effects
...
***REMOVED******REMOVED******REMOVED*** 1. Incomplete Rollback
...
**Fix:**
```python
***REMOVED*** BAD: Only restore one component
def rollback():
    restore_database_connection()
    ***REMOVED*** Forgot to restore Redis, cache, etc.

***REMOVED*** GOOD: Comprehensive rollback
def rollback():
    restore_database_connection()
...
***REMOVED******REMOVED******REMOVED*** 2. Blast Radius Expansion
...
**Fix:**
```python
***REMOVED*** BAD: Affects entire system
def inject_latency():
    ***REMOVED*** All API calls get 5s delay
    requests.get = slow_get

***REMOVED*** GOOD: Scoped to specific endpoint
def inject_latency():
    ***REMOVED*** Only /api/v1/schedules gets delay
...
***REMOVED******REMOVED******REMOVED*** 3. No Baseline Measurement
...
**Fix:**
```python
***REMOVED*** GOOD: Capture baseline first
def run_experiment():
    baseline = {
...
***REMOVED******REMOVED******REMOVED*** 4. Production Data Exposure
...
**Fix:**
```bash
***REMOVED*** BAD: Use production database for chaos test
export DATABASE_URL=postgresql://prod_db

***REMOVED*** GOOD: Use isolated test database
...
***REMOVED******REMOVED******REMOVED*** 5. Timeout Without Abort
...
**Fix:**
```python
***REMOVED*** BAD: No timeout
def run_experiment():
    inject_failure()
    while True:
        observe_system()

***REMOVED*** GOOD: Timeout with abort
...
```markdown
***REMOVED******REMOVED*** Chaos Engineering Report
...
***REMOVED******REMOVED******REMOVED*** Summary of Findings
[High-level summary]

***REMOVED******REMOVED******REMOVED*** Critical Findings
1. [Finding with severity and recommendation]

***REMOVED******REMOVED******REMOVED*** Experiments Detail
