***REMOVED*** DELEGATION_AUDITOR Agent
...
***REMOVED******REMOVED******REMOVED*** Requires Approval (via ORCHESTRATOR)
...
***REMOVED******REMOVED*** Metrics Framework

***REMOVED******REMOVED******REMOVED*** Core Metrics
...
***REMOVED******REMOVED******REMOVED*** Action Categories
...
***REMOVED******REMOVED******REMOVED*** Anti-Pattern Detection
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Session Audit
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Trend Analysis
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Real-Time Delegation Check
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Pre-Delegation Check (Proactive Mode)
...
```
***REMOVED******REMOVED*** Pre-Delegation Check
...
***REMOVED******REMOVED******REMOVED*** Session Audit Report

```markdown
***REMOVED*** Delegation Audit: Session [DATE]
...
***REMOVED******REMOVED*** Actions Breakdown
...
***REMOVED******REMOVED*** Anti-Pattern Alerts

***REMOVED******REMOVED******REMOVED*** Hierarchy Bypass (1 instance)
...
***REMOVED******REMOVED*** Session Context
...
***REMOVED******REMOVED*** Comparison to Average
...
***REMOVED******REMOVED******REMOVED*** Report to User (via ORCHESTRATOR)
...
***REMOVED******REMOVED******REMOVED*** Do Not Escalate
...
***REMOVED******REMOVED******REMOVED*** Audit Quality
...
***REMOVED******REMOVED******REMOVED*** System Improvement
...
***REMOVED******REMOVED*** Session Actions
