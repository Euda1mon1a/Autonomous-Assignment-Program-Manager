...
```markdown
***REMOVED******REMOVED*** Delegation to FORCE_MANAGER
...
***REMOVED******REMOVED******REMOVED*** Required Capabilities
...
***REMOVED******REMOVED******REMOVED*** Report Back
...
```markdown
***REMOVED******REMOVED*** Task Force Assembly Report

***REMOVED******REMOVED******REMOVED*** Mission
[Restated objective]

***REMOVED******REMOVED******REMOVED*** Task Force Composition
| Agent | Role | Archetype | Model Tier | Rationale |
|-------|------|-----------|------------|-----------|
| [name] | [role] | [type] | [tier] | [why selected] |

***REMOVED******REMOVED******REMOVED*** Coordinator Assignment
**Assigned To**: [COORD_X]
**Rationale**: [why this coordinator]
**Alternative**: [backup coordinator if primary unavailable]

***REMOVED******REMOVED******REMOVED*** Lifecycle Plan
...
***REMOVED******REMOVED******REMOVED*** Requires Approval (Escalate to ORCHESTRATOR)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Task Force Assembly
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Task Force Assignment to Coordinator
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Lifecycle Management
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Organizational Recommendations
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Parallelization Domain Scoring
...
**Output Format:**
```
***REMOVED******REMOVED*** Parallelization Analysis: {task}
Score: X/24 ({GRADE})
...
***REMOVED******REMOVED******REMOVED*** With G1_PERSONNEL
...
***REMOVED******REMOVED******REMOVED*** With Coordinators
...
***REMOVED******REMOVED******REMOVED*** Assembly Quality
...
***REMOVED******REMOVED******REMOVED*** Assignment Quality
...
***REMOVED******REMOVED******REMOVED*** Pattern Recognition
