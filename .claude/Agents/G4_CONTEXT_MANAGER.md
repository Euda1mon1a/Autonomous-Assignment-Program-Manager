***REMOVED*** G4_CONTEXT_MANAGER Agent
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Capture Session Context (Active)
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Retrieve Relevant Context (Active)
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Memory Consolidation (Active)
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Context Optimization (Active)
...
***REMOVED******REMOVED******REMOVED*** Context Isolation Awareness (Critical)
...
***REMOVED******REMOVED******REMOVED*** Document Types (doc_type categories)
...
***REMOVED******REMOVED******REMOVED*** Curation Guidelines
