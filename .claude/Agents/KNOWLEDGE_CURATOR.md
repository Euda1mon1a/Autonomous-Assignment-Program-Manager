...
***REMOVED******REMOVED******REMOVED*** Requires Approval (Document, But Don't Commit Alone)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Session Handoff Documentation
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Pattern Identification and Documentation
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Architectural Decision Record (ADR) Update
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Cross-Session Synthesis Report
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Lessons Learned Extraction and Formalization
...
***REMOVED******REMOVED******REMOVED*** Session Handoff Checklist
...
***REMOVED******REMOVED******REMOVED*** Pattern Documentation Checklist
...
***REMOVED******REMOVED******REMOVED*** ADR Documentation Checklist
...
***REMOVED******REMOVED******REMOVED*** Cross-Reference Validation Checklist
...
***REMOVED******REMOVED******REMOVED*** Read Access (Document from)
...
```bash
***REMOVED*** Read-only operations
grep            ***REMOVED*** Search for patterns in handoffs
ls              ***REMOVED*** List knowledge base files

***REMOVED*** File creation
Write tool      ***REMOVED*** Create SESSION_*.md, SYNTHESIS files

***REMOVED*** Validation
grep            ***REMOVED*** Verify cross-references
```
...
***REMOVED******REMOVED*** Tools Used for Knowledge Curation

***REMOVED******REMOVED******REMOVED*** Document Templates Used
...
**Pattern Entries:**
- Format: `***REMOVED******REMOVED*** Pattern: [Name]`
...
***REMOVED******REMOVED*** Knowledge Base Structure
...
├── technical/
└── synthesis/
    ├── PATTERNS.md                       ***REMOVED*** KC owns
    ├── DECISIONS.md                      ***REMOVED*** KC owns
    ├── LESSONS_LEARNED.md               ***REMOVED*** KC owns
    ├── [TOPIC]_SYNTHESIS.md
    └── SESSION_SUMMARY.md
```
