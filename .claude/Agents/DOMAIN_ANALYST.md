...
***REMOVED******REMOVED*** Available Coordinators
...
```markdown
***REMOVED******REMOVED*** Domain Analysis: [Task Name]
...
***REMOVED******REMOVED******REMOVED*** Parallelization Score: X/10
**Rationale:** [Why this score]

***REMOVED******REMOVED******REMOVED*** Serialization Points
