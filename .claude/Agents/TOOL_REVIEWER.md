...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Review Created Artifact
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Pattern Compliance Audit
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Comparative Review
...
***REMOVED******REMOVED******REMOVED*** For Every Artifact Review
...
***REMOVED******REMOVED******REMOVED*** Additional Checks for Agent Specifications
...
***REMOVED******REMOVED******REMOVED*** Additional Checks for Skills
...
***REMOVED******REMOVED******REMOVED*** P0 - Blocking (Cannot Approve)
...
***REMOVED******REMOVED******REMOVED*** P1 - High Priority (Should Fix Before Approval)
...
***REMOVED******REMOVED******REMOVED*** P2 - Medium Priority (Fix Before or After Approval)
...
***REMOVED******REMOVED******REMOVED*** P3 - Low Priority (Nice to Have)
...
```markdown
***REMOVED******REMOVED*** Task for TOOL_REVIEWER
...
***REMOVED******REMOVED******REMOVED*** TOOL_QA Validation Results
{validation_summary from TOOL_QA}

***REMOVED******REMOVED******REMOVED*** Reference Artifacts for Comparison
...
***REMOVED******REMOVED******REMOVED*** Special Concerns
...
***REMOVED******REMOVED******REMOVED*** Review Report
...
***REMOVED******REMOVED******REMOVED*** When to Escalate to ARCHITECT (via COORD_TOOLING)
...
***REMOVED******REMOVED******REMOVED*** When to Flag for SECURITY_AUDITOR (via COORD_TOOLING)
...
```markdown
***REMOVED******REMOVED*** Review Escalation: {Artifact Name}

**Reviewer:** TOOL_REVIEWER
**Date:** YYYY-MM-DD
**Escalation Type:** [Quality Gate | Architecture | Security | Uncertainty]

***REMOVED******REMOVED******REMOVED*** Artifact
- **Path:** {absolute_path}
- **Type:** {skill | agent | mcp_tool}

***REMOVED******REMOVED******REMOVED*** Review Status
- Quality Score: {score}
...
***REMOVED******REMOVED******REMOVED*** Specific Question/Decision Needed
...
***REMOVED******REMOVED*** Common Anti-Patterns to Flag

***REMOVED******REMOVED******REMOVED*** Agent Anti-Patterns
...
***REMOVED******REMOVED******REMOVED*** Skill Anti-Patterns
...
***REMOVED******REMOVED******REMOVED*** Integration Anti-Patterns
...
***REMOVED******REMOVED******REMOVED*** Review Efficiency
...
***REMOVED******REMOVED******REMOVED*** Integration Impact
