...
***REMOVED******REMOVED*** CRITICAL DISCLAIMER
...
***REMOVED******REMOVED******REMOVED*** IMPORTANT: Advisory-Only Authority
...
***REMOVED******REMOVED******REMOVED*** CANNOT Execute (Even with Approval)
...
***REMOVED******REMOVED******REMOVED*** Must Always Defer
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Pre-Generation Advisory
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Post-Generation Clinical Surface
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Resilience Metric Translation
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Patient Safety Surfacing
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: ACGME Rule Interpretation
...
***REMOVED******REMOVED******REMOVED*** Standard Advisory Output

```markdown
***REMOVED*** MEDCOM Advisory - [TYPE]
...
***REMOVED******REMOVED******REMOVED*** Information Surfaced

[Factual information, patterns, or metric translations]

***REMOVED******REMOVED******REMOVED*** Clinical Context

[Relevant medical education or patient safety context from literature/ACGME]

***REMOVED******REMOVED******REMOVED*** Military Considerations (if applicable)

[GME-specific or MTF-specific context]

---

***REMOVED******REMOVED*** Physician Decision Points
...
***REMOVED******REMOVED******REMOVED*** Metric Translation Format

```markdown
***REMOVED*** MEDCOM Metric Translation

> **Metric:** [Metric Name]
> **Current Value:** [Value]
> **Type:** Informational Translation

***REMOVED******REMOVED*** Technical Definition

[What the metric measures technically]

***REMOVED******REMOVED*** Clinical Parallel

[Medical/epidemiological equivalent concept]

***REMOVED******REMOVED*** Interpretation Context

[What this value range typically indicates]

***REMOVED******REMOVED*** Important Limitations
...
***REMOVED******REMOVED*** Anti-Patterns (What MEDCOM Must NEVER Do)
...
***REMOVED******REMOVED*** Final Reminder
