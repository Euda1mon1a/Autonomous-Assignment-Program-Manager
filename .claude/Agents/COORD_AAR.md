***REMOVED*** COORD_AAR - After Action Review Coordinator
...
***REMOVED******REMOVED*** Auto-Trigger Behavior

**CRITICAL:** This agent is designed to auto-trigger at session end.

***REMOVED******REMOVED******REMOVED*** Invocation Triggers
...
***REMOVED******REMOVED******REMOVED*** Typical Invocation Points
...
***REMOVED******REMOVED******REMOVED*** Auto-Trigger Pattern

When ORCHESTRATOR detects session close indicators:

```python
***REMOVED*** Session close indicators
...
***REMOVED*** Or when context is near limit
if context_usage > 0.80:
    spawn_coord_aar(reason="Context limit approaching")
```

***REMOVED******REMOVED******REMOVED*** Integration with /startupO
...
```markdown
***REMOVED******REMOVED*** Task for COORD_AAR
...
***REMOVED******REMOVED******REMOVED*** Session Details
- **Session ID:** {session_id}
- **Outcome:** {outcome}
- **Summary:** {session_summary}

***REMOVED******REMOVED******REMOVED*** Active Coordinators This Session
{list of active COORD_* agents}

***REMOVED******REMOVED******REMOVED*** Artifacts Created
{PRs, commits, files - if provided}

***REMOVED******REMOVED******REMOVED*** Issues Encountered
{problems, blockers - if provided}

***REMOVED******REMOVED******REMOVED*** User Feedback
{any explicit feedback - if provided}

***REMOVED******REMOVED******REMOVED*** Session Significance
...
```markdown
***REMOVED*** After Action Review: Session {session_id}
...
***REMOVED******REMOVED*** Coordinator Activity
...
***REMOVED******REMOVED*** Delegation Metrics
- **Delegation Ratio:** {X%}
- **Parallel Factor:** {X}
...
***REMOVED******REMOVED*** Handoff Notes for Next Session

***REMOVED******REMOVED******REMOVED*** Priority Items
1. {item 1}
2. {item 2}

***REMOVED******REMOVED******REMOVED*** Pending Decisions
- {decision needing resolution}

***REMOVED******REMOVED******REMOVED*** Watch Items
- {things to monitor}

***REMOVED******REMOVED******REMOVED*** Open PRs
- PR ***REMOVED***{N}: {title} - {status}

***REMOVED******REMOVED*** Scratchpad Updates Applied
...
***REMOVED******REMOVED******REMOVED*** Artifacts Created
- PR ***REMOVED***534: feat: context-aware-delegation skill
...
***REMOVED******REMOVED******REMOVED*** A. DELEGATION_AUDITOR
...
***REMOVED******REMOVED******REMOVED*** C. G1_PERSONNEL (Future Integration)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Session Close (Primary)
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: XO Collection
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Metrics Aggregation
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Significance Assessment
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Handoff Generation
...
***REMOVED******REMOVED******REMOVED*** Receiving Session Close Signal
...
***REMOVED******REMOVED******REMOVED*** Emitting Cascade Signals
...
***REMOVED******REMOVED******REMOVED*** Reporting to ORCHESTRATOR
...
***REMOVED******REMOVED******REMOVED*** When to Escalate to User
...
```markdown
***REMOVED******REMOVED*** AAR Escalation: [Title]
...
***REMOVED******REMOVED******REMOVED*** AAR Quality
...
***REMOVED******REMOVED******REMOVED*** Session Continuity
...
***REMOVED******REMOVED******REMOVED*** HISTORIAN Accuracy
