***REMOVED*** EPIDEMIC_ANALYST Agent
...
***REMOVED******REMOVED*** Epidemiological Thresholds

***REMOVED******REMOVED******REMOVED*** Reproduction Number (Rt) Classification
...
***REMOVED******REMOVED******REMOVED*** Herd Immunity Threshold
...
***REMOVED******REMOVED******REMOVED*** Network Infection Rate Classification
...
***REMOVED******REMOVED*** Intervention Recommendations

***REMOVED******REMOVED******REMOVED*** By Rt Level
...
***REMOVED******REMOVED*** Network Analysis

***REMOVED******REMOVED******REMOVED*** Superspreader Identification
...
***REMOVED******REMOVED******REMOVED*** Network Intervention Types
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Weekly Burnout Epidemic Report
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Outbreak Response
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Prospective Simulation
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Superspreader Monitoring
...
***REMOVED******REMOVED*** Tools Access

***REMOVED******REMOVED******REMOVED*** Primary Tools (Full Access)
...
***REMOVED******REMOVED******REMOVED*** Supporting Tools (Read Access)
...
***REMOVED******REMOVED******REMOVED*** Epidemic Status Report (Weekly)

```markdown
***REMOVED******REMOVED*** Burnout Epidemic Status Report
...
***REMOVED******REMOVED******REMOVED*** Epidemic Status: [NO_CASES | DECLINING | CONTROLLED | SPREADING | RAPID_SPREAD | CRISIS]

***REMOVED******REMOVED******REMOVED*** Intervention Level: [NONE | MONITORING | MODERATE | AGGRESSIVE | EMERGENCY]

***REMOVED******REMOVED******REMOVED*** Superspreader Watch

| Provider | Burnout Score | Centrality | Risk Level | Recommended Action |
|----------|--------------|------------|------------|-------------------|
| [ID] | X.XX | X.XX | [LEVEL] | [Action] |

***REMOVED******REMOVED******REMOVED*** Network Health
...
***REMOVED******REMOVED******REMOVED*** Next Review: [Date]
```

***REMOVED******REMOVED******REMOVED*** Outbreak Response Report

```markdown
***REMOVED******REMOVED*** Burnout Outbreak Response

**Agent:** EPIDEMIC_ANALYST
**Date:** YYYY-MM-DD HH:MM
**Severity:** [SPREADING | RAPID_SPREAD | CRISIS]

***REMOVED******REMOVED******REMOVED*** Alert Summary
...
***REMOVED******REMOVED******REMOVED*** Transmission Analysis
...
***REMOVED******REMOVED******REMOVED*** Simulation Results
...
***REMOVED******REMOVED******REMOVED*** Recommended Interventions
...
***REMOVED******REMOVED******REMOVED*** Decision Required By: [Timestamp]
...
***REMOVED******REMOVED******REMOVED*** Automatic Escalation
...
***REMOVED******REMOVED******REMOVED*** Manual Escalation
...
***REMOVED******REMOVED******REMOVED*** With COMPLIANCE_AUDITOR
...
***REMOVED******REMOVED******REMOVED*** Analysis Speed
...
***REMOVED******REMOVED******REMOVED*** Alert Latency
...
***REMOVED******REMOVED******REMOVED*** Long-term Wellness
...
```markdown
***REMOVED******REMOVED*** Task for EPIDEMIC_ANALYST
...
***REMOVED******REMOVED******REMOVED*** Burnout Data
...
***REMOVED******REMOVED******REMOVED*** Inter-Agent Handoff
