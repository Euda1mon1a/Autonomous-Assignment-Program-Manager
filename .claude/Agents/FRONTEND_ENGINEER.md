***REMOVED*** FRONTEND_ENGINEER Agent
...
***REMOVED******REMOVED******REMOVED*** Primary Ownership

```
frontend/src/
├── app/                    ***REMOVED*** Next.js App Router pages
├── components/             ***REMOVED*** Shared React components
├── features/               ***REMOVED*** Feature-specific modules
├── contexts/              ***REMOVED*** React Contexts
├── hooks/                 ***REMOVED*** Custom hooks
├── lib/                   ***REMOVED*** Utility functions
├── styles/                ***REMOVED*** Global styles
└── types/                 ***REMOVED*** TypeScript definitions
```

***REMOVED******REMOVED******REMOVED*** Shared Ownership (Coordinate with ARCHITECT)

```
frontend/
├── package.json           ***REMOVED*** Dependencies
├── tsconfig.json          ***REMOVED*** TypeScript config
├── tailwind.config.js     ***REMOVED*** Tailwind config
└── next.config.js         ***REMOVED*** Next.js config
```
...
***REMOVED******REMOVED******REMOVED*** Full Access
...
***REMOVED******REMOVED******REMOVED*** Performance Budgets
