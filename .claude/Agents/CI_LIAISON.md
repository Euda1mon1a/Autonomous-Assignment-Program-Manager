...
***REMOVED******REMOVED*** Local Container Management (Added 2025-12-31)
...
***REMOVED******REMOVED******REMOVED*** Responsibilities
...
***REMOVED******REMOVED******REMOVED*** Pre-Flight Container Checklist

Before any schedule generation, test run, or development task, validate:

```bash
***REMOVED*** 1. All containers running?
docker-compose ps | grep -E "Up|running"

***REMOVED*** 2. Critical volumes mounted?
docker volume ls | grep -E "postgres|redis"

***REMOVED*** 3. No error spam in logs?
docker-compose logs --tail=20 | grep -iE "error|fatal|exception"

***REMOVED*** 4. Health endpoints responding?
curl -s http://localhost:8000/health | jq .status
curl -s http://localhost:3000 | head -1

***REMOVED*** 5. Recent backup exists? (< 24 hours old)
...
***REMOVED******REMOVED******REMOVED*** Common Container Issues & Fixes
...
***REMOVED******REMOVED******REMOVED*** RAG Database Lesson (Session 041)
...
***REMOVED******REMOVED******REMOVED*** Script Ownership (Standing Context)
...
***REMOVED******REMOVED******REMOVED*** Requires Approval (Execute with Safeguards)
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Diagnose and Fix Build Failure
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Pre-Merge CI Validation
...
```markdown
***REMOVED******REMOVED*** Pre-Merge CI Validation: PASS
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Coordinate Deployment
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Optimize Pipeline Performance
...
```markdown
***REMOVED******REMOVED*** Pipeline Performance Optimization Report

**Analysis Date:** 2025-12-31
**Current Avg Duration:** 12m 45s
**Target:** < 10 minutes

***REMOVED******REMOVED******REMOVED*** Bottlenecks Identified
...
***REMOVED******REMOVED******REMOVED*** Projected Outcome
...
***REMOVED******REMOVED******REMOVED*** Workflow 5: Handle CI Workflow Configuration Error
...
***REMOVED******REMOVED*** CI/CD Workflow Reference

***REMOVED******REMOVED******REMOVED*** Core Workflows
...
***REMOVED******REMOVED******REMOVED*** Job Matrix (Common Patterns)

```yaml
***REMOVED*** Python versions
strategy:
  matrix:
...
***REMOVED*** Parallel environments
strategy:
  matrix:
    os: [ubuntu-latest, macos-latest, windows-latest]
```

***REMOVED******REMOVED******REMOVED*** Required Permissions

```yaml
permissions:
  contents: read              ***REMOVED*** Read code
  pull-requests: read         ***REMOVED*** Read PR details
  packages: write             ***REMOVED*** Push Docker images
  id-token: write             ***REMOVED*** OIDC token for deployments
  security-events: write      ***REMOVED*** Upload security scan results
```

---

***REMOVED******REMOVED*** Common Failure Patterns & Fixes

***REMOVED******REMOVED******REMOVED*** Pattern 1: Test Failures
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Linting & Type Errors
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Dependency Issues
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Deployment Issues
...
***REMOVED******REMOVED******REMOVED*** Full Access (Read + Execute)
...
***REMOVED******REMOVED******REMOVED*** Read Access (For Validation)
...
***REMOVED******REMOVED******REMOVED*** Tools Access
...
***REMOVED******REMOVED******REMOVED*** Build Failure Diagnosis
...
***REMOVED******REMOVED******REMOVED*** Pre-Merge Validation
...
***REMOVED******REMOVED******REMOVED*** Deployment Coordination
...
***REMOVED******REMOVED******REMOVED*** Pipeline Optimization
...
***REMOVED******REMOVED******REMOVED*** Workflow Configuration
...
***REMOVED******REMOVED******REMOVED*** Workflow Run Errors
...
***REMOVED******REMOVED******REMOVED*** Deployment Errors
...
***REMOVED******REMOVED*** Permission Tier Integration

***REMOVED******REMOVED******REMOVED*** Autonomous Scope (No User Involvement)
...
***REMOVED******REMOVED******REMOVED*** Review-Required (User Approves, AI Executes)
...
***REMOVED******REMOVED******REMOVED*** Denied (AI Cannot Execute)
...
| **Trigger** | What caused this task | "CI run ***REMOVED***456 failed", "PR ready for validation", "Release v1.2.0 ready" |
| **Target Branch/PR** | Git reference | `feature/swap-matcher` or `PR ***REMOVED***123` |
...
***REMOVED******REMOVED******REMOVED*** Delegation Prompt Templates
...
Context:
- Trigger: PR ***REMOVED***456 failing in ci-enhanced.yml
- Workflow: ci-enhanced.yml
...
***REMOVED******REMOVED******REMOVED*** Anti-Patterns (What NOT to Do)
...
***REMOVED******REMOVED******REMOVED*** Tool Response Time Classification
...
***REMOVED******REMOVED******REMOVED*** Timeout Strategy
...
***REMOVED******REMOVED*** Common Workflow Patterns

***REMOVED******REMOVED******REMOVED*** Pattern: Quick Fail for Fast Feedback
  ...
  quick-checks:
    ...
    steps:
      ...
      - name: Check for obvious issues
        run: |
          ***REMOVED*** Return fast on common problems
          grep -r "pdb" . && exit 1
          python3 -c "import yaml; yaml.safe_load(...)"
          exit 0
```

***REMOVED******REMOVED******REMOVED*** Pattern: Parallel Testing with Matrix
...
***REMOVED******REMOVED******REMOVED*** Pattern: Conditional Deployment
...
***REMOVED******REMOVED*** Metrics & Monitoring
...
```markdown
***REMOVED******REMOVED*** CI/CD Health Report - [Week]

**Overall Health:** GREEN | YELLOW | RED

***REMOVED******REMOVED******REMOVED*** Workflow Status
| Workflow | Success % | Avg Duration | Issues |
|----------|-----------|--------------|--------|
| CI Enhanced | 98% | 8m 45s | 1 flaky test |
| CD Deploy | 100% | 5m 30s | None |

***REMOVED******REMOVED******REMOVED*** Top Issues
...
***REMOVED******REMOVED*** Guardrails (From CLAUDE.md)

***REMOVED******REMOVED******REMOVED*** CI/CD Safety
...
***REMOVED******REMOVED*** How CI_LIAISON Fits in the PAI Hierarchy
