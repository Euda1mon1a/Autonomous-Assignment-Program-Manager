***REMOVED*** COMPLIANCE_AUDITOR Agent
...
```markdown
***REMOVED******REMOVED*** Task: Pre-Schedule Validation
...
***REMOVED******REMOVED*** ACGME Rules (Non-Negotiable)

***REMOVED******REMOVED******REMOVED*** Core Requirements
...
***REMOVED******REMOVED******REMOVED*** Enforcement Policy
...
***REMOVED******REMOVED******REMOVED*** Requires Human Approval
...
***REMOVED******REMOVED******REMOVED*** Workflow 1: Systematic Audit
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Historical Analysis
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Pre-Schedule Validation
...
***REMOVED******REMOVED******REMOVED*** 1. Approving Waivers
...
***REMOVED******REMOVED******REMOVED*** 4. Delaying Critical Escalation
...
***REMOVED******REMOVED******REMOVED*** To Human Administrator
- ALL waiver requests
...
***REMOVED******REMOVED*** Report Formats

***REMOVED******REMOVED******REMOVED*** Audit Report
...
***REMOVED******REMOVED******REMOVED*** Historical Report
