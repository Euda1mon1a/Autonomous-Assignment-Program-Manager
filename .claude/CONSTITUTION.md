***REMOVED*** CONSTITUTION - Residency Scheduler AI System
...
***REMOVED******REMOVED*** II. FIRST PRINCIPLES

***REMOVED******REMOVED******REMOVED*** A. CLI-First, Deterministic Code
...
**Violations:**
```python
***REMOVED*** FORBIDDEN - Interactive prompt
name = input("Enter resident name: ")

***REMOVED*** REQUIRED - Environment or config
...
***REMOVED******REMOVED******REMOVED*** B. Logging & Auditability
...
***REMOVED******REMOVED*** III. SAFETY-CRITICAL RULES

***REMOVED******REMOVED******REMOVED*** A. ACGME Compliance (Tier 0 - Absolute)
...
***REMOVED******REMOVED******REMOVED*** B. Swap Validation
...
***REMOVED******REMOVED******REMOVED*** C. Resilience Framework Adherence
...
***REMOVED******REMOVED*** IV. CONSTRAINT HIERARCHY
...
***REMOVED******REMOVED*** V. SECURITY DEFENSE-IN-DEPTH

**Rule:** Security is implemented in four independent layers.

***REMOVED******REMOVED******REMOVED*** Layer 1: Authentication & Authorization
...
***REMOVED******REMOVED******REMOVED*** Layer 2: Input Validation
...
class AssignmentCreate(BaseModel):
    person_id: UUID4
    block_id: int = Field(gt=0, le=730)  ***REMOVED*** Valid block range
    rotation_id: UUID4

    @validator('person_id')
    def person_must_exist(cls, v, values):
        ***REMOVED*** Validate person exists in DB
        if not person_exists(v):
            raise ValueError("Person not found")
        return v
```

***REMOVED******REMOVED******REMOVED*** Layer 3: Data Protection
...
***REMOVED******REMOVED******REMOVED*** Layer 4: Monitoring & Incident Response
...
***REMOVED******REMOVED*** VI. AGENT AUTONOMY & ESCALATION

**Rule:** Agents have bounded autonomy with clear escalation protocols.

***REMOVED******REMOVED******REMOVED*** A. Autonomous Actions (No Approval Required)
...
***REMOVED******REMOVED******REMOVED*** B. Approval-Required Actions
...
***REMOVED******REMOVED******REMOVED*** C. Forbidden Actions (Always Refuse)
...
***REMOVED******REMOVED*** VII. SOLVE ONCE, REUSE FOREVER

**Rule:** Solutions to common problems must be captured as reusable patterns.

***REMOVED******REMOVED******REMOVED*** A. Pattern Capture Requirements
...
***REMOVED******REMOVED******REMOVED*** B. Skill Creation Trigger
...
***REMOVED******REMOVED*** VIII. META-IMPROVEMENT

**Rule:** The Constitution and PAI system must evolve based on operational experience.

***REMOVED******REMOVED******REMOVED*** A. Improvement Triggers
...
***REMOVED******REMOVED******REMOVED*** B. Amendment Process
...
***REMOVED******REMOVED******REMOVED*** C. Pattern Deprecation
...
***REMOVED******REMOVED*** IX. ERROR HANDLING & ROLLBACK

**Rule:** All operations must be reversible and errors must be handled gracefully.

***REMOVED******REMOVED******REMOVED*** A. Error Classification
...
***REMOVED******REMOVED******REMOVED*** B. Rollback Requirements
...
alembic current  ***REMOVED*** Record current version
...
***REMOVED*** If failure
alembic downgrade -1
***REMOVED*** Or full restore
pg_restore -d residency_scheduler backup_pre_migration.dump
```

***REMOVED******REMOVED******REMOVED*** C. Graceful Degradation
...
***REMOVED******REMOVED*** X. OPERATING PRINCIPLES FOR ALL AGENTS

***REMOVED******REMOVED******REMOVED*** A. Communication Standards
...
***REMOVED******REMOVED******REMOVED*** B. Code Quality Standards
...
***REMOVED******REMOVED******REMOVED*** C. Testing Requirements
...
***REMOVED******REMOVED*** XI. COMPLIANCE MONITORING

**Rule:** Continuous monitoring ensures Constitution adherence.

***REMOVED******REMOVED******REMOVED*** A. Automated Checks
...
***REMOVED******REMOVED******REMOVED*** B. Violation Reporting
...
```markdown
***REMOVED******REMOVED*** Constitution Violation Report
...
***REMOVED******REMOVED*** XII. DEFINITIONS
...
***REMOVED******REMOVED*** XIII. AMENDMENT HISTORY
...
***REMOVED******REMOVED*** XIV. ENFORCEMENT
