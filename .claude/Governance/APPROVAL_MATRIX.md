***REMOVED*** Approval Authority Matrix

***REMOVED******REMOVED*** Toggle
Controlled by `config.json`.

***REMOVED******REMOVED*** Authority Levels
...
***REMOVED******REMOVED*** Override Protocol

Any rule can be overridden with explicit human approval documented in conversation.

***REMOVED******REMOVED*** Action Categories

***REMOVED******REMOVED******REMOVED*** Autonomous Actions (No Approval Needed)
...
***REMOVED******REMOVED******REMOVED*** Coordinator-Approved Actions
- Editing production code files
- Creating new source files
- Modifying configuration files
- Architectural changes within domain

***REMOVED******REMOVED******REMOVED*** ORCHESTRATOR-Approved Actions
- Cross-coordinator changes
- Multi-domain refactoring
- Emergency bypasses
- Governance exceptions

***REMOVED******REMOVED******REMOVED*** Human-Only Actions
...
***REMOVED******REMOVED******REMOVED*** For Bypasses
...
***REMOVED******REMOVED******REMOVED*** For Escalations
