***REMOVED*** Script Ownership Matrix
...
***REMOVED******REMOVED*** Script Ownership Matrix

***REMOVED******REMOVED******REMOVED*** Infrastructure Scripts (ARCHITECT Domain)
...
***REMOVED******REMOVED******REMOVED*** Container & CI/CD Scripts (CI_LIAISON Domain per ADR-011)
...
***REMOVED******REMOVED******REMOVED*** Database Scripts (DBA Domain)
...
***REMOVED******REMOVED******REMOVED*** Security Scripts (SECURITY_AUDITOR Domain)
...
***REMOVED******REMOVED******REMOVED*** AI/Agent Scripts (COORD_OPS Domain)
...
***REMOVED******REMOVED*** Detailed Script Documentation

***REMOVED******REMOVED******REMOVED*** `scripts/backup-db.sh`
...
**CLI Options:**
```bash
--docker         ***REMOVED*** Use Docker container for backup
--retention N    ***REMOVED*** Keep last N days of backups (default: 30)
--s3             ***REMOVED*** Upload to S3 (requires AWS_* env vars)
--email EMAIL    ***REMOVED*** Send notification email on completion
```
...
***REMOVED******REMOVED******REMOVED*** `scripts/health-check.sh`
...
**CLI Options:**
```bash
--verbose, -v    ***REMOVED*** Show detailed output
--docker, -d     ***REMOVED*** Check Docker containers instead of local services
```
...
***REMOVED******REMOVED******REMOVED*** `scripts/start-celery.sh`
...
**CLI Options:**
```bash
worker    ***REMOVED*** Start worker only
beat      ***REMOVED*** Start beat scheduler only
both      ***REMOVED*** Start both (default)
```
...
***REMOVED******REMOVED******REMOVED*** `scripts/pre-deploy-validate.sh`
...
***REMOVED******REMOVED******REMOVED*** `scripts/audit-fix.sh`
...
***REMOVED******REMOVED******REMOVED*** `scripts/pii-scan.sh`
...
- SSN patterns (***REMOVED******REMOVED******REMOVED***-***REMOVED******REMOVED***-***REMOVED******REMOVED******REMOVED******REMOVED***)
...
***REMOVED******REMOVED******REMOVED*** `.claude/scripts/ccw-validation-gate.sh`
...
***REMOVED******REMOVED******REMOVED*** `scripts/build-wheelhouse.sh`
...
***REMOVED******REMOVED*** Python Scripts (Additional Reference)

***REMOVED******REMOVED******REMOVED*** Seeding & Data Scripts
...
***REMOVED******REMOVED******REMOVED*** Scheduling & Validation Scripts
...
***REMOVED******REMOVED******REMOVED*** Monitoring Scripts
...
***REMOVED******REMOVED******REMOVED*** Operations Scripts
...
***REMOVED******REMOVED******REMOVED*** RAG Scripts
...
***REMOVED******REMOVED*** Escalation Matrix
...
***REMOVED******REMOVED*** Pre-requisites Summary

***REMOVED******REMOVED******REMOVED*** Before Container Operations (CI_LIAISON Scripts)
...
***REMOVED******REMOVED******REMOVED*** Before Database Operations (DBA Scripts)

1. Backup exists and is < 24 hours old
2. Database is accessible
3. Alembic version is known

***REMOVED******REMOVED******REMOVED*** Before Deployment Operations
...
***REMOVED******REMOVED*** Domain Summary for ARCHITECT

***REMOVED******REMOVED******REMOVED*** Infrastructure Domain (ARCHITECT Ownership)
...
***REMOVED******REMOVED******REMOVED*** Operations Domain (COORD_OPS Ownership)
...
***REMOVED******REMOVED******REMOVED*** Database Domain (DBA Ownership via COORD_PLATFORM)
...
***REMOVED******REMOVED******REMOVED*** Security Domain (SECURITY_AUDITOR Ownership via COORD_RESILIENCE)
