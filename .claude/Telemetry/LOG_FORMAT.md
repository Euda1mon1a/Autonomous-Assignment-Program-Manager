***REMOVED*** Telemetry Log Format Specification
...
1. [Format Overview](***REMOVED***format-overview)
2. [Base Event Schema](***REMOVED***base-event-schema)
3. [Event Type Schemas](***REMOVED***event-type-schemas)
4. [Validation Rules](***REMOVED***validation-rules)
5. [Examples](***REMOVED***examples)

---

***REMOVED******REMOVED*** Format Overview

***REMOVED******REMOVED******REMOVED*** File Format
...
***REMOVED******REMOVED*** Base Event Schema
...
***REMOVED******REMOVED******REMOVED*** Timestamp Format
...
***REMOVED******REMOVED*** Event Type Schemas

***REMOVED******REMOVED******REMOVED*** 1. Skill Execution
...
***REMOVED******REMOVED******REMOVED*** 3. Schedule Generation
...
***REMOVED******REMOVED******REMOVED*** 4. Swap Processing
...
***REMOVED******REMOVED******REMOVED*** 5. MCP Tool Call
...
***REMOVED******REMOVED******REMOVED*** 6. Compliance Warning
...
***REMOVED******REMOVED******REMOVED*** 7. Agent Task
...
***REMOVED******REMOVED******REMOVED*** 8. Rollback
...
***REMOVED******REMOVED******REMOVED*** 9. Commit
...
***REMOVED******REMOVED******REMOVED*** 10. Learning Entry
...
***REMOVED******REMOVED******REMOVED*** Required Field Rules
...
***REMOVED******REMOVED******REMOVED*** Data Type Rules
...
***REMOVED******REMOVED******REMOVED*** Privacy Rules
...
***REMOVED******REMOVED******REMOVED*** Complete Event Log Session
...
***REMOVED******REMOVED*** Parsing & Querying

***REMOVED******REMOVED******REMOVED*** Reading JSONL Files
...
***REMOVED*** Get all violations prevented
