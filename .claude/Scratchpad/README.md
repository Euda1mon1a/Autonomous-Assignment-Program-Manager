***REMOVED*** Scratchpad - Temporary Working Files
...
***REMOVED******REMOVED*** When to Use Scratchpad

**Use Scratchpad for:**

***REMOVED******REMOVED******REMOVED*** 1. Debugging & Investigation
```markdown
...
***REMOVED******REMOVED******REMOVED*** 2. Experiment Design
```markdown
***REMOVED*** Scratchpad/2025-08-10_09-15_experiment_pareto_optimization.md

***REMOVED******REMOVED*** Experiment: Multi-Objective Pareto Optimization
...
***REMOVED******REMOVED******REMOVED*** 3. Brainstorming & Design
```markdown
***REMOVED*** Scratchpad/2025-07-20_11-00_design_credential_dashboard.md

***REMOVED******REMOVED*** Idea: Credential Expiration Dashboard
...
***REMOVED******REMOVED******REMOVED*** 4. Meeting Notes & Discussions
```markdown
***REMOVED*** Scratchpad/2025-08-03_13-30_meeting_faculty_feedback.md

***REMOVED******REMOVED*** Faculty Meeting: Block 10 Schedule Review
...
***REMOVED******REMOVED******REMOVED*** 5. Draft Documentation
```markdown
***REMOVED*** Scratchpad/2025-07-25_10-00_draft_constraint_audit_guide.md

***REMOVED******REMOVED*** DRAFT: Quarterly Constraint Audit Guide
...
***REMOVED******REMOVED******REMOVED*** 6. Quick Calculations & Scratch Work
```markdown
***REMOVED*** Scratchpad/2025-08-12_16-45_calc_utilization_threshold.md

***REMOVED******REMOVED*** Calculation: Safe Utilization Threshold
...
Utilization = demand / (capacity × availability)
           = 15 / (12 × 2)  ***REMOVED*** 2 sessions/day
           = 0.625 (62.5%)
...
***REMOVED******REMOVED*** Auto-Cleanup Policy
...
```bash
***REMOVED*** In .claude/settings.json
{
  "scratchpad": {
    "retention_days": 7,
...
```bash
***REMOVED*** 1. Copy content from Scratchpad to History (using template)
cp .claude/History/incidents/TEMPLATE.md \
   .claude/History/incidents/2025-08-15_solver_timeout.md

***REMOVED*** 2. Fill in template with finalized content from Scratchpad
vim .claude/History/incidents/2025-08-15_solver_timeout.md

***REMOVED*** 3. Commit to git
...
***REMOVED*** 4. Delete Scratchpad file (or let auto-cleanup handle it)
...
***REMOVED******REMOVED******REMOVED*** 1. Start with Scratchpad, Finish with History
...
***REMOVED******REMOVED******REMOVED*** 2. Use Descriptive Filenames
...
***REMOVED******REMOVED******REMOVED*** 3. Date Everything
...
***REMOVED******REMOVED******REMOVED*** 4. Link to Related Records
...
- Issue: GitHub issue ***REMOVED***247
```
...
***REMOVED******REMOVED******REMOVED*** 5. Capture Uncertainty
...
***REMOVED******REMOVED*** Integration with Other PAI Components

***REMOVED******REMOVED******REMOVED*** Scratchpad ↔ History
...
***REMOVED******REMOVED******REMOVED*** Scratchpad ↔ MetaUpdater
...
***REMOVED******REMOVED******REMOVED*** Scratchpad ↔ Skills

**Skills can create Scratchpad entries:**

Example: `systematic-debugger` skill
```markdown
***REMOVED*** Scratchpad/2025-08-15_15-00_systematic_debug_swap_error.md

***REMOVED******REMOVED*** Generated by: systematic-debugger skill

***REMOVED******REMOVED******REMOVED*** Phase 1: Exploration
[Agent reads code, examines logs]

***REMOVED******REMOVED******REMOVED*** Phase 2: Hypothesis Generation
[Agent creates 5 hypotheses for root cause]

***REMOVED******REMOVED******REMOVED*** Phase 3: Testing
[Agent tests each hypothesis]

***REMOVED******REMOVED******REMOVED*** Phase 4: Fix
[Agent implements fix]

***REMOVED******REMOVED******REMOVED*** Promotion
...
```bash
***REMOVED*** Secure delete (overwrite before removal)
...
***REMOVED******REMOVED******REMOVED*** "Scratchpad file disappeared!"
...
***REMOVED******REMOVED******REMOVED*** "Scratchpad is getting cluttered"

**Solution:**
```bash
***REMOVED*** Manual cleanup (preview first)
find .claude/Scratchpad/ -name "*.md" -mtime +3

***REMOVED*** Delete files older than 3 days
find .claude/Scratchpad/ -name "*.md" -mtime +3 -delete
```

***REMOVED******REMOVED******REMOVED*** "Want to share Scratchpad file with team"
...
```bash
***REMOVED*** Auto-generate filename with timestamp
...
***REMOVED******REMOVED*** Example Scratchpad Session

**Scenario:** Debugging a swap validation bug

```markdown
***REMOVED*** Scratchpad/2025-08-15_14-30_debug_swap_validation_failure.md

***REMOVED******REMOVED*** Problem
Swap request S12347 rejected with error: "ACGME violation detected"
But manual calculation shows no violation. Investigating.

***REMOVED******REMOVED*** Investigation

***REMOVED******REMOVED******REMOVED*** Step 1: Reproduce
...
***REMOVED******REMOVED******REMOVED*** Step 2: Examine Code
...
***REMOVED*** This includes the CURRENT shift being swapped!
***REMOVED*** Should exclude current shift, only count NEW shift
```

***REMOVED******REMOVED******REMOVED*** Step 3: Hypothesis
...
***REMOVED******REMOVED******REMOVED*** Step 5: Fix
...
def calculate_work_hours(
    ...
    start_date: date,
    end_date: date,
    exclude_blocks: list[int] = None  ***REMOVED*** NEW
) -> float:
    ***REMOVED*** Filter out excluded blocks
    ...
```

***REMOVED******REMOVED*** Outcome
- Bug fixed in PR ***REMOVED***352
- Test added: test_swap_validator_excludes_current_shift()
- Validated with S12347 (now approves correctly)

***REMOVED******REMOVED*** Promote To
