***REMOVED*** SESSION_7_RESILIENCE: Deliverables Index
...
***REMOVED******REMOVED******REMOVED*** PRIMARY: resilience-defense-levels.md (1111 lines)
...
***REMOVED******REMOVED******REMOVED*** SECONDARY: SEARCH_PARTY_FINDINGS.md (260 lines)
...
***REMOVED******REMOVED******REMOVED*** For Operational Use
...
***REMOVED******REMOVED******REMOVED*** For Implementation
...
***REMOVED******REMOVED******REMOVED*** For Leadership Briefing
...
***REMOVED******REMOVED*** Key Facts at a Glance
...
***REMOVED******REMOVED*** Cross-Reference: Where Code Meets Docs
...
***REMOVED******REMOVED******REMOVED*** If You're a Program Director
...
***REMOVED******REMOVED******REMOVED*** If You're a Hospital Administrator
...
***REMOVED******REMOVED******REMOVED*** If You're Training Staff
