***REMOVED*** RESILIENCE DEFENSE LEVELS: Comprehensive Reference
...
1. [Defense Level Definitions](***REMOVED***1-defense-level-definitions)
2. [Level Characteristics Matrix](***REMOVED***2-level-characteristics-matrix)
3. [Transition Rules & Thresholds](***REMOVED***3-transition-rules--thresholds)
4. [Escalation Procedures](***REMOVED***4-escalation-procedures)
5. [De-escalation Procedures](***REMOVED***5-de-escalation-procedures)
6. [Response Playbooks by Level](***REMOVED***6-response-playbooks-by-level)
7. [Hysteresis Logic](***REMOVED***7-hysteresis-logic)
8. [Manual Override Procedures](***REMOVED***8-manual-override-procedures)
9. [Trigger Conditions](***REMOVED***9-trigger-conditions)
10. [Audit & Monitoring](***REMOVED***10-audit--monitoring)

---

***REMOVED******REMOVED*** 1. Defense Level Definitions

***REMOVED******REMOVED******REMOVED*** Level 1: PREVENTION (GREEN)
...
***REMOVED******REMOVED******REMOVED*** Level 2: CONTROL (YELLOW)
...
***REMOVED******REMOVED******REMOVED*** Level 3: SAFETY_SYSTEMS (ORANGE)
...
***REMOVED******REMOVED******REMOVED*** Level 4: CONTAINMENT (RED)
...
***REMOVED******REMOVED******REMOVED*** Level 5: EMERGENCY (BLACK)
...
***REMOVED******REMOVED*** 2. Level Characteristics Matrix
...
***REMOVED******REMOVED*** 3. Transition Rules & Thresholds

***REMOVED******REMOVED******REMOVED*** Escalation Thresholds (GREEN → BLACK)
...
***REMOVED******REMOVED******REMOVED*** De-escalation Thresholds (BLACK → GREEN)
...
***REMOVED******REMOVED*** 4. Escalation Procedures

***REMOVED******REMOVED******REMOVED*** Automatic Escalation Flow
...
***REMOVED******REMOVED******REMOVED*** Escalation Consecutive Check Requirements
...
***REMOVED******REMOVED******REMOVED*** Escalation Alert Template
...
***REMOVED******REMOVED*** 5. De-escalation Procedures

***REMOVED******REMOVED******REMOVED*** Automatic De-escalation Flow
...
***REMOVED******REMOVED******REMOVED*** De-escalation Consecutive Check Requirements
...
***REMOVED******REMOVED******REMOVED*** De-escalation Alert Template
...
***REMOVED******REMOVED*** 6. Response Playbooks by Level

***REMOVED******REMOVED******REMOVED*** Level 1: PREVENTION (GREEN) - Playbook
...
***REMOVED******REMOVED******REMOVED*** Level 2: CONTROL (YELLOW) - Playbook
...
***REMOVED******REMOVED******REMOVED*** Level 3: SAFETY_SYSTEMS (ORANGE) - Playbook
...
***REMOVED******REMOVED******REMOVED*** Level 4: CONTAINMENT (RED) - Playbook
...
***REMOVED******REMOVED******REMOVED*** Level 5: EMERGENCY (BLACK) - Playbook
...
***REMOVED******REMOVED*** 7. Hysteresis Logic
    ...
    ***REMOVED*** De-escalation path
    ...
    IF fwi_score < de_escalate_threshold:
      ...
      ELSE:
        ...
        consecutive_count = 1
    ELSE:
      ***REMOVED*** Within hysteresis band
      candidate_level = None
      consecutive_count = 0
...
***REMOVED******REMOVED******REMOVED*** Example: Threshold Oscillation Prevention
...
***REMOVED******REMOVED*** 8. Manual Override Procedures
...
***REMOVED******REMOVED******REMOVED*** Emergency Escalation Procedure
...
***REMOVED*** → Immediately activates BLACK level
***REMOVED*** → Logs: "Override applied: emergency_escalate to EMERGENCY by admin-5678"
```

***REMOVED******REMOVED******REMOVED*** Level Lock Procedure
...
bridge.apply_override(override)
***REMOVED*** → Locks level at CONTROL
***REMOVED*** → Logs: "Level lock applied: CONTROL until 2025-12-30T15:30:00Z"
```

***REMOVED******REMOVED******REMOVED*** Hysteresis Bypass Procedure
...
override = DefenseOverride(
    ...
    target_level=DefenseLevel.SAFETY_SYSTEMS,  ***REMOVED*** Not used in bypass
    applied_by="admin-user-5678",
    reason="Urgent coverage gap - unexpected faculty departure"
)

bridge.apply_override(override)
***REMOVED*** → Processes current FWI
***REMOVED*** → Immediately applies recommended level (no 2-check wait)
***REMOVED*** → Clears override after use
```

***REMOVED******REMOVED******REMOVED*** System Test Procedure
...
***REMOVED******REMOVED*** 9. Trigger Conditions

***REMOVED******REMOVED******REMOVED*** Automatic Escalation Triggers

***REMOVED******REMOVED******REMOVED******REMOVED*** PRIMARY: FWI Score Mapping
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** SECONDARY: ISI Component (Rapid Deterioration)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** SECONDARY: BUI Component (Sustained Burden)
...
***REMOVED******REMOVED******REMOVED*** Escalation Alert Messages
...
***REMOVED******REMOVED*** 10. Audit & Monitoring
...
***REMOVED******REMOVED*** Operational Reference Tables

***REMOVED******REMOVED******REMOVED*** Quick Escalation Decision Tree
...
***REMOVED******REMOVED******REMOVED*** Response Activation Checklist by Level
...
***REMOVED******REMOVED*** Appendix: Military DEFCON Analogy
