***REMOVED*** Admin API Documentation
...
3. [Admin User Management](***REMOVED***admin-user-management)
4. [Database Administration](***REMOVED***database-administration)
5. [System Configuration & Monitoring](***REMOVED***system-configuration--monitoring)
6. [Error Handling](***REMOVED***error-handling)
7. [Audit Logging](***REMOVED***audit-logging)
8. [Bulk Operations](***REMOVED***bulk-operations)
...
***REMOVED******REMOVED******REMOVED*** Getting an Admin Token
...
***REMOVED******REMOVED*** Admin User Management

***REMOVED******REMOVED******REMOVED*** User Management Endpoints

All user management endpoints are located at `/api/admin/users/`.

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. List Users
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Create User
...
```
- admin            ***REMOVED*** Full system access
- coordinator      ***REMOVED*** Schedule management and monitoring
- faculty          ***REMOVED*** Faculty scheduling and swap requests
- resident         ***REMOVED*** Resident view and preferences
- clinical_staff   ***REMOVED*** Clinical operations
- rn               ***REMOVED*** Nursing staff
- lpn              ***REMOVED*** Licensed Practical Nurse
- msa              ***REMOVED*** Medical Support Assistant
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Update User
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Delete User
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Lock/Unlock Account
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 6. Resend Invitation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 7. Bulk User Actions
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 8. Activity Log
...
```
USER_CREATED        ***REMOVED*** User account created
USER_UPDATED        ***REMOVED*** User account modified
USER_DELETED        ***REMOVED*** User account deleted
USER_LOCKED         ***REMOVED*** Account locked
USER_UNLOCKED       ***REMOVED*** Account unlocked
LOGIN_SUCCESS       ***REMOVED*** Successful login
LOGIN_FAILED        ***REMOVED*** Failed login attempt
PASSWORD_CHANGED    ***REMOVED*** Password changed
ROLE_CHANGED        ***REMOVED*** Role changed
INVITE_SENT         ***REMOVED*** Invitation sent
INVITE_RESENT       ***REMOVED*** Invitation resent
```
...
***REMOVED******REMOVED*** Database Administration

***REMOVED******REMOVED******REMOVED*** Database Admin Endpoints

All database administration endpoints are located at `/api/db-admin/`.

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Database Health Check
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Index Recommendations
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Unused Indexes
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Index Usage Statistics
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Table Statistics
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 6. Query Statistics
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 7. Run VACUUM on Table
...
***REMOVED******REMOVED*** System Configuration & Monitoring

***REMOVED******REMOVED******REMOVED*** Configuration Endpoints

***REMOVED******REMOVED******REMOVED******REMOVED*** System Settings
...
***REMOVED******REMOVED******REMOVED*** Audit Trail Implementation

All admin operations are logged through the `_log_activity()` function.

***REMOVED******REMOVED******REMOVED*** Logged Activities
...
***REMOVED******REMOVED******REMOVED*** Audit Log Schema

Each log entry captures:

```python
{
  "id": "UUID",                    ***REMOVED*** Log entry ID
  "timestamp": "ISO datetime",     ***REMOVED*** When action occurred
  "user_id": "UUID",               ***REMOVED*** Who performed action
  "user_email": "string",          ***REMOVED*** Admin email
  "action": "string",              ***REMOVED*** Action type
  "target_user_id": "UUID",        ***REMOVED*** Who was affected
  "target_user_email": "string",   ***REMOVED*** Affected user email
  "details": "dict",               ***REMOVED*** Action-specific details
  "ip_address": "string",          ***REMOVED*** Requester IP
  "user_agent": "string"           ***REMOVED*** Browser user agent
}
```

***REMOVED******REMOVED******REMOVED*** Accessing Audit Logs
...
***REMOVED******REMOVED******REMOVED*** Bulk User Action Request

**Endpoint:** `POST /api/admin/users/bulk`

***REMOVED******REMOVED******REMOVED*** Bulk Operation Flow
...
***REMOVED******REMOVED******REMOVED*** Bulk Limits

- **Maximum users per request**: 100
- **Maximum concurrent bulk operations**: 10 (per admin)

***REMOVED******REMOVED******REMOVED*** Error Handling in Bulk Operations
...
***REMOVED******REMOVED******REMOVED*** User Management Best Practices
...
***REMOVED******REMOVED******REMOVED*** Database Maintenance Best Practices
...
***REMOVED******REMOVED******REMOVED*** Monitoring Checklist
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Monitoring Script
...
***REMOVED*** Check for unused indexes
curl -X GET "http://localhost:8000/api/db-admin/indexes/unused?min_age_days=30" \
  -H "Authorization: Bearer $TOKEN"
```

***REMOVED******REMOVED******REMOVED******REMOVED*** User Provisioning Script
