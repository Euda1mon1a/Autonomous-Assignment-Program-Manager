***REMOVED*** Resilience API Documentation
...
2. [Health Check Endpoints](***REMOVED***health-check-endpoints)
3. [Tier 1 Critical Endpoints](***REMOVED***tier-1-critical-endpoints)
4. [Tier 2 Strategic Endpoints](***REMOVED***tier-2-strategic-endpoints)
5. [Tier 3 Advanced Endpoints](***REMOVED***tier-3-advanced-endpoints)
6. [Exotic Resilience Endpoints](***REMOVED***exotic-resilience-endpoints)
7. [Metrics and Monitoring](***REMOVED***metrics-and-monitoring)
8. [Alert Integration Guide](***REMOVED***alert-integration-guide)
9. [Response Payload Examples](***REMOVED***response-payload-examples)
...
***REMOVED******REMOVED******REMOVED*** GET /health/ready
...
***REMOVED******REMOVED******REMOVED*** GET /health/detailed
...
***REMOVED******REMOVED******REMOVED*** GET /health/services/{service_name}
...
***REMOVED******REMOVED******REMOVED*** GET /health/history
...
***REMOVED******REMOVED******REMOVED*** GET /health/metrics
...
***REMOVED******REMOVED******REMOVED*** DELETE /health/history
...
***REMOVED******REMOVED******REMOVED*** POST /health/check
...
***REMOVED******REMOVED******REMOVED*** GET /health/status
...
***REMOVED******REMOVED*** Tier 1 Critical Endpoints
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/health
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/crisis/activate
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/crisis/deactivate
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/fallbacks
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/fallbacks/activate
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/fallbacks/deactivate
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/load-shedding
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/load-shedding
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/vulnerability
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/report
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/history/health
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/history/events
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/mtf-compliance
...
***REMOVED******REMOVED*** Tier 2 Strategic Endpoints
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier2/homeostasis
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/tier2/homeostasis/check
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/tier2/allostasis/calculate
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier2/zones
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier2/zones/report
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/tier2/stress
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/tier2/compensation
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier2/equilibrium
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier2/status
...
***REMOVED******REMOVED*** Tier 3 Advanced Endpoints
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/tier3/cognitive/decision
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier3/cognitive/queue
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/tier3/stigmergy/preference
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier3/stigmergy/status
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier3/hubs/top
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier3/hubs/distribution
...
***REMOVED******REMOVED******REMOVED*** GET /resilience/tier3/status
...
***REMOVED******REMOVED*** Exotic Resilience Endpoints
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/exotic/thermodynamics/entropy
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/exotic/thermodynamics/phase-transition
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/exotic/immune/assess
...
***REMOVED******REMOVED******REMOVED*** POST /resilience/exotic/time-crystal/rigidity
...
***REMOVED******REMOVED******REMOVED*** Key Monitoring Metrics
...
***REMOVED******REMOVED******REMOVED*** Alert Triggers
...
***REMOVED******REMOVED*** Alert Integration Guide

***REMOVED******REMOVED******REMOVED*** Webhook Integration

The resilience system can trigger webhooks on state changes:

```bash
***REMOVED*** Configure webhook in environment
RESILIENCE_WEBHOOK_URL=https://alerts.example.com/resilience
RESILIENCE_WEBHOOK_SECRET=<32-char-secret>
```

***REMOVED******REMOVED******REMOVED*** Webhook Payload
...
***REMOVED******REMOVED******REMOVED*** Integration Examples

**Datadog/New Relic:**
```python
***REMOVED*** In app.core.config
...
**Slack Notifications:**
```python
***REMOVED*** Configured via webhook
***REMOVED*** Sends alerts to ***REMOVED***resilience-alerts channel
```

**PagerDuty Escalation:**
```python
***REMOVED*** CRITICAL events trigger PagerDuty incident
***REMOVED*** Assigned to on-call coordinator
```

---

***REMOVED******REMOVED*** Response Payload Examples

***REMOVED******REMOVED******REMOVED*** Complete Health Check Response
...
***REMOVED******REMOVED******REMOVED*** Hub Protection Plan Example
