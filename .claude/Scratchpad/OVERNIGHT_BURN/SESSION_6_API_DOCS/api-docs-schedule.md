***REMOVED*** Schedule API Complete Documentation
...
2. [Core Features](***REMOVED***core-features)
3. [API Endpoint Catalog](***REMOVED***api-endpoint-catalog)
4. [Authentication & Authorization](***REMOVED***authentication--authorization)
5. [Request/Response Schemas](***REMOVED***requestresponse-schemas)
6. [Generation Parameters & Options](***REMOVED***generation-parameters--options)
7. [Response Formats](***REMOVED***response-formats)
8. [Integration Guide](***REMOVED***integration-guide)
9. [Error Handling](***REMOVED***error-handling)
10. [Advanced Features](***REMOVED***advanced-features)
11. [Implementation Notes](***REMOVED***implementation-notes)
...
***REMOVED******REMOVED******REMOVED*** 1. Schedule Generation
...
***REMOVED******REMOVED******REMOVED*** 2. Schedule Validation
...
***REMOVED******REMOVED******REMOVED*** 3. Emergency Coverage
...
***REMOVED******REMOVED******REMOVED*** 4. Import & Analysis
...
***REMOVED******REMOVED******REMOVED*** 5. Swap Finding
...
***REMOVED******REMOVED******REMOVED*** 6. Faculty Outpatient Assignment
...
***REMOVED******REMOVED*** API Endpoint Catalog

***REMOVED******REMOVED******REMOVED*** Core Endpoints (Schedule Management)

***REMOVED******REMOVED******REMOVED******REMOVED*** POST /generate
...
***REMOVED******REMOVED******REMOVED******REMOVED*** GET /validate
...
***REMOVED******REMOVED******REMOVED******REMOVED*** GET /{start_date}/{end_date}
...
***REMOVED******REMOVED******REMOVED******REMOVED*** POST /emergency-coverage
...
***REMOVED******REMOVED******REMOVED*** Import & Analysis Endpoints

***REMOVED******REMOVED******REMOVED******REMOVED*** POST /import/analyze
...
***REMOVED******REMOVED******REMOVED******REMOVED*** POST /import/analyze-file
...
***REMOVED******REMOVED******REMOVED******REMOVED*** POST /import/block
...
***REMOVED******REMOVED******REMOVED*** Swap Finder Endpoints

***REMOVED******REMOVED******REMOVED******REMOVED*** POST /swaps/find
...
***REMOVED******REMOVED******REMOVED******REMOVED*** POST /swaps/candidates
...
***REMOVED******REMOVED******REMOVED*** Faculty Outpatient Endpoints

***REMOVED******REMOVED******REMOVED******REMOVED*** POST /faculty-outpatient/generate
...
***REMOVED******REMOVED******REMOVED*** Authorization Requirements
...
***REMOVED******REMOVED******REMOVED*** ScheduleRequest Schema
...
***REMOVED******REMOVED******REMOVED*** ScheduleResponse Schema
...
***REMOVED******REMOVED******REMOVED*** ValidationResult Schema
...
***REMOVED******REMOVED******REMOVED*** EmergencyRequest/Response Schema
...
***REMOVED******REMOVED******REMOVED*** SwapFinderRequest Schema
...
***REMOVED******REMOVED******REMOVED*** SwapCandidateJsonRequest Schema
...
***REMOVED******REMOVED*** Generation Parameters & Options
...
***REMOVED******REMOVED******REMOVED*** Date Range Considerations
...
***REMOVED******REMOVED******REMOVED*** PGY Level Filtering
...
***REMOVED******REMOVED******REMOVED*** Rotation Template Selection
...
***REMOVED******REMOVED*** Response Formats

***REMOVED******REMOVED******REMOVED*** Schedule Response Status Values
...
***REMOVED******REMOVED******REMOVED*** HTTP Status Code Semantics
...
***REMOVED******REMOVED******REMOVED*** Response Header Details
...
***REMOVED******REMOVED******REMOVED*** Python Client Example
...
***REMOVED******REMOVED******REMOVED*** Common Error Responses
...
***REMOVED******REMOVED******REMOVED*** Error Recovery Strategies
...
***REMOVED******REMOVED******REMOVED*** Idempotency Implementation
...
***REMOVED******REMOVED******REMOVED*** Night Float to Post-Call Audit
...
***REMOVED******REMOVED******REMOVED*** Solver Statistics
...
***REMOVED******REMOVED******REMOVED*** Architecture Overview
...
***REMOVED******REMOVED******REMOVED*** Async/Concurrency
...
***REMOVED******REMOVED******REMOVED*** Error Handling Strategy
...
***REMOVED******REMOVED******REMOVED*** Payload Sizes
...
***REMOVED******REMOVED******REMOVED*** Failure Modes & Recovery
