***REMOVED*** Swap API Documentation
...
1. [Endpoints](***REMOVED***endpoints)
2. [Swap State Transitions](***REMOVED***swap-state-transitions)
3. [Swap Workflows](***REMOVED***swap-workflows)
4. [Auto-Matching System](***REMOVED***auto-matching-system)
...
***REMOVED******REMOVED*** POST /api/swaps/execute
...
***REMOVED******REMOVED******REMOVED*** Failure Response (200 OK - Validation Returned)
...
***REMOVED******REMOVED*** POST /api/swaps/validate
...
***REMOVED******REMOVED******REMOVED*** Validation Failure Response
...
***REMOVED******REMOVED******REMOVED*** Validation Rules Checked
...
***REMOVED******REMOVED*** GET /api/swaps/history
...
| `status` | String | None | Filter by swap status (see [Statuses](***REMOVED***statuses)) |
...
***REMOVED******REMOVED*** GET /api/swaps/{swap_id}
...
***REMOVED******REMOVED*** POST /api/swaps/{swap_id}/rollback
...
***REMOVED******REMOVED******REMOVED*** Error Cases
...
***REMOVED******REMOVED*** Swap State Transitions
...
***REMOVED******REMOVED******REMOVED*** Historical Record
...
***REMOVED******REMOVED*** Swap Workflows

***REMOVED******REMOVED******REMOVED*** Workflow 1: Simple One-to-One Swap
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Flow
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Expected Validation Result
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Absorb Swap (Give Away Week)
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Validation Check Before Committing
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Retrieving Swap History

Coordinators query swap patterns and audit trail.

***REMOVED******REMOVED******REMOVED******REMOVED*** Example: All Swaps by Faculty
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example: All Swaps This Month
...
***REMOVED******REMOVED*** Auto-Matching System
...
***REMOVED******REMOVED******REMOVED*** Match Priority Levels
...
***REMOVED******REMOVED******REMOVED*** Match Types
...
***REMOVED******REMOVED******REMOVED*** API Endpoints (Planned)
...
***REMOVED******REMOVED******REMOVED*** Matching Criteria Customization
...
***REMOVED******REMOVED******REMOVED*** Core Validation Checks

All swaps are validated against these rules:

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Faculty Validation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Date Range Validation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Swap Type Consistency
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Back-to-Back Conflict
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. External Conflicts
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 6. ACGME Compliance (Future Implementation)
...
***REMOVED******REMOVED******REMOVED*** Validation vs. HTTP Errors
...
***REMOVED******REMOVED******REMOVED*** Example 1: Execute One-to-One Swap
...
***REMOVED******REMOVED******REMOVED*** Example 2: Absorb Swap (One-Way)
...
***REMOVED******REMOVED******REMOVED*** Example 3: Validation Failure - Back-to-Back Conflict
...
***REMOVED******REMOVED******REMOVED*** Example 4: Query Swap History
...
***REMOVED******REMOVED******REMOVED*** Example 5: Rollback Swap
...
***REMOVED******REMOVED******REMOVED*** Example 6: Invalid Swap Type Consistency
...
***REMOVED******REMOVED******REMOVED*** Service Layer
