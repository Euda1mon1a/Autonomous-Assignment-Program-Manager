***REMOVED*** Authentication API Documentation
...
2. [Authentication Model](***REMOVED***authentication-model)
3. [Endpoints](***REMOVED***endpoints)
   - [Login](***REMOVED***login)
   - [Login (JSON)](***REMOVED***login-json)
   - [Registration](***REMOVED***registration)
   - [Token Refresh](***REMOVED***token-refresh)
   - [Get Current User](***REMOVED***get-current-user)
   - [Logout](***REMOVED***logout)
   - [List Users](***REMOVED***list-users)
4. [Token Structure](***REMOVED***token-structure)
5. [Security Features](***REMOVED***security-features)
6. [Error Handling](***REMOVED***error-handling)
7. [Integration Guide](***REMOVED***integration-guide)
8. [Rate Limiting](***REMOVED***rate-limiting)
9. [Troubleshooting](***REMOVED***troubleshooting)
10. [Password Requirements](***REMOVED***password-requirements)
...
***REMOVED******REMOVED*** Authentication Model
...
***REMOVED******REMOVED******REMOVED*** User Permissions Matrix
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Headers Set by Server
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example cURL
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example Python
...
***REMOVED*** The access token is also set as a cookie automatically
```

***REMOVED******REMOVED******REMOVED******REMOVED*** Example JavaScript
...
***REMOVED******REMOVED******REMOVED*** Registration
...
| `role` | string | No | Default: `coordinator`. See [User Roles](***REMOVED***user-roles) for options |
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Authorization Rules
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Password Requirements
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Token Rotation Behavior
...
new_refresh = new_tokens["refresh_token"]  ***REMOVED*** Store this
```
...
***REMOVED******REMOVED******REMOVED*** List Users
...
***REMOVED******REMOVED******REMOVED*** Access Token Payload
...
***REMOVED******REMOVED******REMOVED*** Refresh Token Payload
...
***REMOVED******REMOVED******REMOVED*** Token Decoding Example
...
***REMOVED******REMOVED******REMOVED*** 1. httpOnly Cookies (XSS Protection)
...
***REMOVED******REMOVED******REMOVED*** 2. Token Type Validation

Refresh tokens explicitly cannot be used as access tokens:

```python
***REMOVED*** In security.py - verify_token()
if payload.get("type") == "refresh":
    return None  ***REMOVED*** Reject refresh tokens as access tokens
```

This prevents privilege escalation where an attacker uses a long-lived refresh token as a short-lived access token.

***REMOVED******REMOVED******REMOVED*** 3. Token Rotation
...
***REMOVED******REMOVED******REMOVED*** 4. Token Blacklisting
...
if TokenBlacklist.is_blacklisted(db, jti):
    return None  ***REMOVED*** Reject request
```

***REMOVED******REMOVED******REMOVED*** 5. Account Lockout (Exponential Backoff)
...
***REMOVED******REMOVED******REMOVED*** 6. Rate Limiting
...
***REMOVED******REMOVED******REMOVED*** Error Types

***REMOVED******REMOVED******REMOVED******REMOVED*** 400 Bad Request - Validation Errors
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 401 Unauthorized - Authentication Failures
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 403 Forbidden - Authorization Failures
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 429 Too Many Requests - Rate Limit
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 422 Unprocessable Entity - Schema Validation
...
***REMOVED******REMOVED******REMOVED*** Browser-Based Frontend (React/Next.js)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Protected Requests
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Token Refresh
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Logout
...
***REMOVED******REMOVED******REMOVED*** Python Backend Client

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Simple API Client
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Async HTTP Client
...
***REMOVED******REMOVED******REMOVED*** cURL Examples
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Protected Request
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Refresh Token
...
***REMOVED******REMOVED******REMOVED*** Endpoints and Limits
...
***REMOVED******REMOVED******REMOVED*** Account Lockout
...
***REMOVED******REMOVED******REMOVED*** Response Headers
...
***REMOVED******REMOVED******REMOVED*** Issue: "Not authenticated" on protected endpoints
...
***REMOVED******REMOVED******REMOVED*** Issue: "Invalid or expired refresh token"
...
***REMOVED******REMOVED******REMOVED*** Issue: Account locked after failed logins
...
***REMOVED******REMOVED******REMOVED*** Issue: CORS errors when calling API
...
***REMOVED******REMOVED******REMOVED*** Issue: Token not being sent in cookies
...
***REMOVED******REMOVED******REMOVED*** Issue: "Incorrect username or password" but credentials are correct
...
***REMOVED******REMOVED******REMOVED*** Issue: First user registration not becoming admin
...
***REMOVED******REMOVED*** Password Requirements
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Valid Passwords
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Invalid Passwords
...
ACCESS_TOKEN_EXPIRE_MINUTES=15      ***REMOVED*** Default: 15 minutes
REFRESH_TOKEN_EXPIRE_DAYS=7         ***REMOVED*** Default: 7 days

***REMOVED*** Token Rotation
REFRESH_TOKEN_ROTATE=true           ***REMOVED*** Default: rotate on each refresh

***REMOVED*** Rate Limiting
RATE_LIMIT_ENABLED=true             ***REMOVED*** Default: enabled
RATE_LIMIT_LOGIN_ATTEMPTS=5         ***REMOVED*** Per IP per minute
RATE_LIMIT_LOGIN_WINDOW=60          ***REMOVED*** Window in seconds
RATE_LIMIT_REGISTER_ATTEMPTS=3      ***REMOVED*** Per IP per minute
RATE_LIMIT_REGISTER_WINDOW=60       ***REMOVED*** Window in seconds

***REMOVED*** Security
SECRET_KEY=<64-char-random>         ***REMOVED*** JWT signing key (REQUIRED)
DEBUG=false                         ***REMOVED*** Disables Secure flag in production
```

***REMOVED******REMOVED******REMOVED*** Default Settings
...
***REMOVED******REMOVED******REMOVED*** Automatic Documentation
...
***REMOVED******REMOVED******REMOVED*** Example OpenAPI Schema
