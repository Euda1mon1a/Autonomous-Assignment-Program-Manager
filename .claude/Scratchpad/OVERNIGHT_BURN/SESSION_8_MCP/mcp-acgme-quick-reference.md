***REMOVED*** MCP ACGME Tools - Quick Reference

**Fast lookup guide for ACGME compliance validation via MCP**

---

***REMOVED******REMOVED*** All ACGME Tools at a Glance

***REMOVED******REMOVED******REMOVED*** Core Validation (3 tools)
...
***REMOVED******REMOVED******REMOVED*** Contingency & Impact (3 tools)
...
***REMOVED******REMOVED******REMOVED*** Resilience & Defense (3 tools)
...
***REMOVED******REMOVED******REMOVED*** Background Tasks (4 tools)
...
***REMOVED******REMOVED*** The 4 Core ACGME Rules

***REMOVED******REMOVED******REMOVED*** 1. 80-Hour Rule
...
```python
***REMOVED*** Violation looks like:
{
  "rule": "80_HOUR_WEEKLY_LIMIT",
  "average_hours": 84.5,  ***REMOVED*** Exceeds 80
  "violation_hours": 4.5
}
```

***REMOVED******REMOVED******REMOVED*** 2. 1-in-7 Rule
...
***REMOVED*** Violation looks like:
{
  ...
  "consecutive_duty_days": 8,  ***REMOVED*** Exceeds 6
  "violation_days": 2
}
```
...
***REMOVED*** Violation looks like:
{
  ...
  "pgy_level": "PGY1",
  "ratio_required": "2:1",
  "ratio_actual": "2.5:1",  ***REMOVED*** 5 residents, 2 faculty
  "missing_faculty": 1
}
```

***REMOVED******REMOVED******REMOVED*** 4. Availability (Absence Enforcement)
...
***REMOVED******REMOVED******REMOVED*** Use Case 1: Validate Entire Block

```python
***REMOVED*** Block 10 = 13-week academic block
...
***REMOVED******REMOVED******REMOVED*** Use Case 2: Quick Problem Diagnosis

```python
***REMOVED*** Find specific issues in a week
...
***REMOVED******REMOVED******REMOVED*** Use Case 3: Plan for Faculty Leave

```python
***REMOVED*** Faculty going on leave Jan 20-27
...
***REMOVED******REMOVED******REMOVED*** Use Case 4: Monitor Utilization

```python
***REMOVED*** Check if schedule is overloaded
...
***REMOVED******REMOVED*** Constraint Configuration Cheat Sheet

```python
validate_schedule_by_id_tool(
    schedule_id="block10-2025",
    constraint_config="X"  ***REMOVED*** Pick one:
)
```
...
***REMOVED******REMOVED*** Violation Severity Mapping
...
***REMOVED******REMOVED*** Response Fields Reference

***REMOVED******REMOVED******REMOVED*** ValidationResult

```python
{
    "is_valid": bool,                        ***REMOVED*** Pass/fail
    "overall_compliance_rate": 0.0-1.0,     ***REMOVED*** % compliant
    "total_issues": int,                    ***REMOVED*** All violations
    "critical_issues": int,                 ***REMOVED*** Must-fix count
    "warning_issues": int,
    "info_issues": int,
    "issues": [                             ***REMOVED*** Detailed list
        {
            "severity": "CRITICAL|WARNING|INFO",
            "rule_type": "80_HOUR_WEEKLY_LIMIT",
            "message": "...",
            "person_id": "RESIDENT-001",    ***REMOVED*** Anonymized
...
***REMOVED******REMOVED*** Error Codes & Solutions
...
***REMOVED******REMOVED*** When to Use Each Tool
...
***REMOVED******REMOVED*** ACGME Constants Reference

```python
***REMOVED*** Work Hours
MAX_HOURS_PER_WEEK = 80
ROLLING_AVERAGE_WEEKS = 4  ***REMOVED*** 4-week window

***REMOVED*** Rest & Duty Days
MAX_CONSECUTIVE_DAYS = 6   ***REMOVED*** Must have 1 day off in 7
MAX_CONSECUTIVE_HOURS = 24  ***REMOVED*** Plus 4 for handoff
MAX_HANDOFF_HOURS = 4

***REMOVED*** Supervision Ratios
PGY1_RATIO = "1:2"  ***REMOVED*** 1 faculty per 2 residents
PGY2_3_RATIO = "1:4" ***REMOVED*** 1 faculty per 4 residents

***REMOVED*** Night Float (if used)
...
***REMOVED******REMOVED*** Common Fixes Quick List
...
***REMOVED******REMOVED*** Testing a Tool Locally

```python
***REMOVED*** Load MCP client
from scheduler_mcp import client

***REMOVED*** Test validate_schedule_tool
