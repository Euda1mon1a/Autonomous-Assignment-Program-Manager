***REMOVED*** OVERNIGHT_BURN Quick-Start Retrieval Guide
...
***REMOVED******REMOVED*** For Claude Agents: Start Here

***REMOVED******REMOVED******REMOVED*** Quick Facts
...
***REMOVED******REMOVED******REMOVED*** Right Now (Use These)
...
***REMOVED******REMOVED******REMOVED*** Example Queries

***REMOVED******REMOVED******REMOVED******REMOVED*** "I need backend service patterns"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** "What are ACGME requirements?"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** "What security patterns do we use?"
...
***REMOVED******REMOVED*** File Index by Domain

***REMOVED******REMOVED******REMOVED*** SESSION_1_BACKEND (Architecture & Patterns)
...
***REMOVED******REMOVED******REMOVED*** SESSION_2_FRONTEND (React/Next.js)
...
***REMOVED******REMOVED******REMOVED*** SESSION_3_ACGME (Compliance & Rules)
...
***REMOVED******REMOVED******REMOVED*** SESSION_4_SECURITY (Authentication & Authorization)
...
***REMOVED******REMOVED******REMOVED*** SESSION_5_TESTING (Test Coverage & Strategies)
...
***REMOVED******REMOVED******REMOVED*** SESSION_6_API_DOCS (REST API & Schemas)
...
***REMOVED******REMOVED******REMOVED*** SESSION_7_RESILIENCE (Framework & Best Practices)
...
***REMOVED******REMOVED******REMOVED*** SESSION_8_MCP (AI Integration Tools)
...
***REMOVED******REMOVED******REMOVED*** SESSION_9_SKILLS (Agent Capabilities)
...
***REMOVED******REMOVED******REMOVED*** SESSION_10_AGENTS (Agent Architecture)
...
***REMOVED******REMOVED******REMOVED*** Strategy 1: Start with Domain README
...
***REMOVED******REMOVED******REMOVED*** Strategy 2: Find Quick Reference
...
***REMOVED******REMOVED******REMOVED*** Strategy 3: Pattern Search
...
***REMOVED******REMOVED******REMOVED*** Strategy 4: Audit/Finding Search
...
***REMOVED******REMOVED******REMOVED*** Strategy 5: Cross-Domain
...
***REMOVED******REMOVED*** Common Lookups

***REMOVED******REMOVED******REMOVED*** "How do I...?"
...
***REMOVED******REMOVED******REMOVED*** "What is...?"
...
***REMOVED******REMOVED******REMOVED*** "Where is...?"
...
***REMOVED******REMOVED*** File Naming Patterns

***REMOVED******REMOVED******REMOVED*** Index/Navigation Files

- `README.md` - Domain overview
- `INDEX.md` - Navigation and cross-references
- `QUICK_REFERENCE.md` - Fast lookup guide

***REMOVED******REMOVED******REMOVED*** Summary/Overview Files
...
***REMOVED******REMOVED******REMOVED*** Pattern/Practice Files

- `*-patterns.md` - Code patterns and best practices
- `*-best-practices.md` - Best practice guide
- `*-architecture.md` - Architecture documentation

***REMOVED******REMOVED******REMOVED*** Reference/API Files
...
***REMOVED******REMOVED******REMOVED*** Tip 1: Use MASTER_INDEX.md (Now Available!)
...
***REMOVED******REMOVED******REMOVED*** Tip 1b: Query FILE_REGISTRY.json for Metadata
...
***REMOVED******REMOVED******REMOVED*** Tip 2: File Size Matters
...
***REMOVED******REMOVED******REMOVED*** Tip 3: Cross-Reference Connections

Many files have "See also:" sections. Follow these for related patterns across domains.

***REMOVED******REMOVED******REMOVED*** Tip 4: Priority Tagging
...
***REMOVED******REMOVED******REMOVED*** Tip 5: Search Within Domain First

Most questions are answered within one domain. Expand to cross-domain only if needed.

***REMOVED******REMOVED******REMOVED*** Tip 6: Check for Code Examples
...
***REMOVED******REMOVED******REMOVED*** If you need...
...
***REMOVED******REMOVED******REMOVED*** RAG Infrastructure Now Complete
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Immediate Use (Now Available)
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Agent Integration (Recommended)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Vector DB Implementation (Optional, Future)
...
***REMOVED******REMOVED******REMOVED*** For Users Now
...
***REMOVED******REMOVED*** File Locations Reference
