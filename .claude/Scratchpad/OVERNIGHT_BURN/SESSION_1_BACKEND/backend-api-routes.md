***REMOVED*** FastAPI Route Organization Reconnaissance Report
...
***REMOVED******REMOVED*** PROBE 1: PERCEPTION - Route File Organization

***REMOVED******REMOVED******REMOVED*** Directory Structure
```
backend/app/api/
├── __init__.py                    ***REMOVED*** Router registration hub
├── deps.py                        ***REMOVED*** Dependency injection utilities
├── dependencies/
│   ├── __init__.py
│   └── role_filter.py            ***REMOVED*** RBAC helper functions
└── routes/                        ***REMOVED*** 71 route files
    ├── __init__.py               ***REMOVED*** Main router assembly (169 lines)
    ├── absences.py
    ├── academic_blocks.py
    ├── admin_users.py
    ├── analytics.py              ***REMOVED*** 913 lines
    ├── assignments.py
    ├── audit.py                  ***REMOVED*** 845 lines
    ├── auth.py                   ***REMOVED*** Authentication routes
    ├── batch.py
    ├── block_scheduler.py
    ├── blocks.py
    ├── calendar.py
    ...
    ├── certifications.py
    ├── changelog.py
    ├── claude_chat.py            ***REMOVED*** 881 lines
    ├── conflict_resolution.py
    ├── credentials.py
    ├── daily_manifest.py
    ├── db_admin.py               ***REMOVED*** 613 lines
    ├── docs.py
    ├── exotic_resilience.py      ***REMOVED*** 974 lines
    ├── experiments.py
    ├── export.py & exports.py    ***REMOVED*** Dual export endpoints
    ├── fatigue_risk.py           ***REMOVED*** 16 endpoints
    ├── features.py
    ├── fmit_health.py            ***REMOVED*** 1,563 lines ⚠️ BLOAT
    ├── fmit_timeline.py          ***REMOVED*** 676 lines
    ├── game_theory.py            ***REMOVED*** 775 lines
    ├── health.py                 ***REMOVED*** 336 lines (well-structured)
    ├── imports.py
    ├── jobs.py                   ***REMOVED*** 957 lines, 20 endpoints
    ├── leave.py
    ├── me_dashboard.py
    ├── metrics.py
    ├── ml.py                     ***REMOVED*** 610 lines
    ├── oauth2.py
    ├── people.py
    ├── portal.py                 ***REMOVED*** 1,427 lines ⚠️ BLOAT
    ├── procedures.py
    ├── profiling.py              ***REMOVED*** 641 lines, 11 endpoints
    ├── qubo_templates.py         ***REMOVED*** 702 lines
    ├── quota.py
    ├── rag.py
    ├── rate_limit.py
    ├── reports.py
    ├── resilience.py             ***REMOVED*** 2,781 lines, 54 endpoints ⚠️ CRITICAL BLOAT
    ├── role_filter_example.py
    ├── role_views.py
    ├── rotation_templates.py
    ├── schedule.py               ***REMOVED*** 1,301 lines
    ├── scheduler.py              ***REMOVED*** 12 endpoints
    ├── scheduler_ops.py          ***REMOVED*** 1,146 lines
    ├── scheduling_catalyst.py
    ├── search.py
    ├── settings.py
    ├── sessions.py               ***REMOVED*** 11 endpoints
    ├── sso.py
    ├── swap.py
    ├── unified_heatmap.py
    ├── upload.py
    ├── visualization.py          ***REMOVED*** 725 lines
    ├── webhooks.py               ***REMOVED*** 13 endpoints
    └── ws.py                     ***REMOVED*** WebSocket endpoints
```

***REMOVED******REMOVED******REMOVED*** File Size Distribution
...
***REMOVED******REMOVED*** PROBE 2: INVESTIGATION - Route → Controller → Service Chains
...
✅ **auth.py (Login Flow)**
```python
***REMOVED*** Route layer (line 55-80)
...
async def login(
    ...
    ***REMOVED*** Delegate to controller
...
***REMOVED******REMOVED******REMOVED*** Dependency Injection Patterns
...
***REMOVED******REMOVED*** PROBE 3: ARCANA - FastAPI Dependency Injection Patterns

***REMOVED******REMOVED******REMOVED*** Rate Limiting Integration
...
***REMOVED******REMOVED******REMOVED*** Response Models with Pydantic
...
***REMOVED******REMOVED******REMOVED*** Query Parameter Validation
...
***REMOVED******REMOVED*** PROBE 4: HISTORY - API Versioning Evolution

***REMOVED******REMOVED******REMOVED*** Versioning Strategy

**Current Approach (main.py):**
```python
***REMOVED*** Routes mounted at /api/v1
app.include_router(api_router, prefix="/api/v1")

***REMOVED*** Backwards compatibility middleware
@app.middleware("http")
...
***REMOVED******REMOVED******REMOVED*** Router Assembly Pattern (routes/__init__.py)
...
***REMOVED*** ... 69 more include_router calls
```
...
***REMOVED******REMOVED*** PROBE 5: INSIGHT - RESTful Design Decisions

***REMOVED******REMOVED******REMOVED*** HTTP Method Distribution
...
***REMOVED******REMOVED******REMOVED*** RESTful Compliance Score: 72/100
...
***REMOVED******REMOVED******REMOVED*** Resource Organization
...
***REMOVED******REMOVED*** PROBE 6: RELIGION - Thin Routes Compliance

***REMOVED******REMOVED******REMOVED*** CLAUDE.md Requirement Analysis

**From CLAUDE.md Architecture Patterns:**
> "Routes should be thin: Delegate to controllers or services"

***REMOVED******REMOVED******REMOVED*** Compliance Audit (Sample of 5 routes)
...
***REMOVED******REMOVED******REMOVED*** Thin Routes Compliance Score: **92/100**
...
***REMOVED******REMOVED*** PROBE 7: NATURE - Route Bloat & Over-Engineering Analysis

***REMOVED******REMOVED******REMOVED*** Critical Bloat Identified

**Three routes exceed sustainable complexity thresholds:**

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. resilience.py - **2,781 lines** ⚠️ CRITICAL
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. fmit_health.py - **1,563 lines** ⚠️ SEVERE
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. portal.py - **1,427 lines** ⚠️ SEVERE
...
***REMOVED******REMOVED*** PROBE 8: MEDICINE - Response Time & Performance Patterns

***REMOVED******REMOVED******REMOVED*** Documented Performance Patterns
...
***REMOVED******REMOVED******REMOVED*** Resilience Performance Considerations

**Health Check Timeout (health.py):**
```python
health_aggregator = HealthAggregator(
    enable_history=True, history_size=100, timeout=10.0  ***REMOVED*** 10-second timeout
)
```
...
***REMOVED******REMOVED******REMOVED*** Caching Patterns
...
***REMOVED*** Redis-based caching with configurable TTL
```
...
***REMOVED******REMOVED*** PROBE 9: SURVIVAL - Error Response Consistency

***REMOVED******REMOVED******REMOVED*** Error Handling Audit
...
2. **Security Concern** (main.py, lines 273-284)
   ...
   if settings.DEBUG:
       return JSONResponse(
           status_code=500,
           content={"detail": str(exc), "type": type(exc).__name__}  ***REMOVED*** Type exposed
       )
   ```
...
***REMOVED******REMOVED******REMOVED*** Error Response Format Consistency
...
***REMOVED******REMOVED******REMOVED*** Security Information Disclosure
...
***REMOVED******REMOVED*** PROBE 10: STEALTH - Authentication & Authorization Bypass Risks
...
async def lock_account(
    user_id: UUID,
    admin_user: User = Depends(get_admin_user),  ***REMOVED*** Role check
):
    ...
```
...
***REMOVED******REMOVED******REMOVED*** Security Headers & CORS
...
response.set_cookie(
    ...
    httponly=True,        ***REMOVED*** XSS prevention
    secure=not settings.DEBUG,  ***REMOVED*** HTTPS in production
    samesite="lax",       ***REMOVED*** CSRF prevention
)
```

***REMOVED******REMOVED******REMOVED*** OpenAPI Documentation Security

**main.py (lines 236-238):**
```python
docs_url="/docs" if settings.DEBUG else None,  ***REMOVED*** Disable in production
...
***REMOVED******REMOVED******REMOVED*** Known Vulnerabilities Check
...
***REMOVED******REMOVED*** Summary: Route Inventory by Domain

***REMOVED******REMOVED******REMOVED*** Full Endpoint Count
...
***REMOVED******REMOVED*** OpenAPI Documentation Completeness

***REMOVED******REMOVED******REMOVED*** Completeness Score: 85/100
...
***REMOVED******REMOVED*** Authentication/Authorization Patterns Summary

***REMOVED******REMOVED******REMOVED*** Dependency Injection Hierarchy
...
***REMOVED******REMOVED******REMOVED*** Permission Levels
...
***REMOVED******REMOVED*** RESTful Compliance Scoring Details
...
***REMOVED******REMOVED******REMOVED*** Immediate (High Priority)
...
***REMOVED******REMOVED*** Compliance Summary Table
