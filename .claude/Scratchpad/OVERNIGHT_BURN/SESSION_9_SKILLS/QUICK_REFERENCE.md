***REMOVED*** Skills Documentation Quick Reference
...
***REMOVED******REMOVED*** Tier Selection Matrix
...
***REMOVED******REMOVED*** SKILL.md Required Sections Checklist
...
***REMOVED******REMOVED*** Directory Templates

***REMOVED******REMOVED******REMOVED*** Minimal (SKILL.md only)
```
skill-name/
└── SKILL.md
```
...
***REMOVED******REMOVED******REMOVED*** Standard (SKILL.md + supporting docs)
```
skill-name/
├── SKILL.md
...
***REMOVED******REMOVED******REMOVED*** Mature (Full structure with subdir organization)
```
skill-name/
├── SKILL.md
├── Workflows/
...
***REMOVED******REMOVED*** Frontmatter Template (Copy/Paste)
...
***REMOVED******REMOVED*** Common Section Templates

***REMOVED******REMOVED******REMOVED*** When This Skill Activates
```markdown
...
***REMOVED******REMOVED******REMOVED*** Integration with Other Skills
```markdown
...
***REMOVED******REMOVED******REMOVED*** Version & Maintenance
```markdown
...
***REMOVED******REMOVED*** Quality Checklist (Quick)

***REMOVED******REMOVED******REMOVED*** Before Committing Skill Documentation
...
***REMOVED******REMOVED******REMOVED*** For Mature Skills Only
...
***REMOVED******REMOVED*** Workflow Document Template (Minimal)
...
- [Other workflow](***REMOVED***)
```

---

***REMOVED******REMOVED*** File Path Standards
...
***REMOVED******REMOVED*** Documentation Update Frequency
...
***REMOVED******REMOVED*** Audit Commands

```bash
***REMOVED*** Find skills missing SKILL.md
find .claude/skills -maxdepth 1 -type d ! -name "managed" ! -name "CORE" -exec bash -c \
  '[[ ! -f "$1/SKILL.md" ]] && echo "$1"' _ {} \;

***REMOVED*** Find outdated documentation (>90 days)
find .claude/skills -name "*.md" -mtime +90

***REMOVED*** Check for broken internal links
grep -r "\[.*\](***REMOVED***" .claude/skills/ | grep -v "^Binary"

***REMOVED*** Find skills without integration sections
grep -L "Integration with Other Skills" .claude/skills/*/SKILL.md

***REMOVED*** Count documentation tier distribution
...
***REMOVED******REMOVED*** Integration Relationships Map
...
***REMOVED******REMOVED******REMOVED*** Week 1 (Baseline)
