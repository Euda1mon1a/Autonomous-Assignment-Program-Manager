***REMOVED*** Skill YAML Schema Documentation
...
***REMOVED******REMOVED*** I. EXECUTIVE SUMMARY
...
***REMOVED******REMOVED*** II. COMPLETE SCHEMA SPECIFICATION

***REMOVED******REMOVED******REMOVED*** 2.1 YAML Frontmatter Format
...
***REMOVED******REMOVED******REMOVED*** 2.2 Required Fields

***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2.1 `name` Field
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2.2 `description` Field
...
***REMOVED******REMOVED******REMOVED*** 2.3 Optional Fields

***REMOVED******REMOVED******REMOVED******REMOVED*** 2.3.1 `model_tier` Field
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.3.2 `parallel_hints` Field
...
```yaml
***REMOVED*** Skill that can run in parallel with others
parallel_hints:
...
***REMOVED*** Skill with no parallelization constraints
parallel_hints:
...
***REMOVED*** Skill that must always run alone
parallel_hints:
  can_parallel_with: []
...
***REMOVED******REMOVED******REMOVED*** 2.4 Undocumented/Experimental Fields
...
***REMOVED******REMOVED*** III. FIELD COVERAGE ANALYSIS

***REMOVED******REMOVED******REMOVED*** 3.1 Coverage by Field
...
***REMOVED******REMOVED******REMOVED*** 3.2 Field Usage Patterns
...
***REMOVED******REMOVED******REMOVED*** 3.3 Patterns Across Skills
...
***REMOVED******REMOVED*** IV. VALIDATION RULES

***REMOVED******REMOVED******REMOVED*** 4.1 YAML Syntax Validation

**Required checks before accepting skill:**

```yaml
***REMOVED*** VALID - Minimal skill
---
name: my-skill
description: Does something useful
---

***REMOVED*** VALID - All fields
---
name: my-skill
description: Does something useful
model_tier: opus
...
***REMOVED*** INVALID - Missing required field
---
name: my-skill
---

***REMOVED*** INVALID - Empty description
---
name: my-skill
description: ""
---

***REMOVED*** INVALID - Bad name format
---
name: MySkill
description: Does something
---

***REMOVED*** INVALID - Multiline description
---
name: my-skill
description: Does something
  across multiple
...
***REMOVED******REMOVED******REMOVED*** 4.2 Semantic Validation
...
***REMOVED******REMOVED******REMOVED*** 4.3 Validation Checklist
...
***REMOVED******REMOVED*** V. SCHEMA EVOLUTION & MIGRATION

***REMOVED******REMOVED******REMOVED*** 5.1 Version History
...
***REMOVED******REMOVED******REMOVED*** 5.2 Schema Stability Guarantee
...
***REMOVED******REMOVED******REMOVED*** 5.3 Migration Path for Schema Changes
...
```yaml
***REMOVED*** Phase 1-2: New field optional
---
name: my-skill
description: Does something
version: "1.0.0"  ***REMOVED*** New field, not required yet
---

***REMOVED*** Phase 3: Still optional, but documented
---
name: my-skill
description: Does something
***REMOVED*** version: "1.0.0"  ***REMOVED*** COMING REQUIRED: Add this field
---

***REMOVED*** Phase 4: Now required
---
name: my-skill
description: Does something
version: "1.0.0"  ***REMOVED*** Now mandatory
---
```

---

***REMOVED******REMOVED*** VI. FIELD SEMANTICS & INTERPRETATION

***REMOVED******REMOVED******REMOVED*** 6.1 How Fields Affect Runtime Behavior
...
***REMOVED******REMOVED******REMOVED*** 6.2 Backward Compatibility
...
***REMOVED******REMOVED*** VII. DISCOVERY & ROUTING

***REMOVED******REMOVED******REMOVED*** 7.1 How Skills Are Discovered

**Mechanism 1: Slash Command Listing**
```bash
***REMOVED*** User types: /
***REMOVED*** System scans .claude/skills/*/SKILL.md
***REMOVED*** Extracts name and description from YAML
***REMOVED*** Shows: /skill-name - description
```

**Mechanism 2: Keyword Search**
```bash
***REMOVED*** User types: /help code
***REMOVED*** System searches descriptions for "code"
***REMOVED*** Matches: code-review, code-quality-monitor, automated-code-fixer
```

**Mechanism 3: Routing Logic**
```bash
***REMOVED*** Task: "Review this code"
***REMOVED*** System extracts keywords: "review", "code"
***REMOVED*** Matches against description + skill name
***REMOVED*** Routes to: code-review skill
```

***REMOVED******REMOVED******REMOVED*** 7.2 YAML Fields for Discovery
...
***REMOVED******REMOVED******REMOVED*** 8.1 Naming Conventions
...
***REMOVED******REMOVED******REMOVED*** 8.2 Description Best Practices
...
***REMOVED******REMOVED******REMOVED*** 8.3 Model Tier Selection
...
***REMOVED******REMOVED******REMOVED*** 8.4 Parallel Hints Guidelines
...
***REMOVED******REMOVED*** IX. TROUBLESHOOTING

***REMOVED******REMOVED******REMOVED*** 9.1 Common Validation Errors
...
- **Example:**
  ...
  ***REMOVED*** WRONG
  ...
  must_serialize_with: []  ***REMOVED*** Wrong indentation!
...
***REMOVED******REMOVED******REMOVED*** 9.2 Discovery Troubleshooting
...
***REMOVED******REMOVED******REMOVED*** 10.1 Minimal Skill Template
...
***REMOVED*** My Skill Title

Markdown content...
```

***REMOVED******REMOVED******REMOVED*** 10.2 Full-Featured Skill Template
...
***REMOVED******REMOVED******REMOVED*** 10.3 Field Reference Table
...
***REMOVED******REMOVED******REMOVED*** 10.4 Common Skill Patterns
...
```yaml
model_tier: haiku
***REMOVED*** No parallel_hints needed
```

**Domain Expert Skills:**
```yaml
***REMOVED*** No model_tier (use default)
***REMOVED*** No parallel_hints (single-execution)
```

---

***REMOVED******REMOVED*** XI. ARCHIVAL NOTES
