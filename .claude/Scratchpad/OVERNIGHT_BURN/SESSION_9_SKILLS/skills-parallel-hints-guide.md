***REMOVED*** Skills Parallel Hints Guide - Comprehensive Documentation
...
1. [Overview & Philosophy](***REMOVED***overview--philosophy)
2. [Current Annotations (10 Skills)](***REMOVED***current-annotations-10-skills)
3. [Annotation Pattern Reference](***REMOVED***annotation-pattern-reference)
4. [Skill Compatibility Matrix](***REMOVED***skill-compatibility-matrix)
5. [Domain-Based Parallelization](***REMOVED***domain-based-parallelization)
6. [Batch Size Optimization](***REMOVED***batch-size-optimization)
7. [Serialization Requirements](***REMOVED***serialization-requirements)
8. [Best Practices & Patterns](***REMOVED***best-practices--patterns)
9. [Multi-Agent Coordination Workflows](***REMOVED***multi-agent-coordination-workflows)
10. [Future Annotation Roadmap](***REMOVED***future-annotation-roadmap)

---

***REMOVED******REMOVED*** Overview & Philosophy

***REMOVED******REMOVED******REMOVED*** Zero Marginal Cost Principle
...
***REMOVED******REMOVED******REMOVED*** Annotation Metadata
...
***REMOVED******REMOVED*** Current Annotations (10 Skills)

***REMOVED******REMOVED******REMOVED*** 1. test-writer
...
***REMOVED******REMOVED******REMOVED*** 3. security-audit
...
***REMOVED******REMOVED******REMOVED*** 4. lint-monorepo
...
***REMOVED******REMOVED******REMOVED*** 5. fastapi-production
...
***REMOVED******REMOVED******REMOVED*** 6. automated-code-fixer
...
***REMOVED******REMOVED******REMOVED*** 7. docker-containerization
...
***REMOVED******REMOVED******REMOVED*** 8. database-migration
...
***REMOVED******REMOVED******REMOVED*** 9. pr-reviewer
...
**Real-World Scenarios:**
- Review PR ***REMOVED***123 (code-review + security audit in parallel)
- Review PR ***REMOVED***124 (independent PR)
- **Parallel OK** - Different PRs, coordination at merge

---

***REMOVED******REMOVED******REMOVED*** 10. MCP_ORCHESTRATION
...
***REMOVED******REMOVED*** Annotation Pattern Reference

***REMOVED******REMOVED******REMOVED*** Pattern 1: Independent Quality Checks (test-writer, code-review, security-audit, lint-monorepo)
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Code → Test Dependency (fastapi-production → test-writer)

**Characteristic Pattern:**
```yaml
***REMOVED*** fastapi-production
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Database Serialization (database-migration)
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Domain-Based Parallelization

**Characteristic Pattern:**
```yaml
***REMOVED*** Backend skill
domain: development/backend
can_parallel_with: [code-review, test-writer]  ***REMOVED*** Also in dev/quality

***REMOVED*** Frontend skill
domain: development/frontend
can_parallel_with: [code-review, test-writer]  ***REMOVED*** Different domain, OK
```
...
***REMOVED******REMOVED*** Skill Compatibility Matrix

***REMOVED******REMOVED******REMOVED*** Complete 10×10 Matrix
...
***REMOVED******REMOVED******REMOVED*** How to Read Matrix
...
***REMOVED******REMOVED*** Domain-Based Parallelization

***REMOVED******REMOVED******REMOVED*** Coordinator Domains (from PARALLELISM_FRAMEWORK.md)
...
***REMOVED******REMOVED******REMOVED*** Same-Domain Execution Rules
...
***REMOVED******REMOVED*** Batch Size Optimization

***REMOVED******REMOVED******REMOVED*** Batch Size Strategy

**Concept:** Preferred batch size = how many instances of same skill can execute concurrently

***REMOVED******REMOVED******REMOVED*** Size By Skill
...
***REMOVED******REMOVED******REMOVED*** Batch Size Computation

**Formula:**
```
Effective_Batch_Size = min(
    preferred_batch_size,                    ***REMOVED*** From annotation
    available_agents_with_skill,             ***REMOVED*** How many agents available
    ceiling(total_tasks / estimated_time)    ***REMOVED*** Throughput optimization
)
```
...
***REMOVED******REMOVED*** Serialization Requirements

***REMOVED******REMOVED******REMOVED*** Absolute Serialization (database-migration)
...
***REMOVED******REMOVED******REMOVED*** Soft Serialization Requirements
...
```yaml
***REMOVED*** In fastapi-production SKILL.md
must_serialize_with: [database-migration]
...
***REMOVED******REMOVED******REMOVED*** No Serialization (security-audit)

**Definition:** Skills with zero serialization requirements

```yaml
***REMOVED*** In security-audit SKILL.md
must_serialize_with: []
...
***REMOVED******REMOVED*** Best Practices & Patterns

***REMOVED******REMOVED******REMOVED*** Pattern 1: Converging Quality Gates
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Schema-Locked Implementation
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Isolated Security Audit
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Fault-Tolerant Batch Processing
...
***REMOVED******REMOVED*** Multi-Agent Coordination Workflows

***REMOVED******REMOVED******REMOVED*** Workflow 1: Full Feature Development (with Serialization)
...
T=2:35  │ PARALLEL: 4 agents spawn (no conflicts after schema) │
        ...
        │  └─ Completes T=5:15                               │
        │                                                     │
        ├─ Quality Gate ***REMOVED***1 (code-review)                     │
        │  ├─ Check architecture compliance                  │
        │  ├─ Check error handling                           │
        │  └─ Completes T=4:00                               │
        │                                                     │
        ├─ Quality Gate ***REMOVED***2 (security-audit)                  │
        │  ├─ Check file permissions                         │
        │  ├─ Check PII handling in export                   │
        │  └─ Completes T=4:30                               │
        │                                                     │
        └─ Quality Gate ***REMOVED***3 (lint-monorepo)                   │
           └─ Completes T=1:30                               │
        └─────────────────────────────────────────────────────┘
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Emergency Hotfix (Prioritized Serialization)
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Massive Testing Campaign (Batch Optimization)
...
***REMOVED******REMOVED*** Future Annotation Roadmap

***REMOVED******REMOVED******REMOVED*** Skills Not Yet Annotated (23 Remaining)

***REMOVED******REMOVED******REMOVED******REMOVED*** Tier 1: Immediate Candidates (High Impact)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Tier 2: Medium Priority (Moderate Impact)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Tier 3: Low Priority (Niche Skills)
...
***REMOVED******REMOVED******REMOVED*** Annotation Decision Checklist
...
parallel_hints:
  can_parallel_with: [code-review, test-writer, lint-monorepo]
  must_serialize_with: [database-migration]  ***REMOVED*** Only if schema affects types
  preferred_batch_size: 5
```

---

***REMOVED******REMOVED*** Appendix: Configuration Examples

***REMOVED******REMOVED******REMOVED*** Example 1: High-Parallelism Configuration
...
***REMOVED******REMOVED******REMOVED*** Example 2: Medium-Parallelism Configuration
...
***REMOVED******REMOVED******REMOVED*** Example 3: Low-Parallelism Configuration
...
***REMOVED******REMOVED******REMOVED*** Example 4: Asymmetric Configuration

**Use Case:** One-directional dependency

```yaml
***REMOVED*** In fastapi-production
parallel_hints:
  can_parallel_with: [test-writer, code-review]
  must_serialize_with: [database-migration]
  preferred_batch_size: 5

***REMOVED*** In test-writer
parallel_hints:
...
***REMOVED******REMOVED*** Summary: Parallel Hints as Force Multiplier
...
***REMOVED******REMOVED******REMOVED*** Impact on Multi-Agent Workflows
