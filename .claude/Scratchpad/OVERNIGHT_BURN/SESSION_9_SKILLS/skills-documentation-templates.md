***REMOVED*** Skills Documentation Templates & Maintenance Guide
...
2. [Template Standards](***REMOVED***template-standards)
3. [Directory Structure](***REMOVED***directory-structure)
4. [SKILL.md Template](***REMOVED***skillmd-template)
5. [Supporting Document Templates](***REMOVED***supporting-document-templates)
6. [Workflow Documentation](***REMOVED***workflow-documentation)
7. [Reference Documentation](***REMOVED***reference-documentation)
8. [Quality Checklist](***REMOVED***quality-checklist)
9. [Maintenance Guide](***REMOVED***maintenance-guide)
10. [Discovery & Discoverability](***REMOVED***discovery--discoverability)

---

***REMOVED******REMOVED*** Current State Analysis

***REMOVED******REMOVED******REMOVED*** Coverage Metrics
...
***REMOVED******REMOVED******REMOVED*** PERCEPTION (Documentation Quality)
...
***REMOVED******REMOVED*** Template Standards

***REMOVED******REMOVED******REMOVED*** Universal Standards
...
***REMOVED******REMOVED******REMOVED*** Mature Skill (Complete Structure)

```
skill-name/
├── SKILL.md                      ***REMOVED*** Main documentation (required)
├── Workflows/                    ***REMOVED*** Multi-step processes
│   ├── workflow-1.md
│   ├── workflow-2.md
│   └── error-handling.md
├── Reference/                    ***REMOVED*** Reference material
│   ├── detailed-guide.md
│   ├── patterns.md
│   └── error-catalog.md
└── Examples/                     ***REMOVED*** Real-world usage
    ├── example-1.md
    ├── example-2.md
    └── troubleshooting.md
```

***REMOVED******REMOVED******REMOVED*** Standard Skill (Functional Structure)

```
skill-name/
├── SKILL.md                      ***REMOVED*** Main documentation
├── patterns.md                   ***REMOVED*** Optional: Patterns & examples
└── reference.md                  ***REMOVED*** Optional: Detailed reference
```

***REMOVED******REMOVED******REMOVED*** Minimal Skill (Basic Structure)

```
skill-name/
└── SKILL.md                      ***REMOVED*** Main documentation only
```
...
***REMOVED******REMOVED*** SKILL.md Template

***REMOVED******REMOVED******REMOVED*** Full Template with All Sections
...
***REMOVED******REMOVED*** Key Terminology
...
***REMOVED******REMOVED*** How This Skill Works
...
***REMOVED******REMOVED******REMOVED*** Use Case 1: [Name]
...
***REMOVED******REMOVED******REMOVED*** Use Case 2: [Name]

[Continue for 2-4 most common use cases...]

***REMOVED******REMOVED*** Standards & Requirements

[CONDITIONAL: Include if skill enforces rules]

***REMOVED******REMOVED******REMOVED*** Quality Gates / Requirements
...
***REMOVED******REMOVED*** File Locations & Resources
...
***REMOVED******REMOVED******REMOVED*** Issue 1: [Symptom]
...
***REMOVED******REMOVED*** Limitations & Known Issues

***REMOVED******REMOVED******REMOVED*** Limitation 1: [Name]

**Impact:** How this affects usage
**Workaround:** Recommended approach

***REMOVED******REMOVED******REMOVED*** Known Issue 1: [Name]

**Symptom:** What users observe
**Status:** Open / In Progress / Resolved
**Tracking:** Issue link if applicable

***REMOVED******REMOVED*** Version & Maintenance
...
***REMOVED******REMOVED******REMOVED*** Minimal Template (Single-Page Skills)
...
***REMOVED******REMOVED******REMOVED*** Scenario 1
...
***REMOVED******REMOVED******REMOVED*** Issue: [Problem]
**Solution:** [Fix]
...
***REMOVED******REMOVED*** Supporting Document Templates

***REMOVED******REMOVED******REMOVED*** Workflows/error-handling.md

Template for error handling workflows:

```markdown
***REMOVED*** Error Handling Strategy
...
***REMOVED******REMOVED******REMOVED*** Procedure 1: [Name]
...
***REMOVED******REMOVED******REMOVED*** Reference/patterns.md

Template for common patterns:

```markdown
***REMOVED*** [Skill Name] Patterns & Best Practices

***REMOVED******REMOVED*** Pattern 1: [Name]
...
***REMOVED******REMOVED*** Pattern 2: [Name]

[Continue...]

***REMOVED******REMOVED*** Anti-Patterns (Avoid)

***REMOVED******REMOVED******REMOVED*** Bad Pattern 1: [Name]

**Why it's wrong:** Explanation
**Better approach:** Recommended pattern

***REMOVED******REMOVED******REMOVED*** Bad Pattern 2: [Name]

[Continue...]
```

***REMOVED******REMOVED******REMOVED*** Examples/scenario-1.md

Template for real-world examples:

```markdown
***REMOVED*** Example: [Scenario Name]
...
***REMOVED******REMOVED******REMOVED*** Step 1: [Name]
...
***REMOVED******REMOVED******REMOVED*** Step 2: [Name]
...
***REMOVED******REMOVED*** Related Examples

- [Other scenario that covers similar topic](***REMOVED***)
- [Pattern this demonstrates](***REMOVED***)
- [Integration with other skills](***REMOVED***)
```

---

***REMOVED******REMOVED*** Workflow Documentation

***REMOVED******REMOVED******REMOVED*** Workflow File Template
...
***REMOVED******REMOVED*** Example Execution
...
- [Other workflow that chains](***REMOVED***)
- [Alternative approach](***REMOVED***)
- [Fallback workflow](***REMOVED***)
```
...
***REMOVED******REMOVED******REMOVED*** Reference/tool-index.md

For skills that orchestrate multiple tools:

```markdown
***REMOVED*** [Skill Name] Tool Index

***REMOVED******REMOVED*** Tools Summary

**Total Tools:** N
**Categories:** List of categories

***REMOVED******REMOVED*** Tool Directory

***REMOVED******REMOVED******REMOVED*** Category 1: [Name]

**Purpose:** What these tools do collectively

***REMOVED******REMOVED******REMOVED******REMOVED*** Tool 1.1: [Name]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Tool 1.2: [Name]

[Continue for each tool...]

***REMOVED******REMOVED*** Tool Selection Guide
...
***REMOVED******REMOVED*** Error Catalog

***REMOVED******REMOVED******REMOVED*** Error 1: [Name]

**Cause:** When/why this error occurs
**Tools Affected:** tool1, tool2
**Recovery:** How to handle

***REMOVED******REMOVED******REMOVED*** Error 2: [Name]
...
***REMOVED******REMOVED******REMOVED*** Content Quality
...
***REMOVED******REMOVED******REMOVED*** Structural Quality

- [ ] **YAML Frontmatter**: All required fields present
- [ ] **Consistent Headings**: Using H2 (***REMOVED***) for major sections
...
***REMOVED******REMOVED******REMOVED*** Technical Accuracy
...
***REMOVED******REMOVED******REMOVED*** Discoverability
...
***REMOVED******REMOVED*** Maintenance Guide
...
**Process:**
```bash
***REMOVED*** Find documentation with broken links
grep -r "\[.*\](***REMOVED***" .claude/skills/ | grep -v "^Binary"

***REMOVED*** Check for outdated version dates
find .claude/skills -name "*.md" -mtime +90
```

***REMOVED******REMOVED******REMOVED*** Monthly Maintenance
...
**Process:**
```bash
***REMOVED*** Find skills not updated in 30 days
find .claude/skills -name "SKILL.md" -mtime +30

***REMOVED*** List all skill categories
find .claude/skills -maxdepth 2 -type d | sort
```

***REMOVED******REMOVED******REMOVED*** Quarterly Review
...
```markdown
***REMOVED*** Skills Documentation Quarterly Review - Q[X] 2025

***REMOVED******REMOVED*** Audit Results
...
***REMOVED******REMOVED******REMOVED*** Quality Distribution
- Mature (3+ docs): N skills
- Standard (2 docs): N skills
- Basic (SKILL.md only): N skills

***REMOVED******REMOVED******REMOVED*** Maintenance Status
...
***REMOVED******REMOVED*** Next Quarter Focus
- Priority 1: [What to focus on]
- Priority 2: [What to focus on]
```

***REMOVED******REMOVED******REMOVED*** Updating Existing Skills

**Template for Documentation Update:**

```markdown
***REMOVED*** Update: [Skill Name]

***REMOVED******REMOVED*** What Changed
- Change 1
- Change 2

***REMOVED******REMOVED*** Updated Sections
- [Section name]: [Brief description of change]

***REMOVED******REMOVED*** New Information
- [What's new]
...
2. **Add Notice**: Top of SKILL.md
   ...
   > Consider using [replacement-skill](***REMOVED***) instead.
...
***REMOVED******REMOVED*** Discovery & Discoverability

***REMOVED******REMOVED******REMOVED*** PERCEPTION: How Developers Find Skills
...
***REMOVED******REMOVED******REMOVED*** INVESTIGATION: Documentation Patterns
...
***REMOVED******REMOVED******REMOVED*** RELIGION: Completeness Standards
...
***REMOVED******REMOVED******REMOVED*** STEALTH: Finding Outdated Documentation
...
**Audit Process:**
```bash
***REMOVED*** Find skills not updated in 90 days
find .claude/skills -name "*.md" -mtime +90 | head -20

***REMOVED*** Check for dead references
grep -r "backend/app/[^/]*/" .claude/skills/ | grep -v "^Binary"

***REMOVED*** Find integration references to non-existent skills
grep -r "skill[1-9]:" .claude/skills/ SKILL.md
```

***REMOVED******REMOVED******REMOVED*** NATURE: Documentation Maintenance Overhead
...
***REMOVED******REMOVED******REMOVED*** MEDICINE: Context for Clinical/Admin Discovery
...
```markdown
***REMOVED******REMOVED*** For Clinician Administrators
...
***REMOVED******REMOVED******REMOVED*** Schedule Impact
...
***REMOVED******REMOVED******REMOVED*** SURVIVAL: Critical Documentation Dependencies
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Baseline (Week 1)
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Enrichment (Week 2-3)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Optimization (Week 4)
...
***REMOVED******REMOVED*** Template Usage Examples

***REMOVED******REMOVED******REMOVED*** Example 1: Converting Basic to Standard
...
***REMOVED*** Code Quality Monitor Skill
...
***REMOVED******REMOVED*** Monitoring Phases

***REMOVED******REMOVED******REMOVED*** Phase 1: Metric Collection
[Details]
...
***REMOVED******REMOVED******REMOVED*** Complements
- **test-writer**: [How]
- **code-review**: [How]
...
***REMOVED******REMOVED******REMOVED*** Example 2: Adding Workflows

**New File:** `code-quality-monitor/Workflows/coverage-recovery.md`

```markdown
***REMOVED*** Coverage Recovery Workflow

***REMOVED******REMOVED*** When to Use
When test coverage drops below 70%...

***REMOVED******REMOVED*** Process Phases

***REMOVED******REMOVED******REMOVED*** Phase 1: Identify Coverage Gaps
...
```

---

***REMOVED******REMOVED*** Summary Metrics

***REMOVED******REMOVED******REMOVED*** Current Documentation State
- **Total Skills**: 44
- **Documented**: 42 (95%)
- **Mature**: 3 (7%)
- **Standard**: 15 (34%)
...
***REMOVED******REMOVED******REMOVED*** Target State (Post-Implementation)
- **Mature**: 10-12 (23-27%)
- **Standard**: 20-25 (45-57%)
- **Basic**: 12-15 (27-34%)

***REMOVED******REMOVED******REMOVED*** Expected Benefits
...
***REMOVED******REMOVED******REMOVED*** Key Findings from SEARCH_PARTY Reconnaissance
