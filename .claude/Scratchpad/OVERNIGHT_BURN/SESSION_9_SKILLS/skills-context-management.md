***REMOVED*** Skills Context Management & State Handling
***REMOVED******REMOVED*** Comprehensive SEARCH_PARTY Reconnaissance Report
...
***REMOVED******REMOVED*** SECTION 1: THE CORE MODEL - CONTEXT ISOLATION

***REMOVED******REMOVED******REMOVED*** 1.1 The Fundamental Truth
...
***REMOVED******REMOVED******REMOVED*** 1.2 Practical Implications
...
***REMOVED******REMOVED*** SECTION 2: AGENT LIFECYCLE & STATE TIMING

***REMOVED******REMOVED******REMOVED*** 2.1 The Frozen Context Model
...
***REMOVED******REMOVED******REMOVED*** 2.2 Key Insight: "Blueprint vs. Deployed Soldiers"
...
***REMOVED******REMOVED*** SECTION 3: CONTEXT TRANSFER PATTERNS

***REMOVED******REMOVED******REMOVED*** 3.1 The Golden Rule
...
***REMOVED******REMOVED******REMOVED*** 3.2 Required Elements Checklist
...
***REMOVED******REMOVED******REMOVED*** 3.3 Anti-Patterns: What NOT to Do

***REMOVED******REMOVED******REMOVED******REMOVED*** Anti-Pattern 1: Assuming Shared Context
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Anti-Pattern 2: Vague File References
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Anti-Pattern 3: Implicit Decisions
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Anti-Pattern 4: Missing Success Criteria
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Anti-Pattern 5: Circular Context Dependencies
...
***REMOVED******REMOVED*** SECTION 4: STATE MANAGEMENT STRATEGIES

***REMOVED******REMOVED******REMOVED*** 4.1 Stateless Skills (Preferred)

**Design principle:** Skills should be pure functions - same input → same output.

```python
***REMOVED*** ✅ GOOD: Stateless
...
***REMOVED*** ❌ BAD: Stateful
def analyze_code(file_path: str) -> AnalysisResult:
    """Depends on global state set elsewhere."""
    global rules, config  ***REMOVED*** ← STATE!
    violations = check_rules(content, rules)
    ***REMOVED*** If global state changes, behavior changes
```
...
***REMOVED******REMOVED******REMOVED*** 4.2 State via Context (Immutable)

When state is needed, pass it explicitly in the prompt:

```markdown
***REMOVED******REMOVED*** Current System State (provided by parent)
...
***REMOVED******REMOVED******REMOVED*** 4.3 State via Database (Shared)

For persistent state that multiple skills need:

```markdown
***REMOVED******REMOVED*** Shared State (Read from Database)
...
***REMOVED******REMOVED******REMOVED*** 4.4 Memory Management

***REMOVED******REMOVED******REMOVED******REMOVED*** Problem: Context Window Exhaustion
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Chunking Large Data
...
***REMOVED******REMOVED*** SECTION 5: SKILL CONTEXT CATALOG

***REMOVED******REMOVED******REMOVED*** 5.1 The 42 Skills and Their Context Needs
...
***REMOVED******REMOVED******REMOVED*** 5.2 Context Dependency Matrix
...
***REMOVED******REMOVED******REMOVED*** 5.3 Context Injection Points

Where to pass context for maximum clarity:

```markdown
***REMOVED******REMOVED*** Template: Context-Heavy Skill Invocation

***REMOVED******REMOVED******REMOVED*** Skill: [SKILL_NAME]
...
***REMOVED******REMOVED*** SECTION 6: PARALLELISM & ISOLATION

***REMOVED******REMOVED******REMOVED*** 6.1 Why Isolation Enables Parallelism
...
***REMOVED******REMOVED******REMOVED*** 6.2 Safe Parallel Skill Execution
...
***REMOVED******REMOVED******REMOVED*** 6.3 Parallel Skill Patterns

***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern 1: Fan-Out (Parallel Analysis)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern 2: Pipeline Parallelization
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern 3: Map-Reduce
...
***REMOVED******REMOVED*** SECTION 7: SKILL LIFECYCLE & RECOVERY

***REMOVED******REMOVED******REMOVED*** 7.1 Skill Execution Timeline
...
***REMOVED******REMOVED******REMOVED*** 7.2 Recovery Strategies
...
***REMOVED******REMOVED*** SECTION 8: MEMORY OPTIMIZATION TECHNIQUES

***REMOVED******REMOVED******REMOVED*** 8.1 Token Budget Allocation
...
***REMOVED******REMOVED******REMOVED*** 8.2 Data Flattening Technique
...
***REMOVED******REMOVED******REMOVED*** 8.3 Summary + Retrieval Strategy
...
**Do this:**
```markdown
***REMOVED******REMOVED*** Schedule Summary
...
***REMOVED******REMOVED*** Retrieval Methods
...
***REMOVED******REMOVED*** Example Rows (representative)
...
***REMOVED******REMOVED*** SECTION 9: CONTEXT PATTERNS BY SKILL CATEGORY

***REMOVED******REMOVED******REMOVED*** 9.1 Code Analysis Skills (code-review, security-audit, test-writer)
...
***REMOVED******REMOVED*** Rubric/Checklist
- [item 1]
- [item 2]
...
***REMOVED******REMOVED******REMOVED*** 9.2 Scheduling Skills (SCHEDULING, COMPLIANCE_VALIDATION)

**Heavy context required:**

```markdown
***REMOVED******REMOVED*** Current Schedule State
[Summary + retrieval method, not full data]

***REMOVED******REMOVED*** Constraints Active
- [ACGME 80-hour rule]
- [ACGME 1-in-7 rule]
- [Faculty availability]
- [Rotation requirements]

***REMOVED******REMOVED*** Optimization Objectives
- Coverage: [weight/priority]
- Fairness: [weight/priority]
- Continuity: [weight/priority]

***REMOVED******REMOVED*** API Endpoints for Data Retrieval
- GET /api/schedules/{id}/assignments
...
***REMOVED******REMOVED******REMOVED*** 9.3 Resilience Skills (RESILIENCE_SCORING, COMPLIANCE_VALIDATION)

**Heavy context with analytics:**

```markdown
***REMOVED******REMOVED*** Current Metrics
- Utilization: 92%
- Threshold: 80%
- Status: ⚠️ YELLOW (approaching red)

***REMOVED******REMOVED*** Historical Trend (last 7 days)
[Mini chart or trend line]

***REMOVED******REMOVED*** Scenario to Analyze
[Specific N-1/N-2 scenario]

***REMOVED******REMOVED*** Defense Level Target
[YELLOW/ORANGE/RED]

***REMOVED******REMOVED*** Metrics API
...
***REMOVED******REMOVED*** SECTION 10: BEST PRACTICES & ANTI-PATTERNS

***REMOVED******REMOVED******REMOVED*** 10.1 DO: Follow These Patterns
...
***REMOVED******REMOVED******REMOVED*** 10.2 DON'T: Avoid These Anti-Patterns
...
***REMOVED******REMOVED*** SECTION 11: QUICK REFERENCE CARDS

***REMOVED******REMOVED******REMOVED*** 11.1 Context Isolation Cheatsheet
...
***REMOVED******REMOVED******REMOVED*** 11.2 Memory Optimization Checklist
...
***REMOVED******REMOVED******REMOVED*** 11.3 Skill Invocation Template

```markdown
***REMOVED******REMOVED*** Skill Invocation Template

***REMOVED******REMOVED******REMOVED*** Basic (Minimal Context)
Skill(
  name="code-review",
  prompt="""
  ***REMOVED******REMOVED*** Task
...
***REMOVED******REMOVED******REMOVED*** Advanced (Full Context)
Skill(
  name="SCHEDULING",
  prompt="""
...
***REMOVED******REMOVED*** SECTION 12: SKILL STATE TABLES

***REMOVED******REMOVED******REMOVED*** 12.1 All 42 Skills - Context Requirements Summary
...
***REMOVED******REMOVED*** SECTION 13: COMMON FAILURE MODES & RECOVERY

***REMOVED******REMOVED******REMOVED*** 13.1 Failure Mode: Missing Context
...
***REMOVED******REMOVED******REMOVED*** 13.2 Failure Mode: Timeout (>10 minutes)
...
***REMOVED******REMOVED******REMOVED*** 13.3 Failure Mode: Wrong Answer
...
***REMOVED******REMOVED******REMOVED*** 13.4 Failure Mode: Circular Dependency
...
***REMOVED******REMOVED*** SECTION 14: SUMMARY & KEY TAKEAWAYS

***REMOVED******REMOVED******REMOVED*** 14.1 The Five Laws of Skill Context
...
***REMOVED******REMOVED******REMOVED*** 14.2 Golden Rules
...
***REMOVED******REMOVED******REMOVED*** 14.3 Checklist: Before Spawning Any Skill
...
***REMOVED******REMOVED*** SECTION 15: EXAMPLES & CASE STUDIES

***REMOVED******REMOVED******REMOVED*** 15.1 Case Study: SCHEDULING Skill (Heavy Context)
...
***REMOVED******REMOVED******REMOVED*** 15.2 Case Study: Code Review Skills (Light Context)
...
**Right Approach:**
```markdown
***REMOVED******REMOVED*** Agent: CODE REVIEWER
...
***REMOVED******REMOVED*** SECTION 16: FUTURE WORK & RESEARCH DIRECTIONS

***REMOVED******REMOVED******REMOVED*** 16.1 Context Management Enhancements
...
***REMOVED******REMOVED******REMOVED*** 16.2 Memory Optimization Frontiers
...
***REMOVED******REMOVED*** END OF RECONNAISSANCE REPORT
