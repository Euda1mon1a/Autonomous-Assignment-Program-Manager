***REMOVED*** ACGME Rotation Requirements Inventory
...
***REMOVED******REMOVED*** 1. ROTATION TYPE INVENTORY

***REMOVED******REMOVED******REMOVED*** 1.1 Core Rotation Categories
...
***REMOVED******REMOVED******REMOVED*** 1.2 Common Inpatient Rotations
...
***REMOVED******REMOVED******REMOVED*** 1.3 Common Outpatient Rotations
...
***REMOVED******REMOVED******REMOVED*** 1.4 Specialty Rotations
...
***REMOVED******REMOVED******REMOVED*** 1.5 Procedure Rotations
...
***REMOVED******REMOVED******REMOVED*** 1.6 Conference/Didactics
...
***REMOVED******REMOVED******REMOVED*** 1.7 Administrative Rotations
...
***REMOVED******REMOVED*** 2. DURATION REQUIREMENTS

***REMOVED******REMOVED******REMOVED*** 2.1 Annual Schedule Structure
...
***REMOVED******REMOVED******REMOVED*** 2.2 PGY-Level-Specific Duration Requirements

***REMOVED******REMOVED******REMOVED******REMOVED*** PGY-1 Residents
...
***REMOVED******REMOVED******REMOVED******REMOVED*** PGY-2 Residents
...
***REMOVED******REMOVED******REMOVED******REMOVED*** PGY-3 (Chief) Residents
...
***REMOVED******REMOVED******REMOVED*** 2.3 Mandatory Rotation Minimums
...
***REMOVED******REMOVED******REMOVED*** 2.4 Block Duration Assumptions
...
***REMOVED******REMOVED*** 3. SEQUENCE CONSTRAINTS

***REMOVED******REMOVED******REMOVED*** 3.1 Rotation Sequencing Rules

***REMOVED******REMOVED******REMOVED******REMOVED*** FMIT Placement Constraints
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Clinic Sequencing
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Conference/Academic Protection
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Night Float Special Sequencing
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Specialty Rotation Sequencing
...
***REMOVED******REMOVED******REMOVED*** 3.2 Forbidden Patterns
...
***REMOVED******REMOVED******REMOVED*** 3.3 Preferred Sequences (Soft Constraints)
...
***REMOVED******REMOVED*** 4. COMPETENCY MAPPING

***REMOVED******REMOVED******REMOVED*** 4.1 Rotation → Competency Framework
...
***REMOVED******REMOVED******REMOVED*** 4.2 Rotation-Specific Competency Development

***REMOVED******REMOVED******REMOVED******REMOVED*** **FMIT (Inpatient)**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **PGY-1 Clinic**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **PGY-2 Clinic**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **PGY-3 Clinic (Chief Role)**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Specialty Rotations (e.g., Neurology, Dermatology)**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Procedures**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Night Float**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Conference/Didactics**
Develops: **MK, PBLI**
...
***REMOVED******REMOVED******REMOVED*** 4.3 Cross-Rotation Competency Matrices
...
***REMOVED******REMOVED******REMOVED*** 4.4 Competency Verification Requirements
...
***REMOVED******REMOVED*** 5. ROTATION CONFIGURATION IN DATABASE

***REMOVED******REMOVED******REMOVED*** 5.1 RotationTemplate Model Structure

```python
class RotationTemplate(Base):
    ***REMOVED*** Identity
    id: GUID
    name: str                           ***REMOVED*** "FMIT", "PGY-1 Clinic", etc.
    activity_type: str                  ***REMOVED*** "inpatient", "outpatient", "procedure", "conference"
    abbreviation: str                   ***REMOVED*** Short code for Excel export

    ***REMOVED*** Display
    font_color: str                     ***REMOVED*** Tailwind color class
    background_color: str               ***REMOVED*** Tailwind color class

    ***REMOVED*** Leave Policy
    leave_eligible: bool                ***REMOVED*** Can scheduled leave occur on this rotation?

    ***REMOVED*** Clinic Configuration
    clinic_location: str                ***REMOVED*** "Main Clinic", "Procedure Clinic"
    max_residents: int                  ***REMOVED*** Capacity constraint (None = unlimited)

    ***REMOVED*** Specialty Requirements
    requires_specialty: str             ***REMOVED*** "Sports Medicine", null if not required
    requires_procedure_credential: bool ***REMOVED*** Whether credential required

    ***REMOVED*** ACGME Supervision
    supervision_required: bool          ***REMOVED*** Almost always True
    max_supervision_ratio: int          ***REMOVED*** 1:2 (PGY-1) or 1:4 (PGY-2/3), 1:2 for procedures
...
***REMOVED******REMOVED******REMOVED*** 5.2 RotationHalfDayRequirement Model
...
class RotationHalfDayRequirement(Base):
    ...
    ***REMOVED*** Half-day composition per 10-halfday block
    fm_clinic_halfdays: int            ***REMOVED*** Default 4
    specialty_halfdays: int            ***REMOVED*** Default 5 (specialty name in field below)
    specialty_name: str                ***REMOVED*** "Neurology", "Dermatology", etc.
    academics_halfdays: int            ***REMOVED*** Default 1 (Wed AM protected)
    elective_halfdays: int             ***REMOVED*** Flexible buffer time

    ***REMOVED*** Soft constraints
    min_consecutive_specialty: int     ***REMOVED*** Batch specialty days? (default 1)
    prefer_combined_clinic_days: bool  ***REMOVED*** Group FM + specialty same day? (default True)

    ***REMOVED*** Validation
    @property
    def total_halfdays: int            ***REMOVED*** Must equal 10 (or ~14 for extended)

    @property
    def is_balanced: bool              ***REMOVED*** True if total == 10
```
...
***REMOVED******REMOVED******REMOVED*** 5.3 WeeklyPattern Model

**Purpose:** Visual editor for 7×2 grid of activities per rotation type

```python
class WeeklyPattern(Base):
    ***REMOVED*** Position in grid
    rotation_template_id: GUID
    day_of_week: int                  ***REMOVED*** 0=Sunday, 1=Monday, ..., 6=Saturday
    time_of_day: str                  ***REMOVED*** "AM" or "PM"

    ***REMOVED*** Activity
    activity_type: str                ***REMOVED*** "fm_clinic", "specialty", "elective",
                                      ***REMOVED*** "conference", "inpatient", "call", "procedure", "off"

    ***REMOVED*** Special Features
    linked_template_id: GUID          ***REMOVED*** Link to sub-rotation template (optional)
    is_protected: bool                ***REMOVED*** Cannot be changed by users (e.g., Wed AM conference)
    notes: str                        ***REMOVED*** Admin notes
```
...
***REMOVED******REMOVED******REMOVED*** 5.4 RotationPreference Model
...
class RotationPreference(Base):
    rotation_template_id: GUID
    preference_type: str              ***REMOVED*** "full_day_grouping", "consecutive_specialty",
                                      ***REMOVED*** "avoid_isolated", "preferred_days",
                                      ***REMOVED*** "avoid_friday_pm", "balance_weekly"
    weight: str                       ***REMOVED*** "low", "medium", "high", "required"
    config_json: dict                 ***REMOVED*** Type-specific parameters
    is_active: bool
```
...
```python
{
    ...
    "weight": "medium",
    "config_json": {}
    ***REMOVED*** Prefer AM+PM of same activity (full FM day, full elective day)
}

{
    ...
    ***REMOVED*** Group specialty sessions 2+ days together
}

{
    ...
    "weight": "low",
    "config_json": {}
    ***REMOVED*** Keep Friday PM open for travel/transition
}
```

---

***REMOVED******REMOVED*** 6. ROTATION GAMING & EDGE CASES

***REMOVED******REMOVED******REMOVED*** 6.1 Known Gaming Risks

***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 1: Under-Supervision Violations**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 2: Leave-Ineligible Rotation Leave**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 3: Specialty Faculty Assignment Mismatch**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 4: Capacity Overflow**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 5: Procedure Credential Mismatch**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 6: Conference Attendance Enforcement**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 7: FMIT Duration Abuse**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Risk 8: PGY-1 Clinic Sequence Abuse**
...
***REMOVED******REMOVED******REMOVED*** 6.2 Under-Structured Rotation Issues
...
sports_medicine template:
  halfday_requirements:
    fm_clinic_halfdays: 2       ***REMOVED*** Primary care continuity
    specialty_halfdays: 6       ***REMOVED*** Deep SM exposure
    academics_halfdays: 1       ***REMOVED*** Protected (Wed AM)
    elective_halfdays: 1        ***REMOVED*** Buffer
...
***REMOVED******REMOVED******REMOVED*** 6.3 Over-Structured Rotation Issues
...
***REMOVED******REMOVED*** 7. ALL ROTATIONS TRACKED?

***REMOVED******REMOVED******REMOVED*** 7.1 Rotation Inventory Checklist
...
***REMOVED******REMOVED******REMOVED*** 7.2 Coverage Verification
...
***REMOVED******REMOVED*** 8. MISSING ROTATION COVERAGE RISKS

***REMOVED******REMOVED******REMOVED*** 8.1 Critical Coverage Gaps
...
***REMOVED******REMOVED******REMOVED*** 8.2 Aggregate Coverage Dashboard
...
***REMOVED******REMOVED*** 9. ROTATION EVOLUTION & VARIANTS

***REMOVED******REMOVED******REMOVED*** 9.1 Historical Variants Identified in Codebase
...
***REMOVED******REMOVED******REMOVED*** 9.2 Potential Future Variants
...
***REMOVED******REMOVED*** 10. ROTATION OVERSIGHT FUNCTIONS

***REMOVED******REMOVED******REMOVED*** 10.1 Program Director Review Checklist
...
***REMOVED******REMOVED******REMOVED*** 10.2 Annual Rotation Audit
...
***REMOVED******REMOVED*** 11. REFERENCES

***REMOVED******REMOVED******REMOVED*** Models & Schemas
...
***REMOVED******REMOVED******REMOVED*** Validation & Constraints
...
***REMOVED******REMOVED******REMOVED*** Testing & Fixtures
...
***REMOVED******REMOVED*** 12. DELIVERABLE SUMMARY
