***REMOVED*** ACGME Compliance Capability Matrix
...
***REMOVED******REMOVED*** VI.A. Work Hours Requirements

***REMOVED******REMOVED******REMOVED*** VI.A.1 - Eighty-Hour Rule
...
***REMOVED******REMOVED******REMOVED*** VI.A.1.a - One-in-Seven Rule
...
***REMOVED******REMOVED******REMOVED*** VI.A.1.b - 24+4 Rule
...
***REMOVED******REMOVED*** VI.B. Supervision & Oversight

***REMOVED******REMOVED******REMOVED*** VI.B.1 - General Supervision Requirements
...
***REMOVED******REMOVED******REMOVED*** VI.B.1.a - Direct Supervision (PGY-1)
...
**Code References:**
```
***REMOVED*** In supervisor ratio calculation:
...
***REMOVED******REMOVED*** VI.C. Fatigue Mitigation & Sleep

***REMOVED******REMOVED******REMOVED*** VI.C.1 - Sleep Adequacy & Fatigue Risk
...
***REMOVED******REMOVED*** VII. Resident Evaluation & Remediation

***REMOVED******REMOVED******REMOVED*** VII.A - Competency Evaluation
...
***REMOVED******REMOVED******REMOVED*** VII.B - Remediation Plans
...
***REMOVED******REMOVED*** Rotations & Educational Experience

***REMOVED******REMOVED******REMOVED*** VI.D.3 - Rotation Coverage
...
***REMOVED******REMOVED*** Fairness & Equity

***REMOVED******REMOVED******REMOVED*** Workload Distribution Fairness
...
***REMOVED******REMOVED*** Institutional & Financial

***REMOVED******REMOVED******REMOVED*** VIII.A - Educational Budgets & Resources
...
***REMOVED******REMOVED*** Summary Coverage Matrix
...
***REMOVED******REMOVED******REMOVED*** High Priority (Impact on Accreditation)
...
***REMOVED******REMOVED******REMOVED*** Medium Priority (Enhances Compliance)
...
***REMOVED******REMOVED*** Recommended Site Visit Narrative
...
***REMOVED******REMOVED*** Implementation Checklist for Full Compliance
