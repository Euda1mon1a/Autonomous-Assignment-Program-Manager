***REMOVED*** ACGME Call Scheduling Requirements - Comprehensive Guide
...
1. [In-House Call Frequency Limits](***REMOVED***in-house-call-frequency-limits)
2. [Rest Period Requirements](***REMOVED***rest-period-requirements)
3. [Call Structure in System](***REMOVED***call-structure-in-system)
4. [Night Float Implementation](***REMOVED***night-float-implementation)
5. [Post-Call Recovery Rules](***REMOVED***post-call-recovery-rules)
6. [Call Equity Constraints](***REMOVED***call-equity-constraints)
7. [Call Eligibility Rules](***REMOVED***call-eligibility-rules)
8. [Integrated System Constraints](***REMOVED***integrated-system-constraints)

---

***REMOVED******REMOVED*** In-House Call Frequency Limits

***REMOVED******REMOVED******REMOVED*** ACGME "Every Third Night" Rule
...
***REMOVED******REMOVED******REMOVED*** Call Type Coverage in System
...
***REMOVED******REMOVED*** Rest Period Requirements

***REMOVED******REMOVED******REMOVED*** Post-Call Mandatory Rest
...
***REMOVED******REMOVED******REMOVED*** Extended Shift Rules
...
***REMOVED******REMOVED******REMOVED*** PGY-1 Specific Restrictions
...
***REMOVED******REMOVED*** Call Structure in System

***REMOVED******REMOVED******REMOVED*** Call Assignment Model

The system tracks call assignments separately from regular clinical assignments:

```python
class CallAssignment:
    date: Date                           ***REMOVED*** Date of call
    person_id: UUID                      ***REMOVED*** Faculty member
    call_type: str                       ***REMOVED*** 'overnight', 'weekend', 'backup'
    is_weekend: bool                     ***REMOVED*** Weekend indicator
    is_holiday: bool                     ***REMOVED*** Holiday indicator
```

***REMOVED******REMOVED******REMOVED*** Call Types Tracked
...
***REMOVED******REMOVED*** Night Float Implementation

***REMOVED******REMOVED******REMOVED*** Night Float Definition and Usage
...
***REMOVED******REMOVED******REMOVED*** Night Float Rest Requirements
...
```python
***REMOVED*** Night Float to Post-Call transition
...
***REMOVED******REMOVED******REMOVED*** Night Float Validation
...
***REMOVED******REMOVED*** Post-Call Recovery Rules

***REMOVED******REMOVED******REMOVED*** Automatic Post-Call Activity Assignment
...
***REMOVED******REMOVED******REMOVED*** FMIT Weekend Call Post-Call Treatment
...
***REMOVED******REMOVED******REMOVED*** Friday Post-FMIT Blocking
...
***REMOVED******REMOVED*** Call Equity Constraints

***REMOVED******REMOVED******REMOVED*** Sunday Call Equity (Soft Constraint)
...
***REMOVED******REMOVED******REMOVED*** Weekday Call Equity (Mon-Thurs)
...
***REMOVED******REMOVED******REMOVED*** Call Spacing Constraint
...
***REMOVED******REMOVED******REMOVED*** Call Preferences (Soft)
...
***REMOVED******REMOVED*** Call Eligibility Rules

***REMOVED******REMOVED******REMOVED*** Faculty Eligible for Auto-Generated Overnight Call (Sun-Thurs)
...
***REMOVED******REMOVED******REMOVED*** ADJUNCT Faculty Call Assignment
...
***REMOVED******REMOVED******REMOVED*** FMIT Faculty Call Assignment
...
***REMOVED******REMOVED*** Integrated System Constraints

***REMOVED******REMOVED******REMOVED*** Constraint Priority Hierarchy
...
***REMOVED******REMOVED******REMOVED*** Solver Constraint Integration
...
For each night (Sun-Thurs):
  sum(call_vars for eligible faculty) == 1  ***REMOVED*** Exactly one per night
```
...
***REMOVED******REMOVED******REMOVED*** Known Implementation Constraints
...
***REMOVED******REMOVED*** Key ACGME Callout
...
***REMOVED******REMOVED******REMOVED*** Recommended System Enhancements
...
***REMOVED******REMOVED*** Summary Reference
