***REMOVED*** Files Analyzed in Frontend Performance Audit
...
***REMOVED******REMOVED******REMOVED*** Build & Development
...
***REMOVED******REMOVED*** Root Layout & Providers
...
***REMOVED******REMOVED*** Major Page Components

***REMOVED******REMOVED******REMOVED*** Schedule Page
...
***REMOVED******REMOVED******REMOVED*** Admin Pages
...
***REMOVED******REMOVED******REMOVED*** Dashboard Pages
...
***REMOVED******REMOVED******REMOVED*** Other Pages
...
***REMOVED******REMOVED*** Large Component Files (650+ lines)
...
***REMOVED******REMOVED*** Medium Component Files (400-500 lines)
...
***REMOVED******REMOVED*** Schedule View Components
...
***REMOVED******REMOVED*** Dashboard Components
...
***REMOVED******REMOVED*** Charting Components (14 files using Recharts)
...
***REMOVED******REMOVED*** Heatmap Feature Components
...
***REMOVED******REMOVED*** Other Feature Modules
...
***REMOVED******REMOVED*** Library & API Files
...
***REMOVED******REMOVED******REMOVED*** Hooks Directory (New Location)
- `src/hooks/useSchedule.ts`
- `src/hooks/usePeople.ts`
- `src/hooks/useAbsences.ts`
- `src/hooks/useResilience.ts`

***REMOVED******REMOVED*** UI & Form Components
...
***REMOVED******REMOVED*** Common Components
...
***REMOVED******REMOVED*** Skeleton Loaders
...
***REMOVED******REMOVED*** Data Display Components
...
***REMOVED******REMOVED*** Utility & Specialized Components
...
***REMOVED******REMOVED*** Modal Components
