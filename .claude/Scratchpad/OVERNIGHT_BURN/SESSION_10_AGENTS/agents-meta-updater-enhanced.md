***REMOVED*** META_UPDATER Agent Specification - Enhanced
...
***REMOVED******REMOVED*** PERCEPTION: Current State Analysis
...
***REMOVED******REMOVED*** Section 1: Documentation Architecture

***REMOVED******REMOVED******REMOVED*** 1.1 The .claude/ Directory Taxonomy

The `.claude/` infrastructure has evolved into a specialized knowledge base with clear semantic zones:

```
.claude/
├── Agents/                    ***REMOVED*** Agent role specifications (46 files)
│   ├── G-STAFF/             ***REMOVED*** Core leadership team
│   ├── COORDINATORS/        ***REMOVED*** Specialized domains
│   ├── WORKERS/             ***REMOVED*** Task execution
│   └── SUPPORT/             ***REMOVED*** Cross-cutting concerns
├── skills/                    ***REMOVED*** 50+ specialized capabilities
│   ├── CORE/                ***REMOVED*** Core protocols & patterns
│   ├── PROJECT_DOMAIN/      ***REMOVED*** Scheduling, compliance, resilience
│   ├── ENGINEERING/         ***REMOVED*** Code quality, testing, infrastructure
│   └── MANAGED/             ***REMOVED*** Delivered by external systems (MCP)
├── protocols/               ***REMOVED*** Real-time coordination (NEW - Session 025)
│   ├── RESULT_STREAMING.md
│   ├── SIGNAL_PROPAGATION.md
│   └── MULTI_TERMINAL_HANDOFF.md
├── commands/                ***REMOVED*** Quick-invoke entry points (NEW - Session 025)
│   ├── parallel-explore.md
│   ├── parallel-implement.md
│   ├── parallel-test.md
│   └── handoff-session.md
├── docs/                    ***REMOVED*** Framework & schema extensions
│   ├── PARALLELISM_FRAMEWORK.md
│   ├── TODO_PARALLEL_SCHEMA.md
│   └── [domain docs]
└── Scratchpad/              ***REMOVED*** Session documentation & analysis
    ├── SESSION_*/           ***REMOVED*** Session-specific findings
    ├── histories/           ***REMOVED*** Narrative documentation
    └── OVERNIGHT_BURN/      ***REMOVED*** Deep dives on subsystems
```
...
***REMOVED******REMOVED******REMOVED*** 1.2 Documentation Lifecycle Stages
...
***REMOVED******REMOVED******REMOVED*** 1.3 Documentation by Artifact Type

***REMOVED******REMOVED******REMOVED******REMOVED*** Agent Specifications (46 files, 30-60KB each)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Skill Specifications (50+ files, 5-30KB each)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Protocol Specifications (3 files, ~200KB total)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Session Documentation (Scratchpad)
...
***REMOVED******REMOVED*** Section 2: Knowledge Management Strategies

***REMOVED******REMOVED******REMOVED*** 2.1 The Triple-Store Pattern
...
***REMOVED******REMOVED******REMOVED*** 2.2 Maintaining 50+ Skills Without Chaos
...
***REMOVED******REMOVED******REMOVED*** 2.3 Cross-Referencing Best Practices
...
```markdown
***REMOVED*** SIGNAL_PROPAGATION Protocol

***REMOVED******REMOVED******REMOVED*** Integration with ORCHESTRATOR
...
```markdown
***REMOVED*** SESSION_025_HANDOFF_SUMMARY.md

***REMOVED******REMOVED*** Key Concepts for Future Sessions
...
```bash
***REMOVED*** Find all markdown references
grep -r "\[.*\]\(.*\.md\)" .claude/ docs/

***REMOVED*** Check if referenced files exist
***REMOVED*** (Build a verification report)
```

***REMOVED******REMOVED******REMOVED*** 2.4 Deprecation & Sunsetting
...
***REMOVED******REMOVED*** Section 3: Maintenance Strategies - Proactive vs. Reactive

***REMOVED******REMOVED******REMOVED*** 3.1 Proactive Maintenance (Quarterly Audits)
...
```markdown
***REMOVED******REMOVED*** Q1 2026 Documentation Audit

***REMOVED******REMOVED******REMOVED*** Link Verification (Automated)
...
***REMOVED******REMOVED******REMOVED*** Staleness Detection
...
***REMOVED******REMOVED******REMOVED*** Skill Verification
...
***REMOVED******REMOVED******REMOVED*** Framework Consistency
...
***REMOVED******REMOVED******REMOVED*** 3.3 Maintenance Metrics (Success Indicators)
...
***REMOVED******REMOVED*** Section 4: Integration Patterns - How META_UPDATER Coordinates

***REMOVED******REMOVED******REMOVED*** 4.1 Agent Collaboration Matrix
...
***REMOVED******REMOVED******REMOVED*** 4.2 Delegation Patterns for META_UPDATER

**When to Spawn META_UPDATER:**

```markdown
***REMOVED******REMOVED*** Delegate to META_UPDATER When:
...
***REMOVED******REMOVED******REMOVED*** 4.3 Avoiding Bottlenecks
...
***REMOVED******REMOVED*** Section 5: Quality Gates & Standards

***REMOVED******REMOVED******REMOVED*** 5.1 Documentation Quality Checklist
...
***REMOVED******REMOVED******REMOVED*** 5.2 Common Documentation Anti-Patterns (To Avoid)
...
***REMOVED******REMOVED******REMOVED*** 5.3 Documentation Standards

**Markdown Style:**
- Use ATX headings (***REMOVED***, ***REMOVED******REMOVED***, ***REMOVED******REMOVED******REMOVED***) not underlines
...
***REMOVED******REMOVED*** Section 6: Best Practices & Lessons Learned

***REMOVED******REMOVED******REMOVED*** 6.1 From Session 025 Documentation Patterns
...
***REMOVED******REMOVED******REMOVED*** 6.2 Recommended Extensions to Current META_UPDATER

**Extension 1: Automated Link Auditing**

Create a script that runs quarterly:
```bash
***REMOVED*** Find all .md references in .claude/
***REMOVED*** Verify the referenced files exist
***REMOVED*** Report broken links + recommendations
***REMOVED*** Could be triggered by `/lint-docs` command
```
...
***REMOVED******REMOVED*** Section 7: Recommended Enhancements to META_UPDATER Spec

***REMOVED******REMOVED******REMOVED*** 7.1 Enhanced Decision Authority
...
```
***REMOVED******REMOVED******REMOVED*** Tier 1: Autonomous Execute
...
***REMOVED******REMOVED******REMOVED*** 7.2 Enhanced Workflows
...
***REMOVED******REMOVED******REMOVED*** 7.3 Enhanced Escalation Framework
...
***REMOVED******REMOVED*** Section 8: Integration with Session Documentation

***REMOVED******REMOVED******REMOVED*** 8.1 Session-to-Permanent Documentation Pipeline
...
***REMOVED******REMOVED******REMOVED*** 8.2 Seasonal Documentation Cycles
...
***REMOVED******REMOVED*** Section 9: Recommendations for Implementation

***REMOVED******REMOVED******REMOVED*** 9.1 Short-Term (Next 2 Weeks)
...
***REMOVED******REMOVED******REMOVED*** 9.2 Medium-Term (Next Month)
...
***REMOVED******REMOVED******REMOVED*** 9.3 Long-Term (This Quarter & Beyond)
...
***REMOVED******REMOVED*** Section 10: Maintenance Calendar (Recommended)
...
***REMOVED******REMOVED*** Section 11: Reference Implementations

***REMOVED******REMOVED******REMOVED*** 11.1 Example: Quarterly Documentation Audit
...
1. **Link Verification (Week 1)**
   ```bash
   ***REMOVED*** Find all markdown files in .claude/
   ***REMOVED*** Extract all reference patterns: [text](path)
   ***REMOVED*** For each: verify file exists
   ***REMOVED*** Output: broken_links.txt with recommendations
   ```

2. **Staleness Detection (Week 1-2)**
   ```bash
   ***REMOVED*** For each .md file:
   ***REMOVED***   - Extract last commit date
   ***REMOVED***   - If > 6 months old AND not in /histories:
   ***REMOVED***     - Check if still accurate
   ***REMOVED***     - Mark for review
   ***REMOVED*** Output: stale_docs.txt with recommendations
   ```
...
***REMOVED******REMOVED******REMOVED*** 11.2 Example: Skill Integration Update
...
***REMOVED******REMOVED*** Section 12: Success Metrics & Measurement

***REMOVED******REMOVED******REMOVED*** 12.1 Documentation Quality Metrics
...
***REMOVED******REMOVED******REMOVED*** 12.2 Process Metrics
...
***REMOVED******REMOVED*** Conclusion: The Documentation Virtuous Cycle
...
***REMOVED******REMOVED******REMOVED*** Appendix A: Quick Reference - Where Things Live
...
***REMOVED******REMOVED******REMOVED*** Appendix B: Glossary of Key Terms
...
***REMOVED******REMOVED******REMOVED*** Appendix C: References to Key Documents
