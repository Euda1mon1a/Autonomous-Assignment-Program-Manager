...
|--------|----------|---------|
| Experiment Plan | `/Users/aaronmontgomery/.claude/plans/idempotent-crunching-lecun.md` | Experiment design, pool assignments, grading methodology |
| Pool B Execution Log | `/var/folders/y9/nkhp7ql17p91q90nj0pyshcm0000gn/T/claude/-Users-aaronmontgomery-Autonomous-Assignment-Program-Manager/tasks/a86853a.output` | USASOC execution details, token usage, tool invocations |
| Pool C Execution Log | `/var/folders/y9/nkhp7ql17p91q90nj0pyshcm0000gn/T/claude/-Users-aaronmontgomery-Autonomous-Assignment-Program-Manager/tasks/a1cbb88.output` | ARCHITECT+SYNTHESIZER execution details, token usage, tool invocations |
| COORD_AAR Analysis | `/var/folders/y9/nkhp7ql17p91q90nj0pyshcm0000gn/T/claude/-Users-aaronmontgomery-Autonomous-Assignment-Program-Manager/tasks/a12452b.output` | Lessons learned, sustains, improves, process recommendations |
| FORCE_MANAGER Analysis | `/var/folders/y9/nkhp7ql17p91q90nj0pyshcm0000gn/T/claude/-Users-aaronmontgomery-Autonomous-Assignment-Program-Manager/tasks/afee240.output` | Force structure assessment, spawn decision analysis, recommendations |
...
**Classification:** UNCLASSIFIED
**Archive Location:** `.claude/scratchpad/session-086-experiment-report.md`
