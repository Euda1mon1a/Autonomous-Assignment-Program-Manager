***REMOVED*** Session 039 Handoff: Mission Command Restructure
...
***REMOVED******REMOVED*** The Problem With Current Structure
...
***REMOVED******REMOVED*** Proposed: Mission Command Model
...
***REMOVED******REMOVED******REMOVED*** New Hierarchy
...
***REMOVED******REMOVED******REMOVED*** Model Tier Assignments
...
***REMOVED******REMOVED*** Plan, See, Do Operating Model

***REMOVED******REMOVED******REMOVED*** PLAN Phase
...
***REMOVED******REMOVED******REMOVED*** SEE Phase (During Execution)
...
***REMOVED******REMOVED******REMOVED*** DO Phase
...
***REMOVED******REMOVED*** Standing Orders Concept
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Update Agent Specs
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Update Delegation Patterns
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Test
...
***REMOVED******REMOVED******REMOVED*** Task Tool Chain Spawning
...
***REMOVED******REMOVED******REMOVED*** Standing Orders via Prompt
...
Task(
    model="sonnet",
    prompt="""
    ***REMOVED******REMOVED*** Agent: COORD_OPS
    ...
    ***REMOVED******REMOVED*** Current Mission
    [specific task]
    """
)
```
...
***REMOVED******REMOVED*** FIRST PRIORITY: Restore RAG Data

***REMOVED******REMOVED******REMOVED*** RAG Database is Empty - Restore from Backup
...
**Restore commands:**
```bash
***REMOVED*** Extract rag_documents data from backup
gunzip -c backups/postgres/residency_scheduler_20251229_224927.sql.gz > /tmp/full_backup.sql

***REMOVED*** Find and extract just the rag_documents COPY block
grep -n "COPY public.rag_documents" /tmp/full_backup.sql
***REMOVED*** Note the line number, then extract that section

***REMOVED*** Or restore full backup if needed (will overwrite other data):
***REMOVED*** gunzip -c backups/postgres/residency_scheduler_20251229_224927.sql.gz | \
***REMOVED***   docker exec -i residency-scheduler-db psql -U scheduler -d residency_scheduler

***REMOVED*** Verify after restore:
...
***REMOVED******REMOVED******REMOVED*** Blocked: Celery Init Task
...
***REMOVED******REMOVED******REMOVED*** Uncommitted Files
...
***REMOVED******REMOVED*** Questions to Resolve
...
***REMOVED******REMOVED*** Next Session Actions

***REMOVED******REMOVED******REMOVED*** Priority 0: Infrastructure
1. [ ] **RESTORE RAG DATA** - See "FIRST PRIORITY" section above
2. [ ] Fix `export_jobs` migration if needed (`alembic upgrade head`)

***REMOVED******REMOVED******REMOVED*** Priority 1: Mission Command Implementation
