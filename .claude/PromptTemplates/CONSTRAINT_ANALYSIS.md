***REMOVED*** CONSTRAINT_ANALYSIS - Prompt Template
...
```markdown
***REMOVED*** Constraint Analysis: {{context}}
...
***REMOVED******REMOVED******REMOVED*** Soft Constraints (Should Satisfy, Optimize)
...
***REMOVED******REMOVED******REMOVED*** Pairwise Conflict Matrix
...
***REMOVED******REMOVED******REMOVED*** Conflict Details

[FOR conflict IN detected_conflicts]
***REMOVED******REMOVED******REMOVED******REMOVED*** Conflict {{loop.index}}: {{conflict.constraint_a}} ↔ {{conflict.constraint_b}}
...
***REMOVED******REMOVED*** Feasibility Analysis
...
***REMOVED******REMOVED******REMOVED*** Resource Analysis
...
***REMOVED******REMOVED*** Trade-Off Assessment

[IF analysis_goal == "trade_off_assessment" OR analysis_goal == "optimization"]

***REMOVED******REMOVED******REMOVED*** Trade-Off Matrix

When constraints conflict, assess the cost of satisfying one vs. the other:

[FOR trade_off IN trade_offs]
***REMOVED******REMOVED******REMOVED******REMOVED*** Trade-Off {{loop.index}}: {{trade_off.constraint_a}} vs. {{trade_off.constraint_b}}
...
***REMOVED******REMOVED******REMOVED*** Pareto Frontier Analysis
...
***REMOVED******REMOVED*** Constraint Relaxation Analysis

If infeasible, analyze impact of relaxing each constraint:

***REMOVED******REMOVED******REMOVED*** Relaxation Options

[FOR constraint IN constraints WHERE constraint.type == "hard"]
***REMOVED******REMOVED******REMOVED******REMOVED*** Option {{loop.index}}: Relax "{{constraint.name}}"
...
***REMOVED******REMOVED******REMOVED*** Recommended Relaxation Strategy
...
***REMOVED******REMOVED*** Validation Against Existing Schedule

[IF existing_schedule]

***REMOVED******REMOVED******REMOVED*** Current Schedule Validation
...
[IF violations_found]
***REMOVED******REMOVED******REMOVED*** Violations Found

[FOR violation IN violations]
***REMOVED******REMOVED******REMOVED******REMOVED*** {{violation.constraint_name}} Violation
...
***REMOVED******REMOVED******REMOVED*** Summary Recommendations
...
***REMOVED******REMOVED******REMOVED*** Detailed Recommendations

***REMOVED******REMOVED******REMOVED******REMOVED*** Immediate Actions (0-7 days)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Short-term Solutions (1-4 weeks)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Long-term Strategy (1-6 months)
...
[ELSE]
***REMOVED******REMOVED******REMOVED*** Standard Recommendations

***REMOVED******REMOVED******REMOVED******REMOVED*** Critical Issues
[Must address immediately]

1. {{critical_issue_1}}: {{recommendation_1}}
2. {{critical_issue_2}}: {{recommendation_2}}

***REMOVED******REMOVED******REMOVED******REMOVED*** Process Improvements
[Would reduce future conflicts]

1. {{process_improvement_1}}
2. {{process_improvement_2}}

***REMOVED******REMOVED******REMOVED******REMOVED*** Policy Considerations
...
***REMOVED******REMOVED******REMOVED*** Key Messages
...
***REMOVED******REMOVED******REMOVED*** Decision Points
...
***REMOVED******REMOVED******REMOVED*** Example 1: Conflicting ACGME and Coverage Constraints
...
```markdown
***REMOVED*** Constraint Analysis: February 2024 scheduling with 1 resident on unexpected medical leave
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Inpatient coverage minimum
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Night Float consecutive limit
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Conflict 1: 80-hour rule ↔ Inpatient coverage minimum
...
***REMOVED******REMOVED******REMOVED*** Trade-Off 1: ACGME Compliance vs. Coverage Adequacy
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Option 1: Relax "Inpatient coverage minimum"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Option 2: Relax "80-hour rule"
...
***REMOVED******REMOVED******REMOVED*** Process Improvements
[Would reduce future conflicts]
...
***REMOVED******REMOVED******REMOVED*** Policy Considerations
[May need PD/leadership decision]
...
***REMOVED******REMOVED******REMOVED*** Example 2: Preference vs. Equity Conflict (Brief Output)
...
```markdown
***REMOVED*** Constraint Analysis: January 2024 schedule generation
...
***REMOVED******REMOVED******REMOVED*** Trade-Off 1: Equity in weekend distribution vs. Resident preference (PGY2-01 avoid weekends)
...
***REMOVED******REMOVED******REMOVED*** Mathematical Modeling
...
***REMOVED******REMOVED******REMOVED*** Common Conflict Patterns
