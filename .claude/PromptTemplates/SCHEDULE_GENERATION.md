***REMOVED*** SCHEDULE_GENERATION - Prompt Template
...
```markdown
***REMOVED*** Schedule Generation: {{date_range}}
...
***REMOVED******REMOVED*** Schedule Parameters

***REMOVED******REMOVED******REMOVED*** Temporal Scope
...
***REMOVED******REMOVED******REMOVED*** Personnel
**Residents:**
...
***REMOVED******REMOVED******REMOVED*** Rotations Available
...
***REMOVED******REMOVED******REMOVED*** Hard Constraints (MUST satisfy)

***REMOVED******REMOVED******REMOVED******REMOVED*** ACGME Requirements (Non-Negotiable)
1. **80-Hour Rule**
...
[IF constraints]
***REMOVED******REMOVED******REMOVED******REMOVED*** Additional Institutional Constraints
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pre-Determined Assignments (Fixed)
...
***REMOVED******REMOVED******REMOVED*** Soft Constraints (SHOULD satisfy, optimize if possible)

***REMOVED******REMOVED******REMOVED******REMOVED*** Coverage Requirements
...
[IF preferences]
***REMOVED******REMOVED******REMOVED******REMOVED*** Resident Preferences
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Equity Goals
...
***REMOVED******REMOVED*** Optimization Strategy

***REMOVED******REMOVED******REMOVED*** Primary Objectives (in order)
[FOR goal IN optimization_goals]
{{loop.index}}. **{{goal}}**: [Explain what this means]
[ENDFOR]

***REMOVED******REMOVED******REMOVED*** Conflict Resolution Hierarchy
...
***REMOVED******REMOVED*** Schedule Generation Execution

***REMOVED******REMOVED******REMOVED*** Phase 1: Initialization
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Constraint Modeling
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Solver Execution
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Validation
...
***REMOVED******REMOVED******REMOVED*** Phase 5: Rationale Generation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Assignments by Week
[FOR week IN weeks]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Compliance Metrics
...
***REMOVED******REMOVED******REMOVED*** Schedule Generation Report
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Input Summary
[Complete list of all inputs including residents, constraints, preferences]

***REMOVED******REMOVED******REMOVED******REMOVED*** Solver Log
[Detailed log of solver decisions, backtracks, optimizations]

***REMOVED******REMOVED******REMOVED******REMOVED*** Full Assignment Table
| Date | Block | Resident | Rotation | Hours | Cumulative Hours (4wk) | Notes |
|------|-------|----------|----------|-------|------------------------|-------|
| [Each row] | | | | | | |

***REMOVED******REMOVED******REMOVED******REMOVED*** Constraint Verification
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Equity Analysis
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Decision Rationale
...
***REMOVED******REMOVED******REMOVED*** Schedule: {{date_range}}
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Week-by-Week Schedule

[FOR week IN date_range|split_by_week]
***REMOVED******REMOVED******REMOVED*** Week {{loop.index}}: {{week.start_date}} to {{week.end_date}}
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Compliance Verification

***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** Duty Hours (80-Hour Rule)
[FOR resident IN residents]
**{{resident.id}}:**
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** Rest Days (1-in-7 Rule)
[FOR resident IN residents]
**{{resident.id}}:** {{rest_days_count}} days off in 28-day period ✅ (minimum 4 required)
[ENDFOR]

***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** Supervision Ratios
[FOR rotation IN rotations]
**{{rotation}}:**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Workload Equity
...
[IF include_rationale]
***REMOVED******REMOVED******REMOVED******REMOVED*** Assignment Rationale
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Warnings and Notes
...
***REMOVED******REMOVED******REMOVED*** Example 1: Simple Monthly Schedule (Standard Detail)
...
***REMOVED******REMOVED******REMOVED*** Example 2: Emergency Coverage Rescheduling (Urgent, Preview Mode)

**Instantiation:**
```
date_range: "2024-01-20 to 2024-01-31"
residents: ["PGY1-01", "PGY2-01", "PGY2-02", "PGY3-01"]  ***REMOVED*** One resident removed due to illness
...
preferences: []  ***REMOVED*** Ignored in emergency mode
fixed_assignments: []
coverage_requirements: {
  inpatient: {weekday: 2, weekend: 1},  ***REMOVED*** Reduced from normal 3/2 due to shortage
  night_float: {overnight: 1}
}
optimization_goals: ["compliance", "coverage_minimums"]  ***REMOVED*** Dropped equity due to emergency
validation_mode: "warn"  ***REMOVED*** Allow some flexibility
output_format: "summary"
include_rationale: false  ***REMOVED*** Speed up generation
```

**Output:**
```markdown
***REMOVED*** Schedule Generation: 2024-01-20 to 2024-01-31
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Coverage Summary
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Warnings
...
***REMOVED******REMOVED******REMOVED*** Solver Strategy
...
***REMOVED******REMOVED******REMOVED*** Handling Infeasibility
