***REMOVED*** SWAP_REQUEST - Prompt Template
...
```markdown
***REMOVED*** Swap Request Processing
...
***REMOVED******REMOVED*** Request Details
...
***REMOVED******REMOVED*** Swap Type Definition
...
***REMOVED******REMOVED******REMOVED*** Find Coverage
...
[ELIF swap_type == "pool"]
***REMOVED******REMOVED******REMOVED*** Pool Swap (Float Pool Coverage)
...
***REMOVED******REMOVED*** Current Schedule Context

***REMOVED******REMOVED******REMOVED*** Requester Current State
...
[IF swap_partner]
***REMOVED******REMOVED******REMOVED*** Swap Partner Current State
...
***REMOVED******REMOVED******REMOVED*** Strict Validation (All must pass)
[ELIF safety_level == "relaxed"]
***REMOVED******REMOVED******REMOVED*** Relaxed Validation (Warnings allowed)
[ELSE]
***REMOVED******REMOVED******REMOVED*** Standard Validation
[ENDIF]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Operational Checks
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Policy Checks
...
***REMOVED******REMOVED*** Safety Check Summary
...
***REMOVED******REMOVED******REMOVED*** Workload Impact
...
***REMOVED******REMOVED******REMOVED*** Coverage Impact
...
***REMOVED******REMOVED******REMOVED*** Equity Impact
...
***REMOVED******REMOVED******REMOVED*** ✅ APPROVED
...
***REMOVED******REMOVED******REMOVED*** ❌ DENIED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Option 1: Auto-Match Alternative Partners
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Option 2: Modify Request
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Option 3: Request Exception
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Option 4: Use Leave/Time Off
...
***REMOVED******REMOVED******REMOVED*** Example 1: Simple One-to-One Swap (Approved)
...
***REMOVED******REMOVED******REMOVED*** Example 2: Emergency Swap with Auto-Match (Initially Denied, Then Alternative)
...
***REMOVED******REMOVED******REMOVED*** Auto-Match Algorithm
...
***REMOVED******REMOVED******REMOVED*** Common Denial Reasons
