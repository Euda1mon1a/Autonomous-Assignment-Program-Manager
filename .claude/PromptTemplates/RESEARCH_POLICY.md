***REMOVED*** RESEARCH_POLICY - Prompt Template
...
***REMOVED*** Policy Research: {{policy_name}}

***REMOVED******REMOVED*** Research Objective
...
***REMOVED******REMOVED*** Search Strategy

***REMOVED******REMOVED******REMOVED*** Phase 1: Primary Sources
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Contextual Sources
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Cross-Reference
...
***REMOVED******REMOVED*** Temporal Scope
...
***REMOVED******REMOVED*** Research Execution

***REMOVED******REMOVED******REMOVED*** Step 1: Document Retrieval
...
***REMOVED******REMOVED******REMOVED*** Step 2: Extract Key Requirements
...
***REMOVED******REMOVED******REMOVED*** Step 3: Identify Scheduling Implications
...
***REMOVED******REMOVED******REMOVED*** Step 4: Flag Ambiguities
Note any:
- Unclear language
...
***REMOVED******REMOVED******REMOVED*** Summary (2-3 sentences)
[Concise overview of findings]

***REMOVED******REMOVED******REMOVED*** Key Findings (bullet points)
- [Most important finding]
- [Second most important finding]
- [Third most important finding]

***REMOVED******REMOVED******REMOVED*** Immediate Action Needed
...
***REMOVED******REMOVED******REMOVED*** Detailed Findings

***REMOVED******REMOVED******REMOVED******REMOVED*** Policy Requirements
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Historical Context
[Changes over time, if relevant]

***REMOVED******REMOVED******REMOVED******REMOVED*** Institutional Interpretation
[Local policies or clarifications]

***REMOVED******REMOVED******REMOVED******REMOVED*** Cross-Policy Interactions
[Related policies that may conflict or complement]

***REMOVED******REMOVED******REMOVED*** Implications for Scheduling

***REMOVED******REMOVED******REMOVED******REMOVED*** Structural Changes Needed
- [Change 1]
- [Change 2]

***REMOVED******REMOVED******REMOVED******REMOVED*** New Validation Rules
- [Rule 1]
- [Rule 2]

***REMOVED******REMOVED******REMOVED******REMOVED*** Assignment Constraints
- [Constraint 1]
- [Constraint 2]
...
***REMOVED******REMOVED******REMOVED*** Ambiguities and Open Questions
1. [Question 1]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Short-term Actions (1-4 weeks)
- [ ] [Action 1]
- [ ] [Action 2]

***REMOVED******REMOVED******REMOVED******REMOVED*** Long-term Considerations
- [ ] [Action 1]
- [ ] [Action 2]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Must-Do (Required for Compliance)
- [ ] [Action 1]
- [ ] [Action 2]

***REMOVED******REMOVED******REMOVED******REMOVED*** Should-Do (Best Practices)
- [ ] [Action 1]
- [ ] [Action 2]

***REMOVED******REMOVED******REMOVED******REMOVED*** Consider (Optional Improvements)
- [ ] [Action 1]
- [ ] [Action 2]
...
***REMOVED******REMOVED******REMOVED*** Standard Process
...
***REMOVED******REMOVED******REMOVED*** Example 1: ACGME Duty Hour Research (Standard Detail)
...
```markdown
***REMOVED*** Policy Research: ACGME 2023 Common Program Requirements Section VI
...
***REMOVED******REMOVED******REMOVED*** Example 2: Night Float Policy (Urgent, Comprehensive)
...
***REMOVED*** Policy Research: Institutional Night Float Guidelines
...
***REMOVED******REMOVED******REMOVED******REMOVED*** New Validation Rules
```python
***REMOVED*** Constraint: No more than 6 consecutive night shifts
def validate_consecutive_nights(resident, schedule):
    ...
    for shift in schedule:
        if shift.type == "night" and shift.start_time >= 19:00:
            ...
            consecutive = 0  ***REMOVED*** Reset on non-night shift
    return Valid
```
...
***REMOVED******REMOVED******REMOVED*** Adaptation Guidelines
