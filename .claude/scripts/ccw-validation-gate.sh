***REMOVED***!/bin/bash
***REMOVED*** CCW Validation Gate - Run after every ~20 CCW tasks
***REMOVED*** Usage: ./.claude/scripts/ccw-validation-gate.sh
...
***REMOVED*** Gate 3: Token Corruption Check
