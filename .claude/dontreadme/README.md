***REMOVED*** .claude/dontreadme/ - LLM-Focused Documentation
...
***REMOVED******REMOVED******REMOVED*** `/reconnaissance/`
...
***REMOVED******REMOVED*** Usage for AI Agents
...
***REMOVED******REMOVED*** Cross-Reference
