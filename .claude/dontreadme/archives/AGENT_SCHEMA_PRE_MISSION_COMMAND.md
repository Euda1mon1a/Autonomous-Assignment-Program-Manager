***REMOVED*** Agent Schema Archive - Pre-Mission Command Restructure
...
***REMOVED******REMOVED*** Current Model Tier Distribution
...
***REMOVED******REMOVED*** Current Hierarchy (from HIERARCHY.md)
...
***REMOVED******REMOVED*** Routing Table (Current)
...
***REMOVED******REMOVED*** Known Issues With Current Schema
