***REMOVED*** Architectural Decision Record (ADR)
...
***REMOVED******REMOVED*** Formal ADR Files
...
***REMOVED******REMOVED*** Active Decisions

***REMOVED******REMOVED******REMOVED*** ADR-001: FastAPI + SQLAlchemy 2.0 (Async)
...
***REMOVED******REMOVED******REMOVED*** ADR-002: Constraint Programming (OR-Tools) for Scheduling
...
***REMOVED******REMOVED******REMOVED*** ADR-003: MCP Server for AI Integration
...
***REMOVED******REMOVED******REMOVED*** ADR-004: Resilience Framework - Cross-Disciplinary Approach
...
***REMOVED******REMOVED******REMOVED*** ADR-005: Next.js 14 App Router (Frontend)
...
***REMOVED******REMOVED******REMOVED*** ADR-006: Swap System with Auto-Matching
...
***REMOVED******REMOVED******REMOVED*** ADR-007: Monorepo with Docker Compose
...
***REMOVED******REMOVED******REMOVED*** ADR-008: Slot-Type Invariants for Credentials
...
***REMOVED******REMOVED******REMOVED*** ADR-009: Time Crystal Scheduling (Anti-Churn)
...
***REMOVED******REMOVED******REMOVED*** ADR-010: Pytest + Jest Testing Strategy
...
***REMOVED******REMOVED******REMOVED*** ADR-011: CI_LIAISON Owns Local Container Management
...
***REMOVED******REMOVED*** Rejected Decisions

***REMOVED******REMOVED******REMOVED*** REJ-001: GraphQL Instead of REST
...
***REMOVED******REMOVED******REMOVED*** REJ-002: Celery for Schedule Generation
...
***REMOVED******REMOVED*** Decision Review Process
