***REMOVED*** Cross-Disciplinary Resilience Concepts - Quick Reference
...
***REMOVED******REMOVED*** Concept Hierarchy
...
***REMOVED******REMOVED*** Tier 1: Core Concepts (Foundational)

***REMOVED******REMOVED******REMOVED*** 80% Utilization Threshold (Queuing Theory)
...
***REMOVED******REMOVED******REMOVED*** N-1/N-2 Contingency (Power Grid)
...
***REMOVED******REMOVED******REMOVED*** Defense in Depth (5 Safety Levels)
...
***REMOVED******REMOVED*** Tier 3: Analytics (Advanced Monitoring)

***REMOVED******REMOVED******REMOVED*** SPC - Statistical Process Control (Manufacturing)
...
***REMOVED******REMOVED******REMOVED*** Burnout Epidemiology (SIR Model)
...
***REMOVED******REMOVED******REMOVED*** Erlang C Coverage (Telecommunications)
...
***REMOVED******REMOVED******REMOVED*** Burnout Fire Index (Forestry)
...
***REMOVED******REMOVED******REMOVED*** STA/LTA Seismic Detection (Geophysics)
...
***REMOVED******REMOVED*** Tier 5: Exotic Frontier (Research-Grade)

***REMOVED******REMOVED******REMOVED*** Metastability Detection (Statistical Mechanics)
...
***REMOVED******REMOVED******REMOVED*** Spin Glass Model (Condensed Matter Physics)
...
***REMOVED******REMOVED******REMOVED*** Circadian PRC (Chronobiology)
...
***REMOVED******REMOVED******REMOVED*** Penrose Process (Astrophysics)
...
| **Burnout Rt** | Epidemiology | Reproduction ***REMOVED*** | > 1.0 | `mcp__resilience_calculate_burnout_rt` |
...
```python
***REMOVED*** Example: Check defense level
result = await mcp_client.call_tool(
    "mcp__resilience_get_defense_level",
    {"schedule_id": "block_10"}
)

***REMOVED*** Example: Calculate burnout Rt
...
***REMOVED******REMOVED*** Human-Readable Summaries
