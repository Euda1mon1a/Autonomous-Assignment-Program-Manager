***REMOVED*** ACGME Rule Test Coverage Analysis
...
***REMOVED******REMOVED*** Rule → Test Matrix

***REMOVED******REMOVED******REMOVED*** Rule 1: 80-Hour Weekly Limit (CRITICAL)
...
MAX_WEEKLY_HOURS = 80
ROLLING_WEEKS = 4
ROLLING_DAYS = 28  ***REMOVED*** STRICT
HOURS_PER_BLOCK = 6
```
...
***REMOVED******REMOVED******REMOVED*** Rule 2: 1-in-7 Day Off Rule (CRITICAL)
...
**Constants:**
```python
MAX_CONSECUTIVE_DAYS = 6  ***REMOVED*** Can work 6 days, must have day 7 off
```
...
***REMOVED******REMOVED******REMOVED*** Rule 3: Supervision Ratios (CRITICAL)
...
***REMOVED******REMOVED******REMOVED*** Rule 4: Availability Constraint (CRITICAL)
...
***REMOVED******REMOVED******REMOVED*** Rule 5: 24+4 Hour Shift Limit (HIGH)
...
***REMOVED******REMOVED******REMOVED*** Rule 6: Night Float Limits (HIGH)
...
***REMOVED******REMOVED******REMOVED*** Rule 7: Post-Call Day Restrictions (MEDIUM)
...
***REMOVED******REMOVED******REMOVED*** Rule 8: Moonlighting Hours (MEDIUM)
...
**Constants:**
```python
MAX_MOONLIGHTING_HOURS_PER_WEEK = 80  ***REMOVED*** Total internal + external
```
...
***REMOVED******REMOVED******REMOVED*** Rule 9: PGY-Specific Rules (HIGH)
...
***REMOVED******REMOVED*** Edge Case Coverage Analysis

***REMOVED******REMOVED******REMOVED*** Boundary Conditions
...
***REMOVED******REMOVED******REMOVED*** Month/Year Boundaries
...
***REMOVED******REMOVED******REMOVED*** Schedule Patterns
...
***REMOVED******REMOVED******REMOVED*** Personnel Types
...
***REMOVED******REMOVED******REMOVED*** Multiple Residents
...
***REMOVED******REMOVED*** Performance & Load Testing
...
***REMOVED******REMOVED*** Untested Rule Combinations
...
***REMOVED******REMOVED******REMOVED*** By Rule (Test Count)
...
***REMOVED******REMOVED******REMOVED*** By Test File
...
***REMOVED******REMOVED******REMOVED*** Priority 1: CRITICAL (Do First)

***REMOVED******REMOVED******REMOVED******REMOVED*** 1.1 Add Availability Constraint Tests
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1.2 Add Post-Call Day Tests
...
***REMOVED******REMOVED******REMOVED*** Priority 2: HIGH (Next Sprint)

***REMOVED******REMOVED******REMOVED******REMOVED*** 2.1 Add Rule Combination Tests
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2 Enhance Boundary Testing
**Impact:** Catches off-by-one errors that can cascade

Extend `test_acgme_edge_cases.py`:
```python
***REMOVED*** Add to TestACGMEEdgeCases:
...
***REMOVED******REMOVED******REMOVED*** Priority 3: MEDIUM (Nice to Have)

***REMOVED******REMOVED******REMOVED******REMOVED*** 3.1 Add PGY-4+ Support
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3.2 Add Fractional FTE Faculty Tests
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3.3 Add Regression Test Suite
...
***REMOVED******REMOVED*** Testing Philosophy

***REMOVED******REMOVED******REMOVED*** Strengths of Current Suite
...
***REMOVED******REMOVED******REMOVED*** Gaps to Address
...
***REMOVED******REMOVED*** Test Execution Command

```bash
***REMOVED*** Run all ACGME tests
cd /Users/aaronmontgomery/Autonomous-Assignment-Program-Manager/backend
pytest -m acgme -v

***REMOVED*** Run specific rule tests
...
***REMOVED*** Run only critical tests (quick feedback)
