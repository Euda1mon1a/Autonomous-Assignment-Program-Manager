***REMOVED*** SESSION 9: New Skill Opportunities - SEARCH_PARTY Analysis
> **Date:** 2025-12-30
...
***REMOVED******REMOVED*** SEARCH_PARTY Analysis Framework

***REMOVED******REMOVED******REMOVED*** 1. PERCEPTION: Skill Inventory Analysis

***REMOVED******REMOVED******REMOVED******REMOVED*** Current Coverage (40 Skills by Category)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Skill Metadata Audit
...
***REMOVED******REMOVED******REMOVED*** 2. INVESTIGATION: User Workflow Analysis

***REMOVED******REMOVED******REMOVED******REMOVED*** Discovered Problem Domains (from HUMAN_TODO.md, git history, sessions)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Hidden Workflow Patterns (From Session History)
...
***REMOVED******REMOVED******REMOVED*** 3. ARCANA: Skill Design Patterns

***REMOVED******REMOVED******REMOVED******REMOVED*** Advanced Patterns Discovered in Session 025
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Implications for New Skills
...
***REMOVED******REMOVED******REMOVED*** 4. HISTORY: Skill Request Pattern Analysis

***REMOVED******REMOVED******REMOVED******REMOVED*** Recurring Manual Workflows (from git commits)
...
***REMOVED******REMOVED******REMOVED*** 5. INSIGHT: Productivity Improvement Philosophy

***REMOVED******REMOVED******REMOVED******REMOVED*** Core Principle: "Systematize Pain"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Criteria for New Skills
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Implementation Philosophy
...
***REMOVED******REMOVED******REMOVED*** 6. RELIGION: Gap Prioritization Framework

***REMOVED******REMOVED******REMOVED******REMOVED*** Prioritization Matrix
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Decision Criteria
...
***REMOVED******REMOVED*** 7. NATURE: Skill Proliferation Analysis

***REMOVED******REMOVED******REMOVED*** Risk of Skill Bloat
...
***REMOVED******REMOVED******REMOVED*** Consolidation Opportunities
...
***REMOVED******REMOVED*** 8. MEDICINE: ROI Context

***REMOVED******REMOVED******REMOVED*** Cost-Benefit Analysis (P1 Skills)

***REMOVED******REMOVED******REMOVED******REMOVED*** Skill 1: Compliance Auditor
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Skill 2: Schedule Explainer
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Skill 3: Schedule Validator
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Skill 4: Runtime Incident Commander
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Skill 5: Solver Diagnostician
**Implementation:** 40 hours
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Skill 6: Rate Limit Forensics
...
***REMOVED******REMOVED*** 9. SURVIVAL: MVP Skill Definitions

***REMOVED******REMOVED******REMOVED*** MVP Philosophy
...
***REMOVED******REMOVED******REMOVED*** Skill 1: Compliance Auditor (P1) ⭐⭐⭐
...
**Metadata:**
```yaml
model_tier: sonnet  ***REMOVED*** Medium complexity (constraint traversal)
parallel_hints:
...
***REMOVED******REMOVED******REMOVED*** Skill 2: Schedule Validator (P1) ⭐⭐⭐
...
**Metadata:**
```yaml
model_tier: haiku  ***REMOVED*** Simple validation rules
parallel_hints:
...
***REMOVED******REMOVED******REMOVED*** Skill 3: Schedule Explainer (P1) ⭐⭐⭐
...
**Metadata:**
```yaml
model_tier: opus  ***REMOVED*** Requires reasoning about tradeoffs
parallel_hints:
  can_parallel_with: [code-review, test-writer]
  must_serialize_with: []
...
***REMOVED******REMOVED******REMOVED*** Skill 4: Runtime Incident Commander (P1) ⭐⭐
...
**Metadata:**
```yaml
model_tier: opus  ***REMOVED*** Complex diagnosis + reasoning
parallel_hints:
  can_parallel_with: []
...
***REMOVED******REMOVED******REMOVED*** Skill 5: Solver Diagnostician (P2) ⭐⭐
...
**Metadata:**
```yaml
model_tier: sonnet  ***REMOVED*** Medium complexity analysis
parallel_hints:
  can_parallel_with: [code-review, test-writer]
  must_serialize_with: [safe-schedule-generation]
...
***REMOVED******REMOVED******REMOVED*** Skill 6: Rate Limit Forensics (P2) ⭐
...
**Metadata:**
```yaml
model_tier: haiku  ***REMOVED*** Simple data retrieval + pattern matching
parallel_hints:
  can_parallel_with: [code-review, test-writer]
  must_serialize_with: []
...
***REMOVED******REMOVED*** 10. STEALTH: Hidden User Needs

***REMOVED******REMOVED******REMOVED*** Discovered Pain Points (Not Obvious)

***REMOVED******REMOVED******REMOVED******REMOVED*** Pain 1: "I don't know how to unblock myself"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pain 2: "I need to understand before I trust"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pain 3: "I fear publishing broken schedules"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pain 4: "Compliance audits take forever"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pain 5: "I keep making the same diagnosis mistakes"
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pain 6: "Rate limit incidents are chaotic"
...
***REMOVED******REMOVED*** Detailed Skill Specifications

***REMOVED******REMOVED******REMOVED*** Skill 1: COMPLIANCE_AUDITOR
...
```yaml
can_parallel_with:
  - code-review        ***REMOVED*** Different domains
  - test-writer        ***REMOVED*** Different domains
  - security-audit     ***REMOVED*** Different domains
must_serialize_with:
  - safe-schedule-generation  ***REMOVED*** Can't audit running generation
  - schedule-validator        ***REMOVED*** Should validate before auditing
preferred_batch_size: 1       ***REMOVED*** Per-schedule audit, serial
```

---

***REMOVED******REMOVED******REMOVED*** Skill 2: SCHEDULE_VALIDATOR
...
***REMOVED******REMOVED******REMOVED*** Skill 3: SCHEDULE_EXPLAINER
...
***REMOVED******REMOVED******REMOVED*** Skill 4: RUNTIME_INCIDENT_COMMANDER
...
***REMOVED******REMOVED******REMOVED*** Skill 5: SOLVER_DIAGNOSTICIAN
...
***REMOVED******REMOVED******REMOVED*** Skill 6: RATE_LIMIT_FORENSICS
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Core Workflows (Week 2-3)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Polish & Testing (Week 3-4)
...
***REMOVED******REMOVED******REMOVED*** Risk 1: Skill Duplication with Existing Skills
...
***REMOVED******REMOVED******REMOVED*** Risk 2: Skill Metadata Inconsistency
...
***REMOVED******REMOVED******REMOVED*** Risk 3: Adoption Inertia
...
***REMOVED******REMOVED******REMOVED*** Cross-Skill Orchestration Patterns
...
***REMOVED******REMOVED*** Future Work (Beyond P1-P2)

***REMOVED******REMOVED******REMOVED*** P3: Strategic Skills
...
***REMOVED******REMOVED******REMOVED*** P4: Meta Skills
...
***REMOVED******REMOVED*** Appendix A: Skill Template (Boilerplate)
...
metadata:
  model_tier: haiku|sonnet|opus  ***REMOVED*** Recommended tier
  complexity_score: X            ***REMOVED*** 0-30 scale
  estimated_tokens: X-Y          ***REMOVED*** Range for typical use
  execution_time: "X-Y minutes"  ***REMOVED*** Typical runtime
...
workflows: X                      ***REMOVED*** Number of sub-workflows
examples: Y                       ***REMOVED*** Number of example scenarios
...
***REMOVED******REMOVED*** Appendix B: Quick Decision Tree
...
***REMOVED******REMOVED*** Closing Summary
