***REMOVED*** Skills Composition Patterns - Comprehensive Documentation
...
2. [Perception: Current Skill Compositions](***REMOVED***perception-current-skill-compositions)
3. [Investigation: Skill Dependencies](***REMOVED***investigation-skill-dependencies)
4. [Arcana: Composition Patterns](***REMOVED***arcana-composition-patterns)
5. [History: Composition Evolution](***REMOVED***history-composition-evolution)
6. [Insight: Composability Philosophy](***REMOVED***insight-composability-philosophy)
7. [Religion: Compositions Documented](***REMOVED***religion-compositions-documented)
8. [Nature: Composition Complexity](***REMOVED***nature-composition-complexity)
9. [Medicine: Workflow Context](***REMOVED***medicine-workflow-context)
10. [Survival: Composition Failure Handling](***REMOVED***survival-composition-failure-handling)
11. [Stealth: Hidden Compositions](***REMOVED***stealth-hidden-compositions)
12. [Best Practices & Recommendations](***REMOVED***best-practices--recommendations)

---

***REMOVED******REMOVED*** PERCEPTION: Current Skill Compositions

***REMOVED******REMOVED******REMOVED*** Skill Inventory

**Total Skills Documented:** 96+ skill documentation files across 47 skill directories

**Primary Skill Categories:**

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Meta-Skills (Orchestration & Control)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Scheduling Domain Skills
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Development/Quality Skills
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Infrastructure & Deployment Skills
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Specialized Domain Skills
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 6. Support & Documentation Skills
...
***REMOVED******REMOVED******REMOVED*** Current Composition Statistics
...
***REMOVED******REMOVED*** INVESTIGATION: Skill Dependencies

***REMOVED******REMOVED******REMOVED*** Explicit Dependencies (from SKILL.md metadata)

***REMOVED******REMOVED******REMOVED******REMOVED*** MCP_ORCHESTRATION Dependencies
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Key Composition Rules
```yaml
...
***REMOVED******REMOVED******REMOVED*** Implicit Dependencies (from workflow documentation)

***REMOVED******REMOVED******REMOVED******REMOVED*** Scheduling Workflow Dependencies
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Swap Execution Workflow Dependencies
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Development Workflow Dependencies
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Deployment Pipeline Dependencies
...
***REMOVED******REMOVED******REMOVED*** Dependency Matrix
...
***REMOVED******REMOVED*** ARCANA: Composition Patterns

***REMOVED******REMOVED******REMOVED*** Pattern 1: Sequential Chain (Linear Pipeline)
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Parallel Fan-Out (Scatter-Gather)
...
**Synthesis Logic:**
```python
***REMOVED*** All-or-nothing synthesis
if any([check failed]):
    overall_result = FAILED

***REMOVED*** Best-effort synthesis
if any([check succeeded]):
    overall_result = SUCCEEDED

***REMOVED*** Weighted synthesis
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Map-Reduce (Parallel + Aggregation)
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Conditional Routing (Decision Tree)
...
***REMOVED******REMOVED******REMOVED*** Pattern 5: Hybrid Pipeline (Stages with Parallelism)
...
***REMOVED******REMOVED******REMOVED*** Pattern 6: Fire-and-Forget (Asynchronous Delegation)
...
***REMOVED*** Continue other work
await do_other_work()

***REMOVED*** Later, retrieve result
...
***REMOVED******REMOVED*** HISTORY: Composition Evolution

***REMOVED******REMOVED******REMOVED*** Generation 1: Linear Workflows (Initial Design)
...
***REMOVED******REMOVED******REMOVED*** Generation 2: Multi-Skill Orchestration (Explicit Dependencies)
...
***REMOVED******REMOVED******REMOVED*** Generation 3: Complex Orchestration (MCP Tools + Delegation)
...
***REMOVED******REMOVED******REMOVED*** Generation 4: Resilience-Aware Composition (Current State)
...
***REMOVED******REMOVED*** INSIGHT: Composability Philosophy

***REMOVED******REMOVED******REMOVED*** Core Principles

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Separation of Concerns
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Clear Input/Output Contracts

Every skill defines explicit data contracts:

```python
***REMOVED*** Input contract (Pydantic schema)
...
***REMOVED*** Output contract (Pydantic schema)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Explicit Dependency Declaration

Skills declare their dependencies upfront in SKILL.md:

```yaml
***REMOVED*** Declare what I can parallelize with
can_parallel_with: [code-review, test-writer, security-audit]

***REMOVED*** Declare what must be serialized with
must_serialize_with: [database-migration]

***REMOVED*** Declare my batch preferences
preferred_batch_size: 5
```

**Benefit:** Orchestrator can make intelligent scheduling decisions

***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Failure Mode Documentation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Result Synthesis Patterns

Standard synthesis patterns for combining results:

```python
***REMOVED*** All-or-nothing (AND logic)
if any(check failed):
    return FAILED

***REMOVED*** Best-effort (OR logic)
if any(check succeeded):
    return SUCCEEDED

***REMOVED*** Majority vote (consensus)
if votes[decision] > total / 2:
    return decision

***REMOVED*** Weighted aggregation
score = sum([result[i] * weight[i]])

***REMOVED*** Merge-deduplicate
merged = combine(results).unique()
```

**Benefit:** Caller doesn't implement synthesis logic (reusable patterns)

***REMOVED******REMOVED******REMOVED******REMOVED*** 6. Idempotency Where Possible

Skills designed to be idempotent (safe to retry):

```python
***REMOVED*** Idempotent: Same input → same output
def validate_schedule(start_date, end_date):
    return PASS/FAIL based on database state
    ***REMOVED*** Safe to call multiple times

***REMOVED*** Non-idempotent: Side effects
def execute_swap(swap_id):
    update assignments
    ***REMOVED*** NOT safe to call multiple times (transaction already executed)
    ***REMOVED*** Compensated by: Explicit rollback window
```
...
***REMOVED******REMOVED*** RELIGION: Compositions Documented

***REMOVED******REMOVED******REMOVED*** Documentation Structure (for Well-Documented Skills)

***REMOVED******REMOVED******REMOVED******REMOVED*** Level 1: SKILL.md (Metadata + Overview)
```yaml
name: [Skill Name]
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Level 2: Workflows/ (Step-by-Step Execution)
```
Workflows/
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Level 3: Reference/ (Deep Dives)
```
Reference/
...
***REMOVED******REMOVED******REMOVED*** Composition Documentation Status

***REMOVED******REMOVED******REMOVED******REMOVED*** Well-Documented Skills (4+ files each)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Under-Documented Skills (1-2 files each)
...
***REMOVED******REMOVED******REMOVED*** Composition Documentation Gaps
...
***REMOVED******REMOVED*** NATURE: Composition Complexity

***REMOVED******REMOVED******REMOVED*** Composition Complexity Spectrum

***REMOVED******REMOVED******REMOVED******REMOVED*** Complexity Level 1: Simple Chain (2-3 skills)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Complexity Level 2: Fan-Out (4-6 parallel skills)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Complexity Level 3: Hybrid Pipeline (6-8 skills)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Complexity Level 4: Complex Orchestration (10+ skills)
...
***REMOVED******REMOVED******REMOVED*** Composition Complexity Drivers

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Number of Skills
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Dependency Structure
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Error Recovery Strategies
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Data Transformation Between Skills
```
...
***REMOVED******REMOVED******REMOVED*** Composition Complexity Analysis Examples

***REMOVED******REMOVED******REMOVED******REMOVED*** Example 1: Safe Schedule Generation (Moderate Complexity)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 2: Swap Execution (Moderate Complexity)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 3: Comprehensive Resilience Analysis (Low-to-Moderate Complexity)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 4: Production Deployment (High Complexity)
...
***REMOVED******REMOVED*** MEDICINE: Workflow Context

***REMOVED******REMOVED******REMOVED*** Resident Scheduling Domain Context

***REMOVED******REMOVED******REMOVED******REMOVED*** Key Workflows
...
***REMOVED******REMOVED******REMOVED*** Complexity Drivers in Scheduling Domain

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Scale
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Institutional Policies
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Composition of Resident Cohorts
```
...
***REMOVED******REMOVED******REMOVED*** Integration Points in Scheduling Context
...
***REMOVED******REMOVED*** SURVIVAL: Composition Failure Handling

***REMOVED******REMOVED******REMOVED*** Error Classification in Compositions
...
***REMOVED******REMOVED******REMOVED*** Failure Handling in Compositions

***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern 1: Fail-Fast Strategy
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern 2: Fail-Tolerant Strategy
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern 3: Retry-with-Backoff Strategy
...
TOOL_RETRY_CONFIG = {
    ...
    "promote_to_production_tool": {
        "max_retries": 1,  ***REMOVED*** Conservative - deployment should be idempotent
        "base_delay": 5.0,
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern 4: Circuit Breaker Strategy
    ...
    async def execute(self, task):
        ...
        try:
            ...
            if self.state == "HALF_OPEN":
                self.state = "CLOSED"  ***REMOVED*** Recovered
            return result
        except Exception as e:
            self.failures += 1
            if self.failures >= self.failure_threshold:
                self.state = "OPEN"  ***REMOVED*** Trip circuit
            raise
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** When to Escalate (Immediate)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Escalation Levels (from error-handling.md)

```python
class EscalationLevel(str, Enum):
    INFO = "info"           ***REMOVED*** Informational (log only)
    WARNING = "warning"     ***REMOVED*** Non-blocking issue (alert operator)
    CRITICAL = "critical"   ***REMOVED*** Blocking issue (escalate to team)
    EMERGENCY = "emergency" ***REMOVED*** System-level failure (escalate urgently)
```
...
***REMOVED******REMOVED******REMOVED*** Error Handling in Real Workflows

***REMOVED******REMOVED******REMOVED******REMOVED*** Example 1: Schedule Generation Error Recovery
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 2: Swap Execution Rollback
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 3: Deployment Failure with Rollback
...
***REMOVED******REMOVED*** STEALTH: Hidden Compositions

***REMOVED******REMOVED******REMOVED*** Implicit Compositions (Not Explicitly Documented)

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Validation Chains
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Decision Tree Embeddings
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Transformation Pipelines
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Cross-Cutting Concerns
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Caching Layers
...
***REMOVED******REMOVED******REMOVED*** Discovering Hidden Compositions

***REMOVED******REMOVED******REMOVED******REMOVED*** Method 1: Code Analysis

Scan skill implementations for:
```python
***REMOVED*** Implicit validation composition
if not validate_X():
    return error()
if not validate_Y():
    return error()
...
***REMOVED*** Implicit decision tree
if condition_a:
    return path_1()
elif condition_b:
    return path_2()
...
***REMOVED*** Implicit data transformation
data = transform(input)
result = process(data)
output = extract(result)

***REMOVED*** Implicit caching
if cache.has(key):
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Method 2: Dependency Analysis
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Method 3: State Machine Analysis
...
***REMOVED******REMOVED*** Best Practices & Recommendations

***REMOVED******REMOVED******REMOVED*** Best Practices for Skill Composition

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Explicit Dependency Declaration

**DO:**
```yaml
***REMOVED*** In SKILL.md, declare dependencies
dependencies:
  required:
    - acgme-compliance
    - SCHEDULING
...
**DON'T:**
```python
***REMOVED*** Don't hide dependencies in implementation
def execute_swap(swap_id):
    ***REMOVED*** Call dependency implicitly (not declared)
...
def execute_swap(request):
    ***REMOVED*** Implicit input structure (dict with undefined keys)
    ***REMOVED*** Implicit output structure (dict with optional keys)
    ***REMOVED*** No type safety
    pass
```

***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Fail-Safe Defaults

**DO:**
```python
***REMOVED*** Default to fail-fast for safety-critical operations
def validate_schedule(schedule):
    if not acgme_compliant:
        return FAIL  ***REMOVED*** Don't continue on ACGME violation
    if not coverage_adequate:
        return FAIL  ***REMOVED*** Don't continue on coverage failure
```

**DON'T:**
```python
***REMOVED*** Don't silently continue on errors
def validate_schedule(schedule):
    try:
        acgme_compliant = check_acgme()
    except:
        pass  ***REMOVED*** Ignore error, continue
```

***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Observable Compositions

**DO:**
```python
***REMOVED*** Log each composition step
...
**DON'T:**
```python
***REMOVED*** Don't make compositions silent
schedule = await backup_database()
schedule = await generate_schedule()
schedule = await validate_acgme(schedule)
***REMOVED*** No visibility into what happened or how long it took
```

***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Testable Compositions

**DO:**
```python
***REMOVED*** Mock dependencies for testing
@pytest.fixture
...
def test_schedule_generation_with_valid_acgme(mock_acgme_validator):
    ***REMOVED*** Test schedule generation in isolation
    ***REMOVED*** ACGME validation mocked
    pass
...
def test_schedule_generation_with_acgme_violation(mock_acgme_validator):
    ...
    ***REMOVED*** Test error handling path
    pass
```

**DON'T:**
```python
***REMOVED*** Don't test compositions against real dependencies
def test_schedule_generation():
    ***REMOVED*** Calls real database, real solver, real validation
    ***REMOVED*** Test is slow and fragile
    pass
```

***REMOVED******REMOVED******REMOVED*** Recommendations for Better Compositions

***REMOVED******REMOVED******REMOVED******REMOVED*** Recommendation 1: Create Explicit Composition Documentation
...
**Example:**
```markdown
***REMOVED******REMOVED*** Schedule Generation Composition

***REMOVED******REMOVED******REMOVED*** Skills Involved
...
***REMOVED******REMOVED******REMOVED*** Latency Breakdown
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Recommendation 2: Extract Implicit Compositions
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Recommendation 3: Add Observability to Compositions
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Recommendation 4: Performance Optimization Guide
...
**Example:**
```markdown
***REMOVED******REMOVED*** Schedule Generation Performance Tuning

***REMOVED******REMOVED******REMOVED*** Bottleneck Analysis
...
***REMOVED******REMOVED******REMOVED*** Optimization Strategy
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Recommendation 5: Composition Testing Framework
...
def test_schedule_generation_happy_path(mock_skills):
    ...
    ***REMOVED*** Run composition
    result = schedule_generation_composition(mock_skills)

    ***REMOVED*** Assert correct order
...
def test_schedule_generation_acgme_violation(mock_skills):
    ...
    ***REMOVED*** Assert correct error handling
...
***REMOVED******REMOVED*** Summary: Skill Composition Architecture
...
***REMOVED******REMOVED******REMOVED*** Key Strengths
...
***REMOVED******REMOVED******REMOVED*** Key Gaps
...
***REMOVED******REMOVED******REMOVED*** Recommendations (Priority Order)
