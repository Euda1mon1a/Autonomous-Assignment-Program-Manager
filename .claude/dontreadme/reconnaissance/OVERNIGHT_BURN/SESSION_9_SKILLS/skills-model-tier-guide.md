***REMOVED*** Claude Model Tier Selection Guide for Skills
...
1. [Model Tier Definitions](***REMOVED***model-tier-definitions)
2. [Complexity Scoring Algorithm](***REMOVED***complexity-scoring-algorithm)
3. [Tier Selection Decision Tree](***REMOVED***tier-selection-decision-tree)
4. [Perception: Current Tier Usage](***REMOVED***perception-current-tier-usage)
5. [Investigation: Task-to-Tier Mapping](***REMOVED***investigation-task-to-tier-mapping)
6. [Arcana: Model Capability Differences](***REMOVED***arcana-model-capability-differences)
7. [History: Tier Selection Evolution](***REMOVED***history-tier-selection-evolution)
8. [Insight: Cost vs Capability Philosophy](***REMOVED***insight-cost-vs-capability-philosophy)
9. [Religion: Automated Tier Selection](***REMOVED***religion-automated-tier-selection)
10. [Nature: Tier Boundaries](***REMOVED***nature-tier-boundaries)
11. [Medicine: Task Complexity Context](***REMOVED***medicine-task-complexity-context)
12. [Survival: Fallback Tier Handling](***REMOVED***survival-fallback-tier-handling)
13. [Stealth: Misaligned Tier Detection](***REMOVED***stealth-misaligned-tier-detection)
14. [Cost Optimization Strategies](***REMOVED***cost-optimization-strategies)
15. [Implementation Guidelines](***REMOVED***implementation-guidelines)

---

***REMOVED******REMOVED*** Model Tier Definitions

***REMOVED******REMOVED******REMOVED*** Claude Haiku: The Scout
...
***REMOVED******REMOVED******REMOVED*** Claude Sonnet: The Strategist
...
***REMOVED******REMOVED******REMOVED*** Claude Opus: The Architect
...
***REMOVED******REMOVED*** Complexity Scoring Algorithm

***REMOVED******REMOVED******REMOVED*** Formula Breakdown
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Domains (Weight: 3x)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Dependencies (Weight: 2x)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Time Estimate (Weight: 2x)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Risk Level (Weight: 1x)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Knowledge Depth (Weight: 1x)
...
***REMOVED******REMOVED******REMOVED*** Scoring Examples

***REMOVED******REMOVED******REMOVED******REMOVED*** Example 1: Add CSS Styling to Form
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 2: Implement ACGME Compliance Validator
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 3: Fix Lint Error in Python File
```
Domains: 1 (Backend)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 4: Security Audit of Authentication System
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Example 5: Generate Schedule and Validate
```
...
***REMOVED******REMOVED*** Tier Selection Decision Tree
...
***REMOVED******REMOVED*** Perception: Current Tier Usage

***REMOVED******REMOVED******REMOVED*** Current Distribution Across Skills
...
***REMOVED******REMOVED******REMOVED*** Skills Missing Tier Assignment
...
***REMOVED******REMOVED*** Investigation: Task-to-Tier Mapping

***REMOVED******REMOVED******REMOVED*** Task Categories with Recommended Tiers

***REMOVED******REMOVED******REMOVED******REMOVED*** Category: Basic Linting & Formatting
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Category: Routing & Orchestration
**Complexity Range:** 0-5
**Recommended Tier:** Haiku
**Tasks:**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Category: Reference & Knowledge Lookups
**Complexity Range:** 0-5
**Recommended Tier:** Haiku
**Tasks:**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Category: Standard Code Generation
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Category: Advanced Code Review & Analysis
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Category: Complex System Operations
**Complexity Range:** 18+
**Recommended Tier:** Opus
**Tasks:**
- Production incident response
...
***REMOVED******REMOVED*** Arcana: Model Capability Differences

***REMOVED******REMOVED******REMOVED*** Reasoning Capability Comparison
...
***REMOVED******REMOVED******REMOVED*** Code Generation Quality
...
***REMOVED******REMOVED******REMOVED*** Speed vs Quality Trade-offs
...
***REMOVED******REMOVED******REMOVED*** When to Upgrade/Downgrade
...
***REMOVED******REMOVED*** History: Tier Selection Evolution

***REMOVED******REMOVED******REMOVED*** Current State (Session 025-030)
...
***REMOVED******REMOVED******REMOVED*** Recommended Tier Redistribution
...
***REMOVED******REMOVED*** Insight: Cost vs Capability Philosophy

***REMOVED******REMOVED******REMOVED*** The Cost-Capability Trade-off

**Three Philosophies:**

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Cost-First (Haiku-Heavy)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Balanced (Mixed Tiers) - RECOMMENDED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Quality-First (Opus-Heavy)
...
***REMOVED******REMOVED*** Religion: Automated Tier Selection

***REMOVED******REMOVED******REMOVED*** Automatic Tier Assignment Framework

***REMOVED******REMOVED******REMOVED******REMOVED*** Rule-Based Tier Selection
...
```yaml
***REMOVED*** In skill SKILL.md
model_tier_hints:
  recommended: sonnet
  can_downgrade_to: haiku  ***REMOVED*** if score < 5
  must_upgrade_to: opus    ***REMOVED*** if security/compliance involved
  cost_critical: false     ***REMOVED*** if true, prefer Haiku
```

---

***REMOVED******REMOVED******REMOVED******REMOVED*** Automatic Tier Selection Algorithm
...
def select_tier(task_context) -> ModelTier:
    ...
    Args:
        task_context: {
            ...
            'risk_level': int,  ***REMOVED*** 1-5
            'knowledge_required': int,  ***REMOVED*** 1-5
    ...
    ***REMOVED*** Step 3: Map score to tier
    if score >= 13:
        tier = ModelTier.OPUS
    elif score >= 6:
    ...
    ***REMOVED*** Step 4: Apply cost optimization override
    if task_context['cost_optimization_mode'] and score < 8:
        return ModelTier.HAIKU

    ***REMOVED*** Step 5: Apply quality override
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Implementation in Skill YAML

```yaml
---
name: my-skill
description: Example skill with automatic tier selection
model_tier: sonnet  ***REMOVED*** Default/recommended

***REMOVED*** Automatic tier selection parameters
model_tier_params:
  ***REMOVED*** Hard constraints that force tier upgrade
  force_opus_if:
    - is_security_critical
    - is_acgme_compliance
    - is_authentication_related

  ***REMOVED*** Complexity parameters for scoring
  complexity:
    domains: ["backend", "database"]  ***REMOVED*** 2 domains
    dependencies: ["db", "validation_rules"]  ***REMOVED*** 2 deps
    estimated_time_minutes: 15
    risk_level: 2  ***REMOVED*** Medium
    knowledge_required: 2  ***REMOVED*** Intermediate

  ***REMOVED*** Cost optimization hints
  cost_hints:
    cost_optimization_friendly: true  ***REMOVED*** Can use Haiku/Sonnet
    minimum_tier: sonnet  ***REMOVED*** Never go below this

  ***REMOVED*** Skill-specific hints
  skill_hints:
...
***REMOVED******REMOVED******REMOVED*** Monitoring Actual Tier Usage
...
class TierUsageMetrics:
    ...
    cost_actual_vs_expected: float  ***REMOVED*** 1.0 = as expected
    success_rate: float  ***REMOVED*** % tasks that succeed on first try
    quality_score: float  ***REMOVED*** 0-100
    time_to_completion: float  ***REMOVED*** seconds

    ***REMOVED*** Analysis
    is_tier_optimized: bool  ***REMOVED*** assigned == optimal?
    cost_variance: float  ***REMOVED*** % difference from predicted cost
    quality_variance: float  ***REMOVED*** % difference from expected
```

---

***REMOVED******REMOVED*** Nature: Tier Boundaries

***REMOVED******REMOVED******REMOVED*** Hard Boundaries (Non-Negotiable)
...
***REMOVED******REMOVED******REMOVED*** Soft Boundaries (Task-Dependent)
...
***REMOVED******REMOVED******REMOVED*** Tier Overlap Matrix
...
***REMOVED******REMOVED*** Medicine: Task Complexity Context

***REMOVED******REMOVED******REMOVED*** ACGME Compliance Tasks
...
***REMOVED******REMOVED******REMOVED*** Scheduling Tasks
...
***REMOVED******REMOVED******REMOVED*** Security Tasks
...
***REMOVED******REMOVED******REMOVED*** Testing Tasks
...
***REMOVED******REMOVED*** Survival: Fallback Tier Handling

***REMOVED******REMOVED******REMOVED*** What to Do When Model Selection Goes Wrong

***REMOVED******REMOVED******REMOVED******REMOVED*** Scenario 1: Task Too Complex for Assigned Tier
...
def upgrade_tier_on_failure(task, current_tier, failure_reason):
    ...
    if current_tier == Tier.HAIKU:
        ...
        ***REMOVED*** Already at max - may need human intervention
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Scenario 2: Task Too Simple for Assigned Tier
...
***REMOVED******REMOVED******REMOVED*** Fallback Chains
...
***REMOVED******REMOVED*** Stealth: Misaligned Tier Detection

***REMOVED******REMOVED******REMOVED*** Red Flags for Misaligned Tiers

***REMOVED******REMOVED******REMOVED******REMOVED*** Haiku Used For Complex Tasks (Under-Provisioned)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Opus Used For Simple Tasks (Over-Provisioned)
...
***REMOVED******REMOVED******REMOVED*** Automated Detection System
...
class TierMisalignmentDetector:
    ...
    def check_alignment(self, task, assigned_tier):
        ...
        ***REMOVED*** Calculate optimal tier
        optimal_tier = self.calculate_optimal_tier(task)

        ***REMOVED*** Check for misalignment
        ...
        return None  ***REMOVED*** Aligned!
```

---

***REMOVED******REMOVED*** Cost Optimization Strategies

***REMOVED******REMOVED******REMOVED*** Strategy 1: Complexity-Based Tiering
...
***REMOVED******REMOVED******REMOVED*** Strategy 2: Bulk Tier Assignment
...
***REMOVED******REMOVED******REMOVED*** Strategy 3: Time-Based Tier Escalation
...
***REMOVED******REMOVED******REMOVED*** Strategy 4: Batch & Parallelize

**Approach:** Run similar low-complexity tasks on Haiku in batch.

**Example:**
```python
***REMOVED*** Inefficient: One task at a time with Sonnet
for file in files:
    lint_and_fix(file, tier=Sonnet)  ***REMOVED*** Cost: 5x per task

***REMOVED*** Efficient: Batch on Haiku
lint_batch(files, tier=Haiku)  ***REMOVED*** Cost: 1x per batch
```
...
***REMOVED******REMOVED******REMOVED*** Strategy 5: Caching & Reuse

**Approach:** Cache model outputs for common tasks.

**Example:**
```python
***REMOVED*** Cache: "What is ACGME 80-hour rule?"
***REMOVED*** Answer cached from Haiku, reused 1000x
lookup_acgme_rule("80-hour", tier=Haiku)

***REMOVED*** vs regenerating every time:
lookup_acgme_rule("80-hour", tier=Opus)  ***REMOVED*** 100x cost
```
...
***REMOVED******REMOVED******REMOVED*** Recommended Cost Optimization Roadmap
...
***REMOVED******REMOVED******REMOVED*** Adding Tier Assignment to Skills
...
model_tier: sonnet  ***REMOVED*** Add this line
...
model_tier_params:
  complexity:
    domains: 2  ***REMOVED*** Backend, Database
    dependencies: 2  ***REMOVED*** DB, validation rules
...
```yaml
  cost_hints:
    ...
    minimum_tier: sonnet  ***REMOVED*** Never downgrade below Sonnet
```

---

***REMOVED******REMOVED******REMOVED*** Tier Assignment Checklist
...
***REMOVED******REMOVED******REMOVED*** Monitoring & Adjustment
...
***REMOVED******REMOVED******REMOVED*** Appendix A: Quick Reference - Task to Tier Mapping
...
***REMOVED******REMOVED******REMOVED*** Appendix B: Skill Tier Assignment Template
...
***REMOVED*** Model tier for skill execution
model_tier: sonnet  ***REMOVED*** haiku, sonnet, or opus

***REMOVED*** Detailed justification for tier selection
model_tier_justification: |
  COMPLEXITY SCORING:
...
***REMOVED*** Complexity assessment for tier selection
model_tier_params:
  complexity:
    domains:
      - backend
    ...
    dependencies:
      ...
      - validation_rules
    estimated_time_minutes: 15
    risk_level: 2  ***REMOVED*** 1-5 scale
    knowledge_required: 2  ***REMOVED*** 1-5 scale

  cost_hints:
    cost_optimization_friendly: true
    minimum_tier: sonnet  ***REMOVED*** Never downgrade below this

  hard_constraints: []
    ***REMOVED*** - is_security_critical
    ***REMOVED*** - is_production_emergency
    ***REMOVED*** - is_acgme_compliance
...
***REMOVED******REMOVED******REMOVED*** Appendix C: Complexity Scoring Worksheets
...
***REMOVED******REMOVED******REMOVED*** Appendix D: Cost Analysis Tools
...
def estimate_cost(tier, tokens_estimated):
    ...
    cost_per_mtok = {
        'haiku': 0.80,    ***REMOVED*** Haiku: $0.80 per million input tokens
        'sonnet': 3.00,   ***REMOVED*** Sonnet: $3.00 per million input tokens
        'opus': 15.00,    ***REMOVED*** Opus: $15.00 per million input tokens
    }
...
***REMOVED*** Example:
***REMOVED*** 1000 tokens on Haiku = 0.001M × $0.80 = $0.0008
***REMOVED*** 1000 tokens on Opus = 0.001M × $15.00 = $0.015
***REMOVED*** Opus is 18.75x more expensive!
```

---

***REMOVED******REMOVED******REMOVED*** Appendix E: Tier Selection Decision Matrix
