***REMOVED*** Frontend Styling Patterns - SEARCH_PARTY Audit
...
***REMOVED******REMOVED*** 1. Tailwind Configuration Audit
...
***REMOVED******REMOVED******REMOVED*** Key Configuration Decisions
...
***REMOVED******REMOVED******REMOVED*** PostCSS Configuration
...
***REMOVED******REMOVED*** 2. Design Token Inventory

***REMOVED******REMOVED******REMOVED*** Custom Color Palette
...
colors: {
  ...
  clinic: {
    light: '***REMOVED***dbeafe',      // rgb(219, 238, 254) - Light blue
    DEFAULT: '***REMOVED***3b82f6',    // rgb(59, 130, 246) - Tailwind blue-500
    dark: '***REMOVED***1d4ed8',       // rgb(29, 78, 216) - Tailwind blue-800
  },
  inpatient: {
    light: '***REMOVED***ede9fe',      // rgb(237, 233, 254) - Light purple
    DEFAULT: '***REMOVED***8b5cf6',    // rgb(139, 92, 246) - Tailwind violet-500
    dark: '***REMOVED***6d28d9',       // rgb(109, 40, 217) - Tailwind violet-700
  },
  call: {
    light: '***REMOVED***fee2e2',      // rgb(254, 226, 226) - Light red
    DEFAULT: '***REMOVED***ef4444',    // rgb(239, 68, 68) - Tailwind red-500
    dark: '***REMOVED***b91c1c',       // rgb(185, 28, 28) - Tailwind red-800
  },
  leave: {
    light: '***REMOVED***fef3c7',      // rgb(254, 243, 199) - Light amber
    DEFAULT: '***REMOVED***f59e0b',    // rgb(245, 158, 11) - Tailwind amber-500
    dark: '***REMOVED***d97706',       // rgb(217, 119, 6) - Tailwind amber-600
  },

  // Tactical/Medical semantic colors
  scrub: {
    light: '***REMOVED***d1fae5',      // rgb(209, 250, 229) - Light green
    DEFAULT: '***REMOVED***10b981',    // rgb(16, 185, 129) - Tailwind emerald-500
    dark: '***REMOVED***047857',       // rgb(4, 120, 87) - Tailwind emerald-700
  },
  sterile: {
    light: '***REMOVED***f8fafc',      // rgb(248, 250, 252) - Slate-50
    DEFAULT: '***REMOVED***f1f5f9',    // rgb(241, 245, 249) - Slate-100
    dark: '***REMOVED***e2e8f0',       // rgb(226, 232, 240) - Slate-200
  },
}
```

***REMOVED******REMOVED******REMOVED*** Color Usage Pattern Analysis
...
***REMOVED******REMOVED******REMOVED*** Font Family Stack
...
***REMOVED******REMOVED*** 3. Responsive Design Patterns

***REMOVED******REMOVED******REMOVED*** Tailwind Breakpoints (Standard)
...
***REMOVED******REMOVED******REMOVED*** Real-World Usage Patterns
...
***REMOVED******REMOVED******REMOVED*** Responsive Typography
...
***REMOVED******REMOVED*** 4. Dark Mode Implementation

***REMOVED******REMOVED******REMOVED*** Activation Method
...
***REMOVED******REMOVED******REMOVED*** Global Dark Mode Styles
...
***REMOVED******REMOVED******REMOVED*** Component Dark Mode Patterns
...
***REMOVED******REMOVED******REMOVED*** Real Component Usage
...
***REMOVED******REMOVED******REMOVED*** CSS Variables for Dark Mode
...
@media (prefers-color-scheme: dark) {
  .mcp-capabilities-panel {
    --bg-primary: ***REMOVED***1e1e1e;
    --bg-secondary: ***REMOVED***252526;
    --bg-tertiary: ***REMOVED***2d2d30;
    --text-primary: ***REMOVED***cccccc;
    --text-secondary: ***REMOVED***9d9d9d;
    --border-color: ***REMOVED***404040;
    --primary-color: ***REMOVED***3794ff;
    --primary-light: ***REMOVED***1e3a5f;
    --code-bg: ***REMOVED***2d2d30;
  }
}
```
...
***REMOVED******REMOVED*** 5. Component Library & Reusable Patterns

***REMOVED******REMOVED******REMOVED*** Core Component Classes

**Location:** `/frontend/src/app/globals.css` (@layer components)

***REMOVED******REMOVED******REMOVED******REMOVED*** Glass Morphism Panels
```css
.glass-panel {
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Button Classes
```css
.btn-primary {
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Form Elements
```css
.input-field {
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Card Container
```css
.card {
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Schedule Grid Styles
```css
.schedule-cell {
...
***REMOVED******REMOVED******REMOVED*** Semantic Form Components
...
***REMOVED******REMOVED*** 6. Animation & Motion Patterns

***REMOVED******REMOVED******REMOVED*** Framer Motion Integration
...
***REMOVED******REMOVED******REMOVED*** CSS Keyframe Animations
...
***REMOVED******REMOVED******REMOVED*** Status Indicator Glows
...
***REMOVED******REMOVED*** 7. Accessibility Color Contrast Audit

***REMOVED******REMOVED******REMOVED*** WCAG Compliance Analysis
...
├─────────────────┼──────────────────┼─────────────┼──────────────┤
│ Text on Clinic  │ ***REMOVED***fff on ***REMOVED***3b82f6 │ 5.0:1      │ AA ✓         │
│ Text on Call    │ ***REMOVED***fff on ***REMOVED***ef4444 │ 3.8:1      │ AA ✓         │
│ Text on Leave   │ ***REMOVED***fff on ***REMOVED***f59e0b │ 4.9:1      │ AA ✓         │
│ Text on Scrub   │ ***REMOVED***fff on ***REMOVED***10b981 │ 5.3:1      │ AA ✓         │
│ Text on Sterile │ ***REMOVED***1a1a1a on ***REMOVED***f1f5f9 │ 11.2:1 │ AAA ✓ (large)│
│ Dark Body Text  │ ***REMOVED***1a1a1a on ***REMOVED***f8fafc │ 13.1:1 │ AAA ✓        │
│ Light Body Text │ ***REMOVED***cccccc on ***REMOVED***1e1e1e │ 8.6:1  │ AAA ✓        │
└─────────────────┴──────────────────┴─────────────┴──────────────┘
```

***REMOVED******REMOVED******REMOVED*** Critical Accessibility Patterns
...
***REMOVED******REMOVED*** 8. CSS Architecture Insights

***REMOVED******REMOVED******REMOVED*** Layer Organization (@layer)
...
***REMOVED******REMOVED******REMOVED*** CSS Variable Usage (Mixed Approach)
...
***REMOVED******REMOVED*** 9. Print Styles for PDF Export
...
@media print {
  ...
  .card {
    ...
    border: 1px solid ***REMOVED***ddd !important;
    page-break-inside: avoid;
  }

  /* Headings for print */
  h1, h2, h3, h4, h5, h6 {
    color: ***REMOVED***000 !important;
  }
...
***REMOVED******REMOVED*** 10. Design System Recommendations
...
***REMOVED******REMOVED******REMOVED*** Bundle Size Impact
...
***REMOVED******REMOVED*** 11. File Inventory
...
***REMOVED******REMOVED*** 12. Key Metrics
...
***REMOVED******REMOVED*** 13. Responsive Design Checklist
