***REMOVED*** RETRIEVAL_PATTERNS.md - Query Patterns and Usage Examples
...
***REMOVED******REMOVED*** Part 1: Basic Retrieval Patterns
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Keyword Search
...
def search_by_keyword(keywords: List[str], operator: str = "AND") -> List[File]:
    ...
    ***REMOVED*** Score by keyword matches
    scores = {}
    for f in results:
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Type-Based Search
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Priority-Based Search
...
def search_by_priority(priority: List[str], domain: str = None) -> List[File]:
    ...
    ***REMOVED*** Sort by priority order
...
***REMOVED******REMOVED******REMOVED*** Pattern 5: Action Item Search
...
def search_action_items(domain: str = None, priority: List[str] = None) -> List[File]:
    ...
    ***REMOVED*** Sort by action item count
...
***REMOVED******REMOVED*** Part 2: Advanced Retrieval Patterns

***REMOVED******REMOVED******REMOVED*** Pattern 6: Cross-Domain Impact Analysis
...
def cross_domain_impact(source_domain: str, target_domain: str) -> Dict:
    ...
    ***REMOVED*** Find files in source domain
    source_files = [f for f in files if f['domain'] == source_domain]

    ***REMOVED*** Find cross-references
    impacts = {
        'primary': [],      ***REMOVED*** Direct implementations
        'secondary': [],    ***REMOVED*** Indirect implications
        'testing': []       ***REMOVED*** Test coverage needed
    }

    for source_file in source_files:
        ***REMOVED*** Look for target domain mentions in keywords/summary
...
***REMOVED******REMOVED******REMOVED*** Pattern 7: Semantic Similarity Search
...
def semantic_search(query_text: str, top_k: int = 10, domain: str = None) -> List[File]:
    ...
    """
    ***REMOVED*** This requires vector DB implementation
    ***REMOVED*** Pseudocode assumes vector DB is available

    ***REMOVED*** 1. Embed query text
    query_vector = embed(query_text)

    ***REMOVED*** 2. Search vector database
    vector_results = vector_db.search(query_vector, top_k=top_k*2)

    ***REMOVED*** 3. Apply domain filter if specified
    if domain:
        vector_results = [r for r in vector_results
                          if FILE_REGISTRY[r['file_id']]['domain'] == domain]

    ***REMOVED*** 4. Return top K results with relevance scores
...
***REMOVED******REMOVED******REMOVED*** Pattern 8: Code Example Search
...
def search_code_examples(language: str, pattern: str = None,
    ...
    ***REMOVED*** Sort by number of code examples
...
***REMOVED******REMOVED******REMOVED*** Pattern 9: Findings and Issues Search
...
def search_findings(finding_type: str = None,
    ...
    ***REMOVED*** Filter files with sufficient findings count
    ...
    ***REMOVED*** Filter by finding type (if determinable from type/keywords)
    if finding_type:
        results = [f for f in results
                   if f['type'] == 'audit' and finding_type in f['keywords']]

    ***REMOVED*** Sort by findings count descending
...
***REMOVED******REMOVED******REMOVED*** Pattern 10: Metadata-Based Filtering
...
***REMOVED******REMOVED*** Part 3: Agent-Specific Patterns

***REMOVED******REMOVED******REMOVED*** Pattern 11: Initialization/Context Loading
...
***REMOVED******REMOVED******REMOVED*** Pattern 12: Domain Onboarding
...
def domain_onboarding(domain: str, depth: str = "basic") -> Dict:
    ...
    """
    ***REMOVED*** Step 1: Get domain summary
    domain_info = FILE_REGISTRY['domains'][domain]

    ***REMOVED*** Step 2: Load entry point files (P0)
    entry_files = search_domain(domain, priority=['P0'])

    ***REMOVED*** Step 3: Load core files if comprehensive
    if depth == "comprehensive":
        core_files = search_domain(domain, priority=['P1'])
    else:
        core_files = []

    ***REMOVED*** Step 4: Build context
    onboarding = {
...
***REMOVED******REMOVED******REMOVED*** Pattern 13: Task-Specific Content Retrieval
...
def task_retrieval(task: str, context: Dict = None) -> List[File]:
    ...
    """
    ***REMOVED*** Task-to-pattern mapping
    task_patterns = {
    ...
    ***REMOVED*** Get task patterns
    patterns = task_patterns.get(task, {})

    ***REMOVED*** Search with patterns
...
***REMOVED******REMOVED******REMOVED*** Pattern 14: Decision Support
...
def decision_support(decision: str, context: Dict = None) -> Dict:
    ...
    """
    ***REMOVED*** Decision-to-search mapping
    decision_map = {
...
***REMOVED******REMOVED******REMOVED*** Pattern 15: Learning Path / Skill Building
...
def learning_path(skill: str, level: str = "intermediate") -> Dict:
    ...
    """
    ***REMOVED*** Skill-to-domain mapping
    skill_domains = {
        'acgme_compliance': {
    ...
    ***REMOVED*** Build path by level
    learning_path = {
        'beginner': {
            'duration_hours': 4,
            'phase1': read_p0_files(domains['primary']),  ***REMOVED*** Overview
            'phase2': read_key_pattern_files(domains['primary']),  ***REMOVED*** Patterns
...
***REMOVED******REMOVED*** Part 4: Function Signatures for Implementation

***REMOVED******REMOVED******REMOVED*** Core Search Functions

```python
***REMOVED*** Mandatory functions for RAG system
def search_domain(domain: str, priority: List[str] = None) -> List[File]:
...
***REMOVED*** Advanced search functions
def cross_domain_impact(source_domain: str, target_domain: str) -> Dict:
...
***REMOVED*** Agent-specific functions
def load_overnight_burn_context() -> Dict:
...
***REMOVED******REMOVED*** Part 5: Search Decision Tree
...
***REMOVED******REMOVED*** Part 6: Caching and Staleness

***REMOVED******REMOVED******REMOVED*** Cache TTL (Time-To-Live) Rules
...
def is_stale(resource: str, cached_time: datetime) -> bool:
    ...
    """
    ttl_map = {
        'FILE_REGISTRY': 24 * 3600,      ***REMOVED*** 24 hours
        'MASTER_INDEX': 24 * 3600,       ***REMOVED*** 24 hours
        'domain_files': 3600,            ***REMOVED*** 1 hour
        'search_results': 1800,          ***REMOVED*** 30 minutes
        'embeddings': 7 * 24 * 3600      ***REMOVED*** 7 days
    }
...
***REMOVED******REMOVED*** Part 7: Error Handling

***REMOVED******REMOVED******REMOVED*** Common Search Scenarios
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Essential (Must Have)
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Important (Should Have)
- [ ] Pattern 5: Action item search
- [ ] Pattern 13: Task-specific retrieval
- [ ] Caching layer
- [ ] Error handling

***REMOVED******REMOVED******REMOVED*** Phase 3: Nice-to-Have (Can Have Later)
