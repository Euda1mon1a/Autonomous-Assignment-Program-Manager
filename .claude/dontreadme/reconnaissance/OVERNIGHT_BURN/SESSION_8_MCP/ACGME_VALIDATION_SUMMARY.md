***REMOVED*** SESSION_8 SEARCH_PARTY Operation - MCP ACGME Validation Summary
...
***REMOVED******REMOVED******REMOVED*** PERCEPTION: Tool Inventory
...
***REMOVED******REMOVED******REMOVED*** INVESTIGATION: Validation Rule Coverage
...
***REMOVED******REMOVED******REMOVED*** ARCANA: ACGME Domain Concepts
...
***REMOVED******REMOVED******REMOVED*** INSIGHT: Compliance Integration
...
***REMOVED******REMOVED******REMOVED*** RELIGION: Rule Accessibility
...
***REMOVED******REMOVED******REMOVED*** NATURE: Tool Granularity
...
***REMOVED******REMOVED******REMOVED*** MEDICINE: Compliance Context
...
***REMOVED******REMOVED******REMOVED*** SURVIVAL: Violation Handling
...
***REMOVED******REMOVED******REMOVED*** STEALTH: Undocumented Rules
...
***REMOVED******REMOVED*** Core ACGME Rules Reference

***REMOVED******REMOVED******REMOVED*** Rule ***REMOVED***1: 80-Hour Weekly Limit
...
***REMOVED******REMOVED******REMOVED*** Rule ***REMOVED***2: 1-in-7 Rule
...
***REMOVED******REMOVED******REMOVED*** Rule ***REMOVED***3: Supervision Ratios
...
***REMOVED******REMOVED******REMOVED*** Rule ***REMOVED***4: Availability (Absence Enforcement)
...
***REMOVED******REMOVED*** Tool Usage Matrix
...
***REMOVED******REMOVED*** Security Findings
...
***REMOVED******REMOVED******REMOVED*** Canonical Constraint Location
...
***REMOVED******REMOVED******REMOVED*** Validators (Functions)
...
***REMOVED******REMOVED******REMOVED*** How to Add New ACGME Rule
...
***REMOVED******REMOVED******REMOVED*** How to Use in MCP

```python
***REMOVED*** New rule automatically accessible via:
result = await validate_schedule_by_id_tool(
    schedule_id="...",
    constraint_config="strict"  ***REMOVED*** Includes new rule
)
```
...
***REMOVED******REMOVED*** Common Troubleshooting
...
***REMOVED******REMOVED*** Summary by SEARCH_PARTY Lenses
