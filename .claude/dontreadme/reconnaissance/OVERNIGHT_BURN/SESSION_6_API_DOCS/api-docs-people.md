***REMOVED*** People/Personnel API Documentation
...
2. [Authentication & Authorization](***REMOVED***authentication--authorization)
3. [Endpoints Reference](***REMOVED***endpoints-reference)
4. [Data Models](***REMOVED***data-models)
5. [Filtering & Pagination](***REMOVED***filtering--pagination)
6. [Credential Management](***REMOVED***credential-management)
7. [Relationships](***REMOVED***relationships)
8. [Error Handling](***REMOVED***error-handling)
9. [Usage Examples](***REMOVED***usage-examples)
10. [Implementation Details](***REMOVED***implementation-details)
...
***REMOVED******REMOVED******REMOVED*** Base Path
```
/api/people
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Resident
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Faculty
...
***REMOVED******REMOVED*** Endpoints Reference

***REMOVED******REMOVED******REMOVED*** 1. List All People
...
***REMOVED*** Filter by type
curl -X GET "http://localhost:8000/api/people?type=resident" \
  -H "Authorization: Bearer <token>"

***REMOVED*** Filter by type and PGY level
...
***REMOVED******REMOVED******REMOVED*** 2. List Residents
...
***REMOVED******REMOVED******REMOVED*** 3. List Faculty
...
***REMOVED*** Faculty with specific specialty
...
***REMOVED******REMOVED******REMOVED*** 4. Get Person by ID
...
***REMOVED******REMOVED******REMOVED*** 5. Create Person
...
***REMOVED******REMOVED******REMOVED*** 6. Update Person
...
***REMOVED******REMOVED******REMOVED*** 7. Delete Person
...
***REMOVED******REMOVED******REMOVED*** 8. Get Person Credentials
...
***REMOVED******REMOVED******REMOVED*** 9. Get Person Credential Summary
...
***REMOVED******REMOVED******REMOVED*** 10. Get Person Procedures
...
***REMOVED******REMOVED******REMOVED*** PersonResponse Schema
...
***REMOVED******REMOVED******REMOVED*** Resident Properties

**Automatic Calculations**
```python
***REMOVED*** supervision_ratio: ACGME required supervision ratio
pgy_1_resident.supervision_ratio  ***REMOVED*** Returns: 2 (1 faculty per 2 residents)
pgy_2_resident.supervision_ratio  ***REMOVED*** Returns: 4 (1 faculty per 4 residents)
pgy_3_resident.supervision_ratio  ***REMOVED*** Returns: 4 (1 faculty per 4 residents)

***REMOVED*** is_resident: Boolean check
resident.is_resident  ***REMOVED*** Returns: True
faculty.is_resident   ***REMOVED*** Returns: False
```

***REMOVED******REMOVED******REMOVED*** Faculty Properties

**Role-Based Calculations**
```python
***REMOVED*** Clinic hour limits (per role)
faculty.weekly_clinic_limit        ***REMOVED*** Returns: 0-4 depending on role
faculty.block_clinic_limit         ***REMOVED*** Returns: 0-16 depending on role

***REMOVED*** Role-specific flags
faculty.avoid_tuesday_call         ***REMOVED*** Returns: True for PD/APD only
faculty.prefer_wednesday_call      ***REMOVED*** Returns: True for Dept Chief only

***REMOVED*** Specialty checks
faculty.is_sports_medicine         ***REMOVED*** Returns: True if sports med role or specialty
faculty.role_enum                  ***REMOVED*** Returns: FacultyRole enum value
```
...
***REMOVED******REMOVED*** Filtering & Pagination

***REMOVED******REMOVED******REMOVED*** List Endpoint Filtering

The API provides filtering on list endpoints:

**Resident Filtering**
```bash
***REMOVED*** By PGY level
...
***REMOVED******REMOVED******REMOVED*** Credential Status Values
...
***REMOVED******REMOVED******REMOVED*** Competency Levels
...
***REMOVED******REMOVED******REMOVED*** Credential Limits
...
***REMOVED******REMOVED******REMOVED*** N+1 Query Optimization

The service layer provides eager-loading options:

```python
***REMOVED*** Without assignments (default, fast)
service.list_people(type="resident")

***REMOVED*** With assignments (uses selectinload to prevent N+1)
...
***REMOVED******REMOVED******REMOVED*** Common Validation Errors
...
***REMOVED******REMOVED******REMOVED*** Complete Workflow: Create and Configure Resident

```bash
***REMOVED*** 1. Create resident
...
***REMOVED*** 2. Update resident after first month
...
***REMOVED*** 3. Get updated resident
curl -X GET "http://localhost:8000/api/people/$RESIDENT_ID" \
  -H "Authorization: Bearer $TOKEN" | jq '.'

***REMOVED*** 4. Promote to PGY-2 next year
curl -X PUT "http://localhost:8000/api/people/$RESIDENT_ID" \
  -H "Authorization: Bearer $TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
***REMOVED******REMOVED******REMOVED*** Create Faculty with Procedure Credentials

```bash
***REMOVED*** 1. Create faculty
...
***REMOVED******REMOVED******REMOVED*** Database Constraints
...
**Example N+1 Problem**
```python
***REMOVED*** BAD: N+1 query (1 for people + N for assignments)
people = service.list_people()  ***REMOVED*** Default: no assignments
for person in people:
    assignments = person.assignments  ***REMOVED*** Separate query for each person!

***REMOVED*** GOOD: Single batch query with selectinload
people = service.list_people(include_assignments=True)
for person in people:
    assignments = person.assignments  ***REMOVED*** Already loaded
```
...
***REMOVED******REMOVED*** Undocumented Features & Edge Cases

***REMOVED******REMOVED******REMOVED*** Equity Tracking Fields
...
***REMOVED******REMOVED******REMOVED*** Screener Role Support
...
***REMOVED******REMOVED******REMOVED*** Target Clinical Blocks
