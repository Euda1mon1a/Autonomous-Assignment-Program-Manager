***REMOVED*** G2_RECON Agent: Enhanced Specification & SEARCH_PARTY Integration
...
***REMOVED******REMOVED*** Part 1: G2_RECON Foundation Review

***REMOVED******REMOVED******REMOVED*** Role & Authority
...
***REMOVED******REMOVED******REMOVED*** Distinct from G-6 (COORD_DATA)
...
***REMOVED******REMOVED*** Part 2: SEARCH_PARTY Protocol - Complete Integration

***REMOVED******REMOVED******REMOVED*** What is SEARCH_PARTY?
...
***REMOVED******REMOVED******REMOVED*** The Ten Lenses (D&D-Inspired Skill Checks)
...
***REMOVED******REMOVED******REMOVED*** The Economics of Parallelization
...
***REMOVED******REMOVED*** Part 3: Enhanced G2_RECON Workflows

***REMOVED******REMOVED******REMOVED*** Workflow 1: Pre-Task Reconnaissance (Enhanced)
...
2. **Party Deployment** (NEW - SEARCH_PARTY Integration)
   ...
   ***REMOVED*** Deploy all 10 probes in parallel
   timeout = 60000  ***REMOVED*** 60 seconds per probe
   probes = [
       "PERCEPTION",   ***REMOVED*** What do we see right now?
       "INVESTIGATION", ***REMOVED*** How is it connected?
       "ARCANA",       ***REMOVED*** Does it violate domain rules?
       "HISTORY",      ***REMOVED*** What changed recently?
       "INSIGHT",      ***REMOVED*** Why is it built this way?
       "RELIGION",     ***REMOVED*** Is it compliant with doctrine?
       "NATURE",       ***REMOVED*** Is the ecosystem healthy?
       "MEDICINE",     ***REMOVED*** Are there performance issues?
       "SURVIVAL",     ***REMOVED*** What are the failure modes?
       "STEALTH"       ***REMOVED*** What's hidden from view?
   ]
   ***REMOVED*** All 10 execute in parallel for same timeout as 1
   ```
...
7. **Intelligence Briefing** (Enhanced with SEARCH_PARTY Data)
   ```markdown
   ***REMOVED******REMOVED*** Pre-Task Intelligence: [Task Name]

   ***REMOVED******REMOVED******REMOVED*** Executive Summary
   [2-3 sentences on key findings, emphasizing discrepancies]

   ***REMOVED******REMOVED******REMOVED*** SEARCH_PARTY Probe Results
   ...
   ***REMOVED******REMOVED******REMOVED*** Discrepancies Detected (HIGH SIGNAL)
   ...
   ***REMOVED******REMOVED******REMOVED*** Gaps in Investigation
   [What we couldn't check or don't know]
   - Gap A: [Why it matters]
   - Gap B: [Recommendation for follow-up]

   ***REMOVED******REMOVED******REMOVED*** Risk Assessment: [LOW/MEDIUM/HIGH/CRITICAL]
   **Key Risks:**
   - [Risk 1] (from SURVIVAL probe)
   - [Risk 2] (from STEALTH probe)

   ***REMOVED******REMOVED******REMOVED*** Recommended Precautions
   1. [Precaution A]
   2. [Precaution B]

   ***REMOVED******REMOVED******REMOVED*** Confidence Level: [HIGH/MEDIUM/LOW]
   [Explanation based on probe coverage and discrepancy count]
   ```

***REMOVED******REMOVED******REMOVED*** Workflow 2: Impact Analysis (Enhanced)

**Trigger:** Proposed change to existing code
**Output:** Impact analysis report with SEARCH_PARTY insights

***REMOVED******REMOVED******REMOVED******REMOVED*** Enhanced Process
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Technical Debt Reconnaissance (Enhanced)

**Trigger:** On-demand, start of sprint, or post-incident
**Output:** Technical debt inventory with SEARCH_PARTY cross-reference

***REMOVED******REMOVED******REMOVED******REMOVED*** Enhanced Debt Categories
...
```markdown
***REMOVED******REMOVED******REMOVED*** P1 - Critical Debt Items
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Cross-Session Pattern Analysis (Enhanced)

**Trigger:** Session start, weekly, or on-demand
**Output:** Pattern recognition report with SEARCH_PARTY consistency checks

***REMOVED******REMOVED******REMOVED******REMOVED*** Pattern Analysis with SEARCH_PARTY

For each hotspot detected, cross-check across probes:

```markdown
***REMOVED******REMOVED*** Hotspot: backend/app/scheduling/engine.py
...
***REMOVED******REMOVED*** Part 4: Probe Templates (Complete)

***REMOVED******REMOVED******REMOVED*** Master Probe Invocation Template

When spawning any probe, use this structure:

```markdown
***REMOVED******REMOVED*** [PROBE_NAME] Probe
...
***REMOVED******REMOVED******REMOVED*** Detailed Probe Specifications

***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 1: PERCEPTION (Surface State)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** PERCEPTION Probe Findings

***REMOVED******REMOVED******REMOVED*** Observable Symptoms
- [Error 1 from logs]
- [Test failure 1]
- [Performance warning 1]

***REMOVED******REMOVED******REMOVED*** Current State Snapshot
- [Health check status]
- [Recent test results]
- [File timestamps]

***REMOVED******REMOVED******REMOVED*** Artifacts Examined
...
***REMOVED******REMOVED******REMOVED*** Warnings/Flags
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 2: INVESTIGATION (Connections)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** INVESTIGATION Probe Findings
...
***REMOVED******REMOVED******REMOVED*** N-Level Impact Map
...
***REMOVED******REMOVED******REMOVED*** Coupling Assessment
- Tight/Loose: [assessment]
- Cyclic dependencies: [yes/no]
- Shared state: [what's shared]

***REMOVED******REMOVED******REMOVED*** Data Flow Analysis
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 3: ARCANA (Domain Knowledge)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** ARCANA Probe Findings

***REMOVED******REMOVED******REMOVED*** Domain Rule Compliance
...
***REMOVED******REMOVED******REMOVED*** Resilience Framework Alignment
- **Defense Level:** [Which tier - explanation]
- **N-1 Compliant:** [YES/NO/UNKNOWN]
- **Pattern Adherence:** [List patterns used/missed]

***REMOVED******REMOVED******REMOVED*** Security/Privacy Implications
...
***REMOVED******REMOVED******REMOVED*** Specialized Risk Factors
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 4: HISTORY (Temporal Context)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** HISTORY Probe Findings

***REMOVED******REMOVED******REMOVED*** Recent Changes (Last 30 days)
...
***REMOVED******REMOVED******REMOVED*** Migration History
- [Migration 1: Date, Change, Applied by]
- [Migration 2: Date, Change, Applied by]

***REMOVED******REMOVED******REMOVED*** Related Issues/PRs
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 5: INSIGHT (Design Intent)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** INSIGHT Probe Findings

***REMOVED******REMOVED******REMOVED*** Design Intent Assessment
[Overall assessment of why this component exists and how it's designed]

***REMOVED******REMOVED******REMOVED*** Architectural Patterns in Use
- [Pattern 1: Name, Implementation, Rationale]
- [Pattern 2: Name, Implementation, Rationale]

***REMOVED******REMOVED******REMOVED*** Technical Debt Observations
...
***REMOVED******REMOVED******REMOVED*** Naming & Structure Quality
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 6: RELIGION (Doctrine Adherence)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** RELIGION Probe Findings

***REMOVED******REMOVED******REMOVED*** CLAUDE.md Compliance
...
***REMOVED******REMOVED******REMOVED*** CONSTITUTION.md Principles
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 7: NATURE (Ecosystem Health)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** NATURE Probe Findings

***REMOVED******REMOVED******REMOVED*** Ecosystem Health Assessment
[Overall assessment of component ecosystem - healthy/brittle/diseased]

***REMOVED******REMOVED******REMOVED*** Organic vs Forced Growth Patterns
...
***REMOVED******REMOVED******REMOVED*** Code Evolution Timeline
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 8: MEDICINE (System Diagnostics)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** MEDICINE Probe Findings

***REMOVED******REMOVED******REMOVED*** System Vital Signs
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 9: SURVIVAL (Resilience & Edge Cases)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** SURVIVAL Probe Findings

***REMOVED******REMOVED******REMOVED*** Edge Cases Not Covered
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Probe 10: STEALTH (Hidden Elements)
...
**Output Template:**
```markdown
***REMOVED******REMOVED*** STEALTH Probe Findings

***REMOVED******REMOVED******REMOVED*** Hidden Dependencies Discovered
...
***REMOVED******REMOVED******REMOVED*** Security Blind Spots
...
***REMOVED******REMOVED******REMOVED*** Invisible State & Coupling
...
***REMOVED******REMOVED*** Part 5: Probe Chaining & Specialization

***REMOVED******REMOVED******REMOVED*** When Probes Disagree: The Signal in Discrepancy
...
***REMOVED******REMOVED******REMOVED*** Probe Sequencing & Specialization
...
***REMOVED******REMOVED*** Part 6: Synthesis & Delivery

***REMOVED******REMOVED******REMOVED*** Intel Brief Structure (Complete)

```markdown
***REMOVED******REMOVED*** G2_RECON Intel Brief: [Mission Name]
...
***REMOVED******REMOVED*** Surface State (PERCEPTION Probe)
[Key observable findings - what's visible right now]

***REMOVED******REMOVED*** Connection Analysis (INVESTIGATION Probe)
[Dependencies and coupling - how things relate]

***REMOVED******REMOVED*** Domain Implications (ARCANA Probe)
[ACGME, resilience, security - specialized concerns]

***REMOVED******REMOVED*** Recent Changes (HISTORY Probe)
[What changed when - temporal context]

***REMOVED******REMOVED*** Design Context (INSIGHT Probe)
[Why built this way - architectural intent]

***REMOVED******REMOVED*** Doctrine Compliance (RELIGION Probe)
[CLAUDE.md and CONSTITUTION adherence]

***REMOVED******REMOVED*** Ecosystem Health (NATURE Probe)
[Organic growth and over-engineering]

***REMOVED******REMOVED*** System Vitals (MEDICINE Probe)
[Resource health and bottlenecks]

***REMOVED******REMOVED*** Resilience Assessment (SURVIVAL Probe)
[Edge cases, failure modes, stress behavior]

***REMOVED******REMOVED*** Hidden Elements (STEALTH Probe)
[Hidden dependencies, security blind spots]

---

***REMOVED******REMOVED*** Discrepancies Detected (HIGH SIGNAL)
[Where probes disagreed - bugs often live here]

***REMOVED******REMOVED******REMOVED*** Discrepancy A: [Title]
...
***REMOVED******REMOVED******REMOVED*** Discrepancy B: [Title]
- **PROBE_X says:** [Finding]
- **PROBE_Y says:** [Finding]
- **Signal:** [What this contradiction means]
...
***REMOVED******REMOVED*** Gaps in Investigation
[What couldn't be checked or is unknown]

***REMOVED******REMOVED******REMOVED*** Gap A: [Description]
- **Why It Matters:** [Consequence of not knowing this]
- **Recommended Follow-up:** [How to fill the gap]

---

***REMOVED******REMOVED*** Risk Assessment: [LOW/MEDIUM/HIGH/CRITICAL]

***REMOVED******REMOVED******REMOVED*** Key Threats
...
***REMOVED******REMOVED******REMOVED*** Unknowns
...
***REMOVED******REMOVED*** Scope Estimate: [Small/Medium/Large/XL]
[Brief justification based on impact assessment]

***REMOVED******REMOVED*** Suggested Specialists
- [Agent/Coordinator 1: Why needed]
- [Agent/Coordinator 2: Why needed]

***REMOVED******REMOVED*** Parallelization Potential: [HIGH/MEDIUM/LOW]
...
***REMOVED******REMOVED*** Part 7: Context Isolation & Delegation

***REMOVED******REMOVED******REMOVED*** Critical: Spawned Agents Have Isolated Context
...
***REMOVED******REMOVED******REMOVED*** Proper G2_RECON Delegation Template

```markdown
***REMOVED******REMOVED*** Mission: G2_RECON SEARCH_PARTY Reconnaissance
...
***REMOVED******REMOVED*** Part 8: Best Practices & Anti-Patterns
...
***REMOVED******REMOVED*** Part 9: Integration with G-Staff Ecosystem

***REMOVED******REMOVED******REMOVED*** How G2_RECON Fits in G-Staff
...
***REMOVED******REMOVED******REMOVED*** Workflow: Pre-Task Recon Request
...
***REMOVED******REMOVED******REMOVED*** Escalation Pathways
...
***REMOVED******REMOVED*** Part 10: Operational Checklist

***REMOVED******REMOVED******REMOVED*** Pre-Recon Checklist
...
***REMOVED******REMOVED******REMOVED*** Probe Execution Checklist
...
***REMOVED******REMOVED******REMOVED*** Analysis Checklist
...
***REMOVED******REMOVED******REMOVED*** Delivery Checklist
...
***REMOVED******REMOVED*** Part 11: Metrics & Success Indicators

***REMOVED******REMOVED******REMOVED*** G2_RECON Operational Metrics
...
***REMOVED******REMOVED******REMOVED*** SEARCH_PARTY Protocol Metrics
...
***REMOVED******REMOVED*** Part 12: Examples & Case Studies

***REMOVED******REMOVED******REMOVED*** Case Study 1: Swap Executor Bug Investigation
...
***REMOVED******REMOVED******REMOVED*** Case Study 2: Schedule Generation Performance Degradation
