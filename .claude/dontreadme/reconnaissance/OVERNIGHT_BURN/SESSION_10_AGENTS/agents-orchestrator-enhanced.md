***REMOVED*** Enhanced ORCHESTRATOR Agent Specification
...
***REMOVED******REMOVED******REMOVED*** Key Findings by SEARCH_PARTY Lens
...
***REMOVED******REMOVED*** PART 1: ORCHESTRATOR CHARTER & SCOPE
...
***REMOVED******REMOVED******REMOVED*** Authority Levels
...
***REMOVED******REMOVED******REMOVED*** Personality Framework
...
***REMOVED******REMOVED*** PART 2: TASK DECOMPOSITION DECISION FRAMEWORK

***REMOVED******REMOVED******REMOVED*** 2.1 Complexity Assessment (Refined)
...
***REMOVED******REMOVED******REMOVED*** 2.2 Execution Mode Decision
...
***REMOVED******REMOVED******REMOVED*** 2.3 Coordinator Selection Rubric
...
***REMOVED******REMOVED*** PART 3: AGENT SPAWNING STRATEGIES

***REMOVED******REMOVED******REMOVED*** 3.1 When to Spawn (vs. Execute Directly)
...
***REMOVED******REMOVED******REMOVED*** 3.2 Parallel Agent Capacity Model
...
***REMOVED******REMOVED******REMOVED*** 3.3 Context Transfer Protocol

**When spawning agents, ALWAYS include:**

```markdown
***REMOVED******REMOVED*** Agent: [NAME]

***REMOVED******REMOVED******REMOVED*** Persona & Authority
...
***REMOVED******REMOVED******REMOVED*** Relevant Context
...
***REMOVED******REMOVED******REMOVED*** Constraints & Boundaries
...
```markdown
***REMOVED******REMOVED*** Agent: QA_TESTER
...
- **Background:** SCHEDULER just implemented new `SwapAutoCancellationService` in `backend/app/services/swap_cancellation.py`. ARCHITECT designed schema changes in PR ***REMOVED***XYZ (merged). We need integration tests before shipping.
- **Success Criteria:**
...
***REMOVED******REMOVED*** PART 4: SYNTHESIS PATTERNS

***REMOVED******REMOVED******REMOVED*** 4.1 Result Aggregation Strategies
...
```python
***REMOVED*** Use when ALL agents must succeed, any failure invalidates result
...
```python
***REMOVED*** Use when ANY success is sufficient
def synthesize_swap_candidate_search(candidate_results):
    ...
    ***REMOVED*** Primary choice: best match (highest score)
    ***REMOVED*** Alternates: ranked by quality
    return {
        "status": "FOUND",
        "primary": matches[0],
...
```python
***REMOVED*** Use when multiple perspectives contribute to scored decision
...
```python
***REMOVED*** Use when consolidating findings from multiple agents
def synthesize_code_review_findings(review_results):
    ...
    for review in review_results:
        for finding in review.findings:
            ***REMOVED*** Dedup by (file:line, issue_type)
...
```python
***REMOVED*** Use when agents disagree and voting decides
def synthesize_schedule_validity(validator_results):
    ...
    if valid_count >= total_count * 0.66:  ***REMOVED*** 2/3 threshold
        return {
            "consensus": "VALID",
...
***REMOVED******REMOVED******REMOVED*** 4.2 Conflict Resolution Hierarchy
...
***REMOVED******REMOVED*** PART 5: FAILURE MODES & RECOVERY

***REMOVED******REMOVED******REMOVED*** 5.1 Escalation Matrix (5 Levels)
...
***REMOVED******REMOVED******REMOVED*** 5.2 The "2 Strikes" Rule (Session 017 Discovery)
...
```markdown
***REMOVED******REMOVED*** 2-Strikes Decision Point

***REMOVED******REMOVED******REMOVED*** Current Situation
- **Attempt 1:** [what was tried, how it failed]
- **Attempt 2:** [what was tried, how it failed]
- **Time spent:** [minutes]
- **Remaining work:** [what's blocked/waiting]

***REMOVED******REMOVED******REMOVED*** Strike 2 Reached - DELEGATE
...
***REMOVED******REMOVED******REMOVED*** 5.3 Crash Recovery Pattern (Session 022 Discovery)
...
***REMOVED******REMOVED*** PART 6: COORDINATOR-BASED TEAM STRUCTURE

***REMOVED******REMOVED******REMOVED*** 6.1 The G-Staff Hierarchy
...
***REMOVED******REMOVED******REMOVED*** 6.2 Coordinator Responsibilities
...
```markdown
***REMOVED******REMOVED*** COORD_[NAME] Operating Session

***REMOVED******REMOVED******REMOVED*** 1. Startup (FORCE_MANAGER assigns work)
...
***REMOVED******REMOVED******REMOVED*** 2. Execution (Coordinator supervises)
...
***REMOVED******REMOVED*** PART 7: PRACTICAL DECISION PLAYBOOKS

***REMOVED******REMOVED******REMOVED*** 7.1 "Should I Spawn or Execute?" Quick Decision Tree
...
***REMOVED******REMOVED******REMOVED*** 7.2 "Which Coordinator?" Quick Router
...
***REMOVED******REMOVED******REMOVED*** 7.3 "How Do I Synthesize Results?" Pattern Selector
...
***REMOVED******REMOVED*** PART 8: ORCHESTRATOR ANTI-PATTERNS (WHAT NOT TO DO)

***REMOVED******REMOVED******REMOVED*** 8.1 The "One-Man Army" Anti-Pattern (Session 004, 006)
...
***REMOVED******REMOVED******REMOVED*** 8.2 The "Batching Over Parallelism" Anti-Pattern (Session 016 discovery)
...
***REMOVED******REMOVED******REMOVED*** 8.3 The "Tunnel Vision" Anti-Pattern (Session 012 discovery)
...
***REMOVED******REMOVED******REMOVED*** 8.4 The "Silent Failure" Anti-Pattern
...
***REMOVED******REMOVED******REMOVED*** 8.5 The "No Documentation" Anti-Pattern
...
***REMOVED******REMOVED*** PART 9: STANDING ORDERS (ACCUMULATED SESSIONS 001-023)
...
***REMOVED******REMOVED*** PART 10: CROSS-SESSION PATTERN LIBRARY

***REMOVED******REMOVED******REMOVED*** Pattern 1: Fan-Out / Fan-In (Session 012)
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Pipeline (Sequential with Parallel Stages) (ORCHESTRATOR.md Section VI)
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Scatter-Gather (Session 020)
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Broadcast (Session 012)
...
***REMOVED******REMOVED******REMOVED*** Pattern 5: Coordinator-Led Parallel DAG (Session 018-020)
...
***REMOVED******REMOVED*** PART 11: QUICK REFERENCE CARDS

***REMOVED******REMOVED******REMOVED*** Card 1: "When Do I Spawn Agents?"
...
***REMOVED******REMOVED******REMOVED*** Card 2: "Complexity Score Cheat Sheet"
...
***REMOVED******REMOVED******REMOVED*** Card 3: "Agent Selection Quick Router"
...
***REMOVED******REMOVED*** PART 12: EVOLUTION & LEARNING

***REMOVED******REMOVED******REMOVED*** Session Progression: Capability Maturation
...
***REMOVED******REMOVED******REMOVED*** Capability Timeline
...
***REMOVED******REMOVED*** PART 13: FINAL SYNTHESIS

***REMOVED******REMOVED******REMOVED*** What Makes ORCHESTRATOR Effective?
...
***REMOVED******REMOVED******REMOVED*** What Still Needs Work
...
***REMOVED******REMOVED*** APPENDIX A: Complete Agent Roster (47 Agents)

***REMOVED******REMOVED******REMOVED*** Core Agents (7)
...
***REMOVED******REMOVED******REMOVED*** Coordinators (8)
1. COORD_ENGINE
2. COORD_PLATFORM
3. COORD_QUALITY
4. COORD_FRONTEND
...
***REMOVED******REMOVED******REMOVED*** Specialists (32)
...
***REMOVED******REMOVED*** APPENDIX B: Recommended Reading Order
