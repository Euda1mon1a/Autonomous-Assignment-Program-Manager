***REMOVED*** Coordinator Agent Patterns - Comprehensive Reconnaissance
***REMOVED******REMOVED*** SESSION 025 SEARCH_PARTY: G2_RECON Agent Investigation
...
***REMOVED******REMOVED******REMOVED*** Coordinator Inventory
...
***REMOVED******REMOVED*** PART I: COORDINATOR INVENTORY & SPECIFICATIONS

***REMOVED******REMOVED******REMOVED*** 1. COORD_ENGINE - Scheduling Domain Coordinator
...
***REMOVED******REMOVED******REMOVED*** 2. COORD_QUALITY - Testing & QA Domain Coordinator
...
***REMOVED******REMOVED******REMOVED*** 3. COORD_OPS - Operations & Release Domain Coordinator
...
***REMOVED******REMOVED******REMOVED*** 4. COORD_PLATFORM - Backend Infrastructure Coordinator
...
***REMOVED******REMOVED******REMOVED*** 5. COORD_FRONTEND - UI/UX Domain Coordinator
...
***REMOVED******REMOVED******REMOVED*** 6. COORD_RESILIENCE - Safety & Compliance Coordinator
...
***REMOVED******REMOVED******REMOVED*** 7. COORD_INTEL - Forensics & Investigation Coordinator
...
***REMOVED******REMOVED******REMOVED*** 8. COORD_AAR - After Action Review Coordinator
...
***REMOVED******REMOVED*** PART II: COORDINATION PATTERNS & DELEGATION STRATEGIES

***REMOVED******REMOVED******REMOVED*** Pattern 1: Sequential Pipeline (Dependencies)
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Parallel Scatter-Gather (Independence)
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Coordinator-Led Hierarchy (Force Multiplier)
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: Full-Stack Investigation (Parallel Layers)
...
***REMOVED******REMOVED******REMOVED*** Pattern 5: Feedback-Loop Validation (Iterative)
...
***REMOVED******REMOVED******REMOVED*** Pattern 6: Context Isolation (Parallel Safety)
...
***REMOVED******REMOVED*** PART III: DELEGATION AUTHORITY MATRICES

***REMOVED******REMOVED******REMOVED*** COORD_ENGINE Authority
...
***REMOVED******REMOVED******REMOVED*** COORD_QUALITY Authority
...
***REMOVED******REMOVED******REMOVED*** COORD_OPS Authority
...
***REMOVED******REMOVED******REMOVED*** COORD_PLATFORM Authority
...
***REMOVED******REMOVED******REMOVED*** COORD_RESILIENCE Authority
...
***REMOVED******REMOVED******REMOVED*** COORD_INTEL Authority
...
***REMOVED******REMOVED******REMOVED*** COORD_AAR Authority
...
***REMOVED******REMOVED*** PART IV: XO (Executive Officer) PATTERN
...
***REMOVED******REMOVED******REMOVED*** XO Responsibilities
...
***REMOVED******REMOVED******REMOVED*** XO Report Format

```markdown
***REMOVED******REMOVED*** COORD_[NAME] XO Report - [Date]
...
***REMOVED******REMOVED*** PART V: COORDINATOR SIGNAL PATTERNS

***REMOVED******REMOVED******REMOVED*** Broadcast Signals (From ORCHESTRATOR to Coordinators)
...
***REMOVED******REMOVED******REMOVED*** Cascade Signals (From Coordinator to Managed Agents)
...
***REMOVED******REMOVED*** PART VI: BEST PRACTICES & ANTI-PATTERNS

***REMOVED******REMOVED******REMOVED*** Best Practices

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. **Self-Contained Delegation**
...
```markdown
***REMOVED******REMOVED*** Task for SCHEDULER

***REMOVED******REMOVED******REMOVED*** Mission
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. **Parallel Spawning for Independence**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. **Force Multiplier Hierarchy**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. **Result Synthesis Strategy**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. **Escalation Clarity**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1. **One-Man Army** (ORCHESTRATOR doing all work)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. **Over-Delegation** (Delegating for delegation's sake)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. **Context Loss** (Incomplete handoff)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. **Circular Dependencies** (Agent A → B → A)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. **Unbounded Parallelism** (Spawn unlimited agents)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 6. **Late Escalation** (Discovering blocker after spawning)
...
***REMOVED******REMOVED*** PART VII: COORDINATOR COORDINATION PATTERNS

***REMOVED******REMOVED******REMOVED*** Pattern 1: Handoff Between Coordinators
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: Parallel Coordinator Operations
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: Coordinator Escalation
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: XO Cross-Reporting
...
***REMOVED******REMOVED*** PART VIII: SESSION LIFECYCLE WITH COORDINATORS
...
***REMOVED******REMOVED******REMOVED*** During Session (Steady State)
...
***REMOVED******REMOVED******REMOVED*** Session Closure
...
***REMOVED******REMOVED*** PART IX: COORDINATION DISCOVERY TIMELINE

***REMOVED******REMOVED******REMOVED*** Session 001-004: Foundation (3 Coordinators)
...
***REMOVED******REMOVED******REMOVED*** Session 005: Platform Expansion (6 Coordinators)
...
***REMOVED******REMOVED******REMOVED*** Session 016: Force Multiplier Pattern
...
***REMOVED******REMOVED******REMOVED*** Session 018: COORD_INTEL (Forensics)
...
***REMOVED******REMOVED******REMOVED*** Session 019: G-Staff Organizational Expansion
...
***REMOVED******REMOVED*** PART X: COORDINATOR SPAN OF CONTROL

***REMOVED******REMOVED******REMOVED*** Recommended Agent Allocation
...
***REMOVED******REMOVED*** PART XI: CRITICAL INSIGHTS

***REMOVED******REMOVED******REMOVED*** Context Isolation Revelation (Session 016)
...
***REMOVED******REMOVED******REMOVED*** Force Multiplier Pattern (Session 020)
...
***REMOVED******REMOVED******REMOVED*** Crash Resilience Pattern (Session 022)
...
***REMOVED******REMOVED*** PART XII: HANDOFF CONTINUITY

***REMOVED******REMOVED******REMOVED*** Scratchpad Files as Institutional Memory
...
***REMOVED******REMOVED******REMOVED*** Handoff Prompt Components

Every session handoff should include:

```markdown
***REMOVED******REMOVED*** Session Handoff Summary

**Session ID:** [XXX]
**Date:** [ISO date]
**Work Completed:** [1-3 sentences]

***REMOVED******REMOVED******REMOVED*** Key Accomplishments
- [Accomplishment 1]
- [Accomplishment 2]

***REMOVED******REMOVED******REMOVED*** Open PRs
- PR ***REMOVED***XXX: [title] - [status]

***REMOVED******REMOVED******REMOVED*** Uncommitted Changes
- [File 1]: [summary]

***REMOVED******REMOVED******REMOVED*** Priority for Next Session
1. [P0 item]
2. [P1 item]

***REMOVED******REMOVED******REMOVED*** Context for Next ORCHESTRATOR
- [Key insight 1]
- [Key insight 2]

***REMOVED******REMOVED******REMOVED*** Files to Read
- [Relevant file 1]
- [Relevant file 2]
```
...
***REMOVED******REMOVED******REMOVED*** Coordinator Inventory (8 Total)
...
***REMOVED******REMOVED******REMOVED*** Key Patterns (5 Total)
...
***REMOVED******REMOVED******REMOVED*** Best Practices (6 Total)
...
***REMOVED******REMOVED******REMOVED*** Anti-Patterns (6 Total)
