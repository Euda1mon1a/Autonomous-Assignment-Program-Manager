***REMOVED*** HISTORIAN Quick Reference Card
...
***REMOVED******REMOVED*** When to Invoke HISTORIAN
...
***REMOVED******REMOVED*** Six Chronicle Patterns

***REMOVED******REMOVED******REMOVED*** Pattern 1: The Revelation
...
***REMOVED******REMOVED******REMOVED*** Pattern 2: The Paradigm Shift
...
***REMOVED******REMOVED******REMOVED*** Pattern 3: The Gap-Filling
...
***REMOVED******REMOVED******REMOVED*** Pattern 4: The Enterprise Scale
...
***REMOVED******REMOVED******REMOVED*** Pattern 5: The Data Integrity
...
***REMOVED******REMOVED******REMOVED*** Pattern 6: The Cross-Disciplinary
...
***REMOVED******REMOVED*** Six Narrative Techniques
...
***REMOVED******REMOVED*** Quality Gate Checklist (Pre-Publication)
...
***REMOVED******REMOVED*** Delegation Template (Minimal)
...
Artifacts: PR ***REMOVED***XXX, Commits: abc123d, Files: [list]
```

---

***REMOVED******REMOVED*** Selection Scoring Examples

***REMOVED******REMOVED******REMOVED*** Example 1: Block Revelation (Session 014)
...
***REMOVED******REMOVED******REMOVED*** Example 2: Routine Bug Fix
...
***REMOVED******REMOVED******REMOVED*** Example 3: New Feature Completed
...
***REMOVED******REMOVED******REMOVED*** Example 4: Paradigm Shift (Session 016)
...
***REMOVED******REMOVED*** Session vs. Chronicle Guide
...
***REMOVED******REMOVED*** ORCHESTRATOR Decision Flow
...
***REMOVED******REMOVED*** Seven Questions to Ask
...
***REMOVED******REMOVED*** Tone Checklist
