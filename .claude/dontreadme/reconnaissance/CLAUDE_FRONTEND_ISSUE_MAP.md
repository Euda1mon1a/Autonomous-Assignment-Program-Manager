***REMOVED*** Frontend Issue Map (Claude Code)

Purpose: map reported UI issues to likely source files and propose concrete fixes.

***REMOVED******REMOVED*** 1) “View full schedule” link broken
...
***REMOVED******REMOVED*** 2) Templates page shows placeholders / weak fields
...
***REMOVED******REMOVED*** 3) Absences list appears empty
...
***REMOVED******REMOVED*** 4) “My Schedule” redirects to login
...
***REMOVED******REMOVED*** 5) “Add People” modal closes after 1 character (X button focus)
...
***REMOVED******REMOVED*** 6) Block view hard limits should not be user-settable
...
***REMOVED******REMOVED*** Suggested Next Step Order (Fastest UX Wins)
