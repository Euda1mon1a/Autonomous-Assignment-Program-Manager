***REMOVED*** Session 025 Quick Reference Index
...
***REMOVED******REMOVED*** When You Need...

***REMOVED******REMOVED******REMOVED*** A Quick Parallel Task
...
***REMOVED*** Auto-spawns 3-5 agents in parallel
***REMOVED*** Synthesizes findings
```

---

***REMOVED******REMOVED******REMOVED*** To Understand Parallelization
...
***REMOVED******REMOVED******REMOVED*** To Understand a Specific Signal Type
...
***REMOVED******REMOVED******REMOVED*** To Clarify Explore vs G2_RECON
...
***REMOVED******REMOVED******REMOVED*** To Define a Parallel Task with Dependencies
...
{
    "content": str,
    "parallel_group": str,       ***REMOVED*** Tasks in same group run together
    "can_merge_after": [str],    ***REMOVED*** Task dependencies
    "blocks": [str],             ***REMOVED*** What this task unblocks
    "stream": str,               ***REMOVED*** Stream assignment (A-E)
    "terminal": int,             ***REMOVED*** Terminal assignment (1-10)
}
```

---

***REMOVED******REMOVED******REMOVED*** To Set Up a 10-Terminal Session
...
***REMOVED******REMOVED******REMOVED*** To Know What Model Tier to Use
...
***REMOVED******REMOVED******REMOVED*** To Find What Skills Can Run in Parallel
...
***REMOVED******REMOVED******REMOVED*** To Understand Result Streaming vs Signal Propagation
...
***REMOVED******REMOVED******REMOVED*** To Resuming an Interrupted Marathon Session
...
***REMOVED******REMOVED******REMOVED*** To Report Progress from Your Agent
...
***REMOVED******REMOVED******REMOVED*** To Coordinate with Other Parallel Agents
...
***REMOVED******REMOVED******REMOVED*** To Batch-Read Multiple Files (Speculative Parallelism)

**Pattern:** Level 4 of PARALLELISM_FRAMEWORK

```python
***REMOVED*** Old (sequential)
...
***REMOVED*** New (speculative, parallel)
...
***REMOVED******REMOVED******REMOVED*** To Understand How This All Fits Together
...
***REMOVED******REMOVED*** File Locations Quick Map
...
***REMOVED******REMOVED*** Key Vocabulary
...
***REMOVED******REMOVED*** Signal Types at a Glance

***REMOVED******REMOVED******REMOVED*** Result Streaming (Single Agent → Visibility)
...
***REMOVED******REMOVED******REMOVED*** Signal Propagation (Agent ↔ Agent Coordination)
...
***REMOVED******REMOVED******REMOVED*** Pattern: Independent Parallel Tasks
```
Skill A --+
...
***REMOVED******REMOVED******REMOVED*** Pattern: Sequential with Handoff
```
...
***REMOVED******REMOVED******REMOVED*** Pattern: Level 3 Integration Point
```
Stream A ──┐
...
***REMOVED******REMOVED*** Decision Tree: Which Pattern to Use?
