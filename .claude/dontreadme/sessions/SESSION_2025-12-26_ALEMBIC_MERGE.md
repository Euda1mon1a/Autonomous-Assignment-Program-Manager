***REMOVED*** Alembic Migration Merge: Block0 and Main Heads
...
```python
***REMOVED*** backend/alembic/versions/e46cd3bee350_merge_block0_and_main_heads.py
revision = 'e46cd3bee350'
down_revision = ('20251226_block0', '9c693e414966')  ***REMOVED*** Tuple = merge
```
...
```bash
***REMOVED*** Check for multiple heads
alembic heads

***REMOVED*** Create merge migration (auto-generated)
