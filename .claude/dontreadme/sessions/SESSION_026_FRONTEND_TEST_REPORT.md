***REMOVED*** Frontend Test Coverage Analysis Report
***REMOVED******REMOVED*** Session 026 - Marathon Plan
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Coverage Collection Misconfiguration ⚠️
**PRIORITY: CRITICAL**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Missing Source Files (Test Orphans)
**PRIORITY: HIGH**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Test Configuration Issues
...
***REMOVED******REMOVED******REMOVED*** 1. Test Infrastructure Status
...
***REMOVED******REMOVED******REMOVED*** 2. Source File Inventory

***REMOVED******REMOVED******REMOVED******REMOVED*** By Category
...
***REMOVED******REMOVED******REMOVED*** 3. Components Without Tests

***REMOVED******REMOVED******REMOVED******REMOVED*** High Priority (Core User Flows)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Medium Priority (Supporting Features)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Low Priority (Edge Features)
...
***REMOVED******REMOVED******REMOVED*** 4. Hooks Without Tests
...
***REMOVED******REMOVED******REMOVED*** 5. Feature Modules Status
...
***REMOVED******REMOVED******REMOVED*** 6. Contexts Status
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Fix Critical Infrastructure (Week 1)

***REMOVED******REMOVED******REMOVED******REMOVED*** 1.1 Update Jest Coverage Configuration
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1.2 Resolve Missing Source Files
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1.3 Fix Module Resolution Errors
...
***REMOVED******REMOVED******REMOVED*** Phase 2: High-Priority Test Coverage (Weeks 2-3)

Target components by user impact and criticality:

***REMOVED******REMOVED******REMOVED******REMOVED*** 2.1 Core User Flow Tests (Target: 90% coverage)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2.2 Form Component Tests (Week 3, Days 4-5)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Feature Module Completion (Weeks 4-5)

***REMOVED******REMOVED******REMOVED******REMOVED*** 3.1 Conflicts Feature (Week 4, Days 1-2)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3.2 Import/Export Feature (Week 4, Days 3-4)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3.3 Call Roster Feature (Week 4, Day 5)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3.4 FMIT Timeline (Week 5, Days 1-2)
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Hook Testing (Week 5, Days 3-4)
...
***REMOVED******REMOVED******REMOVED*** Phase 5: Admin & Advanced Features (Week 5, Day 5)
...
***REMOVED******REMOVED******REMOVED*** Phase 6: Edge Cases & Polish (Week 6)
...
***REMOVED******REMOVED*** Test Writing Guidelines
...
***REMOVED******REMOVED******REMOVED*** Coverage Targets
...
***REMOVED******REMOVED******REMOVED*** Test Quality Metrics
...
***REMOVED******REMOVED*** Action Items Summary
...
***REMOVED******REMOVED******REMOVED*** High Priority (Next 2 Weeks)
...
***REMOVED******REMOVED******REMOVED*** Medium Priority (Weeks 4-5)
...
***REMOVED******REMOVED******REMOVED*** Low Priority (Week 6)
...
***REMOVED******REMOVED******REMOVED*** Test Command Reference
...
***REMOVED*** Run tests for changed files only
npm test -- --onlyChanged

***REMOVED*** Update snapshots
npm test -- -u

***REMOVED*** Run with verbose output
npm test -- --verbose

***REMOVED*** CI mode (no watch, coverage required)
npm run test:ci
```

***REMOVED******REMOVED******REMOVED*** Useful Testing Utilities
