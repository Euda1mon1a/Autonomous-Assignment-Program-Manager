***REMOVED*** Session: Block Schedule Import - Anchor-Based Fuzzy-Tolerant Excel Parser
...
***REMOVED******REMOVED*** Solution: Anchor-Based Fuzzy-Tolerant Parser
...
```python
***REMOVED*** Traditional (brittle):
template_col = 0  ***REMOVED*** Assumes column A always has templates

***REMOVED*** Anchor-based (robust):
...
***REMOVED******REMOVED******REMOVED*** 1. `backend/app/schemas/block_import.py`
Pydantic schemas for type-safe API responses:

```python
class ResidentRosterItem(BaseModel):
    name: str           ***REMOVED*** "Last, First" format
    template: str       ***REMOVED*** R1, R2, R3
    role: str           ***REMOVED*** PGY 1, PGY 2, PGY 3, FAC
    row: int            ***REMOVED*** Source spreadsheet row
    confidence: float   ***REMOVED*** 0.0-1.0 match confidence
...
***REMOVED******REMOVED******REMOVED*** 2. `backend/app/services/block_markdown.py`
...
***REMOVED******REMOVED******REMOVED*** 3. `backend/app/cli/block_import_commands.py`
Typer CLI with Rich table output:

```bash
***REMOVED*** Parse block and show roster
python -m app.cli.block_import_commands parse schedule.xlsx 10

***REMOVED*** Output as JSON
...
***REMOVED*** Show just roster filtered by template
python -m app.cli.block_import_commands roster schedule.xlsx 10 -t R3

***REMOVED*** Show FMIT schedule
python -m app.cli.block_import_commands fmit schedule.xlsx
```

***REMOVED******REMOVED******REMOVED*** 4. `.claude/skills/managed/import-block.md`
...
***REMOVED******REMOVED******REMOVED*** `backend/app/api/routes/schedule.py`
...
async def import_block_schedule(
    ...
    known_people: str = Form("[]"),  ***REMOVED*** JSON array for fuzzy matching
    current_user: User = Depends(get_current_active_user),
):
```

***REMOVED******REMOVED******REMOVED*** `backend/app/services/xlsx_import.py` (earlier in session)
Added:
...
***REMOVED******REMOVED*** Domain Knowledge Captured

***REMOVED******REMOVED******REMOVED*** Block 10 Schedule (Mar 12 - Apr 8, 2025)
...
- Week 1: Dr. Chu
- Week 2: Dr. Faculty-J-Last
- Week 3: Dr. Chu
- Week 4: Dr. Faculty-D-Last
...
***REMOVED******REMOVED******REMOVED*** Excel Structure Insights
...
***REMOVED******REMOVED******REMOVED*** CLI Test Results
...
***REMOVED******REMOVED******REMOVED*** Markdown Generated
...
***REMOVED******REMOVED******REMOVED*** Why Anchor-Based Parsing?
...
***REMOVED******REMOVED******REMOVED*** CLI Database Workaround
