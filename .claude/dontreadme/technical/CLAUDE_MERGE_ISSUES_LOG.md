...
***REMOVED******REMOVED*** High-risk / history-reconciliation merges
...
***REMOVED******REMOVED*** Recommended fixes for high-risk merges
...
***REMOVED******REMOVED*** Local "merge main" (non‑PR) commits
...
- Standard PR merges (`Merge pull request ***REMOVED***...`) are excluded; those are normal.
