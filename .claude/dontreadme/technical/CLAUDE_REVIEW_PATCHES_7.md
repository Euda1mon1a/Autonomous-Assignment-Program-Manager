***REMOVED*** Review Patches for Claude (Schedule Run Persistence)
...
***REMOVED******REMOVED*** Patch 1) Defer deletions until after a successful solve
...
+            ***REMOVED*** Defer deletion until after a successful solve
@@
...
+            if not solver_result.success:
+                ***REMOVED*** Do not delete existing assignments on failure
...
+                }
+
+            ***REMOVED*** Delete existing assignments only after a successful solve
+            self._delete_existing_assignments(preserve_ids=preserve_ids)
+
...
***REMOVED******REMOVED*** Patch 2) Add `schedule_run_id` to assignments
...
***REMOVED******REMOVED*** Minimal verification
