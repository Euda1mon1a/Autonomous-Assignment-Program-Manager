***REMOVED***!/bin/bash
***REMOVED*** Session Start Hook - Environment Verification
***REMOVED*** Runs at the beginning of each Claude Code session
...
***REMOVED*** Display current git branch prominently
if [ -d "$PROJECT_ROOT/.git" ]; then
    ...
    if [ -n "$CURRENT_BRANCH" ]; then
        ...
        ***REMOVED*** Warn if on main/master
        ...
        ***REMOVED*** Check if branch is tracking a remote
        ...
        if [ -z "$UPSTREAM" ]; then
            ...
            ***REMOVED*** Branch has upstream, verify it exists on remote
...
***REMOVED*** Verify critical files exist
CRITICAL_FILES=(
    "CLAUDE.md"
...
***REMOVED*** Display AI rules at session start
RULES_FILES=(
    "CLAUDE.md"
    "docs/development/AI_RULES_OF_ENGAGEMENT.md"
    "docs/development/CLAUDE_GIT_SAFE_SYNC_CHECKLIST.md"
...
***REMOVED*** Check for debug session notes from previous sessions
...
***REMOVED*** Check if Docker is running (optional)
