...
***REMOVED*** Format code with Black
black app/ tests/ --line-length 88

***REMOVED*** Auto-fix linting issues with Ruff
ruff check app/ tests/ --fix

***REMOVED*** Check for remaining Ruff issues
ruff check app/ tests/

***REMOVED*** Run type checking with mypy (optional, informational)
