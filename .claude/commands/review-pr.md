...
Review pull request ***REMOVED***$ARGUMENTS with comprehensive analysis:
...
***REMOVED*** Get PR information
gh pr view $ARGUMENTS

***REMOVED*** Get PR diff
gh pr diff $ARGUMENTS

***REMOVED*** Check out the PR branch locally (optional)
gh pr checkout $ARGUMENTS

***REMOVED*** Run tests on the PR branch
cd backend
pytest -v

***REMOVED*** Run linting checks
ruff check app/ tests/
black app/ tests/ --check

***REMOVED*** Check for ACGME compliance if relevant
pytest -m acgme -v
```
...
***REMOVED******REMOVED*** Specific Concerns
