...
***REMOVED*** Check Celery worker status (if running)
...
***REMOVED******REMOVED*** Critical Alerts
...
***REMOVED******REMOVED*** Performance Indicators
...
```bash
***REMOVED*** Start all services with Docker Compose
docker-compose up -d

***REMOVED*** Or start backend directly
cd backend
