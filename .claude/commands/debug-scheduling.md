...
***REMOVED*** Debug Scheduling Issue: $ARGUMENTS

Follow this systematic debugging workflow:

***REMOVED******REMOVED*** Phase 1: Exploration (DO NOT FIX YET)
...
***REMOVED*** Check recent scheduler logs for errors
...
***REMOVED*** Review scheduling-related test failures
...
***REMOVED******REMOVED*** Phase 2: Planning (Think Hard)
...
***REMOVED******REMOVED*** Phase 3: Reproduce with Tests
...
***REMOVED*** Create test in tests/scheduling/test_debug_[issue].py
***REMOVED*** The test should fail with the exact error being investigated
...
***REMOVED******REMOVED*** Phase 4: Add Diagnostic Logging

Inject temporary logging to observe runtime behavior:

```python
***REMOVED*** Add to relevant function
import logging
...
***REMOVED******REMOVED*** Phase 5: Implement Fix
...
***REMOVED******REMOVED*** Phase 6: Validate & Document
...
***REMOVED******REMOVED*** Checkpoint Commands
...
***REMOVED******REMOVED*** Common Scheduling Issues
...
***REMOVED******REMOVED*** Important Reminders
