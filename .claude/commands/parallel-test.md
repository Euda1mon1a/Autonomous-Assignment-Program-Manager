...
```
/parallel-test                           ***REMOVED*** Run all tests
/parallel-test backend/app/services/     ***REMOVED*** Test specific path
/parallel-test --coverage=80             ***REMOVED*** Enforce coverage threshold
/parallel-test --quick                   ***REMOVED*** Fast subset only
```
