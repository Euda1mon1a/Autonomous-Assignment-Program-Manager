***REMOVED*** TEST RUNNER FRAMEWORK - Execution & Reporting
...
***REMOVED******REMOVED*** Test Execution Model

***REMOVED******REMOVED******REMOVED*** Phase 1: Preparation (5 minutes)
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Execution (varies by test)
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Validation (2-5 minutes)
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Cleanup (1-2 minutes)
...
***REMOVED******REMOVED*** Test Configuration

***REMOVED******REMOVED******REMOVED*** Environment Variables

```bash
***REMOVED*** Test runner configuration
TEST_LOG_DIR=test_logs          ***REMOVED*** Where to store logs
TEST_DB_PATH=test_results.db    ***REMOVED*** SQLite results database
TEST_TIMEOUT_MULTIPLIER=1.5     ***REMOVED*** Extend timeouts in slow environments
TEST_PARALLEL=true              ***REMOVED*** Run compatible tests in parallel

***REMOVED*** Test-specific settings
CHAOS_PROBE_COUNT=10            ***REMOVED*** Probes per chaos test
SCALING_BASELINE_AGENTS=10      ***REMOVED*** Agents for baseline test
QUALITY_TEST_CASES=10           ***REMOVED*** Test cases per quality test
INTEGRATION_PROTOCOLS=4         ***REMOVED*** Protocols for integration test

***REMOVED*** Resource limits
MAX_CPU_PERCENT=90              ***REMOVED*** Max CPU usage
MAX_MEMORY_MB=8192              ***REMOVED*** Max memory (8GB)
MAX_API_CALLS=400               ***REMOVED*** Max API calls per test
DISK_SPACE_MIN_GB=10            ***REMOVED*** Minimum free disk space required

***REMOVED*** Logging
LOG_LEVEL=INFO                  ***REMOVED*** INFO, DEBUG, TRACE
LOG_FORMAT=json                 ***REMOVED*** json, text, compact
```

***REMOVED******REMOVED******REMOVED*** Configuration File

```yaml
***REMOVED*** .claude/tests/test_config.yaml

test_runner:
  mode: standard              ***REMOVED*** standard, parallel, serial
...
***REMOVED******REMOVED*** Execution Workflows

***REMOVED******REMOVED******REMOVED*** Workflow 1: Full Suite (All Tests)
...
***REMOVED******REMOVED******REMOVED*** Workflow 2: Quick Validation (Smoke Tests)
...
***REMOVED******REMOVED******REMOVED*** Workflow 3: Continuous Integration (Daily)

```bash
***REMOVED*** Run on schedule (e.g., nightly)
...
***REMOVED******REMOVED******REMOVED*** Workflow 4: Targeted Testing (Single Suite)

```bash
***REMOVED*** Run just chaos tests
./test_runners/test_chaos.sh --all

***REMOVED*** Run just scaling tests
./test_runners/test_scaling.sh --all

***REMOVED*** Run just quality tests
./test_runners/test_quality.sh --all

***REMOVED*** Run just integration tests
./test_runners/test_integration.sh --all
```

---

***REMOVED******REMOVED*** Execution Examples

***REMOVED******REMOVED******REMOVED*** Example 1: Run Baseline Scaling Test
...
***REMOVED******REMOVED******REMOVED*** Example 2: Run Chaos Timeout Test
...
***REMOVED******REMOVED******REMOVED*** Example 3: Run Quality Output Validation
...
***REMOVED******REMOVED*** Real-Time Monitoring

***REMOVED******REMOVED******REMOVED*** Dashboard View
...
***REMOVED******REMOVED******REMOVED*** CLI Monitoring

```bash
***REMOVED*** Watch logs in real-time
...
***REMOVED******REMOVED******REMOVED******REMOVED*** HTML Report
...
***REMOVED******REMOVED******REMOVED******REMOVED*** JSON Report
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Console Report
...
***REMOVED******REMOVED******REMOVED*** Test Fails

```bash
***REMOVED*** Check test logs
cat test_logs/{test_name}.log | tail -100

***REMOVED*** Enable debug mode
./test_runners/run_test.sh --test={test_name} --debug

***REMOVED*** Extract metrics from failure
jq '.metrics' test_logs/{test_name}_metrics.json

***REMOVED*** Replay test with same seed (reproducible failure)
./test_runners/run_test.sh --test={test_name} --seed=12345
```

***REMOVED******REMOVED******REMOVED*** Test Hangs

```bash
***REMOVED*** Check orchestrator status
curl http://localhost:8000/health

***REMOVED*** Kill hung test
pkill -f test_runner

***REMOVED*** Check for resource exhaustion
free -h  ***REMOVED*** Memory
df -h    ***REMOVED*** Disk
top -b -n 1 | head -15  ***REMOVED*** Processes
```

***REMOVED******REMOVED******REMOVED*** Test Timeout

```bash
***REMOVED*** Increase timeout
./test_runners/run_test.sh --test={test_name} --timeout=600

***REMOVED*** Check slow systems
...
***REMOVED******REMOVED******REMOVED*** Jenkins Pipeline
...
***REMOVED******REMOVED*** Summary Template

***REMOVED******REMOVED******REMOVED*** Test Completion Report
