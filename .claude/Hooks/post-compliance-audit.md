***REMOVED*** Post-Compliance Audit Hook
...
***REMOVED******REMOVED******REMOVED*** 1. Audit Metadata
...
***REMOVED******REMOVED******REMOVED*** 2. Overall Compliance Score
...
***REMOVED******REMOVED******REMOVED*** 3. 80-Hour Rule Violations
...
***REMOVED******REMOVED******REMOVED*** 4. 1-in-7 Rule Violations
...
***REMOVED******REMOVED******REMOVED*** 5. Supervision Ratio Violations
...
***REMOVED******REMOVED******REMOVED*** 6. Duty Period Violations
...
***REMOVED******REMOVED******REMOVED*** 7. Trend Data
...
***REMOVED******REMOVED******REMOVED*** 8. Recommendations
...
***REMOVED******REMOVED******REMOVED*** 9. People-Level Summary
...
***REMOVED******REMOVED******REMOVED*** 10. Rotation-Level Analysis
...
***REMOVED******REMOVED******REMOVED*** Audit Logs
...
***REMOVED******REMOVED******REMOVED*** Latest Audit

**Location:** `.claude/History/compliance/LATEST.json`

**Purpose:** Symlink to most recent audit

***REMOVED******REMOVED******REMOVED*** Monthly Compliance Report
...
```markdown
***REMOVED*** ACGME Compliance Report - December 2025
...
***REMOVED******REMOVED*** Violations Summary
...
***REMOVED******REMOVED******REMOVED*** Compliance Dashboard Data
...
***REMOVED******REMOVED******REMOVED*** ACGME Compliance Skill
...
***REMOVED******REMOVED******REMOVED*** Schedule Verification Skill
...
***REMOVED******REMOVED*** Example Usage in Claude Session
...
***REMOVED******REMOVED*** Regulatory Compliance Notes

***REMOVED******REMOVED******REMOVED*** ACGME Documentation Requirements
...
***REMOVED******REMOVED******REMOVED*** Accreditation Preparation
...
***REMOVED******REMOVED*** Analytics Use Cases
