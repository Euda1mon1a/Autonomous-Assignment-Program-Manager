***REMOVED*** Skipped Tests Quick Reference
...
***REMOVED******REMOVED*** DEBT-016 Unskip Checklist
...
***REMOVED******REMOVED*** CI Configuration

```bash
***REMOVED*** Main test suite (skip optional deps)
pytest tests/ --ignore=tests/unit/test_contagion_model.py ...

***REMOVED*** With optional deps (requires pip install ndlib networkx scikit-learn)
pytest tests/

***REMOVED*** Integration only (requires Docker)
