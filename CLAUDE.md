...
***REMOVED******REMOVED******REMOVED*** Healthcare Context
...
***REMOVED******REMOVED******REMOVED*** Healthcare Data Protection
...
raise HTTPException(
    status_code=400,
    detail=f"Person {person_id} has SSN {person.ssn}"  ***REMOVED*** PHI leaked!
)
```
