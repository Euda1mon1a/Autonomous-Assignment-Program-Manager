...
class AdminUser(HttpUser):
    ...
    wait_time = between(2, 8)  ***REMOVED*** Longer think time for complex operations
    ...
    def view_dashboard(self):
        ...
        ***REMOVED*** Multiple dashboard endpoints
        endpoints = [
    ...
    def manage_users(self):
        ...
        ***REMOVED*** List users with filters
    ...
    def create_person(self):
        ...
        with self.client.post(
            ...
            if response.status_code == 201:
                ...
                ***REMOVED*** Conflict (duplicate) is expected in load test
                response.success()
            else:
    ...
    def create_rotation(self):
        ...
        rotation_data = {
            ...
            'color': '***REMOVED***' + ''.join([random.choice('0123456789ABCDEF') for _ in range(6)])
        }
    ...
    def generate_schedule(self):
        ...
        with self.client.post(
            ...
            timeout=60  ***REMOVED*** Longer timeout for expensive operation
        ) as response:
    ...
    def export_data(self):
        ...
        ***REMOVED*** List schedules for export
        self.client.get(
            '/api/v1/schedules',
            headers=self.get_headers(),
