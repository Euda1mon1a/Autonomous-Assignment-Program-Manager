...
class MixedWorkloadUser(HttpUser):
    ...
    ***REMOVED*** Wait between 1-5 seconds between tasks
    wait_time = between(1, 5)

    ***REMOVED*** Weight distribution
    ***REMOVED*** Note: Locust uses these proportions when spawning users
    admin_weight = 10
    faculty_weight = 30
    resident_weight = 60
...
***REMOVED*** Event listeners for custom metrics
...
def on_request(request_type, name, response_time, response_length, exception, **kwargs):
    ...
    ***REMOVED*** Custom metrics can be tracked here
    if exception:
        print(f'Request failed: {name} - {exception}')


***REMOVED*** Example custom shape for specific load patterns
...
class StepLoadShape(LoadTestShape):
    ...
    """
    step_time = 60  ***REMOVED*** Seconds per step
    step_load = 10  ***REMOVED*** Users to add per step
    spawn_rate = 2  ***REMOVED*** Users per second spawn rate
    time_limit = 600  ***REMOVED*** Total test time in seconds
...
class SpikeLoadShape(LoadTestShape):
    ...
    def tick(self):
        ...
        if run_time < 60:
            ...
            ***REMOVED*** Spike to 100 users
            return 100, 10
        elif run_time < 180:
            ***REMOVED*** Hold spike
            return 100, 10
        elif run_time < 240:
            ***REMOVED*** Drop back to baseline
            return 20, 5
        else:
            ***REMOVED*** Cool down
            return 10, 2
...
***REMOVED*** To use a specific shape, run:
***REMOVED*** locust -f locustfile.py --host=http://localhost:8000 --shape=StepLoadShape
