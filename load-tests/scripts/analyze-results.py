...
class ResultsAnalyzer:
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        ***REMOVED*** Error rate recommendations
        ...
        ***REMOVED*** Check rate recommendations
    ...
    def print_report(self):
        ...
        ***REMOVED*** Exit code based on thresholds
...
def main():
    ...
    ***REMOVED*** Save JSON output if requested
    if args.output:
