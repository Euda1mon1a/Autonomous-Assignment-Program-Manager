***REMOVED***!/bin/bash
***REMOVED***
***REMOVED*** Load Test Runner Script
***REMOVED*** Runs all rate limiting and authentication security tests
***REMOVED***
***REMOVED*** Usage:
***REMOVED***   ./run-load-tests.sh [options]
***REMOVED***
***REMOVED*** Options:
***REMOVED***   --rate-limit-only    Run only rate limiting attack tests
***REMOVED***   --auth-only          Run only authentication security tests
***REMOVED***   --base-url URL       Override base URL (default: http://localhost:8000)
***REMOVED***   --results-dir DIR    Output directory for results (default: results/)
***REMOVED***   --skip-wait          Skip cooldown period between tests
***REMOVED***
...
***REMOVED*** Ensure results directory exists
mkdir -p "$RESULTS_DIR"

***REMOVED*** Timestamp for result files
...
***REMOVED*** Check if k6 is installed
...
***REMOVED*** Check if application is running
...
***REMOVED*** Display test configuration
echo "================================================================================"
...
***REMOVED*** Function to run a test
run_test() {
    local test_name=$1
    local test_file=$2
    local output_file=$3
...
***REMOVED*** Track overall status
OVERALL_STATUS=0

***REMOVED*** Run Rate Limit Attack Tests
if [ "$RUN_RATE_LIMIT" = true ]; then
    ...
    ***REMOVED*** Cooldown period between tests
...
***REMOVED*** Run Authentication Security Tests
...
***REMOVED*** Display quick metrics summary if jq is available
