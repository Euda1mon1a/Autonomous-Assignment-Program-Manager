***REMOVED*** 3x Opus Parallel Execution Guide

***REMOVED******REMOVED*** Running Three Opus 4.5 Instances Simultaneously
...
***REMOVED******REMOVED*** Core Principle: Strict File Ownership
...
***REMOVED******REMOVED*** Quick Start: Copy-Paste These Prompts

***REMOVED******REMOVED******REMOVED*** Before Starting - Setup
...
***REMOVED******REMOVED*** TERMINAL 1: Opus-API (API & Data Layer)
...
***REMOVED******REMOVED*** YOUR TERRITORY (files you OWN - only you touch these):
...
***REMOVED******REMOVED*** DO NOT TOUCH (other Opus instances own these):
- frontend/components/* (Opus-UI owns this)
- frontend/app/* pages (Opus-UI owns this)
- docs/* (Opus-Docs owns this)

***REMOVED******REMOVED*** YOUR TASKS:

***REMOVED******REMOVED******REMOVED*** Task 1: Create API Client
...
***REMOVED******REMOVED******REMOVED*** Task 2: Create React Query Hooks
...
***REMOVED******REMOVED******REMOVED*** Task 3: Create/Update Types
...
***REMOVED******REMOVED******REMOVED*** Task 4: Scaffold Hook Tests
...
***REMOVED******REMOVED*** TERMINAL 2: Opus-UI (Components & Pages)
...
***REMOVED******REMOVED******REMOVED*** Task 1: Create Base Components
...
***REMOVED******REMOVED******REMOVED*** Task 2: Create Modal Components
...
***REMOVED******REMOVED******REMOVED*** Task 3: Wire Pages to API
...
***REMOVED******REMOVED*** TERMINAL 3: Opus-Docs (Documentation & Backend)
...
***REMOVED******REMOVED******REMOVED*** Task 1: Create docs/ Directory Structure
```
docs/
...
***REMOVED******REMOVED******REMOVED*** Task 2: Write AUTH_ARCHITECTURE.md
...
***REMOVED******REMOVED******REMOVED*** Task 3: Write ERROR_HANDLING.md
...
***REMOVED******REMOVED******REMOVED*** Task 4: Write CACHING_STRATEGY.md
...
***REMOVED******REMOVED******REMOVED*** Task 5: Write API_REFERENCE.md
...
***REMOVED******REMOVED******REMOVED*** Task 6: Backend Tests (if time permits)
...
```bash
***REMOVED*** After all three complete, merge in any order:
git checkout integration-branch

***REMOVED*** Opus-API first (provides types and hooks)
git merge opus-api-branch -m "[Opus-API] Add API client, hooks, and types"

***REMOVED*** Opus-UI second (uses hooks)
git merge opus-ui-branch -m "[Opus-UI] Add components and wire pages"

***REMOVED*** Opus-Docs third (documentation)
...
***REMOVED******REMOVED*** Monitoring Progress

***REMOVED******REMOVED******REMOVED*** Check Status (run in any terminal)

```bash
***REMOVED*** See what each Opus has committed
git log --oneline --all | grep -E "\[Opus-(API|UI|Docs)\]"

***REMOVED*** See uncommitted changes by directory
git status

***REMOVED*** Check if frontend builds
cd frontend && npm run build
```

***REMOVED******REMOVED******REMOVED*** Status Check Prompt (paste into any terminal)
...
***REMOVED******REMOVED*** Handling Dependencies

***REMOVED******REMOVED******REMOVED*** If Opus-UI needs hooks but Opus-API isn't done yet:
...
***REMOVED******REMOVED******REMOVED*** If Opus-API needs types that don't exist:

Create them in `frontend/types/api.ts` - this is Opus-API's territory.

***REMOVED******REMOVED******REMOVED*** If anyone is blocked:
...
***REMOVED******REMOVED*** Commit Message Convention
