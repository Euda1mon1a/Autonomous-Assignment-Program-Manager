...
***REMOVED******REMOVED*** Opus-ScheduleEdit
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Click-to-Edit:
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Edit Modal:
```tsx
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Quick Assign Menu:
...
***REMOVED******REMOVED******REMOVED*** Hooks to use:
...
***REMOVED******REMOVED*** Opus-PersonalView
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Person Filter Dropdown (for schedule page header):
```tsx
...
***REMOVED******REMOVED******REMOVED******REMOVED*** URL Support:
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Personal Schedule Card:
...
***REMOVED******REMOVED******REMOVED******REMOVED*** My Schedule Widget (for Dashboard):
```tsx
<MyScheduleWidget />
```
...
***REMOVED******REMOVED*** Opus-CalendarViews
...
***REMOVED******REMOVED******REMOVED******REMOVED*** View Toggle:
```tsx
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Day View:
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Shared Requirements:
...
***REMOVED******REMOVED*** Opus-NavAndDocs
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Navigation Changes:
...
***REMOVED******REMOVED******REMOVED*** Understanding the Grid
...
***REMOVED******REMOVED******REMOVED*** Navigating Dates

- Use **Previous Block** / **Next Block** to move 4 weeks
- Click **Today** to jump to current date
- Use the date picker for specific dates

***REMOVED******REMOVED******REMOVED*** Viewing Personal Schedules
...
***REMOVED******REMOVED******REMOVED*** Editing Assignments (Admin/Coordinator only)
...
***REMOVED******REMOVED******REMOVED*** View Options
...
***REMOVED******REMOVED*** Coordination Notes

***REMOVED******REMOVED******REMOVED*** Import/Export Between Opus Instances:
...
***REMOVED******REMOVED******REMOVED*** Final Assembly (schedule/page.tsx by Opus-ScheduleGrid):
```tsx
