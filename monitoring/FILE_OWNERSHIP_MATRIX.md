...
***REMOVED******REMOVED******REMOVED*** Root Level Files
...
***REMOVED******REMOVED******REMOVED*** Prometheus Configuration (`prometheus/`)
...
***REMOVED******REMOVED******REMOVED*** Alertmanager Configuration (`alertmanager/`)
...
***REMOVED******REMOVED******REMOVED*** Grafana Configuration (`grafana/`)
...
***REMOVED******REMOVED******REMOVED*** Loki Configuration (`loki/`)

| File | Primary Owner | Secondary Owner | Description |
|------|---------------|-----------------|-------------|
| `loki/loki-config.yml` | SRE | Platform | Loki log aggregation config |

***REMOVED******REMOVED******REMOVED*** Promtail Configuration (`promtail/`)
...
|------|------|---------------|
| DevOps | Platform Team | ***REMOVED***platform-ops |
| SRE | Reliability Team | ***REMOVED***sre-team |
| DBA | Database Team | ***REMOVED***dba-team |

***REMOVED******REMOVED*** Escalation Path

1. **P1 (Critical)**: Page on-call SRE → SRE Lead → VP Engineering
2. **P2 (High)**: Slack ***REMOVED***sre-team → SRE Lead
3. **P3 (Medium)**: Create ticket, assign to team
4. **P4 (Low)**: Backlog grooming

***REMOVED******REMOVED*** Audit Log
