...
***REMOVED******REMOVED******REMOVED*** 5. ~~glob CLI Command Injection (GHSA-5j98-mcp5-4vw2)~~
- **Status:** FIXED
...
***REMOVED******REMOVED******REMOVED*** 6. ~~Refresh Token Usable as Access Token~~
- **Status:** FIXED
- **Fixed In:** `backend/app/core/security.py:201-226` (PR ***REMOVED***327)
...
***REMOVED******REMOVED******REMOVED*** 7. ~~24-Hour Token Expiration Without Refresh~~
- **Status:** FIXED
...
***REMOVED******REMOVED******REMOVED*** 8. ~~No Per-User Account Lockout~~
- **Status:** FIXED
...
***REMOVED******REMOVED*** Medium Vulnerabilities
...
- **Status:** FIXED (See High ***REMOVED***7)
...
- **Status:** FIXED (See ***REMOVED***3 - Startup Secret Validation)
