...
***REMOVED*** Note: In production, import from app.resilience
***REMOVED*** from app.resilience.spc_monitoring import (
***REMOVED***     WorkloadControlChart,
***REMOVED***     calculate_control_limits,
***REMOVED***     calculate_process_capability,
***REMOVED*** )

***REMOVED*** For this example, we'll simulate the imports
print("=" * 70)
...
def example_1_basic_monitoring():
    ...
    ***REMOVED*** Create control chart: target=60h/week, sigma=5h
    chart = WorkloadControlChart(target_hours=60, sigma=5)

    ***REMOVED*** Simulate 10 weeks of resident workload
    resident_id = uuid4()
...
def example_2_historical_control_limits():
    ...
    ***REMOVED*** Historical weekly hours for last academic year
    historical_data = [
        58, 62, 59, 61, 63, 60, 58, 62, 64, 57,  ***REMOVED*** Weeks 1-10
        59, 61, 60, 58, 62, 61, 59, 60, 63, 58,  ***REMOVED*** Weeks 11-20
        60, 62, 59, 61, 60, 58, 62, 61, 59, 60,  ***REMOVED*** Weeks 21-30
    ]
    ...
    ***REMOVED*** Use empirical limits for future monitoring
...
def example_3_process_capability():
    ...
    ***REMOVED*** Weekly hours for a resident
    weekly_hours = [58, 62, 59, 61, 63, 60, 58, 62, 64, 57]

    ***REMOVED*** ACGME specification: 0-80 hours/week
    lsl = 0   ***REMOVED*** Lower spec limit
    usl = 80  ***REMOVED*** Upper spec limit (ACGME maximum)

    print(f"Weekly hours: {weekly_hours}")
    print(f"Specification limits: [{lsl}h, {usl}h]")
    print()

    ***REMOVED*** Calculate capability
...
def example_4_combined_analysis():
    ...
    ***REMOVED*** Simulated workload showing gradual increase (burnout pattern)
    ...
    ***REMOVED*** 1. Real-time SPC monitoring
    ...
    ***REMOVED*** 2. Overall process capability
