...
***REMOVED*** Mock database session for demonstration
class MockDBSession:
...
def demo_basic_usage():
    ...
    ***REMOVED*** Create example metrics
...
def demo_churn_analysis():
    ...
    ***REMOVED*** Mock assignments for demonstration
    ...
    ***REMOVED*** Create old schedule
    old_assignments = [MockAssignment(uuid4(), uuid4(), uuid4()) for _ in range(10)]

    ***REMOVED*** Create new schedule (7 same, 3 removed, 5 added)
...
def demo_n1_vulnerability():
    ...
    ***REMOVED*** Scenario: One person covers unique rotation (single point of failure)
...
def demo_api_response():
    ...
    ***REMOVED*** Convert to dictionary for JSON API response
