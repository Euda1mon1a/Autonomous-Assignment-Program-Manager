...
class ExperimentResult:
    ...
    ***REMOVED*** Quality metrics
    ...
    acgme_compliance: float = 1.0  ***REMOVED*** 0.0-1.0
    coverage_score: float = 1.0  ***REMOVED*** 0.0-1.0
    equity_variance: float = 0.0  ***REMOVED*** Lower is better
    ...
    ***REMOVED*** Comparison to baseline
    ...
    quality_delta: float = 0.0  ***REMOVED*** Positive = better than baseline
...
EXPERIMENTAL_BRANCHES = {
    "quantum-physics": {
        ...
        "success_criteria": {
            "quality_threshold": 0.95,  ***REMOVED*** Must be ≥95% of baseline quality
            "time_threshold": 0.50,  ***REMOVED*** Must be ≤50% of baseline time
        },
    },
    "catalyst-concepts": {
        ...
        "success_criteria": {
            "swap_success_rate": 0.90,  ***REMOVED*** >90% valid transitions
        },
    },
    "transcription-factors": {
        ...
        "success_criteria": {
            "graceful_degradation": True,  ***REMOVED*** Must degrade gracefully at 120% load
        },
    },
}
...
SCENARIOS = {
    ...
    "swap-heavy": {
        ...
        "residents": 24,
        "blocks": 730,
        "swap_rate": 0.15,  ***REMOVED*** 15% of assignments have swap requests
    },
    "crisis-mode": {
        "description": "Emergency staffing crisis simulation",
        "residents": 24,
        "blocks": 730,
        "unavailable_rate": 0.25,  ***REMOVED*** 25% unavailable
        "stress_level": "high",
    },
    "minimal": {
...
***REMOVED*** =============================================================================
***REMOVED*** HARNESS IMPLEMENTATION
***REMOVED*** =============================================================================
...
class ExperimentalHarness:
    ...
    def find_branch(self, branch_key: str) -> str | None:
        ...
        ***REMOVED*** Return most recent (assuming naming convention includes timestamp/id)
...
"""
        ...
        for scenario_key in scenarios:
            ...
            ***REMOVED*** Run baseline
            ...
            for branch_key in EXPERIMENTAL_BRANCHES:
                ...
                ***REMOVED*** Calculate delta vs baseline
    ...
    def save_report(self, report: ComparisonReport, output_path: Path) -> None:
        ...
        ***REMOVED*** Convert dataclasses to dicts
        data = {
