...
def example_single_resident():
    ...
    ***REMOVED*** Example: Resident with moderate concern
    report = rating.calculate_burnout_danger(
        resident_id=uuid4(),
        recent_hours=71.0,  ***REMOVED*** Hours worked last 2 weeks
        monthly_load=264.0,  ***REMOVED*** Average monthly hours (last 3 months)
        yearly_satisfaction=0.56,  ***REMOVED*** Job satisfaction (0.0-1.0)
        workload_velocity=4.5,  ***REMOVED*** Hours/week increase rate
    )
...
def example_program_screening():
    ...
    ***REMOVED*** Simulated resident data
    residents = [
        {
            "resident_id": uuid4(),
            "recent_hours": 52.0,
    ...
    ***REMOVED*** Calculate danger for all residents (returns sorted by FWI, highest first)
    ...
    ***REMOVED*** Identify critical cases
...
def example_component_analysis():
    ...
    ***REMOVED*** FFMC - Fine Fuel Moisture Code (2-week acute stress)
    ...
    ***REMOVED*** DMC - Duff Moisture Code (3-month sustained load)
    ...
    ***REMOVED*** DC - Drought Code (yearly satisfaction)
    ...
    ***REMOVED*** ISI - Initial Spread Index (FFMC + velocity)
    print("\n4. ISI (Spread Rate):")
    ffmc = 70.0
...
def example_custom_targets():
    ...
    ***REMOVED*** Some specialties may have different sustainable workload targets

    ***REMOVED*** Example: Surgery residency with higher expected hours
    surgery_rating = BurnoutDangerRating(
        ffmc_target=70.0,  ***REMOVED*** 70h per 2 weeks (vs 60h default)
        dmc_target=280.0,  ***REMOVED*** 280h per month (vs 240h default)
    )

    report = surgery_rating.calculate_burnout_danger(
        resident_id=uuid4(),
        recent_hours=72.0,  ***REMOVED*** Would be high for IM, moderate for surgery
        monthly_load=275.0,  ***REMOVED*** Ditto
