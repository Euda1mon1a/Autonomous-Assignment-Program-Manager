...
class ResilienceService:
    ...
    def _maybe_run_contingency(
        ...
        should_run = (
            ...
            or current_utilization > 0.80  ***REMOVED*** Always run when stressed
        )
