...
class SpecialistCoverage:
    ...
    predicted_wait_probability: float  ***REMOVED*** P(wait > 0)
    offered_load: float  ***REMOVED*** A = λ * μ
    service_level: float  ***REMOVED*** P(answer within target time)
...
class ErlangMetrics:
    ...
    wait_probability: float  ***REMOVED*** P(wait > 0)
    avg_wait_time: float  ***REMOVED*** Average wait time in same units as service_time
    service_level: float  ***REMOVED*** P(answer within target time)
    occupancy: float  ***REMOVED*** Average server utilization (0.0 to 1.0)
...
class ErlangCCalculator:
    ...
    def erlang_b(self, offered_load: float, servers: int) -> float:
        ...
        Example:
            ...
            0.0349  ***REMOVED*** 3.49% chance all 8 specialists busy
        """
        if servers <= 0:
            return 1.0
        if offered_load <= 0:
        ...
        ***REMOVED*** Calculate using recursive formula for numerical stability
        ***REMOVED*** B(A, c) = (A * B(A, c-1)) / (c + A * B(A, c-1))
        b = 1.0
    ...
    def erlang_c(self, offered_load: float, servers: int) -> float:
        ...
        Example:
            ...
            0.0745  ***REMOVED*** 7.45% of cases will wait for specialist
        """
        if servers <= 0:
            return 1.0
        if offered_load <= 0:
        ...
        ***REMOVED*** Check stability: offered_load must be < servers
        ...
        ***REMOVED*** Calculate Erlang C
        b = self.erlang_b(offered_load, servers)
        rho = offered_load / servers  ***REMOVED*** Utilization per server
    ...
    def calculate_wait_probability(
        ...
        Example:
            ...
            ...     service_time=0.5,  ***REMOVED*** 30 min per case
            ...     servers=3
            ... )
            0.127  ***REMOVED*** 12.7% chance of waiting
        """
    ...
    def calculate_avg_wait_time(
        ...
        Example:
            ...
            ...     servers=3
            ... )
            0.034  ***REMOVED*** ~2 minutes average wait (0.034 hours)
        """
        offered_load = arrival_rate * service_time
        ...
        ***REMOVED*** Average wait time: W = P(wait) * μ / (c - A)
    ...
    def calculate_service_level(
        ...
        Example:
            ...
            ... )
            0.957  ***REMOVED*** 95.7% answered within 15 min
        """
        offered_load = arrival_rate * service_time
    ...
    def calculate_occupancy(
        ...
        Example:
            ...
            ...     servers=3
            ... )
            0.417  ***REMOVED*** 41.7% average utilization
        """
        if servers <= 0:
            return 1.0
    ...
    def optimize_specialist_coverage(
        ...
        ***REMOVED*** Minimum servers: must be > offered_load for stability
        ...
        ***REMOVED*** Search for optimal server count
        for servers in range(min_servers, max_servers + 1):
            try:
                ...
                if wait_prob <= target_wait_prob:
                    ...
                    ***REMOVED*** Calculate service level with typical target (15 min = 0.25 hours)
                    typical_target = service_time * 0.5  ***REMOVED*** Half of service time
                ...
                ***REMOVED*** Unstable configuration, try more servers
                continue

        ***REMOVED*** Target not achievable
        raise ValueError(
    ...
    def calculate_metrics(
        ...
        if target_wait is None:
            target_wait = service_time * 0.5  ***REMOVED*** Default to half service time
    ...
    def generate_staffing_table(
        ...
        for servers in range(min_servers, max_servers + 1):
            try:
                ...
                ***REMOVED*** Skip unstable configurations
                continue
