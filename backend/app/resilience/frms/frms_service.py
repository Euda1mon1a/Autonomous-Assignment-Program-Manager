...
class FRMSService:
    ...
    ***REMOVED*** ACGME duty hour limits
    ...
    async def get_resident_profile(
        ...
        ***REMOVED*** Calculate ACGME status
    ...
    async def scan_all_residents(
        ...
        ***REMOVED*** Sort by hazard level (highest first)
        profiles.sort(
    ...
    async def assess_schedule_fatigue_risk(
        ...
        """
        ***REMOVED*** Convert to ShiftPatterns
        shifts = []
        ...
        ***REMOVED*** Identify high-risk windows
    ...
    def calculate_fatigue_score(
        ...
        ***REMOVED*** Estimate alertness from SP level
        alertness = 1.0 - (sp_level.value - 1) / 6.0

        ***REMOVED*** Get circadian phase
    ...
    ***REMOVED*** Helper methods
    ...
    async def _get_work_history(
        ...
        ***REMOVED*** Get assignments in last 7 days
        ...
        ***REMOVED*** Calculate metrics
        hours_week = len(assignments) * 6  ***REMOVED*** 6 hours per half-day block
        hours_today = (
            sum(
                1
        ...
        ***REMOVED*** Simplified consecutive days/nights calculation
        return {
            ...
            "consecutive_nights": 0,  ***REMOVED*** Would need more complex logic
        }

    def _estimate_hours_awake(self, work_data: dict, target_time: datetime) -> float:
        """Estimate hours since last sleep."""
        ***REMOVED*** Simplified: assume woke at 6 AM if working today
        ...
        return 8.0  ***REMOVED*** Default assumption

    def _estimate_sleep_debt(self, work_data: dict) -> float:
        """Estimate sleep debt from work history."""
        ***REMOVED*** Simplified: assume 1 hour debt per 12 hours worked above 40/week
