...
class N1Analyzer:
    ...
    def analyze_person_failure(
        ...
        ***REMOVED*** Estimate recovery time
        if has_backup:
            recovery_hours = 2.0  ***REMOVED*** Quick swap
        else:
            recovery_hours = num_affected * 4.0  ***REMOVED*** Need to find coverage
    ...
    def analyze_specialty_failure(
        ...
        ***REMOVED*** If only one specialist, losing them is critical
        ...
        if len(available_specialists) == 1:
            criticality = 0.9  ***REMOVED*** Single point of failure
            cascade_potential = 0.7
        elif len(available_specialists) == 2:
            criticality = 0.6  ***REMOVED*** Limited redundancy
            cascade_potential = 0.4
        else:
            criticality = 0.3  ***REMOVED*** Multiple specialists
