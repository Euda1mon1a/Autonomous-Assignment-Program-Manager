...
class N2Analyzer:
    ...
    def analyze_dual_person_failure(
        ...
        ***REMOVED*** Calculate criticality (N-2 is inherently more critical)
        base_criticality = 0.6  ***REMOVED*** N-2 starts higher than N-1
        ...
        ***REMOVED*** Recovery time
        if has_backup:
            recovery_hours = total_affected * 0.5  ***REMOVED*** Parallel recovery
        else:
            recovery_hours = total_affected * 6.0  ***REMOVED*** Serial recovery
