...
class RuleViolation:
    ...
    points_involved: list[int]  ***REMOVED*** Indices of points involved in violation
...
class WesternElectricRules:
    ...
    def check_all_rules(self, data: list[float]) -> list[RuleViolation]:
        ...
        ***REMOVED*** Rule 1: One point beyond 3σ
        ...
        ***REMOVED*** Rule 2: Two of three consecutive beyond 2σ
