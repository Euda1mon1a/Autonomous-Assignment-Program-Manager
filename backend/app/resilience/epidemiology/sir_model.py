...
class SIRState(str, Enum):
    ...
    SUSCEPTIBLE = "susceptible"  ***REMOVED*** Healthy, at risk
    INFECTED = "infected"  ***REMOVED*** Currently burned out
    RECOVERED = "recovered"  ***REMOVED*** Recovered or removed
...
class SIRSnapshot:
    ...
    r0: float  ***REMOVED*** Basic reproduction number (β/γ)
...
class SIRForecast:
    ...
    peak_day: int
    time_to_peak: int
    total_cases: int  ***REMOVED*** Cumulative infected
...
class SIRModel:
    ...
    def __init__(
        self,
        transmission_rate: float = 0.3,  ***REMOVED*** β - burnout contagion rate
        recovery_rate: float = 0.1,  ***REMOVED*** γ - recovery rate (1/10 = 10 days avg)
    ):
        """
    ...
    def simulate(
        ...
        ***REMOVED*** Initial conditions [S, I, R]
        ...
        ***REMOVED*** Total cases (final recovered + current infected)
    ...
    def calculate_herd_immunity_threshold(self) -> float:
        ...
        """
        if self.r0 <= 1.0:
            return 0.0  ***REMOVED*** No epidemic, no herd immunity needed
    ...
    def calculate_intervention_effect(
        ...
        """
        ***REMOVED*** Baseline (no intervention)
    ...
    def classify_epidemic_phase(self, infected_count: int, total_population: int) -> str:
        ...
        if infected_count == 0:
            ...
            return "sporadic"  ***REMOVED*** < 1%
        elif prevalence < 0.05:
            return "outbreak"  ***REMOVED*** 1-5%
        elif prevalence < 0.15:
            return "epidemic"  ***REMOVED*** 5-15%
        else:
            return "crisis"  ***REMOVED*** > 15%
