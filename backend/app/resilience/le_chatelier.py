...
class StressType(str, Enum):
    ...
    EXTERNAL_PRESSURE = "external_pressure"  ***REMOVED*** Regulatory, administrative
...
class EquilibriumShift:
    ...
    ***REMOVED*** Compensation
    ...
    compensation_efficiency: float  ***REMOVED*** How much of the compensation actually helps
...
class StressResponsePrediction:
    ...
    ***REMOVED*** Input stress
    stress_type: StressType
    stress_magnitude: float
    stress_duration_days: int

    ***REMOVED*** Predicted response
    predicted_compensation: float  ***REMOVED*** Expected natural compensation (0-50%)
    predicted_new_capacity: float  ***REMOVED*** Capacity after equilibrium shift
    ...
    ***REMOVED*** Recommendations
    additional_intervention_needed: float  ***REMOVED*** How much more help needed
...
class LeChatelierAnalyzer:
    ...
    def __init__(
        ...
        compensation_cost_multiplier: float = 1.5,  ***REMOVED*** 50% surcharge for stress
    ...
    def apply_stress(
        ...
        ***REMOVED*** Apply impact to current state
    ...
    def initiate_compensation(
        ...
        ***REMOVED*** Apply compensation effect (partial, per Le Chatelier)
    ...
    def calculate_equilibrium_shift(
        ...
        ***REMOVED*** Calculate total impacts
        ...
        ***REMOVED*** Calculate total compensation
        ...
        ***REMOVED*** Calculate new equilibrium values
        ...
        ***REMOVED*** Sustainable capacity (without compensation)
        ...
        ***REMOVED*** Days until exhaustion
        if active_compensations:
            ...
            days_until_exhaustion = -1  ***REMOVED*** No limit

        ***REMOVED*** Determine equilibrium state
    ...
    def predict_stress_response(
        ...
        ***REMOVED*** Calculate natural compensation (Le Chatelier)
        ...
        ***REMOVED*** Calculate intervention needed
        target_coverage = 0.9
    ...
    def calculate_new_equilibrium(
        ...
        ***REMOVED*** But compensation has costs
    ...
    def get_report(self) -> EquilibriumReport:
        ...
        ***REMOVED*** Determine current state
