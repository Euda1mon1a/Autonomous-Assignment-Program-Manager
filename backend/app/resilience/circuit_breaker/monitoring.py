...
class CircuitBreakerMetrics:
    ...
    def __init__(self, registry: Optional["CollectorRegistry"] = None):
        ...
        ***REMOVED*** === COUNTERS ===
        ...
        self.requests_total = Counter(
            ...
            ["breaker", "result"],  ***REMOVED*** result: success, failure, rejected
            registry=self._registry,
        )
        ...
        self.fallback_executions = Counter(
            ...
            ["breaker", "result"],  ***REMOVED*** result: success, failure
            registry=self._registry,
        )
    ...
    def update_breaker_metrics(self, breaker_name: str):
        ...
        try:
            ...
            ***REMOVED*** Update half-open calls
    ...
    def record_request(
        self,
        breaker_name: str,
        result: str,  ***REMOVED*** "success", "failure", "rejected"
    ):
        """
...
***REMOVED*** Auto-update integration
