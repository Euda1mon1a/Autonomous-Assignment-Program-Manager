...
class StateMachine:
    ...
    def record_success(self) -> CircuitState:
        ...
        if self.current_state == CircuitState.HALF_OPEN:
            ***REMOVED*** In half-open, successes count toward recovery
    ...
    def should_allow_request(self) -> bool:
        ...
        if self.current_state == CircuitState.HALF_OPEN:
            ***REMOVED*** Allow limited concurrent calls
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "recent_transitions": [
                ...
                for t in self.metrics.state_transitions[-10:]  ***REMOVED*** Last 10 transitions
            ],
        }
