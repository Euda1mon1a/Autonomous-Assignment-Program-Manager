...
def circuit_breaker(
    ...
    def decorator(func: Callable[..., T]) -> Callable[..., T]:
        ...
        ***REMOVED*** Register breaker if not already registered
        ...
        ***REMOVED*** Attach breaker for introspection
        wrapper._circuit_breaker = breaker  ***REMOVED*** type: ignore
        wrapper._circuit_breaker_name = breaker_name  ***REMOVED*** type: ignore
...
def with_circuit_breaker(breaker_name: str):
    ...
    Example:
        ***REMOVED*** First, register the breaker
        registry = get_registry()
        registry.register("shared_api", failure_threshold=3)

        ***REMOVED*** Then use it with multiple functions
...
def with_async_circuit_breaker(breaker_name: str):
    ...
    Example:
        ...
        ***REMOVED*** Then use it with multiple async functions
