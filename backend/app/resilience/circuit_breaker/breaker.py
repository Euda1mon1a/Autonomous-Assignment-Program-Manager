...
class CircuitBreaker:
    ...
    Example:
        ...
        ***REMOVED*** Use as context manager
        with breaker:
            result = risky_database_call()

        ***REMOVED*** Use with async
        async with breaker:
            result = await risky_async_call()

        ***REMOVED*** Use as decorator (via registry)
    ...
    def call(self, func: Callable[..., T], *args: Any, **kwargs: Any) -> T:
        ...
        ***REMOVED*** If half-open, track in-flight calls
        ...
        try:
            ...
            ***REMOVED*** Check if exception should be excluded from failure count
