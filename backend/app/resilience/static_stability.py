...
class FallbackScheduler:
    ...
    def precompute_fallback(
        ...
        ***REMOVED*** Determine services reduced based on scenario
    ...
    def activate_fallback(
        ...
        Example:
            >>> scheduler = FallbackScheduler()
            >>> ***REMOVED*** Pre-compute during calm period
            >>> scheduler.precompute_fallback(FallbackScenario.HOLIDAY_SKELETON, ...)
            >>> ***REMOVED*** Later, during crisis, activate instantly
    ...
    def _calculate_coverage_rate(
        ...
        ***REMOVED*** Estimate number of blocks (2 per weekday)
