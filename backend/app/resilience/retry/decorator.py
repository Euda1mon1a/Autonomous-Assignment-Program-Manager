...
class RetryExecutor:
    ...
    def should_retry(self, exception: Exception) -> bool:
        ...
        """
        ***REMOVED*** Non-retryable exceptions always prevent retry
        if isinstance(exception, self.config.non_retryable_exceptions):
            return False

        ***REMOVED*** Check if it matches retryable exceptions
    ...
    def execute_sync(
        ...
        **kwargs,
        ...
        while attempt < self.config.max_attempts:
            ...
            ***REMOVED*** Calculate delay for this attempt
            if attempt > 0:
            ...
            ***REMOVED*** Execute the function
            ...
            try:
                ...
                ***REMOVED*** Record the failed attempt
                ...
                ***REMOVED*** Check if we should retry
                ...
                ***REMOVED*** If we have attempts left, trigger retry callback
        ...
        while attempt < self.config.max_attempts:
            ...
            ***REMOVED*** Calculate delay for this attempt
            if attempt > 0:
                ...
                ***REMOVED*** Async sleep before retry
                logger.debug(
                    f"Retrying {operation_name} (attempt {attempt + 1}/{self.config.max_attempts}) "
                    f"after {delay:.2f}s delay"
                )
