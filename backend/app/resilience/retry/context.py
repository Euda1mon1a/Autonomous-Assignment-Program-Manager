...
class RetryAttempt:
    ...
    attempt_number: int
    timestamp: datetime
    delay_before: float  ***REMOVED*** Delay before this attempt (seconds)
    exception: Optional[Exception] = None
    success: bool = False
    duration: float = 0.0  ***REMOVED*** How long the attempt took (seconds)
...
class RetryContext:
    ...
    last_delay: float = 0.0  ***REMOVED*** Track for decorrelated jitter
