...
class UtilizationLevel(Enum):
    ...
    ORANGE = "orange"  ***REMOVED*** 80-90% - Above threshold, degraded operations
...
class UtilizationThreshold:
    ...
    max_utilization: float = 0.80  ***REMOVED*** Target maximum
    warning_threshold: float = 0.70  ***REMOVED*** Yellow alert
    critical_threshold: float = 0.90  ***REMOVED*** Red alert
    emergency_threshold: float = 0.95  ***REMOVED*** Black alert
...
class UtilizationMetrics:
    ...
    total_capacity: int  ***REMOVED*** Total available faculty-blocks
    required_coverage: int  ***REMOVED*** Required coverage blocks
    current_assignments: int  ***REMOVED*** Currently assigned blocks
    utilization_rate: float  ***REMOVED*** current / capacity
    effective_utilization: float  ***REMOVED*** required / capacity
    level: UtilizationLevel
    buffer_remaining: float  ***REMOVED*** How much buffer before threshold

    ***REMOVED*** Breakdown by category
...
class UtilizationMonitor:
    ...
    def calculate_utilization(
        ...
        """
        ***REMOVED*** Calculate theoretical capacity
        total_capacity = int(
        ...
        ***REMOVED*** Calculate buffer remaining before threshold
    ...
    def get_safe_capacity(
        ...
        Example:
            ...
            >>> ***REMOVED*** With 10 faculty, 2 blocks/day, 5 days: 10 * 2 * 5 * 0.8 = 80
    ...
    def forecast_utilization(
        ...
        for day_offset in range(forecast_days):
            ...
            ***REMOVED*** Build contributing factors
            factors = []
            if len(absent_ids) > 0:
