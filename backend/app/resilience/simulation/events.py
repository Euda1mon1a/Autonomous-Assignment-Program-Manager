...
class EventType(str, Enum):
    ...
    ***REMOVED*** Simulation control events
...
def create_event(event_type: EventType, **kwargs: Any) -> SimulationEvent:
    ...
    Examples:
        ...
        True
    """
    ***REMOVED*** Map event types to their corresponding event classes
    ...
    ***REMOVED*** Get the appropriate event class, defaulting to base SimulationEvent
    event_class = event_class_map.get(event_type, SimulationEvent)

    ***REMOVED*** Ensure event_type is set
    kwargs["event_type"] = event_type

    ***REMOVED*** Set default severity if not provided
    if "severity" not in kwargs:
        kwargs["severity"] = _get_default_severity(event_type)

    ***REMOVED*** Create and return the event
