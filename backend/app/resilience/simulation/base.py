...
***REMOVED*** Handle optional SimPy dependency
try:
    import simpy
    HAS_SIMPY = True
except ImportError:
...
class SimulationConfig:
    ...
    zone_count: int = 6
    sick_call_probability: float = 0.02  ***REMOVED*** per day
    resignation_base_probability: float = 0.001  ***REMOVED*** per day
    pcs_probability: float = 0.0027  ***REMOVED*** annual ~1% chance
...
class SimulationEnvironment:
    ...
    def __init__(self, config: SimulationConfig) -> None:
        ...
        self._config = config
        self._env = simpy.Environment()  ***REMOVED*** type: ignore
