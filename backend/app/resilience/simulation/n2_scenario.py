...
class N2IterationResult:
    ...
    failure_mode: str | None  ***REMOVED*** "skill_gap", "capacity", "cascade", None if passed
...
class N2ScenarioResult:
    ...
    )  ***REMOVED*** zone_idx -> failure_count
...
class N2ContingencyScenario:
    ...
    def __init__(self, config: N2ScenarioConfig):
        ...
        self._zones: list[
            dict
        ] = []  ***REMOVED*** Each: {id, faculty, min_coverage, required_skills}
