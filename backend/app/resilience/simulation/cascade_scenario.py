...
class CascadeConfig:
    ...
    total_workload_units: float = 10.0  ***REMOVED*** constant demand
    sustainable_workload: float = 1.2  ***REMOVED*** per person
    burnout_threshold: float = 1.5
    critical_threshold: float = 2.0
    base_departure_rate: float = 0.001  ***REMOVED*** per day, ~3%/year
    burnout_multiplier: float = 5.0  ***REMOVED*** how much burnout increases departure rate
    hiring_delay_days: int = 90
    hiring_rate: float = 0.02  ***REMOVED*** probability per day after delay
...
class DailySnapshot:
    ...
    departures: int
    hires: int
    in_burnout_zone: bool  ***REMOVED*** workload > burnout_threshold
    in_critical_zone: bool  ***REMOVED*** workload > critical_threshold
...
class CascadeResult:
    ...
    collapsed: bool  ***REMOVED*** fell below minimum_viable
    days_to_collapse: int | None
    peak_workload: float
    total_departures: int
    departures_from_burnout: int  ***REMOVED*** when workload > burnout_threshold
    total_hires: int
    entered_vortex: bool  ***REMOVED*** point of no return
    vortex_entry_day: int | None
    vortex_faculty_count: int | None
    time_in_burnout_zone: int  ***REMOVED*** days
    time_in_critical_zone: int  ***REMOVED*** days
...
class BurnoutCascadeScenario:
    ...
    def __init__(self, config: CascadeConfig):
        ...
        self._day = 0
        self._hiring_queue: list[int] = []  ***REMOVED*** days when hires arrive
    ...
    def calculate_departure_probability(self, workload: float) -> float:
        ...
        ***REMOVED*** Exponential increase based on how far above sustainable
        ratio = workload / self.config.sustainable_workload
        k = 1.0  ***REMOVED*** steepness factor
    ...
    def is_in_vortex(self) -> bool:
        ...
        ***REMOVED*** Expected departures per day
        expected_departures = departure_prob * self._faculty_count

        ***REMOVED*** Expected hires per day (considering queue limit)
        ...
        ***REMOVED*** In vortex if losing more than gaining
    ...
    def _process_departures(self) -> int:
        ...
        ***REMOVED*** Track if departures happened during burnout
    ...
    def _process_hiring(self) -> int:
        ...
        ***REMOVED*** Process existing queue - check if anyone arrives today
        new_queue = []
        ...
        ***REMOVED*** Add new hiring attempts if under capacity
    ...
    def _simulate_day(self) -> DailySnapshot:
        ...
        """
        ***REMOVED*** Process in order: departures, then hiring
    ...
    def _generate_recommendations(self) -> list[str]:
        ...
        ***REMOVED*** Hiring queue recommendations
        ...
        ***REMOVED*** Time-based recommendations
