...
class MetricsCollector:
    ...
    def get_summary(self, metric: str) -> MetricsSummary | None:
        ...
        ***REMOVED*** Handle edge case: single data point
        if count == 1:
            val = values[0]
        ...
        ***REMOVED*** Calculate percentiles
        ...
        p25 = statistics.quantiles(sorted_values, n=4)[0]  ***REMOVED*** 25th percentile
        p50 = statistics.median(sorted_values)
        p75 = statistics.quantiles(sorted_values, n=4)[2]  ***REMOVED*** 75th percentile

        ***REMOVED*** For 95th and 99th percentiles, use quantiles with n=100
        if count >= 100:
            percentiles = statistics.quantiles(sorted_values, n=100)
            p95 = percentiles[94]  ***REMOVED*** 95th percentile (index 94 of 99)
            p99 = percentiles[98]  ***REMOVED*** 99th percentile (index 98 of 99)
        else:
            ***REMOVED*** For smaller datasets, approximate with available data
