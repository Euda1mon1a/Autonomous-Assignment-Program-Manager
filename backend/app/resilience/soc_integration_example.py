...
1. In ResilienceService (/backend/app/resilience/service.py):
    ...
    class ResilienceService:
        ...
        async def check_health(
            ...
            ***REMOVED*** NEW: Add SOC early warning analysis
            ...
            ***REMOVED*** Add warnings if critical
        ...
        async def _check_soc_warning(self, assignments) -> CriticalSlowingDownResult:
            ...
            '''
            ***REMOVED*** Get daily utilization for last 60 days
            utilization_history = await self._get_utilization_history(days=60)

            ***REMOVED*** Run SOC analysis
        ...
        async def _get_utilization_history(self, days: int) -> list[float]:
            ...
            '''
            ***REMOVED*** Placeholder - replace with actual DB query
            ***REMOVED*** Example query:
            ***REMOVED*** SELECT date, AVG(utilization) as avg_util
            ***REMOVED*** FROM daily_metrics
            ***REMOVED*** WHERE date >= NOW() - INTERVAL '{days} days'
            ***REMOVED*** ORDER BY date ASC

            ***REMOVED*** For now, return mock data
            return [0.75] * days
...
4. Celery periodic task (for automatic monitoring):
    ...
    ***REMOVED*** backend/app/resilience/tasks.py
    ...
    async def check_soc_warning_task():
        ...
        ***REMOVED*** Get utilization history from database
        ...
        ***REMOVED*** Send alert if critical
    ...
    ***REMOVED*** Add to beat schedule in celeryconfig.py:
    ***REMOVED*** beat_schedule = {
    ***REMOVED***     'soc-warning-check': {
    ***REMOVED***         'task': 'check_soc_warning',
    ***REMOVED***         'schedule': crontab(hour='*/6'),  ***REMOVED*** Every 6 hours
    ***REMOVED***     },
    ***REMOVED*** }
...
5. Database model for persistence (optional):
    ...
    ***REMOVED*** backend/app/models/soc_metrics.py
...
TESTING:
    ...
    ***REMOVED*** Quick test with synthetic data
    import asyncio
    import numpy as np
    from app.resilience.soc_predictor import SOCAvalanchePredictor
    ...
    async def test_soc():
        ...
        ***REMOVED*** Approaching criticality
