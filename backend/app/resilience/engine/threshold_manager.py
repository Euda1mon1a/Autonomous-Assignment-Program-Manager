...
class ThresholdViolation:
    ...
    threshold_name: str
    value: float
    bound_violated: str  ***REMOVED*** "lower", "upper", "warning_lower", etc.
...
class ThresholdManager:
    ...
    def create_adaptive_threshold(
        ...
        ***REMOVED*** Calculate control limits (3-sigma)
    ...
    def check_threshold(self, name: str, value: float) -> ThresholdViolation | None:
        ...
        ***REMOVED*** Check critical bounds first
