...
class AlertGenerator:
    ...
    def generate_utilization_alert(
        ...
        ***REMOVED*** Determine severity
        if utilization >= 0.98:
            ...
            escalation = 5  ***REMOVED*** Escalate after 5 minutes
    ...
    def generate_burnout_alert(
        ...
        if prevalence < 0.05 and rt < 1.0:
            return None  ***REMOVED*** Under control
    ...
    def deduplicate_alerts(self, new_alert: Alert) -> bool:
        ...
        """
        ***REMOVED*** Check recent alerts (last hour)
        ...
        for existing in self.active_alerts:
            ...
            ***REMOVED*** Same category and similar metrics = duplicate
            if (
    ...
    def should_escalate(self, alert: Alert) -> bool:
        ...
        ***REMOVED*** Check if alert has been active longer than escalation time
