...
class RecoveryPlanner:
    ...
    def plan_recovery(
        ...
        ***REMOVED*** Determine target level (always aim for GREEN)
        target_level = DefenseLevel.GREEN

        ***REMOVED*** Generate recovery steps based on current problems
        ...
        ***REMOVED*** Add specific steps for each problem
    ...
    def _estimate_success_probability(
        ...
        ***REMOVED*** Base probability by level
        base_prob = {
        ...
        ***REMOVED*** Reduce probability for complex recoveries (many steps)
