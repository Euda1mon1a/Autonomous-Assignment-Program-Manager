...
class PreferenceTrail:
    ...
    ***REMOVED*** What the trail is about
    slot_id: Optional[UUID] = None       ***REMOVED*** Specific slot
    slot_type: Optional[str] = None      ***REMOVED*** Type of slot (e.g., "monday_am")
    block_type: Optional[str] = None     ***REMOVED*** Type of block
    service_type: Optional[str] = None   ***REMOVED*** Type of service
    target_faculty_id: Optional[UUID] = None  ***REMOVED*** For swap affinity
...
class CollectivePreference:
    ...
    net_preference: float  ***REMOVED*** preference - avoidance
    faculty_count: int
    confidence: float  ***REMOVED*** Based on signal density
...
class StigmergyStatus:
    ...
    ***REMOVED*** Trail health
    average_strength: float
    average_age_days: float
    evaporation_debt_hours: float  ***REMOVED*** How long since last full evaporation

    ***REMOVED*** Patterns detected
...
class StigmergicScheduler:
    ...
    def __init__(
        ...
        ***REMOVED*** Indexes for fast lookup
    ...
    def record_signal(
        ...
        ***REMOVED*** Determine trail type and whether to strengthen or weaken
        if signal_type in (
        ...
        ***REMOVED*** Find or create trail
        ...
        if not trail:
            trail = self.record_preference(
                ...
                slot_type=slot_type,
                target_faculty_id=target_faculty_id,
                strength=0.3,  ***REMOVED*** Start weaker for implicit signals
            )
    ...
    def get_collective_preference(
        ...
        """
        ***REMOVED*** Apply pending evaporation
        ...
        for faculty_id in available_faculty:
            ...
            ***REMOVED*** Check avoidance trails
            ...
            if avoid_trails:
                ...
                score -= max_avoid * 0.4  ***REMOVED*** Avoidance counts more
    ...
    def detect_patterns(self) -> dict[str, Any]:
        ...
        ***REMOVED*** Find popular/unpopular slot types
        slot_preferences = {}
        for trail in self.trails.values():
        ...
        ***REMOVED*** Normalize and categorize
        popular = []
        unpopular = []
        neutral = []
    ...
    def _find_trail(
        ...
        for tid in trail_ids:
            ...
            ***REMOVED*** For swap affinity, need exact slot_type match or both None
