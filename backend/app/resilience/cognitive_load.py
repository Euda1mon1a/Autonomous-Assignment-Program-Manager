...
class Decision:
    ...
    ***REMOVED*** Cognitive cost
    estimated_cognitive_cost: float = 1.0  ***REMOVED*** 1.0 = one "decision unit"
...
class CognitiveSession:
    ...
    ***REMOVED*** Configuration
    max_decisions_before_break: int = 7  ***REMOVED*** Miller's Law
    ...
    ***REMOVED*** Completion
    ...
    def take_break(self):
        ...
        ***REMOVED*** Breaks reduce accumulated load
...
class CognitiveLoadReport:
    ...
    ***REMOVED*** Capacity
    remaining_capacity: float  ***REMOVED*** 0.0 - 1.0
    decisions_until_break: int
    should_take_break: bool

    ***REMOVED*** Historical (today)
    decisions_today: int
    total_sessions_today: int
    average_decision_time: float  ***REMOVED*** seconds
...
class CognitiveLoadManager:
    ...
    def request_decision(
        ...
        ***REMOVED*** Check if we should auto-decide
        ...
        ***REMOVED*** Present to user (in actual implementation, this would be async)
        ***REMOVED*** For now, we return a pending state
    ...
    def _check_state_change(self, session: CognitiveSession):
        ...
        ***REMOVED*** Notification handlers would be called here
    ...
    def get_session_status(self, session_id: UUID) -> CognitiveLoadReport | None:
        ...
        ***REMOVED*** Calculate remaining capacity
        max_cost = self.max_decisions_per_session * 1.5  ***REMOVED*** Rough estimate
        remaining = max(0, (max_cost - session.total_cognitive_cost) / max_cost)

        ***REMOVED*** Calculate average decision time
        times = [
    ...
    def calculate_schedule_cognitive_load(
        ...
        """
        ***REMOVED*** Count complexity factors
        exceptions = 0
        conflicts = 0
        overrides = 0
        cross_coverage = 0
    ...
    def get_decision_templates(self) -> dict[DecisionCategory, dict]:
        ...
        return {
            ...
            DecisionCategory.LEAVE: {
                ...
                "safe_default": "defer",
                "recommended_option": None,  ***REMOVED*** Depends on coverage
            },
            DecisionCategory.COVERAGE: {
                "description": "Assign coverage for {block} on {date}",
                "default_complexity": DecisionComplexity.MODERATE,
                "options": [],  ***REMOVED*** Dynamic based on available faculty
                "safe_default": None,  ***REMOVED*** Must choose
                "recommended_option": None,  ***REMOVED*** Algorithm recommendation
            },
            DecisionCategory.CONFLICT: {
                "description": "Resolve conflict: {description}",
                "default_complexity": DecisionComplexity.COMPLEX,
                "options": [],  ***REMOVED*** Dynamic
                "safe_default": None,  ***REMOVED*** Must decide
            ...
            DecisionCategory.OVERRIDE: {
                ...
                "safe_default": "deny",  ***REMOVED*** Conservative default
            ...
            DecisionCategory.EMERGENCY: {
                ...
                "default_complexity": DecisionComplexity.COMPLEX,
                "options": [],  ***REMOVED*** Dynamic
                "safe_default": None,  ***REMOVED*** Cannot auto-decide emergencies
                "recommended_option": None,
            },
        }
