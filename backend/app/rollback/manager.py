...
class RollbackManager:
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Persistence Methods (File-based storage with gzip compression)
    ***REMOVED*** =========================================================================

    ***REMOVED*** Default storage directory for rollback points
    ...
    def _serialize_rollback_point(
        ...
        """
        ***REMOVED*** Convert dataclass to dict, handling nested dataclasses
        data = {
    ...
    def _persist_rollback_point(self, rollback_point: RollbackPoint) -> None:
        ...
        """
        try:
            ***REMOVED*** Serialize the rollback point
            data = self._serialize_rollback_point(rollback_point)

            ***REMOVED*** Compress and write atomically
            ...
            ***REMOVED*** Write to temp file first, then rename (atomic on POSIX)
    ...
    def _list_persisted_rollback_points(self, limit: int = 100) -> list[RollbackPoint]:
        ...
        try:
            ...
            ***REMOVED*** Sort by created_at descending (newest first)
