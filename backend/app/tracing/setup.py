...
def setup_tracing(config: TracingConfig, app: Any | None = None) -> None:
    ...
    ***REMOVED*** Configure exporters
    if config.console_export:
        ***REMOVED*** Console exporter for development
        console_exporter = ConsoleSpanExporter()
        provider.add_span_processor(SimpleSpanProcessor(console_exporter))
        logger.info("Added console span exporter")

    if config.jaeger_endpoint:
        ***REMOVED*** Jaeger exporter
    ...
    if config.otlp_endpoint:
        ***REMOVED*** OTLP exporter (for OpenTelemetry Collector)
