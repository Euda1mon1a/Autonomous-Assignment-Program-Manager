    ...
    ***REMOVED*** CSP Sources
    ...
    def get_production_policy(cls) -> dict[str, list[str]]:
        ...
        return {
            ...
            cls.UPGRADE_INSECURE_REQUESTS: [],  ***REMOVED*** No value needed
        }
    ...
    def build_header_value(cls, policy: dict[str, list[str]]) -> str:
        ...
        for directive, sources in policy.items():
            if sources:
                ***REMOVED*** Directive with sources
                sources_str = " ".join(sources)
                directives.append(f"{directive} {sources_str}")
            else:
                ***REMOVED*** Directive without sources (e.g., upgrade-insecure-requests)
