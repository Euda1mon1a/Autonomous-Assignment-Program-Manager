...
class Bottleneck:
    ...
    bottleneck_type: str  ***REMOVED*** "cpu", "memory", "sql", "request", "trace"
...
class PerformanceInsight:
    ...
    title: str
    description: str
    priority: int  ***REMOVED*** 1 (highest) to 5 (lowest)
...
class PerformanceAnalyzer:
    ...
    def analyze_profile_results(
        ...
        ***REMOVED*** Analyze execution time
...
class BottleneckDetector:
    ...
    def detect_sql_bottlenecks(self, queries: List[SQLQuery]) -> List[Bottleneck]:
        ...
        ***REMOVED*** Detect N+1 queries
        query_patterns = defaultdict(list)
        for query in queries:
            ***REMOVED*** Normalize SQL to detect patterns
        ...
        ***REMOVED*** Detect missing indexes
    ...
    def detect_request_bottlenecks(
        ...
        ***REMOVED*** Detect high error rates
    ...
    def detect_trace_bottlenecks(self, traces: List[Trace]) -> List[Bottleneck]:
        ...
        ***REMOVED*** Detect long trace chains
    ...
    def _normalize_sql(self, sql: str) -> str:
        ...
        ***REMOVED*** Remove parameter values
...
class QueryAnalyzer:
    ...
    def analyze_query_patterns(
        ...
        ***REMOVED*** Group by query pattern
        patterns = defaultdict(list)
        for query in queries:
            normalized = self._normalize_sql(query.sql)
            patterns[normalized].append(query)

        ***REMOVED*** Calculate statistics per pattern
        pattern_stats = []
        ...
        ***REMOVED*** Sort by total duration
