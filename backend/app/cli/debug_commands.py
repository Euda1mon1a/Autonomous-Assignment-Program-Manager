...
def check_health() -> None:
    ...
    try:
        ...
        ***REMOVED*** Exit with error code if unhealthy
...
def test_db() -> None:
    ...
    try:
        ...
        ***REMOVED*** Check database version
        result = db.execute(text("SELECT version()"))
        version = result.scalar()
        click.echo(f"✓ PostgreSQL version: {version.split(',')[0]}")

        ***REMOVED*** Check current user and database
        ...
        ***REMOVED*** Test query performance
        import time
...
def show_config() -> None:
    ...
    try:
        ...
        ***REMOVED*** Display sanitized config
        config = {
...
def env_check() -> None:
    ...
    try:
        ...
        ***REMOVED*** Check optional variables
        click.echo("\nOptional Variables:")
