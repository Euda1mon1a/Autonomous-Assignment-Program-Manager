...
def scan_file(
    ...
    ***REMOVED*** Try to parse as JSON
    try:
        ...
        ***REMOVED*** Not JSON, treat as plain text
        pass

    ***REMOVED*** Scan as plain text
...
def benchmark(
    ...
    ***REMOVED*** Benchmark
    ...
    config = AnonymizationConfig(
        method=method_enum,
        fields=["email", "phone"],
        audit_trail=False,  ***REMOVED*** Disable for benchmarking
    )
