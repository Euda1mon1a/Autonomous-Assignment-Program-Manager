...
def list(
    ...
    try:
        ...
        ***REMOVED*** Parse status if provided
        status_filter = None
        if status:
            try:
...
def show(
    ...
    try:
        ...
        ***REMOVED*** Display migration details
...
def history(
    ...
    db = SessionLocal()
    try:
        ***REMOVED*** Parse migration ID if provided
        mid = None
        if migration_id:
            try:
                mid = UUID(migration_id)
