...
def generate(
    ...
    try:
        ...
        ***REMOVED*** Initialize scheduling engine
        ...
        ***REMOVED*** Note: SchedulingEngine commits automatically on success
    ...
    try:
        ***REMOVED*** Determine date range
        if block:
            ...
            ***REMOVED*** Find last date of block
        ...
        ***REMOVED*** Generate report
        if report:
            ...
            with open(report_path, "w") as f:
                f.write(f"***REMOVED*** Schedule Validation Report\n\n")
                f.write(f"**Date Range:** {start_date} to {end_date}\n")
                f.write(f"**Assignments:** {len(assignments)}\n")
                f.write(f"**Violations:** {len(violations)}\n\n")

                if violations:
                    f.write("***REMOVED******REMOVED*** Violations\n\n")
                    for v in violations:
...
def export(
    ...
    try:
        ...
        ***REMOVED*** Export based on format
        output_path = Path(output)
        output_path.parent.mkdir(parents=True, exist_ok=True)
