...
def check(
    ...
    try:
        ***REMOVED*** Default to 4-week rolling window
        ...
        ***REMOVED*** Display results
        ...
        if not violations:
            ...
            ***REMOVED*** Group violations by severity
    ...
    try:
        ...
        ***REMOVED*** Calculate statistics
        ...
        for a in assignments:
            ...
            people[a.person_id]["hours"] += 4  ***REMOVED*** Assuming 4-hour half-days
        ...
        ***REMOVED*** Generate report
        if format == "markdown":
            with open(output_path, "w") as f:
                f.write("***REMOVED*** ACGME Compliance Report\n\n")
                ...
                f.write("\n***REMOVED******REMOVED*** Work Hours by Person\n\n")
