...
class ChangeType(str, Enum):
    ...
    ***REMOVED*** Breaking changes (major version bump)
    ...
    ***REMOVED*** Non-breaking changes (minor version bump)
    ...
    ***REMOVED*** Patch changes (patch version bump)
    DESCRIPTION_CHANGED = "description_changed"
    EXAMPLE_CHANGED = "example_changed"
    DEPRECATED_ADDED = "deprecated_added"

    ***REMOVED*** Internal changes (no version bump needed)
...
class APIDiff:
    ...
    def suggest_version_bump(self, current_version: str = "1.0.0") -> str:
        ...
        ***REMOVED*** Check for breaking changes (major bump)
        if self.has_breaking_changes:
            return f"{major + 1}.0.0"

        ***REMOVED*** Check for new features (minor bump)
        new_features = [
            c
        ...
        ***REMOVED*** Patch-level changes only
...
class APIDiffer:
    ...
    def _compare_paths(
        ...
        for path in sorted(all_paths):
            ...
            ***REMOVED*** Compare methods for this path
    ...
    def _compare_methods(
        ...
        ***REMOVED*** Method removed (breaking)
        ...
        ***REMOVED*** Method added (non-breaking)
        ...
        ***REMOVED*** Compare existing methods
        for method in old_methods & new_methods:
    ...
    def _compare_operation(
        ...
        ***REMOVED*** Check description changes
    ...
    def _compare_parameters(
        ...
        ***REMOVED*** Removed parameters (breaking)
    ...
    def _compare_request_body(
        ...
        ***REMOVED*** Body became required (breaking)
    ...
    def _compare_responses(
        ...
        ***REMOVED*** Removed response status (breaking)
        ...
        ***REMOVED*** Added response status (non-breaking)
    ...
    def _compare_components(
        ...
        ***REMOVED*** This is a simplified comparison - could be expanded to check
        ***REMOVED*** for field removals, type changes, etc. within schemas
