...
class VersionHistory:
    ...
    def list_versions(self) -> list[dict[str, Any]]:
        ...
        ***REMOVED*** Sort by saved_at timestamp (newest first)
...
class ChangelogGenerator:
    ...
    def save_current_version(
        ...
        """
        ***REMOVED*** Auto-detect version from schema
        if version is None:
    ...
    def generate_migration_guide(
        ...
        if not diff.breaking_changes:
            return "***REMOVED*** Migration Guide\n\nNo breaking changes detected. Migration is not required."

        lines = []
        lines.append("***REMOVED*** Migration Guide")
        lines.append("")
        lines.append(f"***REMOVED******REMOVED*** Migrating from {diff.old_version} to {diff.new_version}")
        lines.append("")
        lines.append(
        ...
        ***REMOVED*** Table of contents
        lines.append("***REMOVED******REMOVED*** Table of Contents")
        lines.append("")
        for i, change in enumerate(diff.breaking_changes, 1):
            lines.append(f"{i}. {change.description}")
        lines.append("")

        ***REMOVED*** Detailed migration steps
        lines.append("***REMOVED******REMOVED*** Detailed Migration Steps")
        lines.append("")
        ...
        ***REMOVED*** Testing recommendations
        lines.append("***REMOVED******REMOVED*** Testing Recommendations")
        lines.append("")
        ...
        ***REMOVED*** Support
        lines.append("***REMOVED******REMOVED*** Need Help?")
        lines.append("")
