...
class BackupService:
    ...
    def __init__(self, db: Session, backup_dir: str = "backups"):
        ...
        try:
            ...
            ***REMOVED*** Validate write permissions
    ...
    def create_backup(self, backup_type: str = 'full', compress: bool = True) -> dict[str, Any]:
        ...
        ***REMOVED*** Validate backup type
        ...
        try:
            ***REMOVED*** Check available disk space before proceeding
            self._check_disk_space()

            ***REMOVED*** Collect all data
    ...
    def create_schedule_snapshot(self, start_date: date, end_date: date) -> dict[str, Any]:
        ...
        ***REMOVED*** Validate date range
        ...
        try:
            ...
            ***REMOVED*** Get blocks in date range
    ...
    def export_to_json(self, backup_id: str) -> Path:
        ...
        try:
            ...
            ***REMOVED*** Validate source path is within backup directory
            ...
            ***REMOVED*** Write uncompressed JSON
            export_filename = f"export_{backup_id}.json"
            export_path = self.backup_path / export_filename

            ***REMOVED*** Validate export path is within backup directory
    ...
    def delete_backup(self, backup_id: str) -> bool:
        ...
        try:
            ...
            ***REMOVED*** Validate paths are within backup directory
    ...
    ***REMOVED*** Private helper methods
    ...
    def _check_disk_space(self, min_free_mb: int = 100):
        ...
        try:
            ...
            ***REMOVED*** Available space in bytes
            ...
            ***REMOVED*** Don't fail the backup if we can't check disk space
            pass
