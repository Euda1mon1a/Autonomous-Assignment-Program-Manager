...
class WhatIfScenario:
    ...
    name: str
    description: str
    changes: list[dict]  ***REMOVED*** List of assignment changes
    created_at: datetime = field(default_factory=datetime.now)

    ***REMOVED*** Change types:
    ***REMOVED*** {"action": "add", "person_id": ..., "block_id": ..., "rotation_type": ...}
    ***REMOVED*** {"action": "remove", "assignment_id": ...}
    ***REMOVED*** {"action": "swap", "assignment1_id": ..., "assignment2_id": ...}
    ***REMOVED*** {"action": "move", "assignment_id": ..., "new_block_id": ...}
...
class FatigueImpactReport:
    ...
    ***REMOVED*** Baseline metrics (current schedule)
    baseline_metrics: dict[str, Any] = field(default_factory=dict)

    ***REMOVED*** Proposed metrics (after changes)
    proposed_metrics: dict[str, Any] = field(default_factory=dict)

    ***REMOVED*** Impact summary
    impact_summary: dict[str, Any] = field(default_factory=dict)

    ***REMOVED*** Per-person impact
    person_impacts: list[dict] = field(default_factory=list)

    ***REMOVED*** Recommendations
    recommendations: list[str] = field(default_factory=list)

    ***REMOVED*** Holographic export data
...
class ScenarioAnalyzer:
    ...
    def analyze(
        ...
        ***REMOVED*** Generate visualization data
    ...
    def compare_scenarios(
        ...
        ***REMOVED*** Sort by overall fatigue score (lower is better)
        reports.sort(
    ...
    def find_best_coverage(
        ...
        for person in eligible_persons:
            ***REMOVED*** Create scenario for this person covering
            scenario = WhatIfScenario(
        ...
        ***REMOVED*** Sort by fatigue impact (lowest impact first)
    ...
    def _calculate_metrics(
        ...
        ***REMOVED*** Calculate overall fatigue score (inverse of effectiveness)
    ...
    def _calculate_impact(
        ...
        return {
            ...
            "persons_improved": 0,  ***REMOVED*** TODO: Calculate
            "persons_degraded": 0,  ***REMOVED*** TODO: Calculate
        }
