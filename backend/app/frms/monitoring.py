...
class FatigueMonitor:
    ...
    ***REMOVED*** Trend detection
    TREND_WINDOW_HOURS = 4.0  ***REMOVED*** Look back 4 hours for trend
    TREND_THRESHOLD = 5.0  ***REMOVED*** 5% change is significant
    ...
    def get_dashboard_metrics(self) -> DashboardMetrics:
        ...
        ***REMOVED*** Sort highest risk
        ...
        highest_risk = highest_risk[:5]  ***REMOVED*** Top 5
