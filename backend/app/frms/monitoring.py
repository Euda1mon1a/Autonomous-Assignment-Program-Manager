...
class AlertSeverity(str, Enum):
    ...
    INFO = "info"  ***REMOVED*** Approaching thresholds
    WARNING = "warning"  ***REMOVED*** Below FAA caution (77%)
    CRITICAL = "critical"  ***REMOVED*** Below FRA threshold (70%)
    EMERGENCY = "emergency"  ***REMOVED*** Below unacceptable (60%)
...
class DashboardMetrics:
    ...
    ***REMOVED*** Distribution by risk level
    at_optimal: int  ***REMOVED*** ≥95%
    at_acceptable: int  ***REMOVED*** 85-94%
    at_caution: int  ***REMOVED*** 77-84%
    at_high_risk: int  ***REMOVED*** 70-76%
    at_critical: int  ***REMOVED*** <70%

    ***REMOVED*** Trend indicators
    improving: int  ***REMOVED*** Fatigue decreasing
    stable: int  ***REMOVED*** No significant change
    degrading: int  ***REMOVED*** Fatigue increasing

    ***REMOVED*** Top concerns
    highest_risk_residents: list[dict] = field(default_factory=list)
    upcoming_risk_shifts: list[dict] = field(default_factory=list)

    ***REMOVED*** 24-hour statistics
...
class FatigueMonitor:
    ...
    ***REMOVED*** Trend detection (imported from constants)
    ...
    def __init__(
        ...
        ***REMOVED*** Deduplication with timestamps
    ...
    def update_resident(
        ...
        ***REMOVED*** Record effectiveness history
        ...
        if state.effectiveness:
            ...
            ***REMOVED*** Keep only last 48 hours
    ...
    def _check_and_generate_alert(
        ...
        ***REMOVED*** Check for deduplication (don't repeat same alert within 1 hour)
        ...
        ***REMOVED*** Clean up old deduplication keys (older than 1 hour)
        self._cleanup_old_alert_keys(now)

        ***REMOVED*** Trigger callback
    ...
    def _get_recommendations(
        ...
        ***REMOVED*** Add factor-specific recommendations
    ...
    def get_dashboard_metrics(self) -> DashboardMetrics:
        ...
        ***REMOVED*** Sort highest risk
        highest_risk.sort(key=lambda x: x["effectiveness"])
        highest_risk = highest_risk[:TOP_RISK_RESIDENTS_COUNT]  ***REMOVED*** Top N
        ...
        ***REMOVED*** Effectiveness 24h
        ...
        return DashboardMetrics(
            ...
            upcoming_risk_shifts=[],  ***REMOVED*** TODO: Integrate with schedule
