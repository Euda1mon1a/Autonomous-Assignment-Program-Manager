...
class BreakingChange:
    ...
    new_value: Any
    path: str
    severity: str = "high"  ***REMOVED*** high, medium, low
...
class Contract(BaseModel):
    ...
    def validate_version(cls, v: str) -> str:
        ...
        ***REMOVED*** Simple semantic version check: MAJOR.MINOR.PATCH
    ...
    def get_hash(self) -> str:
        ...
        """
        ***REMOVED*** Create a stable representation for hashing
        content = {
...
class ContractVerifier:
    ...
    async def verify_contract(
        ...
        ***REMOVED*** Verify each interaction
    ...
    async def _verify_interaction(
        ...
        ***REMOVED*** Set up provider state if needed
    ...
    async def _run_provider_state(
        ...
        if setup_db:
            ***REMOVED*** If state function accepts db parameter
            import inspect
    ...
    async def _make_request(self, request: ContractRequest) -> dict[str, Any]:
        ...
        if isinstance(self.client, TestClient):
            ***REMOVED*** Synchronous TestClient
            ...
            ***REMOVED*** Async httpx client
            response = await self.client.request(  ***REMOVED*** type: ignore
                method=request.method,
                url=request.path,
                headers=request.headers,
                params=request.query,
    ...
    def _verify_response(
        ...
        ***REMOVED*** Check body with schema if provided
        ...
        ***REMOVED*** Check body structure if no schema
    ...
    def _compare_structures(self, expected: Any, actual: Any) -> bool:
        ...
        if isinstance(expected, list):
            if len(expected) == 0:
                return True  ***REMOVED*** Empty list matches any list
            ***REMOVED*** Check if actual list items match expected structure
            if len(actual) == 0:
                return False
...
class ContractTester:
    ...
    def load_contract(filepath: str) -> Contract:
        ...
        ***REMOVED*** Convert from Pact format to our Contract model
        contract = Contract(
...
class ContractPublisher:
    ...
    async def publish(
        ...
        ***REMOVED*** Prepare contract in Pact format
        pact_data = contract.to_pact_format()

        ***REMOVED*** Add version metadata
        if git_sha:
        ...
        ***REMOVED*** Publish to broker
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                ***REMOVED*** Apply tags if provided
                if tags:
    ...
    async def fetch_contract(
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                ***REMOVED*** Convert to our Contract model
                contract = Contract(
...
class ContractCompatibilityChecker:
    ...
    def check_compatibility(
        ...
        ***REMOVED*** Build interaction maps
        old_interactions = {
        ...
        ***REMOVED*** Check for removed endpoints
        for key, old_interaction in old_interactions.items():
            ...
            ***REMOVED*** Check for changes in existing endpoints
    ...
    def _check_interaction_compatibility(
        ...
        ***REMOVED*** Check response status code
        ...
        ***REMOVED*** Check response body structure
        ...
        ***REMOVED*** Check if response body was removed
        ...
        if isinstance(old_body, dict) and isinstance(new_body, dict):
            ***REMOVED*** Check for removed fields
            for key in old_body.keys():
                ...
                ***REMOVED*** Check for type changes
                old_value = old_body[key]
                ...
                if type(old_value) != type(new_value):
                    ...
                    ***REMOVED*** Recursively check nested objects
            ...
            ***REMOVED*** Check list item compatibility
