...
class ExportFormat(Enum):
    ...
    FULL = "full"  ***REMOVED*** Complete data with all details
    COMPACT = "compact"  ***REMOVED*** Minimal data for visualization
    HOLOGRAPHIC = "holographic"  ***REMOVED*** Optimized for 3D visualization
...
class SolutionExport:
    ...
    generation: int
    position_3d: list[float] | None = None  ***REMOVED*** For 3D visualization
    color: str = "***REMOVED***3B82F6"  ***REMOVED*** Tailwind blue-500 default
...
class TradeOffLandscape:
    ...
    ***REMOVED*** Pareto front structure
...
class ParetoVisualization:
    ...
    ***REMOVED*** Point cloud
    points: list[list[float]] = field(default_factory=list)  ***REMOVED*** [x, y, z] coordinates
    colors: list[str] = field(default_factory=list)  ***REMOVED*** Hex color codes
    sizes: list[float] = field(default_factory=list)  ***REMOVED*** Point sizes
    labels: list[str] = field(default_factory=list)  ***REMOVED*** Hover labels
...
class DecisionJourneyExport:
    ...
    ***REMOVED*** Path through solution space
    exploration_path: list[str] = field(default_factory=list)  ***REMOVED*** Solution IDs
...
class HolographicExporter:
    ...
    def _build_landscape(
        ...
        ***REMOVED*** Export solutions
        ...
        for i, sol in enumerate(frontier.solutions):
            ...
            ***REMOVED*** Color based on feasibility and rank
            if not sol.is_feasible:
                sol_export.color = "***REMOVED***EF4444"  ***REMOVED*** Red
            elif sol.rank == 0:
                sol_export.color = "***REMOVED***10B981"  ***REMOVED*** Green
            else:
                sol_export.color = "***REMOVED***6B7280"  ***REMOVED*** Gray

            sol_exports.append(sol_export)

        ***REMOVED*** Find frontier, extremes, knee
        frontier_indices = list(range(len(frontier.solutions)))  ***REMOVED*** All on Pareto front
        ...
        ***REMOVED*** Build trade-off edges (for FULL format)
        edges = []
    ...
    def _build_tradeoff_edges(self, frontier: ParetoFrontier) -> list[TradeOffEdge]:
        ...
        ***REMOVED*** Only for small fronts (edges grow quadratically)
        if n > 100:
            return edges
    ...
    def _build_visualization(
        ...
        ***REMOVED*** Default to first three objectives
        ...
        for sol in frontier.solutions:
            ...
            ***REMOVED*** Color
            if not sol.is_feasible:
                colors.append("***REMOVED***EF4444")
            elif sol.rank == 0:
                colors.append("***REMOVED***10B981")
            else:
                colors.append("***REMOVED***6B7280")

            ***REMOVED*** Size based on crowding distance
            if sol.crowding_distance == float("inf"):
                sizes.append(1.5)  ***REMOVED*** Boundary solutions larger
            else:
                sizes.append(1.0)
