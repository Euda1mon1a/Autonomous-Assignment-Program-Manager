...
class TradeOff:
    ...
    trade_off_rate: float  ***REMOVED*** degradation per unit improvement
    solution_from: UUID
    solution_to: UUID
    is_favorable: bool  ***REMOVED*** True if improvement > degradation (normalized)
...
class NavigationStep:
    ...
    step_size: float  ***REMOVED*** Distance moved in objective space
    remaining_options: int  ***REMOVED*** How many more solutions in this direction
...
class TradeOffAnalyzer:
    ...
    def analyze_trade_off(
        ...
        for obj in self.active_objectives:
            ...
            ***REMOVED*** Normalize to [0,1] if possible
        ...
        ***REMOVED*** Create trade-off pairs
        trade_offs = []
    ...
    def find_favorable_trade_offs(
        ...
        ***REMOVED*** Find current best in objective
        ...
        ***REMOVED*** Find solutions with favorable trade-offs from other solutions
        favorable = []
        for sol in solutions[1:]:
            trade_offs = self.analyze_trade_off(sol, best)

            ***REMOVED*** Check if all degradations are within limit
            max_deg = max(
...
class SolutionExplorer:
    ...
    def __init__(
        ...
        ***REMOVED*** Current position in exploration
    ...
    def _find_next_solution(
        ...
        if direction == NavigationDirection.TOWARD_OBJECTIVE and objective:
            ...
            ***REMOVED*** Filter to better solutions
            if obj.direction == ObjectiveDirection.MAXIMIZE:
                better = [
                    s
                    for s in candidates
            ...
            ***REMOVED*** Return nearest better solution
            ...
            ***REMOVED*** Filter to worse solutions in this objective
            if obj.direction == ObjectiveDirection.MAXIMIZE:
                worse = [
                    s
                    for s in candidates
        ...
        else:  ***REMOVED*** EXTREME
            ***REMOVED*** Move toward nearest extreme
            ...
            if nearest_extreme.id == current.id:
                ***REMOVED*** Already at an extreme, find furthest
                return max(
                    candidates, key=lambda s: self._calculate_distance(current, s)
                )

            ***REMOVED*** Move toward the extreme
            return min(
                candidates,
    ...
    def _count_remaining(
        ...
        ***REMOVED*** Simple heuristic: count solutions in the direction
        count = 0
    ...
    def compare_bookmarks(self) -> list[SolutionComparison]:
        ...
        for i in range(len(self.bookmarks)):
            for j in range(i + 1, len(self.bookmarks)):
                ...
                ***REMOVED*** Calculate objective differences
                differences = {}
                for obj in self.active_objectives:
                ...
                ***REMOVED*** Recommend based on dominance
...
class PreferenceElicitor:
    ...
    def __init__(self, objectives: list[ObjectiveConfig]):
        ...
        ***REMOVED*** History
        self.comparisons: list[tuple[Solution, Solution, int]] = []  ***REMOVED*** (a, b, preferred: 0=a, 1=b)
...
class WhatIfScenario:
    ...
    name: str
    description: str
    objective_adjustments: dict[str, float]  ***REMOVED*** Multipliers for objectives
    constraint_changes: dict[str, float]  ***REMOVED*** Changes to constraint thresholds
...
class WhatIfAnalyzer:
    ...
    def analyze_scenario(
        ...
        Returns:
            Analysis results
        """
        ***REMOVED*** Re-evaluate solutions with modified objectives
        modified_solutions = []
        ...
        ***REMOVED*** Create modified frontier
        ...
        ***REMOVED*** Find new and lost solutions
...
class DecisionMaker:
    ...
    def get_recommendation(self) -> tuple[Solution | None, str]:
        ...
        ***REMOVED*** Explain recommendation
