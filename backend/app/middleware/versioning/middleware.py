...
***REMOVED*** Context variable for current API version (thread-safe)
...
class APIVersion(str, Enum):
    ...
    def from_string(cls, version: str) -> Optional["APIVersion"]:
        ...
        ***REMOVED*** Normalize: remove 'v' prefix and get major version
        version = version.lower().strip()
        if version.startswith("v"):
            version = version[1:]

        ***REMOVED*** Extract major version number
    ...
    def numeric(self) -> int:
        ...
        return int(self.value[1:])  ***REMOVED*** Remove 'v' prefix
...
***REMOVED*** Default version when none specified
...
class VersioningMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        ...
        ***REMOVED*** URL pattern for version detection
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        """
        ***REMOVED*** Detect version from request
        version = self._detect_version(request)

        ***REMOVED*** Store in request state
        request.state.api_version = version

        ***REMOVED*** Store in context variable (for non-request contexts)
        token = _current_api_version.set(version)

        try:
            ***REMOVED*** Log version for tracking
            ...
            ***REMOVED*** Add version information to response headers
    ...
    def _extract_from_query(self, query_params) -> Optional[APIVersion]:
        ...
        Returns:
            APIVersion or None
        """
        ***REMOVED*** Check both 'version' and 'api_version' params
