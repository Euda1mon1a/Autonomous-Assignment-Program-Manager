...
class VersionStatus(str, Enum):
    ...
    DEVELOPMENT = "development"  ***REMOVED*** Under active development, unstable
    BETA = "beta"  ***REMOVED*** Feature complete but not production-ready
    STABLE = "stable"  ***REMOVED*** Production-ready and actively maintained
    DEPRECATED = "deprecated"  ***REMOVED*** Still available but not recommended
    SUNSET = "sunset"  ***REMOVED*** Scheduled for removal
    RETIRED = "retired"  ***REMOVED*** No longer available
...
class DeprecationWarning:
    ...
    def to_header_value(self) -> str:
        ...
        if self.sunset_date:
            ***REMOVED*** RFC 3339 format for Sunset header
...
class DeprecationManager:
    ...
    def __init__(self):
        ...
        ***REMOVED*** Register default deprecations
        self._register_defaults()

    def _register_defaults(self):
        """Register default deprecation warnings."""
        ***REMOVED*** Example: Deprecate legacy swap endpoint
        ...
        ***REMOVED*** Example: Deprecate old assignment format
        self.register_deprecation(
    ...
    def add_deprecation_headers(
        ...
        ***REMOVED*** Custom header with structured data
        response.headers["X-API-Deprecation"] = deprecation.to_header_value()

        ***REMOVED*** Log the deprecation access for monitoring
        logger.warning(
    ...
    def check_sunset_enforcement(self, request: Request) -> dict | None:
        ...
        ***REMOVED*** Block if past sunset date
    ...
    def get_all_deprecations(self) -> list[dict]:
        ...
        ***REMOVED*** Sort by sunset date (soonest first)
...
***REMOVED*** Global deprecation manager instance
