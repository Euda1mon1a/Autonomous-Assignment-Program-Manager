...
class ResponseLogger:
    ...
    def _parse_response_body(
        ...
        ***REMOVED*** For text responses, include truncated content
        ...
        ***REMOVED*** For other content types, just log metadata
        else:
...
class StreamingResponseLogger:
    ...
    def log_streaming_response(
        ...
        """
        ***REMOVED*** Log initial response metadata
...
class ResponseMetrics:
    ...
    def __init__(self):
        ...
        self.metrics: Dict[str, Any] = {
            ...
            "status_codes": {},
            "response_times": {
                "excellent": 0,  ***REMOVED*** < 100ms
                "good": 0,  ***REMOVED*** < 500ms
                "fair": 0,  ***REMOVED*** < 1000ms
                "poor": 0,  ***REMOVED*** < 3000ms
                "critical": 0,  ***REMOVED*** >= 3000ms
            },
            "endpoints": {},
        }
    ...
    def record_response(
        ...
        ***REMOVED*** Track per-endpoint metrics
