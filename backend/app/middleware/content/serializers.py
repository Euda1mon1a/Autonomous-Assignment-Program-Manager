    ...
    def serialize(self, data: Any) -> bytes:
        ...
        try:
            json_str = json.dumps(
                ...
                default=str,  ***REMOVED*** Convert non-serializable to string
            )
...
class XMLSerializer(Serializer):
    ...
    def serialize(self, data: Any) -> bytes:
        ...
        try:
            ...
            ***REMOVED*** Convert data to XML elements
            self._dict_to_xml(root, data)

            ***REMOVED*** Convert to bytes
            if self._lxml_available:
