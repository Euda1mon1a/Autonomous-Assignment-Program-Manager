...
class TimingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        ***REMOVED*** Get request ID for correlation
        ...
        ***REMOVED*** Process request
        try:
            ...
            ***REMOVED*** Add timing header to response
            response.headers["X-Response-Time"] = f"{duration_ms:.2f}ms"

            ***REMOVED*** Log timing information
            self._log_timing(
                request=request,
                response=response,
            ...
            ***REMOVED*** Log to performance logger
            if self.perf_logger:
    ...
    def _log_timing(
        ...
        ***REMOVED*** Log at appropriate level based on duration and status
