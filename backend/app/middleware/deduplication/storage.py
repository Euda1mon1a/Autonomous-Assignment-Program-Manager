...
class RequestRecord:
    ...
    completed_at: float | None = None  ***REMOVED*** Timestamp when request completed
    ttl: int = 300  ***REMOVED*** Time-to-live in seconds
    response_status: int | None = None  ***REMOVED*** HTTP status code
    response_headers: dict[str, str] | None = None  ***REMOVED*** Response headers
    response_body: bytes | None = None  ***REMOVED*** Cached response body
    error_message: str | None = None  ***REMOVED*** Error message if failed
