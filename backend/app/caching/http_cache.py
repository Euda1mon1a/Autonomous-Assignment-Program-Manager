...
class CacheDirective:
    ...
    ***REMOVED*** Response directives
    ...
    max_age: int | None = None  ***REMOVED*** Max age in seconds
    s_maxage: int | None = None  ***REMOVED*** Shared cache max age
    immutable: bool = False  ***REMOVED*** Never changes (non-standard but widely supported)

    ***REMOVED*** Custom directives
    stale_while_revalidate: int | None = None  ***REMOVED*** Serve stale while revalidating
    stale_if_error: int | None = None  ***REMOVED*** Serve stale if error
