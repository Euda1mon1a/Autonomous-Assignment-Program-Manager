...
class ETagGenerator:
    ...
    Example:
        ...
        ***REMOVED*** Strong ETag from content
        etag = generator.generate(response_body)
        ***REMOVED*** Returns: "abc123def456"

        ***REMOVED*** Weak ETag from data
        etag = generator.generate_weak({"data": "value"})
        ***REMOVED*** Returns: W/"abc123def456"
    """
    ...
    def generate(self, content: bytes | str, weak: bool = False) -> str:
        ...
        Example:
            ...
            ***REMOVED*** Returns: "a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e"
        """
    ...
    def generate_weak(self, data: Any) -> str:
        ...
        Example:
            ...
            ***REMOVED*** Returns: W/"hash_of_json"
        """
        ***REMOVED*** Serialize to JSON (sorted keys for consistency)
    ...
    def is_weak(etag: str) -> bool:
        ...
        Example:
            ETagGenerator.is_weak('W/"abc123"')  ***REMOVED*** True
            ETagGenerator.is_weak('"abc123"')    ***REMOVED*** False
        """
    ...
    def strip_weak_prefix(etag: str) -> str:
        ...
        Example:
            ETagGenerator.strip_weak_prefix('W/"abc123"')  ***REMOVED*** "abc123"
        """
    ...
    def matches(etag1: str, etag2: str, strong_comparison: bool = False) -> bool:
        ...
        Example:
            ***REMOVED*** Weak comparison (default)
            ETagGenerator.matches('W/"abc"', '"abc"')  ***REMOVED*** True

            ***REMOVED*** Strong comparison
            ETagGenerator.matches('W/"abc"', '"abc"', strong_comparison=True)  ***REMOVED*** False
        """
        ***REMOVED*** Strong comparison requires both to be strong
        if strong_comparison:
            if ETagGenerator.is_weak(etag1) or ETagGenerator.is_weak(etag2):
                return False

        ***REMOVED*** Strip weak prefixes for comparison
    ...
    def parse_if_none_match(header_value: str) -> list[str]:
        ...
        Example:
            ...
            ***REMOVED*** Returns: ['"abc"', 'W/"def"', '"ghi"']
        """
        ***REMOVED*** Handle wildcard
        if header_value.strip() == "*":
            return ["*"]

        ***REMOVED*** Split by comma and strip whitespace
    ...
    def matches_any(etag: str, etag_list: list[str]) -> bool:
        ...
        """
        ***REMOVED*** Wildcard matches everything
        if "*" in etag_list:
            return True

        ***REMOVED*** Check each ETag
...
def generate_etag(
    ...
    Example:
        ***REMOVED*** Strong ETag from bytes
    ...
    ***REMOVED*** Handle different content types
    if isinstance(content, (bytes, str)):
        return generator.generate(content, weak=weak)
    else:
        ***REMOVED*** Assume JSON-serializable
