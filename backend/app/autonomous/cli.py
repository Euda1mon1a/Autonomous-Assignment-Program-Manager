...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  ***REMOVED*** Run baseline scenario for 200 iterations
  python -m app.autonomous.cli --scenario baseline --max-iters 200

  ***REMOVED*** Resume a previous run
  python -m app.autonomous.cli --resume baseline_20250122_143052_abc12345

  ***REMOVED*** Run resilience test harness
  python -m app.autonomous.cli --harness --threshold 0.8

  ***REMOVED*** Generate for specific date range
...
""",
    ...
    ***REMOVED*** Generator configuration
    parser.add_argument(
        "--algorithm",
        type=str,
...
def run_loop(args: argparse.Namespace) -> int:
    ...
    ***REMOVED*** Create database session
    ...
    try:
        ***REMOVED*** Create loop configuration
        ...
        ***REMOVED*** Create generator configuration
        generator_config = GeneratorConfig(
            algorithms=[args.algorithm, "greedy", "cp_sat", "pulp", "hybrid"],
            default_timeout=args.timeout,
        )

        ***REMOVED*** Create or resume loop
        ...
        ***REMOVED*** Set initial parameters
        if not args.resume:
