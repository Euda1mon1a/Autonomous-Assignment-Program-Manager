...
class ResilienceHarness:
    ...
    def generate_scenarios(self) -> list[AdversarialScenario]:
        ...
        ***REMOVED*** Get people for targeted scenarios
        ...
        ***REMOVED*** N-1: Remove each faculty member
        for fac in faculty[:3]:  ***REMOVED*** Test first 3 to limit runtime
            scenarios.append(
                AdversarialScenario(
        ...
        ***REMOVED*** N-1: Remove each resident
        ...
        ***REMOVED*** Unexpected leave (random person, random week)
        if faculty:
        ...
        ***REMOVED*** Holiday staffing shock (reduced capacity for period)
        scenarios.append(
            AdversarialScenario(
        ...
        ***REMOVED*** Multiple simultaneous absences
        if len(faculty) >= 2:
            scenarios.append(
                AdversarialScenario(
    ...
    def run_scenario(
        ...
        try:
            ***REMOVED*** Apply scenario modifications
            self._apply_scenario(scenario)

            ***REMOVED*** Generate schedule under scenario conditions
            ...
            for i in range(max_recovery_iterations):
                ...
                ***REMOVED*** Early exit if feasible and good enough
                if evaluation.valid and evaluation.score >= baseline_score * 0.9:
                    break

            ***REMOVED*** Revert scenario modifications
            ...
            self._revert_scenario(scenario)  ***REMOVED*** Ensure cleanup
            return ScenarioResult(
                scenario=scenario,
                baseline_score=baseline_score,
                scenario_score=0.0,
    ...
    def run_all_scenarios(
        ...
        ***REMOVED*** Generate and run scenarios
    ...
    def _apply_scenario(self, scenario: AdversarialScenario) -> None:
        ...
        """
        ***REMOVED*** Create savepoint for rollback
        self._savepoint = self.db.begin_nested()

        if scenario.type == ScenarioType.REMOVE_FACULTY:
            ***REMOVED*** Mark faculty as unavailable for entire period
        ...
        ***REMOVED*** Clear generator cache after modifications
    ...
    def _revert_scenario(self, scenario: AdversarialScenario) -> None:
        ...
        ***REMOVED*** Clear generator cache after revert
        self.generator.clear_cache()
