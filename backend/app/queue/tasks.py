...
class BaseQueueTask(Task):
    ...
    ***REMOVED*** Default retry policy
    autoretry_for = (Exception,)
    max_retries = 3
    retry_backoff = True  ***REMOVED*** Exponential backoff
    retry_backoff_max = 600  ***REMOVED*** Max 10 minutes
    retry_jitter = True  ***REMOVED*** Add randomness to avoid thundering herd

    ***REMOVED*** Task timing
    track_started = True
    acks_late = True  ***REMOVED*** Acknowledge after task completes (ensures no loss on worker crash)
    ...
    def on_failure(
        ...
        ***REMOVED*** Send to dead letter queue
        try:
...
***REMOVED*** ============================================================================
***REMOVED*** Task Creation Utilities
***REMOVED*** ============================================================================
