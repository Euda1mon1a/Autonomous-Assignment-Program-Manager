    ...
    async def _perform_check(self) -> dict[str, Any]:
        ...
        try:
            async with httpx.AsyncClient(verify=self.check_ssl) as client:
                ***REMOVED*** Make GET request to the URL
                ...
                ***REMOVED*** Extract response details
                status_code = response.status_code
                headers = dict(response.headers)

                ***REMOVED*** Parse URL for additional info
...
class DNSHealthCheck:
    ...
    async def check(self) -> dict[str, Any]:
        ...
        try:
            ***REMOVED*** Attempt DNS resolution
            ...
            ***REMOVED*** Extract unique IP addresses
