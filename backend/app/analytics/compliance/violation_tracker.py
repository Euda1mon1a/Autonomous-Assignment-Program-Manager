...
class ViolationTracker:
    ...
    async def _track_80_hour_violations(
        ...
        for person in persons:
            ...
            ***REMOVED*** Check 4-week rolling windows
    ...
    def _check_80_hour_windows(
        ...
        ***REMOVED*** Check 4-week rolling windows
        ...
        for i in range(len(week_nums) - 3):
            ...
            total_hours = len(window_assignments) * 4  ***REMOVED*** 4 hours per half-day
            max_hours = 80 * 4  ***REMOVED*** 80 hours/week * 4 weeks
    ...
    async def get_violation_trends(
        ...
        ***REMOVED*** Track violations week by week
        weeks_data = []
        current = start_date
