...
class AnalyticsEngine:
    ...
    def analyze_schedule(self, start_date: date, end_date: date) -> AnalysisResult:
        ...
        ***REMOVED*** Fetch assignments in date range
        assignments = (
        ...
        ***REMOVED*** Convert to dicts for metric calculations
        ...
        ***REMOVED*** Get schedule run stats
        schedule_runs = (
    ...
    def get_resident_workload_distribution(
        ...
        ***REMOVED*** Group by person
        ...
        for person_id, name, pgy_level, target, count in results:
            target_blocks = target or 48  ***REMOVED*** Default if not set
    ...
    def get_rotation_coverage_stats(
        ...
        ***REMOVED*** Group by activity type
    ...
    def compare_schedules(
        ...
        ***REMOVED*** Get assignments for each run's date range
        assignments1 = (
            self.db.query(Assignment)
            .join(Block)
