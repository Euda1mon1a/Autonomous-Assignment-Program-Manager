...
class AnalyticsEngine:
    ...
    async def calculate_all_metrics(
        ...
        ***REMOVED*** Calculate base metrics
        ...
        ***REMOVED*** Forecasting
        forecasts = self.forecast_engine.forecast(
            time_series_data,
            periods=4,  ***REMOVED*** 4 weeks ahead
        )
    ...
    async def get_person_analytics(
        ...
        ***REMOVED*** Calculate person-specific metrics
