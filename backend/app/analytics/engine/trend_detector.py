...
class TrendDetector:
    ...
    def _analyze_trend(self, series: pd.Series) -> dict[str, Any]:
        ...
        ***REMOVED*** Determine confidence based on p-value and R²
        ...
        ***REMOVED*** Calculate percent change
        if len(series) >= 2:
    ...
    def detect_change_points(
        ...
        ***REMOVED*** Find points exceeding threshold
        change_points = []
    ...
    def detect_cycles(
        ...
        ***REMOVED*** Calculate autocorrelation for different lags
        autocorrs = []
        ...
        ***REMOVED*** Find strongest autocorrelation
