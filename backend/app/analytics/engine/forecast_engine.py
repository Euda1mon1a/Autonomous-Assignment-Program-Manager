...
class ForecastEngine:
    ...
    def _forecast_moving_average(
        ...
        ***REMOVED*** Predict constant value
        predicted_values = [last_ma] * periods

        ***REMOVED*** Calculate prediction interval using historical std
        std = series.std()
        confidence_intervals = [
    ...
    def _forecast_exponential_smoothing(
        ...
        ***REMOVED*** Calculate exponential moving average
        ema = series.ewm(alpha=alpha, adjust=False).mean()
        last_ema = ema.iloc[-1]

        ***REMOVED*** Simple exponential smoothing (constant prediction)
    ...
    def _forecast_linear_trend(
        ...
        ***REMOVED*** Confidence intervals
        ...
        for i, pred in enumerate(predicted_values):
            ***REMOVED*** Wider intervals for further predictions
