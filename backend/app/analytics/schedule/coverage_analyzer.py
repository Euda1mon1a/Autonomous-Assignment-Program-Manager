...
class CoverageAnalyzer:
    ...
    async def _calculate_redundancy(
        ...
        ***REMOVED*** Get blocks with multiple assignments
        query = (
            select(
                Block.date,
                func.count(Assignment.id).label("assignment_count"),
