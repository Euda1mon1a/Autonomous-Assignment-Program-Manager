...
class ChartGenerator:
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** SVG Fallback Methods (when matplotlib is not available)
    ***REMOVED*** =========================================================================
    ...
    def _generate_line_chart_svg(
        ...
        ***REMOVED*** Plot each series
        colors = ["***REMOVED***1f77b4", "***REMOVED***ff7f0e", "***REMOVED***2ca02c", "***REMOVED***d62728", "***REMOVED***9467bd", "***REMOVED***8c564b"]
        legend_y = margin + 20
    ...
    def _generate_bar_chart_svg(
        ...
        ***REMOVED*** Draw bars
        for i, (cat, val) in enumerate(zip(categories, values)):
            ...
            svg_lines.extend(
                [
                    f'<rect x="{x:.1f}" y="{y:.1f}" width="{bar_width:.1f}" height="{bar_height:.1f}" fill="***REMOVED***1f77b4"/>',
    ...
    def _generate_pie_chart_svg(
        ...
        ***REMOVED*** Draw pie slices
        colors = ["***REMOVED***1f77b4", "***REMOVED***ff7f0e", "***REMOVED***2ca02c", "***REMOVED***d62728", "***REMOVED***9467bd", "***REMOVED***8c564b"]
        start_angle = -90  ***REMOVED*** Start at top

        for idx, (label, pct) in enumerate(zip(labels, percentages)):
            color = colors[idx % len(colors)]
            slice_angle = (pct / 100) * 360

            ***REMOVED*** Calculate arc path
    ...
    def _generate_error_svg(self, error_msg: str) -> str:
        ...
        <svg width="400" height="100" xmlns="http://www.w3.org/2000/svg">
            <rect width="400" height="100" fill="***REMOVED***ffeeee" stroke="***REMOVED***ff0000" stroke-width="2"/>
            <text x="200" y="50" text-anchor="middle" font-size="14" fill="***REMOVED***cc0000">
