...
Usage:
    ...
    ***REMOVED*** Create a full backup
    backup_id = await service.create_backup(strategy="full")

    ***REMOVED*** Create an incremental backup
...
class BackupService:
    ...
    async def create_backup(
        ...
        **kwargs,
        ...
        try:
            ***REMOVED*** Get appropriate strategy
            ...
            ***REMOVED*** For incremental/differential, find last backup timestamp
            ...
            ***REMOVED*** Execute backup strategy
    ...
    def get_backup_info(self, backup_id: str) -> dict[str, Any]:
        ...
        """
        try:
            ***REMOVED*** Find backup in list
            all_backups = self.storage.list_backups(limit=1000)

            for backup in all_backups:
                if backup["backup_id"] == backup_id:
                    ***REMOVED*** Add verification status
        ...
        try:
            ...
            ***REMOVED*** Calculate cutoff date
            ...
            for i, backup in enumerate(all_backups):
                ...
                ***REMOVED*** Always keep minimum number of recent backups
                if i < keep_minimum:
                    logger.debug(
                ...
                ***REMOVED*** Keep backups within retention period
                ...
                ***REMOVED*** For old backups, keep one full backup per week
                if backup_type == "full":
