...
class Query:
    ...
    def people(
        ...
        ***REMOVED*** Convert to GraphQL types
        ...
        ***REMOVED*** Apply filters
        if filter:
            ...
            if filter.start_date or filter.end_date:
                ***REMOVED*** Join with blocks to filter by date
    ...
    def schedule_summary(
        ...
        ***REMOVED*** Get total people
        total_people = db.query(func.count(DBPerson.id)).scalar()

        ***REMOVED*** Get total blocks in range
        total_blocks = (
        ...
        ***REMOVED*** Get total assignments in range
        total_assignments = (
        ...
        ***REMOVED*** Calculate average confidence score as proxy for compliance
        avg_confidence = (
