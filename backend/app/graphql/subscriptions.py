...
***REMOVED*** Redis pub/sub channels
...
***REMOVED*** GraphQL types for subscription payloads
...
class UserPresenceUpdate:
    ...
    status: str  ***REMOVED*** "online", "offline", "away"
    last_seen: datetime
...
***REMOVED*** Subscription input filters
...
class ScheduleSubscriptionFilter:
    ...
    update_types: Optional[list[str]] = None  ***REMOVED*** ["generated", "modified", "regenerated"]
...
class SwapSubscriptionFilter:
    ...
    person_id: Optional[strawberry.ID] = None
    swap_types: Optional[list[str]] = None  ***REMOVED*** ["one_to_one", "absorb"]
    statuses: Optional[list[str]] = None  ***REMOVED*** ["pending", "approved", "executed", "rejected"]
...
class ConflictSubscriptionFilter:
    ...
    person_id: Optional[strawberry.ID] = None
    severities: Optional[list[str]] = None  ***REMOVED*** ["critical", "warning", "info"]
    conflict_types: Optional[list[str]] = None


***REMOVED*** Redis pub/sub manager
        ...
        try:
            ...
            async for message in pubsub.listen():
                if message["type"] == "message":
                    try:
                        ***REMOVED*** Parse JSON message data
...
***REMOVED*** Global subscription manager instance
...
***REMOVED*** Helper functions for filtering
...
def should_send_swap_notification(
    ...
    ***REMOVED*** Filter by person ID (requester or target)
...
***REMOVED*** Subscription resolvers
...
class Subscription:
    ...
    async def assignment_updates(
        ...
        try:
            async for message in manager.subscribe(CHANNEL_ASSIGNMENT_UPDATES):
                ***REMOVED*** Filter by person_id if specified
    ...
    async def user_presence(
        ...
        ***REMOVED*** Publish own presence as online
        ...
        try:
            ...
            ***REMOVED*** Publish own presence as offline on disconnect
            await manager.publish(CHANNEL_USER_PRESENCE, {
                "user_id": user_id,
                "status": "offline",
                "last_seen": datetime.utcnow().isoformat(),
...
***REMOVED*** Broadcasting helper functions
