...
class ScheduleSubscriptionFilter:
    ...
    update_types: list[str] | None = None  ***REMOVED*** ["generated", "modified", "regenerated"]
...
class SwapSubscriptionFilter:
    ...
    person_id: strawberry.ID | None = None
    swap_types: list[str] | None = None  ***REMOVED*** ["one_to_one", "absorb"]
    statuses: list[str] | None = None  ***REMOVED*** ["pending", "approved", "executed", "rejected"]
...
class ConflictSubscriptionFilter:
    ...
    person_id: strawberry.ID | None = None
    severities: list[str] | None = None  ***REMOVED*** ["critical", "warning", "info"]
