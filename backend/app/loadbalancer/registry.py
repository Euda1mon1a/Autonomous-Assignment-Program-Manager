...
class ServiceRegistry:
    ...
    def __init__(
        ...
        ***REMOVED*** Service instances organized by service name
        ...
        async with self._lock:
            for service_name, instances in self._instances.items():
                if instance_id in instances:
                    ...
                    ***REMOVED*** Clean up empty service entries
                    if not instances:
            ...
            for instances in self._instances.values():
                if instance_id in instances:
                    ...
                    if healthy:
                        ...
                        ***REMOVED*** Remove instance if it exceeds failure threshold
        ...
        async with self._lock:
            ...
            for service_name, instances in list(self._instances.items()):
                ...
                for instance_id, instance in instances.items():
                    ***REMOVED*** Check if instance is stale
                    if (
                ...
                ***REMOVED*** Remove stale instances
