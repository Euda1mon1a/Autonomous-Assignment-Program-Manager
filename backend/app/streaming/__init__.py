...
Example usage:
    ...
    ***REMOVED*** Publish data to stream
    ...
    ***REMOVED*** Get SSE response for client
    ...
    ***REMOVED*** Wrap WebSocket connection
    ...
    ***REMOVED*** Create stream with custom backpressure
    stream = DataStream(
