...
class QuotaPolicy:
    ...
    ***REMOVED*** Resource-specific limits
    ...
    ***REMOVED*** Report generation limits
    report_daily: int
    report_monthly: int

    ***REMOVED*** Overage handling
    allow_overage: bool = False
    overage_percentage: float = 0.0  ***REMOVED*** % of quota allowed as overage

    ***REMOVED*** Alert thresholds (% of quota used)
    warning_threshold: float = 0.80  ***REMOVED*** 80%
    critical_threshold: float = 0.95  ***REMOVED*** 95%


***REMOVED*** Policy definitions for different user roles
...
STANDARD_POLICY = QuotaPolicy(
    ...
    report_monthly=1000,
    allow_overage=True,
    overage_percentage=0.10,  ***REMOVED*** 10% overage allowed
    warning_threshold=0.80,
    critical_threshold=0.95,
)
...
PREMIUM_POLICY = QuotaPolicy(
    ...
    allow_overage=True,
    overage_percentage=0.20,  ***REMOVED*** 20% overage allowed
...
ADMIN_POLICY = QuotaPolicy(
    ...
    allow_overage=True,
    overage_percentage=0.50,  ***REMOVED*** 50% overage allowed
    warning_threshold=0.90,
    critical_threshold=0.95,
)

***REMOVED*** Role to policy mapping
ROLE_POLICY_MAPPING = {
    "admin": ADMIN_POLICY,
...
def validate_policy_limits(policy: QuotaPolicy) -> bool:
    ...
    """
    ***REMOVED*** Daily limits should be less than monthly
    ...
    ***REMOVED*** Resource-specific daily limits should be <= general daily limit
    ...
    ***REMOVED*** Overage percentage should be between 0 and 1
