...
class QuotaManager:
        ...
        if custom_data:
            ***REMOVED*** Decode and create custom policy
            try:
                ...
                ***REMOVED*** Fall through to role-based policy

        ***REMOVED*** Return role-based policy
    ...
    def enforce_quota(
        ...
        if not is_allowed:
            ***REMOVED*** Get limits for error message
    ...
    def record_usage(
        ...
        ***REMOVED*** Check if we should send alerts
        policy = self.get_policy(user_id, user_role)
    ...
    def _trigger_alert(
        ...
        ***REMOVED*** Store alert in Redis for retrieval
        ...
        self.redis.expire(alert_key, 86400)  ***REMOVED*** 24 hour expiry
    ...
    def get_usage_summary(
        ...
        ***REMOVED*** Get usage for each resource type
