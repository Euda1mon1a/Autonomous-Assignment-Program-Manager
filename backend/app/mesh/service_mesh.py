...
class MTLSMode(str, Enum):
    ...
    STRICT = "strict"  ***REMOVED*** Require mTLS for all traffic
    PERMISSIVE = "permissive"  ***REMOVED*** Accept both mTLS and plaintext
    DISABLED = "disabled"  ***REMOVED*** No mTLS


***REMOVED*** ============================================================================
***REMOVED*** Pydantic Models (Configuration)
***REMOVED*** ============================================================================
...
class SidecarConfig(BaseModel):
    ...
    def to_envoy_config(self) -> dict[str, Any]:
        ...
        ***REMOVED*** Add TLS configuration if enabled
...
***REMOVED*** ============================================================================
***REMOVED*** Dataclasses (Runtime State)
***REMOVED*** ============================================================================
...
class TrafficSplit:
    ...
    def get_destination_for_request(self, headers: dict[str, str]) -> Optional[str]:
        ...
        """
        ***REMOVED*** Check header-based routing first
        ...
        ***REMOVED*** Fall back to weighted random selection
        import random
...
class ObservabilityHeaders:
    ...
    def from_headers(cls, headers: dict[str, str]) -> "ObservabilityHeaders":
        ...
        """
        ***REMOVED*** Support multiple tracing header formats
        trace_id = (
    ...
    def to_headers(self) -> dict[str, str]:
        ...
        ***REMOVED*** W3C Trace Context format
        headers["traceparent"] = (
    ...
    async def discover_service(
        ...
        async with self._lock:
            ...
            for key, service in self.services.items():
                ...
                ***REMOVED*** Check version if specified
                if version and service.version != version:
                    continue

                ***REMOVED*** Check tags if specified
...
***REMOVED*** ============================================================================
***REMOVED*** Service Health Reporter
***REMOVED*** ============================================================================
...
class ServiceHealthReporter:
    ...
    def _update_overall_status(self) -> None:
        ...
        ***REMOVED*** All checks must pass for healthy
        if all(self.checks.values()):
            self.health_status = HealthStatus.HEALTHY
        ***REMOVED*** Some checks passing = degraded
        elif any(self.checks.values()):
            self.health_status = HealthStatus.DEGRADED
        ***REMOVED*** All checks failing = unhealthy
        else:
...
***REMOVED*** ============================================================================
***REMOVED*** Main Service Mesh Class
***REMOVED*** ============================================================================
...
class ServiceMesh:
    ...
    def get_routing_destination(
        ...
        """
        ***REMOVED*** Sort rules by priority
        sorted_rules = sorted(
