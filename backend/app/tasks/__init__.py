...
Tasks can be called directly or queued via Celery:
    ...
    ***REMOVED*** Direct call (synchronous)
    result = compute_schedule_metrics(
        start_date="2025-01-01",
        end_date="2025-03-31"
    )

    ***REMOVED*** Async call via Celery (recommended)
    ...
    ***REMOVED*** RAG embeddings initialization
...
Or manually update the includes:
    ...
    celery_app = Celery(
        ...
        include=[
            ...
            "app.tasks.rag_tasks",  ***REMOVED*** Add for RAG embeddings
        ],
    )
"""

***REMOVED*** Import all tasks for easy access
***REMOVED*** Import configuration helpers
