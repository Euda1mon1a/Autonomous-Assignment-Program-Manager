...
***REMOVED*** Document type mapping (filename -> doc_type)
DOC_TYPE_MAP = {
...
def get_docs_path() -> Path:
    ...
    """
    ***REMOVED*** Assume backend/ is the working directory
...
def initialize_embeddings(
    ...
    try:
        ...
        ***REMOVED*** Clear existing documents if force_refresh
        if force_refresh:
        ...
        ***REMOVED*** Get documents to process
        ...
        ***REMOVED*** Process each document
        ...
        for filepath in files:
            ...
            try:
                ...
                ***REMOVED*** Clear existing docs of this type (idempotent)
                if not force_refresh:  ***REMOVED*** Already cleared if force_refresh
...
def refresh_single_document(
    ...
    return initialize_embeddings(
        ...
        chunk_size=chunk_size,
        chunk_overlap=chunk_overlap,
        force_refresh=False,  ***REMOVED*** Will clear just this doc_type
    )
...
def periodic_refresh(self) -> dict[str, Any]:
    ...
    ***REMOVED*** Check if any documents have changed (simple check)
    docs_path = get_docs_path()
    files = sorted(docs_path.glob("*.md"))
    ...
    ***REMOVED*** Future enhancement: Only refresh changed files based on mtime
    return initialize_embeddings(
        self,
        doc_filter=None,
        chunk_size=500,
        chunk_overlap=50,
        force_refresh=True,  ***REMOVED*** Full refresh
    )
