...
class EmailDeliveryService:
    ...
    def send_export(
        ...
        try:
            ...
            ***REMOVED*** Create multipart message
            msg = MIMEMultipart()
            msg["Subject"] = subject
            ...
            ***REMOVED*** Add attachment
            if isinstance(file_data, bytes):
                ...
                ***REMOVED*** Read from file-like object
                file_data.seek(0)
...
class S3DeliveryService:
    ...
    def upload_export(
        ...
        try:
            ...
            ***REMOVED*** Prepare upload parameters
            upload_params = {
