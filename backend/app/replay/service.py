...
***REMOVED*** =============================================================================
***REMOVED*** In-Memory Storage (for MVP - replace with DB models in production)
***REMOVED*** =============================================================================
...
class ReplayService:
    ...
    ***REMOVED*** =========================================================================
    ...
    async def capture_request(
        ...
        Returns:
            Request ID
        """
        ***REMOVED*** Compute body hash for deduplication
        body_hash = ""
        if body:
    ...
    async def replay_request(
        ...
        ***REMOVED*** Execute request
        ...
        try:
            ...
            ***REMOVED*** Compare with original if requested
            if compare:
    ...
    ***REMOVED*** =========================================================================
    ...
    def _find_json_differences(
        ...
        ***REMOVED*** Check for missing/extra keys
        ...
        ***REMOVED*** Check for value differences
        for key in original_keys & replay_keys:
            ...
            if isinstance(orig_val, dict) and isinstance(replay_val, dict):
                ***REMOVED*** Recurse for nested objects
                differences.extend(
    ...
    ***REMOVED*** =========================================================================
    ...
    async def bulk_replay(
        ...
        """
        ***REMOVED*** Find matching requests
        ...
        async def replay_with_semaphore(req: CapturedRequest):
            ...
            async with semaphore:
                ...
                try:
                    ...
                    ***REMOVED*** Update status distribution
        ...
        ***REMOVED*** Calculate average response time
        valid_times = [
            r.response_time_ms
            for r in results
