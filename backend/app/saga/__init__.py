...
Usage Example:
    ...
    ***REMOVED*** Create saga definition
...
Parallel Execution Example:
    ```python
    ***REMOVED*** Steps in the same parallel_group execute concurrently
    saga_def = SagaDefinition(
        ...
        steps=[
            SagaStepDefinition(
                ...
                parallel_group="updates",  ***REMOVED*** Executes in parallel
            ),
            SagaStepDefinition(
            ...
            SagaStepDefinition(
                ...
                ***REMOVED*** Executes after parallel group completes
            ),
        ],
    )
    ```
...
Recovery After Service Restart:
    ```python
    ***REMOVED*** On service startup, recover interrupted sagas
    orchestrator = SagaOrchestrator(db)
