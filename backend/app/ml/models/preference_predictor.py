...
class PreferencePredictor:
    ...
    def _initialize_model(self) -> None:
        ...
        self.model = RandomForestRegressor(
            ...
            n_jobs=-1,  ***REMOVED*** Use all CPU cores
    ...
    def extract_features(
        ...
        ***REMOVED*** Faculty role encoding (one-hot)
        ...
        ***REMOVED*** Temporal features from block
        ...
        if block_date:
            ...
            ***REMOVED*** Month of year (seasonality)
            features["month"] = block_date.month
            features["quarter"] = (block_date.month - 1) // 3 + 1

            ***REMOVED*** Week of year (academic calendar patterns)
        ...
        ***REMOVED*** Holiday/special days
        features["is_holiday"] = 1 if block_data.get("is_holiday", False) else 0

        ***REMOVED*** Historical statistics (if available)
        if historical_stats:
    ...
    def predict(
        ...
        ***REMOVED*** Reorder columns to match training
    ...
    def explain_prediction(
        ...
        ***REMOVED*** Calculate feature contributions (simplified)
        contributions = {
            feat: float(feature_values[feat] * importances.get(feat, 0))
            for feat in feature_values
        }

        ***REMOVED*** Sort by absolute contribution
