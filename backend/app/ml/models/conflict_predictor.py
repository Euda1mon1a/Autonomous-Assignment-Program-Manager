...
class ConflictPredictor:
    ...
    def __init__(
        ...
        ***REMOVED*** Models and preprocessors
        self.model: Optional[GradientBoostingClassifier] = None
        self.scaler: Optional[StandardScaler] = None
        self.feature_names: list[str] = []

        ***REMOVED*** Load pre-trained model if path provided
    ...
    def extract_features(
        ...
        ***REMOVED*** Calculate hours worked this week (for 80-hour rule)
        ***REMOVED*** Assuming each assignment is a half-day (4 hours)
        ...
        ***REMOVED*** Days worked (for 1-in-7 rule)
        unique_dates = set()
        ...
        ***REMOVED*** Consecutive days worked
            ...
            ***REMOVED*** Sort by date
            ...
            for i in range(1, len(sorted_assignments)):
                ...
                if prev_date and curr_date:
                    ***REMOVED*** Check if dates are consecutive (simplified)
                    consecutive_days += 1
        ...
        ***REMOVED*** Proposed assignment characteristics
        ...
        ***REMOVED*** Day of week for proposed assignment
        ...
        ***REMOVED*** Rotation type conflicts
        ...
        ***REMOVED*** Check for same-day conflicts
        ...
        ***REMOVED*** Call/night shift patterns
        ...
        ***REMOVED*** Coverage level on proposed date
        if context_data:
    ...
    def train(
        ...
        ***REMOVED*** Calculate additional metrics
        y_pred = self.model.predict(X_val_scaled)

        ***REMOVED*** Confusion matrix components
        ...
        ***REMOVED*** Get feature importances
    ...
    def predict_conflict_probability(
        ...
        ***REMOVED*** Ensure all expected features are present
        for col in self.feature_names:
            if col not in X.columns:
                X[col] = 0

        ***REMOVED*** Reorder columns
        X = X[self.feature_names]

        ***REMOVED*** Scale and predict probability
        X_scaled = self.scaler.transform(X)
        prob = self.model.predict_proba(X_scaled)[0][1]  ***REMOVED*** Probability of class 1 (conflict)
    ...
    def identify_high_risk_assignments(
        ...
        ***REMOVED*** Sort by probability (highest risk first)
    ...
    def explain_conflict_risk(
        ...
        ***REMOVED*** Get feature values
        feature_values = X.iloc[0].to_dict()

        ***REMOVED*** Get feature importances
        importances = dict(zip(self.feature_names, self.model.feature_importances_))

        ***REMOVED*** Identify risk factors (features with high values and high importance)
        risk_factors = []
        for feat, value in feature_values.items():
            importance = importances.get(feat, 0)
            if value > 0 and importance > 0.05:  ***REMOVED*** Significant features
                risk_factors.append({
                    "factor": feat,
                    "value": float(value),
