***REMOVED*** Request Validation Package
...
***REMOVED******REMOVED******REMOVED*** Basic Query Validation
...
***REMOVED******REMOVED******REMOVED*** Basic Body Validation
...
***REMOVED******REMOVED******REMOVED*** Cross-Field Validation
...
***REMOVED******REMOVED******REMOVED*** Conditional Validation
...
async def create_person(request: Request):
    ***REMOVED*** pgy_level is only required when type="resident"
    body = await request.json()
    return body
```

***REMOVED******REMOVED*** Available Validation Rules

***REMOVED******REMOVED******REMOVED*** Basic Rules
...
***REMOVED******REMOVED******REMOVED*** Format Rules
...
***REMOVED******REMOVED******REMOVED*** Domain-Specific Rules
...
***REMOVED******REMOVED******REMOVED*** Collection Rules
...
async def get_report(start_date: date, end_date: date):
    ***REMOVED*** Validates start_date <= end_date
    return {"start": start_date, "end": end_date}
```

***REMOVED******REMOVED******REMOVED*** UUID Parameter
...
@validate_body(
    rules={"name": [required]},
    locale=Locale.ES_ES  ***REMOVED*** Spanish error messages
)
async def create_user(request: Request):
    body = await request.json()
    return body
...
***REMOVED******REMOVED*** Validation Context
