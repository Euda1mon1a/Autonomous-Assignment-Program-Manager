...
***REMOVED*** Example 1: Query parameter validation
@router.get("/people")
@validate_query(
    {
...
***REMOVED*** Example 2: Request body validation
@router.post("/people")
@validate_body(
    {
        ...
        "email": [email_format()],
        "pgy_level": [],  ***REMOVED*** Validated conditionally
    }
)
...
***REMOVED*** Example 3: Combined query and body validation
...
***REMOVED*** Example 4: Cross-field validation
...
***REMOVED*** Example 5: Pagination validation
...
***REMOVED*** Example 6: Conditional field validation
@router.post("/staff")
@validate_body(
    {
        "name": [required, string_length(min_length=1, max_length=100)],
...
***REMOVED*** Example 7: Date range validation
@router.get("/reports")
...
***REMOVED*** Example 8: Complex validation with multiple rules
...
***REMOVED*** Example 9: List validation
...
***REMOVED*** Example 10: Custom validation rule
