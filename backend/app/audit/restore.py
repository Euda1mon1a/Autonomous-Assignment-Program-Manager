...
class AuditRestorer:
    ...
    async def restore_from_archive(
        ...
        ***REMOVED*** Apply filters for selective restore
    ...
    async def get_archive_metadata(self, archive_id: str) -> dict[str, Any]:
        ...
        ***REMOVED*** Return metadata without full record list
        metadata = {
    ...
    async def search_across_archives(
        ...
        ***REMOVED*** Get archives to search
        if archive_ids:
            archives = [
                {"archive_id": aid}
        ...
        for archive_meta in archives:
            ...
            try:
                ...
                ***REMOVED*** Add archive source to each record
                for record in records:
                    record["archive_source"] = archive_id

                all_results.extend(records)

                ***REMOVED*** Stop if we hit the limit
        ...
        ***REMOVED*** Collect statistics
        ...
        for archive_meta in archives:
            ...
            try:
                ...
                ***REMOVED*** Aggregate entity type counts
                ...
                ***REMOVED*** Aggregate operation counts
