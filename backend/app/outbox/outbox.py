...
Usage:
------
***REMOVED*** Writing messages within a transaction:
...
def create_assignment(db: Session, assignment_data: dict):
    ...
    ***REMOVED*** Write outbox message in SAME transaction
    ...
    db.commit()  ***REMOVED*** Both assignment and outbox message committed atomically


***REMOVED*** Publishing messages (typically in background task):
