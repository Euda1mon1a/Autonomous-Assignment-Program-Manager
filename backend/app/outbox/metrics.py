...
class OutboxMonitor:
    ...
    Example:
        ::
            ...
            ***REMOVED*** In a health check endpoint
            ...
            def outbox_health(db: Session = Depends(get_db)):
                ...
                if monitor.should_alert():
                    ***REMOVED*** Trigger external alert
    ...
    def detect_anomalies(self) -> list[dict[str, Any]]:
        ...
        ***REMOVED*** Anomaly: High pending message age
        if metrics["max_pending_age_seconds"] > 600:  ***REMOVED*** 10 minutes
            anomalies.append(
                {
                    "type": "high_latency",
                    "severity": "warning",
        ...
        ***REMOVED*** Anomaly: Growing dead letter queue
        ...
        ***REMOVED*** Anomaly: Stuck processing messages
        ...
        ***REMOVED*** Anomaly: Low throughput
    ...
    def should_alert(self) -> bool:
        ...
        ***REMOVED*** Alert if any error-level anomalies
