    ...
    ***REMOVED*** 1. Define a projection
    class PersonSummaryProjection(BaseProjection):
        ...
        ***REMOVED*** Configuration
        checkpoint_interval = 100  ***REMOVED*** Checkpoint every 100 events
        batch_size = 50            ***REMOVED*** Process 50 events at a time
        parallel_enabled = False   ***REMOVED*** Safe for concurrent builds?
...
When a projection's schema changes, increment the version::
    ...
    class PersonSummaryProjection(BaseProjection):
        projection_name = "person_summary"
        version = 2  ***REMOVED*** Incremented from 1
...
***REMOVED*** =============================================================================
***REMOVED*** Projection Status Enums
***REMOVED*** =============================================================================
...
class ProjectionStatus(str, Enum):
    ...
    INITIALIZING = "initializing"  ***REMOVED*** Initial state
    ACTIVE = "active"  ***REMOVED*** Running and processing events
    REBUILDING = "rebuilding"  ***REMOVED*** Full rebuild in progress
    PAUSED = "paused"  ***REMOVED*** Temporarily stopped
    ERROR = "error"  ***REMOVED*** Error state, needs attention
    DEGRADED = "degraded"  ***REMOVED*** Running but with issues


class BuildMode(str, Enum):
    """Mode for building projections."""

    INCREMENTAL = "incremental"  ***REMOVED*** Process only new events
    FULL = "full"  ***REMOVED*** Rebuild from scratch
    CATCHUP = "catchup"  ***REMOVED*** Catch up from last checkpoint
...
class BaseProjection(ABC):
    ...
    def _discover_handlers(self) -> None:
        ...
        for attr_name in dir(self):
            if attr_name.startswith("handle_"):
                ...
                if callable(handler):
                    ***REMOVED*** Extract event name from method name
                    event_name = attr_name[7:]  ***REMOVED*** Remove "handle_" prefix
    ...
    async def handle_event(self, event: BaseEvent) -> None:
        ...
        if event_name in self._event_handlers:
            ...
            ***REMOVED*** No handler for this event type - skip silently
            logger.debug(
    ...
    def _normalize_event_name(self, event_type: str) -> str:
        ...
        """
        ***REMOVED*** Convert PascalCase to snake_case
        result = []
...
class ProjectionBuilder:
    ...
    def register_projection(self, projection: BaseProjection) -> None:
        ...
        ***REMOVED*** Ensure metadata exists
    ...
    def _ensure_metadata(self, projection: BaseProjection) -> None:
        ...
        if not metadata:
            ...
            ***REMOVED*** Version changed - mark for rebuild
            logger.warning(
    ...
    async def build_projection(
        ...
        ***REMOVED*** Update metadata
        ...
        try:
            ...
            ***REMOVED*** Determine sequence range
    ...
    async def _build_all_parallel(self, mode: BuildMode) -> list[BuildResult]:
        ...
        ***REMOVED*** Convert exceptions to error results
        processed_results = []
