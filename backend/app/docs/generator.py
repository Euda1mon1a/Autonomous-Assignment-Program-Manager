...
class DocumentationGenerator:
    ...
    def _initialize_enhancer(self) -> None:
        ...
        ***REMOVED*** Add additional custom examples for key endpoints
    ...
    def _add_schedule_examples(self) -> None:
        ...
        ***REMOVED*** Schedule generation request
        ...
        ***REMOVED*** Schedule generation response
        self.enhancer.add_example(
            "/api/v1/schedule/generate",
            "post",
            "response",
