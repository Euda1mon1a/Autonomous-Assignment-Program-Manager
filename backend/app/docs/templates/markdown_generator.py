...
"""
    ...
    def _generate_toc(self) -> str:
        ...
        toc = """***REMOVED******REMOVED*** Table of Contents

1. [Overview](***REMOVED***overview)
2. [Authentication](***REMOVED***authentication)
3. [Rate Limits](***REMOVED***rate-limits)
4. [Endpoints](***REMOVED***endpoints)
5. [Schemas](***REMOVED***schemas)
6. [Error Codes](***REMOVED***error-codes)
7. [Changelog](***REMOVED***changelog)
"""
        return toc
    ...
    def _generate_overview(self) -> str:
        ...
        overview = """***REMOVED******REMOVED*** Overview
...
"""
        ...
        if servers:
            overview += "\n***REMOVED******REMOVED******REMOVED*** Servers\n\n"
            for server in servers:
                overview += f"- **{server.get('description', 'Server')}:** `{server.get('url', 'N/A')}`\n"

        ***REMOVED*** Add compliance information
    ...
    def _generate_authentication(self) -> str:
        ...
        auth = """***REMOVED******REMOVED*** Authentication
...
"""
        for name, scheme in security_schemes.items():
            ...
            auth += f"***REMOVED******REMOVED******REMOVED*** {name}\n\n"
...
"""
    ...
    def _generate_rate_limits(self) -> str:
        ...
        limits = """***REMOVED******REMOVED*** Rate Limits

The API enforces the following rate limits:

"""
        for endpoint, limit_info in rate_limits.items():
            limits += f"***REMOVED******REMOVED******REMOVED*** {endpoint.title()}\n\n"
...
"""
    ...
    def _generate_endpoints(self) -> str:
        ...
        endpoints = """***REMOVED******REMOVED*** Endpoints

"""
        ***REMOVED*** Group endpoints by tag
        ...
        ***REMOVED*** Generate documentation for each tag
        for tag, operations in sorted(endpoints_by_tag.items()):
            endpoints += f"***REMOVED******REMOVED******REMOVED*** {tag.title()}\n\n"
    ...
    def _generate_endpoint_doc(
        ...
        doc = f"***REMOVED******REMOVED******REMOVED******REMOVED*** `{method.upper()} {path}`\n\n"
...
"""
    ...
    def _generate_error_codes(self) -> str:
        ...
        doc = """***REMOVED******REMOVED*** Error Codes
...
"""
        for code, error_info in sorted(error_codes.items()):
            ...
            doc += f"***REMOVED******REMOVED******REMOVED*** {code} {title}\n\n"
            doc += f"{description}\n\n"
    ...
    def _generate_changelog(self) -> str:
        ...
        changelog = """***REMOVED******REMOVED*** Changelog
...
***REMOVED******REMOVED******REMOVED******REMOVED*** v1.0.0 (Current)
...
"""
    ...
    def generate_endpoint_specific_doc(self, path: str, method: str) -> str:
        ...
        if not operation:
            return f"***REMOVED*** Endpoint Not Found\n\nNo documentation available for `{method.upper()} {path}`"

        doc = f"***REMOVED*** {method.upper()} {path}\n\n"
