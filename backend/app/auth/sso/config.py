...
class SAMLConfig(BaseModel):
    ...
    ***REMOVED*** Identity Provider settings
    ...
    ***REMOVED*** Service Provider certificates (optional, for signing)
    ...
    ***REMOVED*** SAML settings
    name_id_format: str = Field(
        default="urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress",
        description="NameID format",
    )

    ***REMOVED*** Attribute mapping (SAML attribute -> user field)
