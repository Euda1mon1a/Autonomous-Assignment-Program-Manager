...
def require_permission(
    ...
    Usage:
        ...
        ***REMOVED*** With resource ID from path parameter
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs) -> Any:
            ...
            ***REMOVED*** Get resource ID if specified
            resource_id = None
            ...
            ***REMOVED*** Call the actual route handler
    ...
    *permissions: tuple[ResourceType | str, PermissionAction | str],
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs) -> Any:
            ...
            ***REMOVED*** Check if user has any of the permissions
            resolver = await get_permission_resolver()
    ...
    *permissions: tuple[ResourceType | str, PermissionAction | str],
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs) -> Any:
            ...
            ***REMOVED*** Check if user has all of the permissions
            resolver = await get_permission_resolver()
...
def require_role(*roles: str, allow_admin: bool = True):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs) -> Any:
            ...
            ***REMOVED*** Check if user has required role
...
***REMOVED*** Convenience dependencies for common permission checks
