...
__all__ = [
    ...
    ***REMOVED*** Resolver
    "PermissionResolver",
    "get_permission_resolver",
    ***REMOVED*** Decorators and dependencies
    "PermissionDenied",
    "check_permission_dependency",
    "require_permission",
    "require_any_permission",
...
async def warm_permission_cache() -> int:
    ...
    ***REMOVED*** Build permissions map with hierarchy resolution
    permissions_map = {}
...
async def invalidate_permission_cache(
    ...
    if invalidate_all:
        ...
        ***REMOVED*** No specific target, do nothing
        return False
...
async def invalidate_user_role_cache(
    ...
    ***REMOVED*** Invalidate user's permission cache
