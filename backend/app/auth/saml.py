...
***REMOVED*** ============================================================================
***REMOVED*** Multi-IdP Configuration
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** SAML Session Management
***REMOVED*** ============================================================================
...
class SAMLSessionManager:
    ...
    def get_user_sessions(self, user_id: UUID) -> List[SAMLSession]:
        ...
        sessions = []
        for session_id in session_ids[:]:  ***REMOVED*** Copy to avoid modification during iteration
            session = self.get_session(session_id)
            if session:
                sessions.append(session)
            else:
                ***REMOVED*** Remove expired/invalid session
...
***REMOVED*** Global session manager
...
***REMOVED*** ============================================================================
***REMOVED*** SAML Authentication Service
***REMOVED*** ============================================================================
...
class SAMLAuthenticationService:
    ...
    async def initiate_login(
        ...
        ***REMOVED*** Generate authentication request
    ...
    async def initiate_logout(
        ...
        ***REMOVED*** Get SAML session
        ...
        if not sessions:
            ***REMOVED*** No SAML sessions, local logout only
            return None

        ***REMOVED*** Use first session for SLO
        session = sessions[0]

        ***REMOVED*** Get IdP
        idp = self.idp_registry.get(session.idp_id)
        if not idp:
            ***REMOVED*** IdP no longer configured, destroy sessions locally
            self.session_manager.destroy_user_sessions(user_id)
            return None

        ***REMOVED*** Generate logout request
        request_id, redirect_url = idp.provider.generate_logout_request(
            name_id=session.name_id,
            session_index=session.session_index,
        )

        ***REMOVED*** Destroy local sessions
        self.session_manager.destroy_user_sessions(user_id)
    ...
    async def _get_or_create_user(
        ...
        """
        ***REMOVED*** Extract required attributes
        ...
        ***REMOVED*** Generate random password (won't be used for SSO users)
...
async def initialize_default_idp() -> Optional[SAMLIdentityProvider]:
    ...
    ***REMOVED*** Validate required configuration
