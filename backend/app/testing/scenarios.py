...
class ScheduleGenerationScenario(TestScenario):
    ...
    def setup(self, server: MockAPIServer) -> None:
        ...
        ***REMOVED*** Step 1: Start generation (returns job ID)
        ...
        ***REMOVED*** Step 2: Poll job status (stateful - goes from pending -> running -> completed)
        server.register_endpoint(
            method="GET",
        ...
        ***REMOVED*** Step 3: Get generated schedule
        server.register_endpoint(
            method="GET",
        ...
        ***REMOVED*** Step 4: Validate ACGME compliance
        server.register_endpoint(
            method="POST",
    ...
    def _generate_sample_assignments(self) -> List[Dict[str, Any]]:
        ...
        ***REMOVED*** Create 7 days of assignments
        for day in range(7):
...
class SwapWorkflowScenario(TestScenario):
    ...
    def setup(self, server: MockAPIServer) -> None:
        ...
        ***REMOVED*** Step 4: Execute swap (stateful - pending -> executing -> completed)
        server.register_endpoint(
            method="POST",
        ...
        ***REMOVED*** Step 5: Verify assignments updated
        server.register_endpoint(
            method="GET",
...
class EmergencyCoverageScenario(TestScenario):
    ...
    def setup(self, server: MockAPIServer) -> None:
        ...
        ***REMOVED*** Step 1: Report emergency absence
        server.register_endpoint(
            method="POST",
        ...
        ***REMOVED*** Step 2: Check for coverage gaps
        server.register_endpoint(
            method="GET",
        ...
        ***REMOVED*** Step 3: Attempt auto-coverage
        server.register_endpoint(
            method="POST",
        ...
        ***REMOVED*** Step 4: Check resilience
        server.register_endpoint(
            method="GET",
            path="/health/resilience",
            response=create_resilience_health_response(
                status="operational",
                utilization=0.75,  ***REMOVED*** Elevated from normal 0.65 due to coverage
                defense_level="YELLOW",  ***REMOVED*** Elevated from GREEN
            ),
        )
...
class ResilienceLoadScenario(TestScenario):
    ...
    def setup(self, server: MockAPIServer) -> None:
        ...
        ***REMOVED*** Stateful resilience check - shows progression through defense levels
        server.register_endpoint(
            method="GET",
            path="/health/resilience",
            stateful=True,
