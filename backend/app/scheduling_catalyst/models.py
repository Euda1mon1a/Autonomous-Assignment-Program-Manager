...
class BarrierType(str, Enum):
    ...
    KINETIC = "kinetic"  ***REMOVED*** Time-based: freeze horizons, notice periods
    THERMODYNAMIC = "thermodynamic"  ***REMOVED*** Equilibrium: workload balance
    STERIC = "steric"  ***REMOVED*** Structural: credentials, qualifications
    ELECTRONIC = "electronic"  ***REMOVED*** Authorization: role permissions
    REGULATORY = "regulatory"  ***REMOVED*** Compliance: ACGME, legal
...
class CatalystType(str, Enum):
    ...
    HOMOGENEOUS = "homogeneous"  ***REMOVED*** Personnel catalysts (coordinators)
    HETEROGENEOUS = "heterogeneous"  ***REMOVED*** System catalysts (auto-matcher)
    ENZYMATIC = "enzymatic"  ***REMOVED*** Role-specific catalysts (credentials)
    AUTOCATALYTIC = "autocatalytic"  ***REMOVED*** Self-reinforcing (training cascades)
...
class ReactionType(str, Enum):
    ...
    SWAP = "swap"  ***REMOVED*** Exchange assignments between personnel
    REASSIGNMENT = "reassignment"  ***REMOVED*** Move assignment to different person
    CANCELLATION = "cancellation"  ***REMOVED*** Remove assignment
    CREATION = "creation"  ***REMOVED*** New assignment
    MODIFICATION = "modification"  ***REMOVED*** Change assignment parameters
...
class ActivationEnergy:
    ...
    value: float  ***REMOVED*** 0.0 to 1.0, normalized
...
class EnergyBarrier:
    ...
    name: str
    description: str
    energy_contribution: float  ***REMOVED*** 0.0 to 1.0
    is_absolute: bool = False  ***REMOVED*** Some barriers cannot be catalyzed
    source: str = ""
...
class CatalystPerson:
    ...
    catalyst_score: float  ***REMOVED*** 0.0 to 1.0, effectiveness
    ...
    capacity_remaining: float = 1.0  ***REMOVED*** 0.0 = fully utilized
    ...
    def reduction_for_barrier(self, barrier: EnergyBarrier) -> float:
        ...
        ***REMOVED*** Scale by availability and remaining capacity
...
class TransitionState:
    ...
    state_id: str
    description: str
    assignments: dict[str, Any]  ***REMOVED*** Assignment configuration
    energy_level: float  ***REMOVED*** Relative to initial state
    is_stable: bool = False  ***REMOVED*** Metastable intermediates
    duration: Optional[int] = None  ***REMOVED*** Minutes this state persists
...
class ReactionPathway:
    ...
    estimated_duration: Optional[int] = None  ***REMOVED*** Minutes
    ...
    def _recalculate_effective_energy(self) -> None:
        ...
        ***REMOVED*** Apply catalyst reductions
...
class ScheduleReaction:
    ...
    reactants: list[dict[str, Any]]  ***REMOVED*** Initial assignments
    products: list[dict[str, Any]]  ***REMOVED*** Final assignments
    pathway: ReactionPathway
    rate_constant: float = 1.0
    half_life: Optional[int] = None
    is_reversible: bool = True
    reversal_window: int = 1440  ***REMOVED*** 24 hours in minutes
    ...
    def gibbs_free_energy(self) -> float:
        ...
        """
        ***REMOVED*** Simplified: based on workload balance improvement
