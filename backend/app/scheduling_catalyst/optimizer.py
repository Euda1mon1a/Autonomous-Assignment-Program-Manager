...
class TransitionOptimizer:
    ...
    async def find_optimal_pathway(
        ...
        ***REMOVED*** Step 3: Calculate initial activation energy
        initial_energy = self.barrier_detector.calculate_activation_energy()

        ***REMOVED*** Step 4: If energy is already low enough, return simple pathway
        ...
        ***REMOVED*** Step 8: Pathway not feasible, generate recommendations
        return PathwayResult(
            success=False,
            pathway=pathway,  ***REMOVED*** Include partial pathway
            blocking_barriers=[
    ...
    async def optimize_swap(
        ...
        proposed_change = {
            ...
            "other_person_consented": False,  ***REMOVED*** Will check
        }

        result = await self.find_optimal_pathway(assignment_id, proposed_change)

        ***REMOVED*** Swaps need special handling for reversibility
    ...
    async def optimize_emergency_coverage(
        ...
        ***REMOVED*** Emergency override mechanism
    ...
    async def calculate_reaction_kinetics(
        ...
        """
        ***REMOVED*** Rate constant inversely related to activation energy
        ***REMOVED*** Higher energy = slower reaction
        rate_constant = 1.0 / (1.0 + pathway.effective_activation_energy * 10)

        ***REMOVED*** Half-life (time for 50% probability of completion)
        ***REMOVED*** Based on rate constant and complexity
        half_life_minutes = int(60 / rate_constant)

        ***REMOVED*** Determine reaction type from pathway
        ...
        return ScheduleReaction(
            ...
            is_reversible=True,
            reversal_window=1440,  ***REMOVED*** 24 hours
        )
    ...
    def _create_simple_pathway(
        ...
        return ReactionPathway(
            ...
            estimated_duration=30,  ***REMOVED*** 30 minutes for simple changes
        )
    ...
    async def _build_optimized_pathway(
        ...
        ***REMOVED*** Apply catalysts in order of effectiveness
        ...
        ***REMOVED*** If multi-step allowed and energy still high, add transition states
        if (
        ...
        ***REMOVED*** Estimate duration based on complexity
        base_duration = 30  ***REMOVED*** minutes
    ...
    async def _find_alternative_pathways(
        ...
        ***REMOVED*** Try different catalyst subsets
        ...
        for i in range(min(len(all_catalysts), self.config.max_pathways - 1)):
            ***REMOVED*** Skip first catalyst to get alternative
    ...
    def _generate_transition_states(
        ...
        ***REMOVED*** Group barriers by type
        ...
        ***REMOVED*** Create transition state for each barrier type
        energy_so_far = 0.0
        for bt, type_barriers in barriers_by_type.items():
            ...
            states.append(
                TransitionState(
                    ...
                    is_stable=False,
                    duration=10,  ***REMOVED*** 10 minutes per transition
                )
            )
    ...
    def _add_reversibility_info(
        ...
        ***REMOVED*** Add a metastable intermediate representing the 24-hour window
        rollback_state = TransitionState(
            ...
            is_stable=True,  ***REMOVED*** Metastable - can stay here
            duration=1440,  ***REMOVED*** 24 hours
        )
    ...
    def _generate_infeasibility_recommendations(
        ...
        ***REMOVED*** Identify highest-energy barriers not addressed
        unaddressed = []
        addressed_types = set()
...
class BatchOptimizer:
    ...
    async def optimize_batch(
        ...
        ***REMOVED*** First pass: get individual results
        ...
        ***REMOVED*** Second pass: check for catalyst conflicts
                ...
                for catalyst in result.pathway.catalysts_applied:
                    if isinstance(catalyst, CatalystPerson):
                        if catalyst.person_id in used_catalysts:
                            ***REMOVED*** Catalyst already used - need to find alternative
    ...
    async def find_optimal_order(
        ...
        ***REMOVED*** Sort by activation energy (easiest first)
        indexed_energies = [
