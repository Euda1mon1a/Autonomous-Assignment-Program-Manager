...
class BarrierDetector:
    ...
    ***REMOVED*** Helper methods - would integrate with actual services in production
    async def _check_credentials(
        self, person_id: UUID, rotation_id: UUID
    ) -> bool:
        """Check if person has required credentials for rotation."""
        ***REMOVED*** Placeholder - would query procedure_credential table
        return True
    ...
    async def _get_workload(self, person_id: UUID) -> Optional[float]:
        ...
        ***REMOVED*** Placeholder - would calculate from assignments
        return 0.6
    ...
    async def _check_preferences(
        ...
        ***REMOVED*** Placeholder - would query faculty_preference
        return None
