...
class ChaosExperimentConfig:
    ...
    target_component: str | None = None  ***REMOVED*** Specific component to target
    target_zone_id: uuid.UUID | None = None  ***REMOVED*** Specific zone (for zone isolation)
    target_user_id: uuid.UUID | None = None  ***REMOVED*** Specific user (for user isolation)
