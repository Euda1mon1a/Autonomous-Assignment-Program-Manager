...
class CacheCompression:
    ...
    def __init__(
        ...
        min_size_bytes: int = 1024,  ***REMOVED*** Only compress if > 1KB
    ):
    ...
    def compress(self, data: Any) -> tuple[bytes, bool]:
        ...
        ***REMOVED*** Compress based on algorithm
        try:
            ...
            ***REMOVED*** Only use compression if it actually reduces size
    ...
    def decompress(self, data: bytes, was_compressed: bool) -> Any:
        ...
        ***REMOVED*** Decompress based on algorithm
        try:
            if self.algorithm == CompressionAlgorithm.GZIP:
...
class CompressedCacheWrapper:
    ...
    async def set(
        ...
        ***REMOVED*** Store with compression flag
        cache_value = {
            "data": compressed_data.hex(),  ***REMOVED*** Store as hex string
...
***REMOVED*** Global compressed cache
