        ...
        json_schema_extra = {
            "example": {
                ...
                "residents_by_template": {
                    ...
                    "R2": [{"name": "PGY3-E-Last, PGY3-E-First", "template": "R2", "role": "PGY 3", "row": 19, "confidence": 1.0}],
                },
                "fmit_schedule": [
                    {"block_number": 10, "week_number": 1, "faculty_name": "Chu", "is_holiday_call": False},
                    {"block_number": 10, "week_number": 2, "faculty_name": "Faculty-J-Last", "is_holiday_call": False},
                ],
                "warnings": [],
                "errors": [],
            }
