...
class MetricValue(BaseModel):
    ...
    value: float
    unit: str | None = None
    status: str  ***REMOVED*** "good", "warning", "critical"
    trend: str | None = None  ***REMOVED*** "up", "down", "stable"
...
class ScheduleVersionMetrics(BaseModel):
    ...
    timestamp: str
    period: dict[str, str]  ***REMOVED*** start_date, end_date
...
class MetricTimeSeries(BaseModel):
    ...
    statistics: dict[str, float]  ***REMOVED*** mean, median, std_dev, min, max
    trend_direction: str = Field(alias="trendDirection")  ***REMOVED*** "improving", "declining", "stable"
...
***REMOVED*** ============================================================================
***REMOVED*** Fairness Trend Schemas
***REMOVED*** ============================================================================
...
class FairnessTrendReport(BaseModel):
    ...
    ***REMOVED*** Summary statistics
    ...
    trend: str  ***REMOVED*** "improving", "declining", "stable"
...
***REMOVED*** ============================================================================
***REMOVED*** Version Comparison Schemas
***REMOVED*** ============================================================================
...
class VersionMetricComparison(BaseModel):
    ...
    improvement: bool  ***REMOVED*** True if version B is better
...
***REMOVED*** ============================================================================
***REMOVED*** What-If Analysis Schemas
***REMOVED*** ============================================================================
...
class AssignmentChange(BaseModel):
    ...
    change_type: str = Field(alias="changeType")  ***REMOVED*** "add", "remove", "modify"
...
class WhatIfMetricImpact(BaseModel):
    ...
    change: float
    impact_severity: str = Field(alias="impactSeverity")  ***REMOVED*** "positive", "negative", "neutral"
...
class WhatIfResult(BaseModel):
    ...
    ***REMOVED*** Overall assessment
    overall_impact: str = Field(alias="overallImpact")  ***REMOVED*** "positive", "negative", "mixed", "neutral"
    recommendation: str
...
***REMOVED*** ============================================================================
***REMOVED*** Research Export Schemas
***REMOVED*** ============================================================================


class ResidentWorkloadData(BaseModel):
    """Anonymized resident workload data."""
    resident_id: str = Field(alias="residentId")  ***REMOVED*** Anonymized if requested
...
class RotationCoverageData(BaseModel):
    ...
    rotation_id: str = Field(alias="rotationId")  ***REMOVED*** Anonymized if requested
