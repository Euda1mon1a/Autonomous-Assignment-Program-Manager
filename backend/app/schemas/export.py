...
class ExportJobCreate(ExportJobBase):
    ...
    ***REMOVED*** Email delivery settings
    ...
    ***REMOVED*** Status
    ...
    def validate_cron_expression(cls, v: str | None) -> str | None:
        ...
        if v is not None:
            ***REMOVED*** Basic validation: should have 5 space-separated fields
            parts = v.split()
            if len(parts) != 5:
                raise ValueError(
