...
class BlockAssignmentResponse(BaseModel):
    ...
    ***REMOVED*** Nested relations (optional, populated when requested)
...
***REMOVED*** ============================================================================
***REMOVED*** Block Scheduler Request/Response Schemas
***REMOVED*** ============================================================================
...
class ResidentLeaveInfo(BaseModel):
    ...
    pgy_level: int | None
    leave_days: int
    leave_types: list[str]  ***REMOVED*** e.g., ["vacation", "conference"]
...
class LeaveConflict(BaseModel):
    ...
    rotation_name: str
    leave_days: int
    conflict_reason: str  ***REMOVED*** "non_leave_eligible_rotation", "insufficient_coverage"
...
class BlockSchedulerDashboard(BaseModel):
    ...
    block_number: int
    academic_year: int
    block_start_date: str | None  ***REMOVED*** ISO date
    block_end_date: str | None  ***REMOVED*** ISO date

    ***REMOVED*** Residents summary
    total_residents: int
    residents_with_leave: list[ResidentLeaveInfo]

    ***REMOVED*** Rotation summary
    rotation_capacities: list[RotationCapacity]
    leave_eligible_rotations: int
    non_leave_eligible_rotations: int

    ***REMOVED*** Current assignments (if any)
