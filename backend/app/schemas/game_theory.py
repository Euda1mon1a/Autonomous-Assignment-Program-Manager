...
class StrategyCreate(BaseModel):
    ...
    ***REMOVED*** Custom logic (for CUSTOM type)
...
class TournamentCreate(BaseModel):
    ...
    ***REMOVED*** Payoff matrix (optional, uses standard PD values by default)
...
class TournamentResultsResponse(BaseModel):
    ...
    ***REMOVED*** Payoff matrix (strategy names as keys)
...
class EvolutionCreate(BaseModel):
    ...
    ***REMOVED*** Initial population: {strategy_id: count}
...
class PopulationSnapshot(BaseModel):
    ...
    generation: int
    populations: dict[str, int]  ***REMOVED*** strategy_name -> count
...
class EvolutionResultsResponse(BaseModel):
    ...
    ***REMOVED*** Population history (sampled)
