...
class SettingsBase(BaseModel):
    ...
    ***REMOVED*** Scheduling algorithm
    scheduling_algorithm: str = "greedy"  ***REMOVED*** 'greedy', 'min_conflicts', 'cp_sat'

    ***REMOVED*** Work hours
    work_hours_per_week: int = 80  ***REMOVED*** ACGME max
    max_consecutive_days: int = 6  ***REMOVED*** Max days before required day off

    ***REMOVED*** Supervision ratios (faculty per N residents)
    pgy1_supervision_ratio: int = 2  ***REMOVED*** 1:2 for PGY-1
    pgy2_supervision_ratio: int = 4  ***REMOVED*** 1:4 for PGY-2/3

    ***REMOVED*** Academic year settings
