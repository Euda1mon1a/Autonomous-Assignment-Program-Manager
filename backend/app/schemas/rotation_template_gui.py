...
***REMOVED*** =============================================================================
***REMOVED*** Weekly Pattern Schemas
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Rotation Preference Schemas
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Extended Rotation Template Schemas
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Split Rotation Schemas
***REMOVED*** =============================================================================
...
class SplitRotationCreate(BaseModel):
    ...
    ***REMOVED*** Shared properties for both templates
    leave_eligible: bool = True
    supervision_required: bool = True
    max_supervision_ratio: int = 4
...
class PreviewGridCell(BaseModel):
    ...
    date: str  ***REMOVED*** ISO date string
    time_of_day: Literal["AM", "PM"]
    activity_type: str
    abbreviation: str | None = None
    background_color: str | None = None
...
class RotationPreviewResponse(BaseModel):
    ...
    total_half_days: dict[str, int]  ***REMOVED*** Summary by activity type


***REMOVED*** =============================================================================
***REMOVED*** Half-Day Summary Schema
***REMOVED*** =============================================================================
