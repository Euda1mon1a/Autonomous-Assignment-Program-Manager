...
Usage:
    ...
    ***REMOVED*** Register a new schema version
...
***REMOVED*** Pydantic schemas for API
...
class SchemaEvolutionRule:
    ...
    def validate_backward_compatibility(
        ...
        ***REMOVED*** Check for removed fields
        ...
        ***REMOVED*** Check for new required fields
        ...
        ***REMOVED*** Check for type narrowing
        for field_name in old_props:
            if field_name in new_props:
                ...
                if old_type and new_type and old_type != new_type:
                    ***REMOVED*** Check if type change is compatible
    ...
    def validate_forward_compatibility(
        ...
        ***REMOVED*** Check for removed required fields
...
class SchemaRegistry:
    ...
    async def register_schema(
        ...
        """
        ***REMOVED*** Check if version already exists
        ...
        ***REMOVED*** Validate compatibility with previous version if exists
        if version > 1:
        ...
        ***REMOVED*** Create new schema version
        ...
        ***REMOVED*** If making this the default, unset other defaults
        if make_default:
            await self._unset_default_versions(name, exclude_id=schema_version.id)

        ***REMOVED*** Create change event
        ...
        ***REMOVED*** Trigger notification (async)
    ...
    async def get_schema(
        ...
        ***REMOVED*** Get default version or latest active
        if self.is_async:
            stmt = (
    ...
    async def list_schemas(
        ...
        if self.is_async:
            ...
            if tags:
                ***REMOVED*** Filter by tags (PostgreSQL JSON array contains)
                for tag in tags:
    ...
    async def check_compatibility(
        ...
        """
        ***REMOVED*** Get schema to compare against
        ...
        ***REMOVED*** Validate based on compatibility type
        if compatibility_type == SchemaCompatibilityType.BACKWARD.value:
            ...
            ***REMOVED*** Check against all previous versions
        ...
        ***REMOVED*** Add suggestions for common issues
        if violations:
            suggestions.append(
    ...
    async def generate_documentation(
        ...
        ***REMOVED*** Get all versions for history
        all_versions = await self._get_all_schema_versions(name)

        ***REMOVED*** Extract field information
        fields = []
        ...
        ***REMOVED*** Build compatibility history
        ...
        ***REMOVED*** Build migration guides
        migration_guides = []
    ...
    ***REMOVED*** Private helper methods
    ...
    async def _notify_schema_change(self, change_event: SchemaChangeEvent) -> None:
        ...
        try:
            ...
            ***REMOVED*** Integrate with notification service
    ...
    async def notify_schema_change(
        ...
        try:
            ...
            ***REMOVED*** Get admin users who should be notified
            ...
            ***REMOVED*** Create notification data
            ...
            ***REMOVED*** Send notifications to all admins
            notification_data = {
            ...
            ***REMOVED*** Use a generic notification type or create a custom one
            ***REMOVED*** For now, we'll use the notification service directly without a specific type
            for admin_id in admin_ids:
                try:
                    ***REMOVED*** Create an in-app notification record directly
            ...
            ***REMOVED*** Commit all notifications
            if self.is_async:
                await self.db.commit()
            else:
                self.db.commit()
    ...
    async def _get_schema_admin_ids(self) -> list:
        ...
        try:
            ...
            ***REMOVED*** Query for users with ADMIN or COORDINATOR roles and map to person records by email
            if self.is_async:
                stmt = (
                    select(Person.id)
