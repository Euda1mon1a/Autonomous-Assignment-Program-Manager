    ...
    ***REMOVED*** Private helper methods
    ...
    async def _notify_schema_change(self, change_event: SchemaChangeEvent) -> None:
        ...
        try:
            ...
            ***REMOVED*** from app.notifications import get_notification_service
            ***REMOVED*** notification_service = get_notification_service(self.db)
            ***REMOVED*** await notification_service.send_notification(...)
