...
class SwapRequestSummary(BaseModel):
    ...
    created_at: datetime
    is_incoming: bool  ***REMOVED*** True if request is to take a week from me
...
class DashboardAlert(BaseModel):
    ...
    id: UUID
    alert_type: str  ***REMOVED*** conflict, swap_request, reminder
...
class MarketplaceEntry(BaseModel):
    ...
    is_compatible: bool  ***REMOVED*** Based on viewer's schedule
