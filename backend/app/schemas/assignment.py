...
class AssignmentBase(BaseModel):
    ...
    notes: str | None = None
    override_reason: str | None = None  ***REMOVED*** Reason for acknowledging ACGME violations
...
class AssignmentUpdate(BaseModel):
    ...
    notes: str | None = None
    override_reason: str | None = None  ***REMOVED*** Reason for acknowledging ACGME violations
    acknowledge_override: bool | None = None  ***REMOVED*** Set to True to timestamp override_acknowledged_at
...
class AssignmentResponse(AssignmentBase):
    ...
    created_at: datetime
    updated_at: datetime
    override_acknowledged_at: datetime | None = None  ***REMOVED*** When ACGME violation was acknowledged
