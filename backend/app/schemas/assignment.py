...
class AssignmentBase(BaseModel):
    ...
    role: str  ***REMOVED*** 'primary', 'supervising', 'backup'
    activity_override: Optional[str] = None
    notes: Optional[str] = None
    override_reason: Optional[str] = None  ***REMOVED*** Reason for acknowledging ACGME violations
...
class AssignmentUpdate(BaseModel):
    ...
    notes: Optional[str] = None
    override_reason: Optional[str] = None  ***REMOVED*** Reason for acknowledging ACGME violations
    acknowledge_override: Optional[bool] = None  ***REMOVED*** Set to True to timestamp override_acknowledged_at
    updated_at: datetime  ***REMOVED*** Required for optimistic locking
...
class AssignmentResponse(AssignmentBase):
    ...
    created_at: datetime
    updated_at: datetime
    override_acknowledged_at: Optional[datetime] = None  ***REMOVED*** When ACGME violation was acknowledged

    ***REMOVED*** Explainability fields
...
class AssignmentWithExplanation(AssignmentResponse):
    ...
    ***REMOVED*** Computed explanation summary
