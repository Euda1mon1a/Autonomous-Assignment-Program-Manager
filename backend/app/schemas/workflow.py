...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Template Schemas
***REMOVED*** ============================================================================
...
class StepRetryPolicy(BaseModel):
    ...
    max_backoff_seconds: int = Field(default=300, ge=1, description="Maximum backoff time in seconds")
...
class StepDefinition(BaseModel):
    ...
    handler: str = Field(..., description="Handler function path (e.g., 'app.services.email_service.send_email')")
    ...
    condition: str | None = Field(default=None, description="Python expression to evaluate before executing")
    retry_policy: StepRetryPolicy = Field(default_factory=StepRetryPolicy, description="Retry configuration")
    timeout_seconds: int | None = Field(default=None, ge=1, description="Step timeout in seconds")
    input_mapping: dict[str, Any] = Field(default_factory=dict, description="Input parameter mapping")
...
class WorkflowTemplateDefinition(BaseModel):
    ...
    default_timeout_seconds: int = Field(default=3600, ge=1, description="Default workflow timeout")
...
class WorkflowTemplateCreate(BaseModel):
    ...
    definition: WorkflowTemplateDefinition = Field(..., description="Workflow definition")
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Instance Schemas
***REMOVED*** ============================================================================
...
class WorkflowInstanceCreate(BaseModel):
    ...
    name: str | None = Field(default=None, max_length=255, description="Optional custom instance name")
    description: str | None = Field(default=None, description="Instance description")
    input_data: dict[str, Any] = Field(default_factory=dict, description="Input parameters for the workflow")
    priority: int = Field(default=0, ge=0, le=100, description="Execution priority (higher = more important)")
    timeout_seconds: int | None = Field(default=None, ge=1, description="Override workflow timeout")
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Step Execution Schemas
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Execution Schemas
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Query Schemas
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Statistics Schemas
***REMOVED*** ============================================================================
