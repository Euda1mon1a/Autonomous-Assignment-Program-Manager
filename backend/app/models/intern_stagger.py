...
class InternStaggerPattern(Base):
    ...
    ***REMOVED*** Start times for each group
    intern_a_start = Column(Time, nullable=False)  ***REMOVED*** e.g., 07:00
    intern_b_start = Column(Time, nullable=False)  ***REMOVED*** e.g., 09:00

    ***REMOVED*** Overlap metrics
    overlap_duration_minutes = Column(Integer, nullable=False)  ***REMOVED*** e.g., 240 (4 hours)
    overlap_efficiency = Column(Integer, nullable=False, default=85)  ***REMOVED*** Percentage (0-100)

    ***REMOVED*** Experience requirements
    min_intern_a_experience_weeks = Column(Integer, nullable=False, default=2)  ***REMOVED*** Weeks before overlap starts
    ...
    ***REMOVED*** Note: Will be connected to schedule assignments when intern staggering is implemented
