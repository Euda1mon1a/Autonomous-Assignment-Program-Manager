...
class RotationPreference(Base):
    ...
    ***REMOVED*** Examples:
    ***REMOVED*** - consecutive_specialty: {"min_consecutive": 2}
    ***REMOVED*** - preferred_days: {"activity": "fm_clinic", "days": [1, 2, 5]}
    ***REMOVED*** - balance_weekly: {"max_same_per_day": 1}
    config_json = Column(
        JSONType,
        default=dict,
        nullable=False,
    ...
    ***REMOVED*** Human-readable description for UI display
...
***REMOVED*** Default preferences that can be added to new templates
PREFERENCE_DEFAULTS = {
    "full_day_grouping": {
