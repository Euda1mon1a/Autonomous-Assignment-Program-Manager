...
class ConflictAlert(Base):
    ...
    ***REMOVED*** Related records
    ...
    swap_id = Column(PGUUID(as_uuid=True), nullable=True)  ***REMOVED*** FK added when swap model wired

    ***REMOVED*** Status tracking
    status = Column(SQLEnum(ConflictAlertStatus), default=ConflictAlertStatus.NEW, nullable=False)

    ***REMOVED*** Description and notes
