...
class WeeklyPattern(Base):
    ...
    ***REMOVED*** Foreign key to rotation template
    ...
    ***REMOVED*** Optional: link to a specific sub-rotation template for this slot
    ***REMOVED*** This allows slots to reference other templates for complex patterns
    ...
    ***REMOVED*** Protected slots cannot be modified by users
    ***REMOVED*** Example: Wednesday AM conference time is protected
    is_protected = Column(
        Boolean,
        default=False,
        nullable=False,
    ...
    ***REMOVED*** Optional notes for this slot
    ...
    ***REMOVED*** Unique constraint: one slot per day/time per template
    ...
    def is_weekend(self) -> bool:
        ...
        return self.day_of_week in (0, 6)  ***REMOVED*** Sunday or Saturday
