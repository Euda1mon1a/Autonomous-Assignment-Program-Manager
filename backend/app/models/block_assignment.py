...
class AssignmentReason(str, Enum):
    ...
    LEAVE_ELIGIBLE_MATCH = "leave_eligible_match"  ***REMOVED*** Auto-assigned due to leave
    COVERAGE_PRIORITY = "coverage_priority"  ***REMOVED*** Assigned to fill coverage needs
    BALANCED = "balanced"  ***REMOVED*** Assigned for workload balance
    MANUAL = "manual"  ***REMOVED*** Manually assigned by coordinator
    SPECIALTY_MATCH = "specialty_match"  ***REMOVED*** Matches specialty requirements
...
class BlockAssignment(Base):
    ...
    ***REMOVED*** Block identification
    block_number = Column(Integer, nullable=False)  ***REMOVED*** 1-13
    academic_year = Column(Integer, nullable=False)  ***REMOVED*** e.g., 2025 (starts July 1)

    ***REMOVED*** Assignment links
    resident_id = Column(
    ...
    ***REMOVED*** Relationships
    ...
    def is_leave_eligible_rotation(self) -> bool:
        ...
        return True  ***REMOVED*** Assume eligible if no template assigned
