...
class StaffingStatus(str, Enum):
    ...
    OPTIMAL = "optimal"  ***REMOVED*** 1:3 or better
    ADEQUATE = "adequate"  ***REMOVED*** 1:4
    SUBOPTIMAL = "suboptimal"  ***REMOVED*** 1:5
    INADEQUATE = "inadequate"  ***REMOVED*** 1:6 or worse
    UNSTAFFED = "unstaffed"  ***REMOVED*** No screeners
...
class ClinicSession(Base):
    ...
    session_type = Column(String(2), nullable=False)  ***REMOVED*** SessionType enum value (am, pm)
    clinic_type = Column(String(50), nullable=False)  ***REMOVED*** ClinicType enum value
    ...
    ***REMOVED*** Ratio metrics
    screener_ratio = Column(Float)  ***REMOVED*** Actual ratio (e.g., 3.5 for 1:3.5)

    ***REMOVED*** Status tracking
    staffing_status = Column(String(20), nullable=False)  ***REMOVED*** StaffingStatus enum value
    rn_fallback_used = Column(Boolean, default=False)  ***REMOVED*** Whether RN was used as fallback
    ...
    ***REMOVED*** Note: Will be connected to assignments when screener assignments are implemented
