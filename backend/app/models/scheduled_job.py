...
class ScheduledJob(Base):
    ...
    trigger_type = Column(String(50), nullable=False)  ***REMOVED*** cron, interval, date
    ...
    misfire_grace_time = Column(Integer, nullable=True)  ***REMOVED*** seconds
...
class JobExecution(Base):
    ...
    status = Column(String(50), nullable=False, index=True)  ***REMOVED*** success, failure, missed
