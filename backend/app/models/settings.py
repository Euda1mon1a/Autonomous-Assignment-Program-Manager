...
class OverrideReasonCode(str, Enum):
    ...
    EMERGENCY_LEAVE = "emergency_leave"  ***REMOVED*** Family emergency, bereavement
    ADMINISTRATIVE = "administrative"  ***REMOVED*** Admin-directed change
    CRISIS_MODE = "crisis_mode"  ***REMOVED*** System in crisis mode
    OTHER = "other"  ***REMOVED*** Requires free-text justification
...
class ApplicationSettings(Base):
    ...
    ***REMOVED*** Scheduling algorithm configuration
    scheduling_algorithm = Column(String(50), nullable=False, default="greedy")

    ***REMOVED*** Work hour limits (ACGME compliance)
    ...
    ***REMOVED*** Freeze horizon settings
    ***REMOVED*** Number of days before an assignment where changes are restricted
    freeze_horizon_days = Column(Integer, nullable=False, default=7)
    ***REMOVED*** Policy for freeze enforcement
    freeze_scope = Column(
