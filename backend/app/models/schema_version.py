...
class SchemaCompatibilityType(str, Enum):
    ...
    NONE = "none"  ***REMOVED*** No compatibility guarantees
    BACKWARD = "backward"  ***REMOVED*** New schema can read old data
    FORWARD = "forward"  ***REMOVED*** Old schema can read new data
    FULL = "full"  ***REMOVED*** Both backward and forward compatible
    TRANSITIVE = "transitive"  ***REMOVED*** Compatibility with all previous versions
...
class SchemaStatus(str, Enum):
    ...
    DEPRECATED = "deprecated"  ***REMOVED*** Marked for removal, still usable
    ARCHIVED = "archived"  ***REMOVED*** No longer usable, kept for history
    DRAFT = "draft"  ***REMOVED*** Not yet published
