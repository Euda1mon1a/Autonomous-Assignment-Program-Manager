...
class PreferenceWeight(str, Enum):
    ...
    LOW = "low"  ***REMOVED*** Nice to have, minimal penalty if not satisfied
    MEDIUM = "medium"  ***REMOVED*** Moderate priority, some penalty
    HIGH = "high"  ***REMOVED*** Strong preference, significant penalty
    REQUIRED = "required"  ***REMOVED*** Soft but strongly enforced, high penalty
...
class ActivityType(str, Enum):
    ...
    These are the assignable activities for each AM/PM slot in the
    7x2 weekly pattern grid.
    """
