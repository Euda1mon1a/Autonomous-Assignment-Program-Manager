...
class Absence(Base):
    ...
    ***REMOVED*** Blocking vs partial absence
    ***REMOVED*** True = blocks entire period (deployment, extended medical leave)
    ***REMOVED*** False = partial absence, should be tracked but doesn't prevent assignment (single day, appointment)
    is_blocking = Column(Boolean, default=False)

    ***REMOVED*** Return date tracking for admin workflow
    ***REMOVED*** When admin enters emergency absence, exact return date is often unknown
    ***REMOVED*** This flags the absence for follow-up to confirm actual return date
    ...
    ***REMOVED*** Replacement activity (shown in schedule)
    replacement_activity = Column(String(255))  ***REMOVED*** e.g., "TDY - Korea"
