...
def transform_to_title_case(text: str) -> str:
    ...
    ***REMOVED*** Use normalize_name for proper title casing
...
def transform_to_snake_case(text: str) -> str:
    ...
    ***REMOVED*** Replace spaces and hyphens with underscores
    text = re.sub(r"[\s-]+", "_", text)

    ***REMOVED*** Insert underscores before capitals (camelCase -> camel_Case)
...
def transform_to_camel_case(text: str) -> str:
    ...
    ***REMOVED*** Split on spaces, hyphens, underscores
    parts = re.split(r"[\s_-]+", text)

    ***REMOVED*** First part lowercase, rest title case
    if parts:
