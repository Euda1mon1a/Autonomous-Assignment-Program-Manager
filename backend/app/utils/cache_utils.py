...
def generate_cache_key(*args: Any) -> str:
    ...
    """
    ***REMOVED*** Convert args to string representation
    key_parts = [str(arg) for arg in args]
    key_string = ":".join(key_parts)

    ***REMOVED*** Hash the key string
...
def hash_dict(d: dict[str, Any]) -> str:
    ...
    """
    ***REMOVED*** Sort keys to ensure consistent ordering
    sorted_items = sorted(d.items())

    ***REMOVED*** Convert to JSON string
    json_str = json.dumps(sorted_items, sort_keys=True)

    ***REMOVED*** Hash the JSON string
