...
def validate_email_format(value: str) -> bool:
    ...
    ***REMOVED*** Simple but robust email regex
    ***REMOVED*** Allows: letters, numbers, dots, hyphens, underscores before @
    ***REMOVED*** Requires @ symbol
    ***REMOVED*** Allows: letters, numbers, dots, hyphens after @
    ***REMOVED*** Requires at least one dot after @
...
def sanitize_string(value: str, max_length: int | None = None) -> str:
    ...
    ***REMOVED*** Remove control characters and null bytes
...
def normalize_name(value: str) -> str:
    ...
    ***REMOVED*** Remove extra whitespace and strip
    normalized = " ".join(value.split())

    ***REMOVED*** Title case (capitalizes first letter of each word)
    normalized = normalized.title()

    ***REMOVED*** Handle common prefixes that should be capitalized differently
    prefixes = ["Mc", "Mac", "O'"]
    for prefix in prefixes:
        if normalized.startswith(prefix):
            ***REMOVED*** Capitalize letter after prefix
