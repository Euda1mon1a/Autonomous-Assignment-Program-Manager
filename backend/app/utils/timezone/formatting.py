...
class TimezoneFormatter:
    ...
    ***REMOVED*** Common format strings
    FORMAT_DATETIME_FULL = "%Y-%m-%d %H:%M:%S %Z"  ***REMOVED*** 2024-01-15 10:30:00 HST
    FORMAT_DATETIME_SHORT = "%Y-%m-%d %H:%M"  ***REMOVED*** 2024-01-15 10:30
    FORMAT_DATE_ONLY = "%Y-%m-%d"  ***REMOVED*** 2024-01-15
    FORMAT_TIME_ONLY = "%H:%M:%S"  ***REMOVED*** 10:30:00
    FORMAT_TIME_SHORT = "%H:%M"  ***REMOVED*** 10:30
    FORMAT_DISPLAY_FULL = "%B %d, %Y at %I:%M %p %Z"  ***REMOVED*** January 15, 2024 at 10:30 AM HST
    FORMAT_DISPLAY_SHORT = "%b %d, %Y %I:%M %p"  ***REMOVED*** Jan 15, 2024 10:30 AM
    ...
    def format_datetime(
        ...
        Example:
            ...
            >>> ***REMOVED*** Returns "2024-01-15 10:00:00 HST"
        """
    ...
    def format_iso8601(
        ...
        Example:
            ...
            >>> ***REMOVED*** Returns "2024-01-15T20:00:00+00:00"
        """
        if utc:
    ...
    def format_relative(
        ...
        ***REMOVED*** Get reference time
        if reference is None:
            reference = TimezoneConverter.now_utc()

        ***REMOVED*** Normalize both to UTC
        if dt.tzinfo is None:
        ...
        ***REMOVED*** Calculate difference
        delta = reference - dt
        seconds = delta.total_seconds()

        ***REMOVED*** Determine if past or future
        if seconds > 0:
            suffix = "ago"
        else:
            suffix = "from now"
        ...
        ***REMOVED*** Format based on magnitude
        if seconds < 60:
            return f"{int(seconds)} seconds {suffix}"
        elif seconds < 3600:  ***REMOVED*** Less than 1 hour
            minutes = int(seconds / 60)
            return f"{minutes} minute{'s' if minutes != 1 else ''} {suffix}"
        elif seconds < 86400:  ***REMOVED*** Less than 1 day
            hours = int(seconds / 3600)
            return f"{hours} hour{'s' if hours != 1 else ''} {suffix}"
        elif seconds < 604800:  ***REMOVED*** Less than 1 week
            days = int(seconds / 86400)
            return f"{days} day{'s' if days != 1 else ''} {suffix}"
        elif seconds < 2592000:  ***REMOVED*** Less than 30 days
            weeks = int(seconds / 604800)
            return f"{weeks} week{'s' if weeks != 1 else ''} {suffix}"
        elif seconds < 31536000:  ***REMOVED*** Less than 1 year
    ...
    def format_date_range(
        ...
        Example:
            ...
            >>> ***REMOVED*** Returns "January 15 - 19, 2024"
        """
        tz_name = tz_name or TimezoneConverter.DEFAULT_TIMEZONE

        ***REMOVED*** Convert datetime to date if not including time
        if not include_time:
        ...
        ***REMOVED*** Different years or include time
    ...
    def format_for_user(
        ...
        Example:
            ...
            ... )
            >>> ***REMOVED*** Returns "January 15, 2024 at 03:00 PM EST"
        """
    ...
    def format_timezone_info(cls, tz_name: str) -> str:
        ...
        Example:
            ...
            >>> ***REMOVED*** Returns "Pacific/Honolulu (HST, UTC-10:00)"
        """
        try:
    ...
    def format_block_time(
        ...
        Example:
            ...
            ...     date(2024, 1, 15), "AM"
            ... )
            >>> ***REMOVED*** Returns "January 15, 2024 - AM (8:00 AM - 12:00 PM)"
        """
        time_ranges = {
            "AM": "8:00 AM - 12:00 PM",
            "PM": "1:00 PM - 5:00 PM",
    ...
    def format_api_response(
        ...
        ***REMOVED*** Ensure datetime is aware
        if dt.tzinfo is None:
