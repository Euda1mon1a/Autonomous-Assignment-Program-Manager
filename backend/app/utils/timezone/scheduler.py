...
class TimezoneAwareScheduler:
    ...
    ***REMOVED*** Default business hours (24-hour format)
    DEFAULT_BUSINESS_START = time(8, 0)  ***REMOVED*** 8:00 AM
    DEFAULT_BUSINESS_END = time(17, 0)  ***REMOVED*** 5:00 PM

    ***REMOVED*** Medical facility typical hours
    CLINIC_HOURS_AM_START = time(8, 0)  ***REMOVED*** 8:00 AM
    CLINIC_HOURS_AM_END = time(12, 0)  ***REMOVED*** 12:00 PM (noon)
    CLINIC_HOURS_PM_START = time(13, 0)  ***REMOVED*** 1:00 PM
    CLINIC_HOURS_PM_END = time(17, 0)  ***REMOVED*** 5:00 PM
    ...
    def is_business_hours(
        ...
        Example:
            >>> dt = datetime(2024, 1, 15, 10, 0)  ***REMOVED*** Monday 10 AM
            >>> TimezoneAwareScheduler.is_business_hours(dt)
            True
            >>> dt = datetime(2024, 1, 15, 18, 0)  ***REMOVED*** Monday 6 PM
            >>> TimezoneAwareScheduler.is_business_hours(dt)
            False
        """
        ...
        ***REMOVED*** Convert to local timezone
        ...
        ***REMOVED*** Check weekday
        if not include_weekends and local_dt.weekday() >= 5:  ***REMOVED*** Saturday=5, Sunday=6
            return False

        ***REMOVED*** Check time of day
    ...
    def get_next_business_day(
        ...
        Example:
            ...
            >>> ***REMOVED*** Returns Monday (skips weekend)
            >>> next_day == date(2024, 1, 22)
            True
        """
        next_day = reference_date + timedelta(days=1)

        ***REMOVED*** Skip weekends if not included
        if not include_weekends:
            while next_day.weekday() >= 5:  ***REMOVED*** Saturday or Sunday
    ...
    def get_business_days_between(
        ...
        Example:
            >>> start = date(2024, 1, 15)  ***REMOVED*** Monday
            >>> end = date(2024, 1, 19)  ***REMOVED*** Friday
        ...
        while current <= end_date:
            if current.weekday() < 5:  ***REMOVED*** Monday=0, Friday=4
                business_days += 1
    ...
    def is_clinic_am_block(cls, dt: datetime, tz_name: Optional[str] = None) -> bool:
        ...
        Example:
            >>> dt = datetime(2024, 1, 15, 10, 0)  ***REMOVED*** 10 AM
    ...
    def is_clinic_pm_block(cls, dt: datetime, tz_name: Optional[str] = None) -> bool:
        ...
        Example:
            >>> dt = datetime(2024, 1, 15, 14, 0)  ***REMOVED*** 2 PM
    ...
    def normalize_to_business_hours(
        ...
        ***REMOVED*** If weekend, move to next/previous weekday
        if local_dt.weekday() >= 5:
            if direction == "next":
                ***REMOVED*** Move to Monday
        ...
        ***REMOVED*** Check if before business hours
    ...
    def find_overlapping_hours(
        ...
        Example:
            >>> ***REMOVED*** Find overlap between Hawaii and New York business hours
            >>> overlap = TimezoneAwareScheduler.find_overlapping_hours(
            ...     "Pacific/Honolulu", "America/New_York"
            ... )
            >>> ***REMOVED*** Returns overlapping time range in Hawaii time
        """
        ...
        ***REMOVED*** Use today as reference
        ref_date = date.today()

        ***REMOVED*** Create datetime objects in each timezone
        ...
        ***REMOVED*** Convert tz2 times to tz1
        ...
        ***REMOVED*** Check if there's actual overlap
    ...
    def calculate_hours_in_period(
        ...
        if business_hours_only:
            ***REMOVED*** Complex calculation - count only business hours
            tz_name = tz_name or TimezoneConverter.DEFAULT_TIMEZONE

            ***REMOVED*** Normalize to UTC
            ...
            ***REMOVED*** Iterate through each hour
            while current < end_utc:
                if cls.is_business_hours(current, tz_name):
                    ***REMOVED*** Add the fraction of this hour that's in range
                    hour_end = min(
