...
Example:
    ...
    ***REMOVED*** Create and use machine
...
class TransitionEvent:
    ...
    Example:
        ***REMOVED*** Simple event - just an event name string
        machine.trigger_event(db, instance_id, "approve")

        ***REMOVED*** Event with data
...
***REMOVED*** Type aliases for callbacks
...
class Transition:
    ...
    Example:
        ***REMOVED*** Simple transition
        Transition("draft", "pending", "submit")

        ***REMOVED*** Transition with guard and action
        Transition(
        ...
        ***REMOVED*** Alternative transition for same event (lower priority)
        Transition(
...
class ParallelState:
    ...
    Example:
        ***REMOVED*** Two independent tracking regions
        parallel_regions = [
            ParallelState(
                name="approval",
...
class GuardFailedError(StateMachineError):
    ...
    Example:
        try:
            ...
            ***REMOVED*** Inform user why approval was blocked
    """
...
class StateMachine:
    ...
    Example:
        ***REMOVED*** 1. Define the state machine
    ...
    def __init__(
        ...
        ***REMOVED*** Registries for guards and actions
        self._guards: dict[str, Guard] = {}
        self._actions: dict[str, Action] = {}

        ***REMOVED*** Validate the machine definition
    ...
    def _validate_definition(self) -> None:
        ...
        """
        ***REMOVED*** Check for exactly one initial state
        ...
        ***REMOVED*** Validate transitions reference valid states
        ...
        ***REMOVED*** Validate parallel regions
    ...
    def create_instance(
        ...
        ***REMOVED*** Initialize parallel regions if any
        ...
        ***REMOVED*** Execute entry action for initial state
    ...
    def trigger_event(
        ...
        """
        ***REMOVED*** Load instance with transitions
        instance = (
        ...
        ***REMOVED*** Merge context updates
        if context_updates:
            instance.context.update(context_updates)
        if event_obj.data:
            instance.context.update(event_obj.data)

        ***REMOVED*** Find matching transitions (sorted by priority descending)
        ...
        ***REMOVED*** Try transitions in priority order until one succeeds
        transition = None
        guard_failed_name = None

        for candidate in matching_transitions:
            ***REMOVED*** Evaluate guard if present
            if candidate.guard:
                ctx = StateMachineContext(
                    instance_id=instance.id,
        ...
        ***REMOVED*** Execute the transition
    ...
    def _execute_transition_sync(
        ...
        ***REMOVED*** Snapshot context before transition
        ...
        ***REMOVED*** Execute exit action on old state
        ...
        ***REMOVED*** Execute transition action
        ...
        ***REMOVED*** Execute entry action on new state
    ...
    def export_visualization(self, format: str = "dot") -> str:
        ...
        Example:
            ...
            ***REMOVED*** Render with GraphViz (command line):
            ***REMOVED*** dot -Tpng workflow.dot -o workflow.png
            ***REMOVED*** dot -Tsvg workflow.dot -o workflow.svg
        """
        if format != "dot":
        ...
        ***REMOVED*** Define states
        for state in self.states.values():
            ...
            ***REMOVED*** Add entry/exit actions to label
            actions = []
        ...
        ***REMOVED*** Define transitions
        for transition in self.transitions:
            ...
            ***REMOVED*** Add guard and action to label
            details = []
            if transition.guard:
