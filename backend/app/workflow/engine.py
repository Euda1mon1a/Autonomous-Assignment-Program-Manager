...
Creating and executing a workflow::
    ...
    ***REMOVED*** Create and execute an instance
...
class WorkflowEngine:
    ...
    ***REMOVED*** ========================================================================
    ...
    def create_template(
        ...
        """
        ***REMOVED*** Check if template with this name exists
        existing = (
    ...
    def get_template(
        ...
        if name:
            query = self.db.query(WorkflowTemplate).filter(
                ...
                WorkflowTemplate.is_active == True,  ***REMOVED*** noqa: E712
            )
    ...
    def update_template(
        ...
        ***REMOVED*** If definition changed, create new version
        ...
        ***REMOVED*** Otherwise update in place
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Workflow Instance Management
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
        ...
        try:
            ...
            ***REMOVED*** Execute steps
            for step_group in execution_plan:
                ...
                ***REMOVED*** Execute step group (parallel or sequential)
                await self._execute_step_group(instance, step_group)

            ***REMOVED*** Workflow completed successfully
    ...
    def _build_execution_plan(self, steps: list[dict]) -> list[list[dict]]:
        ...
        ***REMOVED*** Build dependency graph
        ...
        while len(executed) < len(steps):
            ***REMOVED*** Find steps with no unmet dependencies
            ready_steps = [
                step
                for step in steps
    ...
    async def _execute_step_group(
        ...
        ***REMOVED*** Execute all steps in group concurrently
    ...
    async def _execute_step(
        ...
        ***REMOVED*** Check if step should be skipped based on condition
        ...
        ***REMOVED*** Try to execute step with retries
        for attempt in range(1, max_attempts + 1):
            try:
                ...
                if step_exec.status == StepStatus.COMPLETED.value:
                    ***REMOVED*** Update execution state with step output
                ...
                ***REMOVED*** Step failed, check if we should retry
    ...
    async def _execute_step_attempt(
        ...
        ***REMOVED*** Create or update step execution record
        step_exec = (
        ...
        ***REMOVED*** Prepare input data
        ...
        try:
            ***REMOVED*** Load and execute handler
            ...
            ***REMOVED*** Step completed successfully
    ...
    ***REMOVED*** ========================================================================
    ...
    def _evaluate_condition(
        ...
        """
        try:
            ***REMOVED*** Build safe evaluation context
            context = {
    ...
    def _prepare_step_input(
        ...
        for param_name, param_value in input_mapping.items():
            ***REMOVED*** If value is a string starting with "step_outputs.", resolve it
    ...
    ***REMOVED*** ========================================================================
    ...
    def query_instances(
        ...
        ***REMOVED*** Apply pagination and ordering
        instances = (
            query.order_by(
    ...
    def get_statistics(self, template_id: UUID | None = None) -> dict[str, Any]:
        ...
        ***REMOVED*** Calculate average duration for completed workflows
        avg_duration = None
