...
class EventMetadata(BaseModel):
    ...
    correlation_id: Optional[str] = None  ***REMOVED*** Links related events
    causation_id: Optional[str] = None  ***REMOVED*** ID of event that caused this one
...
class BaseEvent(BaseModel):
    ...
    aggregate_id: str  ***REMOVED*** ID of the entity this event relates to
    aggregate_type: str  ***REMOVED*** Type of entity (e.g., "Schedule", "Assignment")
    metadata: EventMetadata

    class Config:
        frozen = True  ***REMOVED*** Make events immutable
        json_encoders = {
            datetime: lambda v: v.isoformat() + "Z"
        }
...
class SwapRequestedEvent(BaseEvent):
    ...
    swap_type: str  ***REMOVED*** "one_to_one" or "absorb"
    reason: Optional[str] = None
...
class ACGMEViolationDetectedEvent(BaseEvent):
    ...
    violation_id: str
    person_id: str
    violation_type: str  ***REMOVED*** "80_hour", "1_in_7", "supervision_ratio"
    severity: str  ***REMOVED*** "warning", "critical"
...
class ACGMEOverrideAppliedEvent(BaseEvent):
    ...
    applied_by: str
    justification: str
    approval_level: str  ***REMOVED*** "coordinator", "program_director"
...
***REMOVED*** =============================================================================
***REMOVED*** Event Version Migration Support
***REMOVED*** =============================================================================
...
class EventVersionMigrator:
    ...
    def migrate(event_data: dict[str, Any]) -> dict[str, Any]:
        ...
        ***REMOVED*** Add version-specific migrations here
        ***REMOVED*** Example:
        ***REMOVED*** if event_type == "ScheduleCreated" and event_version == 1:
        ***REMOVED***     event_data = migrate_schedule_created_v1_to_v2(event_data)
