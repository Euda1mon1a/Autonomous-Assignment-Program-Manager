...
class StoredEvent(Base):
    ...
    ***REMOVED*** Metadata
    ...
    correlation_id = Column(String(255), index=True)  ***REMOVED*** Links related events
    causation_id = Column(String(255), index=True)  ***REMOVED*** Event that caused this one
    user_id = Column(String(255), index=True)
    ip_address = Column(String(45))  ***REMOVED*** IPv6 max length
    user_agent = Column(Text)
    session_id = Column(String(255))

    ***REMOVED*** Optimistic concurrency control
    expected_version = Column(Integer)

    __table_args__ = (
        ***REMOVED*** Composite index for efficient aggregate queries
...
class EventSnapshot(Base):
    ...
    ***REMOVED*** Metadata
    event_count = Column(Integer, nullable=False)  ***REMOVED*** Events replayed to build this
...
class EventStore:
    ...
    async def append_event(
        ...
        ***REMOVED*** Check optimistic concurrency
    ...
    async def append_events(
        ...
        ***REMOVED*** Verify all events are for same aggregate
    ...
    async def get_events(
        ...
        ***REMOVED*** Convert to event objects
        events = []
    ...
    async def get_events_by_correlation(
        ...
        """
        return await self.get_events(
            ***REMOVED*** Using raw query since get_events doesn't have correlation_id param
        )
        stored_events = (
            self.db.query(StoredEvent)
    ...
    def _deserialize_event(self, stored: StoredEvent) -> BaseEvent:
        ...
        """
        ***REMOVED*** Migrate event data if needed
        event_data = EventVersionMigrator.migrate(stored.event_data)

        ***REMOVED*** Get event class
...
***REMOVED*** =============================================================================
***REMOVED*** Event Store Statistics
***REMOVED*** =============================================================================
