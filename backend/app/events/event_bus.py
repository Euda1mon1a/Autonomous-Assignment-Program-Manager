...
class EventBus:
    ...
    def unsubscribe(self, subscriber_id: str, event_type: str | None = None):
        ...
        if event_type:
            ...
            ***REMOVED*** Unsubscribe from all event types
    ...
    async def _handle_event_with_retry(
        ...
        ***REMOVED*** Add to dead letter queue
    ...
    async def replay_dead_letter_event(self, event_id: str) -> bool:
        ...
        """
        ***REMOVED*** Find the event in dead letter queue
        dead_letter = None
...
***REMOVED*** =============================================================================
***REMOVED*** Convenience Decorators
***REMOVED*** =============================================================================
