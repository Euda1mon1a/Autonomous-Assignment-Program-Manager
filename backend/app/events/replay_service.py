...
class ReplaySpeed(str, Enum):
    ...
    REAL_TIME = "real_time"  ***REMOVED*** Replay at actual event timing
    SLOW_MOTION = "slow_motion"  ***REMOVED*** 0.5x speed
    NORMAL = "normal"  ***REMOVED*** No delay between events
    FAST = "fast"  ***REMOVED*** Batch processing
    MAXIMUM = "maximum"  ***REMOVED*** No throttling
...
class ReplayTarget(str, Enum):
    ...
    LATEST = "latest"  ***REMOVED*** Replay all available events


***REMOVED*** =============================================================================
***REMOVED*** Configuration Models
***REMOVED*** =============================================================================
...
class ReplayFilterConfig(BaseModel):
    ...
    def matches(self, event: BaseEvent) -> bool:
        ...
        """
        ***REMOVED*** Include filters (any match = include)
        ...
        ***REMOVED*** Exclude filters (any match = exclude)
...
***REMOVED*** =============================================================================
***REMOVED*** Progress and State Models
***REMOVED*** =============================================================================
...
class EventReplayService:
    ...
    async def start_replay(
        ...
        ***REMOVED*** Initialize progress tracking
        ...
        ***REMOVED*** Start replay in background
    ...
    async def _execute_replay(
        ...
        try:
            ...
            ***REMOVED*** Get total event count for progress calculation
            ...
            async for event in self._stream_events(config):
                ...
                ***REMOVED*** Process event
                try:
                    ...
                    ***REMOVED*** Create checkpoint if needed
                ...
                ***REMOVED*** Apply speed control
                await self._apply_speed_control(config.speed, event)

            ***REMOVED*** Replay completed
    ...
    async def _stream_events(self, config: ReplayConfig) -> AsyncIterator[BaseEvent]:
        ...
        ***REMOVED*** Order by sequence
        query = query.order_by(StoredEvent.sequence_number)

        ***REMOVED*** Apply event count limit if specified
    ...
    async def _transform_event(
        ...
        ***REMOVED*** Apply field transformations
    ...
    async def _apply_speed_control(
        ...
        if speed == ReplaySpeed.NORMAL:
            await asyncio.sleep(0)  ***REMOVED*** Yield control
            ...
            if hash(current_event.metadata.event_id) % 10 == 0:
                await asyncio.sleep(0)  ***REMOVED*** Yield every 10th event
        ***REMOVED*** MAXIMUM: no delays at all
    ...
    async def _verify_timestamp_ordering(
        ...
        ***REMOVED*** Check timestamp ordering
...
async def replay_aggregate_history(
    ...
    ***REMOVED*** Get first event timestamp for this aggregate
    first_event = (
