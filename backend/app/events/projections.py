...
***REMOVED*** =============================================================================
***REMOVED*** Projection State Storage
***REMOVED*** =============================================================================
...
class ProjectionState(Base):
    ...
    status = Column(String(50), default="active")  ***REMOVED*** active, rebuilding, paused
...
class EventProjection(ABC):
    ...
    def _load_state(self):
        ...
        if state:
            ...
            ***REMOVED*** Initialize new projection
    ...
    async def rebuild(self, event_store):
        ...
        ***REMOVED*** Mark as rebuilding
        self.status = "rebuilding"
        self._save_state()

        try:
            ***REMOVED*** Reset projection-specific data
            await self.reset()

            ***REMOVED*** Get all events
            ...
            ***REMOVED*** Process events
            for i, event in enumerate(events, start=1):
                ...
                ***REMOVED*** Checkpoint every 100 events
                if i % 100 == 0:
...
***REMOVED*** =============================================================================
***REMOVED*** ACGME Compliance Projection
***REMOVED*** =============================================================================
...
class ACGMEComplianceProjection(EventProjection):
    ...
    def get_overrides_by_person(self, person_id: str) -> list[dict]:
        ...
        ***REMOVED*** This would need to join with assignments
        return list(self.overrides.values())


***REMOVED*** =============================================================================
***REMOVED*** Projection Manager
***REMOVED*** =============================================================================
