...
class CacheTTL:
    ...
    ***REMOVED*** Short-lived caches (frequently changing data)
    SHORT = 60  ***REMOVED*** 1 minute

    ***REMOVED*** Medium-lived caches (heatmaps, calendars)
    MEDIUM = 300  ***REMOVED*** 5 minutes

    ***REMOVED*** Long-lived caches (rarely changing data)
    LONG = 3600  ***REMOVED*** 1 hour

    ***REMOVED*** Very long-lived caches (static reference data)
    EXTENDED = 86400  ***REMOVED*** 24 hours
...
def invalidate_schedule_cache() -> int:
    ...
    Example:
        ***REMOVED*** After modifying assignments
    ...
    ***REMOVED*** Invalidate all schedule-related prefixes
    for prefix in [
