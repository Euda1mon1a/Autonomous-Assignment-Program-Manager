...
***REMOVED*** Default sensitive field names
SENSITIVE_FIELDS = {
    "password",
    "passwd",
    "pwd",
...
class DataSanitizer:
    ...
    def __init__(
        ...
        ***REMOVED*** Built-in sanitization rules
    ...
    def sanitize_dict(
        ...
        for key, value in data.items():
            ***REMOVED*** Check if field should be redacted by name
            ...
            if should_redact:
                ...
                ***REMOVED*** Recursively sanitize nested structures
                if isinstance(value, dict):
                    sanitized[key] = self.sanitize_dict(value, recursive=True)
                elif isinstance(value, list):
                    sanitized[key] = self._sanitize_list(value)
                elif isinstance(value, str):
                    ***REMOVED*** Apply pattern-based sanitization
    ...
    def _sanitize_string(self, value: str) -> str:
        ...
        ***REMOVED*** Apply all pattern-based rules
    ...
    def _mask_value(self, value: str) -> str:
        ...
        if self.partial_mask and length > 4:
            ***REMOVED*** Show last 4 characters: "***-1234"
            visible = value[-4:]
...
***REMOVED*** Global sanitizer instance
...
def create_custom_rule(
    ...
    Example:
        ***REMOVED*** Redact military ID numbers
