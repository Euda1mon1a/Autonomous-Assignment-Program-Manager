...
class LogFormat(str, Enum):
    ...
    JSON = "json"
    TEXT = "text"
    GELF = "gelf"  ***REMOVED*** Graylog Extended Log Format
    LOGFMT = "logfmt"  ***REMOVED*** Key=value format
...
class LoggingConfig:
    ...
    max_file_size: int = field(default=100)  ***REMOVED*** MB
    ...
    def from_env(cls) -> "LoggingConfig":
        ...
        """
        ***REMOVED*** Determine format based on environment
        default_format = (
...
def configure_module_logging(
    ...
    Example:
        ***REMOVED*** Quiet down noisy third-party library
        configure_module_logging("sqlalchemy.engine", LogLevel.WARNING)

        ***REMOVED*** Enable debug logging for specific module
...
***REMOVED*** Global logging configuration
