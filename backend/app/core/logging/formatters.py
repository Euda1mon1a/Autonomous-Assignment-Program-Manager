...
class JSONFormatter:
    ...
    def format(self, record: dict[str, Any]) -> str:
        ...
        ***REMOVED*** Add extra fields if present
        if self.include_extra and record.get("extra"):
            for key, value in record["extra"].items():
                if key not in entry:  ***REMOVED*** Avoid overwriting core fields
                    entry[key] = value
        ...
        ***REMOVED*** Add process/thread info
        entry["process"] = {
...
class GELFFormatter:
    ...
    def format(self, record: dict[str, Any]) -> str:
        ...
        """
        ***REMOVED*** GELF specification version 1.1
        gelf_entry = {
            "version": "1.1",
            "host": self.hostname,
    ...
    def _map_level(self, loguru_level: int) -> int:
        ...
        """
        ***REMOVED*** Map to syslog levels:
        ***REMOVED*** 0: Emergency, 1: Alert, 2: Critical, 3: Error
        ***REMOVED*** 4: Warning, 5: Notice, 6: Informational, 7: Debug
        if loguru_level >= 50:  ***REMOVED*** CRITICAL
            return 2
        elif loguru_level >= 40:  ***REMOVED*** ERROR
            return 3
        elif loguru_level >= 30:  ***REMOVED*** WARNING
            return 4
        elif loguru_level >= 20:  ***REMOVED*** INFO
            return 6
        else:  ***REMOVED*** DEBUG
            return 7
...
class LogfmtFormatter:
    ...
    def _quote(self, value: str) -> str:
        ...
        if " " in value or "=" in value or '"' in value:
            ***REMOVED*** Escape quotes and wrap in quotes
...
class CloudWatchFormatter:
    ...
    def format(self, record: dict[str, Any]) -> str:
        ...
        ***REMOVED*** Extra fields (CloudWatch Insights can query these)
        if self.include_extra and record.get("extra"):
            for key, value in record["extra"].items():
                entry[key] = value
...
class ColoredTextFormatter:
    ...
    ***REMOVED*** ANSI color codes
    COLORS = {
        ...
        "SUCCESS": "\033[92m",  ***REMOVED*** Bright green
        "WARNING": "\033[33m",  ***REMOVED*** Yellow
        "ERROR": "\033[31m",  ***REMOVED*** Red
        "CRITICAL": "\033[91m",  ***REMOVED*** Bright red
        "RESET": "\033[0m",  ***REMOVED*** Reset
    }
    ...
    def format(self, record: dict[str, Any]) -> str:
        ...
        ***REMOVED*** Format timestamp
        timestamp = record["time"].strftime("%Y-%m-%d %H:%M:%S.%f")[:-3]

        ***REMOVED*** Format location
