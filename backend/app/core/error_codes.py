...
class ErrorCode(str, Enum):
    ...
    ***REMOVED*** Date validation errors
    ...
    ***REMOVED*** Concurrency errors
    CONFLICT = "CONFLICT"
    CONCURRENT_MODIFICATION = "CONCURRENT_MODIFICATION"

    ***REMOVED*** Authorization errors
    ...
    ***REMOVED*** Business logic errors
    BUSINESS_RULE_VIOLATION = "BUSINESS_RULE_VIOLATION"
    CONSTRAINT_VIOLATION = "CONSTRAINT_VIOLATION"
    INVALID_STATE_TRANSITION = "INVALID_STATE_TRANSITION"

    ***REMOVED*** Scheduling errors
    ...
    ***REMOVED*** ACGME compliance errors
    ...
    ***REMOVED*** External service errors
    ...
    ***REMOVED*** Generic error
    INTERNAL_ERROR = "INTERNAL_ERROR"


***REMOVED*** Error code to user-friendly description mapping
...
def get_error_code_from_message(error_message: str) -> ErrorCode:
    ...
    ***REMOVED*** ACGME compliance patterns
    ...
    ***REMOVED*** Not found patterns
    if "not found" in message_lower:
        return ErrorCode.NOT_FOUND

    ***REMOVED*** Concurrency patterns
    ...
    ***REMOVED*** Default to internal error for unknown messages
    return ErrorCode.INTERNAL_ERROR
