...
try:
    ...
    ***REMOVED*** Stub Collector for when prometheus is not available
    class Collector:  ***REMOVED*** type: ignore
...
class SystemResourceCollector(Collector):
    ...
    def collect(self):
        ...
        try:
            ***REMOVED*** Import here to avoid issues if prometheus_client not available
            from prometheus_client.core import GaugeMetricFamily

            ***REMOVED*** ================================================================
            ***REMOVED*** CPU METRICS
            ***REMOVED*** ================================================================
            ***REMOVED*** Overall CPU usage
            ...
            ***REMOVED*** Process memory percent
            ...
            ***REMOVED*** ================================================================
            ***REMOVED*** DISK METRICS
            ***REMOVED*** ================================================================

            ***REMOVED*** Disk usage for root partition
            ...
            ***REMOVED*** Open file descriptors
            try:
                ...
                ***REMOVED*** num_fds() not available on Windows
                pass

            ***REMOVED*** Process connections
            try:
            ...
            ***REMOVED*** System load average (Unix only)
...
class DatabasePoolCollector(Collector):
    ...
    def collect(self):
        ...
        try:
            ...
            ***REMOVED*** Checked out connections
            yield GaugeMetricFamily(
                "db_pool_checked_out",
            ...
            ***REMOVED*** Overflow (connections beyond pool size)
...
class ApplicationMetricsCollector(Collector):
    ...
    def collect(self):
        ...
        try:
            ...
            ***REMOVED*** This is a placeholder - actual implementation would query database
            ***REMOVED*** Disabled by default to avoid performance impact during scrapes
...
def register_custom_collectors(registry=None, engine=None, db_session_factory=None):
    ...
    ***REMOVED*** System resource collector
    if PSUTIL_AVAILABLE:
    ...
    ***REMOVED*** Database pool collector
    if engine:
    ...
    ***REMOVED*** Application metrics collector (disabled by default for performance)
    ***REMOVED*** Uncomment to enable:
    ***REMOVED*** if db_session_factory:
    ***REMOVED***     app_collector = ApplicationMetricsCollector(db_session_factory)
    ***REMOVED***     target_registry.register(app_collector)
    ***REMOVED***     collectors.append(app_collector)
    ***REMOVED***     logger.info("Registered ApplicationMetricsCollector")
