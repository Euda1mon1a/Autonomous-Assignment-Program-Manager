...
class AlertRuleBuilder:
    ...
    def build_system_alerts(self) -> list[AlertRule]:
        ...
        return [
            ...
            ***REMOVED*** Database connection pool exhaustion
            AlertRule(
    ...
    def build_compliance_alerts(self) -> list[AlertRule]:
        ...
        return [
            ...
            ***REMOVED*** Multiple violations for same person
            AlertRule(
            ...
            ***REMOVED*** Work hour threshold approaching
            AlertRule(
    ...
    def build_security_alerts(self) -> list[AlertRule]:
        ...
        """
        return [
            ***REMOVED*** Failed authentication spike
            AlertRule(
