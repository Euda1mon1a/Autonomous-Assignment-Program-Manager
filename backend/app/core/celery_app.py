...
***REMOVED*** Redis URL from environment or build from settings with password
***REMOVED*** Priority: Use environment variable if set (for Docker), otherwise use settings with password
REDIS_URL = os.getenv("REDIS_URL")
if not REDIS_URL:
    ***REMOVED*** Fallback to settings with password support for local development
...
celery_app.conf.update(
    ...
    ***REMOVED*** Beat schedule for periodic tasks
    beat_schedule={
        ...
        ***REMOVED*** Schedule Metrics - Hourly snapshots during business hours
        ...
        ***REMOVED*** Schedule Metrics - Daily cleanup at 3 AM
        ...
        ***REMOVED*** Schedule Metrics - Weekly fairness report on Monday at 7 AM
        ...
        ***REMOVED*** Schedule Metrics - Daily full computation at 5 AM
        ...
        ***REMOVED*** Export Jobs - Run scheduled exports every 5 minutes
        ...
        ***REMOVED*** Export Jobs - Daily cleanup at 4 AM
        ...
        ***REMOVED*** Export Jobs - Health check every hour
        "export-health-check": {
        ...
        ***REMOVED*** Secret Rotation - Check scheduled rotations daily at 1 AM
        ...
        ***REMOVED*** Secret Rotation - Complete grace periods every hour
        ...
        ***REMOVED*** Secret Rotation - Health monitoring daily at 8 AM
        ...
        ***REMOVED*** Secret Rotation - Cleanup old history monthly on the 1st at 2 AM
