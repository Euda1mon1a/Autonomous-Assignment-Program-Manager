...
class DutyHoursPeriod(TypedDict):
    ...
    start: str  ***REMOVED*** ISO format date string
    end: str  ***REMOVED*** ISO format date string
...
class FatigueScore(TypedDict):
    ...
    person_name: str
    pgy_level: NotRequired[int]
    date: str  ***REMOVED*** ISO format date string
    fatigue_score: float
...
class FatigueTrend(TypedDict):
    ...
    person_id: str
    person_name: str
    start_date: str  ***REMOVED*** ISO format date string
    days_ahead: int
...
class SwapDetails(TypedDict):
    ...
    source_week: str  ***REMOVED*** ISO format date
    target_week: NotRequired[str]  ***REMOVED*** ISO format date
    swap_type: Literal["one_to_one", "absorb"]
    status: Literal[
        "pending", "approved", "executed", "rejected", "cancelled", "rolled_back"
    ]
    executed_at: NotRequired[str]  ***REMOVED*** ISO format datetime
    rolled_back_at: NotRequired[str]  ***REMOVED*** ISO format datetime
...
class CoverageReportItem(TypedDict):
    ...
    period_start: str  ***REMOVED*** ISO format date
    period_end: str  ***REMOVED*** ISO format date
    total_blocks: int
    covered_blocks: int
...
class CoverageReport(TypedDict):
    ...
    start_date: str  ***REMOVED*** ISO format date
    end_date: str  ***REMOVED*** ISO format date
...
class ScheduleGenerationMetrics(TypedDict):
    ...
    generated_at: NotRequired[str]  ***REMOVED*** ISO format datetime
...
class ResilienceAnalysisResult(TypedDict):
    ...
    utilization_rate: float
    safety_level: Literal["GREEN", "YELLOW", "ORANGE", "RED", "BLACK"]
    defense_level: NotRequired[int]  ***REMOVED*** 1-5
    n1_vulnerabilities: int
    n2_vulnerabilities: int
    n1_pass: bool
    n2_pass: bool
...
class WorkloadDistribution(TypedDict):
    ...
    variance: int  ***REMOVED*** actual - target
    fairness_score: NotRequired[float]
...
class AnalyticsReport(TypedDict):
    ...
    recommendations: NotRequired[list[str]]
    generated_at: str  ***REMOVED*** ISO format datetime
