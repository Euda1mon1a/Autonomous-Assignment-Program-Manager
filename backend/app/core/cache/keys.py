...
class CacheKeyGenerator:
    ...
    Example:
        ...
        ***REMOVED*** Returns: "cache:schedule:v1:get_assignments:hash"
    """
    ...
    def generate(
        ...
        **kwargs
        ...
        Example:
            ...
            ***REMOVED*** Returns: "cache:schedule:v1:get_user:f7c3bc1d45e2"
        """
        ...
        ***REMOVED*** Add parameter hash if parameters provided
        if kwargs:
    ...
    def generate_pattern(
        ...
        Example:
            ...
            ***REMOVED*** Returns: "cache:schedule:v1:get_user:*"
        """
        components = [self.prefix]
    ...
    def _hash_params(self, params: dict[str, Any]) -> str:
        ...
        """
        ***REMOVED*** Sort parameters for consistency
        sorted_params = dict(sorted(params.items()))

        ***REMOVED*** Serialize to JSON (handles basic types)
        try:
            param_str = json.dumps(sorted_params, sort_keys=True, default=str)
        except (TypeError, ValueError):
            ***REMOVED*** Fallback for non-serializable types
            param_str = str(sorted_params)

        ***REMOVED*** Generate hash (MD5 is fast and sufficient for cache keys)
...
def generate_tag_key(namespace: str, tag: str, prefix: str = "cache") -> str:
    ...
    Example:
        ...
        ***REMOVED*** Returns: "cache:tag:schedule:user:123"
    """
...
def generate_stats_key(namespace: str, prefix: str = "cache") -> str:
    ...
    Example:
        ...
        ***REMOVED*** Returns: "cache:stats:schedule"
    """
