...
***REMOVED*** Backward compatibility: import ServiceCache from renamed service_cache.py
...
__all__ = [
    ...
    ***REMOVED*** Backward compatibility exports from service_cache.py
    "CachePrefix",
    "CacheTTL",
    "ServiceCache",
    "get_service_cache",
