...
class TaskQueue:
    ...
    async def enqueue(
        ...
        ***REMOVED*** Add to appropriate priority queue
        queue = self.queues[priority]

        ***REMOVED*** Priority queue uses negative priority for proper ordering
    ...
    async def stop(self):
        ...
        ***REMOVED*** Wait for active tasks to complete
    ...
    async def _worker(self):
        ...
        while self._running:
            try:
                ***REMOVED*** Try to get tasks from queues in priority order
                task = await self._get_next_task()

                if task:
                    ***REMOVED*** Execute task with concurrency limit
                    ...
                    ***REMOVED*** No tasks available, wait a bit
            ...
            try:
                ...
                ***REMOVED*** Retry logic
                if task.retries < task.max_retries:
                    ...
                    ***REMOVED*** Re-enqueue with exponential backoff
...
***REMOVED*** Global task queue instance
