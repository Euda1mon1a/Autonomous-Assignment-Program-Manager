...
class SanitizationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        ***REMOVED*** Skip excluded paths
        ...
        try:
            ...
            ***REMOVED*** Log error but don't break the request
            logger.error(
            ...
            ***REMOVED*** Continue without sanitization if middleware fails
            return await call_next(request)
    ...
    async def _sanitize_query_params(self, request: Request) -> None:
        ...
        try:
            ...
            ***REMOVED*** Update query params (note: this modifies the request scope)
        ...
        try:
            ...
            ***REMOVED*** Try to parse as JSON
            try:
                ...
                ***REMOVED*** Not JSON, skip sanitization
                return

            ***REMOVED*** Sanitize data
            sanitized_data = self._sanitize_dict(data)

            ***REMOVED*** Update request body
    ...
    def _sanitize_value(self, field_name: str, value: str) -> str:
        ...
        ***REMOVED*** Check for attacks first
        threats_detected = []
        ...
        ***REMOVED*** Log threats
        if threats_detected:
            ...
            ***REMOVED*** If detect_only mode, just log and return original
