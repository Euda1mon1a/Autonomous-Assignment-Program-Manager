...
async def validate_orphaned_assignments(
    ...
    ***REMOVED*** Get all assignments
    ...
    for assignment in assignments:
        ...
        ***REMOVED*** Check rotation template exists (if specified)
...
async def validate_cascade_delete_impact(
    ...
    if entity_type == "person":
        ***REMOVED*** Get assignments for this person
        result = await db.execute(
        ...
        ***REMOVED*** Get assignments using this rotation template
        result = await db.execute(
...
async def validate_referential_integrity(
    ...
    """
    ***REMOVED*** Check for orphaned assignments
    orphan_result = await validate_orphaned_assignments(db)

    ***REMOVED*** Could add more checks here:
    ***REMOVED*** - Check person references
    ***REMOVED*** - Check block references
    ***REMOVED*** - Check rotation template references
