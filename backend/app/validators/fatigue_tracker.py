...
class FatigueTracker:
    ...
    ***REMOVED*** Fatigue scoring weights
    WEIGHT_CONSECUTIVE_DAYS = 10  ***REMOVED*** Points per consecutive day
    WEIGHT_NIGHT_SHIFT = 15  ***REMOVED*** Extra points per night shift
    WEIGHT_WEEKEND = 12  ***REMOVED*** Extra points per weekend day
    WEIGHT_NO_DAY_OFF = 8  ***REMOVED*** Points per day without a day off
    WEIGHT_HOURLY_LOAD = 1.5  ***REMOVED*** Points per hour worked

    ***REMOVED*** Thresholds
    FATIGUE_THRESHOLD_HIGH = 70  ***REMOVED*** High risk threshold
    FATIGUE_THRESHOLD_MODERATE = 50  ***REMOVED*** Moderate risk threshold
    HOURS_PER_HALF_DAY = 6

    ***REMOVED*** Recovery constants
    BASE_RECOVERY_HOURS = 24  ***REMOVED*** Base recovery time
    RECOVERY_PER_FATIGUE_POINT = 0.5  ***REMOVED*** Additional hours per fatigue point
    ...
    def calculate_fatigue_score(
        self, person_id: str, target_date: date
    ) -> FatigueScore:
        """
        ...
        ***REMOVED*** Look back 14 days to calculate fatigue
        ...
        ***REMOVED*** Calculate fatigue score
        fatigue_score = (
    ...
    def get_recovery_time_needed(
        ...
        ***REMOVED*** Recommend consecutive days off
    ...
    def predict_fatigue_trend(
        ...
        for day_offset in range(days_ahead):
            ...
            ***REMOVED*** Get fatigue score for this date
    ...
    def get_high_risk_residents(
        ...
        ***REMOVED*** Sort by fatigue score (highest first)
    ...
    def _calculate_consecutive_days(
        ...
        ***REMOVED*** Get dates with assignments
        dates_worked = set()
        ...
        ***REMOVED*** Count backwards from target date
        consecutive = 0
    ...
    def _days_since_last_off(
        ...
        ***REMOVED*** Check backwards from target date to find last day off
        days_since_off = 0
        check_date = target_date
