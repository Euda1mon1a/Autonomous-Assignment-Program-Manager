...
class PaginationParams:
    ...
    def __init__(self, skip: int = 0, limit: int = 100):
        ...
        self.limit = max(1, min(limit, 1000))  ***REMOVED*** Cap at 1000
...
class AsyncBaseRepository(Generic[ModelType]):
    ...
    ***REMOVED*** ============= Pagination Operations =============
    ...
    async def get_paginated(
        ...
        ***REMOVED*** Count total before pagination
    ...
    ***REMOVED*** ============= Eager Loading Operations =============
    ...
    ***REMOVED*** ============= Counting and Existence Operations =============
