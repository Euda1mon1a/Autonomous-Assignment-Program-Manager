...
class SignatureAlgorithm(str, Enum):
    ...
    SHA256 = "sha256"
    SHA512 = "sha512"
    SHA1 = "sha1"  ***REMOVED*** Legacy support only, not recommended
...
class WebhookVerificationService:
    ...
    def __init__(
        ...
        max_payload_size_bytes: int = 1048576,  ***REMOVED*** 1MB default
    ):
        """
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Main Verification Methods
    ***REMOVED*** =========================================================================
    ...
    async def verify_webhook(
        ...
        Example:
            ...
            ... )
            >>> if result:
            ...     ***REMOVED*** Process webhook
            ...     pass
            >>> else:
            ...     logger.warning(f"Verification failed: {result.failure_reason}")
        """
        ***REMOVED*** Step 1: Validate IP address if whitelist enabled
        ...
        ***REMOVED*** Step 2: Validate required headers
        if required_headers:
        ...
        ***REMOVED*** Step 3: Extract and parse payload
        try:
        ...
        ***REMOVED*** Step 4: Validate payload size
        ...
        ***REMOVED*** Step 5: Load webhook secret if webhook_id provided
        ...
        ***REMOVED*** Step 6: Extract signature and timestamp from headers
        ...
        ***REMOVED*** Step 7: Parse timestamp
        try:
        ...
        ***REMOVED*** Step 8: Verify timestamp freshness
        ...
        ***REMOVED*** Step 9: Verify signature
        ...
        ***REMOVED*** Step 10: Detect retries/duplicates if enabled
    ...
    async def verify_and_raise(
        ...
        Example:
            ...
            ...     )
            ...     ***REMOVED*** Process verified webhook
            ...     return {"status": "ok"}
        """
        ...
        ***REMOVED*** Extract payload from request
        body = await request.body()
        return json.loads(body) if body else {}

    ***REMOVED*** =========================================================================
    ***REMOVED*** Individual Verification Methods
    ***REMOVED*** =========================================================================
    ...
    def _verify_signature(
        ...
        try:
            ...
            ***REMOVED*** Normalize signature format (remove algorithm prefix if present)
            signature_value = signature
            if "=" in signature:
                sig_algo, signature_value = signature.split("=", 1)
                ***REMOVED*** Validate algorithm matches
            ...
            ***REMOVED*** Constant-time comparison to prevent timing attacks
    ...
    def _verify_timestamp(self, timestamp: int) -> VerificationResult:
        ...
        try:
            ...
            ***REMOVED*** Calculate when the webhook was sent
    ...
    def _verify_ip_address(
        ...
        try:
            ...
            for allowed in ip_whitelist:
                try:
                    ***REMOVED*** Check if CIDR notation
                    if "/" in allowed:
                        ...
                        ***REMOVED*** Individual IP comparison
    ...
    def _verify_required_headers(
        ...
        ***REMOVED*** Convert to lowercase for case-insensitive comparison
    ...
    async def _detect_retry(
        ...
        """
        try:
            ***REMOVED*** Check if we've seen this delivery ID before
            ...
            ***REMOVED*** Don't fail verification on retry detection errors
    ...
    ***REMOVED*** =========================================================================
    ...
    def _generate_signature(
        ...
        """
        ***REMOVED*** Create signing string: timestamp.payload_json
        payload_json = json.dumps(payload, sort_keys=True, separators=(",", ":"))
        signing_string = f"{timestamp}.{payload_json}"

        ***REMOVED*** Select hash algorithm
        hash_func = {
    ...
    ***REMOVED*** =========================================================================
    ...
    def rotate_webhook_secret(
        ...
        Example:
            ...
            ... )
            >>> metadata["old_secret_valid_until"]  ***REMOVED*** datetime when old secret expires
        """
        import secrets
    ...
    ***REMOVED*** =========================================================================
    ...
    def log_verification_failure(
        ...
        ***REMOVED*** Optional: Send to monitoring/alerting system
        ***REMOVED*** This could trigger alerts for potential security issues
