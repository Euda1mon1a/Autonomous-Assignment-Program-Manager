...
class WebhookService:
    ...
    ***REMOVED*** =========================================================================
    ...
    async def create_webhook(
        ...
        ***REMOVED*** Generate secret if not provided
        if not secret:
    ...
    async def list_webhooks(
        ...
        ***REMOVED*** Note: event_type filtering requires array contains check
        ***REMOVED*** This is PostgreSQL-specific and would need adjustment for other DBs
    ...
    ***REMOVED*** =========================================================================
    ...
    async def trigger_event(
        ...
        Example:
            ...
            ... )
        """
        ***REMOVED*** Find active webhooks subscribed to this event
        result = await db.execute(
            select(Webhook).where(Webhook.status == WebhookStatus.ACTIVE.value)
        )
        webhooks = result.scalars().all()

        ***REMOVED*** Filter webhooks subscribed to this event type
        subscribed_webhooks = [
        ...
        ***REMOVED*** Create delivery records for each webhook
        ...
        ***REMOVED*** If immediate delivery requested, process now
        if immediate:
            for webhook in subscribed_webhooks:
                ***REMOVED*** Get the delivery we just created
                result = await db.execute(
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Dead Letter Queue Management
    ***REMOVED*** =========================================================================
    ...
    async def resolve_dead_letter(
        ...
        ***REMOVED*** Optionally retry the delivery
        if retry:
            ***REMOVED*** Create new delivery attempt
            delivery = WebhookDelivery(
