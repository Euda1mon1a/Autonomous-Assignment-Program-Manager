...
class WebhookDeliveryManager:
    ...
    async def deliver(
        ...
        ***REMOVED*** Update delivery status
    ...
    async def _send_webhook(
        ...
        """
        ***REMOVED*** Generate signature and headers
        ...
        ***REMOVED*** Make request with timeout
    ...
    async def _handle_delivery_failure(
        ...
        Args:
            ...
            webhook: Webhook configuration
        """
        ***REMOVED*** Check if we can retry
        if delivery.can_retry and webhook.retry_enabled:
            ***REMOVED*** Calculate next retry time with exponential backoff
            ...
            ***REMOVED*** Max retries exceeded - move to dead letter queue
    ...
    async def process_pending_deliveries(
        ...
        """
        ***REMOVED*** Find deliveries ready for retry
        result = await db.execute(
