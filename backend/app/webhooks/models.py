...
class WebhookDeliveryStatus(str, enum.Enum):
    ...
    SUCCESS = "success"
    FAILED = "failed"
    DEAD_LETTER = "dead_letter"  ***REMOVED*** Moved to dead letter queue after max retries
...
class Webhook(Base):
    ...
    ***REMOVED*** Endpoint configuration
    url = Column(String(2048), nullable=False)
    name = Column(String(255), nullable=False)
    description = Column(Text, nullable=True)

    ***REMOVED*** Event subscriptions (array of event types)
    ...
    ***REMOVED*** Secret for signature verification (stored encrypted in production)
    ...
    ***REMOVED*** Headers to include in requests (e.g., API keys, custom headers)
...
class WebhookDelivery(Base):
    ...
    ***REMOVED*** Event details
    ...
    event_id = Column(String(255), nullable=True, index=True)  ***REMOVED*** Optional event identifier
...
class WebhookDeadLetter(Base):
    ...
    ***REMOVED*** Original delivery reference
    delivery_id = Column(
        GUID(),
    ...
    ***REMOVED*** Event details (denormalized for quick access)
    event_type = Column(String(100), nullable=False, index=True)
    payload = Column(JSONType, nullable=False)

    ***REMOVED*** Failure details
    total_attempts = Column(Integer, nullable=False)
    last_error_message = Column(Text, nullable=True)
    last_http_status = Column(Integer, nullable=True)

    ***REMOVED*** Resolution tracking
