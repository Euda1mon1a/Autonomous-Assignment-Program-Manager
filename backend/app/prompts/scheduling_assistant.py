...
***REMOVED******REMOVED*** ACGME Compliance Rules (CRITICAL)
...
***REMOVED******REMOVED*** How to Use Tools
...
***REMOVED******REMOVED*** Response Guidelines
...
***REMOVED******REMOVED*** Context Awareness
...
***REMOVED******REMOVED*** What You Should NOT Do
...
def build_rag_prompt(
    ...
    ***REMOVED*** Add task-specific instructions if provided
    if task_prompt:
        parts.append("\n***REMOVED******REMOVED*** CURRENT TASK\n")
        parts.append(task_prompt)

    ***REMOVED*** Inject RAG context
    if context and context.strip():
        parts.append("\n--- RELEVANT CONTEXT ---\n")
        parts.append(context)
        parts.append("\n--- END CONTEXT ---\n")

    ***REMOVED*** Add user query
    parts.append(f"\n***REMOVED******REMOVED*** USER REQUEST\n\n{query}")

    ***REMOVED*** Add instruction to respond
    parts.append(
...
***REMOVED*** =============================================================================
***REMOVED*** ERROR HANDLING PROMPTS
***REMOVED*** =============================================================================
...
class PromptManager:
    ...
    def build_prompt(
        ...
        ***REMOVED*** Build base prompt with RAG context
        ...
        ***REMOVED*** Optionally include few-shot examples
        if include_examples and task_type:
            examples = self._get_relevant_examples(task_type)
            if examples:
                prompt += "\n\n***REMOVED******REMOVED*** EXAMPLES OF SIMILAR QUERIES\n\n"
                prompt += examples
    ...
    def get_error_prompt(
        ...
        **kwargs
        ...
        try:
            ...
            ***REMOVED*** If formatting fails, return template as-is
            return template
    ...
    def _get_relevant_examples(self, task_type: str) -> str:
        ...
        """
        ***REMOVED*** Map task types to example types
        task_to_examples = {
            "swap": ["swap_request"],
