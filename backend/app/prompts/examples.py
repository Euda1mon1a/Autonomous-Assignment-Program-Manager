...
def example_compliance_check():
    ...
    ***REMOVED*** Format schedule data as context
    schedule_data = {
...
def example_few_shot():
    ...
    ***REMOVED*** Build prompt with examples included
    query = "Can I swap my Monday clinic shift?"
    prompt = pm.build_prompt(
        query=query,
        context="Dr. Jones is assigned to Monday clinic...",
        task_type="swap",
        include_examples=True,  ***REMOVED*** Include few-shot examples
    )
...
def example_tool_response():
    ...
    ***REMOVED*** Simulated tool results (JSON)
    tool_results = """{
  "candidates": [
    {
      "id": "person_456",
...
def example_custom_task():
    ...
    ***REMOVED*** Add a custom task type
