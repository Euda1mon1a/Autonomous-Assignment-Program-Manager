...
class IndexRecommendation:
    ...
    table_name: str
    columns: list[str]
    index_type: str  ***REMOVED*** btree, hash, gin, gist
...
class IndexAdvisor:
    ...
    def analyze_and_recommend(
        ...
        ***REMOVED*** Get tables with sequential scans
        ...
        ***REMOVED*** Analyze slow query patterns
    ...
    def find_unused_indexes(
        ...
        try:
            ...
            for row in result:
                ***REMOVED*** Parse size (e.g., "15 MB" -> 15.0)
                size_str = row[3]
    ...
    def _recommend_indexes_for_table(
        ...
        ***REMOVED*** Common patterns for this application
        common_patterns = {
            "assignments": [
        ...
        if table_name in common_patterns:
            for columns, reason in common_patterns[table_name]:
                ***REMOVED*** Check if index already exists
    ...
    def _analyze_slow_query_patterns(self) -> list[IndexRecommendation]:
        ...
        Returns:
            List of index recommendations
        """
        ***REMOVED*** This would require pg_stat_statements extension
        ***REMOVED*** For now, return empty list
        ***REMOVED*** In production, you'd parse query patterns and suggest indexes
        return []
    ...
    def _index_exists(self, table_name: str, columns: list[str]) -> bool:
        ...
        try:
            ***REMOVED*** Build pattern to match column order
            ...
            return True  ***REMOVED*** Assume exists to avoid duplicate recommendations
    ...
    def _parse_size_to_mb(self, size_str: str) -> float:
        ...
        """
        try:
            ***REMOVED*** Extract number and unit
