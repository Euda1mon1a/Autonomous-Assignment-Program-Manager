...
class PoolStatistics:
    ...
    def update_avg_checkout_duration(self, duration: float):
        ...
        ***REMOVED*** Keep only last 100 samples
...
class PoolMonitor:
    ...
    def capture_snapshot(self) -> PoolSnapshot:
        ...
        ***REMOVED*** Parse pool status string
        ***REMOVED*** Example: "Pool size: 10  Connections in pool: 7 Current Overflow: 2 Current Checked out connections: 5"
    ...
    def _extract_metric(self, status: str, key: str) -> int:
        ...
        try:
            if key in status:
                ...
                ***REMOVED*** Find the next space or end of string
    ...
    def get_statistics(self) -> PoolStatistics:
        ...
        """
        with self._lock:
            ***REMOVED*** Return a copy to prevent external modification
    ...
    def get_health_metrics(self) -> Dict[str, any]:
        ...
        ***REMOVED*** Calculate overflow rate
        overflow_rate = (
