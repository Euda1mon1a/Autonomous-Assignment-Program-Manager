...
class ExplainAnalyzer:
    ...
    def _has_node_type(self, plan: dict, node_type: str) -> bool:
        ...
        ***REMOVED*** Recursively check children
    ...
    def _extract_filter_columns(self, filter_str: str) -> list[str]:
        ...
        """
        ***REMOVED*** Simple regex to extract column names
        ***REMOVED*** This is a basic implementation - could be more sophisticated
        pattern = r'\((\w+)\s+[=<>!]'
    ...
    def _generate_recommendations(
        ...
        ***REMOVED*** Sequential scan on large tables
        ...
        ***REMOVED*** Check for nested loops without indexes
        ...
        ***REMOVED*** Check for sorts on large datasets
    ...
    def _has_nested_loop_without_index(self, plan: dict) -> bool:
        ...
        if plan.get("Node Type") == "Nested Loop":
            ***REMOVED*** Check if any child is a sequential scan
            for child in plan.get("Plans", []):
    ...
    def _has_expensive_sort(self, plan: dict) -> bool:
        ...
        if plan.get("Node Type") == "Sort":
            ***REMOVED*** Check if sort is on large dataset
