...
class JobScheduler:
    ...
    def __init__(self):
        ...
        self.scheduler = BackgroundScheduler(
            ...
            job_defaults={
                "coalesce": True,
                "max_instances": 1,
                "misfire_grace_time": 300,  ***REMOVED*** 5 minutes
            },
        )
    ...
    def start(self) -> None:
        ...
        ***REMOVED*** Load jobs from database
        self.load_jobs_from_database()

        ***REMOVED*** Start the scheduler
    ...
    def sync_with_database(self) -> dict[str, int]:
        ...
        try:
            ...
            ***REMOVED*** Get current jobs in scheduler
            scheduler_jobs = {job.id: job for job in self.scheduler.get_jobs()}

            ***REMOVED*** Convert database jobs to dict
    ...
    def add_job(
        ...
        try:
            ...
            ***REMOVED*** Create job in database
    ...
    def _add_job_to_scheduler(self, job: Any) -> None:
        ...
        """
        ***REMOVED*** Get the function to execute
        func = get_job_function(job.job_func)

        ***REMOVED*** Create trigger
        trigger = create_trigger(job.trigger_type, job.trigger_config)

        ***REMOVED*** Wrap function to track execution
    ...
    def _create_wrapped_function(
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                ***REMOVED*** Record execution start
