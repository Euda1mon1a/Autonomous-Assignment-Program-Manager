    ...
    def execute(self) -> Any:
        ...
        for job in self.jobs:
            try:
                ...
                ***REMOVED*** Pass previous result as first argument
...
def scheduled_job(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        ***REMOVED*** Add scheduling metadata
...
***REMOVED*** Example job functions that can be scheduled
...
def cleanup_old_executions(retention_days: int = 90) -> dict[str, Any]:
    ...
    db = SessionLocal()
    try:
        ***REMOVED*** Delete old execution records
        result = (
