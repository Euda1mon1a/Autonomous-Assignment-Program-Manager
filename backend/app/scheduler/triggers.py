...
class CronTriggerConfig(BaseModel):
    ...
    Example:
        >>> ***REMOVED*** Run every day at 3:00 AM
        >>> CronTriggerConfig(hour=3, minute=0)
        >>> ***REMOVED*** Run every Monday at 9:30 AM
        >>> CronTriggerConfig(day_of_week='mon', hour=9, minute=30)
        >>> ***REMOVED*** Run every 15 minutes during business hours
...
class IntervalTriggerConfig(BaseModel):
    ...
    Example:
        >>> ***REMOVED*** Run every 30 minutes
        >>> IntervalTriggerConfig(minutes=30)
        >>> ***REMOVED*** Run every 2 hours starting at noon
        >>> IntervalTriggerConfig(hours=2, start_date=datetime(2024, 1, 1, 12, 0))
        >>> ***REMOVED*** Run every day at the same time
...
class DateTriggerConfig(BaseModel):
    ...
    Example:
        >>> ***REMOVED*** Run once on January 1, 2025 at 10:00 AM UTC
