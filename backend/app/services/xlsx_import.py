...
class ParsedBlockAssignment:
    ...
    slot_am: str | None = None  ***REMOVED*** Value in AM column
    slot_pm: str | None = None  ***REMOVED*** Value in PM column
    row_idx: int = 0
...
class BlockScheduleParser:
    ...
    ***REMOVED*** Known rotation templates
    VALID_TEMPLATES = {
        "R1",
        "R2",
        "R3",  ***REMOVED*** Resident rotations
        "C19",
        "Ca9",
        "CP",  ***REMOVED*** Clinic/faculty
        "TY",
        "PSYCH",
        "IPAP",  ***REMOVED*** Transitional/specialty
    ...
    ***REMOVED*** Known roles
    ...
    def __init__(self, known_people: list[str] | None = None):
        ...
        self._name_cache: dict[
            str, tuple[str, float]
        ] = {}  ***REMOVED*** raw -> (matched, confidence)
