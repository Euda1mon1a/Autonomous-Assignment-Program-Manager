...
class LLMProvider(ABC):
    ...
    async def health_check(self) -> ProviderHealth:
        ...
        """
        try:
            ***REMOVED*** Simple availability check
    ...
    def _record_success(self, latency_ms: float) -> None:
        ...
        ***REMOVED*** Keep only last 100 latencies
...
class OllamaProvider(LLMProvider):
    ...
    async def generate(
        ...
        **kwargs,
        ...
        try:
            ...
            ***REMOVED*** Extract usage if available
            usage = None
    ...
    async def generate_with_tools(
        ...
        **kwargs,
        ...
        start_time = time.time()
        model = model or "mistral"  ***REMOVED*** Mistral has better tool calling support

        try:
            ***REMOVED*** Build messages format for chat endpoint
            messages = []
            if system:
            ...
            ***REMOVED*** Extract message content
            message = data.get("message", {})
            content = message.get("content", "")

            ***REMOVED*** Extract tool calls if present
            tool_calls = None
    ...
    async def stream_generate(
        ...
        **kwargs,
        ...
        try:
            ...
            self._record_success(0)  ***REMOVED*** Success but no latency for streaming
    ...
    def is_available(self) -> bool:
        ...
        if not self._is_available:
            ***REMOVED*** Try to recover after 60 seconds
    ...
    async def generate_with_tools(
        ...
        **kwargs,
        ...
        try:
            ...
            ***REMOVED*** Extract content and tool calls
            content = ""
            tool_calls = []
        ...
        **kwargs,
        ...
        try:
            async with self._client.messages.stream(
                ...
                ***REMOVED*** Final chunk with finish reason
...
class CircuitBreaker:
    ...
    def can_execute(self, provider: str) -> bool:
        ...
        if state.state == "closed":
            ...
            ***REMOVED*** Check if recovery timeout passed
...
class LLMRouter:
    ...
    def __init__(
        ...
        ***REMOVED*** Initialize providers
        self.providers: dict[str, LLMProvider] = {
            "ollama": OllamaProvider(),
        }

        ***REMOVED*** Only add Anthropic if not in airgap mode
        if not airgap_mode:
            self.providers["anthropic"] = AnthropicProvider()

        ***REMOVED*** Fallback chain (local first, then cloud)
    ...
    async def generate(
        ...
        """
        ***REMOVED*** Classify task and select provider
        ...
        ***REMOVED*** Try primary provider
        try:
            ...
            ***REMOVED*** Try fallback chain if enabled
    ...
    async def _generate_with_provider(
        ...
        ***REMOVED*** Check circuit breaker
        ...
        try:
            ***REMOVED*** Choose method based on tools
            if tools:
    ...
    async def _fallback_generate(
        ...
        for provider_name in self.fallback_chain:
            if provider_name == failed_provider:
                continue  ***REMOVED*** Skip the failed provider
    ...
    async def classify_task(
        ...
        ***REMOVED*** Check for privacy-sensitive keywords (always route to local)
        ...
        ***REMOVED*** Check if tools required
        if tools:
            return TaskClassification(
        ...
        ***REMOVED*** Heuristic-based classification
        word_count = len(prompt.split())

        ***REMOVED*** Multi-step reasoning keywords (check before word count)
        multi_step_keywords = [
            "analyze",
            "compare",
            "evaluate",
        ...
        ***REMOVED*** Code generation (check before word count)
        ...
        ***REMOVED*** Simple query (< 20 words, no specific keywords detected)
        if word_count < 20:
            return TaskClassification(
        ...
        ***REMOVED*** Default: explanation/medium complexity
        return TaskClassification(
