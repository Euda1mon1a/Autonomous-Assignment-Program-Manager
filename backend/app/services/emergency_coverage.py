...
class EmergencyCoverageService:
    ...
    ***REMOVED*** Critical services that must be covered
    ...
    async def handle_emergency_absence(
        ...
        ***REMOVED*** Find affected assignments
        ...
        for assignment in affected:
            ...
            ***REMOVED*** Find replacement
            ...
            if replacement:
                ***REMOVED*** Update assignment with new person
                ...
                if is_critical:
                    ***REMOVED*** Critical gap - needs manual attention
                    ...
                    ***REMOVED*** Non-critical - can be cancelled
    ...
    async def _find_replacement(self, assignment: Assignment) -> Person | None:
        ...
        ***REMOVED*** Get current person's details
        current_person = (
            self.db.query(Person).filter(Person.id == assignment.person_id).first()
        )

        ***REMOVED*** Find candidates (same type as current person)
        candidates = (
        ...
        ***REMOVED*** Filter out those already assigned to this block
        assigned_to_block = (
        ...
        ***REMOVED*** Filter out those with absences on this date
        absences_on_date = (
        ...
        ***REMOVED*** Return first available
        return candidates[0]
