...
class CSVExporter:
    ...
    async def export_assignments(
        ...
        while True:
            ...
            ***REMOVED*** Write header on first batch
            if writer is None:
                if rows:
    ...
    async def export_schedule(
        ...
        while True:
            ...
            ***REMOVED*** Format as flat rows
            rows = [format_schedule_row(a, flat=True) for a in assignments]

            ***REMOVED*** Filter fields if specified
            if fields:
                rows = [
    ...
    async def export_analytics(
        ...
        ***REMOVED*** Get all unique field names from all metrics
        fieldnames = set()
    ...
    async def stream_export(
        ...
        ***REMOVED*** In production, you might want to yield smaller chunks
