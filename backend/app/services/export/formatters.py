...
def format_schedule_row(
    ...
    ***REMOVED*** Flatten all related data into single row
    data = {
...
def sanitize_for_export(value: Any) -> Any:
    ...
    Returns:
        Sanitized value
    """
    ***REMOVED*** Convert common non-serializable types
