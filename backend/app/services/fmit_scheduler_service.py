...
class FMITWeekAssignment:
    ...
    is_complete: bool = False  ***REMOVED*** All blocks for the week assigned
...
class FacultyLoadResult:
    ...
    average_load: float  ***REMOVED*** Weeks per year
    is_balanced: bool  ***REMOVED*** Within 1 week of average
...
class FMITSchedulerService:
    ...
    ***REMOVED*** Constants
    BLOCKS_PER_WEEK = 14  ***REMOVED*** 7 days × 2 blocks (AM/PM)
    ...
    def get_fmit_schedule(
        ...
        ***REMOVED*** Get FMIT rotation template
        ...
        ***REMOVED*** Query all FMIT assignments in range
        assignments = (
        ...
        ***REMOVED*** Group assignments by faculty and week
        ...
        ***REMOVED*** Build FMITWeekAssignment objects
        week_assignments = []
        faculty_ids = set()
    ...
    def assign_faculty_to_week(
        ...
        ***REMOVED*** Validate faculty exists
        faculty = (
        ...
        ***REMOVED*** Get week boundaries
        week_start = self._get_week_start(week_date)
        week_end = week_start + timedelta(days=6)

        ***REMOVED*** Get or create all blocks for the week
        ...
        ***REMOVED*** Create assignments for all blocks
        assignment_ids = []
        warnings = []

        for block in blocks:
            ***REMOVED*** Check for conflicts with this block
            existing_assignment = (
                self.db.query(Assignment)
                .filter(
    ...
    def remove_faculty_from_week(
        ...
        ***REMOVED*** Find and delete assignments
        assignments = (
            self.db.query(Assignment)
            .join(Block, Assignment.block_id == Block.id)
            .filter(
    ...
    def get_faculty_load(
        ...
        ***REMOVED*** Define year boundaries
        year_start = date(year, 1, 1)
        year_end = date(year, 12, 31)

        ***REMOVED*** Get all FMIT assignments for this faculty in the year
        assignments = (
            self.db.query(Assignment)
            .join(Block, Assignment.block_id == Block.id)
            .filter(
        ...
        ***REMOVED*** Calculate average load across all faculty
        average_load = self._calculate_average_fmit_load(year)

        ***REMOVED*** Check if balanced (within 1 week of average)
    ...
    def generate_fair_schedule(
        ...
        ***REMOVED*** Calculate weeks in year (52 weeks)
        year_start = date(year, 1, 1)
        year_end = date(year, 12, 31)
        total_weeks = 52

        ***REMOVED*** Calculate fair distribution
        total_weeks / len(faculty)

        ***REMOVED*** Get existing loads
        faculty_loads = {}
        for f in faculty:
        ...
        ***REMOVED*** Generate week by week
        ...
        while current_week <= year_end:
            ...
            ***REMOVED*** Assign to faculty with lowest load
    ...
    def validate_schedule(
        ...
        ***REMOVED*** Check for coverage gaps
        ...
        ***REMOVED*** Check for back-to-back assignments
        ...
        for faculty_id, weeks in faculty_weeks.items():
            ...
            for i in range(len(sorted_weeks) - 1):
                ...
                if gap_days <= 14:  ***REMOVED*** Less than 2 weeks apart
    ...
    ***REMOVED*** Private helper methods
    ...
    def _get_or_create_blocks(
        ...
        while current_date <= end_date:
            for time_of_day in ["AM", "PM"]:
                ***REMOVED*** Try to get existing block
                block = (
                    self.db.query(Block)
                    .filter(
                ...
                ***REMOVED*** Create if doesn't exist
                if not block:
                    block = Block(
                        date=current_date,
                        time_of_day=time_of_day,
                        block_number=1,  ***REMOVED*** Default block number
    ...
    def _get_eligible_faculty_for_week(
        ...
        for person in faculty:
            ...
            ***REMOVED*** Check for back-to-back assignments
            ***REMOVED*** Get assignments from 2 weeks before to 2 weeks after
            ...
            ***REMOVED*** Check if any existing week is too close
