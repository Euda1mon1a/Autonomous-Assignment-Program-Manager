...
try:
    ...
    SentenceTransformer = None  ***REMOVED*** type: ignore
...
class EmbeddingService:
    ...
    _model: Optional[object] = None  ***REMOVED*** SentenceTransformer | None
    ...
    def get_model(cls):  ***REMOVED*** type: ignore
        ...
        if cls._model is None:
            cls._model = SentenceTransformer(cls.MODEL_NAME)  ***REMOVED*** type: ignore
        return cls._model
