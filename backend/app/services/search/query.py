...
class QueryBuilder:
    ...
    def everywhere(self) -> "QueryBuilder":
        ...
        return self.in_entities(
            ["person", "rotation", "procedure", "assignment", "swap"]
        )
    ...
    @classmethod
    def quick_search(
        cls, query_string: str, entity_type: str = "person"
    ) -> SearchQuery:
        """
        ...
        Returns:
            SearchQuery instance
        """
        return cls().search(query_string).in_entities([entity_type]).build()
