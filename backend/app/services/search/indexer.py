...
class SearchIndexer:
    ...
    def __init__(
        ...
        ***REMOVED*** Specialized analyzers for different entity types
        self.analyzers = {
    ...
    async def search(
        ...
        """
        ***REMOVED*** Execute search via backend
        ...
        ***REMOVED*** Calculate pagination metadata
    ...
    async def get_facets(
        ...
        results = await self.backend.search(
            ...
            filters={},
            limit=0,  ***REMOVED*** Don't need actual results
            offset=0,
        )
