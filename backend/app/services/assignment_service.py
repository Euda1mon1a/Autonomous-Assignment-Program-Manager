...
class AssignmentService:
    ...
    def create_assignment(
        ...
        activity_type: str | None = None,
        notes: str | None = None,
        ***REMOVED*** Freeze horizon override parameters
        ...
        """
        ***REMOVED*** Get block to check freeze horizon
        ...
        ***REMOVED*** Update audit record with assignment ID if freeze was overridden
        ...
        ***REMOVED*** Add override note if provided
        ...
        ***REMOVED*** Invalidate schedule cache after assignment creation
        try:
    ...
    def update_assignment(
        ...
        ***REMOVED*** Get block for freeze horizon check
        ...
        ***REMOVED*** Optimistic locking check
        ...
        ***REMOVED*** Invalidate schedule cache after assignment update
        try:
            invalidate_schedule_cache()
    ...
    def delete_assignment(
        ...
        ***REMOVED*** Invalidate schedule cache after assignment deletion
        try:
            invalidate_schedule_cache()
    ...
    def delete_assignments_bulk(
        ...
        ***REMOVED*** Any overlap with freeze horizon?
        ...
        if has_frozen_assignments and settings.freeze_scope != "none":
            ...
            ***REMOVED*** Use earliest affected date for freeze check
        ...
        ***REMOVED*** Invalidate schedule cache after bulk deletion
        if deleted_count > 0:
            try:
                invalidate_schedule_cache()
                logger.debug(
    ...
    def _validate_acgme(
        ...
        ***REMOVED*** Validate a window around the assignment date (+/- 4 weeks)
        ...
        ***REMOVED*** Filter violations related to this person
