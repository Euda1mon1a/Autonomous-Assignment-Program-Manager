...
class UserRole(str, Enum):
    ...
    FACULTY = "faculty"
    CLINICAL_STAFF = "clinical_staff"  ***REMOVED*** Unified role for rn, lpn, msa
...
class RoleFilterService:
    ...
    ***REMOVED*** Define role permissions mapping
    ...
    def can_access(cls, resource: ResourceType, role: str | UserRole) -> bool:
        ...
        """
        ***REMOVED*** Convert string to UserRole if needed
        ...
        ***REMOVED*** Normalize clinical staff roles
        role = cls.normalize_clinical_staff_role(role)

        ***REMOVED*** Get permissions for role
    ...
    def filter_for_role(
        ...
        ***REMOVED*** Filter academic blocks
    ...
    def filter_schedule_list(
        ...
        ***REMOVED*** Admin and coordinators see everything
        if role in (UserRole.ADMIN, UserRole.COORDINATOR):
            schedules_filtered = schedules
        ***REMOVED*** Clinical staff sees only today's manifest
    ...
    def can_access_endpoint(
        ...
        ***REMOVED*** Map endpoint categories to resource types
        category_map = {
    ...
    def get_role_description(cls, role: str | UserRole) -> Dict[str, Any]:
        ...
        ***REMOVED*** Role descriptions based on PROJECT_STATUS_ASSESSMENT.md
        descriptions = {
            UserRole.ADMIN: {
                "role": "admin",
                "title": "Administrator",
