...
class BatchValidator:
    ...
    def validate_create_batch(
        ...
        ***REMOVED*** Validate ACGME compliance if requested
        acgme_warnings = []
    ...
    def validate_update_batch(
        ...
        ***REMOVED*** Check for duplicate assignment IDs in batch
        seen_ids = set()
        for idx, assignment in enumerate(assignments):
        ...
        ***REMOVED*** Validate ACGME compliance if requested (skip for now as updates are complex)
        acgme_warnings = []
    ...
    def validate_delete_batch(
        ...
        ***REMOVED*** Validate each assignment exists
        for idx, assignment in enumerate(assignments):
    ...
    def _validate_single_create(
        ...
        ***REMOVED*** Check if assignment already exists
    ...
    def _validate_single_update(
        ...
        ***REMOVED*** Check if assignment exists
    ...
    def _validate_acgme_batch(
        ...
        ***REMOVED*** Expand window for rolling average validation
