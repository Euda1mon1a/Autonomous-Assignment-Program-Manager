...
class WorkflowService:
    ...
    ***REMOVED*** ========================================================================
    ...
    def list_templates(
        ...
        if active_only:
            query = query.filter(WorkflowTemplate.is_active == True)  ***REMOVED*** noqa: E712

        if tags:
            ***REMOVED*** Filter templates that have any of the specified tags
    ...
    ***REMOVED*** ========================================================================
    ...
    def start_workflow(
        ...
        """
        ***REMOVED*** Get latest version of template
        ...
        try:
            ...
            ***REMOVED*** Start execution
            ...
            if async_execution:
                ...
                ***REMOVED*** Execute synchronously (blocking)
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Common Workflow Templates
    ***REMOVED*** ========================================================================
    ...
    def create_schedule_generation_workflow(
        ...
        definition = {
            ...
            "default_timeout_seconds": 1800,  ***REMOVED*** 30 minutes
        }
