...
class CachedHeatmapService:
    ...
    def _build_heatmap_cache_key(
        ...
        ***REMOVED*** Use hash of all IDs to ensure unique cache keys for different ID sets
        ***REMOVED*** This prevents cache collisions when more than 5 IDs are provided
        if person_ids:
    ...
    def generate_unified_heatmap_with_time_range(
        ...
        ***REMOVED*** Use the cached unified heatmap method
    ...
    def generate_coverage_heatmap(
        ...
        ***REMOVED*** Generate coverage heatmap
    ...
    def generate_person_workload_heatmap(
        ...
        """
        ***REMOVED*** Build cache key with hash of all person IDs (not truncated)
        person_hash = _hash_id_list(person_ids)
        cache_key = (
        ...
        ***REMOVED*** Generate workload heatmap
    ...
    ***REMOVED*** Delegate non-cached methods to underlying service
    @staticmethod
...
class CachedCalendarService:
    ...
    ***REMOVED*** Delegate non-cached methods to CalendarService
    @staticmethod
