...
class ResponseResult:
    ...
    success: bool
    message: str = ""
    new_request_id: Optional[UUID] = None  ***REMOVED*** For counter-offers
    executed: bool = False
    errors: List[ValidationError] = field(default_factory=list)
...
class SwapRequestService:
    ...
    ***REMOVED*** Helper methods
    ...
    def _is_week_assigned_to_faculty(self, faculty_id: UUID, week_start: date) -> bool:
        ...
        ***REMOVED*** Look for FMIT assignments in the week
        ...
        assignment = self.db.query(Assignment).join(Block).filter(
            ...
            ***REMOVED*** Assuming FMIT rotation has specific identifier
            ***REMOVED*** This might need adjustment based on actual data model
        ).first()

        ***REMOVED*** For now, return True as placeholder
