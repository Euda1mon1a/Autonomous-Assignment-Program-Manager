...
Usage:
    ...
    ***REMOVED*** Start scheduler on app startup
    scheduler = CertificationScheduler()
    scheduler.start()

    ***REMOVED*** Stop on shutdown
    scheduler.stop()
...
***REMOVED*** Reminder thresholds in days
...
class CertificationScheduler:
    ...
    def start(self) -> None:
        ...
        try:
            ...
            ***REMOVED*** Daily certification check at configured hour
    ...
    def run_daily_check(self) -> None:
        ...
        try:
            ...
            ***REMOVED*** 3. Send compliance summary to admin
            if self.admin_email:
    ...
    def _send_reminders_for_threshold(
        ...
        for cert in certs_needing_reminder:
            ***REMOVED*** Check if this cert type has this reminder enabled
    ...
    def run_now(self, db: Session | None = None) -> None:
        ...
        Example:
            ...
            >>> scheduler.run_now()  ***REMOVED*** Trigger check immediately
        """
        if db is None:
            db = SessionLocal()
            close_db = True
