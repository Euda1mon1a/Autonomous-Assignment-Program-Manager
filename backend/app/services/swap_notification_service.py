...
"""
    ...
    def _should_notify(self, faculty_id: UUID, preference_key: str) -> bool:
        ...
        if not prefs:
            return True  ***REMOVED*** Default to notify
...
"""
    ...
    def _send_notification(self, notification: SwapNotification) -> bool:
        ...
        try:
            ***REMOVED*** Convert plain text body to simple HTML
            body_html = f"""
            <!DOCTYPE html>
            <html>
            <head>
                <style>
                    ...
                    .content {{ padding: 20px; background-color: ***REMOVED***f9f9f9; white-space: pre-wrap; }}
