...
class CertificationService:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Certification Type Operations
    ***REMOVED*** ========================================================================
    ...
    def create_certification_type(
        ...
        ***REMOVED*** Check for duplicate name
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Person Certification Operations
    ***REMOVED*** ========================================================================
    ...
    def create_person_certification(
        ...
        ***REMOVED*** Validate certification type exists
        ...
        ***REMOVED*** Check for existing (update instead of duplicate)
    ...
    def update_person_certification(self, cert_id: UUID, update_data: dict) -> dict:
        ...
        ***REMOVED*** Recalculate status if expiration date changes
    ...
    def renew_certification(
        ...
        update_data = {
            ...
            "status": "current",
            ***REMOVED*** Reset reminder tracking
