...
class DatabaseLeaveProvider(LeaveProvider):
    ...
    def get_all_leave(self, start_date: date | None = None, end_date: date | None = None) -> list[LeaveRecord]:
        ...
        ***REMOVED*** OPTIMIZATION: Use joinedload to eagerly load the person relationship
        ***REMOVED*** This prevents N+1 queries when accessing a.person.name in the list comprehension
        absences = (
