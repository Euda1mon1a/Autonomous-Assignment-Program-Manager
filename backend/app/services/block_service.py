...
class BlockService:
    ...
    def create_block(
        ...
        ***REMOVED*** Calculate is_weekend if not provided
    ...
    def generate_blocks(
        ...
        """
        block_duration_days = 28  ***REMOVED*** Block number changes every 4 weeks
        blocks_created = []
        current_date = start_date

        while current_date <= end_date:
            for time_of_day in ["AM", "PM"]:
                ***REMOVED*** Skip if block already exists
