...
***REMOVED*** =============================================================================
***REMOVED*** Base Types (compatible with scheduling.constraints.base)
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Validator Protocol (interface compatibility)
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** ACGME Constraint Implementations
***REMOVED*** =============================================================================
    ...
    def add_to_cpsat(self, model, variables: dict, context: SchedulingContext) -> None:
        ...
        ***REMOVED*** For each possible 28-day window starting point
        for window_start in dates:
            ...
            ***REMOVED*** Get all blocks in this strict 28-day window
            window_blocks = [
    ...
    def validate(
        ...
        ***REMOVED*** Group assignments by resident
        ...
        for resident in context.residents:
            ...
            ***REMOVED*** Get hours per date for this resident
            ...
            ***REMOVED*** Check EVERY possible 28-day window (strict rolling average)
            for start_date in sorted_dates:
                ...
                if avg_weekly > self.MAX_WEEKLY_HOURS:
                    ...
                    ***REMOVED*** Report first violation per resident for efficiency
                    break
