...
class ImpactEstimate:
    ...
    workload_balance_score: float  ***REMOVED*** 0-1, higher is better
    feasibility_score: float  ***REMOVED*** 0-1, higher is better
    recommendation: str  ***REMOVED*** human-readable recommendation
...
class ResolutionHistory:
    ...
    options_attempted: list[str]  ***REMOVED*** option IDs
...
class ConflictAlertService:
    ...
    def create_alert(
        ...
        """
        ***REMOVED*** Check for existing similar alert
        ...
        if existing:
            ***REMOVED*** Update existing alert instead of creating duplicate
    ...
    ***REMOVED*** ==================== AUTO-RESOLUTION METHODS ====================
    ...
    def generate_resolution_options(
        ...
        ***REMOVED*** Generate options based on conflict type
        ...
        ***REMOVED*** Estimate impact for each option
        for option in options:
            option.impact = self.estimate_resolution_impact(option)

        ***REMOVED*** Sort by feasibility (highest first)
    ...
    def apply_auto_resolution(
        ...
        ***REMOVED*** Generate options to find the requested one
        ...
        ***REMOVED*** Validate the resolution
        ...
        ***REMOVED*** Apply the resolution based on strategy
        try:
            ...
            if success:
                ***REMOVED*** Mark alert as resolved
                alert.status = ConflictAlertStatus.RESOLVED
                alert.resolved_at = datetime.utcnow()
                alert.resolved_by_id = user_id
    ...
    def validate_resolution(
        ...
        ***REMOVED*** Check alert is still unresolved
        if alert.status not in [ConflictAlertStatus.NEW, ConflictAlertStatus.ACKNOWLEDGED]:
            return False, f"Alert already {alert.status}"

        ***REMOVED*** Validate based on strategy
    ...
    def estimate_resolution_impact(
        ...
        """
        ***REMOVED*** Base impact depends on strategy
        if resolution.strategy == ResolutionStrategy.SWAP_ASSIGNMENT:
        ...
        ***REMOVED*** Default low-impact estimate
    ...
    def get_resolution_history(
        ...
        """
        ***REMOVED*** In a full implementation, this would query a resolution_history table
        ***REMOVED*** For now, we return None as history is not persisted
        return None
    ...
    ***REMOVED*** ==================== PRIVATE HELPER METHODS ====================
    ...
    def _generate_leave_overlap_options(
        ...
        ***REMOVED*** Option 1: Swap with another faculty for this week
        available_faculty = self._find_available_faculty_for_week(alert.fmit_week, alert.faculty_id)
        for faculty in available_faculty[:3]:  ***REMOVED*** Top 3 candidates
        ...
        ***REMOVED*** Option 2: Find backup coverage from pool
        ...
        ***REMOVED*** Option 3: Request coverage from volunteer pool
        options.append(ResolutionOption(
    ...
    def _generate_back_to_back_options(
        ...
        ***REMOVED*** Option 1: Swap one of the weeks with another faculty
        options.append(ResolutionOption(
        ...
        ***REMOVED*** Option 2: Adjust time boundaries if possible
        options.append(ResolutionOption(
    ...
    def _generate_workload_balance_options(
        ...
        ***REMOVED*** Option: Redistribute assignments
        options.append(ResolutionOption(
    ...
    def _generate_external_commitment_options(
        ...
        ***REMOVED*** Primary option: Find coverage
        options.append(ResolutionOption(
    ...
    def _validate_time_adjustment(
        ...
        ***REMOVED*** Time adjustments are generally safe but low impact
    ...
    def _validate_backup_reassignment(
        ...
        ***REMOVED*** Check if backup pool has capacity
    ...
    def _validate_coverage_request(
        ...
        ***REMOVED*** Coverage requests are always valid but may not be filled
    ...
    def _apply_swap_resolution(
        ...
        if not target_faculty_id:
            ***REMOVED*** Auto-find best candidate
        ...
        ***REMOVED*** Create swap record
        swap = SwapRecord(
            ...
            target_week=None,  ***REMOVED*** Absorb type
    ...
    def _apply_time_adjustment(
        ...
        ***REMOVED*** This would adjust assignment time boundaries
        ***REMOVED*** For now, just note it in the resolution
    ...
    def _apply_backup_reassignment(
        ...
        ***REMOVED*** This would create assignments for backup personnel
        ***REMOVED*** For now, just note it
    ...
    def _apply_coverage_request(
        ...
        ***REMOVED*** This would create a coverage request notification
        ***REMOVED*** For now, just note it
    ...
    def _estimate_swap_impact(
        ...
        ***REMOVED*** Swaps typically affect 2 faculty members
        return ImpactEstimate(
            affected_faculty_count=2,
            affected_weeks_count=1,
            new_conflicts_created=0,  ***REMOVED*** Would need to check for cascading conflicts
    ...
    def _estimate_backup_impact(
        ...
        return ImpactEstimate(
            affected_faculty_count=2,  ***REMOVED*** Original + backup
            affected_weeks_count=1,
            new_conflicts_created=0,
    ...
    def _estimate_coverage_pool_impact(
        ...
        return ImpactEstimate(
            affected_faculty_count=1,  ***REMOVED*** Plus volunteer
            affected_weeks_count=1,
            new_conflicts_created=0,
            workload_balance_score=0.65,
            feasibility_score=0.5,  ***REMOVED*** Depends on volunteer availability
    ...
    def _find_available_faculty_for_week(
        ...
        ***REMOVED*** OPTIMIZATION: Get all faculty members
        all_faculty = self.db.query(Person).filter(
            Person.type == "faculty",
            Person.id != exclude_faculty_id,
        ).all()

        ***REMOVED*** OPTIMIZATION: Batch query for conflicts and assignments to avoid N+1
        faculty_ids = [f.id for f in all_faculty]

        ***REMOVED*** Get all conflict alerts for these faculty for this week
        ...
        ***REMOVED*** Get all faculty with assignments in this week
        ...
        ***REMOVED*** Filter to available faculty
        available = [
    ...
    def _check_backup_pool_availability(
        ...
        """
        ***REMOVED*** In a real implementation, this would check:
        ***REMOVED*** - Backup roster
        ***REMOVED*** - Current backup assignments
        ***REMOVED*** - Backup personnel certifications
        ***REMOVED*** For now, return True to allow the option
        return True
