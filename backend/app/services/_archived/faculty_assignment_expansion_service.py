"""
DEPRECATED: Faculty Assignment Expansion Service.

Archived 2026-02-03. This service created template half-day slots before the solver.
With half_day_assignments as canonical, faculty slots are now created by:
  1) FacultyOutpatientAssignmentService (clinic + supervision)
  2) SchedulingEngine._ensure_faculty_half_day_slots (fills remaining OFF slots)

This file remains only for reference and should not be imported by live code.
