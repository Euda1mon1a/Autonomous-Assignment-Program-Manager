...
class BlastRadiusAnalysisResult:
    ...
    ***REMOVED*** Borrowing status
    active_borrowing_requests: int
    pending_borrowing_requests: int

    ***REMOVED*** Zone details
    zone_details: list[dict] = field(default_factory=list)

    ***REMOVED*** Recommendations
    recommendations: list[str] = field(default_factory=list)

    ***REMOVED*** Severity assessment
    severity: str = "healthy"  ***REMOVED*** healthy, warning, degraded, critical
...
class IncidentRecordResult:
    ...
    message: str = ""
    error_code: str | None = None
    ***REMOVED*** FIX: Added started_at field to provide timestamp to API response
...
class BlastRadiusService:
    ...
    def __init__(
        ...
        ***REMOVED*** Initialize the blast radius manager
        self._manager = BlastRadiusManager()

        ***REMOVED*** Apply configuration
    ...
    def calculate_blast_radius(
        ...
        try:
            ***REMOVED*** Get the full report from the manager
            report = self._manager.check_all_zones()

            ***REMOVED*** Convert zone reports to detail dicts
            zone_details = []
    ...
    def create_zone(
        ...
        """
        try:
            ***REMOVED*** Map string zone type to enum
            type_map = {
    ...
    def record_incident(
        ...
        try:
            ...
            ***REMOVED*** Check if containment was activated
            ...
            ***REMOVED*** FIX: Return started_at and capacity_lost from the incident
            return IncidentRecordResult(
                success=True,
