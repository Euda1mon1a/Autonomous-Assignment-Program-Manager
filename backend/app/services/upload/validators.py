...
class FileValidator:
    ...
    ***REMOVED*** Default file type configurations
    ALLOWED_IMAGE_TYPES = {
        "image/jpeg",
        "image/png",
        "image/gif",
    ...
    ***REMOVED*** Magic byte signatures for common file types
    MAGIC_SIGNATURES = {
        "image/jpeg": [b"\xFF\xD8\xFF"],
        "image/png": [b"\x89PNG\r\n\x1a\n"],
        "image/gif": [b"GIF87a", b"GIF89a"],
        "application/pdf": [b"%PDF"],
        "application/zip": [b"PK\x03\x04", b"PK\x05\x06"],  ***REMOVED*** DOCX, XLSX are ZIP archives
    }
    ...
    def validate_file(
        ...
        ***REMOVED*** Validate extension matches MIME type
        ...
        ***REMOVED*** Check expected MIME type if provided
    ...
    def _detect_mime_type(self, file_content: bytes) -> str:
        ...
        try:
            ...
            ***REMOVED*** Fallback to basic detection
    ...
    def _verify_magic_bytes(self, file_content: bytes, mime_type: str) -> bool:
        ...
        """
        ***REMOVED*** Special handling for Office documents (ZIP-based)
        if mime_type in {
            "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
            "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        }:
            ***REMOVED*** These are ZIP archives
        ...
        if not signatures:
            ***REMOVED*** No signature defined for this type
            return True
    ...
    def _sanitize_filename(self, filename: str) -> str:
        ...
        ***REMOVED*** Remove dangerous characters - only allow alphanumeric, dots, underscores, hyphens
    ...
    def _scan_for_viruses(
        ...
        ***REMOVED*** Example integration points:
        ***REMOVED*** 1. ClamAV: Use pyclamd library
        ***REMOVED*** 2. VirusTotal: Use virustotal-python library
        ***REMOVED*** 3. Cloud scanner: AWS S3 + Lambda with scanner
