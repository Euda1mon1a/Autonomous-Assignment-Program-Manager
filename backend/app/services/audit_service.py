...
Usage:
    ...
    ***REMOVED*** Query audit logs with filters
...
***REMOVED*** Map entity types to their model classes
ENTITY_MODEL_MAP = {
...
***REMOVED*** Map entity types to version table names
VERSION_TABLE_MAP = {
...
def _validate_and_quote_table_name(table_name: str) -> str:
    ...
    """
    ***REMOVED*** Validate against allowlist
    if table_name not in VERSION_TABLE_MAP.values():
        raise ValueError(f"Invalid table name: {table_name}")

    ***REMOVED*** Return quoted identifier (PostgreSQL uses double quotes)
    ***REMOVED*** This prevents SQL injection even if allowlist is bypassed
    return f'"{table_name}"'
...
def get_audit_logs(
    ...
    """
    try:
        ***REMOVED*** Determine which tables to query
        tables_to_query = (
        ...
        ***REMOVED*** Query each version table
...
def _query_version_table(
    ...
    ***REMOVED*** Validate and quote table name to prevent SQL injection
...
def _get_audit_user(db: Session, user_id: str | None) -> AuditUser:
    ...
    try:
        ***REMOVED*** Try to parse as UUID
        try:
            user_uuid = UUID(user_id)
            user = db.query(User).filter(User.id == user_uuid).first()
        except (ValueError, AttributeError):
            ***REMOVED*** Not a valid UUID, try username
    ...
    ***REMOVED*** Fallback for unknown user
    return AuditUser(
        id=user_id,
...
def _get_field_changes(
    ...
    try:
        ...
        ***REMOVED*** Get the version class
        VersionClass = version_class(model_class)

        ***REMOVED*** Get current and previous versions
        current_version = (
        ...
        ***REMOVED*** Get previous version
        ...
        if not previous_version:
            ***REMOVED*** This is the first version (create), no changes to show
            return None
        ...
        for column in current_version.__table__.columns:
            ...
            ***REMOVED*** Skip internal columns
            ...
            if old_value != new_value:
                ***REMOVED*** Convert to string for display
...
def _determine_severity(entity_type: str, action: str, operation_type: int) -> str:
    ...
    ***REMOVED*** Delete operations are warnings
    if operation_type == 2:
        return "warning"
...
def _format_field_name(field_name: str) -> str:
    ...
    ***REMOVED*** Convert snake_case to Title Case
...
def get_audit_users(db: Session) -> list[AuditUser]:
    ...
    try:
        ***REMOVED*** Query transaction table for unique users
        query = text(
            """
...
def get_audit_statistics(
    ...
    """
    try:
        ***REMOVED*** Get all entries for date range
...
***REMOVED*** =============================================================================
***REMOVED*** Pydantic Models for Test Compatibility
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** AuditService Class Wrapper
***REMOVED*** =============================================================================
...
class AuditService:
    ...
    ***REMOVED*** =========================================================================
    ...
    def query_audit_logs(
        ...
        ***REMOVED*** Convert to AuditLogEntry models
        items = [
            AuditLogEntry(
                id=entry.get("id", 0),
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Static Methods (backward compatibility)
    ***REMOVED*** =========================================================================
    ...
    def get_recent_changes(
        ...
        ***REMOVED*** Convert to expected format
        return [
            {
