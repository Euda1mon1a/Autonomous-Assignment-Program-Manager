...
class ComplianceReportTemplate:
    ...
    def generate(self, request: ComplianceReportRequest) -> bytes:
        ...
        ***REMOVED*** Compliance status overview
        elements.append(
        ...
        ***REMOVED*** Detailed violations by resident
    ...
    def _create_status_section(self, validation_result: Any) -> list:
        ...
        ***REMOVED*** Status indicator
        if validation_result.valid:
            status_text = '<font color="***REMOVED***28a745" size=12><b>✓ COMPLIANT</b></font>'
            status_desc = "All ACGME requirements are met for this period."
        else:
            status_text = '<font color="***REMOVED***dc3545" size=12><b>✗ NON-COMPLIANT</b></font>'
            status_desc = (
    ...
    def _create_violations_summary(self, violations: list) -> list:
        ...
        ***REMOVED*** Count violations by type and severity
        ...
        ***REMOVED*** Violations by type table
        elements.append(
        ...
        ***REMOVED*** Violations by severity table
        elements.append(
            Paragraph(
        ...
        ***REMOVED*** Color-code severity rows
        severity_colors = {
            "CRITICAL": colors.HexColor("***REMOVED***dc3545"),
            "HIGH": colors.HexColor("***REMOVED***fd7e14"),
            "MEDIUM": colors.HexColor("***REMOVED***ffc107"),
            "LOW": colors.HexColor("***REMOVED***17a2b8"),
        }
    ...
    def _create_detailed_violations(
        ...
        ***REMOVED*** Group violations by person
        ...
        ***REMOVED*** Create section for each resident with violations
        ...
        ***REMOVED*** Handle violations without person_id
