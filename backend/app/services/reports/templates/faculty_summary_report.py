...
class FacultySummaryReportTemplate:
    ...
    def generate(self, request: FacultySummaryReportRequest) -> bytes:
        ...
        ***REMOVED*** If no faculty IDs specified, get all faculty
        ...
        ***REMOVED*** Generate report for each faculty member
    ...
    def _get_faculty_data(
        ...
        ***REMOVED*** Calculate rotation breakdown
        rotation_breakdown = {}
        ...
        ***REMOVED*** Calculate total blocks (half-days)
        total_blocks = len(assignment_list)
        total_weeks = total_blocks / 10  ***REMOVED*** Assuming 10 blocks (5 days) per week
    ...
    def _create_swap_history(self, faculty_data: dict[str, Any]) -> list:
        ...
        ***REMOVED*** Create swap summary table
        data = [
            ["Swap Type", "Count"],
