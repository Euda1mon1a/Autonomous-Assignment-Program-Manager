...
class PDFReportGenerator:
    ...
    ***REMOVED*** Color scheme
    PRIMARY_COLOR = colors.HexColor("***REMOVED***1f3a93")  ***REMOVED*** Navy blue
    SECONDARY_COLOR = colors.HexColor("***REMOVED***2e5090")
    ACCENT_COLOR = colors.HexColor("***REMOVED***4a90e2")  ***REMOVED*** Light blue
    TEXT_COLOR = colors.HexColor("***REMOVED***333333")
    LIGHT_GRAY = colors.HexColor("***REMOVED***f5f5f5")
    MEDIUM_GRAY = colors.HexColor("***REMOVED***cccccc")
    ...
    def _setup_custom_styles(self) -> None:
        ...
        ***REMOVED*** Subsection header style
        self.styles.add(
            ParagraphStyle(
    ...
    def _add_header(
        ...
        ***REMOVED*** Optionally add logo (placeholder for now)
        if include_logo:
            ***REMOVED*** Logo would be drawn here
            ***REMOVED*** For now, just add organization name
    ...
    def _add_footer(
        ...
        ***REMOVED*** Add generation timestamp
        canvas_obj.setFont("Helvetica", 8)
        canvas_obj.drawString(
            self.MARGIN_LEFT,
            self.MARGIN_BOTTOM - 0.4 * inch,
    ...
    def generate_pdf(
        ...
        ***REMOVED*** Define page template with header/footer
    ...
    def create_metadata(
        ...
        """
        ***REMOVED*** Estimate page count if not provided
        if page_count is None:
            ***REMOVED*** Rough estimate: ~3KB per page
