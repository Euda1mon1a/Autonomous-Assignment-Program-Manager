...
class CallAssignmentService:
    ...
    async def get_call_assignments(
        ...
        ***REMOVED*** Apply pagination and execute
    ...
    async def create_call_assignment(
        ...
        ***REMOVED*** Check for duplicate (same person, date, and call_type)
        ...
        ***REMOVED*** Create the call assignment
    ...
    async def update_call_assignment(
        ...
        *,
        ...
        """
        ***REMOVED*** Get existing call assignment
        ...
        ***REMOVED*** Check if person exists if being updated
    ...
    async def bulk_create_call_assignments(
        ...
        if replace_existing and assignments:
            ***REMOVED*** Find date range from assignments
    ...
    async def clear_call_assignments_in_range(
        ...
        *,
        ...
        Returns:
            ...
            - error: Error message if deletion failed
        """
        ***REMOVED*** Delete all call assignments in range
    ...
    async def get_coverage_report(
        ...
        """
        ***REMOVED*** Get all call assignments in range
        assignments = await self.get_call_assignments_by_date_range(
            start_date, end_date
        )

        ***REMOVED*** Build set of covered dates
        covered_dates = set()
        for a in assignments:
            if a.call_type == "overnight":
                covered_dates.add(a.date)

        ***REMOVED*** Find expected overnight call dates (Sun-Thu, weekday 0,1,2,3,6)
        expected_dates = []
        current = start_date
        while current <= end_date:
            if current.weekday() in (0, 1, 2, 3, 6):  ***REMOVED*** Sun-Thu
                expected_dates.append(current)
            current = current + date.resolution

        ***REMOVED*** Calculate gaps
    ...
    async def get_equity_report(
        ...
        ***REMOVED*** Count calls per person, separated by Sunday vs weekday
        ...
        for a in assignments:
            if a.call_type == "overnight":
                ...
                if a.date.weekday() == 6:  ***REMOVED*** Sunday
        ...
        ***REMOVED*** Build distribution details
        distribution = []
        ...
        ***REMOVED*** Sort by total calls descending
