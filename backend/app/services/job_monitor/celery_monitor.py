...
class CeleryMonitorService:
        ...
        try:
            ...
            for worker, tasks in active.items():
                for task in tasks:
                    ...
                    ***REMOVED*** Filter by queue if specified
    ...
    def get_task_info(self, task_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            ***REMOVED*** Add result if available
            if result.ready():
            ...
            ***REMOVED*** Add task metadata if available
    ...
    def get_registered_tasks(self) -> list[str]:
        ...
        try:
            ...
            ***REMOVED*** Collect all unique task names from all workers
            all_tasks = set()
