...
class SwapNotifier:
    ...
    async def notify_swap_created(
        ...
        ***REMOVED*** Get faculty information
        ...
        ***REMOVED*** Send email to target faculty
        ...
        ***REMOVED*** Send in-app notification
    ...
    async def notify_swap_executed(
        ...
        ***REMOVED*** Send email to both parties
    ...
    async def notify_swap_rolled_back(
        ...
        ***REMOVED*** Send urgent notifications
        for faculty in [source_faculty, target_faculty]:
            email_sent = await self._send_email(
                recipient=faculty.email if hasattr(faculty, "email") else None,
    ...
    ***REMOVED*** ===== Private Helper Methods =====
    ...
    async def _send_email(
        ...
        ***REMOVED*** In real implementation, would use email service
    ...
    async def _send_in_app_notification(
        ...
        Returns:
            True if sent successfully
        """
        ***REMOVED*** In real implementation, would create notification record
