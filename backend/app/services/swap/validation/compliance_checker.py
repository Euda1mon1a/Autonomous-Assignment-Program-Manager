...
class ACGMEComplianceChecker:
    ...
    ***REMOVED*** ACGME limits
    ...
    async def check_compliance(
        ...
        ***REMOVED*** Check source faculty after swap
        ...
        ***REMOVED*** Check target faculty after swap
    ...
    async def _check_faculty_compliance(
        ...
        ***REMOVED*** Get faculty's schedule for a 4-week window
        ***REMOVED*** (ACGME uses rolling 4-week average)
        if adding_week:
            check_start = adding_week - timedelta(days=21)  ***REMOVED*** 3 weeks before
            check_end = adding_week + timedelta(days=7)  ***REMOVED*** 1 week after
        else:
            check_start = datetime.utcnow().date()
            check_end = check_start + timedelta(days=28)

        ***REMOVED*** Get assignments in this window
        ...
        ***REMOVED*** Simulate swap effect
        if removing_week and adding_week:
            ***REMOVED*** Remove assignments from removed week
            assignments = [
                a
            ...
            ***REMOVED*** Would add assignments for new week
            ***REMOVED*** (simplified - in reality would clone assignments)

        ***REMOVED*** Check 80-hour rule (rolling 4-week average)
    ...
    async def _check_supervision_ratios(
        ...
        ***REMOVED*** Check if swap maintains required supervision ratios
    ...
    def _is_in_week(self, assignment: Assignment, week_start: date) -> bool:
        ...
        ***REMOVED*** Would need to get block date
        ***REMOVED*** Simplified for now
        return False
    ...
    def _calculate_weekly_hours(
        ...
        ***REMOVED*** Group assignments by week and calculate hours
        ***REMOVED*** Simplified: assume each assignment is 10 hours
        weekly_hours = []

        if assignments:
            ***REMOVED*** Group by week (simplified)
    ...
    def _calculate_days_off(self, assignments: list[Assignment]) -> int:
        ...
        ***REMOVED*** Simplified: assume 1 day off per week
        return 1
