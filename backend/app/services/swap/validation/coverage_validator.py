...
class CoverageValidator:
    ...
    ***REMOVED*** Minimum coverage requirements by rotation type
    MIN_COVERAGE = {
        "inpatient": 2,  ***REMOVED*** At least 2 faculty on inpatient
        "emergency": 1,  ***REMOVED*** At least 1 faculty in emergency
        "call": 1,  ***REMOVED*** At least 1 faculty on call
    }
    ...
    async def validate_coverage(
        ...
        ***REMOVED*** Check coverage for source week after swap
        ...
        ***REMOVED*** Check coverage for target week after swap (if one-to-one)
        if swap.target_week:
    ...
    async def _check_week_coverage(
        ...
        ***REMOVED*** Would add assignments for adding_faculty
        ***REMOVED*** (simplified - actual implementation would create new assignments)

        ***REMOVED*** Group assignments by rotation type and count faculty
        rotation_counts = {}
        ...
        ***REMOVED*** Check against minimum requirements
    ...
    async def check_specialty_coverage(
        ...
        """
        ***REMOVED*** Get specialties of faculty involved
        ...
        ***REMOVED*** Check if specialty requirements are met
        ***REMOVED*** (Simplified - would check against rotation requirements)
    ...
    async def _get_faculty_specialty(self, faculty_id: UUID) -> str | None:
        ...
        if faculty:
            ***REMOVED*** Would get from faculty.specialty field
            return "general"  ***REMOVED*** Placeholder
