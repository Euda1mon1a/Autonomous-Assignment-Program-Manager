...
class SkillValidator:
    ...
    async def validate_skills(
        ...
        ***REMOVED*** Check source faculty can do target's duties
        source_check = await self._check_faculty_credentials(
            swap.target_faculty_id,  ***REMOVED*** Check target's current duties
            swap.source_faculty_id,  ***REMOVED*** Against source's credentials
        ...
        ***REMOVED*** Check target faculty can do source's duties
        target_check = await self._check_faculty_credentials(
            swap.source_faculty_id,  ***REMOVED*** Check source's current duties
            swap.target_faculty_id,  ***REMOVED*** Against target's credentials
            swap.source_week,
        )
    ...
    async def _check_faculty_credentials(
        self,
        duties_faculty_id: UUID,  ***REMOVED*** Who currently does these duties
        checking_faculty_id: UUID,  ***REMOVED*** Who we're checking can do them
        week: date,
    ) -> dict[str, Any]:
    ...
    async def _get_faculty_credentials(
        ...
        ***REMOVED*** This would query the credentials table
        ***REMOVED*** For now, return a placeholder

        ***REMOVED*** In real implementation:
        ***REMOVED*** - Query credential records
        ***REMOVED*** - Check expiration dates
        ***REMOVED*** - Return dict of credential_name -> {expires_at, status}
