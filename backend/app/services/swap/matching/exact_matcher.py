...
class ExactMatch:
    ...
    week_a: date
    week_b: date
    match_score: float  ***REMOVED*** Always 1.0 for exact matches
    is_mutual: bool = True
...
class ExactMatcher:
    ...
    async def find_exact_matches(
        ...
        ***REMOVED*** Check each pair of requests
    ...
    def _is_exact_match(
        ...
        ***REMOVED*** Check if they want each other's weeks
        a_wants_b = (
