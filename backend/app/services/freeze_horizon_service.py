...
class FreezeOverrideRequest:
    ...
    reason_text: str  ***REMOVED*** Required even for structured codes (additional context)
    initiated_by: str  ***REMOVED*** User ID or system identifier
    initiating_module: str  ***REMOVED*** "manual", "planning", "resiliency", "crisis"
...
class FreezeHorizonService:
    ...
    ***REMOVED*** Emergency reason codes that can bypass non-emergency freeze scope
    ...
    def get_settings(self) -> ApplicationSettings:
        ...
        if self._settings_cache is None:
            ...
            if self._settings_cache is None:
                ***REMOVED*** Create default settings if none exist
    ...
    def check_freeze_status(
        ...
        ***REMOVED*** Calculate days until assignment
        if reference_date is None:
            reference_date = date.today()

        days_until = (block_date - reference_date).days

        ***REMOVED*** Check if within freeze horizon
    ...
    def validate_override(
        ...
        ***REMOVED*** Check if emergency bypass is allowed
        ...
        ***REMOVED*** ALL_CHANGES_REQUIRE_OVERRIDE - any override with reason is valid
        if (
    ...
    def create_audit_record(
        ...
        ***REMOVED*** Store in memory (would also persist to database in production)
        self._override_records.append(record)

        ***REMOVED*** Log the override
        logger.warning(
    ...
    def enforce_freeze_or_override(
        ...
        ***REMOVED*** Assignment is frozen - check for override
        if override_request is None:
            raise FreezeHorizonViolation(freeze_result)

        ***REMOVED*** Validate the override
        ...
        ***REMOVED*** Override is valid - create audit record
        ...
        ***REMOVED*** Update result to indicate override was used
