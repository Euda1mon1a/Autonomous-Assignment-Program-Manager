...
class SolverResult:
    ...
    def __init__(
        self,
        success: bool,
        assignments: list[tuple[UUID, UUID, UUID | None]],  ***REMOVED*** (person_id, block_id, template_id)
        status: str,
        ...
        self.explanations = explanations or {}  ***REMOVED*** (person_id, block_id) -> explanation dict
...
class CPSATSolver(BaseSolver):
    ...
    def solve(
        ...
        ***REMOVED*** ==================================================
        ***REMOVED*** OBJECTIVE FUNCTION
        ***REMOVED*** Maximize: coverage * 1000 - equity_penalty
        ***REMOVED*** ==================================================
...
class GreedySolver(BaseSolver):
    ...
    def solve(
        ...
        ***REMOVED*** Track existing assignments
        ...
        template_block_counts = defaultdict(lambda: defaultdict(int))  ***REMOVED*** template_id -> block_id -> count
        ...
        ***REMOVED*** Assign residents with explanations
        ...
        for block in sorted_blocks:
            ...
            ***REMOVED*** Select best available template
            template = None
            for t in context.templates:
                ...
                ***REMOVED*** Found a valid template
                template = t
                break
