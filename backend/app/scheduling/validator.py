...
class ACGMEValidator:
    ...
    ***REMOVED*** Constants
    MAX_WEEKLY_HOURS = 80
    HOURS_PER_HALF_DAY = 6  ***REMOVED*** AM or PM block = 6 hours (realistic clinical duty)
    ...
    def validate_all(
        ...
        ***REMOVED*** Get assignments in range (prefer provided candidate assignments)
        assignments = self._select_assignments_in_range(
            assignments, start_date, end_date
        )

        ***REMOVED*** Check each resident
    ...
    def _check_80_hour_rule(
        ...
        ***REMOVED*** Check all possible 28-day windows
        for i in range(len(dates)):
            ...
            ***REMOVED*** Sum hours in window
            ...
            if avg_weekly > self.MAX_WEEKLY_HOURS:
                ...
                ***REMOVED*** Only report first violation per resident
                break
    ...
    def _check_1_in_7_rule(
        ...
        ***REMOVED*** Get unique dates with assignments
        ...
        ***REMOVED*** Check for consecutive days > 6
        consecutive = 1
        max_consecutive = 1
