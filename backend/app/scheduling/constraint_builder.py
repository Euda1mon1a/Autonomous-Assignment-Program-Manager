...
class ConstraintBuilder:
    ...
    def build(self) -> Constraint:
        ...
        ***REMOVED*** Create constraint instance
        if self._is_hard:
        ...
        ***REMOVED*** Add parameters as attributes
    ...
    def clone(self) -> "ConstraintBuilder":
        ...
        Example:
            ...
            >>> ***REMOVED*** builder1 and builder2 have different parameters
        """
...
class ConstraintCloner:
    ...
    def clone(constraint: Constraint) -> Constraint:
        ...
        """
        ***REMOVED*** Create new instance of same class
...
class ConstraintSerializer:
        ...
        for attr_name in dir(constraint):
            if not attr_name.startswith("_"):
                ...
                if not callable(attr_value) and attr_name not in [
                    ...
                    try:
                        ***REMOVED*** Try to serialize (skip non-serializable)
    ...
    def from_dict(data: dict) -> Constraint | None:
        ...
        """
        try:
            ***REMOVED*** Reconstruct constraint using builder
            builder = ConstraintBuilder()
            ...
            ***REMOVED*** Reconstruct constraint type
