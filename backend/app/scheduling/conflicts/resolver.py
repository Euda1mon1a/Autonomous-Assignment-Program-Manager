...
class ConflictResolver:
    ...
    async def suggest_resolutions(
        ...
        ***REMOVED*** Route to specific handlers based on conflict type
        if isinstance(conflict, TimeOverlapConflict):
            ...
            ***REMOVED*** Generic suggestions
            suggestions = await self._generic_resolutions(conflict)

        ***REMOVED*** Sort by confidence and return top suggestions
    ...
    async def _resolve_time_overlap(
        ...
        ***REMOVED*** Strategy 1: Cancel one assignment
        ...
        ***REMOVED*** Strategy 2: Reassign to different person
        suggestions.append(
            ResolutionSuggestion(
                ...
                impact={
                    "affected_people": 2,  ***REMOVED*** Original + replacement
        ...
        ***REMOVED*** Strategy 3: Split assignment
    ...
    async def _resolve_supervision_issue(
        ...
        ***REMOVED*** Strategy 1: Add faculty
        suggestions.append(
            ResolutionSuggestion(
        ...
        ***REMOVED*** Strategy 2: Reduce resident count
        ...
        ***REMOVED*** Strategy 3: Use backup faculty
        suggestions.append(
            ResolutionSuggestion(
                ...
                confidence=0.75,
                estimated_time_minutes=20,
                requires_approval=False,  ***REMOVED*** Backup activation is standard procedure
            )
        )
    ...
    async def _resolve_acgme_violation(
        ...
        if conflict.conflict_type == ConflictType.EIGHTY_HOUR_VIOLATION:
            ***REMOVED*** 80-hour violation resolutions
            suggestions.append(
                ResolutionSuggestion(
            ...
            suggestions.append(
                ResolutionSuggestion(
                    ...
                    impact={
                        "affected_people": 3,  ***REMOVED*** Usually affects 2-3 residents
                        "disruption_level": "medium",
                        "coverage_risk": "low",
                        "acgme_impact": "resolves_violation",
                    },
            ...
            ***REMOVED*** 1-in-7 violation resolutions
            suggestions.append(
                ResolutionSuggestion(
                    ...
                    impact={
                        "affected_people": 2,  ***REMOVED*** Resident + replacement
                        "disruption_level": "medium",
                        "coverage_risk": "medium",
                        "acgme_impact": "resolves_violation",
                    },
    ...
    async def _resolve_resource_contention(
        ...
        ***REMOVED*** Generic resource allocation suggestion
        suggestions.append(
            ResolutionSuggestion(
    ...
    async def _generic_resolutions(
        ...
        ***REMOVED*** Manual review suggestion (always available)
        suggestions.append(
            ResolutionSuggestion(
