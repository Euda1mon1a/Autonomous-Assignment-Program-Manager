...
class ConflictAnalyzer:
    ...
    ***REMOVED*** ACGME Constants
    ...
    HOURS_PER_BLOCK = 6.0
    ROLLING_WEEKS = 4
    ROLLING_WINDOW_DAYS = 27  ***REMOVED*** 28 days - 1 (inclusive end date for timedelta)

    ***REMOVED*** Supervision ratios
    PGY1_RATIO = 2  ***REMOVED*** 1 faculty per 2 PGY-1 residents
    OTHER_RATIO = 4  ***REMOVED*** 1 faculty per 4 PGY-2/3 residents
    ...
    async def analyze_schedule(
        ...
        ***REMOVED*** Detect different types of conflicts
        ...
        ***REMOVED*** Sort by severity and urgency
    ...
    async def _detect_time_overlaps(
        ...
        ***REMOVED*** Find overlaps (more than one assignment per person per block)
        for (person_id, block_id), person_assignments in by_person_and_block.items():
            if len(person_assignments) <= 1:
                continue

            ***REMOVED*** Double booking detected
    ...
    async def _detect_supervision_issues(
        ...
        ***REMOVED*** Get all assignments in date range
    ...
    async def _check_eighty_hour_rule(
        ...
        ***REMOVED*** Check rolling 4-week windows
        for window_start in dates:
            window_end = window_start + timedelta(days=self.ROLLING_WINDOW_DAYS)  ***REMOVED*** 4 weeks = 28 days
    ...
    async def _check_one_in_seven_rule(
        ...
        ***REMOVED*** Get unique dates worked
        ...
        ***REMOVED*** Find consecutive work days
        consecutive = 1
        max_consecutive = 1
    ...
    async def _detect_resource_contentions(
        ...
        """
        ***REMOVED*** Placeholder - to be implemented based on resource tracking requirements
        return []
    ...
    async def generate_summary(
        ...
        ***REMOVED*** Count by category and type
        for conflict in conflicts:
        ...
        ***REMOVED*** Count affected entities
        all_people = set()
        all_blocks = set()
        for conflict in conflicts:
