...
class ValidationError:
    ...
    level: str  ***REMOVED*** 'ERROR', 'WARNING', 'INFO'
    category: str  ***REMOVED*** 'SYNTAX', 'FEASIBILITY', 'CONFLICT', 'COVERAGE', 'PERFORMANCE'
    message: str
...
class ConstraintSyntaxValidator:
    ...
    def validate_constraint(
        ...
        ***REMOVED*** Check required attributes
        ...
        ***REMOVED*** Check soft constraint weight
...
class ConstraintFeasibilityChecker:
    ...
    def check_feasibility(
        ...
        ***REMOVED*** Check for obviously infeasible combinations
    ...
    def _check_infeasible_combinations(
        ...
        ***REMOVED*** Example: Cannot have both CRITICAL availability and complete coverage
        ***REMOVED*** (in a scheduling scenario where requirements exceed capacity)
        pass
...
class ConstraintConflictDetector:
    ...
    def detect_conflicts(
        ...
        ***REMOVED*** Check for conflicting priorities
    ...
    def _conflicts(self, c1: Constraint, c2: Constraint) -> bool:
        ...
        ***REMOVED*** Known conflicts from CONSTRAINT_CATALOG.md
        conflict_pairs = [
            ("Equity", "Continuity"),
...
class ConstraintCoverageAnalyzer:
    ...
    def analyze_coverage(
        ...
        ***REMOVED*** Check coverage of ACGME requirements
...
class ConstraintPerformanceProfiler:
    ...
    def profile_performance(
        ...
        ***REMOVED*** Estimate computational complexity
        total_complexity = 0

        complexity_estimates = {
            ConstraintType.AVAILABILITY: 10,  ***REMOVED*** O(n)
            ConstraintType.CAPACITY: 100,  ***REMOVED*** O(n²)
            ConstraintType.EQUITY: 50,  ***REMOVED*** O(n)
            ConstraintType.CALL: 75,  ***REMOVED*** O(n log n)
        }
        ...
        ***REMOVED*** Check for soft constraint weight distribution
