...
class VisualizationConfig:
    ...
    dpi: int = 100
    color_ergosphere: str = "***REMOVED***FF6B6B"  ***REMOVED*** Red for high-energy regions
    color_positive: str = "***REMOVED***4ECDC4"  ***REMOVED*** Cyan for positive energy
    color_negative: str = "***REMOVED***95E1D3"  ***REMOVED*** Light cyan for negative energy
    color_extraction: str = "***REMOVED***F38181"  ***REMOVED*** Pink for extraction
...
class PenroseVisualizer:
    ...
    def plot_ergosphere_timeline(
        ...
        ***REMOVED*** Plot each ergosphere as a rectangle
        ...
        for ergosphere in sorted_ergospheres:
            ...
            ***REMOVED*** Add extraction potential label
    ...
    def plot_extraction_efficiency(
        ...
        ***REMOVED*** Calculate cumulative extraction
        ...
        ***REMOVED*** Plot 1: Cumulative extraction
        ax1.plot(
            swap_numbers,
            cumulative_extraction,
            marker="o",
        ...
        ***REMOVED*** Add Penrose limit line
        ...
        ***REMOVED*** Plot 2: Individual swap contributions
    ...
    def plot_swap_network(
        ...
        ***REMOVED*** Add nodes (assignments)
        ...
        for assignment_id in assignment_ids:
            G.add_node(str(assignment_id)[:8])  ***REMOVED*** Use first 8 chars for readability

        ***REMOVED*** Add edges (swaps)
        edge_weights = []
        edge_colors = []
        ...
        for swap in swaps:
            ...
            ***REMOVED*** Edge weight = net extraction
            weight = swap.net_extraction
            edge_weights.append(abs(weight) * 5)  ***REMOVED*** Scale for visibility

            ***REMOVED*** Color based on execution status
            if swap.executed:
        ...
        ***REMOVED*** Add edge labels for executed swaps
        executed_edges = {
    ...
    def plot_phase_decomposition(
        ...
        ***REMOVED*** Group phases by assignment
        ...
        ***REMOVED*** Sort assignments
        sorted_assignments = sorted(phases_by_assignment.keys())

        ***REMOVED*** Plot each assignment's phases
        y_position = 0
        ...
        for assignment_id in sorted_assignments:
            ...
            for phase in assignment_phases:
                ***REMOVED*** Determine color based on energy state
                ...
                ***REMOVED*** Width proportional to phase duration
                duration = (phase.phase_end - phase.phase_start).total_seconds() / 3600
                width = duration / 24  ***REMOVED*** Normalize to 24-hour scale

                ***REMOVED*** Draw phase rectangle
                rect = Rectangle(
                ...
                ***REMOVED*** Add conflict score label
        ...
        ***REMOVED*** Set axis properties
        ax.set_xlim(0, 3)  ***REMOVED*** Three phases
    ...
    def _generate_recommendations(
        ...
        ***REMOVED*** Check if approaching Penrose limit
        if efficiency > 0.25:
        ...
        ***REMOVED*** Check for high-potential ergospheres
        ...
        ***REMOVED*** Check for underutilized swaps
        ...
        ***REMOVED*** Check for low extraction efficiency
        if efficiency < 0.05:
            recommendations.append(
