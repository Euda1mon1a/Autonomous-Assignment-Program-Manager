...
class ConstraintInsight:
    ...
    name: str
    dual_value: float  ***REMOVED*** Shadow price - value of relaxing constraint by 1 unit
    slack: float  ***REMOVED*** How much headroom before constraint is binding
    is_binding: bool  ***REMOVED*** True if constraint is at its limit
    interpretation: str  ***REMOVED*** Human-readable explanation
...
class PyomoSolver(BaseSolver):
    ...
    def __init__(
        ...
        solver_name: str = "cbc",  ***REMOVED*** Free solver, or "glpk", "gurobi", "cplex"
    ...
    def solve(
        ...
        ***REMOVED*** Create Pyomo model
        model = ConcreteModel(name="ResidencyScheduler")

        ***REMOVED*** ==================================================
        ***REMOVED*** DECISION VARIABLES
        ***REMOVED*** x[r,b,t] = 1 if resident r assigned to template t in block b
        ***REMOVED*** ==================================================
        ...
        ***REMOVED*** ==================================================
        ***REMOVED*** CONSTRAINT: Template capacity per block
        ***REMOVED*** ==================================================
        ...
        ***REMOVED*** ==================================================
        ***REMOVED*** CONSTRAINT: Preserve existing assignments
        ***REMOVED*** ==================================================
        ...
        ***REMOVED*** ==================================================
        try:
            ...
            ***REMOVED*** Enable dual/slack capture
            if self.capture_duals:
                model.dual = None  ***REMOVED*** Will be populated after solve
        ...
        ***REMOVED*** Check termination condition
        ...
        ***REMOVED*** ==================================================
        ***REMOVED*** CAPTURE CONSTRAINT INSIGHTS
        ***REMOVED*** ==================================================
    ...
    def _capture_constraint_insights(
        ...
        ***REMOVED*** Analyze one_rotation constraints
        ...
        ***REMOVED*** Analyze template_capacity constraints
        ...
        ***REMOVED*** Identify bottleneck resources (constraints with highest dual values)
...
***REMOVED*** Register with SolverFactory
