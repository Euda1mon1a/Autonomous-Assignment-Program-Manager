...
class PSOConfig:
    ...
    ***REMOVED*** PSO parameters
    inertia_weight: float = 0.7  ***REMOVED*** w: momentum
    cognitive_coeff: float = 1.5  ***REMOVED*** c1: attraction to personal best
    social_coeff: float = 1.5  ***REMOVED*** c2: attraction to global/local best
    velocity_clamp: float = 0.5  ***REMOVED*** Max velocity magnitude
    ...
    ***REMOVED*** Search space bounds
    dimension: int = 6  ***REMOVED*** Number of objective weights to optimize
...
class ParticleSwarmSolver(BioInspiredSolver):
    ...
    def _generate_schedule(
        ...
        ***REMOVED*** Higher weight on ACGME = respect limits
        ...
        target_density = 0.3 + 0.4 * weights[0]  ***REMOVED*** Coverage weight affects density
            ...
            ***REMOVED*** Score each resident for this block
            ...
            for r_idx in range(n_residents):
                ...
                ***REMOVED*** ACGME: respect weekly limits
                ...
                if weekly_count >= 13:  ***REMOVED*** ~80 hours
