...
class PSOConfig:
    ...
    ***REMOVED*** PSO parameters
    ...
    cognitive_coeff: float = PSO_DEFAULT_COGNITIVE_COEFF  ***REMOVED*** c1: attraction to personal best
    social_coeff: float = PSO_DEFAULT_SOCIAL_COEFF  ***REMOVED*** c2: attraction to global/local best
...
class ParticleSwarmSolver(BioInspiredSolver):
    ...
    def _generate_schedule(
        ...
        ***REMOVED*** Higher weight on ACGME = respect limits
        ...
        target_density = PSO_DENSITY_BASE + PSO_DENSITY_RANGE * weights[0]  ***REMOVED*** Coverage weight affects density
