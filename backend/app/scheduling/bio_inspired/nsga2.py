...
class ParetoFront:
    ...
    def add(self, individual: Individual) -> None:
        ...
        ***REMOVED*** Check if dominated by any existing member
        for existing in self.individuals:
            if existing.fitness and individual.fitness:
                if existing.fitness.dominates(individual.fitness):
                    return  ***REMOVED*** Dominated, don't add

        ***REMOVED*** Remove any existing members dominated by new individual
        self.individuals = [
            ind
        ...
        ***REMOVED*** Check for duplicates (same fitness values)
            ...
            for existing in self.individuals:
                if existing.fitness:
                    if np.allclose(
                        ...
                        return  ***REMOVED*** Already have this point
    ...
    def get_knee_point(self) -> Individual | None:
        ...
        ***REMOVED*** Use coverage and fairness for 2D knee detection
        points = [
        ...
        ***REMOVED*** Find point with maximum perpendicular distance from line
        ***REMOVED*** connecting first and last points
    ...
    def compute_spread(self) -> float:
        ...
        ***REMOVED*** Compute range in each objective
...
class CrowdingDistance:
    ...
    def compute(
        ...
        ***REMOVED*** Initialize distances
        for ind in individuals:
            ind.crowding_distance = 0.0

        ***REMOVED*** Compute for each objective
        for obj in objectives:
            ...
            ***REMOVED*** Compute distances for middle points
...
class NSGA2Config:
    ...
    tournament_size: int = NSGA2_DEFAULT_TOURNAMENT_SIZE  ***REMOVED*** Binary tournament for NSGA-II
...
class NSGA2Solver(BioInspiredSolver):
    ...
    def __init__(
        ...
        ***REMOVED*** NSGA-II specific state
    ...
    def _evolve(self, context: SchedulingContext) -> Individual:
        ...
        ***REMOVED*** Evolution loop
        for generation in range(self.max_generations):
            ...
            ***REMOVED*** Create offspring population
            offspring = self._create_offspring(context, generation)

            ***REMOVED*** Combine parent and offspring
            combined = self.population + offspring

            ***REMOVED*** Fast non-dominated sort
            self.fronts = self._fast_non_dominated_sort(combined)

            ***REMOVED*** Select next generation
        ...
        ***REMOVED*** Return knee point of final Pareto front
    ...
    def _fast_non_dominated_sort(
        ...
        ***REMOVED*** Compare all pairs
        for i, ind_i in enumerate(population):
            ...
            ***REMOVED*** If not dominated by anyone, it's in front 0
            if domination_count[i] == 0:
                population[i].rank = 0
                fronts[0].append(population[i])

        ***REMOVED*** Build subsequent fronts
        current_front = 0
        ...
        ***REMOVED*** Remove empty last front
        if not fronts[-1]:
            fronts.pop()
    ...
    def _create_offspring(
        ...
        while len(offspring) < self.population_size:
            ***REMOVED*** Binary tournament selection (crowded comparison)
    ...
    def _select_next_generation(self) -> list[Individual]:
        ...
        for front in self.fronts:
            ***REMOVED*** Compute crowding distance for this front
            CrowdingDistance.compute(front, self.objectives)

            if len(new_population) + len(front) <= self.population_size:
                ***REMOVED*** Add entire front
                new_population.extend(front)
            else:
                ***REMOVED*** Add best from this front based on crowding distance
                remaining = self.population_size - len(new_population)
                sorted_front = sorted(
                    front,
                    key=lambda ind: ind.crowding_distance,
                    reverse=True,  ***REMOVED*** Higher crowding = more diverse
                )
    ...
    def _check_improvement(self) -> bool:
        ...
        ***REMOVED*** Check if spread increased or size increased
        return (
    ...
    def _check_convergence(self, generation: int) -> bool:
        ...
        ***REMOVED*** Check hypervolume stability
        recent_hv = [
            s.hypervolume
