...
async def example_basic_usage():
    ...
    ***REMOVED*** Setup (in real usage, these come from FastAPI dependencies)
    event_bus = get_event_bus()
    redis_client = redis.from_url("redis://localhost:6379", decode_responses=True)

    ***REMOVED*** Note: db would be AsyncSession in real usage
    db = None  ***REMOVED*** Placeholder for this example
    ...
    ***REMOVED*** Observer sees UNCHANGED state (stroboscopic!)
    ...
    ***REMOVED*** Advance checkpoint - atomic transition
    ...
    ***REMOVED*** Observer NOW sees new state
...
async def example_concurrent_draft_and_observe():
    ...
    ***REMOVED*** Run observer and proposer concurrently
...
async def example_checkpoint_history():
    ...
    ***REMOVED*** Create several checkpoints
