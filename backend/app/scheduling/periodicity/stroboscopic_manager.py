...
Usage:
    ...
    ***REMOVED*** Observers always see stable state
...
class StateStatus(str, Enum):
    ...
    DRAFT = "draft"  ***REMOVED*** Proposed changes, not yet authoritative
    AUTHORITATIVE = "authoritative"  ***REMOVED*** Current observable state
    ARCHIVED = "archived"  ***REMOVED*** Historical checkpoint


***REMOVED*** Lock configuration
CHECKPOINT_LOCK_TIMEOUT = 60  ***REMOVED*** Checkpoint operations must complete in 60s
...
class ScheduleState(BaseModel):
    ...
    ***REMOVED*** Provenance
    ...
    created_from_draft: str | None = None  ***REMOVED*** ID of draft that became authoritative

    ***REMOVED*** Integrity
    state_hash: str | None = None  ***REMOVED*** SHA-256 of state data for verification

    class Config:
        frozen = True  ***REMOVED*** Immutable after creation
    ...
    def __init__(self, **data):
        ...
        if self.state_hash is None:
            ***REMOVED*** Calculate hash after initialization
    ...
    def _calculate_hash(self) -> str:
        ...
        """
        ***REMOVED*** Create deterministic representation
        state_dict = {
...
class CheckpointEvent(BaseEvent):
    ...
    def __init__(self, **data):
        ...
        ***REMOVED*** BaseEvent expects aggregate_id
...
***REMOVED*** =============================================================================
***REMOVED*** Stroboscopic Schedule Manager
***REMOVED*** =============================================================================
...
class StroboscopicScheduleManager:
    ...
    Example:
        ...
        ***REMOVED*** Propose changes (non-blocking, does not affect observers)
    ...
    def __init__(
        ...
        ***REMOVED*** Checkpoint history (in-memory cache, backed by DB/event store)
        self._checkpoint_history: list[ScheduleState] = []
        self._max_history_size = 50  ***REMOVED*** Keep last 50 checkpoints in memory
    ...
    async def initialize(self, initial_state: ScheduleState | None = None) -> None:
        ...
        if initial_state:
            ...
            ***REMOVED*** Create empty authoritative state
    ...
    async def propose_draft(
        ...
        ***REMOVED*** Use current authoritative state as base if no assignments provided
    ...
    async def advance_checkpoint(
        ...
        ***REMOVED*** Acquire distributed lock for checkpoint transition
        ...
        try:
            ***REMOVED*** Acquire lock with timeout
            ...
            ***REMOVED*** Archive previous authoritative state
            ...
            ***REMOVED*** Emit checkpoint event to notify all observers
    ...
    def _count_changed_assignments(
        ...
        """
        ***REMOVED*** Quick check: if hashes match, no changes
        if (
        ...
        ***REMOVED*** Count added and removed assignments
    ...
    def _assignment_key(self, assignment: dict[str, Any]) -> str:
        ...
        Returns:
            Unique key string
        """
        ***REMOVED*** Use core fields to identify assignment
...
***REMOVED*** =============================================================================
***REMOVED*** Checkpoint Scheduler (Helper)
***REMOVED*** =============================================================================
...
class CheckpointScheduler:
    ...
    async def should_checkpoint(self) -> CheckpointBoundary | None:
        ...
        ***REMOVED*** Check for week boundary (Monday 00:00)
        if now.weekday() == 0:  ***REMOVED*** Monday
            if (
        ...
        ***REMOVED*** Check for ACGME window (every 28 days)
        if (
