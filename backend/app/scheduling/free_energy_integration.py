...
class ForecastGenerator:
    ...
    async def generate_forecast(
        ...
        """
        ***REMOVED*** Query historical assignments
        ...
        ***REMOVED*** Get templates (would need to query from context)
        ***REMOVED*** For now, create forecast from assignments
        template_counts = {}
    ...
    async def generate_outcomes_from_history(
        ...
        while current_start < end_date:
            ...
            ***REMOVED*** Query assignments in this block
            query = (
                select(Assignment)
                .join(Assignment.block)
            ...
            if block_assignments:
                ***REMOVED*** Compute actual coverage
                template_counts = {}
...
class FreeEnergySolverAdapter:
    ...
    async def solve_with_free_energy(
        ...
        ***REMOVED*** Generate forecast if requested
        if use_historical_forecast and context.start_date:
            try:
                ...
                ***REMOVED*** Attach forecast to context
        ...
        ***REMOVED*** Add FEP-specific metadata
        ...
        result.statistics["free_energy"] = {
            "surprise_history": [
                ...
                for s in solver.surprise_history[-10:]  ***REMOVED*** Last 10
            ],
    ...
    async def train_model_from_history(
        ...
        ***REMOVED*** Generate historical outcomes
        ...
        ***REMOVED*** Create and train model
...
class HybridFreeEnergySolver:
    ...
    async def solve_hybrid(
        ...
        ***REMOVED*** Phase 1: FEP pre-optimization
        ...
        if not fep_result.success:
            ...
            ***REMOVED*** Fall back to classical solver
...
async def get_default_forecast(
    ...
    ***REMOVED*** Fall back to uniform prior
