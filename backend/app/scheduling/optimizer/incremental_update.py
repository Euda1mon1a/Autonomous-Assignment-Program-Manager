...
class IncrementalScheduleUpdater:
    ...
    async def add_person(
        ...
        ***REMOVED*** Find available slots for new person
        ...
        ***REMOVED*** Assign person to best slots
    ...
    async def remove_person(
        ...
        Example:
            >>> ***REMOVED*** Remove person completely
            >>> schedule = await updater.remove_person(schedule, "r123")
            >>>
            >>> ***REMOVED*** Remove for specific date range (e.g., leave)
        ...
        if date_range:
            ...
            ***REMOVED*** Remove assignments in date range
            schedule["assignments"] = [
                a
            ...
            ***REMOVED*** Remove all assignments
            removed_count = len(
    ...
    async def swap_assignments(
        ...
        Example:
            >>> ***REMOVED*** Person 1 wants to work Person 2's shift and vice versa
            >>> schedule = await updater.swap_assignments(
            ...     schedule,
            ...     "r123", "r456",
        ...
        ***REMOVED*** Check if swap would violate constraints
    ...
    async def update_rotation_capacity(
        ...
        Example:
            >>> ***REMOVED*** Reduce ICU capacity from 3 to 2 residents
        ...
        ***REMOVED*** Check each date in range
        current_date = start_date
        while current_date <= end_date:
            ***REMOVED*** Count assignments for this rotation on this date
            assignments = [
                a
                for a in schedule["assignments"]
    ...
    def _find_available_slots(
        ...
        current_date = start_date
        while current_date <= end_date:
            ***REMOVED*** Check if person is already assigned
            existing = next(
                (
                    a
                    for a in schedule["assignments"]
    ...
    def _assign_to_slots(
        ...
        for slot in available_slots:
            if slot["rotations"]:
                ***REMOVED*** Pick best rotation for this slot
                rotation_id = slot["rotations"][0]  ***REMOVED*** Simplified
    ...
    def _would_violate_constraints(
        ...
        """
        ***REMOVED*** Check ACGME rules, rotation requirements, etc.
        ***REMOVED*** For now, return False (assume valid)
        return False
