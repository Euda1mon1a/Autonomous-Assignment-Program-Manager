...
class ConstraintType(Enum):
    ...
    CALL = "call"
    SPECIALTY = "specialty"
    ***REMOVED*** Resilience-aware constraint types
...
class ConstraintManager:
    ...
    def create_default(cls) -> "ConstraintManager":
        ...
        ***REMOVED*** Resilience-aware soft constraints (disabled by default for backward compatibility)
    ...
    def create_resilience_aware(cls, target_utilization: float = 0.80) -> "ConstraintManager":
        ...
        ***REMOVED*** Resilience-aware soft constraints (ENABLED)
        manager.add(HubProtectionConstraint(weight=15.0))
