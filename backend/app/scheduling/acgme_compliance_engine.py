...
class ACGMEComplianceEngine:
    ...
    def validate_complete_schedule(
        ...
        ***REMOVED*** Run validation for each resident
        by_resident = {}
        total_critical = 0
        total_high = 0
        ...
        ***REMOVED*** Validate supervision across blocks
        ...
        ***REMOVED*** Generate executive summary
    ...
    def validate_resident_compliance(
        ...
        ***REMOVED*** 1. Work Hour Validation
        ...
        ***REMOVED*** 2. Supervision Validation (as resident)
        ***REMOVED*** Supervision is checked per-block, not per-resident

        ***REMOVED*** 3. Call Validation
        ...
        ***REMOVED*** Aggregate violation counts
        total_critical = sum(
    ...
    def _calculate_hours_by_date(
        ...
        for assignment in assignments:
            ...
            ***REMOVED*** Standard 6 hours per block
            hours = 6.0
