...
class WednesdayPMSingleFacultyConstraint(HardConstraint):
    ...
    def _is_regular_wednesday_pm(self, block: Any) -> bool:
        ...
        if getattr(block, "time_of_day", None) != "PM":
            return False
        ***REMOVED*** Check if 4th Wednesday (day 22-28)
    ...
    def add_to_cpsat(
        ...
        for block in context.blocks:
            ...
            ***REMOVED*** Exactly 1 faculty in clinic
    ...
    def validate(
        ...
        ***REMOVED*** Early return if no clinic templates
        if not clinic_template_ids:
            return ConstraintResult(satisfied=True, violations=[])
...
class InvertedWednesdayConstraint(HardConstraint):
    ...
    def _is_fourth_wednesday(self, block: Any) -> bool:
        ...
        if block.date.weekday() != self.WEDNESDAY:
            return False
        ***REMOVED*** 4th Wednesday: day 22-28 only (5th would be 29-31)
    ...
    def add_to_cpsat(
        ...
        ***REMOVED*** Group 4th Wednesday blocks by date and time
        ...
        for date_str, blocks_by_time in fourth_wed_groups.items():
            ...
            ***REMOVED*** Collect AM faculty clinic variables
            ...
            ***REMOVED*** Collect PM faculty clinic variables
            ...
            ***REMOVED*** Exactly 1 faculty AM
            if am_vars:
                model.Add(sum(v for _, v in am_vars) == 1)

            ***REMOVED*** Exactly 1 faculty PM
            if pm_vars:
                model.Add(sum(v for _, v in pm_vars) == 1)

            ***REMOVED*** Different faculty AM vs PM (if same faculty in both, sum <= 1)
            if am_vars and pm_vars:
                ...
                for fac_id in faculty_in_both:
                    ...
                    if am_v and pm_v:
                        ***REMOVED*** Cannot have same faculty both AM and PM
    ...
    def add_to_pulp(
        ...
        for date_str, blocks_by_time in fourth_wed_groups.items():
            ...
            ***REMOVED*** Different faculty AM vs PM
            if am_vars and pm_vars:
    ...
    def validate(
        ...
        ***REMOVED*** Group 4th Wednesday blocks by date
        ...
        for date_str, blocks_by_time in fourth_wed_dates.items():
            ...
            ***REMOVED*** Check AM != PM (different faculty)
