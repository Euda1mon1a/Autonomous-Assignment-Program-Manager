...
class FacultyRoleClinicConstraint(HardConstraint):
    ...
    def add_to_cpsat(
        ...
        ***REMOVED*** Get faculty from context
    ...
    def validate(
        ...
        ***REMOVED*** Count clinic assignments by faculty and week
        ...
        for a in assignments:
            ***REMOVED*** Only check faculty clinic assignments
...
class SMFacultyClinicConstraint(HardConstraint):
    ...
    def add_to_cpsat(
        ...
        ***REMOVED*** Identify regular clinic templates (not SM clinic)
        regular_clinic_ids = {
            t.id for t in context.templates
            if hasattr(t, 'activity_type') and t.activity_type == 'clinic'
        ...
        ***REMOVED*** Find SM faculty
        for faculty in context.faculty:
            if not hasattr(faculty, 'is_sports_medicine') or not faculty.is_sports_medicine:
                continue
            ***REMOVED*** Check role specifically for sports_med role
            if hasattr(faculty, 'faculty_role') and faculty.faculty_role == 'sports_med':
                f_i = context.resident_idx.get(faculty.id)
                if f_i is None:
                    continue

                ***REMOVED*** Block from all regular clinic assignments
