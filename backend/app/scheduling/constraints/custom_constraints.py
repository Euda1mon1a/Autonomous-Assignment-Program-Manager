"""
Custom and Business Constraints.

This module contains soft constraints for optimization objectives including
equity, continuity, preferences, and resilience-aware scheduling.

Soft Constraints:
- EquityConstraint: Balances workload across residents
- ContinuityConstraint: Maintains continuity in rotation assignments
- PreferenceConstraint: Respects resident preferences
- HubProtectionConstraint: Protects critical "hub" faculty from over-assignment
- UtilizationBufferConstraint: Maintains system capacity buffer (queuing theory)
- ZoneBoundaryConstraint: Minimizes cross-zone assignments (blast radius isolation)
- PreferenceTrailConstraint: Uses learned preferences from stigmergy
- N1VulnerabilityConstraint: Protects single-point-of-failure faculty
"""
import logging
