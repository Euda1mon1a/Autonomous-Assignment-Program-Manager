...
***REMOVED*** Import all constraint classes
from .acgme import (
...
class ConstraintManager:
    ...
    def create_default(cls) -> "ConstraintManager":
        ...
        ***REMOVED*** Block 10 hard constraints - inpatient headcount and post-FMIT blocking
        ...
        ***REMOVED*** Uses primary_duties.json for per-faculty clinic min/max and availability
        ...
        ***REMOVED*** Block 10 soft constraints - call equity (weight hierarchy documented)
        ***REMOVED*** Weight order: Sunday (10) > CallSpacing (8) > Weekday (5) > Tuesday (2)
        ...
        ***REMOVED*** Tier 1: Resilience-aware soft constraints (ENABLED by default)
        ***REMOVED*** These provide critical protection against cascade failures
        manager.add(HubProtectionConstraint(weight=15.0))
        manager.add(UtilizationBufferConstraint(weight=20.0))
        ***REMOVED*** Tier 2: Strategic resilience constraints (disabled by default - more aggressive)
        ...
        ***REMOVED*** Tier 2 disabled by default - enable with create_resilience_aware(tier=2)
    ...
    def create_resilience_aware(
        ...
        ***REMOVED*** Block 10 soft constraints - call equity
        manager.add(SundayCallEquityConstraint(weight=10.0))
        manager.add(CallSpacingConstraint(weight=8.0))
        manager.add(WeekdayCallEquityConstraint(weight=5.0))
        manager.add(TuesdayCallPreferenceConstraint(weight=2.0))
