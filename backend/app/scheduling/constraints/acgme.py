...
class SupervisionRatioConstraint(HardConstraint):
    ...
    def calculate_required_faculty(self, pgy1_count: int, other_count: int) -> int:
        ...
        """
        ***REMOVED*** Integer math: PGY-1 = 2 units, PGY-2/3 = 1 unit (4 units = 1 faculty)
...
***REMOVED*** Re-export ACGMEConstraintValidator from services
***REMOVED*** This enables using the high-level validator from the old import path
try:
    from app.services.constraints.acgme import ACGMEConstraintValidator
except ImportError:
    ***REMOVED*** Fallback if services module not yet available (e.g., during initialization)
