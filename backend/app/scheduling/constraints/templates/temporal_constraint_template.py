...
class TemporalConstraintTemplate(HardConstraint):
    ...
    Examples:
        ...
        >>> constraint.allowed_times = ['AM']  ***REMOVED*** Morning only
    """
    ...
    def __init__(self) -> None:
        ...
        ***REMOVED*** Temporal parameters
        self.allowed_days = None  ***REMOVED*** ['Monday', 'Wednesday', ...]
        self.forbidden_days = None  ***REMOVED*** ['Sunday', 'Saturday']
        self.allowed_times = None  ***REMOVED*** ['AM', 'PM']
        self.date_range = None  ***REMOVED*** (start_date, end_date)
        self.recovery_days = 0  ***REMOVED*** Days required after event
    ...
    def add_to_cpsat(
        ...
        for resident in context.residents:
            ...
            for block in context.blocks:
                ...
                ***REMOVED*** Check temporal constraints
