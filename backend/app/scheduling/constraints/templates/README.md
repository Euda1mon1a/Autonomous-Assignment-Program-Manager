...
***REMOVED******REMOVED******REMOVED*** Composite Constraints
...
***REMOVED******REMOVED*** How to Use Templates

***REMOVED******REMOVED******REMOVED*** Creating a New Hard Constraint
...
```python
***REMOVED*** Example: Custom rotation constraint
class CustomRotationConstraint(HardConstraint):
    ...
    def _violates_constraint(self, assignment, context):
        ***REMOVED*** Check if resident can take this rotation
...
***REMOVED******REMOVED******REMOVED*** Creating a New Soft Constraint
...
```python
***REMOVED*** Example: Specialty preference constraint
...
***REMOVED******REMOVED******REMOVED*** Creating a Composite Constraint
...
```python
***REMOVED*** Example: Surgical call constraint group
...
***REMOVED******REMOVED*** Common Parameters

***REMOVED******REMOVED******REMOVED*** Hard Constraint __init__()
```python
def __init__(self):
    super().__init__(
        name="ConstraintName",
        constraint_type=ConstraintType.XXX,  ***REMOVED*** Choose appropriate type
        priority=ConstraintPriority.HIGH,     ***REMOVED*** CRITICAL, HIGH, MEDIUM, LOW
    )
```

***REMOVED******REMOVED******REMOVED*** Soft Constraint __init__()
```python
def __init__(self, weight: float = 1.0):
    super().__init__(
        name="ConstraintName",
        constraint_type=ConstraintType.XXX,
        weight=weight,  ***REMOVED*** Higher = more important
        priority=ConstraintPriority.MEDIUM,
    )
```

***REMOVED******REMOVED*** Weight Guidelines for Soft Constraints
...
***REMOVED******REMOVED*** Testing Constraints

Each constraint should have unit tests:

```python
***REMOVED*** tests/scheduling/constraints/test_my_constraint.py
...
***REMOVED******REMOVED*** Registering a New Constraint
...
***REMOVED******REMOVED*** Example Implementation Files
