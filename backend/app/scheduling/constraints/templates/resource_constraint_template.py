...
class ResourceConstraintTemplate(HardConstraint):
    ...
    Examples:
        ...
        >>> constraint.max_capacity = 4  ***REMOVED*** Max 4 residents per clinic
    ...
    def __init__(self) -> None:
        ...
        self.resource_type = None  ***REMOVED*** 'clinic', 'faculty', 'room', etc.
        self.resource_id = None  ***REMOVED*** UUID of specific resource
        self.max_capacity = None  ***REMOVED*** Maximum allocation
        self.min_utilization = 0  ***REMOVED*** Minimum usage requirement
    ...
    def _get_resource_key(self, assignment: Any, context: SchedulingContext) -> Any:
        ...
        ***REMOVED*** Override in subclasses to return appropriate key
    ...
    def add_to_cpsat(
        ...
        ***REMOVED*** Group assignments by resource
        for resource_id in self._get_resources(context):
            ...
            ***REMOVED*** Add capacity constraint
            if self.max_capacity:
                model.Add(usage_sum <= self.max_capacity)

            ***REMOVED*** Add minimum utilization constraint
    ...
    def add_to_pulp(
        ...
        for resource_id in self._get_resources(context):
            ...
            ***REMOVED*** Create sum for resource usage
            usage_sum = sum(
                x.get((res.id, block.id), 0)
                for res in resource_assignments
                for block in context.blocks
    ...
    def validate(
        ...
        ***REMOVED*** Count allocations per resource
        ...
        for resource_id, count in allocation.items():
            ...
            ***REMOVED*** Check minimum utilization
    ...
    def _get_assignments_for_resource(
        ...
        ***REMOVED*** Override in subclasses
        return []
