...
Example:
    ...
    ...     ***REMOVED*** Enable overnight call scheduling
    ...     pass
"""
...
class ConstraintCategory(str, Enum):
    ...
    ACGME = "ACGME"  ***REMOVED*** Regulatory compliance
    CAPACITY = "CAPACITY"  ***REMOVED*** Resource capacity limits
    COVERAGE = "COVERAGE"  ***REMOVED*** Coverage requirements
    EQUITY = "EQUITY"  ***REMOVED*** Fairness and workload distribution
    CALL = "CALL"  ***REMOVED*** Overnight call scheduling
    FMIT = "FMIT"  ***REMOVED*** FMIT (Friday inpatient) scheduling
    SPECIALTY = "SPECIALTY"  ***REMOVED*** Specialty-specific (SM, etc.)
    RESILIENCE = "RESILIENCE"  ***REMOVED*** Resilience framework
    TEMPORAL = "TEMPORAL"  ***REMOVED*** Time-based constraints
    FACULTY = "FACULTY"  ***REMOVED*** Faculty-specific constraints


class ConstraintPriorityLevel(int, Enum):
    """Priority levels for constraint application."""

    CRITICAL = 1  ***REMOVED*** Must be satisfied (ACGME, safety)
    HIGH = 2  ***REMOVED*** Important for quality
    MEDIUM = 3  ***REMOVED*** Optimization objectives
    LOW = 4  ***REMOVED*** Nice-to-have preferences
...
class ConstraintConfig:
    ...
    weight: float = 1.0  ***REMOVED*** For soft constraints
    category: ConstraintCategory = ConstraintCategory.COVERAGE
    description: str = ""
    dependencies: List[str] = field(default_factory=list)
    conflicts_with: List[str] = field(default_factory=list)
    enable_condition: Optional[str] = None  ***REMOVED*** When to enable (documentation)
    disable_reason: Optional[str] = None  ***REMOVED*** Why disabled by default
...
class ConstraintConfigManager:
    ...
    def _initialize_default_configs(self) -> None:
        ...
        ***REMOVED*** ========================================
        ***REMOVED*** ACGME CONSTRAINTS (Always Enabled)
        ***REMOVED*** ========================================
        ...
        ***REMOVED*** ========================================
        ***REMOVED*** CAPACITY CONSTRAINTS (Always Enabled)
        ***REMOVED*** ========================================
        ...
        ***REMOVED*** ========================================
        ***REMOVED*** EQUITY CONSTRAINTS (Always Enabled)
        ***REMOVED*** ========================================
        ...
        ***REMOVED*** ========================================
        ***REMOVED*** FMIT CONSTRAINTS (Opt-in)
        ***REMOVED*** ========================================
        ...
        ***REMOVED*** ========================================
        ***REMOVED*** RESILIENCE CONSTRAINTS (Tiered)
        ***REMOVED*** ========================================
        ***REMOVED*** Tier 1: Core resilience (Enabled in resilience-aware mode)
        self._configs["HubProtection"] = ConstraintConfig(
            name="HubProtection",
            enabled=True,  ***REMOVED*** Tier 1
            priority=ConstraintPriorityLevel.MEDIUM,
            weight=15.0,
        ...
        ***REMOVED*** Tier 2: Strategic resilience (Opt-in for aggressive protection)
        self._configs["ZoneBoundary"] = ConstraintConfig(
            name="ZoneBoundary",
            enabled=False,  ***REMOVED*** Tier 2
            priority=ConstraintPriorityLevel.MEDIUM,
            weight=12.0,
            category=ConstraintCategory.RESILIENCE,
    ...
    def _apply_minimal_preset(self) -> None:
        ...
        ***REMOVED*** Disable all optional constraints
        for name in [
            "Continuity",
    ...
    def _apply_strict_preset(self) -> None:
        ...
        ***REMOVED*** Enable all constraints
        for config in self._configs.values():
            config.enabled = True
            if config.weight > 0:
                config.weight *= 2  ***REMOVED*** Double weights for strict mode
    ...
    def _apply_resilience_tier1_preset(self) -> None:
        ...
        ***REMOVED*** Tier 2 remains disabled
    ...
    def _apply_resilience_tier2_preset(self) -> None:
        ...
        ***REMOVED*** Enable all resilience constraints
        self.enable("HubProtection")
        self.enable("UtilizationBuffer")
...
def get_constraint_config() -> ConstraintConfigManager:
    ...
    if _constraint_config_manager is None:
        ...
        ***REMOVED*** Apply preset from environment if specified
