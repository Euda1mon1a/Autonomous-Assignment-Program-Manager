...
class ConstraintMetadata:
    ...
    category: str  ***REMOVED*** 'ACGME', 'CAPACITY', 'EQUITY', 'CUSTOM', etc.
    description: str = ""
    is_deprecated: bool = False
    deprecation_message: str = ""
    replacement_constraint: Optional[str] = None  ***REMOVED*** Name of replacement if deprecated
    tags: list[str] = field(default_factory=list)
    constraints_types: list[ConstraintType] = field(default_factory=list)
    is_enabled: bool = True
    author: str = ""
    since_version: str = ""  ***REMOVED*** Scheduler version when constraint was added
...
class ConstraintRegistry:
    ...
    def get(
        ...
        """
        ***REMOVED*** Use latest version if not specified
        if version is None:
    ...
    def deprecate(
        ...
        """
        if version is None:
            ***REMOVED*** Deprecate all versions
            for metadata in cls._constraints.values():
            ...
            ***REMOVED*** Deprecate specific version
            key = (name, version)
...
***REMOVED*** Initialize with built-in constraints
def _register_builtin_constraints():
    ...
    ***REMOVED*** Register ACGME constraints
    ConstraintRegistry.register(
        name="Availability",
        version="1.0",
        category="ACGME",
    ...
    ***REMOVED*** Register capacity constraints
    ConstraintRegistry.register(
    ...
    ***REMOVED*** Register equity constraints
    ConstraintRegistry.register(
        name="Equity",
        version="1.0",
        category="EQUITY",
...
***REMOVED*** Register built-in constraints on import
try:
