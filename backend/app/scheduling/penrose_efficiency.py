...
PENROSE_EFFICIENCY_LIMIT = (
    0.29  ***REMOVED*** Theoretical maximum extraction from rotating black holes (29%)
)
...
class ErgospherePeriod:
    ...
    def duration_hours(self) -> float:
        ...
        return (self.end_time - self.start_time).total_seconds() / (
            60 * 60
        )  ***REMOVED*** Convert seconds to hours
...
class RotationEnergyTracker:
    ...
    def __init__(self, initial_rotation_energy: float) -> None:
        ...
        self.max_extraction_fraction = (
            PENROSE_EFFICIENCY_LIMIT  ***REMOVED*** Penrose theoretical limit
        )
        ...
        phases.extend(
            [
                ...
                PhaseComponent(
                    ...
                    flexibility_score=flexibility
                    * 0.7,  ***REMOVED*** Slightly lower during transition
                ),
                PhaseComponent(
                    assignment_id=assignment.id,
