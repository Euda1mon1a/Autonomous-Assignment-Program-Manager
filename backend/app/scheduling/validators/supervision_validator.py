...
***REMOVED*** ACGME Supervision Constants
...
class SupervisionValidator:
    ...
    def calculate_required_faculty(self, pgy1_count: int, other_count: int) -> int:
        ...
        """
        ***REMOVED*** Calculate supervision units
        supervision_units = (pgy1_count * 2) + other_count

        if supervision_units == 0:
            return 0

        ***REMOVED*** Apply ceiling division: ceil(n/4) = (n+3)//4
    ...
    def validate_period_supervision(
        ...
        ***REMOVED*** Track supervision load distribution
        load_distribution = {
            "all_compliant": 0,
            "single_deficit": 0,
            "multi_deficit": 0,
    ...
    def validate_specialty_supervision(
        ...
        """
        ***REMOVED*** Check if any faculty has required specialty
    ...
    def validate_procedure_supervision(
        ...
        Returns:
            (is_valid, error_message) tuple
        """
        ***REMOVED*** Check if any faculty certified for procedure
        for faculty in supervising_faculty:
