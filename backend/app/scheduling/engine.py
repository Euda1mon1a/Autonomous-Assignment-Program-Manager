    ...
    ***REMOVED*** Available algorithms
    ...
    def generate(
        ...
        ***REMOVED*** Store as instance attribute for _populate_resilience_data to access
        ...
        try:
            ...
            ***REMOVED*** Issue ***REMOVED***2: Delete existing assignments for this date range to avoid duplicates
            ...
            ***REMOVED*** Step 4: Create scheduling context (with resilience data if available)
            context = self._build_context(
                ...
                existing_assignments=fmit_assignments,
            )
    ...
    def _build_context(
        ...
        Args:
            ...
            existing_assignments: Pre-existing assignments to preserve (e.g., FMIT)
    ...
    def _run_solver(
        ...
        try:
            ...
            ***REMOVED*** Pass existing_assignments from context to solver
            return solver.solve(context, existing_assignments=context.existing_assignments)
        except Exception as e:
