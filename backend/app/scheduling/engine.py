    ...
    ***REMOVED*** Available algorithms
    ...
    def _populate_resilience_data(
        ...
        try:
            ...
            ***REMOVED*** This is already calculated in check_health()
            ...
            ***REMOVED*** Get N-1 vulnerable faculty from latest contingency analysis
            ...
            ***REMOVED*** Get preference trails from stigmergy (for future use)
    ...
    def _create_assignments_from_result(
        ...
        for person_id, block_id, template_id in result.assignments:
            ***REMOVED*** Get explanation for this assignment if available
            explanation = result.explanations.get((person_id, block_id))

            ***REMOVED*** Extract confidence and score from explanation
            ...
            if explanation:
                ...
                if alternatives:
                    alternatives_json = alternatives[:3]  ***REMOVED*** Top 3 alternatives

                ***REMOVED*** Compute audit hash for integrity verification
