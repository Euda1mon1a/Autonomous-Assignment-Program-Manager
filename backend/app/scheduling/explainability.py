...
class ExplainabilityService:
    ...
    Usage:
        ...
        ***REMOVED*** During assignment selection:
    ...
    def __init__(
        ...
        ***REMOVED*** Cache for person names
    ...
    def explain_assignment(
        ...
        Returns:
            DecisionExplanation: Complete explanation object with:
                ...
                - margin_vs_next_best: Score difference from ***REMOVED***2 candidate
                - confidence: Level (high/medium/low)
        ...
        ***REMOVED*** Evaluate constraints for the selected person
        constraints_evaluated = self._evaluate_constraints(
            selected_person, block, template
        )

        ***REMOVED*** Build alternatives list (top 3, excluding selected)
        ...
        ***REMOVED*** Calculate margin vs next best
        margin = 0.0
        if alternatives:
            margin = selected_score - alternatives[0].score

        ***REMOVED*** Generate trade-off summary
        ...
        ***REMOVED*** Check for hard constraint violations
        hard_satisfied = all(
    ...
    def _build_inputs(
        ...
        return DecisionInputs(
            ...
            overrides_in_effect=[],  ***REMOVED*** NOTE: Populate when override tracking is implemented
        )
    ...
    def _evaluate_constraints(
        ...
        ***REMOVED*** Check availability (hard constraint)
        ...
        ***REMOVED*** Check ACGME 80-hour rule (hard constraint)
        ***REMOVED*** Simplified check - actual implementation would use validator
        evaluations.append(
            ConstraintEvaluation(
                constraint_name="ACGME 80-Hour Rule",
                constraint_type=ConstraintType.HARD,
                status=ConstraintStatus.SATISFIED,  ***REMOVED*** Assume satisfied unless we have data
                weight=100.0,
                penalty=0.0,
        ...
        ***REMOVED*** Check ACGME 1-in-7 rule (hard constraint)
        evaluations.append(
            ConstraintEvaluation(
        ...
        ***REMOVED*** Check clinic capacity if template provided (hard constraint)
        ...
        ***REMOVED*** Equity (soft constraint)
        evaluations.append(
            ConstraintEvaluation(
        ...
        ***REMOVED*** Continuity (soft constraint)
        evaluations.append(
            ConstraintEvaluation(
    ...
    def _build_alternatives(
        ...
        ***REMOVED*** Sort candidates by score (descending)
        ...
        ***REMOVED*** Take top 3
        for candidate in sorted_candidates[:3]:
            ...
            ***REMOVED*** Determine rejection reasons
            rejection_reasons = []
            violations = []
            ...
            ***REMOVED*** Check if they have more assignments (equity reason)
    ...
    def _calculate_confidence(
        ...
        factors = []
        score = 0.5  ***REMOVED*** Start at medium

        ***REMOVED*** Factor 1: Margin vs next best
        if alternatives:
            margin = selected_score - alternatives[0].score
            if margin > 100:
                score += 0.2
        ...
        ***REMOVED*** Factor 2: Number of candidates
        if num_candidates == 1:
            score += 0.1
        ...
        ***REMOVED*** Factor 3: Hard constraint violations
        hard_violations = [
            c
        ...
        ***REMOVED*** Factor 4: Soft constraint penalties
