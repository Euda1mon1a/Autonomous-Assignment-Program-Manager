...
***REMOVED*** Context variables for async-safe storage
...
def initialize_context(
    ...
    ***REMOVED*** Calculate depth and chain
    depth = 0
    chain = []

    if parent_id:
        ***REMOVED*** This is a nested request
        parent_depth = get_request_depth()
        depth = parent_depth + 1

        ***REMOVED*** Extend the chain
        parent_chain = get_request_chain()
        chain = parent_chain + [request_id]
    else:
        ***REMOVED*** This is a root request
        chain = [request_id]

    ***REMOVED*** Set context variables
...
class CorrelationContextManager:
    ...
    Usage:
        with CorrelationContextManager(correlation_id="abc-123"):
            ***REMOVED*** Code here has correlation context set
            process_request()
        ***REMOVED*** Context is automatically cleared
    """
