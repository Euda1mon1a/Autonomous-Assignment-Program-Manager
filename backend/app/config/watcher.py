...
class ConfigFileHandler(FileSystemEventHandler):
    ...
    def __init__(
        ...
        self._debounce_delay = 1.0  ***REMOVED*** Wait 1 second before processing change
    ...
    def on_modified(self, event: FileSystemEvent) -> None:
        ...
        ***REMOVED*** Check if this is a watched file
    ...
    def _debounced_change(self, file_path: Path) -> None:
        ...
        """
        ***REMOVED*** Cancel existing timer for this file
        if file_path in self._debounce_timers:
            self._debounce_timers[file_path].cancel()

        ***REMOVED*** Create new timer
...
class ConfigWatcher:
    ...
    def __init__(
        ...
        ***REMOVED*** Add initial config files
        if config_files:
    ...
    def add_file(self, file_path: Path) -> None:
        ...
        ***REMOVED*** If watcher is running, restart to pick up new file
        if self._running:
            self.restart()
    ...
    def remove_file(self, file_path: Path) -> None:
        ...
        if resolved_path in self.config_files:
            ...
            ***REMOVED*** If watcher is running, restart to update watch list
            if self._running:
                self.restart()
    ...
    def _on_file_change(self, file_path: Path) -> None:
        ...
        ***REMOVED*** Invoke all registered callbacks
