...
Example:
    ...
    ***REMOVED*** Validate before migration
    ...
    ***REMOVED*** Execute migration if validation passes
    if pre_result.is_valid:
        migrator.execute_migration(...)

    ***REMOVED*** Validate after migration
...
class ValidationRecord(Base):
    ...
    validation_type = Column(String(50), nullable=False)  ***REMOVED*** 'pre' or 'post'

    ***REMOVED*** Results
    is_valid = Column(String(10), nullable=False)  ***REMOVED*** 'true' or 'false'
...
class MigrationValidator:
    ...
    def validate_pre_migration(
        ...
        ***REMOVED*** Save results if requested
        if save_results:
    ...
    def _save_validation_record(
        ...
        try:
            ***REMOVED*** Create summary of issues
            issues_summary = "\n".join(
                [
                    f"[{issue.severity.upper()}] {issue.message}"
                    for issue in result.issues[:100]  ***REMOVED*** Limit to first 100
                ]
            )
    ...
    ***REMOVED*** Built-in validation checks
            ...
            ***REMOVED*** Find duplicates
            ...
            if duplicates:
                result.add_issue(
                    ...
                    f"Values: {[d[0] for d in duplicates[:10]]}",  ***REMOVED*** First 10
                )
