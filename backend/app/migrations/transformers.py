...
class DataTransformer:
    ...
    def capitalize_name(record: Any) -> dict[str, Any]:
        ...
        ***REMOVED*** Handle special cases like "McDonald", "O'Brien"
    ...
    def normalize_phone_number(record: Any, field: str = 'phone') -> dict[str, Any]:
        ...
        ***REMOVED*** Remove all non-digits
        digits = re.sub(r'\D', '', phone)

        ***REMOVED*** Format if 10 digits
        if len(digits) == 10:
    ...
    def ensure_uuid(record: Any, field: str = 'id') -> dict[str, Any]:
        ...
        ***REMOVED*** If already UUID, return empty
        if isinstance(value, UUID):
            return {}

        ***REMOVED*** Try to parse string as UUID
        try:
    ...
    def ensure_datetime(record: Any, field: str) -> dict[str, Any]:
        ...
        ***REMOVED*** If already datetime, return empty
        if isinstance(value, datetime):
            return {}

        ***REMOVED*** If date, convert to datetime
        if isinstance(value, date):
            return {field: datetime.combine(value, datetime.min.time())}

        ***REMOVED*** Try to parse string
    ...
    def convert_to_boolean(record: Any, field: str) -> dict[str, Any]:
        ...
        ***REMOVED*** Already boolean
        if isinstance(value, bool):
            return {}

        ***REMOVED*** String values
        if isinstance(value, str):
...
***REMOVED*** Convenience functions for common transformations
