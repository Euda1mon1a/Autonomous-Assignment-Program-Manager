...
async def update_job(
    ...
    ***REMOVED*** Check permissions
    ...
    try:
        ...
        ***REMOVED*** Update in database
        updated_job = persistence.update_job(job_id, **update_data)

        if not updated_job:
            raise HTTPException(status_code=404, detail="Job not found")

        ***REMOVED*** If job was enabled/disabled, sync with scheduler
...
async def get_job_executions(
    ...
    try:
        ...
        ***REMOVED*** Count total executions
        total = (
