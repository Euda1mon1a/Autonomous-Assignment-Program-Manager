...
async def list_zones(
    ...
    ***REMOVED*** Use the new BlastRadiusService
...
async def get_blast_radius_report(
    ...
    ***REMOVED*** Use the new BlastRadiusService for calculation
    result = blast_radius_service.calculate_blast_radius(check_all_zones=True)

    ***REMOVED*** Convert zone details to schema format
    zone_reports = [
        SchemaZoneHealth(
...
async def create_zone(
    ...
    ***REMOVED*** Get zone details for response
...
async def record_zone_incident(
    ...
    return ZoneIncidentResponse(
        ...
        description=description,
        severity=severity,
        started_at=None,  ***REMOVED*** Not available from service result
