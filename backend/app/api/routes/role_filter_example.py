...
async def get_dashboard(
    ...
    """
    ***REMOVED*** Build complete dashboard data
    raw_data = {
        "schedules": [
            {
                "id": 1,
    ...
    ***REMOVED*** Apply role-based filtering
...
async def get_my_schedule(
    ...
    """
    ***REMOVED*** Simulate fetching user's schedule
    all_schedules = [
        {
            "id": 1,
            "person_id": str(current_user.id),
    ...
    ***REMOVED*** Filter to only user's schedules
