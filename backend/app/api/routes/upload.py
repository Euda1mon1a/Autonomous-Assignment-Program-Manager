...
def get_upload_service() -> UploadService:
    ...
    ***REMOVED*** Determine storage backend from config
    storage_type = getattr(settings, "UPLOAD_STORAGE_BACKEND", "local")

    if storage_type == "s3":
        ***REMOVED*** S3 storage configuration
...
async def download_file(
    ...
    try:
        ...
        ***REMOVED*** Create streaming response
