...
***REMOVED*** ============================================================================
***REMOVED*** Webhook Management Endpoints
***REMOVED*** ============================================================================
...
async def list_webhooks(
    ...
    **Required permissions:** Authenticated user
    ...
    return WebhookListResponse(
        webhooks=webhooks,
        total=len(webhooks),  ***REMOVED*** Note: This is limited by the query
        skip=skip,
        limit=limit
    )
...
async def update_webhook(
    ...
    **Required permissions:** Authenticated user
    """
    ***REMOVED*** Convert webhook_data to dict, excluding None values
    updates = webhook_data.model_dump(exclude_none=True)

    ***REMOVED*** Convert URL to string if present
    if "url" in updates:
...
***REMOVED*** ============================================================================
***REMOVED*** Event Trigger Endpoints
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Delivery Monitoring Endpoints
***REMOVED*** ============================================================================
...
async def list_deliveries(
    ...
    **Required permissions:** Authenticated user
    ...
    return WebhookDeliveryListResponse(
        ...
        total=len(deliveries),  ***REMOVED*** Note: This is limited by the query
        skip=skip,
        limit=limit
    )
...
async def retry_delivery(
    ...
    ***REMOVED*** Return updated delivery status
    delivery = await service.get_delivery_status(db, retry_data.delivery_id)
    return delivery


***REMOVED*** ============================================================================
***REMOVED*** Dead Letter Queue Endpoints
***REMOVED*** ============================================================================
...
async def list_dead_letters(
    ...
    **Required permissions:** Authenticated user
    ...
    return WebhookDeadLetterListResponse(
        ...
        total=len(dead_letters),  ***REMOVED*** Note: This is limited by the query
        skip=skip,
        limit=limit
    )
...
async def resolve_dead_letter(
    ...
    ***REMOVED*** Return updated dead letter
