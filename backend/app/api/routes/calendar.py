...
def create_subscription(
    ...
    try:
        ...
        ***REMOVED*** Generate subscription URL
        ***REMOVED*** In production, this would use the actual server URL from config
        ...
        return CalendarSubscriptionResponse(
            ...
            person_id=request.person_id,
            created_at=None,  ***REMOVED*** Would come from database
...
def get_subscription_feed(
    ...
    try:
        ...
        ***REMOVED*** Generate calendar for the next 6 months
