...
def export_all_calendars(
    ...
    try:
        ...
        ***REMOVED*** Return ICS file as download
        return Response(
            content=ics_content,
...
***REMOVED*** =============================================================================
***REMOVED*** Webcal Subscription Endpoints
***REMOVED*** =============================================================================
...
def get_subscription_feed(
    ...
    **Cache behavior:**
    ...
    """
    try:
        ***REMOVED*** Validate token and get person_id
        ...
        ***REMOVED*** Generate calendar: today through 6 months ahead
        ...
        ***REMOVED*** Return ICS with proper headers for calendar apps
        return Response(
            content=ics_content,
            media_type="text/calendar",
            headers={
                "Content-Type": "text/calendar; charset=utf-8",
                ***REMOVED*** Suggest 15-minute refresh, but allow caching
                "Cache-Control": "private, max-age=900",
                ***REMOVED*** Prevent transformation by proxies
...
def revoke_subscription(
    ...
    Returns:
        Success message
    """
    ***REMOVED*** Verify the subscription exists and belongs to the user
