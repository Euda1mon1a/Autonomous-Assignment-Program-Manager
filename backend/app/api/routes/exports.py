...
async def run_export_job(
    ...
    ***REMOVED*** Verify job exists
    ...
    try:
        ***REMOVED*** Queue job execution via Celery
...
async def get_export_stats(
    ...
    try:
        ...
        ***REMOVED*** Count successful executions
        ...
        ***REMOVED*** Count failed executions
        ...
        ***REMOVED*** Calculate average runtime
        ...
        ***REMOVED*** Calculate total rows and bytes
