...
async def metrics_health() -> dict[str, Any]:
    ...
    ***REMOVED*** Check if prometheus is available
    prometheus_available = metrics._enabled

    ***REMOVED*** List active metric collectors
    collectors = []
...
async def export_metrics(request: Request) -> Response:
    ...
    try:
        ...
        ***REMOVED*** Generate metrics in Prometheus text format
...
async def metrics_summary() -> dict[str, Any]:
    ...
    ***REMOVED*** Note: Extracting current values from Prometheus metrics is complex
    ***REMOVED*** This is a simplified version showing structure
    ***REMOVED*** In production, you might want to use prometheus_client's internal APIs

    summary = {
        "status": "enabled",
        "timestamp": None,  ***REMOVED*** Would add current timestamp
        "http": {
...
async def reset_metrics() -> dict[str, Any]:
    ...
    ***REMOVED*** Note: Prometheus metrics cannot easily be reset
    ***REMOVED*** This would require recreating the metrics registry
    ***REMOVED*** For now, return a warning
