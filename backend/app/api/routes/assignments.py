...
def validate_assignment_acgme(
    ...
    """
    ***REMOVED*** Get the block to determine date range for validation
    ...
    ***REMOVED*** Validate a window around the assignment date (e.g., +/- 4 weeks)
    ...
    ***REMOVED*** Check if override was provided for violations
...
def create_assignment(
    ...
    """
    ***REMOVED*** Check for duplicate (one person per block)
    ...
    ***REMOVED*** Create assignment (exclude override_reason from model fields)
    ...
    ***REMOVED*** Add override to notes if provided
    ...
    ***REMOVED*** Build response with warnings
...
def update_assignment(
    ...
    ***REMOVED*** Optimistic locking: check if updated_at matches
    ...
    ***REMOVED*** Exclude updated_at and override_reason from the update data
