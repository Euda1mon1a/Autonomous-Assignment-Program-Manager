...
***REMOVED*** Core infrastructure routes
...
api_router.include_router(call_assignments.router)  ***REMOVED*** prefix="/call-assignments" defined in router
...
api_router.include_router(fatigue_risk.router)  ***REMOVED*** prefix="/fatigue-risk" defined in router
api_router.include_router(
...
api_router.include_router(portal.router)  ***REMOVED*** prefix="/portal" defined in router
