...
async def claude_chat(
    ...
    """
    try:
        ***REMOVED*** Verify user has access to the program
        ***REMOVED*** This should be validated in your access control layer
...
async def claude_chat_stream(
    ...
    async def stream_generator() -> AsyncGenerator[str, None]:
        try:
            ***REMOVED*** Stream from Claude service
            async for update in claude_service.stream_task(
                request=request,
                user_id=current_user.id,
            ):
                ***REMOVED*** Send as SSE format
