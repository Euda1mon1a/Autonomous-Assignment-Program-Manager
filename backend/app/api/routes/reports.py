...
async def generate_schedule_report(
    ...
    try:
        ...
        ***REMOVED*** Create filename
        filename = (
            f"schedule_report_{request.start_date}_to_{request.end_date}.pdf"
        )

        ***REMOVED*** Return PDF as streaming response
...
async def generate_faculty_summary_report(
    ...
    try:
        ...
        ***REMOVED*** For now, use analytics template
        ***REMOVED*** TODO: Implement dedicated FacultySummaryReportTemplate
