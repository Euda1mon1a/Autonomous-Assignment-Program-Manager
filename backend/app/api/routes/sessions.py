...
async def logout_specific_session(
    ...
    """
    ***REMOVED*** Get the session to verify ownership
    ...
    ***REMOVED*** Verify session belongs to current user
...
async def logout_other_sessions(
    ...
    ***REMOVED*** Logout all sessions except current
