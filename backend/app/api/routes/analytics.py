...
async def get_current_metrics(
    ...
    """
    try:
        ***REMOVED*** Get the most recent successful schedule run
        latest_run = (
        ...
        ***REMOVED*** Use analytics engine to get comprehensive data
        ...
        ***REMOVED*** Convert to response schema
        return ScheduleVersionMetrics(
            ...
            preferenceSatisfaction=MetricValue(
                ...
                value=0.0,  ***REMOVED*** Placeholder - would calculate from preferences
                unit="%",
                status="good",
...
async def get_metrics_history(
    ...
    """
    try:
        ***REMOVED*** Get all schedule runs in the date range
        runs = (
            db.query(ScheduleRun)
            .filter(
                and_(
        ...
        for run in runs:
            try:
                ...
                ***REMOVED*** Extract the requested metric
                value = None
        ...
        ***REMOVED*** Determine trend direction
        if len(values) >= 2:
            first_half_avg = statistics.mean(values[:len(values)//2])
            second_half_avg = statistics.mean(values[len(values)//2:])
            if metric_name == "violations":
                ***REMOVED*** For violations, lower is better
                trend = "improving" if second_half_avg < first_half_avg else "declining"
            else:
                ***REMOVED*** For other metrics, higher is better
                trend = "improving" if second_half_avg > first_half_avg else "declining"
...
async def get_fairness_trend(
    ...
    try:
        ...
        ***REMOVED*** Get schedule runs in the period
        runs = (
            db.query(ScheduleRun)
            .filter(
                and_(
        ...
        for run in runs:
            try:
                ...
                gini = 1 - fairness_index  ***REMOVED*** Convert back to Gini
        ...
        ***REMOVED*** Find most/least fair periods
...
async def compare_versions(
    ...
    try:
        ...
        ***REMOVED*** For now, treat version as run_id
        ***REMOVED*** In a more sophisticated system, you might have version management
        ...
        ***REMOVED*** Add violations comparison
        ...
        metric_comparisons.append(
            VersionMetricComparison(
                ...
                improvement=violations_diff < 0  ***REMOVED*** Lower is better
            )
        )
        ...
        ***REMOVED*** Calculate overall improvement
        ...
        ***REMOVED*** Calculate assignment changes (simplified - would need more complex logic)
...
async def what_if_analysis(
    ...
    try:
        ...
        ***REMOVED*** Simulate the changes (simplified - in production would create temp tables)
        ***REMOVED*** For now, just provide estimated impacts based on change types
        ...
        ***REMOVED*** Analyze each change
        for change in proposed_changes:
            ...
            if person:
                ...
                ***REMOVED*** Estimate workload change
                ...
                ***REMOVED*** Check for potential violations
        ...
        ***REMOVED*** Estimate fairness impact (simplified)
        ...
        ***REMOVED*** Overall assessment
        ...
        return WhatIfResult(
            ...
            resolvedViolations=[],  ***REMOVED*** Would need to check if changes fix existing violations
...
async def export_for_research(
    ...
    """
    try:
        ***REMOVED*** Get all data in date range
        blocks = (
            db.query(Block)
            .filter(
                and_(
        ...
        ***REMOVED*** Build resident workload data
        ...
        for resident in residents:
            ...
            ***REMOVED*** Count clinical vs non-clinical (simplified)
            clinical_blocks = len(person_assignments)  ***REMOVED*** Would need more logic
        ...
        ***REMOVED*** Build rotation coverage data
        ...
        for rotation_id, data in rotation_counts.items():
            ...
            rotation_coverage.append(
                RotationCoverageData(
                    ...
                    rotationType="clinical",  ***REMOVED*** Would need more logic
                    activityType="clinical",
                    totalAssignments=data["assignments"],
                    uniqueResidents=len(data["residents"]),
                    averageDuration=4.0  ***REMOVED*** Placeholder
                )
            )

        ***REMOVED*** Compliance data
        runs = (
            db.query(ScheduleRun)
            .filter(
                and_(
        ...
        compliance_data = ComplianceData(
            ...
            violationsByType={"unspecified": total_violations},  ***REMOVED*** Would need more detail
            violationsBySeverity={"high": total_violations},  ***REMOVED*** Would need more detail
            overrideCount=total_overrides
        )

        ***REMOVED*** Calculate aggregate metrics
        assignment_dicts = [
