...
async def optimize_template_selection(
    ...
    ***REMOVED*** Check permissions
    ...
    try:
        ***REMOVED*** Build scheduling context from database
        ...
        ***REMOVED*** Convert desirability mappings
        ...
        ***REMOVED*** Quantum advantage estimate
        ...
        if benchmarks:
            ...
            if greedy_time > 0 and qubo_improvement > 0:
                ***REMOVED*** Simple heuristic: advantage = quality_improvement / time_overhead
