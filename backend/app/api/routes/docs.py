...
def _get_doc_generator(request: Request) -> DocumentationGenerator:
    ...
    """
    ***REMOVED*** Cache the generator in the app state to avoid recreating it
...
async def get_endpoint_documentation(
    ...
    Example:
        ```bash
        ***REMOVED*** Get Markdown documentation for GET /api/v1/people
        curl "http://localhost:8000/api/v1/docs/endpoint?path=/api/v1/people&method=GET"

        ***REMOVED*** Get JSON documentation for POST /api/v1/assignments
...
async def get_code_examples(
    ...
    Example:
        ```bash
        ***REMOVED*** Get all code examples for GET /api/v1/people
        curl "http://localhost:8000/api/v1/docs/examples?path=/api/v1/people&method=GET"

        ***REMOVED*** Get only Python example
