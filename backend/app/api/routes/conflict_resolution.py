...
***REMOVED*** ============================================================================
***REMOVED*** Schemas for list endpoint
***REMOVED*** ============================================================================
...
def list_conflicts(
    ...
    ***REMOVED*** Apply filters with validation
    if types:
        try:
    ...
    ***REMOVED*** Apply sorting (whitelist allowed fields)
    sortable_fields = {
    ...
    ***REMOVED*** Convert to response items
    items = []
