...
def require_resource_access(resource: ResourceType):
    ...
    Example:
        ...
        def get_schedules(
            ...
            ***REMOVED*** User has been verified to have access to schedules
            pass
    """
    def check_access(
...
def require_admin():
    ...
    Example:
        ...
        def create_user(
            ...
            ***REMOVED*** User has been verified to be admin
            pass
    """
    def check_admin(
        current_user: User = Depends(get_current_active_user)
...
def apply_role_filter(
    ...
    Example:
        ...
        def get_dashboard(
            ...
            ***REMOVED*** Build raw data
            data = {
                "schedules": [...],
                "compliance": [...],
                "users": [...]
            }
            ***REMOVED*** Apply filtering
...
def filter_response(filter_func: Callable = None):
    ...
    Example:
        ...
        async def get_dashboard(
            ...
            ***REMOVED*** Return raw data - will be filtered automatically
            return {
                "schedules": [...],
                "compliance": [...],
                "users": [...]
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ***REMOVED*** Get current user from kwargs
            current_user = kwargs.get('current_user')
            if not current_user:
                ***REMOVED*** Try to find user in args
                for arg in args:
            ...
            ***REMOVED*** If result is a dict and we have a user, filter it
...
def check_endpoint_access(endpoint_category: str):
    ...
    Example:
        ...
        def get_compliance_report(
            ...
            ***REMOVED*** User has been verified to have access to compliance endpoints
            pass
    """
    def check_access(
        current_user: User = Depends(get_current_active_user)
