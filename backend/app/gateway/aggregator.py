...
class AggregationStrategy(str, Enum):
    ...
    MERGE = "merge"  ***REMOVED*** Merge all responses into single object
    ARRAY = "array"  ***REMOVED*** Collect responses into array
    FIRST_SUCCESS = "first_success"  ***REMOVED*** Return first successful response
    FASTEST = "fastest"  ***REMOVED*** Return fastest response
    CONSENSUS = "consensus"  ***REMOVED*** Return response agreed upon by majority
    WATERFALL = "waterfall"  ***REMOVED*** Try services in order until success
...
class ResponseAggregator:
    ...
    async def aggregate(
        ...
        """
        ***REMOVED*** Filter successful responses
        successful_responses = [r for r in responses if r.success]

        ***REMOVED*** Check minimum success count
        ...
        ***REMOVED*** Apply aggregation strategy
    ...
    async def aggregate_parallel(
        ...
        ***REMOVED*** Execute calls in parallel
    ...
    async def _merge_responses(
        ...
        ***REMOVED*** Merge data
        if self.config.merge_strategy == "deep":
            ...
            ***REMOVED*** Shallow merge
            for response in responses:
                if isinstance(response.data, dict):
                    result["data"].update(response.data)
                else:
                    ***REMOVED*** If not dict, store under service name
    ...
    async def _array_responses(
        ...
        ***REMOVED*** Extract array key if specified
    ...
    async def _consensus_response(
        ...
        ***REMOVED*** Find matching response
    ...
    def _deep_merge(self, dicts: list[Any]) -> dict[str, Any]:
        ...
        for d in dicts:
            ...
            for key, value in d.items():
                if key in result:
                    ***REMOVED*** Key exists - merge values
                    if isinstance(result[key], dict) and isinstance(value, dict):
                        result[key] = self._deep_merge([result[key], value])
                    elif isinstance(result[key], list) and isinstance(value, list):
                        result[key].extend(value)
                    else:
                        ***REMOVED*** Overwrite with new value
                        result[key] = value
                else:
                    result[key] = value
