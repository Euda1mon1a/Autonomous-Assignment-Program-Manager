...
class QueryTokenizer:
    ...
    ***REMOVED*** Common stop words to filter out
    STOP_WORDS = {
...
class SpellCorrector:
    ...
    def suggest(self, word: str, max_distance: int = 2) -> list[str]:
        ...
        ***REMOVED*** If word is in vocabulary, no correction needed
        ...
        ***REMOVED*** Sort by edit distance and return top 5
...
class TextHighlighter:
    ...
    def highlight(
        ...
        ***REMOVED*** Find first match position
        first_match = -1
        for term in terms:
        ...
        ***REMOVED*** Extract snippet around match
        if first_match == -1:
...
class FullTextSearchService:
    ...
    async def search(self, search_request: SearchRequest) -> SearchResponse:
        ...
        ***REMOVED*** Sort by relevance score
    ...
    async def _search_persons(
        ...
        ***REMOVED*** Build search conditions
        conditions = []
        ...
        ***REMOVED*** Apply filters
        ...
        for person in persons:
            ***REMOVED*** Calculate relevance score
    ...
    async def _search_assignments(
        ...
        ***REMOVED*** Search by person name or rotation
        conditions = []
        for token in tokens:
            conditions.append(
                or_(
    ...
    def _calculate_facets(
        ...
        for result in results:
            ***REMOVED*** Entity type facet
            facets["type"][result.type] += 1

            ***REMOVED*** Entity-specific facets
            if result.entity:
        ...
        ***REMOVED*** Convert defaultdict to regular dict
        return {
            key: dict(value_dict)
