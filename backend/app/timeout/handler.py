...
***REMOVED*** Context variable for tracking timeout state
...
class TimeoutHandler:
    ...
    async def __aexit__(self, exc_type, exc_val, exc_tb):
        ...
        ***REMOVED*** Handle asyncio.CancelledError as timeout
        ...
        ***REMOVED*** Handle asyncio.TimeoutError
