...
class ScheduleUpdatedEvent(BaseModel):
    ...
    update_type: str  ***REMOVED*** "generated", "modified", "regenerated"
...
class AssignmentChangedEvent(BaseModel):
    ...
    change_type: str  ***REMOVED*** "created", "updated", "deleted"
...
class SwapRequestedEvent(BaseModel):
    ...
    swap_type: str  ***REMOVED*** "one_to_one", "absorb"
...
class ConflictDetectedEvent(BaseModel):
    ...
    person_id: UUID
    conflict_type: str  ***REMOVED*** "double_booking", "acgme_violation", "absence_overlap"
...
class ResilienceAlertEvent(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.utcnow)
    alert_type: str  ***REMOVED*** "utilization_high", "n1_failure", "n2_failure", "defense_level_change"
    severity: str  ***REMOVED*** "green", "yellow", "orange", "red", "black"
