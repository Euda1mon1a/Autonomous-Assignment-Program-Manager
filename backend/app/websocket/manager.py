...
class ConnectionManager:
    ...
    def __init__(self):
        ...
        ***REMOVED*** Map of user_id -> list of connections (supports multiple tabs)
        self._connections: dict[UUID, list[Connection]] = defaultdict(list)

        ***REMOVED*** Map of schedule_id -> set of user_ids watching
        self._schedule_watchers: dict[UUID, set[UUID]] = defaultdict(set)

        ***REMOVED*** Map of person_id -> set of user_ids (for person-specific events)
    ...
    async def connect(self, websocket: WebSocket, user_id: UUID) -> Connection:
        ...
        ***REMOVED*** Send connection acknowledgment
...
***REMOVED*** Global connection manager instance
...
***REMOVED*** Convenience functions for broadcasting events
...
async def broadcast_swap_requested(
    ...
    ***REMOVED*** Notify target if specified
    if target_person_id:
...
async def broadcast_resilience_alert(
    ...
    ***REMOVED*** Broadcast to all users for system-wide alerts
    await manager.broadcast_to_all(event)
