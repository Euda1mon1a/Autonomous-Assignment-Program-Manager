    ...
    ***REMOVED*** Constants
    ...
    def generate_compliance_data(
        ...
        Example:
            ...
            ...     pgy_levels=[1],  ***REMOVED*** Only PGY-1 residents
        ...
        ***REMOVED*** Build resident query with filters
        ...
        ***REMOVED*** Get all assignments for the period
        assignments = (
        ...
        ***REMOVED*** Get all absences for the period
        absences = (
    ...
    def _analyze_resident(
        ...
        ***REMOVED*** Determine max weekly hours
    ...
    def _calculate_hours_by_week(
        ...
        for assignment in assignments:
            ...
            ***REMOVED*** Get Monday of the week (ISO week start)
    ...
    def _calculate_rolling_averages(
        ...
        ***REMOVED*** Calculate rolling averages
    ...
    def _calculate_leave_utilization(
        ...
        for absence in absences:
            ***REMOVED*** Calculate overlapping days within period
        ...
        ***REMOVED*** Calculate average per resident
        avg_absence_days = (
            total_absence_days / len(residents) if residents else 0
        )

        ***REMOVED*** Period length in days
        period_days = (end_date - start_date).days + 1

        ***REMOVED*** Absence rate as percentage
    ...
    def _calculate_coverage_metrics(
        ...
        """
        ***REMOVED*** Get total workday blocks (exclude weekends)
        total_workday_blocks = (
            self.db.query(Block)
            .filter(
                Block.date >= start_date,
                Block.date <= end_date,
                Block.is_weekend == False,  ***REMOVED*** noqa: E712
            )
            .count()
        )
    ...
    def _calculate_trend_data(
        ...
        ***REMOVED*** Calculate weekly trends
        current = start_date
        while current <= end_date:
            week_end = min(current + timedelta(days=6), end_date)

            ***REMOVED*** Hours this week
            week_assignments = [
                a
    ...
    def export_to_pdf(
        ...
        ***REMOVED*** Custom styles
        title_style = ParagraphStyle(
            ...
            fontSize=24,
            textColor=colors.HexColor("***REMOVED***1f4788"),
            spaceAfter=30,
        )
        ...
        ***REMOVED*** ACGME Violations
        if report_data.acgme_violations:
            ...
            for violation in report_data.acgme_violations[:20]:  ***REMOVED*** Limit to 20
                viol_text = (
    ...
    def generate_trend_chart(
        ...
        if not trend_data:
            ***REMOVED*** Return empty image
            return b""

        ***REMOVED*** Extract data based on chart type
