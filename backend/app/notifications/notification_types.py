...
::
    ...
    ***REMOVED*** Get template metadata
    template = get_template(NotificationType.ACGME_WARNING)
    print(f"Priority: {template.priority}")  ***REMOVED*** "high"
    print(f"Channels: {template.channels}")  ***REMOVED*** ["in_app", "email", "webhook"]
"""
...
class NotificationTemplate:
    ...
    body_template: str
    channels: list[str]  ***REMOVED*** e.g., ['in_app', 'email', 'webhook']
    priority: str = "normal"  ***REMOVED*** high, normal, low
