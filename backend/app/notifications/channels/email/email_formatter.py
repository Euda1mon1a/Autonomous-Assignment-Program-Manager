...
class EmailFormatter:
    ...
    def format_plain_text(self, text: str, max_line_length: int = 78) -> str:
        ...
        for paragraph in text.split("\n\n"):
            ...
            for word in words:
                word_length = len(word) + 1  ***REMOVED*** +1 for space
            ...
            lines.append("")  ***REMOVED*** Paragraph break
    ...
    def plain_to_html(self, text: str) -> str:
        ...
        ***REMOVED*** Convert newlines to <br>
        text = text.replace("\n\n", "</p><p>")
        text = text.replace("\n", "<br>")

        ***REMOVED*** Wrap in paragraphs
        text = f"<p>{text}</p>"

        ***REMOVED*** Convert URLs to links
