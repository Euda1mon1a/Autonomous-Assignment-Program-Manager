...
EMAIL_TEMPLATES = {
    "acgme_warning": {
        ...
        "html": """
<h2 style="color: ***REMOVED***dc3545;">ACGME Compliance Alert</h2>
...
<p style="margin-top: 20px;">
    <a href="{{action_url}}" style="background-color: ***REMOVED***dc3545; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px;">
        Review Details
    </a>
</p>
        """,
...
<p style="margin-top: 20px;">
    <a href="{{schedule_url}}" style="background-color: ***REMOVED***003366; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px;">
        View Schedule
    </a>
</p>
        """,
...
def render_email_template(
    ...
    ***REMOVED*** Simple string replacement
