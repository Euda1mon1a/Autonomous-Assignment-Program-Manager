...
class BounceType(str, Enum):
    ...
    HARD = "hard"  ***REMOVED*** Permanent failure (invalid address)
    SOFT = "soft"  ***REMOVED*** Temporary failure (mailbox full)
    COMPLAINT = "complaint"  ***REMOVED*** Spam complaint
    BLOCK = "block"  ***REMOVED*** Blocked by recipient
...
class BounceHandler:
    ...
    ***REMOVED*** Thresholds for suppression
    HARD_BOUNCE_THRESHOLD = 1  ***REMOVED*** Suppress after 1 hard bounce
    SOFT_BOUNCE_THRESHOLD = 3  ***REMOVED*** Suppress after 3 soft bounces
    COMPLAINT_THRESHOLD = 1  ***REMOVED*** Suppress after 1 complaint
    ...
    def record_bounce(
        ...
        ***REMOVED*** Check if should suppress
