...
class CircuitState(str, Enum):
    ...
    OPEN = "open"  ***REMOVED*** Failing, rejecting requests
...
class CircuitBreaker:
    ...
    def record_failure(self, channel: str) -> None:
        ...
        if state["state"] == CircuitState.HALF_OPEN:
            ***REMOVED*** Failed during recovery, reopen circuit
    ...
    def can_execute(self, channel: str) -> bool:
        ...
        if state["state"] == CircuitState.OPEN:
            ***REMOVED*** Check if recovery timeout elapsed
