...
class NotificationMetrics:
    ...
    def __init__(self):
        ...
        ***REMOVED*** Latency tracking (in seconds)
        self._latencies: list[float] = []
        self._max_latencies = 1000  ***REMOVED*** Keep last 1000
    ...
    def get_summary(self) -> dict[str, Any]:
        ...
        ***REMOVED*** Calculate latency statistics
        latency_stats = {}
        if self._latencies:
            latency_stats = {
