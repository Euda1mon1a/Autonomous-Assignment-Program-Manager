...
class NotificationEngine:
    ...
    async def send_notification(
        ...
        """
        ***REMOVED*** Step 1: Render the notification template
        ...
        ***REMOVED*** Step 2: Check deduplication
        ...
        ***REMOVED*** Step 3: Get user preferences
        ...
        ***REMOVED*** Step 4: Determine priority
        ...
        ***REMOVED*** Step 5: Determine target channels
        ...
        ***REMOVED*** Step 6: Check rate limits
        if not await self.rate_limiter.check_rate_limit(
            ...
            ***REMOVED*** Queue for later delivery
        ...
        ***REMOVED*** Step 7: Create notification payload
        ...
        ***REMOVED*** Step 8: Check if batching is enabled
        ...
        ***REMOVED*** Step 9: Dispatch immediately
        ...
        ***REMOVED*** Step 10: Handle failures with retry
        ...
        ***REMOVED*** Step 11: Record for deduplication
    ...
    async def send_bulk(
        ...
        """
        ***REMOVED*** Batch load preferences to avoid N+1 queries
        await self.preference_manager.preload_preferences(recipient_ids)

        ***REMOVED*** Send notifications concurrently
        tasks = [
        ...
        ***REMOVED*** Build results dictionary
        results = {}
    ...
    async def process_queue(self) -> int:
        ...
        ***REMOVED*** Process high-priority queue first
    ...
    async def process_batches(self) -> int:
        ...
        for batch in batches:
            try:
                ***REMOVED*** Create aggregated notification
                aggregated = await self.batching.aggregate_batch(batch)

                ***REMOVED*** Send to all recipients in batch
