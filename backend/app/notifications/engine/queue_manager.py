...
class NotificationQueueManager:
    ...
    def __init__(self):
        ...
        ***REMOVED*** Separate queues for each priority level
        ...
        ***REMOVED*** Index for fast lookup by ID
    ...
    async def enqueue(
        ...
        async with self._lock:
            ...
            ***REMOVED*** Determine which queue to use based on priority
            if priority >= 75:
    ...
    async def dequeue(self, priority: str = "high") -> QueuedNotification | None:
        ...
        async with self._lock:
            ...
            ***REMOVED*** Get oldest notification (FIFO within priority)
    ...
    async def remove(self, notification_id: UUID) -> bool:
        ...
        async with self._lock:
            ...
            ***REMOVED*** Find and remove from appropriate queue
    ...
    def _get_queue(self, priority: str) -> list[QueuedNotification]:
        ...
        if priority == "high":
            ...
            return self._normal_priority  ***REMOVED*** Default
