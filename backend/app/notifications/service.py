...
::
    ...
    ***REMOVED*** Send immediate notification
    ...
    ***REMOVED*** Update user preferences
    prefs = NotificationPreferences(
        user_id=user_uuid,
        enabled_channels=["in_app"],  ***REMOVED*** Email disabled
...
class NotificationPreferences(BaseModel):
    ...
    quiet_hours_start: int | None = None  ***REMOVED*** Hour (0-23)
    quiet_hours_end: int | None = None  ***REMOVED*** Hour (0-23)
...
class NotificationService:
    ...
    async def send_notification(
        ...
        ***REMOVED*** Check user preferences
        ...
        ***REMOVED*** Filter channels by user preferences
        ...
        ***REMOVED*** Store notification record for in-app display
    ...
    async def send_bulk(
        ...
        """
        ***REMOVED*** OPTIMIZATION: Batch-load all user preferences to avoid N+1 queries
        preferences_records = (
        ...
        ***REMOVED*** Build a cache of preferences by user_id
        preferences_cache = {
        ...
        for recipient_id in recipient_ids:
            ***REMOVED*** Use cached preferences if available, otherwise use defaults
        ...
        ***REMOVED*** Clear the cache after bulk operation
        self._preferences_cache = {}
    ...
    def schedule_notification(
        ...
        ***REMOVED*** Return Pydantic model for API
    ...
    async def process_scheduled_notifications(self) -> int:
        ...
        ***REMOVED*** Query due notifications from database
        due_notifications = (
        ...
        ***REMOVED*** OPTIMIZATION: Batch-load all user preferences to avoid N+1 queries
        ...
        if unique_recipient_ids:
            ...
            ***REMOVED*** Build cache of preferences
            self._preferences_cache = {
                record.user_id: NotificationPreferences(
                    user_id=record.user_id,
                    enabled_channels=record.get_enabled_channels(),
            ...
            ***REMOVED*** Add default preferences for users without records
        ...
        ***REMOVED*** Clear the cache after processing
        self._preferences_cache = {}
    ...
    def _get_user_preferences(self, user_id: UUID) -> NotificationPreferences:
        ...
        """
        ***REMOVED*** OPTIMIZATION: Check cache first to avoid repeated queries
        ...
        ***REMOVED*** Return default preferences if none exist
