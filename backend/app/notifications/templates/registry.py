...
class TemplateRegistry:
    ...
    def register_template(
        ...
        """
        ***REMOVED*** Validate template syntax
        try:
        ...
        ***REMOVED*** Set as active if requested
        if set_active:
    ...
    def get_template(
        ...
        ***REMOVED*** Get all versions for this template
        versions = self._templates[template_id]

        ***REMOVED*** Filter by locale if specified
        if locale:
            locale_versions = [v for v in versions if v.locale == locale]
            if locale_versions:
                versions = locale_versions

        ***REMOVED*** If no version specified, return active version
        if version is None:
            return self._active_versions.get(template_id)

        ***REMOVED*** Find specific version
    ...
    def get_all_versions(self, template_id: str) -> list[TemplateVersion]:
        ...
        ***REMOVED*** Sort by version (newest first)
    ...
    def create_new_version(
        ...
        ***REMOVED*** Register the new version
