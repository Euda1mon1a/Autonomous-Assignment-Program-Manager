...
def register_built_in_templates() -> None:
    ...
    ***REMOVED*** Schedule Published Template
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <h2 style="color: ***REMOVED***003366;">New Schedule Published</h2>

    <p>A new schedule has been published for <strong>{{ period }}</strong>.</p>

    <div style="background-color: ***REMOVED***f5f5f5; padding: 15px; margin: 20px 0; border-left: 4px solid ***REMOVED***003366;">
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid ***REMOVED***ddd; font-size: 12px; color: ***REMOVED***666;">
...
""",
    ...
    ***REMOVED*** Assignment Changed Template
    registry.register_template(
        TemplateVersion(
            ...
            html_template="""
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <h2 style="color: ***REMOVED***856404; background-color: ***REMOVED***fff3cd; padding: 10px; border-left: 4px solid ***REMOVED***ffc107;">
        Assignment Change Notice
    </h2>

    <p>Your assignment has been changed.</p>

    <div style="background-color: ***REMOVED***f8f9fa; padding: 15px; margin: 20px 0;">
        <p><strong>Rotation:</strong> {{ rotation_name }}</p>
        <p><strong>Block:</strong> {{ block_name }}</p>
        <p><strong>Date Range:</strong> {{ start_date }} to {{ end_date }}</p>
    </div>

    <div style="background-color: ***REMOVED***fff3cd; padding: 15px; margin: 20px 0;">
        <p><strong>Previous Assignment:</strong> {{ previous_rotation }}</p>
        <p><strong>New Assignment:</strong> {{ new_rotation }}</p>
    </div>

    <div style="background-color: ***REMOVED***e7f3ff; padding: 15px; margin: 20px 0;">
...
""",
    ...
    ***REMOVED*** Shift Reminder 24H Template
    registry.register_template(
        TemplateVersion(
            ...
            html_template="""
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <h2 style="color: ***REMOVED***0056b3;">Upcoming Shift Reminder</h2>

    <p>This is a reminder that you have a shift starting tomorrow.</p>

    <div style="background-color: ***REMOVED***e7f3ff; padding: 15px; margin: 20px 0; border-left: 4px solid ***REMOVED***0056b3;">
        <p><strong>Rotation:</strong> {{ rotation_name }}</p>
...
""",
    ...
    ***REMOVED*** Shift Reminder 1H Template
    registry.register_template(
        TemplateVersion(
            ...
            html_template="""
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <h2 style="color: ***REMOVED***dc3545; background-color: ***REMOVED***f8d7da; padding: 10px; border-left: 4px solid ***REMOVED***dc3545;">
        Shift Starting Soon
    </h2>

    <p>Your shift starts in approximately <strong>1 hour</strong>.</p>

    <div style="background-color: ***REMOVED***fff3cd; padding: 15px; margin: 20px 0; border-left: 4px solid ***REMOVED***ffc107;">
        <p><strong>Rotation:</strong> {{ rotation_name }}</p>
        <p><strong>Location:</strong> {{ location }}</p>
...
""",
    ...
    ***REMOVED*** ACGME Warning Template
    registry.register_template(
        TemplateVersion(
            ...
            html_template="""
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <div style="background-color: ***REMOVED***dc3545; color: white; padding: 15px; margin-bottom: 20px;">
    ...
    <div style="background-color: ***REMOVED***f8d7da; padding: 15px; margin: 20px 0; border-left: 4px solid ***REMOVED***dc3545;">
        <p><strong>Violation Type:</strong> {{ violation_type }}</p>
        <p><strong>Severity:</strong> <span style="color: ***REMOVED***dc3545; font-weight: bold;">{{ severity }}</span></p>
    ...
    <div style="background-color: ***REMOVED***d1ecf1; padding: 15px; margin: 20px 0; border-left: 4px solid ***REMOVED***17a2b8;">
        <p><strong>Recommended Action:</strong></p>
        <p>{{ recommended_action }}</p>
    </div>

    <p style="color: ***REMOVED***dc3545; font-weight: bold;">
...
""",
    ...
    ***REMOVED*** Absence Approved Template
    registry.register_template(
        TemplateVersion(
            ...
            html_template="""
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <div style="background-color: ***REMOVED***28a745; color: white; padding: 15px; margin-bottom: 20px;">
        <h2 style="margin: 0; color: white;">✓ Absence Request Approved</h2>
    </div>

    <p>Your absence request has been approved.</p>

    <div style="background-color: ***REMOVED***d4edda; padding: 15px; margin: 20px 0; border-left: 4px solid ***REMOVED***28a745;">
...
""",
    ...
    ***REMOVED*** Absence Rejected Template
    registry.register_template(
        TemplateVersion(
            ...
            html_template="""
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <div style="background-color: ***REMOVED***ffc107; color: ***REMOVED***333; padding: 15px; margin-bottom: 20px;">
        <h2 style="margin: 0; color: ***REMOVED***333;">Absence Request Not Approved</h2>
    </div>
...
***REMOVED*** Auto-register built-in templates when module is imported
