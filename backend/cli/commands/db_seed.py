...
async def seed_all(profile: str):
    ...
    ***REMOVED*** Import models
    ...
    async for session in db_manager.get_session():
        try:
            ***REMOVED*** Seed in order of dependencies
...
async def seed_schedules(block: int):
    ...
    ***REMOVED*** Implementation would create assignments for the block
...
async def clear_data(table: str = None):
    ...
    ***REMOVED*** Implementation would delete data
    ***REMOVED*** This is a placeholder
...
async def _seed_rotations(session, profile: str):
    ...
    rotations = [
        {"name": "Inpatient", "description": "Inpatient ward", "color": "***REMOVED***FF5733"},
        {"name": "Clinic", "description": "Outpatient clinic", "color": "***REMOVED***33FF57"},
        {"name": "Procedures", "description": "Procedures", "color": "***REMOVED***3357FF"},
        {"name": "Conference", "description": "Educational", "color": "***REMOVED***F3FF33"},
        {"name": "Call", "description": "On-call duty", "color": "***REMOVED***FF33F3"},
        {"name": "Night Float", "description": "Night coverage", "color": "***REMOVED***33FFF3"},
    ]
...
async def _seed_persons(session, profile: str):
    ...
    ***REMOVED*** Add sample persons based on profile
...
async def _seed_blocks(session, profile: str):
    ...
    ***REMOVED*** Create blocks for current academic year
    start_date = date(2024, 7, 1)  ***REMOVED*** July 1, 2024

    for block_num in range(1, 13):
        ***REMOVED*** Each block is ~4 weeks
...
async def _seed_assignments(session, profile: str):
    ...
    ***REMOVED*** This would create sample schedule assignments
