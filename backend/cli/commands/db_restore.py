...
def from_file(
    ...
    ***REMOVED*** Confirm dangerous operation
    if not force:
...
def from_backup(
    ...
    ***REMOVED*** Try to find backup file
    backup_file = None
    ...
    ***REMOVED*** Check if compressed
    ...
    with step("Checking file integrity"):
        if is_compressed:
            ...
            ***REMOVED*** Basic SQL file check
            try:
                with open(backup_file) as f:
                    content = f.read(1000)  ***REMOVED*** Read first 1KB
