...
def calculate_block_dates(block_number: int, academic_year: int = 2026) -> tuple:
    ...
    ***REMOVED*** Academic year starts July 1
    year_start = date(academic_year - 1, 7, 1)  ***REMOVED*** e.g., 2025-07-01 for AY 2025-2026
...
def export_schedule_metrics(db, block_number: int = None) -> dict:
    ...
    if db is None:
        ***REMOVED*** Return mock data structure for testing
    ...
    try:
        ...
        ***REMOVED*** Get date range for block
        if block_number:
        ...
        ***REMOVED*** Coverage metrics
        ...
        metrics["coverage"] = {
            "total_half_days": total_blocks * 2,  ***REMOVED*** AM/PM
            "assigned_half_days": assigned_blocks,
            "coverage_percentage": round(coverage_pct, 1),
        }

        ***REMOVED*** Workload distribution (anonymized)
        hours_query = (
        ...
        if hours_query:
            ...
            ***REMOVED*** Convert assignment count to approximate hours (4 hours per half-day)
            ...
            metrics["workload"] = {
                ...
                "person_count": len(counts),  ***REMOVED*** No names, just count
            }

            ***REMOVED*** Gini coefficient for fairness
            metrics["workload"]["gini_coefficient"] = _calculate_gini(counts)

        ***REMOVED*** PGY level distribution (anonymized)
        pgy_query = (
...
def export_violation_summary(db, block_number: int = None) -> dict:
    ...
    try:
        ***REMOVED*** Query your constraint violation tables here
        ***REMOVED*** This is a placeholder - adapt to your schema
        ...
        ***REMOVED*** Table may not exist - return defaults
        pass
...
def export_solver_metrics() -> dict:
    ...
    return {
        "solver_used": "CP-SAT",  ***REMOVED*** or detect from config
...
Examples:
    ...
    ***REMOVED*** Close database connection
    if db:
        db.close()
