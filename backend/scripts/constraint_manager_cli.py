...
Usage:
    python constraint_manager_cli.py status          ***REMOVED*** Show status report
    python constraint_manager_cli.py list            ***REMOVED*** List all constraints
    python constraint_manager_cli.py enabled         ***REMOVED*** List enabled constraints
    python constraint_manager_cli.py disabled        ***REMOVED*** List disabled constraints
    python constraint_manager_cli.py enable NAME     ***REMOVED*** Enable a constraint
    python constraint_manager_cli.py disable NAME    ***REMOVED*** Disable a constraint
    python constraint_manager_cli.py preset PRESET   ***REMOVED*** Apply a preset
    python constraint_manager_cli.py test-all        ***REMOVED*** Test all disabled constraints
...
***REMOVED*** Import directly from config module to avoid scheduling/__init__.py dependencies
