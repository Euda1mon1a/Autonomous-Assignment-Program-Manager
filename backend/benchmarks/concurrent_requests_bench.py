...
async def benchmark_concurrent_reads(
    ...
    ***REMOVED*** Setup test data (using sync engine)
    ...
    try:
        ...
        ***REMOVED*** Run workers concurrently
...
async def benchmark_concurrent_writes(
    ...
    ***REMOVED*** Setup test data
    ...
    try:
        ...
        ***REMOVED*** Run concurrent write operations
        total_operations = 0
        successful_operations = 0
        start_time = time.perf_counter()
        operation_times = []
...
def run_suite(verbose: bool = False):
    ...
    async def run_async_suite():
        ***REMOVED*** Concurrent reads with varying worker counts
        ...
        ***REMOVED*** Concurrent writes (lower worker count due to lock contention)
