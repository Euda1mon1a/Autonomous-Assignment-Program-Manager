...
def benchmark_join_queries(
    ...
    try:
        ...
        ***REMOVED*** Benchmark eager loading (joinedload)
        for i in range(iterations):
        ...
        ***REMOVED*** Benchmark lazy loading (selectinload)
        for i in range(iterations):
...
def benchmark_bulk_operations(
    ...
    db = SessionLocal()
    try:
        ***REMOVED*** Create minimal dependencies
        template = RotationTemplate(
            id=uuid4(),
            name="Bulk Test",
            activity_type="clinic",
        ...
        for i in range(iterations):
            ...
            ***REMOVED*** Cleanup after each iteration
