...
Usage:
    ...
    ***REMOVED*** Run specific benchmark
...
class BenchmarkResult:
    ...
    max_duration: float
    std_deviation: float
    throughput: Optional[float] = None  ***REMOVED*** Operations per second
...
def measure_performance(name: str = "operation"):
    ...
    start_memory = process.memory_info().rss / 1024 / 1024  ***REMOVED*** MB
    ...
    try:
        ...
        end_memory = process.memory_info().rss / 1024 / 1024  ***REMOVED*** MB
