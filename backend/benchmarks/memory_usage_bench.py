...
def get_memory_info():
    ...
    return {
        "rss_mb": mem_info.rss / 1024 / 1024,  ***REMOVED*** Resident Set Size
        "vms_mb": mem_info.vms / 1024 / 1024,  ***REMOVED*** Virtual Memory Size
    ...
    ***REMOVED*** Get baseline memory
    ...
    for i in range(iterations):
        ...
        try:
            ...
            ***REMOVED*** Force GC between iterations
            force_gc()

    ***REMOVED*** Final memory check
    ...
    result = BenchmarkResult(
        ...
        duration_seconds=0,  ***REMOVED*** Not time-based
...
def benchmark_validation_memory(iterations: int = 20, verbose: bool = False) -> BenchmarkResult:
    ...
    ***REMOVED*** Create persistent test data
    db = SessionLocal()
    try:
        template = RotationTemplate(
            id=uuid4(),
