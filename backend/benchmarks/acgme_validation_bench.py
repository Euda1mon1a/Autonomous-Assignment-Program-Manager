...
def create_validation_dataset(
    ...
    ***REMOVED*** Create residents with PGY distribution
    residents = []
    ...
    ***REMOVED*** Create assignments (skip Sundays for 1-in-7 compliance)
    assignments = []
...
def benchmark_acgme_validation(
    ...
    ***REMOVED*** Calculate throughput (residents validated per second)
    ...
    result = BenchmarkResult(
        ...
        metadata={
            ...
            "total_assignments": num_residents * num_weeks * 14,  ***REMOVED*** Estimate
        },
    )
...
def run_suite(verbose: bool = False):
    ...
    configurations = [
        ...
        (50, 4, "full"),
        (100, 4, "full"),
        (100, 12, "full"),  ***REMOVED*** Extended period
    ]
