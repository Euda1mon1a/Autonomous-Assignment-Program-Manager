...
def setup_swap_data(db, num_faculty: int = 30, num_weeks: int = 4):
    ...
    ***REMOVED*** Create assignments
    assignments = []
    for fac in faculty:
        ***REMOVED*** Assign each faculty member to random blocks
        assigned_blocks = blocks[::3]  ***REMOVED*** Every 3rd block
        for block in assigned_blocks[:20]:  ***REMOVED*** Limit to 20 per faculty
