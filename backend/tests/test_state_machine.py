...
def machine_with_actions():
    ...
    ***REMOVED*** Track action executions
    action_log = []
...
class TestStateTransitions:
    ...
    def test_simple_transition(self, simple_machine, db):
        ...
        ***REMOVED*** Transition from draft to review
...
class TestGuardConditions:
    ...
    def test_transition_priority_with_guards(self, db):
        ...
        ***REMOVED*** Should take high priority path
...
class TestActions:
    ...
    def test_entry_and_exit_actions(self, machine_with_actions, db):
        ...
        ***REMOVED*** Should execute: exit (none for idle) -> transition -> entry
    ...
    def test_action_execution_order(self, machine_with_actions, db):
        ...
        ***REMOVED*** Order: exit_action, transition_action, entry_action
        ***REMOVED*** idle has no exit action, so: transition, entry
        ...
        ***REMOVED*** active has exit action, done has no entry action
...
class TestVisualization:
    ...
    def test_dot_marks_final_states(self, simple_machine):
        ...
        ***REMOVED*** Final states should have doublecircle shape
        assert "approved" in dot
