...
def seasonal_workload() -> np.ndarray:
    ...
    np.random.seed(42)
    t = np.arange(60)
    seasonal = 2.0 * np.sin(2 * np.pi * t / 7)  ***REMOVED*** Weekly cycle
    base = 8.0
    ...
    def test_series_date_length_mismatch(self, sample_dates: list[date]):
        ...
        with pytest.raises(ValueError, match="same length"):
            WorkloadSeries(
                ...
                dates=sample_dates,  ***REMOVED*** 60 dates
            )


***REMOVED*** =============================================================================
***REMOVED*** ARIMAForecaster Tests
***REMOVED*** =============================================================================
...
class TestCheckStationarity:
    ...
    def test_stationary_series(self, stable_workload: np.ndarray):
        ...
        ***REMOVED*** Stable workload should likely be stationary
    ...
    def test_non_stationary_series(self, trending_workload: np.ndarray):
        ...
        ***REMOVED*** Trending series may not be stationary
        assert "is_stationary" in result
...
class TestEdgeCases:
    ...
    def test_constant_series(self):
        ...
        ***REMOVED*** Should still produce forecasts
    ...
    def test_large_values(self):
        ...
        ***REMOVED*** Forecasts should be in similar range
        for f in result["forecasts"]:
    ...
    def test_forecast_long_horizon(self, stable_workload: np.ndarray):
        ...
        ***REMOVED*** Confidence intervals should widen over time
        first_width = (
