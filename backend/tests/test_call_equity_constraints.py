...
class TestSundayCallEquityConstraint:
    ...
    def test_sunday_is_weekday_6(self):
        ...
        ***REMOVED*** Jan 5, 2025 is a Sunday
...
class TestWeekdayCallEquityConstraint:
    ...
    def test_weekday_numbers(self):
        ...
        ***REMOVED*** Jan 6-9, 2025 is Mon-Thu
...
class TestTuesdayCallPreferenceConstraint:
    ...
    def test_tuesday_is_weekday_1(self):
        ...
        ***REMOVED*** Jan 7, 2025 is a Tuesday
        tuesday = date(2025, 1, 7)
        assert tuesday.weekday() == 1
...
class TestDeptChiefWednesdayPreferenceConstraint:
    ...
    def test_validate_empty_assignments(self):
        ...
        result = constraint.validate([], context)
        assert result.satisfied is True
        assert result.penalty == 0.0  ***REMOVED*** No bonus without assignments

    def test_wednesday_is_weekday_2(self):
        """Test that Wednesday is correctly identified as weekday 2."""
        ***REMOVED*** Jan 8, 2025 is a Wednesday
        wednesday = date(2025, 1, 8)
        assert wednesday.weekday() == 2
...
class TestCallDayIdentification:
    ...
    def test_full_week_days(self):
        ...
        ***REMOVED*** Week of Jan 5-11, 2025 (Sun-Sat)
        sunday = date(2025, 1, 5)
        monday = date(2025, 1, 6)
        tuesday = date(2025, 1, 7)
        wednesday = date(2025, 1, 8)
        ...
        ***REMOVED*** Sunday equity day
        assert sunday.weekday() == 6

        ***REMOVED*** Weekday equity days (Mon-Thu)
        weekday_days = [monday, tuesday, wednesday, thursday]
        for day in weekday_days:
            assert day.weekday() in (0, 1, 2, 3)

        ***REMOVED*** FMIT call days (Fri-Sat)
    ...
    def test_tuesday_avoidance_day(self):
        ...
        constraint = TuesdayCallPreferenceConstraint()
        ***REMOVED*** Verify the constraint looks for weekday 1 (Tuesday)
        tuesday = date(2025, 1, 7)
        assert tuesday.weekday() == 1
    ...
    def test_wednesday_preference_day(self):
        ...
        constraint = DeptChiefWednesdayPreferenceConstraint()
        ***REMOVED*** Verify the constraint looks for weekday 2 (Wednesday)
        wednesday = date(2025, 1, 8)
        assert wednesday.weekday() == 2
...
class TestCallSpacingConstraint:
    ...
    def test_iso_week_calculation(self):
        ...
        ***REMOVED*** Week 1 of 2025 starts Monday Dec 30, 2024
        week1_day = date(2025, 1, 6)  ***REMOVED*** Monday of week 2
        week2_day = date(2025, 1, 13)  ***REMOVED*** Monday of week 3

        iso1 = week1_day.isocalendar()
        iso2 = week2_day.isocalendar()

        assert iso1[0] == 2025  ***REMOVED*** year
        assert iso1[1] == 2  ***REMOVED*** week 2
        assert iso2[1] == 3  ***REMOVED*** week 3
    ...
    def test_consecutive_weeks_detection(self):
        ...
        ***REMOVED*** Same year, adjacent week numbers = consecutive
    ...
    def test_non_consecutive_weeks(self):
        ...
        ***REMOVED*** Same year but week 2 and week 4 are not adjacent
    ...
    def test_year_boundary_weeks(self):
        ...
        """
        week52_day = date(2024, 12, 30)  ***REMOVED*** Monday of ISO week 1 of 2025 (edge case)
        week1_day = date(2025, 1, 6)  ***REMOVED*** Monday of week 2 of 2025

        iso52 = week52_day.isocalendar()
        iso1 = week1_day.isocalendar()

        ***REMOVED*** This tests the year rollover logic in the constraint
        ***REMOVED*** Note: Dec 30 2024 is actually ISO week 1 of 2025
        ***REMOVED*** So this is not a year boundary case for ISO calendar
        ***REMOVED*** A true year boundary would be Dec 23 2024 (week 52) to Dec 30 2024 (week 1 of 2025)
        ...
        assert iso_52[1] == 52
        assert iso_1[1] == 1  ***REMOVED*** Week 1 of 2025

        ***REMOVED*** Year rollover detection
