...
class TestApprovalContextValidation:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Leave/Absence Approval Tests
    ***REMOVED*** ========================================================================
    ...
    def test_coordinator_approve_leave_without_department(self, acm):
        ...
        context = PermissionContext(
            ...
            user_role=UserRole.COORDINATOR,
            resource_owner_id=requester_id,
            resource_metadata={},  ***REMOVED*** Missing department
        )
    ...
    def test_admin_approve_leave_bypasses_context_checks(self, acm):
        ...
        ***REMOVED*** Minimal context - admin should still be allowed
        context = PermissionContext(
            user_id=admin_id,
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_coordinator_approve_swap_missing_parties(self, acm):
        ...
        ***REMOVED*** Missing target_user_id
        context = PermissionContext(
            user_id=coordinator_id,
            user_role=UserRole.COORDINATOR,
            resource_owner_id=uuid4(),
    ...
    def test_faculty_approve_swap_involved(self, acm):
        ...
        context = PermissionContext(
            ...
            resource_metadata={
                "requesting_user_id": str(faculty_id),  ***REMOVED*** Faculty is involved
    ...
    def test_faculty_cannot_approve_swap_not_involved(self, acm):
        ...
        context = PermissionContext(
            ...
            resource_metadata={
                "requesting_user_id": str(requester_id),
                "target_user_id": str(target_id),
                ***REMOVED*** Faculty not in either party
            },
        )
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Reject Action Tests (same validation as APPROVE)
    ***REMOVED*** ========================================================================
    ...
    def test_reject_requires_same_context_as_approve(self, acm):
        ...
        ***REMOVED*** REJECT should work with valid context
        assert acm.has_permission(
            UserRole.COORDINATOR,
            ResourceType.LEAVE,
        ...
        ***REMOVED*** Invalid context (missing department)
        ...
        ***REMOVED*** REJECT should fail with invalid context
        assert not acm.has_permission(
            UserRole.COORDINATOR,
            ResourceType.LEAVE,
            PermissionAction.REJECT,
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_approval_denial_logged(self, acm):
        ...
        ***REMOVED*** Attempt approval without proper context
        context = PermissionContext(
            user_id=coordinator_id,
            user_role=UserRole.COORDINATOR,
            resource_owner_id=None,  ***REMOVED*** Missing - will fail
            resource_metadata={"department": "Medicine"},
        )
        ...
        ***REMOVED*** Check that the denial was logged
...
class TestRolePermissionIsolation:
    ...
    def test_faculty_cannot_approve_leave(self, acm):
        ...
        ***REMOVED*** Faculty should NOT be able to approve leave
        assert not acm.has_permission(
            UserRole.FACULTY,
            ResourceType.LEAVE,
            PermissionAction.APPROVE,
    ...
    def test_resident_cannot_approve_swaps(self, acm):
        ...
        ***REMOVED*** Resident can approve SWAP_REQUEST (between residents)
        assert acm.has_permission(
            UserRole.RESIDENT,
            ResourceType.SWAP_REQUEST,
            PermissionAction.APPROVE,
        ...
        ***REMOVED*** But CANNOT approve SWAP (coordinator-level resource)
        ***REMOVED*** Note: SWAP and SWAP_REQUEST have different permission rules
        assert not acm.has_permission(
            UserRole.RESIDENT,
            ResourceType.SWAP,
            PermissionAction.APPROVE,
