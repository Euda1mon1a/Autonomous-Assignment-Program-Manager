...
class TestPricingConfig:
    ...
    def test_calculate_cost_basic_tier(self):
        ...
        ***REMOVED*** Should be base price (1.00) * quantity (1) * tier multiplier (1.0)
    ...
    def test_calculate_cost_professional_tier(self):
        ...
        ***REMOVED*** Should be base price (1.00) * tier multiplier (0.75)
    ...
    def test_calculate_cost_volume_discount(self):
        ...
        ***REMOVED*** Base price: 0.001
        ***REMOVED*** Volume discount: 5% (for >1000 units)
        ***REMOVED*** Expected: 0.001 * 2000 * 0.95 = 1.90
    ...
    def test_calculate_cost_free_tier(self):
        ...
        ***REMOVED*** Free tier should have 0 cost
...
class TestMeteringService:
    ...
    async def test_record_event(self, metering_service, mock_redis):
        ...
        ***REMOVED*** Verify Redis calls were made
    ...
    async def test_check_quota_within_limit(self, metering_service, mock_redis):
        ...
        ***REMOVED*** Mock current usage as 50
    ...
    async def test_check_quota_exceeds_limit(self, metering_service, mock_redis):
        ...
        ***REMOVED*** Mock current usage as 95
    ...
    async def test_forecast_usage(self, metering_service, mock_redis):
        ...
        ***REMOVED*** Mock historical usage data
        historical_events = []
        for i in range(30):
            event_data = {
                "quantity": 10 + i,  ***REMOVED*** Increasing usage
                "cost": "1.00",
                "metadata": {},
    ...
    async def test_get_usage_trends(self, metering_service, mock_redis):
        ...
        ***REMOVED*** Mock increasing usage over time
        events = []
        for i in range(7):
            event = {
                "quantity": i + 1,
...
class TestAggregation:
    ...
    async def test_aggregate_usage_single_resource(self, metering_service, mock_redis):
        ...
        ***REMOVED*** Mock events
        ...
        assert agg.total_quantity == 10  ***REMOVED*** 5 events * 2 quantity each
        assert agg.total_cost == Decimal("10.00")  ***REMOVED*** 5 events * 2.00 each
    ...
    async def test_aggregate_usage_no_events(self, metering_service, mock_redis):
        ...
        ***REMOVED*** Should return empty list or handle gracefully
