...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Utilization Alerts
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Burnout Alerts
***REMOVED*** ============================================================================
...
class TestBurnoutAlerts:
    ...
    def test_info_alert_with_low_prevalence_high_rt(self, alert_generator):
        ...
        alert = alert_generator.generate_burnout_alert(
            infected_count=1, total_population=20, rt=1.1  ***REMOVED*** 5% prevalence
        )
    ...
    def test_warning_alert_with_moderate_prevalence(self, alert_generator):
        ...
        alert = alert_generator.generate_burnout_alert(
            infected_count=2, total_population=20, rt=1.2  ***REMOVED*** 10% prevalence
        )
    ...
    def test_critical_alert_with_high_prevalence(self, alert_generator):
        ...
        alert = alert_generator.generate_burnout_alert(
            infected_count=3, total_population=20, rt=1.6  ***REMOVED*** 15% prevalence
        )
    ...
    def test_emergency_alert_with_epidemic(self, alert_generator):
        ...
        alert = alert_generator.generate_burnout_alert(
            infected_count=4, total_population=20, rt=2.5  ***REMOVED*** 20% prevalence, Rt > 2
        )
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: N-1 Contingency Alerts
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Alert Deduplication
***REMOVED*** ============================================================================
...
class TestAlertDeduplication:
    ...
    def test_dont_deduplicate_different_severities(self, alert_generator):
        ...
        alert1 = alert_generator.generate_utilization_alert(utilization=0.92)  ***REMOVED*** WARNING
        alert_generator.active_alerts.append(alert1)

        alert2 = alert_generator.generate_utilization_alert(utilization=0.98)  ***REMOVED*** EMERGENCY

        is_duplicate = alert_generator.deduplicate_alerts(alert2)
        ***REMOVED*** Different severities, should not be considered duplicate
        assert is_duplicate is False

    def test_deduplicate_only_recent_alerts(self, alert_generator):
        """Test deduplication only considers recent alerts (last hour)."""
        ***REMOVED*** Create old alert
        ...
        ***REMOVED*** New alert should not be considered duplicate
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Alert Prioritization
***REMOVED*** ============================================================================
...
class TestAlertPrioritization:
    ...
    def test_prioritize_by_timestamp_when_same_severity(self, alert_generator):
        ...
        assert prioritized[0].id == "2"  ***REMOVED*** Newer alert first


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Alert Escalation
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Alert Structure
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Alert History
***REMOVED*** ============================================================================
