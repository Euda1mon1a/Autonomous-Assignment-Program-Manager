...
***REMOVED*** =============================================================================
***REMOVED*** Test Fixtures and Helpers
***REMOVED*** =============================================================================
...
def create_test_population(n_faculty: int = 5, n_blocks: int = 10) -> tuple:
    ...
    ***REMOVED*** Create varied assignments - some faculty cover more blocks
    assignments = []
    for i, fac in enumerate(faculty):
        ***REMOVED*** Faculty 0 covers all blocks (hub)
        ***REMOVED*** Faculty 1 covers half blocks
        ***REMOVED*** Faculty 2-4 cover fewer blocks
...
class TestDomainScore:
    ...
    def test_threshold_exceeded_by_score(self):
        ...
        score = DomainScore(
            ...
            raw_score=0.8,
            normalized_score=0.75,  ***REMOVED*** Above 0.7 threshold
        )
    ...
    def test_threshold_exceeded_by_critical_flag(self):
        ...
        score = DomainScore(
            ...
            raw_score=0.3,
            normalized_score=0.3,  ***REMOVED*** Below 0.7 threshold
            is_critical=True,  ***REMOVED*** But explicitly marked critical
        )
...
***REMOVED*** =============================================================================
***REMOVED*** UnifiedCriticalIndex Tests
***REMOVED*** =============================================================================
...
class TestUnifiedCriticalIndex:
    ...
    def test_domain_agreement_high(self):
        ...
        assert idx.domain_agreement > 0.9  ***REMOVED*** High agreement
    ...
    def test_domain_agreement_low(self):
        ...
        assert idx.domain_agreement < 0.7  ***REMOVED*** Lower agreement
...
***REMOVED*** =============================================================================
***REMOVED*** UnifiedCriticalIndexAnalyzer Tests
***REMOVED*** =============================================================================
...
class TestUnifiedCriticalIndexAnalyzer:
    ...
    def test_build_network(self):
        ...
        ***REMOVED*** Should have edges from shared assignments
    ...
    def test_compute_contingency_score_redundant(self):
        ...
        block_id = uuid4()
        ***REMOVED*** All three cover the same block
    ...
    def test_compute_hub_score(self):
        ...
        ***REMOVED*** Faculty 0 should have highest hub score (covers all blocks)
        score_0 = analyzer.compute_hub_score(faculty[0].id)
        score_last = analyzer.compute_hub_score(faculty[-1].id)

        ***REMOVED*** Can't guarantee ordering without more assignments, but both should compute
    ...
    def test_normalize_scores(self):
        ...
        ***REMOVED*** After normalization: min=0, max=1
        assert normalized[0].normalized_score == 0.0  ***REMOVED*** Lowest
        assert normalized[2].normalized_score == 1.0  ***REMOVED*** Highest
        assert 0 < normalized[1].normalized_score < 1  ***REMOVED*** Middle
    ...
    def test_analyze_population(self):
        ...
        ***REMOVED*** All indices should have priority rank assigned
        ranks = [idx.priority_rank for idx in result.indices]
        assert sorted(ranks) == list(range(1, 6))


***REMOVED*** =============================================================================
***REMOVED*** PopulationAnalysis Tests
***REMOVED*** =============================================================================
...
class TestPopulationAnalysis:
    ...
    def test_pattern_distribution(self):
        ...
        ***REMOVED*** Create indices with known patterns
        indices = []
...
class TestConvenienceFunctions:
    ...
    def test_get_top_critical(self):
        ...
        assert len(top_3) == 3
        ***REMOVED*** Should be sorted by composite index
    ...
    def test_get_by_pattern(self):
        ...
        ***REMOVED*** Create mixed population
        indices = []
...
class TestIntegration:
    ...
    def test_full_workflow(self):
        ...
        ***REMOVED*** Create realistic population
        faculty = [
        ...
        ***REMOVED*** Create varied assignment patterns
        assignments = []
        for i, block_id in enumerate(blocks):
            ***REMOVED*** Dr. Smith covers everything (hub)
            assignments.append(MockAssignment.create(faculty[0].id, block_id))

            ***REMOVED*** Others have varied coverage
            if i % 2 == 0:
        ...
        ***REMOVED*** Dr. Smith should be highest priority (covers all blocks)
    ...
    def test_network_reuse_efficiency(self):
        ...
        ***REMOVED*** Build network once
        analyzer.build_network(faculty, assignments)
        network_nodes = analyzer._network.number_of_nodes()

        ***REMOVED*** Run multiple analyses
        ...
        ***REMOVED*** Network should not have been rebuilt
