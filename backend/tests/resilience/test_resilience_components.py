...
def faculty_pool(db: Session) -> list[Person]:
    ...
    for i in range(5):
        person = Person(
            ...
            performs_procedures=(i < 3),  ***REMOVED*** First 3 can do procedures
        )
        db.add(person)
...
def create_heavy_schedule(
    ...
    for day in range(days):
        ...
        for tod in ["AM", "PM"]:
            ...
            ***REMOVED*** Assign 80% of available personnel
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Defense Level Transitions
***REMOVED*** ============================================================================
...
class TestDefenseLevelTransitions:
    ...
    def test_green_to_yellow_transition_on_threshold(
        ...
        ***REMOVED*** Create schedule with 65% utilization (triggers YELLOW)
        for day in range(7):
            current_date = start_date + timedelta(days=day)
            block = Block(
                id=uuid4(),
            ...
            ***REMOVED*** Assign 65% of faculty (3.25 ≈ 3 out of 5)
            for i in range(3):
                assignment = Assignment(
                    id=uuid4(),
                    block_id=block.id,
    ...
    def test_orange_to_red_on_n_minus_1_failure(
        ...
        ***REMOVED*** Create schedule using all but one faculty member
        for day in range(7):
            current_date = start_date + timedelta(days=day)
            block = Block(
                id=uuid4(),
            ...
            ***REMOVED*** Use 4 out of 5 faculty
            for i in range(4):
                assignment = Assignment(
                    id=uuid4(),
                    block_id=block.id,
        ...
        current_level = defense_manager.assess_defense_level(start_date)
        ***REMOVED*** Should be RED if losing one more faculty breaks coverage
        assert current_level >= DefenseLevel.ORANGE
    ...
    def test_de_escalation_when_utilization_drops(
        ...
        ***REMOVED*** Initial heavy schedule
        create_heavy_schedule(db, faculty_pool, sample_rotation_template, start_date, 7)

        initial_level = defense_manager.assess_defense_level(start_date)

        ***REMOVED*** Remove some assignments to reduce utilization
        assignments = (
            db.query(Assignment)
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: N-1 Contingency Analysis
***REMOVED*** ============================================================================
...
class TestNMinus1Contingency:
    ...
    def test_n_minus_1_passes_with_adequate_backup(
        ...
        ***REMOVED*** Use only 3 out of 5 faculty (40% spare capacity)
        for day in range(7):
            current_date = start_date + timedelta(days=day)
            block = Block(
                id=uuid4(),
    ...
    def test_n_minus_1_fails_at_capacity(
        ...
        ***REMOVED*** Use all 5 faculty (no spare capacity)
        for day in range(7):
            current_date = start_date + timedelta(days=day)
            block = Block(
                id=uuid4(),
    ...
    def test_n_minus_1_identifies_critical_personnel(
        ...
        ***REMOVED*** Create specialized rotation only one faculty can cover
        ...
        ***REMOVED*** Only one faculty member assigned
        assignment = Assignment(
            id=uuid4(),
            block_id=block.id,
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: N-2 Contingency Analysis
***REMOVED*** ============================================================================
...
class TestNMinus2Contingency:
    ...
    def test_n_minus_2_passes_with_deep_bench(
        ...
        ***REMOVED*** Use 3 out of 6 residents (50% capacity)
        for day in range(7):
            current_date = start_date + timedelta(days=day)
            block = Block(
                id=uuid4(),
    ...
    def test_n_minus_2_fails_with_thin_margins(
        ...
        ***REMOVED*** Use 4 out of 5 faculty (80% utilization)
        ...
        result = n_minus_analyzer.analyze_n_minus_2(start_date)
        assert result.passes is False
        ***REMOVED*** Losing 2 people would cause coverage failure


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Utilization Monitoring
***REMOVED*** ============================================================================
    ...
    def test_utilization_below_80_percent_threshold(
        ...
        ***REMOVED*** 60% utilization
        for day in range(7):
            ...
            for i in range(3):  ***REMOVED*** 3 out of 5 = 60%
                assignment = Assignment(
                    id=uuid4(),
                    block_id=block.id,
                    person_id=faculty_pool[i].id,
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Blast Radius Isolation
***REMOVED*** ============================================================================
...
class TestBlastRadiusIsolation:
    ...
    def test_failure_contained_to_single_rotation(
        ...
        ***REMOVED*** Create two independent rotations
    ...
    def test_cascade_detection_in_dependent_rotations(
        ...
        ***REMOVED*** Create dependent rotations (prerequisite relationship)
        ...
        advanced_rotation = RotationTemplate(
            ...
            abbreviation="ADV",
            max_residents=2,
            prerequisites=[basic_rotation.id],  ***REMOVED*** Requires basic first
        )
        db.add_all([basic_rotation, advanced_rotation])
        db.commit()

        ***REMOVED*** If basic rotation fails, advanced should be affected
        blast_radius = blast_radius_analyzer.calculate_blast_radius(
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Homeostasis Feedback
***REMOVED*** ============================================================================
...
class TestHomeostasisFeedback:
    ...
    def test_workload_balancing_feedback(
        ...
        ***REMOVED*** Create imbalanced schedule (one person overworked)
        for day in range(14):
            current_date = start_date + timedelta(days=day)
            block = Block(
                id=uuid4(),
            ...
            ***REMOVED*** Always assign to first faculty member
            assignment = Assignment(
                id=uuid4(),
                block_id=block.id,
                person_id=faculty_pool[0].id,
        ...
        ***REMOVED*** Homeostasis should detect imbalance
    ...
    def test_equilibrium_restoration_after_perturbation(
        ...
        ***REMOVED*** Create balanced initial schedule
        for day in range(7):
            current_date = start_date + timedelta(days=day)
            block = Block(
                id=uuid4(),
            ...
            ***REMOVED*** Balanced assignment (rotate through residents)
            assignment = Assignment(
                id=uuid4(),
                block_id=block.id,
        ...
        ***REMOVED*** Apply perturbation (remove one resident's assignments)
        assignments = (
            db.query(Assignment)
