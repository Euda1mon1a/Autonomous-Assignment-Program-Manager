...
class TestCpkCalculation:
    ...
    def test_cpk_formula_validation(self, analyzer):
        ...
        ***REMOVED*** Create data: mean=65, σ varies based on sample
        ...
        ***REMOVED*** Cpk depends on actual std deviation calculation
        ***REMOVED*** Just verify it's a valid positive value
        assert cpk > 0
...
class TestEdgeCases:
    ...
    def test_very_large_sample(self, analyzer):
        ...
        ***REMOVED*** Status depends on actual Cpk which varies with sample
        assert report.capability_status in ["EXCELLENT", "CAPABLE", "MARGINAL"]
