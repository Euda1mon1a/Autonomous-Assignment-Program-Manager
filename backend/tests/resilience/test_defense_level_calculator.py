...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Basic Calculation
***REMOVED*** ============================================================================
...
class TestDefenseLevelBasicCalculation:
    ...
    def test_yellow_level_with_moderate_utilization(self, calculator):
        ...
        result = calculator.calculate(
            utilization=0.85,  ***REMOVED*** 80-90% range
            n1_failures=0,
            n2_failures=0,
            coverage_gaps=0,
            burnout_cases=0,
    ...
    def test_orange_level_with_high_utilization(self, calculator):
        ...
        result = calculator.calculate(
            utilization=0.92,  ***REMOVED*** 90-95% range
            n1_failures=5,
            n2_failures=0,
            coverage_gaps=1,
            burnout_cases=3,
    ...
    def test_red_level_with_critical_utilization(self, calculator):
        ...
        result = calculator.calculate(
            utilization=0.96,  ***REMOVED*** 95-98% range
            n1_failures=15,
            n2_failures=5,
            coverage_gaps=3,
            burnout_cases=8,
    ...
    def test_black_level_with_emergency_conditions(self, calculator):
        ...
        result = calculator.calculate(
            utilization=1.05,  ***REMOVED*** Over 100%
            n1_failures=30,
            n2_failures=20,
            coverage_gaps=12,
            burnout_cases=15,
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Utilization Scoring
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: N-1 Failure Scoring
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: N-2 Failure Scoring
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Cascade Risk Scoring
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Coverage Gap Scoring
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Burnout Scoring
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Score to Level Mapping
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Rationale Generation
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Recommendations Generation
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Weighted Scoring
***REMOVED*** ============================================================================
...
class TestWeightedScoring:
    ...
    def test_high_utilization_dominates_other_metrics(self, calculator):
        ...
        result = calculator.calculate(
            utilization=1.00,  ***REMOVED*** Critical
            n1_failures=0,
            n2_failures=0,
            coverage_gaps=0,
            burnout_cases=0,
        ...
        ***REMOVED*** Should be at least RED due to utilization alone
        assert result.level >= DefenseLevel.RED

    def test_n2_failures_are_weighted_heavily(self, calculator):
        """Test that N-2 failures are weighted heavily (25%)."""
        result = calculator.calculate(
            utilization=0.70,  ***REMOVED*** Normal
            n1_failures=0,
            n2_failures=20,  ***REMOVED*** Critical
            coverage_gaps=0,
            burnout_cases=0,
            cascade_risk=0.0,
        )

        ***REMOVED*** Should escalate significantly due to N-2 failures
        assert result.level >= DefenseLevel.ORANGE

    def test_multiple_moderate_issues_escalate_level(self, calculator):
        """Test that multiple moderate issues combine to escalate."""
        result = calculator.calculate(
            utilization=0.88,  ***REMOVED*** YELLOW range
            n1_failures=8,  ***REMOVED*** ORANGE range
            n2_failures=3,  ***REMOVED*** YELLOW range
            coverage_gaps=3,  ***REMOVED*** ORANGE range
            burnout_cases=5,  ***REMOVED*** ORANGE range
            cascade_risk=0.20,  ***REMOVED*** YELLOW range
        )

        ***REMOVED*** Combined should be ORANGE or higher
        assert result.level >= DefenseLevel.ORANGE


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Result Structure
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Defense Level Comparison
***REMOVED*** ============================================================================
