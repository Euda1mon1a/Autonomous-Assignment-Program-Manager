...
class TestWorkloadControlChart:
    ...
    def test_initialization_defaults(self):
        ...
        assert chart.ucl_3sigma == 75.0  ***REMOVED*** 60 + 3*5
        assert chart.lcl_3sigma == 45.0  ***REMOVED*** 60 - 3*5
        assert chart.ucl_2sigma == 70.0  ***REMOVED*** 60 + 2*5
        assert chart.lcl_2sigma == 50.0  ***REMOVED*** 60 - 2*5
        assert chart.ucl_1sigma == 65.0  ***REMOVED*** 60 + 1*5
        assert chart.lcl_1sigma == 55.0  ***REMOVED*** 60 - 1*5
    ...
    def test_initialization_custom_parameters(self):
        ...
        assert chart.ucl_3sigma == 80.0  ***REMOVED*** 50 + 3*10
        assert chart.lcl_3sigma == 20.0  ***REMOVED*** 50 - 3*10
    ...
    def test_detect_violations_no_violations(self):
        ...
        ***REMOVED*** All points within 1σ (55-65)
...
class TestWesternElectricRule1:
    ...
    def test_rule_1_upper_violation(self):
        ...
        ***REMOVED*** UCL = 75.0
        ...
        weekly_hours = [60, 62, 76, 61, 59]  ***REMOVED*** 76 > 75

        alerts = chart.detect_western_electric_violations(resident_id, weekly_hours)

        ***REMOVED*** Should have exactly 1 Rule 1 alert
        ...
        assert "75.0" in alert.message  ***REMOVED*** UCL value
    ...
    def test_rule_1_lower_violation(self):
        ...
        ***REMOVED*** LCL = 45.0
        ...
        weekly_hours = [60, 62, 44, 61, 59]  ***REMOVED*** 44 < 45
        ...
        assert "45.0" in alert.message  ***REMOVED*** LCL value
    ...
    def test_rule_1_multiple_violations(self):
        ...
        weekly_hours = [76, 44, 60, 77]  ***REMOVED*** Two upper, one lower violations

        alerts = chart.detect_western_electric_violations(resident_id, weekly_hours)

        rule1_alerts = [a for a in alerts if a.rule == "Rule 1"]
        assert len(rule1_alerts) == 3  ***REMOVED*** All three violations detected
    ...
    def test_rule_1_boundary_values(self):
        ...
        ***REMOVED*** Exactly at 3σ limits should not violate
...
class TestWesternElectricRule2:
    ...
    def test_rule_2_upper_violation(self):
        ...
        chart = WorkloadControlChart(target_hours=60.0, sigma=5.0)
        ***REMOVED*** 2σ upper = 70.0
        resident_id = uuid4()

        weekly_hours = [71, 72, 60, 61]  ***REMOVED*** First 3: two above 70
    ...
    def test_rule_2_lower_violation(self):
        ...
        chart = WorkloadControlChart(target_hours=60.0, sigma=5.0)
        ***REMOVED*** 2σ lower = 50.0
        resident_id = uuid4()

        weekly_hours = [49, 48, 60, 61]  ***REMOVED*** First 3: two below 50
    ...
    def test_rule_2_insufficient_violations(self):
        ...
        weekly_hours = [71, 60, 61]  ***REMOVED*** Only 1 above 2σ
    ...
    def test_rule_2_insufficient_data(self):
        ...
        weekly_hours = [71, 72]  ***REMOVED*** Only 2 points
    ...
    def test_rule_2_mixed_sides(self):
        ...
        ***REMOVED*** One above 2σ upper, one below 2σ lower - different sides
...
class TestWesternElectricRule3:
    ...
    def test_rule_3_upper_violation(self):
        ...
        chart = WorkloadControlChart(target_hours=60.0, sigma=5.0)
        ***REMOVED*** 1σ upper = 65.0
        resident_id = uuid4()

        weekly_hours = [66, 67, 60, 68, 69]  ***REMOVED*** 4 of 5 above 65
    ...
    def test_rule_3_lower_violation(self):
        ...
        chart = WorkloadControlChart(target_hours=60.0, sigma=5.0)
        ***REMOVED*** 1σ lower = 55.0
        resident_id = uuid4()

        weekly_hours = [54, 53, 60, 52, 51]  ***REMOVED*** 4 of 5 below 55
    ...
    def test_rule_3_insufficient_violations(self):
        ...
        weekly_hours = [66, 67, 60, 61, 68]  ***REMOVED*** Only 3 above 1σ
    ...
    def test_rule_3_insufficient_data(self):
        ...
        weekly_hours = [66, 67, 68, 69]  ***REMOVED*** Only 4 points
    ...
    def test_rule_3_exactly_4_of_5(self):
        ...
        weekly_hours = [66, 67, 60, 68, 69]  ***REMOVED*** Exactly 4 of 5
    ...
    def test_rule_3_all_5_of_5(self):
        ...
        weekly_hours = [66, 67, 68, 69, 70]  ***REMOVED*** All 5 above 1σ
...
class TestWesternElectricRule4:
    ...
    def test_rule_4_insufficient_consecutive(self):
        ...
        ***REMOVED*** Only 7 above centerline
    ...
    def test_rule_4_interrupted_sequence(self):
        ...
        ***REMOVED*** 7 above, then 1 below, then 1 above - no 8 consecutive
    ...
    def test_rule_4_on_centerline_breaks_sequence(self):
        ...
        ***REMOVED*** Point exactly on centerline should not count
    ...
    def test_rule_4_insufficient_data(self):
        ...
        weekly_hours = [61, 62, 63, 64, 65, 66, 67]  ***REMOVED*** Only 7 points
...
class TestMultipleRuleViolations:
    ...
    def test_rule_1_and_rule_2_together(self):
        ...
        ***REMOVED*** 76 triggers Rule 1 (> 75)
        ***REMOVED*** 71, 72 in window trigger Rule 2 (2 of 3 > 70)
    ...
    def test_all_rules_no_violation(self):
        ...
        ***REMOVED*** Perfectly centered data
        weekly_hours = [60, 60, 60, 60, 60, 60, 60, 60]

        alerts = chart.detect_western_electric_violations(resident_id, weekly_hours)

        ***REMOVED*** Algorithm may trigger Rule 4 (8 on same side) or no alerts
        ***REMOVED*** depending on how "same side" is calculated for values exactly at center
...
class TestCalculateControlLimits:
    ...
    def test_calculate_control_limits_known_values(self):
        ...
        ***REMOVED*** Data with mean=50, stdev=10
        data = [40, 45, 50, 55, 60]
        expected_mean = 50.0
    ...
    def test_calculate_control_limits_two_points(self):
        ...
        assert limits["n"] == 2
        ***REMOVED*** Standard deviation should be calculated
...
class TestCalculateProcessCapability:
    ...
    def test_process_capability_basic(self):
        ...
        ***REMOVED*** Centered process: mean=60, stdev=5
        ***REMOVED*** LSL=40, USL=80
        ...
        ***REMOVED*** Cp = (USL - LSL) / (6 * sigma)
        ***REMOVED*** Cp = (80 - 40) / (6 * ~2.5) = ~2.67
    ...
    def test_process_capability_centered_process(self):
        ...
        ***REMOVED*** Perfect normal distribution centered at 60
        data = [60] * 10  ***REMOVED*** No variation, perfectly centered
        ...
        ***REMOVED*** Zero variation -> infinite capability
    ...
    def test_process_capability_not_centered(self):
        ...
        ***REMOVED*** Process biased high: mean=70, stdev=5
        ...
        ***REMOVED*** Off-center process should have Cpk < Cp
        ***REMOVED*** (Cpk accounts for centering, Cp does not)
        assert capability["cpk"] <= capability["cp"]
        assert capability["mean"] > 60  ***REMOVED*** Biased high

    def test_process_capability_interpretation_not_capable(self):
        """Test interpretation for non-capable process (Cpk < 1.0)."""
        ***REMOVED*** Wide variation: sigma=15, mean=60
    ...
    def test_process_capability_interpretation_capable(self):
        ...
        ***REMOVED*** Tight distribution: mean=60, low variation
        ...
        ***REMOVED*** Should be capable with tight distribution
        assert capability["cpk"] > 0
    ...
    def test_process_capability_cp_formula(self):
        ...
        ***REMOVED*** Known values: mean=60, stdev=5, LSL=40, USL=80
        data = [55, 60, 65, 58, 62, 59, 61, 60]
        lsl = 40
        usl = 80
    ...
    def test_process_capability_cpk_formula(self):
        ...
        ***REMOVED*** Cpk = min((USL - mean)/(3*sigma), (mean - LSL)/(3*sigma))
    ...
    def test_process_capability_outside_spec_no_variation(self):
        ...
        ***REMOVED*** Mean at 90, all points identical, but USL=80
        data = [90, 90, 90, 90]
        lsl = 40
        usl = 80
        ...
        assert capability["sigma"] == 0.0
        assert capability["cpk"] == float("-inf")  ***REMOVED*** Outside spec
    ...
    def test_process_capability_acgme_scenario(self):
        ...
        ***REMOVED*** Weekly hours: target 60, variation ±5
        ***REMOVED*** ACGME limit: 80 hours/week
        data = [58, 62, 59, 61, 63, 60, 58, 62, 64, 57]
        lsl = 0  ***REMOVED*** Minimum hours (can't be negative)
        usl = 80  ***REMOVED*** ACGME limit

        capability = calculate_process_capability(data, lsl, usl)

        ***REMOVED*** Should show good capability (mean ~60, low variation)
        assert capability["mean"] < 65  ***REMOVED*** Well below ACGME limit
        assert capability["cpk"] > 1.0  ***REMOVED*** Should be capable
...
class TestIntegrationScenarios:
    ...
    def test_acgme_violation_scenario(self):
        ...
        ***REMOVED*** Gradual increase leading to ACGME violation
        weekly_hours = [60, 65, 68, 72, 75, 78, 80, 82]

        alerts = chart.detect_western_electric_violations(resident_id, weekly_hours)

        ***REMOVED*** Should trigger multiple rules
        assert len(alerts) > 0

        ***REMOVED*** Should have CRITICAL alert (Rule 1) for 82 hours
    ...
    def test_normal_rotation_variation(self):
        ...
        ***REMOVED*** Normal variation within ±1σ
        weekly_hours = [58, 62, 59, 61, 60, 58, 63, 59]

        alerts = chart.detect_western_electric_violations(resident_id, weekly_hours)

        ***REMOVED*** Should not trigger WARNING or CRITICAL alerts
        critical_or_warning = [
    ...
    def test_burnout_pattern_detection(self):
        ...
        ***REMOVED*** Sustained high hours (between 1σ and 2σ)
        weekly_hours = [66, 67, 68, 67, 66, 68, 67, 66]

        alerts = chart.detect_western_electric_violations(resident_id, weekly_hours)

        ***REMOVED*** Should trigger Rule 4 (8 consecutive above centerline)
        rule4_alerts = [a for a in alerts if a.rule == "Rule 4"]
        assert len(rule4_alerts) == 1
    ...
    def test_scheduling_gap_detection(self):
        ...
        ***REMOVED*** Sudden drop suggesting scheduling gap
        weekly_hours = [60, 62, 59, 20, 61]  ***REMOVED*** 20 hours << 45 (3σ lower)

        alerts = chart.detect_western_electric_violations(resident_id, weekly_hours)

        ***REMOVED*** Should trigger Rule 1 for low hours
        rule1_alerts = [a for a in alerts if a.rule == "Rule 1"]
        assert len(rule1_alerts) > 0
