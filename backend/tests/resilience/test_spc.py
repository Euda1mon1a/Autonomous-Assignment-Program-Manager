...
class TestControlChart:
    ...
    def test_calculate_limits_from_baseline(self):
        ...
        ***REMOVED*** Mean should be around 11.5
    ...
    def test_out_of_control_point(self):
        ...
        ***REMOVED*** Add point far beyond UCL
    ...
    def test_capability_indices(self):
        ...
        ***REMOVED*** Add stable process data
        for _ in range(10):
...
class TestCUSUMChart:
    ...
    def test_cusum_detects_shift(self):
        ...
        ***REMOVED*** Process shifts from 10 to 10.5
        for i in range(20):
            value = 10.5
            point = cusum.add_point(value)

            ***REMOVED*** Should eventually go out of control
            if i > 10:
                assert not point.is_in_control
    ...
    def test_cusum_stays_in_control_no_shift(self):
        ...
        ***REMOVED*** Should stay in control
        assert point.is_in_control
    ...
    def test_cusum_reset(self):
        ...
        cusum.add_point(15.0)  ***REMOVED*** Cause accumulation
        cusum.reset()
...
class TestEWMAChart:
    ...
    def test_ewma_smooths_data(self):
        ...
        ***REMOVED*** Add noisy data
        values = [10.5, 9.5, 10.2, 9.8, 10.1]

        for value in values:
            point = ewma.add_point(value)

        ***REMOVED*** EWMA should be smoother than raw data
        ***REMOVED*** and converge toward mean
    ...
    def test_ewma_detects_shift(self):
        ...
        ***REMOVED*** Gradual shift upward
        for i in range(50):
            value = 10.0 + i * 0.05  ***REMOVED*** Slow drift
            point = ewma.add_point(value)
...
class TestWesternElectricRules:
    ...
    def test_rule_1_beyond_3sigma(self):
        ...
        data = [10.0] * 10 + [14.0]  ***REMOVED*** Last point beyond 3σ
    ...
    def test_rule_4_eight_same_side(self):
        ...
        data = [10.5] * 8  ***REMOVED*** All above center line
    ...
    def test_rule_5_six_trending(self):
        ...
        data = [10.0, 10.1, 10.2, 10.3, 10.4, 10.5]  ***REMOVED*** Increasing trend
    ...
    def test_no_violations_in_control(self):
        ...
        ***REMOVED*** Random but in-control data
        data = [10.0, 10.2, 9.8, 10.1, 9.9, 10.0, 10.1, 9.9]

        violations = rules.check_all_rules(data)

        ***REMOVED*** Should have minimal violations
    ...
    def test_get_rule_summary(self):
        ...
        data = [10.0] * 5 + [14.0] + [10.0] * 5  ***REMOVED*** One outlier
