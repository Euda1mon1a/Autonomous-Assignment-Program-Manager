...
class TestSIRModel:
    ...
    def test_simulate_epidemic_growth(self):
        ...
        model = SIRModel(transmission_rate=0.4, recovery_rate=0.1)  ***REMOVED*** R0 = 4
        ...
        ***REMOVED*** Should have epidemic peak
    ...
    def test_simulate_die_out(self):
        ...
        model = SIRModel(transmission_rate=0.05, recovery_rate=0.1)  ***REMOVED*** R0 = 0.5
        ...
        ***REMOVED*** Epidemic should die out
        final_infected = forecast.forecasted_infected[-1]
        assert final_infected < 5  ***REMOVED*** Fewer infected at end than start

    def test_herd_immunity_threshold(self):
        """Test herd immunity threshold calculation."""
        ***REMOVED*** R0 = 4 => HIT = 1 - 1/4 = 0.75 (75% immune needed)
        ...
        ***REMOVED*** R0 < 1 => no herd immunity needed
    ...
    def test_predict_final_size(self):
        ...
        ***REMOVED*** Should be > 10 (epidemic spreads)
    ...
    def test_intervention_effect(self):
        ...
        impact = model.calculate_intervention_effect(
            current_beta=0.4,
            intervention_beta=0.2,  ***REMOVED*** 50% reduction in transmission
            current_infected=10,
            total_population=100,
            days=60,
        )

        ***REMOVED*** Intervention should reduce cases
    ...
    def test_conservation_of_population(self):
        ...
        ***REMOVED*** Check conservation at random time points
        for i in [0, 30, 60, 89]:
            total = (
            ...
            assert total == pytest.approx(100, abs=2)  ***REMOVED*** Allow small numerical error
    ...
    def test_peak_timing_reasonable(self):
        ...
        ***REMOVED*** Peak should occur between day 0 and day 100
