...
class TestBurnoutEarlyWarning:
    ...
    def test_trigger_onset_basic(self):
        ...
        ***REMOVED*** Create STA/LTA with clear trigger
        sta_lta = np.array([
            1.0, 1.0, 1.0,  ***REMOVED*** Below threshold
            3.0, 4.0, 3.5,  ***REMOVED*** Above threshold
            0.8, 0.8, 0.8,  ***REMOVED*** Back below
        ])
    ...
    def test_trigger_onset_multiple_triggers(self):
        ...
        sta_lta = np.array([
            1.0, 1.0, 3.0, 3.0, 0.5,  ***REMOVED*** First trigger
            1.0, 1.0, 4.0, 4.0, 0.5,  ***REMOVED*** Second trigger
        ])
    ...
    def test_detect_precursors_basic(self):
        ...
        ***REMOVED*** Baseline: 0-1 per week, then increasing stress
        time_series = (
            [0, 1, 0, 1, 0, 0, 1, 0, 1, 0] * 3  ***REMOVED*** 30 days baseline
            + [1, 2, 2, 3, 3, 4, 5, 6, 7, 8]  ***REMOVED*** 10 days increasing
        )
    ...
    def test_detect_precursors_no_anomaly(self):
        ...
        ***REMOVED*** Should not detect any alerts
        assert len(alerts) == 0
...
class TestIntegration:
    ...
    def test_multi_signal_magnitude_prediction(self):
        ...
        ***REMOVED*** Should predict significant burnout risk
