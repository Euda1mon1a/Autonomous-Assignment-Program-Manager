...
class TestFMITWeekDates:
    ...
    def test_thursday_returns_current_week(self):
        ...
        thursday = date(2025, 1, 9)  ***REMOVED*** Thursday
    ...
    def test_week_span_is_7_days(self):
        ...
        start, end = get_fmit_week_dates(friday)
        assert (end - start).days == 6  ***REMOVED*** Inclusive of both days = 7 days
...
class TestFMITWeekBlockingConstraint:
    ...
    def test_constraint_initialization(self):
        ...
        assert constraint.priority.value == 100  ***REMOVED*** CRITICAL
...
class TestPostFMITRecoveryConstraint:
    ...
    def test_constraint_initialization(self):
        ...
        assert constraint.priority.value == 75  ***REMOVED*** HIGH

    def test_recovery_friday_calculation(self):
        """Test that recovery Friday is day after FMIT Thursday."""
        ***REMOVED*** FMIT week: Fri Jan 3 - Thu Jan 9
        ***REMOVED*** Recovery Friday: Jan 10
        ...
        assert recovery_friday.weekday() == 4  ***REMOVED*** Friday
...
class TestFacultyRoleClinicConstraint:
    ...
    def test_get_week_start_monday(self):
        ...
        constraint = FacultyRoleClinicConstraint()
        ***REMOVED*** Wednesday Jan 8, 2025
        wednesday = date(2025, 1, 8)
        week_start = constraint._get_week_start(wednesday)
        assert week_start == date(2025, 1, 6)  ***REMOVED*** Monday
        assert week_start.weekday() == 0  ***REMOVED*** Monday
...
class TestFMITWeekEdgeCases:
    ...
    def test_year_boundary(self):
        ...
        ***REMOVED*** If Dec 31 is in middle of FMIT week
        dec_31_2024 = date(2024, 12, 31)  ***REMOVED*** Tuesday
        start, end = get_fmit_week_dates(dec_31_2024)
        ***REMOVED*** Friday Dec 27, 2024 to Thursday Jan 2, 2025
        assert start == date(2024, 12, 27)
        assert end == date(2025, 1, 2)

    def test_leap_year(self):
        """Test FMIT week in leap year."""
        ***REMOVED*** Feb 29, 2024 was a Thursday
        leap_day = date(2024, 2, 29)
        start, end = get_fmit_week_dates(leap_day)
        assert start == date(2024, 2, 23)  ***REMOVED*** Friday
        assert end == leap_day  ***REMOVED*** Thursday (leap day)

    def test_consecutive_weeks(self):
        """Test consecutive FMIT weeks don't overlap."""
        ***REMOVED*** Week 1: Fri Jan 3 - Thu Jan 9
        week1_start, week1_end = get_fmit_week_dates(date(2025, 1, 5))

        ***REMOVED*** Week 2: Fri Jan 10 - Thu Jan 16
        week2_start, week2_end = get_fmit_week_dates(date(2025, 1, 12))

        ***REMOVED*** Week 1 end should be day before week 2 start
...
class TestPostFMITSundayBlockingConstraint:
    ...
    def test_blocked_sunday_calculation(self):
        ...
        assert blocked_sunday.weekday() == 6  ***REMOVED*** Sunday
    ...
    def test_recovery_friday_vs_blocked_sunday(self):
        ...
        ***REMOVED*** Should be different days
        assert recovery_friday != blocked_sunday
        ***REMOVED*** Recovery is Friday (day 4), blocked Sunday is Sunday (day 6)
        assert recovery_friday.weekday() == 4
        assert blocked_sunday.weekday() == 6
        ***REMOVED*** 2-day gap between them (Saturday is open)
    ...
    def test_saturday_not_blocked(self):
        ...
        ***REMOVED*** Saturday should be day 5, between recovery Friday and blocked Sunday
        assert saturday.weekday() == 5
        ***REMOVED*** Saturday is NOT the blocked Sunday
        blocked_sunday = thursday_end + timedelta(days=3)
