***REMOVED*** Test Files Summary

***REMOVED******REMOVED*** test_people_routes.py

**Total Test Functions:** 65
**Total Test Classes:** 12

***REMOVED******REMOVED******REMOVED*** Test Classes and Coverage:
...
***REMOVED******REMOVED*** test_calendar_routes.py
...
***REMOVED******REMOVED******REMOVED*** People Routes (10 endpoints)
- ✓ GET /api/people
...
***REMOVED******REMOVED******REMOVED*** Calendar Routes (8 main endpoints + 1 legacy)
...
```bash
***REMOVED*** Run all people route tests
pytest tests/test_people_routes.py -v

***REMOVED*** Run all calendar route tests
