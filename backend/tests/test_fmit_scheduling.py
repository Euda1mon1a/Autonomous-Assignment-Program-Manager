...
***REMOVED*** ============================================================================
***REMOVED*** Unit Tests for Constraint Detection
***REMOVED*** ============================================================================
...
class TestBackToBackDetection:
    ...
    def test_no_conflict_with_gap(self):
        ...
        weeks = [
            date(2025, 3, 3),   ***REMOVED*** Week 1
            date(2025, 3, 17),  ***REMOVED*** Week 3 (2 week gap)
            date(2025, 4, 7),   ***REMOVED*** Week 6 (3 week gap)
        ]
    ...
    def test_conflict_consecutive_weeks(self):
        ...
        weeks = [
            date(2025, 3, 3),   ***REMOVED*** Week 1
            date(2025, 3, 10),  ***REMOVED*** Week 2 (consecutive!)
        ]
    ...
    def test_conflict_near_consecutive(self):
        ...
        weeks = [
            date(2025, 3, 3),   ***REMOVED*** Monday
            date(2025, 3, 9),   ***REMOVED*** Sunday (6 days later)
        ]
        assert has_back_to_back_conflict(weeks)
    ...
    def test_conflict_unsorted_input(self):
        ...
        weeks = [
            date(2025, 3, 17),  ***REMOVED*** Out of order
            date(2025, 3, 3),
            date(2025, 3, 10),  ***REMOVED*** Consecutive with 3/3
        ]
        assert has_back_to_back_conflict(weeks)
...
class TestAlternatingPatternDetection:
    ...
    def test_no_alternating_sparse(self):
        ...
        weeks = [
            date(2025, 3, 3),
            date(2025, 4, 7),   ***REMOVED*** 5 week gap
            date(2025, 5, 12),  ***REMOVED*** 5 week gap
        ]
    ...
    def test_alternating_pattern_detected(self):
        ...
        weeks = [
            date(2025, 3, 3),   ***REMOVED*** Week 1
            date(2025, 3, 17),  ***REMOVED*** Week 3 (1 week gap = alternating)
            date(2025, 3, 31),  ***REMOVED*** Week 5 (1 week gap = alternating)
        ]
    ...
    def test_mixed_pattern(self):
        ...
        weeks = [
            date(2025, 3, 3),   ***REMOVED*** Week 1
            date(2025, 3, 17),  ***REMOVED*** Week 3 (alternating)
            date(2025, 4, 21),  ***REMOVED*** Week 8 (not alternating - 5 week gap)
            date(2025, 5, 5),   ***REMOVED*** Week 10 (alternating)
        ]
        assert count_alternating_cycles(weeks) == 2
...
class TestSwapFinder:
    ...
    def mock_fmit_schedule(self) -> ImportResult:
        ...
        ***REMOVED*** Provider A has weeks 1, 3, 5 (alternating)
        ...
        ***REMOVED*** Provider B has weeks 2, 6 (not alternating)
        ...
        ***REMOVED*** Provider C has week 4 only (under target)
    ...
    def test_find_swap_candidates_basic(self, mock_fmit_schedule):
        ...
        ***REMOVED*** Find candidates to take Dr. Smith's week 3
        target_week = date(2025, 3, 17)  ***REMOVED*** Week 3
        candidates = finder.find_swap_candidates("Dr. Smith", target_week)

        assert len(candidates) == 2  ***REMOVED*** Jones and Lee
    ...
    def test_find_swap_candidates_back_to_back_check(self, mock_fmit_schedule):
        ...
        ***REMOVED*** Week 3 is March 17. Jones has week 2 (Mar 10) - would create back-to-back
        target_week = date(2025, 3, 17)
        candidates = finder.find_swap_candidates("Dr. Smith", target_week)

        jones_candidate = next(c for c in candidates if c.faculty == "Dr. Jones")
        ***REMOVED*** Jones has week 2, taking week 3 would be back-to-back
        assert not jones_candidate.back_to_back_ok

        lee_candidate = next(c for c in candidates if c.faculty == "Dr. Lee")
        ***REMOVED*** Lee has week 4, taking week 3 would be back-to-back
    ...
    def test_external_conflict_blocks_candidate(self, mock_fmit_schedule):
        ...
        ***REMOVED*** Find candidates for week 3 (March 17)
        target_week = date(2025, 3, 17)
        candidates = finder.find_swap_candidates("Dr. Smith", target_week)
...
***REMOVED*** ============================================================================
***REMOVED*** Absence Integration Tests
***REMOVED*** ============================================================================
...
class TestAbsenceIntegration:
    ...
    def test_load_conflicts_from_blocking_absence(
        ...
        ***REMOVED*** Create a blocking TDY absence
        absence = Absence(
            id=uuid4(),
    ...
    def test_non_blocking_absence_excluded(
        ...
        ***REMOVED*** Create a short vacation (non-blocking)
        absence = Absence(
            id=uuid4(),
            person_id=sample_faculty_for_absence.id,
            start_date=date.today() + timedelta(days=30),
            end_date=date.today() + timedelta(days=32),  ***REMOVED*** 3 days
        ...
        ***REMOVED*** Should not include short vacation
    ...
    def test_deployment_always_blocking(
        ...
        absence = Absence(
            ...
            is_blocking=True,  ***REMOVED*** Must be explicit due to column default
        )
        db.add(absence)
        db.commit()
...
class TestSwapFinderAPI:
    ...
    def test_find_swaps_with_external_conflicts(
        ...
        ***REMOVED*** Dr. Jones should have external conflict flagged
...
class TestSwapFinderSchemas:
    ...
    def test_swap_finder_request_valid(self):
        ...
        assert request.include_absence_conflicts is True  ***REMOVED*** default
    ...
    def test_external_conflict_input_validates_dates(self):
        ...
        with pytest.raises(ValueError):
            ExternalConflictInput(
                ...
                end_date=date(2025, 3, 1),  ***REMOVED*** End before start
                conflict_type="leave",
            )
    ...
    def test_faculty_target_input_constraints(self):
        ...
        ***REMOVED*** Should reject invalid weeks
        with pytest.raises(ValueError):
            FacultyTargetInput(
                name="Dr. Smith",
                target_weeks=100,  ***REMOVED*** Too high
            )
