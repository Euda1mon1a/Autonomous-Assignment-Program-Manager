...
***REMOVED*** =============================================================================
***REMOVED*** MINIMAL REIMPLEMENTATION FOR STANDALONE TESTING
***REMOVED*** =============================================================================
...
***REMOVED*** Simplified QUBO formulation
...
***REMOVED*** Simplified Quantum Tunneling Annealer
...
def test_landscape_export():
    ...
    ***REMOVED*** Test JSON serialization
...
def test_scalability():
    ...
    ***REMOVED*** 30 nights, excluding weekends
    nights = []
    current = base_date
    while len(nights) < 30:
        if current.weekday() not in (4, 5):  ***REMOVED*** Exclude Fri/Sat
            nights.append(
