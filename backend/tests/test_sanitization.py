...
class TestHTMLSanitization:
    ...
    def test_escape_html(self):
        ...
        assert escape_html("'single'") == "&***REMOVED***x27;single&***REMOVED***x27;"
...
class TestSQLSanitization:
    ...
    def test_validate_identifier_invalid(self):
        ...
        with pytest.raises(SQLInjectionError):
            validate_identifier("123invalid")  ***REMOVED*** Can't start with number

        with pytest.raises(SQLInjectionError):
            validate_identifier("")  ***REMOVED*** Empty
    ...
    def test_sanitize_numeric_id(self):
        ...
        assert sanitize_numeric_id("-1") is None  ***REMOVED*** Negative
...
class TestXSSPrevention:
    ...
    def test_normalize_unicode(self):
        ...
        ***REMOVED*** Test that it doesn't crash with various Unicode
        result = normalize_unicode("café")
        assert result == "café"

        ***REMOVED*** Test control character removal
...
class TestSanitizationIntegration:
    ...
    def test_sanitization_preserves_safe_content(self):
        ...
        for safe_input in safe_inputs:
            ***REMOVED*** Should not detect threats
    ...
    def test_unicode_normalization_prevents_bypass(self):
        ...
        ***REMOVED*** Test with various Unicode forms
        text = "café"
        normalized = normalize_unicode(text)
        assert normalized  ***REMOVED*** Should not be empty
        assert len(normalized) <= len(text)  ***REMOVED*** May be shorter after normalization
...
class TestEdgeCases:
    ...
    def test_mixed_encodings(self):
        ...
        ***REMOVED*** Should detect encoded script tag
