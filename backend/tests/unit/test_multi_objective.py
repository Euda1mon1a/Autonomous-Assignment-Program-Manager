...
class TestObjectiveConfig:
    ...
    def test_normalize_minimize(self):
        ...
        assert obj.normalize(0.0) == 0.0  ***REMOVED*** Ideal
        assert obj.normalize(1.0) == 1.0  ***REMOVED*** Worst
        assert obj.normalize(0.5) == 0.5  ***REMOVED*** Middle
    ...
    def test_normalize_maximize(self):
        ...
        assert obj.normalize(1.0) == 0.0  ***REMOVED*** Ideal (best)
        assert obj.normalize(0.0) == 1.0  ***REMOVED*** Worst
        assert obj.normalize(0.5) == 0.5  ***REMOVED*** Middle
...
class TestDominance:
    ...
    def test_dominates(self, two_objective_config):
        ...
        ***REMOVED*** Coverage: maximize, Equity: minimize
...
class TestParetoFrontier:
    ...
    def test_reject_dominated(self, two_objective_config):
        ...
        frontier.add(better)
        assert not frontier.add(worse)  ***REMOVED*** Should be rejected
    ...
    def test_get_extreme_solutions(self, pareto_frontier):
        ...
        assert len(extremes) >= 2  ***REMOVED*** At least one for each objective
...
class TestWeightVectors:
    ...
    def test_generate_uniform_2d(self):
        ...
        for w in weights:
            assert abs(sum(w) - 1.0) < 1e-10  ***REMOVED*** Sum to 1
...
***REMOVED*** ============================================================================
***REMOVED*** Constraint Handling Tests
***REMOVED*** ============================================================================
class TestPenaltyMethods:
    ...
    def test_static_penalty(self):
        ...
        expected = 1000.0 * 0.25 + 10.0 * 0.09  ***REMOVED*** magnitude^2
    ...
    def test_adaptive_penalty_updates(self):
        ...
        penalty.update_feasibility(0.2)  ***REMOVED*** Too few feasible
        assert penalty.coefficient < initial  ***REMOVED*** Should decrease

        penalty.update_feasibility(0.8)  ***REMOVED*** Too many feasible
        ***REMOVED*** Should increase
...
class TestConstraintRelaxer:
    ...
    def test_relaxation_on_infeasibility(self):
        ...
        ***REMOVED*** Simulate infeasibility streak
        for _ in range(5):
            relaxer.update(is_feasible=False, feasibility_ratio=0.0)

        thresholds = relaxer.get_current_thresholds()
        assert thresholds["capacity"] > 1.0  ***REMOVED*** Should have relaxed
    ...
    def test_restoration_on_feasibility(self):
        ...
        ***REMOVED*** Then restore
        for _ in range(10):
            relaxer.update(is_feasible=True, feasibility_ratio=0.5)

        restored = relaxer.get_current_thresholds()["capacity"]
        assert restored < relaxed  ***REMOVED*** Should have moved toward original


***REMOVED*** ============================================================================
***REMOVED*** Preference Articulation Tests
***REMOVED*** ============================================================================
class TestWeightedSumPreference:
    ...
    def test_score_calculation(self, two_objective_config):
        ...
        ***REMOVED*** Coverage is maximize (negated), equity is minimize
    ...
    def test_ranking(self, two_objective_config, sample_solutions):
        ...
        ***REMOVED*** Should be sorted by coverage (highest first, but scores are negated)
...
class TestAchievementScalarizing:
    ...
    def test_asf_score(self, two_objective_config):
        ...
        ***REMOVED*** Solution is worse in both, so score should be positive
        assert score > 0
...
***REMOVED*** ============================================================================
***REMOVED*** Quality Indicator Tests
***REMOVED*** ============================================================================
class TestHypervolume:
    ...
    def test_2d_hypervolume(self, two_objective_config):
        ...
        ***REMOVED*** Add two non-dominated solutions
...
***REMOVED*** ============================================================================
***REMOVED*** Decision Support Tests
***REMOVED*** ============================================================================
class TestTradeOffAnalyzer:
    ...
    def test_analyze_trade_off(self, two_objective_config):
        ...
        ***REMOVED*** Coverage improves, equity degrades
...
class TestSolutionExplorer:
    ...
    def test_navigate_toward_objective(self, two_objective_config, pareto_frontier):
        ...
        if steps:  ***REMOVED*** May be empty if already at extreme
...
class TestCrowdingDistance:
    ...
    def test_calculate_crowding(self, two_objective_config, sample_solutions):
        ...
        ***REMOVED*** Boundary solutions should have infinite distance
...
class TestEpsilonDominance:
    ...
    def test_update_archive(self, two_objective_config):
        ...
        sol2 = Solution(objective_values={"coverage": 0.81, "equity": 0.21})  ***REMOVED*** Same cell

        archive = eps_dom.update_archive(archive, sol1)
        archive = eps_dom.update_archive(archive, sol2)

        ***REMOVED*** Should only keep one (same cell)
...
class TestObjectiveAdjuster:
    ...
    def test_weight_bounds(self, two_objective_config):
        ...
        ***REMOVED*** Try to set extreme weight
...
class TestDynamicReweighter:
    ...
    def test_boost_objective(self, two_objective_config):
        ...
        ***REMOVED*** Coverage should have increased relative to others
...
class TestMultiObjectiveIntegration:
    ...
    def test_full_optimization_workflow(self, three_objective_config):
        ...
        ***REMOVED*** Simple evaluation/mutation functions
        def evaluate(sol):
            return sol
    ...
    def test_decision_support_workflow(self, two_objective_config, pareto_frontier):
        ...
        ***REMOVED*** Start at recommended point
