...
***REMOVED*** ============================================================================
***REMOVED*** Test 1: Notification Creation - Single User
***REMOVED*** ============================================================================
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            ***REMOVED*** Mock preferences
            with patch.object(
                ...
                ***REMOVED*** Verify delivery was successful
                assert len(results) == 1
                assert results[0].success is True
                assert results[0].channel == "in_app"

                ***REMOVED*** Verify database add was called
    ...
    async def test_create_notification_with_high_priority(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                ***REMOVED*** Verify notification was stored
                assert mock_db.add.called

                ***REMOVED*** Check that the added notification has high priority
    ...
    async def test_create_notification_with_normal_priority(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                assert len(results) > 0
                ***REMOVED*** Verify normal priority
                call_args = mock_db.add.call_args_list
                notification = call_args[-1][0][0]
...
***REMOVED*** ============================================================================
***REMOVED*** Test 2: Notification Creation - Multiple Users
***REMOVED*** ============================================================================
...
class TestNotificationCreationMultipleUsers:
    ...
    async def test_create_notification_multiple_users_bulk(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                ***REMOVED*** Verify all recipients received notification
    ...
    async def test_bulk_notification_partial_failure(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ***REMOVED*** First two succeed, third fails
...
***REMOVED*** ============================================================================
***REMOVED*** Test 4: Delivery Channels - Email (Mock SMTP)
***REMOVED*** ============================================================================
...
class TestDeliveryChannelEmail:
    ...
    async def test_email_channel_handles_exception(self):
        ...
        ***REMOVED*** Mock _format_html to raise exception
        with patch.object(
...
***REMOVED*** ============================================================================
***REMOVED*** Test 5: Delivery Channels - Webhook/Slack (Mock Webhook)
***REMOVED*** ============================================================================
...
class TestDeliveryChannelWebhook:
    ...
    async def test_webhook_channel_no_url(self):
        ...
        ***REMOVED*** Should still succeed (queued for delivery)
        assert result.success is True
        assert result.metadata["webhook_url"] is None


***REMOVED*** ============================================================================
***REMOVED*** Test 6: Template Rendering - Variable Substitution
***REMOVED*** ============================================================================
...
class TestTemplateVariableSubstitution:
    ...
    def test_template_rendering_missing_variables_safe_substitute(self):
        ...
        ***REMOVED*** Provide incomplete data
        data = {
            "period": "January 2025",
            "coverage_rate": "95.0",
            ***REMOVED*** Missing: total_assignments, violations_count, publisher_name, published_at
        }
        ...
        assert "January 2025" in rendered["subject"]
        assert "95.0" in rendered["body"]
        ***REMOVED*** Missing variables should be left as $variable_name (safe_substitute behavior)
    ...
    def test_template_rendering_empty_data(self):
        ...
        assert rendered is not None
        ***REMOVED*** Template should still render with placeholders


***REMOVED*** ============================================================================
***REMOVED*** Test 7: Template Rendering - HTML vs Plain Text
***REMOVED*** ============================================================================
...
class TestTemplateHTMLvsPlainText:
    ...
    async def test_email_channel_produces_html(self):
        ...
        ***REMOVED*** Body should be plain text
        assert email_payload["body"] == "Your schedule has been published."

        ***REMOVED*** HTML should be formatted version
        html = email_payload["html"]
        assert "<html>" in html
        assert "<body>" in html
    ...
    async def test_in_app_channel_plain_text(self):
        ...
        ***REMOVED*** In-app should be plain text (no HTML formatting)
        assert result.success is True


***REMOVED*** ============================================================================
***REMOVED*** Test 8: Batching Logic - Batch Multiple Notifications
***REMOVED*** ============================================================================
    ...
    async def test_batch_notifications_sequential(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                ***REMOVED*** Verify all notifications sent
                assert len(results) == 5

                ***REMOVED*** Verify channel.deliver was called 5 times
                assert mock_channel.deliver.call_count == 5


***REMOVED*** ============================================================================
***REMOVED*** Test 9: Batching Logic - Immediate vs Scheduled Delivery
***REMOVED*** ============================================================================
...
class TestImmediateVsScheduledDelivery:
    ...
    async def test_immediate_delivery(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                ***REMOVED*** Immediate delivery should happen now
                assert len(results) > 0
                assert results[0].success is True
    ...
    def test_scheduled_delivery(
        ...
        ***REMOVED*** Mock database query
        mock_db.add = Mock()
        mock_db.commit = Mock()

        ***REMOVED*** Create a mock record that will be returned after commit
        ...
        ***REMOVED*** Verify scheduled notification was created
    ...
    async def test_process_scheduled_notifications_due(
        ...
        ***REMOVED*** Create a mock due notification
        ...
        ***REMOVED*** Mock query to return the due notification
        mock_query = Mock()
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                ***REMOVED*** Verify notification was sent
                assert sent_count == 1
                assert mock_record.status == "sent"


***REMOVED*** ============================================================================
***REMOVED*** Test 10: Retry Handling - Failed Delivery Retry
***REMOVED*** ============================================================================
...
class TestRetryFailedDelivery:
    ...
    async def test_failed_delivery_increments_retry_count(
        ...
        ***REMOVED*** Force send_notification to raise an exception
        with patch.object(
            notification_service,
            "send_notification",
            ...
            ***REMOVED*** Verify retry count was incremented
            assert sent_count == 1
    ...
    async def test_retry_after_transient_failure(
        ...
        mock_record.send_at = datetime.utcnow() - timedelta(minutes=5)
        mock_record.status = "pending"
        mock_record.retry_count = 1  ***REMOVED*** Already retried once
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ***REMOVED*** First attempt fails, second succeeds (simulating retry)
            mock_channel = Mock()
            mock_channel.deliver = AsyncMock(
                return_value=DeliveryResult(
            ...
            with patch.object(
                ...
                ***REMOVED*** Should succeed on retry
                assert sent_count == 1
                assert mock_record.status == "sent"


***REMOVED*** ============================================================================
***REMOVED*** Test 11: Retry Handling - Max Retry Limit
***REMOVED*** ============================================================================
...
class TestMaxRetryLimit:
    ...
    async def test_max_retry_limit_enforced(
        ...
        ***REMOVED*** Create notification that has already been retried 3 times
        mock_record = Mock(spec=ScheduledNotificationRecord)
        mock_record.id = uuid4()
        mock_record.recipient_id = uuid4()
        ...
        mock_record.status = "pending"
        mock_record.retry_count = 3  ***REMOVED*** Max retries typically 3
        ...
        ***REMOVED*** Simulate failure
        with patch.object(
            ...
            ***REMOVED*** Should be marked as failed
            assert sent_count == 1
            assert mock_record.status == "failed"
            assert mock_record.retry_count == 4  ***REMOVED*** Incremented
            ***REMOVED*** Note: Real implementation might have logic to not retry after max


***REMOVED*** ============================================================================
***REMOVED*** Test 12: User Preferences - Channel Filtering
***REMOVED*** ============================================================================
...
class TestUserPreferencesChannelFiltering:
    ...
    async def test_disabled_notification_type_skipped(
        ...
        ***REMOVED*** User has disabled schedule_published notifications
        ...
        with patch.object(
            ...
            ***REMOVED*** Notification should be skipped
            assert len(results) == 0
    ...
    async def test_channel_filtering_by_preference(
        ...
        ***REMOVED*** User only wants in_app notifications
        preferences = NotificationPreferences(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                results = await notification_service.send_notification(
                    ...
                    channels=["in_app", "email"],  ***REMOVED*** Request both channels
                )

                ***REMOVED*** Only in_app should be delivered
                assert len(results) == 1
                assert results[0].channel == "in_app"


***REMOVED*** ============================================================================
***REMOVED*** Test 13: Quiet Hours - Notification Suppression
***REMOVED*** ============================================================================
...
class TestQuietHoursNotificationSuppression:
    ...
    async def test_quiet_hours_suppresses_normal_priority(
        ...
        with patch.object(
            ...
            ***REMOVED*** Normal priority notification should be suppressed during quiet hours
            assert len(results) == 0
    ...
    async def test_quiet_hours_allows_high_priority(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            with patch.object(
                ...
                results = await notification_service.send_notification(
                    recipient_id=sample_recipient_id,
                    notification_type=NotificationType.ACGME_WARNING,  ***REMOVED*** High priority
                    data={
                ...
                ***REMOVED*** High priority should bypass quiet hours
                assert len(results) > 0


***REMOVED*** ============================================================================
***REMOVED*** Test 14: Template Not Found Handling
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test 15: Channel Not Found Handling
***REMOVED*** ============================================================================
    ...
    async def test_invalid_channel_returns_error(
        ...
        with patch("app.notifications.service.get_channel", return_value=None):
            with patch.object(
                ...
                ***REMOVED*** Should have error result for invalid channel
                assert len(results) == 1
                assert results[0].success is False
...
***REMOVED*** ============================================================================
***REMOVED*** Test 16: Notification Retrieval and Read Status
***REMOVED*** ============================================================================
...
class TestNotificationRetrievalAndReadStatus:
    ...
    def test_get_pending_notifications_unread_only(
        ...
        ***REMOVED*** Mock unread notifications
        mock_notifications = [
            Mock(
                id=uuid4(),
                notification_type="schedule_published",
...
***REMOVED*** ============================================================================
***REMOVED*** Test 17: Update User Preferences
***REMOVED*** ============================================================================
...
class TestUpdateUserPreferences:
    ...
    def test_create_new_preferences(
        ...
        ***REMOVED*** Mock query returns no existing preferences
        mock_query = Mock()
        mock_query.filter.return_value = mock_query
    ...
    def test_update_existing_preferences(
        ...
        ***REMOVED*** Mock existing preferences record
        ...
        ***REMOVED*** Verify preferences were updated
...
***REMOVED*** ============================================================================
***REMOVED*** Test 18: Multiple Channel Delivery
***REMOVED*** ============================================================================
...
class TestMultipleChannelDelivery:
    ...
    async def test_deliver_to_multiple_channels(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ***REMOVED*** Mock different channels
            ...
            with patch.object(
                ...
                ***REMOVED*** All three channels should have results
                assert len(results) == 3
