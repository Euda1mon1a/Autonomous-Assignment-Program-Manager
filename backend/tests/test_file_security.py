...
class TestValidateBackupId:
    ...
    def test_valid_backup_id(self):
        ...
        valid_ids = [
            ...
            "test_backup_123",
            "ABC-123-xyz",
            "12345678-1234-1234-1234-123456789012",  ***REMOVED*** UUID format
        ]
...
class TestValidateFilePath:
    ...
    def test_path_traversal_rejected(self, tmp_path):
        ...
        ***REMOVED*** Try to escape the base directory
    ...
    def test_absolute_path_outside_base(self, tmp_path):
        ...
        ***REMOVED*** Absolute path outside base directory
    ...
    def test_symlink_escape_rejected(self, tmp_path):
        ...
        ***REMOVED*** Create a target outside the base
        outside_target = tmp_path / "outside" / "target.txt"
        outside_target.parent.mkdir(parents=True)
        outside_target.write_text("secret")

        ***REMOVED*** Create symlink inside base pointing outside
        symlink_path = base_dir / "link"
        symlink_path.symlink_to(outside_target)

        ***REMOVED*** Should reject because resolved path is outside base
        with pytest.raises(FileSecurityError, match="outside allowed directory"):
...
class TestPathTraversalIntegration:
    ...
    def test_backup_id_path_traversal_attack(self, tmp_path):
        ...
        ***REMOVED*** Attacker tries to access /etc/passwd via backup_id
    ...
    def test_csv_path_traversal_attack(self, tmp_path):
        ...
        ***REMOVED*** Attacker tries to access sensitive file outside allowed directory
    ...
    def test_windows_path_traversal_attack(self, tmp_path):
        ...
        ***REMOVED*** Windows-style path traversal
...
class TestValidateExcelUpload:
    ...
    def test_valid_xlsx_file(self):
        ...
        ***REMOVED*** XLSX files start with PK\x03\x04 (ZIP signature)
        valid_xlsx = b"PK\x03\x04" + b"\x00" * 100

        ***REMOVED*** Should pass without content_type
        validate_excel_upload(valid_xlsx, "test.xlsx")

        ***REMOVED*** Should pass with correct content_type
        validate_excel_upload(
            valid_xlsx,
            "test.xlsx",
    ...
    def test_valid_xls_file(self):
        ...
        ***REMOVED*** XLS files start with D0 CF 11 E0 A1 B1 1A E1 (OLE2 signature)
        ...
        ***REMOVED*** Should pass with correct content_type
        validate_excel_upload(valid_xls, "test.xls", "application/vnd.ms-excel")

    def test_content_type_with_charset(self):
        """Test that content_type with charset parameter is normalized correctly."""
        valid_xlsx = b"PK\x03\x04" + b"\x00" * 100

        ***REMOVED*** Content-Type with charset should be accepted
        validate_excel_upload(
            valid_xlsx,
            "test.xlsx",
    ...
    def test_file_too_large(self):
        ...
        ***REMOVED*** Create 11 MB file (exceeds 10 MB limit)
    ...
    def test_xlsx_wrong_magic_bytes(self):
        ...
        ***REMOVED*** XLSX with wrong signature
    ...
    def test_xls_wrong_magic_bytes(self):
        ...
        ***REMOVED*** XLS with wrong signature
    ...
    def test_content_type_mismatch_extension(self):
        ...
        ***REMOVED*** XLSX file but XLS content type
        with pytest.raises(FileValidationError, match="does not match file extension"):
            validate_excel_upload(
                valid_xlsx,
                "test.xlsx",
                "application/vnd.ms-excel",  ***REMOVED*** XLS content type for XLSX file
            )
    ...
    def test_extension_spoofing_attack(self):
        ...
        ***REMOVED*** PDF file masquerading as XLSX
    ...
    def test_content_type_spoofing_attack(self):
        ...
        ***REMOVED*** Text file with Excel extension and content-type
    ...
    def test_double_extension_attack(self):
        ...
        ***REMOVED*** File with double extension
        valid_xlsx = b"PK\x03\x04" + b"\x00" * 100

        ***REMOVED*** Should use the last extension (.xlsx)
    ...
    def test_case_insensitive_extension(self):
        ...
        ***REMOVED*** Uppercase extension should work
        validate_excel_upload(valid_xlsx, "test.XLSX")
        validate_excel_upload(valid_xlsx, "test.XLS".replace("XLS", "xlsx"))

        ***REMOVED*** Mixed case should work
        validate_excel_upload(valid_xlsx, "test.XlSx")
