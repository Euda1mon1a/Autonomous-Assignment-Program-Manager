...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: 80-Hour Weekly Limit
***REMOVED*** ============================================================================
...
class TestEightyHourWeeklyLimit:
    ...
    def test_compliant_schedule_under_80_hours(
        ...
        ***REMOVED*** Create assignments for 5 days per week (10 half-days = ~50 hours)
    ...
    def test_violation_exceeding_80_hours_single_week(
        ...
        ***REMOVED*** Assign all blocks (7 days × 2 half-days × 12 hours = 168 hours)
        for block in blocks:
            assignment = Assignment(
                id=uuid4(),
                block_id=block.id,
    ...
    def test_rolling_4_week_average_calculation(
        ...
        ***REMOVED*** Week 1-2: Heavy (6 days/week)
        for i in range(14):
        ...
        ***REMOVED*** Week 3-4: Light (3 days/week)
        ...
        violations = validator.validate_80_hour_limit(pgy2_resident.id, start_date)
        ***REMOVED*** Should detect violations even if overall average is acceptable
    ...
    def test_boundary_exactly_80_hours(
        ...
        ***REMOVED*** Create exactly 80 hours worth of assignments
        ***REMOVED*** Assuming 12-hour half-days, assign 6.67 days (rounded to 7 AM blocks)
        for i in range(7):
            assignment = Assignment(
                id=uuid4(),
                block_id=blocks[i * 2].id,  ***REMOVED*** AM blocks only
                person_id=pgy2_resident.id,
                rotation_template_id=clinic_rotation.id,
                role="primary",
            )
        ...
        violations = validator.validate_80_hour_limit(pgy2_resident.id, start_date)
        ***REMOVED*** Exactly 80 hours should be acceptable
        assert len(violations) == 0


***REMOVED*** ============================================================================
***REMOVED*** Test Class: 1-in-7 Day Off Rule
***REMOVED*** ============================================================================
...
class TestOneInSevenDayOff:
    ...
    def test_compliant_schedule_with_weekly_days_off(
        ...
        ***REMOVED*** Work Mon-Sat, off Sunday (6 days on, 1 day off)
        for week in range(4):
            for day in range(6):  ***REMOVED*** Mon-Sat
    ...
    def test_violation_no_day_off_in_8_days(
        ...
        ***REMOVED*** Work 8 consecutive days
        for i in range(8):
            for tod_idx in range(2):
                block_idx = i * 2 + tod_idx
                assignment = Assignment(
    ...
    def test_day_off_resets_counter(
        ...
        ***REMOVED*** Work 6 days, off 1, work 6 days, off 1, work 6 days
        day_idx = 0
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Maximum Shift Length
***REMOVED*** ============================================================================
...
class TestMaximumShiftLength:
    ...
    def test_pgy1_16_hour_limit_compliant(
        ...
        ***REMOVED*** Single half-day shifts (≤12 hours each)
    ...
    def test_pgy2_24_plus_4_hour_limit_compliant(
        ...
        ***REMOVED*** 24+4 is allowed for PGY-2+
        assert len(violations) == 0
    ...
    def test_pgy3_extended_shift_with_strategic_nap(
        ...
        ***REMOVED*** 24-hour shift with post-call relief
        for i in range(2):
            assignment = Assignment(
                id=uuid4(),
                block_id=blocks[i].id,
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Night Float Limits
***REMOVED*** ============================================================================
...
class TestNightFloatLimits:
    ...
    def test_compliant_night_float_under_6_consecutive(
        ...
        ***REMOVED*** 5 consecutive nights (compliant)
        for i in range(5):
            assignment = Assignment(
                id=uuid4(),
                block_id=blocks[i * 2 + 1].id,  ***REMOVED*** PM blocks for nights
                person_id=pgy2_resident.id,
    ...
    def test_violation_exceeds_6_consecutive_nights(
        ...
        ***REMOVED*** 7 consecutive nights (violation)
        for i in range(7):
            assignment = Assignment(
                id=uuid4(),
                block_id=blocks[i * 2 + 1].id,  ***REMOVED*** PM blocks
                person_id=pgy2_resident.id,
                rotation_template_id=night_float_rotation.id,
                role="primary",
            )
    ...
    def test_night_float_reset_after_day_off(
        ...
        ***REMOVED*** 5 nights, 1 off, 5 nights (both compliant)
        for i in range(5):
            assignment = Assignment(
                id=uuid4(),
        ...
        ***REMOVED*** Day off on day 6 (skip index 5)

        ***REMOVED*** Next 5 nights starting day 7
        for i in range(7, 12):
            assignment = Assignment(
                id=uuid4(),
                block_id=blocks[i * 2 + 1].id,
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Edge Cases and Boundary Conditions
***REMOVED*** ============================================================================
...
class TestACGMEEdgeCases:
    ...
    def test_resident_with_no_assignments(
        ...
        violations = validator.validate_80_hour_limit(pgy2_resident.id, start_date)
        assert len(violations) == 0  ***REMOVED*** No violations if no work
    ...
    def test_validation_across_month_boundary(
        ...
        ***REMOVED*** Start on last day of month
        start_date = date(2024, 1, 31)
        blocks = create_blocks(db, start_date, 28)

        ***REMOVED*** Create heavy schedule that spans into February
        for i in range(28):
            for tod_idx in range(2):
                block_idx = i * 2 + tod_idx
                if block_idx < len(blocks):
        ...
        violations = validator.validate_80_hour_limit(pgy2_resident.id, start_date)
        ***REMOVED*** Should handle month transition correctly
    ...
    def test_leap_year_february_handling(
        ...
        ***REMOVED*** Leap year February
        ...
        violations = validator.validate_one_in_seven(pgy2_resident.id, start_date)
        ***REMOVED*** Should detect violations in 29-day February
    ...
    def test_multiple_residents_independent_validation(
        ...
        ***REMOVED*** PGY1: Violating schedule (24-hour shifts)
        for i in range(2):
            assignment = Assignment(
                id=uuid4(),
                block_id=blocks[i].id,
        ...
        ***REMOVED*** PGY2: Compliant schedule
        assignment = Assignment(
            id=uuid4(),
