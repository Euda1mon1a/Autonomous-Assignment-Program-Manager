...
class TestValidate24Plus4Rule:
    ...
    def test_no_violations_with_normal_schedule(
        ...
        ***REMOVED*** Create 3 days of AM shifts only (6 hours each = 18 hours total)
    ...
    def test_violation_with_excessive_continuous_hours(
        ...
        ***REMOVED*** Create 3 consecutive days with both AM and PM shifts
        ***REMOVED*** 3 days * 2 shifts * 6 hours = 36 hours > 28 hour limit
    ...
    def test_no_violation_exactly_at_limit(
        ...
        ***REMOVED*** Create assignments totaling exactly 28 hours
        ***REMOVED*** Day 1: AM + PM = 12 hours
        ***REMOVED*** Day 2: AM + PM = 12 hours
        ***REMOVED*** Day 3: AM = 6 hours (need to stop here for exactly 30 hours)
        ***REMOVED*** But we need 28 hours, so let's do 4 shifts + 2/3 of another
        ***REMOVED*** Actually, each block is 6 hours, so 28 hours = 4.67 blocks
        ***REMOVED*** Since we can't do partial blocks, let's create 4 blocks (24 hours)
        create_blocks_with_assignments(
        ...
        ***REMOVED*** 24 hours should not violate
        assert len(violations) == 0
    ...
    def test_non_resident_returns_no_violations(
        ...
        ***REMOVED*** Create excessive hours for faculty
        create_blocks_with_assignments(
...
***REMOVED*** ============================================================================
***REMOVED*** Test Night Float Limits
***REMOVED*** ============================================================================
...
class TestValidateNightFloatLimits:
    ...
    def test_no_violations_with_few_night_shifts(
        ...
        ***REMOVED*** Create 3 consecutive PM shifts (night shifts)
    ...
    def test_violation_with_seven_consecutive_nights(
        ...
        ***REMOVED*** Create 7 consecutive PM shifts (exceeds max of 6)
    ...
    def test_exactly_six_consecutive_nights_no_violation(
        ...
        ***REMOVED*** Create exactly 6 consecutive PM shifts
    ...
    def test_non_consecutive_nights_no_violation(
        ...
        ***REMOVED*** Create PM shifts on days 0, 1, 2, then skip 3, then 4, 5, 6
        ***REMOVED*** Two sequences of 3 nights each
        create_blocks_with_assignments(db, pgy2_resident, start, 3, "PM")
        create_blocks_with_assignments(
    ...
    def test_only_am_shifts_no_night_violations(
        ...
        ***REMOVED*** Create 10 consecutive AM shifts
    ...
    def test_non_resident_returns_no_violations(
        ...
        ***REMOVED*** Create 10 consecutive PM shifts for faculty
...
***REMOVED*** ============================================================================
***REMOVED*** Test Moonlighting Hours
***REMOVED*** ============================================================================
...
class TestValidateMoonlightingHours:
    ...
    def test_no_violations_with_normal_hours(
        ...
        ***REMOVED*** Create 4 weeks of reasonable schedule
        ***REMOVED*** 5 days/week * 2 shifts/day * 4 weeks = 40 blocks = 240 hours
        ***REMOVED*** 240 hours / 4 weeks = 60 hours/week (under 80 limit)
        for week in range(4):
            week_start = start + timedelta(weeks=week)
            for day in range(5):  ***REMOVED*** 5 days per week
                create_blocks_with_assignments(
                    db,
                    pgy2_resident,
    ...
    def test_violation_with_excessive_total_hours(
        ...
        ***REMOVED*** Create 4 weeks of heavy schedule
        ***REMOVED*** 7 days/week * 2 shifts/day * 4 weeks = 56 blocks = 336 hours
        ***REMOVED*** 336 hours / 4 weeks = 84 hours/week (over 80 limit)
        for week in range(4):
            week_start = start + timedelta(weeks=week)
            create_blocks_with_assignments(
    ...
    def test_violation_with_external_moonlighting_hours(
        ...
        ***REMOVED*** Create 4 weeks of moderate schedule
        ***REMOVED*** 5 days/week * 2 shifts/day * 4 weeks = 40 blocks = 240 hours
        ***REMOVED*** 240 hours / 4 weeks = 60 hours/week
        for week in range(4):
            week_start = start + timedelta(weeks=week)
            for day in range(5):
                create_blocks_with_assignments(
        ...
        ***REMOVED*** Add 100 hours of external moonlighting (25 hours/week)
        ***REMOVED*** Total: 60 + 25 = 85 hours/week (over 80 limit)
        violations = validator.validate_moonlighting_hours(
    ...
    def test_no_violations_with_minimal_external_hours(
        ...
        ***REMOVED*** Create 4 weeks of light schedule
        ***REMOVED*** 4 days/week * 2 shifts/day * 4 weeks = 32 blocks = 192 hours
        ***REMOVED*** 192 hours / 4 weeks = 48 hours/week
        for week in range(4):
            week_start = start + timedelta(weeks=week)
            for day in range(4):
                create_blocks_with_assignments(
        ...
        ***REMOVED*** Add 80 hours of external moonlighting (20 hours/week)
        ***REMOVED*** Total: 48 + 20 = 68 hours/week (under 80 limit)
        violations = validator.validate_moonlighting_hours(
    ...
    def test_non_resident_returns_no_violations(
        ...
        ***REMOVED*** Create excessive schedule for faculty
        create_blocks_with_assignments(
...
***REMOVED*** ============================================================================
***REMOVED*** Test PGY-Specific Rules
***REMOVED*** ============================================================================
...
class TestValidatePGYSpecificRules:
    ...
    def test_pgy1_no_violation_with_max_daily_hours(
        ...
        ***REMOVED*** Create day with both shifts (12 hours - max possible per day)
        create_blocks_with_assignments(
        ...
        ***REMOVED*** 12 hours is under 16-hour limit, should not violate
        assert len(violations) == 0
    ...
    def test_pgy1_no_violation_with_16_hour_shift(
        ...
        ***REMOVED*** Create less than 16 hours per day (2 shifts = 12 hours)
        create_blocks_with_assignments(
            db, pgy1_resident, start, 1, include_both_shifts=True
        )
    ...
    def test_pgy2_no_violation_with_24_hour_shift(
        ...
        ***REMOVED*** Create 2 consecutive days with both shifts (24 hours)
        create_blocks_with_assignments(
            db, pgy2_resident, start, 2, include_both_shifts=True
        )
    ...
    def test_pgy2_no_violation_with_max_daily_hours(
        ...
        ***REMOVED*** Create multiple days with both shifts (12 hours each day)
        create_blocks_with_assignments(
            db, pgy2_resident, start, 3, include_both_shifts=True
        )
        ...
        ***REMOVED*** Each day has 12 hours, under 24-hour limit, should not violate
        assert len(violations) == 0
...
***REMOVED*** ============================================================================
***REMOVED*** Test Duty Hours Breakdown
***REMOVED*** ============================================================================
...
class TestCalculateDutyHoursBreakdown:
    ...
    def test_breakdown_with_normal_schedule(
        ...
        ***REMOVED*** Start on a Monday to ensure weekdays only
        start = date.today()
        while start.weekday() != 0:  ***REMOVED*** 0 = Monday
            start += timedelta(days=1)

        ***REMOVED*** Create 2 weeks of schedule
        ***REMOVED*** Week 1: Mon-Fri, AM+PM (10 blocks = 60 hours)
        ***REMOVED*** Week 2: Mon-Fri, AM+PM (10 blocks = 60 hours)
        ***REMOVED*** Total: 120 hours over 14 days
        for week in range(2):
            week_start = start + timedelta(weeks=week)
            for day in range(5):  ***REMOVED*** Mon-Fri
                create_blocks_with_assignments(
                    db,
                    pgy2_resident,
                    week_start + timedelta(days=day),
    ...
    def test_breakdown_includes_weekend_hours(
        ...
        ***REMOVED*** Start on a Monday
        start = date.today()
        while start.weekday() != 0:  ***REMOVED*** 0 = Monday
            start += timedelta(days=1)

        ***REMOVED*** Create full week including weekend
        ***REMOVED*** Mon-Fri: 5 days * 2 shifts = 10 blocks = 60 hours weekday
        ***REMOVED*** Sat-Sun: 2 days * 2 shifts = 4 blocks = 24 hours weekend
        create_blocks_with_assignments(
        ...
        assert breakdown["hours"]["total"] == 84  ***REMOVED*** 14 blocks * 6 hours
        assert breakdown["hours"]["weekend"] == 24  ***REMOVED*** 4 blocks * 6 hours
        assert breakdown["hours"]["weekday"] == 60  ***REMOVED*** 10 blocks * 6 hours
    ...
    def test_breakdown_includes_night_hours(
        ...
        ***REMOVED*** Create 1 week with mixed shifts
        ***REMOVED*** 7 days of AM shifts = 42 hours
        ***REMOVED*** 3 days of PM shifts = 18 hours night
        ...
        assert breakdown["hours"]["total"] == 60  ***REMOVED*** 10 blocks * 6 hours
        assert breakdown["hours"]["night"] == 18  ***REMOVED*** 3 PM blocks * 6 hours
    ...
    def test_breakdown_calculates_average_weekly_hours(
        ...
        ***REMOVED*** Create 4 weeks of schedule
        ***REMOVED*** 5 days/week * 2 shifts/day * 4 weeks = 40 blocks = 240 hours
        ***REMOVED*** Average: 240 / 4 = 60 hours/week
        for week in range(4):
            week_start = start + timedelta(weeks=week)
            for day in range(5):
                create_blocks_with_assignments(
...
***REMOVED*** ============================================================================
***REMOVED*** Test Helper Method: _assignments_to_hours
***REMOVED*** ============================================================================
...
class TestAssignmentsToHours:
    ...
    def test_converts_single_assignment_to_hours(
        ...
        assert hours_by_date[start] == 6  ***REMOVED*** HOURS_PER_HALF_DAY
    ...
    def test_converts_multiple_assignments_same_day(
        ...
        assert len(hours_by_date) == 1
        assert hours_by_date[start] == 12  ***REMOVED*** 2 shifts * 6 hours
    ...
    def test_converts_mixed_schedule(
        ...
        ***REMOVED*** Day 1: AM + PM (12 hours)
        ***REMOVED*** Day 2: AM only (6 hours)
        ***REMOVED*** Day 3: PM only (6 hours)
        ***REMOVED*** Day 4: AM + PM (12 hours)
        create_blocks_with_assignments(
            db, pgy2_resident, start, 1, include_both_shifts=True
        )
        create_blocks_with_assignments(
...
***REMOVED*** ============================================================================
***REMOVED*** Edge Cases and Boundary Conditions
***REMOVED*** ============================================================================
...
class TestEdgeCases:
    ...
    def test_single_day_validation_period(
        ...
        ***REMOVED*** Single day with 12 hours should not violate
        assert len(violations) == 0
    ...
    def test_validation_with_gaps_in_schedule(
        ...
        ***REMOVED*** Create assignments on days 0-2, skip 3-4, then 5-7
        create_blocks_with_assignments(
            db, pgy2_resident, start, 3, include_both_shifts=True
        )
        create_blocks_with_assignments(
        ...
        ***REMOVED*** Each segment is 36 hours (3 days * 12 hours/day)
        ***REMOVED*** But there's a gap, so they should be evaluated separately
        ***REMOVED*** 36 hours > 28, so we should have violations
        assert len(violations) > 0
    ...
    def test_date_boundary_exactly_on_week_boundary(
        ...
        assert breakdown["hours"]["total"] == 42  ***REMOVED*** 7 days * 6 hours
    ...
    def test_very_long_validation_period(
        ...
        ***REMOVED*** Create sparse assignments over a year
        ...
        assert breakdown["hours"]["total"] == 360  ***REMOVED*** 60 blocks * 6 hours
    ...
    def test_all_validators_with_same_resident(
        ...
        ***REMOVED*** Create a complex schedule
        create_blocks_with_assignments(db, pgy1_resident, start, 10, "PM")

        ***REMOVED*** Run all validators
        ...
        ***REMOVED*** Should have night float violation (10 consecutive nights > 6)
        assert len(violations_night) > 0

        ***REMOVED*** Should have breakdown data
        assert breakdown["hours"]["total"] > 0
        assert breakdown["hours"]["night"] > 0
