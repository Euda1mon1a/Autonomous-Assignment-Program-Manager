...
***REMOVED*** ==============================================================================
***REMOVED*** Work Hour Validator Tests
***REMOVED*** ==============================================================================
...
class TestWorkHourValidator:
    ...
    def test_80_hour_rule_exactly_80_hours_compliant(self, validator, resident_id):
        ...
        ***REMOVED*** 28 days of 10 hours = 280 hours = 70 hours/week average
    ...
    def test_80_hour_rule_exceeds_limit_violation(self, validator, resident_id):
        ...
        ***REMOVED*** 28 days of 11.5 hours = 322 hours = 80.5 hours/week
        start_date = date(2025, 1, 1)
        hours_by_date = {
    ...
    def test_80_hour_rule_approaching_limit_warning(self, validator, resident_id):
        ...
        ***REMOVED*** 28 days of 10.85 hours = 304 hours = 76 hours/week
        start_date = date(2025, 1, 1)
        hours_by_date = {
        ...
        shift_data = [
            {
                'date': date(2025, 1, 1),
                'start_time': '06:00',
                'end_time': '14:00',  ***REMOVED*** 32 hours
                'duration_hours': 32.0,
            }
        ]
    ...
    def test_moonlighting_integration(self, validator, resident_id):
        ...
        ***REMOVED*** Regular hours: 70/week, Moonlighting: 15/week = 85/week total
        start_date = date(2025, 1, 1)
        regular_hours = {
            start_date + timedelta(days=i): 10.0
            for i in range(28)
    ...
    def test_moonlighting_warning_threshold(self, validator, resident_id):
        ...
        start_date = date(2025, 1, 1)
        moonlighting_hours = {
            start_date: 25.0,  ***REMOVED*** 25 hours in one day (high)
        }
...
***REMOVED*** ==============================================================================
***REMOVED*** Supervision Validator Tests
***REMOVED*** ==============================================================================
...
class TestSupervisionValidator:
    ...
    def test_calculate_required_faculty_pgy1_only(self, validator):
        ...
        ***REMOVED*** 1 PGY-1 = 2 units, ceil(2/4) = 1 faculty
        assert validator.calculate_required_faculty(1, 0) == 1
        ***REMOVED*** 2 PGY-1 = 4 units, ceil(4/4) = 1 faculty
        assert validator.calculate_required_faculty(2, 0) == 1
        ***REMOVED*** 3 PGY-1 = 6 units, ceil(6/4) = 2 faculty
    ...
    def test_calculate_required_faculty_pgy2_3_only(self, validator):
        ...
        ***REMOVED*** 1 PGY-2 = 1 unit, ceil(1/4) = 1 faculty
        assert validator.calculate_required_faculty(0, 1) == 1
        ***REMOVED*** 4 PGY-2 = 4 units, ceil(4/4) = 1 faculty
        assert validator.calculate_required_faculty(0, 4) == 1
        ***REMOVED*** 5 PGY-2 = 5 units, ceil(5/4) = 2 faculty
    ...
    def test_calculate_required_faculty_mixed_pgy(self, validator):
        ...
        ***REMOVED*** 1 PGY-1 + 1 PGY-2 = 2+1 = 3 units, ceil(3/4) = 1 faculty
        assert validator.calculate_required_faculty(1, 1) == 1
        ***REMOVED*** 2 PGY-1 + 2 PGY-2 = 4+2 = 6 units, ceil(6/4) = 2 faculty
    ...
    def test_validate_block_supervision_compliant(self, validator):
        ...
        pgy1 = [uuid4(), uuid4()]
        other = [uuid4()]
        faculty = [uuid4()]  ***REMOVED*** Need 2 for 2 PGY-1 + 1 PGY-2
        ...
        ***REMOVED*** Need ceil((2*2 + 1 + 3)/4) = ceil(8/4) = 2, have 1
    ...
    def test_validate_block_supervision_violates(self, validator):
        ...
        block_id = uuid4()
        block_date = date(2025, 1, 1)
        pgy1 = [uuid4(), uuid4(), uuid4()]  ***REMOVED*** Need 2 faculty
        other = []
        faculty = [uuid4()]  ***REMOVED*** Only 1 faculty
...
class TestCallValidator:
    ...
    def test_call_frequency_compliant(self, validator, faculty_id):
        ...
        ***REMOVED*** ~9 calls in 28 days is compliant
        start_date = date(2025, 1, 1)
    ...
    def test_call_frequency_exceeds_limit(self, validator, faculty_id):
        ...
        start_date = date(2025, 1, 1)
        call_dates = [start_date + timedelta(days=i) for i in range(12)]  ***REMOVED*** 12 calls in 12 days
    ...
    def test_consecutive_nights_within_limit(self, validator, faculty_id):
        ...
        ***REMOVED*** 2 consecutive nights is compliant
        call_dates = [
            date(2025, 1, 1),
            date(2025, 1, 2),
        ]
    ...
    def test_consecutive_nights_exceeds(self, validator, faculty_id):
        ...
        ***REMOVED*** 3 consecutive nights exceeds limit
        call_dates = [
            date(2025, 1, 1),
            date(2025, 1, 2),
            date(2025, 1, 3),
    ...
    def test_call_spacing_violation(self, validator, faculty_id):
        ...
        ***REMOVED*** Calls on consecutive days violates spacing rule
        call_dates = [
            date(2025, 1, 1),
            date(2025, 1, 2),
        ]
    ...
    def test_call_equity_imbalance(self, validator):
        ...
        assignments = {
            ...
            uuid4(): [date(2025, 1, 2)],  ***REMOVED*** 1 call
        }
...
class TestLeaveValidator:
    ...
    def test_conditional_blocking_medical_short(self, validator):
        ...
        ***REMOVED*** 5 days should not block
        assert validator.should_block_assignment(
            'medical',
            date(2025, 1, 1),
            date(2025, 1, 5),
...
***REMOVED*** ==============================================================================
***REMOVED*** Rotation Validator Tests
***REMOVED*** ==============================================================================
...
class TestRotationValidator:
    ...
    def test_procedure_volume_low(self, validator, resident_id):
        ...
        violation, warning = validator.validate_procedure_volume(
            resident_id,
            pgy_level=2,
            procedures_completed=15,  ***REMOVED*** Only 50% of target
        )
...
class TestComplianceIntegration:
    ...
    def test_resident_compliance_multiple_violations(self):
        ...
        ***REMOVED*** Create hours data with violation
        hours_by_date = {
            start_date + timedelta(days=i): 12.0
            for i in range(28)
        }  ***REMOVED*** 84 hours/week

        ***REMOVED*** Check work hours
        wh_violations, _ = work_hour_validator.validate_80_hour_rolling_average(
            resident_id, hours_by_date
        )

        ***REMOVED*** Check supervision
        ...
        ***REMOVED*** Simulate 3 residents
        ...
        for resident in residents:
            hours_by_date = {
                ...
                for i in range(28)
            }  ***REMOVED*** 56 hours/week - compliant
