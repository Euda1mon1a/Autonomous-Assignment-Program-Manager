...
class TestSportsMedicineIdentification:
    ...
    def test_resident_not_sm(self):
        ...
        ***REMOVED*** Residents don't have faculty_role, so role_enum is None
        ***REMOVED*** but they may have specialty - is_sports_medicine checks both
        assert person.is_sports_medicine is True  ***REMOVED*** Has specialty
...
class TestCallEquityFields:
    ...
    def test_default_call_counts_are_zero(self):
        ...
        ***REMOVED*** Note: These default to 0 via Column default
