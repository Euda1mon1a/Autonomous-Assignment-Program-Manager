...
class TestGetSettingsEndpoint:
    ...
    def test_get_settings_creates_defaults_when_none_exist(
        ...
        ***REMOVED*** Verify no settings exist
        ...
        ***REMOVED*** Verify settings were created in database
    ...
    def test_get_settings_response_structure(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Verify all fields are present
        required_fields = [
...
class TestUpdateSettingsEndpoint:
    ...
    def test_update_all_settings_success(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Verify all fields were updated
    ...
    def test_update_settings_invalid_algorithm(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Should fail at database constraint level (500) or validation level (422)
    ...
    def test_update_settings_work_hours_below_minimum(
        ...
        response = client.post(
            ...
            json={
                ...
                "work_hours_per_week": 30,  ***REMOVED*** Below minimum
                "max_consecutive_days": 6,
                "min_days_off_per_week": 1,
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
    ...
    def test_update_settings_work_hours_above_maximum(
        ...
        response = client.post(
            ...
            json={
                "scheduling_algorithm": "greedy",
                "work_hours_per_week": 120,  ***REMOVED*** Above maximum
                "max_consecutive_days": 6,
                "min_days_off_per_week": 1,
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
    ...
    def test_update_settings_work_hours_at_boundaries(
        ...
        ***REMOVED*** Test minimum boundary (40)
        response = client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "greedy",
        ...
        ***REMOVED*** Test maximum boundary (100)
        response = client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "greedy",
    ...
    def test_update_settings_max_consecutive_days_invalid(
        ...
        ***REMOVED*** Test below minimum
        response = client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "greedy",
                "work_hours_per_week": 80,
                "max_consecutive_days": 0,  ***REMOVED*** Below minimum
                "min_days_off_per_week": 1,
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
                "pgy3_supervision_ratio": "1:4",
        ...
        ***REMOVED*** Test above maximum
        response = client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "greedy",
                "work_hours_per_week": 80,
                "max_consecutive_days": 8,  ***REMOVED*** Above maximum
                "min_days_off_per_week": 1,
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
                "pgy3_supervision_ratio": "1:4",
        ...
        ***REMOVED*** Test below minimum
        response = client.post(
            ...
            json={
                ...
                "work_hours_per_week": 80,
                "max_consecutive_days": 6,
                "min_days_off_per_week": 0,  ***REMOVED*** Below minimum
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
                "pgy3_supervision_ratio": "1:4",
                "enable_weekend_scheduling": True,
        ...
        ***REMOVED*** Test above maximum
        response = client.post(
            ...
            json={
                ...
                "work_hours_per_week": 80,
                "max_consecutive_days": 6,
                "min_days_off_per_week": 4,  ***REMOVED*** Above maximum
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
                "pgy3_supervision_ratio": "1:4",
                "enable_weekend_scheduling": True,
        ...
        ***REMOVED*** Test below minimum
        response = client.post(
            ...
            json={
                ...
                "enable_weekend_scheduling": True,
                "enable_holiday_scheduling": False,
                "default_block_duration_hours": 0,  ***REMOVED*** Below minimum
            },
        )
        assert response.status_code == 422
        ...
        ***REMOVED*** Test above maximum
        response = client.post(
            ...
            json={
                ...
                "enable_weekend_scheduling": True,
                "enable_holiday_scheduling": False,
                "default_block_duration_hours": 13,  ***REMOVED*** Above maximum
            },
        )
        assert response.status_code == 422
    ...
    def test_update_settings_updates_timestamp(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Create initial settings
        ...
        ***REMOVED*** Verify timestamp was updated
...
class TestPatchSettingsEndpoint:
    ...
    def test_patch_single_field(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Create initial settings
        ...
        assert data["scheduling_algorithm"] == "cp_sat"
        ***REMOVED*** Other fields should remain at defaults
        assert data["work_hours_per_week"] == 80
        assert data["max_consecutive_days"] == 6
    ...
    def test_patch_empty_data_returns_unchanged(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Patch with empty object
        response = client.patch("/api/settings", json={})

        assert response.status_code == 200
        data = response.json()

        ***REMOVED*** Should be identical to initial
    ...
    def test_patch_with_invalid_value(self, client: TestClient, db: Session):
        ...
        response = client.patch(
            "/api/settings",
            json={"work_hours_per_week": 150},  ***REMOVED*** Above maximum
        )
    ...
    def test_patch_preserves_other_fields(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Create settings with specific values
        client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "min_conflicts",
        ...
        ***REMOVED*** All other fields should be preserved
...
class TestResetSettingsEndpoint:
    ...
    def test_reset_settings_to_defaults(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Verify settings were reset
        response = client.get("/api/settings")
        data = response.json()
    ...
    def test_reset_settings_preserves_record(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Create settings
        client.get("/api/settings")

        ***REMOVED*** Get the settings ID
        ...
        ***REMOVED*** Verify the same record still exists
...
class TestSettingsValidation:
    ...
    def test_settings_boundary_values(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Test minimum boundary values
        response = client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "greedy",
                "work_hours_per_week": 40,  ***REMOVED*** Minimum
                "max_consecutive_days": 1,  ***REMOVED*** Minimum
                "min_days_off_per_week": 1,  ***REMOVED*** Minimum
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
                "pgy3_supervision_ratio": "1:4",
                "enable_weekend_scheduling": True,
                "enable_holiday_scheduling": False,
                "default_block_duration_hours": 1,  ***REMOVED*** Minimum
            },
        )
        ...
        ***REMOVED*** Test maximum boundary values
        response = client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "greedy",
                "work_hours_per_week": 100,  ***REMOVED*** Maximum
                "max_consecutive_days": 7,  ***REMOVED*** Maximum
                "min_days_off_per_week": 3,  ***REMOVED*** Maximum
                "pgy1_supervision_ratio": "1:2",
                "pgy2_supervision_ratio": "1:4",
                "pgy3_supervision_ratio": "1:4",
                "enable_weekend_scheduling": True,
                "enable_holiday_scheduling": False,
                "default_block_duration_hours": 12,  ***REMOVED*** Maximum
            },
        )
    ...
    def test_settings_missing_required_field(self, client: TestClient, db: Session):
        ...
        response = client.post(
            ...
            json={
                "scheduling_algorithm": "greedy",
                "work_hours_per_week": 80,
                ***REMOVED*** Missing other required fields
            },
        )
...
class TestSettingsIntegration:
    ...
    def test_full_settings_lifecycle(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** 1. Get initial defaults (creates settings)
        response = client.get("/api/settings")
        assert response.status_code == 200
        initial_data = response.json()
        assert initial_data["scheduling_algorithm"] == "greedy"

        ***REMOVED*** 2. Full update
        response = client.post(
            "/api/settings",
            json={
                "scheduling_algorithm": "cp_sat",
        ...
        ***REMOVED*** 3. Partial update
        ...
        data = response.json()
        assert data["work_hours_per_week"] == 80
        assert data["scheduling_algorithm"] == "cp_sat"  ***REMOVED*** Unchanged

        ***REMOVED*** 4. Reset to defaults
        response = client.delete("/api/settings")
        assert response.status_code == 204

        ***REMOVED*** 5. Verify reset worked
        response = client.get("/api/settings")
        assert response.status_code == 200
    ...
    def test_multiple_updates_same_field(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Verify final value persists
        response = client.get("/api/settings")
        assert response.json()["work_hours_per_week"] == 60
    ...
    def test_settings_singleton_behavior(self, client: TestClient, db: Session):
        ...
        ***REMOVED*** Create settings multiple times
        client.get("/api/settings")
        client.post(
            "/api/settings",
            json={
        ...
        ***REMOVED*** Verify only one record exists
