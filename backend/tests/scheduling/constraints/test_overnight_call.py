...
class TestIsOvernightCallNight:
    ...
    def test_sunday_is_call_night(self):
        ...
        ***REMOVED*** Find a Sunday in 2025
        sunday = date(2025, 1, 5)  ***REMOVED*** January 5, 2025 is a Sunday
        assert sunday.weekday() == 6  ***REMOVED*** Verify it's Sunday
        assert is_overnight_call_night(sunday) is True

    def test_monday_is_call_night(self):
        """Monday should require overnight call."""
        monday = date(2025, 1, 6)  ***REMOVED*** January 6, 2025 is a Monday
        assert monday.weekday() == 0  ***REMOVED*** Verify it's Monday
        assert is_overnight_call_night(monday) is True

    def test_tuesday_is_call_night(self):
        """Tuesday should require overnight call."""
        tuesday = date(2025, 1, 7)  ***REMOVED*** January 7, 2025 is a Tuesday
        assert tuesday.weekday() == 1  ***REMOVED*** Verify it's Tuesday
    ...
    def test_wednesday_is_call_night(self):
        ...
        wednesday = date(2025, 1, 8)  ***REMOVED*** January 8, 2025 is a Wednesday
        assert wednesday.weekday() == 2  ***REMOVED*** Verify it's Wednesday
    ...
    def test_thursday_is_call_night(self):
        ...
        thursday = date(2025, 1, 9)  ***REMOVED*** January 9, 2025 is a Thursday
        assert thursday.weekday() == 3  ***REMOVED*** Verify it's Thursday
    ...
    def test_friday_is_not_call_night(self):
        ...
        friday = date(2025, 1, 10)  ***REMOVED*** January 10, 2025 is a Friday
        assert friday.weekday() == 4  ***REMOVED*** Verify it's Friday
    ...
    def test_saturday_is_not_call_night(self):
        ...
        saturday = date(2025, 1, 11)  ***REMOVED*** January 11, 2025 is a Saturday
        assert saturday.weekday() == 5  ***REMOVED*** Verify it's Saturday
...
class TestOvernightCallGenerationConstraint:
    ...
    def test_constraint_initialization(self):
        ...
        ***REMOVED*** Should be a hard constraint
    ...
    def test_constraint_has_required_methods(self):
        ...
        ***REMOVED*** All constraints must implement these
...
class TestOvernightCallEligibility:
    ...
    def test_identify_fmit_weeks_empty_context(self):
        ...
        ***REMOVED*** Create a minimal mock context
        class MockContext:
    ...
    def test_is_overnight_call_night_boundary(self):
        ...
        ***REMOVED*** Thursday night (last call night before FMIT)
        thursday = date(2025, 1, 9)
        assert is_overnight_call_night(thursday) is True

        ***REMOVED*** Friday night (FMIT starts)
        friday = date(2025, 1, 10)
        assert is_overnight_call_night(friday) is False

        ***REMOVED*** Sunday night (call nights resume)
...
class TestOvernightCallValidation:
    ...
    def test_validate_empty_assignments(self):
        ...
        ***REMOVED*** Should be satisfied when there are no blocks to check
