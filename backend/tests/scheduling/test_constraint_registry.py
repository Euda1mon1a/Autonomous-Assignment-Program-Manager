...
class TestConstraintRegistry:
    ...
    def test_get_by_latest_version(self):
        ...
        ***REMOVED*** Get without version should return latest (2.0)
    ...
    def test_multiple_versions_tracking(self):
        ...
        ***REMOVED*** All should be retrievable
