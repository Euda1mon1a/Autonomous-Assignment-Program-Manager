...
***REMOVED*** ============================================================================
***REMOVED*** Test QUBOTemplateFormulation
***REMOVED*** ============================================================================
...
class TestQUBOTemplateFormulation:
    ...
    def test_formulation_creation(self):
        ...
        ***REMOVED*** Should have rotation periods (blocks aggregated into 2-week chunks)
        assert len(formulation.rotation_periods) > 0

        ***REMOVED*** Should have variables
    ...
    def test_variable_indexing(self):
        ...
        ***REMOVED*** Index mapping should be bijective
        assert len(formulation.var_index) == len(formulation.index_to_var)

        ***REMOVED*** All indices should be consecutive
    ...
    def test_qubo_build(self):
        ...
        ***REMOVED*** Q should be a dict with (i, j) -> coefficient
        assert isinstance(Q, dict)
        assert len(Q) > 0

        ***REMOVED*** All coefficients should be numeric
        for (i, j), coef in Q.items():
            assert isinstance(i, int)
            assert isinstance(j, int)
            assert isinstance(coef, (int, float))

        ***REMOVED*** Matrix should be upper triangular (i <= j)
        for (i, j) in Q.keys():
            assert i <= j
    ...
    def test_objective_matrices_populated(self):
        ...
        ***REMOVED*** Should have objective matrices
    ...
    def test_coverage_objective(self):
        ...
        ***REMOVED*** Coverage matrix should have negative diagonal terms
        coverage_matrix = formulation.objective_matrices["coverage"]
        diagonal_sum = sum(
            coef for (i, j), coef in coverage_matrix.items() if i == j
        )
        assert diagonal_sum < 0  ***REMOVED*** Negative encourages x[i] = 1
    ...
    def test_solution_decoding(self):
        ...
        ***REMOVED*** Create a sample solution where first variable is 1
        sample = {i: 0 for i in range(formulation.num_variables)}
        sample[0] = 1

        assignments = formulation.decode_solution(sample)

        ***REMOVED*** Should have assignments for blocks in the first period
    ...
    def test_custom_config(self):
        ...
        ***REMOVED*** Should still build successfully
        assert len(Q) > 0
    ...
    def test_desirability_mapping(self):
        ...
        ***REMOVED*** Should have preference matrix populated
        assert len(formulation.objective_matrices["preference"]) > 0


***REMOVED*** ============================================================================
***REMOVED*** Test AdaptiveTemperatureSchedule
***REMOVED*** ============================================================================
...
class TestAdaptiveTemperatureSchedule:
    ...
    def test_beta_progression(self):
        ...
        ***REMOVED*** Beta should generally increase (though reheats may cause decreases)
    ...
    def test_reheat_on_plateau(self):
        ...
        ***REMOVED*** Simulate plateau (constant energy)
        for sweep in range(100):
            schedule.get_beta(sweep, energy=0.0)

        ***REMOVED*** Should have triggered at least one reheat
...
***REMOVED*** ============================================================================
***REMOVED*** Test EnergyLandscapeExplorer
***REMOVED*** ============================================================================
...
class TestEnergyLandscapeExplorer:
    ...
    def test_local_minima_identification(self):
        ...
        ***REMOVED*** Should find at least one local minimum
        minima = [p for p in points if p.is_local_minimum]
        assert len(minima) >= 0  ***REMOVED*** May be 0 for small problems
...
***REMOVED*** ============================================================================
***REMOVED*** Test ParetoFrontExplorer
***REMOVED*** ============================================================================
...
class TestParetoFrontExplorer:
    ...
    def test_exploration(self):
        ...
        ***REMOVED*** Should find at least one solution
    ...
    def test_pareto_dominance(self):
        ...
        ***REMOVED*** sol1 dominates sol2 (smaller is better in minimization)
    ...
    def test_non_dominated_solutions(self):
        ...
        ***REMOVED*** All frontier solutions should have rank 0
        for sol in frontier:
            assert sol.rank == 0
...
***REMOVED*** ============================================================================
***REMOVED*** Test HybridTemplatePipeline
***REMOVED*** ============================================================================
...
class TestHybridTemplatePipeline:
    ...
    def test_pipeline_stages(self):
        ...
        ***REMOVED*** All stages should have results
    ...
    def test_energy_improvement(self):
        ...
        ***REMOVED*** Refined energy should be <= QUBO energy
...
***REMOVED*** ============================================================================
***REMOVED*** Test QUBOTemplateSolver
***REMOVED*** ============================================================================
...
class TestQUBOTemplateSolver:
    ...
    def test_reproducibility(self):
        ...
        ***REMOVED*** Same seed should produce same number of assignments
        assert len(result1.assignments) == len(result2.assignments)


***REMOVED*** ============================================================================
***REMOVED*** Test TemplateBenchmark
***REMOVED*** ============================================================================
...
class TestScalability:
    ...
    def test_scaling(self, n_residents: int, n_blocks: int, n_templates: int):
        ...
        assert result.success
        assert result.runtime_seconds < 60.0  ***REMOVED*** Should complete within 60s

    def test_780_variable_sweet_spot(self):
        """Test near the 780 variable sweet spot."""
        ***REMOVED*** Approximate: 15 residents × 4 periods × 13 templates ≈ 780 variables
        context = create_test_context(
            n_residents=10,
            n_blocks=40,  ***REMOVED*** ~4 rotation periods
            n_templates=8,
        )
        config = TemplateSelectionConfig(
            num_reads=20,
        ...
        ***REMOVED*** Should be in reasonable range
...
class TestEdgeCases:
    ...
    def test_weekend_blocks_excluded(self):
        ...
        blocks = []
        for i in range(14):
            is_weekend = i % 7 in [5, 6]  ***REMOVED*** Saturday, Sunday
            blocks.append(
                MockBlock(
        ...
        ***REMOVED*** Should aggregate non-weekend blocks into periods
    ...
    def test_unavailable_resident(self):
        ...
        ***REMOVED*** Mark first resident as unavailable for first block
        ...
        ***REMOVED*** Should still build QUBO
        assert len(Q) > 0
    ...
    def test_template_with_capacity(self):
        ...
        context.templates[0].max_residents = 2  ***REMOVED*** Limited capacity

        formulation = QUBOTemplateFormulation(context)
        Q = formulation.build()

        ***REMOVED*** Constraint matrix should have capacity penalties
