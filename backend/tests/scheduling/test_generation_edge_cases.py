...
def high_capacity_rotation(db: Session) -> RotationTemplate:
    ...
    rotation = RotationTemplate(
        ...
        abbreviation="BUSY",
        max_residents=10,  ***REMOVED*** Requires 10 residents
        min_residents=8,
...
def exclusive_rotation(db: Session) -> RotationTemplate:
    ...
    rotation = RotationTemplate(
        ...
        max_residents=1,
        min_residents=1,
        exclusive=True,  ***REMOVED*** Can't be scheduled with other rotations
    )
    db.add(rotation)
    db.commit()
    db.refresh(rotation)
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Insufficient Resources
***REMOVED*** ============================================================================
...
class TestInsufficientResources:
    ...
    def test_insufficient_faculty_for_coverage(
        ...
        ***REMOVED*** Try to schedule rotation requiring 10 people with only 1 available
    ...
    def test_all_residents_on_leave(
        ...
        ***REMOVED*** Mark all residents on leave
    ...
    def test_partial_availability_scheduling(
        ...
        ***REMOVED*** Mark 2 out of 3 residents on leave
        for i in range(2):
            absence = Absence(
                id=uuid4(),
        ...
        ***REMOVED*** Should succeed with reduced capacity or provide partial schedule
        if result.success:
            assert result.assignments_created > 0


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Conflicting Constraints
***REMOVED*** ============================================================================
...
class TestConflictingConstraints:
    ...
    def test_mutually_exclusive_rotations_same_time(
        ...
        ***REMOVED*** Pre-assign resident to exclusive rotation
        ...
        ***REMOVED*** Try to add another rotation for same resident at same time
    ...
    def test_supervision_ratio_impossible_to_meet(
        ...
        ***REMOVED*** Create rotation requiring 1:1 supervision
        rotation = RotationTemplate(
            id=uuid4(),
            ...
            max_residents=3,
            supervision_required=True,
            max_supervision_ratio=1,  ***REMOVED*** 1:1 ratio required
        )
        db.add(rotation)
        db.commit()
        ...
        ***REMOVED*** Try to schedule 3 residents with only 1 faculty
        result = scheduling_engine.generate_schedule(
            start_date=start_date,
            end_date=start_date,
    ...
    def test_acgme_hours_make_schedule_impossible(
        ...
        ***REMOVED*** Try to schedule 7 consecutive 24-hour call shifts (violates 80-hour limit)
        blocks = create_blocks_range(db, start_date, start_date + timedelta(days=6))

        for i in range(0, len(blocks), 2):
            ***REMOVED*** Assign full 24-hour blocks
            for j in range(2):
                if i + j < len(blocks):
                    assignment = Assignment(
                        id=uuid4(),
...
class TestHolidayWeekendHandling:
    ...
    def test_schedule_over_major_holiday(
        ...
        ***REMOVED*** December 25, 2024 (Christmas)
        ...
        ***REMOVED*** Should either succeed with holiday pay or apply special rules
    ...
    def test_weekend_coverage_requirements(
        ...
        ***REMOVED*** Create weekend call rotation
        ...
        ***REMOVED*** Should assign weekend coverage
        assert result.success is True
        assert result.assignments_created > 0


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Boundary Conditions
***REMOVED*** ============================================================================
...
class TestBoundaryConditions:
    ...
    def test_schedule_full_year(
        ...
        ***REMOVED*** Create blocks (this will be 730 blocks)
        ...
        ***REMOVED*** Should handle large scale scheduling
        assert result.success is not None
    ...
    def test_midnight_boundary_handling(
        ...
        ***REMOVED*** Create overnight call rotation
        ...
        ***REMOVED*** Assign overnight shift spanning midnight
        ...
        ***REMOVED*** Validate shift continuity
        violations = scheduling_engine.validate_schedule(sample_resident.id, today)
        ***REMOVED*** Should recognize as continuous shift, not two separate shifts


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Emergency Coverage
***REMOVED*** ============================================================================
...
class TestEmergencyCoverage:
    ...
    def test_last_minute_absence_coverage(
        ...
        ***REMOVED*** Resident calls in sick (last minute absence)
        absence = Absence(
            id=uuid4(),
            person_id=original.id,
            start_date=tomorrow,
        ...
        ***REMOVED*** Should find available replacement from remaining residents
    ...
    def test_deployment_coverage_planning(
        ...
        deployment_duration = 180  ***REMOVED*** 6 months

        ***REMOVED*** Mark faculty as deployed
        ...
        ***REMOVED*** Generate schedule without deployed faculty
        result = scheduling_engine.generate_schedule(
            start_date=start_date,
            end_date=start_date + timedelta(days=deployment_duration),
            rotation_ids=[sample_rotation_template.id],
        ...
        ***REMOVED*** Should generate schedule with remaining faculty
