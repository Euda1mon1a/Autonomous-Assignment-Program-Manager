...
class TestErgospherePeriod:
    ...
    def test_ergosphere_duration_hours(self):
        ...
        assert ergosphere.duration_hours == 30.0  ***REMOVED*** 1.5 days
    ...
    def test_ergosphere_high_potential(self):
        ...
        ergosphere_high = ErgospherePeriod(
            ...
            extraction_potential=0.20,  ***REMOVED*** 20% > 15% threshold
            boundary_type="week_end",
        )
        ...
        ergosphere_low = ErgospherePeriod(
            ...
            end_time=datetime(2024, 1, 2),
            rotation_velocity=1.0,
            extraction_potential=0.10,  ***REMOVED*** 10% < 15% threshold
            boundary_type="week_end",
        )
    ...
    def test_ergosphere_invalid_time_order(self):
        ...
        with pytest.raises(ValueError, match="start_time must be before end_time"):
            ErgospherePeriod(
                ...
                end_time=datetime(2024, 1, 1),  ***REMOVED*** End before start
                rotation_velocity=1.0,
                extraction_potential=0.1,
                boundary_type="week_end",
            )
    ...
    def test_ergosphere_extraction_potential_warning(self, caplog):
        ...
        ergosphere = ErgospherePeriod(
            ...
            extraction_potential=0.35,  ***REMOVED*** Exceeds 29% limit
            boundary_type="week_end",
        )

        assert "exceeds Penrose limit" in caplog.text
        assert ergosphere.extraction_potential == 0.35  ***REMOVED*** Still created
...
class TestPenroseSwap:
    ...
    def test_create_valid_swap(self):
        ...
        assert swap.net_extraction == 3.0  ***REMOVED*** 5.0 - 2.0
    ...
    def test_swap_extraction_ratio(self):
        ...
        assert swap.extraction_ratio == 3.0  ***REMOVED*** 6.0 / 2.0
...
class TestRotationEnergyTracker:
    ...
    def test_tracker_extraction_budget(self):
        ...
        ***REMOVED*** Max extractable = 100 * 0.29 = 29
    ...
    def test_tracker_record_extraction(self):
        ...
        assert tracker.extraction_fraction == 0.03  ***REMOVED*** 3/100
    ...
    def test_tracker_exhaustion(self):
        ...
        ***REMOVED*** Extract up to the limit
        tracker.extracted_energy = 29.0  ***REMOVED*** 29% extracted
    ...
    def test_tracker_reject_non_beneficial_swap(self):
        ...
        swap = PenroseSwap(
            ...
            assignment_b=uuid.uuid4(),
            local_cost=5.0,
            global_benefit=2.0,  ***REMOVED*** Not beneficial
            ergosphere_period=ergosphere,
        )
...
class TestPenroseEfficiencyExtractor:
    ...
    def sample_blocks(self):
        ...
        blocks = []
        start_date = date(2024, 1, 1)  ***REMOVED*** Monday

        for i in range(14):  ***REMOVED*** Two weeks
    ...
    async def test_identify_ergosphere_periods(self, extractor, mock_db, sample_blocks):
        ...
        ***REMOVED*** Mock database query to return sample blocks
        mock_result = MagicMock()
        mock_result.scalars.return_value.all.return_value = sample_blocks
        mock_db.execute = AsyncMock(return_value=mock_result)

        ***REMOVED*** Mock _get_assignments_in_period
        ...
        ***REMOVED*** Should find at least one week-end ergosphere
    ...
    async def test_decompose_into_phases(self, extractor):
        ...
        ***REMOVED*** Create test assignment with block
        block = Block(
            id=uuid.uuid4(),
            date=date(2024, 1, 1),
            time_of_day="AM",
        ...
        assert len(phases) == 3  ***REMOVED*** Pre, transition, post
    ...
    async def test_find_negative_energy_swaps(self, extractor, mock_db):
        ...
        ***REMOVED*** Create test ergosphere
        ergosphere = ErgospherePeriod(
            start_time=datetime(2024, 1, 5, 12, 0),  ***REMOVED*** Friday PM
            end_time=datetime(2024, 1, 8, 8, 0),  ***REMOVED*** Monday AM
            rotation_velocity=2.0,
            extraction_potential=0.15,
            boundary_type="week_end",
        ...
        ***REMOVED*** Create test assignments
        ...
        ***REMOVED*** May or may not find beneficial swaps depending on heuristics
        for swap in swaps:
            assert swap.is_beneficial
    ...
    async def test_compute_extraction_efficiency(self, extractor):
        ...
        ***REMOVED*** Initialize tracker
        ...
        assert efficiency > 0
        assert efficiency <= 0.29  ***REMOVED*** Should not exceed Penrose limit

    async def test_execute_penrose_cascade(self, extractor, mock_db):
        """Test execution of Penrose cascade optimization."""
        schedule_id = uuid.uuid4()

        ***REMOVED*** Mock the identify_ergosphere_periods method
        extractor.identify_ergosphere_periods = AsyncMock(
            return_value=[
                ErgospherePeriod(
                    ...
                    end_time=datetime(2024, 1, 2),
                    rotation_velocity=2.0,
                    extraction_potential=0.20,  ***REMOVED*** High potential
                    boundary_type="week_end",
        ...
        ***REMOVED*** Mock find_negative_energy_swaps
