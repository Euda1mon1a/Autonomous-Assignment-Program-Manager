...
class TestConstraintPruner:
    ...
    def test_prune_by_person_type(
        ...
        ***REMOVED*** Cardiology clinic only allows faculty
        ...
        ***REMOVED*** Assert
        ***REMOVED*** Only faculty should be assigned to cardiology clinic
    ...
    def test_prune_by_pgy_level(self, sample_persons, sample_rotations, sample_blocks):
        ...
        ***REMOVED*** Assert
        ***REMOVED*** Only PGY2+ residents should be assigned
        for assignment in result["feasible_assignments"]:
            person = next(
                p for p in sample_persons if p["id"] == assignment["person_id"]
            )
    ...
    def test_prune_by_specialty(self, sample_persons, sample_rotations, sample_blocks):
        ...
        ***REMOVED*** Cardiology clinic requires cardiology specialty
        cardiology_rotation = next(
            r for r in sample_rotations if r["name"] == "Cardiology Clinic"
        )
        ...
        ***REMOVED*** Assert
        ***REMOVED*** Only people with cardiology specialty should be assigned
        for assignment in result["feasible_assignments"]:
            person = next(
                p for p in sample_persons if p["id"] == assignment["person_id"]
            )
    ...
    def test_prune_by_time_of_day(
        ...
        ***REMOVED*** Assert
        ***REMOVED*** Only AM blocks should have assignments
        for assignment in result["feasible_assignments"]:
    ...
    def test_prune_by_unavailability(
        ...
        ***REMOVED*** Mark one person as unavailable on Jan 1
        ...
        ***REMOVED*** Assert
        ***REMOVED*** First person should not be assigned on Jan 1
    ...
    def test_prune_with_existing_assignments(
        ...
        ***REMOVED*** Assert
        ***REMOVED*** Existing assignment should not be in feasible assignments
    ...
    def test_pruning_reasons_tracked(
        ...
        ***REMOVED*** Should have some pruning reasons (e.g., person_type_mismatch, pgy_level_too_low)
