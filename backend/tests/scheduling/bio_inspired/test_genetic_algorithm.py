...
class TestCrossoverOperator:
    ...
    def test_uniform_crossover(self):
        ...
        crossover = CrossoverOperator(
            ...
            crossover_rate=1.0,  ***REMOVED*** Always crossover
        )

        np.random.seed(42)
        child1, child2 = crossover.crossover(parent1, parent2)

        ***REMOVED*** Children should have mix of 1s and 2s
    ...
    def test_row_based_crossover(self):
        ...
        ***REMOVED*** Each row should be all 1s or all 2s
    ...
    def test_no_crossover_when_rate_zero(self):
        ...
        ***REMOVED*** Children should be copies of parents
...
class TestMutationOperator:
    ...
    def test_flip_mutation(self):
        ...
        mutator = MutationOperator(
            ...
            base_rate=1.0,  ***REMOVED*** Mutate all
        )

        np.random.seed(42)
        mutated = mutator.mutate(chrom, n_templates=3)

        ***REMOVED*** Some genes should have changed
    ...
    def test_swap_mutation(self):
        ...
        ***REMOVED*** Shape should be preserved
    ...
    def test_insert_mutation(self):
        ...
        ***REMOVED*** Should have some assignments now
    ...
    def test_delete_mutation(self):
        ...
        ***REMOVED*** Should have fewer assignments
    ...
    def test_adaptive_mutation_increases_on_stagnation(self):
        ...
        ***REMOVED*** Simulate stagnation (no improvement)
        for _ in range(15):
            mutator.adapt_rate(improved=False, diversity=0.5, generation=_)

        ***REMOVED*** Rate should have increased
    ...
    def test_adaptive_mutation_decreases_on_progress(self):
        ...
        ***REMOVED*** Simulate good progress
        for i in range(15):
            mutator.adapt_rate(improved=True, diversity=0.5, generation=i)

        ***REMOVED*** Rate should have decreased
