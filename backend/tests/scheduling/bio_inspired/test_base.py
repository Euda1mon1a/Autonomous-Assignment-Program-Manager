...
class TestFitnessVector:
    ...
    def test_fitness_to_array(self):
        ...
        assert len(arr) == 6
        assert arr[0] == 0.8  ***REMOVED*** coverage
        assert arr[4] == 0.9  ***REMOVED*** acgme_compliance
    ...
    def test_fitness_dominates(self):
        ...
        ***REMOVED*** f1 dominates f2 (better in all objectives)
        f1 = FitnessVector(
    ...
    def test_fitness_not_dominates_incomparable(self):
        ...
        ***REMOVED*** f1 is better in coverage, f2 is better in fairness
...
class TestChromosome:
    ...
    def test_chromosome_create_random(self):
        ...
        ***REMOVED*** Some assignments should be non-zero
    ...
    def test_chromosome_copy(self):
        ...
        ***REMOVED*** Original should be unchanged
    ...
    def test_hamming_distance(self):
        ...
        ***REMOVED*** Different positions: (0,1), (1,1)
    ...
    def test_similarity(self):
        ...
        ***REMOVED*** Modify one position
        c2.genes[0, 0] = 99
        expected_similarity = 1.0 - (1 / 15)  ***REMOVED*** 1 difference out of 15 positions
...
class TestIndividual:
    ...
    def test_individual_comparison(self):
        ...
        ***REMOVED*** Lower rank is better
        assert ind2 < ind1

        ***REMOVED*** Same rank, higher crowding distance is better
        assert ind3 < ind2
