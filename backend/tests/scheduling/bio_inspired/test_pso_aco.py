...
class TestParticle:
    ...
    def test_particle_update_personal_best(self):
        ...
        particle = Particle(
            ...
            fitness=0.8,  ***REMOVED*** Better than personal best
        )
...
class TestParticleSwarmSolver:
    ...
    def test_pso_setup_global_topology(self):
        ...
        ***REMOVED*** Each particle should see all others
        for particle in solver.swarm:
    ...
    def test_pso_setup_ring_topology(self):
        ...
        ***REMOVED*** Each particle should have 3 neighbors (self + 2)
        for particle in solver.swarm:
    ...
    def test_pso_normalize_weights(self):
        ...
        ***REMOVED*** Should sum to 1
        assert np.isclose(np.sum(weights), 1.0)
        ***REMOVED*** All positive
...
class TestPheromoneMatrix:
    ...
    def test_pheromone_matrix_creation(self):
        ...
        assert pm.assignment.shape == (5, 10, 4)  ***REMOVED*** +1 for unassigned
    ...
    def test_pheromone_evaporation(self):
        ...
        ***REMOVED*** Should be 90% of original
    ...
    def test_pheromone_deposit(self):
        ...
        ***REMOVED*** Check that pheromone increased on path
        assert pm.assignment[0, 0, 1] > 1.0
        assert pm.transition[0, 1] > 1.0  ***REMOVED*** Transition from 0 to 1
    ...
    def test_pheromone_min_max_bounds(self):
        ...
        ***REMOVED*** Deposit a lot of pheromone
        paths = [
            AntPath(
                resident_idx=0,
                path=[1, 1, 1],
        ...
        ***REMOVED*** Should be capped at max
        assert np.all(pm.assignment <= 5.0)

        ***REMOVED*** Evaporate many times
        for _ in range(100):
            pm.evaporate()

        ***REMOVED*** Should be at least min
    ...
    def test_get_assignment_probability(self):
        ...
        ***REMOVED*** Should be valid probability distribution
...
class TestAntColonySolver:
    ...
    def test_aco_get_pheromone_analysis(self):
        ...
        ***REMOVED*** Without pheromone matrix
        analysis = solver.get_pheromone_analysis()
        assert analysis == {}

        ***REMOVED*** With pheromone matrix
