...
class TestParetoExporter:
    ...
    def test_export_with_objectives(self):
        ...
        ***REMOVED*** Other objectives should not be present
...
class TestHolographicExporter:
    ...
    def test_holographic_nodes(self):
        ...
        assert len(nodes) == 3  ***REMOVED*** 3 Pareto solutions
    ...
    def test_fitness_to_color(self):
        ...
        ***REMOVED*** High fitness = green
        color_good = exporter._fitness_to_color(1.0)
        assert color_good.startswith("***REMOVED***")
        assert color_good[3:5] == "ff"  ***REMOVED*** Green channel high

        ***REMOVED*** Low fitness = red
        color_bad = exporter._fitness_to_color(0.0)
        assert color_bad[1:3] == "ff"  ***REMOVED*** Red channel high
