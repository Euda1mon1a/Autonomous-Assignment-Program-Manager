...
def person_with_user(db: Session) -> tuple[Person, User]:
    ...
    user = User(
        id=uuid4(),
        username="testuser",
        email="testuser@hospital.org",  ***REMOVED*** Match person email
...
def faculty_person_with_user(db: Session) -> tuple[Person, User]:
    ...
    user = User(
        ...
        email="faculty@hospital.org",  ***REMOVED*** Match person email
        hashed_password=get_password_hash("testpass123"),
        role="faculty",
        is_active=True,
    )
...
def rotation_templates(db: Session) -> list[RotationTemplate]:
    ...
    templates = [
        ...
        RotationTemplate(
            ...
            activity_type="admin",
            abbreviation="ADM",
            clinic_location=None,  ***REMOVED*** No location
            max_residents=10,
        ),
    ]
...
class TestDashboardSuccess:
    ...
    def test_get_dashboard_with_schedule(
        ...
        ***REMOVED*** Create assignments for the next week
        for i in range(5):  ***REMOVED*** 5 days
            block = future_blocks[i * 2]  ***REMOVED*** AM blocks
        ...
        ***REMOVED*** Should have 5 schedule items
        assert len(data["upcoming_schedule"]) == 5

        ***REMOVED*** Check first schedule item structure
    ...
    def test_get_dashboard_with_pending_swaps(
        ...
        ***REMOVED*** Create pending swaps where person is source
        swap1 = SwapRecord(
            id=uuid4(),
        ...
        ***REMOVED*** Create another swap where person is target
        swap2 = SwapRecord(
            id=uuid4(),
        ...
        ***REMOVED*** Should have 2 pending swaps
        assert len(data["pending_swaps"]) == 2

        ***REMOVED*** Check swap structure
        ...
        ***REMOVED*** Check other_party_name is correct
    ...
    def test_get_dashboard_with_absences(
        ...
        ***REMOVED*** Create another future absence
        absence2 = Absence(
            id=uuid4(),
            person_id=person.id,
        ...
        ***REMOVED*** Should have 2 absences
        assert len(data["absences"]) == 2

        ***REMOVED*** Check absence structure
    ...
    def test_get_dashboard_past_absences_excluded(
        ...
        ***REMOVED*** Create current absence (ends today)
        ...
        ***REMOVED*** Should only have the current absence (ends today)
    ...
    def test_get_dashboard_with_calendar_sync(
        ...
        ***REMOVED*** Calendar sync URL should be present (or None if service fails)
        assert "calendar_sync_url" in data
        ***REMOVED*** URL should be a string or None
    ...
    def test_get_dashboard_calendar_sync_creates_subscription(
        ...
        ***REMOVED*** Mock no existing subscriptions
        mock_list.return_value = []

        ***REMOVED*** Mock created subscription
        ...
        ***REMOVED*** Verify subscription was created
        ...
        ***REMOVED*** Verify URL was generated
    ...
    def test_get_dashboard_calendar_sync_uses_existing(
        ...
        ***REMOVED*** Mock existing subscription
        mock_subscription = MagicMock()
        ...
        ***REMOVED*** Verify no new subscription was created
        mock_create.assert_not_called()

        ***REMOVED*** Verify URL was generated with existing token
    ...
    def test_get_dashboard_calendar_sync_failure_continues(
        ...
        ***REMOVED*** Mock calendar service failure
        ...
        ***REMOVED*** Calendar sync URL should be None
        assert data["calendar_sync_url"] is None

        ***REMOVED*** Other data should still be present
        assert "user" in data
        assert "upcoming_schedule" in data
        assert "summary" in data
    ...
    def test_get_dashboard_with_full_data(
        ...
        ***REMOVED*** Add schedule assignments
        for i in range(10):
            assignment = Assignment(
                id=uuid4(),
        ...
        ***REMOVED*** Verify all sections have data
...
class TestDashboardQueryParameters:
    ...
    def test_get_dashboard_default_days_ahead(
        ...
        assert response.status_code == 200
        ***REMOVED*** Default is 30 days, should work without parameter
    ...
    def test_get_dashboard_custom_days_ahead(
        ...
        ***REMOVED*** Create assignments spread across 50 days
        ...
        ***REMOVED*** Request only 7 days ahead
        response = client.get(
        ...
        ***REMOVED*** Should only include assignments within 7 days
    ...
    def test_get_dashboard_days_ahead_too_large(
        ...
        ***REMOVED*** Should return validation error
...
class TestDashboardSummary:
    ...
    def test_dashboard_summary_next_assignment(
        ...
        ***REMOVED*** Create assignment 5 days from now
        ...
        ***REMOVED*** Next assignment should be the one we created
    ...
    def test_dashboard_summary_workload_calculation(
        ...
        ***REMOVED*** Create assignments within 4 weeks
        ...
        for i in range(60):
            ...
            if block.date <= four_weeks:
                ...
                ***REMOVED*** Also add some beyond 4 weeks
                if i < 80:
                    assignment = Assignment(
                        id=uuid4(),
                        block_id=block.id,
        ...
        ***REMOVED*** Workload should only count blocks within 4 weeks
    ...
    def test_dashboard_summary_pending_swap_count(
        ...
        ***REMOVED*** Create multiple pending swaps
        for i in range(3):
            swap = SwapRecord(
                id=uuid4(),
                source_faculty_id=person.id,
        ...
        ***REMOVED*** Create an approved swap (should not be counted)
        ...
        ***REMOVED*** Should only count pending swaps
    ...
    def test_dashboard_summary_absences_count(
        ...
        ***REMOVED*** Create future absences
        for i in range(2):
            absence = Absence(
                id=uuid4(),
                person_id=person.id,
...
class TestDashboardScheduleDetails:
    ...
    def test_schedule_can_trade_other_roles(
        ...
        ***REMOVED*** Create backup and supervising assignments
        ...
        ***REMOVED*** Find the backup and supervising items
        for item in data["upcoming_schedule"]:
    ...
    def test_schedule_no_location(
        ...
        ***REMOVED*** Use template with no location
        assignment = Assignment(
            id=uuid4(),
            block_id=future_blocks[0].id,
            person_id=person.id,
            rotation_template_id=rotation_templates[2].id,  ***REMOVED*** Admin template with no location
            role="primary",
        )
        db.add(assignment)
        db.commit()
    ...
    def test_schedule_ordered_by_date_and_time(
        ...
        ***REMOVED*** Create assignments in random order
        dates_times = [
        ...
        ***REMOVED*** Verify ordering
        ...
        for i in range(len(schedule) - 1):
            ...
            ***REMOVED*** Either next date is after current, or same date with time ordering
            if current_date == next_date:
                ***REMOVED*** If same date, AM should come before PM
...
class TestDashboardSwapDetails:
    ...
    def test_swap_absorb_type(
        ...
        swap = SwapRecord(
            ...
            target_faculty_id=sample_faculty.id,
            source_week=date.today() + timedelta(days=14),
            target_week=None,  ***REMOVED*** Absorb has no target week
    ...
    def test_swap_only_pending_status(
        ...
        ***REMOVED*** Should only show pending swap
        assert len(data["pending_swaps"]) == 1
...
class TestDashboardErrors:
    ...
    def test_get_dashboard_no_person_profile(
        ...
        ***REMOVED*** Create user without matching person
        user = User(
            id=uuid4(),
            username="noperson",
    ...
    def test_get_dashboard_inactive_user(
        ...
        ***REMOVED*** Try to login
        response = client.post(
            "/api/auth/login/json",
            json={"username": "testuser", "password": "testpass123"},
        )

        ***REMOVED*** Should not be able to login with inactive user
        assert response.status_code in [400, 401]


***REMOVED*** ============================================================================
***REMOVED*** Faculty User Tests
***REMOVED*** ============================================================================
...
class TestDashboardFaculty:
    ...
    def test_get_dashboard_faculty_user(
        ...
        ***REMOVED*** Login as faculty
        ...
        assert data["user"]["pgy_level"] is None  ***REMOVED*** Faculty don't have PGY level
...
class TestDashboardEdgeCases:
    ...
    def test_get_dashboard_empty_results(
        ...
        ***REMOVED*** All lists should be empty but present
    ...
    def test_get_dashboard_assignment_without_template(
        ...
        ***REMOVED*** Create assignment without template
        assignment = Assignment(
            id=uuid4(),
            block_id=future_blocks[0].id,
            person_id=person.id,
    ...
    def test_get_dashboard_large_dataset(
        ...
        ***REMOVED*** Create many assignments
        for block in future_blocks[:100]:  ***REMOVED*** 100 assignments
            assignment = Assignment(
                id=uuid4(),
                block_id=block.id,
                person_id=person.id,
        ...
        ***REMOVED*** Should handle large dataset
