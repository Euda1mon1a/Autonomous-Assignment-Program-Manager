...
class TestAuditAuthentication:
    """Tests for audit API authentication requirements."""
...
class TestAuditLogsEndpoint:
    ...
    def test_get_logs_filter_by_entity_type(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** All returned items should be assignment or person
    ...
    def test_get_logs_acgme_overrides_only(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** All returned items should have ACGME override
        for item in data["items"]:
    ...
    def test_get_logs_date_range_filter(self, client: TestClient, auth_headers: dict):
    ...
    def test_get_logs_invalid_page_size(self, client: TestClient, auth_headers: dict):
        ...
        response = client.get(
            "/api/audit/logs",
            params={"page_size": 200},  ***REMOVED*** Over 100 limit
            headers=auth_headers
        )
...
class TestAuditLogByIdEndpoint:
    ...
    def test_get_log_by_id_exists(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** First get a list to find a valid ID
    ...
    def test_get_log_with_changes(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Get a log with changes (like audit-001)
    ...
    def test_get_log_with_acgme_override(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Get a log with ACGME override (like audit-002)
...
class TestAuditStatisticsEndpoint:
    ...
    def test_get_statistics_default(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Validate structure of grouped counts
    ...
    def test_get_statistics_with_date_range(self, client: TestClient, auth_headers: dict):
...
class TestAuditUsersEndpoint:
    ...
    def test_get_users_list(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Validate user structure
        if data:
            user = data[0]
            assert "id" in user
            assert "name" in user
            ***REMOVED*** email and role are optional
...
class TestAuditExportEndpoint:
    ...
    def test_export_with_date_range(self, client: TestClient, auth_headers: dict):
    ...
    def test_export_json_contains_data(self, client: TestClient, auth_headers: dict):
        ...
        assert response.status_code == 200
        ***REMOVED*** The response should be valid JSON
        import json
    ...
    def test_export_csv_has_headers(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** First line should be headers
        assert len(lines) > 0
        headers = lines[0]
...
class TestMarkReviewedEndpoint:
    ...
    def test_mark_reviewed_missing_reviewer(self, client: TestClient, auth_headers: dict):
    ...
    def test_mark_reviewed_single_entry(self, client: TestClient, auth_headers: dict):
        ...
        response = client.post(
            "/api/audit/mark-reviewed",
            json={
                "ids": ["audit-007"],  ***REMOVED*** Critical ACGME override
                "reviewedBy": "user-002",
    ...
    def test_mark_reviewed_multiple_entries(self, client: TestClient, auth_headers: dict):
...
class TestAuditLogStructure:
    ...
    def test_audit_entry_has_required_fields(self, client: TestClient, auth_headers: dict):
    ...
    def test_audit_entry_timestamp_format(self, client: TestClient, auth_headers: dict):
        ...
        if data["items"]:
            ...
            ***REMOVED*** Should be parseable as ISO datetime
            try:
                datetime.fromisoformat(timestamp.replace('Z', '+00:00'))
            except ValueError:
                pytest.fail(f"Invalid timestamp format: {timestamp}")

    def test_audit_entry_changes_structure(self, client: TestClient, auth_headers: dict):
        ...
        for entry in data["items"]:
            if entry.get("changes"):
                for change in entry["changes"]:
                    ...
                    assert "oldValue" in change
                    assert "newValue" in change
                    ***REMOVED*** displayName is optional
