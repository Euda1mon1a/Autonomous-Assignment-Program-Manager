...
***REMOVED*** ============================================================================
***REMOVED*** Test send_notification
***REMOVED*** ============================================================================
...
class TestSendNotification:
    ...
    async def test_send_notification_success(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            ***REMOVED*** Verify notification was stored in database
            notification = (
    ...
    async def test_send_notification_template_not_found(
        ...
        ***REMOVED*** Create a mock NotificationType that doesn't have a template
    ...
    async def test_send_notification_respects_preferences(
        ...
        ***REMOVED*** Create preferences with schedule_published disabled
        prefs = NotificationPreferenceRecord(
            user_id=sample_user.id,
            enabled_channels="in_app,email",
        ...
        ***REMOVED*** Should return empty list (notification skipped)
    ...
    async def test_send_notification_quiet_hours(
        ...
        ***REMOVED*** Set quiet hours to include current hour
        prefs = NotificationPreferenceRecord(
            user_id=sample_user.id,
            enabled_channels="in_app,email",
            notification_types={},
        ...
        ***REMOVED*** Try to send normal priority notification (should be skipped)
        results = await notification_service.send_notification(
            recipient_id=sample_user.id,
    ...
    async def test_send_notification_multiple_channels(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ***REMOVED*** Mock both in_app and email channels
            mock_channel = Mock()
            mock_channel.deliver = AsyncMock(
                return_value=DeliveryResult(
            ...
            ***REMOVED*** Should have results from both channels
            assert len(results) == 2


***REMOVED*** ============================================================================
***REMOVED*** Test send_bulk
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test schedule_notification
***REMOVED*** ============================================================================
...
class TestScheduleNotification:
    ...
    def test_schedule_notification_success(
        ...
        ***REMOVED*** Verify stored in database
        record = (
    ...
    def test_schedule_notification_in_past(
        ...
        assert scheduled is not None
        ***REMOVED*** Will be processed immediately by process_scheduled_notifications


***REMOVED*** ============================================================================
***REMOVED*** Test process_scheduled_notifications
***REMOVED*** ============================================================================
...
class TestProcessScheduledNotifications:
    ...
    async def test_process_due_notifications(
        ...
        ***REMOVED*** Create a due notification
    ...
    async def test_process_no_due_notifications(
        ...
        ***REMOVED*** Create a future notification
    ...
    async def test_process_handles_failures(
        ...
        record = ScheduledNotificationRecord(
            recipient_id=sample_user.id,
            notification_type="invalid_type",  ***REMOVED*** Invalid type will cause failure
            data={},
            send_at=past_time,
            status="pending",
        )
        ...
        ***REMOVED*** Verify status is failed
        db.refresh(record)
...
***REMOVED*** ============================================================================
***REMOVED*** Test get_pending_notifications
***REMOVED*** ============================================================================
...
class TestGetPendingNotifications:
    ...
    def test_get_unread_notifications(
        ...
        ***REMOVED*** Create multiple notifications
        for i in range(3):
            notification = Notification(
                recipient_id=sample_user.id,
                notification_type="schedule_published",
        ...
        ***REMOVED*** Create one read notification
    ...
    def test_get_all_notifications(
        ...
        ***REMOVED*** Create unread notification
        unread = Notification(
            recipient_id=sample_user.id,
            notification_type="schedule_published",
            subject="Unread",
        ...
        ***REMOVED*** Create read notification
        read = Notification(
            recipient_id=sample_user.id,
            notification_type="assignment_changed",
            subject="Read",
    ...
    def test_get_notifications_limit(
        ...
        ***REMOVED*** Create 10 notifications
        for i in range(10):
            notification = Notification(
                recipient_id=sample_user.id,
                notification_type="schedule_published",
    ...
    def test_get_notifications_wrong_user(
        ...
        ***REMOVED*** Create notification for sample_user
        notification = Notification(
            recipient_id=sample_user.id,
            notification_type="schedule_published",
            subject="Test",
...
class TestMarkAsRead:
    ...
    def test_mark_multiple_notifications_as_read(
        ...
        ***REMOVED*** Verify all are marked as read
...
***REMOVED*** ============================================================================
***REMOVED*** Test Notification Preferences
***REMOVED*** ============================================================================
...
class TestNotificationPreferences:
    ...
    def test_get_user_preferences_default(
        ...
        assert prefs is not None
        assert prefs.user_id == sample_user.id
        ***REMOVED*** Should have default channels
        assert "in_app" in prefs.enabled_channels
        assert "email" in prefs.enabled_channels
    ...
    def test_update_user_preferences_existing(
        ...
        ***REMOVED*** Verify updated in database
    ...
    def test_should_send_notification_quiet_hours_high_priority(
        ...
        ***REMOVED*** High priority notification should still send
        should_send = notification_service._should_send_notification(
            prefs,
            NotificationType.ACGME_WARNING,  ***REMOVED*** High priority
        )

        ***REMOVED*** Note: This depends on template having high priority
        ***REMOVED*** The actual implementation may vary
...
class TestEdgeCases:
    ...
    async def test_send_notification_invalid_recipient(
        ...
        ***REMOVED*** Should not crash, but may skip based on preferences
        results = await notification_service.send_notification(
            recipient_id=uuid4(),  ***REMOVED*** Non-existent user
            notification_type=NotificationType.SCHEDULE_PUBLISHED,
            data={
                "period": "January 2025",
                "coverage_rate": "95.0",
        ...
        ***REMOVED*** Should handle gracefully (may return empty or skip)
    ...
    def test_get_preferences_invalid_user(
        ...
        ***REMOVED*** Should return default preferences
        assert prefs is not None
    ...
    async def test_send_notification_channel_not_found(
        ...
        with patch("app.notifications.service.get_channel", return_value=None):
            ...
            ***REMOVED*** Should have a failure result
            assert len(results) > 0
    ...
    def test_notification_preferences_edge_cases(
        ...
        ***REMOVED*** Test with quiet hours wrapping around midnight
        prefs = NotificationPreferences(
            user_id=sample_user.id,
            enabled_channels=[],  ***REMOVED*** No channels enabled
            notification_types={},
            quiet_hours_start=23,  ***REMOVED*** 11 PM
            quiet_hours_end=2,  ***REMOVED*** 2 AM
        )
...
***REMOVED*** ============================================================================
***REMOVED*** Test NotificationPreferences Model
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test ScheduledNotification Model
***REMOVED*** ============================================================================
...
class TestNotificationServiceIntegration:
    ...
    async def test_complete_notification_workflow(
        ...
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            ...
            ***REMOVED*** Step 1: Send notification
            ...
            ***REMOVED*** Step 2: Get pending notifications
            notifications = notification_service.get_pending_notifications(
                user_id=sample_user.id, unread_only=True
            )
            ...
            ***REMOVED*** Step 3: Mark as read
            count = notification_service.mark_as_read([notif_id])
            assert count == 1

            ***REMOVED*** Step 4: Verify no unread notifications
    ...
    async def test_scheduled_notification_workflow(
        ...
        ***REMOVED*** Step 1: Schedule notification for past (will be processed immediately)
        ...
        ***REMOVED*** Step 2: Process scheduled notifications
        with patch("app.notifications.service.get_channel") as mock_get_channel:
            mock_channel = Mock()
            mock_channel.deliver = AsyncMock(
                return_value=DeliveryResult(
        ...
        ***REMOVED*** Step 3: Verify notification was created
        notifications = notification_service.get_pending_notifications(
            user_id=sample_user.id
        )
        assert len(notifications) >= 1
