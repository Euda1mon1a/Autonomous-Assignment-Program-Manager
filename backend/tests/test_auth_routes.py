...
***REMOVED*** ============================================================================
***REMOVED*** Login Endpoint Tests (OAuth2 Form)
***REMOVED*** ============================================================================
...
class TestLoginEndpoint:
    ...
    def test_login_updates_last_login(self, client: TestClient, admin_user: User, db: Session):
        ...
        ***REMOVED*** Record original last_login
        original_last_login = admin_user.last_login

        ***REMOVED*** Perform login
        response = client.post(
            "/api/auth/login",
            data={"username": "testadmin", "password": "testpass123"},
        )
        ...
        ***REMOVED*** Refresh user from database
        db.refresh(admin_user)

        ***REMOVED*** Verify last_login was updated
    ...
    def test_login_token_is_valid_jwt(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Decode token without verification to check structure
        decoded = jwt.decode(
            token,
            settings.SECRET_KEY,
        ...
        assert "sub" in decoded  ***REMOVED*** User ID
        assert "username" in decoded
        assert "exp" in decoded  ***REMOVED*** Expiration
        assert "jti" in decoded  ***REMOVED*** JWT ID
        assert decoded["username"] == "testadmin"


***REMOVED*** ============================================================================
***REMOVED*** Login JSON Endpoint Tests
***REMOVED*** ============================================================================
...
class TestLoginJsonEndpoint:
    ...
    def test_login_json_case_sensitive_username(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Should fail because username is case-sensitive
        assert response.status_code == 401
    ...
    def test_login_json_with_extra_fields(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Should succeed, extra fields are ignored
        assert response.status_code == 200
...
class TestLogoutEndpoint:
    ...
    def test_logout_success(self, client: TestClient, auth_headers: dict, db: Session):
        ...
        ***REMOVED*** Verify token was added to blacklist
    ...
    def test_logout_token_unusable_after_logout(
        ...
        ***REMOVED*** First, logout
        response = client.post("/api/auth/logout", headers=auth_headers)
        assert response.status_code == 200

        ***REMOVED*** Try to use the same token
    ...
    def test_logout_inactive_user_token(
        ...
        ***REMOVED*** Create token for inactive user
        ...
        ***REMOVED*** Should fail because user is inactive
        assert response.status_code == 401


***REMOVED*** ============================================================================
***REMOVED*** Get Current User Endpoint Tests
***REMOVED*** ============================================================================
...
class TestGetCurrentUserEndpoint:
    ...
    def test_get_me_success(self, client: TestClient, auth_headers: dict, admin_user: User):
        ...
        assert "id" in data
        ***REMOVED*** Password should not be in response
    ...
    def test_get_me_with_blacklisted_token(
        ...
        ***REMOVED*** First logout to blacklist the token
        client.post("/api/auth/logout", headers=auth_headers)

        ***REMOVED*** Try to use the blacklisted token
        response = client.get("/api/auth/me", headers=auth_headers)
...
***REMOVED*** ============================================================================
***REMOVED*** Register User Endpoint Tests
***REMOVED*** ============================================================================
...
class TestRegisterUserEndpoint:
        ...
        ***REMOVED*** Clear all users
        ...
        response = client.post(
            ...
            json={
                ...
                "role": "coordinator"  ***REMOVED*** Should be overridden to admin
            },
        )
        ...
        assert data["role"] == "admin"  ***REMOVED*** First user becomes admin
        assert data["is_active"] is True
    ...
    def test_register_subsequent_user_requires_admin(
        ...
        assert data["role"] == "coordinator"  ***REMOVED*** Not admin
    ...
    def test_register_duplicate_username(
        ...
        response = client.post(
            "/api/auth/register",
            json={
                "username": "testadmin",  ***REMOVED*** Already exists
    ...
    def test_register_duplicate_email(
        ...
        response = client.post(
            ...
            json={
                ...
                "email": "testadmin@test.org",  ***REMOVED*** Already exists
                "password": "password123",
                "role": "coordinator"
            },
            headers=auth_headers
    ...
    def test_register_invalid_role(
        ...
        ***REMOVED*** Should create user but may fail database constraint
    ...
    def test_register_missing_required_fields(
        ...
        response = client.post(
            ...
            json={
                "username": "newuser",
                ***REMOVED*** Missing email and password
            },
            headers=auth_headers
        )
    ...
    def test_register_password_is_hashed(
        ...
        ***REMOVED*** Verify password is hashed in database
        user = db.query(User).filter(User.username == "hasheduser").first()
        assert user is not None
        assert user.hashed_password != plain_password
        assert user.hashed_password.startswith("$2b$")  ***REMOVED*** bcrypt hash


***REMOVED*** ============================================================================
***REMOVED*** List Users Endpoint Tests
***REMOVED*** ============================================================================
...
class TestListUsersEndpoint:
    ...
    def test_list_users_success(
        ...
        assert len(data) >= 1
        ***REMOVED*** Should include admin user
    ...
    def test_list_users_ordered(
        ...
        ***REMOVED*** Create additional users
        for i in range(3):
            user = User(
                id=uuid4(),
                username=f"user_{chr(97 + i)}",  ***REMOVED*** user_a, user_b, user_c
        ...
        ***REMOVED*** Should be ordered by username
        assert usernames == sorted(usernames)


***REMOVED*** ============================================================================
***REMOVED*** Token Security Tests
***REMOVED*** ============================================================================
...
class TestTokenSecurity:
    ...
    def test_token_jti_is_unique(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** JTIs should be different
    ...
    def test_token_has_expiration(self, client: TestClient, admin_user: User):
        ...
        assert "iat" in decoded  ***REMOVED*** Issued at

        ***REMOVED*** Expiration should be in the future
    ...
    def test_tampered_token_rejected(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Tamper with token by changing a character
    ...
    def test_token_with_wrong_secret_rejected(
        ...
        ***REMOVED*** Create token with wrong secret
...
class TestAuthEdgeCases:
    ...
    def test_login_with_special_characters_in_password(
        ...
        special_password = "p@$$w0rd!***REMOVED***%&*()[]{}|;:',.<>?/~`"

        ***REMOVED*** Create user with special password
        user = User(
            id=uuid4(),
    ...
    def test_login_with_unicode_characters(
        ...
        ***REMOVED*** Create user with unicode username
        user = User(
            id=uuid4(),
            username="user_中文_🚀",
    ...
    def test_register_with_very_long_username(
        ...
        long_username = "a" * 150  ***REMOVED*** Longer than 100 char limit
        ...
        ***REMOVED*** Should fail validation or database constraint
        assert response.status_code in [400, 422]
    ...
    def test_concurrent_registrations_same_username(
        ...
        ***REMOVED*** Second registration with same username
        response2 = client.post(
            "/api/auth/register",
            json={
                "username": "concurrent",
    ...
    def test_logout_multiple_times(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Second logout with same token should fail
    ...
    def test_get_me_with_deleted_user_token(
        ...
        ***REMOVED*** Try to use token
        response = client.get("/api/auth/me", headers=headers)

        ***REMOVED*** Should fail because user no longer exists
        assert response.status_code == 401
...
***REMOVED*** ============================================================================
***REMOVED*** Refresh Token Endpoint Tests
***REMOVED*** ============================================================================
...
class TestRefreshTokenEndpoint:
    ...
    def test_refresh_returns_new_tokens(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Login to get initial tokens
        response = client.post(
            "/api/auth/login/json",
            json={"username": "testadmin", "password": "testpass123"},
        )
        ...
        ***REMOVED*** New access token should be different
    ...
    def test_refresh_with_expired_token(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Create an expired refresh token
    ...
    def test_refresh_with_access_token_fails(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Create an access token (wrong type)
        ...
        ***REMOVED*** Should fail because access tokens have no "type" field or wrong type
        assert response.status_code == 401
    ...
    def test_refresh_blacklists_old_token_on_rotation(
        ...
        """
        ***REMOVED*** Login to get initial refresh token
        response = client.post(
            "/api/auth/login/json",
            json={"username": "testadmin", "password": "testpass123"},
        )
        ...
        ***REMOVED*** Use refresh token (this should blacklist the original)
        response = client.post(
            "/api/auth/refresh",
            json={"refresh_token": original_refresh_token},
        )
        ...
        ***REMOVED*** Verify the original token's JTI is now blacklisted
        blacklisted = db.query(TokenBlacklist).filter(
    ...
    def test_refresh_reused_token_rejected(
        ...
        ***REMOVED*** First use of refresh token - should succeed
        response = client.post(
            "/api/auth/refresh",
            json={"refresh_token": original_refresh_token},
        )
        ...
        ***REMOVED*** Second use of same refresh token - should fail (token was blacklisted)
        response = client.post(
            "/api/auth/refresh",
            json={"refresh_token": original_refresh_token},
        )
    ...
    def test_refresh_new_token_works_after_rotation(
        ...
        ***REMOVED*** New token should be different from original
        assert new_refresh_token != original_refresh_token

        ***REMOVED*** New token should work for another refresh
        response = client.post(
            "/api/auth/refresh",
    ...
    def test_refresh_with_inactive_user(
        ...
        ***REMOVED*** Create refresh token for inactive user
        refresh_token, _, _ = create_refresh_token(
            data={"sub": str(inactive_user.id), "username": inactive_user.username}
        )
    ...
    def test_refresh_with_deleted_user(
        ...
        ***REMOVED*** Try to use refresh token
        response = client.post(
            "/api/auth/refresh",
            json={"refresh_token": refresh_token},
        )
    ...
    def test_refresh_token_has_correct_type(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Login to get refresh token
        response = client.post(
            "/api/auth/login/json",
            json={"username": "testadmin", "password": "testpass123"},
        )
        ...
        ***REMOVED*** Decode and verify type
        decoded = jwt.decode(
            refresh_token,
            settings.SECRET_KEY,
            algorithms=[ALGORITHM]
    ...
    def test_refresh_sets_access_token_cookie(self, client: TestClient, admin_user: User):
        ...
        ***REMOVED*** Refresh
        ...
        assert response.status_code == 200
        ***REMOVED*** Check that access_token cookie is set
    ...
    def test_multiple_rapid_refreshes_all_blacklisted(
        ...
        that token.
        """
        ***REMOVED*** Login to get initial token
        response = client.post(
            "/api/auth/login/json",
            json={"username": "testadmin", "password": "testpass123"},
        )
        ...
        ***REMOVED*** Perform multiple refreshes in sequence
        for i in range(3):
            response = client.post(
                "/api/auth/refresh",
        ...
        ***REMOVED*** All previous tokens (except the latest) should be blacklisted
        ...
        ***REMOVED*** Latest token should not be blacklisted yet
