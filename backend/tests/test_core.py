...
class TestConfigurationSettings:
    ...
    def test_default_settings_exist(self):
        ...
        ***REMOVED*** Check default values exist
    ...
    def test_get_settings_cached(self):
        ...
        ***REMOVED*** Should return the same cached instance
    ...
    def test_settings_cors_origins(self):
        ...
        ***REMOVED*** CORS_ORIGINS should be a list
    ...
    def test_cors_origins_default_is_restrictive(self):
        ...
        ***REMOVED*** Default should NOT contain wildcard
        assert "*" not in settings.CORS_ORIGINS
        ***REMOVED*** Default should be localhost for development
    ...
    def test_cors_origins_wildcard_forbidden_in_production(self, monkeypatch):
        ...
        ***REMOVED*** Set production mode and wildcard CORS
        monkeypatch.setenv("DEBUG", "false")
        monkeypatch.setenv("CORS_ORIGINS", '["*"]')

        ***REMOVED*** Should raise ValueError in production
    ...
    def test_cors_origins_wildcard_allowed_in_debug(self, monkeypatch):
        ...
        ***REMOVED*** Set debug mode and wildcard CORS
        monkeypatch.setenv("DEBUG", "true")
        monkeypatch.setenv("CORS_ORIGINS", '["*"]')

        ***REMOVED*** Should succeed in debug mode (with warning)
        settings = Settings()
...
class TestPasswordHashing:
    ...
    def test_password_hash_unique_per_call(self):
        ...
        ***REMOVED*** Hashes should be different due to random salt
        assert hash1 != hash2
    ...
    def test_empty_password_hash(self):
        ...
        ***REMOVED*** Empty password should still hash
...
class TestTokenPayload:
    ...
    def test_token_contains_subject(self):
        ...
        ***REMOVED*** Decode without verification to check payload
        payload = jwt.decode(
            token,
            settings.SECRET_KEY,
            algorithms=["HS256"],
...
class TestSecurityConstants:
    ...
    def test_default_token_expire_minutes(self):
        ...
        ***REMOVED*** Should have an expiration setting
...
class TestResilienceConfiguration:
    ...
    def test_resilience_settings_exist(self):
        ...
        ***REMOVED*** Check resilience-related settings
        resilience_attrs = [
...
class TestSecretValidation:
    ...
    def test_secret_key_allows_weak_debug(self, monkeypatch, caplog):
        ...
        ***REMOVED*** Should succeed with warning
        settings = Settings()
    ...
    def test_redis_password_allows_empty_debug(self, monkeypatch):
        ...
        ***REMOVED*** Should succeed in debug mode
        settings = Settings()
    ...
    def test_all_secrets_strong_production(self, monkeypatch):
        ...
        ***REMOVED*** Should succeed with all strong secrets
        settings = Settings()
