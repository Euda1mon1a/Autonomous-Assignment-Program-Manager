...
def sample_heatmap_data(db: Session, sample_blocks: list[Block]) -> dict:
    ...
    ***REMOVED*** Create assignments
    ...
    for i, block in enumerate(sample_blocks[:6]):
        ***REMOVED*** Assign faculty to FMIT
        if i % 2 == 0:
        ...
        ***REMOVED*** Assign residents to clinic and procedures
        assignment = Assignment(
            id=uuid4(),
            block_id=block.id,
...
class TestGetHeatmapData:
    ...
    def test_get_heatmap_data_success(
        ...
        assert len(data["x_labels"]) == 7  ***REMOVED*** 7 days
    ...
    def test_get_heatmap_data_fmit_only(
        ...
        assert response.status_code == 200
        data = response.json()
        ***REMOVED*** Should only include FMIT rotation
        if data["y_labels"]:
    ...
    def test_get_heatmap_data_residency_only(
        ...
        assert response.status_code == 200
        data = response.json()
        ***REMOVED*** Should not include FMIT rotation
...
***REMOVED*** ============================================================================
***REMOVED*** Test POST /heatmap/data
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test GET /heatmap/render
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test POST /heatmap/render
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test GET /heatmap/export
***REMOVED*** ============================================================================
...
class TestGetHeatmapExport:
    ...
    def test_export_heatmap_custom_dimensions(
        ...
        assert response.status_code == 200
        ***REMOVED*** Verify that service was called with correct dimensions
...
***REMOVED*** ============================================================================
***REMOVED*** Test POST /heatmap/export
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test GET /person-coverage/data
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test POST /person-coverage/data
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test GET /weekly-fmit/data
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test POST /weekly-fmit/data
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Integration Tests with Real Data
***REMOVED*** ============================================================================
...
class TestHeatmapIntegration:
    ...
    def test_empty_date_range_handling(
        ...
        ***REMOVED*** Use far future date where no assignments exist
        ...
        assert response.status_code == 200
        data = response.json()
        ***REMOVED*** Should still return structure even with no data
        assert "x_labels" in data
        assert "y_labels" in data
        assert "z_values" in data
