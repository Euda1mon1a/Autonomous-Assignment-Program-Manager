...
***REMOVED*** =============================================================================
***REMOVED*** Helper Functions Tests
***REMOVED*** =============================================================================
...
class TestHelperFunctions:
    ...
    async def test_send_notification_success(self):
        ...
        with patch(
            ...
            ***REMOVED*** Verify notification service was called correctly
    ...
    async def test_invalidate_cache_handles_import_error(self, caplog):
        ...
        with patch(
            ...
            ***REMOVED*** Should log debug message
            assert any(
    ...
    async def test_update_metrics_without_prometheus(self, caplog):
        ...
        ***REMOVED*** Should not raise even without prometheus
        await update_metrics("test_metric", 1.0)

        ***REMOVED*** Should log debug message (prometheus not available)
        assert any(
...
***REMOVED*** =============================================================================
***REMOVED*** Schedule Event Handlers Tests
***REMOVED*** =============================================================================
...
class TestScheduleEventHandlers:
    ...
    async def test_on_schedule_created(self, caplog):
        ...
        ***REMOVED*** Verify logging occurred
        assert any(
...
***REMOVED*** =============================================================================
***REMOVED*** Assignment Event Handlers Tests
***REMOVED*** =============================================================================
...
class TestAssignmentEventHandlers:
    ...
    async def test_on_assignment_updated_without_reason(self, caplog):
        ...
        ***REMOVED*** Verify logging occurred but no reason logged
        assert any(
            "Assignment updated: assign-123" in record.message
            for record in caplog.records
        )
...
***REMOVED*** =============================================================================
***REMOVED*** Swap Event Handlers Tests
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Absence Event Handlers Tests
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** ACGME Compliance Event Handlers Tests
***REMOVED*** =============================================================================
...
class TestACGMEEventHandlers:
    ...
    async def test_on_acgme_violation_detected(self, caplog):
        ...
        ***REMOVED*** Verify warning log occurred
        assert any(
...
***REMOVED*** =============================================================================
***REMOVED*** Handler Registration Tests
***REMOVED*** =============================================================================
...
class TestHandlerRegistration:
    ...
    def test_register_schedule_handlers(self, db, caplog):
        ...
        ***REMOVED*** Verify handlers were registered
        assert any(
        ...
        ***REMOVED*** Verify event bus has subscribers
