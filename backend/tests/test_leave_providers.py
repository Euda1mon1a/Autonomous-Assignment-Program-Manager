...
class TestLeaveRecord:
    ...
    def test_create_record(self):
        ...
        assert record.is_blocking is True  ***REMOVED*** Default
...
class TestDatabaseLeaveProvider:
    ...
    def test_init(self, db):
        ...
        assert provider.cache_ttl == 300  ***REMOVED*** Default
    ...
    def test_get_conflicts_blocking_only(self, db, sample_faculty):
        ...
        ***REMOVED*** Non-blocking should not appear in conflicts
    ...
    def test_get_conflicts_date_range(self, db, sample_faculty):
        ...
        ***REMOVED*** Create absence in next month
        absence = Absence(
            id=uuid4(),
            person_id=sample_faculty.id,
        ...
        ***REMOVED*** Query for this week only
        conflicts = provider.get_conflicts(
            start_date=date.today(),
            end_date=date.today() + timedelta(days=7),
        )

        ***REMOVED*** Absence should not appear
    ...
    def test_sync_clears_cache(self, db):
        ...
        assert count == 0  ***REMOVED*** No records in empty db
