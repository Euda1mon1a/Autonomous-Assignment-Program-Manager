...
***REMOVED*** ============================================================================
***REMOVED*** List Procedures Endpoint
***REMOVED*** ============================================================================
...
class TestListProceduresEndpoint:
    ...
    def test_list_procedures_with_data(self, client: TestClient, sample_procedures):
        ...
        assert response.status_code == 200
        data = response.json()
        assert data["total"] == 6  ***REMOVED*** All procedures including inactive
    ...
    def test_list_procedures_filter_by_specialty(
        ...
        assert response.status_code == 200
        data = response.json()
        assert data["total"] == 2  ***REMOVED*** Colposcopy and Labor and Delivery
    ...
    def test_list_procedures_filter_by_category(
        ...
        assert response.status_code == 200
        data = response.json()
        assert data["total"] == 3  ***REMOVED*** Botox, Colposcopy, Deprecated
    ...
    def test_list_procedures_filter_by_complexity_level(
        ...
        response = client.get(
            "/api/v1/procedures", params={"complexity_level": "basic"}
        )

        assert response.status_code == 200
        data = response.json()
        assert data["total"] == 3  ***REMOVED*** Botox, Sports Medicine, Deprecated
    ...
    def test_list_procedures_combined_filters(
        ...
        assert response.status_code == 200
        data = response.json()
        ***REMOVED*** Should get Botox and Colposcopy (not deprecated)
        assert data["total"] == 2
    ...
    def test_list_procedures_no_matches(self, client: TestClient, sample_procedures):
        ...
        response = client.get(
            "/api/v1/procedures", params={"specialty": "NonExistentSpecialty"}
        )
...
***REMOVED*** ============================================================================
***REMOVED*** Get Specialties and Categories Endpoints
***REMOVED*** ============================================================================
...
class TestGetSpecialtiesEndpoint:
    ...
    def test_get_specialties_with_data(self, client: TestClient, sample_procedures):
        ...
        ***REMOVED*** Should include all unique specialties
...
class TestGetCategoriesEndpoint:
    ...
    def test_get_categories_with_data(self, client: TestClient, sample_procedures):
        ...
        ***REMOVED*** Should include all unique categories
        expected_categories = {
            "office",
            "surgical",
            "obstetric",
...
***REMOVED*** ============================================================================
***REMOVED*** Get Procedure Endpoints
***REMOVED*** ============================================================================
...
class TestGetProcedureByNameEndpoint:
    ...
    def test_get_procedure_by_name_case_sensitive(
        ...
        ***REMOVED*** Exact match should work
        response = client.get(f"/api/v1/procedures/by-name/{sample_procedure.name}")
        assert response.status_code == 200

        ***REMOVED*** Different case might not work (depends on implementation)
        response = client.get(
            f"/api/v1/procedures/by-name/{sample_procedure.name.lower()}"
        )
        ***REMOVED*** Could be 200 or 404 depending on case sensitivity
...
***REMOVED*** ============================================================================
***REMOVED*** Create Procedure Endpoint
***REMOVED*** ============================================================================
...
class TestCreateProcedureEndpoint:
    ...
    def test_create_procedure_minimal_fields(
        ...
        procedure_data = {
            ...
            ***REMOVED*** Other fields should use defaults
        }
    ...
    def test_create_procedure_duplicate_name(
        ...
        procedure_data = {
            "name": sample_procedure.name,  ***REMOVED*** Duplicate
            "category": "office",
        }
    ...
    def test_create_procedure_invalid_pgy_level(
        ...
        procedure_data = {
            ...
            "min_pgy_level": 5,  ***REMOVED*** Invalid: must be 1-3
        }
    ...
    def test_create_procedure_invalid_supervision_ratio(
        ...
        procedure_data = {
            ...
            "supervision_ratio": 0,  ***REMOVED*** Invalid: must be at least 1
        }
...
***REMOVED*** ============================================================================
***REMOVED*** Update Procedure Endpoint
***REMOVED*** ============================================================================
...
class TestUpdateProcedureEndpoint:
    ...
    def test_update_procedure_success(
        ...
        ***REMOVED*** Name should remain unchanged
        assert data["name"] == sample_procedure.name
    ...
    def test_update_procedure_not_found(self, client: TestClient, auth_headers: dict):
    ...
    def test_update_procedure_partial_update(
        ...
        ***REMOVED*** Other fields should remain unchanged
        assert data["name"] == sample_procedure.name
        assert data["category"] == sample_procedure.category
        assert data["specialty"] == sample_procedure.specialty
    ...
    def test_update_procedure_invalid_complexity(
        ...
        update_data = {
            "complexity_level": "super_complex",  ***REMOVED*** Invalid
        }
...
***REMOVED*** ============================================================================
***REMOVED*** Delete Procedure Endpoint
***REMOVED*** ============================================================================
...
class TestDeleteProcedureEndpoint:
    ...
    def test_delete_procedure_success(
        ...
        ***REMOVED*** Create a procedure to delete
        procedure = Procedure(
            id=uuid4(),
    ...
    def test_delete_procedure_not_found(self, client: TestClient, auth_headers: dict):
...
***REMOVED*** ============================================================================
***REMOVED*** Activate/Deactivate Procedure Endpoints
***REMOVED*** ============================================================================
...
class TestActivateProcedureEndpoint:
    ...
    def test_activate_procedure_requires_auth(self, client: TestClient, db: Session):
    ...
    def test_activate_procedure_not_found(self, client: TestClient, auth_headers: dict):
...
***REMOVED*** ============================================================================
***REMOVED*** Edge Cases and Validation
***REMOVED*** ============================================================================
...
class TestProcedureEdgeCases:
    ...
    def test_create_procedure_very_long_name(
        ...
        long_name = "A" * 300  ***REMOVED*** Very long name
        ...
        ***REMOVED*** Might succeed or fail depending on column size
    ...
    def test_update_procedure_to_duplicate_name(
        ...
        update_data = {
            "name": sample_procedures[1].name,  ***REMOVED*** Try to use another's name
        }
        ...
        ***REMOVED*** Should fail due to unique constraint
        assert response.status_code in [400, 422]
    ...
    def test_filter_procedures_with_null_values(
        ...
        ***REMOVED*** Create procedure with minimal fields
        procedure = Procedure(
            id=uuid4(),
        ...
        ***REMOVED*** Should still be able to list all procedures
        response = client.get("/api/v1/procedures")
        assert response.status_code == 200
        data = response.json()
        assert data["total"] >= 1
