...
class TestAsyncRepositoryPagination:
    ...
    async def test_pagination_params_limits(self):
        ...
        assert params.limit == 1000  ***REMOVED*** Capped at 1000
...
***REMOVED*** ============= Transaction Management Tests =============
