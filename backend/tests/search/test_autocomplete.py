...
class TestAutocompleteSuggestion:
    ...
    def test_suggestion_default_values(self):
        ...
        ***REMOVED*** Assert
        assert suggestion.score == 1.0  ***REMOVED*** Default
        assert suggestion.metadata == {}  ***REMOVED*** Default
        assert suggestion.matched_field is None  ***REMOVED*** Default
    ...
    def test_suggestion_to_dict(self):
        ...
        ***REMOVED*** Assert
        ...
        assert result["score"] == 0.877  ***REMOVED*** Rounded to 3 decimals
...
class TestAutocompleteAnalytics:
    ...
    def test_analytics_to_dict(self):
        ...
        ***REMOVED*** Assert
        ...
        assert result["response_time_ms"] == 25.12  ***REMOVED*** Rounded to 2 decimals
...
class TestAutocompleteSuggestionComparison:
    ...
    def test_suggestions_can_be_sorted_by_score(self):
        ...
        ***REMOVED*** Assert
        assert sorted_suggestions[0].text == "B"  ***REMOVED*** Highest score
        assert sorted_suggestions[1].text == "C"
        assert sorted_suggestions[2].text == "A"  ***REMOVED*** Lowest score
