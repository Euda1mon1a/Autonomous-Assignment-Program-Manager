...
***REMOVED*** Path to the CLI module
...
def sample_fmit_excel(tmp_path):
    ...
    ***REMOVED*** Header row with dates (weekly schedule)
    ws["A1"] = "Provider"
    ws["B1"] = date(2025, 3, 3)   ***REMOVED*** Week 1
    ws["C1"] = date(2025, 3, 10)  ***REMOVED*** Week 2
    ws["D1"] = date(2025, 3, 17)  ***REMOVED*** Week 3
    ws["E1"] = date(2025, 3, 24)  ***REMOVED*** Week 4
    ws["F1"] = date(2025, 3, 31)  ***REMOVED*** Week 5

    ***REMOVED*** Provider data - Dr. Smith has weeks 1, 3, 5 (alternating)
    ws["A2"] = "Dr. Smith"
    ws["B2"] = "FMIT"
    ws["C2"] = ""
    ws["D2"] = "FMIT"
    ...
    ***REMOVED*** Dr. Jones has weeks 2, 4
    ws["A3"] = "Dr. Jones"
    ws["B3"] = ""
    ws["C3"] = "FMIT"
    ws["D3"] = ""
    ...
    ***REMOVED*** Dr. Lee has only week 3
    ws["A4"] = "Dr. Lee"
    ws["B4"] = ""
    ws["C4"] = ""
    ws["D4"] = ""
...
***REMOVED*** ============================================================================
***REMOVED*** Help and Argument Parsing Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** File Error Handling Tests
***REMOVED*** ============================================================================
...
class TestFileErrorHandling:
    ...
    def test_invalid_file_format(self, invalid_excel):
        ...
        ***REMOVED*** The tool handles invalid formats gracefully (returns 0) with empty results
        assert result.returncode == 0
    ...
    def test_faculty_not_found(self, sample_fmit_excel):
        ...
        ***REMOVED*** Should suggest available faculty
        assert "Available faculty" in result.stderr or "Dr. Smith" in result.stderr


***REMOVED*** ============================================================================
***REMOVED*** Successful Execution Tests
***REMOVED*** ============================================================================
...
class TestSuccessfulExecution:
    ...
    def test_alternating_patterns_mode(self, sample_fmit_excel):
        ...
        ***REMOVED*** The output should show either found patterns or indicate none were found
    ...
    def test_custom_threshold(self, sample_fmit_excel):
        ...
        assert result.returncode == 0
        ***REMOVED*** Should find faculty with 2+ alternating cycles
    ...
    def test_external_conflicts_file(self, sample_fmit_excel, conflicts_json):
        ...
        assert result.returncode == 0
        ***REMOVED*** Dr. Jones should have conflict flagged
        if "Dr. Jones" in result.stdout:
            ***REMOVED*** Check for conflict indicator in the output
            assert "⚠" in result.stdout or "External conflict" in result.stdout


***REMOVED*** ============================================================================
***REMOVED*** Short Option Tests
***REMOVED*** ============================================================================
...
class TestOutputFormat:
    ...
    def test_swap_candidates_format(self, sample_fmit_excel):
        ...
        assert result.returncode == 0
        ***REMOVED*** Should show viable vs total counts
        assert "candidates:" in result.stdout.lower()
        ***REMOVED*** Should show status indicators (✓ or ✗)
    ...
    def test_alternating_pattern_suggestions(self, sample_fmit_excel):
        ...
        assert result.returncode == 0
        ***REMOVED*** Should show FMIT weeks for faculty with alternating patterns
