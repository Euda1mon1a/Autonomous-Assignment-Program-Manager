...
***REMOVED*** ============================================================================
***REMOVED*** Authorization Tests (Role-Based Access Control)
***REMOVED*** ============================================================================
...
class TestAssignmentRoleBasedAccessControl:
    ...
    def test_coordinator_can_delete_assignment(
        ...
        ***REMOVED*** Create an assignment to delete
        assignment = Assignment(
            id=uuid4(),
...
class TestAssignmentFiltering:
    ...
    def test_filter_by_date_range(
        ...
        ***REMOVED*** Create assignments on specific dates
        today = date.today()

        ***REMOVED*** Assignment today
    ...
    def test_filter_by_person_id(
        ...
        ***REMOVED*** Filter by specific resident
    ...
    def test_filter_by_activity_type_clinic(
        ...
        ***REMOVED*** Create assignments with different activity types
        ...
        ***REMOVED*** Filter by clinic activity type
        response = client.get(
            "/api/assignments",
            headers={"Authorization": f"Bearer {admin_token}"},
        ...
        data = response.json()
        assert len(data["items"]) >= 1
        ***REMOVED*** Note: Response includes rotation_template nested object
        for item in data["items"]:
    ...
    def test_filter_by_activity_type_on_call(
        ...
        ***REMOVED*** Create on-call assignment
        assignment = Assignment(
            id=uuid4(),
            block_id=test_blocks[2].id,
            person_id=test_resident.id,
        ...
        ***REMOVED*** Filter by on_call activity type
        response = client.get(
            "/api/assignments",
            headers={"Authorization": f"Bearer {admin_token}"},
    ...
    def test_filter_by_activity_type_inpatient(
        ...
        ***REMOVED*** Create inpatient assignment
        assignment = Assignment(
            id=uuid4(),
        ...
        ***REMOVED*** Filter by inpatient activity type
        response = client.get(
            "/api/assignments",
            headers={"Authorization": f"Bearer {admin_token}"},
    ...
    def test_filter_combined_date_and_person(
        ...
        ***REMOVED*** Filter by date range and person
        response = client.get(
            "/api/assignments",
            headers={"Authorization": f"Bearer {admin_token}"},
            params={
    ...
    def test_filter_combined_activity_type_and_role(
        ...
        ***REMOVED*** Create on-call primary assignment
        assignment = Assignment(
            id=uuid4(),
            block_id=test_blocks[4].id,
            person_id=test_resident.id,
        ...
        ***REMOVED*** Filter by activity type and role
        response = client.get(
            "/api/assignments",
            headers={"Authorization": f"Bearer {admin_token}"},
            params={
...
***REMOVED*** ============================================================================
***REMOVED*** Optimistic Locking Tests
***REMOVED*** ============================================================================
...
class TestOptimisticLocking:
    ...
    def test_update_with_stale_timestamp_fails(
        ...
        ***REMOVED*** Create a fresh assignment
        assignment = Assignment(
            id=uuid4(),
        ...
        ***REMOVED*** Second update with stale timestamp
        response2 = client.put(
            f"/api/assignments/{assignment.id}",
            headers={"Authorization": f"Bearer {admin_token}"},
            json={
                "role": "supervising",
                "updated_at": original_updated_at.isoformat(),  ***REMOVED*** Stale
            },
        )
    ...
    def test_concurrent_updates_detection(
        ...
        ***REMOVED*** Coordinator tries to update with stale timestamp
        response2 = client.put(
            f"/api/assignments/{assignment.id}",
            headers={"Authorization": f"Bearer {coordinator_token}"},
            json={
...
***REMOVED*** ============================================================================
***REMOVED*** ACGME Validation Tests
***REMOVED*** ============================================================================
...
class TestACGMEValidation:
    ...
    def test_create_assignment_with_override_reason(
        ...
        assert response.status_code == 201
        data = response.json()
        ***REMOVED*** If override reason is provided, check for acknowledgment
        if data.get("acgme_warnings"):
            ***REMOVED*** The notes or warnings might include override info
...
class TestBulkDelete:
    ...
    def test_bulk_delete_success(
        ...
        ***REMOVED*** Create assignments for specific date range
        start_date = date.today() + timedelta(days=14)
        end_date = start_date + timedelta(days=7)

        ***REMOVED*** Create blocks for this range
        blocks_to_delete = []
        for i in range(7):
            current_date = start_date + timedelta(days=i)
            block = Block(
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_create_assignment_missing_required_fields(
        ...
        response = client.post(
            ...
            json={
                "role": "primary",
                ***REMOVED*** Missing block_id, person_id, rotation_template_id
            },
        )
        assert response.status_code == 422  ***REMOVED*** Validation error
    ...
    def test_create_assignment_duplicate_on_same_block(
        ...
        ***REMOVED*** Create first assignment
        ...
        ***REMOVED*** Should fail with conflict or validation error
