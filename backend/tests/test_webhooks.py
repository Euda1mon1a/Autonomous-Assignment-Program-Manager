...
***REMOVED*** Async test database setup
...
***REMOVED*** ============================================================================
***REMOVED*** Signature Generation Tests
***REMOVED*** ============================================================================
...
class TestWebhookSignatureGenerator:
    ...
    def test_verify_signature_valid(self):
        ...
        ***REMOVED*** Verify with correct signature and timestamp
    ...
    def test_verify_signature_invalid(self):
        ...
        ***REMOVED*** Verify with wrong secret
...
class TestWebhookService:
    ...
    async def test_trigger_event(self, async_db):
        ...
        ***REMOVED*** Verify delivery was created
    ...
    async def test_trigger_event_no_subscribers(self, async_db):
        ...
        ***REMOVED*** Trigger event without any webhooks
        count = await service.trigger_event(
            db=async_db,
            event_type=WebhookEventType.SCHEDULE_CREATED.value,
            payload={"schedule_id": "123"}
...
***REMOVED*** ============================================================================
***REMOVED*** Webhook Delivery Tests
***REMOVED*** ============================================================================
...
class TestWebhookDeliveryManager:
    ...
    async def test_calculate_retry_delay_with_cap(self):
        ...
        assert manager._calculate_retry_delay(10) == 300  ***REMOVED*** Capped

    @pytest.mark.asyncio
    @patch('httpx.AsyncClient.post')
    async def test_successful_delivery(self, mock_post, async_db):
        """Test successful webhook delivery."""
        ***REMOVED*** Create webhook and delivery
        webhook = Webhook(
            id=uuid4(),
            url="https://example.com/webhook",
            name="Test Webhook",
        ...
        ***REMOVED*** Mock successful HTTP response
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.text = "OK"
        mock_post.return_value = mock_response

        ***REMOVED*** Deliver webhook
        manager = WebhookDeliveryManager()
    ...
    async def test_failed_delivery_with_retry(self, mock_post, async_db):
        ...
        ***REMOVED*** Mock failed HTTP response
        mock_response = MagicMock()
    ...
    async def test_max_retries_creates_dead_letter(self, mock_post, async_db):
        ...
        ***REMOVED*** Create webhook and delivery
        ...
        delivery = WebhookDelivery(
            ...
            status=WebhookDeliveryStatus.PENDING.value,
            max_attempts=2,
            attempt_count=2  ***REMOVED*** Already at max attempts
        )
        async_db.add(delivery)
        await async_db.commit()
        await async_db.refresh(delivery)
        ...
        ***REMOVED*** Verify dead letter was created
        service = WebhookService()
...
class TestWebhookIntegration:
    ...
    async def test_complete_webhook_flow(self, mock_post, async_db):
        ...
        ***REMOVED*** 3. Mock successful delivery
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.text = "OK"
        mock_post.return_value = mock_response

        ***REMOVED*** 4. Get delivery and process it
        ...
        ***REMOVED*** 5. Verify delivery status
