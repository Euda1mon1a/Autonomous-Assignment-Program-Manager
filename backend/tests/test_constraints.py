...
from app.scheduling.constraints import (  ***REMOVED*** Hard constraints; Soft constraints
...
def sample_context():
    ...
    ***REMOVED*** Create blocks for a week
    ...
    ***REMOVED*** Set all residents as available
    for r in residents:
...
***REMOVED*** ============================================================================
***REMOVED*** Availability Constraint Tests
***REMOVED*** ============================================================================
...
class TestAvailabilityConstraint:
    ...
    def test_validate_unavailable_assignment(self, sample_context):
        ...
        ***REMOVED*** Mark resident as unavailable for first block
        ...
        ***REMOVED*** Create invalid assignment
...
***REMOVED*** ============================================================================
***REMOVED*** One Person Per Block Constraint Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** 80-Hour Rule Constraint Tests
***REMOVED*** ============================================================================
...
class TestEightyHourRuleConstraint:
    ...
    def test_validate_under_limit(self, sample_context):
        ...
        ***REMOVED*** Create a few assignments (well under 80 hours/week)
        assignments = [
            MockAssignment(
                person_id=sample_context.residents[0].id,
                block_id=sample_context.blocks[i].id,
            )
            for i in range(4)  ***REMOVED*** 4 blocks = 24 hours
        ]
...
***REMOVED*** ============================================================================
***REMOVED*** 1-in-7 Rule Constraint Tests
***REMOVED*** ============================================================================
...
class TestOneInSevenRuleConstraint:
    ...
    def test_validate_with_day_off(self, sample_context):
        ...
        ***REMOVED*** Create assignments for 5 days
        resident = sample_context.residents[0]
        workday_blocks = [b for b in sample_context.blocks if not b.is_weekend]

        ***REMOVED*** Assign to first 5 workdays only
        assignments = [
            MockAssignment(
        ...
        ***REMOVED*** With only 5 days of assignments in a week, should pass
        assert result.satisfied is True


***REMOVED*** ============================================================================
***REMOVED*** Supervision Ratio Constraint Tests
***REMOVED*** ============================================================================
...
class TestSupervisionRatioConstraint:
    ...
    def test_calculate_required_faculty_fractional_load(self):
        ...
        ***REMOVED*** 1 PGY-1 + 1 PGY-2: 0.5 + 0.25 = 0.75 → ceil = 1 (not 2)
        assert constraint.calculate_required_faculty(1, 1) == 1

        ***REMOVED*** 1 PGY-1 + 2 PGY-2: 0.5 + 0.5 = 1.0 → ceil = 1 (not 2)
        assert constraint.calculate_required_faculty(1, 2) == 1

        ***REMOVED*** 1 PGY-1 + 3 PGY-2: 0.5 + 0.75 = 1.25 → ceil = 2
        assert constraint.calculate_required_faculty(1, 3) == 2

        ***REMOVED*** 2 PGY-1 + 2 PGY-2: 1.0 + 0.5 = 1.5 → ceil = 2
        assert constraint.calculate_required_faculty(2, 2) == 2

        ***REMOVED*** 3 PGY-1 + 2 PGY-2 + 2 PGY-3: 1.5 + 0.5 + 0.5 = 2.5 → ceil = 3
        ***REMOVED*** (This is the example from the docs)
    ...
    def test_validate_adequate_supervision(self, sample_context):
        ...
        block = sample_context.blocks[0]
        assignments = [
            ***REMOVED*** 1 PGY-1 resident
            MockAssignment(
                person_id=sample_context.residents[0].id,  ***REMOVED*** PGY-1
                block_id=block.id,
                role="primary",
            ),
            ***REMOVED*** 1 faculty
...
***REMOVED*** ============================================================================
***REMOVED*** Equity Constraint Tests
***REMOVED*** ============================================================================
...
class TestEquityConstraint:
    ...
    def test_validate_balanced_workload(self, sample_context):
        ...
        ***REMOVED*** Assign equally to all residents
        assignments = []
        ...
        ***REMOVED*** Soft constraint - always "satisfied" but may have penalty
        assert result.satisfied is True
    ...
    def test_validate_imbalanced_workload(self, sample_context):
        ...
        ***REMOVED*** Assign all blocks to one resident
        resident = sample_context.residents[0]
        assignments = [
        ...
        ***REMOVED*** Should have higher penalty for imbalance
        assert result.penalty > 0


***REMOVED*** ============================================================================
***REMOVED*** Coverage Constraint Tests
***REMOVED*** ============================================================================
...
class TestCoverageConstraint:
    ...
    def test_validate_full_coverage(self, sample_context):
        ...
        assert result.satisfied is True
        assert result.penalty == 0  ***REMOVED*** Full coverage = no penalty

    def test_validate_partial_coverage(self, sample_context):
        """Test validation with partial coverage."""
        constraint = CoverageConstraint()

        ***REMOVED*** Only assign to first 2 blocks
        assignments = [
            MockAssignment(
                person_id=sample_context.residents[0].id,
                block_id=sample_context.blocks[0].id,
        ...
        ***REMOVED*** Partial coverage = some penalty
        assert result.penalty > 0


***REMOVED*** ============================================================================
***REMOVED*** ConstraintManager Tests
***REMOVED*** ============================================================================
...
class TestConstraintManager:
    ...
    def test_create_default_manager(self):
        ...
        ***REMOVED*** Should have hard and soft constraints
    ...
    def test_create_minimal_manager(self):
        ...
        ***REMOVED*** Should have fewer constraints
    ...
    def test_get_enabled_constraints(self):
        ...
        ***REMOVED*** All constraints should be enabled by default
    ...
    def test_validate_all_constraints(self, sample_context):
        ...
        ***REMOVED*** Create some valid assignments
        assignments = [
            MockAssignment(
                person_id=sample_context.residents[0].id,
                block_id=sample_context.blocks[0].id,
...
***REMOVED*** ============================================================================
***REMOVED*** Priority and Type Tests
***REMOVED*** ============================================================================
...
class TestConstraintIntegration:
    ...
    def test_full_validation_workflow(self, sample_context):
        ...
        ***REMOVED*** Create a realistic set of assignments
        assignments = []
        workday_blocks = [b for b in sample_context.blocks if not b.is_weekend]

        for i, block in enumerate(workday_blocks):
            ***REMOVED*** Rotate through residents
            ...
            ***REMOVED*** Add faculty supervision
        ...
        assert isinstance(result, ConstraintResult)
        ***REMOVED*** The result should indicate validation status
        assert result.satisfied is not None


***REMOVED*** ============================================================================
***REMOVED*** Max Physicians In Clinic Constraint Tests
***REMOVED*** ============================================================================
...
class TestMaxPhysiciansInClinicConstraint:
    ...
    def clinic_context(self):
        ...
        ***REMOVED*** Create blocks for one day
        start_date = date(2024, 1, 8)  ***REMOVED*** A Monday
        blocks = [
            MockBlock(block_date=start_date, time_of_day="AM"),
            MockBlock(block_date=start_date, time_of_day="PM"),
        ]

        ***REMOVED*** Create clinic template
    ...
    def test_validate_under_limit(self, clinic_context):
        ...
        ***REMOVED*** Assign 5 people to clinic (under limit of 6)
    ...
    def test_validate_at_limit(self, clinic_context):
        ...
        ***REMOVED*** Assign exactly 6 people to clinic
        block = context.blocks[0]
        assignments = [
            MockAssignment(
                person_id=context.residents[i].id,
    ...
    def test_validate_over_limit(self, clinic_context):
        ...
        ***REMOVED*** Assign 7 people to clinic (over limit of 6)
        block = context.blocks[0]
        assignments = [
            MockAssignment(
                person_id=context.residents[i].id,
    ...
    def test_validate_counts_faculty_and_residents(self, clinic_context):
        ...
        block = context.blocks[0]
        ***REMOVED*** 4 residents + 3 faculty = 7 (over limit)
        assignments = [
            MockAssignment(
                person_id=context.residents[i].id,
                block_id=block.id,
    ...
    def test_validate_per_block_independence(self, clinic_context):
        ...
        ***REMOVED*** AM block: 5 people (under limit)
        ***REMOVED*** PM block: 7 people (over limit)
        ...
        assert result.satisfied is False
        assert len(result.violations) == 1  ***REMOVED*** Only PM block violates
    ...
    def test_validate_ignores_non_clinic_templates(self, clinic_context):
        ...
        ***REMOVED*** Add a non-clinic template
        ...
        block = context.blocks[0]
        ***REMOVED*** 5 in clinic + 3 in research = 8 total, but only 5 in clinic
        assignments = [
            MockAssignment(
                person_id=context.residents[i].id,
                block_id=block.id,
...
***REMOVED*** ============================================================================
***REMOVED*** Wednesday AM Intern Only Constraint Tests
***REMOVED*** ============================================================================
...
class TestWednesdayAMInternOnlyConstraint:
    ...
    def wednesday_context(self):
        ...
        ***REMOVED*** Create residents with different PGY levels
        residents = [
        ...
        ***REMOVED*** Create blocks including Wednesday
        ***REMOVED*** date(2024, 1, 3) is a Wednesday
        ...
        blocks = [
            ...
            MockBlock(block_date=wednesday, time_of_day="AM"),  ***REMOVED*** Target block
    ...
    def test_validate_intern_on_wednesday_am(self, wednesday_context):
        ...
        ***REMOVED*** Find Wednesday AM block
        wed_am_block = [
    ...
    def test_validate_pgy2_on_wednesday_am_fails(self, wednesday_context):
        ...
        ***REMOVED*** Assign PGY-2 to Wednesday AM clinic
    ...
    def test_validate_pgy3_on_wednesday_am_fails(self, wednesday_context):
        ...
        ***REMOVED*** Assign PGY-3 to Wednesday AM clinic
    ...
    def test_validate_pgy2_on_wednesday_pm_passes(self, wednesday_context):
        ...
        ***REMOVED*** Find Wednesday PM block
        wed_pm_block = [
            b for b in context.blocks if b.date.weekday() == 2 and b.time_of_day == "PM"
        ][0]

        ***REMOVED*** Assign PGY-2 to Wednesday PM clinic (should be allowed)
        pgy2 = [r for r in context.residents if r.pgy_level == 2][0]
        assignments = [
            MockAssignment(
                person_id=pgy2.id,
    ...
    def test_validate_pgy2_on_monday_am_passes(self, wednesday_context):
        ...
        ***REMOVED*** Find Monday AM block
        mon_am_block = [
            b for b in context.blocks if b.date.weekday() == 0 and b.time_of_day == "AM"
        ][0]

        ***REMOVED*** Assign PGY-2 to Monday AM clinic (should be allowed)
        pgy2 = [r for r in context.residents if r.pgy_level == 2][0]
        assignments = [
            MockAssignment(
                person_id=pgy2.id,
    ...
    def test_validate_faculty_on_wednesday_am_passes(self, wednesday_context):
        ...
        ***REMOVED*** Assign faculty to Wednesday AM clinic
    ...
    def test_validate_ignores_non_clinic_templates(self, wednesday_context):
        ...
        ***REMOVED*** Assign PGY-2 to Wednesday AM research (not clinic - should be allowed)
        pgy2 = [r for r in context.residents if r.pgy_level == 2][0]
        assignments = [
            MockAssignment(
                person_id=pgy2.id,
    ...
    def test_validate_multiple_violations(self, wednesday_context):
        ...
        ***REMOVED*** Assign both PGY-2 and PGY-3 to Wednesday AM clinic
        pgy2 = [r for r in context.residents if r.pgy_level == 2][0]
        pgy3 = [r for r in context.residents if r.pgy_level == 3][0]
