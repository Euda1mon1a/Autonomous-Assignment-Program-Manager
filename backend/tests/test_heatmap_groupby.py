...
class TestHeatmapGroupBy:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Valid group_by Values Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Case Insensitivity Tests
    ***REMOVED*** ========================================================================
    ...
    def test_heatmap_group_by_daily_uppercase(
        ...
        assert response.status_code == 200
        ***REMOVED*** Verify it was normalized to lowercase
        call_kwargs = mock_service.generate_unified_heatmap.call_args[1]
        assert call_kwargs["group_by"] == "daily"
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Invalid group_by Values Tests
    ***REMOVED*** ========================================================================
