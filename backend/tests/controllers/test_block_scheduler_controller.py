...
class TestBlockSchedulerController:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_schedule_block_dry_run(self, db, setup_data):
        ...
        ***REMOVED*** Dry run should not save to database
        saved = (
        ...
        ***REMOVED*** May or may not have saved depending on implementation
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Create Assignment Tests
    ***REMOVED*** ========================================================================
    ...
    def test_create_assignment_duplicate_fails(self, db, setup_data):
        ...
        ***REMOVED*** Try to create duplicate
        assignment_data = BlockAssignmentCreate(
            block_number=6,  ***REMOVED*** Same block
            academic_year=2025,  ***REMOVED*** Same year
            resident_id=setup_data["residents"][0].id,  ***REMOVED*** Same resident
        ...
        assert exc_info.value.status_code == 409  ***REMOVED*** Conflict

    ***REMOVED*** ========================================================================
    ***REMOVED*** Update Assignment Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Delete Assignment Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_schedule_then_modify_workflow(self, db, setup_data):
        ...
        ***REMOVED*** Create a manual assignment
        assignment_data = BlockAssignmentCreate(
            block_number=10,
            academic_year=2025,
            resident_id=setup_data["residents"][0].id,
    ...
    def test_multiple_residents_same_block(self, db, setup_data):
        ...
        ***REMOVED*** Create assignments for multiple residents in same block
        ...
        ***REMOVED*** Check dashboard shows all assignments
    ...
    def test_leave_eligible_rotation_assignment(self, db, setup_data):
        ...
        ***REMOVED*** Find leave-eligible template
        leave_template = next(t for t in setup_data["templates"] if t.leave_eligible)

        ***REMOVED*** Create assignment with leave
        assignment_data = BlockAssignmentCreate(
            block_number=12,
            academic_year=2025,
            resident_id=setup_data["residents"][0].id,
        ...
        ***REMOVED*** Update to indicate leave
        update_data = BlockAssignmentUpdate(
            has_leave=True,
            leave_days=7,
        )
    ...
    def test_different_academic_years(self, db, setup_data):
        ...
        ***REMOVED*** Create assignments for different years
        ...
        ***REMOVED*** Check dashboards for each year
        for year in [2024, 2025, 2026]:
