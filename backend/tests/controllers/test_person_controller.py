...
class TestPersonController:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_create_person_duplicate_email(self, db):
        ...
        ***REMOVED*** Create existing person
        existing = Person(
            id=uuid4(),
            name="Dr. Existing",
            type="resident",
        ...
        person_data = PersonCreate(
            name="Dr. New Person",
            type="resident",
            email="duplicate@hospital.org",  ***REMOVED*** Same email
            pgy_level=2,
        )
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_update_person_success(self, db):
        ...
        assert result.type == "resident"  ***REMOVED*** Unchanged
