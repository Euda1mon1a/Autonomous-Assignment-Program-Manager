...
class TestBlockController:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_blocks_with_date_filter(self, db):
        ...
        ***REMOVED*** Should return blocks for Jan 1-3 (3 days, AM and PM = 6 blocks potentially)
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_generate_blocks_week(self, db):
        ...
        ***REMOVED*** 7 days * 2 blocks per day = 14 blocks
    ...
    def test_generate_blocks_custom_block_number(self, db):
        ...
        assert result.total == 2
        ***REMOVED*** All generated blocks should have block_number 5
    ...
    def test_generate_blocks_identifies_weekends(self, db):
        ...
        ***REMOVED*** Generate blocks including a weekend
        ***REMOVED*** June 7, 2025 is a Saturday
        start = date(2025, 6, 6)  ***REMOVED*** Friday
        end = date(2025, 6, 8)    ***REMOVED*** Sunday
        ...
        ***REMOVED*** Should have some weekend blocks (Sat, Sun = 4 blocks)
        assert len(weekend_blocks) == 4
        ***REMOVED*** And some weekday blocks (Fri = 2 blocks)
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_generate_and_list_blocks(self, db):
        ...
        ***REMOVED*** Generate blocks for 3 days
        ...
        assert gen_result.total == 6  ***REMOVED*** 3 days * 2 blocks

        ***REMOVED*** List blocks for that date range
