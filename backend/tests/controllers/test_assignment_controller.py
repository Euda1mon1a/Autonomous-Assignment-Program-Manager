...
class TestAssignmentController:
    ...
    def setup_data(self, db):
        ...
        ***REMOVED*** Create a user for auth
        user = User(
            id=uuid4(),
            username="testuser",
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_assignments_with_person_filter(self, db, setup_data):
        ...
        ***REMOVED*** Create another resident with assignments
        ...
        ***REMOVED*** Should include the original resident's assignments
        assert all(
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_create_assignment_with_notes(self, db, setup_data):
        ...
        ***REMOVED*** Create a new block to avoid conflicts
        block = Block(
            id=uuid4(),
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_update_assignment_success(self, db, setup_data):
        ...
        ***REMOVED*** Create another block for update
        new_block = Block(
            id=uuid4(),
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_create_get_update_delete_workflow(self, db, setup_data):
        ...
        ***REMOVED*** Create new block for this workflow
        block = Block(
            id=uuid4(),
