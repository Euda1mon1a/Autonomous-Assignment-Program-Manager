...
class TestProcedureController:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_procedures_filter_active_only(self, db, setup_data):
        ...
        ***REMOVED*** Create inactive procedure
        inactive = Procedure(
            id=uuid4(),
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Create Procedure Tests
    ***REMOVED*** ========================================================================
    ...
    def test_create_procedure_minimal_data(self, db):
        ...
        assert result.is_active is True  ***REMOVED*** Default
    ...
    def test_create_procedure_duplicate_name(self, db, setup_data):
        ...
        procedure_data = ProcedureCreate(
            name="Mastectomy",  ***REMOVED*** Already exists
            category="surgical",
        )
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Update Procedure Tests
    ***REMOVED*** ========================================================================
    ...
    def test_update_procedure_change_complexity(self, db, setup_data):
        ...
        procedure = setup_data["procedures"][2]  ***REMOVED*** Botox - basic
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Delete Procedure Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Get Specialties/Categories Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_specialties_and_categories_update(self, db, setup_data):
        ...
        ***REMOVED*** Get initial specialties
        initial_specialties = controller.get_specialties()

        ***REMOVED*** Add new procedure with new specialty
        ...
        ***REMOVED*** Check specialties now include new one
