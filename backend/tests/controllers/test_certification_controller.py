...
class TestCertificationController:
    ...
    def setup_data(self, db):
        ...
        ***REMOVED*** Create residents and faculty
        resident = Person(
            id=uuid4(),
            name="Dr. Resident",
            type="resident",
        ...
        ***REMOVED*** Create certification types
        ...
        pals = CertificationType(
            ...
            renewal_period_months=24,
            required_for_residents=True,
            required_for_faculty=False,  ***REMOVED*** Not required for faculty
            is_active=True,
        )
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Certification Type Tests
    ***REMOVED*** ========================================================================
    ...
    def test_create_certification_type_duplicate_name(self, db, setup_data):
        ...
        cert_type_data = CertificationTypeCreate(
            name="BLS",  ***REMOVED*** Already exists
            full_name="Basic Life Support",
        )
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_certifications_exclude_expired(self, db, setup_data):
        ...
        ***REMOVED*** Create current and expired certifications
        ...
        ***REMOVED*** Note: For expired certs we need a separate cert type to avoid unique constraint
        ...
        ***REMOVED*** Should only include non-expired
    ...
    def test_create_person_certification_duplicate(self, db, setup_data):
        ...
        ***REMOVED*** Create initial certification
        ...
        cert_data = PersonCertificationCreate(
            person_id=setup_data["resident"].id,
            certification_type_id=setup_data["bls"].id,  ***REMOVED*** Same person and type
            issued_date=date.today(),
            expiration_date=date.today() + timedelta(days=730),
        )
    ...
    def test_renew_certification(self, db, setup_data):
        ...
        cert = PersonCertification(
            ...
            expiration_date=date.today() + timedelta(days=30),  ***REMOVED*** Expiring soon
            certification_number="BLS12345",
        )
        db.add(cert)
        db.commit()
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_get_expiring_certifications(self, db, setup_data):
        ...
        ***REMOVED*** Create certifications with different expiration dates
        expiring_soon = PersonCertification(
            id=uuid4(),
            person_id=setup_data["resident"].id,
            certification_type_id=setup_data["bls"].id,
            issued_date=date.today() - timedelta(days=700),
            expiration_date=date.today() + timedelta(days=30),  ***REMOVED*** 30 days
        )
        not_expiring = PersonCertification(
            ...
            certification_type_id=setup_data["bls"].id,
            issued_date=date.today(),
            expiration_date=date.today() + timedelta(days=365),  ***REMOVED*** 1 year
        )
        ...
        ***REMOVED*** Should include the one expiring in 30 days
    ...
    def test_get_compliance_summary(self, db, setup_data):
        ...
        ***REMOVED*** Create some certifications
        cert = PersonCertification(
            id=uuid4(),
            person_id=setup_data["resident"].id,
            certification_type_id=setup_data["bls"].id,
    ...
    def test_get_person_compliance(self, db, setup_data):
        ...
        ***REMOVED*** Create some certifications for resident
        cert = PersonCertification(
            id=uuid4(),
            person_id=setup_data["resident"].id,
            certification_type_id=setup_data["bls"].id,
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_compliance_tracking(self, db, setup_data):
        ...
        ***REMOVED*** Check compliance again
