...
def small_context():
    ...
    ***REMOVED*** Create blocks for 3 days
...
def medium_context():
    ...
    ***REMOVED*** Create blocks for 2 weeks (exclude weekends)
    start_date = date(2024, 1, 1)
    blocks = []
...
class TestGreedySolver:
    ...
    def test_solve_produces_valid_assignments(self, small_context):
        ...
        ***REMOVED*** Check all assignments have valid IDs
        ...
        for person_id, block_id, template_id in result.assignments:
            ...
            assert template_id in template_ids  ***REMOVED*** All assignments must have a rotation
    ...
    def test_solve_respects_availability(self, small_context):
        ...
        ***REMOVED*** Check that unavailable resident is not assigned to that block
    ...
    def test_solve_respects_rotation_capacity(self, small_context):
        ...
        ***REMOVED*** Set max_residents to 1 for the only template
...
class TestCPSATSolver:
    ...
    def test_solve_assigns_valid_rotations(self, small_context):
        ...
        for person_id, block_id, template_id in result.assignments:
            ...
            assert template_id is not None  ***REMOVED*** Must have a rotation
...
class TestPuLPSolver:
    ...
    def test_solve_returns_objective_value(self, small_context):
        ...
        ***REMOVED*** PuLP should return an objective value
...
class TestSolverPerformance:
    ...
    def test_greedy_is_fast(self, medium_context):
        ...
        ***REMOVED*** Greedy should complete in under 1 second
    ...
    def test_solvers_respect_timeout(self, medium_context):
        ...
        ***REMOVED*** Solver should complete within timeout (with some buffer)
