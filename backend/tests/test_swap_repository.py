...
class TestSwapRepositoryFindByFaculty:
    ...
    def test_find_as_source(self, swap_repo, faculty_a, faculty_b, faculty_c):
        ...
        ***REMOVED*** Create swap with faculty_a as source
        ...
        ***REMOVED*** Create swap with faculty_b as source
        ...
        ***REMOVED*** Find swaps where faculty_a is source
    ...
    def test_find_as_target(self, swap_repo, faculty_a, faculty_b, faculty_c):
        ...
        ***REMOVED*** Create swap with faculty_b as target
        swap1 = swap_repo.create(
            source_faculty_id=faculty_a.id,
            source_week=date.today() + timedelta(days=7),
            target_faculty_id=faculty_b.id,
        ...
        ***REMOVED*** Create swap with faculty_c as target
        swap2 = swap_repo.create(
            source_faculty_id=faculty_a.id,
            source_week=date.today() + timedelta(days=14),
            target_faculty_id=faculty_c.id,
        ...
        ***REMOVED*** Find swaps where faculty_b is target
        results = swap_repo.find_by_faculty(
    ...
    def test_find_as_both(self, swap_repo, faculty_a, faculty_b):
        ...
        ***REMOVED*** Find all swaps involving faculty_a
        results = swap_repo.find_by_faculty(
    ...
    def test_find_ordered_by_requested_at(self, swap_repo, faculty_a, faculty_b):
        ...
        ***REMOVED*** Create multiple swaps
        ...
        assert len(results) == 2
        ***REMOVED*** Most recent should be first
...
class TestSwapRepositoryFindByStatus:
    ...
    def test_find_by_status_with_faculty_filter(
        ...
        ***REMOVED*** Find pending swaps involving faculty_a
...
class TestSwapRepositoryFindRecent:
    ...
    def test_find_recent_executed(self, swap_repo, faculty_a, faculty_b, test_user):
        ...
        ***REMOVED*** Leave swap2 as PENDING
...
class TestSwapRepositoryFindWithPagination:
    ...
    def test_pagination_basic(self, swap_repo, faculty_a, faculty_b):
        ...
        ***REMOVED*** Get first page (20 items)
    ...
    def test_pagination_with_faculty_filter(
        ...
        ***REMOVED*** Create swaps for faculty_a
        for i in range(10):
            swap_repo.create(
                source_faculty_id=faculty_a.id,
                source_week=date.today() + timedelta(days=i),
        ...
        ***REMOVED*** Create swaps for faculty_c
        for i in range(5):
            swap_repo.create(
    ...
    def test_pagination_with_date_filters(self, swap_repo, faculty_a, faculty_b):
        ...
        ***REMOVED*** Create swaps across different dates
        for i in range(10):
            swap_repo.create(
                source_faculty_id=faculty_a.id,
        ...
        ***REMOVED*** Filter to first 4 weeks
        records, total = swap_repo.find_with_pagination(
...
***REMOVED*** ============================================================================
***REMOVED*** Approval Methods Tests
***REMOVED*** ============================================================================
...
class TestSwapRepositoryApprovals:
    ...
    def test_is_fully_approved_false_pending(
        ...
        swap_repo.record_approval_response(approval1.id, approved=True)
        ***REMOVED*** approval2 left pending
...
***REMOVED*** ============================================================================
***REMOVED*** Statistics Methods Tests
***REMOVED*** ============================================================================
...
class TestSwapRepositoryStatistics:
    ...
    def test_count_by_status_with_faculty_filter(
        ...
        ***REMOVED*** Create swap for faculty_c
        swap2 = swap_repo.create(
            source_faculty_id=faculty_c.id,
            source_week=date.today() + timedelta(days=14),
            target_faculty_id=faculty_b.id,
    ...
    def test_count_executed_for_faculty(
        ...
        ***REMOVED*** Create and execute swaps
        swap1 = swap_repo.create(
            source_faculty_id=faculty_a.id,
            source_week=date.today() + timedelta(days=7),
            target_faculty_id=faculty_b.id,
        ...
        ***REMOVED*** Swap not involving faculty_a
        swap3 = swap_repo.create(
            source_faculty_id=faculty_b.id,
            source_week=date.today() + timedelta(days=21),
            target_faculty_id=faculty_c.id,
    ...
    def test_count_executed_with_date_range(
        ...
        ***REMOVED*** Create swaps and manually set executed_at
        swap1 = swap_repo.create(
            source_faculty_id=faculty_a.id,
            source_week=date.today() + timedelta(days=7),
            target_faculty_id=faculty_b.id,
        ...
        ***REMOVED*** Manually update executed_at to be in the past
        ...
        ***REMOVED*** Count only recent (last 30 days)
