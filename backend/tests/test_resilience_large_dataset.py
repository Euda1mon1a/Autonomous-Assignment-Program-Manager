...
Issue: ***REMOVED***277 - Resilience reports truncate data at 100 rows
"""
...
class TestLargeDatasetQueryBehavior:
    ...
    def test_faculty_query_returns_all_150(self, db: Session):
        ...
        """
        ***REMOVED*** Create 150 faculty members
        for i in range(150):
            person = Person(
                id=uuid4(),
        ...
        ***REMOVED*** Query using the same pattern as the resilience routes
        faculty = (
            db.query(Person).filter(Person.type == "faculty").order_by(Person.id).all()
        )

        ***REMOVED*** Verify all 150 are returned (not truncated to 100)
    ...
    def test_blocks_query_returns_all_120(self, db: Session):
        ...
        """
        ***REMOVED*** Create 120 blocks (60 days * 2 blocks per day)
        ...
        ***REMOVED*** Verify all 120 are returned (not truncated to 100)
    ...
    def test_assignments_query_returns_all_150(self, db: Session):
        ...
        ***REMOVED*** Create 150 assignments
        for i in range(150):
...
class TestLargeDatasetScenarios:
    ...
    def test_mixed_large_dataset_all_types(self, db: Session):
        ...
        ***REMOVED*** Create 200 assignments
        for i in range(200):
            assignment = Assignment(
                id=uuid4(),
                block_id=blocks[i % len(blocks)].id,
        ...
        ***REMOVED*** Verify none are truncated
    ...
    def test_query_ordering_is_deterministic(self, db: Session):
        ...
        """
        ***REMOVED*** Create faculty in random order
        import random
    ...
    def test_101_records_all_returned(self, db: Session):
        ...
        ***REMOVED*** This would have been 100 before the fix
