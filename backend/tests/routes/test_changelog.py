...
class TestChangelogRoutes:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Version Management Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Changelog Generation Tests
    ***REMOVED*** ========================================================================
    ...
    def test_generate_changelog_success(
        ...
        mock_generator.generate_from_versions.return_value = "***REMOVED*** API Changelog\n\n***REMOVED******REMOVED*** Changes"
    ...
    def test_generate_changelog_from_schemas(
        ...
        mock_generator.generate_changelog.return_value = "***REMOVED*** Changelog"
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_generate_migration_guide_success(
        ...
        ***REMOVED*** Mock version loading
        mock_generator.version_history.load_version.side_effect = [
            {"schema": {"openapi": "3.0.0", "paths": {}}},
            {"schema": {"openapi": "3.0.0", "paths": {}}},
        ]

        mock_generator.generate_migration_guide.return_value = "***REMOVED*** Migration Guide"
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Version Suggestion Tests
    ***REMOVED*** ========================================================================
