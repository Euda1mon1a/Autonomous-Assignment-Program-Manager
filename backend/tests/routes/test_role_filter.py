...
class TestRoleFilterRoutes:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_get_dashboard_admin(
        ...
        ***REMOVED*** Admin should see all data
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_get_manifest_with_access(
        ...
        ***REMOVED*** Will succeed or fail based on role
        assert response.status_code in [200, 403]

    ***REMOVED*** ========================================================================
    ***REMOVED*** Compliance Access Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_compliance_report_admin_only(
        ...
        ***REMOVED*** Will succeed if admin, fail otherwise
        assert response.status_code in [200, 403]

    ***REMOVED*** ========================================================================
    ***REMOVED*** User Creation Tests (Admin Only)
    ***REMOVED*** ========================================================================
    ...
    def test_create_user_admin_success(
        ...
        ***REMOVED*** Will succeed for admin, fail for others
        assert response.status_code in [200, 403]
    ...
    def test_create_user_invalid_role(
        ...
        ***REMOVED*** Should fail with 400 for invalid role
        assert response.status_code in [400, 403]

    ***REMOVED*** ========================================================================
    ***REMOVED*** Access Check Tests
    ***REMOVED*** ========================================================================
