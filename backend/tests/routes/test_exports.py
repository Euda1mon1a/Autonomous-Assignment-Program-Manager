...
class TestExportRoutes:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Create Export Job Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** List Export Jobs Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Update Export Job Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Delete Export Job Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Execution History Tests
    ***REMOVED*** ========================================================================
    ...
    def test_list_executions_success(
        ...
        ***REMOVED*** Mock the database queries
        with patch("app.api.routes.exports.select") as mock_select:
            ...
            ***REMOVED*** Will be 200 if properly mocked, otherwise just verify auth works
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_templates_success(
        ...
        ***REMOVED*** Verify known templates exist
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_get_stats_success(
        ...
        ***REMOVED*** Setup mock database session and queries
        mock_db = AsyncMock()
        ...
        ***REMOVED*** The response may fail due to complex mocking, but we verify auth works
