...
class TestDocsRoutes:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Documentation Index Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Enhanced OpenAPI Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_enhanced_openapi(self, client: TestClient):
        ...
        data = response.json()
        ***REMOVED*** OpenAPI schema should have basic structure
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Markdown Documentation Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_markdown_docs(self, client: TestClient):
        ...
        ***REMOVED*** Should return plain text
        assert "text/plain" in response.headers["content-type"]

        ***REMOVED*** Content should be non-empty
    ...
    def test_get_markdown_docs_contains_headings(self, client: TestClient):
        ...
        ***REMOVED*** Markdown should have some structure
        content = response.text
        ***REMOVED*** Should contain markdown headings
        assert "***REMOVED***" in content or "API" in content

    ***REMOVED*** ========================================================================
    ***REMOVED*** Endpoint Documentation Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Error Documentation Tests
    ***REMOVED*** ========================================================================
    ...
    def test_error_documentation_structure(self, client: TestClient):
        ...
        ***REMOVED*** Should return dict or list of error codes
        data = response.json()
        assert isinstance(data, (dict, list))

    ***REMOVED*** ========================================================================
    ***REMOVED*** Changelog Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_get_version_info(self, client: TestClient):
        ...
        data = response.json()
        ***REMOVED*** Should have version-related fields
