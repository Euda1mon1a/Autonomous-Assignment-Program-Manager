...
class TestReportRoutes:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Compliance Report Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Analytics Report Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Faculty Summary Report Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_report_content_length_header(
        ...
        pdf_content = b"%PDF-1.4 " + (b"x" * 1000)  ***REMOVED*** ~1KB PDF
        mock_template = MagicMock()
        mock_template.generate.return_value = pdf_content
        mock_template_class.return_value = mock_template
        ...
        assert response.status_code == 200
        ***REMOVED*** Content-Length should be present
