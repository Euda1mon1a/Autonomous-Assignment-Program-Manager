...
class TestDailyManifest:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Parameter Validation Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Assignment Display Tests
    ***REMOVED*** ========================================================================
    ...
    def test_daily_manifest_shows_assignments(
        ...
        ***REMOVED*** Create a block and assignment
        ...
        ***REMOVED*** Should have at least one location
        assert len(data["locations"]) >= 1

        ***REMOVED*** Find the location with our assignment
    ...
    def test_daily_manifest_groups_by_location(
        ...
        ***REMOVED*** Create rotation templates with different locations
        ...
        ***REMOVED*** Assign residents to different locations
        ...
        ***REMOVED*** Should have two locations
    ...
    def test_daily_manifest_filters_by_time(
        ...
        ***REMOVED*** Create assignments for both time slots
        ...
        ***REMOVED*** Check only AM assignments returned
        found_am = False
        found_pm = False
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_daily_manifest_staffing_summary(
        ...
        ***REMOVED*** Assign 2 residents and 1 faculty
        ...
        ***REMOVED*** Find Main Clinic location
        main_clinic = next(
            (
                loc
        ...
        ***REMOVED*** Check staffing summary
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_daily_manifest_response_format(
        ...
        ***REMOVED*** date should be ISO format
        assert data["date"] == "2025-01-15"

        ***REMOVED*** locations should be a list
    ...
    def test_daily_manifest_location_format(
        ...
        ***REMOVED*** time_slots should be dict with AM/PM keys
        assert isinstance(location["time_slots"], dict)

        ***REMOVED*** staffing_summary should have counts
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_daily_manifest_unassigned_location(
        ...
        ***REMOVED*** Create block and assignment without rotation template
        block = Block(
            id=uuid4(),
            date=test_date,
            time_of_day="AM",
        ...
        assignment = Assignment(
            ...
            person_id=sample_resident.id,
            role="primary",
            rotation_template_id=None,  ***REMOVED*** No template
        )
        db.add(assignment)
        db.commit()
    ...
    def test_daily_manifest_sorts_locations(
        ...
        ***REMOVED*** Create templates with different locations
        ...
        ***REMOVED*** Assign to different locations (including one with no template)
        ...
        assignment_none = Assignment(
            ...
            role="primary",
            rotation_template_id=None,  ***REMOVED*** Will be "Unassigned"
        )
        db.add(assignment_z)
        db.add(assignment_a)
        ...
        ***REMOVED*** Check location order
        location_names = [loc["clinic_location"] for loc in data["locations"]]
        assert len(location_names) == 3

        ***REMOVED*** Alpha should come before Zebra
