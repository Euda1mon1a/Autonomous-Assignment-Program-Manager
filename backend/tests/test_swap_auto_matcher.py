...
def sample_blocks(db: Session) -> list[Block]:
    ...
    for i in range(12):  ***REMOVED*** 12 weeks
        block = Block(
            id=uuid4(),
            name=f"Week {i+1}",
...
def faculty_preferences(db: Session, faculty_members: list[Person]) -> list[FacultyPreference]:
    ...
    ***REMOVED*** Faculty 0: prefers week 2, blocks week 0
    ...
    ***REMOVED*** Faculty 1: prefers week 0, blocks week 2
    ...
    ***REMOVED*** Faculty 2: no specific preferences
...
def pending_swap_requests(
    ...
    ***REMOVED*** Perfect mutual match: Faculty 0 and 1 want each other's weeks
    swap1 = SwapRecord(
        id=uuid4(),
...
***REMOVED*** ============================================================================
***REMOVED*** Test Service Initialization
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Finding Compatible Swaps
***REMOVED*** ============================================================================
...
class TestFindCompatibleSwaps:
    ...
    def test_find_compatible_swaps_no_matches(
        ...
        ***REMOVED*** Create an isolated swap request with no potential matches
    ...
    def test_find_compatible_swaps_only_pending_status(
        ...
        ***REMOVED*** Create an approved swap (should not be matched)
        ...
        ***REMOVED*** Should return empty list for non-pending requests
        assert len(matches) == 0
    ...
    def test_find_compatible_swaps_excludes_same_faculty(
        ...
        ***REMOVED*** Create two swaps from same faculty
        swap1 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
        ...
        ***REMOVED*** Should not match with swap2 (same faculty)
        match_ids = [m.request_b_id for m in matches]
        assert swap2.id not in match_ids


***REMOVED*** ============================================================================
***REMOVED*** Test 5-Factor Compatibility Scoring
***REMOVED*** ============================================================================
...
class TestCompatibilityScoring:
    ...
    def test_score_swap_compatibility_perfect_match(
        ...
        ***REMOVED*** Faculty 0 wants week 2, Faculty 1 wants week 0
        ***REMOVED*** These preferences already exist in faculty_preferences fixture
        swap_a = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
        ...
        ***REMOVED*** Perfect match should have high score
    ...
    def test_score_swap_compatibility_blocked_week(
        ...
        ***REMOVED*** Faculty 0 blocks week 0, so they can't accept it from Faculty 2
        swap_a = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[2].id,
        ...
        ***REMOVED*** Blocked week should result in very low or zero score
        assert 0.0 <= score <= 1.0
    ...
    def test_score_date_proximity_close_dates(
        ...
        ***REMOVED*** Dates within 2 weeks
        ...
        swap_b = SwapRecord(
            source_faculty_id=faculty_members[1].id,
            source_week=base_date + timedelta(days=7),  ***REMOVED*** 1 week apart
            swap_type=SwapType.ONE_TO_ONE,
            status=SwapStatus.PENDING,
        )
    ...
    def test_score_date_proximity_distant_dates(
        ...
        ***REMOVED*** Dates far apart
        ...
        swap_b = SwapRecord(
            source_faculty_id=faculty_members[1].id,
            source_week=base_date + timedelta(days=120),  ***REMOVED*** ~17 weeks apart
            swap_type=SwapType.ONE_TO_ONE,
            status=SwapStatus.PENDING,
        )
    ...
    def test_score_availability_both_available(
        ...
        ***REMOVED*** Faculty 2 has no blocks
        swap_a = SwapRecord(
            source_faculty_id=faculty_members[2].id,
            source_week=base_date + timedelta(weeks=1),
            swap_type=SwapType.ONE_TO_ONE,
    ...
    def test_score_availability_one_blocked(
        ...
        ***REMOVED*** Faculty 0 blocks week 0
        swap_a = SwapRecord(
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
            swap_type=SwapType.ONE_TO_ONE,
    ...
    def test_score_swap_history_no_history(
        ...
        ***REMOVED*** No history should default to neutral/high score
    ...
    def test_score_swap_history_with_past_rejection(
        ...
        ***REMOVED*** Create past rejected swap between faculty 0 and 1
        ...
        ***REMOVED*** New swap between same faculty
        swap_a = SwapRecord(
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
            swap_type=SwapType.ONE_TO_ONE,
        ...
        ***REMOVED*** Past rejection should lower score
        assert 0.0 <= score <= 1.0
    ...
    def test_score_swap_history_with_past_success(
        ...
        ***REMOVED*** Create past executed swap between faculty 0 and 1
        past_swap = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[0].id,
            target_faculty_id=faculty_members[1].id,
        ...
        ***REMOVED*** Past success should maintain or boost score
        assert 0.5 <= score <= 1.0
...
***REMOVED*** ============================================================================
***REMOVED*** Test Suggesting Optimal Matches
***REMOVED*** ============================================================================
...
class TestSuggestOptimalMatches:
    ...
    def test_suggest_optimal_matches_with_results(
        ...
        ***REMOVED*** Verify first match structure
        first_match = matches[0]
    ...
    def test_suggest_optimal_matches_sorted_by_score(
        ...
        if len(matches) > 1:
            ***REMOVED*** Verify descending order
    ...
    def test_suggest_optimal_matches_filters_by_threshold(
        ...
        ***REMOVED*** Create swaps with poor compatibility
        swap1 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
        ...
        swap2 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[1].id,
            source_week=base_date + timedelta(weeks=15),  ***REMOVED*** Far apart
            target_week=None,
            swap_type=SwapType.ABSORB,
            status=SwapStatus.PENDING,
        )
        ...
        ***REMOVED*** Custom criteria has threshold of 0.5
        matches = custom_criteria_matcher.suggest_optimal_matches(swap1.id, top_k=10)

        ***REMOVED*** All returned matches should be above threshold
...
***REMOVED*** ============================================================================
***REMOVED*** Test Priority Determination
***REMOVED*** ============================================================================
...
class TestPriorityDetermination:
    ...
    def test_determine_priority_critical_with_blocked_week(
        ...
        ***REMOVED*** Faculty 0 has week 0 blocked
        swap_a = SwapRecord(
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
            swap_type=SwapType.ONE_TO_ONE,
        ...
        ***REMOVED*** Blocked week with good score should be critical
...
***REMOVED*** ============================================================================
***REMOVED*** Test Batch Auto-Matching
***REMOVED*** ============================================================================
...
class TestAutoMatchPendingRequests:
    ...
    def test_auto_match_pending_requests_tracks_no_matches(
        ...
        ***REMOVED*** Create isolated swap with no potential matches
        isolated_swap = SwapRecord(
            id=uuid4(),
    ...
    def test_auto_match_pending_requests_identifies_high_priority(
        ...
        ***REMOVED*** Check if any high priority matches were found
...
***REMOVED*** ============================================================================
***REMOVED*** Test Proactive Swap Suggestions
***REMOVED*** ============================================================================
...
class TestSuggestProactiveSwaps:
    ...
    def test_suggest_proactive_swaps_with_blocked_week(
        ...
        ***REMOVED*** Create assignment for faculty 0 on their blocked week
        ...
        ***REMOVED*** Create assignment for faculty 1 on a preferred week
        ...
        ***REMOVED*** Should suggest swaps for blocked week
    ...
    def test_suggest_proactive_swaps_no_conflicts(
        ...
        ***REMOVED*** Faculty 5 has no preferences or assignments
        suggestions = swap_auto_matcher.suggest_proactive_swaps(
            faculty_members[5].id,
            limit=5
        )

        ***REMOVED*** Should return empty list or very low benefit suggestions
        assert isinstance(suggestions, list)
    ...
    def test_suggest_proactive_swaps_respects_limit(
        ...
        ***REMOVED*** Create multiple potential suggestions
        for i in range(3):
            assignment = Assignment(
                id=uuid4(),
    ...
    def test_suggest_proactive_swaps_sorted_by_benefit(
        ...
        ***REMOVED*** Create assignments
        ...
        if len(suggestions) > 1:
            ***REMOVED*** Verify descending order by benefit score
            for i in range(len(suggestions) - 1):
                assert suggestions[i].benefit_score >= suggestions[i+1].benefit_score


***REMOVED*** ============================================================================
***REMOVED*** Test Edge Cases and Error Handling
***REMOVED*** ============================================================================
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_perfect_mutual_match_identified(
        ...
        ***REMOVED*** Create perfect mutual match
        swap1 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
    ...
    def test_absorb_type_swap_matching(
        ...
        ***REMOVED*** pending_swap_requests[3] is an ABSORB type
        matches = swap_auto_matcher.find_compatible_swaps(
            pending_swap_requests[3].id
        )

        ***REMOVED*** ABSORB swaps should still find compatible matches
    ...
    def test_date_separation_constraint(
        ...
        ***REMOVED*** Create swaps beyond max_date_separation_days (90 days)
        swap1 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
        ...
        swap2 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[1].id,
            source_week=base_date + timedelta(days=100),  ***REMOVED*** Beyond limit
            target_week=None,
            swap_type=SwapType.ONE_TO_ONE,
            status=SwapStatus.PENDING,
        )
        ...
        ***REMOVED*** Should not match due to date separation constraint
        match_ids = [m.request_b_id for m in matches]
        assert swap2.id not in match_ids
    ...
    def test_warnings_for_distant_dates(
        ...
        swap2 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[1].id,
            source_week=base_date + timedelta(days=70),  ***REMOVED*** Far apart
            target_week=None,
            swap_type=SwapType.ONE_TO_ONE,
            status=SwapStatus.PENDING,
        )
        ...
        if len(matches) > 0:
            ***REMOVED*** Check if warnings exist for distant dates
            for match in matches:
    ...
    def test_warnings_for_imminent_swaps(
        ...
        base_date = date.today() + timedelta(days=7)  ***REMOVED*** Within 2 weeks
        ...
        if len(matches) > 0:
            ***REMOVED*** Should have warning about imminent swap
    ...
    def test_workload_imbalance_warning(
        ...
        ***REMOVED*** Create many assignments for faculty 0
        for i in range(10):
        ...
        ***REMOVED*** Create few assignments for faculty 1
        assignment2 = Assignment(
            id=uuid4(),
            block_id=sample_blocks[0].id,
            person_id=faculty_members[1].id,
        ...
        ***REMOVED*** Create swaps between them
        swap1 = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty_members[0].id,
            source_week=base_date,
        ...
        if len(matches) > 0:
            ***REMOVED*** Check for workload imbalance warning
            for match in matches:
                if match.match.request_b_id == swap2.id:
                    ...
                    ***REMOVED*** May or may not have warning depending on threshold
    ...
    def test_match_explanation_generation(
        ...
        if len(matches) > 0:
            for match in matches:
                ...
                ***REMOVED*** Should contain some reasoning
    ...
    def test_recommended_action_varies_by_priority(
        ...
        if len(matches) > 0:
            for match in matches:
                ...
                ***REMOVED*** Critical/high priority should have stronger recommendations
...
***REMOVED*** ============================================================================
***REMOVED*** Test Integration with Mocked Dependencies
***REMOVED*** ============================================================================
...
class TestMockedDependencies:
    ...
    def test_compatibility_scoring_with_mocked_preference_service(
        ...
        ***REMOVED*** Mock the preference alignment scoring
        with patch.object(
            ...
            ***REMOVED*** Should still return valid score
            assert 0.0 <= score <= 1.0
            ***REMOVED*** Should be higher due to perfect preference alignment
            assert score > 0.5
    ...
    def test_compatibility_scoring_with_mocked_validation_service(
        ...
        ***REMOVED*** Create mock validation result
        ...
        with patch.object(
            ...
            ***REMOVED*** Should proceed normally with valid validation
            score = swap_auto_matcher.score_swap_compatibility(swap_a, swap_b)
            assert 0.0 <= score <= 1.0
