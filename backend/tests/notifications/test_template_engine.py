...
class TestTemplateEngine:
    ...
    def test_validate_syntax_invalid(self):
        ...
        engine = TemplateEngine()
        template = "Hello {{ name }! {% if admin %}"  ***REMOVED*** Missing closing braces and endif
    ...
    def test_error_includes_template_name(self):
        ...
        ***REMOVED*** The error should include information about the template
