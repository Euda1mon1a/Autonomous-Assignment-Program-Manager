...
class TestTemplateRegistry:
    ...
    def test_get_template_specific_version(self):
        ...
        ***REMOVED*** Register v2.0.0 (active)
        ...
        ***REMOVED*** Get active version (should be v2)
    ...
    def test_get_all_versions(self):
        ...
        ***REMOVED*** Register multiple versions
        for i in range(1, 4):
            template = TemplateVersion(
                template_id="test_template",
                version=f"{i}.0.0",
        ...
        ***REMOVED*** Should be sorted by version descending
    ...
    def test_deactivate_template(self):
        ...
        ***REMOVED*** Should not have active version
        active = registry.get_template("test_template")
    ...
    def test_create_new_version(self):
        ...
        ***REMOVED*** Register original version
        template_v1 = TemplateVersion(
            template_id="test_template",
            version="1.0.0",
            name="Test Template",
        ...
        ***REMOVED*** Other fields should be inherited
    ...
    def test_list_templates_active_only(self):
        ...
        ***REMOVED*** Register active template
        ...
        ***REMOVED*** Register inactive template
    ...
    def test_list_templates_by_locale(self):
        ...
        ***REMOVED*** Register English template
        ...
        ***REMOVED*** Register Spanish template
    ...
    def test_list_templates_by_tags(self):
        ...
        ***REMOVED*** List by multiple tags (any match)
    ...
    def test_delete_version(self):
        ...
        ***REMOVED*** Delete the version
        success = registry.delete_version("test_template", "1.0.0")
        assert success is True

        ***REMOVED*** Should not be retrievable
    ...
    def test_register_template_invalid_syntax(self):
        ...
        template = TemplateVersion(
            ...
            version="1.0.0",
            name="Bad Template",
            subject_template="Bad {{ syntax",  ***REMOVED*** Invalid
            html_template="<p>HTML</p>",
            text_template="Text",
        )
