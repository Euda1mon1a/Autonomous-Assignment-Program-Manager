...
class TestTemplateValidator:
    ...
    def test_validate_syntax_invalid(self):
        ...
        validator = TemplateValidator()
        template = "Hello {{ name }!"  ***REMOVED*** Missing closing brace
    ...
    def test_validate_required_variables_missing(self):
        ...
        validator = TemplateValidator()
        template = "Hello {{ name }}!"
        required_variables = ["name", "order_id"]  ***REMOVED*** order_id is missing
    ...
    def test_validate_complete_template_missing_variables(self):
        ...
        text = "Text content"
        required_vars = ["user_name", "order_id"]  ***REMOVED*** Not present in templates
