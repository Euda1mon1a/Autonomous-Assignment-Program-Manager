...
class TestBuiltInTemplates:
    ...
    def test_shift_reminder_24h_template_renders(self):
        ...
        assert "2 weeks" in result["text"]  ***REMOVED*** Test pluralize filter
    ...
    def test_absence_approved_template_renders(self):
        ...
        assert "7 days" in result["text"]  ***REMOVED*** Test pluralize filter
    ...
    def test_absence_approved_template_renders_without_notes(self):
        ...
        assert result is not None
        assert "1 day" in result["text"]  ***REMOVED*** Test pluralize filter singular
    ...
    def test_all_templates_have_valid_syntax(self):
        ...
        for template_id in template_ids:
            ...
            ***REMOVED*** Validate syntax for all template parts
    ...
    def test_templates_use_proper_html_structure(self):
        ...
        for template_id in template_ids:
            ...
            ***REMOVED*** Check for basic HTML elements
    ...
    def test_templates_include_variable_placeholders(self):
        ...
        ***REMOVED*** Check that declared variables are actually used
        combined = (
