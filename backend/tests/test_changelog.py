...
***REMOVED*** Sample OpenAPI schemas for testing
SAMPLE_SCHEMA_V1 = {
    "openapi": "3.0.0",
    "info": {
        "title": "Test API",
...
SAMPLE_SCHEMA_V2_BREAKING = {
    ...
    "paths": {
        "/users": {
                ...
                "parameters": [
                    {
                        "name": "page",
                        "in": "query",
                        "schema": {"type": "string"},  ***REMOVED*** Type changed (breaking)
                        "required": False,
                    },
                    {
                        "name": "limit",
                        "in": "query",
                        "schema": {"type": "integer"},
                        "required": True,  ***REMOVED*** New required param (breaking)
                    }
                ],
                "responses": {
                    "200": {
            ...
            ***REMOVED*** POST removed (breaking)
        },
        "/users/{id}": {  ***REMOVED*** New endpoint (non-breaking)
            "get": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "query",
                        "schema": {"type": "integer"},
                        "required": False,  ***REMOVED*** New optional param (non-breaking)
                    }
                ],
                "responses": {
                    "200": {
...
class TestAPIDiffer:
    ...
    def test_detect_endpoint_removed(self):
        ...
        ***REMOVED*** Check that POST /users removal is detected
        removed_methods = [
    ...
    def test_detect_endpoint_added(self):
        ...
        ***REMOVED*** Check that /users/{id} is detected as new
        added_endpoints = [
            c for c in diff.changes
    ...
    def test_detect_required_param_added(self):
        ...
        ***REMOVED*** Check that required 'limit' param is detected
        required_params = [
            c for c in diff.changes
    ...
    def test_detect_param_type_changed(self):
        ...
        ***REMOVED*** Check that 'page' type change is detected
        type_changes = [
            c for c in diff.changes
    ...
    def test_detect_optional_param_added(self):
        ...
        ***REMOVED*** Check that optional 'limit' param is detected
        optional_params = [
            c for c in diff.changes
    ...
    def test_breaking_changes_identified(self):
        ...
        ***REMOVED*** Should have breaking changes
        assert diff.has_breaking_changes
        assert len(diff.breaking_changes) > 0

        ***REMOVED*** All breaking changes should be marked as breaking
    ...
    def test_non_breaking_changes(self):
        ...
        ***REMOVED*** Should not have breaking changes
        assert not diff.has_breaking_changes

        ***REMOVED*** Should have non-breaking changes
    ...
    def test_version_bump_suggestion_major(self):
        ...
        ***REMOVED*** Should suggest major version bump
    ...
    def test_version_bump_suggestion_minor(self):
        ...
        ***REMOVED*** Should suggest minor version bump
        suggested = diff.suggest_version_bump("1.0.0")
...
class TestChangelogFormatter:
    ...
    def test_format_markdown(self):
        ...
        ***REMOVED*** Check for key sections
        assert "***REMOVED*** API Changelog" in markdown
        assert "***REMOVED******REMOVED*** Summary" in markdown
        assert "***REMOVED******REMOVED*** ⚠️ Breaking Changes" in markdown
    ...
    def test_format_html(self):
        ...
        ***REMOVED*** Check for HTML structure
    ...
    def test_migration_guide_included(self):
        ...
        ***REMOVED*** Should include migration guide section
        assert "***REMOVED******REMOVED*** 📖 Migration Guide" in markdown
    ...
    def test_migration_guide_excluded(self):
        ...
        ***REMOVED*** Migration guide section should not be present
        assert "***REMOVED******REMOVED*** 📖 Migration Guide" not in markdown
...
class TestChangelogGenerator:
    ...
    def test_generate_changelog(self, tmp_path):
        ...
        ***REMOVED*** Should be a non-empty string
    ...
    def test_list_versions(self, tmp_path):
        ...
        ***REMOVED*** Save multiple versions
    ...
    def test_generate_migration_guide(self, tmp_path):
        ...
        ***REMOVED*** Should be a non-empty string
        ...
        assert len(guide) > 0
        assert "***REMOVED*** Migration Guide" in guide
    ...
    def test_suggest_version(self, tmp_path):
        ...
        ***REMOVED*** Breaking changes -> major bump
        ...
        ***REMOVED*** Non-breaking changes -> minor bump
        suggested = generator.suggest_version(
            SAMPLE_SCHEMA_V1,
            SAMPLE_SCHEMA_V1_1_NON_BREAKING,
        )
    ...
    def test_version_not_found(self, tmp_path):
        ...
        ***REMOVED*** Try to generate changelog for non-existent versions
        changelog = generator.generate_from_versions(
            "1.0.0",
            "2.0.0",
            output_format=OutputFormat.MARKDOWN,
