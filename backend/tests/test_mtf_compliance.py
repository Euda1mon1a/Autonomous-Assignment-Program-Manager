...
class TestDRRSTranslator:
    ...
    def test_personnel_strength_with_overloaded(self):
        ...
        ***REMOVED*** 10 available, 10 required, but 4 overloaded
        ***REMOVED*** Effective = 10 - (4 * 0.5) = 8 -> 80% -> P-3
        rating, pct = translator.translate_personnel_strength(
            available_faculty=10,
            required_faculty=10,
            overloaded_count=4,
...
class TestCircuitBreaker:
    ...
    def test_trip_on_coverage_collapse(self):
        ...
        tripped, trigger, details = cb.check_and_trip(
            n1_pass=True,
            n2_pass=True,
            coverage_rate=0.65,  ***REMOVED*** Below 70% threshold
            average_allostatic_load=50,
            volatility_level="normal",
            compensation_debt=100,
        )
    ...
    def test_trip_on_allostatic_overload(self):
        ...
        tripped, trigger, details = cb.check_and_trip(
            ...
            n2_pass=True,
            coverage_rate=0.90,
            average_allostatic_load=85,  ***REMOVED*** Above 80 threshold
            volatility_level="normal",
            compensation_debt=100,
        )
    ...
    def test_locked_operations_when_open(self):
        ...
        ***REMOVED*** Check operations
        allowed, reason = cb.is_operation_allowed("new_assignments")
        assert allowed is False
        assert "451" in reason  ***REMOVED*** HTTP 451 Unavailable For Legal Reasons

        ***REMOVED*** Patient safety always allowed
    ...
    def test_override_allows_operations(self):
        ...
        ***REMOVED*** Now operations should be allowed
        allowed, reason = cb.is_operation_allowed("new_assignments")
        assert allowed is True
    ...
    def test_override_expires(self):
        ...
        ***REMOVED*** Trip and override with expired time
        ...
        cb.override = type(
            ...
            (object,),
            {
                ...
                "expires_at": datetime.now() - timedelta(hours=1),  ***REMOVED*** Expired
                "mfr_id": None,
            },
        )()

        ***REMOVED*** Override should not be active
        assert cb._override_active() is False

        ***REMOVED*** Operations should be blocked
        allowed, reason = cb.is_operation_allowed("new_assignments")
        assert allowed is False
...
***REMOVED*** =============================================================================
***REMOVED*** Iron Dome Service Tests
***REMOVED*** =============================================================================
...
class TestIronDomeService:
    ...
    def test_get_status(self):
        ...
        ***REMOVED*** Generate some documents
...
class TestIronDomeIntegration:
    ...
    def test_full_crisis_workflow(self):
        ...
        ***REMOVED*** System state indicating crisis
        system_state = {
            "n1_pass": False,
            "n2_pass": False,
            "coverage_rate": 0.68,
        ...
        ***REMOVED*** 2. Check circuit breaker (should trip)
        ...
        ***REMOVED*** 3. Generate risk MFR if trying to publish anyway
        mfr = service.generate_risk_mfr(
        ...
        ***REMOVED*** 4. Draft RFF for support
        rff = service.draft_resource_request(
