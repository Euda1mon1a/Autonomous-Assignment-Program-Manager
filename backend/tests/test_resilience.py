...
***REMOVED*** ============================================================================
***REMOVED*** Utilization Monitor Tests
***REMOVED*** ============================================================================
...
class TestUtilizationMonitor:
    ...
    def test_utilization_calculation_warning(self):
        ...
        metrics = monitor.calculate_utilization(
            available_faculty=faculty,
            required_blocks=56,  ***REMOVED*** 70% utilization
            blocks_per_faculty_per_day=2.0,
            days_in_period=4,
        )
    ...
    def test_utilization_calculation_critical(self):
        ...
        metrics = monitor.calculate_utilization(
            available_faculty=faculty,
            required_blocks=76,  ***REMOVED*** 95% utilization
            blocks_per_faculty_per_day=2.0,
            days_in_period=4,
        )
    ...
    def test_wait_time_multiplier(self):
        ...
        ***REMOVED*** At 50% utilization, multiplier should be ~1x
        ...
        ***REMOVED*** At 80% utilization, multiplier should be ~4x
...
***REMOVED*** ============================================================================
***REMOVED*** Defense in Depth Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Contingency Analysis Tests
***REMOVED*** ============================================================================
...
class TestContingencyAnalyzer:
    ...
    def test_n1_analysis_with_redundancy(self):
        ...
        ***REMOVED*** Create mock data with redundancy
        faculty = [
        ...
        ***REMOVED*** Each block covered by multiple faculty
        assignments = []
        for i, block in enumerate(blocks):
            for j in range(2):  ***REMOVED*** 2 faculty per block
                assignments.append(
                    type(
                        "obj",
                        (object,),
        ...
        ***REMOVED*** With redundancy, should pass N-1
    ...
    def test_centrality_calculation(self):
        ...
        ***REMOVED*** Faculty 0 covers many more assignments
        assignments = []
        for i in range(10):
            assignments.append(
                type(
...
***REMOVED*** ============================================================================
***REMOVED*** Sacrifice Hierarchy Tests
***REMOVED*** ============================================================================
...
class TestSacrificeHierarchy:
    ...
    def test_activity_priorities(self):
        ...
        ***REMOVED*** PATIENT_SAFETY should be highest priority (lowest number)
        assert (
    ...
    def test_protected_activities_at_black(self):
        ...
        ***REMOVED*** Patient safety should always be protected
        assert (
...
***REMOVED*** ============================================================================
***REMOVED*** Resilience Service Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Integration Tests with Database
***REMOVED*** ============================================================================
...
class TestResilienceAPI:
    ...
    def test_health_endpoint(self, client: TestClient):
        ...
        ***REMOVED*** May fail if no data, but should return a response
...
class TestResilienceEdgeCases:
    ...
    def test_zero_faculty(self):
        ...
        ***REMOVED*** Should handle gracefully (100% or infinite utilization)
        assert (
    ...
    def test_zero_blocks(self):
        ...
        ***REMOVED*** Should be healthy (0% utilization)
    ...
    def test_recovery_plan_order(self):
        ...
        ***REMOVED*** Activate to BLACK (most severe)
        hierarchy.activate_level(LoadSheddingLevel.BLACK, reason="Test")

        ***REMOVED*** Get recovery plan
        plan = hierarchy.get_recovery_plan()

        ***REMOVED*** Should restore in reverse sacrifice order
        ***REMOVED*** (low priority activities restored last)
        assert len(plan) > 0


***REMOVED*** ============================================================================
***REMOVED*** Homeostasis Volatility Tracking Tests
***REMOVED*** ============================================================================
...
class TestFeedbackLoopVolatility:
    ...
    def test_momentum_increasing(self):
        ...
        assert momentum > 0  ***REMOVED*** Positive momentum (increasing)
    ...
    def test_momentum_decreasing(self):
        ...
        momentum = loop.get_momentum()
        assert momentum < 0  ***REMOVED*** Negative momentum (decreasing)
    ...
    def test_volatility_metrics_critical(self):
        ...
        ***REMOVED*** High variance + high jitter + near threshold
        ...
        ***REMOVED*** High volatility and jitter
...
class TestHomeostasisMonitorVolatility:
    ...
    def test_detect_volatility_no_alerts_stable(self):
        ...
        ***REMOVED*** Add stable values to all loops
        for loop in monitor.feedback_loops.values():
            for i in range(10):
                ***REMOVED*** Values near target with low variance
    ...
    def test_detect_volatility_alerts_unstable(self):
        ...
        ***REMOVED*** Get the coverage_rate loop and add unstable values
        loop = monitor.get_feedback_loop("coverage_rate")
        assert loop is not None

        ***REMOVED*** Add highly variable values that oscillate
        ...
        ***REMOVED*** Should have at least one alert
        assert len(alerts) > 0
    ...
    def test_get_status_includes_volatility(self):
        ...
        ***REMOVED*** Add some values to loops
        for loop in monitor.feedback_loops.values():
            for i in range(6):
        ...
        ***REMOVED*** New fields should be present
    ...
    def test_volatility_affects_overall_state(self):
        ...
        ***REMOVED*** Add unstable values to multiple loops
        for loop in monitor.feedback_loops.values():
            unstable = [0.60, 0.95, 0.50, 0.90, 0.55, 0.92, 0.65, 0.88, 0.70, 0.85]
            for val in unstable:
                loop.record_value(val)

        ***REMOVED*** Detect volatility first
        monitor.detect_volatility_risks()

        status = monitor.get_status()

        ***REMOVED*** With high volatility, should not be in pure HOMEOSTASIS
        ***REMOVED*** (may be ALLOSTASIS due to volatility even if avg values are OK)
