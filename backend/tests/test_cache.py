...
***REMOVED*** ============================================================================
***REMOVED*** Unit Tests - ServiceCache Class
***REMOVED*** ============================================================================
...
class TestServiceCache:
    ...
    def test_set_with_custom_ttl(self, service_cache, mock_redis):
        ...
        assert call_args[0][1] == 300  ***REMOVED*** TTL is second positional arg
...
class TestCacheKeyGeneration:
    ...
    def test_serialize_list(self, service_cache):
        ...
        assert result == "[a,b,c]"  ***REMOVED*** Sorted
...
class TestCacheDecorator:
    ...
    def test_decorator_caches_result(self, service_cache, mock_redis):
        ...
        ***REMOVED*** Setup mock to return None (cache miss), then return cached value
    ...
    def test_decorator_returns_cached_value(self, service_cache, mock_redis):
        ...
        def expensive_function() -> dict:
            return {"result": 0}  ***REMOVED*** Should not be called
    ...
    def test_decorator_skips_db_session_in_key(self, service_cache, mock_redis):
        ...
        ***REMOVED*** The db session should not be in the cache key
        call_args = mock_redis.setex.call_args
...
class TestHelperFunctions:
    ...
    def test_get_service_cache_singleton(self):
        ...
        with patch("app.core.cache.ServiceCache") as MockCache:
            ...
            ***REMOVED*** Reset the global cache
...
***REMOVED*** ============================================================================
***REMOVED*** Integration Tests with Real Redis
***REMOVED*** ============================================================================
...
class TestCacheIntegration:
    ...
    def test_real_redis_pattern_invalidation(self, real_redis_cache):
        ...
        ***REMOVED*** Set multiple values with common prefix
...
class TestCacheTTL:
    ...
    def test_ttl_values(self):
        ...
        assert CacheTTL.SHORT == 300  ***REMOVED*** 5 minutes
        assert CacheTTL.MEDIUM == 1800  ***REMOVED*** 30 minutes
        assert CacheTTL.LONG == 3600  ***REMOVED*** 1 hour
        assert CacheTTL.DAY == 86400  ***REMOVED*** 24 hours


***REMOVED*** ============================================================================
***REMOVED*** Cache Prefix Tests
***REMOVED*** ============================================================================
