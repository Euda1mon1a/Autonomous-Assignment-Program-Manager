...
***REMOVED*** ============================================================================
***REMOVED*** TranscriptionFactor Tests
***REMOVED*** ============================================================================
...
class TestTranscriptionFactor:
    ...
    def test_create_activator_tf(self):
        ...
        assert tf.expression_level == 0.1  ***REMOVED*** Defaults to basal
        assert not tf.is_active  ***REMOVED*** Below 0.2 threshold
    ...
    def test_tf_induction_sigmoid_response(self):
        ...
        ***REMOVED*** Weak signal (0.2) should give low response
        ...
        ***REMOVED*** Strong signal (0.8) should give high response
        tf.induce(signal_strength=0.8)
        strong_response = tf.expression_level

        assert strong_response > weak_response * 2  ***REMOVED*** Nonlinear response
    ...
    def test_tf_decay(self):
        ...
        ***REMOVED*** Induce to max
        tf.induce(signal_strength=1.0)
        initial_expression = tf.expression_level

        ***REMOVED*** Decay for 24 hours (one half-life)
        tf.decay(hours_elapsed=24.0)

        ***REMOVED*** Should be approximately halfway between max and basal
        ***REMOVED*** (exponential decay toward basal, not zero)
    ...
    def test_tf_effective_strength(self):
        ...
        ***REMOVED*** Activator: activation_strength * expression_level
        assert activator.get_effective_strength() == 1.0  ***REMOVED*** 2.0 * 0.5

        ***REMOVED*** Repressor: repression_strength * expression_level
        assert repressor.get_effective_strength() == 0.4  ***REMOVED*** 0.8 * 0.5


***REMOVED*** ============================================================================
***REMOVED*** Binding Site Tests
***REMOVED*** ============================================================================
...
class TestBindingSite:
    ...
    def test_enhancer_site(self):
        ...
        ***REMOVED*** Enhancer should boost by 1.5x (capped at 1.0)
    ...
    def test_silencer_site(self):
        ...
        ***REMOVED*** Silencer should reduce by 0.5x
        assert effective < 0.8 * 0.8
...
***REMOVED*** ============================================================================
***REMOVED*** Promoter Architecture Tests
***REMOVED*** ============================================================================
...
class TestPromoterArchitecture:
    ...
    def test_and_logic_activation(self):
        ...
        ***REMOVED*** Only TF1 bound - should NOT activate
        bound_tfs = {tf1_id: 0.8}
        ...
        ***REMOVED*** Both bound - should activate
    ...
    def test_silenced_chromatin_blocks_activation(self):
        ...
        ***REMOVED*** Strong activator should still be blocked
        bound_tfs = {tf_id: 1.0}
        activation, explanation = promoter.calculate_activation(bound_tfs)
...
class TestTranscriptionFactorScheduler:
    ...
    def test_default_tfs_created(self):
        ...
        ***REMOVED*** Should have default TFs
        assert len(tfs.transcription_factors) > 0

        ***REMOVED*** Check specific defaults exist
        ...
        assert patient_safety.basal_expression == 1.0  ***REMOVED*** Always on
    ...
    def test_link_tf_to_constraint(self):
        ...
        ***REMOVED*** Create TF and link to constraint
    ...
    def test_signal_processing(self):
        ...
        ***REMOVED*** Military TF should respond to deployment
        military_tf = tfs.get_tf_by_name("MilitaryEmergency_TF")
        initial_expression = military_tf.expression_level

        ***REMOVED*** Process deployment signal
    ...
    def test_constraint_weight_calculation(self):
        ...
        ***REMOVED*** Create activator and link
        tf = tfs.create_tf(
            "WeightModifier",
            TFType.ACTIVATOR,
            activation_strength=2.0,
        ...
        ***REMOVED*** Initially TF not active - weight should be low
        ...
        ***REMOVED*** Now weight should be higher
    ...
    def test_chromatin_state_management(self):
        ...
        ***REMOVED*** Setup constraint with active regulation
    ...
    def test_tf_cascade(self):
        ...
        ***REMOVED*** Create two TFs where TF1 induces TF2
        ...
        ***REMOVED*** TF2 should also be induced via cascade
    ...
    def test_tf_expression_report(self):
        ...
        ***REMOVED*** Highest expressed should be first
        assert report[0]["expression"] >= report[-1]["expression"]


***REMOVED*** ============================================================================
***REMOVED*** Regulatory Loop Detection Tests
***REMOVED*** ============================================================================
...
class TestRegulatoryLoopDetection:
    ...
    def test_detect_feedback_loop(self):
        ...
        ***REMOVED*** Create two TFs that regulate each other
        ...
        ***REMOVED*** Should detect the feedback loop
        assert len(loops) > 0

        ***REMOVED*** Should be classified as positive feedback (both activators)
    ...
    def test_detect_negative_feedback(self):
        ...
        ***REMOVED*** Create activator -> repressor -> activator
...
class TestResilienceServiceIntegration:
    ...
    def test_process_signal_via_service(self):
        ...
        assert len(signal.target_tf_ids) > 0  ***REMOVED*** Should induce military TF
    ...
    def test_get_regulated_weights(self):
        ...
        ***REMOVED*** Setup regulation
        service.create_transcription_factor(
            name="WeightTF",
            tf_type=TFType.ACTIVATOR,
            basal_expression=0.5,  ***REMOVED*** Already somewhat expressed
        )
    ...
    def test_silence_constraints_for_crisis(self):
        ...
        ***REMOVED*** Silence for crisis
        service.silence_constraints_for_crisis(constraint_ids)

        ***REMOVED*** All should be silenced
        for cid in constraint_ids:
...
class TestScenarios:
    ...
    def test_deployment_scenario(self):
        ...
        ***REMOVED*** Setup emergency coverage constraint
        ...
        service.link_tf_to_constraint(
            ...
            base_weight=0.5,  ***REMOVED*** Low weight normally
        )

        ***REMOVED*** Get weight before deployment
    ...
    def test_crisis_mode_scenario(self):
        ...
        ***REMOVED*** Setup constraints
        essential_id = uuid4()
        optional_id = uuid4()

        ***REMOVED*** Essential constraint - linked to master regulator
        service.link_tf_to_constraint(
            tf_name="PatientSafety_MR",
        ...
        ***REMOVED*** Optional constraint - linked to crisis mode repressor
        service.link_tf_to_constraint(
            tf_name="CrisisMode_TF",
            constraint_id=optional_id,
            constraint_name="OptionalEducation",
            as_activator=False,  ***REMOVED*** Represses this constraint
        )

        ***REMOVED*** Activate crisis mode
        service.process_regulatory_signal(
            event_type="crisis",
        ...
        ***REMOVED*** Essential should remain active (master regulator always on)
        ...
        ***REMOVED*** Crisis mode TF should repress optional
    ...
    def test_combinatorial_regulation(self):
        ...
        ***REMOVED*** Create two TFs that must both be active
        ...
        ***REMOVED*** Create promoter with AND logic
        ...
        ***REMOVED*** Only TF1 active - should not activate constraint
        ...
        ***REMOVED*** Both active - should activate
