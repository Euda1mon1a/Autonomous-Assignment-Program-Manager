...
class EmergencyScenarios:
    ...
    def create_family_emergency_absence(db: Session) -> dict:
        ...
        ***REMOVED*** Family emergency starting today
    ...
    def create_multiple_simultaneous_emergencies(db: Session) -> dict:
        ...
        ***REMOVED*** Emergency 1: Faculty deployment
        deployment = LeaveFactory.create_deployment(
            db,
        ...
        ***REMOVED*** Emergency 2: Resident family emergency
        ...
        ***REMOVED*** Emergency 3: Faculty medical emergency
    ...
    def create_tdy_overlap_emergency(db: Session) -> dict:
        ...
        ***REMOVED*** Create overlapping TDY assignments
        tdys = []
        start_date = date.today() + timedelta(days=7)

        for i, fac in enumerate(faculty[:3]):
            ***REMOVED*** Stagger start dates slightly but overlap
    ...
    def create_natural_disaster_scenario(db: Session) -> dict:
        ...
        ***REMOVED*** Emergency closure starting tomorrow
        closure_date = date.today() + timedelta(days=1)

        ***REMOVED*** All staff unavailable during closure
        absences = []
    ...
    def create_covid_outbreak_scenario(db: Session) -> dict:
        ...
        ***REMOVED*** 5 residents test positive (need 10-day quarantine)
        quarantine_absences = []
    ...
    def create_facility_power_outage(db: Session) -> dict:
        ...
        """
        ***REMOVED*** Create weekend call schedule
        schedule = ScheduleFactory.create_weekend_call_schedule(
            db, num_faculty=4, num_weekends=2
        )

        ***REMOVED*** Power outage affects operations (represented as emergency closure)
    ...
    def create_cascading_callout_failure(db: Session) -> dict:
        ...
        ***REMOVED*** Primary on-call: family emergency (unavailable)
        ...
        ***REMOVED*** Backup on-call: medical emergency (also unavailable)
