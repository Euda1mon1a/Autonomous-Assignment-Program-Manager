...
class TestFreezeHorizonService:
    ...
    ***REMOVED*** =========================================================================
    ...
    def test_check_freeze_status_frozen(self, service):
        ...
        ***REMOVED*** Assignment 3 days out (within 7-day horizon)
        ...
        assert result.can_use_emergency_bypass is True  ***REMOVED*** NON_EMERGENCY_ONLY scope
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Test validate_override
    ***REMOVED*** =========================================================================
    ...
    def test_validate_override_non_emergency_rejected(self, service):
        ...
        override = FreezeOverrideRequest(
            reason_code=OverrideReasonCode.OTHER,  ***REMOVED*** Not classified as emergency
    ...
    def test_validate_override_all_changes_requires_text(self, service):
        ...
        ***REMOVED*** Short reason text should be rejected
        override = FreezeOverrideRequest(
            reason_code=OverrideReasonCode.OTHER,
            reason_text="short",  ***REMOVED*** Less than 10 characters
            initiated_by="user123",
            initiating_module="manual",
        )
        ...
        ***REMOVED*** Long reason text should be accepted
        override.reason_text = "This is a sufficiently long reason text"
        is_valid, message = service.validate_override(freeze_result, override)
        assert is_valid is True

    ***REMOVED*** =========================================================================
    ***REMOVED*** Test enforce_freeze_or_override
    ***REMOVED*** =========================================================================
    ...
    def test_enforce_frozen_with_valid_override_passes(self, service):
        ...
        assert result.is_frozen is True  ***REMOVED*** Still frozen, but override accepted
    ...
    def test_enforce_frozen_with_invalid_override_raises(self, service):
        ...
        future_date = date.today() + timedelta(days=3)
        override = FreezeOverrideRequest(
            reason_code=OverrideReasonCode.OTHER,  ***REMOVED*** Not emergency
    ...
    ***REMOVED*** =========================================================================
    ...
    def test_audit_record_created_on_override(self, service):
        ...
        ***REMOVED*** Check audit records
        ...
        assert record.is_emergency is True  ***REMOVED*** COVERAGE_GAP is emergency

    def test_get_freeze_statistics(self, service):
        """Test freeze statistics calculation."""
        ***REMOVED*** Create some override records
        future_date = date.today() + timedelta(days=3)
