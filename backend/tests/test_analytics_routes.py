...
***REMOVED*** ============================================================================
***REMOVED*** Current Metrics Endpoint Tests
***REMOVED*** ============================================================================
...
class TestCurrentMetricsEndpoint:
    ...
    def test_get_current_metrics_success(
        ...
        ***REMOVED*** Create some residents and assignments
        for i in range(3):
            resident = Person(
                id=uuid4(),
    ...
    def test_get_current_metrics_only_uses_successful_runs(
        ...
        ***REMOVED*** Create a failed run (should be ignored)
        ...
        ***REMOVED*** Should still return 404 since no successful runs
        assert response.status_code == 404
    ...
    def test_get_current_metrics_uses_most_recent(
        ...
        ***REMOVED*** Create older successful run
        old_run = ScheduleRun(
            id=uuid4(),
        ...
        ***REMOVED*** Create newer successful run
        new_run = ScheduleRun(
            id=uuid4(),
            start_date=start_date,
            end_date=start_date + timedelta(days=7),
        ...
        ***REMOVED*** Create blocks for the new run
        for i in range(7):
            for tod in ["AM", "PM"]:
                block = Block(
                    id=uuid4(),
        ...
        ***REMOVED*** Verify it's using the newer run
        assert data["scheduleRunId"] == str(new_run.id)


***REMOVED*** ============================================================================
***REMOVED*** Metrics History Endpoint Tests
***REMOVED*** ============================================================================
...
class TestMetricsHistoryEndpoint:
    ...
    def test_get_metrics_history_fairness(
        ...
        ***REMOVED*** Verify statistics structure
    ...
    def test_get_metrics_history_trend_calculation(
        ...
        ***REMOVED*** Create multiple runs with varying fairness
        for i in range(4):
...
***REMOVED*** ============================================================================
***REMOVED*** Fairness Trend Endpoint Tests
***REMOVED*** ============================================================================
...
class TestFairnessTrendEndpoint:
    ...
    def test_get_fairness_trend_success(
        ...
        ***REMOVED*** Create some schedule runs
        for i in range(3):
            ...
            ***REMOVED*** Create blocks for the run
            for j in range(7):
                for tod in ["AM", "PM"]:
                    block = Block(
                        id=uuid4(),
        ...
        ***REMOVED*** Verify data point structure
...
***REMOVED*** ============================================================================
***REMOVED*** Version Comparison Endpoint Tests
***REMOVED*** ============================================================================
...
class TestVersionComparisonEndpoint:
    ...
    def test_compare_versions_success(
        ...
        ***REMOVED*** Create blocks for both runs
        for i in range(7):
            for tod in ["AM", "PM"]:
                block = Block(
                    id=uuid4(),
        ...
        ***REMOVED*** Verify metric comparison structure
    ...
    def test_compare_versions_improvement_detection(
        ...
        ***REMOVED*** Version A - worse metrics
        run_a = ScheduleRun(
            id=uuid4(),
            start_date=start_date,
            end_date=end_date,
        ...
        ***REMOVED*** Version B - better metrics
        run_b = ScheduleRun(
            id=uuid4(),
            start_date=start_date,
            end_date=end_date,
...
class TestWhatIfAnalysisEndpoint:
    ...
    def test_what_if_add_assignment(
        ...
        ***REMOVED*** Create baseline schedule
        run = ScheduleRun(
            id=uuid4(),
            start_date=start_date,
            end_date=start_date + timedelta(days=7),
    ...
    def test_what_if_remove_assignment(
        ...
        ***REMOVED*** Create existing assignment
        assignment = Assignment(
            id=uuid4(),
            block_id=block.id,
            person_id=resident.id,
    ...
    def test_what_if_workload_violation(
        ...
        blocks = []
        for i in range(60):  ***REMOVED*** Many blocks
            block = Block(
                id=uuid4(),
                date=start_date + timedelta(days=i),
                time_of_day="AM",
        ...
        resident = Person(
            ...
            type="resident",
            pgy_level=2,
            target_clinical_blocks=48,  ***REMOVED*** Target is much lower than blocks
        )
        db.add(resident)

        ***REMOVED*** Create many existing assignments (will exceed target)
        ...
        ***REMOVED*** Try to add more (should trigger violation)
        response = client.post(
            "/api/analytics/what-if",
            json=[
                {
        ...
        ***REMOVED*** Should have new violations
    ...
    def test_what_if_metric_impacts(
        ...
        ***REMOVED*** Should have metric impacts
...
***REMOVED*** ============================================================================
***REMOVED*** Research Export Endpoint Tests
***REMOVED*** ============================================================================
...
class TestResearchExportEndpoint:
    ...
    def test_research_export_success(
        ...
        ***REMOVED*** Create residents and assignments
        for i in range(3):
            resident = Person(
                id=uuid4(),
    ...
    def test_research_export_non_anonymized(
        ...
        ***REMOVED*** Should include institution details when not anonymized
    ...
    def test_research_export_empty_date_range(
        ...
        ***REMOVED*** Should still return valid structure with zeros
...
***REMOVED*** ============================================================================
***REMOVED*** Error Handling and Edge Cases
***REMOVED*** ============================================================================
...
class TestAnalyticsErrorHandling:
    ...
    def test_what_if_invalid_change_type(
        ...
        ***REMOVED*** Try with invalid change type
        response = client.post(
            "/api/analytics/what-if",
            json=[
                {
        ...
        ***REMOVED*** Should still process but may not calculate correctly
        ***REMOVED*** The endpoint doesn't strictly validate change_type in schema
    ...
    def test_compare_versions_with_same_version(
        ...
        ***REMOVED*** Should work, but all differences should be 0
        assert response.status_code == 200
        data = response.json()
