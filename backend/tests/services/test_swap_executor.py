...
class TestSwapExecutor:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_execute_swap_one_to_one_success(self, db, sample_faculty):
        ...
        ***REMOVED*** Create blocks for two weeks
        week1_start = date(2025, 1, 6)  ***REMOVED*** Monday
        week2_start = date(2025, 1, 13)  ***REMOVED*** Monday

        ***REMOVED*** Create blocks for week 1
        week1_blocks = []
        ...
        ***REMOVED*** Create blocks for week 2
        week2_blocks = []
        for day_offset in range(7):
            for time in ["AM", "PM"]:
                block = Block(
        ...
        ***REMOVED*** Create assignments for week 1 (faculty1)
        for block in week1_blocks[:4]:  ***REMOVED*** First 2 days
        ...
        ***REMOVED*** Create assignments for week 2 (faculty2)
        for block in week2_blocks[:4]:  ***REMOVED*** First 2 days
            assignment = Assignment(
                id=uuid4(),
                block_id=block.id,
        ...
        ***REMOVED*** Verify swap record was created
        ...
        ***REMOVED*** Verify assignments were swapped
        ...
        for assignment in week1_assignments:
            ***REMOVED*** Faculty1's assignments should now belong to faculty2
        ...
        for assignment in week2_assignments:
            ***REMOVED*** Faculty2's assignments should now belong to faculty1
    ...
    def test_execute_swap_absorb_success(self, db, sample_faculty):
        ...
        ***REMOVED*** Create blocks for one week
        week_start = date(2025, 1, 6)  ***REMOVED*** Monday
        blocks = []
        for day_offset in range(7):
            for time in ["AM", "PM"]:
                block = Block(
        ...
        ***REMOVED*** Create assignments for faculty1
        ...
        ***REMOVED*** Execute absorb swap (faculty2 takes faculty1's week)
        executor = SwapExecutor(db)
        result = executor.execute_swap(
            source_faculty_id=faculty1.id,
            source_week=week_start,
            target_faculty_id=faculty2.id,
            target_week=None,  ***REMOVED*** No target week for absorb
            swap_type="absorb",
        ...
        ***REMOVED*** Verify assignments were transferred
        week_assignments = (
            db.query(Assignment)
            .join(Block)
    ...
    def test_execute_swap_with_call_cascade(self, db, sample_faculty):
        ...
        ***REMOVED*** Create week starting on Monday
        week_start = date(2025, 1, 6)  ***REMOVED*** Monday, Jan 6, 2025

        ***REMOVED*** Create blocks for the week
        for day_offset in range(7):
            for time in ["AM", "PM"]:
                block = Block(
                    id=uuid4(),
        ...
        ***REMOVED*** Create call assignment for Friday (day 4)
        ...
        ***REMOVED*** Create call assignment for Saturday (day 5)
        ...
        ***REMOVED*** Verify call assignments were transferred
    ...
    def test_execute_swap_failure_rolls_back(self, db, sample_faculty):
        ...
        ***REMOVED*** Try to execute swap with invalid target faculty (doesn't exist)
        executor = SwapExecutor(db)
        result = executor.execute_swap(
            source_faculty_id=faculty1.id,
            source_week=date(2025, 1, 6),
            target_faculty_id=uuid4(),  ***REMOVED*** Non-existent faculty
            target_week=None,
            swap_type="absorb",
        )

        ***REMOVED*** Should handle gracefully and not create partial data
        ***REMOVED*** In this case, the swap record might be created but assignments won't change
        ***REMOVED*** The important thing is that we don't have inconsistent state

    ***REMOVED*** ========================================================================
    ***REMOVED*** Rollback Swap Tests
    ***REMOVED*** ========================================================================
    ...
    def test_rollback_swap_success(self, db, sample_faculty):
        ...
        ***REMOVED*** Verify assignments were transferred to faculty2
        ...
        ***REMOVED*** Verify swap record status
        ...
        ***REMOVED*** Verify assignments were restored to faculty1
    ...
    def test_rollback_swap_invalid_status(self, db, sample_faculty):
        ...
        ***REMOVED*** Create a swap record with PENDING status
    ...
    def test_rollback_swap_expired_window(self, db, sample_faculty):
        ...
        ***REMOVED*** Create a swap record executed 25 hours ago (past 24-hour window)
        ...
        ***REMOVED*** Try to rollback
        ...
        assert "24" in result.message  ***REMOVED*** Mentions the 24-hour window

    ***REMOVED*** ========================================================================
    ***REMOVED*** Can Rollback Tests
    ***REMOVED*** ========================================================================
    ...
    def test_can_rollback_within_window(self, db, sample_faculty):
        ...
        ***REMOVED*** Create recently executed swap
        swap_record = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty1.id,
            source_week=date(2025, 1, 6),
            ...
            swap_type=SwapType.ABSORB,
            status=SwapStatus.EXECUTED,
            executed_at=datetime.utcnow() - timedelta(hours=2),  ***REMOVED*** 2 hours ago
        )
        db.add(swap_record)
        db.commit()
    ...
    def test_can_rollback_outside_window(self, db, sample_faculty):
        ...
        ***REMOVED*** Create old executed swap
        swap_record = SwapRecord(
            id=uuid4(),
            source_faculty_id=faculty1.id,
            source_week=date(2025, 1, 6),
            ...
            swap_type=SwapType.ABSORB,
            status=SwapStatus.EXECUTED,
            executed_at=datetime.utcnow() - timedelta(hours=30),  ***REMOVED*** 30 hours ago
        )
        db.add(swap_record)
        db.commit()
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_execute_swap_with_enum_type(self, db, sample_faculty):
        ...
        ***REMOVED*** Create blocks
        ...
        result = executor.execute_swap(
            ...
            target_faculty_id=faculty2.id,
            target_week=None,
            swap_type=SwapType.ABSORB,  ***REMOVED*** Using enum directly
        )
    ...
    def test_execute_swap_preserves_executed_by(self, db, sample_faculty, admin_user):
        ...
        ***REMOVED*** Verify executed_by_id was saved
        swap_record = db.query(SwapRecord).filter(SwapRecord.id == result.swap_id).first()
