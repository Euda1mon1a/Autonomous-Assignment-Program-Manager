...
class TestBlockService:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_blocks_filter_by_start_date(self, db):
        ...
        ***REMOVED*** Create blocks on specific dates
        ...
        assert result["total"] == 2  ***REMOVED*** block2 and block3
    ...
    def test_list_blocks_filter_by_end_date(self, db):
        ...
        ***REMOVED*** Create blocks on specific dates
        ...
        assert result["total"] == 2  ***REMOVED*** block1 and block2
    ...
    def test_list_blocks_filter_by_date_range(self, db):
        ...
        ***REMOVED*** Should return blocks for days 3, 4, 5, 6, 7 (5 blocks)
    ...
    def test_list_blocks_multiple_filters(self, db):
        ...
        ***REMOVED*** Days 3-5 have block_number=1 (3 blocks)
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_create_block_auto_calculates_is_weekend(self, db):
        ...
        ***REMOVED*** Create block on a weekday (Monday = 0)
        weekday = date(2025, 1, 6)  ***REMOVED*** Monday
        result = service.create_block(
            block_date=weekday,
            time_of_day="AM",
        )
        ...
        ***REMOVED*** Create block on a weekend (Saturday = 5)
        weekend = date(2025, 1, 11)  ***REMOVED*** Saturday
        result = service.create_block(
            block_date=weekend,
            time_of_day="PM",
        )
        ...
        ***REMOVED*** Sunday (6)
        sunday = date(2025, 1, 12)  ***REMOVED*** Sunday
        result = service.create_block(
            block_date=sunday,
            time_of_day="AM",
        )
    ...
    def test_create_block_with_all_fields(self, db):
        ...
        service = BlockService(db)
        block_date = date(2025, 7, 4)  ***REMOVED*** Independence Day
    ...
    def test_create_block_different_times_same_day(self, db):
        ...
        ***REMOVED*** Create PM block (should succeed)
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_generate_blocks_single_day(self, db):
        ...
        ***REMOVED*** Should create 2 blocks (AM and PM)
        assert result["total"] == 2
    ...
    def test_generate_blocks_one_week(self, db):
        ...
        ***REMOVED*** 7 days * 2 times per day = 14 blocks
        assert result["total"] == 14
    ...
    def test_generate_blocks_calculates_block_numbers(self, db):
        ...
        service = BlockService(db)
        start = date(2025, 1, 1)
        end = date(2025, 1, 30)  ***REMOVED*** 30 days (slightly over 1 block period)

        result = service.generate_blocks(start, end, base_block_number=10)

        ***REMOVED*** Blocks on days 0-27 should be block_number 10
        ***REMOVED*** Blocks on days 28-29 should be block_number 11
    ...
    def test_generate_blocks_sets_is_weekend_correctly(self, db):
        ...
        service = BlockService(db)
        ***REMOVED*** Start on Monday Jan 6, 2025
        start = date(2025, 1, 6)  ***REMOVED*** Monday
        end = date(2025, 1, 12)  ***REMOVED*** Sunday

        result = service.generate_blocks(start, end)

        ***REMOVED*** Check weekend flags
        for block in result["items"]:
            weekday = block.date.weekday()
            if weekday >= 5:  ***REMOVED*** Saturday or Sunday
    ...
    def test_generate_blocks_skips_existing(self, db):
        ...
        ***REMOVED*** Should create 5 blocks (3 days * 2 - 1 existing)
        assert result["total"] == 5

        ***REMOVED*** Verify the existing block is still there
    ...
    def test_generate_blocks_large_range(self, db):
        ...
        ***REMOVED*** 365 days * 2 times per day = 730 blocks
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_generate_blocks_empty_range(self, db):
        ...
        end = date(2025, 11, 10)  ***REMOVED*** Before start

        result = service.generate_blocks(start, end)

        ***REMOVED*** Should create no blocks
        assert result["total"] == 0
        assert len(result["items"]) == 0
    ...
    def test_list_blocks_date_boundary_inclusive(self, db):
        ...
        ***REMOVED*** Should include all three (boundaries are inclusive)
        assert result["total"] == 3
