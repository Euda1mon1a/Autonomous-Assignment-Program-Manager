...
class TestPDFReportGenerator:
    ...
    def test_create_table_with_header_row(self, pdf_generator):
        ...
        ***REMOVED*** Verify table has style applied
    ...
    def test_create_table_with_custom_column_widths(self, pdf_generator):
        ...
        ***REMOVED*** Arrange
        ...
        col_widths = [1.5, 2.0, 1.0]  ***REMOVED*** In inches
    ...
    def test_generate_pdf_returns_bytes(self, pdf_generator):
        ...
        ***REMOVED*** PDF files start with %PDF
    ...
    def test_generate_pdf_with_table(self, pdf_generator):
        ...
        ***REMOVED*** Assert
        assert isinstance(pdf_bytes, bytes)
        assert len(pdf_bytes) > 1000  ***REMOVED*** Should have substantial content
    ...
    def test_create_metadata_estimates_page_count(self, pdf_generator):
        ...
        ***REMOVED*** Roughly 3KB = 1 page, so 9KB should estimate 3 pages
        pdf_bytes = b"x" * 9000
    ...
    def test_page_dimensions_are_letter_size(self, pdf_generator):
        ...
        ***REMOVED*** Assert
        ***REMOVED*** Letter size is 8.5 x 11 inches = 612 x 792 points
    ...
    def test_generate_complex_multi_section_report(self, pdf_generator):
        ...
        ***REMOVED*** Assert
        assert isinstance(pdf_bytes, bytes)
        assert len(pdf_bytes) > 2000  ***REMOVED*** Multi-section report should be substantial
        assert pdf_bytes[:4] == b"%PDF"
