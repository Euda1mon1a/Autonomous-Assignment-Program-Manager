...
***REMOVED*** ============================================================================
***REMOVED*** Certification Type Operations Tests
***REMOVED*** ============================================================================
...
class TestCertificationTypeOperations:
    ...
    def test_create_certification_type_with_defaults(self, db):
        ...
        assert result["error"] is None
        cert_type = result["certification_type"]
        assert cert_type.renewal_period_months == 24  ***REMOVED*** Default
        assert cert_type.required_for_residents is True  ***REMOVED*** Default
        assert cert_type.required_for_faculty is True  ***REMOVED*** Default
...
***REMOVED*** ============================================================================
***REMOVED*** Person Certification Operations Tests
***REMOVED*** ============================================================================
...
class TestPersonCertificationOperations:
    ...
    def test_list_certifications_for_person_exclude_expired(
        ...
        assert result["total"] == 2  ***REMOVED*** Both are current (not expired)
        assert len(result["items"]) == 2
    ...
    def test_create_person_certification_success(
        ...
        assert cert.status == "current"  ***REMOVED*** Far future expiration
    ...
    def test_create_person_certification_expiring_soon_status(
        ...
        expires = date.today() + timedelta(days=60)  ***REMOVED*** Within 180 days
    ...
    def test_create_person_certification_expired_status(
        ...
        expires = date.today() - timedelta(days=50)  ***REMOVED*** Already expired
    ...
    def test_renew_certification_success(self, db, expiring_soon_certification):
        ...
        ***REMOVED*** Reminder flags should be reset
...
***REMOVED*** ============================================================================
***REMOVED*** Expiration & Compliance Tests
***REMOVED*** ============================================================================
...
class TestExpirationAndCompliance:
    ...
    def test_get_expiring_certifications_default_180_days(
        ...
        ***REMOVED*** expiring_soon_certification expires in 60 days, should be included
        ***REMOVED*** current_certification expires in 365 days, should NOT be included
        ***REMOVED*** expired_certification already expired, should NOT be included
    ...
    def test_get_expiring_certifications_custom_days(
        ...
        ***REMOVED*** Only certifications expiring within 30 days
        ***REMOVED*** expiring_soon_certification expires in 60 days, should NOT be included
        assert result["total"] == 0

        ***REMOVED*** Test with 90 days
    ...
    def test_get_compliance_summary(
        ...
        assert result["total"] == 3
        assert result["current"] == 2  ***REMOVED*** current and expiring_soon
        assert result["expired"] == 1
        assert result["expiring_soon"] == 1
        ***REMOVED*** Compliance rate should be (2/3) * 100 = 66.67
    ...
    def test_get_compliance_summary_empty(self, db):
        ...
        assert result["compliance_rate"] == 100  ***REMOVED*** Default when none exist
    ...
    def test_get_person_compliance_with_missing_certs(
        ...
        assert result["error"] is None
        ***REMOVED*** Person has no certifications but 2 are required
    ...
    def test_get_certifications_needing_reminder(self, db, expiring_soon_certification):
        ...
        service = CertificationService(db)
        ***REMOVED*** expiring_soon_certification expires in 60 days
    ...
    def test_mark_reminder_sent_success(self, db, expiring_soon_certification):
        ...
        ***REMOVED*** Verify reminder was marked
    ...
    def test_update_all_statuses(
        ...
        ***REMOVED*** Manually set wrong statuses
        current_certification.status = "expired"  ***REMOVED*** Wrong
        expiring_soon_certification.status = "current"  ***REMOVED*** Wrong
        db.commit()

        service = CertificationService(db)
        count = service.update_all_statuses()

        ***REMOVED*** Should have updated 2 certifications
        assert count == 2

        ***REMOVED*** Verify statuses are corrected
