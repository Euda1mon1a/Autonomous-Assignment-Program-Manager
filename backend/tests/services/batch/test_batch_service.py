...
class TestBatchService:
    ...
    def test_create_batch_success(
        ...
        ***REMOVED*** Mock validator to return valid result
        with patch.object(
            ...
            ***REMOVED*** Mock processor to return successful results
            with patch.object(
    ...
    def test_create_batch_validation_failure(
        ...
        ***REMOVED*** Mock validator to return invalid result
        with patch.object(
            batch_service.validator,
            "validate_create_batch",
            return_value=BatchValidationResult(
    ...
    def test_create_batch_dry_run(
        ...
        ***REMOVED*** Assert
        ...
        assert response.completed_at is not None
        ***REMOVED*** Processor should not be called in dry run
    ...
    def test_create_batch_partial_success(
        ...
        ***REMOVED*** Mock validator to return valid result
        with patch.object(
            ...
            ***REMOVED*** Mock processor to return mixed results
            with patch.object(
                batch_service.processor,
                "process_create_batch",
                new_callable=AsyncMock,
    ...
    def test_create_batch_exception_handling(
        ...
        ***REMOVED*** Mock validator to raise exception
        with patch.object(
            batch_service.validator,
            "validate_create_batch",
