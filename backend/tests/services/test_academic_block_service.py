...
class TestAcademicBlockService:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Parse Academic Year Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Generate Academic Blocks Tests
    ***REMOVED*** ========================================================================
    ...
    def test_generate_academic_blocks_full_year(self, db):
        ...
        ***REMOVED*** Should generate 13 blocks (52 weeks / 4 weeks per block)
    ...
    def test_generate_academic_blocks_contiguous_dates(self, db):
        ...
        for i in range(len(blocks) - 1):
            ...
            ***REMOVED*** Next block should start the day after current block ends
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_get_residents_all(self, db, sample_residents):
        ...
        ***REMOVED*** Verify ResidentRow schema
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Get Assignments in Range Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_assignments_in_range_with_data(self, db, sample_assignment):
        ...
        ***REMOVED*** Verify eager loading worked
    ...
    def test_get_assignments_in_range_exact_boundaries(self, db):
        ...
        ***REMOVED*** Create blocks and assignments on specific dates
        resident = Person(
            id=uuid4(),
            name="Test Resident",
            type="resident",
        ...
        ***REMOVED*** Create 3 blocks on consecutive days
        ...
        ***REMOVED*** Query for middle date only
        assignments = service._get_assignments_in_range(
        ...
        ***REMOVED*** Query for all three dates
        assignments = service._get_assignments_in_range(
            start_date=date(2024, 7, 1),
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Get Primary Rotation Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_primary_rotation_single_rotation(self, db, sample_rotation_template):
        ...
        ***REMOVED*** Create assignment with rotation template
        assignment = Assignment(
            id=uuid4(),
        ...
        assert abbr == "SM"  ***REMOVED*** From sample_rotation_template
    ...
    def test_get_primary_rotation_multiple_same(self, db, sample_rotation_template):
        ...
        ***REMOVED*** Create multiple assignments to same rotation
        assignments = [
            Assignment(
                id=uuid4(),
                rotation_template_id=sample_rotation_template.id,
    ...
    def test_get_primary_rotation_multiple_different_picks_most_common(self, db):
        ...
        ***REMOVED*** Create two rotation templates
        ...
        ***REMOVED*** 3 assignments to rotation1, 2 to rotation2
        assignments = [
            Assignment(
                id=uuid4(),
    ...
    def test_get_primary_rotation_with_activity_override(self, db):
        ...
        assert abbr == "VAC"  ***REMOVED*** First 3 chars uppercase
    ...
    def test_get_primary_rotation_mixed_template_and_override(self, db):
        ...
        ***REMOVED*** 2 with template, 3 with override
        assignments = [
            Assignment(
                id=uuid4(),
                rotation_template_id=rotation.id,
        ...
        ***REMOVED*** "Leave" appears 3 times vs "CLI" 2 times
        assert abbr == "LEA"
    ...
    def test_get_primary_rotation_no_abbreviation_uses_first_three_chars(self, db):
        ...
        rotation = RotationTemplate(
            id=uuid4(),
            name="Surgery",
            abbreviation=None,  ***REMOVED*** No abbreviation
            activity_type="outpatient",
        )
        ...
        assert abbr == "SUR"  ***REMOVED*** First 3 chars of "Surgery"
        assert full_name == "Surgery"

    ***REMOVED*** ========================================================================
    ***REMOVED*** Check ACGME Compliance Tests
    ***REMOVED*** ========================================================================
    ...
    def test_check_acgme_compliance_compliant(self, db, sample_resident):
        ...
        ***REMOVED*** 70 hours per week average (compliant)
        hours = 70 * 4  ***REMOVED*** 280 hours over 4 weeks
    ...
    def test_check_acgme_compliance_violation_over_80_hours(self, db, sample_resident):
        ...
        ***REMOVED*** 85 hours per week average (violation)
        hours = 85 * 4  ***REMOVED*** 340 hours over 4 weeks
    ...
    def test_check_acgme_compliance_warning_approaching_limit(
        ...
        ***REMOVED*** 77 hours per week (warning range: 75-80)
        hours = 77 * 4  ***REMOVED*** 308 hours over 4 weeks
        ...
        assert status.is_compliant is True  ***REMOVED*** Still compliant
        assert len(status.violations) == 0
    ...
    def test_check_acgme_compliance_with_validator_violations(
        ...
        ***REMOVED*** Setup mock validator
        mock_validator = MagicMock()
        mock_validator_class.return_value = mock_validator

        ***REMOVED*** Mock violation from 24+4 rule
    ...
    def test_check_acgme_compliance_validator_exception_handled(
        ...
        ***REMOVED*** Setup mock validator that raises exception
        mock_validator = MagicMock()
        mock_validator_class.return_value = mock_validator
        ...
        ***REMOVED*** Should not crash, but add warning
        assert len(status.warnings) > 0
        assert "Error checking ACGME compliance" in status.warnings[0]

    ***REMOVED*** ========================================================================
    ***REMOVED*** Calculate Matrix Summary Tests
    ***REMOVED*** ========================================================================
    ...
    def test_calculate_matrix_summary_basic(self, db, sample_residents):
        ...
        ***REMOVED*** Create mock residents
        residents = service._get_residents()

        ***REMOVED*** Create mock cells (all compliant)
        cells = [
            type(
                "MatrixCell",
                (),
            ...
            for i in range(13)  ***REMOVED*** 13 blocks
        ]
    ...
    def test_calculate_matrix_summary_with_violations(self, db, sample_residents):
        ...
        ***REMOVED*** 10 compliant, 3 non-compliant
        compliant_cells = [
            type(
                "MatrixCell",
                (),
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Calculate Block Summary Tests
    ***REMOVED*** ========================================================================
    ...
    def test_calculate_block_summary_with_assignments(
        ...
        ***REMOVED*** Create blocks and assignments
        ...
        for db_block in blocks_list:
            ...
            db.add(assignment)
            assignment.block = db_block  ***REMOVED*** Set relationship
            assignments.append(assignment)

        db.commit()

        ***REMOVED*** Refresh to get relationships
        ...
        assert summary.total_assignments == 56  ***REMOVED*** 28 days * 2 times
        assert summary.total_residents == 1
        assert summary.compliance_rate == 100.0  ***REMOVED*** Within limits
    ...
    def test_calculate_block_summary_empty_assignments(self, db):
        ...
        assert summary.total_residents == 0
        assert summary.compliance_rate == 100.0  ***REMOVED*** No violations
        assert summary.average_hours == 0.0

    ***REMOVED*** ========================================================================
    ***REMOVED*** List Academic Blocks Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Get Block Matrix Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_block_matrix_structure(self, db, sample_residents):
        ...
        assert response.academic_year == "2024-2025"
        assert len(response.columns) == 13  ***REMOVED*** 13 blocks
        assert len(response.rows) == 3  ***REMOVED*** 3 residents
        ***REMOVED*** 3 residents × 13 blocks = 39 cells
    ...
    def test_get_block_matrix_with_assignments(
        ...
        ***REMOVED*** Create blocks and assignments for first week of academic year
        resident = sample_residents[0]
        start_date = date(2024, 7, 1)
        ...
        ***REMOVED*** First cell (resident 0, block 0) should have rotation info
        first_cell = next(
            (c for c in response.cells if c.row_index == 0 and c.column_index == 0),
            None,
        )
        assert first_cell is not None
        assert first_cell.rotation == "SM"  ***REMOVED*** From sample_rotation_template
        assert first_cell.hours == 84.0  ***REMOVED*** 7 days * 2 times * 6 hours
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_full_workflow_with_real_data(
        ...
        ***REMOVED*** Create blocks for first block period (28 days)
        start_date = date(2024, 7, 1)
        for i in range(28):
            block_date = start_date + timedelta(days=i)
            for time_of_day in ["AM", "PM"]:
                ...
                ***REMOVED*** Assign all residents to this block
        ...
        ***REMOVED*** Generate matrix
        response = service.get_block_matrix("2024-2025")

        ***REMOVED*** Verify results
        assert len(response.rows) == 3  ***REMOVED*** All residents
        assert len(response.columns) == 13  ***REMOVED*** All blocks
        assert response.summary["total_residents"] == 3

        ***REMOVED*** First block should have all residents assigned
        ...
        ***REMOVED*** 28 days * 2 times * 6 hours = 336 hours
