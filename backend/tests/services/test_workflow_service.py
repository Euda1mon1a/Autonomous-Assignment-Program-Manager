...
***REMOVED*** ============================================================================
***REMOVED*** Template Management Tests
***REMOVED*** ============================================================================
...
class TestTemplateManagement:
    ...
    def test_create_template_invalid_definition_error(self, db):
        ...
        ***REMOVED*** Mock the engine to raise ValueError
        with patch.object(
            service.engine,
            "create_template",
    ...
    def test_create_template_database_rollback_on_error(self, db, sample_workflow_definition):
        ...
        ***REMOVED*** Mock the engine to raise an exception
        with patch.object(
            service.engine,
            "create_template",
    ...
    def test_list_templates_active_only(self, db, sample_workflow_definition, admin_user):
        ...
        ***REMOVED*** Create active and inactive templates
    ...
    def test_list_templates_filter_by_tags(self, db, sample_workflow_definition, admin_user):
        ...
        ***REMOVED*** Create templates with different tags
        ...
        ***REMOVED*** Should include template1 but not template2
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Instance Management Tests
***REMOVED*** ============================================================================
...
class TestWorkflowInstanceManagement:
    ...
    def test_start_workflow_async_success(
        ...
        ***REMOVED*** Mock the engine methods
        ...
        with patch.object(
            ...
            ***REMOVED*** Verify async task was created
    ...
    def test_start_workflow_inactive_template_error(
        ...
        ***REMOVED*** Deactivate the template
    ...
    def test_cancel_workflow_success(
        ...
        ***REMOVED*** Set instance to running state
...
***REMOVED*** ============================================================================
***REMOVED*** Query and Monitoring Tests
***REMOVED*** ============================================================================
...
class TestQueryAndMonitoring:
    ...
    def test_get_running_workflows_with_limit(self, db):
        ...
        with patch.object(
            ...
            ***REMOVED*** Verify that limit was passed to query
    ...
    def test_get_failed_workflows_with_time_filter(self, db):
        ...
        with patch.object(
            ...
            ***REMOVED*** Verify that created_after was passed
            mock_query.assert_called_once()
            call_kwargs = mock_query.call_args[1]
...
***REMOVED*** ============================================================================
***REMOVED*** Common Workflow Templates Tests
***REMOVED*** ============================================================================
...
class TestCommonWorkflowTemplates:
    ...
    def test_schedule_generation_workflow_has_correct_steps(self, db, admin_user):
        ...
        ***REMOVED*** Verify all required steps are present
    ...
    def test_schedule_generation_workflow_has_error_handlers(self, db, admin_user):
        ...
        ***REMOVED*** Verify error handlers are configured
    ...
    def test_schedule_generation_workflow_has_timeout(self, db, admin_user):
        ...
        assert result.definition["default_timeout_seconds"] == 1800  ***REMOVED*** 30 minutes
    ...
    def test_schedule_generation_workflow_parallel_steps(self, db, admin_user):
        ...
        ***REMOVED*** These steps should run in parallel
...
class TestEdgeCases:
    ...
    def test_multiple_template_versions(self, db, sample_workflow_definition, admin_user):
        ...
        ***REMOVED*** Get template by name should return latest version
    ...
    def test_list_templates_ordering(self, db, sample_workflow_definition, admin_user):
        ...
        ***REMOVED*** Create multiple templates with different names and versions
        ...
        ***REMOVED*** Verify ordering: a_workflow v2, a_workflow v1, b_workflow v1
        template_names_versions = [(t.name, t.version) for t in result]

        ***REMOVED*** Find indices of our templates
        ...
        ***REMOVED*** Verify ordering if all found
        if a_v2_idx is not None and a_v1_idx is not None:
            assert a_v2_idx < a_v1_idx  ***REMOVED*** v2 before v1
        if a_v1_idx is not None and b_v1_idx is not None:
            assert a_v1_idx < b_v1_idx  ***REMOVED*** a before b
    ...
    def test_workflow_service_reuses_database_session(self, db):
        ...
        ***REMOVED*** Verify the service uses the same session
