...
def expired_credential(db, sample_faculty, sample_procedure) -> ProcedureCredential:
    ...
    ***REMOVED*** Create a different procedure for expired credential
    ...
    credential = ProcedureCredential(
        ...
        expiration_date=date.today() - timedelta(days=30),  ***REMOVED*** Expired 30 days ago
    )
    db.add(credential)
    db.commit()
    db.refresh(credential)
...
***REMOVED*** ============================================================================
***REMOVED*** List Credentials Tests
***REMOVED*** ============================================================================
...
class TestListCredentialsForPerson:
    ...
    def test_list_credentials_for_person_exclude_expired(
        ...
        ***REMOVED*** Should only include the active, non-expired credential
        assert result["total"] == 1
        assert result["items"][0].id == sample_credential.id
    ...
    def test_list_credentials_for_person_include_expired(
        ...
        ***REMOVED*** Should include both active and expired credentials
...
***REMOVED*** ============================================================================
***REMOVED*** List Qualified Faculty Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** List Procedures for Faculty Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Is Faculty Qualified Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Create Credential Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Update Credential Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Delete Credential Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Suspend/Activate Credential Tests
***REMOVED*** ============================================================================
...
class TestSuspendActivateCredential:
    ...
    def test_activate_credential_success(self, db, sample_credential):
        ...
        ***REMOVED*** First suspend it
        service = CredentialService(db)
        service.suspend_credential(sample_credential.id)

        ***REMOVED*** Then activate it
...
***REMOVED*** ============================================================================
***REMOVED*** Verify Credential Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** List Expiring Credentials Tests
***REMOVED*** ============================================================================
...
class TestListExpiringCredentials:
    ...
    def test_list_expiring_credentials_default_30_days(self, db, sample_faculty):
        ...
        ***REMOVED*** Create credential expiring in 15 days
    ...
    def test_list_expiring_credentials_custom_days(self, db, sample_faculty):
        ...
        ***REMOVED*** Create credential expiring in 60 days
    ...
    def test_list_expiring_credentials_excludes_far_future(
        ...
        ***REMOVED*** sample_credential expires in 365 days, should not be included
        assert result["total"] == 0
...
***REMOVED*** ============================================================================
***REMOVED*** Get Faculty Credential Summary Tests
***REMOVED*** ============================================================================
...
class TestGetFacultyCredentialSummary:
    ...
    def test_get_faculty_credential_summary_success(
        ...
        assert result["expiring_soon"] == 0  ***REMOVED*** Expires in 365 days
...
***REMOVED*** ============================================================================
***REMOVED*** Bulk Create Credentials Tests
***REMOVED*** ============================================================================
...
class TestBulkCreateCredentials:
    ...
    def test_bulk_create_credentials_partial_success(
        ...
        ***REMOVED*** sample_credential already exists for one procedure
    ...
    def test_bulk_create_credentials_with_defaults(
        ...
        assert result["total_created"] == 3
        ***REMOVED*** Verify defaults were applied
    ...
    def test_bulk_create_credentials_all_failures(self, db, sample_resident):
        ...
        ***REMOVED*** Using a resident should fail all creations
...
class TestEdgeCases:
    ...
    def test_credential_is_valid_property(self, db, sample_credential):
        ...
        ***REMOVED*** Active credential with future expiration should be valid
    ...
    def test_multiple_faculty_same_procedure(self, db, sample_procedure):
        ...
        ***REMOVED*** Create credentials for both faculty
        ...
        ***REMOVED*** Verify both are qualified
    ...
    def test_credential_without_expiration_never_expires(self, db, sample_faculty):
        ...
        result = service.create_credential(
            person_id=sample_faculty.id,
            procedure_id=procedure.id,
            expiration_date=None,  ***REMOVED*** No expiration
        )
    ...
    def test_updates_persist_across_service_instances(
        ...
        ***REMOVED*** Create new service instance and verify change persisted
