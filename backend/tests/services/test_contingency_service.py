...
def mock_assignments(mock_faculty, mock_blocks):
    ...
    ***REMOVED*** Create diverse assignment patterns
    ***REMOVED*** Faculty 0 covers blocks 0-3 (heavy load)
    for i in range(4):
    ...
    ***REMOVED*** Faculty 1 covers blocks 2-5 (overlaps with faculty 0)
    for i in range(2, 6):
        assignments.append(MockAssignment(
    ...
    ***REMOVED*** Faculty 2 is sole provider for block 6 (critical)
    assignments.append(MockAssignment(
        person_id=mock_faculty[2].id,
        block_id=mock_blocks[6].id,
    ))

    ***REMOVED*** Faculty 3 covers blocks 0, 6 (light load)
    assignments.append(MockAssignment(
    ...
    ***REMOVED*** Faculty 4 has no assignments (available backup)
    ***REMOVED*** No assignments for faculty 4
...
def create_service_with_mock_data(mock_db, faculty, blocks, assignments):
    ...
    ***REMOVED*** Mock the _load_data method
...
***REMOVED*** ============================================================================
***REMOVED*** VulnerabilityInfo Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** ContingencyService Initialization Tests
***REMOVED*** ============================================================================
...
class TestN1Simulation:
    ...
    def test_simulate_single_loss_no_impact(self, mock_db, mock_faculty, mock_blocks, mock_assignments):
        ...
        ***REMOVED*** Simulate loss of faculty 0 (blocks 0-3 are covered)
        ***REMOVED*** Blocks 0, 2, 3 have backup; block 1 may not
    ...
    def test_simulate_single_loss_critical(self, mock_db, mock_faculty, mock_blocks, mock_assignments):
        ...
        ***REMOVED*** Simulate loss of faculty 2 (sole provider for block 6)
        result = service._simulate_single_loss(
            mock_faculty[2], mock_blocks, mock_assignments,
            coverage_requirements, lookups
        )

        ***REMOVED*** Block 6 should be affected but faculty 3 also covers it
    ...
    def test_n1_simulation_optimized(self, mock_db, mock_faculty, mock_blocks, mock_assignments):
        ...
        ***REMOVED*** Should have simulation for each faculty
        assert len(simulations) == len(mock_faculty)

        ***REMOVED*** Faculty 4 (no assignments) should have 0 blocks affected
    ...
    def test_severity_calculation_high(self, mock_db):
        ...
        severity = service._calculate_severity(
            affected_blocks=15,
            is_unique=False,
            total_blocks=50,  ***REMOVED*** 30% affected
        )
    ...
    def test_severity_calculation_medium(self, mock_db):
        ...
        severity = service._calculate_severity(
            affected_blocks=7,
            is_unique=False,
            total_blocks=100,  ***REMOVED*** 7% affected
        )
    ...
    def test_severity_calculation_low(self, mock_db):
        ...
        severity = service._calculate_severity(
            affected_blocks=2,
            is_unique=False,
            total_blocks=100,  ***REMOVED*** 2% affected
        )
...
class TestN2Simulation:
    ...
    def test_n2_simulation_optimized(self, mock_db, mock_faculty, mock_blocks, mock_assignments):
        ...
        ***REMOVED*** Create some vulnerabilities for N-2 to focus on
        n1_vulns = [
            VulnerabilityInfo(
        ...
        ***REMOVED*** Should return a list (possibly empty)
        assert isinstance(fatal_pairs, list)


***REMOVED*** ============================================================================
***REMOVED*** Centrality Calculation Tests
***REMOVED*** ============================================================================
...
class TestCentralityCalculation:
    ...
    def test_calculate_centrality_basic(self, mock_db, mock_faculty, mock_blocks, mock_assignments):
        ...
        services = {}  ***REMOVED*** Empty services mapping
        ...
        ***REMOVED*** Scores should be sorted descending
    ...
    def test_calculate_centrality_with_services(self, mock_db, mock_faculty, mock_blocks, mock_assignments):
        ...
        ***REMOVED*** Create service mapping where faculty 2 is sole provider for a service
        services = {
            uuid4(): [mock_faculty[0].id, mock_faculty[1].id],  ***REMOVED*** Shared
            uuid4(): [mock_faculty[2].id],  ***REMOVED*** Sole provider
        }
...
class TestFullAnalysis:
    ...
    def test_analyze_contingency_skip_n2(self, mock_db, mock_faculty, mock_blocks, mock_assignments):
        ...
        ***REMOVED*** N-2 should pass (not run, so default to pass)
        assert result.n2_pass is True
        assert len(result.n2_fatal_pairs) == 0
...
***REMOVED*** ============================================================================
***REMOVED*** Vulnerability Assessment Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Single Faculty Simulation Tests
***REMOVED*** ============================================================================
