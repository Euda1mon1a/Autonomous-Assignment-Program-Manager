...
class TestBatchProcessor:
    ...
    ***REMOVED*** ========================================================================
    ...
    async def test_process_create_batch_with_error_rollback(
        ...
        ***REMOVED*** Create valid and invalid batch data
        batch_data = [
            BatchAssignmentCreate(
                block_id=sample_block.id,
                person_id=sample_resident.id,
            ...
            BatchAssignmentCreate(
                block_id=uuid4(),  ***REMOVED*** Invalid block ID
                person_id=sample_resident.id,
                role="primary",
            ),
        ]
        ...
        ***REMOVED*** First should succeed, second should fail
    ...
    async def test_process_create_batch_without_rollback(
        ...
        batch_data = [
            ...
            BatchAssignmentCreate(
                block_id=uuid4(),  ***REMOVED*** Invalid
                person_id=sample_resident.id,
                role="primary",
            ),
            BatchAssignmentCreate(
    ...
    ***REMOVED*** ========================================================================
    ...
    async def test_process_update_batch_optimistic_locking(self, db, sample_assignment):
        ...
        ***REMOVED*** Simulate another update
