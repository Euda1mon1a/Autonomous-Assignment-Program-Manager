...
class TestJSONExporter:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Export Analytics Tests
    ***REMOVED*** ========================================================================
    ...
    async def test_export_analytics_pretty(self):
        ...
        ***REMOVED*** Pretty printed JSON should have newlines and indentation
        assert "\n" in json_str
        assert "  " in json_str
    ...
    async def test_export_analytics_compressed(self):
        ...
        ***REMOVED*** Result should be compressed bytes
        assert isinstance(result, bytes)

        ***REMOVED*** Decompress and verify
