...
class TestEmergencyCoverageEdgeCases:
    ...
    ***REMOVED*** ===== TESTS FOR handle_emergency_absence() =====
    ...
    async def test_handle_emergency_absence_deployment(
        ...
        start = date.today()
        end = start + timedelta(days=180)  ***REMOVED*** 6-month deployment
    ...
    async def test_handle_emergency_absence_no_assignments(
        ...
        ***REMOVED*** Should succeed with no replacements needed
    ...
    async def test_handle_emergency_absence_critical_service(
        ...
        ***REMOVED*** Create critical assignment (call coverage)
        start = date.today()
        block = Block(
            id=uuid4(),
            date=start,
        ...
        ***REMOVED*** Critical service should require manual review if no replacement
    ...
    async def test_handle_emergency_absence_non_critical_service(
        ...
        ***REMOVED*** Non-critical can be cancelled without replacement
    ...
    async def test_handle_emergency_absence_multiple_days(
        ...
        ***REMOVED*** Create assignments for multiple days
        for i in range(6):
        ...
        ***REMOVED*** Should process multiple assignments
    ...
    ***REMOVED*** ===== TESTS FOR _is_critical_service() =====
    ...
    ***REMOVED*** ===== TESTS FOR _find_affected_assignments() =====
    ...
    def test_find_affected_assignments_date_range(
        ...
        ***REMOVED*** Create assignments within range
        for i in range(4):
            day = start + timedelta(days=i)
            block = Block(
                id=uuid4(),
        ...
        ***REMOVED*** Create assignment outside range
        future_block = Block(
            id=uuid4(),
        ...
        ***REMOVED*** Should find only 4 assignments within date range
    ...
    ***REMOVED*** ===== EDGE CASE TESTS =====
    ...
    async def test_handle_emergency_absence_weekend(
        ...
        ***REMOVED*** Find next weekend (Saturday)
        today = date.today()
        days_ahead = (5 - today.weekday()) % 7  ***REMOVED*** 5 = Saturday
