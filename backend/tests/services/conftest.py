...
***REMOVED*** ============================================================================
***REMOVED*** Async Database Fixtures (for async service tests)
***REMOVED*** ============================================================================

***REMOVED*** Use in-memory SQLite with async support
ASYNC_TEST_DATABASE_URL = "sqlite+aiosqlite:///:memory:"

***REMOVED*** Create async engine for tests
...
class AssignmentFactory:
    ...
    def create_bulk_assignments(
        ...
        for i, person in enumerate(people):
            for j, block in enumerate(blocks[:7]):  ***REMOVED*** Assign to first week
                assignment = Assignment(
                    id=uuid4(),
                    person_id=person.id,
                    block_id=block.id,
...
***REMOVED*** ============================================================================
***REMOVED*** Convenience Fixtures (pre-created test data)
***REMOVED*** ============================================================================
