...
class TestAgentMatcher:
    ...
    def test_get_agent_for_task_returns_tuple(self):
        ...
        assert len(result) == 2
        assert isinstance(result[0], str)  ***REMOVED*** agent name
        assert isinstance(result[1], str)  ***REMOVED*** model

    def test_get_agent_for_task_fallback(self):
        """Test fallback agent when no match found."""
        matcher = AgentMatcher(similarity_threshold=1.0)  ***REMOVED*** Impossible threshold
...
class TestSemanticMatching:
    ...
    def matcher(self):
        ...
        matcher = AgentMatcher()
        matcher._loaded = True  ***REMOVED*** Bypass file loading

        ***REMOVED*** Create test agents with distinctive capabilities
    ...
    def test_scheduling_task_matches_scheduler(self, matcher):
        ...
        ***REMOVED*** SCHEDULER should be highly ranked for scheduling tasks
    ...
    def test_compliance_task_matches_validator(self, matcher):
        ...
        assert len(matches) > 0
        ***REMOVED*** ACGME_VALIDATOR should be highly ranked for compliance tasks
    ...
    def test_testing_task_matches_tester(self, matcher):
        ...
        assert len(matches) > 0
        ***REMOVED*** QA_TESTER should be highly ranked for testing tasks
    ...
    def test_different_tasks_get_different_agents(self, matcher):
        ...
        ***REMOVED*** Each task should have a different top recommendation
