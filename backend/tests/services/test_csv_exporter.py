...
***REMOVED*** Note: CSVExporter uses AsyncSession, so we need async fixtures
***REMOVED*** For these tests, we'll use the regular Session with a sync wrapper
...
class TestCSVExporter:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Export Assignments Tests
    ***REMOVED*** ========================================================================
    ...
    async def test_export_assignments_basic(
        ...
        ***REMOVED*** Create a mock async session from sync session
        ***REMOVED*** Since CSVExporter expects AsyncSession, we'll test the logic
        ***REMOVED*** by mocking the database calls or using sync methods

        ***REMOVED*** For this test, we'll verify the format is correct
        ***REMOVED*** In a real scenario, you'd use an async test database
        pass  ***REMOVED*** Placeholder - would need async DB setup
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Compression Tests
    ***REMOVED*** ========================================================================

    def test_compress_content(self):
        """Test gzip compression of CSV content."""
        ***REMOVED*** We can test the compression method directly
        ***REMOVED*** even without async DB
        from app.services.export.csv_exporter import CSVExporter

        exporter = CSVExporter(db=None)  ***REMOVED*** Don't need DB for this test
        test_content = "name,value\ntest1,123\ntest2,456"

        compressed = exporter._compress(test_content)

        ***REMOVED*** Verify it's compressed
        assert isinstance(compressed, bytes)
        assert len(compressed) < len(test_content.encode("utf-8")) + 100

        ***REMOVED*** Verify we can decompress it
        decompressed = gzip.decompress(compressed).decode("utf-8")
        assert decompressed == test_content

    ***REMOVED*** ========================================================================
    ***REMOVED*** Batch Processing Tests
    ***REMOVED*** ========================================================================
    ...
    async def test_export_analytics_data(self, db):
        ...
        ***REMOVED*** This doesn't require database, we can test it
