...
class TestHelperFunctions:
    ...
    def test_calculate_block_dates_block_1(self):
        ...
        assert (end - start).days == 27  ***REMOVED*** 28 days total (0-27)
    ...
    def test_calculate_block_dates_block_13(self):
        ...
        ***REMOVED*** Block 13 starts after 12 * 28 = 336 days
    ...
    def test_format_date_header_single_digit_days(self):
        ...
        ***REMOVED*** Should be "5-Mar", not "05-Mar"
...
class TestLegacyXlsxExporter:
    ...
    def test_initialization(self, db: Session):
        ...
        ***REMOVED*** Default sheet should be removed
    ...
    def test_save_to_bytes_empty_workbook(self, db: Session):
        ...
        ***REMOVED*** Verify it's valid Excel format by loading it back
    ...
    def test_save_to_bytes_with_sheet(self, db: Session):
        ...
        ***REMOVED*** Verify sheet exists when loaded back
        wb = load_workbook(io.BytesIO(bytes_output))
    ...
    def test_generate_block_schedule_empty_database(self, db: Session):
        ...
        ***REMOVED*** Should create sheet even with no data
    ...
    def test_generate_block_schedule_with_residents(
        ...
        ***REMOVED*** Check header has block number
        assert ws["C1"].value == 1

        ***REMOVED*** Verify sheet was created
    ...
    def test_generate_block_schedule_with_assignments(
        ...
        ***REMOVED*** Create assignments for first day
        ...
        ***REMOVED*** Verify schedule was generated
        assert len(exporter.wb.worksheets) == 1
    ...
    def test_generate_block_schedule_with_holidays(self, db: Session):
        ...
        ***REMOVED*** July 4th is a federal holiday
        ...
        ***REMOVED*** Find column for July 4th (should be highlighted)
        ***REMOVED*** Day 4 would be at offset 3 (0-indexed), each day has 2 columns (AM/PM)
        ***REMOVED*** Starting at column F (6), so July 4 AM would be at column 6 + (3 * 2) = 12
        ***REMOVED*** We can verify the sheet exists
        assert ws.title == "Block 1"
    ...
    def test_generate_block_schedule_mixed_pgy_levels(
        ...
        ***REMOVED*** Should have created sheet with residents from different PGY levels
        assert len(exporter.wb.worksheets) == 1
    ...
    def test_generate_block_schedule_faculty_separation(
        ...
        ***REMOVED*** Should have created sheet with both residents and faculty
        assert len(exporter.wb.worksheets) == 1
    ...
    def test_generate_full_year_default_blocks(self, db: Session):
        ...
        ***REMOVED*** Should have 13 sheets (one per block)
        assert len(exporter.wb.worksheets) == 13

        ***REMOVED*** Verify sheet names
        for i in range(1, 14):
    ...
    def test_generate_full_year_with_holidays(self, db: Session):
        ...
        academic_year_start = date(2024, 7, 1)
        federal_holidays = [
            date(2024, 7, 4),  ***REMOVED*** Independence Day
            date(2024, 11, 28),  ***REMOVED*** Thanksgiving
            date(2024, 12, 25),  ***REMOVED*** Christmas
        ]
...
class TestGenerateLegacyXlsx:
    ...
    def test_generate_empty_schedule(self, db: Session):
        ...
        ***REMOVED*** Verify it's valid Excel
    ...
    def test_generate_with_explicit_block_number(self, db: Session):
        ...
        ***REMOVED*** Check block number in cell C1
        ws = wb["Block 5"]
    ...
    def test_generate_with_calculated_block_number(self, db: Session):
        ...
        ***REMOVED*** Start date in August (second month of academic year starting July 1)
        ...
        xlsx_bytes = generate_legacy_xlsx(
            ...
            start_date=start_date,
            end_date=end_date,
            block_number=None,  ***REMOVED*** Let it calculate
        )

        ***REMOVED*** Should auto-calculate block number
        wb = load_workbook(io.BytesIO(xlsx_bytes))
        ***REMOVED*** Aug 1 is 31 days after July 1, so block 2 (31 // 28 = 1, +1 = 2)
    ...
    def test_generate_with_residents_and_assignments(
        ...
        ***REMOVED*** Verify file is valid
        wb = load_workbook(io.BytesIO(xlsx_bytes))
        ws = wb["Block 1"]

        ***REMOVED*** Should have resident name somewhere
    ...
    def test_generate_across_month_boundary(self, db: Session):
        ...
        ***REMOVED*** Start in July, end in August
...
class TestEdgeCases:
    ...
    def test_weekend_highlighting(self, db: Session):
        ...
        ***REMOVED*** Start on a Friday, go through weekend
        start_date = date(2024, 7, 5)  ***REMOVED*** Friday
        end_date = date(2024, 7, 7)  ***REMOVED*** Sunday
    ...
    def test_very_long_provider_name(self, db: Session):
        ...
        ***REMOVED*** Should handle long names without crashing
        wb = load_workbook(io.BytesIO(xlsx_bytes))
        assert len(wb.worksheets) == 1
    ...
    def test_overlapping_absence_and_assignment(
        ...
        ***REMOVED*** Create absence for same day
        absence = Absence(
            id=uuid4(),
            person_id=sample_resident.id,
            start_date=start_date,
        ...
        ***REMOVED*** Should prioritize absence over assignment
        wb = load_workbook(io.BytesIO(xlsx_bytes))
        assert len(wb.worksheets) == 1
...
class TestExcelFormatting:
    ...
    def test_column_widths_set(self, db: Session):
        ...
        ***REMOVED*** Check that specific columns have widths set
    ...
    def test_header_merge_cells(self, db: Session):
        ...
        ***REMOVED*** Check that C1:D3 is merged for block number
    ...
    def test_date_range_in_header(self, db: Session):
        ...
        ***REMOVED*** Check C4 for date range
    ...
    def test_header_labels_present(self, db: Session):
        ...
        ***REMOVED*** Check for expected header labels
