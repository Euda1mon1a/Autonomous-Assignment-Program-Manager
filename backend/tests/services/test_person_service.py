...
class TestPersonService:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_people_no_filters(self, db, sample_residents, sample_faculty_members):
        ...
        ***REMOVED*** Should return all residents and faculty
        assert result["total"] == 6  ***REMOVED*** 3 residents + 3 faculty
    ...
    def test_list_people_filter_by_type_and_pgy(self, db):
        ...
        ***REMOVED*** Create residents with specific PGY levels
        resident1 = Person(
            id=uuid4(),
            name="PGY1 Resident",
            type="resident",
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_list_faculty_filter_by_specialty(self, db):
        ...
        ***REMOVED*** Create faculty with specific specialties
        faculty1 = Person(
            id=uuid4(),
        ...
        ***REMOVED*** Should return faculty1 and faculty3
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Create Person Tests (Resident)
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Create Person Tests (Faculty)
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_update_changes_persist_across_queries(self, db, sample_resident):
        ...
        ***REMOVED*** Update the person
        service.update_person(
            sample_resident.id,
            {"name": "Dr. Persistent Update"},
        )

        ***REMOVED*** Query again with fresh service
