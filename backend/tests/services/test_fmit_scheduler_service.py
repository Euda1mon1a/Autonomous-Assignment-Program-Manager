...
class TestFMITSchedulerService:
    ...
    def fmit_rotation_template(self, db):
        ...
        template = RotationTemplate(
            id=uuid4(),
            name="FMIT",  ***REMOVED*** Must match FMITSchedulerService.FMIT_ROTATION_NAME
    ...
    def week_blocks(self, db):
        ...
        blocks = []
        ***REMOVED*** Use a fixed Monday for reproducibility
    ...
    ***REMOVED*** =========================================================================
    ...
    def test_generate_fair_schedule_success(
        ...
        ***REMOVED*** Each faculty should have some assignments
    ...
    def test_generate_fair_schedule_no_template(self, db, sample_faculty_list):
        ...
        ***REMOVED*** Should still succeed but with warnings about missing template
        ***REMOVED*** The service will create empty schedule
        assert result is not None
    ...
    ***REMOVED*** =========================================================================
    ...
    def test_validate_schedule_detects_coverage_gaps(
        ...
        result = service.validate_schedule(
            start_date=date(2025, 1, 6),
            end_date=date(2025, 1, 19),  ***REMOVED*** 2 weeks
        )

        assert result is not None
        assert not result.valid  ***REMOVED*** No assignments = coverage gaps
    ...
    def test_validate_schedule_clean(
        ...
        ***REMOVED*** Create assignments for all blocks in the week
        ...
        assert result is not None
        ***REMOVED*** Week should have coverage
        assert len(result.coverage_gaps) == 0
    ...
    ***REMOVED*** =========================================================================
    ...
    def test_assign_faculty_to_week_success(
        ...
        assert result.success
        assert len(result.assignment_ids) == 14  ***REMOVED*** 7 days × 2 blocks
    ...
    def test_assign_faculty_to_week_not_found(self, db, fmit_rotation_template):
        ...
        service = FMITSchedulerService(db)
        result = service.assign_faculty_to_week(
            faculty_id=uuid4(),  ***REMOVED*** Non-existent
            week_date=date(2025, 1, 6),
            created_by="test",
        )
    ...
    def test_assign_faculty_to_week_already_assigned(
        ...
        ***REMOVED*** First assignment should succeed
        ...
        ***REMOVED*** Second assignment for same faculty/week should fail
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Remove Faculty From Week Tests
    ***REMOVED*** =========================================================================
    ...
    def test_remove_faculty_from_week_not_found(
        ...
        result = service.remove_faculty_from_week(
            faculty_id=sample_faculty_list[0].id,
            week_date=date(2025, 1, 6),  ***REMOVED*** Not assigned
        )
...
class TestFMITSchedulerIntegration:
    ...
    def test_full_schedule_generation_workflow(
        ...
        ***REMOVED*** 1. Generate fair schedule for a month
        ...
        ***REMOVED*** 2. Get schedule to verify
        ...
        ***REMOVED*** 3. Validate schedule
        validation = service.validate_schedule(
            start_date=date(2025, 1, 1),
            end_date=date(2025, 3, 31),
        )
        ***REMOVED*** Should have mostly valid coverage after generation
    ...
    def test_assign_and_remove_workflow(
        ...
        ***REMOVED*** 2. Verify assignment exists
        ...
        ***REMOVED*** 4. Verify assignment is gone
