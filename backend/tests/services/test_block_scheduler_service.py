...
class TestBlockSchedulerService:
    ...
    def residents_with_leave(self, db: Session) -> list[tuple[Person, Absence]]:
        ...
        ***REMOVED*** Block 5 of 2025 starts July 1 + (5-1)*28 = July 1 + 112 days = Oct 21
        block_start = date(2025, 10, 21)
        block_end = block_start + timedelta(days=27)

        results = []

        ***REMOVED*** Resident 1: Full block vacation
        r1 = Person(
            id=uuid4(),
        ...
        ***REMOVED*** Resident 2: Partial leave (conference)
        r2 = Person(
            id=uuid4(),
            name="Dr. Conference",
            type="resident",
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Block Date Calculation Tests
    ***REMOVED*** =========================================================================
    ...
    def test_get_block_dates_block_1(self, service: BlockSchedulerService):
        ...
        ***REMOVED*** Block 1 starts July 1, 2025
        assert start == date(2025, 7, 1)
        assert end == date(2025, 7, 28)
        assert (end - start).days == 27  ***REMOVED*** 28 days inclusive
    ...
    def test_get_block_dates_block_5(self, service: BlockSchedulerService):
        ...
        ***REMOVED*** Block 5 starts July 1 + 4*28 days = July 1 + 112 days
    ...
    def test_get_block_dates_block_0_orientation(self, service: BlockSchedulerService):
        ...
        ***REMOVED*** Block 0 is orientation, last week before July 1
        assert end == date(2025, 6, 30)
        assert start == date(2025, 6, 24)

    ***REMOVED*** =========================================================================
    ***REMOVED*** Leave Detection Tests
    ***REMOVED*** =========================================================================
    ...
    def test_get_residents_with_leave_in_block(
        ...
        ***REMOVED*** Block 5 of 2025 contains our test leave
        result = service.get_residents_with_leave_in_block(5, 2025)

        assert len(result) == 2

        ***REMOVED*** Check full vacation resident
        ...
        ***REMOVED*** Check partial leave resident
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Rotation Capacity Tests
    ***REMOVED*** =========================================================================
    ...
    def test_get_rotation_capacities(
        ...
        ***REMOVED*** Check leave-eligible rotation
        ...
        ***REMOVED*** Check non-leave-eligible rotation
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Scheduling Algorithm Tests
    ***REMOVED*** =========================================================================
    ...
    def test_schedule_block_assigns_leave_residents_to_leave_eligible(
        ...
        ***REMOVED*** All assignments should be to leave-eligible rotation
    ...
    def test_schedule_block_coverage_priority(
        ...
        ***REMOVED*** Check that non-leave-eligible rotation gets priority
        coverage_assignments = [
            a for a in result.assignments if not a.is_leave_eligible_rotation
        ]

        ***REMOVED*** Should have assignments to non-leave-eligible (FMIT)
        ***REMOVED*** up to its capacity (2)
    ...
    def test_schedule_block_dry_run_does_not_save(
        ...
        ***REMOVED*** Check database has no assignments
        assignments = (
    ...
    def test_schedule_block_saves_when_not_dry_run(
        ...
        ***REMOVED*** Check database has assignments
        assignments = (
            db.query(BlockAssignment)
            .filter(
                BlockAssignment.block_number == 5,
    ...
    def test_schedule_block_identifies_coverage_gaps(
        ...
        ***REMOVED*** No residents to assign, so FMIT will have gaps
        result = service.schedule_block(
            block_number=1,
            academic_year=2025,
            dry_run=True,
        ...
        ***REMOVED*** Find gap for non-leave-eligible rotation
        fmit_gaps = [
            g for g in result.coverage_gaps if g.rotation_name == "FMIT Inpatient"
        ]

        assert len(fmit_gaps) == 1
        assert fmit_gaps[0].gap == 2  ***REMOVED*** max_residents = 2, assigned = 0
        assert fmit_gaps[0].severity == "critical"

    ***REMOVED*** =========================================================================
    ***REMOVED*** Dashboard Tests
    ***REMOVED*** =========================================================================
    ...
    def test_get_dashboard(
        ...
        ***REMOVED*** Check resident counts
        assert dashboard.total_residents == 5  ***REMOVED*** 2 with leave + 3 without
        assert len(dashboard.residents_with_leave) == 2

        ***REMOVED*** Check rotation counts
    ...
    ***REMOVED*** =========================================================================
    ...
    def test_update_assignment(
        ...
        ***REMOVED*** Create initial assignment
        assignment = service.create_manual_assignment(
            block_number=1,
            academic_year=2025,
            resident_id=resident.id,
        ...
        ***REMOVED*** Update to different rotation
        ...
        assert updated.assignment_reason == "manual"  ***REMOVED*** Changed due to rotation update
...
class TestLeaveConflictDetection:
    ...
    def test_leave_conflict_when_no_leave_eligible_capacity(
        ...
        ***REMOVED*** Create only non-leave-eligible rotation
        ...
        ***REMOVED*** Create resident with leave
        resident = Person(
            id=uuid4(),
            name="Dr. Stuck",
            type="resident",
