...
class TestStateMachine:
    ...
    def test_transition_to_open_on_failure_threshold(self, state_machine):
        ...
        ***REMOVED*** Record failures up to threshold
        for _ in range(3):
            state = state_machine.record_failure()
    ...
    def test_transition_to_half_open_after_timeout(self, state_machine):
        ...
        ***REMOVED*** Wait for timeout
        time.sleep(1.1)

        ***REMOVED*** Check if request should be allowed (triggers transition)
    ...
    def test_half_open_limits_concurrent_calls(self, state_machine):
        ...
        ***REMOVED*** Transition to HALF_OPEN
        state_machine._transition_to_half_open("Test")

        ***REMOVED*** Simulate in-flight calls
    ...
    def test_transition_to_closed_on_success_threshold_in_half_open(
        ...
        ***REMOVED*** Record successes up to threshold
        for _ in range(2):
            state = state_machine.record_success()
    ...
    def test_transition_to_open_on_failure_in_half_open(self, state_machine):
        ...
        ***REMOVED*** Record one success, then one failure
    ...
    def test_force_closed(self, state_machine):
        ...
        ***REMOVED*** First open it
        state_machine.force_open("Test")
        assert state_machine.current_state == CircuitState.OPEN

        ***REMOVED*** Then force close
...
class TestCircuitMetrics:
    ...
    def test_failure_rate_calculation(self, metrics):
        ...
        ***REMOVED*** No requests yet
        assert metrics.failure_rate == 0.0

        ***REMOVED*** Add some requests
...
class TestCircuitBreaker:
    ...
    def test_circuit_opens_after_failures(self, breaker):
        ...
        ***REMOVED*** Make calls up to threshold
        for _ in range(3):
    ...
    def test_excluded_exceptions_not_counted(self):
        ...
        ***REMOVED*** This should raise but not count as failure
    ...
    def test_reset(self, breaker):
        ...
        ***REMOVED*** Generate some activity
...
class TestCircuitBreakerRegistry:
    ...
    def test_set_default_config(self, registry):
        ...
        ***REMOVED*** New breakers should use default config
...
class TestRegistryGlobalFunctions:
    ...
    def test_setup_registry_creates_new(self):
        ...
        ***REMOVED*** After setup, get_registry should return the new one
        assert get_registry() is new_registry


***REMOVED*** ============================================================================
***REMOVED*** Decorator Tests
***REMOVED*** ============================================================================
...
class TestCircuitBreakerDecorators:
    ...
    def test_circuit_breaker_decorator(self):
        ...
        ***REMOVED*** Check that breaker was registered
    ...
    def test_circuit_breaker_with_fallback(self):
        ...
        ***REMOVED*** First call fails and opens circuit
        with pytest.raises(ValueError):
            failing_func()

        ***REMOVED*** Second call uses fallback
        result = failing_func()
    ...
    def test_with_circuit_breaker_decorator(self):
        ...
        ***REMOVED*** First register a breaker
        registry = get_registry()
        ...
        ***REMOVED*** Both should use the same breaker
...
class TestCircuitBreakerIntegration:
    ...
    def test_full_circuit_lifecycle(self):
        ...
        ***REMOVED*** Start CLOSED
        assert breaker.state == CircuitState.CLOSED

        ***REMOVED*** Trigger failures to OPEN
        for _ in range(2):
            with pytest.raises(ValueError):
        ...
        ***REMOVED*** Next call should transition to HALF_OPEN
        def success_func():
            return "success"
        ...
        ***REMOVED*** Second success should close circuit
        result = breaker.call(success_func)
    ...
    def test_multiple_breakers_independent(self):
        ...
        ***REMOVED*** Fail breaker1
        for _ in range(2):
            with pytest.raises(ValueError):
                breaker1.call(lambda: (_ for _ in ()).throw(ValueError("Error")))

        ***REMOVED*** breaker1 should be OPEN, breaker2 should be CLOSED
        assert breaker1.state == CircuitState.OPEN
        assert breaker2.state == CircuitState.CLOSED

        ***REMOVED*** breaker2 should still accept calls
    ...
    def test_fallback_chain(self):
        ...
        ***REMOVED*** Next call should use fallback
