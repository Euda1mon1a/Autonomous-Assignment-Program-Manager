...
***REMOVED*** ============================================================================
***REMOVED*** Async Database Fixture
***REMOVED*** ============================================================================
...
class TestCallAssignmentService:
    ...
    ***REMOVED*** =========================================================================
    ...
    async def test_get_call_assignment_success(
        ...
        ***REMOVED*** Person should be eagerly loaded
    ...
    async def test_get_call_assignments_by_date_range(
        ...
        ***REMOVED*** Query for middle date range
        result = await service.get_call_assignments(
    ...
    async def test_get_call_assignments_pagination(
        ...
        ***REMOVED*** Items should be different
        page1_ids = {item.id for item in page1["items"]}
        page2_ids = {item.id for item in page2["items"]}
        assert len(page1_ids & page2_ids) == 0  ***REMOVED*** No overlap
    ...
    ***REMOVED*** =========================================================================
    ...
    async def test_delete_call_assignment_not_found(self, async_db):
        ...
        ***REMOVED*** Try to delete non-existent ID
...
class TestCallAssignmentConcurrency:
    ...
    ***REMOVED*** NOTE: These tests are kept as placeholders for future implementation
    ***REMOVED*** when concurrency testing infrastructure is fully set up.
    pass
...
class TestCallAssignmentIntegration:
    ...
    ***REMOVED*** NOTE: These tests are kept as placeholders for future implementation
    ***REMOVED*** when full ACGME validation integration is available.
    pass
