...
class TestHeatmapService:
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_calculate_date_range_week(self):
        ...
        ***REMOVED*** Should start on Monday (Jan 8) and end on Sunday (Jan 14)
        assert start == date(2024, 1, 8)
        assert end == date(2024, 1, 14)
        assert (end - start).days == 6  ***REMOVED*** 7 days total
    ...
    def test_calculate_date_range_week_default_reference(self):
        ...
        ***REMOVED*** Should be Monday to Sunday of current week
        today = date.today()
    ...
    def test_calculate_date_range_month_february(self):
        ...
        service = HeatmapService()
        reference = date(2024, 2, 15)  ***REMOVED*** 2024 is a leap year
        time_range = TimeRangeType(range_type="month", reference_date=reference)
    ...
    def test_calculate_date_range_quarter_q1(self):
        ...
        service = HeatmapService()
        reference = date(2024, 2, 15)  ***REMOVED*** Q1
    ...
    def test_calculate_date_range_quarter_q2(self):
        ...
        service = HeatmapService()
        reference = date(2024, 5, 15)  ***REMOVED*** Q2
        time_range = TimeRangeType(range_type="quarter", reference_date=reference)
    ...
    def test_calculate_date_range_quarter_q3(self):
        ...
        service = HeatmapService()
        reference = date(2024, 8, 15)  ***REMOVED*** Q3
        time_range = TimeRangeType(range_type="quarter", reference_date=reference)
    ...
    def test_calculate_date_range_quarter_q4(self):
        ...
        service = HeatmapService()
        reference = date(2024, 11, 15)  ***REMOVED*** Q4
        time_range = TimeRangeType(range_type="quarter", reference_date=reference)
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** _get_blocks_in_range Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_blocks_in_range_with_blocks(self, db):
        ...
        ***REMOVED*** Create blocks
        ...
        assert len(blocks) == 6  ***REMOVED*** 3 days × 2 time periods
    ...
    def test_get_blocks_in_range_partial_overlap(self, db):
        ...
        ***REMOVED*** Create blocks from Jan 1-5
        for i in range(5):
            block = Block(
                id=uuid4(),
        ...
        ***REMOVED*** Should get Jan 2, 3, 4 (3 blocks)
        assert len(blocks) == 3
        assert all(query_start <= b.date <= query_end for b in blocks)

    ***REMOVED*** ========================================================================
    ***REMOVED*** _get_assignments_in_range Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_assignments_in_range_filter_by_person(
        ...
        ***REMOVED*** Create assignments for different people
        ...
        ***REMOVED*** Filter by first resident
    ...
    def test_get_assignments_in_range_filter_by_rotation(
        ...
        ***REMOVED*** Create assignments with different rotations
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** _get_swap_records_in_range Tests
    ***REMOVED*** ========================================================================
    ...
    def test_get_swap_records_in_range_excludes_pending(
        ...
        ***REMOVED*** Create pending swap (should be excluded)
        swap = SwapRecord(
            id=uuid4(),
            source_faculty_id=sample_faculty_members[0].id,
            source_week=date(2024, 1, 15),
    ...
    def test_get_swap_records_in_range_date_filtering(self, db, sample_faculty_members):
        ...
        ***REMOVED*** Create swaps with different dates
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** generate_unified_heatmap Tests - Daily Grouping
    ***REMOVED*** ========================================================================
    ...
    def test_generate_unified_heatmap_daily(self, db, sample_resident, sample_blocks):
        ...
        ***REMOVED*** Create assignments for 3 days
        for i in range(3):
            assignment = Assignment(
                id=uuid4(),
                block_id=sample_blocks[i * 2].id,  ***REMOVED*** AM blocks
                person_id=sample_resident.id,
                role="primary",
            )
            db.add(assignment)
        ...
        assert len(result.data.x_labels) == 3  ***REMOVED*** 3 days
        assert result.data.y_labels == ["Total Assignments"]
        assert len(result.data.z_values) == 1  ***REMOVED*** Single row
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** generate_unified_heatmap Tests - Weekly Grouping
    ***REMOVED*** ========================================================================

    def test_generate_unified_heatmap_weekly(self, db, sample_resident):
        """Test weekly heatmap generation."""
        service = HeatmapService()
        start = date(2024, 1, 1)  ***REMOVED*** Monday
        end = date(2024, 1, 21)  ***REMOVED*** 3 weeks

        ***REMOVED*** Create blocks and assignments across 3 weeks
        for i in range(21):
            block = Block(
                id=uuid4(),
                date=start + timedelta(days=i),
        ...
        assert len(result.data.x_labels) == 3  ***REMOVED*** 3 weeks
        assert result.data.y_labels == ["Total Assignments"]
        assert result.metadata["grouping_type"] == "weekly"
        assert result.metadata["weeks_count"] == 3

    ***REMOVED*** ========================================================================
    ***REMOVED*** generate_unified_heatmap Tests - Person Grouping
    ***REMOVED*** ========================================================================
    ...
    def test_generate_unified_heatmap_by_person(self, db, sample_residents):
        ...
        ***REMOVED*** Create assignments for each resident
        ...
        assert len(result.data.y_labels) == 3  ***REMOVED*** 3 residents
        assert len(result.data.x_labels) == 3  ***REMOVED*** 3 days
        assert len(result.data.z_values) == 3  ***REMOVED*** 3 rows (one per person)
    ...
    def test_generate_unified_heatmap_by_person_filter(self, db, sample_residents):
        ...
        ***REMOVED*** Filter to only first resident
        result = service.generate_unified_heatmap(
            db,
            start,
            end,
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** generate_unified_heatmap Tests - Rotation Grouping
    ***REMOVED*** ========================================================================
    ...
    def test_generate_unified_heatmap_by_rotation(self, db, sample_resident):
        ...
        ***REMOVED*** Assign to different rotations
        assignment1 = Assignment(
            id=uuid4(),
        ...
        assert len(result.data.y_labels) == 2  ***REMOVED*** 2 rotations
        assert len(result.data.x_labels) == 3  ***REMOVED*** 3 days
        assert len(result.data.z_values) == 2  ***REMOVED*** 2 rows (one per rotation)

    ***REMOVED*** ========================================================================
    ***REMOVED*** generate_coverage_heatmap Tests
    ***REMOVED*** ========================================================================
    ...
    def test_generate_coverage_heatmap_full_coverage(self, db, sample_resident):
        ...
        ***REMOVED*** Create blocks and assignments (full coverage)
        for i in range(3):
            block = Block(
                id=uuid4(),
                date=start + timedelta(days=i),
    ...
    def test_generate_coverage_heatmap_partial_coverage(self, db, sample_resident):
        ...
        ***REMOVED*** Only assign first day (2 days uncovered)
        assignment = Assignment(
            id=uuid4(),
            block_id=blocks[0].id,
            person_id=sample_resident.id,
        ...
        assert result.coverage_percentage < 100.0
        assert len(result.gaps) > 0
        ***REMOVED*** Check that gaps have correct structure
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** generate_person_workload_heatmap Tests
    ***REMOVED*** ========================================================================
    ...
    def test_generate_person_workload_heatmap_basic(self, db, sample_residents):
        ...
        service = HeatmapService()
        start = date(2024, 1, 1)  ***REMOVED*** Monday
        end = date(2024, 1, 5)  ***REMOVED*** Friday (5 weekdays)
        ...
        ***REMOVED*** Create blocks and assignments
        ...
        assert len(result.data.y_labels) == 1  ***REMOVED*** 1 person
        assert len(result.data.x_labels) == 5  ***REMOVED*** 5 weekdays
        assert result.metadata["total_blocks"] == 10  ***REMOVED*** 5 days × 2 blocks
    ...
    def test_generate_person_workload_heatmap_with_weekends(self, db, sample_resident):
        ...
        service = HeatmapService()
        start = date(2024, 1, 1)  ***REMOVED*** Monday
        end = date(2024, 1, 7)  ***REMOVED*** Sunday (7 days)

        ***REMOVED*** Create blocks for all 7 days
        for i in range(7):
            block = Block(
                id=uuid4(),
                date=start + timedelta(days=i),
        ...
        assert len(result.data.x_labels) == 7  ***REMOVED*** All 7 days
    ...
    def test_generate_person_workload_heatmap_exclude_weekends(
        ...
        ***REMOVED*** Should only have 5 weekdays (Mon-Fri)
        assert len(result.data.x_labels) == 5
        ***REMOVED*** Verify no weekend dates
    ...
    def test_generate_person_workload_heatmap_multiple_people(
        ...
        ***REMOVED*** Create assignments for different people
        ...
        assert len(result.data.y_labels) == 3  ***REMOVED*** 3 people
        assert result.metadata["people_count"] == 3
        assert result.metadata["avg_blocks_per_person"] == 1.0  ***REMOVED*** 3 blocks / 3 people

    ***REMOVED*** ========================================================================
    ***REMOVED*** export_heatmap_image Tests
    ***REMOVED*** ========================================================================
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** create_plotly_figure Tests
    ***REMOVED*** ========================================================================
