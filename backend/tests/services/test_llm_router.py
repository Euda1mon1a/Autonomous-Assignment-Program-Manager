...
class TestOllamaProvider:
    ...
    async def test_generate_failure_records_error(self):
        ...
        ***REMOVED*** Mock httpx to raise error
        with patch.object(
            provider._client,
            "post",
        ...
        ***REMOVED*** Check failure recorded
    ...
    async def test_is_available_after_failures(self):
        ...
        ***REMOVED*** Initially available
        assert provider.is_available() is True

        ***REMOVED*** Record 3 failures
        provider._record_failure()
        provider._record_failure()
        provider._record_failure()

        ***REMOVED*** Should be unavailable
...
class TestCircuitBreaker:
    ...
    def test_circuit_breaker_opens_after_failures(self):
        ...
        ***REMOVED*** Initially can execute
        assert breaker.can_execute("test_provider") is True

        ***REMOVED*** Record failures
...
class TestLLMRouter:
    ...
    async def test_generate_with_explicit_provider(self):
        ...
        ***REMOVED*** Mock the provider's generate method
