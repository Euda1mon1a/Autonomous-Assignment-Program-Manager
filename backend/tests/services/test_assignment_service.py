...
class TestAssignmentService:
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** List Assignments Tests
    ***REMOVED*** ========================================================================
    ...
    def test_list_assignments_filter_by_date_range(self, db, sample_resident):
        ...
        ***REMOVED*** Create blocks with specific dates
        block1 = Block(
            id=uuid4(),
            date=date(2025, 1, 15),
            time_of_day="AM",
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_create_assignment_success(self, mock_validator, db, sample_resident, sample_block):
        ...
        ***REMOVED*** Mock ACGME validation to return no violations
    ...
    def test_create_assignment_with_acgme_violations(self, mock_validator, db, sample_resident, sample_block):
        ...
        ***REMOVED*** Mock ACGME validation to return violations
        mock_violation = Mock()
    ...
    ***REMOVED*** ========================================================================
    ...
    def test_update_assignment_optimistic_locking_conflict(
        ...
        ***REMOVED*** Simulate another user updating the assignment
        assignment.role = "backup"
        db.commit()
        db.refresh(assignment)

        ***REMOVED*** Try to update with old timestamp
        service = AssignmentService(db)
        result = service.update_assignment(
            assignment.id,
            {"notes": "My update"},
    ...
    ***REMOVED*** ========================================================================
    ***REMOVED*** Delete Assignments Bulk Tests
    ***REMOVED*** ========================================================================
    ...
    def test_delete_assignments_bulk_success(self, db, sample_resident):
        ...
        ***REMOVED*** Create assignments for these blocks
        for block in blocks:
            assignment = Assignment(
                id=uuid4(),
                block_id=block.id,
        ...
        ***REMOVED*** Delete assignments in a date range (first 5 days)
        service = AssignmentService(db)
        ...
        ***REMOVED*** Verify remaining assignments
    ...
    def test_delete_assignments_bulk_partial_range(self, db, sample_resident):
        ...
        ***REMOVED*** Create blocks before, during, and after the range
        block_before = Block(
            id=uuid4(),
        ...
        ***REMOVED*** Delete only January assignments
        service = AssignmentService(db)
        result = service.delete_assignments_bulk(
            date(2025, 1, 1),
            date(2025, 1, 31),
        ...
        ***REMOVED*** Verify correct assignments remain
