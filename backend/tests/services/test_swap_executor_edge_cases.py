...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Concurrent Swap Handling
***REMOVED*** ============================================================================
...
class TestConcurrentSwapHandling:
    ...
    def test_concurrent_swaps_same_shift_first_wins(
        ...
        ***REMOVED*** Create block and initial assignment
        block = Block(
            id=uuid4(),
        ...
        ***REMOVED*** Create two swap requests for same shift
        swap1 = SwapRequest(
            id=uuid4(),
        ...
        ***REMOVED*** Second swap should fail (assignment already swapped)
    ...
    def test_simultaneous_bidirectional_swaps(
        ...
        ***REMOVED*** Create bidirectional swap requests
...
class TestACGMEComplianceDuringSwaps:
    ...
    def test_swap_rejected_would_violate_80_hour_limit(
        ...
        ***REMOVED*** Give faculty_b a very heavy schedule already
        for i in range(7):
            for tod in ["AM", "PM"]:
                block = Block(
                    id=uuid4(),
        ...
        ***REMOVED*** Create swap request that would add more hours
        new_block = Block(
            id=uuid4(),
    ...
    def test_swap_maintains_one_in_seven_compliance(
        ...
        ***REMOVED*** Give faculty_b 6 consecutive days of work
        for i in range(6):
            block = Block(
                id=uuid4(),
                date=start_date + timedelta(days=i),
        ...
        ***REMOVED*** Try to swap day 7 (which should be day off) to faculty_b
        day7_block = Block(
            id=uuid4(),
        ...
        result = swap_executor.execute_swap(swap.id)
        ***REMOVED*** Should reject to maintain 1-in-7 compliance
        assert result.success is False


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Rollback Scenarios
***REMOVED*** ============================================================================
...
class TestSwapRollbackScenarios:
    ...
    def test_rollback_swap_within_24_hours(
        ...
        ***REMOVED*** Rollback within 24 hours
        rollback_result = swap_executor.rollback_swap(swap.id)
        assert rollback_result.success is True

        ***REMOVED*** Verify assignment back to original owner
        db.refresh(assignment)
    ...
    def test_partial_rollback_cascade_handling(
        ...
        ***REMOVED*** Create chain: A->B (swap1), then B->C (swap2)
        block1 = Block(
            id=uuid4(),
            date=date.today() + timedelta(days=7),
            time_of_day="AM",
        ...
        ***REMOVED*** First swap: A gives shift to B
        swap1 = SwapRequest(
            id=uuid4(),
            requester_id=faculty_a.id,
            target_id=faculty_b.id,
        ...
        ***REMOVED*** Second swap: B gives shift to C
        swap2 = SwapRequest(
            id=uuid4(),
            requester_id=faculty_b.id,
            target_id=faculty_c.id,
        ...
        ***REMOVED*** Try to rollback first swap - should handle chain dependency
        rollback_result = swap_executor.rollback_swap(swap1.id)
        ***REMOVED*** May succeed with cascade or fail with dependency message


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Edge Cases
***REMOVED*** ============================================================================
...
class TestSwapEdgeCases:
    ...
    def test_swap_with_past_date_block(
        ...
        block = Block(
            id=uuid4(),
            date=date.today() - timedelta(days=7),  ***REMOVED*** Past date
            time_of_day="AM",
            block_number=1,
        )
        db.add(block)
    ...
    def test_swap_self_assignment(
        ...
        swap = SwapRequest(
            id=uuid4(),
            requester_id=faculty_a.id,
            target_id=faculty_a.id,  ***REMOVED*** Same person
            swap_type=SwapType.ABSORB,
            requester_assignment_id=assignment.id,
            status=SwapStatus.PENDING,
        )
    ...
    def test_swap_with_nonexistent_target_person(
        ...
        swap = SwapRequest(
            id=uuid4(),
            requester_id=faculty_a.id,
            target_id=uuid4(),  ***REMOVED*** Nonexistent person
            swap_type=SwapType.ABSORB,
            requester_assignment_id=assignment.id,
            status=SwapStatus.PENDING,
        )
