...
class TestConflictAutoDetector:
    ...
    def test_detect_insufficient_rest(
        ...
        day1 = date.today()
        day2 = day1 + timedelta(hours=20)  ***REMOVED*** Less than 24 hours
    ...
    def test_auto_fix_conflicts(
        ...
        ***REMOVED*** Get all conflicts
        conflicts = detector.detect_all()

        ***REMOVED*** Try to auto-fix
    ...
    def test_detect_multiple_people_conflicts(
        ...
        ***REMOVED*** Create multiple residents
        residents = []
        for i in range(3):
            person = Person(
                id=uuid4(),
    ...
    def test_conflict_severity_assessment(
        ...
        for conflict in conflicts:
            ***REMOVED*** Each conflict should have some way to determine severity
