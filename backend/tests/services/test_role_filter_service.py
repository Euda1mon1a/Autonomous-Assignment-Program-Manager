...
class TestRoleFilterService:
    ...
    def test_filter_for_admin(self):
        ...
        assert filtered == data  ***REMOVED*** Admin sees everything
    ...
    def test_filter_for_coordinator(self):
        ...
        assert "compliance" not in filtered  ***REMOVED*** Coordinator can't see compliance
        assert "users" not in filtered  ***REMOVED*** Coordinator can't manage users
    ...
    def test_filter_for_faculty(self):
        ...
        assert "schedules" in filtered
        assert len(filtered["schedules"]) == 1  ***REMOVED*** Only their own schedule
    ...
    def test_filter_schedule_list_for_admin(self):
        ...
        assert len(filtered) == 2  ***REMOVED*** Admin sees all
    ...
    def test_filter_schedule_list_for_faculty(self):
        ...
        assert len(filtered) == 2  ***REMOVED*** Only schedules for user-1
    ...
    def test_filter_schedule_list_for_clinical_staff_today_only(self):
        ...
        assert len(filtered) == 2  ***REMOVED*** Only today's schedules
    ...
    def test_string_role_conversion(self):
        ...
        ***REMOVED*** Test can_access with string role
        ...
        ***REMOVED*** Test filter_for_role with string role
