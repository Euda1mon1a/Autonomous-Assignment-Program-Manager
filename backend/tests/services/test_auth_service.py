...
class TestAuthService:
    ...
    def test_authenticate_updates_last_login(
        ...
        ***REMOVED*** Refresh user from DB to get updated last_login
    ...
    def test_register_user_admin_can_create_users(
        ...
        ***REMOVED*** Make test_user an admin
    ...
    def test_register_user_invalid_email(
        ...
        ***REMOVED*** May or may not validate email, depends on implementation
        result = auth_service.register_user(
            username="badmail",
            email="not-an-email",
            password="Password@123",
        ...
        ***REMOVED*** Either should fail or should succeed - depends on validation
    ...
    def test_register_user_empty_username(self, auth_service: AuthService):
        ...
        ***REMOVED*** Should either fail or be rejected
        assert isinstance(result, dict)
    ...
    def test_authenticate_case_sensitive_username(
        ...
        ***REMOVED*** Depends on implementation - may or may not be case-sensitive
        assert isinstance(result, dict)
    ...
    def test_authenticate_creates_valid_token(
        ...
        assert len(token) > 0
        ***REMOVED*** JWT tokens have 3 parts separated by dots
    ...
    def test_authenticate_multiple_times_different_jti(
        ...
        ***REMOVED*** JTIs should be different for different token generations
    ...
    def test_register_user_hashes_password(
        ...
        ***REMOVED*** Get user from DB and verify password is hashed (not plaintext)
        new_user = result["user"]
        assert new_user.hashed_password != "SecurePass@123"
        assert len(new_user.hashed_password) > 20  ***REMOVED*** Hash should be longer
