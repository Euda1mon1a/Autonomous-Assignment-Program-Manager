...
class CredentialFactory:
    ...
    def create_person_certification(
        ...
        if certification_number is None:
            certification_number = fake.bothify(text="???-***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***", letters="ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    ...
    def create_current_certification(
        ...
        """
        issued_date = date.today() - timedelta(days=180)  ***REMOVED*** 6 months ago
        expiration_date = issued_date + timedelta(
            days=certification_type.renewal_period_months * 30
        )
    ...
    def create_mixed_status_certifications(
        ...
        ***REMOVED*** ACLS: expiring in 30 days
        ...
        ***REMOVED*** PALS: expiring in 7 days
        ...
        ***REMOVED*** NRP: expired 5 days ago
