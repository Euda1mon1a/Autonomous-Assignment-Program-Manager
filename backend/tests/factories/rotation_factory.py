...
class RotationFactory:
    ...
    def create_rotation_template(
        ...
        if abbreviation is None:
            ...
            abbreviation = abbreviation[:10]  ***REMOVED*** Max 10 chars
    ...
    def create_clinic_template(
        ...
        return RotationFactory.create_rotation_template(
            db,
            name=name,
            activity_type="outpatient",  ***REMOVED*** Engine default filter
            abbreviation=abbreviation,
            max_residents=max_residents,
    ...
    def create_fmit_template(db: Session) -> RotationTemplate:
        ...
        return RotationFactory.create_rotation_template(
            ...
            abbreviation="FMIT",
            max_residents=None,  ***REMOVED*** No hard cap, staffing driven
            supervision_required=True,
            max_supervision_ratio=4,
            leave_eligible=False,  ***REMOVED*** Coverage-critical, not leave-eligible
        )
    ...
    def create_procedure_template(db: Session) -> RotationTemplate:
        ...
        return RotationFactory.create_rotation_template(
            ...
            abbreviation="PROC",
            max_residents=2,  ***REMOVED*** Limited by procedure room capacity
            supervision_required=True,
            max_supervision_ratio=2,  ***REMOVED*** Closer supervision for procedures
            leave_eligible=True,
            requires_procedure_credential=True,
        )
    ...
    def create_conference_template(db: Session) -> RotationTemplate:
        ...
        return RotationFactory.create_rotation_template(
            ...
            abbreviation="CONF",
            max_residents=None,  ***REMOVED*** No capacity limit
            supervision_required=False,  ***REMOVED*** Group learning
            leave_eligible=False,  ***REMOVED*** Mandatory attendance
        )
    ...
    def create_admin_template(db: Session) -> RotationTemplate:
        ...
        return RotationFactory.create_rotation_template(
            ...
            activity_type="outpatient",
            abbreviation="ADMIN",
            max_residents=1,  ***REMOVED*** Usually one chief at a time
