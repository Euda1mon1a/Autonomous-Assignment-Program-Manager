...
class LeaveFactory:
    ...
    def create_absence(
        ...
        if end_date is None:
            ***REMOVED*** Default duration based on type
            duration_days = {
                "vacation": 7,
                "deployment": 90,
                "tdy": 14,
                ...
                "sick": 2,
                "convalescent": 14,
                "maternity_paternity": 84,  ***REMOVED*** 12 weeks
            }
    ...
    def create_family_emergency(
        ...
        ***REMOVED*** Default to 7 days but mark as tentative if return unknown
