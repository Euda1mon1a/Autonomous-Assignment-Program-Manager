...
class BlockFactory:
    ...
    US_FEDERAL_HOLIDAYS = {
        "New Year's Day": (1, 1),
        "Martin Luther King Jr. Day": None,  ***REMOVED*** 3rd Monday in January
        "Presidents' Day": None,  ***REMOVED*** 3rd Monday in February
        "Memorial Day": None,  ***REMOVED*** Last Monday in May
        "Independence Day": (7, 4),
        "Labor Day": None,  ***REMOVED*** 1st Monday in September
        "Columbus Day": None,  ***REMOVED*** 2nd Monday in October
        "Veterans Day": (11, 11),
        "Thanksgiving": None,  ***REMOVED*** 4th Thursday in November
        "Christmas": (12, 25),
    }
    ...
    def create_academic_year_blocks(
        ...
        start_date = date(year, 7, 1)  ***REMOVED*** July 1
        end_date = date(year + 1, 6, 30)  ***REMOVED*** June 30 next year
    ...
    def _check_holiday(check_date: date) -> tuple[bool, str | None]:
        ...
        ***REMOVED*** TODO: Implement floating holidays (MLK Day, Presidents' Day, etc.)
        ***REMOVED*** For now, return False for these
