...
class ScheduleFactory:
    ...
    def create_complete_schedule(
        ...
        ***REMOVED*** Create assignments (simple round-robin for testing)
        assignments = []
        clinic_template = templates["pgy1_clinic"]

        for i, resident in enumerate(residents):
            ***REMOVED*** Assign each resident to a week of clinic blocks
            week_start = i % (num_days // 7)  ***REMOVED*** Cycle through weeks
        ...
        ***REMOVED*** Optionally add absences
        if include_absences:
        ...
        ***REMOVED*** Optionally add certifications
    ...
    def create_clinic_day_schedule(
        ...
        ***REMOVED*** Create blocks for the day
        ...
        ***REMOVED*** Create supervised sessions
    ...
    def create_academic_year_skeleton(
        ...
        ***REMOVED*** Create all blocks for academic year
    ...
    def create_minimal_schedule(
        ...
        ***REMOVED*** Create assignments for resident
    ...
    def create_fmit_week_schedule(
        db: Session,
        num_faculty: int = 7,  ***REMOVED*** 7 faculty for 7 days
    ) -> dict:
        """
        ...
        ***REMOVED*** Assign one faculty per day (both AM and PM)
        assignments = []
        for day_index in range(7):
            faculty_index = day_index % len(faculty)
            day_faculty = faculty[faculty_index]

            ***REMOVED*** AM and PM blocks for this day
            am_block = blocks[day_index * 2]
            pm_block = blocks[day_index * 2 + 1]

            ***REMOVED*** Assign faculty to both blocks (24-hour coverage)
    ...
    def create_understaffed_schedule(
        db: Session,
        num_residents: int = 8,
        num_faculty: int = 2,  ***REMOVED*** Deliberately low
        num_days: int = 7,
    ) -> dict:
        """
        ...
        ***REMOVED*** Assign all residents to all blocks (oversaturated)
        assignments = []
        for resident in residents:
            for block in blocks:
        ...
        ***REMOVED*** Minimal faculty supervision (will violate ratios)
        for faculty_member in faculty:
            for block in blocks[:14]:  ***REMOVED*** Just first week
