...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Authentication
***REMOVED*** ============================================================================
...
class TestAuthentication:
    ...
    def test_password_hashing_verification(self):
        ...
        ***REMOVED*** Hash should not equal plain password
        assert hashed != password

        ***REMOVED*** Verification should succeed with correct password
        assert verify_password(password, hashed) is True

        ***REMOVED*** Verification should fail with incorrect password
    ...
    def test_jwt_token_contains_user_info(self, admin_user_obj: User):
        ...
        ***REMOVED*** Decode token without verification for testing
        decoded = jwt.decode(
        ...
        assert "exp" in decoded  ***REMOVED*** Expiration time


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Authorization by Role
***REMOVED*** ============================================================================
...
class TestRoleBasedAuthorization:
    ...
    def test_admin_can_access_all_endpoints(
        ...
        ***REMOVED*** Admin endpoints
        ...
        assert response.status_code in [200, 404]  ***REMOVED*** Not forbidden

        ***REMOVED*** Regular endpoints
    ...
    def test_coordinator_can_manage_schedules(
        ...
        ***REMOVED*** Should be able to view schedules
        response = client.get("/api/assignments", headers=headers)
        assert response.status_code == 200

        ***REMOVED*** Should be able to create assignments (if endpoint exists)
        ***REMOVED*** Implementation depends on specific endpoints
    ...
    def test_faculty_can_view_own_schedule(
        ...
        ***REMOVED*** Create person record for faculty
        person = Person(
            id=uuid4(),
            name="Dr. Faculty",
            type="faculty",
    ...
    def test_resident_can_request_swaps(
        ...
        ***REMOVED*** Should be able to view swap options
    ...
    def test_clinical_staff_has_read_only_access(
        ...
        ***REMOVED*** Can read schedules
        response = client.get("/api/assignments", headers=headers)
        assert response.status_code == 200

        ***REMOVED*** Cannot create/modify (if enforced)
        ***REMOVED*** Implementation depends on endpoint permissions


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Token Validation
***REMOVED*** ============================================================================
...
class TestTokenValidation:
    ...
    def test_expired_token_returns_401(self, client: TestClient):
        ...
        ***REMOVED*** Create token that expired 1 hour ago
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Permission Edge Cases
***REMOVED*** ============================================================================
...
class TestPermissionEdgeCases:
    ...
    def test_user_cannot_access_others_private_data(
        ...
        ***REMOVED*** Create another user's person record
        other_person = Person(
            id=uuid4(),
        ...
        ***REMOVED*** Try to access private endpoints for other user
        ***REMOVED*** Implementation depends on privacy controls
        response = client.get(
            f"/api/people/{other_person.id}/private",
            headers=headers,
        )

        ***REMOVED*** Should either be forbidden or not found
    ...
    def test_deleted_user_token_invalid(
        ...
        ***REMOVED*** Token should no longer work
        response = client.get("/api/people", headers=headers)
        assert response.status_code == 401
    ...
    def test_role_change_requires_new_token(
        ...
        ***REMOVED*** Get token as resident
        old_token = create_access_token(
            data={"sub": resident_user.username, "role": "resident"}
        )
        old_headers = {"Authorization": f"Bearer {old_token}"}

        ***REMOVED*** Change role to admin
        resident_user.role = "admin"
        db.commit()

        ***REMOVED*** Old token still has old role
        ***REMOVED*** New permissions won't be available until new login
        response = client.get("/api/admin/users", headers=old_headers)
        assert response.status_code == 403  ***REMOVED*** Still forbidden with old token
