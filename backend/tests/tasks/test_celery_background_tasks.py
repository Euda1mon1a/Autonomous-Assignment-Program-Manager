...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Task Execution
***REMOVED*** ============================================================================
...
class TestTaskExecution:
    ...
    def test_resilience_health_check_task_executes(self, mock_monitor, db: Session):
        ...
        ***REMOVED*** Execute task synchronously for testing
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Retry Logic
***REMOVED*** ============================================================================
...
class TestRetryLogic:
    ...
    def test_task_retries_on_failure(self, mock_email_service):
        ...
        ***REMOVED*** Task should retry automatically
        ***REMOVED*** Implementation depends on Celery retry configuration
    ...
    def test_task_retries_with_exponential_backoff(self, mock_analyzer):
        ...
        mock_instance.analyze_n_minus_1.side_effect = [
            ...
            Exception("Network error"),
            {"passes": True},  ***REMOVED*** Succeeds on third try
        ]
        mock_analyzer.return_value = mock_instance

        ***REMOVED*** Task should retry with increasing delays
        ***REMOVED*** Verify retry behavior matches configuration

    def test_task_gives_up_after_max_retries(self):
        """Test task stops retrying after max attempts."""
        ***REMOVED*** Mock a task that always fails
        with patch("app.tasks.notification_tasks.EmailService") as mock_service:
            ...
            ***REMOVED*** After max retries, task should fail permanently
            ***REMOVED*** Implementation depends on max_retries setting


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Task Results
***REMOVED*** ============================================================================
...
class TestTaskResults:
    ...
    def test_task_result_stored_and_retrievable(self, mock_engine, db: Session):
        ...
        ***REMOVED*** Should be able to retrieve result
        task_id = result.id
    ...
    def test_failed_task_stores_error_info(self):
        ...
        with patch("app.tasks.resilience_tasks.ResilienceMonitor") as mock_monitor:
            ...
            ***REMOVED*** Result should contain error information
            assert result.failed()
            assert "Test error" in str(result.traceback)


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Periodic Tasks
***REMOVED*** ============================================================================
...
class TestPeriodicTasks:
    ...
    def test_resilience_check_runs_periodically(self, mock_monitor):
        ...
        ***REMOVED*** Verify task is registered with Celery Beat
        from app.core.celery_app import celery_app

        ***REMOVED*** Check if task is in beat schedule
    ...
    def test_n_minus_analysis_scheduled_daily(self, mock_analyzer):
        ...
        schedule = celery_app.conf.beat_schedule
        ***REMOVED*** Verify daily N-minus analysis is scheduled
        ***REMOVED*** Task name may vary based on configuration


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Task Timeouts
***REMOVED*** ============================================================================
...
class TestTaskTimeouts:
    ...
    def test_long_running_task_times_out(self, mock_engine):
        ...
        def slow_generate(*args, **kwargs):
            time.sleep(10)  ***REMOVED*** Simulate slow operation
            return Mock(success=True)

        mock_instance.generate_schedule.side_effect = slow_generate
        mock_engine.return_value = mock_instance

        ***REMOVED*** Task should timeout if configured with time_limit
        ***REMOVED*** Implementation depends on task configuration

    def test_soft_timeout_sends_warning(self):
        """Test soft timeout sends warning before hard timeout."""
        ***REMOVED*** Celery supports soft_time_limit for warnings
        ***REMOVED*** Test that soft timeout is triggered appropriately


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Task Chains and Groups
***REMOVED*** ============================================================================
...
class TestTaskChainsAndGroups:
    ...
    def test_bulk_notifications_as_group(self, mock_email_service, db: Session):
        ...
        ***REMOVED*** Send notifications as group
        ...
        ***REMOVED*** All tasks in group should complete
...
class TestErrorHandling:
    ...
    def test_task_handles_database_error_gracefully(self, mock_monitor, db: Session):
        ...
        ***REMOVED*** Task should fail but not crash
        assert result.failed()
    ...
    def test_task_logs_error_on_failure(self, mock_email_service):
        ...
        with patch("app.tasks.notification_tasks.logger") as mock_logger:
            ...
            ***REMOVED*** Logger should have been called with error
            assert mock_logger.error.called or mock_logger.exception.called


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Task Status Tracking
***REMOVED*** ============================================================================
...
class TestTaskStatusTracking:
    ...
    def test_task_progress_can_be_monitored(self, mock_engine):
        ...
        ***REMOVED*** Should be able to check status
