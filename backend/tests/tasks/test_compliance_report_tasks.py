...
class TestReportStorage:
    ...
    def test_save_report_creates_file(self, tmp_path):
        ...
        ***REMOVED*** This test assumes there's a save_report helper function
        ***REMOVED*** If it doesn't exist, this tests the file creation logic
        ...
        ***REMOVED*** Verify file exists and contains correct data
    ...
    def test_save_report_creates_directory(self, tmp_path):
        ...
        ***REMOVED*** Directory should not exist yet
        assert not reports_dir.exists()

        ***REMOVED*** Create directory
        reports_dir.mkdir(parents=True, exist_ok=True)

        ***REMOVED*** Verify directory was created
        assert reports_dir.exists()

        ***REMOVED*** Save a test report
...
***REMOVED*** =============================================================================
***REMOVED*** Daily Compliance Summary Tests
***REMOVED*** =============================================================================
...
class TestDailyComplianceSummary:
    ...
    def test_generate_daily_compliance_summary_success(
        ...
        ***REMOVED*** Verify database session was closed
    ...
    def test_generate_daily_compliance_summary_with_violations(
        ...
        ***REMOVED*** Mock report data with violations
        mock_report_data = MagicMock()
        mock_report_data.work_hour_summary = {
            "total_residents": 10,
            "total_violations": 3,
...
class TestWeeklyComplianceReport:
    ...
    def test_generate_weekly_compliance_report_pdf(self, mock_generator, mock_session):
        ...
        ***REMOVED*** Verify PDF export was called
    ...
    def test_generate_weekly_compliance_report_excel(
        ...
        ***REMOVED*** Verify Excel export was called
        mock_gen_instance.export_to_excel.assert_called_once()


***REMOVED*** =============================================================================
***REMOVED*** Monthly Executive Summary Tests
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** Custom Compliance Report Tests
***REMOVED*** =============================================================================
...
class TestCustomComplianceReport:
    ...
    def test_generate_custom_compliance_report_with_resident_ids(
        ...
        ***REMOVED*** Execute task with resident IDs
...
***REMOVED*** =============================================================================
***REMOVED*** Violation Alerts Tests
***REMOVED*** =============================================================================
...
class TestViolationAlerts:
    ...
    def test_check_violation_alerts_no_violations(
        ...
        ***REMOVED*** Mock report data with no violations
        mock_report_data = MagicMock()
    ...
    def test_check_violation_alerts_limits_violations(
        ...
        ***REMOVED*** Mock report data with many violations
        violations = [
        ...
        ***REMOVED*** Verify results
        ...
        assert len(result["violations"]) == 10  ***REMOVED*** Limited to first 10
...
class TestTaskErrorHandling:
    ...
    def test_task_retries_on_exception(self, mock_session):
        ...
        ***REMOVED*** Mock database session to raise exception
        mock_session.side_effect = Exception("Database connection failed")

        ***REMOVED*** Create a mock task instance with retry method
        mock_task = MagicMock()
        mock_task.retry = MagicMock(side_effect=Exception("Retry called"))

        ***REMOVED*** Execute task should raise retry exception
        with pytest.raises(Exception, match="Retry called"):
            ***REMOVED*** Bind the task instance
    ...
    def test_database_session_always_closes(self, mock_generator, mock_session):
        ...
        ***REMOVED*** Mock generator to raise exception
        mock_gen_instance = MagicMock()
        ...
        ***REMOVED*** Execute task should handle exception
        mock_task = MagicMock()
        ...
        ***REMOVED*** Verify database session was still closed
        mock_db.close.assert_called_once()
