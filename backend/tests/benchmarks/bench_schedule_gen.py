...
class TestScheduleGenerationBenchmarks:
    ...
    async def schedule_data(self, db: AsyncSession):
        ...
        ***REMOVED*** Create blocks for 30 days
        blocks = []
    ...
    def test_greedy_scheduler_small(self, benchmark, db: AsyncSession, schedule_data):
        ...
        def run_scheduler():
            ***REMOVED*** Note: In real benchmarks, you'd need to handle async properly
            ***REMOVED*** This is a simplified example
            return scheduler.generate_schedule(
                persons=schedule_data["persons"][:10],  ***REMOVED*** 10 persons
                rotations=schedule_data["rotations"],
                blocks=schedule_data["blocks"][:20],  ***REMOVED*** 10 days
    ...
    def test_schedule_validation(self, benchmark, schedule_data):
        ...
        ***REMOVED*** Create a simple schedule to validate
        assignments = []
        ***REMOVED*** ... populate assignments ...
...
class TestConstraintBenchmarks:
    ...
    def test_80_hour_rule_check(self, benchmark):
        ...
        ***REMOVED*** Create test data
        work_hours = [70, 75, 78, 80, 72, 68, 74]  ***REMOVED*** 7 days of work hours
    ...
    def test_one_in_seven_rule_check(self, benchmark):
        ...
        ***REMOVED*** Create test data - 7 days of work indicators
...
class TestDatabaseBenchmarks:
    ...
    async def test_bulk_assignment_create(self, benchmark, db: AsyncSession):
        ...
        ***REMOVED*** Note: pytest-benchmark doesn't directly support async
        ***REMOVED*** You'd need to use a sync wrapper or pytest-benchmark-asyncio
        ***REMOVED*** This is a simplified example
...
class TestResilienceBenchmarks:
    ...
    def test_n_minus_one_analysis(self, benchmark):
        ...
        ***REMOVED*** Sample schedule data
        schedule = {
            "assignments": [],  ***REMOVED*** Populate with test data
            "persons": [],
            "rotations": [],
        }
...
***REMOVED*** Benchmark configuration
