...
class TestGetOrCreatePreferences:
    ...
    def test_create_new_preferences_persists_to_db(
        ...
        ***REMOVED*** Verify it's persisted by querying directly
    ...
    def test_create_preferences_for_non_faculty_person(
        ...
        ***REMOVED*** Create a resident instead of faculty
        resident = Person(
            id=uuid4(),
            name="Dr. Resident",
            type="resident",
...
class TestUpdatePreferences:
    ...
    def test_update_preferred_weeks(
        ...
        ***REMOVED*** Verify other fields unchanged
    ...
    def test_update_creates_preferences_if_not_exists(
        ...
        assert result.faculty_id == faculty_member.id
        assert result.max_weeks_per_month == 4
        ***REMOVED*** Should have default values for other fields
        assert result.preferred_weeks == []
        assert result.blocked_weeks == []
    ...
    def test_update_updates_timestamp(
        ...
        ***REMOVED*** Wait a tiny bit to ensure timestamp difference
        import time
        time.sleep(0.01)
...
class TestAddPreferredWeek:
    ...
    def test_add_preferred_week_to_existing_list(
        ...
        assert "2025-01-06" in result.preferred_weeks  ***REMOVED*** Original weeks still there
    ...
    def test_add_duplicate_preferred_week(
        ...
        week_date = date(2025, 1, 6)  ***REMOVED*** Already in list
    ...
    def test_add_preferred_week_removes_from_blocked(
        ...
        week_date = date(2025, 2, 3)  ***REMOVED*** In blocked list
    ...
    def test_add_preferred_week_handles_none_list(
        ...
        ***REMOVED*** Set preferred_weeks to None
...
class TestAddBlockedWeek:
    ...
    def test_add_blocked_week_to_existing_list(
        ...
        assert "2025-02-03" in result.blocked_weeks  ***REMOVED*** Original weeks still there
    ...
    def test_add_duplicate_blocked_week(
        ...
        week_date = date(2025, 2, 3)  ***REMOVED*** Already in list
    ...
    def test_add_blocked_week_removes_from_preferred(
        ...
        week_date = date(2025, 1, 6)  ***REMOVED*** In preferred list
    ...
    def test_add_blocked_week_handles_none_list(
        ...
        ***REMOVED*** Set blocked_weeks to None
...
class TestRemovePreferredWeek:
    ...
    def test_remove_existing_preferred_week(
        ...
        week_date = date(2025, 1, 6)  ***REMOVED*** In the list
        ...
        assert "2025-01-06" not in result.preferred_weeks
        assert "2025-01-13" in result.preferred_weeks  ***REMOVED*** Other week still there
    ...
    def test_remove_nonexistent_preferred_week(
        ...
        week_date = date(2025, 11, 3)  ***REMOVED*** Not in list
        original_weeks = existing_preference.preferred_weeks.copy()
    ...
    def test_remove_preferred_week_from_empty_list(
        ...
        ***REMOVED*** Create preferences with empty list
    ...
    def test_remove_preferred_week_from_none_list(
        ...
        ***REMOVED*** Should not error, just no change
...
class TestRemoveBlockedWeek:
    ...
    def test_remove_existing_blocked_week(
        ...
        week_date = date(2025, 2, 3)  ***REMOVED*** In the list
        ...
        assert "2025-02-03" not in result.blocked_weeks
        assert "2025-02-10" in result.blocked_weeks  ***REMOVED*** Other week still there
    ...
    def test_remove_nonexistent_blocked_week(
        ...
        week_date = date(2025, 12, 1)  ***REMOVED*** Not in list
...
class TestIsWeekBlocked:
    ...
    def test_week_is_not_blocked(
        ...
        week_date = date(2025, 1, 6)  ***REMOVED*** Not in blocked list
...
class TestIsWeekPreferred:
    ...
    def test_week_is_not_preferred(
        ...
        week_date = date(2025, 2, 3)  ***REMOVED*** Not in preferred list
...
class TestGetFacultyWithPreferenceForWeek:
    ...
    def test_get_faculty_with_preference_for_week(
        ...
        ***REMOVED*** Set up preferences for multiple faculty
        ...
        pref2 = FacultyPreference(
            ...
            preferred_weeks=["2025-06-02"],  ***REMOVED*** Different week
            blocked_weeks=[],
        )
    ...
    def test_get_faculty_with_preference_excludes_specific_faculty(
        ...
        ***REMOVED*** All three faculty prefer this week
        for i in range(3):
    ...
    def test_get_faculty_with_preference_no_matches(
        ...
        ***REMOVED*** Set up preferences that don't include target week
        pref1 = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[0].id,
...
class TestGetFacultyWithoutBlocksForWeek:
    ...
    def test_get_faculty_without_blocks(
        ...
        ***REMOVED*** Set up preferences
        pref1 = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[0].id,
            preferred_weeks=[],
            blocked_weeks=[target_week_str],  ***REMOVED*** Blocked
        )
        pref2 = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[1].id,
            preferred_weeks=[],
            blocked_weeks=["2025-11-03"],  ***REMOVED*** Not blocked
        )
        pref3 = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[2].id,
            preferred_weeks=[],
            blocked_weeks=[],  ***REMOVED*** Not blocked
        )
    ...
    def test_get_faculty_without_blocks_excludes_specific_faculty(
        ...
        ***REMOVED*** All three faculty are available (no blocks)
        for i in range(3):
            pref = FacultyPreference(
                id=uuid4(),
                faculty_id=multiple_faculty[i].id,
        ...
        ***REMOVED*** Exclude first two faculty
        result = faculty_preference_service.get_faculty_without_blocks_for_week(
            target_week,
    ...
    def test_get_faculty_without_blocks_all_blocked(
        ...
        ***REMOVED*** All faculty block this week
        for i in range(3):
            pref = FacultyPreference(
                id=uuid4(),
                faculty_id=multiple_faculty[i].id,
    ...
    def test_get_faculty_without_blocks_none_blocked_list(
        ...
        pref1 = FacultyPreference(
            ...
            faculty_id=multiple_faculty[0].id,
            preferred_weeks=[],
            blocked_weeks=None,  ***REMOVED*** None means not blocked
        )
        db.add(pref1)
        db.commit()
    ...
    def test_get_faculty_without_blocks_empty_blocked_list(
        ...
        pref1 = FacultyPreference(
            ...
            faculty_id=multiple_faculty[0].id,
            preferred_weeks=[],
            blocked_weeks=[],  ***REMOVED*** Empty means not blocked
        )
        db.add(pref1)
        db.commit()
...
class TestEdgeCases:
    ...
    def test_concurrent_updates_to_same_preference(
        ...
        ***REMOVED*** Simulate two updates in sequence
        ...
        ***REMOVED*** Last update should win
    ...
    def test_add_week_with_special_date_formats(
        ...
        ***REMOVED*** Test with different dates
        dates_to_test = [
            date(2025, 1, 1),  ***REMOVED*** New Year
            date(2025, 12, 31),  ***REMOVED*** Year end
            date(2024, 2, 29),  ***REMOVED*** Leap year
        ]
    ...
    def test_remove_all_weeks_from_lists(
        ...
        ***REMOVED*** Remove all preferred weeks
        ...
        ***REMOVED*** Remove all blocked weeks
    ...
    def test_large_number_of_weeks(
        ...
        ***REMOVED*** Add 52 weeks (full year)
        large_week_list = []
    ...
    def test_service_with_different_db_sessions(
        ...
        ***REMOVED*** Update using service1
        result1 = service1.update_preferences(
            faculty_member.id,
            max_weeks_per_month=7,
        )

        ***REMOVED*** Read using service2
...
class TestSwapAutoMatching:
    ...
    def test_find_best_matches_perfect_mutual_match(
        ...
        ***REMOVED*** swap1 and swap2 are perfect mutual matches
        matches = faculty_preference_service.find_best_matches(swap_requests[0].id)

        assert len(matches) >= 1
        assert matches[0]["swap_id"] == swap_requests[1].id
        assert matches[0]["compatibility_score"] > 0.5  ***REMOVED*** Should be high score
    ...
    def test_find_best_matches_no_matches(
        ...
        ***REMOVED*** Create a swap with no matching counterpart
    ...
    def test_find_best_matches_respects_limit(
        ...
        ***REMOVED*** Create multiple swap requests
        ...
        ***REMOVED*** Create several potential matches
        for i in range(5):
...
class TestCalculateCompatibilityScore:
    ...
    def test_perfect_match_score(
        ...
        ***REMOVED*** Should be high score due to perfect mutual alignment
    ...
    def test_incompatible_blocked_weeks(
        ...
        ***REMOVED*** Set up blocking preferences
        pref_a = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[0].id,
            preferred_weeks=[],
            blocked_weeks=["2025-09-08"],  ***REMOVED*** Blocks the week they would get from swap_b
        )
        db.add(pref_a)
        db.commit()
        ...
        ***REMOVED*** Should be 0 or very low due to blocking constraint
        assert score < 0.3  ***REMOVED*** Blocking accounts for 30% of score
    ...
    def test_score_with_preference_alignment(
        ...
        ***REMOVED*** Set up preferences
        pref_a = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[0].id,
            preferred_weeks=["2025-10-06"],  ***REMOVED*** Wants the week swap_b has
            blocked_weeks=[],
        )
        pref_b = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[1].id,
            preferred_weeks=["2025-09-29"],  ***REMOVED*** Wants the week swap_a has
            blocked_weeks=[],
        )
        ...
        swap_b = SwapRecord(
            ...
            target_faculty_id=multiple_faculty[0].id,
            target_week=None,  ***REMOVED*** No specific target, just wants to give up this week
        ...
        ***REMOVED*** Should have a reasonable score due to preference alignment
...
class TestAutoSuggestSwaps:
    ...
    def blocks_and_assignments(
        ...
        ***REMOVED*** Create future blocks for next 4 weeks
        for i in range(4):
            block = Block(
                id=uuid4(),
                name=f"Week {i+1}",
        ...
        ***REMOVED*** Create assignments for faculty
    ...
    def test_auto_suggest_swaps_with_blocked_week(
        ...
        ***REMOVED*** Person 0 has blocks[0] but wants to avoid it
        ***REMOVED*** Person 1 has blocks[1] and person 0 prefers it
        ...
        ***REMOVED*** Should suggest swapping with person 1
    ...
    def test_auto_suggest_swaps_no_suggestions(
        ...
        ***REMOVED*** Person 0 has no blocks or preferences
        pref_0 = FacultyPreference(
            id=uuid4(),
            faculty_id=multiple_faculty[0].id,
            preferred_weeks=[],
        ...
        ***REMOVED*** Should have no suggestions
...
class TestLearnFromSwapHistory:
    ...
    def test_learn_from_swap_history_with_data(
        ...
        ***REMOVED*** Create approval records
        ...
        assert insights["acceptance_rate"] == 1.0  ***REMOVED*** Both approved
    ...
    def test_learn_from_swap_history_no_data(
        ...
        assert insights["acceptance_rate"] == 0.5  ***REMOVED*** Neutral default
    ...
    def test_learn_from_swap_history_with_rejections(
        ...
        ***REMOVED*** Create approval records (one rejected, one approved)
        approval1 = SwapApproval(
            id=uuid4(),
            swap_id=swap1.id,
            faculty_id=multiple_faculty[0].id,
            role="target",
            approved=False,  ***REMOVED*** Rejected
        ...
        assert insights["total_swaps"] == 2
        assert insights["acceptance_rate"] == 0.5  ***REMOVED*** 1 approved, 1 rejected
        assert insights["rejection_rate"] == 0.5
    ...
    def test_learn_from_swap_history_respects_lookback_period(
        ...
        ***REMOVED*** Create old swap (outside lookback period)
        old_swap = SwapRecord(
            id=uuid4(),
            source_faculty_id=multiple_faculty[0].id,
            ...
            swap_type=SwapType.ONE_TO_ONE,
            status=SwapStatus.EXECUTED,
            requested_at=datetime.utcnow() - timedelta(days=400),  ***REMOVED*** More than 365 days ago
        )
        db.add(old_swap)
        db.commit()
        ...
        ***REMOVED*** Should not include the old swap
        assert insights["total_swaps"] == 0
