...
def create_week_of_blocks(start_date=None):
    ...
    if start_date is None:
        ***REMOVED*** Start from next Monday
        today = date.today()
        days_ahead = 0 - today.weekday()  ***REMOVED*** Monday is 0
        if days_ahead <= 0:
            days_ahead += 7
    ...
    for i in range(7):
        ...
        ***REMOVED*** Create AM and PM blocks
...
def create_residents(count=3):
    ...
    for i in range(count):
        resident = MockPerson(
            ...
            person_type="resident",
            pgy_level=(i % 3) + 1,  ***REMOVED*** PGY-1, PGY-2, PGY-3
        )
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for OnePersonPerBlockConstraint
***REMOVED*** ============================================================================
...
class TestOnePersonPerBlockConstraint:
    ...
    def test_validate_one_primary_per_block(self):
        ...
        ***REMOVED*** Assign different residents to different blocks
        assignments = [
            MockAssignment(
    ...
    def test_validate_multiple_primaries_same_block(self):
        ...
        ***REMOVED*** Assign both residents to same block as primary
    ...
    def test_validate_non_primary_assignments_ignored(self):
        ...
        assignments = [
            ...
            MockAssignment(
                person_id=residents[1].id,
                block_id=first_block.id,
                role="backup",  ***REMOVED*** Not primary
            ),
        ]
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should pass because only one primary assignment
        assert result.satisfied is True
        assert len(result.violations) == 0
    ...
    def test_validate_multiple_blocks_with_violations(self):
        ...
        assignments = [
            ***REMOVED*** Block 0: 2 primaries (violation)
            MockAssignment(
                person_id=residents[0].id,
                block_id=blocks[0].id,
                role="primary",
            ...
            ***REMOVED*** Block 1: 1 primary (ok)
            MockAssignment(
                person_id=residents[2].id,
                block_id=blocks[1].id,
                role="primary",
            ),
            ***REMOVED*** Block 2: 2 primaries (violation)
            MockAssignment(
                person_id=residents[2].id,
        ...
        ***REMOVED*** Verify both blocks are reported
    ...
    def test_validate_custom_max_per_block(self):
        ...
        ***REMOVED*** Should pass with max_per_block=2
        result = constraint.validate(assignments, context)
        assert result.satisfied is True

        ***REMOVED*** Add third assignment - should fail
        assignments.append(
            MockAssignment(
                person_id=residents[2].id,
                block_id=first_block.id,
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for ClinicCapacityConstraint
***REMOVED*** ============================================================================
...
class TestClinicCapacityConstraint:
    ...
    def test_validate_no_template_limits(self):
        ...
        ***REMOVED*** Assign all residents to same block/template
        assignments = [
            MockAssignment(
                person_id=r.id,
                block_id=blocks[0].id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should pass because template has no max_residents limit
        assert result.satisfied is True
        assert len(result.violations) == 0
    ...
    def test_validate_within_capacity_limit(self):
        ...
        ***REMOVED*** Assign 3 residents to template with max 4
        assignments = [
            MockAssignment(
                person_id=r.id,
                block_id=blocks[0].id,
    ...
    def test_validate_at_capacity_limit(self):
        ...
        ***REMOVED*** Assign exactly 4 residents to template with max 4
        assignments = [
            MockAssignment(
                person_id=r.id,
                block_id=blocks[0].id,
    ...
    def test_validate_exceeds_capacity_limit(self):
        ...
        ***REMOVED*** Assign 5 residents to template with max 4
        first_block = blocks[0]
        assignments = [
            MockAssignment(
                person_id=r.id,
    ...
    def test_validate_multiple_templates_different_blocks(self):
        ...
        assignments = [
            ***REMOVED*** Block 0, Template 1: 3 residents (at limit, ok)
            MockAssignment(
                person_id=residents[0].id,
                block_id=blocks[0].id,
            ...
            ***REMOVED*** Block 1, Template 2: 2 residents (at limit, ok)
            MockAssignment(
                person_id=residents[3].id,
                block_id=blocks[1].id,
    ...
    def test_validate_same_template_different_blocks(self):
        ...
        assignments = [
            ***REMOVED*** Block 0: 3 residents (ok)
            MockAssignment(
                person_id=residents[0].id,
                block_id=blocks[0].id,
                rotation_template_id=template.id,
            ...
            ***REMOVED*** Block 1: 3 residents (ok)
            MockAssignment(
                person_id=residents[3].id,
                block_id=blocks[1].id,
                rotation_template_id=template.id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should pass - capacity applies per block
        assert result.satisfied is True
        assert len(result.violations) == 0
    ...
    def test_validate_multiple_violations(self):
        ...
        assignments = [
            ***REMOVED*** Block 0, Template 1: 3 residents (violation)
            MockAssignment(
                person_id=residents[0].id,
                block_id=blocks[0].id,
                rotation_template_id=template1.id,
            ...
            ***REMOVED*** Block 1, Template 2: 4 residents (violation)
            MockAssignment(
                person_id=residents[3].id,
                block_id=blocks[1].id,
                rotation_template_id=template2.id,
    ...
    def test_validate_zero_capacity_limit(self):
        ...
        ***REMOVED*** Assign residents to template with max_residents=0
        assignments = [
            MockAssignment(
                person_id=r.id,
                block_id=blocks[0].id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** max_residents=0 is treated as no limit
        assert result.satisfied is True
        assert len(result.violations) == 0


***REMOVED*** ============================================================================
***REMOVED*** Tests for MaxPhysiciansInClinicConstraint
***REMOVED*** ============================================================================
...
class TestMaxPhysiciansInClinicConstraint:
    ...
    def test_validate_no_clinic_templates(self):
        ...
        ***REMOVED*** Template is not outpatient type
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should pass because no clinic templates
        assert result.satisfied is True
        assert len(result.violations) == 0
    ...
    def test_validate_within_physician_limit(self):
        ...
        ***REMOVED*** Assign 4 residents + 2 faculty = 6 physicians (at limit)
        assignments = []
        for r in residents:
            assignments.append(
                MockAssignment(
    ...
    def test_validate_exceeds_physician_limit(self):
        ...
        ***REMOVED*** Assign 5 residents + 3 faculty = 8 physicians (exceeds limit of 6)
        first_block = blocks[0]
        assignments = []
        for r in residents:
            assignments.append(
    ...
    def test_validate_multiple_blocks_separate_counts(self):
        ...
        assignments = [
            ***REMOVED*** Block 0: 4 residents (at limit, ok)
            MockAssignment(
                person_id=residents[0].id,
                block_id=blocks[0].id,
                rotation_template_id=template.id,
            ...
            ***REMOVED*** Block 1: 4 residents (at limit, ok)
            MockAssignment(
                person_id=residents[4].id,
                block_id=blocks[1].id,
                rotation_template_id=template.id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should pass - each block counted separately
        assert result.satisfied is True
        assert len(result.violations) == 0
    ...
    def test_validate_multiple_clinic_templates_combined(self):
        ...
        ***REMOVED*** Assign to same block but different clinic templates
        first_block = blocks[0]
        assignments = [
            MockAssignment(
                person_id=residents[0].id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should fail - total 6 physicians across both clinics exceeds limit of 5
        assert result.satisfied is False
        assert len(result.violations) == 1
    ...
    def test_validate_mixed_clinic_non_clinic_templates(self):
        ...
        first_block = blocks[0]
        assignments = [
            ***REMOVED*** 3 in clinic (within limit)
            MockAssignment(
                person_id=residents[0].id,
                block_id=first_block.id,
            ...
            ***REMOVED*** 3 in inpatient (should not count)
            MockAssignment(
                person_id=residents[3].id,
                block_id=first_block.id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should pass - only clinic assignments count
        assert result.satisfied is True
        assert len(result.violations) == 0


***REMOVED*** ============================================================================
***REMOVED*** Tests for CoverageConstraint (Soft Constraint)
***REMOVED*** ============================================================================
...
class TestCoverageConstraint:
    ...
    def test_validate_empty_assignments(self):
        ...
        result = constraint.validate([], context)
        ***REMOVED*** Soft constraint always returns satisfied=True
        assert result.satisfied is True
        ***REMOVED*** Should have violation for low coverage
        assert len(result.violations) == 1
        assert result.violations[0].severity == "MEDIUM"
        assert "0.0%" in result.violations[0].message
        ***REMOVED*** Penalty should be (1 - 0.0) * 1000.0 = 1000.0
    ...
    def test_validate_full_coverage(self):
        ...
        constraint = CoverageConstraint()
        blocks = create_week_of_blocks()
        ***REMOVED*** Filter out weekend blocks
        ...
        ***REMOVED*** Assign to all workday blocks
        assignments = []
    ...
    def test_validate_partial_coverage(self):
        ...
        ***REMOVED*** Assign to half of workday blocks
        ...
        ***REMOVED*** Coverage rate should be approximately 0.5
        ***REMOVED*** Penalty = (1 - coverage_rate) * weight
        expected_penalty = (1 - 0.5) * 1000.0
        assert abs(result.penalty - expected_penalty) < 100.0  ***REMOVED*** Allow some margin
    ...
    def test_validate_high_coverage_no_violation(self):
        ...
        ***REMOVED*** Assign to 95% of workday blocks
        ...
        result = constraint.validate(assignments, context)
        assert result.satisfied is True
        ***REMOVED*** Should have no violation message for >90% coverage
        assert len(result.violations) == 0
    ...
    def test_validate_low_coverage_has_violation(self):
        ...
        ***REMOVED*** Assign to 50% of workday blocks (< 90%)
        ...
        result = constraint.validate(assignments, context)
        assert result.satisfied is True  ***REMOVED*** Soft constraints always satisfied
        ***REMOVED*** Should have violation message for <90% coverage
        assert len(result.violations) == 1
        assert result.violations[0].severity == "MEDIUM"
    ...
    def test_validate_weekends_excluded_from_coverage(self):
        ...
        ***REMOVED*** Only assign to workday blocks, leave weekends empty
        assignments = []
        for i, block in enumerate(workday_blocks):
            assignments.append(
                MockAssignment(
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should be 100% coverage (weekends don't count)
        assert result.satisfied is True
        assert len(result.violations) == 0
        assert result.penalty == 0.0
    ...
    def test_validate_duplicate_block_assignments(self):
        ...
        ***REMOVED*** Assign multiple residents to same blocks
        assignments = []
        for block in workday_blocks[:3]:
            ***REMOVED*** Assign two residents to same block
            assignments.append(
                MockAssignment(
                    person_id=residents[0].id,
                    block_id=block.id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Coverage should be 3 / total_workdays, not 6 / total_workdays
        assert result.satisfied is True
        ***REMOVED*** Penalty should reflect only 3 unique blocks covered
...
class TestCapacityConstraintsIntegration:
    ...
    def test_all_constraints_valid_scenario(self):
        ...
        ***REMOVED*** Create valid assignments:
        ***REMOVED*** - One resident per block (satisfies OnePersonPerBlock)
        ***REMOVED*** - Within template capacity (satisfies ClinicCapacity)
        ***REMOVED*** - Within physician limit (satisfies MaxPhysiciansInClinic)
        ***REMOVED*** - Good coverage (satisfies Coverage)
        assignments = []
        for i, block in enumerate(workday_blocks[:8]):
            ***REMOVED*** Alternate residents
    ...
    def test_multiple_constraint_violations(self):
        ...
        ***REMOVED*** Create scenario with multiple violations:
        ***REMOVED*** - Multiple primaries per block
        ***REMOVED*** - Exceeds template capacity
        ***REMOVED*** - Exceeds physician limit
        first_block = blocks[0]
        assignments = []
        ...
        ***REMOVED*** All should fail
        assert result1.satisfied is False  ***REMOVED*** 10 primaries in one block
        assert result2.satisfied is False  ***REMOVED*** 10 > template max of 2
        assert result3.satisfied is False  ***REMOVED*** 10 > default max of 6
