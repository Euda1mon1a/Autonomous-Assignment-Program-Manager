...
***REMOVED*** Mock classes (same as in test file)
class MockPerson:
...
def test_one_person_per_block_basic():
    ...
    ***REMOVED*** Test violation scenario
    assignments.append(
...
def test_max_physicians_in_clinic_basic():
    ...
    ***REMOVED*** Test at limit (4 residents + 2 faculty = 6, at limit)
    assignments = []
    for r in residents:
        assignments.append(
    ...
    ***REMOVED*** Add one more faculty - should exceed
    assignments.append(
...
def test_coverage_constraint_basic():
    ...
    ***REMOVED*** Test partial coverage (50%)
    half_assignments = assignments[:2]  ***REMOVED*** Only 2 out of 5 blocks
    ...
    ***REMOVED*** Penalty should be (1 - 0.4) * 1000 = 600
