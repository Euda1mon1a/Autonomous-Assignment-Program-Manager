...
def create_basic_context() -> SchedulingContext:
    ...
    ***REMOVED*** Create blocks for one week
    start_date = date(2025, 1, 6)  ***REMOVED*** Monday, Jan 6, 2025
    blocks = []
    for i in range(7):
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for ConstraintManager
***REMOVED*** ============================================================================
...
class TestConstraintManager:
    ...
    def test_add_hard_constraint(self):
        ...
        ***REMOVED*** Create a simple hard constraint
    ...
    def test_validate_all_aggregates_results(self):
        ...
        ***REMOVED*** Should return a ConstraintResult
        assert isinstance(result, ConstraintResult)
        assert result.satisfied is True  ***REMOVED*** No violations with empty assignments
    ...
    def test_validate_all_with_violations(self):
        ...
        ***REMOVED*** Create violating assignments (2 primaries on same block)
        assignments = [
            MockAssignment(
    ...
    def test_validate_all_accumulates_penalties(self):
        ...
        ***REMOVED*** Coverage constraint produces penalties with empty assignments
        manager.add(CoverageConstraint(weight=1000.0))

        context = create_basic_context()
        result = manager.validate_all([], context)

        ***REMOVED*** With empty assignments, Coverage should have penalty (0% coverage)
        assert result.penalty > 0
        assert result.penalty == 1000.0  ***REMOVED*** (1 - 0.0) * 1000.0


***REMOVED*** ============================================================================
***REMOVED*** Tests for Factory Methods
***REMOVED*** ============================================================================
...
class TestConstraintManagerFactories:
    ...
    def test_create_default_has_acgme_constraints(self):
        ...
        ***REMOVED*** Check for key ACGME constraints
    ...
    def test_create_default_has_resilience_tier1_enabled(self):
        ...
        ***REMOVED*** Tier 1 resilience constraints should be enabled by default
    ...
    def test_create_default_has_resilience_tier2_disabled(self):
        ...
        ***REMOVED*** Tier 2 resilience constraints should be disabled by default
    ...
    def test_create_resilience_aware_tier1(self):
        ...
        ***REMOVED*** Tier 1 should be enabled
    ...
    def test_create_resilience_aware_tier2(self):
        ...
        ***REMOVED*** Tier 2 should be enabled
    ...
    def test_create_minimal_has_only_essential_constraints(self):
        ...
        ***REMOVED*** Should have minimal set
        assert "Availability" in constraint_names
        assert "OnePersonPerBlock" in constraint_names
        assert "Coverage" in constraint_names

        ***REMOVED*** Should be small
    ...
    def test_create_strict_increases_soft_weights(self):
        ...
        ***REMOVED*** Find a soft constraint in both
        default_equity = next(
        ...
        ***REMOVED*** Strict should have doubled weight
        assert strict_equity.weight == default_equity.weight * 2


***REMOVED*** ============================================================================
***REMOVED*** Tests for All Registered Constraints
***REMOVED*** ============================================================================
...
class TestAllConstraintsValidatable:
    ...
    def test_all_hard_constraints_return_satisfied_on_empty(self):
        ...
        for constraint in manager.get_hard_constraints():
            ***REMOVED*** Skip constraints that require specific context data
            skip_constraints = {
    ...
    def test_all_soft_constraints_return_satisfied(self):
        ...
        for constraint in manager.get_soft_constraints():
            result = constraint.validate([], context)
            ***REMOVED*** Soft constraints always return satisfied=True
            assert result.satisfied is True
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for Constraint Interactions
***REMOVED*** ============================================================================
...
class TestConstraintInteractions:
    ...
    def test_no_conflicting_hard_constraints_on_valid_schedule(self):
        ...
        ***REMOVED*** Create a simple valid schedule
        residents = context.residents
        ...
        ***REMOVED*** Validate with all hard constraints
        for constraint in manager.get_hard_constraints():
            result = constraint.validate(assignments, context)
            ***REMOVED*** Most should pass on this simple schedule
            ***REMOVED*** (Some like WednesdayPM may fail, but shouldn't conflict)
            assert isinstance(result, ConstraintResult)
    ...
    def test_constraint_manager_aggregates_multiple_violations(self):
        ...
        ***REMOVED*** Template with capacity limit of 2
        ...
        ***REMOVED*** Create violations for both constraints
        assignments = [
            ***REMOVED*** Multiple primaries on same block (violates OnePersonPerBlock)
            MockAssignment(
                person_id=residents[0].id,
                block_id=blocks[0].id,
        ...
        assert result.satisfied is False
        ***REMOVED*** Should have violations from both constraints
    ...
    def test_soft_constraints_accumulate_penalties(self):
        ...
        ***REMOVED*** Use Coverage (which has penalty on empty) + Equity
        manager.add(CoverageConstraint(weight=1000.0)).add(EquityConstraint(weight=10.0))

        context = create_basic_context()

        ***REMOVED*** Create a simple schedule to generate Equity penalty
        residents = context.residents
        blocks = [b for b in context.blocks if not b.is_weekend]
        templates = context.templates

        ***REMOVED*** Assign all blocks to one resident (creates equity imbalance)
        assignments = []
        ...
        ***REMOVED*** Should have penalties from both constraints
        assert result.penalty > 0

        ***REMOVED*** Validate individual constraints to check additive behavior
...
class TestConstraintErrorHandling:
    ...
    def test_validate_handles_missing_context_data_gracefully(self):
        ...
        ***REMOVED*** Should not raise errors
        result = manager.validate_all([], context)
        assert isinstance(result, ConstraintResult)
    ...
    def test_validate_handles_none_assignments(self):
        ...
        ***REMOVED*** Most constraints should handle empty list
        result = constraint.validate([], context)
        assert isinstance(result, ConstraintResult)
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for SchedulingContext
***REMOVED*** ============================================================================
...
class TestSchedulingContext:
    ...
    def test_context_builds_blocks_by_date(self):
        ...
        ***REMOVED*** Should have 7 dates (one week)
        assert len(context.blocks_by_date) == 7

        ***REMOVED*** Each date should have 2 blocks (AM and PM)
...
class TestConstraintSystemIntegration:
    ...
    def test_all_factory_methods_produce_valid_managers(self):
        ...
        for factory in factories:
            ...
            ***REMOVED*** Should be able to validate
            result = manager.validate_all([], context)
            assert isinstance(result, ConstraintResult)
    ...
    def test_constraint_priorities_affect_order(self):
        ...
        ***REMOVED*** When sorted by priority (descending), should match expected order
        sorted_priorities = sorted(priorities, reverse=True)

        ***REMOVED*** The actual application order should be descending by priority
        ***REMOVED*** (This is verified in apply_to_cpsat and apply_to_pulp methods)
