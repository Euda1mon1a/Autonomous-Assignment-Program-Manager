...
***REMOVED*** ============================================================================
***REMOVED*** Mock Classes for Testing
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for WednesdayAMInternOnlyConstraint
***REMOVED*** ============================================================================
...
class TestWednesdayAMInternOnlyConstraint:
    ...
    def test_wednesday_constant(self):
        ...
        ***REMOVED*** Verify with a known Wednesday
        known_wednesday = date(2025, 1, 8)  ***REMOVED*** Wednesday, Jan 8, 2025
    ...
    def test_validate_intern_on_wednesday_am(self):
        ...
        ***REMOVED*** Create PGY-1 resident (intern)
        intern = MockPerson(
            person_type="resident",
            name="PGY-1 Resident",
            pgy_level=1,
        ...
        ***REMOVED*** Assign intern to Wednesday AM clinic
    ...
    def test_validate_pgy2_on_wednesday_am_violation(self):
        ...
        ***REMOVED*** Assign PGY-2 to Wednesday AM clinic (violation)
        assignment = MockAssignment(
            person_id=pgy2.id,
            block_id=am_block.id,
            rotation_template_id=clinic_template.id,
    ...
    def test_validate_wednesday_pm_not_checked(self):
        ...
        ***REMOVED*** PGY-2 on Wednesday PM is OK (constraint only checks AM)
        pgy2 = MockPerson(
            person_type="resident",
            name="PGY-2 Resident",
            pgy_level=2,
    ...
    def test_validate_non_clinic_template_ignored(self):
        ...
        ***REMOVED*** Non-clinic template (e.g., inpatient)
        inpatient_template = MockTemplate(
            name="Inpatient Ward",
            activity_type="inpatient",
        )

        ***REMOVED*** PGY-2 on Wednesday AM inpatient is OK (not clinic)
        pgy2 = MockPerson(
            person_type="resident",
            name="PGY-2 Resident",
            pgy_level=2,
    ...
    def test_validate_faculty_on_wednesday_am_ignored(self):
        ...
        ***REMOVED*** Faculty on Wednesday AM clinic is OK (constraint only checks residents)
        faculty = MockPerson(
            person_type="faculty",
            name="Dr. Faculty",
        )
    ...
    def test_validate_mixed_pgy_levels(self):
        ...
        assignments = [
            ***REMOVED*** PGY-1 on Wed AM - OK
            MockAssignment(
                person_id=pgy1.id,
                block_id=am_block.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** PGY-2 on Wed AM - Violation
            MockAssignment(
                person_id=pgy2.id,
                block_id=am_block.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** PGY-3 on Wed AM - Violation
            MockAssignment(
                person_id=pgy3.id,
                block_id=am_block.id,
                rotation_template_id=clinic_template.id,
        ...
        assert result.satisfied is False
        assert len(result.violations) == 2  ***REMOVED*** PGY-2 and PGY-3
    ...
    def test_validate_no_clinic_templates(self):
        ...
        ***REMOVED*** Template is not a clinic
        ...
        result = constraint.validate([assignment], context)
        ***REMOVED*** Should pass because no clinic templates to check
        assert result.satisfied is True
        assert len(result.violations) == 0


***REMOVED*** ============================================================================
***REMOVED*** Tests for WednesdayPMSingleFacultyConstraint
***REMOVED*** ============================================================================
...
class TestWednesdayPMSingleFacultyConstraint:
    ...
    def test_is_regular_wednesday_pm_first_week(self):
        ...
        ***REMOVED*** 1st Wednesday PM - should be True
    ...
    def test_is_regular_wednesday_pm_fourth_week(self):
        ...
        ***REMOVED*** 4th Wednesday PM - should be False
        wed4_am, wed4_pm = create_wednesday_blocks(2025, 1, 4)
        assert wed4_pm.date.day >= 22  ***REMOVED*** Verify it's 4th week
    ...
    def test_validate_fourth_wednesday_ignored(self):
        ...
        ***REMOVED*** No faculty on 4th Wed PM - should pass (not checked)
        context = SchedulingContext(
            residents=[],
            faculty=[],
    ...
    def test_validate_wednesday_am_ignored(self):
        ...
        ***REMOVED*** Faculty on Wed AM (not checked) + no faculty on Wed PM
        assignment = MockAssignment(
            person_id=faculty.id,
            block_id=wed1_am.id,
            rotation_template_id=clinic_template.id,
        ...
        result = constraint.validate([assignment], context)
        ***REMOVED*** Should fail because Wed PM has 0 faculty
        assert result.satisfied is False
        assert len(result.violations) == 1
    ...
    def test_validate_non_clinic_template_ignored(self):
        ...
        ***REMOVED*** Faculty on Wed PM inpatient (not clinic)
        assignment = MockAssignment(
            person_id=faculty.id,
            block_id=wed1_pm.id,
            rotation_template_id=inpatient_template.id,
        ...
        result = constraint.validate([assignment], context)
        ***REMOVED*** Should fail because clinic has 0 faculty
        assert result.satisfied is False
    ...
    def test_validate_resident_assignments_ignored(self):
        ...
        ***REMOVED*** Resident on Wed PM clinic (doesn't count as faculty)
        assignment = MockAssignment(
        ...
        result = constraint.validate([assignment], context)
        ***REMOVED*** Should fail because no faculty (resident doesn't count)
        assert result.satisfied is False
    ...
    def test_validate_multiple_wednesdays(self):
        ...
        ***REMOVED*** Create blocks for 1st, 2nd, 3rd Wed
        wed1_am, wed1_pm = create_wednesday_blocks(2025, 1, 1)
        wed2_am, wed2_pm = create_wednesday_blocks(2025, 1, 2)
        wed3_am, wed3_pm = create_wednesday_blocks(2025, 1, 3)
        ...
        assignments = [
            ***REMOVED*** 1st Wed - 1 faculty (OK)
            MockAssignment(
                person_id=faculty.id,
                block_id=wed1_pm.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 2nd Wed - 1 faculty (OK)
            MockAssignment(
                person_id=faculty.id,
                block_id=wed2_pm.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 3rd Wed - 0 faculty (Violation)
        ]
        ...
        result = constraint.validate(assignments, context)
        assert result.satisfied is False
        assert len(result.violations) == 1  ***REMOVED*** 3rd Wed missing faculty
...
***REMOVED*** ============================================================================
***REMOVED*** Tests for InvertedWednesdayConstraint
***REMOVED*** ============================================================================
...
class TestInvertedWednesdayConstraint:
    ...
    def test_is_fourth_wednesday_detection(self):
        ...
        ***REMOVED*** 4th Wednesday - should be True
        wed4_am, wed4_pm = create_wednesday_blocks(2025, 1, 4)
    ...
    def test_validate_empty_assignments(self):
        ...
        result = constraint.validate([], context)
        assert result.satisfied is False
        ***REMOVED*** Should have 2 violations (0 AM faculty, 0 PM faculty)
    ...
    def test_validate_same_faculty_am_and_pm_violation(self):
        ...
        result = constraint.validate(assignments, context)
        assert result.satisfied is False
        ***REMOVED*** Should have violation for same faculty AM and PM
    ...
    def test_validate_zero_faculty_am(self):
        ...
        result = constraint.validate([assignment], context)
        assert result.satisfied is False
        ***REMOVED*** Should have violation for 0 AM faculty
    ...
    def test_validate_two_faculty_am_violation(self):
        ...
        result = constraint.validate(assignments, context)
        assert result.satisfied is False
        ***REMOVED*** Should have violation for 2 AM faculty
    ...
    def test_validate_two_faculty_pm_violation(self):
        ...
        result = constraint.validate(assignments, context)
        assert result.satisfied is False
        ***REMOVED*** Should have violation for 2 PM faculty
    ...
    def test_validate_non_fourth_wednesday_ignored(self):
        ...
        ***REMOVED*** No assignments on 1st Wednesday - should pass (not checked)
        context = SchedulingContext(
            residents=[],
            faculty=[],
            blocks=[wed1_am, wed1_pm],
    ...
    def test_validate_non_clinic_template_ignored(self):
        ...
        ***REMOVED*** Faculty on 4th Wed AM inpatient (not clinic)
        assignment = MockAssignment(
            person_id=faculty.id,
            block_id=wed4_am.id,
            rotation_template_id=inpatient_template.id,
        ...
        result = constraint.validate([assignment], context)
        ***REMOVED*** Should fail because clinic has no faculty
        assert result.satisfied is False
    ...
    def test_validate_resident_assignments_ignored(self):
        ...
        assignments = [
            ***REMOVED*** Residents on both AM and PM (don't count)
            MockAssignment(
                person_id=resident.id,
                block_id=wed4_am.id,
                rotation_template_id=clinic_template.id,
        ...
        result = constraint.validate(assignments, context)
        ***REMOVED*** Should fail because no faculty (residents don't count)
        assert result.satisfied is False
        assert len(result.violations) == 2  ***REMOVED*** 0 AM faculty, 0 PM faculty
...
class TestTemporalConstraintsIntegration:
    ...
    def test_complete_month_all_constraints(self):
        ...
        ***REMOVED*** Create all 4 Wednesdays in January 2025
        wed1_am, wed1_pm = create_wednesday_blocks(2025, 1, 1)
        wed2_am, wed2_pm = create_wednesday_blocks(2025, 1, 2)
        wed3_am, wed3_pm = create_wednesday_blocks(2025, 1, 3)
        wed4_am, wed4_pm = create_wednesday_blocks(2025, 1, 4)
        ...
        ***REMOVED*** Valid assignments
        assignments = [
            ***REMOVED*** 1st Wed AM: PGY-1 only (correct)
            MockAssignment(
                person_id=pgy1.id,
                block_id=wed1_am.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 1st Wed PM: 1 faculty (correct)
            MockAssignment(
                person_id=faculty1.id,
                block_id=wed1_pm.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 2nd Wed AM: PGY-1 only (correct)
            MockAssignment(
                person_id=pgy1.id,
                block_id=wed2_am.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 2nd Wed PM: 1 faculty (correct)
            MockAssignment(
                person_id=faculty2.id,
                block_id=wed2_pm.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 3rd Wed AM: PGY-1 only (correct)
            MockAssignment(
                person_id=pgy1.id,
                block_id=wed3_am.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 3rd Wed PM: 1 faculty (correct)
            MockAssignment(
                person_id=faculty1.id,
                block_id=wed3_pm.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 4th Wed AM: 1 faculty (correct)
            MockAssignment(
                person_id=faculty1.id,
                block_id=wed4_am.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 4th Wed PM: 1 different faculty (correct)
            MockAssignment(
                person_id=faculty2.id,
                block_id=wed4_pm.id,
                rotation_template_id=clinic_template.id,
    ...
    def test_complete_month_multiple_violations(self):
        ...
        ***REMOVED*** Create all 4 Wednesdays
        wed1_am, wed1_pm = create_wednesday_blocks(2025, 1, 1)
        wed2_am, wed2_pm = create_wednesday_blocks(2025, 1, 2)
        wed3_am, wed3_pm = create_wednesday_blocks(2025, 1, 3)
        wed4_am, wed4_pm = create_wednesday_blocks(2025, 1, 4)
        ...
        ***REMOVED*** Assignments with violations
        assignments = [
            ***REMOVED*** 1st Wed AM: PGY-2 (VIOLATION - should be PGY-1 only)
            MockAssignment(
                person_id=pgy2.id,
                block_id=wed1_am.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 1st Wed PM: 2 faculty (VIOLATION - should be 1)
            MockAssignment(
                person_id=faculty1.id,
                block_id=wed1_pm.id,
                rotation_template_id=clinic_template.id,
            ...
            ***REMOVED*** 2nd Wed AM: PGY-1 (correct)
            MockAssignment(
                person_id=pgy1.id,
                block_id=wed2_am.id,
                rotation_template_id=clinic_template.id,
            ),
            ***REMOVED*** 2nd Wed PM: 0 faculty (VIOLATION - should be 1)
            ***REMOVED*** 4th Wed AM: 0 faculty (VIOLATION - should be 1)
            ***REMOVED*** 4th Wed PM: 0 faculty (VIOLATION - should be 1)
        ]
        ...
        ***REMOVED*** All should fail
        assert result1.satisfied is False
        assert result2.satisfied is False
        assert result3.satisfied is False

        ***REMOVED*** Check specific violations
        assert len(result1.violations) >= 1  ***REMOVED*** PGY-2 on Wed AM
        assert len(result2.violations) >= 2  ***REMOVED*** 2 faculty on 1st, 0 on 2nd and 3rd
        assert len(result3.violations) >= 2  ***REMOVED*** 0 AM and 0 PM on 4th Wed
