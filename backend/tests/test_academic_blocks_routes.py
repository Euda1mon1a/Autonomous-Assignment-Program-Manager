...
***REMOVED*** ============================================================================
***REMOVED*** Test Data Setup Fixtures
***REMOVED*** ============================================================================
...
def sample_academic_blocks(db: Session) -> list[Block]:
    ...
    while current_date <= end_date:
        ...
        ***REMOVED*** Update block number every 28 days (4 weeks)
...
def sample_assignments_academic_year(
    ...
    ***REMOVED*** Assign first few weeks for testing
    for block in sample_academic_blocks[:56]:  ***REMOVED*** First 4 weeks (28 days × 2 blocks/day)
        for i, resident in enumerate(sample_residents_all_pgy[:3]):  ***REMOVED*** First 3 residents
...
***REMOVED*** ============================================================================
***REMOVED*** Block Matrix Endpoint Tests
***REMOVED*** ============================================================================
...
class TestGetAcademicBlockMatrix:
    ...
    def test_get_matrix_success(
        ...
        ***REMOVED*** Verify academic year
        assert data["academic_year"] == academic_year_2024

        ***REMOVED*** Verify columns (academic blocks)
        assert isinstance(data["columns"], list)
        assert len(data["columns"]) == 13  ***REMOVED*** 13 blocks in academic year

        ***REMOVED*** Verify first column structure
        if data["columns"]:
    ...
    def test_get_matrix_with_pgy_filter(
        ...
        ***REMOVED*** All returned residents should be PGY-2
    ...
    def test_get_matrix_cells_structure(
        ...
        ***REMOVED*** Verify cells structure
        ...
        if data["cells"]:
            ...
            ***REMOVED*** ACGME status structure
    ...
    def test_get_matrix_summary_structure(
        ...
        ***REMOVED*** Verify summary structure
    ...
    def test_get_matrix_with_assignments(
        ...
        ***REMOVED*** Should have cells with rotation data
        cells_with_rotation = [
    ...
    def test_get_matrix_empty_academic_year(
        ...
        ***REMOVED*** Should return structure but with empty/zero assignments
        assert data["academic_year"] == "2022-2023"
        assert len(data["columns"]) == 13  ***REMOVED*** Always generates blocks


***REMOVED*** ============================================================================
***REMOVED*** Block Matrix Validation Tests
***REMOVED*** ============================================================================
...
class TestAcademicBlockMatrixValidation:
    ...
    def test_get_matrix_invalid_year_range(
        ...
        response = client.get(
            "/api/matrix/academic-blocks",
            params={"academic_year": "2024-2026"},  ***REMOVED*** Should be 2024-2025
            headers=auth_headers,
        )
...
***REMOVED*** ============================================================================
***REMOVED*** Block List Endpoint Tests
***REMOVED*** ============================================================================
...
class TestListAcademicBlocks:
    ...
    def test_list_blocks_success(
        ...
        ***REMOVED*** Verify blocks
        assert isinstance(data["blocks"], list)
        assert data["total_blocks"] == len(data["blocks"])
        assert len(data["blocks"]) == 13  ***REMOVED*** 13 blocks per academic year
    ...
    def test_list_blocks_ordering(
        ...
        ***REMOVED*** Blocks should be in sequential order
    ...
    def test_list_blocks_date_ranges(
        ...
        ***REMOVED*** First block should start July 1, 2024
        first_block = data["blocks"][0]
        assert first_block["start_date"] == "2024-07-01"

        ***REMOVED*** Last block should end June 30, 2025
        last_block = data["blocks"][-1]
        assert last_block["end_date"] == "2025-06-30"

        ***REMOVED*** Check that blocks are contiguous (no gaps)
    ...
    def test_list_blocks_with_assignments(
        ...
        ***REMOVED*** First block should have assignments
        first_block = data["blocks"][0]
    ...
    def test_list_blocks_statistics_accuracy(
        ...
        for block in data["blocks"]:
            ***REMOVED*** Compliance rate should be 0-100
            assert 0 <= block["compliance_rate"] <= 100

            ***REMOVED*** Average hours should be non-negative
            assert block["average_hours"] >= 0

            ***REMOVED*** Total assignments should be non-negative
    ...
    def test_list_blocks_empty_academic_year(
        ...
        ***REMOVED*** Should return structure with zero statistics
...
***REMOVED*** ============================================================================
***REMOVED*** Block List Validation Tests
***REMOVED*** ============================================================================
...
class TestListAcademicBlocksValidation:
    ...
    def test_list_blocks_invalid_year_range(
        ...
        response = client.get(
            "/api/matrix/blocks",
            params={"academic_year": "2025-2024"},  ***REMOVED*** Reversed
            headers=auth_headers,
        )
...
***REMOVED*** ============================================================================
***REMOVED*** Edge Cases and Special Scenarios
***REMOVED*** ============================================================================
...
class TestAcademicBlocksEdgeCases:
    ...
    def test_matrix_no_residents(
        ...
        ***REMOVED*** Should return empty rows
    ...
    def test_matrix_pgy_level_no_matches(
        ...
        ***REMOVED*** Note: All PGY levels 1-3 exist, so this tests the filtering logic
        response = client.get(
            "/api/matrix/academic-blocks",
            params={
                "academic_year": academic_year_2024,
        ...
        ***REMOVED*** Should only return PGY-1 residents
    ...
    def test_blocks_multiple_academic_years(
        ...
        ***REMOVED*** Academic years should be different
        assert data_2024["academic_year"] != data_2023["academic_year"]

        ***REMOVED*** Date ranges should be different
    ...
    def test_matrix_acgme_compliance_calculation(
        ...
        ***REMOVED*** Check that ACGME status is populated
    ...
    def test_matrix_cell_count(
        ...
        ***REMOVED*** Total cells = residents × blocks
    ...
    def test_matrix_future_academic_year(
        ...
        ***REMOVED*** Should work even for future years
    ...
    def test_blocks_past_academic_year(
        ...
        ***REMOVED*** Should work for past years
        assert data["academic_year"] == "2010-2011"
        assert data["total_blocks"] == 13


***REMOVED*** ============================================================================
***REMOVED*** Response Format Tests
***REMOVED*** ============================================================================
...
class TestAcademicBlocksResponseFormat:
    ...
    def test_matrix_date_format(
        ...
        ***REMOVED*** Check date formats in columns
        for column in data["columns"]:
            start_date = column["start_date"]
            end_date = column["end_date"]

            ***REMOVED*** Should be parseable as ISO date
            try:
