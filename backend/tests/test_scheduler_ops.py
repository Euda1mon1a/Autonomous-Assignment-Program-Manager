...
class TestSitrepEndpoint:
    ...
    def test_sitrep_task_metrics_structure(
        ...
        ***REMOVED*** Verify task metrics fields
        ...
        ***REMOVED*** Verify types and ranges
...
class TestFixItEndpoint:
    ...
    def test_fix_it_greedy_mode(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Greedy mode should have warning
...
class TestApproveEndpoint:
    ...
    def test_generate_approval_token(self, client: TestClient, auth_headers: dict):
        ...
        assert len(data["token"]) > 20  ***REMOVED*** Secure token
        assert data["task_ids"] == ["task-1", "task-2"]
        assert "expires_at" in data

        ***REMOVED*** Return token for use in other tests
        return data["token"]
    ...
    def test_approve_with_valid_token(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** First generate a token
        ...
        ***REMOVED*** Then approve with that token
        response = client.post(
            "/api/scheduler/approve",
            headers=auth_headers,
            json={
    ...
    def test_deny_with_valid_token(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Then deny with that token
        response = client.post(
            "/api/scheduler/approve",
            headers=auth_headers,
            json={
    ...
    def test_approve_specific_task(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Generate token for multiple tasks
        token_response = client.post(
            "/api/scheduler/approve/token/generate",
            headers=auth_headers,
            json={
...
def auth_headers(client: TestClient) -> dict:
    ...
    """
    ***REMOVED*** In real tests, you would:
    ***REMOVED*** 1. Create a test user
    ***REMOVED*** 2. Login to get JWT token
    ***REMOVED*** 3. Return headers with Authorization: Bearer <token>

    ***REMOVED*** Placeholder - update based on your auth implementation
    return {
