...
***REMOVED*** =============================================================================
***REMOVED*** Helper Functions for Dashboard Queries
***REMOVED*** =============================================================================
...
async def get_faculty_week_counts(
    ...
    ***REMOVED*** Count total weeks assigned (grouped by week)
    ***REMOVED*** This is a simplified count - in reality would group by week_start
    ...
    ***REMOVED*** For simplicity, count weeks by dividing by sessions per week (14 = 7 days * 2 sessions)
    weeks_assigned = total_weeks // 14 if total_weeks > 0 else 0

    ***REMOVED*** Count completed weeks (before today)
    today = date.today()
...
async def get_upcoming_weeks(
    ...
    ***REMOVED*** Get future assignments
    today = date.today()
    assignments = db.query(Assignment).join(
        ...
        Assignment.rotation_template_id == fmit_template.id,
        Block.date >= today
    ).order_by(Block.date).limit(limit * 14).all()  ***REMOVED*** Rough limit

    ***REMOVED*** Group by week
    week_map = defaultdict(list)
    for assignment in assignments:
        ***REMOVED*** Get Monday of the week
    ...
    ***REMOVED*** Convert to list and limit
    upcoming = []
...
class TestDashboardQueries:
    ...
    async def test_get_faculty_week_counts_with_assignments(self, db, sample_faculty):
        ...
        ***REMOVED*** Create blocks for 2 weeks (14 days * 2 sessions = 28 blocks)
        blocks = []
        ...
        ***REMOVED*** Create assignments
        ...
        assert result["weeks_assigned"] == 2  ***REMOVED*** 28 blocks / 14 = 2 weeks
    ...
    async def test_get_upcoming_weeks_with_data(self, db, sample_faculty):
        ...
        ***REMOVED*** Create future blocks (next week)
    ...
    async def test_get_pending_swaps_with_data(self, db, sample_faculty, sample_faculty_members):
        ...
        ***REMOVED*** Create swap requests targeting this faculty
...
***REMOVED*** =============================================================================
***REMOVED*** Dashboard Endpoint Tests
***REMOVED*** =============================================================================
...
class TestDashboardEndpoint:
    ...
    def test_get_dashboard_requires_faculty_profile(self, client: TestClient, admin_user: User, auth_headers: dict):
        ...
        ***REMOVED*** Should return 403 if no faculty profile linked
    ...
    def test_get_dashboard_success(self, client: TestClient, db: Session, auth_headers: dict, admin_user: User):
        ...
        ***REMOVED*** Create faculty profile linked to admin user
        faculty = Person(
            id=uuid4(),
            name="Dr. Test Faculty",
            type="faculty",
            email=admin_user.email,  ***REMOVED*** Link by email
        ...
        ***REMOVED*** Verify stats structure
        stats = data["stats"]
    ...
    def test_get_dashboard_with_data(self, client: TestClient, db: Session, auth_headers: dict, admin_user: User):
        ...
        ***REMOVED*** Create faculty profile
        faculty = Person(
            id=uuid4(),
            name="Dr. Test Faculty",
            type="faculty",
...
class TestDashboardIntegration:
    ...
    def test_full_dashboard_workflow(self, client: TestClient, db: Session, auth_headers: dict, admin_user: User):
        ...
        ***REMOVED*** Setup: Create faculty profile
        faculty = Person(
            id=uuid4(),
        ...
        ***REMOVED*** Verify all components present
