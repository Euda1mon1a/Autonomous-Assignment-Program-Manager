...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Request Validation
***REMOVED*** ============================================================================
...
class TestRequestValidation:
    ...
    def test_invalid_json_body_returns_422(
        ...
        response = client.post(
            ...
            data="invalid json{",  ***REMOVED*** Malformed JSON
    ...
    def test_missing_required_field_returns_422(
        ...
        response = client.post(
            ...
            headers=auth_headers,
            json={
                ***REMOVED*** Missing required 'name' field
                "type": "resident",
    ...
    def test_invalid_field_type_returns_422(
        ...
        response = client.post(
            ...
            json={
                ...
                "type": "resident",
                "email": "test@example.com",
                "pgy_level": "not_a_number",  ***REMOVED*** Should be integer
            },
        )
    ...
    def test_query_parameter_type_validation(
        ...
        response = client.get(
            "/api/assignments?limit=not_a_number",  ***REMOVED*** Invalid limit type
            headers=auth_headers,
        )
    ...
    def test_path_parameter_uuid_validation(
        ...
        response = client.get(
            "/api/people/invalid-uuid",  ***REMOVED*** Not a valid UUID
            headers=auth_headers,
        )
    ...
    def test_date_parameter_format_validation(
        ...
        response = client.get(
            "/api/blocks?date=not-a-date",  ***REMOVED*** Invalid date format
            headers=auth_headers,
        )
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Response Validation
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Test Class: Error Handling
***REMOVED*** ============================================================================
...
class TestErrorHandling:
    ...
    def test_error_response_has_detail_field(
        ...
        response = client.get(
            f"/api/people/{uuid4()}",  ***REMOVED*** Non-existent resource
            headers=auth_headers,
        )
    ...
    def test_validation_error_includes_field_info(
        ...
        response = client.post(
            ...
            json={
                "type": "resident",
                ***REMOVED*** Missing name and email
            },
        )

        assert response.status_code == 422
        error = response.json()
        ***REMOVED*** Should specify missing fields
        assert "detail" in error
    ...
    def test_internal_error_returns_500(
        ...
        ***REMOVED*** This test would need to mock an internal error
        ***REMOVED*** Implementation depends on how endpoints handle exceptions
        pass
    ...
    def test_conflict_error_returns_409(
        ...
        ***REMOVED*** Create person with unique email
        person1 = Person(
            id=uuid4(),
            name="Dr. First",
            type="faculty",
        ...
        ***REMOVED*** Try to create another with same email
        response = client.post(
            "/api/people",
            headers=auth_headers,
            json={
        ...
        ***REMOVED*** Should return 409 Conflict or 400 Bad Request
        assert response.status_code in [400, 409]


***REMOVED*** ============================================================================
***REMOVED*** Test Class: HTTP Headers
***REMOVED*** ============================================================================
...
class TestHTTPHeaders:
    ...
    def test_content_type_json_required(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Should reject non-JSON content type
    ...
    def test_cors_headers_present(self, client: TestClient):
        ...
        ***REMOVED*** CORS headers should be present
        ***REMOVED*** Implementation depends on CORS middleware configuration
    ...
    def test_rate_limit_headers_present(self, client: TestClient, auth_headers: dict):
        ...
        ***REMOVED*** Rate limit headers (if enabled)
        ***REMOVED*** X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset
        ***REMOVED*** Implementation depends on rate limiting configuration


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Pagination
***REMOVED*** ============================================================================
...
class TestPagination:
    ...
    def test_limit_parameter_controls_page_size(
        ...
        ***REMOVED*** Create multiple people
        for i in range(20):
            person = Person(
                id=uuid4(),
                name=f"Dr. Person {i}",
    ...
    def test_offset_parameter_skips_results(
        ...
        ***REMOVED*** Create people with predictable names
        for i in range(10):
            person = Person(
                id=uuid4(),
        ...
        ***REMOVED*** Pages should have different results
        ...
        ***REMOVED*** Assuming items have IDs
        if len(items1) > 0 and len(items2) > 0:
            ids1 = {item["id"] for item in items1}
            ids2 = {item["id"] for item in items2}
            assert ids1 != ids2  ***REMOVED*** Different items


***REMOVED*** ============================================================================
***REMOVED*** Test Class: Filtering and Sorting
***REMOVED*** ============================================================================
...
class TestFilteringAndSorting:
    ...
    def test_filter_by_type(self, client: TestClient, auth_headers: dict, db: Session):
        ...
        ***REMOVED*** Create mix of residents and faculty
        for i in range(3):
            resident = Person(
                id=uuid4(),
        ...
        data = response.json()
        items = data if isinstance(data, list) else data.get("items", [])
        ***REMOVED*** All results should be residents
        for item in items:
    ...
    def test_sort_by_field(self, client: TestClient, auth_headers: dict, db: Session):
        ...
        ***REMOVED*** Create people with different names
        ...
        ***REMOVED*** Check if sorted (assuming ascending order)
        if len(items) >= 2:
    ...
    def test_date_range_filtering(
        ...
        ***REMOVED*** Create blocks for different dates
        for i in range(10):
        ...
        ***REMOVED*** Query for specific date range
        ...
        ***REMOVED*** All results should be within range
        for item in items:
