...
class TestRAGHealth:
    ...
    def test_rag_health_returns_stats(
        ...
        ***REMOVED*** Mock the RAG service to avoid needing pgvector in tests
...
***REMOVED*** =============================================================================
***REMOVED*** Retrieval Endpoint Tests
***REMOVED*** =============================================================================
...
class TestRAGRetrieve:
    ...
    def test_rag_retrieve_returns_results(
        ...
        ***REMOVED*** Create mock retrieved documents
        mock_docs = [
            RetrievedDocument(
                id=uuid4(),
        ...
        ***REMOVED*** Verify document structure
    ...
    def test_rag_retrieve_filters_by_category(
        ...
        ***REMOVED*** Create mock response with only scheduling_policy documents
        mock_docs = [
            RetrievedDocument(
                id=uuid4(),
        ...
        ***REMOVED*** Verify filter was applied (mock was called with doc_type)
        ...
        ***REMOVED*** Verify response only contains scheduling_policy docs
    ...
    def test_rag_retrieve_empty_query(
        ...
        ***REMOVED*** Pydantic validation should catch empty string (min_length=1)
    ...
    def test_rag_retrieve_whitespace_only_query(
        ...
        ***REMOVED*** Whitespace-only query should fail validation in service
        with patch("app.api.routes.rag.RAGService") as MockRAGService:
            mock_service = MagicMock()
            ...
            response = client.post(
                "/api/rag/retrieve",
                json={"query": "   "},  ***REMOVED*** Whitespace only
                headers=auth_headers,
            )
    ...
    def test_rag_retrieve_with_similarity_threshold(
        ...
        mock_retrieval_response = RetrievalResponse(
            query="test query",
            documents=[],  ***REMOVED*** No documents meet the high threshold
            total_results=0,
        ...
        with patch("app.api.routes.rag.RAGService") as MockRAGService:
            ...
            response = client.post(
                ...
                json={
                    "query": "test query",
                    "min_similarity": 0.9,  ***REMOVED*** High threshold
                },
                headers=auth_headers,
            )
        ...
        ***REMOVED*** Verify min_similarity was passed to service
        mock_service.retrieve.assert_called_once()
        call_kwargs = mock_service.retrieve.call_args[1]
...
class TestRAGIngest:
    ...
    def test_rag_ingest_invalid_doc_type(
        ...
        response = client.post(
            ...
            json={
                "content": "Test document content.",
                "doc_type": "invalid_type",  ***REMOVED*** Not in allowed list
            },
            headers=auth_headers,
        )

        ***REMOVED*** Pydantic validation should catch invalid doc_type
        assert response.status_code == 422


***REMOVED*** =============================================================================
***REMOVED*** Context Endpoint Tests
***REMOVED*** =============================================================================
...
class TestRAGContext:
    ...
    def test_rag_context_success(
        ...
        mock_context_response = RAGContext(
            ...
            context="***REMOVED*** Relevant Context for Query: What are the scheduling rules?\n\nScheduling must follow ACGME guidelines...",
            sources=[
                RetrievedDocument(
                    id=uuid4(),
...
class TestRAGErrorHandling:
    ...
    def test_rag_retrieve_service_error(
        ...
        ***REMOVED*** Should return 500 with generic error message
