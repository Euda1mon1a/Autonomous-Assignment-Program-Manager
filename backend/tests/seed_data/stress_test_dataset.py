...
class StressTestDataset:
    ...
    def seed_large_program(db: Session, num_residents: int = 50) -> dict:
        ...
        """
        ***REMOVED*** Calculate proportional faculty (1 faculty per 10 residents)
        ...
        ***REMOVED*** Create one month of blocks (for performance testing)
    ...
    def seed_massive_assignment_load(
        ...
        ***REMOVED*** Create massive number of assignments
        ***REMOVED*** Total assignments = num_residents × num_days × 2 (AM/PM)
        assignments = []
    ...
    def seed_swap_flood(db: Session, num_faculty: int = 50, num_swaps: int = 500) -> dict:
        ...
        ***REMOVED*** Create massive number of swaps
    ...
    def seed_certification_flood(
        ...
        ***REMOVED*** Create many certifications
        all_certifications = []
    ...
    def seed_full_stress_test(
        ...
        Returns:
            dict: Dictionary with all seeded entities
        """
        ***REMOVED*** Create comprehensive schedule
        schedule = ScheduleFactory.create_complete_schedule(
            db,
            num_residents=num_residents,
            num_faculty=num_faculty,
        ...
        ***REMOVED*** Add extra swaps
        swaps = SwapFactory.create_batch_swaps(
            db, faculty=schedule["faculty"], num_swaps=100
        )

        ***REMOVED*** Add extra absences
