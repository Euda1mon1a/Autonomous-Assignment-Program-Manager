...
class TestSchedulingEngineBasics:
    ...
    def test_availability_matrix_with_absence(
        ...
        ***REMOVED*** Create absence for first resident
        absence = Absence(
            id=uuid4(),
        ...
        ***REMOVED*** Check first resident is unavailable for absence period
...
class TestGreedyAlgorithm:
    ...
    def test_greedy_respects_availability(
        ...
        ***REMOVED*** Make first resident absent for entire period
        absence = Absence(
            id=uuid4(),
            person_id=sample_residents[0].id,
            start_date=start_date,
...
class TestFacultyAssignment:
    ...
    def test_faculty_respects_availability(
        ...
        ***REMOVED*** Make all but one faculty absent
