...
***REMOVED*** The TestClient is available in conftest.py
...
class TestScheduleGenerationRoutes:
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** Schedule Generation Tests
    ***REMOVED*** =========================================================================
    ...
    def test_post_schedule_generate_success(
        ...
        ***REMOVED*** May succeed with 200, partial success with 207, or fail with 422
        assert response.status_code in [200, 207, 422]

        ***REMOVED*** If successful, should have expected fields
    ...
    def test_post_schedule_generate_invalid_date_range(self, client, auth_headers):
        ...
        ***REMOVED*** Pydantic may reject this as 422, or engine may reject as 400/422
    ...
    ***REMOVED*** =========================================================================
    ...
    def test_get_schedule_validate_success(self, client):
        ...
        ***REMOVED*** The validate endpoint is a GET, not POST, based on the routes
        response = client.get(
        ...
        ***REMOVED*** Should return validation result even for empty schedule
    ...
    def test_get_schedule_validate_acgme_compliance(self, client):
        ...
        assert response.status_code == 200
        data = response.json()
        ***REMOVED*** Should have compliance information
        assert "is_compliant" in data or "violations" in data or "status" in data

    ***REMOVED*** =========================================================================
    ***REMOVED*** Emergency Coverage Tests
    ***REMOVED*** =========================================================================
    ...
    def test_post_emergency_coverage_success(
        ...
        ***REMOVED*** Should succeed or fail gracefully if no coverage available
...
class TestScheduleRetrievalRoutes:
    ...
    def test_get_schedule_by_date_range(self, client):
        ...
        ***REMOVED*** Based on routes, the endpoint is /api/schedule/{start_date}/{end_date}
...
class TestScheduleModificationRoutes:
    ...
    def test_schedule_generation_idempotency_key(self, client, auth_headers):
        ...
        ***REMOVED*** Should process the request (may succeed or fail)
    ...
    def test_schedule_generation_duplicate_idempotency_key(self, client, auth_headers):
        ...
        ***REMOVED*** Second request with same key and params
        ...
        ***REMOVED*** Should either return cached result or conflict (409)
        assert response2.status_code in [first_status, 409]
        ***REMOVED*** If replayed, should have header
        if response2.status_code == first_status and first_status in [200, 207]:
            ***REMOVED*** May have X-Idempotency-Replayed header
            pass
