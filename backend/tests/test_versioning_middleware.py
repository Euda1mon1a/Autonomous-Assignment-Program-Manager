...
class TestVersioningMiddleware:
    ...
    def app(self):
        ...
        ***REMOVED*** Add versioning middleware
    ...
    def test_version_detection_from_header(self, client):
        ...
        ***REMOVED*** Header should override URL
        assert response.json()["version"] == "v2"
    ...
    def test_version_detection_from_query_param(self, client):
        ...
        ***REMOVED*** Query param should be used when no header
        assert response.json()["version"] == "v2"
    ...
    def test_version_priority_order(self, client):
        ...
        ***REMOVED*** URL takes precedence over header
        response = client.get(
            "/api/v2/test",
...
class TestDeprecationManager:
    ...
    def test_sunset_date_calculation(self, deprecation_mgr):
        ...
        assert days_remaining >= 29  ***REMOVED*** Allow for test execution time
    ...
    def test_get_all_deprecations(self, deprecation_mgr):
        ...
        ***REMOVED*** Should include default deprecations
...
class TestVersionedAPIRouter:
    ...
    def app(self):
        ...
        ***REMOVED*** Create versioned routers
    ...
    def test_version_enforcement(self, client):
        ...
        ***REMOVED*** Try to access v2 endpoint with v3 version
        ***REMOVED*** This should work since no max_version set
        response = client.get(
            "/api/v2/users",
...
class TestResponseTransformers:
    ...
    def test_date_format_transformer(self):
        ...
        ***REMOVED*** Test datetime transformation
        ...
        assert "T" in v2_result  ***REMOVED*** ISO 8601 format
    ...
    def test_transform_registry(self):
        ...
        ***REMOVED*** Register custom transformer
        registry.register("test", DateFormatTransformer())

        ***REMOVED*** Verify registration
...
class TestVersionChangelog:
    ...
    def test_version_changelog_structure(self):
        ...
        ***REMOVED*** Check v2 has breaking changes
        v2 = changelog["v2"]
...
class TestVersionIntegration:
    ...
    def app(self):
        ...
        ***REMOVED*** Get deprecation manager
    ...
    def test_version_detection_integration(self, client):
        ...
        ***REMOVED*** Test URL path detection
        response = client.get("/current-version?version=2")
        assert response.status_code == 200
        assert response.json()["version"] == "v2"

        ***REMOVED*** Test header detection
        response = client.get(
            "/current-version",
            headers={"Accept-Version": "v3"}
        )
