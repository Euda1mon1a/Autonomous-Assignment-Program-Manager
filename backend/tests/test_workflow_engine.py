...
async def mock_timeout_step_handler(input_data: dict) -> dict:
    ...
    await asyncio.sleep(100)  ***REMOVED*** Will timeout
    return {"success": True}
...
def test_template_versioning(workflow_engine, simple_template_definition, db):
    ...
    ***REMOVED*** Create initial template
    ...
    ***REMOVED*** Update with new definition (creates new version)
    ...
    ***REMOVED*** Original version should still exist
...
def test_get_template_by_name(workflow_engine, simple_template_definition, db):
    ...
    ***REMOVED*** Get latest version by name
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Instance Tests
***REMOVED*** ============================================================================
...
def test_workflow_instance_timeout_calculation(
    ...
    ***REMOVED*** Use default timeout from template (300 seconds)
    ...
    assert abs(default_timeout - 300) < 2  ***REMOVED*** Within 2 seconds

    ***REMOVED*** Override with custom timeout
...
***REMOVED*** ============================================================================
***REMOVED*** Workflow Execution Tests
***REMOVED*** ============================================================================
...
async def test_execute_simple_workflow(workflow_engine, simple_template_definition, db):
    ...
    ***REMOVED*** Execute workflow synchronously
...
async def test_execute_parallel_workflow(
    ...
    ***REMOVED*** Verify all steps executed
    step_execs = (
        db.query(WorkflowStepExecution)
        .filter(WorkflowStepExecution.workflow_instance_id == instance.id)
        .all()
...
async def test_conditional_step_execution(
    ...
    ***REMOVED*** Step 2 should be executed (condition is true)
    step2 = (
        db.query(WorkflowStepExecution)
        .filter(
...
***REMOVED*** ============================================================================
***REMOVED*** Query and Statistics Tests
***REMOVED*** ============================================================================
...
def test_query_workflow_instances(workflow_engine, simple_template_definition, db):
    ...
    ***REMOVED*** Create multiple instances
    for i in range(5):
    ...
    ***REMOVED*** Query all instances
    instances, total = workflow_engine.query_instances()
    assert total >= 5

    ***REMOVED*** Query by template
    instances, total = workflow_engine.query_instances(template_id=template.id)
    assert total == 5

    ***REMOVED*** Query by priority
    instances, total = workflow_engine.query_instances(
        template_id=template.id,
        priority_min=3,
    )
    assert total == 2  ***REMOVED*** Priorities 3 and 4
...
def test_workflow_statistics(workflow_engine, simple_template_definition, db):
    ...
    ***REMOVED*** Create instances with different statuses
...
def test_build_execution_plan(workflow_engine, parallel_template_definition):
    ...
    ***REMOVED*** Should have 3 groups: [step1], [step2a, step2b], [step3]
    assert len(execution_plan) == 3
    assert len(execution_plan[0]) == 1  ***REMOVED*** step1
    assert len(execution_plan[1]) == 2  ***REMOVED*** step2a, step2b
    assert len(execution_plan[2]) == 1  ***REMOVED*** step3
