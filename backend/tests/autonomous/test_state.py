...
class TestIterationRecord:
    ...
    def test_to_ndjson_line(self):
        ...
        ***REMOVED*** Should be valid JSON without trailing newline
...
class TestRunState:
    ...
    def test_update_with_result_no_improvement(self):
        ...
        result = EvaluationResult(
            valid=True,
            score=0.7,  ***REMOVED*** No improvement
            hard_constraint_pass=True,
            soft_score=0.3,
            coverage_rate=0.8,
            total_violations=0,
        ...
        assert state.best_score == 0.9  ***REMOVED*** Unchanged
        assert state.best_iteration == 5  ***REMOVED*** Unchanged
...
class TestStateStore:
    ...
    def test_save_and_load_run(self, tmp_path):
        ...
        ***REMOVED*** Create and modify state
        state = store.create_run(
            scenario="test",
            start_date=date(2025, 1, 1),
            end_date=date(2025, 3, 31),
    ...
    def test_get_best_from_history(self, tmp_path):
        ...
        ***REMOVED*** Add iterations with varying scores
        ...
        assert best.iteration == 3  ***REMOVED*** Index of 0.8
