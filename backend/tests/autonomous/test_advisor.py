...
class TestSuggestionSchema:
    ...
    def test_timeout_too_low(self):
        ...
        params = {"timeout_seconds": 5.0}  ***REMOVED*** Below 10s minimum
        is_valid, error = SuggestionSchema.validate_params(params)
    ...
    def test_timeout_too_high(self):
        ...
        params = {"timeout_seconds": 1000.0}  ***REMOVED*** Above 600s maximum
        is_valid, error = SuggestionSchema.validate_params(params)
    ...
    def test_weight_out_of_range(self):
        ...
        params = {
            "constraint_weights": {
                "coverage_rate": 5.0,  ***REMOVED*** Above 2.0 max
            }
        }
        is_valid, error = SuggestionSchema.validate_params(params)
...
class TestLLMAdvisor:
    ...
    def test_validate_suggestion_low_confidence(self):
        ...
        suggestion = Suggestion(
            type=SuggestionType.PARAMETER_CHANGE,
            confidence=0.2,  ***REMOVED*** Below 0.3 threshold
    ...
    def test_validate_suggestion_no_reasoning(self):
        ...
        suggestion = Suggestion(
            type=SuggestionType.PARAMETER_CHANGE,
            confidence=0.8,
            reasoning="",  ***REMOVED*** Empty reasoning
        )
    ...
    def test_validate_suggestion_invalid_params(self):
        ...
        ***REMOVED*** The params contain an invalid algorithm
        ***REMOVED*** But GeneratorParams doesn't validate itself, so we need to
        ***REMOVED*** check via the schema
        assert advisor.validate_suggestion(suggestion) is False
...
class TestMockLLMAdvisor:
    ...
    def test_suggest_none_on_good_result(self):
        ...
        ***REMOVED*** No suggestion needed for good result
        assert suggestion is None
