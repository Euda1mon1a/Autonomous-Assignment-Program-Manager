...
***REMOVED*** Use in-memory SQLite for tests
...
***REMOVED*** Configure mappers to ensure SQLAlchemy-Continuum creates version tables
configure_mappers()
...
def sample_rotation_template(db: Session) -> RotationTemplate:
    ...
    template = RotationTemplate(
        ...
        activity_type="outpatient",  ***REMOVED*** Must match engine's default filter
        abbreviation="SM",
