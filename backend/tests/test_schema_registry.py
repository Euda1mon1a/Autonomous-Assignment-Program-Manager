...
***REMOVED*** ============================================================================
***REMOVED*** Sample Schema Definitions
***REMOVED*** ============================================================================
...
PERSON_SCHEMA_V2_BACKWARD = {
    ...
    "properties": {
        ...
        "email": {"type": "string", "format": "email"},
        "age": {"type": "integer"},
        "phone": {"type": "string"},  ***REMOVED*** New optional field
    },
    "required": ["name", "email"],  ***REMOVED*** Same required fields
}
...
PERSON_SCHEMA_V2_BREAKING = {
    ...
    "required": ["name", "email", "phone"],  ***REMOVED*** Added required field - BREAKING
}
...
PERSON_SCHEMA_V2_TYPE_CHANGE = {
    ...
    "properties": {
        "name": {"type": "string"},
        "email": {"type": "string", "format": "email"},
        "age": {"type": "string"},  ***REMOVED*** Changed type from integer - BREAKING
    },
    "required": ["name", "email"],
}
...
***REMOVED*** ============================================================================
***REMOVED*** SchemaEvolutionRule Tests
***REMOVED*** ============================================================================
...
class TestSchemaEvolutionRule:
    ...
    def test_forward_compatible_remove_optional_field(self):
        ...
        ***REMOVED*** Removing optional field is forward compatible
        ***REMOVED*** (old schema can still read new data)
    ...
    def test_full_compatibility_breaking_changes(self):
        ...
        ***REMOVED*** Adding optional field is backward compatible but not forward compatible
        assert len(violations) > 0


***REMOVED*** ============================================================================
***REMOVED*** SchemaRegistry Basic Operations Tests
***REMOVED*** ============================================================================
...
class TestSchemaRegistryBasicOperations:
    ...
    async def test_get_schema_default_version(
        ...
        ***REMOVED*** V1 is marked as default in fixture
    ...
    async def test_get_schema_latest_when_no_default(
        ...
        ***REMOVED*** Unset default on v1
        ...
        assert schema is not None
        ***REMOVED*** Should return v2 as it's the latest active
...
***REMOVED*** ============================================================================
***REMOVED*** SchemaRegistry List and Search Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** Compatibility Check Tests
***REMOVED*** ============================================================================
...
class TestSchemaCompatibilityChecks:
    ...
    async def test_check_forward_compatibility(
        ...
        ***REMOVED*** Adding field is forward incompatible
        assert result.compatible is False
    ...
    async def test_check_full_compatibility(
        ...
        ***REMOVED*** Adding optional field is backward compatible but not forward
        assert result.compatible is False
    ...
    async def test_check_transitive_compatibility(
        ...
        ***REMOVED*** Create a third version
        result = await registry.check_compatibility(
            "PersonCreate",
            PERSON_SCHEMA_V2_BACKWARD,  ***REMOVED*** Same as v2
            "transitive",
        )

        ***REMOVED*** Should check against both v1 and v2
...
***REMOVED*** ============================================================================
***REMOVED*** Schema Lifecycle Tests
***REMOVED*** ============================================================================
...
class TestSchemaLifecycle:
    ...
    async def test_deprecate_schema(
        ...
        ***REMOVED*** Verify schema status changed
    ...
    async def test_deprecate_already_deprecated_fails(
        ...
        ***REMOVED*** Deprecate once
        await registry.deprecate_schema("PersonCreate", 1)

        ***REMOVED*** Try to deprecate again
    ...
    async def test_set_default_version(
        ...
        ***REMOVED*** Verify v2 is now default and v1 is not
        db.refresh(sample_schema_v1)
...
***REMOVED*** ============================================================================
***REMOVED*** Documentation Generation Tests
***REMOVED*** ============================================================================
...
class TestSchemaDocumentation:
    ...
    async def test_generate_documentation_fields(
        ...
        ***REMOVED*** Check field information
        field_names = [f["name"] for f in doc.fields]
        assert "name" in field_names
        assert "email" in field_names

        ***REMOVED*** Check required field marking
    ...
    async def test_generate_documentation_migration_guides(
        ...
        ***REMOVED*** V2 has migration notes, should appear in guides
...
***REMOVED*** ============================================================================
***REMOVED*** Convenience Functions Tests
***REMOVED*** ============================================================================
...
class TestEdgeCasesAndErrors:
    ...
    async def test_register_schema_with_empty_definition(
        ...
        ***REMOVED*** Should succeed - validation is up to the schema definition
        assert result["success"] is True
    ...
    async def test_register_schema_version_zero_fails(
        ...
        ***REMOVED*** This should fail due to CHECK constraint version > 0
        ...
        with pytest.raises(Exception):  ***REMOVED*** Database integrity error
            db.commit()
    ...
    async def test_multiple_default_versions_prevented(
        ...
        ***REMOVED*** V1 is default from fixture
        assert sample_schema_v1.is_default is True

        ***REMOVED*** Set v2 as default
        await registry.set_default_version("PersonCreate", 2)

        ***REMOVED*** Refresh v1 from database
        registry.db.refresh(sample_schema_v1)

        ***REMOVED*** V1 should no longer be default
        assert sample_schema_v1.is_default is False
        assert sample_schema_v2.is_default is True
    ...
    async def test_compatibility_check_with_missing_fields(
        ...
        ***REMOVED*** Should handle missing properties/required fields gracefully
        assert isinstance(result, SchemaCompatibilityResult)
