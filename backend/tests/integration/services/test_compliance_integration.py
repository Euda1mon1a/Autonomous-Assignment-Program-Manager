...
class TestComplianceIntegration:
    ...
    def test_80_hour_rule_enforcement_integration(
        ...
        ***REMOVED*** Create assignments (all blocks = violation)
        for block in blocks:
        ...
        ***REMOVED*** compliance_service = ComplianceService(db)
        ***REMOVED*** result = compliance_service.check_80_hour_rule(
        ***REMOVED***     person_id=sample_resident.id,
        ***REMOVED***     start_date=start_date,
        ***REMOVED*** )
        ***REMOVED*** assert result.is_compliant == False
    ...
    def test_1_in_7_rule_enforcement_integration(
        ...
        ***REMOVED*** Create continuous assignments (violation)
        for i in range(14):
            current_date = start_date + timedelta(days=i)
            for tod in ["AM", "PM"]:
                block = Block(
        ...
        ***REMOVED*** Check compliance
        ***REMOVED*** Should detect violation of 1-in-7 rule
    ...
    def test_supervision_ratio_integration(
        ...
        ***REMOVED*** Create supervised rotation
        ...
        ***REMOVED*** Assign residents without adequate supervision
        ...
        ***REMOVED*** Check supervision compliance
        ***REMOVED*** Should detect inadequate supervision
    ...
    def test_rolling_average_calculation_integration(
        ...
        ***REMOVED*** Create 4 weeks of assignments with varying load
        for i in range(28):
            current_date = start_date + timedelta(days=i)
            for tod in ["AM", "PM"]:
                block = Block(
                ...
                ***REMOVED*** Vary assignment pattern
                if i % 3 != 0:  ***REMOVED*** Work 2 out of 3
                    assignment = Assignment(
                        id=uuid4(),
                        block_id=block.id,
                        person_id=sample_resident.id,
        ...
        ***REMOVED*** Calculate rolling average
        ***REMOVED*** Should compute 4-week rolling average correctly
