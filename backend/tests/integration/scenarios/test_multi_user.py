...
class TestMultiUserScenarios:
    ...
    def test_coordinator_approves_faculty_swap_scenario(
        ...
        ***REMOVED*** Faculty creates swap request
        ***REMOVED*** Coordinator approves
    ...
    def test_resident_requests_admin_approves_scenario(
        ...
        ***REMOVED*** Resident requests vacation
        ***REMOVED*** Admin approves
        ***REMOVED*** Schedule updated
        pass
