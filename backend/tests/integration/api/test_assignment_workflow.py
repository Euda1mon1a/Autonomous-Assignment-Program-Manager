...
class TestAssignmentWorkflow:
    ...
    def test_assignment_conflict_detection_workflow(
        ...
        ***REMOVED*** Try to create conflicting assignment
        ...
        ***REMOVED*** Should detect conflict
        if conflict_response.status_code in [200, 201]:
            ***REMOVED*** Check conflict endpoint
    ...
    def test_assignment_by_date_range_workflow(
        ...
        ***REMOVED*** Create assignments across date range
        start_date = date.today()
        for i in range(7):
            current_date = start_date + timedelta(days=i)
            block = Block(
    ...
    def test_assignment_history_workflow(
        ...
        ***REMOVED*** Get assignment history
