...
class TestUserManagementWorkflow:
    ...
    def test_create_user_workflow(
        ...
        ***REMOVED*** Step 2: Verify user was created
    ...
    def test_update_user_workflow(
        ...
        ***REMOVED*** Step 1: Update user details
    ...
    def test_delete_user_workflow(
        ...
        ***REMOVED*** Step 3: Verify user is deleted or deactivated
        get_response = client.get(
            f"/api/people/{person_id}",
            headers=auth_headers,
        )
        ***REMOVED*** Should be 404 or show as inactive
    ...
    def test_list_users_workflow(
        ...
        ***REMOVED*** Step 2: Test pagination
    ...
    def test_user_profile_workflow(
        ...
        ***REMOVED*** Step 1: Get own profile
    ...
    def test_user_roles_workflow(
        ...
        ***REMOVED*** Step 3: Verify role change
    ...
    def test_bulk_user_import_workflow(
        ...
        ***REMOVED*** Step 1: Prepare bulk import data
        users_data = [
            {
                "name": f"Dr. Import {i}",
                "type": "resident",
    ...
    def test_user_deactivation_workflow(
        ...
        ***REMOVED*** Step 2: Deactivate user
        ...
        ***REMOVED*** Step 3: Verify user is inactive
        get_response = client.get(
            f"/api/people/{person_id}",
            headers=auth_headers,
        )
        if get_response.status_code == 200:
            data = get_response.json()
            ***REMOVED*** May have is_active field
            if "is_active" in data:
                assert data["is_active"] == False

        ***REMOVED*** Step 4: Reactivate user
