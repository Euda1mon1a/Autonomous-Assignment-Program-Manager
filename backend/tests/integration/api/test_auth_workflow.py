...
class TestAuthWorkflow:
    ...
    def test_user_registration_workflow(
        ...
        ***REMOVED*** Step 1: Register new user
        ...
        ***REMOVED*** May succeed or return 404 if registration disabled
        ...
        if register_response.status_code in [200, 201]:
            ...
            ***REMOVED*** Step 2: Verify user can login
    ...
    def test_login_logout_workflow(
        ...
        ***REMOVED*** Step 2: Access protected endpoint
    ...
    def test_token_refresh_workflow(
        ...
        ***REMOVED*** Step 2: Request token refresh
    ...
    def test_password_change_workflow(
        ...
        ***REMOVED*** Step 1: Change password
        ...
        if change_response.status_code == 200:
            ***REMOVED*** Step 2: Verify old password doesn't work
            ...
            ***REMOVED*** Step 3: Verify new password works
    ...
    def test_password_reset_workflow(
        ...
        ***REMOVED*** Step 2: Request password reset
        ...
        ***REMOVED*** Step 3: Reset password with token (if implemented)
        if reset_request.status_code in [200, 202]:
            ***REMOVED*** In real system, would get token from email
    ...
    def test_role_based_access_workflow(
        ...
        ***REMOVED*** Step 1: Create users with different roles
        roles_data = [
            ("admin_test", "admin"),
        ...
        ***REMOVED*** Step 2: Test admin-only endpoint
        if "admin" in tokens:
            ...
            ***REMOVED*** Should succeed for admin
            assert admin_endpoint.status_code in [200, 404]

        ***REMOVED*** Step 3: Test resident cannot access admin endpoint
    ...
    def test_session_expiration_workflow(
        ...
        ***REMOVED*** Step 2: Use valid token
        valid_response = client.get("/api/people/", headers=headers)
        assert valid_response.status_code == 200

        ***REMOVED*** Step 3: Use invalid token
    ...
    def test_concurrent_session_workflow(
        ...
        ***REMOVED*** Step 1: Login from first session
        login1 = client.post(
            "/api/auth/login/json",
        ...
        ***REMOVED*** Step 2: Login from second session
        login2 = client.post(
            "/api/auth/login/json",
            json={"username": "testadmin", "password": "testpass123"},
        )
        ...
        ***REMOVED*** Step 3: Both tokens should work (unless single-session enforced)
        ...
        ***REMOVED*** Both should work or first should be invalidated
    ...
    def test_api_key_authentication_workflow(
        ...
        ***REMOVED*** Step 1: Generate API key
        ...
        if api_key_response.status_code in [200, 201]:
            ...
            ***REMOVED*** Step 2: Use API key to access endpoint
