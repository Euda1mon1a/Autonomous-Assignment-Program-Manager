...
class TestComplianceWorkflow:
    ...
    def test_80_hour_rule_validation_workflow(
        ...
        ***REMOVED*** Step 1: Create blocks for one week
        ...
        ***REMOVED*** Step 2: Assign resident to all blocks (should violate 80-hour rule)
        for block in blocks:
            client.post(
                "/api/assignments/",
                json={
        ...
        ***REMOVED*** Step 3: Check compliance
        ...
        ***REMOVED*** Should detect violation or provide compliance status
        assert compliance_response.status_code in [200, 404]

        if compliance_response.status_code == 200:
            data = compliance_response.json()
            ***REMOVED*** Verify 80-hour rule is checked
    ...
    def test_1_in_7_rule_validation_workflow(
        ...
        ***REMOVED*** Step 1: Create blocks for 14 days (2 weeks)
        start_date = date.today()
        ...
        ***REMOVED*** Step 2: Get created blocks
        ...
        if blocks_response.status_code == 200:
            ...
            ***REMOVED*** Step 3: Assign to all blocks (violates 1-in-7 rule)
            for block in blocks:
                client.post(
                    "/api/assignments/",
                    json={
            ...
            ***REMOVED*** Step 4: Validate compliance
    ...
    def test_supervision_ratio_workflow(
        ...
        ***REMOVED*** Step 2: Create template requiring supervision
        template_response = client.post(
            ...
            json={
                ...
                "max_supervision_ratio": 2,  ***REMOVED*** 1:2 faculty:resident
            },
            headers=auth_headers,
        )
        ...
        ***REMOVED*** Step 3: Assign residents without faculty (should fail supervision check)
        for resident in sample_residents[:3]:  ***REMOVED*** 3 residents
            client.post(
                "/api/assignments/",
                json={
                    "block_id": block_id,
        ...
        ***REMOVED*** Step 4: Check supervision compliance
        ...
        ***REMOVED*** Step 5: Add faculty to meet ratio
        if len(sample_faculty_members) > 0:
            ...
            ***REMOVED*** Step 6: Re-check compliance
    ...
    def test_rolling_4_week_average_workflow(
        ...
        ***REMOVED*** Step 1: Create blocks for 4 weeks
        start_date = date.today()
        ...
        ***REMOVED*** Step 2: Get blocks
        ...
        if blocks_response.status_code == 200:
            ...
            ***REMOVED*** Step 3: Create varying workload across weeks
            for i, block in enumerate(blocks):
                ***REMOVED*** Vary assignment to create realistic schedule
                if i % 3 != 0:  ***REMOVED*** Work 2 out of 3 blocks
                    client.post(
                        "/api/assignments/",
                        json={
                            "block_id": block["id"],
            ...
            ***REMOVED*** Step 4: Check rolling average
    ...
    def test_compliance_dashboard_workflow(
        ...
        ***REMOVED*** Step 1: Get overall compliance dashboard
        ...
        if dashboard_response.status_code == 200:
            ...
            ***REMOVED*** Should contain compliance metrics
            assert isinstance(data, (dict, list))

        ***REMOVED*** Step 2: Get per-resident compliance
    ...
    def test_violation_alert_workflow(
        ...
        ***REMOVED*** Step 1: Create scenario that violates rules
        start_date = date.today()

        ***REMOVED*** Create 10 consecutive days of full schedules
        for i in range(10):
            current_date = start_date + timedelta(days=i)
            for tod in ["AM", "PM"]:
                block_response = client.post(
        ...
        ***REMOVED*** Step 2: Trigger compliance check
        ...
        ***REMOVED*** Step 3: Check for alerts
    ...
    def test_compliance_report_generation_workflow(
        ...
        ***REMOVED*** Request compliance report
    ...
    def test_proactive_compliance_check_workflow(
        ...
        ***REMOVED*** Step 1: Create some baseline assignments
        ...
        ***REMOVED*** Step 2: Check if new assignment would violate compliance
        if len(sample_blocks) > 5:
            ...
            ***REMOVED*** Should return validation result
