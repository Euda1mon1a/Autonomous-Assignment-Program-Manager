...
class TestScheduleWorkflow:
    ...
    def test_create_schedule_workflow(
        ...
        ***REMOVED*** Step 1: Create rotation templates
        ...
        ***REMOVED*** Step 2: Create blocks for a week
        ...
        ***REMOVED*** Step 3: Create assignments
        blocks = db.query(Block).filter(Block.date >= start_date).all()
        assignments_created = []

        for i, block in enumerate(blocks[:10]):  ***REMOVED*** Assign first 10 blocks
        ...
        ***REMOVED*** Step 4: Validate schedule compliance
        ...
        ***REMOVED*** Step 5: Verify assignments were created
        assert len(assignments_created) == 10

        ***REMOVED*** Step 6: Retrieve schedule
    ...
    def test_modify_schedule_workflow(
        ...
        ***REMOVED*** Step 1: Get current assignment
        ...
        ***REMOVED*** Step 2: Update assignment to different resident
        ...
        ***REMOVED*** Step 3: Verify change was persisted
    ...
    def test_delete_schedule_workflow(
        ...
        ***REMOVED*** Step 1: Verify assignment exists
        get_response = client.get(
            f"/api/assignments/{sample_assignment.id}",
            headers=auth_headers,
        )
        ...
        ***REMOVED*** Step 2: Delete assignment
        ...
        ***REMOVED*** Step 3: Verify assignment no longer exists
        verify_response = client.get(
            f"/api/assignments/{sample_assignment.id}",
            headers=auth_headers,
        )
    ...
    def test_bulk_schedule_generation_workflow(
        ...
        ***REMOVED*** Step 2: Create blocks for 4 weeks
        start_date = date.today()
        for i in range(28):
            current_date = start_date + timedelta(days=i)
            for tod in ["AM", "PM"]:
        ...
        ***REMOVED*** Step 3: Request bulk schedule generation
        ...
        ***REMOVED*** Step 4: Verify generation started
    ...
    def test_schedule_conflict_detection_workflow(
        ...
        ***REMOVED*** Step 1: Create first assignment
        ...
        ***REMOVED*** Step 2: Try to create overlapping assignment (same person, same block)
        ...
        ***REMOVED*** Step 3: Should either reject or detect conflict
        ***REMOVED*** Different systems may handle this differently
        if second_response.status_code in [200, 201]:
            ***REMOVED*** If created, check for conflict detection
            ...
            ***REMOVED*** Should return 400 or 409 for conflict
    ...
    def test_schedule_copy_workflow(
        ...
        ***REMOVED*** Step 1: Create assignments in first week
        first_week = sample_blocks[:14]  ***REMOVED*** 7 days * 2 blocks
        ...
        ***REMOVED*** Step 2: Create blocks for second week
        ...
        ***REMOVED*** Step 3: Request schedule copy
        ...
        ***REMOVED*** Should either succeed or explain why copy isn't supported
