...
class TestBulkOperationsWorkflow:
    ...
    def test_bulk_assignment_creation_workflow(
        ...
        ***REMOVED*** Prepare bulk assignments
        assignments_data = [
            {
    ...
    def test_bulk_delete_workflow(
        ...
        ***REMOVED*** Create blocks to delete
        block_ids = []
        for i in range(5):
            block = Block(
                id=uuid4(),
    ...
    def test_bulk_validation_workflow(
        ...
        ***REMOVED*** Prepare invalid and valid data
        assignments_data = [
            {
                "block_id": str(uuid4()),  ***REMOVED*** Non-existent block
