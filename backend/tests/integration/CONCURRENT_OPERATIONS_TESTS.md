***REMOVED*** Concurrent Operations Integration Tests
...
***REMOVED******REMOVED******REMOVED*** 1. Concurrent Assignment Edit Tests (`TestConcurrentAssignmentEdit`)

**Frame 5.1 Implementation**

***REMOVED******REMOVED******REMOVED******REMOVED*** `test_concurrent_assignment_edit_with_separate_sessions`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `test_concurrent_edit_with_explicit_locking`
...
***REMOVED******REMOVED******REMOVED*** 2. Swap During Schedule Generation Tests (`TestSwapDuringGeneration`)

**Frame 5.2 Implementation**

***REMOVED******REMOVED******REMOVED******REMOVED*** `test_swap_during_schedule_generation`
...
***REMOVED******REMOVED******REMOVED*** 3. Task Cancellation Tests (`TestTaskCancellation`)

**Frame 5.3 Implementation**

***REMOVED******REMOVED******REMOVED******REMOVED*** `test_task_cancellation_mid_execution`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `test_task_cancellation_with_asyncio`
...
***REMOVED******REMOVED******REMOVED*** 4. Swap Race Condition Tests (`TestSwapRaceCondition`)

**Frame 5.4 Implementation**

***REMOVED******REMOVED******REMOVED******REMOVED*** `test_swap_race_condition_two_faculty_want_same_shift`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `test_swap_auto_matcher_prevents_double_booking`
...
***REMOVED******REMOVED******REMOVED*** 5. Additional Edge Cases (`TestConcurrentEdgeCases`)

***REMOVED******REMOVED******REMOVED******REMOVED*** `test_concurrent_read_during_write`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `test_deadlock_prevention`
...
***REMOVED******REMOVED******REMOVED*** 1. Thread-Based Concurrency
```python
...
***REMOVED******REMOVED******REMOVED*** 2. Separate Database Sessions
```python
...
***REMOVED******REMOVED******REMOVED*** 3. Explicit Row Locking
```python
assignment = (
    db.query(Assignment)
    .filter_by(id=assignment_id)
    .with_for_update()  ***REMOVED*** SELECT ... FOR UPDATE
    .first()
)
```

***REMOVED******REMOVED******REMOVED*** 4. Cancellation Flag Pattern
```python
...
***REMOVED******REMOVED******REMOVED*** Run All Concurrent Operation Tests
```bash
cd backend
...
***REMOVED******REMOVED******REMOVED*** Run with Detailed Output
```bash
...
***REMOVED******REMOVED******REMOVED*** From `integration/conftest.py`
...
***REMOVED******REMOVED*** Database Behavior Differences

***REMOVED******REMOVED******REMOVED*** SQLite (Test Environment)
...
***REMOVED******REMOVED******REMOVED*** PostgreSQL (Production)
...
***REMOVED******REMOVED******REMOVED*** 1. Optimistic Locking
