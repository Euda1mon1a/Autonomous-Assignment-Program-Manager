...
***REMOVED*** ============================================================================
***REMOVED*** SlotType Classification Tests
***REMOVED*** ============================================================================
...
***REMOVED*** ============================================================================
***REMOVED*** ProviderSchedule Tests
***REMOVED*** ============================================================================
...
class TestProviderSchedule:
    ...
    def test_get_fmit_weeks_single_week(self):
        ...
        ***REMOVED*** Add FMIT slots for Mon-Fri of a single week (March 3-7, 2025)
        for day in range(3, 8):  ***REMOVED*** Mon-Fri
        ...
        assert len(weeks) == 1
        ***REMOVED*** Week should be Monday (Mar 3) to Sunday (Mar 9)
    ...
    def test_get_fmit_weeks_multiple_weeks(self):
        ...
        ***REMOVED*** Week 1: March 3-5, 2025 (Mon-Wed)
        for day in [3, 4, 5]:
            schedule.add_slot(ScheduleSlot(
                "Dr. Smith",
                date(2025, 3, day),
        ...
        ***REMOVED*** Week 2: March 17-19, 2025 (Mon-Wed)
        for day in [17, 18, 19]:
            schedule.add_slot(ScheduleSlot(
                "Dr. Smith",
                date(2025, 3, day),
    ...
    def test_has_alternating_pattern_detected(self):
        ...
        ***REMOVED*** Week on: Mar 3, Week off, Week on: Mar 17, Week off, Week on: Mar 31
        ***REMOVED*** This creates an alternating pattern with 1-week gaps
        schedule.add_slot(ScheduleSlot("Dr. Smith", date(2025, 3, 3), "AM", SlotType.FMIT, "fmit"))
        schedule.add_slot(ScheduleSlot("Dr. Smith", date(2025, 3, 17), "AM", SlotType.FMIT, "fmit"))
    ...
    def test_has_alternating_pattern_not_detected(self):
        ...
        ***REMOVED*** 3 consecutive weeks (no gaps)
        schedule.add_slot(ScheduleSlot("Dr. Smith", date(2025, 3, 3), "AM", SlotType.FMIT, "fmit"))
        schedule.add_slot(ScheduleSlot("Dr. Smith", date(2025, 3, 10), "AM", SlotType.FMIT, "fmit"))
        schedule.add_slot(ScheduleSlot("Dr. Smith", date(2025, 3, 17), "AM", SlotType.FMIT, "fmit"))

        ***REMOVED*** Gap calculation: 7 days between each week (consecutive)
        ***REMOVED*** has_alternating_pattern looks for gaps of 6-8 days but needs at least 2 such gaps
        ***REMOVED*** Here we have consecutive weeks, not alternating
        assert not schedule.has_alternating_pattern()


***REMOVED*** ============================================================================
***REMOVED*** Date Parsing Tests
***REMOVED*** ============================================================================
...
class TestDateParsing:
    ...
    def test_parse_date_day_month_abbrev(self, importer):
        ...
        ***REMOVED*** Note: This format assumes current academic year
...
***REMOVED*** ============================================================================
***REMOVED*** ClinicScheduleImporter Excel Parsing Tests
***REMOVED*** ============================================================================
...
class TestClinicScheduleImporter:
    ...
    def create_invalid_excel(self):
        ...
        ***REMOVED*** No dates, just random text
        ws['A1'] = "Random"
        ws['B1'] = "Data"
        ws['C1'] = "Here"
        ws['A2'] = "No"
    ...
    def test_import_invalid_excel_structure(self):
        ...
        ***REMOVED*** Should still succeed but may have limited data
        ***REMOVED*** The importer tries to detect format and may find nothing
        assert result is not None
    ...
    def test_import_counts_slot_types(self):
        ...
        ***REMOVED*** Dr. Smith: clinic, fmit, off
        ***REMOVED*** Dr. Jones: fmit, clinic, vacation
        assert result.total_slots == 6
        assert result.clinic_slots == 2  ***REMOVED*** 2 clinic slots
        assert result.fmit_slots == 2    ***REMOVED*** 2 fmit slots
    ...
    def test_provider_schedule_slot_retrieval(self):
        ...
        ***REMOVED*** Dr. Smith has clinic on 3/10, fmit on 3/11, off on 3/12
...
class TestEdgeCases:
    ...
    def test_schedule_slot_key_property(self):
        ...
        ***REMOVED*** Same provider, date, time should have same key
        slot1_dup = ScheduleSlot("Dr. Smith", date(2025, 3, 10), "AM", SlotType.FMIT, "fmit")
        assert slot1.key == slot1_dup.key

        ***REMOVED*** Different times should have different keys
        assert slot1.key != slot2.key

        ***REMOVED*** Different providers should have different keys
