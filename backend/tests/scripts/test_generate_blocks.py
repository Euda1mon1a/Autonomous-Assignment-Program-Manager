...
class TestBlockCountPerDay:
    ...
    def test_single_day_creates_2_blocks(self):
        ...
        ***REMOVED*** Logic test: for each day, we create AM and PM
        time_of_days = ["AM", "PM"]
    ...
    def test_full_year_creates_728_blocks(self):
        ...
        ***REMOVED*** Note: The model docstring says 730 (365 × 2), but the academic
        ***REMOVED*** year is actually 364 days (13 × 28), so it's 728 blocks
        num_blocks = 13
        days_per_block = 28
        blocks_per_day = 2
