...
class TestHeatmapServiceGroupBy:
    ...
    def test_generate_daily_heatmap(self):
        ...
        ***REMOVED*** Add another assignment on day 1
        assignment = MagicMock()
        assignment.block = MagicMock()
        assignment.block.date = date(2025, 1, 1)
        assignments.append(assignment)

        ***REMOVED*** Mock swap records query
        ...
        ***REMOVED*** Should have 2 assignments on day 1, 1 on day 2, 1 on day 3
    ...
    def test_generate_daily_heatmap_with_fmit(self):
        ...
        ***REMOVED*** Mock swap records query to return 2 swaps
    ...
    def test_generate_weekly_heatmap(self):
        ...
        ***REMOVED*** Create mock assignments
        ***REMOVED*** Week starting 2024-12-30 (Monday)
        assignments = []
        for i in range(2):
            assignment = MagicMock()
            assignment.block = MagicMock()
        ...
        ***REMOVED*** Week starting 2025-01-06 (Monday)
        for i in range(3):
            assignment = MagicMock()
            assignment.block = MagicMock()
    ...
    def test_generate_weekly_heatmap_with_fmit(self):
        ...
        ***REMOVED*** Mock swap records query to return 3 swaps
    ...
    def test_generate_heatmap_with_daily_group_by(self):
        ...
        ***REMOVED*** Create mock database and assignments
        db = MagicMock()
        assignments = []

        ***REMOVED*** Day 1: 3 assignments
        for i in range(3):
            assignment = MagicMock()
            assignment.block = MagicMock()
            assignment.block.date = date(2025, 1, 1)
        ...
        ***REMOVED*** Mock the query methods
    ...
    def test_generate_heatmap_with_weekly_group_by(self):
        ...
        ***REMOVED*** Week 1 (2024-12-30 to 2025-01-05): 4 assignments
        for i in range(4):
            assignment = MagicMock()
            assignment.block = MagicMock()
            assignment.block.date = date(2024, 12, 30 + i)
        ...
        ***REMOVED*** Week 2 (2025-01-06 to 2025-01-12): 3 assignments
        for i in range(3):
            assignment = MagicMock()
            assignment.block = MagicMock()
            assignment.block.date = date(2025, 1, 6 + i)
        ...
        ***REMOVED*** Mock the query methods
        ...
        assert result.data.y_labels == ["Total Assignments"]
        assert len(result.data.x_labels) >= 2
        assert result.data.z_values[0][0] == 4.0  ***REMOVED*** First week
        assert result.metadata["grouping_type"] == "weekly"
    ...
    def test_generate_heatmap_person_grouping_still_works(self):
        ...
        ***REMOVED*** Create mock person objects
        person1 = MagicMock()
        person1.id = "person-1"
    ...
    def test_generate_heatmap_rotation_grouping_still_works(self):
        ...
        ***REMOVED*** Create mock rotation objects
        rotation1 = MagicMock()
