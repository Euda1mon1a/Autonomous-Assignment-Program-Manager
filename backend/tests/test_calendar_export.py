...
class TestCalendarExportICSEndpoint:
    ...
    def test_export_ics_basic_success(
        ...
        ***REMOVED*** Verify ICS content exists
    ...
    def test_export_ics_with_multiple_assignments(
        ...
        ***REMOVED*** Create blocks and assignments for a week
        ...
        for i in range(7):
            ...
            ***REMOVED*** Assignments - alternate between rotations
        ...
        ***REMOVED*** Should have 14 events (7 days × 2 blocks per day)
    ...
    def test_export_ics_with_date_filtering(
        ...
        ***REMOVED*** Create assignments over 30 days
        ...
        ***REMOVED*** Export only first 7 days
        response = client.get(
            "/api/calendar/export.ics",
            params={
                "person_id": str(person.id),
        ...
        ***REMOVED*** Should only have 7 events
        event_count = content.count("BEGIN:VEVENT")
    ...
    def test_export_ics_with_different_roles(
        ...
        ***REMOVED*** Create assignments with different roles
        ...
        ***REMOVED*** Verify role labels in summary
...
class TestRFC5545Compliance:
    ...
    def test_ics_has_required_vcalendar_properties(
        ...
        ***REMOVED*** Required properties per RFC 5545
        assert "BEGIN:VCALENDAR" in content
    ...
    def test_ics_vcalendar_structure(
        ...
        ***REMOVED*** First line should be BEGIN:VCALENDAR (after stripping whitespace)
        first_line = lines[0].strip()
        assert first_line == "BEGIN:VCALENDAR"

        ***REMOVED*** Last line should be END:VCALENDAR
    ...
    def test_ics_vevent_properties(
        ...
        ***REMOVED*** Required VEVENT properties per RFC 5545
    ...
    def test_ics_uid_format(
        ...
        ***REMOVED*** Extract all UIDs
        uid_pattern = r"UID:([^\r\n]+)"
        uids = re.findall(uid_pattern, content)

        ***REMOVED*** All UIDs should be unique
        assert len(uids) == len(set(uids))

        ***REMOVED*** UIDs should contain @residency-scheduler domain
        for uid in uids:
    ...
    def test_ics_datetime_format(
        ...
        ***REMOVED*** Check for proper date-time format (YYYYMMDDTHHMMSS)
        ***REMOVED*** AM block should start at 08:00
        assert "20240910T080000" in content  ***REMOVED*** Start time
        assert "20240910T120000" in content  ***REMOVED*** End time (12:00 PM)
...
class TestTimezoneHandling:
    ...
    def test_vtimezone_component_present(
        ...
        ***REMOVED*** VTIMEZONE component should be present
    ...
    def test_vtimezone_america_new_york(
        ...
        ***REMOVED*** Should specify America/New_York timezone
    ...
    def test_vtimezone_standard_and_daylight(
        ...
        ***REMOVED*** Should have both STANDARD and DAYLIGHT components
    ...
    def test_vtimezone_est_edt_names(
        ...
        ***REMOVED*** Should include EST and EDT timezone names
    ...
    def test_am_block_time_correct(
        ...
        ***REMOVED*** AM block: 8:00 AM - 12:00 PM
        assert "20240515T080000" in content  ***REMOVED*** 8:00 AM start
        assert "20240515T120000" in content  ***REMOVED*** 12:00 PM end
    ...
    def test_pm_block_time_correct(
        ...
        ***REMOVED*** PM block: 1:00 PM - 5:00 PM
        assert "20240620T130000" in content  ***REMOVED*** 1:00 PM start
        assert "20240620T170000" in content  ***REMOVED*** 5:00 PM end
...
class TestFilterParameters:
    ...
    def test_person_id_filter_required(
        ...
        ***REMOVED*** Should return 422 Unprocessable Entity for missing required parameter
    ...
    def test_invalid_date_format(
        ...
        response = client.get(
            ...
            params={
                "person_id": str(person_id),
                "start_date": "2024-13-45",  ***REMOVED*** Invalid date
    ...
    def test_filters_by_exact_person_id(
        ...
        ***REMOVED*** Create two different people
        person1 = Person(
            id=uuid.uuid4(),
            name="Dr. Person One",
            type="resident",
        ...
        ***REMOVED*** Create assignments for both people on same block
        ...
        ***REMOVED*** Export for person1 only
        response = client.get(
            "/api/calendar/export.ics",
            params={
        ...
        ***REMOVED*** Should only have 1 event (person1's assignment)
...
class TestErrorHandling:
    ...
    def test_empty_assignment_set(
        ...
        ***REMOVED*** Should succeed but return calendar with no events
        assert response.status_code == 200
        content = response.text
        assert "BEGIN:VCALENDAR" in content
    ...
    def test_internal_server_error_handling(
        ...
        ***REMOVED*** This test verifies the error handling structure
        ***REMOVED*** In a real scenario, this might be tested with mocking
        ***REMOVED*** For now, we just verify the endpoint structure is sound
        ...
        ***REMOVED*** Normal request should work
        response = client.get(
            "/api/calendar/export.ics",
            params={
                "person_id": str(person.id),
        ...
        ***REMOVED*** Should not error on valid request
    ...
    def test_malformed_query_parameters(
        ...
        response = client.get(
            "/api/calendar/export.ics",
            params={
                "person_id": "12345",  ***REMOVED*** Not a valid UUID
