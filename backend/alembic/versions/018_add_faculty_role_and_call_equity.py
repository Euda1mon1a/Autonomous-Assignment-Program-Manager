...
def upgrade() -> None:
    ...
    """
    ***REMOVED*** Add faculty_role column
    op.add_column(
        'people',
        sa.Column('faculty_role', sa.String(50), nullable=True)
    )

    ***REMOVED*** Add call equity tracking fields
    op.add_column(
        'people',
    ...
    ***REMOVED*** Add check constraint for valid faculty roles
...
def downgrade() -> None:
    ...
    ***REMOVED*** Drop check constraint first
