...
down_revision: str | None = "b15f4b13e203"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "file_hash", sa.String(64), nullable=True
        ),  # SHA-256 for dedup detection
        ...
        sa.Column(
            "conflict_resolution",
            sa.Enum("replace", "merge", "upsert", name="conflictresolutionmode"),
            nullable=False,
    ...
    op.create_table(
        ...
        # Conflict detection
        sa.Column(
            "conflict_type", sa.String(50), nullable=True
        ),  # none/duplicate/overwrite
    ...
    op.create_index(
        "ix_import_staged_assignments_status", "import_staged_assignments", ["status"]
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_import_staged_assignments_status", table_name="import_staged_assignments"
    )
    op.drop_index(
        "ix_import_staged_assignments_batch_id", table_name="import_staged_assignments"
    )
