...
down_revision: Union[str, None] = 'acfc96d01118'
...
def upgrade() -> None:
    ...
    """
    ***REMOVED*** Block date index for schedule views
    op.create_index(
        'idx_block_date',
        'blocks',
        ['date'],
    ...
    ***REMOVED*** Assignment indexes for lookup performance
    op.create_index(
        'idx_assignment_person_id',
        'assignments',
        ['person_id'],
        if_not_exists=True
    )
    op.create_index(
        'idx_assignment_block_id',
        'assignments',
        ['block_id'],
        if_not_exists=True
    )

    ***REMOVED*** Swap record indexes for swap operations
    op.create_index(
