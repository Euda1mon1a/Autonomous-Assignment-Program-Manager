...
def upgrade() -> None:
    ...
    ***REMOVED*** Create scheduled_jobs table
    op.create_table(
        'scheduled_jobs',
    ...
    ***REMOVED*** Create indexes for scheduled_jobs
    ...
    ***REMOVED*** Create job_executions table
    op.create_table(
        'job_executions',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    ***REMOVED*** Create indexes for job_executions
...
def downgrade() -> None:
    ...
    ***REMOVED*** Drop job_executions indexes
    ...
    ***REMOVED*** Drop job_executions table
    op.drop_table('job_executions')

    ***REMOVED*** Drop scheduled_jobs indexes
    ...
    ***REMOVED*** Drop scheduled_jobs table
