...
def upgrade() -> None:
    ...
    ***REMOVED*** Add index for efficient queries
    op.create_index(
    ...
    ***REMOVED*** Also add to assignments_version table for SQLAlchemy-Continuum
    op.add_column(
        "assignments_version",
        sa.Column("schedule_run_id", UUID(as_uuid=True), nullable=True),
    )
