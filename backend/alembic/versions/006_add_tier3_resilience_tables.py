...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_cognitive_sessions_started_at", "cognitive_sessions", ["started_at"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["session_id"], ["cognitive_sessions.id"], ondelete="SET NULL"
        ),
    )
    op.create_index(
        "ix_cognitive_decisions_session_id", "cognitive_decisions", ["session_id"]
    )
    op.create_index(
        "ix_cognitive_decisions_category", "cognitive_decisions", ["category"]
    )
    op.create_index(
        "ix_cognitive_decisions_outcome", "cognitive_decisions", ["outcome"]
    )
    op.create_index(
        "ix_cognitive_decisions_created_at", "cognitive_decisions", ["created_at"]
    )
    ...
    op.create_index(
        "ix_preference_trails_faculty_id", "preference_trails", ["faculty_id"]
    )
    op.create_index(
        "ix_preference_trails_trail_type", "preference_trails", ["trail_type"]
    )
    op.create_index(
        "ix_preference_trails_slot_type", "preference_trails", ["slot_type"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["trail_id"], ["preference_trails.id"], ondelete="CASCADE"
        ),
    )
    ...
    op.create_index(
        "ix_faculty_centrality_faculty_id", "faculty_centrality", ["faculty_id"]
    )
    op.create_index(
        "ix_faculty_centrality_composite_score",
        "faculty_centrality",
        ["composite_score"],
    )
    ...
    op.create_index(
        "ix_hub_protection_plans_hub_faculty_id",
        "hub_protection_plans",
        ["hub_faculty_id"],
    )
    op.create_index(
        "ix_hub_protection_plans_status", "hub_protection_plans", ["status"]
    )
    op.create_index(
        "ix_hub_protection_plans_period",
        "hub_protection_plans",
    ...
    op.create_index(
        "ix_cross_training_priority", "cross_training_recommendations", ["priority"]
    )
    op.create_index(
        "ix_cross_training_status", "cross_training_recommendations", ["status"]
    )
