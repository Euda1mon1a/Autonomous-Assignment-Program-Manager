...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_schedule_versions_run", "schedule_versions", ["schedule_run_id"]
    )
    op.create_index(
        "idx_schedule_versions_created", "schedule_versions", ["created_at"]
    )
    op.create_index(
        "idx_schedule_versions_trigger", "schedule_versions", ["trigger_type"]
    )
    op.create_index(
        "idx_schedule_versions_parent", "schedule_versions", ["parent_version_id"]
    )
    ...
    op.create_index(
        "ix_metrics_version_category",
        "metric_snapshots",
        ["schedule_version_id", "category"],
    )
    op.create_index(
        "ix_metrics_name_time", "metric_snapshots", ["metric_name", "computed_at"]
    )
    ...
    op.create_index(
        "idx_diffs_from_to", "schedule_diffs", ["from_version_id", "to_version_id"]
    )
