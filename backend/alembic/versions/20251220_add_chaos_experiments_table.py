...
down_revision: Union[str, None] = '20251220_add_gateway_auth_tables'
...
def upgrade() -> None:
    ...
    ***REMOVED*** Create chaos_experiments table
    op.create_table(
        'chaos_experiments',
        ...
        ***REMOVED*** Execution tracking
        ...
        sa.Column('max_duration_minutes', sa.Integer(), nullable=False, server_default='15'),
        ...
        ***REMOVED*** Results
        ...
        sa.Column('successful_injections', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('failed_injections', sa.Integer(), nullable=False, server_default='0'),
    ...
    ***REMOVED*** Create indexes for chaos_experiments
    op.create_index(
