...
down_revision: str | None = "20260103_add_activity_log"
...
def upgrade() -> None:
    ...
    op.add_column(
        "rotation_templates", sa.Column("archived_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "rotation_templates",
    ...
    op.create_index(
        "ix_rotation_templates_is_archived", "rotation_templates", ["is_archived"]
    )
