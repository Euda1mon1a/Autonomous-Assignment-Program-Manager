...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_swap_records_source_faculty_id", "swap_records", ["source_faculty_id"]
    )
    op.create_index(
        "ix_swap_records_target_faculty_id", "swap_records", ["target_faculty_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "max_weeks_per_month", sa.Integer(), nullable=True, server_default="2"
        ),
        sa.Column(
            "max_consecutive_weeks", sa.Integer(), nullable=True, server_default="1"
        ),
        sa.Column(
            "min_gap_between_weeks", sa.Integer(), nullable=True, server_default="2"
        ),
        sa.Column(
            "target_weeks_per_year", sa.Integer(), nullable=True, server_default="6"
        ),
        sa.Column(
            "notify_swap_requests", sa.Boolean(), nullable=True, server_default="true"
        ),
        sa.Column(
        ...
        sa.Column(
            "notify_conflict_alerts", sa.Boolean(), nullable=True, server_default="true"
        ),
        sa.Column(
            "notify_reminder_days", sa.Integer(), nullable=True, server_default="7"
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_faculty_preferences_faculty_id", "faculty_preferences", ["faculty_id"]
    )
