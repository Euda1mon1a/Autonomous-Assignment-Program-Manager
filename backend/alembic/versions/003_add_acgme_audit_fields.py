...
def upgrade() -> None:
    ...
    """
    ***REMOVED*** Add override fields to assignments table
    op.add_column(
        'assignments',
    ...
    ***REMOVED*** Add acgme_override_count to schedule_runs table
    op.add_column(
        'schedule_runs',
        sa.Column('acgme_override_count', sa.Integer(), server_default='0', nullable=True)
    )
