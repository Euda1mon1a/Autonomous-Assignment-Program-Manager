...
def upgrade() -> None:
    ...
    ***REMOVED*** Enable pgvector extension
    op.execute('CREATE EXTENSION IF NOT EXISTS vector')

    ***REMOVED*** Model tiers lookup table
    ***REMOVED*** Maps agent names to their default Claude model tier (haiku, sonnet, opus)
    op.create_table(
        'model_tiers',
    ...
    ***REMOVED*** Agent embeddings table
    ***REMOVED*** Pre-computed embeddings from agent specifications for semantic similarity
    op.create_table(
        'agent_embeddings',
        sa.Column('agent_name', sa.String(), primary_key=True),
    ...
    ***REMOVED*** Task history table
    ***REMOVED*** Tracks which agents handle which tasks for learning and optimization
    op.create_table(
        'task_history',
...
def downgrade() -> None:
    ...
    ***REMOVED*** Drop pgvector extension
