...
down_revision: Union[str, None] = "20251220_add_scheduled_jobs"
...
def upgrade() -> None:
    ...
    ***REMOVED*** Create api_keys table
    op.create_table(
        ...
        ***REMOVED*** Ownership and permissions
        sa.Column("owner_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("scopes", sa.Text(), nullable=True),
        sa.Column("allowed_ips", sa.Text(), nullable=True),
        ***REMOVED*** Rate limiting
        sa.Column(
            "rate_limit_per_minute", sa.Integer(), nullable=True, server_default="100"
        ),
        sa.Column(
            "rate_limit_per_hour", sa.Integer(), nullable=True, server_default="5000"
        ),
        ***REMOVED*** Status and lifecycle
        ...
        ***REMOVED*** Foreign keys
        ...
        sa.ForeignKeyConstraint(
            ["rotated_to_id"], ["api_keys.id"], ondelete="SET NULL"
        ),
    )

    ***REMOVED*** Create indexes for api_keys
    ...
    ***REMOVED*** Create oauth2_clients table
    op.create_table(
        ...
        ***REMOVED*** Status
        sa.Column("is_active", sa.Boolean(), nullable=False, server_default="true"),
        sa.Column(
            "is_confidential", sa.Boolean(), nullable=False, server_default="true"
        ),
        ***REMOVED*** Rate limiting
        sa.Column(
            "rate_limit_per_minute", sa.Integer(), nullable=True, server_default="100"
        ...
        ***REMOVED*** Usage tracking
        sa.Column("last_used_at", sa.DateTime(), nullable=True),
        sa.Column(
            "total_tokens_issued", sa.Integer(), nullable=False, server_default="0"
        ),
        ***REMOVED*** Timestamps
        sa.Column(
            "created_at", sa.DateTime(), nullable=False, server_default=sa.func.now()
    ...
    ***REMOVED*** Create indexes for oauth2_clients
    ...
    op.create_index(
        "idx_oauth2_client_owner", "oauth2_clients", ["owner_id", "is_active"]
    )

    ***REMOVED*** Create ip_whitelists table
    op.create_table(
        "ip_whitelists",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    ***REMOVED*** Create indexes for ip_whitelists
    op.create_index("ix_ip_whitelists_ip_address", "ip_whitelists", ["ip_address"])
    op.create_index(
        "idx_ip_whitelist_active", "ip_whitelists", ["is_active", "expires_at"]
    )
    op.create_index(
        "idx_ip_whitelist_applies_to", "ip_whitelists", ["applies_to", "is_active"]
    )

    ***REMOVED*** Create ip_blacklists table
    op.create_table(
        "ip_blacklists",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("ip_address", sa.String(45), nullable=False),
    ...
    ***REMOVED*** Create indexes for ip_blacklists
    op.create_index("ix_ip_blacklists_ip_address", "ip_blacklists", ["ip_address"])
    op.create_index(
        "idx_ip_blacklist_active", "ip_blacklists", ["is_active", "expires_at"]
    )
    op.create_index(
        "idx_ip_blacklist_detection", "ip_blacklists", ["detection_method", "is_active"]
    )

    ***REMOVED*** Create request_signatures table
    op.create_table(
        "request_signatures",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    ***REMOVED*** Create indexes for request_signatures
    op.create_index(
        "ix_request_signatures_signature_hash", "request_signatures", ["signature_hash"]
    )
    op.create_index(
        "idx_request_signature_timestamp",
        "request_signatures",
        ["request_timestamp", "verified_at"],
    )
    op.create_index(
        "idx_request_signature_api_key",
        "request_signatures",
        ["api_key_id", "verified_at"],
    )
...
def downgrade() -> None:
    ...
    ***REMOVED*** Drop tables in reverse order (to respect foreign keys)
