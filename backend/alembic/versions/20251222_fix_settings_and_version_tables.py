...
def upgrade() -> None:
    ...
    ***REMOVED*** 1. Add freeze columns to application_settings
    ...
    ***REMOVED*** Add check constraints for freeze columns
    ...
    ***REMOVED*** 2. Rename version tables to match Continuum convention
    ***REMOVED*** Continuum expects {tablename}_version, so:
    ***REMOVED*** - schedule_runs table -> schedule_runs_version (not schedule_run_version)
    ***REMOVED*** - assignments table -> assignments_version (not assignment_version)
    op.execute("""
        DO $$
        BEGIN
    ...
    ***REMOVED*** Update indexes to use new table names
