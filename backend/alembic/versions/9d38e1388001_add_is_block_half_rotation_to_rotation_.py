...
def upgrade() -> None:
    ***REMOVED*** Add is_block_half_rotation column for split rotations like Night Float
    op.add_column(
        'rotation_templates',
        sa.Column('is_block_half_rotation', sa.Boolean(), nullable=False, server_default='false')
    )
