...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('fm_clinic_min_per_week', sa.Integer(), nullable=False, server_default='2'),
        sa.Column('fm_clinic_max_per_week', sa.Integer(), nullable=False, server_default='3'),
        # Specialty requirements
        sa.Column('specialty_min_per_week', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('specialty_max_per_week', sa.Integer(), nullable=False, server_default='10'),
        # Academic time
        sa.Column('academics_required', sa.Boolean(), nullable=False, server_default='true'),
