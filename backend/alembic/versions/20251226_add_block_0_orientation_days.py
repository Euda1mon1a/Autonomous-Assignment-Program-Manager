...
def upgrade() -> None:
    ...
    ***REMOVED*** Insert Block 0 records (idempotent - uses ON CONFLICT DO NOTHING)
    ***REMOVED*** July 1, 2025 - AM
    op.execute(
        sa.text("""
...
def downgrade() -> None:
    ...
    ***REMOVED*** Delete all blocks with block_number = 0
    op.execute(
