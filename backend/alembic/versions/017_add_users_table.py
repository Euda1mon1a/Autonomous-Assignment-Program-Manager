...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        ***REMOVED*** Check constraint for valid roles
        sa.CheckConstraint(
    ...
    ***REMOVED*** Add FK from email_templates.created_by_id to users.id
    ***REMOVED*** (column was created in migration 016 without FK)
...
def downgrade() -> None:
    ...
    ***REMOVED*** Drop FK from email_templates first (before dropping users table)
