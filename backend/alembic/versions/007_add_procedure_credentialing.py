...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Categorization
        sa.Column('category', sa.String(100)),  # 'surgical', 'office', 'obstetric', 'clinic'
        sa.Column('specialty', sa.String(100)),  # 'Sports Medicine', 'OB/GYN', 'Dermatology'

        # Supervision requirements
        sa.Column('supervision_ratio', sa.Integer(), server_default='1'),  # Max residents per faculty
    ...
    op.create_table(
        ...
        sa.Column('max_concurrent_residents', sa.Integer()),  # NULL uses procedure default
