...
def upgrade() -> None:
    ...
    ***REMOVED*** Table 1: procedures
    ***REMOVED*** Defines medical procedures that require credentialed supervision
    op.create_table(
        'procedures',
        ...
        ***REMOVED*** Categorization
        sa.Column('category', sa.String(100)),  ***REMOVED*** 'surgical', 'office', 'obstetric', 'clinic'
        sa.Column('specialty', sa.String(100)),  ***REMOVED*** 'Sports Medicine', 'OB/GYN', 'Dermatology'

        ***REMOVED*** Supervision requirements
        sa.Column('supervision_ratio', sa.Integer(), server_default='1'),  ***REMOVED*** Max residents per faculty
        ...
        ***REMOVED*** Constraints
        ...
        sa.CheckConstraint(
            "min_pgy_level BETWEEN 1 AND 3",
            name='check_procedure_pgy_level'
        ),
        sa.CheckConstraint(
            "supervision_ratio >= 1",
            name='check_supervision_ratio'
        ),
    )
    ...
    ***REMOVED*** Table 2: procedure_credentials
    ***REMOVED*** Links faculty to procedures they are credentialed to supervise
    op.create_table(
        ...
        ***REMOVED*** Dates
        ...
        sa.Column('expiration_date', sa.Date()),  ***REMOVED*** NULL = no expiration
        sa.Column('last_verified_date', sa.Date()),

        ***REMOVED*** Supervision capacity (overrides procedure defaults)
        sa.Column('max_concurrent_residents', sa.Integer()),  ***REMOVED*** NULL uses procedure default
        sa.Column('max_per_week', sa.Integer()),  ***REMOVED*** NULL = unlimited
        sa.Column('max_per_academic_year', sa.Integer()),  ***REMOVED*** NULL = unlimited
        ...
        ***REMOVED*** Constraints
        sa.UniqueConstraint('person_id', 'procedure_id', name='uq_person_procedure_credential'),
        sa.CheckConstraint(
    ...
    op.create_index('idx_credentials_procedure', 'procedure_credentials', ['procedure_id'])
    op.create_index('idx_credentials_status', 'procedure_credentials', ['status'])
    op.create_index('idx_credentials_expiration', 'procedure_credentials', ['expiration_date'])
