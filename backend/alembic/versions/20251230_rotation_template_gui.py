...
down_revision = "acfc96d01118"  ***REMOVED*** TODO: Update to actual latest revision
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ***REMOVED*** ==========================================================================
    ***REMOVED*** 1. Extend rotation_templates table
    ***REMOVED*** ==========================================================================
    op.add_column(
        "rotation_templates",
        sa.Column(
    ...
    ***REMOVED*** Add foreign key for paired template (self-referential)
    ...
    ***REMOVED*** ==========================================================================
    ***REMOVED*** 2. Create weekly_patterns table
    ***REMOVED*** ==========================================================================
    op.create_table(
        "weekly_patterns",
    ...
    ***REMOVED*** ==========================================================================
    ***REMOVED*** 3. Create rotation_preferences table
    ***REMOVED*** ==========================================================================
    op.create_table(
...
def downgrade() -> None:
    ...
    ***REMOVED*** Drop foreign key and columns from rotation_templates
