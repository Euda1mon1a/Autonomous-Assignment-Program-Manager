...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "operation_type", sa.SmallInteger(), nullable=False
    ...
    op.create_index(
        "idx_assignment_version_transaction", "assignment_version", ["transaction_id"]
    )
    op.create_index(
        "idx_assignment_version_end_transaction",
        "assignment_version",
        ["end_transaction_id"],
    )
    op.create_index(
        "idx_assignment_version_operation", "assignment_version", ["operation_type"]
    )
    ...
    op.create_index(
        "idx_absence_version_transaction", "absence_version", ["transaction_id"]
    )
    op.create_index(
        "idx_absence_version_end_transaction", "absence_version", ["end_transaction_id"]
    )
    op.create_index(
        "idx_absence_version_operation", "absence_version", ["operation_type"]
    )
    ...
    op.create_index(
        "idx_schedule_run_version_transaction",
        "schedule_run_version",
        ["transaction_id"],
    )
    op.create_index(
        "idx_schedule_run_version_end_transaction",
        "schedule_run_version",
        ["end_transaction_id"],
    )
    op.create_index(
        "idx_schedule_run_version_operation", "schedule_run_version", ["operation_type"]
    )
