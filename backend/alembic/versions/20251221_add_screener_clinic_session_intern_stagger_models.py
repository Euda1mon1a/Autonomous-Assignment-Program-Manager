...
def upgrade() -> None:
    ...
    """
    ***REMOVED*** ============================================
    ***REMOVED*** 1. Add screener fields to people table
    ***REMOVED*** ============================================
    op.add_column(
        'people',
    ...
    ***REMOVED*** Add check constraints for screener fields
    ...
    ***REMOVED*** ============================================
    ***REMOVED*** 2. Create clinic_sessions table
    ***REMOVED*** ============================================
    op.create_table(
        'clinic_sessions',
    ...
    ***REMOVED*** Add indexes for clinic_sessions
    op.create_index('ix_clinic_sessions_date', 'clinic_sessions', ['date'])

    ***REMOVED*** Add check constraints for clinic_sessions
    op.create_check_constraint(
        'check_session_type',
        'clinic_sessions',
    ...
    ***REMOVED*** ============================================
    ***REMOVED*** 3. Create intern_stagger_patterns table
    ***REMOVED*** ============================================
    op.create_table(
    ...
    ***REMOVED*** Add check constraints for intern_stagger_patterns
    op.create_check_constraint(
...
def downgrade() -> None:
    ...
    ***REMOVED*** Drop intern_stagger_patterns table
    ...
    ***REMOVED*** Drop clinic_sessions table
    ...
    ***REMOVED*** Drop screener fields from people table
