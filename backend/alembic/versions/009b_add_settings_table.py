...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=False,
            server_default="greedy",
        ),
        # Work hour limits
        sa.Column(
            "work_hours_per_week", sa.Integer(), nullable=False, server_default="80"
        ),
        sa.Column(
            "max_consecutive_days", sa.Integer(), nullable=False, server_default="6"
        ),
        sa.Column(
            "min_days_off_per_week", sa.Integer(), nullable=False, server_default="1"
        ),
        # Supervision ratios
        sa.Column(
