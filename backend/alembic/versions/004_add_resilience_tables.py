...
def upgrade() -> None:
    ...
    ***REMOVED*** Table 1: resilience_health_checks
    ***REMOVED*** Stores periodic system health check results for trend analysis and alerting
    op.create_table(
        ...
        ***REMOVED*** Utilization metrics (queuing theory)
        sa.Column('utilization_rate', sa.Float(), nullable=False),
        sa.Column('utilization_level', sa.String(20), nullable=False),  ***REMOVED*** GREEN, YELLOW, ORANGE, RED, BLACK
        sa.Column('buffer_remaining', sa.Float()),

        ***REMOVED*** Defense status (nuclear safety paradigm)
        sa.Column('defense_level', sa.String(30)),  ***REMOVED*** PREVENTION, CONTROL, SAFETY_SYSTEMS, CONTAINMENT, EMERGENCY
        sa.Column('load_shedding_level', sa.String(20)),  ***REMOVED*** NORMAL, YELLOW, ORANGE, RED, BLACK, CRITICAL

        ***REMOVED*** Contingency compliance (N-1/N-2)
        sa.Column('n1_pass', sa.Boolean(), default=True),
        sa.Column('n2_pass', sa.Boolean(), default=True),
        sa.Column('phase_transition_risk', sa.String(20)),  ***REMOVED*** low, medium, high, critical
    ...
    ***REMOVED*** Table 2: resilience_events
    ***REMOVED*** Audit log for all resilience system state changes
    op.create_table(
        'resilience_events',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('timestamp', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        ...
        ***REMOVED*** Event context
        sa.Column('severity', sa.String(20)),  ***REMOVED*** minor, moderate, severe, critical
        sa.Column('reason', sa.String(500)),
        sa.Column('triggered_by', sa.String(100)),  ***REMOVED*** 'system', 'user:<id>', 'scheduled_task'

        ***REMOVED*** State before/after for audit trail
    ...
    ***REMOVED*** Table 3: sacrifice_decisions
    ***REMOVED*** Audit trail for load shedding (sacrifice) decisions
    op.create_table(
        'sacrifice_decisions',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('timestamp', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        ...
        ***REMOVED*** Decision details
        sa.Column('from_level', sa.String(20), nullable=False),  ***REMOVED*** Previous load shedding level
        sa.Column('to_level', sa.String(20), nullable=False),  ***REMOVED*** New load shedding level
        ...
        ***REMOVED*** Authorization
        sa.Column('approved_by', sa.String(100)),  ***REMOVED*** User ID or 'auto' for automatic
        sa.Column('approval_method', sa.String(50)),  ***REMOVED*** 'automatic', 'manual', 'emergency_override'

        ***REMOVED*** Context at decision time
    ...
    ***REMOVED*** Table 4: fallback_activations
    ***REMOVED*** Tracks fallback schedule activations for audit and effectiveness tracking
    op.create_table(
        ...
        ***REMOVED*** Authorization
        sa.Column('activated_by', sa.String(100)),  ***REMOVED*** User ID or 'auto'
    ...
    ***REMOVED*** Table 5: vulnerability_records
    ***REMOVED*** Stores N-1/N-2 vulnerability analysis results for trend tracking
    op.create_table(
