...
def upgrade() -> None:
    ...
    ***REMOVED*** Assignment table - rotation template FK index (not covered by 12b3fa4f11ec)
    op.create_index(
    ...
    ***REMOVED*** Block table - composite index for specific half-day lookups
    ***REMOVED*** (12b3fa4f11ec only covers single-column date index)
    op.create_index(
    ...
    ***REMOVED*** Absence table - person_id FK index
    op.create_index(
    ...
    ***REMOVED*** CallAssignment table - person_id and date indexes
    op.create_index(
