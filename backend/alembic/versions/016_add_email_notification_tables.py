...
def upgrade() -> None:
    ...
    ***REMOVED*** Table 1: email_logs - tracks all emails sent
    op.create_table(
        'email_logs',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),

        ***REMOVED*** Optional link to notification
        sa.Column(
            'notification_id',
    ...
    ***REMOVED*** Indexes for email_logs
    ...
    ***REMOVED*** Table 2: email_templates - reusable email templates
    op.create_table(
        'email_templates',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        ...
        ***REMOVED*** Template content (supports Jinja2 variable substitution)
        ...
        ***REMOVED*** Template status
        sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true'),

        ***REMOVED*** Audit tracking
        ***REMOVED*** Note: FK to users added in migration 017 after users table is created
        sa.Column(
            'created_by_id',
            postgresql.UUID(as_uuid=True),
            nullable=True
    ...
    ***REMOVED*** Indexes for email_templates
