...
Usage:
    ...
    ***REMOVED*** Profile database queries
    python -m profiling.profile_queries

    ***REMOVED*** Generate flame graph
...
class ProfilerContext:
    ...
    def get_function_stats(self, func_name: str) -> dict[str, Any]:
        ...
        ***REMOVED*** Create string buffer to capture output
        buffer = StringIO()
...
def analyze_pstats_file(filepath: Path, sort_by: str = "cumulative", limit: int = 50):
    ...
    ***REMOVED*** Print callers for top functions
    print(f"\n{'=' * 80}")
...
def compare_profiles(baseline_file: Path, current_file: Path):
    ...
    ***REMOVED*** This is simplified - would need custom comparison logic
    ***REMOVED*** for detailed regression analysis
