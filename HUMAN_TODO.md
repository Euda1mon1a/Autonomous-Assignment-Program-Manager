...
***REMOVED******REMOVED*** Next Session Priority (2025-12-25)

***REMOVED******REMOVED******REMOVED*** 1. Block 10 Schedule Generation - COMPLETE ✅
**Priority:** High
...
***REMOVED******REMOVED******REMOVED*** 2. Complete MCP Wiring - DONE
**Priority:** Medium
**Context:** PR ***REMOVED***402 wired 3/5 tools, 2 remaining - **FIXED 2025-12-24**
...
***REMOVED******REMOVED******REMOVED*** 3. PuLP Solver Template Balance - DONE
**Priority:** Low
...
***REMOVED******REMOVED******REMOVED*** 4. Optional: Add `solver_managed` Flag
...
***REMOVED******REMOVED*** Feature Requests - Pending Investigation

***REMOVED******REMOVED******REMOVED*** ACGME Rest Hours - PGY-Level Differentiation
**Priority:** Medium
**Added:** 2025-12-30
...
```python
ACGME_MIN_REST_PGY1 = 10.0      ***REMOVED*** ACGME "should have"
ACGME_MIN_REST_PGY2_PLUS = 8.0  ***REMOVED*** ACGME "must have"
```
...
***REMOVED******REMOVED******REMOVED*** Resident Call Types
**Priority:** Medium
**Added:** 2025-12-26
...
***REMOVED******REMOVED*** UI/UX Improvements (2025-12-26)

> Findings from Comet Assistant GUI exploration session

***REMOVED******REMOVED******REMOVED*** 1. Schedule Grid - Frozen Headers/Columns
**Priority:** High
...
***REMOVED******REMOVED******REMOVED*** 2. Heatmap Page - Add Block Navigation
**Priority:** High
**Page:** `/heatmap`
**Status:** ✅ COMPLETE (Session 012, 2025-12-28)
...
***REMOVED******REMOVED******REMOVED*** 3. Heatmap Backend Bug - group_by Validation - FIXED
**Priority:** Medium
**Page:** `/heatmap`
**Status:** FIXED (PR ***REMOVED***512)

**Issue:** Backend rejects "Daily" and "Weekly" `group_by` values, only accepts "person" or "rotation"

**Resolution (PR ***REMOVED***512):**
...
***REMOVED******REMOVED******REMOVED*** 4. Daily Manifest - Empty State UX
**Priority:** Medium
**Page:** `/daily-manifest`
**Status:** COMPLETE (Session 012, 2025-12-28)
...
***REMOVED******REMOVED*** Documentation Cleanup
...
***REMOVED******REMOVED******REMOVED*** Backend Fix: Faculty Assignments Missing rotation_template_id - FIXED
...
***REMOVED******REMOVED******REMOVED*** Solver Template Distribution Bugs - FIXED & VERIFIED
...
3. [x] **Template Filtering:** `_get_rotation_templates()` now defaults to `activity_type="outpatient"`
   - **NOTE (2025-12-26):** Previous fix incorrectly used `"clinic"` instead of `"outpatient"`.
     PR ***REMOVED***442 was not merged due to this issue being caught during evaluation.
...
***REMOVED******REMOVED******REMOVED*** NF Half-Block Documentation Consistency - VERIFIED
...
***REMOVED******REMOVED*** Cleanup Session Report (2025-12-21 Overnight)

***REMOVED******REMOVED******REMOVED*** Completed Autonomously
...
***REMOVED******REMOVED******REMOVED*** Broken Documentation Links (Need Decision)
...
***REMOVED******REMOVED******REMOVED*** Big Ideas (Deferred for Morning Review)
...
***REMOVED******REMOVED******REMOVED*** Skipped (Too Invasive for Rest Mode)
...
***REMOVED******REMOVED*** Full-Stack MVP Review Findings (2025-12-30)

> Comprehensive 16-layer inspection conducted. See `docs/planning/MVP_STATUS_REPORT.md` for full details.

***REMOVED******REMOVED******REMOVED*** 🔴 CRITICAL - Fix Before Launch

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Celery Worker Missing Queues - ✅ RESOLVED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Security TODOs in audience_tokens.py - ✅ RESOLVED
**Priority:** CRITICAL → RESOLVED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Frontend Environment Variable Mismatch - ✅ RESOLVED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Missing Database Indexes - ✅ RESOLVED
**Priority:** HIGH → RESOLVED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Admin Users Page API Not Wired
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 6. Resilience API Response Models - 85% COMPLETE
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 7. CD Pipeline - Deployment Logic Placeholder-Only
**Priority:** HIGH
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 8. MCP Server - Missing from Production Compose
**Priority:** HIGH
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 9. Frontend Procedure Hooks - All Stubs
**Priority:** HIGH
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 10. Frontend Resilience Components - Skeleton Only
**Priority:** HIGH
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 11. Frontend TypeScript Errors - Pre-existing Build Issues
**Priority:** HIGH
...
***REMOVED******REMOVED******REMOVED*** 🟢 MEDIUM PRIORITY - Post-Launch Sprint

***REMOVED******REMOVED******REMOVED******REMOVED*** 13. Frontend Accessibility Gaps
- Only 24/80 core components have ARIA attributes
- Missing `<thead>` in ScheduleGrid tables
- Missing `aria-label` on icon-only buttons

***REMOVED******REMOVED******REMOVED******REMOVED*** 14. Token Refresh Not Implemented - ✅ RESOLVED
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 18. Activity Logging Not Implemented
**Priority:** MEDIUM
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 19. Penrose Efficiency - Placeholder Logic
**Priority:** MEDIUM
...
***REMOVED******REMOVED******REMOVED*** Full-Stack Review Summary
...
***REMOVED******REMOVED******REMOVED*** PHI Exposure in API Responses
**Priority:** HIGH
...
***REMOVED******REMOVED*** Documentation Improvements (Completed 2025-12-31)
