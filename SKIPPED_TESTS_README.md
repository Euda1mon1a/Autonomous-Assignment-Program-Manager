***REMOVED*** Skipped Tests Intelligence Report - Index
...
***REMOVED******REMOVED*** The Report Files
...
***REMOVED******REMOVED******REMOVED*** By The Numbers
...
***REMOVED******REMOVED******REMOVED*** Action Items (Priority Order)
...
***REMOVED******REMOVED*** Which File Should I Read?
...
***REMOVED******REMOVED******REMOVED*** I'm a Tech Lead / PM
...
***REMOVED******REMOVED******REMOVED*** I'm QA / Tester
...
***REMOVED******REMOVED*** The 7 Categories

***REMOVED******REMOVED******REMOVED*** 1. DEBT-016 Placeholders (HIGH PRIORITY)
...
***REMOVED******REMOVED******REMOVED*** 2. Missing Optional Dependencies (KEEP SKIPPED)
...
***REMOVED******REMOVED******REMOVED*** 3. Known Issues - Test Isolation (CRITICAL)
...
***REMOVED******REMOVED******REMOVED*** 4. Not Yet Implemented (DEFER)
...
***REMOVED******REMOVED******REMOVED*** 5. Vector Database (KEEP SKIPPED)
...
***REMOVED******REMOVED******REMOVED*** 6. Misc Fixtures (IMPLEMENT + UNSKIP)
...
***REMOVED******REMOVED******REMOVED*** 7. MCP Server Optional (KEEP SKIPPED)
...
***REMOVED******REMOVED*** Unskip Strategy

***REMOVED******REMOVED******REMOVED*** Phase 1 (Immediate - 1 sprint)
```
...
***REMOVED******REMOVED******REMOVED*** Phase 2 (Medium-term - 2-3 weeks)
```
...
***REMOVED******REMOVED******REMOVED*** Phase 3 (Ongoing)
```
...
***REMOVED******REMOVED******REMOVED*** HIGH RISK (Missing Coverage)
...
***REMOVED******REMOVED******REMOVED*** MEDIUM RISK (Incomplete)
...
***REMOVED******REMOVED******REMOVED*** LOW RISK (OK to Skip)
...
***REMOVED******REMOVED*** Implementation Tips

***REMOVED******REMOVED******REMOVED*** For DEBT-016 Unskip
...
***REMOVED******REMOVED******REMOVED*** For Test Isolation Fix
...
***REMOVED******REMOVED******REMOVED*** For Optional Dependencies

**Python Install:**
```bash
pip install ndlib networkx scikit-learn  ***REMOVED*** For optional tests
```

**CI Config:**
```bash
pytest tests/unit/test_contagion_model.py  ***REMOVED*** Optional tests
```
...
***REMOVED******REMOVED*** Quick Links to File Locations
