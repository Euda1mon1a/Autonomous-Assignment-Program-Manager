...
***REMOVED*** Template IDs for splitting
COMBINED_TEMPLATES = {
    ***REMOVED*** template_id: (first_half_template_name, second_half_template_name)
    "38d35ac5-bb3c-4161-ace8-9f26ec4e88a6": ("Night Float", "Dermatology"),  ***REMOVED*** NF-DERM
    "6dd781d5-41aa-4dd3-a44b-a3c3eea439c5": ("Night Float", "FMIT"),          ***REMOVED*** NF-I (Night Float Intern + FMIT)
    "691ad20d-cc4a-4d2a-bed4-22b90ad1a903": ("Night Float", "Cardiology"),    ***REMOVED*** NF+ (Night Float + Cardiology)
}
...
def main():
    ...
    ***REMOVED*** Get template IDs for individual rotations
    cur.execute("""
    ...
    ***REMOVED*** Map logical names to actual template IDs
    template_map = {
        "Night Float": {
        ...
        "Dermatology": {
            "AM": templates.get("Dermatology"),  ***REMOVED*** Same for AM and PM
    ...
    ***REMOVED*** Find all combined assignments
    cur.execute("""
    ...
    ***REMOVED*** Process each group
    ...
    for key, group in grouped.items():
        ...
        ***REMOVED*** Find the midpoint date (day 15 is start of second half)
        first_date = assignments[0]["date"]
        mid_date = first_date + timedelta(days=14)  ***REMOVED*** Day 15 is 14 days after day 1

        print(f"  Block starts: {first_date}, Mid-block (day 15): {mid_date}")

        ***REMOVED*** Delete original combined assignments
        ...
        ***REMOVED*** Create new split assignments
        new_count = 0
