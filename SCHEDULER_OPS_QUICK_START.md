***REMOVED*** Scheduler Operations API - Quick Start Guide
...
***REMOVED******REMOVED*** Quick Setup (3 Steps)

***REMOVED******REMOVED******REMOVED*** Step 1: Register the Router

Edit `/backend/app/api/routes/__init__.py`:

```python
***REMOVED*** Add import (around line 24)
from app.api.routes import (
    ***REMOVED*** ... existing imports ...
    resilience,
    scheduler_ops,  ***REMOVED*** ← ADD THIS
    settings,
    ***REMOVED*** ...
)

***REMOVED*** Add router registration (around line 47)
api_router.include_router(resilience.router, prefix="/resilience", tags=["resilience"])
api_router.include_router(scheduler_ops.router, prefix="/scheduler", tags=["scheduler-ops"])  ***REMOVED*** ← ADD THIS
```

***REMOVED******REMOVED******REMOVED*** Step 2: Test the Endpoints
...
***REMOVED*** In another terminal, test sitrep
curl http://localhost:8000/api/scheduler/sitrep \
  -H "Authorization: Bearer YOUR_TOKEN"
```

***REMOVED******REMOVED******REMOVED*** Step 3: Update n8n Workflows (Optional)
...
***REMOVED******REMOVED*** API Cheat Sheet

***REMOVED******REMOVED******REMOVED*** Sitrep - System Status
...
***REMOVED******REMOVED******REMOVED*** Fix-It - Auto Recovery
...
***REMOVED******REMOVED******REMOVED*** Approve - Task Approval

```bash
***REMOVED*** Step 1: Generate token
...
***REMOVED*** Step 2: Use token to approve
...
***REMOVED*** Use the access_token in Authorization header
```

***REMOVED******REMOVED******REMOVED*** Issue: 500 Internal Server Error
...
***REMOVED*** Verify database connection
docker-compose ps db
```

***REMOVED******REMOVED******REMOVED*** Issue: n8n workflow not calling endpoint
